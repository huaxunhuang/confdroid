...
public class MtpEvent {
    ...
    private int mEventCode = android.mtp.MtpEvent.EVENT_UNDEFINED;
    ...
    public int getObjectHandle() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_OBJECT_ADDED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_OBJECT_REMOVED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_OBJECT_INFO_CHANGED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_REQUEST_OBJECT_TRANSFER :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_OBJECT_PROP_CHANGED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_OBJECT_REFERENCES_CHANGED :
                return mParameter1;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectHandle", mEventCode);
        }
    }
    ...
    public int getStorageId() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_STORE_ADDED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_STORE_REMOVED :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_STORE_FULL :
                return mParameter1;
            case android.mtp.MtpEvent.EVENT_STORAGE_INFO_CHANGED :
                return mParameter1;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("storageID", mEventCode);
        }
    }
    ...
    public int getDevicePropCode() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_DEVICE_PROP_CHANGED :
                return mParameter1;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("devicePropCode", mEventCode);
        }
    }
    ...
    public int getTransactionId() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_CAPTURE_COMPLETE :
                return mParameter1;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("transactionID", mEventCode);
        }
    }
    ...
    public int getObjectPropCode() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_OBJECT_PROP_CHANGED :
                return mParameter2;
            case android.mtp.MtpEvent.EVENT_OBJECT_PROP_DESC_CHANGED :
                return mParameter1;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectPropCode", mEventCode);
        }
    }
    ...
    public int getObjectFormatCode() {
        switch (mEventCode) {
            case android.mtp.MtpEvent.EVENT_OBJECT_PROP_DESC_CHANGED :
                return mParameter2;
            default :
                throw new android.mtp.MtpEvent.IllegalParameterAccess("objectFormatCode", mEventCode);
        }
    }

    private static class IllegalParameterAccess extends java.lang.UnsupportedOperationException {
        public IllegalParameterAccess(java.lang.String propertyName, int eventCode) {
