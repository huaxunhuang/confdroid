...
class MtpPropertyList {
    ...
    public java.lang.String[] mStringValues;
    ...
    public void append(int handle, int property, java.lang.String value) {
        int index = mCount++;
        if (mStringValues == null) {
            mStringValues = new java.lang.String[mMaxCount];
        }
        mObjectHandles[index] = handle;
        mPropertyCodes[index] = property;
        mDataTypes[index] = android.mtp.MtpConstants.TYPE_STR;
