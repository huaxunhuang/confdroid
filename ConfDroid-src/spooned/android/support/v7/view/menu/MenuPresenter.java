...
public interface MenuPresenter {
    ...
    interface Callback {
         ...
         * 		
         */
        void onCloseMenu(android.support.v7.view.menu.MenuBuilder menu, boolean allMenusAreClosing);
         ...
         */
        boolean onOpenSubMenu(android.support.v7.view.menu.MenuBuilder subMenu);
    }
     ...
     * 		Menu to host
     */
    void initForMenu(android.content.Context context, android.support.v7.view.menu.MenuBuilder menu);
     ...
     */
    android.support.v7.view.menu.MenuView getMenuView(android.view.ViewGroup root);
     ...
     */
    void setCallback(android.support.v7.view.menu.MenuPresenter.Callback cb);
     ...
     */
    boolean onSubMenuSelected(android.support.v7.view.menu.SubMenuBuilder subMenu);
     ...
     */
    boolean expandItemActionView(android.support.v7.view.menu.MenuBuilder menu, android.support.v7.view.menu.MenuItemImpl item);
     ...
     */
    boolean collapseItemActionView(android.support.v7.view.menu.MenuBuilder menu, android.support.v7.view.menu.MenuItemImpl item);
