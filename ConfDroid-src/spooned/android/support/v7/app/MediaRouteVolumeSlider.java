 ...
 */
class MediaRouteVolumeSlider extends android.support.v7.widget.AppCompatSeekBar {
    private static final java.lang.String TAG = "MediaRouteVolumeSlider";
    ...
    public MediaRouteVolumeSlider(android.content.Context context) {
        this(context, null);
    }

    public MediaRouteVolumeSlider(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, android.support.v7.appcompat.R.attr.seekBarStyle);
    }

    public MediaRouteVolumeSlider(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
    ...
    public void setColor(int color) {
        ...
        if (android.graphics.Color.alpha(color) != 0xff) {
            android.util.Log.e(android.support.v7.app.MediaRouteVolumeSlider.TAG, "Volume slider color cannot be translucent: #" + java.lang.Integer.toHexString(color));
        }
        mColor = color;
    }
}
