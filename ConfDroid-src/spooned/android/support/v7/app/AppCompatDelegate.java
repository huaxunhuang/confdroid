...
public abstract class AppCompatDelegate {
    ...
    private static int sDefaultNightMode = android.support.v7.app.AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM;
    ...
    @android.support.annotation.IntDef({ android.support.v7.app.AppCompatDelegate.MODE_NIGHT_NO, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_YES, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_AUTO, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_UNSPECIFIED })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public @interface NightMode {}

    @android.support.annotation.IntDef({ android.support.v7.app.AppCompatDelegate.MODE_NIGHT_NO, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_YES, android.support.v7.app.AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public static final int FEATURE_SUPPORT_ACTION_BAR = 100 + android.support.v4.view.WindowCompat.FEATURE_ACTION_BAR;
     ...
     * that space.
     */
    public static final int FEATURE_SUPPORT_ACTION_BAR_OVERLAY = 100 + android.support.v4.view.WindowCompat.FEATURE_ACTION_BAR_OVERLAY;

    /**
     * Flag for specifying the behavior of action modes when an Action Bar is not present.
     * If overlay is enabled, the action mode UI will be allowed to cover existing window content.
     */
    public static final int FEATURE_ACTION_MODE_OVERLAY = android.support.v4.view.WindowCompat.FEATURE_ACTION_MODE_OVERLAY;
     ...
     */
    public static android.support.v7.app.AppCompatDelegate create(android.app.Activity activity, android.support.v7.app.AppCompatCallback callback) {
        return android.support.v7.app.AppCompatDelegate.create(activity, activity.getWindow(), callback);
    }
     ...
     * 		An optional callback for AppCompat specific events
     */
    public static android.support.v7.app.AppCompatDelegate create(android.app.Dialog dialog, android.support.v7.app.AppCompatCallback callback) {
        return android.support.v7.app.AppCompatDelegate.create(dialog.getContext(), dialog.getWindow(), callback);
    }

    private static android.support.v7.app.AppCompatDelegate create(android.content.Context context, android.view.Window window, android.support.v7.app.AppCompatCallback callback) {
        final int sdk = android.os.Build.VERSION.SDK_INT;
        if (android.support.v4.os.BuildCompat.isAtLeastN()) {
            return new android.support.v7.app.AppCompatDelegateImplN(context, window, callback);
        } else
            if (sdk >= 23) {
                return new android.support.v7.app.AppCompatDelegateImplV23(context, window, callback);
            } else
                if (sdk >= 14) {
                    return new android.support.v7.app.AppCompatDelegateImplV14(context, window, callback);
                } else
                    if (sdk >= 11) {
                        return new android.support.v7.app.AppCompatDelegateImplV11(context, window, callback);
                    } else {
                        return new android.support.v7.app.AppCompatDelegateImplV9(context, window, callback);
                    }
     ...
     */
    public abstract void setSupportActionBar(@android.support.annotation.Nullable
     ...
     * </pre>
     */
    public abstract void onCreate(android.os.Bundle savedInstanceState);

    /**
     * Should be called from {@link Activity#onPostCreate(android.os.Bundle)}
     */
    public abstract void onPostCreate(android.os.Bundle savedInstanceState);
     ...
     */
    @android.support.annotation.Nullable
    public abstract android.view.View findViewById(@android.support.annotation.IdRes
    int id);

    /**
     * Should be called instead of {@link Activity#setContentView(android.view.View)}}
     */
    public abstract void setContentView(android.view.View v);

    /**
     * Should be called instead of {@link Activity#setContentView(int)}}
     */
    public abstract void setContentView(@android.support.annotation.LayoutRes
    int resId);
     ...
     */
    public abstract void setContentView(android.view.View v, android.view.ViewGroup.LayoutParams lp);

    /**
     * Should be called instead of
     * {@link Activity#addContentView(android.view.View, android.view.ViewGroup.LayoutParams)}}
     */
    public abstract void addContentView(android.view.View v, android.view.ViewGroup.LayoutParams lp);

    /**
     * Should be called from {@link Activity#onTitleChanged(CharSequence, int)}}
     */
    public abstract void setTitle(@android.support.annotation.Nullable
     ...
     */
    @android.support.annotation.Nullable
    public abstract android.support.v7.view.ActionMode startSupportActionMode(@android.support.annotation.NonNull
     ...
     */
    public abstract android.view.View createView(@android.support.annotation.Nullable
    android.view.View parent, java.lang.String name, @android.support.annotation.NonNull
     ...
     *
     * @param enabled
     * 		whether AppCompat should handle native action modes.
     */
     ...
     */
    public abstract void setLocalNightMode(@android.support.v7.app.AppCompatDelegate.NightMode
    int mode);
     ...
     */
    public static void setDefaultNightMode(@android.support.v7.app.AppCompatDelegate.NightMode
    int mode) {
        switch (mode) {
            ...
            case android.support.v7.app.AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM :
                android.support.v7.app.AppCompatDelegate.sDefaultNightMode = mode;
                break;
            default :
                android.util.Log.d(android.support.v7.app.AppCompatDelegate.TAG, "setDefaultNightMode() called with an unknown mode");
                break;
        }
    }
    ...
    public static int getDefaultNightMode() {
        return android.support.v7.app.AppCompatDelegate.sDefaultNightMode;
    }
    ...
    public static void setCompatVectorFromResourcesEnabled(boolean enabled) {
        android.support.v7.app.AppCompatDelegate.sCompatVectorFromResourcesEnabled = enabled;
    }
    ...
    public static boolean isCompatVectorFromResourcesEnabled() {
        return android.support.v7.app.AppCompatDelegate.sCompatVectorFromResourcesEnabled;
    }
}
