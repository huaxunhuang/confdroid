...
class AppCompatDelegateImplV9 extends android.support.v7.app.AppCompatDelegateImplBase implements android.support.v4.view.LayoutInflaterFactory , android.support.v7.view.menu.MenuBuilder.Callback {
    ...
    AppCompatDelegateImplV9(android.content.Context context, android.view.Window window, android.support.v7.app.AppCompatCallback callback) {
    ...
    public void onConfigurationChanged(android.content.res.Configuration newConfig) {
        ...
        android.support.v7.widget.AppCompatDrawableManager.get().onConfigurationChanged(mContext);
    ...
    private void ensureSubDecor() {
        if (!mSubDecorInstalled) {
            ...
            android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = getPanelState(android.view.Window.FEATURE_OPTIONS_PANEL, false);
    ...
    void onPanelClosed(final int featureId, android.view.Menu menu) {
        if (featureId == android.support.v7.app.AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR) {
            ...
            if (featureId == android.view.Window.FEATURE_OPTIONS_PANEL) {
                ...
                // ToolbarActionBar
                android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = getPanelState(featureId, true);
                if (st.isOpen) {
                    closePanel(st, false);
                }
            }
    ...
    public boolean onMenuItemSelected(android.support.v7.view.menu.MenuBuilder menu, android.view.MenuItem item) {
        ...
        if ((cb != null) && (!isDestroyed())) {
            final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState panel = findMenuPanel(menu.getRootMenu());
            if (panel != null) {
    ...
    final android.support.v7.view.ActionMode.Callback callback) {
        ...
        final android.support.v7.view.ActionMode.Callback wrappedCallback = new android.support.v7.app.AppCompatDelegateImplV9.ActionModeCallbackWrapperV9(callback);
        android.support.v7.app.ActionBar ab = getSupportActionBar();
        if (ab != null) {
    ...
    android.support.v7.view.ActionMode.Callback callback) {
        ...
        if (!(callback instanceof android.support.v7.app.AppCompatDelegateImplV9.ActionModeCallbackWrapperV9)) {
            // If the callback hasn't been wrapped yet, wrap it
            callback = new android.support.v7.app.AppCompatDelegateImplV9.ActionModeCallbackWrapperV9(callback);
        }
    ...
    boolean onKeyShortcut(int keyCode, android.view.KeyEvent ev) {
        ...
        if (mPreparedPanel == null) {
            android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = getPanelState(android.view.Window.FEATURE_OPTIONS_PANEL, true);
            preparePanel(st, ev);
    ...
    public void installViewFactory() {
        ...
        if (layoutInflater.getFactory() == null) {
            ...
            if (!(android.support.v4.view.LayoutInflaterCompat.getFactory(layoutInflater) instanceof android.support.v7.app.AppCompatDelegateImplV9)) {
    ...
    private void openPanel(final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st, android.view.KeyEvent event) {
        // Already open, return
    ...
    private boolean initializePanelDecor(android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st) {
        st.setStyle(getActionBarThemedContext());
        st.decorView = new android.support.v7.app.AppCompatDelegateImplV9.ListMenuDecorView(st.listPresenterContext);
        ...
        if (((mDecorContentParent != null) && mDecorContentParent.canShowOverflowMenu()) && ((!android.support.v4.view.ViewConfigurationCompat.hasPermanentMenuKey(android.view.ViewConfiguration.get(mContext))) || mDecorContentParent.isOverflowMenuShowPending())) {
            ...
            if ((!mDecorContentParent.isOverflowMenuShowing()) || (!toggleMenuMode)) {
                if ((cb != null) && (!isDestroyed())) {
                    ...
                    final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = getPanelState(android.view.Window.FEATURE_OPTIONS_PANEL, true);
    ...
    private boolean initializePanelMenu(final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st) {
        android.content.Context context = mContext;
    ...
    private boolean initializePanelContent(android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st) {
        if (st.createdPanelView != null) {
        ...
        if (mPanelMenuPresenterCallback == null) {
            mPanelMenuPresenterCallback = new android.support.v7.app.AppCompatDelegateImplV9.PanelMenuPresenterCallback();
        }
    ...
    private boolean preparePanel(android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st, android.view.KeyEvent event) {
        if (isDestroyed()) {
            return false;
        }
            ...
            if ((st.menu == null) || st.refreshMenuContent) {
                ...
                if (isActionBarMenu && (mDecorContentParent != null)) {
                    if (mActionMenuPresenterCallback == null) {
                        mActionMenuPresenterCallback = new android.support.v7.app.AppCompatDelegateImplV9.ActionMenuPresenterCallback();
                    }
    ...
    void checkCloseActionMenu(android.support.v7.view.menu.MenuBuilder menu) {
    ...
    void closePanel(android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st, boolean doCallback) {
    ...
    private boolean onKeyUpPanel(int featureId, android.view.KeyEvent event) {
        ...
        final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = getPanelState(featureId, true);
    ...
    void callOnPanelClosed(int featureId, android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState panel, android.view.Menu menu) {
        // Try to get a menu
        if (menu == null) {
    ...
    android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState findMenuPanel(android.view.Menu menu) {
        final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState[] panels = mPanels;
        final int N = (panels != null) ? panels.length : 0;
        for (int i = 0; i < N; i++) {
            final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState panel = panels[i];
    ...
    protected android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState getPanelState(int featureId, boolean required) {
        android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState[] ar;
        if (((ar = mPanels) == null) || (ar.length <= featureId)) {
            android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState[] nar = new android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState[featureId + 1];
            if (ar != null) {
                java.lang.System.arraycopy(ar, 0, nar, 0, ar.length);
            }
            mPanels = ar = nar;
        }
        android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st = ar[featureId];
        if (st == null) {
            ar[featureId] = st = new android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState(featureId);
        }
        return st;
    }

    private boolean performPanelShortcut(android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState st, int keyCode, android.view.KeyEvent event, int flags) {
        if (event.isSystem()) {
            return false;
        }
        boolean handled = false;
    ...
    class ActionModeCallbackWrapperV9 implements android.support.v7.view.ActionMode.Callback {
        ...
        public ActionModeCallbackWrapperV9(android.support.v7.view.ActionMode.Callback wrapped) {
            mWrapped = wrapped;
        }
    ...
    private final class PanelMenuPresenterCallback implements android.support.v7.view.menu.MenuPresenter.Callback {
        ...
        public void onCloseMenu(android.support.v7.view.menu.MenuBuilder menu, boolean allMenusAreClosing) {
            ...
            final android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState panel = findMenuPanel(isSubMenu ? parentMenu : menu);
            if (panel != null) {
                if (isSubMenu) {
    ...
    protected static final class PanelFeatureState {
        ...
        android.os.Parcelable onSaveInstanceState() {
            android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState savedState = new android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState();
        ...
        void onRestoreInstanceState(android.os.Parcelable state) {
            android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState savedState = ((android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState) (state));
        ...
        private static class SavedState implements android.os.Parcelable {
            ...
            static android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState readFromParcel(android.os.Parcel source, java.lang.ClassLoader loader) {
                android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState savedState = new android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState();
            ...
            public static final android.os.Parcelable.Creator<android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState> CREATOR = android.support.v4.os.ParcelableCompat.newCreator(new android.support.v4.os.ParcelableCompatCreatorCallbacks<android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState>() {
                @java.lang.Override
                public android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState createFromParcel(android.os.Parcel in, java.lang.ClassLoader loader) {
                    return android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState.readFromParcel(in, loader);
                }

                @java.lang.Override
                public android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState[] newArray(int size) {
                    return new android.support.v7.app.AppCompatDelegateImplV9.PanelFeatureState.SavedState[size];
                }
            });
        }
    }
    ...
    private class ListMenuDecorView extends android.support.v7.widget.ContentFrameLayout {
        ...
        public boolean dispatchKeyEvent(android.view.KeyEvent event) {
            return android.support.v7.app.AppCompatDelegateImplV9.this.dispatchKeyEvent(event) || super.dispatchKeyEvent(event);
        }
        ...
        public void setBackgroundResource(int resid) {
            setBackgroundDrawable(android.support.v7.content.res.AppCompatResources.getDrawable(getContext(), resid));
        }
