...
public abstract class PreferenceFragmentCompat extends android.support.v4.app.Fragment implements android.support.v7.preference.DialogPreference.TargetFragment , android.support.v7.preference.PreferenceManager.OnDisplayPreferenceDialogListener , android.support.v7.preference.PreferenceManager.OnNavigateToScreenListener , android.support.v7.preference.PreferenceManager.OnPreferenceTreeClickListener {
    ...
    private final android.support.v7.preference.PreferenceFragmentCompat.DividerDecoration mDividerDecoration = new android.support.v7.preference.PreferenceFragmentCompat.DividerDecoration();
    ...
    private android.os.Handler mHandler = new android.os.Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case android.support.v7.preference.PreferenceFragmentCompat.MSG_BIND_PREFERENCES :
                    bindPreferences();
                    break;
            }
        }
    ...
    public interface OnPreferenceStartFragmentCallback {
         ...
         */
        boolean onPreferenceStartFragment(android.support.v7.preference.PreferenceFragmentCompat caller, android.support.v7.preference.Preference pref);
    }
    ...
    public interface OnPreferenceStartScreenCallback {
         ...
         */
        boolean onPreferenceStartScreen(android.support.v7.preference.PreferenceFragmentCompat caller, android.support.v7.preference.PreferenceScreen pref);
    }
    ...
    public interface OnPreferenceDisplayDialogCallback {
         ...
         */
        boolean onPreferenceDisplayDialog(android.support.v7.preference.PreferenceFragmentCompat caller, android.support.v7.preference.Preference pref);
    }
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        if (args != null) {
            rootKey = getArguments().getString(android.support.v7.preference.PreferenceFragmentCompat.ARG_PREFERENCE_ROOT);
        } else {
            rootKey = null;
        }
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        android.content.res.TypedArray a = mStyledContext.obtainStyledAttributes(null, R.styleable.PreferenceFragmentCompat, R.attr.preferenceFragmentCompatStyle, 0);
        mLayoutResId = a.getResourceId(R.styleable.PreferenceFragmentCompat_android_layout, mLayoutResId);
        final android.graphics.drawable.Drawable divider = a.getDrawable(R.styleable.PreferenceFragmentCompat_android_divider);
     ...
     * @param divider
     * 		the drawable to use
     * @unknown ref R.styleable#PreferenceFragmentCompat_android_divider
     */
     ...
     * @unknown ref R.styleable#PreferenceFragmentCompat_android_dividerHeight
     */
    ...
    public void onActivityCreated(android.os.Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            android.os.Bundle container = savedInstanceState.getBundle(android.support.v7.preference.PreferenceFragmentCompat.PREFERENCES_TAG);
            if (container != null) {
    ...
    public void onDestroyView() {
        ...
        mHandler.removeMessages(android.support.v7.preference.PreferenceFragmentCompat.MSG_BIND_PREFERENCES);
        if (mHavePrefs) {
            unbindPreferences();
        }
        mList = null;
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        if (preferenceScreen != null) {
            ...
            outState.putBundle(android.support.v7.preference.PreferenceFragmentCompat.PREFERENCES_TAG, container);
        }
    }
    ...
    public boolean onPreferenceTreeClick(android.support.v7.preference.Preference preference) {
        if (preference.getFragment() != null) {
            ...
            if (getCallbackFragment() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartFragmentCallback) {
                handled = ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartFragmentCallback) (getCallbackFragment())).onPreferenceStartFragment(this, preference);
            }
            if ((!handled) && (getActivity() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartFragmentCallback)) {
                handled = ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartFragmentCallback) (getActivity())).onPreferenceStartFragment(this, preference);
            }
            return handled;
        }
        return false;
    ...
    public void onNavigateToScreen(android.support.v7.preference.PreferenceScreen preferenceScreen) {
        boolean handled = false;
        if (getCallbackFragment() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartScreenCallback) {
            handled = ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartScreenCallback) (getCallbackFragment())).onPreferenceStartScreen(this, preferenceScreen);
        }
        if ((!handled) && (getActivity() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartScreenCallback)) {
            ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceStartScreenCallback) (getActivity())).onPreferenceStartScreen(this, preferenceScreen);
        }
    }
    ...
    private void postBindPreferences() {
        if (mHandler.hasMessages(android.support.v7.preference.PreferenceFragmentCompat.MSG_BIND_PREFERENCES))
            return;

        mHandler.obtainMessage(android.support.v7.preference.PreferenceFragmentCompat.MSG_BIND_PREFERENCES).sendToTarget();
    }
    ...
    public android.support.v7.widget.RecyclerView onCreateRecyclerView(android.view.LayoutInflater inflater, android.view.ViewGroup parent, android.os.Bundle savedInstanceState) {
        android.support.v7.widget.RecyclerView recyclerView = ((android.support.v7.widget.RecyclerView) (inflater.inflate(R.layout.preference_recyclerview, parent, false)));
    ...
    public void onDisplayPreferenceDialog(android.support.v7.preference.Preference preference) {
        boolean handled = false;
        if (getCallbackFragment() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceDisplayDialogCallback) {
            handled = ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceDisplayDialogCallback) (getCallbackFragment())).onPreferenceDisplayDialog(this, preference);
        }
        if ((!handled) && (getActivity() instanceof android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceDisplayDialogCallback)) {
            handled = ((android.support.v7.preference.PreferenceFragmentCompat.OnPreferenceDisplayDialogCallback) (getActivity())).onPreferenceDisplayDialog(this, preference);
        }
        if (handled) {
            return;
        }
        // check if dialog is already showing
        if (getFragmentManager().findFragmentByTag(android.support.v7.preference.PreferenceFragmentCompat.DIALOG_FRAGMENT_TAG) != null) {
            return;
        }
        final android.support.v4.app.DialogFragment f;
        if (preference instanceof android.support.v7.preference.EditTextPreference) {
            f = android.support.v7.preference.EditTextPreferenceDialogFragmentCompat.newInstance(preference.getKey());
        } else
            if (preference instanceof android.support.v7.preference.ListPreference) {
                f = android.support.v7.preference.ListPreferenceDialogFragmentCompat.newInstance(preference.getKey());
            } else
                if (preference instanceof android.support.v7.preference.internal.AbstractMultiSelectListPreference) {
                    f = android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.newInstance(preference.getKey());
                } else {
        ...
        f.show(getFragmentManager(), android.support.v7.preference.PreferenceFragmentCompat.DIALOG_FRAGMENT_TAG);
    }
     ...
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    public android.support.v4.app.Fragment getCallbackFragment() {
        return null;
    }
        ...
        final java.lang.Runnable r = new java.lang.Runnable() {
            ...
            public void run() {
                ...
                if (position != android.support.v7.widget.RecyclerView.NO_POSITION) {
                    ...
                    adapter.registerAdapterDataObserver(new android.support.v7.preference.PreferenceFragmentCompat.ScrollToPreferenceObserver(adapter, mList, preference, key));
                }
            }
        };
        if (mList == null) {
