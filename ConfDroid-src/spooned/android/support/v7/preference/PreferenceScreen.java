...
public final class PreferenceScreen extends android.support.v7.preference.PreferenceGroup {
    ...
    public PreferenceScreen(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs, android.support.v4.content.res.TypedArrayUtils.getAttr(context, R.attr.preferenceScreenStyle, android.R.attr.preferenceScreenStyle));
    }
    ...
    protected void onClick() {
        ...
        final android.support.v7.preference.PreferenceManager.OnNavigateToScreenListener listener = getPreferenceManager().getOnNavigateToScreenListener();
        if (listener != null) {
     ...
     *
     * @param shouldUseGeneratedIds
     * 		{@code true} if the adapter should use the preference ID as a
