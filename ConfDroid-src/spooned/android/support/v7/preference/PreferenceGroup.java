 ...
 * </div>
 *
 * @unknown name android:orderingFromXml
 */
public abstract class PreferenceGroup extends android.support.v7.preference.Preference {
    ...
    private final android.support.v4.util.SimpleArrayMap<java.lang.String, java.lang.Long> mIdRecycleCache = new android.support.v4.util.SimpleArrayMap<>();

    private final android.os.Handler mHandler = new android.os.Handler();

    private final java.lang.Runnable mClearRecycleCacheRunnable = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            synchronized(this) {
    ...
    public PreferenceGroup(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PreferenceGroup, defStyleAttr, defStyleRes);
        mOrderingAsAdded = android.support.v4.content.res.TypedArrayUtils.getBoolean(a, R.styleable.PreferenceGroup_orderingFromXml, R.styleable.PreferenceGroup_orderingFromXml, true);
        a.recycle();
    }
     ...
     */
    public void addItemFromInflater(android.support.v7.preference.Preference preference) {
     ...
     *
     * @param index
     * 		The index of the {@link Preference} to retrieve.
     * @return The {@link Preference}.
     */
    public android.support.v7.preference.Preference getPreference(int index) {
    ...
    public boolean addPreference(android.support.v7.preference.Preference preference) {
        ...
        if (preference.getOrder() == android.support.v7.preference.Preference.DEFAULT_ORDER) {
            if (mOrderingAsAdded) {
            ...
            if (preference instanceof android.support.v7.preference.PreferenceGroup) {
                ...
                ((android.support.v7.preference.PreferenceGroup) (preference)).setOrderingAsAdded(mOrderingAsAdded);
            }
        }
        int insertionIndex = java.util.Collections.binarySearch(mPreferenceList, preference);
        if (insertionIndex < 0) {
        ...
        final android.support.v7.preference.PreferenceManager preferenceManager = getPreferenceManager();
    ...
    private boolean removePreferenceInt(android.support.v7.preference.Preference preference) {
        synchronized(this) {
    ...
    public void removeAll() {
        synchronized(this) {
            java.util.List<android.support.v7.preference.Preference> preferenceList = mPreferenceList;
    ...
    public android.support.v7.preference.Preference findPreference(java.lang.CharSequence key) {
        if (android.text.TextUtils.equals(getKey(), key)) {
            return this;
        }
        final int preferenceCount = getPreferenceCount();
        for (int i = 0; i < preferenceCount; i++) {
            final android.support.v7.preference.Preference preference = getPreference(i);
            final java.lang.String curKey = preference.getKey();
            if ((curKey != null) && curKey.equals(key)) {
                return preference;
            }
            if (preference instanceof android.support.v7.preference.PreferenceGroup) {
                final android.support.v7.preference.Preference returnedPreference = ((android.support.v7.preference.PreferenceGroup) (preference)).findPreference(key);
    ...
    void sortPreferences() {
        synchronized(this) {
            java.util.Collections.sort(mPreferenceList);
        }
    }
    ...
    public interface PreferencePositionCallback {
         ...
         *
         * @param key
         * 		Key of {@link Preference} to find
         * @return Adapter position of the {@link Preference} or
        {@link android.support.v7.widget.RecyclerView#NO_POSITION} if not found
         */
        int getPreferenceAdapterPosition(java.lang.String key);

        /**
         * Return the adapter position of the specified {@link Preference} object
         *
         * @param preference
         * 		{@link Preference} object to find
         * @return Adapter position of the {@link Preference} or
        {@link android.support.v7.widget.RecyclerView#NO_POSITION} if not found
         */
        int getPreferenceAdapterPosition(android.support.v7.preference.Preference preference);
    }
}
