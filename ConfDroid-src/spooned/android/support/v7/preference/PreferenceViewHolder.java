...
public class PreferenceViewHolder extends android.support.v7.widget.RecyclerView.ViewHolder {
    private final android.util.SparseArray<android.view.View> mCachedViews = new android.util.SparseArray<>(4);
    ...
    /* package */
    PreferenceViewHolder(android.view.View itemView) {
        super(itemView);
        ...
        mCachedViews.put(android.support.v7.preference.AndroidResources.ANDROID_R_ICON_FRAME, itemView.findViewById(android.support.v7.preference.AndroidResources.ANDROID_R_ICON_FRAME));
    }
    ...
    int id) {
        final android.view.View cachedView = mCachedViews.get(id);
        if (cachedView != null) {
            return cachedView;
        } else {
            final android.view.View v = itemView.findViewById(id);
            if (v != null) {
