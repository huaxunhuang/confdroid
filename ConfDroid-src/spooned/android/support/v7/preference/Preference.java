 ...
 * @unknown name android:key
 * @unknown name android:title
 * @unknown name android:summary
 * @unknown name android:order
 * @unknown name android:fragment
 * @unknown name android:layout
 * @unknown name android:widgetLayout
 * @unknown name android:enabled
 * @unknown name android:selectable
 * @unknown name android:dependency
 * @unknown name android:persistent
 * @unknown name android:defaultValue
 * @unknown name android:shouldDisableView
 */
public class Preference implements java.lang.Comparable<android.support.v7.preference.Preference> {
    /**
    ...
    private android.support.v7.preference.Preference.OnPreferenceChangeListener mOnChangeListener;

    private android.support.v7.preference.Preference.OnPreferenceClickListener mOnClickListener;

    private int mOrder = android.support.v7.preference.Preference.DEFAULT_ORDER;
    ...
    private android.support.v7.preference.Preference.OnPreferenceChangeInternalListener mListener;

    private java.util.List<android.support.v7.preference.Preference> mDependents;
    ...
    public interface OnPreferenceChangeListener {
         ...
         */
        boolean onPreferenceChange(android.support.v7.preference.Preference preference, java.lang.Object newValue);
    }
    ...
    public interface OnPreferenceClickListener {
         ...
         */
        boolean onPreferenceClick(android.support.v7.preference.Preference preference);
    }
    ...
    interface OnPreferenceChangeInternalListener {
         ...
         * 		This preference.
         */
        void onPreferenceChange(android.support.v7.preference.Preference preference);
         ...
         * 		This Preference.
         */
        void onPreferenceHierarchyChange(android.support.v7.preference.Preference preference);
         ...
         * 		This Preference.
         */
        void onPreferenceVisibilityChange(android.support.v7.preference.Preference preference);
    }
    ...
    public Preference(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        mContext = context;
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Preference, defStyleAttr, defStyleRes);
        mIconResId = android.support.v4.content.res.TypedArrayUtils.getResourceId(a, R.styleable.Preference_icon, R.styleable.Preference_android_icon, 0);
        mKey = android.support.v4.content.res.TypedArrayUtils.getString(a, R.styleable.Preference_key, R.styleable.Preference_android_key);
        mTitle = android.support.v4.content.res.TypedArrayUtils.getString(a, R.styleable.Preference_title, R.styleable.Preference_android_title);
        ...
        mOrder = android.support.v4.content.res.TypedArrayUtils.getInt(a, R.styleable.Preference_order, R.styleable.Preference_android_order, android.support.v7.preference.Preference.DEFAULT_ORDER);
        mFragment = android.support.v4.content.res.TypedArrayUtils.getString(a, R.styleable.Preference_fragment, R.styleable.Preference_android_fragment);
        mLayoutResId = android.support.v4.content.res.TypedArrayUtils.getResourceId(a, R.styleable.Preference_layout, R.styleable.Preference_android_layout, R.layout.preference);
        mWidgetLayoutResId = android.support.v4.content.res.TypedArrayUtils.getResourceId(a, R.styleable.Preference_widgetLayout, R.styleable.Preference_android_widgetLayout, 0);
        mEnabled = android.support.v4.content.res.TypedArrayUtils.getBoolean(a, R.styleable.Preference_enabled, R.styleable.Preference_android_enabled, true);
        mSelectable = android.support.v4.content.res.TypedArrayUtils.getBoolean(a, R.styleable.Preference_selectable, R.styleable.Preference_android_selectable, true);
        mPersistent = android.support.v4.content.res.TypedArrayUtils.getBoolean(a, R.styleable.Preference_persistent, R.styleable.Preference_android_persistent, true);
        mDependencyKey = android.support.v4.content.res.TypedArrayUtils.getString(a, R.styleable.Preference_dependency, R.styleable.Preference_android_dependency);
        ...
        mShouldDisableView = android.support.v4.content.res.TypedArrayUtils.getBoolean(a, R.styleable.Preference_shouldDisableView, R.styleable.Preference_android_shouldDisableView, true);
        a.recycle();
    }
    ...
    public Preference(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, android.support.v4.content.res.TypedArrayUtils.getAttr(context, R.attr.preferenceStyle, android.R.attr.preferenceStyle));
    }
    ...
    public void onBindViewHolder(android.support.v7.preference.PreferenceViewHolder holder) {
        ...
        final android.widget.TextView titleView = ((android.widget.TextView) (holder.findViewById(android.R.id.title)));
        if (titleView != null) {
        ...
        final android.widget.TextView summaryView = ((android.widget.TextView) (holder.findViewById(android.R.id.summary)));
        if (summaryView != null) {
        ...
        final android.widget.ImageView imageView = ((android.widget.ImageView) (holder.findViewById(android.R.id.icon)));
        if (imageView != null) {
            if ((mIconResId != 0) || (mIcon != null)) {
                if (mIcon == null) {
                    mIcon = android.support.v4.content.ContextCompat.getDrawable(getContext(), mIconResId);
                }
                if (mIcon != null) {
                    imageView.setImageDrawable(mIcon);
                }
            }
            imageView.setVisibility(mIcon != null ? android.view.View.VISIBLE : android.view.View.GONE);
        }
        android.view.View imageFrame = holder.findViewById(R.id.icon_frame);
        if (imageFrame == null) {
            imageFrame = holder.findViewById(android.support.v7.preference.AndroidResources.ANDROID_R_ICON_FRAME);
        }
        if (imageFrame != null) {
            imageFrame.setVisibility(mIcon != null ? android.view.View.VISIBLE : android.view.View.GONE);
        }
    ...
    public void setIcon(int iconResId) {
        setIcon(android.support.v4.content.ContextCompat.getDrawable(mContext, iconResId));
     ...
     *
     * @param visible
     * 		Set false if this preference should be hidden from the list.
     */
     ...
     */
    public void setOnPreferenceChangeListener(android.support.v7.preference.Preference.OnPreferenceChangeListener onPreferenceChangeListener) {
     ...
     */
    public android.support.v7.preference.Preference.OnPreferenceChangeListener getOnPreferenceChangeListener() {
     ...
     * 		The callback to be invoked.
     */
    public void setOnPreferenceClickListener(android.support.v7.preference.Preference.OnPreferenceClickListener onPreferenceClickListener) {
     ...
     * @return The callback to be invoked.
     */
    public android.support.v7.preference.Preference.OnPreferenceClickListener getOnPreferenceClickListener() {
    ...
    public void performClick() {
        ...
        if (preferenceManager != null) {
            android.support.v7.preference.PreferenceManager.OnPreferenceTreeClickListener listener = preferenceManager.getOnPreferenceTreeClickListener();
    ...
    android.support.v7.preference.Preference another) {
     ...
     * @see #notifyChanged()
     */
    final void setOnPreferenceChangeInternalListener(android.support.v7.preference.Preference.OnPreferenceChangeInternalListener listener) {
        mListener = listener;
    }
     ...
     */
    protected void onAttachedToHierarchy(android.support.v7.preference.PreferenceManager preferenceManager) {
     ...
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    protected void onAttachedToHierarchy(android.support.v7.preference.PreferenceManager preferenceManager, long id) {
        mId = id;
        mHasId = true;
        try {
    ...
    private void registerDependency() {
        ...
        android.support.v7.preference.Preference preference = findPreferenceInHierarchy(mDependencyKey);
        if (preference != null) {
    ...
    private void unregisterDependency() {
        if (mDependencyKey != null) {
            final android.support.v7.preference.Preference oldDependency = findPreferenceInHierarchy(mDependencyKey);
     ...
     */
    protected android.support.v7.preference.Preference findPreferenceInHierarchy(java.lang.String key) {
     ...
     */
    private void registerDependent(android.support.v7.preference.Preference dependent) {
        if (mDependents == null) {
            mDependents = new java.util.ArrayList<android.support.v7.preference.Preference>();
        }
     ...
     */
    private void unregisterDependent(android.support.v7.preference.Preference dependent) {
        if (mDependents != null) {
    ...
    public void notifyDependencyChange(boolean disableDependents) {
        final java.util.List<android.support.v7.preference.Preference> dependents = mDependents;
        if (dependents == null) {
            return;
        }
     ...
     */
    public void onDependencyChanged(android.support.v7.preference.Preference dependency, boolean disableDependent) {
     ...
     * 		Set true to disable this Preference.
     */
    public void onParentChanged(android.support.v7.preference.Preference parent, boolean disableChild) {
    ...
    private void tryCommit(@android.support.annotation.NonNull
    ...
    protected android.os.Parcelable onSaveInstanceState() {
        ...
        return android.support.v7.preference.Preference.BaseSavedState.EMPTY_STATE;
    }
    ...
    protected void onRestoreInstanceState(android.os.Parcelable state) {
        mBaseMethodCalled = true;
        if ((state != android.support.v7.preference.Preference.BaseSavedState.EMPTY_STATE) && (state != null)) {
    ...
    public static class BaseSavedState extends android.view.AbsSavedState {
        ...
        public static final android.os.Parcelable.Creator<android.support.v7.preference.Preference.BaseSavedState> CREATOR = new android.os.Parcelable.Creator<android.support.v7.preference.Preference.BaseSavedState>() {
            @java.lang.Override
            public android.support.v7.preference.Preference.BaseSavedState createFromParcel(android.os.Parcel in) {
                return new android.support.v7.preference.Preference.BaseSavedState(in);
            }

            @java.lang.Override
            public android.support.v7.preference.Preference.BaseSavedState[] newArray(int size) {
                return new android.support.v7.preference.Preference.BaseSavedState[size];
            }
        };
    }
}
