...
public class AndroidResources {
    ...
    public static final int ANDROID_R_PREFERENCE_FRAGMENT_STYLE = android.R.attr.preferenceFragmentStyle;

    public static final int ANDROID_R_EDITTEXT_PREFERENCE_STYLE = android.R.attr.editTextPreferenceStyle;
}
