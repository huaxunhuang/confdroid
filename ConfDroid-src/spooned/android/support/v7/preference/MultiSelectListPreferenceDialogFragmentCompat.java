...
public class MultiSelectListPreferenceDialogFragmentCompat extends android.support.v7.preference.PreferenceDialogFragmentCompat {
    ...
    public static android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat newInstance(java.lang.String key) {
        final android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat fragment = new android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat();
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mNewValues.clear();
            mNewValues.addAll(savedInstanceState.getStringArrayList(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_VALUES));
            mPreferenceChanged = savedInstanceState.getBoolean(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_CHANGED, false);
            mEntries = savedInstanceState.getCharSequenceArray(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_ENTRIES);
            mEntryValues = savedInstanceState.getCharSequenceArray(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_ENTRY_VALUES);
        }
    }
    ...
    android.os.Bundle outState) {
        ...
        outState.putStringArrayList(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_VALUES, new java.util.ArrayList<>(mNewValues));
        outState.putBoolean(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_CHANGED, mPreferenceChanged);
        outState.putCharSequenceArray(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_ENTRIES, mEntries);
        outState.putCharSequenceArray(android.support.v7.preference.MultiSelectListPreferenceDialogFragmentCompat.SAVE_STATE_ENTRY_VALUES, mEntryValues);
    }
