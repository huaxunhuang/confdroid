...
final class GrowingArrayUtils {
    ...
    public static <T> T[] append(T[] array, int currentSize, T element) {
        ...
        if ((currentSize + 1) > array.length) {
            T[] newArray = ((T[]) (java.lang.reflect.Array.newInstance(array.getClass().getComponentType(), android.support.v7.content.res.GrowingArrayUtils.growSize(currentSize))));
    ...
    public static int[] append(int[] array, int currentSize, int element) {
        assert currentSize <= array.length;
        if ((currentSize + 1) > array.length) {
            int[] newArray = new int[android.support.v7.content.res.GrowingArrayUtils.growSize(currentSize)];
            java.lang.System.arraycopy(array, 0, newArray, 0, currentSize);
            array = newArray;
        }
        array[currentSize] = element;
    ...
    public static long[] append(long[] array, int currentSize, long element) {
        assert currentSize <= array.length;
        if ((currentSize + 1) > array.length) {
            long[] newArray = new long[android.support.v7.content.res.GrowingArrayUtils.growSize(currentSize)];
            java.lang.System.arraycopy(array, 0, newArray, 0, currentSize);
            array = newArray;
        }
        array[currentSize] = element;
    ...
    public static boolean[] append(boolean[] array, int currentSize, boolean element) {
        assert currentSize <= array.length;
        if ((currentSize + 1) > array.length) {
            boolean[] newArray = new boolean[android.support.v7.content.res.GrowingArrayUtils.growSize(currentSize)];
            java.lang.System.arraycopy(array, 0, newArray, 0, currentSize);
            array = newArray;
        }
        array[currentSize] = element;
     ...
     *
     * @param array
     * 		The array to which to append the element. Must NOT be null.
     * @param currentSize
     * 		The number of elements in the array. Must be less than or equal to
     * 		array.length.
     * @param element
    ...
    public static <T> T[] insert(T[] array, int currentSize, int index, T element) {
        assert currentSize <= array.length;
        if ((currentSize + 1) <= array.length) {
            java.lang.System.arraycopy(array, index, array, index + 1, currentSize - index);
            array[index] = element;
            return array;
        }
        T[] newArray = ((T[]) (java.lang.reflect.Array.newInstance(array.getClass().getComponentType(), android.support.v7.content.res.GrowingArrayUtils.growSize(currentSize))));
