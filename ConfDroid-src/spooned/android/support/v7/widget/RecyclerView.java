 ...
 *
 * @unknown ref android.support.v7.recyclerview.R.styleable#RecyclerView_layoutManager
 */
public class RecyclerView extends android.view.ViewGroup implements android.support.v4.view.NestedScrollingChild , android.support.v4.view.ScrollingView {
    ...
    private static final int[] NESTED_SCROLLING_ATTRS = new int[]{ 16843830/* android.R.attr.nestedScrollingEnabled */
     };

    private static final int[] CLIP_TO_PADDING_ATTR = new int[]{ android.R.attr.clipToPadding };
     ...
     * this criteria.
     */
    static final boolean FORCE_INVALIDATE_DISPLAY_LIST = ((android.os.Build.VERSION.SDK_INT == 18) || (android.os.Build.VERSION.SDK_INT == 19)) || (android.os.Build.VERSION.SDK_INT == 20);
     ...
     */
    static final boolean ALLOW_SIZE_IN_UNSPECIFIED_SPEC = android.os.Build.VERSION.SDK_INT >= 23;

    static final boolean POST_UPDATES_ON_ANIMATION = android.os.Build.VERSION.SDK_INT >= 16;
     ...
     */
    private static final boolean ALLOW_PREFETCHING = android.os.Build.VERSION.SDK_INT >= 21;
     ...
     */
    private static final java.lang.String TRACE_PREFETCH_TAG = "RV Prefetch";
    ...
    private static final java.lang.Class<?>[] LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE = new java.lang.Class[]{ android.content.Context.class, android.util.AttributeSet.class, int.class, int.class };

    private final android.support.v7.widget.RecyclerView.RecyclerViewDataObserver mObserver = new android.support.v7.widget.RecyclerView.RecyclerViewDataObserver();

    final android.support.v7.widget.RecyclerView.Recycler mRecycler = new android.support.v7.widget.RecyclerView.Recycler();
     ...
     */
    final android.support.v7.widget.ViewInfoStore mViewInfoStore = new android.support.v7.widget.ViewInfoStore();
     ...
     * 3) We're attached
     */
    final java.lang.Runnable mUpdateChildViewsRunnable = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
    ...
    final android.graphics.RectF mTempRectF = new android.graphics.RectF();
    ...
    final java.util.ArrayList<android.support.v7.widget.RecyclerView.ItemDecoration> mItemDecorations = new java.util.ArrayList<>();

    private final java.util.ArrayList<android.support.v7.widget.RecyclerView.OnItemTouchListener> mOnItemTouchListeners = new java.util.ArrayList<>();
    ...
    android.support.v7.widget.RecyclerView.ItemAnimator mItemAnimator = new android.support.v7.widget.DefaultItemAnimator();
    ...
    private int mScrollState = android.support.v7.widget.RecyclerView.SCROLL_STATE_IDLE;

    private int mScrollPointerId = android.support.v7.widget.RecyclerView.INVALID_POINTER;
    ...
    private float mScrollFactor = java.lang.Float.MIN_VALUE;

    private boolean mPreserveFocusAfterLayout = true;

    final android.support.v7.widget.RecyclerView.ViewFlinger mViewFlinger = new android.support.v7.widget.RecyclerView.ViewFlinger();

    private static final long MIN_PREFETCH_TIME_NANOS = java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(4);

    static long sFrameIntervalNanos = 0;

    android.support.v7.widget.RecyclerView.ViewPrefetcher mViewPrefetcher = (android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING) ? new android.support.v7.widget.RecyclerView.ViewPrefetcher() : null;

    final android.support.v7.widget.RecyclerView.State mState = new android.support.v7.widget.RecyclerView.State();
    ...
    private android.support.v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener mItemAnimatorListener = new android.support.v7.widget.RecyclerView.ItemAnimatorRestoreListener();
     ...
     */
    private final java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> mPendingAccessibilityImportanceChange = new java.util.ArrayList();

    private java.lang.Runnable mItemAnimatorRunner = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
    ...
    static final android.view.animation.Interpolator sQuinticInterpolator = new android.view.animation.Interpolator() {
        @java.lang.Override
     ...
     */
    private final android.support.v7.widget.ViewInfoStore.ProcessCallback mViewInfoProcessCallback = new android.support.v7.widget.ViewInfoStore.ProcessCallback() {
        @java.lang.Override
        public void processDisappeared(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo info, @android.support.annotation.Nullable
        ...
        @java.lang.Override
        public void processAppeared(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo, android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo info) {
        ...
        @java.lang.Override
        public void unused(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    public RecyclerView(android.content.Context context, @android.support.annotation.Nullable
    ...
    android.util.AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, android.support.v7.widget.RecyclerView.CLIP_TO_PADDING_ATTR, defStyle, 0);
        ...
        setWillNotDraw(getOverScrollMode() == android.view.View.OVER_SCROLL_NEVER);
        ...
        mAccessibilityManager = ((android.view.accessibility.AccessibilityManager) (getContext().getSystemService(android.content.Context.ACCESSIBILITY_SERVICE)));
        setAccessibilityDelegateCompat(new android.support.v7.widget.RecyclerViewAccessibilityDelegate(this));
        // Create the layoutManager if specified.
        boolean nestedScrollingEnabled = true;
        if (attrs != null) {
            int defStyleRes = 0;
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerView, defStyle, defStyleRes);
            java.lang.String layoutManagerName = a.getString(R.styleable.RecyclerView_layoutManager);
            ...
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                a = context.obtainStyledAttributes(attrs, android.support.v7.widget.RecyclerView.NESTED_SCROLLING_ATTRS, defStyle, defStyleRes);
     ...
     */
    public void setAccessibilityDelegateCompat(android.support.v7.widget.RecyclerViewAccessibilityDelegate accessibilityDelegate) {
        mAccessibilityDelegate = accessibilityDelegate;
        android.support.v4.view.ViewCompat.setAccessibilityDelegate(this, mAccessibilityDelegate);
    }

    /**
     * Instantiate and set a LayoutManager, if specified in the attributes.
     */
    private void createLayoutManager(android.content.Context context, java.lang.String className, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        if (className != null) {
            className = className.trim();
            if (className.length() != 0) {
                // Can't use isEmpty since it was added in API 9.
                ...
                try {
                    ...
                    java.lang.Class<? extends android.support.v7.widget.RecyclerView.LayoutManager> layoutManagerClass = classLoader.loadClass(className).asSubclass(android.support.v7.widget.RecyclerView.LayoutManager.class);
                    java.lang.reflect.Constructor<? extends android.support.v7.widget.RecyclerView.LayoutManager> constructor;
                    java.lang.Object[] constructorArgs = null;
                    try {
                        constructor = layoutManagerClass.getConstructor(android.support.v7.widget.RecyclerView.LAYOUT_MANAGER_CONSTRUCTOR_SIGNATURE);
                        constructorArgs = new java.lang.Object[]{ context, attrs, defStyleAttr, defStyleRes };
                    } catch (java.lang.NoSuchMethodException e) {
                        try {
                            constructor = layoutManagerClass.getConstructor();
                        } catch (java.lang.NoSuchMethodException e1) {
                            e1.initCause(e);
                            throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Error creating LayoutManager ") + className, e1);
                        }
                    }
                    constructor.setAccessible(true);
                    setLayoutManager(constructor.newInstance(constructorArgs));
                } catch (java.lang.ClassNotFoundException e) {
                    throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Unable to find LayoutManager ") + className, e);
                } catch (java.lang.reflect.InvocationTargetException e) {
                    throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Could not instantiate the LayoutManager: ") + className, e);
                } catch (java.lang.InstantiationException e) {
                    throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Could not instantiate the LayoutManager: ") + className, e);
                } catch (java.lang.IllegalAccessException e) {
                    throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Cannot access non-public constructor ") + className, e);
                } catch (java.lang.ClassCastException e) {
                    throw new java.lang.IllegalStateException((attrs.getPositionDescription() + ": Class is not a LayoutManager ") + className, e);
                }
            }
        }
    }

    private java.lang.String getFullClassName(android.content.Context context, java.lang.String className) {
        ...
        return (android.support.v7.widget.RecyclerView.class.getPackage().getName() + '.') + className;
    }

    private void initChildrenHelper() {
        mChildHelper = new android.support.v7.widget.ChildHelper(new android.support.v7.widget.ChildHelper.Callback() {
            @java.lang.Override
            public int getChildCount() {
                return android.support.v7.widget.RecyclerView.this.getChildCount();
            }

            @java.lang.Override
            public void addView(android.view.View child, int index) {
                android.support.v7.widget.RecyclerView.this.addView(child, index);
                dispatchChildAttached(child);
            }

            @java.lang.Override
            public int indexOfChild(android.view.View view) {
                return android.support.v7.widget.RecyclerView.this.indexOfChild(view);
            }

            @java.lang.Override
            public void removeViewAt(int index) {
                final android.view.View child = android.support.v7.widget.RecyclerView.this.getChildAt(index);
                if (child != null) {
                    dispatchChildDetached(child);
                }
                android.support.v7.widget.RecyclerView.this.removeViewAt(index);
            }

            @java.lang.Override
            public android.view.View getChildAt(int offset) {
                return android.support.v7.widget.RecyclerView.this.getChildAt(offset);
            }
            ...
            public void removeAllViews() {
                ...
                android.support.v7.widget.RecyclerView.this.removeAllViews();
            }

            @java.lang.Override
            public android.support.v7.widget.RecyclerView.ViewHolder getChildViewHolder(android.view.View view) {
                return android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            }

            @java.lang.Override
            public void attachViewToParent(android.view.View child, int index, android.view.ViewGroup.LayoutParams layoutParams) {
                final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
                if (vh != null) {
                    if ((!vh.isTmpDetached()) && (!vh.shouldIgnore())) {
                        throw new java.lang.IllegalArgumentException(("Called attach on a child which is not" + " detached: ") + vh);
                    }
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "reAttach " + vh);
                    }
                    vh.clearTmpDetachFlag();
                }
                android.support.v7.widget.RecyclerView.this.attachViewToParent(child, index, layoutParams);
            }

            @java.lang.Override
            public void detachViewFromParent(int offset) {
                final android.view.View view = getChildAt(offset);
                if (view != null) {
                    final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
                    if (vh != null) {
                        if (vh.isTmpDetached() && (!vh.shouldIgnore())) {
                            throw new java.lang.IllegalArgumentException(("called detach on an already" + " detached child ") + vh);
                        }
                        if (android.support.v7.widget.RecyclerView.DEBUG) {
                            android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "tmpDetach " + vh);
                        }
                        vh.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_TMP_DETACHED);
                    }
                }
                android.support.v7.widget.RecyclerView.this.detachViewFromParent(offset);
            }

            @java.lang.Override
            public void onEnteredHiddenState(android.view.View child) {
                final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onEnteredHiddenState(android.support.v7.widget.RecyclerView.this);
                }
            }

            @java.lang.Override
            public void onLeftHiddenState(android.view.View child) {
                final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
                if (vh != null) {
                    vh.onLeftHiddenState(android.support.v7.widget.RecyclerView.this);
                }
            }
        });
    }
    ...
    void initAdapterManager() {
        mAdapterHelper = new android.support.v7.widget.AdapterHelper(new android.support.v7.widget.AdapterHelper.Callback() {
            ...
            public android.support.v7.widget.RecyclerView.ViewHolder findViewHolder(int position) {
                final android.support.v7.widget.RecyclerView.ViewHolder vh = findViewHolderForPosition(position, true);
                if (vh == null) {
                    return null;
                }
                ...
                if (mChildHelper.isHidden(vh.itemView)) {
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "assuming view holder cannot be find because it is hidden");
                    }
                    return null;
                }
                return vh;
            ...
            @java.lang.Override
            public void onDispatchFirstPass(android.support.v7.widget.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }

            void dispatchUpdate(android.support.v7.widget.AdapterHelper.UpdateOp op) {
                switch (op.cmd) {
                    case android.support.v7.widget.AdapterHelper.UpdateOp.ADD :
                        mLayout.onItemsAdded(android.support.v7.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case android.support.v7.widget.AdapterHelper.UpdateOp.REMOVE :
                        mLayout.onItemsRemoved(android.support.v7.widget.RecyclerView.this, op.positionStart, op.itemCount);
                        break;
                    case android.support.v7.widget.AdapterHelper.UpdateOp.UPDATE :
                        mLayout.onItemsUpdated(android.support.v7.widget.RecyclerView.this, op.positionStart, op.itemCount, op.payload);
                        break;
                    case android.support.v7.widget.AdapterHelper.UpdateOp.MOVE :
                        mLayout.onItemsMoved(android.support.v7.widget.RecyclerView.this, op.positionStart, op.itemCount, 1);
                        break;
                }
            }

            @java.lang.Override
            public void onDispatchSecondPass(android.support.v7.widget.AdapterHelper.UpdateOp op) {
                dispatchUpdate(op);
            }
     ...
     * @unknown name android:clipToPadding
     */
     ...
     *
     * @param slopConstant
     * 		One of the <code>TOUCH_SLOP_</code> constants representing
     * 		the intended usage of this RecyclerView
     */
    public void setScrollingTouchSlop(int slopConstant) {
        final android.view.ViewConfiguration vc = android.view.ViewConfiguration.get(getContext());
        switch (slopConstant) {
            default :
                android.util.Log.w(android.support.v7.widget.RecyclerView.TAG, ("setScrollingTouchSlop(): bad argument constant " + slopConstant) + "; using default value");
                // fall-through
            case android.support.v7.widget.RecyclerView.TOUCH_SLOP_DEFAULT :
                mTouchSlop = vc.getScaledTouchSlop();
                break;
            case android.support.v7.widget.RecyclerView.TOUCH_SLOP_PAGING :
     ...
     * 		invalidation).
     * @param removeAndRecycleViews
     * 		If true, we'll remove and recycle all existing views. If
     * 		compatibleWithPrevious is false, this parameter is ignored.
     */
    private void setAdapterInternal(android.support.v7.widget.RecyclerView.Adapter adapter, boolean compatibleWithPrevious, boolean removeAndRecycleViews) {
        if (mAdapter != null) {
        ...
        final android.support.v7.widget.RecyclerView.Adapter oldAdapter = mAdapter;
        mAdapter = adapter;
        if (adapter != null) {
    ...
    public void addOnChildAttachStateChangeListener(android.support.v7.widget.RecyclerView.OnChildAttachStateChangeListener listener) {
        if (mOnChildAttachStateListeners == null) {
            mOnChildAttachStateListeners = new java.util.ArrayList<>();
        }
    ...
    public void setLayoutManager(android.support.v7.widget.RecyclerView.LayoutManager layout) {
        ...
        if (layout != null) {
            if (layout.mRecyclerView != null) {
                throw new java.lang.IllegalArgumentException((("LayoutManager " + layout) + " is already attached to a RecyclerView: ") + layout.mRecyclerView);
            }
     ...
     * 		The {@link OnFlingListener} instance.
     */
    public void setOnFlingListener(@android.support.annotation.Nullable
    ...
    protected android.os.Parcelable onSaveInstanceState() {
        android.support.v7.widget.RecyclerView.SavedState state = new android.support.v7.widget.RecyclerView.SavedState(super.onSaveInstanceState());
    ...
    protected void onRestoreInstanceState(android.os.Parcelable state) {
        if (!(state instanceof android.support.v7.widget.RecyclerView.SavedState)) {
            super.onRestoreInstanceState(state);
            return;
        }
        mPendingSavedState = ((android.support.v7.widget.RecyclerView.SavedState) (state));
     ...
     */
    private void addAnimatingView(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    boolean removeAnimatingView(android.view.View view) {
        ...
        if (removed) {
            final android.support.v7.widget.RecyclerView.ViewHolder viewHolder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            mRecycler.unscrapView(viewHolder);
            mRecycler.recycleViewHolderInternal(viewHolder);
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("after removing animated view: " + view) + ", ") + this);
            }
        }
    ...
    void setScrollState(int state) {
        ...
        if (android.support.v7.widget.RecyclerView.DEBUG) {
            android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("setting scroll state to " + state) + " from ") + mScrollState, new java.lang.Exception());
        }
        mScrollState = state;
     ...
     *
     * @param childDrawingOrderCallback
    ...
    public void addOnScrollListener(android.support.v7.widget.RecyclerView.OnScrollListener listener) {
        if (mScrollListeners == null) {
            mScrollListeners = new java.util.ArrayList<>();
        }
    ...
    public void scrollToPosition(int position) {
        ...
        stopScroll();
        if (mLayout == null) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "Cannot scroll to position a LayoutManager set. " + "Call setLayoutManager with a non-null argument.");
            return;
        }
    ...
    public void scrollTo(int x, int y) {
        android.util.Log.w(android.support.v7.widget.RecyclerView.TAG, "RecyclerView does not support scrolling to an absolute position. " + "Use scrollToPosition instead");
    }

    @java.lang.Override
    public void scrollBy(int x, int y) {
        if (mLayout == null) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "Cannot scroll without a LayoutManager set. " + "Call setLayoutManager with a non-null argument.");
            return;
        }
        if (mLayoutFrozen) {
            return;
    ...
    void consumePendingUpdateOperations() {
        if ((!mFirstLayoutComplete) || mDataSetHasChangedAfterLayout) {
            android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_ON_DATA_SET_CHANGE_LAYOUT_TAG);
            dispatchLayout();
        ...
        if (mAdapterHelper.hasAnyUpdateTypes(android.support.v7.widget.AdapterHelper.UpdateOp.UPDATE) && (!mAdapterHelper.hasAnyUpdateTypes((android.support.v7.widget.AdapterHelper.UpdateOp.ADD | android.support.v7.widget.AdapterHelper.UpdateOp.REMOVE) | android.support.v7.widget.AdapterHelper.UpdateOp.MOVE))) {
            android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_HANDLE_ADAPTER_UPDATES_TAG);
            eatRequestLayout();
    ...
    private boolean hasUpdatedView() {
        ...
        for (int i = 0; i < childCount; i++) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getChildAt(i));
     ...
     * @param ev
     * 		The originating MotionEvent, or null if not from a touch event.
     * @return Whether any scroll was consumed in either direction.
     */
    boolean scrollByInternal(int x, int y, android.view.MotionEvent ev) {
        int unconsumedX = 0;
        int unconsumedY = 0;
        int consumedX = 0;
        int consumedY = 0;
        ...
        if (mAdapter != null) {
            eatRequestLayout();
            onEnterLayoutOrScroll();
            android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_SCROLL_TAG);
            if (x != 0) {
    ...
    void resumeRequestLayout(boolean performLayoutChildren) {
        if (mEatRequestLayout < 1) {
            ...
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                throw new java.lang.IllegalStateException("invalid eat request layout count");
            }
            mEatRequestLayout = 1;
        }
     ...
     *
     * <p>
     * <code>setLayoutFrozen(true)</code> does not prevent app from directly calling {@link LayoutManager#scrollToPosition(int)}, {@link LayoutManager#smoothScrollToPosition(
    ...
    public void setLayoutFrozen(boolean frozen) {
        if (frozen != mLayoutFrozen) {
            ...
            if (!frozen) {
                ...
                android.view.MotionEvent cancelEvent = android.view.MotionEvent.obtain(now, now, android.view.MotionEvent.ACTION_CANCEL, 0.0F, 0.0F, 0);
    ...
    public boolean fling(int velocityX, int velocityY) {
        if (mLayout == null) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "Cannot fling without a LayoutManager set. " + "Call setLayoutManager with a non-null argument.");
            return false;
        }
        if (mLayoutFrozen) {
            return false;
        ...
        final boolean canScrollHorizontal = mLayout.canScrollHorizontally();
        final boolean canScrollVertical = mLayout.canScrollVertically();
        if ((!canScrollHorizontal) || (java.lang.Math.abs(velocityX) < mMinFlingVelocity)) {
            velocityX = 0;
        }
        if ((!canScrollVertical) || (java.lang.Math.abs(velocityY) < mMinFlingVelocity)) {
            velocityY = 0;
        }
        ...
        if (!dispatchNestedPreFling(velocityX, velocityY)) {
            ...
            if (canScroll) {
                velocityX = java.lang.Math.max(-mMaxFlingVelocity, java.lang.Math.min(velocityX, mMaxFlingVelocity));
                velocityY = java.lang.Math.max(-mMaxFlingVelocity, java.lang.Math.min(velocityY, mMaxFlingVelocity));
    ...
    public void stopScroll() {
        setScrollState(android.support.v7.widget.RecyclerView.SCROLL_STATE_IDLE);
        stopScrollersInternal();
    }
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        ...
        if (overscrollX < 0) {
            ensureLeftGlow();
            if (mLeftGlow.onPull((-overscrollX) / getWidth(), 1.0F - (y / getHeight()))) {
                invalidate = true;
            }
        } else
            if (overscrollX > 0) {
        ...
        if (overscrollY < 0) {
            ...
            if (overscrollY > 0) {
                ensureBottomGlow();
                if (mBottomGlow.onPull(overscrollY / getHeight(), 1.0F - (x / getWidth()))) {
                    invalidate = true;
                }
            }
    ...
    void ensureLeftGlow() {
        ...
        mLeftGlow = new android.support.v4.widget.EdgeEffectCompat(getContext());
        if (mClipToPadding) {
    ...
    void ensureRightGlow() {
        ...
        mRightGlow = new android.support.v4.widget.EdgeEffectCompat(getContext());
        if (mClipToPadding) {
    ...
    void ensureTopGlow() {
        ...
        mTopGlow = new android.support.v4.widget.EdgeEffectCompat(getContext());
        if (mClipToPadding) {
    ...
    void ensureBottomGlow() {
        ...
        mBottomGlow = new android.support.v4.widget.EdgeEffectCompat(getContext());
        if (mClipToPadding) {
    ...
    public android.view.View focusSearch(android.view.View focused, int direction) {
        android.view.View result = mLayout.onInterceptFocusSearch(focused, direction);
        if (result != null) {
            return result;
        }
        ...
        if (canRunFocusFailure && ((direction == android.view.View.FOCUS_FORWARD) || (direction == android.view.View.FOCUS_BACKWARD))) {
            ...
            if (mLayout.canScrollVertically()) {
                ...
                final android.view.View found = ff.findNextFocus(this, focused, absDir);
                needsFocusFailureLayout = found == null;
            }
            if ((!needsFocusFailureLayout) && mLayout.canScrollHorizontally()) {
                boolean rtl = mLayout.getLayoutDirection() == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL;
            ...
            if (needsFocusFailureLayout) {
                consumePendingUpdateOperations();
                final android.view.View focusedItemView = findContainingItemView(focused);
     ...
     */
    private boolean isPreferredNextFocus(android.view.View focused, android.view.View next, int direction) {
        ...
        if ((direction == android.view.View.FOCUS_FORWARD) || (direction == android.view.View.FOCUS_BACKWARD)) {
            final boolean rtl = mLayout.getLayoutDirection() == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL;
            final int absHorizontal = ((direction == android.view.View.FOCUS_FORWARD) ^ rtl) ? android.view.View.FOCUS_RIGHT : android.view.View.FOCUS_LEFT;
            if (isPreferredNextFocusAbsolute(focused, next, absHorizontal)) {
                return true;
            }
            if (direction == android.view.View.FOCUS_FORWARD) {
                return isPreferredNextFocusAbsolute(focused, next, android.view.View.FOCUS_DOWN);
            } else {
                return isPreferredNextFocusAbsolute(focused, next, android.view.View.FOCUS_UP);
            }
        } else {
     ...
     */
    private boolean isPreferredNextFocusAbsolute(android.view.View focused, android.view.View next, int direction) {
        ...
        throw new java.lang.IllegalArgumentException("direction must be absolute. received:" + direction);
    }
    ...
    public void requestChildFocus(android.view.View child, android.view.View focused) {
        if ((!mLayout.onRequestChildFocus(this, mState, child, focused)) && (focused != null)) {
            ...
            // View in viewport.
            final android.view.ViewGroup.LayoutParams focusedLayoutParams = focused.getLayoutParams();
            if (focusedLayoutParams instanceof android.support.v7.widget.RecyclerView.LayoutParams) {
                // if focused child has item decors, use them. Otherwise, ignore.
                final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (focusedLayoutParams));
                if (!lp.mInsetsDirty) {
                    final android.graphics.Rect insets = lp.mDecorInsets;
    ...
    protected void onAttachedToWindow() {
        ...
        mPostedAnimatorRunner = false;
        if (android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING && (android.support.v7.widget.RecyclerView.sFrameIntervalNanos == 0)) {
            ...
            android.support.v7.widget.RecyclerView.sFrameIntervalNanos = ((long) (1000000000 / refreshRate));
        }
    }
     ...
     * @see #assertNotInLayoutOrScroll(String)
     */
    void assertInLayoutOrScroll(java.lang.String message) {
        if (!isComputingLayout()) {
            if (message == null) {
     ...
     * @see #assertInLayoutOrScroll(String)
     */
    void assertNotInLayoutOrScroll(java.lang.String message) {
        if (isComputingLayout()) {
            if (message == null) {
        ...
        if (mDispatchScrollCounter > 0) {
            android.util.Log.w(android.support.v7.widget.RecyclerView.TAG, "Cannot call this method in a scroll callback. Scroll callbacks might be run" + ((" during a measure & layout pass where you cannot change the RecyclerView" + " data. Any method call that might change the structure of the RecyclerView") + " or the adapter contents should be postponed to the next frame."), new java.lang.IllegalStateException(""));
        }
    }
    ...
    private boolean dispatchOnItemTouchIntercept(android.view.MotionEvent e) {
        final int action = e.getAction();
        if ((action == android.view.MotionEvent.ACTION_CANCEL) || (action == android.view.MotionEvent.ACTION_DOWN)) {
            mActiveOnItemTouchListener = null;
        }
        final int listenerCount = mOnItemTouchListeners.size();
        for (int i = 0; i < listenerCount; i++) {
            final android.support.v7.widget.RecyclerView.OnItemTouchListener listener = mOnItemTouchListeners.get(i);
            if (listener.onInterceptTouchEvent(this, e) && (action != android.view.MotionEvent.ACTION_CANCEL)) {
    ...
    private boolean dispatchOnItemTouch(android.view.MotionEvent e) {
        final int action = e.getAction();
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent e) {
        ...
        switch (action) {
            case android.view.MotionEvent.ACTION_DOWN :
                ...
                if (mScrollState == android.support.v7.widget.RecyclerView.SCROLL_STATE_SETTLING) {
                    getParent().requestDisallowInterceptTouchEvent(true);
                    setScrollState(android.support.v7.widget.RecyclerView.SCROLL_STATE_DRAGGING);
                }
                // Clear the nested offsets
                mNestedOffsets[0] = mNestedOffsets[1] = 0;
                int nestedScrollAxis = android.support.v4.view.ViewCompat.SCROLL_AXIS_NONE;
                if (canScrollHorizontally) {
                    nestedScrollAxis |= android.support.v4.view.ViewCompat.SCROLL_AXIS_HORIZONTAL;
                }
                if (canScrollVertically) {
                    nestedScrollAxis |= android.support.v4.view.ViewCompat.SCROLL_AXIS_VERTICAL;
                }
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                {
                    ...
                    if (index < 0) {
                        android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, ("Error processing scroll; pointer index for id " + mScrollPointerId) + " not found. Did any MotionEvents get skipped?");
                        return false;
                    }
                    final int x = ((int) (e.getX(index) + 0.5F));
                    final int y = ((int) (e.getY(index) + 0.5F));
                    if (mScrollState != android.support.v7.widget.RecyclerView.SCROLL_STATE_DRAGGING) {
                        final int dx = x - mInitialTouchX;
                        final int dy = y - mInitialTouchY;
                        boolean startScroll = false;
                        if (canScrollHorizontally && (java.lang.Math.abs(dx) > mTouchSlop)) {
                            mLastTouchX = mInitialTouchX + (mTouchSlop * (dx < 0 ? -1 : 1));
                            startScroll = true;
                        }
                        if (canScrollVertically && (java.lang.Math.abs(dy) > mTouchSlop)) {
        ...
        return mScrollState == android.support.v7.widget.RecyclerView.SCROLL_STATE_DRAGGING;
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent e) {
        ...
        final android.view.MotionEvent vtev = android.view.MotionEvent.obtain(e);
        final int action = android.support.v4.view.MotionEventCompat.getActionMasked(e);
        final int actionIndex = android.support.v4.view.MotionEventCompat.getActionIndex(e);
        if (action == android.view.MotionEvent.ACTION_DOWN) {
            mNestedOffsets[0] = mNestedOffsets[1] = 0;
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                {
                    ...
                    if (mScrollState == android.support.v7.widget.RecyclerView.SCROLL_STATE_DRAGGING) {
                        ...
                        if (android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING) {
            ...
            case android.view.MotionEvent.ACTION_UP :
                {
                    ...
                    final float xvel = (canScrollHorizontally) ? -android.support.v4.view.VelocityTrackerCompat.getXVelocity(mVelocityTracker, mScrollPointerId) : 0;
                    final float yvel = (canScrollVertically) ? -android.support.v4.view.VelocityTrackerCompat.getYVelocity(mVelocityTracker, mScrollPointerId) : 0;
    ...
    private void onPointerUp(android.view.MotionEvent e) {
        final int actionIndex = android.support.v4.view.MotionEventCompat.getActionIndex(e);
    ...
    public boolean onGenericMotionEvent(android.view.MotionEvent event) {
        ...
        if ((event.getSource() & android.support.v4.view.InputDeviceCompat.SOURCE_CLASS_POINTER) != 0) {
            if (event.getAction() == android.support.v4.view.MotionEventCompat.ACTION_SCROLL) {
                final float vScroll;
                final float hScroll;
                if (mLayout.canScrollVertically()) {
                    // Inverse the sign of the vertical scroll to align the scroll orientation
                    // with AbsListView.
                    vScroll = -android.support.v4.view.MotionEventCompat.getAxisValue(event, android.support.v4.view.MotionEventCompat.AXIS_VSCROLL);
                } else {
                    vScroll = 0.0F;
                }
                if (mLayout.canScrollHorizontally()) {
                    hScroll = android.support.v4.view.MotionEventCompat.getAxisValue(event, android.support.v4.view.MotionEventCompat.AXIS_HSCROLL);
                } else {
                    hScroll = 0.0F;
                }
    ...
    private float getScrollFactor() {
        if (mScrollFactor == java.lang.Float.MIN_VALUE) {
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (mLayout.mAutoMeasure) {
            ...
            final boolean skipMeasure = (widthMode == android.view.View.MeasureSpec.EXACTLY) && (heightMode == android.view.View.MeasureSpec.EXACTLY);
            mLayout.onMeasure(mRecycler, mState, widthSpec, heightSpec);
            if (skipMeasure || (mAdapter == null)) {
                return;
            }
            if (mState.mLayoutStep == android.support.v7.widget.RecyclerView.State.STEP_START) {
                dispatchLayoutStep1();
            }
            ...
            if (mLayout.shouldMeasureTwice()) {
                mLayout.setMeasureSpecs(android.view.View.MeasureSpec.makeMeasureSpec(getMeasuredWidth(), android.view.View.MeasureSpec.EXACTLY), android.view.View.MeasureSpec.makeMeasureSpec(getMeasuredHeight(), android.view.View.MeasureSpec.EXACTLY));
                mState.mIsMeasuring = true;
                dispatchLayoutStep2();
                // now we can get the width and height from the children.
                mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
    ...
    void defaultOnMeasure(int widthSpec, int heightSpec) {
        ...
        final int width = android.support.v7.widget.RecyclerView.LayoutManager.chooseSize(widthSpec, getPaddingLeft() + getPaddingRight(), android.support.v4.view.ViewCompat.getMinimumWidth(this));
        final int height = android.support.v7.widget.RecyclerView.LayoutManager.chooseSize(heightSpec, getPaddingTop() + getPaddingBottom(), android.support.v4.view.ViewCompat.getMinimumHeight(this));
    ...
    void onExitLayoutOrScroll() {
        ...
        if (mLayoutOrScrollCounter < 1) {
            if (android.support.v7.widget.RecyclerView.DEBUG && (mLayoutOrScrollCounter < 0)) {
                throw new java.lang.IllegalStateException("layout or scroll counter cannot go below zero." + "Some calls are not matching");
            }
            mLayoutOrScrollCounter = 0;
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        if ((flags != 0) && isAccessibilityEnabled()) {
            final android.view.accessibility.AccessibilityEvent event = android.view.accessibility.AccessibilityEvent.obtain();
            event.setEventType(android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_WINDOW_CONTENT_CHANGED);
            android.support.v4.view.accessibility.AccessibilityEventCompat.setContentChangeTypes(event, flags);
     ...
     */
    boolean shouldDeferAccessibilityEvent(android.view.accessibility.AccessibilityEvent event) {
        if (isComputingLayout()) {
            int type = 0;
            if (event != null) {
                type = android.support.v4.view.accessibility.AccessibilityEventCompat.getContentChangeTypes(event);
            }
            if (type == 0) {
                type = android.support.v4.view.accessibility.AccessibilityEventCompat.CONTENT_CHANGE_TYPE_UNDEFINED;
            }
    ...
    void postAnimationRunner() {
        if ((!mPostedAnimatorRunner) && mIsAttached) {
            android.support.v4.view.ViewCompat.postOnAnimation(this, mItemAnimatorRunner);
    ...
    void dispatchLayout() {
        if (mAdapter == null) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "No adapter attached; skipping layout");
            // leave the state in START
            return;
        }
        if (mLayout == null) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "No layout manager attached; skipping layout");
            // leave the state in START
            return;
        }
    ...
    private void saveFocusInfo() {
        ...
        final android.support.v7.widget.RecyclerView.ViewHolder focusedVh = (child == null) ? null : findContainingViewHolder(child);
        if (focusedVh == null) {
            resetFocusInfo();
        } else {
            mState.mFocusedItemId = (mAdapter.hasStableIds()) ? focusedVh.getItemId() : android.support.v7.widget.RecyclerView.NO_ID;
            mState.mFocusedItemPosition = (mDataSetHasChangedAfterLayout) ? android.support.v7.widget.RecyclerView.NO_POSITION : focusedVh.getAdapterPosition();
            mState.mFocusedSubChildId = getDeepestFocusedViewWithId(focusedVh.itemView);
        }
    }

    private void resetFocusInfo() {
        mState.mFocusedItemId = android.support.v7.widget.RecyclerView.NO_ID;
        mState.mFocusedItemPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
        mState.mFocusedSubChildId = android.view.View.NO_ID;
    }
    ...
    private void recoverFocusFromState() {
        ...
        if (!isFocused()) {
            final android.view.View focusedChild = getFocusedChild();
            if ((focusedChild == null) || (!mChildHelper.isHidden(focusedChild))) {
                return;
            }
        }
        android.support.v7.widget.RecyclerView.ViewHolder focusTarget = null;
        if (mState.mFocusedItemPosition != android.support.v7.widget.RecyclerView.NO_POSITION) {
            focusTarget = findViewHolderForAdapterPosition(mState.mFocusedItemPosition);
        }
        if (((focusTarget == null) && (mState.mFocusedItemId != android.support.v7.widget.RecyclerView.NO_ID)) && mAdapter.hasStableIds()) {
        ...
        android.view.View viewToFocus = focusTarget.itemView;
        if (mState.mFocusedSubChildId != android.support.v7.widget.RecyclerView.NO_ID) {
            android.view.View child = focusTarget.itemView.findViewById(mState.mFocusedSubChildId);
    ...
    private void dispatchLayoutStep1() {
        mState.assertLayoutStep(android.support.v7.widget.RecyclerView.State.STEP_START);
        mState.mIsMeasuring = false;
        eatRequestLayout();
        ...
        if (mState.mRunSimpleAnimations) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                final android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo animationInfo = mItemAnimator.recordPreLayoutInformation(mState, holder, android.support.v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(holder), holder.getUnmodifiedPayloads());
        ...
        if (mState.mRunPredictiveAnimations) {
            ...
            for (int i = 0; i < mChildHelper.getChildCount(); ++i) {
                final android.view.View child = mChildHelper.getChildAt(i);
                final android.support.v7.widget.RecyclerView.ViewHolder viewHolder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
                if (viewHolder.shouldIgnore()) {
                    continue;
                }
                if (!mViewInfoStore.isInPreLayout(viewHolder)) {
                    int flags = android.support.v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(viewHolder);
                    boolean wasHidden = viewHolder.hasAnyOfTheFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                    if (!wasHidden) {
                        flags |= android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
                    }
                    final android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo animationInfo = mItemAnimator.recordPreLayoutInformation(mState, viewHolder, flags, viewHolder.getUnmodifiedPayloads());
                    if (wasHidden) {
        ...
        onExitLayoutOrScroll();
        resumeRequestLayout(false);
        mState.mLayoutStep = android.support.v7.widget.RecyclerView.State.STEP_LAYOUT;
    }
    ...
    private void dispatchLayoutStep2() {
        eatRequestLayout();
        onEnterLayoutOrScroll();
        mState.assertLayoutStep(android.support.v7.widget.RecyclerView.State.STEP_LAYOUT | android.support.v7.widget.RecyclerView.State.STEP_ANIMATIONS);
        mAdapterHelper.consumeUpdatesInOnePass();
        mState.mItemCount = mAdapter.getItemCount();
        ...
        mState.mLayoutStep = android.support.v7.widget.RecyclerView.State.STEP_ANIMATIONS;
        onExitLayoutOrScroll();
        resumeRequestLayout(false);
    }
    ...
    private void dispatchLayoutStep3() {
        mState.assertLayoutStep(android.support.v7.widget.RecyclerView.State.STEP_ANIMATIONS);
        eatRequestLayout();
        onEnterLayoutOrScroll();
        mState.mLayoutStep = android.support.v7.widget.RecyclerView.State.STEP_START;
        if (mState.mRunSimpleAnimations) {
            // Step 3: Find out where things are now, and process change animations.
            // traverse list in reverse because we may call animateChange in the loop which may
            // remove the target view holder.
            for (int i = mChildHelper.getChildCount() - 1; i >= 0; i--) {
                android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getChildAt(i));
                if (holder.shouldIgnore()) {
                    continue;
                }
                long key = getChangedHolderKey(holder);
                final android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo animationInfo = mItemAnimator.recordPostLayoutInformation(mState, holder);
                android.support.v7.widget.RecyclerView.ViewHolder oldChangeViewHolder = mViewInfoStore.getFromOldChangeHolders(key);
                if ((oldChangeViewHolder != null) && (!oldChangeViewHolder.shouldIgnore())) {
                    ...
                    if (oldDisappearing && (oldChangeViewHolder == holder)) {
                        ...
                        final android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo = mViewInfoStore.popFromPreLayout(oldChangeViewHolder);
                        // we add and remove so that any post info is merged.
                        mViewInfoStore.addToPostLayout(holder, animationInfo);
                        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo = mViewInfoStore.popFromPostLayout(holder);
                        if (preInfo == null) {
     ...
     * @param holder
     * 		Current ViewHolder
     * @param oldChangeViewHolder
     * 		Changed ViewHolder
     */
    private void handleMissingPreInfoForChangeError(long key, android.support.v7.widget.RecyclerView.ViewHolder holder, android.support.v7.widget.RecyclerView.ViewHolder oldChangeViewHolder) {
        // check if two VH have the same key, if so, print that as an error
        final int childCount = mChildHelper.getChildCount();
        for (int i = 0; i < childCount; i++) {
            android.view.View view = mChildHelper.getChildAt(i);
            android.support.v7.widget.RecyclerView.ViewHolder other = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            if (other == holder) {
                continue;
            }
        ...
        android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, ((("Problem while matching changed view holders with the new" + "ones. The pre-layout information for the change holder ") + oldChangeViewHolder) + " cannot be found but it is necessary for ") + holder);
    }
     ...
     */
    void recordAnimationInfoIfBouncedHiddenView(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo animationInfo) {
        // looks like this view bounced back from hidden list!
        viewHolder.setFlags(0, android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
    ...
    private void findMinMaxChildLayoutPositions(int[] into) {
        ...
        if (count == 0) {
            into[0] = android.support.v7.widget.RecyclerView.NO_POSITION;
            into[1] = android.support.v7.widget.RecyclerView.NO_POSITION;
            return;
        }
        int minPositionPreLayout = java.lang.Integer.MAX_VALUE;
        int maxPositionPreLayout = java.lang.Integer.MIN_VALUE;
        for (int i = 0; i < count; ++i) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getChildAt(i));
            if (holder.shouldIgnore()) {
                continue;
    ...
    protected void removeDetachedView(android.view.View child, boolean animate) {
        android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
        if (vh != null) {
            if (vh.isTmpDetached()) {
                vh.clearTmpDetachFlag();
            } else
                if (!vh.shouldIgnore()) {
                    throw new java.lang.IllegalArgumentException(("Called removeDetachedView with a view which" + " is not flagged as tmp detached.") + vh);
                }
     ...
     */
    long getChangedHolderKey(android.support.v7.widget.RecyclerView.ViewHolder holder) {
        return mAdapter.hasStableIds() ? holder.getItemId() : holder.mPosition;
    }

    void animateAppearance(@android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ViewHolder itemHolder, @android.support.annotation.Nullable
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @android.support.annotation.NonNull
    ...
    void animateDisappearance(@android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ViewHolder holder, @android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @android.support.annotation.Nullable
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
    ...
    private void animateChange(@android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ViewHolder oldHolder, @android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ViewHolder newHolder, @android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo, @android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo, boolean oldHolderDisappearing, boolean newHolderDisappearing) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_ON_LAYOUT_TAG);
        dispatchLayout();
        android.support.v4.os.TraceCompat.endSection();
    ...
    void markItemDecorInsetsDirty() {
        ...
        for (int i = 0; i < childCount; i++) {
            final android.view.View child = mChildHelper.getUnfilteredChildAt(i);
            ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mInsetsDirty = true;
        }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return (p instanceof android.support.v7.widget.RecyclerView.LayoutParams) && mLayout.checkLayoutParams(((android.support.v7.widget.RecyclerView.LayoutParams) (p)));
    }
    ...
    void saveOldPositions() {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        for (int i = 0; i < childCount; i++) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
            if ((android.support.v7.widget.RecyclerView.DEBUG && (holder.mPosition == (-1))) && (!holder.isRemoved())) {
                throw new java.lang.IllegalStateException("view holder cannot have position -1 unless it" + " is removed");
            }
            if (!holder.shouldIgnore()) {
    ...
    void offsetPositionRecordsForMove(int from, int to) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("offsetPositionRecordsForMove attached child " + i) + " holder ") + holder);
            }
    ...
    void offsetPositionRecordsForInsert(int positionStart, int itemCount) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (((holder != null) && (!holder.shouldIgnore())) && (holder.mPosition >= positionStart)) {
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (((("offsetPositionRecordsForInsert attached child " + i) + " holder ") + holder) + " now at position ") + (holder.mPosition + itemCount));
                }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((holder != null) && (!holder.shouldIgnore())) {
                if (holder.mPosition >= positionEnd) {
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (((("offsetPositionRecordsForRemove attached child " + i) + " holder ") + holder) + " now at position ") + (holder.mPosition - itemCount));
                    }
                    ...
                    if (holder.mPosition >= positionStart) {
                        if (android.support.v7.widget.RecyclerView.DEBUG) {
                            android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, ((("offsetPositionRecordsForRemove attached child " + i) + " holder ") + holder) + " now REMOVED");
                        }
     ...
     *
     * @param positionStart
     * 		Adapter position to start at
     * @param itemCount
     * 		Number of views that must explicitly be rebound
     */
    void viewRangeUpdate(int positionStart, int itemCount, java.lang.Object payload) {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        final int positionEnd = positionStart + itemCount;
        for (int i = 0; i < childCount; i++) {
            final android.view.View child = mChildHelper.getUnfilteredChildAt(i);
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
            if ((holder == null) || holder.shouldIgnore()) {
                continue;
            }
    ...
    boolean canReuseUpdatedViewHolder(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
    ...
    void setDataSetChangedAfterLayout() {
        ...
        for (int i = 0; i < childCount; i++) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
            if ((holder != null) && (!holder.shouldIgnore())) {
                holder.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN);
            }
        }
     ...
     *
     * @param preserveFocusAfterLayout
     ...
     */
    public android.support.v7.widget.RecyclerView.ViewHolder getChildViewHolder(android.view.View child) {
        final android.view.ViewParent parent = child.getParent();
        if ((parent != null) && (parent != this)) {
            throw new java.lang.IllegalArgumentException((("View " + child) + " is not a direct child of ") + this);
        }
        return android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
    }
     ...
     */
    @android.support.annotation.Nullable
    public android.support.v7.widget.RecyclerView.ViewHolder findContainingViewHolder(android.view.View view) {
        android.view.View itemView = findContainingItemView(view);
        return itemView == null ? null : getChildViewHolder(itemView);
    }

    static android.support.v7.widget.RecyclerView.ViewHolder getChildViewHolderInt(android.view.View child) {
        if (child == null) {
            return null;
        }
        return ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mViewHolder;
    }
     ...
     */
    @java.lang.Deprecated
    public int getChildPosition(android.view.View child) {
    ...
    public int getChildAdapterPosition(android.view.View child) {
        final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
        return holder != null ? holder.getAdapterPosition() : android.support.v7.widget.RecyclerView.NO_POSITION;
    }
     ...
     */
    public int getChildLayoutPosition(android.view.View child) {
        final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
        return holder != null ? holder.getLayoutPosition() : android.support.v7.widget.RecyclerView.NO_POSITION;
    }
     ...
     */
    public long getChildItemId(android.view.View child) {
        if ((mAdapter == null) || (!mAdapter.hasStableIds())) {
            return android.support.v7.widget.RecyclerView.NO_ID;
        }
        final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
        return holder != null ? holder.getItemId() : android.support.v7.widget.RecyclerView.NO_ID;
    }
    ...
    public android.support.v7.widget.RecyclerView.ViewHolder findViewHolderForAdapterPosition(int position) {
        ...
        android.support.v7.widget.RecyclerView.ViewHolder hidden = null;
        for (int i = 0; i < childCount; i++) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
    ...
    android.support.v7.widget.RecyclerView.ViewHolder findViewHolderForPosition(int position, boolean checkNewPosition) {
        final int childCount = mChildHelper.getUnfilteredChildCount();
        android.support.v7.widget.RecyclerView.ViewHolder hidden = null;
        for (int i = 0; i < childCount; i++) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(mChildHelper.getUnfilteredChildAt(i));
     ...
     */
    public android.view.View findChildViewUnder(float x, float y) {
        final int count = mChildHelper.getChildCount();
        for (int i = count - 1; i >= 0; i--) {
            final android.view.View child = mChildHelper.getChildAt(i);
            final float translationX = android.support.v4.view.ViewCompat.getTranslationX(child);
            final float translationY = android.support.v4.view.ViewCompat.getTranslationY(child);
     ...
     */
    public void onChildAttachedToWindow(android.view.View child) {
    }
     ...
     */
    public void onChildDetachedFromWindow(android.view.View child) {
    }
    ...
    public void getDecoratedBoundsWithMargins(android.view.View view, android.graphics.Rect outBounds) {
        android.support.v7.widget.RecyclerView.getDecoratedBoundsWithMarginsInt(view, outBounds);
    }

    static void getDecoratedBoundsWithMarginsInt(android.view.View view, android.graphics.Rect outBounds) {
        final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (view.getLayoutParams()));
        final android.graphics.Rect insets = lp.mDecorInsets;
    ...
    android.graphics.Rect getItemDecorInsetsForChild(android.view.View child) {
        final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams()));
        if (!lp.mInsetsDirty) {
     ...
     *
     * @param state
     * 		the new scroll state, one of {@link #SCROLL_STATE_IDLE},
     ...
     * waiting for VSYNC.
     */
    class ViewPrefetcher implements java.lang.Runnable {
        long mPostTimeNanos;
        ...
        public void postFromTraversal(int dx, int dy) {
            if (((android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING && (mAdapter != null)) && (mLayout != null)) && (mLayout.getItemPrefetchCount() > 0)) {
                mDx = dx;
                mDy = dy;
                mPostTimeNanos = java.lang.System.nanoTime();
                android.support.v7.widget.RecyclerView.this.post(this);
            }
        }
        ...
        public boolean lastPrefetchIncludedPosition(int position) {
            if (mItemPrefetchArray != null) {
                for (int i = 0; i < mItemPrefetchArray.length; i++) {
                    if (mItemPrefetchArray[i] == position)
                        return true;
        ...
        public void clearPrefetchPositions() {
            if (mItemPrefetchArray != null) {
                java.util.Arrays.fill(mItemPrefetchArray, -1);
            }
        }
        ...
        public void run() {
            try {
                android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_PREFETCH_TAG);
                if (((((mAdapter == null) || (mLayout == null)) || (!mLayout.isItemPrefetchEnabled())) || (mLayout.getItemPrefetchCount() < 1)) || hasPendingAdapterUpdates()) {
                    // abort - no work
                    return;
                }
                ...
                long lastFrameVsyncNanos = java.util.concurrent.TimeUnit.MILLISECONDS.toNanos(getDrawingTime());
                if ((lastFrameVsyncNanos == 0) || (android.support.v7.widget.RecyclerView.sFrameIntervalNanos == 0)) {
                    // abort - couldn't get info for estimating next vsync
                    return;
                }
                long nowNanos = java.lang.System.nanoTime();
                long nextFrameNanos = lastFrameVsyncNanos + android.support.v7.widget.RecyclerView.sFrameIntervalNanos;
                if (((nowNanos - mPostTimeNanos) > android.support.v7.widget.RecyclerView.sFrameIntervalNanos) || ((nextFrameNanos - nowNanos) < android.support.v7.widget.RecyclerView.MIN_PREFETCH_TIME_NANOS)) {
    ...
    private class ViewFlinger implements java.lang.Runnable {
        ...
        private android.view.animation.Interpolator mInterpolator = android.support.v7.widget.RecyclerView.sQuinticInterpolator;
        ...
        public ViewFlinger() {
            mScroller = android.support.v4.widget.ScrollerCompat.create(getContext(), android.support.v7.widget.RecyclerView.sQuinticInterpolator);
        }
        ...
        public void run() {
            ...
            final android.support.v4.widget.ScrollerCompat scroller = mScroller;
            final android.support.v7.widget.RecyclerView.SmoothScroller smoothScroller = mLayout.mSmoothScroller;
            if (scroller.computeScrollOffset()) {
                ...
                if (scroller.isFinished() || (!fullyConsumedAny)) {
                    setScrollState(android.support.v7.widget.RecyclerView.SCROLL_STATE_IDLE);// setting state to idle will stop this.
        ...
        void postOnAnimation() {
            if (mEatRunOnAnimationRequest) {
                ...
                android.support.v4.view.ViewCompat.postOnAnimation(android.support.v7.widget.RecyclerView.this, this);
            }
        }

        public void fling(int velocityX, int velocityY) {
            setScrollState(android.support.v7.widget.RecyclerView.SCROLL_STATE_SETTLING);
            mLastFlingX = mLastFlingY = 0;
            mScroller.fling(0, 0, velocityX, velocityY, java.lang.Integer.MIN_VALUE, java.lang.Integer.MAX_VALUE, java.lang.Integer.MIN_VALUE, java.lang.Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            final int velocity = ((int) (java.lang.Math.sqrt((vx * vx) + (vy * vy))));
            final int delta = ((int) (java.lang.Math.sqrt((dx * dx) + (dy * dy))));
            final int containerSize = (horizontal) ? getWidth() : getHeight();
            final int halfContainerSize = containerSize / 2;
            final float distanceRatio = java.lang.Math.min(1.0F, (1.0F * delta) / containerSize);
            ...
            return java.lang.Math.min(duration, android.support.v7.widget.RecyclerView.MAX_SCROLL_DURATION);
        }

        public void smoothScrollBy(int dx, int dy, int duration) {
            smoothScrollBy(dx, dy, duration, android.support.v7.widget.RecyclerView.sQuinticInterpolator);
        }

        public void smoothScrollBy(int dx, int dy, int duration, android.view.animation.Interpolator interpolator) {
            if (mInterpolator != interpolator) {
                mInterpolator = interpolator;
                mScroller = android.support.v4.widget.ScrollerCompat.create(getContext(), interpolator);
            }
            setScrollState(android.support.v7.widget.RecyclerView.SCROLL_STATE_SETTLING);
            mLastFlingX = mLastFlingY = 0;
    ...
    void repositionShadowingViews() {
        ...
        for (int i = 0; i < count; i++) {
            android.view.View view = mChildHelper.getChildAt(i);
            android.support.v7.widget.RecyclerView.ViewHolder holder = getChildViewHolder(view);
            if ((holder != null) && (holder.mShadowingHolder != null)) {
                android.view.View shadowingView = holder.mShadowingHolder.itemView;
    ...
    private class RecyclerViewDataObserver extends android.support.v7.widget.RecyclerView.AdapterDataObserver {
        ...
        void triggerUpdateProcessor() {
            if ((android.support.v7.widget.RecyclerView.POST_UPDATES_ON_ANIMATION && mHasFixedSize) && mIsAttached) {
                android.support.v4.view.ViewCompat.postOnAnimation(android.support.v7.widget.RecyclerView.this, mUpdateChildViewsRunnable);
            } else {
    ...
    public static class RecycledViewPool {
        private android.util.SparseArray<java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>> mScrap = new android.util.SparseArray<java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>>();

        private android.util.SparseIntArray mMaxScrap = new android.util.SparseIntArray();
        ...
        public void setMaxRecycledViews(int viewType, int max) {
            ...
            final java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> scrapHeap = mScrap.get(viewType);
            if (scrapHeap != null) {
        ...
        public android.support.v7.widget.RecyclerView.ViewHolder getRecycledView(int viewType) {
            ...
            if ((scrapHeap != null) && (!scrapHeap.isEmpty())) {
                ...
                final android.support.v7.widget.RecyclerView.ViewHolder scrap = scrapHeap.get(index);
        ...
        int size() {
            ...
            for (int i = 0; i < mScrap.size(); i++) {
                java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> viewHolders = mScrap.valueAt(i);
                if (viewHolders != null) {
        ...
        public void putRecycledView(android.support.v7.widget.RecyclerView.ViewHolder scrap) {
            ...
            final java.util.ArrayList scrapHeap = getScrapHeapForType(viewType);
            if (mMaxScrap.get(viewType) <= scrapHeap.size()) {
                return;
            }
            if (android.support.v7.widget.RecyclerView.DEBUG && scrapHeap.contains(scrap)) {
        ...
        void attach(android.support.v7.widget.RecyclerView.Adapter adapter) {
            mAttachCount++;
        }
         ...
         * @param newAdapter
         * 		The new adapter instance. Will be attached.
         * @param compatibleWithPrevious
         * 		True if both oldAdapter and newAdapter are using the same
         * 		ViewHolder and view types.
         */
        void onAdapterChanged(android.support.v7.widget.RecyclerView.Adapter oldAdapter, android.support.v7.widget.RecyclerView.Adapter newAdapter, boolean compatibleWithPrevious) {
            if (oldAdapter != null) {
                detach();
            }
        ...
        private java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> getScrapHeapForType(int viewType) {
            java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> scrap = mScrap.get(viewType);
            if (scrap == null) {
                scrap = new java.util.ArrayList<>();
                mScrap.put(viewType, scrap);
                if (mMaxScrap.indexOfKey(viewType) < 0) {
                    mMaxScrap.put(viewType, android.support.v7.widget.RecyclerView.RecycledViewPool.DEFAULT_MAX_SCRAP);
                }
            }
            return scrap;
        }
    ...
    public final class Recycler {
        final java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> mAttachedScrap = new java.util.ArrayList<>();

        java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> mChangedScrap = null;

        final java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder> mCachedViews = new java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>();

        private final java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> mUnmodifiableAttachedScrap = java.util.Collections.unmodifiableList(mAttachedScrap);

        private int mRequestedCacheMax = android.support.v7.widget.RecyclerView.Recycler.DEFAULT_CACHE_SIZE;

        int mViewCacheMax = android.support.v7.widget.RecyclerView.Recycler.DEFAULT_CACHE_SIZE;
        ...
        void updateViewCacheSize() {
            int extraCache = 0;
            if ((mLayout != null) && android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING) {
        ...
        boolean validateViewHolderForOffsetPosition(android.support.v7.widget.RecyclerView.ViewHolder holder) {
            ...
            if (holder.isRemoved()) {
                if (android.support.v7.widget.RecyclerView.DEBUG && (!mState.isPreLayout())) {
                    throw new java.lang.IllegalStateException("should not receive a removed view unless it" + " is pre layout");
                }
                return mState.isPreLayout();
            }
            if ((holder.mPosition < 0) || (holder.mPosition >= mAdapter.getItemCount())) {
                throw new java.lang.IndexOutOfBoundsException(("Inconsistency detected. Invalid view holder " + "adapter position") + holder);
            }
         ...
         */
        public void bindViewToPosition(android.view.View view, int position) {
            android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            if (holder == null) {
            ...
            if ((offsetPosition < 0) || (offsetPosition >= mAdapter.getItemCount())) {
                throw new java.lang.IndexOutOfBoundsException((((((("Inconsistency detected. Invalid item " + "position ") + position) + "(offset:") + offsetPosition) + ").") + "state:") + mState.getItemCount());
            }
            ...
            final android.view.ViewGroup.LayoutParams lp = holder.itemView.getLayoutParams();
        ...
        public int convertPreLayoutPositionToPostLayout(int position) {
            if ((position < 0) || (position >= mState.getItemCount())) {
                throw new java.lang.IndexOutOfBoundsException(((("invalid position " + position) + ". State ") + "item count is ") + mState.getItemCount());
            }
            if (!mState.isPreLayout()) {
                return position;
            }
         ...
         */
        public android.view.View getViewForPosition(int position) {
            return getViewForPosition(position, false);
        }

        android.view.View getViewForPosition(int position, boolean dryRun) {
            if ((position < 0) || (position >= mState.getItemCount())) {
                throw new java.lang.IndexOutOfBoundsException((((("Invalid item position " + position) + "(") + position) + "). Item count:") + mState.getItemCount());
            }
            ...
            if (holder == null) {
                holder = getScrapViewForPosition(position, android.support.v7.widget.RecyclerView.INVALID_TYPE, dryRun);
                if (holder != null) {
            ...
            if (holder == null) {
                ...
                if ((holder == null) && (mViewCacheExtension != null)) {
                    ...
                    // know it.
                    final android.view.View view = mViewCacheExtension.getViewForPositionAndType(this, position, type);
                    if (view != null) {
                ...
                if (holder == null) {
                    ...
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("getViewForPosition(" + position) + ") fetching from shared ") + "pool");
                    }
                    holder = getRecycledViewPool().getRecycledView(type);
                    if (holder != null) {
                        holder.resetInternal();
                        if (android.support.v7.widget.RecyclerView.FORCE_INVALIDATE_DISPLAY_LIST) {
                ...
                if (holder == null) {
                    ...
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "getViewForPosition created new ViewHolder");
                    }
                }
            }
            ...
            if ((fromScrap && (!mState.isPreLayout())) && holder.hasAnyOfTheFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST)) {
                holder.setFlags(0, android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                if (mState.mRunSimpleAnimations) {
                    int changeFlags = android.support.v7.widget.RecyclerView.ItemAnimator.buildAdapterChangeFlagsForAnimations(holder);
                    changeFlags |= android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT;
                    final android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo info = mItemAnimator.recordPreLayoutInformation(mState, holder, changeFlags, holder.getUnmodifiedPayloads());
            ...
            if (mState.isPreLayout() && holder.isBound()) {
                ...
                if (((!holder.isBound()) || holder.needsUpdate()) || holder.isInvalid()) {
                    if (android.support.v7.widget.RecyclerView.DEBUG && holder.isRemoved()) {
                        throw new java.lang.IllegalStateException(("Removed holder should be bound and it should" + " come here only in pre-layout. Holder: ") + holder);
                    }
                    final int offsetPosition = mAdapterHelper.findPositionOffset(position);
                    holder.mOwnerRecyclerView = android.support.v7.widget.RecyclerView.this;
                    mAdapter.bindViewHolder(holder, offsetPosition);
        ...
        private void attachAccessibilityDelegate(android.view.View itemView) {
            if (isAccessibilityEnabled()) {
                if (android.support.v4.view.ViewCompat.getImportantForAccessibility(itemView) == android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
                    android.support.v4.view.ViewCompat.setImportantForAccessibility(itemView, android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);
                }
                if (!android.support.v4.view.ViewCompat.hasAccessibilityDelegate(itemView)) {
                    android.support.v4.view.ViewCompat.setAccessibilityDelegate(itemView, mAccessibilityDelegate.getItemDelegate());
                }
            }
        }

        private void invalidateDisplayListInt(android.support.v7.widget.RecyclerView.ViewHolder holder) {
            if (holder.itemView instanceof android.view.ViewGroup) {
                invalidateDisplayListInt(((android.view.ViewGroup) (holder.itemView)), false);
            }
        }

        private void invalidateDisplayListInt(android.view.ViewGroup viewGroup, boolean invalidateThis) {
            for (int i = viewGroup.getChildCount() - 1; i >= 0; i--) {
                final android.view.View view = viewGroup.getChildAt(i);
                if (view instanceof android.view.ViewGroup) {
                    invalidateDisplayListInt(((android.view.ViewGroup) (view)), true);
                }
            }
            if (!invalidateThis) {
                return;
            ...
            if (viewGroup.getVisibility() == android.view.View.INVISIBLE) {
        ...
        void recycleViewInternal(android.view.View view) {
            recycleViewHolderInternal(android.support.v7.widget.RecyclerView.getChildViewHolderInt(view));
        }
         ...
         *
         * @param cachedViewIndex
         * 		The index of the view in cached views list
         */
        void recycleCachedViewAt(int cachedViewIndex) {
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "Recycling cached view at index " + cachedViewIndex);
            }
            android.support.v7.widget.RecyclerView.ViewHolder viewHolder = mCachedViews.get(cachedViewIndex);
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "CachedViewHolder to be recycled: " + viewHolder);
            }
        ...
        void recycleViewHolderInternal(android.support.v7.widget.RecyclerView.ViewHolder holder) {
            if (holder.isScrap() || (holder.itemView.getParent() != null)) {
                throw new java.lang.IllegalArgumentException((("Scrapped or attached views may not be recycled. isScrap:" + holder.isScrap()) + " isAttached:") + (holder.itemView.getParent() != null));
            }
            if (holder.isTmpDetached()) {
                throw new java.lang.IllegalArgumentException(("Tmp detached view should be removed " + "from RecyclerView before it can be recycled: ") + holder);
            }
            if (holder.shouldIgnore()) {
            ...
            if (android.support.v7.widget.RecyclerView.DEBUG && mCachedViews.contains(holder)) {
                throw new java.lang.IllegalArgumentException("cached view received recycle internal? " + holder);
            }
            if (forceRecycle || holder.isRecyclable()) {
                if ((mViewCacheMax > 0) && (!holder.hasAnyOfTheFlags((android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED) | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE))) {
                    ...
                    if ((android.support.v7.widget.RecyclerView.ALLOW_PREFETCHING && (cachedViewSize > 0)) && (!mViewPrefetcher.lastPrefetchIncludedPosition(holder.mPosition))) {
                ...
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "trying to recycle a non-recycleable holder. Hopefully, it will " + "re-visit here. We are still removing it from animation lists");
                }
        ...
        void addViewHolderToRecycledViewPool(android.support.v7.widget.RecyclerView.ViewHolder holder) {
            android.support.v4.view.ViewCompat.setAccessibilityDelegate(holder.itemView, null);
        ...
        void quickRecycleScrapView(android.view.View view) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
        ...
        void scrapView(android.view.View view) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            if ((holder.hasAnyOfTheFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID) || (!holder.isUpdated())) || canReuseUpdatedViewHolder(holder)) {
                ...
                if (mChangedScrap == null) {
                    mChangedScrap = new java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>();
                }
        ...
        android.view.View getScrapViewAt(int index) {
         ...
         * 		View type
         * @param dryRun
         * 		Does a dry run, finds the ViewHolder but does not remove
         * @return a ViewHolder that can be re-used for this position.
         */
        android.support.v7.widget.RecyclerView.ViewHolder getScrapViewForPosition(int position, int type, boolean dryRun) {
            ...
            for (int i = 0; i < scrapCount; i++) {
                ...
                if ((((!holder.wasReturnedFromScrap()) && (holder.getLayoutPosition() == position)) && (!holder.isInvalid())) && (mState.mInPreLayout || (!holder.isRemoved()))) {
                    if ((type != android.support.v7.widget.RecyclerView.INVALID_TYPE) && (holder.getItemViewType() != type)) {
                        android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, (((((("Scrap view for position " + position) + " isn't dirty but has") + " wrong view type! (found ") + holder.getItemViewType()) + " but expected ") + type) + ")");
                        break;
                    }
                    holder.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP);
                    return holder;
            ...
            if (!dryRun) {
                android.view.View view = mChildHelper.findHiddenNonRemovedView(position, type);
                if (view != null) {
                    ...
                    if (layoutIndex == android.support.v7.widget.RecyclerView.NO_POSITION) {
                        throw new java.lang.IllegalStateException(("layout index should not be -1 after " + "unhiding a view:") + vh);
                    }
                    mChildHelper.detachViewFromParent(layoutIndex);
                    scrapView(view);
                    vh.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUNCED_FROM_HIDDEN_LIST);
                    return vh;
                }
            }
            ...
            for (int i = 0; i < cacheSize; i++) {
                ...
                if ((!holder.isInvalid()) && (holder.getLayoutPosition() == position)) {
                    ...
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (((("getScrapViewForPosition(" + position) + ", ") + type) + ") found match in cache: ") + holder);
                    }
                    return holder;
                }
            }
        ...
        android.support.v7.widget.RecyclerView.ViewHolder getScrapViewForId(long id, int type, boolean dryRun) {
                ...
                if ((holder.getItemId() == id) && (!holder.wasReturnedFromScrap())) {
                    if (type == holder.getItemViewType()) {
                        ...
                        if (holder.isRemoved()) {
                            ...
                            // between.
                            if (!mState.isPreLayout()) {
                                holder.setFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE, (android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID) | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED);
                            }
                        }
                        return holder;
                    } else
        ...
        void dispatchViewRecycled(android.support.v7.widget.RecyclerView.ViewHolder holder) {
            ...
            if (android.support.v7.widget.RecyclerView.DEBUG)
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "dispatchViewRecycled: " + holder);
        ...
        void offsetPositionRecordsForMove(int from, int to) {
            ...
            for (int i = 0; i < cachedCount; i++) {
                ...
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("offsetPositionRecordsForMove cached child " + i) + " holder ") + holder);
                }
            }
        }
        ...
        void offsetPositionRecordsForInsert(int insertedAt, int count) {
            ...
            for (int i = 0; i < cachedCount; i++) {
                ...
                if ((holder != null) && (holder.mPosition >= insertedAt)) {
                    if (android.support.v7.widget.RecyclerView.DEBUG) {
                        android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (((("offsetPositionRecordsForInsert cached " + i) + " holder ") + holder) + " now at position ") + (holder.mPosition + count));
                    }
         ...
         * 		If true, changes will affect ViewHolder's pre-layout position, if
            ...
            for (int i = cachedCount - 1; i >= 0; i--) {
                ...
                if (holder != null) {
                    if (holder.mPosition >= removedEnd) {
                        if (android.support.v7.widget.RecyclerView.DEBUG) {
                            android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (((("offsetPositionRecordsForRemove cached " + i) + " holder ") + holder) + " now at position ") + (holder.mPosition - count));
                        }
                        holder.offsetPosition(-count, applyToPreLayout);
                    } else
                        if (holder.mPosition >= removedFrom) {
        ...
        boolean isPrefetchPositionAttached(int position) {
            final int childCount = mChildHelper.getUnfilteredChildCount();
            for (int i = 0; i < childCount; i++) {
                android.view.View attachedView = mChildHelper.getUnfilteredChildAt(i);
                android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(attachedView);
        ...
        void prefetch(int[] itemPrefetchArray, int viewCount) {
            ...
            if (childPosition < 0) {
                throw new java.lang.IllegalArgumentException("Recycler requested to prefetch invalid view " + childPosition);
            }
            android.view.View prefetchView = null;
    ...
    public static abstract class ViewCacheExtension {
         ...
         */
        public abstract android.view.View getViewForPositionAndType(android.support.v7.widget.RecyclerView.Recycler recycler, int position, int type);
    }
    ...
    public static abstract class Adapter<VH extends android.support.v7.widget.RecyclerView.ViewHolder> {
        private final android.support.v7.widget.RecyclerView.AdapterDataObservable mObservable = new android.support.v7.widget.RecyclerView.AdapterDataObservable();
        ...
        public final VH createViewHolder(android.view.ViewGroup parent, int viewType) {
            android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_CREATE_VIEW_TAG);
        ...
        public final void bindViewHolder(VH holder, int position) {
            ...
            holder.setFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUND, ((android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUND | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE) | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID) | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN);
            android.support.v4.os.TraceCompat.beginSection(android.support.v7.widget.RecyclerView.TRACE_BIND_VIEW_TAG);
            onBindViewHolder(holder, position, holder.getUnmodifiedPayloads());
            holder.clearPayload();
            final android.view.ViewGroup.LayoutParams layoutParams = holder.itemView.getLayoutParams();
            if (layoutParams instanceof android.support.v7.widget.RecyclerView.LayoutParams) {
                ((android.support.v7.widget.RecyclerView.LayoutParams) (layoutParams)).mInsetsDirty = true;
            }
            android.support.v4.os.TraceCompat.endSection();
        }
    ...
    void dispatchChildDetached(android.view.View child) {
        final android.support.v7.widget.RecyclerView.ViewHolder viewHolder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
    ...
    void dispatchChildAttached(android.view.View child) {
        final android.support.v7.widget.RecyclerView.ViewHolder viewHolder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
    ...
    public static abstract class LayoutManager {
        ...
        void setRecyclerView(android.support.v7.widget.RecyclerView recyclerView) {
            ...
            mWidthMode = android.view.View.MeasureSpec.EXACTLY;
            mHeightMode = android.view.View.MeasureSpec.EXACTLY;
        }

        void setMeasureSpecs(int wSpec, int hSpec) {
            mWidth = android.view.View.MeasureSpec.getSize(wSpec);
            mWidthMode = android.view.View.MeasureSpec.getMode(wSpec);
            if ((mWidthMode == android.view.View.MeasureSpec.UNSPECIFIED) && (!android.support.v7.widget.RecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC)) {
                mWidth = 0;
            }
            mHeight = android.view.View.MeasureSpec.getSize(hSpec);
            mHeightMode = android.view.View.MeasureSpec.getMode(hSpec);
            if ((mHeightMode == android.view.View.MeasureSpec.UNSPECIFIED) && (!android.support.v7.widget.RecyclerView.ALLOW_SIZE_IN_UNSPECIFIED_SPEC)) {
                mHeight = 0;
            }
        }
         ...
         *
         * @param widthSpec
         * 		The widthSpec that was passing into RecyclerView's onMeasure
         * @param heightSpec
         * 		The heightSpec that was passing into RecyclerView's onMeasure
         */
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                final android.graphics.Rect bounds = mRecyclerView.mTempRect;
        ...
        public void setMeasuredDimension(android.graphics.Rect childrenBounds, int wSpec, int hSpec) {
            ...
            int width = android.support.v7.widget.RecyclerView.LayoutManager.chooseSize(wSpec, usedWidth, getMinimumWidth());
            int height = android.support.v7.widget.RecyclerView.LayoutManager.chooseSize(hSpec, usedHeight, getMinimumHeight());
            setMeasuredDimension(width, height);
        }
        ...
        public static int chooseSize(int spec, int desired, int min) {
            ...
            final int size = android.view.View.MeasureSpec.getSize(spec);
            switch (mode) {
                case android.view.View.MeasureSpec.EXACTLY :
                    return size;
                case android.view.View.MeasureSpec.AT_MOST :
                    return java.lang.Math.min(size, java.lang.Math.max(desired, min));
                case android.view.View.MeasureSpec.UNSPECIFIED :
                default :
                    return java.lang.Math.max(desired, min);
            }
        }
         ...
         *
         * @param enabled
         * 		<code>True</code> if the Layout should be measured by the
         ...
         *
         * @param enabled
         * 		<code>True</code> if items should be prefetched in between traversals.
        ...
        void dispatchAttachedToWindow(android.support.v7.widget.RecyclerView view) {
            mIsAttachedToWindow = true;
            onAttachedToWindow(view);
        }

        void dispatchDetachedFromWindow(android.support.v7.widget.RecyclerView view, android.support.v7.widget.RecyclerView.Recycler recycler) {
        ...
        public void postOnAnimation(java.lang.Runnable action) {
            if (mRecyclerView != null) {
                android.support.v4.view.ViewCompat.postOnAnimation(mRecyclerView, action);
            }
        }
        ...
        public void onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
        }
        ...
        public android.support.v7.widget.RecyclerView.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams lp) {
            if (lp instanceof android.support.v7.widget.RecyclerView.LayoutParams) {
                return new android.support.v7.widget.RecyclerView.LayoutParams(((android.support.v7.widget.RecyclerView.LayoutParams) (lp)));
            } else
                if (lp instanceof android.view.ViewGroup.MarginLayoutParams) {
                    return new android.support.v7.widget.RecyclerView.LayoutParams(((android.view.ViewGroup.MarginLayoutParams) (lp)));
                } else {
                    return new android.support.v7.widget.RecyclerView.LayoutParams(lp);
                }
        ...
        public android.support.v7.widget.RecyclerView.LayoutParams generateLayoutParams(android.content.Context c, android.util.AttributeSet attrs) {
            return new android.support.v7.widget.RecyclerView.LayoutParams(c, attrs);
        }
        ...
        public void scrollToPosition(int position) {
            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "You MUST implement scrollToPosition. It will soon become abstract");
            }
        }
        ...
        public void smoothScrollToPosition(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.State state, int position) {
            android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }
        ...
        public int getLayoutDirection() {
            return android.support.v4.view.ViewCompat.getLayoutDirection(mRecyclerView);
        }
        ...
        public void endAnimation(android.view.View view) {
            if (mRecyclerView.mItemAnimator != null) {
                mRecyclerView.mItemAnimator.endAnimation(android.support.v7.widget.RecyclerView.getChildViewHolderInt(view));
            }
        }
         ...
         */
        public void addDisappearingView(android.view.View child) {
         ...
         * 		Index of the view.
         */
        public void addDisappearingView(android.view.View child, int index) {
        ...
        private void addViewInt(android.view.View child, int index, boolean disappearing) {
            final android.support.v7.widget.RecyclerView.ViewHolder holder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                if (android.support.v7.widget.RecyclerView.DISPATCH_TEMP_DETACH) {
                    android.support.v4.view.ViewCompat.dispatchFinishTemporaryDetach(child);
                }
            } else
                if (child.getParent() == mRecyclerView) {
                    // it was not a scrap but a valid child
                    ...
                    if (currentIndex == (-1)) {
                        throw new java.lang.IllegalStateException(("Added View has RecyclerView as parent but" + " view is not a real child. Unfiltered index:") + mRecyclerView.indexOfChild(child));
                    }
            ...
            if (lp.mPendingInvalidate) {
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "consuming pending invalidate on child " + lp.mViewHolder);
                }
        ...
        public int getPosition(android.view.View view) {
            return ((android.support.v7.widget.RecyclerView.LayoutParams) (view.getLayoutParams())).getViewLayoutPosition();
        }
        ...
        public int getItemViewType(android.view.View view) {
            return android.support.v7.widget.RecyclerView.getChildViewHolderInt(view).getItemViewType();
        }
        ...
        public android.view.View findContainingItemView(android.view.View view) {
            ...
            android.view.View found = mRecyclerView.findContainingItemView(view);
            if (found == null) {
                return null;
            }
         ...
         * 		Child to detach
         */
        public void detachView(android.view.View child) {
        ...
        private void detachViewInternal(int index, android.view.View view) {
            if (android.support.v7.widget.RecyclerView.DISPATCH_TEMP_DETACH) {
                android.support.v4.view.ViewCompat.dispatchStartTemporaryDetach(view);
            }
         ...
         */
        public void attachView(android.view.View child, int index, android.support.v7.widget.RecyclerView.LayoutParams lp) {
            android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(child);
            if (vh.isRemoved()) {
         ...
         * 		Intended child index for child
         */
        public void attachView(android.view.View child, int index) {
            attachView(child, index, ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())));
        }
         ...
         * 		Child to reattach
         */
        public void attachView(android.view.View child) {
            attachView(child, -1);
        }
         ...
         */
        public void removeDetachedView(android.view.View child) {
        ...
        public void moveView(int fromIndex, int toIndex) {
            android.view.View view = getChildAt(fromIndex);
            if (view == null) {
                throw new java.lang.IllegalArgumentException("Cannot move a child from non-existing index:" + fromIndex);
            }
         ...
         */
        public void detachAndScrapView(android.view.View child, android.support.v7.widget.RecyclerView.Recycler recycler) {
         ...
         * 		Recycler to deposit the new scrap view into
         */
        public void detachAndScrapViewAt(int index, android.support.v7.widget.RecyclerView.Recycler recycler) {
            final android.view.View child = getChildAt(index);
            scrapOrRecycleView(recycler, index, child);
        }
         ...
         */
        public void removeAndRecycleView(android.view.View child, android.support.v7.widget.RecyclerView.Recycler recycler) {
            removeView(child);
         ...
         * 		Recycler to use to recycle child
         */
        public void removeAndRecycleViewAt(int index, android.support.v7.widget.RecyclerView.Recycler recycler) {
        ...
        public int getPaddingStart() {
            return mRecyclerView != null ? android.support.v4.view.ViewCompat.getPaddingStart(mRecyclerView) : 0;
        }
        ...
        public int getPaddingEnd() {
            return mRecyclerView != null ? android.support.v4.view.ViewCompat.getPaddingEnd(mRecyclerView) : 0;
        }
        ...
        public android.view.View getFocusedChild() {
            ...
            final android.view.View focused = mRecyclerView.getFocusedChild();
        ...
        public int getItemCount() {
            final android.support.v7.widget.RecyclerView.Adapter a = (mRecyclerView != null) ? mRecyclerView.getAdapter() : null;
        ...
        public void ignoreView(android.view.View view) {
            ...
            final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            vh.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_IGNORE);
        ...
        public void stopIgnoringView(android.view.View view) {
            ...
            vh.stopIgnoring();
            vh.resetInternal();
            vh.addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID);
        }
        ...
        private void scrapOrRecycleView(android.support.v7.widget.RecyclerView.Recycler recycler, int index, android.view.View view) {
            final android.support.v7.widget.RecyclerView.ViewHolder viewHolder = android.support.v7.widget.RecyclerView.getChildViewHolderInt(view);
            if (viewHolder.shouldIgnore()) {
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "ignoring view " + viewHolder);
                }
                return;
            }
         ...
         * 		Recycler
         */
        void removeAndRecycleScrapInt(android.support.v7.widget.RecyclerView.Recycler recycler) {
            final int scrapCount = recycler.getScrapCount();
            // Loop backward, recycler might be changed by removeDetachedView()
            for (int i = scrapCount - 1; i >= 0; i--) {
                final android.view.View scrap = recycler.getScrapViewAt(i);
                final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(scrap);
                if (vh.shouldIgnore()) {
                    continue;
                }
         ...
         */
        public void measureChild(android.view.View child, int widthUsed, int heightUsed) {
            final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams()));
            final android.graphics.Rect insets = mRecyclerView.getItemDecorInsetsForChild(child);
            widthUsed += insets.left + insets.right;
            heightUsed += insets.top + insets.bottom;
            final int widthSpec = android.support.v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (getPaddingLeft() + getPaddingRight()) + widthUsed, lp.width, canScrollHorizontally());
            final int heightSpec = android.support.v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (getPaddingTop() + getPaddingBottom()) + heightUsed, lp.height, canScrollVertically());
         ...
         */
        boolean shouldReMeasureChild(android.view.View child, int widthSpec, int heightSpec, android.support.v7.widget.RecyclerView.LayoutParams lp) {
            return ((!mMeasurementCacheEnabled) || (!android.support.v7.widget.RecyclerView.LayoutManager.isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, lp.width))) || (!android.support.v7.widget.RecyclerView.LayoutManager.isMeasurementUpToDate(child.getMeasuredHeight(), heightSpec, lp.height));
        }
         ...
         */
        boolean shouldMeasureChild(android.view.View child, int widthSpec, int heightSpec, android.support.v7.widget.RecyclerView.LayoutParams lp) {
            return ((child.isLayoutRequested() || (!mMeasurementCacheEnabled)) || (!android.support.v7.widget.RecyclerView.LayoutManager.isMeasurementUpToDate(child.getWidth(), widthSpec, lp.width))) || (!android.support.v7.widget.RecyclerView.LayoutManager.isMeasurementUpToDate(child.getHeight(), heightSpec, lp.height));
        }
        ...
        private static boolean isMeasurementUpToDate(int childSize, int spec, int dimension) {
            final int specMode = android.view.View.MeasureSpec.getMode(spec);
            final int specSize = android.view.View.MeasureSpec.getSize(spec);
        ...
        public void measureChildWithMargins(android.view.View child, int widthUsed, int heightUsed) {
            ...
            widthUsed += insets.left + insets.right;
            heightUsed += insets.top + insets.bottom;
            final int widthSpec = android.support.v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), (((getPaddingLeft() + getPaddingRight()) + lp.leftMargin) + lp.rightMargin) + widthUsed, lp.width, canScrollHorizontally());
            final int heightSpec = android.support.v7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), (((getPaddingTop() + getPaddingBottom()) + lp.topMargin) + lp.bottomMargin) + heightUsed, lp.height, canScrollVertically());
            if (shouldMeasureChild(child, widthSpec, heightSpec, lp)) {
                child.measure(widthSpec, heightSpec);
            }
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int padding, int childDimension, boolean canScroll) {
            int size = java.lang.Math.max(0, parentSize - padding);
            int resultSize = 0;
            int resultMode = 0;
            if (canScroll) {
                if (childDimension >= 0) {
                ...
                if (childDimension >= 0) {
                    ...
                    if (childDimension == android.support.v7.widget.RecyclerView.LayoutParams.MATCH_PARENT) {
                        resultSize = size;
                        // TODO this should be my spec.
                        resultMode = android.view.View.MeasureSpec.EXACTLY;
                    } else
                        if (childDimension == android.support.v7.widget.RecyclerView.LayoutParams.WRAP_CONTENT) {
                            resultSize = size;
            ...
            if (childDimension >= 0) {
                ...
                if (canScroll) {
                    ...
                    if (childDimension == android.support.v7.widget.RecyclerView.LayoutParams.MATCH_PARENT) {
                        ...
                        if (childDimension == android.support.v7.widget.RecyclerView.LayoutParams.WRAP_CONTENT) {
                            resultSize = size;
                            if ((parentMode == android.view.View.MeasureSpec.AT_MOST) || (parentMode == android.view.View.MeasureSpec.EXACTLY)) {
                                resultMode = android.view.View.MeasureSpec.AT_MOST;
                            } else {
                                resultMode = android.view.View.MeasureSpec.UNSPECIFIED;
                            }
         ...
         */
        public int getDecoratedMeasuredWidth(android.view.View child) {
            final android.graphics.Rect insets = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets;
         ...
         */
        public int getDecoratedMeasuredHeight(android.view.View child) {
            final android.graphics.Rect insets = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets;
         ...
         */
        public void layoutDecorated(android.view.View child, int left, int top, int right, int bottom) {
            final android.graphics.Rect insets = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets;
         ...
         */
        public void layoutDecoratedWithMargins(android.view.View child, int left, int top, int right, int bottom) {
            final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams()));
            final android.graphics.Rect insets = lp.mDecorInsets;
         ...
         */
        public void getTransformedBoundingBox(android.view.View child, boolean includeDecorInsets, android.graphics.Rect out) {
            if (includeDecorInsets) {
                android.graphics.Rect insets = ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets;
                out.set(-insets.left, -insets.top, child.getWidth() + insets.right, child.getHeight() + insets.bottom);
            } else {
                out.set(0, 0, child.getWidth(), child.getHeight());
            }
            if (mRecyclerView != null) {
                final android.graphics.Matrix childMatrix = android.support.v4.view.ViewCompat.getMatrix(child);
                if ((childMatrix != null) && (!childMatrix.isIdentity())) {
                    final android.graphics.RectF tempRectF = mRecyclerView.mTempRectF;
                    tempRectF.set(out);
                    childMatrix.mapRect(tempRectF);
                    out.set(((int) (java.lang.Math.floor(tempRectF.left))), ((int) (java.lang.Math.floor(tempRectF.top))), ((int) (java.lang.Math.ceil(tempRectF.right))), ((int) (java.lang.Math.ceil(tempRectF.bottom))));
                }
            }
         ...
         */
        public void calculateItemDecorationsForChild(android.view.View child, android.graphics.Rect outRect) {
            if (mRecyclerView == null) {
                outRect.set(0, 0, 0, 0);
                return;
            }
            android.graphics.Rect insets = mRecyclerView.getItemDecorInsetsForChild(child);
            outRect.set(insets);
        }
         ...
         */
        public int getTopDecorationHeight(android.view.View child) {
            return ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets.top;
        }
         ...
         * @see #calculateItemDecorationsForChild(View, Rect)
         */
        public int getBottomDecorationHeight(android.view.View child) {
            return ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets.bottom;
        }
         ...
         * @see #calculateItemDecorationsForChild(View, Rect)
         */
        public int getLeftDecorationWidth(android.view.View child) {
            return ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets.left;
        }
         ...
         * @see #calculateItemDecorationsForChild(View, Rect)
         */
        public int getRightDecorationWidth(android.view.View child) {
            return ((android.support.v7.widget.RecyclerView.LayoutParams) (child.getLayoutParams())).mDecorInsets.right;
        }
         ...
         */
        public boolean requestChildRectangleOnScreen(android.support.v7.widget.RecyclerView parent, android.view.View child, android.graphics.Rect rect, boolean immediate) {
            ...
            final int offScreenLeft = java.lang.Math.min(0, childLeft - parentLeft);
            final int offScreenTop = java.lang.Math.min(0, childTop - parentTop);
            final int offScreenRight = java.lang.Math.max(0, childRight - parentRight);
            final int offScreenBottom = java.lang.Math.max(0, childBottom - parentBottom);
            // Favor the "start" layout direction over the end when bringing one side or the other
            // of a large rect into view. If we decide to bring in end because start is already
            // visible, limit the scroll such that start won't go out of bounds.
            final int dx;
            if (getLayoutDirection() == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL) {
                dx = (offScreenRight != 0) ? offScreenRight : java.lang.Math.max(offScreenLeft, childRight - parentRight);
            } else {
                dx = (offScreenLeft != 0) ? offScreenLeft : java.lang.Math.min(childLeft - parentLeft, offScreenRight);
            }
            // Favor bringing the top into view over the bottom. If top is already visible and
            // we should scroll to make bottom visible, make sure top does not go out of bounds.
            final int dy = (offScreenTop != 0) ? offScreenTop : java.lang.Math.min(childTop - parentTop, offScreenBottom);
            if ((dx != 0) || (dy != 0)) {
                if (immediate) {
         ...
         */
        public boolean onRequestChildFocus(android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.State state, android.view.View child, android.view.View focused) {
         ...
         * 		Transient state of RecyclerView
         * @param widthSpec
         * 		Width {@link android.view.View.MeasureSpec}
         * @param heightSpec
         * 		Height {@link android.view.View.MeasureSpec}
         */
        ...
        public int getMinimumWidth() {
            return android.support.v4.view.ViewCompat.getMinimumWidth(mRecyclerView);
        }
        ...
        public int getMinimumHeight() {
            return android.support.v4.view.ViewCompat.getMinimumHeight(mRecyclerView);
        }
        ...
        private void onSmoothScrollerStopped(android.support.v7.widget.RecyclerView.SmoothScroller smoothScroller) {
        ...
        public void removeAndRecycleAllViews(android.support.v7.widget.RecyclerView.Recycler recycler) {
            for (int i = getChildCount() - 1; i >= 0; i--) {
                ...
                if (!android.support.v7.widget.RecyclerView.getChildViewHolderInt(view).shouldIgnore()) {
        ...
        void onInitializeAccessibilityNodeInfo(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat info) {
        ...
        public void onInitializeAccessibilityNodeInfo(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat info) {
            if (android.support.v4.view.ViewCompat.canScrollVertically(mRecyclerView, -1) || android.support.v4.view.ViewCompat.canScrollHorizontally(mRecyclerView, -1)) {
         ...
         */
        public void onInitializeAccessibilityEvent(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.view.accessibility.AccessibilityEvent event) {
            ...
            record.setScrollable(((android.support.v4.view.ViewCompat.canScrollVertically(mRecyclerView, 1) || android.support.v4.view.ViewCompat.canScrollVertically(mRecyclerView, -1)) || android.support.v4.view.ViewCompat.canScrollHorizontally(mRecyclerView, -1)) || android.support.v4.view.ViewCompat.canScrollHorizontally(mRecyclerView, 1));
        ...
        // called by accessibility delegate
        void onInitializeAccessibilityNodeInfoForItem(android.view.View host, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat info) {
            final android.support.v7.widget.RecyclerView.ViewHolder vh = android.support.v7.widget.RecyclerView.getChildViewHolderInt(host);
        ...
        public void onInitializeAccessibilityNodeInfoForItem(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.view.View host, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat info) {
            ...
            final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat itemInfo = android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(rowIndexGuess, 1, columnIndexGuess, 1, false, false);
        ...
        {@link AccessibilityNodeInfoCompat.CollectionInfoCompat#SELECTION_MODE_NONE}.
         */
        public int getSelectionModeForAccessibility(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
            return android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat.SELECTION_MODE_NONE;
        }
         ...
         */
        public boolean isLayoutHierarchical(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
            return false;
        }

        // called by accessibility delegate
        boolean performAccessibilityAction(int action, android.os.Bundle args) {
        ...
        public boolean performAccessibilityAction(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, int action, android.os.Bundle args) {
            ...
            switch (action) {
                case android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_SCROLL_BACKWARD :
                    if (android.support.v4.view.ViewCompat.canScrollVertically(mRecyclerView, -1)) {
                        vScroll = -((getHeight() - getPaddingTop()) - getPaddingBottom());
                    }
                    if (android.support.v4.view.ViewCompat.canScrollHorizontally(mRecyclerView, -1)) {
        ...
        // called by accessibility delegate
        boolean performAccessibilityActionForItem(android.view.View view, int action, android.os.Bundle args) {
         ...
         * @see View#performAccessibilityAction(int, android.os.Bundle)
         */
        public boolean performAccessibilityActionForItem(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.view.View view, int action, android.os.Bundle args) {
            return false;
        }
         ...
         *
         * @unknown ref android.support.v7.recyclerview.R.styleable#RecyclerView_android_orientation
         * @unknown ref android.support.v7.recyclerview.R.styleable#RecyclerView_spanCount
         * @unknown ref android.support.v7.recyclerview.R.styleable#RecyclerView_reverseLayout
         * @unknown ref android.support.v7.recyclerview.R.styleable#RecyclerView_stackFromEnd
         * @return an object containing the properties as specified in the attrs.
         */
        public static android.support.v7.widget.RecyclerView.LayoutManager.Properties getProperties(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            android.support.v7.widget.RecyclerView.LayoutManager.Properties properties = new android.support.v7.widget.RecyclerView.LayoutManager.Properties();
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(R.styleable.RecyclerView_android_orientation, android.support.v7.widget.RecyclerView.VERTICAL);
        ...
        void setExactMeasureSpecsFrom(android.support.v7.widget.RecyclerView recyclerView) {
            setMeasureSpecs(android.view.View.MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), android.view.View.MeasureSpec.EXACTLY), android.view.View.MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), android.view.View.MeasureSpec.EXACTLY));
        }
    ...
    public static abstract class ItemDecoration {
         ...
         */
        @java.lang.Deprecated
        public void onDraw(android.graphics.Canvas c, android.support.v7.widget.RecyclerView parent) {
        }
         ...
         */
        @java.lang.Deprecated
        public void onDrawOver(android.graphics.Canvas c, android.support.v7.widget.RecyclerView parent) {
        }
         ...
         */
        @java.lang.Deprecated
        public void getItemOffsets(android.graphics.Rect outRect, int itemPosition, android.support.v7.widget.RecyclerView parent) {
            outRect.set(0, 0, 0, 0);
        }
        ...
        public void getItemOffsets(android.graphics.Rect outRect, android.view.View view, android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.State state) {
            getItemOffsets(outRect, ((android.support.v7.widget.RecyclerView.LayoutParams) (view.getLayoutParams())).getViewLayoutPosition(), parent);
        }
    }
    ...
    public static abstract class OnScrollListener {
         ...
         * @param newState
         * 		The updated scroll state. One of {@link #SCROLL_STATE_IDLE},
         * 		{@link #SCROLL_STATE_DRAGGING} or {@link #SCROLL_STATE_SETTLING}.
         */
    ...
    public static abstract class ViewHolder {
        ...
        int mPosition = android.support.v7.widget.RecyclerView.NO_POSITION;

        int mOldPosition = android.support.v7.widget.RecyclerView.NO_POSITION;

        long mItemId = android.support.v7.widget.RecyclerView.NO_ID;

        int mItemViewType = android.support.v7.widget.RecyclerView.INVALID_TYPE;

        int mPreLayoutPosition = android.support.v7.widget.RecyclerView.NO_POSITION;

        // The item that this holder is shadowing during an item change event/animation
        android.support.v7.widget.RecyclerView.ViewHolder mShadowedHolder = null;

        // The item that is shadowing this holder during an item change event/animation
        android.support.v7.widget.RecyclerView.ViewHolder mShadowingHolder = null;
        ...
        // scrap container.
        private android.support.v7.widget.RecyclerView.Recycler mScrapContainer = null;
        ...
        private int mWasImportantForAccessibilityBeforeHidden = android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;

        // set if we defer the accessibility state change of the view holder
        private int mPendingAccessibilityState = android.support.v7.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET;
        ...
        void flagRemovedAndOffsetPosition(int mNewPosition, int offset, boolean applyToPreLayout) {
            addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED);
            offsetPosition(offset, applyToPreLayout);
            mPosition = mNewPosition;
        }

        void offsetPosition(int offset, boolean applyToPreLayout) {
            if (mOldPosition == android.support.v7.widget.RecyclerView.NO_POSITION) {
                mOldPosition = mPosition;
            }
            if (mPreLayoutPosition == android.support.v7.widget.RecyclerView.NO_POSITION) {
            ...
            if (itemView.getLayoutParams() != null) {
                ((android.support.v7.widget.RecyclerView.LayoutParams) (itemView.getLayoutParams())).mInsetsDirty = true;
            }
        }

        void clearOldPosition() {
            mOldPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            mPreLayoutPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
        }
        ...
        boolean shouldIgnore() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_IGNORE) != 0;
        }
        ...
        public final int getPosition() {
            return mPreLayoutPosition == android.support.v7.widget.RecyclerView.NO_POSITION ? mPosition : mPreLayoutPosition;
        }
        ...
        boolean wasReturnedFromScrap() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP) != 0;
        }

        void clearReturnedFromScrapFlag() {
            mFlags = mFlags & (~android.support.v7.widget.RecyclerView.ViewHolder.FLAG_RETURNED_FROM_SCRAP);
        }

        void clearTmpDetachFlag() {
            mFlags = mFlags & (~android.support.v7.widget.RecyclerView.ViewHolder.FLAG_TMP_DETACHED);
        }

        void stopIgnoring() {
            mFlags = mFlags & (~android.support.v7.widget.RecyclerView.ViewHolder.FLAG_IGNORE);
        }

        void setScrapContainer(android.support.v7.widget.RecyclerView.Recycler recycler, boolean isChangeScrap) {
            mScrapContainer = recycler;
            mInChangeScrap = isChangeScrap;
        }

        boolean isInvalid() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID) != 0;
        }

        boolean needsUpdate() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE) != 0;
        }

        boolean isBound() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_BOUND) != 0;
        }

        boolean isRemoved() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED) != 0;
        }
        ...
        boolean isTmpDetached() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_TMP_DETACHED) != 0;
        }

        boolean isAdapterPositionUnknown() {
            return ((mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN) != 0) || isInvalid();
        }
        ...
        void addChangePayload(java.lang.Object payload) {
            if (payload == null) {
                addFlags(android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_FULLUPDATE);
            } else
                if ((mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_FULLUPDATE) == 0) {
        ...
        private void createPayloadsIfNeeded() {
            if (mPayloads == null) {
                mPayloads = new java.util.ArrayList<java.lang.Object>();
                mUnmodifiedPayloads = java.util.Collections.unmodifiableList(mPayloads);
            }
        }
        ...
        void clearPayload() {
            ...
            mFlags = mFlags & (~android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_FULLUPDATE);
        }
        ...
        java.util.List<java.lang.Object> getUnmodifiedPayloads() {
            if ((mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_FULLUPDATE) == 0) {
                if ((mPayloads == null) || (mPayloads.size() == 0)) {
                    ...
                    return android.support.v7.widget.RecyclerView.ViewHolder.FULLUPDATE_PAYLOADS;
                }
        ...
        void resetInternal() {
            ...
            mOldPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            mItemId = android.support.v7.widget.RecyclerView.NO_ID;
            mPreLayoutPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            mIsRecyclableCount = 0;
            mShadowedHolder = null;
            mShadowingHolder = null;
            clearPayload();
            mWasImportantForAccessibilityBeforeHidden = android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO;
            mPendingAccessibilityState = android.support.v7.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET;
        }

        /**
         * Called when the child view enters the hidden state
         */
        private void onEnteredHiddenState(android.support.v7.widget.RecyclerView parent) {
            // While the view item is in hidden state, make it invisible for the accessibility.
            mWasImportantForAccessibilityBeforeHidden = android.support.v4.view.ViewCompat.getImportantForAccessibility(itemView);
            parent.setChildImportantForAccessibilityInternal(this, android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_NO_HIDE_DESCENDANTS);
        }

        /**
         * Called when the child view leaves the hidden state
         */
        private void onLeftHiddenState(android.support.v7.widget.RecyclerView parent) {
        ...
        public java.lang.String toString() {
            final java.lang.StringBuilder sb = new java.lang.StringBuilder((((((((("ViewHolder{" + java.lang.Integer.toHexString(hashCode())) + " position=") + mPosition) + " id=") + mItemId) + ", oldPos=") + mOldPosition) + ", pLpos:") + mPreLayoutPosition);
            if (isScrap()) {
        ...
        public final void setIsRecyclable(boolean recyclable) {
            ...
            if (mIsRecyclableCount < 0) {
                ...
                android.util.Log.e(android.view.View.VIEW_LOG_TAG, ("isRecyclable decremented below 0: " + "unmatched pair of setIsRecyable() calls for ") + this);
            } else
                if ((!recyclable) && (mIsRecyclableCount == 1)) {
                    mFlags |= android.support.v7.widget.RecyclerView.ViewHolder.FLAG_NOT_RECYCLABLE;
                } else
                    if (recyclable && (mIsRecyclableCount == 0)) {
                        mFlags &= ~android.support.v7.widget.RecyclerView.ViewHolder.FLAG_NOT_RECYCLABLE;
                    }


            if (android.support.v7.widget.RecyclerView.DEBUG) {
                android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, (("setIsRecyclable val:" + recyclable) + ":") + this);
            }
        }
        ...
        public final boolean isRecyclable() {
            return ((mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_NOT_RECYCLABLE) == 0) && (!android.support.v4.view.ViewCompat.hasTransientState(itemView));
        }
        ...
        private boolean shouldBeKeptAsChild() {
            return (mFlags & android.support.v7.widget.RecyclerView.ViewHolder.FLAG_NOT_RECYCLABLE) != 0;
        }
     ...
     */
    @android.support.annotation.VisibleForTesting
    boolean setChildImportantForAccessibilityInternal(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int importantForAccessibility) {
        if (isComputingLayout()) {
            viewHolder.mPendingAccessibilityState = importantForAccessibility;
            mPendingAccessibilityImportanceChange.add(viewHolder);
            return false;
        }
        android.support.v4.view.ViewCompat.setImportantForAccessibility(viewHolder.itemView, importantForAccessibility);
        return true;
    }

    void dispatchPendingImportantForAccessibilityChanges() {
        for (int i = mPendingAccessibilityImportanceChange.size() - 1; i >= 0; i--) {
            android.support.v7.widget.RecyclerView.ViewHolder viewHolder = mPendingAccessibilityImportanceChange.get(i);
            if ((viewHolder.itemView.getParent() != this) || viewHolder.shouldIgnore()) {
                return;
            }
            int state = viewHolder.mPendingAccessibilityState;
            if (state != android.support.v7.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET) {
                // noinspection WrongConstant
                android.support.v4.view.ViewCompat.setImportantForAccessibility(viewHolder.itemView, state);
                viewHolder.mPendingAccessibilityState = android.support.v7.widget.RecyclerView.ViewHolder.PENDING_ACCESSIBILITY_STATE_NOT_SET;
            }
        }
        mPendingAccessibilityImportanceChange.clear();
    }

    int getAdapterPositionFor(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.hasAnyOfTheFlags((android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED) | android.support.v7.widget.RecyclerView.ViewHolder.FLAG_ADAPTER_POSITION_UNKNOWN) || (!viewHolder.isBound())) {
            return android.support.v7.widget.RecyclerView.NO_POSITION;
        }
    ...
    public static abstract class SmoothScroller {
        private int mTargetPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
        ...
        public SmoothScroller() {
            mRecyclingAction = new android.support.v7.widget.RecyclerView.SmoothScroller.Action(0, 0);
        }
         ...
         */
        void start(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.LayoutManager layoutManager) {
            mRecyclerView = recyclerView;
            mLayoutManager = layoutManager;
            if (mTargetPosition == android.support.v7.widget.RecyclerView.NO_POSITION) {
        ...
        protected final void stop() {
            ...
            onStop();
            mRecyclerView.mState.mTargetPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            mTargetView = null;
            mTargetPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
        ...
        private void onAnimation(int dx, int dy) {
            final android.support.v7.widget.RecyclerView recyclerView = mRecyclerView;
            if (((!mRunning) || (mTargetPosition == android.support.v7.widget.RecyclerView.NO_POSITION)) || (recyclerView == null)) {
                stop();
            }
            mPendingInitialRun = false;
            if (mTargetView != null) {
                ...
                if (getChildPosition(mTargetView) == mTargetPosition) {
                    ...
                    android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "Passed over target position while smooth scrolling.");
                    mTargetView = null;
                }
            }
            if (mRunning) {
        ...
        protected void onChildAttachedToWindow(android.view.View child) {
            if (getChildPosition(child) == getTargetPosition()) {
                mTargetView = child;
                if (android.support.v7.widget.RecyclerView.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.RecyclerView.TAG, "smooth scroll target view has been attached");
                }
            }
        }
         ...
         */
        protected void normalize(android.graphics.PointF scrollVector) {
            final double magnitude = java.lang.Math.sqrt((scrollVector.x * scrollVector.x) + (scrollVector.y * scrollVector.y));
         ...
         * 		update this object.
         */
        protected abstract void onSeekTargetStep(int dx, int dy, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.RecyclerView.SmoothScroller.Action action);
         ...
         */
        protected abstract void onTargetFound(android.view.View targetView, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.RecyclerView.SmoothScroller.Action action);

        /**
         * Holds information about a smooth scroll request by a {@link SmoothScroller}.
         */
        public static class Action {
            public static final int UNDEFINED_DURATION = java.lang.Integer.MIN_VALUE;
            ...
            private int mJumpToPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            ...
            public Action(int dx, int dy) {
                this(dx, dy, android.support.v7.widget.RecyclerView.SmoothScroller.Action.UNDEFINED_DURATION, null);
            }
             ...
             * 		animation step
             */
            public Action(int dx, int dy, int duration, android.view.animation.Interpolator interpolator) {
                mDx = dx;
                mDy = dy;
                mDuration = duration;
                mInterpolator = interpolator;
            ...
            void runIfNecessary(android.support.v7.widget.RecyclerView recyclerView) {
                if (mJumpToPosition >= 0) {
                    final int position = mJumpToPosition;
                    mJumpToPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
                ...
                if (changed) {
                    ...
                    if (mInterpolator == null) {
                        if (mDuration == android.support.v7.widget.RecyclerView.SmoothScroller.Action.UNDEFINED_DURATION) {
                    ...
                    if (consecutiveUpdates > 10) {
                        ...
                        android.util.Log.e(android.support.v7.widget.RecyclerView.TAG, "Smooth Scroll action is being updated too frequently. Make sure" + " you are not changing it unless necessary");
                    }
                    changed = false;
                } else {
             ...
             * 		animation step
             */
            public void update(int dx, int dy, int duration, android.view.animation.Interpolator interpolator) {
                mDx = dx;
                mDy = dy;
                mDuration = duration;
                mInterpolator = interpolator;
        ...
        public interface ScrollVectorProvider {
             ...
             */
            android.graphics.PointF computeScrollVectorForPosition(int targetPosition);
        }
    }
    ...
    public static class SavedState extends android.support.v4.view.AbsSavedState {
        ...
        SavedState(android.os.Parcel in, java.lang.ClassLoader loader) {
            super(in, loader);
            mLayoutState = in.readParcelable(loader != null ? loader : android.support.v7.widget.RecyclerView.LayoutManager.class.getClassLoader());
        }
        ...
        public static final android.os.Parcelable.Creator<android.support.v7.widget.RecyclerView.SavedState> CREATOR = android.support.v4.os.ParcelableCompat.newCreator(new android.support.v4.os.ParcelableCompatCreatorCallbacks<android.support.v7.widget.RecyclerView.SavedState>() {
            @java.lang.Override
            public android.support.v7.widget.RecyclerView.SavedState createFromParcel(android.os.Parcel in, java.lang.ClassLoader loader) {
    ...
    public static class State {
        ...
        void assertLayoutStep(int accepted) {
            if ((accepted & mLayoutStep) == 0) {
                throw new java.lang.IllegalStateException((("Layout state should be one of " + java.lang.Integer.toBinaryString(accepted)) + " but it is ") + java.lang.Integer.toBinaryString(mLayoutStep));
            }
        }

        @android.support.annotation.IntDef(flag = true, value = { android.support.v7.widget.RecyclerView.State.STEP_START, android.support.v7.widget.RecyclerView.State.STEP_LAYOUT, android.support.v7.widget.RecyclerView.State.STEP_ANIMATIONS })
        ...
        int mLayoutStep = android.support.v7.widget.RecyclerView.State.STEP_START;
        ...
        public void put(int resourceId, java.lang.Object data) {
            if (mData == null) {
                mData = new android.util.SparseArray<java.lang.Object>();
            }
        ...
        public boolean hasTargetScrollPosition() {
            return mTargetPosition != android.support.v7.widget.RecyclerView.NO_POSITION;
        }
    ...
    public static abstract class ItemAnimator {
         ...
         */
        public static final int FLAG_CHANGED = android.support.v7.widget.RecyclerView.ViewHolder.FLAG_UPDATE;
         ...
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
        public static final int FLAG_REMOVED = android.support.v7.widget.RecyclerView.ViewHolder.FLAG_REMOVED;
         ...
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
        public static final int FLAG_INVALIDATED = android.support.v7.widget.RecyclerView.ViewHolder.FLAG_INVALID;
         ...
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
        public static final int FLAG_MOVED = android.support.v7.widget.RecyclerView.ViewHolder.FLAG_MOVED;
         ...
         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
         */
        public static final int FLAG_APPEARED_IN_PRE_LAYOUT = android.support.v7.widget.RecyclerView.ViewHolder.FLAG_APPEARED_IN_PRE_LAYOUT;

        /**
         * The set of flags that might be passed to
         * {@link #recordPreLayoutInformation(State, ViewHolder, int, List)}.
         */
        @android.support.annotation.IntDef(flag = true, value = { android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_CHANGED, android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_REMOVED, android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_MOVED, android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_INVALIDATED, android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_APPEARED_IN_PRE_LAYOUT })
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
        public @interface AdapterChanges {}

        private android.support.v7.widget.RecyclerView.ItemAnimator.ItemAnimatorListener mListener = null;

        private java.util.ArrayList<android.support.v7.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener> mFinishedListeners = new java.util.ArrayList<android.support.v7.widget.RecyclerView.ItemAnimator.ItemAnimatorFinishedListener>();
         ...
         *
         * @param listener
         * 		The listener that must be called.
         */
        ...
        public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo recordPreLayoutInformation(@android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.State state, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ViewHolder viewHolder, @android.support.v7.widget.RecyclerView.ItemAnimator.AdapterChanges
        int changeFlags, @android.support.annotation.NonNull
         ...
         */
        @android.support.annotation.NonNull
        public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo recordPostLayoutInformation(@android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.State state, @android.support.annotation.NonNull
        ...
        false otherwise.
         */
        public abstract boolean animateDisappearance(@android.support.annotation.NonNull
         ...
         * @param postLayoutInfo
         * 		The information that was returned from {@link #recordPreLayoutInformation(State, ViewHolder, int, List)}.
         * @return true if a later call to {@link #runPendingAnimations()} is requested,
        false otherwise.
         */
        public abstract boolean animateAppearance(@android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ViewHolder viewHolder, @android.support.annotation.Nullable
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
        ...
        false otherwise.
         */
        public abstract boolean animatePersistence(@android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ViewHolder viewHolder, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
        ...
        false otherwise.
         */
        public abstract boolean animateChange(@android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ViewHolder oldHolder, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ViewHolder newHolder, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @android.support.annotation.NonNull
        android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo);
        ...
        static int buildAdapterChangeFlagsForAnimations(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            int flags = viewHolder.mFlags & ((android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_INVALIDATED | android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_REMOVED) | android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_CHANGED);
            if (viewHolder.isInvalid()) {
                return android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_INVALIDATED;
            }
            if ((flags & android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_INVALIDATED) == 0) {
                final int oldPos = viewHolder.getOldPosition();
                final int pos = viewHolder.getAdapterPosition();
                if (((oldPos != android.support.v7.widget.RecyclerView.NO_POSITION) && (pos != android.support.v7.widget.RecyclerView.NO_POSITION)) && (oldPos != pos)) {
                    flags |= android.support.v7.widget.RecyclerView.ItemAnimator.FLAG_MOVED;
                }
            }
            return flags;
        }
         ...
         */
        public abstract void endAnimation(android.support.v7.widget.RecyclerView.ViewHolder item);
        ...
        public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo obtainHolderInfo() {
            return new android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo();
        }
        ...
        interface ItemAnimatorListener {
            void onAnimationFinished(android.support.v7.widget.RecyclerView.ViewHolder item);
        }
        ...
        public static class ItemHolderInfo {
             ...
             * @return This {@link ItemHolderInfo}
             */
            public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo setFrom(android.support.v7.widget.RecyclerView.ViewHolder holder, @android.support.v7.widget.RecyclerView.ItemAnimator.AdapterChanges
            int flags) {
    ...
    private android.support.v4.view.NestedScrollingChildHelper getScrollingChildHelper() {
        if (mScrollingChildHelper == null) {
            mScrollingChildHelper = new android.support.v4.view.NestedScrollingChildHelper(this);
        }
