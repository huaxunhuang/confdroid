 ...
 */
class DropDownListView extends android.support.v7.widget.ListViewCompat {
     ...
     * 		this view's context
     */
    public DropDownListView(android.content.Context context, boolean hijackFocus) {
     ...
     */
    public boolean onForwardedEvent(android.view.MotionEvent event, int activePointerId) {
        boolean handledEvent = true;
        boolean clearPressedItem = false;
        final int actionMasked = android.support.v4.view.MotionEventCompat.getActionMasked(event);
        switch (actionMasked) {
        ...
        if (handledEvent) {
            if (mScrollHelper == null) {
                mScrollHelper = new android.support.v4.widget.ListViewAutoScrollHelper(this);
            }
     ...
     */
    private void clickPressedItem(final android.view.View child, final int position) {
    ...
    private void clearPressedItem() {
        ...
        final android.view.View motionView = getChildAt(mMotionPosition - getFirstVisiblePosition());
        if (motionView != null) {
    ...
    private void setPressedItem(android.view.View child, int position, float x, float y) {
        ...
        if (mMotionPosition != android.support.v7.widget.ListViewCompat.INVALID_POSITION) {
            final android.view.View motionView = getChildAt(mMotionPosition - getFirstVisiblePosition());
