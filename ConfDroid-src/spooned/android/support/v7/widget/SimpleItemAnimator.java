...
public abstract class SimpleItemAnimator extends android.support.v7.widget.RecyclerView.ItemAnimator {
     ...
     *
     * @param supportsChangeAnimations
    ...
    @java.lang.Override
    public boolean animateDisappearance(@android.support.annotation.NonNull
    ...
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
        ...
        if ((!viewHolder.isRemoved()) && ((oldLeft != newLeft) || (oldTop != newTop))) {
            ...
            if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
                android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("DISAPPEARING: " + viewHolder) + " with view ") + disappearingItemView);
            }
            return animateMove(viewHolder, oldLeft, oldTop, newLeft, newTop);
        } else {
            if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
                android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("REMOVED: " + viewHolder) + " with view ") + disappearingItemView);
            }
    ...
    @java.lang.Override
    public boolean animateAppearance(@android.support.annotation.NonNull
    ...
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
        if ((preLayoutInfo != null) && ((preLayoutInfo.left != postLayoutInfo.left) || (preLayoutInfo.top != postLayoutInfo.top))) {
            ...
            if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
                android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("APPEARING: " + viewHolder) + " with view ") + viewHolder);
            }
            return animateMove(viewHolder, preLayoutInfo.left, preLayoutInfo.top, postLayoutInfo.left, postLayoutInfo.top);
        } else {
            if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
                android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("ADDED: " + viewHolder) + " with view ") + viewHolder);
            }
    ...
    @java.lang.Override
    public boolean animatePersistence(@android.support.annotation.NonNull
    android.support.v7.widget.RecyclerView.ViewHolder viewHolder, @android.support.annotation.NonNull
    ...
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo) {
        if ((preInfo.left != postInfo.left) || (preInfo.top != postInfo.top)) {
            if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
                android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("PERSISTENT: " + viewHolder) + " with view ") + viewHolder.itemView);
            }
    ...
    @java.lang.Override
    public boolean animateChange(@android.support.annotation.NonNull
    ...
    android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo) {
        if (android.support.v7.widget.SimpleItemAnimator.DEBUG) {
            android.util.Log.d(android.support.v7.widget.SimpleItemAnimator.TAG, (("CHANGED: " + oldHolder) + " with view ") + oldHolder.itemView);
        }
    ...
    false otherwise.
     */
    public abstract boolean animateRemove(android.support.v7.widget.RecyclerView.ViewHolder holder);
    ...
    false otherwise.
     */
    public abstract boolean animateAdd(android.support.v7.widget.RecyclerView.ViewHolder holder);
    ...
    false otherwise.
     */
    public abstract boolean animateMove(android.support.v7.widget.RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY);
    ...
    false otherwise.
     */
    public abstract boolean animateChange(android.support.v7.widget.RecyclerView.ViewHolder oldHolder, android.support.v7.widget.RecyclerView.ViewHolder newHolder, int fromLeft, int fromTop, int toLeft, int toTop);
    ...
    ItemHolderInfo)
     */
    public final void dispatchRemoveFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
     ...
     */
    public final void dispatchMoveFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
        onMoveFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     */
    public final void dispatchAddFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
        onAddFinished(item);
        dispatchAnimationFinished(item);
    }
     ...
     */
    public final void dispatchChangeFinished(android.support.v7.widget.RecyclerView.ViewHolder item, boolean oldItem) {
     ...
     */
    public final void dispatchRemoveStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
     ...
     */
    public final void dispatchMoveStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
        onMoveStarting(item);
    }
     ...
     */
    public final void dispatchAddStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
        onAddStarting(item);
    }
     ...
     * 		it is the new item that replaced the old item.
     */
    public final void dispatchChangeStarting(android.support.v7.widget.RecyclerView.ViewHolder item, boolean oldItem) {
    ...
    public void onRemoveStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     * 		The ViewHolder being animated.
     */
    public void onRemoveFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     */
    @java.lang.SuppressWarnings("UnusedParameters")
    public void onAddStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     * 		The ViewHolder being animated.
     */
    public void onAddFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     */
    @java.lang.SuppressWarnings("UnusedParameters")
    public void onMoveStarting(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     * 		The ViewHolder being animated.
     */
    public void onMoveFinished(android.support.v7.widget.RecyclerView.ViewHolder item) {
    }
     ...
     */
    @java.lang.SuppressWarnings("UnusedParameters")
    public void onChangeStarting(android.support.v7.widget.RecyclerView.ViewHolder item, boolean oldItem) {
    }
     ...
     * 		it is the new item that replaced the old item.
     */
    public void onChangeFinished(android.support.v7.widget.RecyclerView.ViewHolder item, boolean oldItem) {
    }
}
