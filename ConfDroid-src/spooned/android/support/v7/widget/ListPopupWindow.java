...
public class ListPopupWindow implements android.support.v7.view.menu.ShowableListMenu {
    ...
    static {
        try {
            android.support.v7.widget.ListPopupWindow.sClipToWindowEnabledMethod = android.widget.PopupWindow.class.getDeclaredMethod("setClipToScreenEnabled", boolean.class);
        } catch (java.lang.NoSuchMethodException e) {
            android.util.Log.i(android.support.v7.widget.ListPopupWindow.TAG, "Could not find method setClipToScreenEnabled() on PopupWindow. Oh well.");
        }
        try {
            android.support.v7.widget.ListPopupWindow.sGetMaxAvailableHeightMethod = android.widget.PopupWindow.class.getDeclaredMethod("getMaxAvailableHeight", android.view.View.class, int.class, boolean.class);
        } catch (java.lang.NoSuchMethodException e) {
            android.util.Log.i(android.support.v7.widget.ListPopupWindow.TAG, "Could not find method getMaxAvailableHeight(View, int, boolean)" + " on PopupWindow. Oh well.");
        }
        try {
            android.support.v7.widget.ListPopupWindow.sSetEpicenterBoundsMethod = android.widget.PopupWindow.class.getDeclaredMethod("setEpicenterBounds", android.graphics.Rect.class);
        } catch (java.lang.NoSuchMethodException e) {
            android.util.Log.i(android.support.v7.widget.ListPopupWindow.TAG, "Could not find method setEpicenterBounds(Rect) on PopupWindow. Oh well.");
        }
    }
    ...
    private int mPromptPosition = android.support.v7.widget.ListPopupWindow.POSITION_PROMPT_ABOVE;
    ...
    final android.support.v7.widget.ListPopupWindow.ResizePopupRunnable mResizePopupRunnable = new android.support.v7.widget.ListPopupWindow.ResizePopupRunnable();

    private final android.support.v7.widget.ListPopupWindow.PopupTouchInterceptor mTouchInterceptor = new android.support.v7.widget.ListPopupWindow.PopupTouchInterceptor();

    private final android.support.v7.widget.ListPopupWindow.PopupScrollListener mScrollListener = new android.support.v7.widget.ListPopupWindow.PopupScrollListener();

    private final android.support.v7.widget.ListPopupWindow.ListSelectorHider mHideSelector = new android.support.v7.widget.ListPopupWindow.ListSelectorHider();
     ...
     */
    public ListPopupWindow(@android.support.annotation.NonNull
    ...
    int defStyleRes) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 11) {
            mPopup = new android.support.v7.widget.AppCompatPopupWindow(context, attrs, defStyleAttr, defStyleRes);
        } else {
            mPopup = new android.support.v7.widget.AppCompatPopupWindow(context, attrs, defStyleAttr);
        }
     ...
     */
    public void setAdapter(@android.support.annotation.Nullable
    android.widget.ListAdapter adapter) {
        if (mObserver == null) {
            mObserver = new android.support.v7.widget.ListPopupWindow.PopupDataSetObserver();
        } else
            if (mAdapter != null) {
     ...
     */
    public void setAnimationStyle(@android.support.annotation.StyleRes
    int animationStyle) {
     ...
     */
    public void setAnchorView(@android.support.annotation.Nullable
     ...
     */
    public void setOnItemSelectedListener(@android.support.annotation.Nullable
     ...
     */
    public void setPromptView(@android.support.annotation.Nullable
    ...
    public void show() {
        ...
        android.support.v4.widget.PopupWindowCompat.setWindowLayoutType(mPopup, mDropDownWindowLayoutType);
        if (mPopup.isShowing()) {
            final int widthSpec;
            ...
            if (android.support.v7.widget.ListPopupWindow.sSetEpicenterBoundsMethod != null) {
                try {
                    android.support.v7.widget.ListPopupWindow.sSetEpicenterBoundsMethod.invoke(mPopup, mEpicenterBounds);
                } catch (java.lang.Exception e) {
                    android.util.Log.e(android.support.v7.widget.ListPopupWindow.TAG, "Could not invoke setEpicenterBounds on PopupWindow", e);
                }
            }
            android.support.v4.widget.PopupWindowCompat.showAsDropDown(mPopup, getAnchorView(), mDropDownHorizontalOffset, mDropDownVerticalOffset, mDropDownGravity);
    ...
    public void setSelection(int position) {
        android.support.v7.widget.DropDownListView list = mDropDownList;
    ...
    public void clearListSelection() {
        final android.support.v7.widget.DropDownListView list = mDropDownList;
        if (list != null) {
    ...
    public boolean isInputMethodNotNeeded() {
        return mPopup.getInputMethodMode() == android.support.v7.widget.ListPopupWindow.INPUT_METHOD_NOT_NEEDED;
    }
    ...
    android.support.v7.widget.DropDownListView createDropDownListView(android.content.Context context, boolean hijackFocus) {
        return new android.support.v7.widget.DropDownListView(context, hijackFocus);
    }
    ...
    android.view.KeyEvent event) {
        ...
        if (isShowing()) {
            ...
            if ((keyCode != android.view.KeyEvent.KEYCODE_SPACE) && ((mDropDownList.getSelectedItemPosition() >= 0) || (!android.support.v7.widget.ListPopupWindow.isConfirmKey(keyCode)))) {
                ...
                if (android.support.v7.widget.ListPopupWindow.DEBUG)
                    android.util.Log.v(android.support.v7.widget.ListPopupWindow.TAG, (("Key down: code=" + keyCode) + " list consumed=") + consumed);
     ...
     * @see #setModal(boolean)
     */
    public boolean onKeyUp(int keyCode, @android.support.annotation.NonNull
    android.view.KeyEvent event) {
        if (isShowing() && (mDropDownList.getSelectedItemPosition() >= 0)) {
            boolean consumed = mDropDownList.onKeyUp(keyCode, event);
            if (consumed && android.support.v7.widget.ListPopupWindow.isConfirmKey(keyCode)) {
     ...
     * @see #setModal(boolean)
     */
    public boolean onKeyPreIme(int keyCode, @android.support.annotation.NonNull
    android.view.KeyEvent event) {
    ...
    public android.view.View.OnTouchListener createDragToOpenListener(android.view.View src) {
        return new android.support.v7.widget.ForwardingListener(src) {
            @java.lang.Override
            public android.support.v7.widget.ListPopupWindow getPopup() {
                return android.support.v7.widget.ListPopupWindow.this;
            }
        };
    }
    ...
    private int buildDropDown() {
        ...
        if (mDropDownList == null) {
            ...
            mDropDownList.setOnItemSelectedListener(new android.widget.AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(android.widget.AdapterView<?> parent, android.view.View view, int position, long id) {
                    if (position != (-1)) {
                        android.support.v7.widget.DropDownListView dropDownList = mDropDownList;
            ...
            if (hintView != null) {
                ...
                switch (mPromptPosition) {
                    case android.support.v7.widget.ListPopupWindow.POSITION_PROMPT_BELOW :
                        hintContainer.addView(dropDownView, hintParams);
                        hintContainer.addView(hintView);
                        break;
                    case android.support.v7.widget.ListPopupWindow.POSITION_PROMPT_ABOVE :
                        hintContainer.addView(hintView);
                        hintContainer.addView(dropDownView, hintParams);
                        break;
                    default :
                        android.util.Log.e(android.support.v7.widget.ListPopupWindow.TAG, "Invalid hint position " + mPromptPosition);
                        break;
                }
        ...
        final int listContent = mDropDownList.measureHeightOfChildrenCompat(childWidthSpec, 0, android.support.v7.widget.DropDownListView.NO_POSITION, maxHeight - otherHeights, -1);
        if (listContent > 0) {
    ...
    private class ResizePopupRunnable implements java.lang.Runnable {
        ...
        @java.lang.Override
        public void run() {
            if ((((mDropDownList != null) && android.support.v4.view.ViewCompat.isAttachedToWindow(mDropDownList)) && (mDropDownList.getCount() > mDropDownList.getChildCount())) && (mDropDownList.getChildCount() <= mListItemExpandMaximum)) {
                mPopup.setInputMethodMode(android.widget.PopupWindow.INPUT_METHOD_NOT_NEEDED);
                show();
            }
        }
    ...
    private class PopupTouchInterceptor implements android.view.View.OnTouchListener {
        ...
        public boolean onTouch(android.view.View v, android.view.MotionEvent event) {
            ...
            if ((((action == android.view.MotionEvent.ACTION_DOWN) && (mPopup != null)) && mPopup.isShowing()) && ((((x >= 0) && (x < mPopup.getWidth())) && (y >= 0)) && (y < mPopup.getHeight()))) {
                mHandler.postDelayed(mResizePopupRunnable, android.support.v7.widget.ListPopupWindow.EXPAND_LIST_TIMEOUT);
            } else
    ...
    private static boolean isConfirmKey(int keyCode) {
        return (keyCode == android.view.KeyEvent.KEYCODE_ENTER) || (keyCode == android.view.KeyEvent.KEYCODE_DPAD_CENTER);
    }
    ...
    private void setPopupClipToScreenEnabled(boolean clip) {
        if (android.support.v7.widget.ListPopupWindow.sClipToWindowEnabledMethod != null) {
            try {
                android.support.v7.widget.ListPopupWindow.sClipToWindowEnabledMethod.invoke(mPopup, clip);
            } catch (java.lang.Exception e) {
                android.util.Log.i(android.support.v7.widget.ListPopupWindow.TAG, "Could not call setClipToScreenEnabled() on PopupWindow. Oh well.");
            }
        }
    }

    private int getMaxAvailableHeight(android.view.View anchor, int yOffset, boolean ignoreBottomDecorations) {
        if (android.support.v7.widget.ListPopupWindow.sGetMaxAvailableHeightMethod != null) {
            try {
                return ((int) (android.support.v7.widget.ListPopupWindow.sGetMaxAvailableHeightMethod.invoke(mPopup, anchor, yOffset, ignoreBottomDecorations)));
            } catch (java.lang.Exception e) {
                android.util.Log.i(android.support.v7.widget.ListPopupWindow.TAG, "Could not call getMaxAvailableHeightMethod(View, int, boolean)" + " on PopupWindow. Using the public version.");
            }
        }
