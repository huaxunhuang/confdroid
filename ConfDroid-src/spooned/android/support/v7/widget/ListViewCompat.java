...
public class ListViewCompat extends android.widget.ListView {
    ...
    final android.graphics.Rect mSelectorRect = new android.graphics.Rect();
    ...
    private android.support.v7.widget.ListViewCompat.GateKeeperDrawable mSelector;
    ...
    public ListViewCompat(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mIsChildViewEnabled = android.widget.AbsListView.class.getDeclaredField("mIsChildViewEnabled");
    ...
    public void setSelector(android.graphics.drawable.Drawable sel) {
        mSelector = (sel != null) ? new android.support.v7.widget.ListViewCompat.GateKeeperDrawable(sel) : null;
    ...
    protected void drawSelectorCompat(android.graphics.Canvas canvas) {
        if (!mSelectorRect.isEmpty()) {
            final android.graphics.drawable.Drawable selector = getSelector();
            if (selector != null) {
    ...
    public int lookForSelectablePosition(int position, boolean lookDown) {
        ...
        if ((adapter == null) || isInTouchMode()) {
            return android.support.v7.widget.ListViewCompat.INVALID_POSITION;
        }
    ...
    protected void positionSelectorLikeTouchCompat(int position, android.view.View sel, float x, float y) {
        positionSelectorLikeFocusCompat(position, sel);
        android.graphics.drawable.Drawable selector = getSelector();
        if ((selector != null) && (position != android.support.v7.widget.ListViewCompat.INVALID_POSITION)) {
            android.support.v4.graphics.drawable.DrawableCompat.setHotspot(selector, x, y);
        }
    }

    protected void positionSelectorLikeFocusCompat(int position, android.view.View sel) {
        ...
        final android.graphics.drawable.Drawable selector = getSelector();
        final boolean manageState = (selector != null) && (position != android.support.v7.widget.ListViewCompat.INVALID_POSITION);
        if (manageState) {
        ...
        if (manageState) {
            ...
            selector.setVisible(getVisibility() == android.view.View.VISIBLE, false);
            android.support.v4.graphics.drawable.DrawableCompat.setHotspot(selector, x, y);
        }
    }

    protected void positionSelectorCompat(int position, android.view.View sel) {
     ...
     * 		In general, whether the returned height should only
    ...
    public int measureHeightOfChildrenCompat(int widthMeasureSpec, int startPosition, int endPosition, final int maxHeight, int disallowPartialChildPosition) {
        ...
        final android.graphics.drawable.Drawable divider = getDivider();
        final android.widget.ListAdapter adapter = getAdapter();
        if (adapter == null) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            android.view.ViewGroup.LayoutParams childLp = child.getLayoutParams();
            if (childLp == null) {
                childLp = generateDefaultLayoutParams();
                child.setLayoutParams(childLp);
            }
            if (childLp.height > 0) {
                heightMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(childLp.height, android.view.View.MeasureSpec.EXACTLY);
            } else {
                heightMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(0, android.view.View.MeasureSpec.UNSPECIFIED);
            }
