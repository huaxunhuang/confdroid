...
public class ActivityChooserView extends android.view.ViewGroup implements android.support.v7.widget.ActivityChooserModel.ActivityChooserModelClient {
     ...
     */
    final android.database.DataSetObserver mModelDataSetObserver = new android.database.DataSetObserver() {
        @java.lang.Override
     ...
     */
    int mInitialActivityCount = android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_DEFAULT;
    ...
    public ActivityChooserView(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        ...
        android.content.res.TypedArray attributesArray = context.obtainStyledAttributes(attrs, R.styleable.ActivityChooserView, defStyle, 0);
        mInitialActivityCount = attributesArray.getInt(R.styleable.ActivityChooserView_initialActivityCount, android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_DEFAULT);
        ...
        mCallbacks = new android.support.v7.widget.ActivityChooserView.Callbacks();
        mActivityChooserContent = ((android.support.v7.widget.LinearLayoutCompat) (findViewById(R.id.activity_chooser_view_content)));
        ...
        mDefaultActivityButtonImage = ((android.widget.ImageView) (mDefaultActivityButton.findViewById(R.id.image)));
        ...
        expandButton.setOnTouchListener(new android.support.v7.widget.ForwardingListener(expandButton) {
            @java.lang.Override
        ...
        mExpandActivityOverflowButtonImage = ((android.widget.ImageView) (expandButton.findViewById(R.id.image)));
        mExpandActivityOverflowButtonImage.setImageDrawable(expandActivityOverflowButtonDrawable);
        mAdapter = new android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter();
        ...
        mListPopupMaxWidth = java.lang.Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
    }
    ...
    public void setExpandActivityOverflowButtonContentDescription(int resourceId) {
        java.lang.CharSequence contentDescription = getContext().getString(resourceId);
     ...
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    public void setProvider(android.support.v4.view.ActionProvider provider) {
        mProvider = provider;
    }
    ...
    void showPopupUnchecked(int maxActivityCount) {
        ...
        if ((maxActivityCount != android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED) && (activityCount > (maxActivityCount + maxActivityCountOffset))) {
        ...
        android.support.v7.widget.ListPopupWindow popupWindow = getListPopupWindow();
    ...
    protected void onAttachedToWindow() {
        ...
        android.support.v7.widget.ActivityChooserModel dataModel = mAdapter.getDataModel();
        if (dataModel != null) {
    ...
    android.support.v7.widget.ListPopupWindow getListPopupWindow() {
        if (mListPopupWindow == null) {
            mListPopupWindow = new android.support.v7.widget.ListPopupWindow(getContext());
    ...
    void updateAppearance() {
        ...
        if ((activityCount == 1) || ((activityCount > 1) && (historySize > 0))) {
            ...
            if (mDefaultActionButtonContentDescription != 0) {
                ...
                java.lang.String contentDescription = getContext().getString(mDefaultActionButtonContentDescription, label);
    ...
    private class Callbacks implements android.view.View.OnClickListener , android.view.View.OnLongClickListener , android.widget.AdapterView.OnItemClickListener , android.widget.PopupWindow.OnDismissListener {
        ...
        public void onItemClick(android.widget.AdapterView<?> parent, android.view.View view, int position, long id) {
            android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter adapter = ((android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter) (parent.getAdapter()));
            final int itemViewType = adapter.getItemViewType(position);
            switch (itemViewType) {
                case android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_FOOTER :
                    {
                        showPopupUnchecked(android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
                    }
                    break;
                case android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_ACTIVITY :
                    {
                        dismissPopup();
    ...
    private class ActivityChooserViewAdapter extends android.widget.BaseAdapter {
        ...
        private int mMaxActivityCount = android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_DEFAULT;
        ...
        public void setDataModel(android.support.v7.widget.ActivityChooserModel dataModel) {
            android.support.v7.widget.ActivityChooserModel oldDataModel = mAdapter.getDataModel();
        ...
        public int getItemViewType(int position) {
            if (mShowFooterView && (position == (getCount() - 1))) {
                return android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_FOOTER;
            } else {
                return android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_ACTIVITY;
            }
        }

        @java.lang.Override
        public int getViewTypeCount() {
            return android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_COUNT;
        }
        ...
        public android.view.View getView(int position, android.view.View convertView, android.view.ViewGroup parent) {
            ...
            switch (itemViewType) {
                case android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_FOOTER :
                    if ((convertView == null) || (convertView.getId() != android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_FOOTER)) {
                        convertView = android.view.LayoutInflater.from(getContext()).inflate(R.layout.abc_activity_chooser_view_list_item, parent, false);
                        convertView.setId(android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_FOOTER);
                        android.widget.TextView titleView = ((android.widget.TextView) (convertView.findViewById(R.id.title)));
                ...
                case android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.ITEM_VIEW_TYPE_ACTIVITY :
                    ...
                    android.content.pm.PackageManager packageManager = getContext().getPackageManager();
                    // Set the icon
                    android.widget.ImageView iconView = ((android.widget.ImageView) (convertView.findViewById(R.id.icon)));
                    ...
                    if ((mShowDefaultActivity && (position == 0)) && mHighlightDefaultActivity) {
                        android.support.v4.view.ViewCompat.setActivated(convertView, true);
                    } else {
                        android.support.v4.view.ViewCompat.setActivated(convertView, false);
                    }
                    return convertView;
                default :
                    throw new java.lang.IllegalArgumentException();
        ...
        public int measureContentWidth() {
            ...
            mMaxActivityCount = android.support.v7.widget.ActivityChooserView.ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED;
            int contentWidth = 0;
     ...
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    public static class InnerLayout extends android.support.v7.widget.LinearLayoutCompat {
        private static final int[] TINT_ATTRS = new int[]{ android.R.attr.background };

        public InnerLayout(android.content.Context context, android.util.AttributeSet attrs) {
            super(context, attrs);
            android.support.v7.widget.TintTypedArray a = android.support.v7.widget.TintTypedArray.obtainStyledAttributes(context, attrs, android.support.v7.widget.ActivityChooserView.InnerLayout.TINT_ATTRS);
