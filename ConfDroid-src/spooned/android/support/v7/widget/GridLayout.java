 ...
 * @unknown name android:rowCount
 * @unknown name android:columnCount
 * @unknown name android:useDefaultMargins
 * @unknown name android:rowOrderPreserved
 * @unknown name android:columnOrderPreserved
 */
public class GridLayout extends android.view.ViewGroup {
     ...
     */
    public static final int UNDEFINED = java.lang.Integer.MIN_VALUE;
    ...
    static final android.util.Printer LOG_PRINTER = new android.util.LogPrinter(android.util.Log.DEBUG, android.support.v7.widget.GridLayout.class.getName());

    static final android.util.Printer NO_PRINTER = new android.util.Printer() {
        @java.lang.Override
    ...
    // Defaults
    private static final int DEFAULT_ORIENTATION = android.support.v7.widget.GridLayout.HORIZONTAL;

    private static final int DEFAULT_COUNT = android.support.v7.widget.GridLayout.UNDEFINED;

    private static final boolean DEFAULT_USE_DEFAULT_MARGINS = false;

    static final boolean DEFAULT_ORDER_PRESERVED = true;

    private static final int DEFAULT_ALIGNMENT_MODE = android.support.v7.widget.GridLayout.ALIGN_MARGINS;
    ...
    // Instance variables
    final android.support.v7.widget.GridLayout.Axis mHorizontalAxis = new android.support.v7.widget.GridLayout.Axis(true);

    final android.support.v7.widget.GridLayout.Axis mVerticalAxis = new android.support.v7.widget.GridLayout.Axis(false);

    int mOrientation = android.support.v7.widget.GridLayout.DEFAULT_ORIENTATION;

    boolean mUseDefaultMargins = android.support.v7.widget.GridLayout.DEFAULT_USE_DEFAULT_MARGINS;

    int mAlignmentMode = android.support.v7.widget.GridLayout.DEFAULT_ALIGNMENT_MODE;

    int mDefaultGap;

    int mLastLayoutParamsHashCode = android.support.v7.widget.GridLayout.UNINITIALIZED_HASH;

    android.util.Printer mPrinter = android.support.v7.widget.GridLayout.LOG_PRINTER;
    ...
    public GridLayout(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        ...
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GridLayout);
        try {
            setRowCount(a.getInt(android.support.v7.widget.GridLayout.ROW_COUNT, android.support.v7.widget.GridLayout.DEFAULT_COUNT));
            setColumnCount(a.getInt(android.support.v7.widget.GridLayout.COLUMN_COUNT, android.support.v7.widget.GridLayout.DEFAULT_COUNT));
            setOrientation(a.getInt(android.support.v7.widget.GridLayout.ORIENTATION, android.support.v7.widget.GridLayout.DEFAULT_ORIENTATION));
            setUseDefaultMargins(a.getBoolean(android.support.v7.widget.GridLayout.USE_DEFAULT_MARGINS, android.support.v7.widget.GridLayout.DEFAULT_USE_DEFAULT_MARGINS));
            setAlignmentMode(a.getInt(android.support.v7.widget.GridLayout.ALIGNMENT_MODE, android.support.v7.widget.GridLayout.DEFAULT_ALIGNMENT_MODE));
            setRowOrderPreserved(a.getBoolean(android.support.v7.widget.GridLayout.ROW_ORDER_PRESERVED, android.support.v7.widget.GridLayout.DEFAULT_ORDER_PRESERVED));
            setColumnOrderPreserved(a.getBoolean(android.support.v7.widget.GridLayout.COLUMN_ORDER_PRESERVED, android.support.v7.widget.GridLayout.DEFAULT_ORDER_PRESERVED));
        } finally {
            a.recycle();
        }
    }
     ...
     * @see #ALIGN_MARGINS
     * @see #setAlignmentMode(int)
     * @unknown name android:alignmentMode
     */
     ...
     * 		{@code true} to force GridLayout to respect the order
     * 		of row boundaries
     ...
     * 		use {@code true} to force GridLayout to respect the order
    ...
    public void setPrinter(android.util.Printer printer) {
        this.mPrinter = (printer == null) ? android.support.v7.widget.GridLayout.NO_PRINTER : printer;
    }
    ...
    static int max2(int[] a, int valueIfEmpty) {
        ...
        for (int i = 0, N = a.length; i < N; i++) {
            result = java.lang.Math.max(result, a[i]);
        }
        return result;
    }
    ...
    static android.support.v7.widget.GridLayout.Alignment getAlignment(int gravity, boolean horizontal) {
        int mask = (horizontal) ? android.view.Gravity.HORIZONTAL_GRAVITY_MASK : android.view.Gravity.VERTICAL_GRAVITY_MASK;
        int shift = (horizontal) ? android.view.Gravity.AXIS_X_SHIFT : android.view.Gravity.AXIS_Y_SHIFT;
        int flags = (gravity & mask) >> shift;
        switch (flags) {
            case android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_BEFORE :
                return horizontal ? android.support.v7.widget.GridLayout.LEFT : android.support.v7.widget.GridLayout.TOP;
            case android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_AFTER :
                return horizontal ? android.support.v7.widget.GridLayout.RIGHT : android.support.v7.widget.GridLayout.BOTTOM;
            case (android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_BEFORE) | android.view.Gravity.AXIS_PULL_AFTER :
                return android.support.v7.widget.GridLayout.FILL;
            case android.view.Gravity.AXIS_SPECIFIED :
                return android.support.v7.widget.GridLayout.CENTER;
            case (android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_BEFORE) | android.support.v4.view.GravityCompat.RELATIVE_LAYOUT_DIRECTION :
                return android.support.v7.widget.GridLayout.START;
            case (android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_AFTER) | android.support.v4.view.GravityCompat.RELATIVE_LAYOUT_DIRECTION :
                return android.support.v7.widget.GridLayout.END;
            default :
                return android.support.v7.widget.GridLayout.UNDEFINED_ALIGNMENT;
        }
    }
    ...
    private int getDefaultMargin(android.view.View c, boolean isAtEdge, boolean horizontal, boolean leading) {
        /* isAtEdge ? DEFAULT_CONTAINER_MARGIN : */
    ...
    private int getDefaultMargin(android.view.View c, android.support.v7.widget.GridLayout.LayoutParams p, boolean horizontal, boolean leading) {
        ...
        android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? p.columnSpec : p.rowSpec;
        android.support.v7.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
        android.support.v7.widget.GridLayout.Interval span = spec.span;
    ...
    int getMargin1(android.view.View view, boolean horizontal, boolean leading) {
        android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(view);
        int margin = (horizontal) ? leading ? lp.leftMargin : lp.rightMargin : leading ? lp.topMargin : lp.bottomMargin;
        return margin == android.support.v7.widget.GridLayout.UNDEFINED ? getDefaultMargin(view, lp, horizontal, leading) : margin;
    }
    ...
    private int getMargin(android.view.View view, boolean horizontal, boolean leading) {
        if (mAlignmentMode == android.support.v7.widget.GridLayout.ALIGN_MARGINS) {
            return getMargin1(view, horizontal, leading);
        } else {
            android.support.v7.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
            int[] margins = (leading) ? axis.getLeadingMargins() : axis.getTrailingMargins();
            android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(view);
            android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
    ...
    private static void procrusteanFill(int[] a, int start, int end, int value) {
        int length = a.length;
        java.util.Arrays.fill(a, java.lang.Math.min(start, length), java.lang.Math.min(end, length), value);
    }
    ...
    private static void setCellGroup(android.support.v7.widget.GridLayout.LayoutParams lp, int row, int rowSpan, int col, int colSpan) {
        lp.setRowSpecSpan(new android.support.v7.widget.GridLayout.Interval(row, row + rowSpan));
        lp.setColumnSpecSpan(new android.support.v7.widget.GridLayout.Interval(col, col + colSpan));
    }
    ...
    private static int clip(android.support.v7.widget.GridLayout.Interval minorRange, boolean minorWasDefined, int count) {
        ...
        int min = (minorWasDefined) ? java.lang.Math.min(minorRange.min, count) : 0;
        return java.lang.Math.min(size, count - min);
    }

    // install default indices for cells that don't define them
    private void validateLayoutParams() {
        final boolean horizontal = mOrientation == android.support.v7.widget.GridLayout.HORIZONTAL;
        final android.support.v7.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
        final int count = (axis.definedCount != android.support.v7.widget.GridLayout.UNDEFINED) ? axis.definedCount : 0;
        int major = 0;
        int minor = 0;
        int[] maxSizes = new int[count];
        for (int i = 0, N = getChildCount(); i < N; i++) {
            android.support.v7.widget.GridLayout.LayoutParams lp = ((android.support.v7.widget.GridLayout.LayoutParams) (getChildAt(i).getLayoutParams()));
            final android.support.v7.widget.GridLayout.Spec majorSpec = (horizontal) ? lp.rowSpec : lp.columnSpec;
            final android.support.v7.widget.GridLayout.Interval majorRange = majorSpec.span;
            final boolean majorWasDefined = majorSpec.startDefined;
            final int majorSpan = majorRange.size();
            if (majorWasDefined) {
                major = majorRange.min;
            }
            final android.support.v7.widget.GridLayout.Spec minorSpec = (horizontal) ? lp.columnSpec : lp.rowSpec;
            final android.support.v7.widget.GridLayout.Interval minorRange = minorSpec.span;
            final boolean minorWasDefined = minorSpec.startDefined;
            final int minorSpan = android.support.v7.widget.GridLayout.clip(minorRange, minorWasDefined, count);
            if (minorWasDefined) {
            ...
            if (count != 0) {
                ...
                if ((!majorWasDefined) || (!minorWasDefined)) {
                    while (!android.support.v7.widget.GridLayout.fits(maxSizes, major, minor, minor + minorSpan)) {
                        if (minorWasDefined) {
                            major++;
                        } else {
                ...
                android.support.v7.widget.GridLayout.procrusteanFill(maxSizes, minor, minor + minorSpan, major + majorSpan);
            }
            if (horizontal) {
                android.support.v7.widget.GridLayout.setCellGroup(lp, major, majorSpan, minor, minorSpan);
            } else {
                android.support.v7.widget.GridLayout.setCellGroup(lp, minor, minorSpan, major, majorSpan);
            }
    ...
    private void invalidateStructure() {
        mLastLayoutParamsHashCode = android.support.v7.widget.GridLayout.UNINITIALIZED_HASH;
    ...
    final android.support.v7.widget.GridLayout.LayoutParams getLayoutParams(android.view.View c) {
        return ((android.support.v7.widget.GridLayout.LayoutParams) (c.getLayoutParams()));
    }

    static void handleInvalidParams(java.lang.String msg) {
        throw new java.lang.IllegalArgumentException(msg + ". ");
    }

    private void checkLayoutParams(android.support.v7.widget.GridLayout.LayoutParams lp, boolean horizontal) {
        java.lang.String groupName = (horizontal) ? "column" : "row";
        android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
        android.support.v7.widget.GridLayout.Interval span = spec.span;
        if ((span.min != android.support.v7.widget.GridLayout.UNDEFINED) && (span.min < 0)) {
            android.support.v7.widget.GridLayout.handleInvalidParams(groupName + " indices must be positive");
        }
        android.support.v7.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
        int count = axis.definedCount;
        if (count != android.support.v7.widget.GridLayout.UNDEFINED) {
            if (span.max > count) {
                android.support.v7.widget.GridLayout.handleInvalidParams(((groupName + " indices (start + span) mustn't exceed the ") + groupName) + " count");
            }
            if (span.size() > count) {
                android.support.v7.widget.GridLayout.handleInvalidParams(((groupName + " span mustn't exceed the ") + groupName) + " count");
            }
        }
    }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (!(p instanceof android.support.v7.widget.GridLayout.LayoutParams)) {
            return false;
        }
        android.support.v7.widget.GridLayout.LayoutParams lp = ((android.support.v7.widget.GridLayout.LayoutParams) (p));
    ...
    protected android.support.v7.widget.GridLayout.LayoutParams generateDefaultLayoutParams() {
        return new android.support.v7.widget.GridLayout.LayoutParams();
    }

    @java.lang.Override
    public android.support.v7.widget.GridLayout.LayoutParams generateLayoutParams(android.util.AttributeSet attrs) {
        return new android.support.v7.widget.GridLayout.LayoutParams(getContext(), attrs);
    }

    @java.lang.Override
    protected android.support.v7.widget.GridLayout.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams lp) {
        if (lp instanceof android.support.v7.widget.GridLayout.LayoutParams) {
            return new android.support.v7.widget.GridLayout.LayoutParams(((android.support.v7.widget.GridLayout.LayoutParams) (lp)));
        } else
            if (lp instanceof android.view.ViewGroup.MarginLayoutParams) {
                return new android.support.v7.widget.GridLayout.LayoutParams(((android.view.ViewGroup.MarginLayoutParams) (lp)));
            } else {
                return new android.support.v7.widget.GridLayout.LayoutParams(lp);
            }
    ...
    private int computeLayoutParamsHashCode() {
        ...
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            android.support.v7.widget.GridLayout.LayoutParams lp = ((android.support.v7.widget.GridLayout.LayoutParams) (c.getLayoutParams()));
    ...
    private void consistencyCheck() {
        if (mLastLayoutParamsHashCode == android.support.v7.widget.GridLayout.UNINITIALIZED_HASH) {
    ...
    private void measureChildWithMargins2(android.view.View child, int parentWidthSpec, int parentHeightSpec, int childWidth, int childHeight) {
        int childWidthSpec = android.view.ViewGroup.getChildMeasureSpec(parentWidthSpec, getTotalMargin(child, true), childWidth);
        int childHeightSpec = android.view.ViewGroup.getChildMeasureSpec(parentHeightSpec, getTotalMargin(child, false), childHeight);
    ...
    private void measureChildrenWithMargins(int widthSpec, int heightSpec, boolean firstPass) {
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(c);
            if (firstPass) {
                measureChildWithMargins2(c, widthSpec, heightSpec, lp.width, lp.height);
            } else {
                boolean horizontal = mOrientation == android.support.v7.widget.GridLayout.HORIZONTAL;
                android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                if (spec.getAbsoluteAlignment(horizontal) == android.support.v7.widget.GridLayout.FILL) {
                    android.support.v7.widget.GridLayout.Interval span = spec.span;
                    android.support.v7.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
    ...
    static int adjust(int measureSpec, int delta) {
        return android.view.View.MeasureSpec.makeMeasureSpec(android.view.View.MeasureSpec.getSize(measureSpec + delta), android.view.View.MeasureSpec.getMode(measureSpec));
    }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        int widthSpecSansPadding = android.support.v7.widget.GridLayout.adjust(widthSpec, -hPadding);
        int heightSpecSansPadding = android.support.v7.widget.GridLayout.adjust(heightSpec, -vPadding);
        ...
        if (mOrientation == android.support.v7.widget.GridLayout.HORIZONTAL) {
        ...
        int measuredWidth = java.lang.Math.max(widthSansPadding + hPadding, getSuggestedMinimumWidth());
        int measuredHeight = java.lang.Math.max(heightSansPadding + vPadding, getSuggestedMinimumHeight());
        setMeasuredDimension(android.support.v4.view.ViewCompat.resolveSizeAndState(measuredWidth, widthSpec, 0), android.support.v4.view.ViewCompat.resolveSizeAndState(measuredHeight, heightSpec, 0));
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(c);
            android.support.v7.widget.GridLayout.Spec columnSpec = lp.columnSpec;
            android.support.v7.widget.GridLayout.Spec rowSpec = lp.rowSpec;
            android.support.v7.widget.GridLayout.Interval colSpan = columnSpec.span;
            android.support.v7.widget.GridLayout.Interval rowSpan = rowSpec.span;
            ...
            android.support.v7.widget.GridLayout.Alignment hAlign = columnSpec.getAbsoluteAlignment(true);
            android.support.v7.widget.GridLayout.Alignment vAlign = rowSpec.getAbsoluteAlignment(false);
            android.support.v7.widget.GridLayout.Bounds boundsX = mHorizontalAxis.getGroupBounds().getValue(i);
            android.support.v7.widget.GridLayout.Bounds boundsY = mVerticalAxis.getGroupBounds().getValue(i);
            ...
            if ((width != c.getMeasuredWidth()) || (height != c.getMeasuredHeight())) {
                c.measure(android.view.View.MeasureSpec.makeMeasureSpec(width, android.view.View.MeasureSpec.EXACTLY), android.view.View.MeasureSpec.makeMeasureSpec(height, android.view.View.MeasureSpec.EXACTLY));
            }
    ...
    final class Axis {
        ...
        public int definedCount = android.support.v7.widget.GridLayout.UNDEFINED;

        private int maxIndex = android.support.v7.widget.GridLayout.UNDEFINED;

        android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Spec, android.support.v7.widget.GridLayout.Bounds> groupBounds;

        public boolean groupBoundsValid = false;

        android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> forwardLinks;

        public boolean forwardLinksValid = false;

        android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> backwardLinks;
        ...
        boolean orderPreserved = android.support.v7.widget.GridLayout.DEFAULT_ORDER_PRESERVED;

        private android.support.v7.widget.GridLayout.MutableInt parentMin = new android.support.v7.widget.GridLayout.MutableInt(0);

        private android.support.v7.widget.GridLayout.MutableInt parentMax = new android.support.v7.widget.GridLayout.MutableInt(-android.support.v7.widget.GridLayout.MAX_SIZE);
        ...
        private int calculateMaxIndex() {
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                android.view.View c = getChildAt(i);
                android.support.v7.widget.GridLayout.LayoutParams params = getLayoutParams(c);
                android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? params.columnSpec : params.rowSpec;
                android.support.v7.widget.GridLayout.Interval span = spec.span;
                result = java.lang.Math.max(result, span.min);
                result = java.lang.Math.max(result, span.max);
                result = java.lang.Math.max(result, span.size());
            }
            return result == (-1) ? android.support.v7.widget.GridLayout.UNDEFINED : result;
        }

        private int getMaxIndex() {
            if (maxIndex == android.support.v7.widget.GridLayout.UNDEFINED) {
                maxIndex = java.lang.Math.max(0, calculateMaxIndex());// use zero when there are no children
        ...
        public int getCount() {
            return java.lang.Math.max(definedCount, getMaxIndex());
        }

        public void setCount(int count) {
            if ((count != android.support.v7.widget.GridLayout.UNDEFINED) && (count < getMaxIndex())) {
                android.support.v7.widget.GridLayout.handleInvalidParams(((horizontal ? "column" : "row") + "Count must be greater than or equal to the maximum of all grid indices ") + "(and spans) defined in the LayoutParams of each child");
            }
        ...
        private android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Spec, android.support.v7.widget.GridLayout.Bounds> createGroupBounds() {
            android.support.v7.widget.GridLayout.Assoc<android.support.v7.widget.GridLayout.Spec, android.support.v7.widget.GridLayout.Bounds> assoc = android.support.v7.widget.GridLayout.Assoc.of(android.support.v7.widget.GridLayout.Spec.class, android.support.v7.widget.GridLayout.Bounds.class);
            for (int i = 0, N = getChildCount(); i < N; i++) {
                android.view.View c = getChildAt(i);
                // we must include views that are GONE here, see introductory javadoc
                android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(c);
                android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                android.support.v7.widget.GridLayout.Bounds bounds = spec.getAbsoluteAlignment(horizontal).getBounds();
        ...
        private void computeGroupBounds() {
            android.support.v7.widget.GridLayout.Bounds[] values = groupBounds.values;
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                groupBounds.getValue(i).include(android.support.v7.widget.GridLayout.this, c, spec, this, size);
            }
        }

        public android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Spec, android.support.v7.widget.GridLayout.Bounds> getGroupBounds() {
            if (groupBounds == null) {
        ...
        private android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> createLinks(boolean min) {
            android.support.v7.widget.GridLayout.Assoc<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> result = android.support.v7.widget.GridLayout.Assoc.of(android.support.v7.widget.GridLayout.Interval.class, android.support.v7.widget.GridLayout.MutableInt.class);
            android.support.v7.widget.GridLayout.Spec[] keys = getGroupBounds().keys;
            for (int i = 0, N = keys.length; i < N; i++) {
                android.support.v7.widget.GridLayout.Interval span = (min) ? keys[i].span : keys[i].span.inverse();
                result.put(span, new android.support.v7.widget.GridLayout.MutableInt());
            }
            return result.pack();
        }

        private void computeLinks(android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> links, boolean min) {
            android.support.v7.widget.GridLayout.MutableInt[] spans = links.values;
            for (int i = 0; i < spans.length; i++) {
                spans[i].reset();
            }
            // Use getter to trigger a re-evaluation
            android.support.v7.widget.GridLayout.Bounds[] bounds = getGroupBounds().values;
            for (int i = 0; i < bounds.length; i++) {
                int size = bounds[i].size(min);
                android.support.v7.widget.GridLayout.MutableInt valueHolder = links.getValue(i);
                // this effectively takes the max() of the minima and the min() of the maxima
                valueHolder.value = java.lang.Math.max(valueHolder.value, min ? size : -size);
            }
        }

        private android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> getForwardLinks() {
        ...
        private android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> getBackwardLinks() {
        ...
        private void include(java.util.List<android.support.v7.widget.GridLayout.Arc> arcs, android.support.v7.widget.GridLayout.Interval key, android.support.v7.widget.GridLayout.MutableInt size, boolean ignoreIfAlreadyPresent) {
            ...
            if (ignoreIfAlreadyPresent) {
                for (android.support.v7.widget.GridLayout.Arc arc : arcs) {
                    android.support.v7.widget.GridLayout.Interval span = arc.span;
                    if (span.equals(key)) {
                        return;
                    }
                }
            }
            arcs.add(new android.support.v7.widget.GridLayout.Arc(key, size));
        }

        private void include(java.util.List<android.support.v7.widget.GridLayout.Arc> arcs, android.support.v7.widget.GridLayout.Interval key, android.support.v7.widget.GridLayout.MutableInt size) {
        ...
        android.support.v7.widget.GridLayout.Arc[][] groupArcsByFirstVertex(android.support.v7.widget.GridLayout.Arc[] arcs) {
            int N = getCount() + 1;// the number of vertices

            android.support.v7.widget.GridLayout.Arc[][] result = new android.support.v7.widget.GridLayout.Arc[N][];
            int[] sizes = new int[N];
            for (android.support.v7.widget.GridLayout.Arc arc : arcs) {
                sizes[arc.span.min]++;
            }
            for (int i = 0; i < sizes.length; i++) {
                result[i] = new android.support.v7.widget.GridLayout.Arc[sizes[i]];
            }
        ...
        private android.support.v7.widget.GridLayout.Arc[] topologicalSort(final android.support.v7.widget.GridLayout.Arc[] arcs) {
            return new java.lang.Object() {
                android.support.v7.widget.GridLayout.Arc[] result = new android.support.v7.widget.GridLayout.Arc[arcs.length];

                int cursor = result.length - 1;

                android.support.v7.widget.GridLayout.Arc[][] arcsByVertex = groupArcsByFirstVertex(arcs);

                int[] visited = new int[getCount() + 1];

                void walk(int loc) {
                    switch (visited[loc]) {
                        case android.support.v7.widget.GridLayout.Axis.NEW :
                            {
                                visited[loc] = android.support.v7.widget.GridLayout.Axis.PENDING;
                                for (android.support.v7.widget.GridLayout.Arc arc : arcsByVertex[loc]) {
                                    walk(arc.span.max);
                                    result[cursor--] = arc;
                                }
                                visited[loc] = android.support.v7.widget.GridLayout.Axis.COMPLETE;
                                break;
                            }
                        case android.support.v7.widget.GridLayout.Axis.PENDING :
                            {
                                // le singe est dans l'arbre
                                assert false;
                                break;
                            }
                        case android.support.v7.widget.GridLayout.Axis.COMPLETE :
                            {
                                break;
                            }
                    }
        ...
        private android.support.v7.widget.GridLayout.Arc[] topologicalSort(java.util.List<android.support.v7.widget.GridLayout.Arc> arcs) {
            return topologicalSort(arcs.toArray(new android.support.v7.widget.GridLayout.Arc[arcs.size()]));
        }

        private void addComponentSizes(java.util.List<android.support.v7.widget.GridLayout.Arc> result, android.support.v7.widget.GridLayout.PackedMap<android.support.v7.widget.GridLayout.Interval, android.support.v7.widget.GridLayout.MutableInt> links) {
            for (int i = 0; i < links.keys.length; i++) {
                android.support.v7.widget.GridLayout.Interval key = links.keys[i];
                include(result, key, links.values[i], false);
            }
        }

        private android.support.v7.widget.GridLayout.Arc[] createArcs() {
            java.util.List<android.support.v7.widget.GridLayout.Arc> mins = new java.util.ArrayList<android.support.v7.widget.GridLayout.Arc>();
            java.util.List<android.support.v7.widget.GridLayout.Arc> maxs = new java.util.ArrayList<android.support.v7.widget.GridLayout.Arc>();
            ...
            if (orderPreserved) {
                ...
                for (int i = 0; i < getCount(); i++) {
                    include(mins, new android.support.v7.widget.GridLayout.Interval(i, i + 1), new android.support.v7.widget.GridLayout.MutableInt(0));
                }
            }
            ...
            int N = getCount();
            include(mins, new android.support.v7.widget.GridLayout.Interval(0, N), parentMin, false);
            include(maxs, new android.support.v7.widget.GridLayout.Interval(N, 0), parentMax, false);
            // Sort
            android.support.v7.widget.GridLayout.Arc[] sMins = topologicalSort(mins);
            android.support.v7.widget.GridLayout.Arc[] sMaxs = topologicalSort(maxs);
            return android.support.v7.widget.GridLayout.append(sMins, sMaxs);
        }
        ...
        private boolean relax(int[] locations, android.support.v7.widget.GridLayout.Arc entry) {
            if (!entry.valid) {
                return false;
            }
            android.support.v7.widget.GridLayout.Interval span = entry.span;
            int u = span.min;
            int v = span.max;
        ...
        private java.lang.String arcsToString(java.util.List<android.support.v7.widget.GridLayout.Arc> arcs) {
            java.lang.String var = (horizontal) ? "x" : "y";
        ...
        private void logError(java.lang.String axisName, android.support.v7.widget.GridLayout.Arc[] arcs, boolean[] culprits0) {
            java.util.List<android.support.v7.widget.GridLayout.Arc> culprits = new java.util.ArrayList<android.support.v7.widget.GridLayout.Arc>();
            java.util.List<android.support.v7.widget.GridLayout.Arc> removed = new java.util.ArrayList<android.support.v7.widget.GridLayout.Arc>();
            for (int c = 0; c < arcs.length; c++) {
                android.support.v7.widget.GridLayout.Arc arc = arcs[c];
                if (culprits0[c]) {
                    culprits.add(arc);
                }
                if (!arc.valid) {
         ...
         */
        private boolean solve(android.support.v7.widget.GridLayout.Arc[] arcs, int[] locations) {
            return solve(arcs, locations, true);
        }

        private boolean solve(android.support.v7.widget.GridLayout.Arc[] arcs, int[] locations, boolean modifyOnError) {
            java.lang.String axisName = (horizontal) ? "horizontal" : "vertical";
            ...
            for (int p = 0; p < arcs.length; p++) {
                ...
                for (int i = 0; i < arcs.length; i++) {
                    if (culprits[i]) {
                        android.support.v7.widget.GridLayout.Arc arc = arcs[i];
        ...
        private void computeMargins(boolean leading) {
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                margins[index] = java.lang.Math.max(margins[index], getMargin1(c, horizontal, leading));
            }
        }
        ...
        private boolean computeHasWeights() {
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(child);
                android.support.v7.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                if (spec.weight != 0) {
                    return true;
                }
        ...
        private void shareOutDelta(int totalDelta, float totalWeight) {
            java.util.Arrays.fill(deltas, 0);
            for (int i = 0, N = getChildCount(); i < N; i++) {
                final android.view.View c = getChildAt(i);
                if (c.getVisibility() == android.view.View.GONE) {
                    continue;
                }
                android.support.v7.widget.GridLayout.LayoutParams lp = getLayoutParams(c);
                ...
                if (weight != 0) {
                    int delta = java.lang.Math.round((weight * totalDelta) / totalWeight);
                    deltas[i] = delta;
        ...
        public int getMeasure(int measureSpec) {
            ...
            switch (mode) {
                case android.view.View.MeasureSpec.UNSPECIFIED :
                    {
                        return getMeasure(0, android.support.v7.widget.GridLayout.MAX_SIZE);
                    }
        ...
        public void invalidateStructure() {
            maxIndex = android.support.v7.widget.GridLayout.UNDEFINED;
            groupBounds = null;
            forwardLinks = null;
            backwardLinks = null;
            leadingMargins = null;
     ...
     *
     * @unknown name android:row
     * @unknown name android:rowSpan
     * @unknown name android:rowWeight
     * @unknown name android:column
     * @unknown name android:columnSpan
     * @unknown name android:columnWeight
     * @unknown name android:gravity
     */
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
        // Default values
        private static final int DEFAULT_WIDTH = android.view.ViewGroup.LayoutParams.WRAP_CONTENT;

        private static final int DEFAULT_HEIGHT = android.view.ViewGroup.LayoutParams.WRAP_CONTENT;

        private static final int DEFAULT_MARGIN = android.support.v7.widget.GridLayout.UNDEFINED;

        private static final int DEFAULT_ROW = android.support.v7.widget.GridLayout.UNDEFINED;

        private static final int DEFAULT_COLUMN = android.support.v7.widget.GridLayout.UNDEFINED;

        private static final android.support.v7.widget.GridLayout.Interval DEFAULT_SPAN = new android.support.v7.widget.GridLayout.Interval(android.support.v7.widget.GridLayout.UNDEFINED, android.support.v7.widget.GridLayout.UNDEFINED + 1);

        private static final int DEFAULT_SPAN_SIZE = android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_SPAN.size();
         ...
         */
        public android.support.v7.widget.GridLayout.Spec rowSpec = android.support.v7.widget.GridLayout.Spec.UNDEFINED;
         ...
         * calls to remove the warnings as soon as it is practical.
         */
        public android.support.v7.widget.GridLayout.Spec columnSpec = android.support.v7.widget.GridLayout.Spec.UNDEFINED;

        // Constructors
        private LayoutParams(int width, int height, int left, int top, int right, int bottom, android.support.v7.widget.GridLayout.Spec rowSpec, android.support.v7.widget.GridLayout.Spec columnSpec) {
            super(width, height);
         ...
         * 		the columnSpec
         */
        public LayoutParams(android.support.v7.widget.GridLayout.Spec rowSpec, android.support.v7.widget.GridLayout.Spec columnSpec) {
            this(android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_WIDTH, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_HEIGHT, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, rowSpec, columnSpec);
        }
         ...
         */
        public LayoutParams() {
            this(android.support.v7.widget.GridLayout.Spec.UNDEFINED, android.support.v7.widget.GridLayout.Spec.UNDEFINED);
        }
        ...
        private void reInitSuper(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GridLayout_Layout);
            try {
                int margin = a.getDimensionPixelSize(android.support.v7.widget.GridLayout.LayoutParams.MARGIN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_MARGIN);
                this.leftMargin = a.getDimensionPixelSize(android.support.v7.widget.GridLayout.LayoutParams.LEFT_MARGIN, margin);
                this.topMargin = a.getDimensionPixelSize(android.support.v7.widget.GridLayout.LayoutParams.TOP_MARGIN, margin);
                this.rightMargin = a.getDimensionPixelSize(android.support.v7.widget.GridLayout.LayoutParams.RIGHT_MARGIN, margin);
                this.bottomMargin = a.getDimensionPixelSize(android.support.v7.widget.GridLayout.LayoutParams.BOTTOM_MARGIN, margin);
            } finally {
                a.recycle();
            }
        }
        ...
        private void init(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GridLayout_Layout);
            try {
                int gravity = a.getInt(android.support.v7.widget.GridLayout.LayoutParams.GRAVITY, android.view.Gravity.NO_GRAVITY);
                int column = a.getInt(android.support.v7.widget.GridLayout.LayoutParams.COLUMN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_COLUMN);
                int colSpan = a.getInt(android.support.v7.widget.GridLayout.LayoutParams.COLUMN_SPAN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_SPAN_SIZE);
                float colWeight = a.getFloat(android.support.v7.widget.GridLayout.LayoutParams.COLUMN_WEIGHT, android.support.v7.widget.GridLayout.Spec.DEFAULT_WEIGHT);
                this.columnSpec = android.support.v7.widget.GridLayout.spec(column, colSpan, android.support.v7.widget.GridLayout.getAlignment(gravity, true), colWeight);
                int row = a.getInt(android.support.v7.widget.GridLayout.LayoutParams.ROW, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_ROW);
                int rowSpan = a.getInt(android.support.v7.widget.GridLayout.LayoutParams.ROW_SPAN, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_SPAN_SIZE);
                float rowWeight = a.getFloat(android.support.v7.widget.GridLayout.LayoutParams.ROW_WEIGHT, android.support.v7.widget.GridLayout.Spec.DEFAULT_WEIGHT);
                this.rowSpec = android.support.v7.widget.GridLayout.spec(row, rowSpan, android.support.v7.widget.GridLayout.getAlignment(gravity, false), rowWeight);
            } finally {
                a.recycle();
            }
        }
        ...
        public void setGravity(int gravity) {
            rowSpec = rowSpec.copyWriteAlignment(android.support.v7.widget.GridLayout.getAlignment(gravity, false));
            columnSpec = columnSpec.copyWriteAlignment(android.support.v7.widget.GridLayout.getAlignment(gravity, true));
        }

        @java.lang.Override
        protected void setBaseAttributes(android.content.res.TypedArray attributes, int widthAttr, int heightAttr) {
            this.width = attributes.getLayoutDimension(widthAttr, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_WIDTH);
            this.height = attributes.getLayoutDimension(heightAttr, android.support.v7.widget.GridLayout.LayoutParams.DEFAULT_HEIGHT);
        }

        final void setRowSpecSpan(android.support.v7.widget.GridLayout.Interval span) {
            rowSpec = rowSpec.copyWriteSpan(span);
        }

        final void setColumnSpecSpan(android.support.v7.widget.GridLayout.Interval span) {
        ...
        public boolean equals(java.lang.Object o) {
            ...
            android.support.v7.widget.GridLayout.LayoutParams that = ((android.support.v7.widget.GridLayout.LayoutParams) (o));
    ...
    static final class Arc {
        ...
        public Arc(android.support.v7.widget.GridLayout.Interval span, android.support.v7.widget.GridLayout.MutableInt value) {
            this.span = span;
            this.value = value;
        }
    ...
    static final class Assoc<K, V> extends java.util.ArrayList<android.util.Pair<K, V>> {
        ...
        private Assoc(java.lang.Class<K> keyType, java.lang.Class<V> valueType) {
            this.keyType = keyType;
            this.valueType = valueType;
        }

        public static <K, V> android.support.v7.widget.GridLayout.Assoc<K, V> of(java.lang.Class<K> keyType, java.lang.Class<V> valueType) {
            return new android.support.v7.widget.GridLayout.Assoc<K, V>(keyType, valueType);
        }

        public void put(K key, V value) {
            add(android.util.Pair.create(key, value));
        }

        @java.lang.SuppressWarnings("unchecked")
        public android.support.v7.widget.GridLayout.PackedMap<K, V> pack() {
            int N = size();
            K[] keys = ((K[]) (java.lang.reflect.Array.newInstance(keyType, N)));
            V[] values = ((V[]) (java.lang.reflect.Array.newInstance(valueType, N)));
            for (int i = 0; i < N; i++) {
                keys[i] = get(i).first;
                values[i] = get(i).second;
            }
            return new android.support.v7.widget.GridLayout.PackedMap<K, V>(keys, values);
        }
    }
    ...
    static final class PackedMap<K, V> {
        ...
        PackedMap(K[] keys, V[] values) {
            this.index = android.support.v7.widget.GridLayout.PackedMap.createIndex(keys);
            this.keys = android.support.v7.widget.GridLayout.PackedMap.compact(keys, index);
            this.values = android.support.v7.widget.GridLayout.PackedMap.compact(values, index);
        }
        ...
        private static <K> int[] createIndex(K[] keys) {
            ...
            java.util.Map<K, java.lang.Integer> keyToIndex = new java.util.HashMap<K, java.lang.Integer>();
            for (int i = 0; i < size; i++) {
                K key = keys[i];
                java.lang.Integer index = keyToIndex.get(key);
                if (index == null) {
        ...
        private static <K> K[] compact(K[] a, int[] index) {
            int size = a.length;
            java.lang.Class<?> componentType = a.getClass().getComponentType();
            K[] result = ((K[]) (java.lang.reflect.Array.newInstance(componentType, android.support.v7.widget.GridLayout.max2(index, -1) + 1)));
    ...
    static class Bounds {
        ...
        protected void reset() {
            before = java.lang.Integer.MIN_VALUE;
            after = java.lang.Integer.MIN_VALUE;
            flexibility = android.support.v7.widget.GridLayout.CAN_STRETCH;// from the above, we're flexible when empty

        }

        protected void include(int before, int after) {
            this.before = java.lang.Math.max(this.before, before);
            this.after = java.lang.Math.max(this.after, after);
        }

        protected int size(boolean min) {
            if (!min) {
                if (android.support.v7.widget.GridLayout.canStretch(flexibility)) {
                    return android.support.v7.widget.GridLayout.MAX_SIZE;
                }
            }
            return before + after;
        }

        protected int getOffset(android.support.v7.widget.GridLayout gl, android.view.View c, android.support.v7.widget.GridLayout.Alignment a, int size, boolean horizontal) {
            return before - a.getAlignmentValue(c, size, android.support.v4.view.ViewGroupCompat.getLayoutMode(gl));
        }

        protected final void include(android.support.v7.widget.GridLayout gl, android.view.View c, android.support.v7.widget.GridLayout.Spec spec, android.support.v7.widget.GridLayout.Axis axis, int size) {
            this.flexibility &= spec.getFlexibility();
            boolean horizontal = axis.horizontal;
            android.support.v7.widget.GridLayout.Alignment alignment = spec.getAbsoluteAlignment(horizontal);
            // todo test this works correctly when the returned value is UNDEFINED
            int before = alignment.getAlignmentValue(c, size, android.support.v4.view.ViewGroupCompat.getLayoutMode(gl));
    ...
    static final class Interval {
        ...
        android.support.v7.widget.GridLayout.Interval inverse() {
            return new android.support.v7.widget.GridLayout.Interval(max, min);
        }
        ...
        public boolean equals(java.lang.Object that) {
            ...
            android.support.v7.widget.GridLayout.Interval interval = ((android.support.v7.widget.GridLayout.Interval) (that));
            if (max != interval.max) {
                return false;
            }
    ...
    public static class Spec {
        static final android.support.v7.widget.GridLayout.Spec UNDEFINED = android.support.v7.widget.GridLayout.spec(android.support.v7.widget.GridLayout.UNDEFINED);
        ...
        private Spec(boolean startDefined, android.support.v7.widget.GridLayout.Interval span, android.support.v7.widget.GridLayout.Alignment alignment, float weight) {
        ...
        Spec(boolean startDefined, int start, int size, android.support.v7.widget.GridLayout.Alignment alignment, float weight) {
            this(startDefined, new android.support.v7.widget.GridLayout.Interval(start, start + size), alignment, weight);
        }

        public android.support.v7.widget.GridLayout.Alignment getAbsoluteAlignment(boolean horizontal) {
            if (alignment != android.support.v7.widget.GridLayout.UNDEFINED_ALIGNMENT) {
                return alignment;
            }
            if (weight == 0.0F) {
                return horizontal ? android.support.v7.widget.GridLayout.START : android.support.v7.widget.GridLayout.BASELINE;
            }
            return android.support.v7.widget.GridLayout.FILL;
        }

        final android.support.v7.widget.GridLayout.Spec copyWriteSpan(android.support.v7.widget.GridLayout.Interval span) {
            return new android.support.v7.widget.GridLayout.Spec(startDefined, span, alignment, weight);
        }

        final android.support.v7.widget.GridLayout.Spec copyWriteAlignment(android.support.v7.widget.GridLayout.Alignment alignment) {
            return new android.support.v7.widget.GridLayout.Spec(startDefined, span, alignment, weight);
        }

        final int getFlexibility() {
            return (alignment == android.support.v7.widget.GridLayout.UNDEFINED_ALIGNMENT) && (weight == 0) ? android.support.v7.widget.GridLayout.INFLEXIBLE : android.support.v7.widget.GridLayout.CAN_STRETCH;
        }
        ...
        public boolean equals(java.lang.Object that) {
            ...
            android.support.v7.widget.GridLayout.Spec spec = ((android.support.v7.widget.GridLayout.Spec) (that));
     ...
     * 		the weight
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, int size, android.support.v7.widget.GridLayout.Alignment alignment, float weight) {
        return new android.support.v7.widget.GridLayout.Spec(start != android.support.v7.widget.GridLayout.UNDEFINED, start, size, alignment, weight);
    }
     ...
     * 		the weight
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, android.support.v7.widget.GridLayout.Alignment alignment, float weight) {
        return android.support.v7.widget.GridLayout.spec(start, 1, alignment, weight);
    }
     ...
     * 		the weight
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, int size, float weight) {
        return android.support.v7.widget.GridLayout.spec(start, size, android.support.v7.widget.GridLayout.UNDEFINED_ALIGNMENT, weight);
    }
     ...
     * 		the weight
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, float weight) {
        return android.support.v7.widget.GridLayout.spec(start, 1, weight);
    }
     ...
     * 		the alignment
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, int size, android.support.v7.widget.GridLayout.Alignment alignment) {
        return android.support.v7.widget.GridLayout.spec(start, size, alignment, android.support.v7.widget.GridLayout.Spec.DEFAULT_WEIGHT);
    }
     ...
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, android.support.v7.widget.GridLayout.Alignment alignment) {
        return android.support.v7.widget.GridLayout.spec(start, 1, alignment);
    }
     ...
     */
    public static android.support.v7.widget.GridLayout.Spec spec(int start, int size) {
        return android.support.v7.widget.GridLayout.spec(start, size, android.support.v7.widget.GridLayout.UNDEFINED_ALIGNMENT);
    }
    ...
    public static android.support.v7.widget.GridLayout.Spec spec(int start) {
        return android.support.v7.widget.GridLayout.spec(start, 1);
    }
    ...
    public static abstract class Alignment {
        ...
        abstract int getGravityOffset(android.view.View view, int cellDelta);
         ...
         * @param mode
         * 		the basis of alignment: CLIP or OPTICAL
         * @return the alignment value
         */
        abstract int getAlignmentValue(android.view.View view, int viewSize, int mode);
         ...
         */
        int getSizeInCell(android.view.View view, int viewSize, int cellSize) {
            return viewSize;
        }

        android.support.v7.widget.GridLayout.Bounds getBounds() {
            return new android.support.v7.widget.GridLayout.Bounds();
        }
    ...
    static final android.support.v7.widget.GridLayout.Alignment UNDEFINED_ALIGNMENT = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return android.support.v7.widget.GridLayout.UNDEFINED;
        }

        @java.lang.Override
        public int getAlignmentValue(android.view.View view, int viewSize, int mode) {
            return android.support.v7.widget.GridLayout.UNDEFINED;
        }
     ...
     */
    private static final android.support.v7.widget.GridLayout.Alignment LEADING = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return 0;
        }
     ...
     * edges of the other views in its cell group.
     */
    private static final android.support.v7.widget.GridLayout.Alignment TRAILING = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return cellDelta;
        }
     ...
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment TOP = android.support.v7.widget.GridLayout.LEADING;

    /**
     * Indicates that a view should be aligned with the <em>bottom</em>
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment BOTTOM = android.support.v7.widget.GridLayout.TRAILING;

    /**
     * Indicates that a view should be aligned with the <em>start</em>
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment START = android.support.v7.widget.GridLayout.LEADING;

    /**
     * Indicates that a view should be aligned with the <em>end</em>
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment END = android.support.v7.widget.GridLayout.TRAILING;

    private static android.support.v7.widget.GridLayout.Alignment createSwitchingAlignment(final android.support.v7.widget.GridLayout.Alignment ltr, final android.support.v7.widget.GridLayout.Alignment rtl) {
        return new android.support.v7.widget.GridLayout.Alignment() {
            @java.lang.Override
            int getGravityOffset(android.view.View view, int cellDelta) {
                boolean isLayoutRtl = android.support.v4.view.ViewCompat.getLayoutDirection(view) == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL;
     ...
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment LEFT = android.support.v7.widget.GridLayout.createSwitchingAlignment(android.support.v7.widget.GridLayout.START, android.support.v7.widget.GridLayout.END);

    /**
     * Indicates that a view should be aligned with the <em>right</em>
     * edges of the other views in its cell group.
     */
    public static final android.support.v7.widget.GridLayout.Alignment RIGHT = android.support.v7.widget.GridLayout.createSwitchingAlignment(android.support.v7.widget.GridLayout.END, android.support.v7.widget.GridLayout.START);

    /**
     * Indicates that a view should be <em>centered</em> with the other views in its cell group.
     * This constant may be used in both {@link LayoutParams#rowSpec rowSpecs} and {@link LayoutParams#columnSpec columnSpecs}.
     */
    public static final android.support.v7.widget.GridLayout.Alignment CENTER = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return cellDelta >> 1;
        }
     ...
     */
    public static final android.support.v7.widget.GridLayout.Alignment BASELINE = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
        ...
        public int getAlignmentValue(android.view.View view, int viewSize, int mode) {
            ...
            return baseline == (-1) ? android.support.v7.widget.GridLayout.UNDEFINED : baseline;
        }
        ...
        public android.support.v7.widget.GridLayout.Bounds getBounds() {
            return new android.support.v7.widget.GridLayout.Bounds() {
                ...
                protected void reset() {
                    super.reset();
                    size = java.lang.Integer.MIN_VALUE;
                }

                @java.lang.Override
                protected void include(int before, int after) {
                    super.include(before, after);
                    size = java.lang.Math.max(size, before + after);
                }

                @java.lang.Override
                protected int size(boolean min) {
                    return java.lang.Math.max(super.size(min), size);
                }

                @java.lang.Override
                protected int getOffset(android.support.v7.widget.GridLayout gl, android.view.View c, android.support.v7.widget.GridLayout.Alignment a, int size, boolean hrz) {
                    return java.lang.Math.max(0, super.getOffset(gl, c, a, size, hrz));
                }
            };
        }
     ...
     */
    public static final android.support.v7.widget.GridLayout.Alignment FILL = new android.support.v7.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return 0;
        }
        ...
        @java.lang.Override
        public int getSizeInCell(android.view.View view, int viewSize, int cellSize) {
            return cellSize;
        }
    ...
    static boolean canStretch(int flexibility) {
        return (flexibility & android.support.v7.widget.GridLayout.CAN_STRETCH) != 0;
    }
