 ...
 */
public class LinearLayoutManager extends android.support.v7.widget.RecyclerView.LayoutManager implements android.support.v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider , android.support.v7.widget.helper.ItemTouchHelper.ViewDropHandler {
    ...
    public static final int INVALID_OFFSET = java.lang.Integer.MIN_VALUE;
     ...
     * called.
     */
    int mPendingScrollPositionOffset = android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET;

    private boolean mRecycleChildrenOnDetach;

    android.support.v7.widget.LinearLayoutManager.SavedState mPendingSavedState = null;
     ...
     */
    final android.support.v7.widget.LinearLayoutManager.AnchorInfo mAnchorInfo = new android.support.v7.widget.LinearLayoutManager.AnchorInfo();

    /**
     * Stashed to avoid allocation, currently only used in #fill()
     */
    private final android.support.v7.widget.LinearLayoutManager.LayoutChunkResult mLayoutChunkResult = new android.support.v7.widget.LinearLayoutManager.LayoutChunkResult();
    ...
    public LinearLayoutManager(android.content.Context context) {
        this(context, android.support.v7.widget.LinearLayoutManager.VERTICAL, false);
    }
     ...
     */
    public LinearLayoutManager(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public android.support.v7.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        return new android.support.v7.widget.RecyclerView.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
    }
    ...
    public android.os.Parcelable onSaveInstanceState() {
        if (mPendingSavedState != null) {
            return new android.support.v7.widget.LinearLayoutManager.SavedState(mPendingSavedState);
        }
        android.support.v7.widget.LinearLayoutManager.SavedState state = new android.support.v7.widget.LinearLayoutManager.SavedState();
        if (getChildCount() > 0) {
            ensureLayoutState();
            boolean didLayoutFromEnd = mLastStackFromEnd ^ mShouldReverseLayout;
            state.mAnchorLayoutFromEnd = didLayoutFromEnd;
            if (didLayoutFromEnd) {
                final android.view.View refChild = getChildClosestToEnd();
                state.mAnchorOffset = mOrientationHelper.getEndAfterPadding() - mOrientationHelper.getDecoratedEnd(refChild);
                state.mAnchorPosition = getPosition(refChild);
            } else {
                final android.view.View refChild = getChildClosestToStart();
                state.mAnchorPosition = getPosition(refChild);
    ...
    public void onRestoreInstanceState(android.os.Parcelable state) {
        if (state instanceof android.support.v7.widget.LinearLayoutManager.SavedState) {
            mPendingSavedState = ((android.support.v7.widget.LinearLayoutManager.SavedState) (state));
            requestLayout();
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "loaded saved state");
            }
        } else
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "invalid saved state class");
            }
    ...
    public boolean canScrollHorizontally() {
        return mOrientation == android.support.v7.widget.LinearLayoutManager.HORIZONTAL;
    }
    ...
    public boolean canScrollVertically() {
        return mOrientation == android.support.v7.widget.LinearLayoutManager.VERTICAL;
    }
    ...
    public void setOrientation(int orientation) {
        if ((orientation != android.support.v7.widget.LinearLayoutManager.HORIZONTAL) && (orientation != android.support.v7.widget.LinearLayoutManager.VERTICAL)) {
    ...
    public android.view.View findViewByPosition(int position) {
        ...
        if ((viewPosition >= 0) && (viewPosition < childCount)) {
            final android.view.View child = getChildAt(viewPosition);
    ...
    public void smoothScrollToPosition(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.State state, int position) {
        android.support.v7.widget.LinearSmoothScroller linearSmoothScroller = new android.support.v7.widget.LinearSmoothScroller(recyclerView.getContext());
    ...
    public void onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        ...
        // create layout state
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "is pre layout:" + state.isPreLayout());
        }
        ...
        if (((!mAnchorInfo.mValid) || (mPendingScrollPosition != android.support.v7.widget.RecyclerView.NO_POSITION)) || (mPendingSavedState != null)) {
            mAnchorInfo.reset();
        ...
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Anchor info:" + mAnchorInfo);
        }
        ...
        if ((state.isPreLayout() && (mPendingScrollPosition != android.support.v7.widget.RecyclerView.NO_POSITION)) && (mPendingScrollPositionOffset != android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET)) {
            // if the child is visible and we are going to move it around, we should layout
            // extra items in the opposite direction to make sure new items animate nicely
            // instead of just fading in
            final android.view.View existing = findViewByPosition(mPendingScrollPosition);
            if (existing != null) {
                final int current;
        ...
        if (mAnchorInfo.mLayoutFromEnd) {
            firstLayoutDirection = (mShouldReverseLayout) ? android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL : android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD;
        } else {
            firstLayoutDirection = (mShouldReverseLayout) ? android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD : android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL;
        }
    ...
    public void onLayoutCompleted(android.support.v7.widget.RecyclerView.State state) {
        ...
        mPendingScrollPositionOffset = android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET;
        mAnchorInfo.reset();
    }
     ...
     *
     * @param recycler
     * 		The recycler for the layout
     * @param state
     * 		The layout state
     * @param anchorInfo
     * 		The mutable POJO that keeps the position and offset.
     * @param firstLayoutItemDirection
     * 		The direction of the first layout filling in terms of adapter
     * 		indices.
     */
    void onAnchorReady(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.LinearLayoutManager.AnchorInfo anchorInfo, int firstLayoutItemDirection) {
    }

    /**
     * If necessary, layouts new items for predictive animations
     */
    private void layoutForPredictiveAnimations(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, int startOffset, int endOffset) {
        ...
        int scrapExtraEnd = 0;
        final java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> scrapList = recycler.getScrapList();
        ...
        for (int i = 0; i < scrapSize; i++) {
            ...
            final int direction = ((position < firstChildPos) != mShouldReverseLayout) ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START : android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END;
            if (direction == android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START) {
        ...
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, ((("for unused scrap, decided to add " + scrapExtraStart) + " towards start and ") + scrapExtraEnd) + " towards end");
        }
        mLayoutState.mScrapList = scrapList;
        if (scrapExtraStart > 0) {
            android.view.View anchor = getChildClosestToStart();
        ...
        if (scrapExtraEnd > 0) {
            android.view.View anchor = getChildClosestToEnd();
    ...
    private void updateAnchorInfoForLayout(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.LinearLayoutManager.AnchorInfo anchorInfo) {
        if (updateAnchorFromPendingData(state, anchorInfo)) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "updated anchor info from pending information");
            }
            return;
        }
        if (updateAnchorFromChildren(recycler, state, anchorInfo)) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "updated anchor info from existing children");
            }
            return;
        }
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "deciding anchor info for fresh state");
        }
     ...
     */
    private boolean updateAnchorFromChildren(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.LinearLayoutManager.AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
        final android.view.View focused = getFocusedChild();
        ...
        android.view.View referenceChild = (anchorInfo.mLayoutFromEnd) ? findReferenceChildClosestToEnd(recycler, state) : findReferenceChildClosestToStart(recycler, state);
     ...
     */
    private boolean updateAnchorFromPendingData(android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.LinearLayoutManager.AnchorInfo anchorInfo) {
        ...
        if ((mPendingScrollPosition < 0) || (mPendingScrollPosition >= state.getItemCount())) {
            ...
            mPendingScrollPositionOffset = android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET;
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.e(android.support.v7.widget.LinearLayoutManager.TAG, "ignoring invalid scroll position " + mPendingScrollPosition);
            }
            return false;
        }
        ...
        if (mPendingScrollPositionOffset == android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET) {
            android.view.View child = findViewByPosition(mPendingScrollPosition);
            if (child != null) {
     ...
     */
    private int fixLayoutEndGap(int endOffset, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, boolean canOffsetChildren) {
    ...
    private void updateLayoutStateToFillEnd(int itemPosition, int offset) {
        ...
        mLayoutState.mItemDirection = (mShouldReverseLayout) ? android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD : android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL;
        mLayoutState.mCurrentPosition = itemPosition;
        mLayoutState.mLayoutDirection = android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END;
        mLayoutState.mOffset = offset;
        mLayoutState.mScrollingOffset = android.support.v7.widget.LinearLayoutManager.LayoutState.SCROLLING_OFFSET_NaN;
    }
    ...
    private void updateLayoutStateToFillStart(int itemPosition, int offset) {
        ...
        mLayoutState.mCurrentPosition = itemPosition;
        mLayoutState.mItemDirection = (mShouldReverseLayout) ? android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL : android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD;
        mLayoutState.mLayoutDirection = android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START;
        mLayoutState.mOffset = offset;
        mLayoutState.mScrollingOffset = android.support.v7.widget.LinearLayoutManager.LayoutState.SCROLLING_OFFSET_NaN;
    }
    ...
    android.support.v7.widget.LinearLayoutManager.LayoutState createLayoutState() {
        return new android.support.v7.widget.LinearLayoutManager.LayoutState();
    }
    ...
    private int computeScrollOffset(android.support.v7.widget.RecyclerView.State state) {
        ...
        ensureLayoutState();
        return android.support.v7.widget.ScrollbarHelper.computeScrollOffset(state, mOrientationHelper, findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true), this, mSmoothScrollbarEnabled, mShouldReverseLayout);
    }
    ...
    private int computeScrollExtent(android.support.v7.widget.RecyclerView.State state) {
        ...
        ensureLayoutState();
        return android.support.v7.widget.ScrollbarHelper.computeScrollExtent(state, mOrientationHelper, findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true), this, mSmoothScrollbarEnabled);
    }
    ...
    private int computeScrollRange(android.support.v7.widget.RecyclerView.State state) {
        ...
        ensureLayoutState();
        return android.support.v7.widget.ScrollbarHelper.computeScrollRange(state, mOrientationHelper, findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true), findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true), this, mSmoothScrollbarEnabled);
    }
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace, boolean canUseExistingSpace, android.support.v7.widget.RecyclerView.State state) {
        // If parent provides a hint, don't measure unlimited.
        mLayoutState.mInfinite = resolveIsInfinite();
        mLayoutState.mExtra = getExtraLayoutSpace(state);
        mLayoutState.mLayoutDirection = layoutDirection;
        int scrollingOffset;
        if (layoutDirection == android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END) {
            mLayoutState.mExtra += mOrientationHelper.getEndPadding();
            // get the first child in the direction we are going
            final android.view.View child = getChildClosestToEnd();
            ...
            final android.view.View child = getChildClosestToStart();
    ...
    boolean resolveIsInfinite() {
        return (mOrientationHelper.getMode() == android.view.View.MeasureSpec.UNSPECIFIED) && (mOrientationHelper.getEnd() == 0);
    }
    ...
    int gatherPrefetchIndices(int dx, int dy, android.support.v7.widget.RecyclerView.State state, int[] outIndices) {
        int delta = (mOrientation == android.support.v7.widget.LinearLayoutManager.HORIZONTAL) ? dx : dy;
        if ((getChildCount() == 0) || (delta == 0)) {
            // can't support this scroll, so don't bother prefetching
            return 0;
        }
        final int layoutDirection = (delta > 0) ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END : android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START;
        final int absDy = java.lang.Math.abs(delta);
    ...
    int scrollBy(int dy, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        ...
        ensureLayoutState();
        final int layoutDirection = (dy > 0) ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END : android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START;
        final int absDy = java.lang.Math.abs(dy);
        updateLayoutState(layoutDirection, absDy, true, state);
        final int consumed = mLayoutState.mScrollingOffset + fill(recycler, mLayoutState, state, false);
        if (consumed < 0) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Don't have any more elements to scroll");
            }
            return 0;
        }
        ...
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, (("scroll req: " + dy) + " scrolled: ") + scrolled);
        }
    ...
    private void recycleChildren(android.support.v7.widget.RecyclerView.Recycler recycler, int startIndex, int endIndex) {
        ...
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, ("Recycling " + java.lang.Math.abs(startIndex - endIndex)) + " items");
        }
    ...
    private void recycleViewsFromStart(android.support.v7.widget.RecyclerView.Recycler recycler, int dt) {
        if (dt < 0) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Called recycle from start with a negative value. This might happen" + " during layout changes but may be sign of a bug");
            }
            return;
        }
    ...
    private void recycleViewsFromEnd(android.support.v7.widget.RecyclerView.Recycler recycler, int dt) {
        ...
        if (dt < 0) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Called recycle from end with a negative value. This might happen" + " during layout changes but may be sign of a bug");
            }
            return;
        }
     ...
     * @param layoutState
     * 		Current layout state. Right now, this object does not change but
     ...
     */
    private void recycleByLayoutState(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.LinearLayoutManager.LayoutState layoutState) {
     ...
     */
    int fill(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.LinearLayoutManager.LayoutState layoutState, android.support.v7.widget.RecyclerView.State state, boolean stopOnFocusable) {
    ...
    void layoutChunk(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state, android.support.v7.widget.LinearLayoutManager.LayoutState layoutState, android.support.v7.widget.LinearLayoutManager.LayoutChunkResult result) {
        ...
        if (view == null) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG && (layoutState.mScrapList == null)) {
                throw new java.lang.RuntimeException("received null view when unexpected");
            }
        ...
        if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, (((((((("laid out child at position " + getPosition(view)) + ", with l:") + (left + params.leftMargin)) + ", t:") + (top + params.topMargin)) + ", r:") + (right - params.rightMargin)) + ", b:") + (bottom - params.bottomMargin));
        }
    ...
    boolean shouldMeasureTwice() {
        return ((getHeightMode() != android.view.View.MeasureSpec.EXACTLY) && (getWidthMode() != android.view.View.MeasureSpec.EXACTLY)) && hasFlexibleChildInBothOrientations();
    }
    ...
    int convertFocusDirectionToLayoutDirection(int focusDirection) {
        switch (focusDirection) {
            case android.view.View.FOCUS_BACKWARD :
                if (mOrientation == android.support.v7.widget.LinearLayoutManager.VERTICAL) {
                    return android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START;
                } else
                    if (isLayoutRTL()) {
                        return android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END;
                    } else {
                        return android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START;
                    }
            ...
            case android.view.View.FOCUS_UP :
                return mOrientation == android.support.v7.widget.LinearLayoutManager.VERTICAL ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START : android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case android.view.View.FOCUS_DOWN :
                return mOrientation == android.support.v7.widget.LinearLayoutManager.VERTICAL ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END : android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case android.view.View.FOCUS_LEFT :
                return mOrientation == android.support.v7.widget.LinearLayoutManager.HORIZONTAL ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START : android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            case android.view.View.FOCUS_RIGHT :
                return mOrientation == android.support.v7.widget.LinearLayoutManager.HORIZONTAL ? android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_END : android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT;
            default :
                if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                    android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Unknown focus request:" + focusDirection);
                }
                return android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT;
        }
    }
     ...
     * enough children.
     *
     * @param completelyVisible
     * 		Whether child should be completely visible or not
     * @return The first visible child closest to start of the layout from user's perspective.
     */
    private android.view.View findFirstVisibleChildClosestToStart(boolean completelyVisible, boolean acceptPartiallyVisible) {
        if (mShouldReverseLayout) {
     ...
     */
    private android.view.View findFirstVisibleChildClosestToEnd(boolean completelyVisible, boolean acceptPartiallyVisible) {
        if (mShouldReverseLayout) {
            return findOneVisibleChild(0, getChildCount(), completelyVisible, acceptPartiallyVisible);
        } else {
            return findOneVisibleChild(getChildCount() - 1, -1, completelyVisible, acceptPartiallyVisible);
     ...
     */
    private android.view.View findReferenceChildClosestToEnd(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private android.view.View findReferenceChildClosestToStart(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        return mShouldReverseLayout ? findLastReferenceChild(recycler, state) : findFirstReferenceChild(recycler, state);
    }

    private android.view.View findFirstReferenceChild(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private android.view.View findLastReferenceChild(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
    ...
    public int findFirstVisibleItemPosition() {
        final android.view.View child = findOneVisibleChild(0, getChildCount(), false, true);
        return child == null ? android.support.v7.widget.RecyclerView.NO_POSITION : getPosition(child);
    }
    ...
    public int findFirstCompletelyVisibleItemPosition() {
        final android.view.View child = findOneVisibleChild(0, getChildCount(), true, false);
        return child == null ? android.support.v7.widget.RecyclerView.NO_POSITION : getPosition(child);
    }
    ...
    public int findLastVisibleItemPosition() {
        final android.view.View child = findOneVisibleChild(getChildCount() - 1, -1, false, true);
        return child == null ? android.support.v7.widget.RecyclerView.NO_POSITION : getPosition(child);
    }
    ...
    public int findLastCompletelyVisibleItemPosition() {
        final android.view.View child = findOneVisibleChild(getChildCount() - 1, -1, true, false);
        return child == null ? android.support.v7.widget.RecyclerView.NO_POSITION : getPosition(child);
    }
    ...
    public android.view.View onFocusSearchFailed(android.view.View focused, int focusDirection, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        ...
        if (layoutDir == android.support.v7.widget.LinearLayoutManager.LayoutState.INVALID_LAYOUT) {
            return null;
        }
        ensureLayoutState();
        final android.view.View referenceChild;
        if (layoutDir == android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START) {
        ...
        if (referenceChild == null) {
            if (android.support.v7.widget.LinearLayoutManager.DEBUG) {
                android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "Cannot find a child with a valid position to be used for focus search.");
            }
            return null;
        }
        ensureLayoutState();
        final int maxScroll = ((int) (android.support.v7.widget.LinearLayoutManager.MAX_SCROLL_FACTOR * mOrientationHelper.getTotalSpace()));
        updateLayoutState(layoutDir, maxScroll, false, state);
        mLayoutState.mScrollingOffset = android.support.v7.widget.LinearLayoutManager.LayoutState.SCROLLING_OFFSET_NaN;
        mLayoutState.mRecycle = false;
        fill(recycler, mLayoutState, state, true);
        final android.view.View nextFocus;
        if (layoutDir == android.support.v7.widget.LinearLayoutManager.LayoutState.LAYOUT_START) {
    ...
    private void logChildren() {
        android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "internal representation of views on the screen");
        for (int i = 0; i < getChildCount(); i++) {
            android.view.View child = getChildAt(i);
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, (("item " + getPosition(child)) + ", coord:") + mOrientationHelper.getDecoratedStart(child));
        }
        android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "==============");
    }
    ...
    void validateChildOrder() {
        android.util.Log.d(android.support.v7.widget.LinearLayoutManager.TAG, "validating child count " + getChildCount());
        if (getChildCount() < 1) {
            return;
        }
        ...
        if (mShouldReverseLayout) {
            for (int i = 1; i < getChildCount(); i++) {
                ...
                if (pos < lastPos) {
                    logChildren();
                    throw new java.lang.RuntimeException("detected invalid position. loc invalid? " + (screenLoc < lastScreenLoc));
                }
     ...
     *
     *
     * @unknown This method should be called by ItemTouchHelper only.
     */
    ...
    public void prepareForDrop(android.view.View view, android.view.View target, int x, int y) {
        ...
        final int dropDirection = (myPos < targetPos) ? android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL : android.support.v7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_HEAD;
        if (mShouldReverseLayout) {
    ...
    static class LayoutState {
        ...
        static final int INVALID_LAYOUT = java.lang.Integer.MIN_VALUE;

        static final int ITEM_DIRECTION_HEAD = -1;

        static final int ITEM_DIRECTION_TAIL = 1;

        static final int SCROLLING_OFFSET_NaN = java.lang.Integer.MIN_VALUE;
         ...
         */
        java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> mScrapList = null;
         ...
         */
        android.view.View next(android.support.v7.widget.RecyclerView.Recycler recycler) {
            if (mScrapList != null) {
                return nextViewFromScrapList();
            }
            final android.view.View view = recycler.getViewForPosition(mCurrentPosition);
        ...
        private android.view.View nextViewFromScrapList() {
            ...
            for (int i = 0; i < size; i++) {
                final android.view.View view = mScrapList.get(i).itemView;
        ...
        public void assignPositionFromScrapList(android.view.View ignore) {
            final android.view.View closest = nextViewInLimitedList(ignore);
            if (closest == null) {
                mCurrentPosition = android.support.v7.widget.RecyclerView.NO_POSITION;
            } else {
                mCurrentPosition = ((android.support.v7.widget.RecyclerView.LayoutParams) (closest.getLayoutParams())).getViewLayoutPosition();
            }
        }

        public android.view.View nextViewInLimitedList(android.view.View ignore) {
            int size = mScrapList.size();
            android.view.View closest = null;
            int closestDistance = java.lang.Integer.MAX_VALUE;
            if (android.support.v7.widget.LinearLayoutManager.DEBUG && mIsPreLayout) {
                throw new java.lang.IllegalStateException("Scrap list cannot be used in pre layout");
            }
            for (int i = 0; i < size; i++) {
                android.view.View view = mScrapList.get(i).itemView;
                final android.support.v7.widget.RecyclerView.LayoutParams lp = ((android.support.v7.widget.RecyclerView.LayoutParams) (view.getLayoutParams()));
        ...
        void log() {
            android.util.Log.d(android.support.v7.widget.LinearLayoutManager.LayoutState.TAG, (((((((("avail:" + mAvailable) + ", ind:") + mCurrentPosition) + ", dir:") + mItemDirection) + ", offset:") + mOffset) + ", layoutDir:") + mLayoutDirection);
        }
    }
    ...
    public static class SavedState implements android.os.Parcelable {
        ...
        public static final android.os.Parcelable.Creator<android.support.v7.widget.LinearLayoutManager.SavedState> CREATOR = new android.os.Parcelable.Creator<android.support.v7.widget.LinearLayoutManager.SavedState>() {
            @java.lang.Override
            public android.support.v7.widget.LinearLayoutManager.SavedState createFromParcel(android.os.Parcel in) {
    ...
    class AnchorInfo {
        ...
        void reset() {
            ...
            mCoordinate = android.support.v7.widget.LinearLayoutManager.INVALID_OFFSET;
        ...
        boolean isViewValidAsAnchor(android.view.View child, android.support.v7.widget.RecyclerView.State state) {
        ...
        public void assignFromViewAndKeepVisibleRect(android.view.View child) {
            ...
            if (mLayoutFromEnd) {
                ...
                if (previousEndMargin > 0) {
                    ...
                    final int startReference = layoutStart + java.lang.Math.min(previousStartMargin, 0);
                    final int startMargin = estimatedChildStart - startReference;
                    if (startMargin < 0) {
                        // offset to make top visible but not too much
                        mCoordinate += java.lang.Math.min(previousEndMargin, -startMargin);
                    }
                }
            } else {
                final int childStart = mOrientationHelper.getDecoratedStart(child);
                ...
                if (startMargin > 0) {
                    ...
                    final int endReference = mOrientationHelper.getEndAfterPadding() - java.lang.Math.min(0, previousEndMargin);
                    final int endMargin = endReference - estimatedEnd;
                    if (endMargin < 0) {
                        mCoordinate -= java.lang.Math.min(startMargin, -endMargin);
                    }
                }
            }
        }

        public void assignFromView(android.view.View child) {
            if (mLayoutFromEnd) {
