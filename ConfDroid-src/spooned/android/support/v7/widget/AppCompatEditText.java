...
public class AppCompatEditText extends android.widget.EditText implements android.support.v4.view.TintableBackgroundView {
    ...
    public AppCompatEditText(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, R.attr.editTextStyle);
    }

    public AppCompatEditText(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
