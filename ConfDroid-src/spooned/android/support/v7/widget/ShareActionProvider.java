 ...
 *
 * <ol>
 * <li>Get a reference to the ShareActionProvider by calling {@link android.view.MenuItem#getActionProvider getActionProvider()} and
 ...
 * file with the name specified by {@link #DEFAULT_SHARE_HISTORY_FILE_NAME}. Ordinarily, the share action provider stores
 ...
 * you specify is used until the next time you call {@link #setShareHistoryFileName setShareHistoryFileName()}.</p>
 *
 * @see ActionProvider
 */
public class ShareActionProvider extends android.support.v4.view.ActionProvider {
    ...
    public interface OnShareTargetSelectedListener {
         ...
         */
        public boolean onShareTargetSelected(android.support.v7.widget.ShareActionProvider source, android.content.Intent intent);
    }
     ...
     */
    private int mMaxShownActivityCount = android.support.v7.widget.ShareActionProvider.DEFAULT_INITIAL_ACTIVITY_COUNT;

    /**
     * Listener for handling menu item clicks.
     */
    private final android.support.v7.widget.ShareActionProvider.ShareMenuItemOnMenuItemClickListener mOnMenuItemClickListener = new android.support.v7.widget.ShareActionProvider.ShareMenuItemOnMenuItemClickListener();
     ...
     */
    java.lang.String mShareHistoryFileName = android.support.v7.widget.ShareActionProvider.DEFAULT_SHARE_HISTORY_FILE_NAME;
    ...
    public android.view.View onCreateActionView() {
        ...
        android.support.v7.widget.ActivityChooserView activityChooserView = new android.support.v7.widget.ActivityChooserView(mContext);
        if (!activityChooserView.isInEditMode()) {
            android.support.v7.widget.ActivityChooserModel dataModel = android.support.v7.widget.ActivityChooserModel.get(mContext, mShareHistoryFileName);
            activityChooserView.setActivityChooserModel(dataModel);
        }
        // Lookup and set the expand action icon.
        android.util.TypedValue outTypedValue = new android.util.TypedValue();
        mContext.getTheme().resolveAttribute(R.attr.actionModeShareDrawable, outTypedValue, true);
        android.graphics.drawable.Drawable drawable = android.support.v7.content.res.AppCompatResources.getDrawable(mContext, outTypedValue.resourceId);
    ...
    public void onPrepareSubMenu(android.view.SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            ...
            android.view.SubMenu expandedSubMenu = subMenu.addSubMenu(android.view.Menu.NONE, collapsedActivityCount, collapsedActivityCount, mContext.getString(R.string.abc_activity_chooser_view_see_all));
    ...
    private void setActivityChooserPolicyIfNeeded() {
        ...
        if (mOnChooseActivityListener == null) {
            mOnChooseActivityListener = new android.support.v7.widget.ShareActionProvider.ShareActivityChooserModelPolicy();
        }
        android.support.v7.widget.ActivityChooserModel dataModel = android.support.v7.widget.ActivityChooserModel.get(mContext, mShareHistoryFileName);
    ...
    private class ShareActivityChooserModelPolicy implements android.support.v7.widget.ActivityChooserModel.OnChooseActivityListener {
        ...
        public boolean onChooseActivity(android.support.v7.widget.ActivityChooserModel host, android.content.Intent intent) {
            if (mOnShareTargetSelectedListener != null) {
                mOnShareTargetSelectedListener.onShareTargetSelected(android.support.v7.widget.ShareActionProvider.this, intent);
            }
            return false;
        }
    }
    ...
    void updateIntent(android.content.Intent intent) {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            ...
            intent.addFlags(android.content.Intent.FLAG_ACTIVITY_NEW_DOCUMENT | android.content.Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
        } else {
