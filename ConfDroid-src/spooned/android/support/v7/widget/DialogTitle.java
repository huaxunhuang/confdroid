        ...
        if (layout != null) {
            ...
            if (lineCount > 0) {
                ...
                if (ellipsisCount > 0) {
                    setSingleLine(false);
                    setMaxLines(2);
                    final android.content.res.TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.TextAppearance, android.R.attr.textAppearanceMedium, android.R.style.TextAppearance_Medium);
