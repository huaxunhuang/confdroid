...
public class ActionMenuView extends android.support.v7.widget.LinearLayoutCompat implements android.support.v7.view.menu.MenuBuilder.ItemInvoker , android.support.v7.view.menu.MenuView {
    ...
    public ActionMenuView(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        setBaselineAligned(false);
        final float density = context.getResources().getDisplayMetrics().density;
        mMinCellSize = ((int) (android.support.v7.widget.ActionMenuView.MIN_CELL_SIZE * density));
        mGeneratedItemPadding = ((int) (android.support.v7.widget.ActionMenuView.GENERATED_ITEM_PADDING * density));
     ...
     *
     * @param presenter
     * 		Menu presenter used to display popup menu
     * @unknown 
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    public void setPresenter(android.support.v7.widget.ActionMenuPresenter presenter) {
    ...
    public void setOnMenuItemClickListener(android.support.v7.widget.ActionMenuView.OnMenuItemClickListener listener) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mFormatItems = android.view.View.MeasureSpec.getMode(widthMeasureSpec) == android.view.View.MeasureSpec.EXACTLY;
        ...
        if (mFormatItems && (childCount > 0)) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (child.getLayoutParams()));
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int itemHeightSpec = android.view.ViewGroup.getChildMeasureSpec(heightMeasureSpec, heightPadding, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final boolean isGeneratedItem = child instanceof android.support.v7.view.menu.ActionMenuItemView;
            visibleItemCount++;
            if (isGeneratedItem) {
            ...
            lp.leftMargin = 0;
            lp.rightMargin = 0;
            lp.preventEdgeOffset = isGeneratedItem && ((android.support.v7.view.menu.ActionMenuItemView) (child)).hasText();
            // Overflow always gets 1 cell. No more, no less.
            final int cellsAvailable = (lp.isOverflowButton) ? 1 : cellsRemaining;
            final int cellsUsed = android.support.v7.widget.ActionMenuView.measureChildForCells(child, cellSize, cellsAvailable, itemHeightSpec, heightPadding);
            maxCellsUsed = java.lang.Math.max(maxCellsUsed, cellsUsed);
            if (lp.expandable)
                expandableItemCount++;
            ...
            maxChildHeight = java.lang.Math.max(maxChildHeight, child.getMeasuredHeight());
            if (cellsUsed == 1)
                smallestItemsAt |= 1 << i;
        ...
        while ((expandableItemCount > 0) && (cellsRemaining > 0)) {
            int minCells = java.lang.Integer.MAX_VALUE;
        ...
        if (((cellsRemaining > 0) && (smallestItemsAt != 0)) && (((cellsRemaining < (visibleItemCount - 1)) || singleItem) || (maxCellsUsed > 1))) {
            float expandCount = java.lang.Long.bitCount(smallestItemsAt);
            if (!singleItem) {
                // The items at the far edges may only expand by half in order to pin to either side.
                if ((smallestItemsAt & 1) != 0) {
                    android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (getChildAt(0).getLayoutParams()));
                    if (!lp.preventEdgeOffset)
                        expandCount -= 0.5F;

                }
                if ((smallestItemsAt & (1 << (childCount - 1))) != 0) {
                    android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (getChildAt(childCount - 1).getLayoutParams()));
                    if (!lp.preventEdgeOffset)
                        expandCount -= 0.5F;
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final android.view.View child = getChildAt(i);
                final android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (child.getLayoutParams()));
                if (child instanceof android.support.v7.view.menu.ActionMenuItemView) {
        ...
        if (needsExpansion) {
            for (int i = 0; i < childCount; i++) {
                ...
                child.measure(android.view.View.MeasureSpec.makeMeasureSpec(width, android.view.View.MeasureSpec.EXACTLY), itemHeightSpec);
            }
        }
     ...
     */
    static int measureChildForCells(android.view.View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        final android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (child.getLayoutParams()));
        final int childHeightSize = android.view.View.MeasureSpec.getSize(parentHeightMeasureSpec) - parentHeightPadding;
        final int childHeightMode = android.view.View.MeasureSpec.getMode(parentHeightMeasureSpec);
        final int childHeightSpec = android.view.View.MeasureSpec.makeMeasureSpec(childHeightSize, childHeightMode);
        final android.support.v7.view.menu.ActionMenuItemView itemView = (child instanceof android.support.v7.view.menu.ActionMenuItemView) ? ((android.support.v7.view.menu.ActionMenuItemView) (child)) : null;
        final boolean hasText = (itemView != null) && itemView.hasText();
        int cellsUsed = 0;
        if ((cellsRemaining > 0) && ((!hasText) || (cellsRemaining >= 2))) {
            final int childWidthSpec = android.view.View.MeasureSpec.makeMeasureSpec(cellSize * cellsRemaining, android.view.View.MeasureSpec.AT_MOST);
        ...
        child.measure(android.view.View.MeasureSpec.makeMeasureSpec(targetWidth, android.view.View.MeasureSpec.EXACTLY), childHeightSpec);
        return cellsUsed;
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            android.support.v7.widget.ActionMenuView.LayoutParams p = ((android.support.v7.widget.ActionMenuView.LayoutParams) (v.getLayoutParams()));
        ...
        if ((childCount == 1) && (!hasOverflow)) {
            ...
            final android.view.View v = getChildAt(0);
        ...
        final int spacerSize = java.lang.Math.max(0, spacerCount > 0 ? widthRemaining / spacerCount : 0);
        if (isLayoutRtl) {
            int startRight = getWidth() - getPaddingRight();
            for (int i = 0; i < childCount; i++) {
                final android.view.View v = getChildAt(i);
                final android.support.v7.widget.ActionMenuView.LayoutParams lp = ((android.support.v7.widget.ActionMenuView.LayoutParams) (v.getLayoutParams()));
                if ((v.getVisibility() == android.view.View.GONE) || lp.isOverflowButton) {
                    continue;
                }
    ...
    protected android.support.v7.widget.ActionMenuView.LayoutParams generateDefaultLayoutParams() {
        android.support.v7.widget.ActionMenuView.LayoutParams params = new android.support.v7.widget.ActionMenuView.LayoutParams(android.support.v7.widget.ActionMenuView.LayoutParams.WRAP_CONTENT, android.support.v7.widget.ActionMenuView.LayoutParams.WRAP_CONTENT);
        params.gravity = android.view.Gravity.CENTER_VERTICAL;
        return params;
    }

    @java.lang.Override
    public android.support.v7.widget.ActionMenuView.LayoutParams generateLayoutParams(android.util.AttributeSet attrs) {
        return new android.support.v7.widget.ActionMenuView.LayoutParams(getContext(), attrs);
    }

    @java.lang.Override
    protected android.support.v7.widget.ActionMenuView.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (p != null) {
            final android.support.v7.widget.ActionMenuView.LayoutParams result = (p instanceof android.support.v7.widget.ActionMenuView.LayoutParams) ? new android.support.v7.widget.ActionMenuView.LayoutParams(((android.support.v7.widget.ActionMenuView.LayoutParams) (p))) : new android.support.v7.widget.ActionMenuView.LayoutParams(p);
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return (p != null) && (p instanceof android.support.v7.widget.ActionMenuView.LayoutParams);
    }
    ...
    public android.support.v7.widget.ActionMenuView.LayoutParams generateOverflowButtonLayoutParams() {
        android.support.v7.widget.ActionMenuView.LayoutParams result = generateDefaultLayoutParams();
    ...
    public android.view.Menu getMenu() {
        if (mMenu == null) {
            ...
            mMenu.setCallback(new android.support.v7.widget.ActionMenuView.MenuBuilderCallback());
            mPresenter = new android.support.v7.widget.ActionMenuPresenter(context);
            mPresenter.setReserveOverflow(true);
            mPresenter.setCallback(mActionMenuPresenterCallback != null ? mActionMenuPresenterCallback : new android.support.v7.widget.ActionMenuView.ActionMenuPresenterCallback());
     ...
     *
     * @unknown Internal use only for action bar integration
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
     ...
     *
     *
     * @unknown Private LinearLayout (superclass) API. Un-hide if LinearLayout API is made public.
     */
    @android.support.annotation.RestrictTo(android.support.annotation.RestrictTo.Scope.GROUP_ID)
    protected boolean hasSupportDividerBeforeChildAt(int childIndex) {
        ...
        final android.view.View childBefore = getChildAt(childIndex - 1);
        final android.view.View child = getChildAt(childIndex);
        boolean result = false;
        if ((childIndex < getChildCount()) && (childBefore instanceof android.support.v7.widget.ActionMenuView.ActionMenuChildView)) {
            result |= ((android.support.v7.widget.ActionMenuView.ActionMenuChildView) (childBefore)).needsDividerAfter();
        }
        if ((childIndex > 0) && (child instanceof android.support.v7.widget.ActionMenuView.ActionMenuChildView)) {
            result |= ((android.support.v7.widget.ActionMenuView.ActionMenuChildView) (child)).needsDividerBefore();
        }
        return result;
    }
    ...
    private class ActionMenuPresenterCallback implements android.support.v7.view.menu.MenuPresenter.Callback {
