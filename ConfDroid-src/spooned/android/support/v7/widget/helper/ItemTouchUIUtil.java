...
public interface ItemTouchUIUtil {
     ...
     */
    void onDraw(android.graphics.Canvas c, android.support.v7.widget.RecyclerView recyclerView, android.view.View view, float dX, float dY, int actionState, boolean isCurrentlyActive);

    /**
     * The default implementation for {@link ItemTouchHelper.Callback#onChildDrawOver(Canvas,
     * RecyclerView, RecyclerView.ViewHolder, float, float, int, boolean)}
     */
    void onDrawOver(android.graphics.Canvas c, android.support.v7.widget.RecyclerView recyclerView, android.view.View view, float dX, float dY, int actionState, boolean isCurrentlyActive);
