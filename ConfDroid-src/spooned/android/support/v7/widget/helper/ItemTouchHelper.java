...
public class ItemTouchHelper extends android.support.v7.widget.RecyclerView.ItemDecoration implements android.support.v7.widget.RecyclerView.OnChildAttachStateChangeListener {
     ...
     */
    public static final int START = android.support.v7.widget.helper.ItemTouchHelper.LEFT << 2;

    /**
     * Horizontal end direction. Resolved to LEFT or RIGHT depending on RecyclerView's layout
     * direction. Used for swipe & drag control.
     */
    public static final int END = android.support.v7.widget.helper.ItemTouchHelper.RIGHT << 2;
    ...
    private static final int ACTION_MODE_IDLE_MASK = (1 << android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT) - 1;

    static final int ACTION_MODE_SWIPE_MASK = android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_IDLE_MASK << android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT;

    static final int ACTION_MODE_DRAG_MASK = android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_SWIPE_MASK << android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT;
     ...
     */
    final java.util.List<android.view.View> mPendingCleanup = new java.util.ArrayList<android.view.View>();
     ...
     */
    int mActivePointerId = android.support.v7.widget.helper.ItemTouchHelper.ACTIVE_POINTER_ID_NONE;
     ...
     * Current mode.
     */
    int mActionState = android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_IDLE;
     ...
     * jumpy UIs.
     */
    java.util.List<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation> mRecoverAnimations = new java.util.ArrayList<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation>();
     ...
     */
    final java.lang.Runnable mScrollRunnable = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            if ((mSelected != null) && scrollIfNecessary()) {
                ...
                android.support.v4.view.ViewCompat.postOnAnimation(mRecyclerView, this);
            }
        }
    };
    ...
    private final android.support.v7.widget.RecyclerView.OnItemTouchListener mOnItemTouchListener = new android.support.v7.widget.RecyclerView.OnItemTouchListener() {
        @java.lang.Override
        public boolean onInterceptTouchEvent(android.support.v7.widget.RecyclerView recyclerView, android.view.MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (android.support.v7.widget.helper.ItemTouchHelper.DEBUG) {
                android.util.Log.d(android.support.v7.widget.helper.ItemTouchHelper.TAG, (((("intercept: x:" + event.getX()) + ",y:") + event.getY()) + ", ") + event);
            }
            final int action = android.support.v4.view.MotionEventCompat.getActionMasked(event);
            if (action == android.view.MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation animation = findAnimation(event);
                    if (animation != null) {
                ...
                if ((action == android.view.MotionEvent.ACTION_CANCEL) || (action == android.view.MotionEvent.ACTION_UP)) {
                    mActivePointerId = android.support.v7.widget.helper.ItemTouchHelper.ACTIVE_POINTER_ID_NONE;
                    select(null, android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_IDLE);
                } else
                    if (mActivePointerId != android.support.v7.widget.helper.ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
                        // in a non scroll orientation, if distance change is above threshold, we
                        // can select the item
                        final int index = event.findPointerIndex(mActivePointerId);
                        if (android.support.v7.widget.helper.ItemTouchHelper.DEBUG) {
                            android.util.Log.d(android.support.v7.widget.helper.ItemTouchHelper.TAG, "pointer index " + index);
                        }
                        if (index >= 0) {
        ...
        @java.lang.Override
        public void onTouchEvent(android.support.v7.widget.RecyclerView recyclerView, android.view.MotionEvent event) {
            mGestureDetector.onTouchEvent(event);
            if (android.support.v7.widget.helper.ItemTouchHelper.DEBUG) {
                android.util.Log.d(android.support.v7.widget.helper.ItemTouchHelper.TAG, (((("on touch: x:" + mInitialTouchX) + ",y:") + mInitialTouchY) + ", :") + event);
            }
            if (mVelocityTracker != null) {
                mVelocityTracker.addMovement(event);
            }
            ...
            switch (action) {
                ...
                case android.view.MotionEvent.ACTION_POINTER_UP :
                    {
                        final int pointerIndex = android.support.v4.view.MotionEventCompat.getActionIndex(event);
     ...
     */
    public ItemTouchHelper(android.support.v7.widget.helper.ItemTouchHelper.Callback callback) {
        mCallback = callback;
    }

    private static boolean hitTest(android.view.View child, float x, float y, float left, float top) {
    ...
    android.support.v7.widget.RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            final android.content.res.Resources resources = recyclerView.getResources();
    ...
    private void setupCallbacks() {
        android.view.ViewConfiguration vc = android.view.ViewConfiguration.get(mRecyclerView.getContext());
    ...
    private void destroyCallbacks() {
        ...
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation recoverAnimation = mRecoverAnimations.get(0);
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new android.support.v4.view.GestureDetectorCompat(mRecyclerView.getContext(), new android.support.v7.widget.helper.ItemTouchHelper.ItemTouchHelperGestureListener());
    }

    private void getSelectedDxDy(float[] outPosition) {
        if ((mSelectedFlags & (android.support.v7.widget.helper.ItemTouchHelper.LEFT | android.support.v7.widget.helper.ItemTouchHelper.RIGHT)) != 0) {
            outPosition[0] = (mSelectedStartX + mDx) - mSelected.itemView.getLeft();
        } else {
            outPosition[0] = android.support.v4.view.ViewCompat.getTranslationX(mSelected.itemView);
        }
        if ((mSelectedFlags & (android.support.v7.widget.helper.ItemTouchHelper.UP | android.support.v7.widget.helper.ItemTouchHelper.DOWN)) != 0) {
            outPosition[1] = (mSelectedStartY + mDy) - mSelected.itemView.getTop();
        } else {
            outPosition[1] = android.support.v4.view.ViewCompat.getTranslationY(mSelected.itemView);
        }
    }
    ...
    void select(android.support.v7.widget.RecyclerView.ViewHolder selected, int actionState) {
        ...
        int actionStateMask = (1 << (android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT + (android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT * actionState))) - 1;
        boolean preventLayout = false;
        if (mSelected != null) {
            final android.support.v7.widget.RecyclerView.ViewHolder prevSelected = mSelected;
            if (prevSelected.itemView.getParent() != null) {
                final int swipeDir = (prevActionState == android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG) ? 0 : swipeIfNecessary(prevSelected);
                releaseVelocityTracker();
                ...
                int animationType;
                switch (swipeDir) {
                    case android.support.v7.widget.helper.ItemTouchHelper.LEFT :
                    case android.support.v7.widget.helper.ItemTouchHelper.RIGHT :
                    case android.support.v7.widget.helper.ItemTouchHelper.START :
                    case android.support.v7.widget.helper.ItemTouchHelper.END :
                        targetTranslateY = 0;
                        targetTranslateX = java.lang.Math.signum(mDx) * mRecyclerView.getWidth();
                        break;
                    case android.support.v7.widget.helper.ItemTouchHelper.UP :
                    case android.support.v7.widget.helper.ItemTouchHelper.DOWN :
                        targetTranslateX = 0;
                        targetTranslateY = java.lang.Math.signum(mDy) * mRecyclerView.getHeight();
                        break;
                    default :
                        targetTranslateX = 0;
                        targetTranslateY = 0;
                }
                if (prevActionState == android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG) {
                    animationType = android.support.v7.widget.helper.ItemTouchHelper.ANIMATION_TYPE_DRAG;
                } else
                    if (swipeDir > 0) {
                        animationType = android.support.v7.widget.helper.ItemTouchHelper.ANIMATION_TYPE_SWIPE_SUCCESS;
                    } else {
                        animationType = android.support.v7.widget.helper.ItemTouchHelper.ANIMATION_TYPE_SWIPE_CANCEL;
                    }

                getSelectedDxDy(mTmpPosition);
                final float currentTranslateX = mTmpPosition[0];
                final float currentTranslateY = mTmpPosition[1];
                final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation rv = new android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation(prevSelected, animationType, prevActionState, currentTranslateX, currentTranslateY, targetTranslateX, targetTranslateY) {
                    @java.lang.Override
        ...
        if (selected != null) {
            mSelectedFlags = (mCallback.getAbsoluteMovementFlags(mRecyclerView, selected) & actionStateMask) >> (mActionState * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT);
            mSelectedStartX = selected.itemView.getLeft();
            mSelectedStartY = selected.itemView.getTop();
            mSelected = selected;
            if (actionState == android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG) {
                mSelected.itemView.performHapticFeedback(android.view.HapticFeedbackConstants.LONG_PRESS);
            }
        }
        final android.view.ViewParent rvParent = mRecyclerView.getParent();
        if (rvParent != null) {
    ...
    void postDispatchSwipe(final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim, final int swipeDir) {
        // wait until animations are complete.
        mRecyclerView.post(new java.lang.Runnable() {
            @java.lang.Override
            public void run() {
                if ((((mRecyclerView != null) && mRecyclerView.isAttachedToWindow()) && (!anim.mOverridden)) && (anim.mViewHolder.getAdapterPosition() != android.support.v7.widget.RecyclerView.NO_POSITION)) {
    ...
    boolean scrollIfNecessary() {
        ...
        final long scrollDuration = (mDragScrollStartTimeInMs == java.lang.Long.MIN_VALUE) ? 0 : now - mDragScrollStartTimeInMs;
    ...
    private java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> findSwapTargets(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        if (mSwapTargets == null) {
            mSwapTargets = new java.util.ArrayList<android.support.v7.widget.RecyclerView.ViewHolder>();
            mDistances = new java.util.ArrayList<java.lang.Integer>();
        } else {
            mSwapTargets.clear();
            mDistances.clear();
        }
        final int margin = mCallback.getBoundingBoxMargin();
        final int left = java.lang.Math.round(mSelectedStartX + mDx) - margin;
        final int top = java.lang.Math.round(mSelectedStartY + mDy) - margin;
        ...
        for (int i = 0; i < childCount; i++) {
            android.view.View other = lm.getChildAt(i);
            ...
            if (mCallback.canDropOver(mRecyclerView, mSelected, otherVh)) {
                ...
                final int dx = java.lang.Math.abs(centerX - ((other.getLeft() + other.getRight()) / 2));
                final int dy = java.lang.Math.abs(centerY - ((other.getTop() + other.getBottom()) / 2));
    ...
    void moveIfNecessary(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        ...
        if (mActionState != android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG) {
            return;
        }
        final float threshold = mCallback.getMoveThreshold(viewHolder);
        final int x = ((int) (mSelectedStartX + mDx));
        final int y = ((int) (mSelectedStartY + mDy));
        if ((java.lang.Math.abs(y - viewHolder.itemView.getTop()) < (viewHolder.itemView.getHeight() * threshold)) && (java.lang.Math.abs(x - viewHolder.itemView.getLeft()) < (viewHolder.itemView.getWidth() * threshold))) {
            return;
        }
        java.util.List<android.support.v7.widget.RecyclerView.ViewHolder> swapTargets = findSwapTargets(viewHolder);
    ...
    int endRecoverAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, boolean override) {
        final int recoverAnimSize = mRecoverAnimations.size();
        for (int i = recoverAnimSize - 1; i >= 0; i--) {
            final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim = mRecoverAnimations.get(i);
    ...
    private android.support.v7.widget.RecyclerView.ViewHolder findSwipedView(android.view.MotionEvent motionEvent) {
        final android.support.v7.widget.RecyclerView.LayoutManager lm = mRecyclerView.getLayoutManager();
        if (mActivePointerId == android.support.v7.widget.helper.ItemTouchHelper.ACTIVE_POINTER_ID_NONE) {
            return null;
        }
        ...
        final float absDx = java.lang.Math.abs(dx);
        final float absDy = java.lang.Math.abs(dy);
        ...
        android.view.View child = findChildView(motionEvent);
        if (child == null) {
            return null;
        }
     ...
     */
    boolean checkSelectForSwipe(int action, android.view.MotionEvent motionEvent, int pointerIndex) {
        if ((((mSelected != null) || (action != android.view.MotionEvent.ACTION_MOVE)) || (mActionState == android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG)) || (!mCallback.isItemViewSwipeEnabled())) {
            return false;
        }
        ...
        final int swipeFlags = (movementFlags & android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_SWIPE_MASK) >> (android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT * android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE);
        if (swipeFlags == 0) {
            return false;
        }
        ...
        if (absDx > absDy) {
            if ((dx < 0) && ((swipeFlags & android.support.v7.widget.helper.ItemTouchHelper.LEFT) == 0)) {
                return false;
            }
            if ((dx > 0) && ((swipeFlags & android.support.v7.widget.helper.ItemTouchHelper.RIGHT) == 0)) {
                return false;
            }
        } else {
            if ((dy < 0) && ((swipeFlags & android.support.v7.widget.helper.ItemTouchHelper.UP) == 0)) {
                return false;
            }
            if ((dy > 0) && ((swipeFlags & android.support.v7.widget.helper.ItemTouchHelper.DOWN) == 0)) {
                return false;
            }
        }
        mDx = mDy = 0.0F;
        mActivePointerId = motionEvent.getPointerId(0);
        select(vh, android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE);
        return true;
    }

    android.view.View findChildView(android.view.MotionEvent event) {
        // first check elevated views, if none, then call RV
        final float x = event.getX();
        final float y = event.getY();
        if (mSelected != null) {
            final android.view.View selectedView = mSelected.itemView;
            if (android.support.v7.widget.helper.ItemTouchHelper.hitTest(selectedView, x, y, mSelectedStartX + mDx, mSelectedStartY + mDy)) {
                return selectedView;
            }
        }
        for (int i = mRecoverAnimations.size() - 1; i >= 0; i--) {
            final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim = mRecoverAnimations.get(i);
            final android.view.View view = anim.mViewHolder.itemView;
            if (android.support.v7.widget.helper.ItemTouchHelper.hitTest(view, x, y, anim.mX, anim.mY)) {
                return view;
            }
        }
    ...
    public void startDrag(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        if (!mCallback.hasDragFlag(mRecyclerView, viewHolder)) {
            android.util.Log.e(android.support.v7.widget.helper.ItemTouchHelper.TAG, "Start drag has been called but swiping is not enabled");
            return;
        }
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            android.util.Log.e(android.support.v7.widget.helper.ItemTouchHelper.TAG, "Start drag has been called with a view holder which is not a child of " + "the RecyclerView which is controlled by this ItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0.0F;
        select(viewHolder, android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG);
    }
    ...
    public void startSwipe(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        if (!mCallback.hasSwipeFlag(mRecyclerView, viewHolder)) {
            android.util.Log.e(android.support.v7.widget.helper.ItemTouchHelper.TAG, "Start swipe has been called but dragging is not enabled");
            return;
        }
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            android.util.Log.e(android.support.v7.widget.helper.ItemTouchHelper.TAG, "Start swipe has been called with a view holder which is not a child of " + "the RecyclerView controlled by this ItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0.0F;
        select(viewHolder, android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE);
    }

    android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation findAnimation(android.view.MotionEvent event) {
        if (mRecoverAnimations.isEmpty()) {
            return null;
        }
        android.view.View target = findChildView(event);
        for (int i = mRecoverAnimations.size() - 1; i >= 0; i--) {
            final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim = mRecoverAnimations.get(i);
    ...
    void updateDxDy(android.view.MotionEvent ev, int directionFlags, int pointerIndex) {
        final float x = ev.getX(pointerIndex);
        final float y = ev.getY(pointerIndex);
        // Calculate the distance moved
        mDx = x - mInitialTouchX;
        mDy = y - mInitialTouchY;
        if ((directionFlags & android.support.v7.widget.helper.ItemTouchHelper.LEFT) == 0) {
            mDx = java.lang.Math.max(0, mDx);
        }
        if ((directionFlags & android.support.v7.widget.helper.ItemTouchHelper.RIGHT) == 0) {
            mDx = java.lang.Math.min(0, mDx);
        }
        if ((directionFlags & android.support.v7.widget.helper.ItemTouchHelper.UP) == 0) {
            mDy = java.lang.Math.max(0, mDy);
        }
        if ((directionFlags & android.support.v7.widget.helper.ItemTouchHelper.DOWN) == 0) {
            mDy = java.lang.Math.min(0, mDy);
        }
    }
    ...
    private int swipeIfNecessary(android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
        ...
        final int absoluteMovementFlags = mCallback.convertToAbsoluteDirection(originalMovementFlags, android.support.v4.view.ViewCompat.getLayoutDirection(mRecyclerView));
        final int flags = (absoluteMovementFlags & android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_SWIPE_MASK) >> (android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT);
        if (flags == 0) {
            return 0;
        }
        final int originalFlags = (originalMovementFlags & android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_SWIPE_MASK) >> (android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT);
        int swipeDir;
        if (java.lang.Math.abs(mDx) > java.lang.Math.abs(mDy)) {
            if ((swipeDir = checkHorizontalSwipe(viewHolder, flags)) > 0) {
                ...
                if ((originalFlags & swipeDir) == 0) {
                    // convert to relative
                    return android.support.v7.widget.helper.ItemTouchHelper.Callback.convertToRelativeDirection(swipeDir, android.support.v4.view.ViewCompat.getLayoutDirection(mRecyclerView));
                }
                return swipeDir;
            }
    ...
    private int checkHorizontalSwipe(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int flags) {
        if ((flags & (android.support.v7.widget.helper.ItemTouchHelper.LEFT | android.support.v7.widget.helper.ItemTouchHelper.RIGHT)) != 0) {
            final int dirFlag = (mDx > 0) ? android.support.v7.widget.helper.ItemTouchHelper.RIGHT : android.support.v7.widget.helper.ItemTouchHelper.LEFT;
            if ((mVelocityTracker != null) && (mActivePointerId > (-1))) {
                mVelocityTracker.computeCurrentVelocity(android.support.v7.widget.helper.ItemTouchHelper.PIXELS_PER_SECOND, mCallback.getSwipeVelocityThreshold(mMaxSwipeVelocity));
                final float xVelocity = android.support.v4.view.VelocityTrackerCompat.getXVelocity(mVelocityTracker, mActivePointerId);
                final float yVelocity = android.support.v4.view.VelocityTrackerCompat.getYVelocity(mVelocityTracker, mActivePointerId);
                final int velDirFlag = (xVelocity > 0.0F) ? android.support.v7.widget.helper.ItemTouchHelper.RIGHT : android.support.v7.widget.helper.ItemTouchHelper.LEFT;
                final float absXVelocity = java.lang.Math.abs(xVelocity);
                if (((((velDirFlag & flags) != 0) && (dirFlag == velDirFlag)) && (absXVelocity >= mCallback.getSwipeEscapeVelocity(mSwipeEscapeVelocity))) && (absXVelocity > java.lang.Math.abs(yVelocity))) {
                    return velDirFlag;
                }
            }
            final float threshold = mRecyclerView.getWidth() * mCallback.getSwipeThreshold(viewHolder);
            if (((flags & dirFlag) != 0) && (java.lang.Math.abs(mDx) > threshold)) {
                return dirFlag;
            }
        }
        return 0;
    ...
    private int checkVerticalSwipe(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int flags) {
        if ((flags & (android.support.v7.widget.helper.ItemTouchHelper.UP | android.support.v7.widget.helper.ItemTouchHelper.DOWN)) != 0) {
            final int dirFlag = (mDy > 0) ? android.support.v7.widget.helper.ItemTouchHelper.DOWN : android.support.v7.widget.helper.ItemTouchHelper.UP;
            if ((mVelocityTracker != null) && (mActivePointerId > (-1))) {
                mVelocityTracker.computeCurrentVelocity(android.support.v7.widget.helper.ItemTouchHelper.PIXELS_PER_SECOND, mCallback.getSwipeVelocityThreshold(mMaxSwipeVelocity));
                final float xVelocity = android.support.v4.view.VelocityTrackerCompat.getXVelocity(mVelocityTracker, mActivePointerId);
                final float yVelocity = android.support.v4.view.VelocityTrackerCompat.getYVelocity(mVelocityTracker, mActivePointerId);
                final int velDirFlag = (yVelocity > 0.0F) ? android.support.v7.widget.helper.ItemTouchHelper.DOWN : android.support.v7.widget.helper.ItemTouchHelper.UP;
                final float absYVelocity = java.lang.Math.abs(yVelocity);
                if (((((velDirFlag & flags) != 0) && (velDirFlag == dirFlag)) && (absYVelocity >= mCallback.getSwipeEscapeVelocity(mSwipeEscapeVelocity))) && (absYVelocity > java.lang.Math.abs(xVelocity))) {
                    return velDirFlag;
                }
            }
            final float threshold = mRecyclerView.getHeight() * mCallback.getSwipeThreshold(viewHolder);
            if (((flags & dirFlag) != 0) && (java.lang.Math.abs(mDy) > threshold)) {
                return dirFlag;
            }
        }
        return 0;
    ...
    public static interface ViewDropHandler {
         ...
         * @param x
         * 		The <code>left</code> offset of the View that is being dragged. This value
         * 		includes the movement caused by the user.
         * @param y
         * 		The <code>top</code> offset of the View that is being dragged. This value
         * 		includes the movement caused by the user.
         */
        public void prepareForDrop(android.view.View view, android.view.View target, int x, int y);
    }
    ...
    public static abstract class Callback {
        ...
        static final int RELATIVE_DIR_FLAGS = ((android.support.v7.widget.helper.ItemTouchHelper.START | android.support.v7.widget.helper.ItemTouchHelper.END) | ((android.support.v7.widget.helper.ItemTouchHelper.START | android.support.v7.widget.helper.ItemTouchHelper.END) << android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT)) | ((android.support.v7.widget.helper.ItemTouchHelper.START | android.support.v7.widget.helper.ItemTouchHelper.END) << (2 * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT));

        private static final android.support.v7.widget.helper.ItemTouchUIUtil sUICallback;

        private static final int ABS_HORIZONTAL_DIR_FLAGS = ((android.support.v7.widget.helper.ItemTouchHelper.LEFT | android.support.v7.widget.helper.ItemTouchHelper.RIGHT) | ((android.support.v7.widget.helper.ItemTouchHelper.LEFT | android.support.v7.widget.helper.ItemTouchHelper.RIGHT) << android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT)) | ((android.support.v7.widget.helper.ItemTouchHelper.LEFT | android.support.v7.widget.helper.ItemTouchHelper.RIGHT) << (2 * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT));

        private static final android.view.animation.Interpolator sDragScrollInterpolator = new android.view.animation.Interpolator() {
            @java.lang.Override
        ...
        private static final android.view.animation.Interpolator sDragViewScrollCapInterpolator = new android.view.animation.Interpolator() {
            @java.lang.Override
            public float getInterpolation(float t) {
                t -= 1.0F;
        ...
        static {
            if (android.os.Build.VERSION.SDK_INT >= 21) {
                sUICallback = new android.support.v7.widget.helper.ItemTouchUIUtilImpl.Lollipop();
            } else
                if (android.os.Build.VERSION.SDK_INT >= 11) {
                    sUICallback = new android.support.v7.widget.helper.ItemTouchUIUtilImpl.Honeycomb();
                } else {
                    sUICallback = new android.support.v7.widget.helper.ItemTouchUIUtilImpl.Gingerbread();
                }
        ...
        public static android.support.v7.widget.helper.ItemTouchUIUtil getDefaultUIUtil() {
            return android.support.v7.widget.helper.ItemTouchHelper.Callback.sUICallback;
        }
        ...
        public static int convertToRelativeDirection(int flags, int layoutDirection) {
            int masked = flags & android.support.v7.widget.helper.ItemTouchHelper.Callback.ABS_HORIZONTAL_DIR_FLAGS;
            if (masked == 0) {
            ...
            if (layoutDirection == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_LTR) {
                ...
                flags |= (masked << 1) & (~android.support.v7.widget.helper.ItemTouchHelper.Callback.ABS_HORIZONTAL_DIR_FLAGS);
                // first clean RIGHT bit then add LEFT flag as END
                flags |= ((masked << 1) & android.support.v7.widget.helper.ItemTouchHelper.Callback.ABS_HORIZONTAL_DIR_FLAGS) << 2;
            }
            return flags;
        }
        ...
        public static int makeMovementFlags(int dragFlags, int swipeFlags) {
            return (android.support.v7.widget.helper.ItemTouchHelper.Callback.makeFlag(android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_IDLE, swipeFlags | dragFlags) | android.support.v7.widget.helper.ItemTouchHelper.Callback.makeFlag(android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_SWIPE, swipeFlags)) | android.support.v7.widget.helper.ItemTouchHelper.Callback.makeFlag(android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG, dragFlags);
        }
         ...
         * @param directions
         * 		The direction flags. Can be composed from {@link #UP}, {@link #DOWN},
        ...
        public static int makeFlag(int actionState, int directions) {
            return directions << (actionState * android.support.v7.widget.helper.ItemTouchHelper.DIRECTION_FLAG_COUNT);
        }
        ...
        public int convertToAbsoluteDirection(int flags, int layoutDirection) {
            int masked = flags & android.support.v7.widget.helper.ItemTouchHelper.Callback.RELATIVE_DIR_FLAGS;
            if (masked == 0) {
            ...
            if (layoutDirection == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_LTR) {
                ...
                flags |= (masked >> 1) & (~android.support.v7.widget.helper.ItemTouchHelper.Callback.RELATIVE_DIR_FLAGS);
                // first clean start bit then add END flag as LEFT
                flags |= ((masked >> 1) & android.support.v7.widget.helper.ItemTouchHelper.Callback.RELATIVE_DIR_FLAGS) >> 2;
            }
            return flags;
        }

        final int getAbsoluteMovementFlags(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            final int flags = getMovementFlags(recyclerView, viewHolder);
            return convertToAbsoluteDirection(flags, android.support.v4.view.ViewCompat.getLayoutDirection(recyclerView));
        }
        ...
        boolean hasDragFlag(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            ...
            return (flags & android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_DRAG_MASK) != 0;
        }

        boolean hasSwipeFlag(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            final int flags = getAbsoluteMovementFlags(recyclerView, viewHolder);
            return (flags & android.support.v7.widget.helper.ItemTouchHelper.ACTION_MODE_SWIPE_MASK) != 0;
        }
        ...
        otherwise.
         */
        public boolean canDropOver(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder current, android.support.v7.widget.RecyclerView.ViewHolder target) {
            return true;
        }
         ...
         */
        public abstract boolean onMove(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder, android.support.v7.widget.RecyclerView.ViewHolder target);
            ...
            for (int i = 0; i < targetsSize; i++) {
                ...
                if (dx > 0) {
                    ...
                    if ((diff < 0) && (target.itemView.getRight() > selected.itemView.getRight())) {
                        final int score = java.lang.Math.abs(diff);
         ...
         * 		`direction` will be relative as well. ({@link #START} or {@link #END}).
         */
         ...
         * 		it is cleared.
         * @param actionState
         * 		One of {@link ItemTouchHelper#ACTION_STATE_IDLE},
        ...
        public void onSelectedChanged(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                android.support.v7.widget.helper.ItemTouchHelper.Callback.sUICallback.onSelected(viewHolder.itemView);
            }
        }
         ...
         * 		{@link RecyclerView.ItemDecoration}s.
         */
        public void onMoved(final android.support.v7.widget.RecyclerView recyclerView, final android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int fromPos, final android.support.v7.widget.RecyclerView.ViewHolder target, int toPos, int x, int y) {
            ...
            if (layoutManager instanceof android.support.v7.widget.helper.ItemTouchHelper.ViewDropHandler) {
                ((android.support.v7.widget.helper.ItemTouchHelper.ViewDropHandler) (layoutManager)).prepareForDrop(viewHolder.itemView, target.itemView, x, y);
                return;
            }
        ...
        void onDraw(android.graphics.Canvas c, android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder selected, java.util.List<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
        ...
        void onDrawOver(android.graphics.Canvas c, android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder selected, java.util.List<android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation> recoverAnimationList, int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final android.support.v7.widget.helper.ItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                final int count = c.save();
        ...
        public void clearView(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            android.support.v7.widget.helper.ItemTouchHelper.Callback.sUICallback.clearView(viewHolder.itemView);
        }
        ...
        boolean)
         */
        public void onChildDraw(android.graphics.Canvas c, android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
            android.support.v7.widget.helper.ItemTouchHelper.Callback.sUICallback.onDraw(c, recyclerView, viewHolder.itemView, dX, dY, actionState, isCurrentlyActive);
        }
        ...
        public void onChildDrawOver(android.graphics.Canvas c, android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
            android.support.v7.widget.helper.ItemTouchHelper.Callback.sUICallback.onDrawOver(c, recyclerView, viewHolder.itemView, dX, dY, actionState, isCurrentlyActive);
        }
         ...
         * @param animationType
         * 		The type of animation. Is one of {@link #ANIMATION_TYPE_DRAG},
        ...
        public long getAnimationDuration(android.support.v7.widget.RecyclerView recyclerView, int animationType, float animateDx, float animateDy) {
            ...
            if (itemAnimator == null) {
                return animationType == android.support.v7.widget.helper.ItemTouchHelper.ANIMATION_TYPE_DRAG ? android.support.v7.widget.helper.ItemTouchHelper.Callback.DEFAULT_DRAG_ANIMATION_DURATION : android.support.v7.widget.helper.ItemTouchHelper.Callback.DEFAULT_SWIPE_ANIMATION_DURATION;
            } else {
                return animationType == android.support.v7.widget.helper.ItemTouchHelper.ANIMATION_TYPE_DRAG ? itemAnimator.getMoveDuration() : itemAnimator.getRemoveDuration();
            }
        }
         ...
         */
        public int interpolateOutOfBoundsScroll(android.support.v7.widget.RecyclerView recyclerView, int viewSize, int viewSizeOutOfBounds, int totalSize, long msSinceStartScroll) {
            final int maxScroll = getMaxDragScroll(recyclerView);
            final int absOutOfBounds = java.lang.Math.abs(viewSizeOutOfBounds);
            final int direction = ((int) (java.lang.Math.signum(viewSizeOutOfBounds)));
            // might be negative if other direction
            float outOfBoundsRatio = java.lang.Math.min(1.0F, (1.0F * absOutOfBounds) / viewSize);
            final int cappedScroll = ((int) ((direction * maxScroll) * android.support.v7.widget.helper.ItemTouchHelper.Callback.sDragViewScrollCapInterpolator.getInterpolation(outOfBoundsRatio)));
            final float timeRatio;
            if (msSinceStartScroll > android.support.v7.widget.helper.ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS) {
                timeRatio = 1.0F;
            } else {
                timeRatio = ((float) (msSinceStartScroll)) / android.support.v7.widget.helper.ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS;
            }
            final int value = ((int) (cappedScroll * android.support.v7.widget.helper.ItemTouchHelper.Callback.sDragScrollInterpolator.getInterpolation(timeRatio)));
            if (value == 0) {
    ...
    public static abstract class SimpleCallback extends android.support.v7.widget.helper.ItemTouchHelper.Callback {
         ...
         * @param swipeDirs
         * 		Binary OR of direction flags in which the Views can be swiped. Must be
         * 		composed of {@link #LEFT}, {@link #RIGHT}, {@link #START}, {@link #END},
         * 		{@link #UP} and {@link #DOWN}.
         */
         ...
         * 		The RecyclerView to which the ItemTouchHelper is attached to.
         * @param viewHolder
         * 		The RecyclerView for which the swipe direction is queried.
        ...
        public int getMovementFlags(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.ViewHolder viewHolder) {
            return android.support.v7.widget.helper.ItemTouchHelper.Callback.makeMovementFlags(getDragDirs(recyclerView, viewHolder), getSwipeDirs(recyclerView, viewHolder));
        }
    }
    ...
    private class ItemTouchHelperGestureListener extends android.view.GestureDetector.SimpleOnGestureListener {
        ...
        public void onLongPress(android.view.MotionEvent e) {
            android.view.View child = findChildView(e);
            if (child != null) {
                android.support.v7.widget.RecyclerView.ViewHolder vh = mRecyclerView.getChildViewHolder(child);
                if (vh != null) {
                    ...
                    if (pointerId == mActivePointerId) {
                        ...
                        mDx = mDy = 0.0F;
                        if (android.support.v7.widget.helper.ItemTouchHelper.DEBUG) {
                            android.util.Log.d(android.support.v7.widget.helper.ItemTouchHelper.TAG, (("onlong press: x:" + mInitialTouchX) + ",y:") + mInitialTouchY);
                        }
                        if (mCallback.isLongPressDragEnabled()) {
                            select(vh, android.support.v7.widget.helper.ItemTouchHelper.ACTION_STATE_DRAG);
                        }
                    }
                }
            }
    ...
    private class RecoverAnimation implements android.support.v4.animation.AnimatorListenerCompat {
        ...
        public RecoverAnimation(android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int animationType, int actionState, float startDx, float startDy, float targetX, float targetY) {
            mActionState = actionState;
            ...
            mTargetX = targetX;
            mTargetY = targetY;
            mValueAnimator = android.support.v4.animation.AnimatorCompatHelper.emptyValueAnimator();
            mValueAnimator.addUpdateListener(new android.support.v4.animation.AnimatorUpdateListenerCompat() {
                @java.lang.Override
                public void onAnimationUpdate(android.support.v4.animation.ValueAnimatorCompat animation) {
        ...
        public void update() {
            if (mStartDx == mTargetX) {
                mX = android.support.v4.view.ViewCompat.getTranslationX(mViewHolder.itemView);
            } else {
                mX = mStartDx + (mFraction * (mTargetX - mStartDx));
            }
            if (mStartDy == mTargetY) {
                mY = android.support.v4.view.ViewCompat.getTranslationY(mViewHolder.itemView);
            } else {
        ...
        @java.lang.Override
        public void onAnimationStart(android.support.v4.animation.ValueAnimatorCompat animation) {
        }
        ...
        @java.lang.Override
        public void onAnimationCancel(android.support.v4.animation.ValueAnimatorCompat animation) {
            setFraction(1.0F);// make sure we recover the view's state.

        }

        @java.lang.Override
        public void onAnimationRepeat(android.support.v4.animation.ValueAnimatorCompat animation) {
        }
    }
}
