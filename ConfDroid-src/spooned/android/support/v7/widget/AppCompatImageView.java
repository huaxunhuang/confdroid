...
public class AppCompatImageView extends android.widget.ImageView implements android.support.v4.view.TintableBackgroundView {
    ...
    public AppCompatImageView(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AppCompatImageView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
     ...
     * @unknown ref R.styleable#AppCompatImageView_srcCompat
     */
    @java.lang.Override
