...
public abstract class MediaRouteProvider {
    ...
    private final android.support.v7.media.MediaRouteProvider.ProviderHandler mHandler = new android.support.v7.media.MediaRouteProvider.ProviderHandler();
     ...
     * 		The context.
     */
    public MediaRouteProvider(@android.support.annotation.NonNull
    android.content.Context context) {
        this(context, null);
    }

    MediaRouteProvider(android.content.Context context, android.support.v7.media.MediaRouteProvider.ProviderMetadata metadata) {
        if (context == null) {
            throw new java.lang.IllegalArgumentException("context must not be null");
        }
        mContext = context;
        if (metadata == null) {
            mMetadata = new android.support.v7.media.MediaRouteProvider.ProviderMetadata(new android.content.ComponentName(context, getClass()));
        } else {
            mMetadata = metadata;
        }
    }
     ...
     */
    public final void setCallback(@android.support.annotation.Nullable
    ...
    public final void setDiscoveryRequest(android.support.v7.media.MediaRouteDiscoveryRequest request) {
        ...
        if (!mPendingDiscoveryRequestChange) {
            ...
            mHandler.sendEmptyMessage(android.support.v7.media.MediaRouteProvider.MSG_DELIVER_DISCOVERY_REQUEST_CHANGED);
        }
    }
     ...
     */
    public void onDiscoveryRequestChanged(@android.support.annotation.Nullable
     ...
     * @see Callback#onDescriptorChanged
     */
    public final void setDescriptor(@android.support.annotation.Nullable
    android.support.v7.media.MediaRouteProviderDescriptor descriptor) {
        ...
        if (mDescriptor != descriptor) {
            ...
            if (!mPendingDescriptorChange) {
                ...
                mHandler.sendEmptyMessage(android.support.v7.media.MediaRouteProvider.MSG_DELIVER_DESCRIPTOR_CHANGED);
            }
        }
    }
     ...
     *
     * @param routeId
     * 		The unique id of the member route.
     * @param routeGroupId
    ...
    public static final class ProviderMetadata {
        ...
        ProviderMetadata(android.content.ComponentName componentName) {
            if (componentName == null) {
                throw new java.lang.IllegalArgumentException("componentName must not be null");
            }
    ...
    public static abstract class RouteController {
         ...
         *
         * @param volume
         * 		The new volume value between 0 and {@link MediaRouteDescriptor#getVolumeMax}.
         */
         ...
         */
        public boolean onControlRequest(android.content.Intent intent, @android.support.annotation.Nullable
    ...
    public static abstract class Callback {
         ...
         */
        public void onDescriptorChanged(@android.support.annotation.NonNull
        android.support.v7.media.MediaRouteProvider provider, @android.support.annotation.Nullable
        android.support.v7.media.MediaRouteProviderDescriptor descriptor) {
        }
    }

    private final class ProviderHandler extends android.os.Handler {
        ProviderHandler() {
        }
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case android.support.v7.media.MediaRouteProvider.MSG_DELIVER_DESCRIPTOR_CHANGED :
                    deliverDescriptorChanged();
                    break;
                case android.support.v7.media.MediaRouteProvider.MSG_DELIVER_DISCOVERY_REQUEST_CHANGED :
