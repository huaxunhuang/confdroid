...
public final class MediaItemStatus {
    ...
    static final java.lang.String KEY_PLAYBACK_STATE = "playbackState";

    static final java.lang.String KEY_CONTENT_POSITION = "contentPosition";

    static final java.lang.String KEY_CONTENT_DURATION = "contentDuration";
     ...
     * </p>
     */
    public static final java.lang.String EXTRA_HTTP_STATUS_CODE = "android.media.status.extra.HTTP_STATUS_CODE";
     ...
     * </p>
     */
    public static final java.lang.String EXTRA_HTTP_RESPONSE_HEADERS = "android.media.status.extra.HTTP_RESPONSE_HEADERS";

    MediaItemStatus(android.os.Bundle bundle) {
        mBundle = bundle;
    }
    ...
    public long getTimestamp() {
        return mBundle.getLong(android.support.v7.media.MediaItemStatus.KEY_TIMESTAMP);
    }
    ...
    public int getPlaybackState() {
        return mBundle.getInt(android.support.v7.media.MediaItemStatus.KEY_PLAYBACK_STATE, android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_ERROR);
    }
    ...
    public long getContentPosition() {
        return mBundle.getLong(android.support.v7.media.MediaItemStatus.KEY_CONTENT_POSITION, -1);
    }
    ...
    public long getContentDuration() {
        return mBundle.getLong(android.support.v7.media.MediaItemStatus.KEY_CONTENT_DURATION, -1);
    }
    ...
    public android.os.Bundle getExtras() {
        return mBundle.getBundle(android.support.v7.media.MediaItemStatus.KEY_EXTRAS);
    }
    ...
    public java.lang.String toString() {
        ...
        result.append(", playbackState=").append(android.support.v7.media.MediaItemStatus.playbackStateToString(getPlaybackState()));
    ...
    private static java.lang.String playbackStateToString(int playbackState) {
        switch (playbackState) {
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_PENDING :
                return "pending";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_BUFFERING :
                return "buffering";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_PLAYING :
                return "playing";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_PAUSED :
                return "paused";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_FINISHED :
                return "finished";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_CANCELED :
                return "canceled";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_INVALIDATED :
                return "invalidated";
            case android.support.v7.media.MediaItemStatus.PLAYBACK_STATE_ERROR :
                return "error";
        }
        return java.lang.Integer.toString(playbackState);
    }
     ...
     */
    public static android.support.v7.media.MediaItemStatus fromBundle(android.os.Bundle bundle) {
        return bundle != null ? new android.support.v7.media.MediaItemStatus(bundle) : null;
    }
    ...
    public static final class Builder {
         ...
         */
        public Builder(android.support.v7.media.MediaItemStatus status) {
            if (status == null) {
        ...
        public android.support.v7.media.MediaItemStatus.Builder setTimestamp(long elapsedRealtimeTimestamp) {
            mBundle.putLong(android.support.v7.media.MediaItemStatus.KEY_TIMESTAMP, elapsedRealtimeTimestamp);
            return this;
        }
        ...
        public android.support.v7.media.MediaItemStatus.Builder setPlaybackState(int playbackState) {
            mBundle.putInt(android.support.v7.media.MediaItemStatus.KEY_PLAYBACK_STATE, playbackState);
            return this;
        }
        ...
        public android.support.v7.media.MediaItemStatus.Builder setContentPosition(long positionMilliseconds) {
            mBundle.putLong(android.support.v7.media.MediaItemStatus.KEY_CONTENT_POSITION, positionMilliseconds);
            return this;
        }
        ...
        public android.support.v7.media.MediaItemStatus.Builder setContentDuration(long durationMilliseconds) {
            mBundle.putLong(android.support.v7.media.MediaItemStatus.KEY_CONTENT_DURATION, durationMilliseconds);
            return this;
        }
         ...
         * by applications.
         */
        public android.support.v7.media.MediaItemStatus.Builder setExtras(android.os.Bundle extras) {
            mBundle.putBundle(android.support.v7.media.MediaItemStatus.KEY_EXTRAS, extras);
            return this;
        }
        ...
        public android.support.v7.media.MediaItemStatus build() {
            return new android.support.v7.media.MediaItemStatus(mBundle);
        }
    }
}
