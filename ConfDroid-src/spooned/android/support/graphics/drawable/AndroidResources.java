...
class AndroidResources {
    ...
    static final int[] styleable_VectorDrawableTypeArray = new int[]{ android.R.attr.name, android.R.attr.tint, android.R.attr.height, android.R.attr.width, android.R.attr.alpha, android.R.attr.autoMirrored, android.R.attr.tintMode, android.R.attr.viewportWidth, android.R.attr.viewportHeight };
    ...
    static final int[] styleable_VectorDrawableGroup = new int[]{ android.R.attr.name, android.R.attr.pivotX, android.R.attr.pivotY, android.R.attr.scaleX, android.R.attr.scaleY, android.R.attr.rotation, android.R.attr.translateX, android.R.attr.translateY };
    ...
    static final int[] styleable_VectorDrawableClipPath = new int[]{ android.R.attr.name, android.R.attr.pathData };

    static final int styleable_VectorDrawableClipPath_name = 0;

    static final int styleable_VectorDrawableClipPath_pathData = 1;

    static final int[] styleable_AnimatedVectorDrawable = new int[]{ android.R.attr.drawable };

    static final int styleable_AnimatedVectorDrawable_drawable = 0;

    static final int[] styleable_AnimatedVectorDrawableTarget = new int[]{ android.R.attr.name, android.R.attr.animation };
