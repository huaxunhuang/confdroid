 ...
 */
class ValueAnimatorCompatImplGingerbread extends android.support.design.widget.ValueAnimatorCompat.Impl {
    ...
    private long mDuration = android.support.design.widget.ValueAnimatorCompatImplGingerbread.DEFAULT_DURATION;

    private android.view.animation.Interpolator mInterpolator;

    private java.util.ArrayList<android.support.design.widget.ValueAnimatorCompat.Impl.AnimatorListenerProxy> mListeners;

    private java.util.ArrayList<android.support.design.widget.ValueAnimatorCompat.Impl.AnimatorUpdateListenerProxy> mUpdateListeners;
    ...
    final void startInternal() {
        ...
        android.support.design.widget.ValueAnimatorCompatImplGingerbread.sHandler.postDelayed(mRunnable, android.support.design.widget.ValueAnimatorCompatImplGingerbread.HANDLER_DELAY);
    }
    ...
    @java.lang.Override
    public void addListener(android.support.design.widget.ValueAnimatorCompat.Impl.AnimatorListenerProxy listener) {
        if (mListeners == null) {
    ...
    @java.lang.Override
    public void addUpdateListener(android.support.design.widget.ValueAnimatorCompat.Impl.AnimatorUpdateListenerProxy updateListener) {
        if (mUpdateListeners == null) {
            mUpdateListeners = new java.util.ArrayList<>();
        }
    ...
    public void cancel() {
        mIsRunning = false;
        android.support.design.widget.ValueAnimatorCompatImplGingerbread.sHandler.removeCallbacks(mRunnable);
