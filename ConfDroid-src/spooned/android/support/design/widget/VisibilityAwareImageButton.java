...
class VisibilityAwareImageButton extends android.widget.ImageButton {
    ...
    public VisibilityAwareImageButton(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VisibilityAwareImageButton(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
