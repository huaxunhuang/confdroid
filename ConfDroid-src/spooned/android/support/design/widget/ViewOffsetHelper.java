...
class ViewOffsetHelper {
    ...
    private void updateOffsets() {
        android.support.v4.view.ViewCompat.offsetTopAndBottom(mView, mOffsetTop - (mView.getTop() - mLayoutTop));
        android.support.v4.view.ViewCompat.offsetLeftAndRight(mView, mOffsetLeft - (mView.getLeft() - mLayoutLeft));
    }
