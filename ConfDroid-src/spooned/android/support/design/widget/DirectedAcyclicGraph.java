...
final class DirectedAcyclicGraph<T> {
    private final android.support.v4.util.Pools.Pool<java.util.ArrayList<T>> mListPool = new android.support.v4.util.Pools.SimplePool<>(10);

    private final android.support.v4.util.SimpleArrayMap<T, java.util.ArrayList<T>> mGraph = new android.support.v4.util.SimpleArrayMap<>();
     ...
     * 		the node to add
     */
    void addNode(@android.support.annotation.NonNull
    T node) {
     ...
     */
    boolean contains(@android.support.annotation.NonNull
    T node) {
     ...
     */
    void addEdge(@android.support.annotation.NonNull
    T node, @android.support.annotation.NonNull
    T incomingEdge) {
        if ((!mGraph.containsKey(node)) || (!mGraph.containsKey(incomingEdge))) {
            throw new java.lang.IllegalArgumentException("All nodes must be present in the graph before" + " being added as an edge");
        }
        java.util.ArrayList<T> edges = mGraph.get(node);
        if (edges == null) {
    ...
    java.util.List getIncomingEdges(@android.support.annotation.NonNull
    T node) {
     ...
     */
    @android.support.annotation.Nullable
    java.util.List getOutgoingEdges(@android.support.annotation.NonNull
    T node) {
        java.util.ArrayList<T> result = null;
        for (int i = 0, size = mGraph.size(); i < size; i++) {
            java.util.ArrayList<T> edges = mGraph.valueAt(i);
    ...
    boolean hasOutgoingEdges(@android.support.annotation.NonNull
    T node) {
        for (int i = 0, size = mGraph.size(); i < size; i++) {
            java.util.ArrayList<T> edges = mGraph.valueAt(i);
            if ((edges != null) && edges.contains(node)) {
    ...
    java.util.ArrayList<T> getSortedList() {
        mSortResult.clear();
    ...
    private void dfs(final T node, final java.util.ArrayList<T> result, final java.util.HashSet<T> tmpMarked) {
        ...
        final java.util.ArrayList<T> edges = mGraph.get(node);
        if (edges != null) {
    ...
    private java.util.ArrayList<T> getEmptyList() {
        java.util.ArrayList<T> list = mListPool.acquire();
        if (list == null) {
    ...
    private void poolList(@android.support.annotation.NonNull
