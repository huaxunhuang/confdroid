...
public class ScrimInsetsFrameLayout extends android.widget.FrameLayout {
    ...
    public ScrimInsetsFrameLayout(android.content.Context context, android.util.AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScrimInsetsFrameLayout(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScrimInsetsFrameLayout, defStyleAttr, R.style.Widget_Design_ScrimInsetsFrameLayout);
        ...
        android.support.v4.view.ViewCompat.setOnApplyWindowInsetsListener(this, new android.support.v4.view.OnApplyWindowInsetsListener() {
            ...
            public android.support.v4.view.WindowInsetsCompat onApplyWindowInsets(android.view.View v, android.support.v4.view.WindowInsetsCompat insets) {
                if (null == mInsets) {
                    mInsets = new android.graphics.Rect();
                }
                ...
                android.support.v4.view.ViewCompat.postInvalidateOnAnimation(android.support.design.internal.ScrimInsetsFrameLayout.this);
