...
public class ScriptIntrinsicBlur extends android.support.v8.renderscript.ScriptIntrinsic {
    ...
    protected ScriptIntrinsicBlur(long id, android.support.v8.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public static android.support.v8.renderscript.ScriptIntrinsicBlur create(android.support.v8.renderscript.RenderScript rs, android.support.v8.renderscript.Element e) {
        if ((!e.isCompatible(android.support.v8.renderscript.Element.U8_4(rs))) && (!e.isCompatible(android.support.v8.renderscript.Element.U8(rs)))) {
            throw new android.support.v8.renderscript.RSIllegalArgumentException("Unsupported element type.");
        }
        long id;
        boolean mUseIncSupp = rs.isUseNative() && (android.os.Build.VERSION.SDK_INT < android.support.v8.renderscript.ScriptIntrinsicBlur.INTRINSIC_API_LEVEL);
        id = rs.nScriptIntrinsicCreate(5, e.getID(rs), mUseIncSupp);
        android.support.v8.renderscript.ScriptIntrinsicBlur si = new android.support.v8.renderscript.ScriptIntrinsicBlur(id, rs);
    ...
    public void setRadius(float radius) {
        if ((radius <= 0) || (radius > 25)) {
            throw new android.support.v8.renderscript.RSIllegalArgumentException("Radius out of range (0 < r <= 25).");
        }
        setVar(0, radius);
    }
