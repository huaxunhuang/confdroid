...
public class Matrix4f {
    ...
    public Matrix4f(float[] dataArray) {
        mMat = new float[16];
        java.lang.System.arraycopy(dataArray, 0, mMat, 0, mMat.length);
    }
    ...
    public void load(android.support.v8.renderscript.Matrix4f src) {
        java.lang.System.arraycopy(src.getArray(), 0, mMat, 0, mMat.length);
    }
     ...
     */
    public void loadMultiply(android.support.v8.renderscript.Matrix4f lhs, android.support.v8.renderscript.Matrix4f rhs) {
        for (int i = 0; i < 4; i++) {
            float ri0 = 0;
            float ri1 = 0;
            float ri2 = 0;
    ...
    public void loadPerspective(float fovy, float aspect, float near, float far) {
        float top = near * ((float) (java.lang.Math.tan(((float) ((fovy * java.lang.Math.PI) / 360.0F)))));
        float bottom = -top;
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        android.support.v8.renderscript.Matrix4f m1 = new android.support.v8.renderscript.Matrix4f();
        android.support.v8.renderscript.Matrix4f m2 = new android.support.v8.renderscript.Matrix4f();
        if (w > h) {
    ...
    public void multiply(android.support.v8.renderscript.Matrix4f rhs) {
        android.support.v8.renderscript.Matrix4f tmp = new android.support.v8.renderscript.Matrix4f();
    ...
    public boolean inverse() {
        android.support.v8.renderscript.Matrix4f result = new android.support.v8.renderscript.Matrix4f();
        for (int i = 0; i < 4; ++i) {
            for (int j = 0; j < 4; ++j) {
        ...
        if (java.lang.Math.abs(det) < 1.0E-6) {
            return false;
        }
        det = 1.0F / det;
        for (int i = 0; i < 16; ++i) {
