...
public class Matrix3f {
     ...
     */
    public void loadMultiply(android.support.v8.renderscript.Matrix3f lhs, android.support.v8.renderscript.Matrix3f rhs) {
        for (int i = 0; i < 3; i++) {
            float ri0 = 0;
            float ri1 = 0;
            float ri2 = 0;
    ...
    public void multiply(android.support.v8.renderscript.Matrix3f rhs) {
        android.support.v8.renderscript.Matrix3f tmp = new android.support.v8.renderscript.Matrix3f();
