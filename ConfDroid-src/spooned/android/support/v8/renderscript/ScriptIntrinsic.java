...
public abstract class ScriptIntrinsic extends android.support.v8.renderscript.Script {
    ScriptIntrinsic(long id, android.support.v8.renderscript.RenderScript rs) {
        super(id, rs);
        if (id == 0) {
            throw new android.support.v8.renderscript.RSRuntimeException("Loading of ScriptIntrinsic failed.");
        }
    }
}
