...
public class Matrix2f {
     ...
     */
    public void loadMultiply(android.support.v8.renderscript.Matrix2f lhs, android.support.v8.renderscript.Matrix2f rhs) {
        for (int i = 0; i < 2; i++) {
            float ri0 = 0;
            float ri1 = 0;
            for (int j = 0; j < 2; j++) {
    ...
    public void multiply(android.support.v8.renderscript.Matrix2f rhs) {
        android.support.v8.renderscript.Matrix2f tmp = new android.support.v8.renderscript.Matrix2f();
