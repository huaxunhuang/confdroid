...
public class PercentRelativeLayout extends android.widget.RelativeLayout {
    ...
    public PercentRelativeLayout(android.content.Context context) {
        super(context);
    }

    public PercentRelativeLayout(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
    }

    public PercentRelativeLayout(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    @java.lang.Override
    protected android.support.percent.PercentRelativeLayout.LayoutParams generateDefaultLayoutParams() {
        return new android.support.percent.PercentRelativeLayout.LayoutParams(android.support.percent.PercentRelativeLayout.LayoutParams.MATCH_PARENT, android.support.percent.PercentRelativeLayout.LayoutParams.MATCH_PARENT);
    }

    @java.lang.Override
    public android.support.percent.PercentRelativeLayout.LayoutParams generateLayoutParams(android.util.AttributeSet attrs) {
        return new android.support.percent.PercentRelativeLayout.LayoutParams(getContext(), attrs);
    }
    ...
    public static class LayoutParams extends android.widget.RelativeLayout.LayoutParams implements android.support.percent.PercentLayoutHelper.PercentLayoutParams {
