...
public abstract class TitleViewAdapter {
    ...
    public interface Provider {
         ...
         */
        android.support.v17.leanback.widget.TitleViewAdapter getTitleViewAdapter();
    }

    public static final int BRANDING_VIEW_VISIBLE = 0x2;

    public static final int SEARCH_VIEW_VISIBLE = 0x4;

    public static final int FULL_VIEW_VISIBLE = android.support.v17.leanback.widget.TitleViewAdapter.BRANDING_VIEW_VISIBLE | android.support.v17.leanback.widget.TitleViewAdapter.SEARCH_VIEW_VISIBLE;
     ...
     */
    public abstract android.view.View getSearchAffordanceView();
