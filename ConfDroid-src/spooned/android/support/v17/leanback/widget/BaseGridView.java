...
abstract class BaseGridView extends android.support.v7.widget.RecyclerView {
     ...
     * default value is 1/2 of the size.
     */
    public static final int WINDOW_ALIGN_BOTH_EDGE = android.support.v17.leanback.widget.BaseGridView.WINDOW_ALIGN_LOW_EDGE | android.support.v17.leanback.widget.BaseGridView.WINDOW_ALIGN_HIGH_EDGE;
     ...
     * Value indicates that percent is not used.
     */
    public static final float ITEM_ALIGN_OFFSET_PERCENT_DISABLED = android.support.v17.leanback.widget.ItemAlignmentFacet.ITEM_ALIGN_OFFSET_PERCENT_DISABLED;
    ...
    public interface OnMotionInterceptListener {
         ...
         * Returns true if the touch dispatch event should be consumed.
         */
        public boolean onInterceptMotionEvent(android.view.MotionEvent event);
    }
    ...
    final android.support.v17.leanback.widget.GridLayoutManager mLayoutManager;
    ...
    private android.support.v7.widget.RecyclerView.ItemAnimator mSavedItemAnimator;

    private android.support.v17.leanback.widget.BaseGridView.OnTouchInterceptListener mOnTouchInterceptListener;

    private android.support.v17.leanback.widget.BaseGridView.OnMotionInterceptListener mOnMotionInterceptListener;

    private android.support.v17.leanback.widget.BaseGridView.OnKeyInterceptListener mOnKeyInterceptListener;

    android.support.v7.widget.RecyclerView.RecyclerListener mChainedRecyclerListener;

    private android.support.v17.leanback.widget.BaseGridView.OnUnhandledKeyListener mOnUnhandledKeyListener;

    public BaseGridView(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        mLayoutManager = new android.support.v17.leanback.widget.GridLayoutManager(this);
        ...
        ((android.support.v7.widget.SimpleItemAnimator) (getItemAnimator())).setSupportsChangeAnimations(false);
        super.setRecyclerListener(new android.support.v7.widget.RecyclerView.RecyclerListener() {
            @java.lang.Override
    ...
    protected void initBaseGridViewAttributes(android.content.Context context, android.util.AttributeSet attrs) {
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.lbBaseGridView);
        ...
        if (a.hasValue(R.styleable.lbBaseGridView_android_gravity)) {
            setGravity(a.getInt(R.styleable.lbBaseGridView_android_gravity, android.view.Gravity.NO_GRAVITY));
        }
        a.recycle();
    }
    ...
    public void setFocusScrollStrategy(int scrollStrategy) {
        if (((scrollStrategy != android.support.v17.leanback.widget.BaseGridView.FOCUS_SCROLL_ALIGNED) && (scrollStrategy != android.support.v17.leanback.widget.BaseGridView.FOCUS_SCROLL_ITEM)) && (scrollStrategy != android.support.v17.leanback.widget.BaseGridView.FOCUS_SCROLL_PAGE)) {
    ...
    /**
     * Sets the offset percent for window alignment in addition to {@link #getWindowAlignmentOffset()}.
     *
     * @param offsetPercent
     ...
     */
    public void setOnChildLaidOutListener(android.support.v17.leanback.widget.OnChildLaidOutListener listener) {
     ...
     */
    public void setSelectedPositionSmooth(final int position, final android.support.v17.leanback.widget.ViewHolderTask task) {
        if (task != null) {
            android.support.v7.widget.RecyclerView.ViewHolder vh = findViewHolderForPosition(position);
            if ((vh == null) || hasPendingAdapterUpdates()) {
                addOnChildViewHolderSelectedListener(new android.support.v17.leanback.widget.OnChildViewHolderSelectedListener() {
                    @java.lang.Override
                    public void onChildViewHolderSelected(android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder child, int selectedPosition, int subposition) {
     ...
     * 		Task to executed on the ViewHolder at a given position.
     */
    public void setSelectedPosition(final int position, final android.support.v17.leanback.widget.ViewHolderTask task) {
        if (task != null) {
            android.support.v7.widget.RecyclerView.ViewHolder vh = findViewHolderForPosition(position);
            if ((vh == null) || hasPendingAdapterUpdates()) {
                addOnChildViewHolderSelectedListener(new android.support.v17.leanback.widget.OnChildViewHolderSelectedListener() {
    ...
    public android.view.View focusSearch(int direction) {
        if (isFocused()) {
            ...
            android.view.View view = mLayoutManager.findViewByPosition(mLayoutManager.getSelection());
            if (view != null) {
    ...
    public final void setFocusSearchDisabled(boolean disabled) {
        ...
        setDescendantFocusability(disabled ? android.view.ViewGroup.FOCUS_BLOCK_DESCENDANTS : android.view.ViewGroup.FOCUS_AFTER_DESCENDANTS);
     ...
     * So application should check in both {@link OnChildSelectedListener} and {@link OnChildLaidOutListener}.
     *
     * @param position
     * 		Position in adapter.
     */
     ...
     */
    public void setOnTouchInterceptListener(android.support.v17.leanback.widget.BaseGridView.OnTouchInterceptListener listener) {
     ...
     */
    public void setOnMotionInterceptListener(android.support.v17.leanback.widget.BaseGridView.OnMotionInterceptListener listener) {
     ...
     */
    public void setOnKeyInterceptListener(android.support.v17.leanback.widget.BaseGridView.OnKeyInterceptListener listener) {
     ...
     */
    public void setOnUnhandledKeyListener(android.support.v17.leanback.widget.BaseGridView.OnUnhandledKeyListener listener) {
     ...
     */
    public android.support.v17.leanback.widget.BaseGridView.OnUnhandledKeyListener getOnUnhandledKeyListener() {
