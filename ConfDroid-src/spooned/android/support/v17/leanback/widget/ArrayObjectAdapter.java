...
public class ArrayObjectAdapter extends android.support.v17.leanback.widget.ObjectAdapter {
    private java.util.ArrayList<java.lang.Object> mItems = new java.util.ArrayList<java.lang.Object>();

    /**
     * Constructs an adapter with the given {@link PresenterSelector}.
     */
    public ArrayObjectAdapter(android.support.v17.leanback.widget.PresenterSelector presenterSelector) {
     ...
     */
    public ArrayObjectAdapter(android.support.v17.leanback.widget.Presenter presenter) {
        super(presenter);
    }
     ...
     * @param items
     * 		A {@link Collection} of items to insert.
     */
    public void addAll(int index, java.util.Collection items) {
     ...
     */
    public void replace(int position, java.lang.Object item) {
    ...
    public int removeItems(int position, int count) {
        int itemsToRemove = java.lang.Math.min(count, mItems.size() - position);
        if (itemsToRemove <= 0) {
            return 0;
        }
     ...
     */
    public <E> java.util.List<E> unmodifiableList() {
        return java.util.Collections.unmodifiableList(((java.util.List<E>) (mItems)));
    }
