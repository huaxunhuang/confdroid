...
public class Row {
    ...
    private int mFlags = android.support.v17.leanback.widget.Row.FLAG_ID_USE_HEADER;

    private android.support.v17.leanback.widget.HeaderItem mHeaderItem;

    private long mId = android.support.v17.leanback.widget.ObjectAdapter.NO_ID;
     ...
     * 		The id of the row.
     * @param headerItem
     * 		The {@link HeaderItem} for this Row, or null if there
     * 		is no header.
     */
    public Row(long id, android.support.v17.leanback.widget.HeaderItem headerItem) {
        setId(id);
     ...
     * 		is no header.
     */
    public Row(android.support.v17.leanback.widget.HeaderItem headerItem) {
        setHeaderItem(headerItem);
    }
     ...
     * 		header.
     */
    public final void setHeaderItem(android.support.v17.leanback.widget.HeaderItem headerItem) {
    ...
    public final void setId(long id) {
        mId = id;
        setFlags(android.support.v17.leanback.widget.Row.FLAG_ID_USE_ID, android.support.v17.leanback.widget.Row.FLAG_ID_USE_MASK);
    }
    ...
    public final long getId() {
        if ((mFlags & android.support.v17.leanback.widget.Row.FLAG_ID_USE_MASK) == android.support.v17.leanback.widget.Row.FLAG_ID_USE_HEADER) {
            android.support.v17.leanback.widget.HeaderItem header = getHeaderItem();
            if (header != null) {
                return header.getId();
            }
