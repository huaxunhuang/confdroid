...
public class ListRow extends android.support.v17.leanback.widget.Row {
    ...
    public ListRow(android.support.v17.leanback.widget.HeaderItem header, android.support.v17.leanback.widget.ObjectAdapter adapter) {
        super(header);
        mAdapter = adapter;
        verify();
    }

    public ListRow(long id, android.support.v17.leanback.widget.HeaderItem header, android.support.v17.leanback.widget.ObjectAdapter adapter) {
        super(id, header);
        mAdapter = adapter;
        verify();
    }

    public ListRow(android.support.v17.leanback.widget.ObjectAdapter adapter) {
        super();
        mAdapter = adapter;
        verify();
    }
    ...
    private void verify() {
        if (mAdapter == null) {
            throw new java.lang.IllegalArgumentException("ObjectAdapter cannot be null");
        }
    }
    ...
    public java.lang.CharSequence getContentDescription() {
        ...
        final android.support.v17.leanback.widget.HeaderItem headerItem = getHeaderItem();
        if (headerItem != null) {
            java.lang.CharSequence contentDescription = headerItem.getContentDescription();
