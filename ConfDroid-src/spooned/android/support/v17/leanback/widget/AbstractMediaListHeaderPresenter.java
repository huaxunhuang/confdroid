 ...
 * <p>
 *    Subclasses of this class must override {@link #onBindMediaListHeaderViewHolder(ViewHolder, Object)} in order to bind their header text to
...
public abstract class AbstractMediaListHeaderPresenter extends android.support.v17.leanback.widget.RowPresenter {
    ...
    public static class ViewHolder extends android.support.v17.leanback.widget.RowPresenter.ViewHolder {
        private final android.widget.TextView mHeaderView;

        public ViewHolder(android.view.View view) {
            super(view);
            mHeaderView = ((android.widget.TextView) (view.findViewById(R.id.mediaListHeader)));
        }
     ...
     */
    public AbstractMediaListHeaderPresenter(android.content.Context context, int mThemeResId) {
        mContext = new android.view.ContextThemeWrapper(context.getApplicationContext(), mThemeResId);
    ...
    protected android.support.v17.leanback.widget.RowPresenter.ViewHolder createRowViewHolder(android.view.ViewGroup parent) {
        android.content.Context context = (mContext != null) ? mContext : parent.getContext();
        android.view.View view = android.view.LayoutInflater.from(context).inflate(R.layout.lb_media_list_header, parent, false);
        view.setFocusable(false);
        view.setFocusableInTouchMode(false);
        android.support.v17.leanback.widget.AbstractMediaListHeaderPresenter.ViewHolder vh = new android.support.v17.leanback.widget.AbstractMediaListHeaderPresenter.ViewHolder(view);
    ...
    protected void onBindRowViewHolder(android.support.v17.leanback.widget.RowPresenter.ViewHolder vh, java.lang.Object item) {
        ...
        onBindMediaListHeaderViewHolder(((android.support.v17.leanback.widget.AbstractMediaListHeaderPresenter.ViewHolder) (vh)), item);
    }
     ...
     *
     * @param vh
     * 		The ViewHolder for this {@link AbstractMediaListHeaderPresenter}.
     * @param item
     * 		The header data object being presented.
     */
    protected abstract void onBindMediaListHeaderViewHolder(android.support.v17.leanback.widget.AbstractMediaListHeaderPresenter.ViewHolder vh, java.lang.Object item);
}
