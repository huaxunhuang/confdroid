...
/**
 * A data class which represents an action within a {@link android.support.v17.leanback.app.GuidedStepFragment}. GuidedActions contain at minimum a title
...
public class GuidedAction extends android.support.v17.leanback.widget.Action {
    private static final java.lang.String TAG = "GuidedAction";
     ...
     */
    public static abstract class BuilderBase<B extends android.support.v17.leanback.widget.GuidedAction.BuilderBase> {
        ...
        private java.lang.CharSequence mEditTitle;

        private java.lang.CharSequence mDescription;

        private java.lang.CharSequence mEditDescription;
        ...
        private int mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_NONE;

        private int mInputType = android.text.InputType.TYPE_CLASS_TEXT;

        private int mDescriptionInputType = android.text.InputType.TYPE_CLASS_TEXT;

        private int mEditInputType = android.text.InputType.TYPE_CLASS_TEXT;

        private int mDescriptionEditInputType = android.text.InputType.TYPE_CLASS_TEXT;

        private int mCheckSetId = android.support.v17.leanback.widget.GuidedAction.NO_CHECK_SET;

        private java.util.List<android.support.v17.leanback.widget.GuidedAction> mSubActions;
        ...
        public BuilderBase(android.content.Context context) {
            mContext = context;
            mActionFlags = (android.support.v17.leanback.widget.GuidedAction.PF_ENABLED | android.support.v17.leanback.widget.GuidedAction.PF_FOCUSABLE) | android.support.v17.leanback.widget.GuidedAction.PF_AUTORESTORE;
        }
         ...
         */
        protected final void applyValues(android.support.v17.leanback.widget.GuidedAction action) {
            // Base Action values
            action.setId(mId);
         ...
         *
         * @param id
         * 		One of {@link GuidedAction#ACTION_ID_OK} {@link GuidedAction#ACTION_ID_CANCEL}
        ...
        public B clickAction(long id) {
            if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_OK) {
                mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_OK;
                mTitle = mContext.getString(android.R.string.ok);
            } else
                if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_CANCEL) {
                    mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_CANCEL;
                    mTitle = mContext.getString(android.R.string.cancel);
                } else
                    if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_FINISH) {
                        mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_FINISH;
                        mTitle = mContext.getString(R.string.lb_guidedaction_finish_title);
                    } else
                        if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_CONTINUE) {
                            mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_CONTINUE;
                            mTitle = mContext.getString(R.string.lb_guidedaction_continue_title);
                        } else
                            if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_YES) {
                                mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_YES;
                                mTitle = mContext.getString(android.R.string.yes);
                            } else
                                if (id == android.support.v17.leanback.widget.GuidedAction.ACTION_ID_NO) {
                                    mId = android.support.v17.leanback.widget.GuidedAction.ACTION_ID_NO;
         ...
         */
        public B title(java.lang.CharSequence title) {
            mTitle = title;
            return ((B) (this));
        }
         ...
         */
        public B title(@android.support.annotation.StringRes
        int titleResourceId) {
         ...
         */
        public B editTitle(java.lang.CharSequence editTitle) {
         ...
         * replaces the string of title.
         *
         * @param editTitleResourceId
         * 		String resource id of the optional title text to edit when
         * 		TextView is activated.
         */
        public B editTitle(@android.support.annotation.StringRes
        int editTitleResourceId) {
         ...
         */
        public B description(java.lang.CharSequence description) {
         ...
         * providing extra information on what the action will do.
         *
         * @param descriptionResourceId
         * 		String resource id of the description for this action.
         */
        public B description(@android.support.annotation.StringRes
         ...
         */
        public B editDescription(java.lang.CharSequence description) {
         ...
         * 		action.
         */
        public B editDescription(@android.support.annotation.StringRes
        int descriptionResourceId) {
         ...
         */
        public B intent(android.content.Intent intent) {
            mIntent = intent;
            return ((B) (this));
        }
         ...
         */
        public B icon(android.graphics.drawable.Drawable icon) {
            mIcon = icon;
            return ((B) (this));
        }
        ...
        public B iconResourceId(@android.support.annotation.DrawableRes
        int iconResourceId, android.content.Context context) {
            return icon(android.support.v4.content.ContextCompat.getDrawable(context, iconResourceId));
        }
         ...
         * 		The resource ID for the icon associated with this action.
         */
        public B icon(@android.support.annotation.DrawableRes
        int iconResourceId) {
            return icon(android.support.v4.content.ContextCompat.getDrawable(getContext(), iconResourceId));
        }
        ...
        public B editable(boolean editable) {
            if (!editable) {
                if (mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_TITLE) {
                    mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_NONE;
                }
                return ((B) (this));
            }
            mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_TITLE;
            if (isChecked() || (mCheckSetId != android.support.v17.leanback.widget.GuidedAction.NO_CHECK_SET)) {
        ...
        public B descriptionEditable(boolean editable) {
            if (!editable) {
                if (mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_DESCRIPTION) {
                    mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_NONE;
                }
                return ((B) (this));
            }
            mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_DESCRIPTION;
            if (isChecked() || (mCheckSetId != android.support.v17.leanback.widget.GuidedAction.NO_CHECK_SET)) {
                throw new java.lang.IllegalArgumentException("Editable actions cannot also be checked");
            }
            return ((B) (this));
        ...
        public B hasEditableActivatorView(boolean editable) {
            if (!editable) {
                if (mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_ACTIVATOR_VIEW) {
                    mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_NONE;
                }
                return ((B) (this));
            }
            mEditable = android.support.v17.leanback.widget.GuidedAction.EDITING_ACTIVATOR_VIEW;
            if (isChecked() || (mCheckSetId != android.support.v17.leanback.widget.GuidedAction.NO_CHECK_SET)) {
                throw new java.lang.IllegalArgumentException("Editable actions cannot also be checked");
            }
            return ((B) (this));
        ...
        private boolean isChecked() {
            return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_CHECKED) == android.support.v17.leanback.widget.GuidedAction.PF_CHECKED;
        }
        ...
        public B checked(boolean checked) {
            setFlags(checked ? android.support.v17.leanback.widget.GuidedAction.PF_CHECKED : 0, android.support.v17.leanback.widget.GuidedAction.PF_CHECKED);
            if (mEditable != android.support.v17.leanback.widget.GuidedAction.EDITING_NONE) {
                throw new java.lang.IllegalArgumentException("Editable actions cannot also be checked");
            }
            return ((B) (this));
        }
         ...
         *
         * @param checkSetId
         * 		The check set ID, or {@link GuidedAction#NO_CHECK_SET} to indicate not
         ...
         * appropriately.
         *
         * @param multilineDescription
         * 		Whether this action has a multiline description.
         */
        public B multilineDescription(boolean multilineDescription) {
            setFlags(multilineDescription ? android.support.v17.leanback.widget.GuidedAction.PF_MULTI_lINE_DESCRIPTION : 0, android.support.v17.leanback.widget.GuidedAction.PF_MULTI_lINE_DESCRIPTION);
            return ((B) (this));
        }
        ...
        public B hasNext(boolean hasNext) {
            setFlags(hasNext ? android.support.v17.leanback.widget.GuidedAction.PF_HAS_NEXT : 0, android.support.v17.leanback.widget.GuidedAction.PF_HAS_NEXT);
            return ((B) (this));
        }
        ...
        public B infoOnly(boolean infoOnly) {
            setFlags(infoOnly ? android.support.v17.leanback.widget.GuidedAction.PF_INFO_ONLY : 0, android.support.v17.leanback.widget.GuidedAction.PF_INFO_ONLY);
            return ((B) (this));
        }
        ...
        public B enabled(boolean enabled) {
            setFlags(enabled ? android.support.v17.leanback.widget.GuidedAction.PF_ENABLED : 0, android.support.v17.leanback.widget.GuidedAction.PF_ENABLED);
            return ((B) (this));
        }
        ...
        public B focusable(boolean focusable) {
            setFlags(focusable ? android.support.v17.leanback.widget.GuidedAction.PF_FOCUSABLE : 0, android.support.v17.leanback.widget.GuidedAction.PF_FOCUSABLE);
            return ((B) (this));
        }
         ...
         * @return The same BuilderBase object.
         */
        public B subActions(java.util.List<android.support.v17.leanback.widget.GuidedAction> subActions) {
        ...
        public B autoSaveRestoreEnabled(boolean autoSaveRestoreEnabled) {
            setFlags(autoSaveRestoreEnabled ? android.support.v17.leanback.widget.GuidedAction.PF_AUTORESTORE : 0, android.support.v17.leanback.widget.GuidedAction.PF_AUTORESTORE);
            return ((B) (this));
        }
    }
     ...
     */
    public static class Builder extends android.support.v17.leanback.widget.GuidedAction.BuilderBase<android.support.v17.leanback.widget.GuidedAction.Builder> {
        /**
         *
         *
         ...
         */
        public android.support.v17.leanback.widget.GuidedAction build() {
            android.support.v17.leanback.widget.GuidedAction action = new android.support.v17.leanback.widget.GuidedAction();
            applyValues(action);
            return action;
        }
    }

    static final int PF_CHECKED = 0x1;

    static final int PF_MULTI_lINE_DESCRIPTION = 0x2;

    static final int PF_HAS_NEXT = 0x4;

    static final int PF_INFO_ONLY = 0x8;

    static final int PF_ENABLED = 0x10;

    static final int PF_FOCUSABLE = 0x20;

    static final int PF_AUTORESTORE = 0x40;
    ...
    java.util.List<android.support.v17.leanback.widget.GuidedAction> mSubActions;
     ...
     *
     * @param editTitle
     * 		Optional title text to edit instead of {@link #setTitle(CharSequence)}.
     */
    public void setEditTitle(java.lang.CharSequence editTitle) {
        mEditTitle = editTitle;
    }
     ...
     */
    public java.lang.CharSequence getEditDescription() {
     ...
     */
    public void setEditDescription(java.lang.CharSequence editDescription) {
    ...
    public boolean isEditable() {
        return mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_TITLE;
    }
    ...
    public boolean isDescriptionEditable() {
        return mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_DESCRIPTION;
    }
    ...
    public boolean hasTextEditable() {
        return (mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_TITLE) || (mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_DESCRIPTION);
    }
    ...
    public boolean hasEditableActivatorView() {
        return mEditable == android.support.v17.leanback.widget.GuidedAction.EDITING_ACTIVATOR_VIEW;
    }
    ...
    public boolean hasMultilineDescription() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_MULTI_lINE_DESCRIPTION) == android.support.v17.leanback.widget.GuidedAction.PF_MULTI_lINE_DESCRIPTION;
    }
    ...
    public boolean isEnabled() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_ENABLED) == android.support.v17.leanback.widget.GuidedAction.PF_ENABLED;
    }
    ...
    public boolean isFocusable() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_FOCUSABLE) == android.support.v17.leanback.widget.GuidedAction.PF_FOCUSABLE;
    }
    ...
    public boolean hasNext() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_HAS_NEXT) == android.support.v17.leanback.widget.GuidedAction.PF_HAS_NEXT;
    }
    ...
    public boolean infoOnly() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_INFO_ONLY) == android.support.v17.leanback.widget.GuidedAction.PF_INFO_ONLY;
    }
     ...
     */
    public void setSubActions(java.util.List<android.support.v17.leanback.widget.GuidedAction> actions) {
        mSubActions = actions;
    }
     ...
     */
    public java.util.List<android.support.v17.leanback.widget.GuidedAction> getSubActions() {
        return mSubActions;
    }
    ...
    public final boolean isAutoSaveRestoreEnabled() {
        return (mActionFlags & android.support.v17.leanback.widget.GuidedAction.PF_AUTORESTORE) == android.support.v17.leanback.widget.GuidedAction.PF_AUTORESTORE;
    }
    ...
    public void onSaveInstanceState(android.os.Bundle bundle, java.lang.String key) {
        if (needAutoSaveTitle() && (getTitle() != null)) {
            ...
            if (needAutoSaveDescription() && (getDescription() != null)) {
                ...
                if (getCheckSetId() != android.support.v17.leanback.widget.GuidedAction.NO_CHECK_SET) {
    ...
    public void onRestoreInstanceState(android.os.Bundle bundle, java.lang.String key) {
        if (needAutoSaveTitle()) {
            java.lang.String title = bundle.getString(key);
            if (title != null) {
                setTitle(title);
            }
        } else
            if (needAutoSaveDescription()) {
                java.lang.String description = bundle.getString(key);
                if (description != null) {
    ...
    static final boolean isPasswordVariant(int inputType) {
        final int variation = inputType & android.text.InputType.TYPE_MASK_VARIATION;
        return ((variation == android.text.InputType.TYPE_TEXT_VARIATION_PASSWORD) || (variation == android.text.InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD)) || (variation == android.text.InputType.TYPE_TEXT_VARIATION_WEB_PASSWORD);
    }

    final boolean needAutoSaveTitle() {
        return isEditable() && (!android.support.v17.leanback.widget.GuidedAction.isPasswordVariant(getEditInputType()));
    }

    final boolean needAutoSaveDescription() {
        return isDescriptionEditable() && (!android.support.v17.leanback.widget.GuidedAction.isPasswordVariant(getDescriptionEditInputType()));
    }
}
