...
public class VerticalGridView extends android.support.v17.leanback.widget.BaseGridView {
    ...
    public VerticalGridView(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
        ...
        mLayoutManager.setOrientation(android.support.v7.widget.RecyclerView.VERTICAL);
        initAttributes(context, attrs);
    }

    protected void initAttributes(android.content.Context context, android.util.AttributeSet attrs) {
        initBaseGridViewAttributes(context, attrs);
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.lbVerticalGridView);
        setColumnWidth(a);
    ...
    void setColumnWidth(android.content.res.TypedArray array) {
        android.util.TypedValue typedValue = array.peekValue(R.styleable.lbVerticalGridView_columnWidth);
        if (typedValue != null) {
     ...
     *
     * @param width
     * 		May be {@link android.view.ViewGroup.LayoutParams#WRAP_CONTENT}, or a size
