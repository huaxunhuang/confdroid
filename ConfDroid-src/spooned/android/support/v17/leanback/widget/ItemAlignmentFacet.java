...
public final class ItemAlignmentFacet {
    ...
    public static class ItemAlignmentDef {
        int mViewId = android.view.View.NO_ID;

        int mFocusViewId = android.view.View.NO_ID;
        ...
        public final void setItemAlignmentOffsetPercent(float percent) {
            if (((percent < 0) || (percent > 100)) && (percent != android.support.v17.leanback.widget.ItemAlignmentFacet.ITEM_ALIGN_OFFSET_PERCENT_DISABLED)) {
        ...
        public final int getItemAlignmentFocusViewId() {
            return mFocusViewId != android.view.View.NO_ID ? mFocusViewId : mViewId;
        }
    ...
    private android.support.v17.leanback.widget.ItemAlignmentFacet.ItemAlignmentDef[] mAlignmentDefs = new android.support.v17.leanback.widget.ItemAlignmentFacet.ItemAlignmentDef[]{ new android.support.v17.leanback.widget.ItemAlignmentFacet.ItemAlignmentDef() };
     ...
     */
    public void setAlignmentDefs(android.support.v17.leanback.widget.ItemAlignmentFacet.ItemAlignmentDef[] defs) {
