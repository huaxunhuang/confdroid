...
public final class ShadowOverlayHelper {
    ...
    public static final class Builder {
        ...
        private android.support.v17.leanback.widget.ShadowOverlayHelper.Options options = android.support.v17.leanback.widget.ShadowOverlayHelper.Options.DEFAULT;
         ...
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder needsOverlay(boolean needsOverlay) {
         ...
         * @return The Builder object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder needsShadow(boolean needsShadow) {
         ...
         *
         * @param needsRoundedCorner
         * 		True if needs rounded corner.
         * @return The Builder object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder needsRoundedCorner(boolean needsRoundedCorner) {
         ...
         * @return The Builder object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder preferZOrder(boolean preferZOrder) {
         ...
         *
         * @param keepForegroundDrawable
         * 		True to keep the original foreground drawable.
         * @return The Builder object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder keepForegroundDrawable(boolean keepForegroundDrawable) {
         ...
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Builder options(android.support.v17.leanback.widget.ShadowOverlayHelper.Options options) {
         ...
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper build(android.content.Context context) {
            final android.support.v17.leanback.widget.ShadowOverlayHelper helper = new android.support.v17.leanback.widget.ShadowOverlayHelper();
            helper.mNeedsOverlay = needsOverlay;
            helper.mNeedsRoundedCorner = needsRoundedCorner && android.support.v17.leanback.widget.ShadowOverlayHelper.supportsRoundedCorner();
            helper.mNeedsShadow = needsShadow && android.support.v17.leanback.widget.ShadowOverlayHelper.supportsShadow();
            ...
            if (helper.mNeedsShadow) {
                ...
                if ((!preferZOrder) || (!android.support.v17.leanback.widget.ShadowOverlayHelper.supportsDynamicShadow())) {
                    helper.mShadowType = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_STATIC;
                    // static shadow requires ShadowOverlayContainer to support crossfading
                    // of two shadow views.
                    helper.mNeedsWrapper = true;
                } else {
                    helper.mShadowType = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC;
                    helper.setupDynamicShadowZ(options, context);
                    helper.mNeedsWrapper = ((!android.support.v17.leanback.widget.ShadowOverlayHelper.supportsForeground()) || keepForegroundDrawable) && helper.mNeedsOverlay;
                }
            } else {
                helper.mShadowType = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_NONE;
                helper.mNeedsWrapper = ((!android.support.v17.leanback.widget.ShadowOverlayHelper.supportsForeground()) || keepForegroundDrawable) && helper.mNeedsOverlay;
            }
            return helper;
        }
    ...
    public static final class Options {
         ...
         */
        public static final android.support.v17.leanback.widget.ShadowOverlayHelper.Options DEFAULT = new android.support.v17.leanback.widget.ShadowOverlayHelper.Options();
         ...
         *
         * @param roundedCornerRadius
         * 		Number of pixels of rounded corner radius.
         * 		Set to 0 to use default settings.
         * @return The Options object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Options roundedCornerRadius(int roundedCornerRadius) {
         ...
         * @return The Options object itself.
         */
        public android.support.v17.leanback.widget.ShadowOverlayHelper.Options dynamicShadowZ(float unfocusedZ, float focusedZ) {
    ...
    int mShadowType = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_NONE;
    ...
    public static boolean supportsShadow() {
        return android.support.v17.leanback.widget.StaticShadowHelper.getInstance().supportsShadow();
    }
    ...
    public static boolean supportsDynamicShadow() {
        return android.support.v17.leanback.widget.ShadowHelper.getInstance().supportsDynamicShadow();
    }
    ...
    public static boolean supportsRoundedCorner() {
        return android.support.v17.leanback.widget.RoundedRectHelper.supportsRoundedCorner();
    }
    ...
    public static boolean supportsForeground() {
        return android.support.v17.leanback.widget.ForegroundHelper.supportsForeground();
    }
     ...
     */
    public void prepareParentForShadow(android.view.ViewGroup parent) {
        if (mShadowType == android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_STATIC) {
            android.support.v17.leanback.widget.StaticShadowHelper.getInstance().prepareParent(parent);
        }
    }
     ...
     */
    public android.support.v17.leanback.widget.ShadowOverlayContainer createShadowOverlayContainer(android.content.Context context) {
        if (!needsWrapper()) {
            throw new java.lang.IllegalArgumentException();
        }
        return new android.support.v17.leanback.widget.ShadowOverlayContainer(context, mShadowType, mNeedsOverlay, mUnfocusedZ, mFocusedZ, mRoundedCornerRadius);
    }
     ...
     */
    public static void setNoneWrapperOverlayColor(android.view.View view, int color) {
        android.graphics.drawable.Drawable d = android.support.v17.leanback.widget.ForegroundHelper.getInstance().getForeground(view);
        if (d instanceof android.graphics.drawable.ColorDrawable) {
            ((android.graphics.drawable.ColorDrawable) (d)).setColor(color);
        } else {
            android.support.v17.leanback.widget.ForegroundHelper.getInstance().setForeground(view, new android.graphics.drawable.ColorDrawable(color));
        }
    }
     ...
     * or other view type.
     */
    public void setOverlayColor(android.view.View view, int color) {
        if (needsWrapper()) {
            ((android.support.v17.leanback.widget.ShadowOverlayContainer) (view)).setOverlayColor(color);
        } else {
            android.support.v17.leanback.widget.ShadowOverlayHelper.setNoneWrapperOverlayColor(view, color);
        }
    }
        ...
        if (!needsWrapper()) {
            if (!mNeedsShadow) {
                if (mNeedsRoundedCorner) {
                    android.support.v17.leanback.widget.RoundedRectHelper.getInstance().setClipToRoundedOutline(view, true, mRoundedCornerRadius);
                }
            } else {
                if (mShadowType == android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC) {
                    java.lang.Object tag = android.support.v17.leanback.widget.ShadowHelper.getInstance().addDynamicShadow(view, mUnfocusedZ, mFocusedZ, mRoundedCornerRadius);
     ...
     */
    public static void setNoneWrapperShadowFocusLevel(android.view.View view, float level) {
        android.support.v17.leanback.widget.ShadowOverlayHelper.setShadowFocusLevel(android.support.v17.leanback.widget.ShadowOverlayHelper.getNoneWrapperDynamicShadowImpl(view), android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC, level);
    }

    /**
     * Set shadow focus level (0 to 1). 0 for unfocused, 1 for fully focused.
     */
    public void setShadowFocusLevel(android.view.View view, float level) {
        if (needsWrapper()) {
            ((android.support.v17.leanback.widget.ShadowOverlayContainer) (view)).setShadowFocusLevel(level);
        } else {
            android.support.v17.leanback.widget.ShadowOverlayHelper.setShadowFocusLevel(android.support.v17.leanback.widget.ShadowOverlayHelper.getNoneWrapperDynamicShadowImpl(view), android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC, level);
        }
    }

    void setupDynamicShadowZ(android.support.v17.leanback.widget.ShadowOverlayHelper.Options options, android.content.Context context) {
    ...
    void setupRoundedCornerRadius(android.support.v17.leanback.widget.ShadowOverlayHelper.Options options, android.content.Context context) {
    ...
    static java.lang.Object getNoneWrapperDynamicShadowImpl(android.view.View view) {
        return view.getTag(R.id.lb_shadow_impl);
    }

    static void setShadowFocusLevel(java.lang.Object impl, int shadowType, float level) {
        if (impl != null) {
            if (level < 0.0F) {
                level = 0.0F;
            } else
            ...
            switch (shadowType) {
                case android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC :
                    android.support.v17.leanback.widget.ShadowHelper.getInstance().setShadowFocusLevel(impl, level);
                    break;
                case android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_STATIC :
                    android.support.v17.leanback.widget.StaticShadowHelper.getInstance().setShadowFocusLevel(impl, level);
                    break;
            }
        }
    }
