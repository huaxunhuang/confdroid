...
public class ShadowOverlayContainer extends android.widget.FrameLayout {
     ...
     * No shadow.
     */
    public static final int SHADOW_NONE = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_NONE;

    /**
     * Shadows are fixed.
     */
    public static final int SHADOW_STATIC = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_STATIC;

    /**
     * Shadows depend on the size, shape, and position of the view.
     */
    public static final int SHADOW_DYNAMIC = android.support.v17.leanback.widget.ShadowOverlayHelper.SHADOW_DYNAMIC;

    private boolean mInitialized;

    private java.lang.Object mShadowImpl;

    private android.view.View mWrappedView;

    private boolean mRoundedCorners;

    private int mShadowType = android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_NONE;
     ...
     */
    public ShadowOverlayContainer(android.content.Context context) {
        this(context, null, 0);
    }
     ...
     * Create ShadowOverlayContainer and auto select shadow type.
     */
    public ShadowOverlayContainer(android.content.Context context, android.util.AttributeSet attrs) {
     ...
     * Create ShadowOverlayContainer and auto select shadow type.
     */
    public ShadowOverlayContainer(android.content.Context context, android.util.AttributeSet attrs, int defStyle) {
     ...
     */
    ShadowOverlayContainer(android.content.Context context, int shadowType, boolean hasColorDimOverlay, float unfocusedZ, float focusedZ, int roundedCornerRadius) {
        super(context);
     ...
     * to parent.
     */
    public static void prepareParentForShadow(android.view.ViewGroup parent) {
    ...
    public void useDynamicShadow(float unfocusedZ, float focusedZ) {
        ...
        if (android.support.v17.leanback.widget.ShadowOverlayContainer.supportsDynamicShadow()) {
            mShadowType = android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_DYNAMIC;
            mUnfocusedZ = unfocusedZ;
            mFocusedZ = focusedZ;
        }
    }
    ...
    public void useStaticShadow() {
        ...
        if (android.support.v17.leanback.widget.ShadowOverlayContainer.supportsShadow()) {
            mShadowType = android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_STATIC;
        }
    }
    ...
    public void initialize(boolean hasShadow, boolean hasColorDimOverlay, boolean roundedCorners) {
        int shadowType;
        if (!hasShadow) {
            shadowType = android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_NONE;
        } else {
            shadowType = mShadowType;
        }
        int roundedCornerRadius = (roundedCorners) ? getContext().getResources().getDimensionPixelSize(R.dimen.lb_rounded_rect_corner_radius) : 0;
        initialize(shadowType, hasColorDimOverlay, roundedCornerRadius);
    }
    ...
    void initialize(int shadowType, boolean hasColorDimOverlay, int roundedCornerRadius) {
        ...
        switch (mShadowType) {
            case android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_DYNAMIC :
                mShadowImpl = android.support.v17.leanback.widget.ShadowHelper.getInstance().addDynamicShadow(this, mUnfocusedZ, mFocusedZ, mRoundedCornerRadius);
                break;
            case android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_STATIC :
                mShadowImpl = android.support.v17.leanback.widget.StaticShadowHelper.getInstance().addStaticShadow(this);
                break;
        }
        if (hasColorDimOverlay) {
            setWillNotDraw(false);
            mOverlayColor = android.graphics.Color.TRANSPARENT;
            mOverlayPaint = new android.graphics.Paint();
    ...
    public void draw(android.graphics.Canvas canvas) {
        super.draw(canvas);
        if ((mOverlayPaint != null) && (mOverlayColor != android.graphics.Color.TRANSPARENT)) {
            canvas.drawRect(mWrappedView.getLeft(), mWrappedView.getTop(), mWrappedView.getRight(), mWrappedView.getBottom(), mOverlayPaint);
        }
    }
    ...
    public void setShadowFocusLevel(float level) {
        if (mShadowImpl != null) {
            android.support.v17.leanback.widget.ShadowOverlayHelper.setShadowFocusLevel(mShadowImpl, mShadowType, level);
        }
    }
     ...
     */
    public void setOverlayColor(@android.support.annotation.ColorInt
    int overlayColor) {
     ...
     */
    public void wrap(android.view.View view) {
        ...
        if (lp != null) {
            ...
            android.view.ViewGroup.LayoutParams wrapped_lp = new android.widget.FrameLayout.LayoutParams(lp.width, lp.height);
            ...
            lp.width = (lp.width == android.widget.FrameLayout.LayoutParams.MATCH_PARENT) ? android.widget.FrameLayout.LayoutParams.MATCH_PARENT : android.widget.FrameLayout.LayoutParams.WRAP_CONTENT;
            lp.height = (lp.height == android.widget.FrameLayout.LayoutParams.MATCH_PARENT) ? android.widget.FrameLayout.LayoutParams.MATCH_PARENT : android.widget.FrameLayout.LayoutParams.WRAP_CONTENT;
            this.setLayoutParams(lp);
            addView(view, wrapped_lp);
        } else {
            addView(view);
        }
        if (mRoundedCorners && (mShadowType == android.support.v17.leanback.widget.ShadowOverlayContainer.SHADOW_STATIC)) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && (mWrappedView != null)) {
            android.support.v17.leanback.widget.ShadowOverlayContainer.sTempRect.left = ((int) (mWrappedView.getPivotX()));
            android.support.v17.leanback.widget.ShadowOverlayContainer.sTempRect.top = ((int) (mWrappedView.getPivotY()));
            offsetDescendantRectToMyCoords(mWrappedView, android.support.v17.leanback.widget.ShadowOverlayContainer.sTempRect);
            setPivotX(android.support.v17.leanback.widget.ShadowOverlayContainer.sTempRect.left);
            setPivotY(android.support.v17.leanback.widget.ShadowOverlayContainer.sTempRect.top);
        }
    }
