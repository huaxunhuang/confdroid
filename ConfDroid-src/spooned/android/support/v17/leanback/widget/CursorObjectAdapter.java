...
public class CursorObjectAdapter extends android.support.v17.leanback.widget.ObjectAdapter {
    ...
    private android.support.v17.leanback.database.CursorMapper mMapper;

    private final android.util.LruCache<java.lang.Integer, java.lang.Object> mItemCache = new android.util.LruCache<java.lang.Integer, java.lang.Object>(android.support.v17.leanback.widget.CursorObjectAdapter.CACHE_SIZE);

    /**
     * Constructs an adapter with the given {@link PresenterSelector}.
     */
    public CursorObjectAdapter(android.support.v17.leanback.widget.PresenterSelector presenterSelector) {
     ...
     */
    public CursorObjectAdapter(android.support.v17.leanback.widget.Presenter presenter) {
        super(presenter);
    }
     ...
     * Objects.
     */
    public final void setMapper(android.support.v17.leanback.database.CursorMapper mapper) {
    ...
    public java.lang.Object get(int index) {
        ...
        java.lang.Object item = mItemCache.get(index);
        if (item != null) {
            return item;
        }
