...
public abstract class ObjectAdapter {
    ...
    private static final class DataObservable extends android.database.Observable<android.support.v17.leanback.widget.ObjectAdapter.DataObserver> {
        DataObservable() {
        }
    ...
    private final android.support.v17.leanback.widget.ObjectAdapter.DataObservable mObservable = new android.support.v17.leanback.widget.ObjectAdapter.DataObservable();
     ...
     */
    public ObjectAdapter(android.support.v17.leanback.widget.PresenterSelector presenterSelector) {
     ...
     */
    public ObjectAdapter(android.support.v17.leanback.widget.Presenter presenter) {
        setPresenterSelector(new android.support.v17.leanback.widget.SinglePresenterSelector(presenter));
    }
    ...
    public final void setPresenterSelector(android.support.v17.leanback.widget.PresenterSelector presenterSelector) {
        if (presenterSelector == null) {
            throw new java.lang.IllegalArgumentException("Presenter selector must not be null");
        }
     ...
     */
    public final void registerObserver(android.support.v17.leanback.widget.ObjectAdapter.DataObserver observer) {
     ...
     */
    public final void unregisterObserver(android.support.v17.leanback.widget.ObjectAdapter.DataObserver observer) {
     ...
     */
    public final android.support.v17.leanback.widget.Presenter getPresenter(java.lang.Object item) {
        if (mPresenterSelector == null) {
            throw new java.lang.IllegalStateException("Presenter selector must not be null");
        }
    ...
    public long getId(int position) {
        return android.support.v17.leanback.widget.ObjectAdapter.NO_ID;
    }
