...
public class Action {
    ...
    private long mId = android.support.v17.leanback.widget.Action.NO_ID;

    private android.graphics.drawable.Drawable mIcon;

    private java.lang.CharSequence mLabel1;

    private java.lang.CharSequence mLabel2;

    private java.util.ArrayList mKeyCodes = new java.util.ArrayList();
     ...
     */
    public Action(long id, java.lang.CharSequence label) {
        this(id, label, null);
    }
     ...
     */
    public Action(long id, java.lang.CharSequence label1, java.lang.CharSequence label2) {
     ...
     */
    public Action(long id, java.lang.CharSequence label1, java.lang.CharSequence label2, android.graphics.drawable.Drawable icon) {
        setId(id);
        setLabel1(label1);
        setLabel2(label2);
        setIcon(icon);
     ...
     */
    public final void setLabel1(java.lang.CharSequence label) {
        mLabel1 = label;
    }
     ...
     */
    public final void setLabel2(java.lang.CharSequence label) {
        mLabel2 = label;
    }
     ...
     */
    public final void setIcon(android.graphics.drawable.Drawable icon) {
        mIcon = icon;
    }
    ...
    public java.lang.String toString() {
        ...
        if (!android.text.TextUtils.isEmpty(mLabel1)) {
            sb.append(mLabel1);
        }
        if (!android.text.TextUtils.isEmpty(mLabel2)) {
            if (!android.text.TextUtils.isEmpty(mLabel1)) {
                sb.append(" ");
            }
            sb.append(mLabel2);
