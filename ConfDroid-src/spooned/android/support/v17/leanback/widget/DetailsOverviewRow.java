 ...
 * After the row is bound to view, the application may change the image by calling {@link #setImageBitmap(Context, Bitmap)} or {@link #setImageDrawable(Drawable)} on the UI thread,
...
public class DetailsOverviewRow extends android.support.v17.leanback.widget.Row {
    ...
    private java.util.ArrayList<java.lang.ref.WeakReference<android.support.v17.leanback.widget.DetailsOverviewRow.Listener>> mListeners;

    private android.support.v17.leanback.widget.PresenterSelector mDefaultActionPresenter = new android.support.v17.leanback.widget.ActionPresenterSelector();

    private android.support.v17.leanback.widget.ObjectAdapter mActionsAdapter = new android.support.v17.leanback.widget.ArrayObjectAdapter(mDefaultActionPresenter);
     ...
     */
    public DetailsOverviewRow(java.lang.Object item) {
        super(null);
        mItem = item;
        verify();
    }
     ...
     */
    final void addListener(android.support.v17.leanback.widget.DetailsOverviewRow.Listener listener) {
        if (mListeners == null) {
            mListeners = new java.util.ArrayList<java.lang.ref.WeakReference<android.support.v17.leanback.widget.DetailsOverviewRow.Listener>>();
        } else {
            for (int i = 0; i < mListeners.size();) {
                android.support.v17.leanback.widget.DetailsOverviewRow.Listener l = mListeners.get(i).get();
                if (l == null) {
                    mListeners.remove(i);
                } else {
                    if (l == listener) {
        ...
        mListeners.add(new java.lang.ref.WeakReference<android.support.v17.leanback.widget.DetailsOverviewRow.Listener>(listener));
    }

    /**
     * Removes listener of the details page.
     */
    final void removeListener(android.support.v17.leanback.widget.DetailsOverviewRow.Listener listener) {
        if (mListeners != null) {
            for (int i = 0; i < mListeners.size();) {
                android.support.v17.leanback.widget.DetailsOverviewRow.Listener l = mListeners.get(i).get();
                if (l == null) {
     ...
     */
    public final void setItem(java.lang.Object item) {
        if (item != mItem) {
            mItem = item;
            notifyItemChanged();
        }
    ...
    private android.support.v17.leanback.widget.ArrayObjectAdapter getArrayObjectAdapter() {
        return ((android.support.v17.leanback.widget.ArrayObjectAdapter) (mActionsAdapter));
    }
    ...
    public final void addAction(android.support.v17.leanback.widget.Action action) {
     ...
     */
    @java.lang.Deprecated
    public final void addAction(int pos, android.support.v17.leanback.widget.Action action) {
     ...
     */
    @java.lang.Deprecated
    public final boolean removeAction(android.support.v17.leanback.widget.Action action) {
     ...
     */
    @java.lang.Deprecated
    public final java.util.List<android.support.v17.leanback.widget.Action> getActions() {
     ...
     * 		Adapter for actions.
     */
    public final void setActionsAdapter(android.support.v17.leanback.widget.ObjectAdapter adapter) {
    ...
    public android.support.v17.leanback.widget.Action getActionForKeyCode(int keyCode) {
        android.support.v17.leanback.widget.ObjectAdapter adapter = getActionsAdapter();
        if (adapter != null) {
