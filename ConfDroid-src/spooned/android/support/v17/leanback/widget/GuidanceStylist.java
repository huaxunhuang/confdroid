 ...
 * @unknown ref android.support.v17.leanback.R.styleable#LeanbackGuidedStepTheme_guidanceContainerStyle
 * @unknown ref android.support.v17.leanback.R.styleable#LeanbackGuidedStepTheme_guidanceTitleStyle
 * @unknown ref android.support.v17.leanback.R.styleable#LeanbackGuidedStepTheme_guidanceDescriptionStyle
 * @unknown ref android.support.v17.leanback.R.styleable#LeanbackGuidedStepTheme_guidanceBreadcrumbStyle
 * @unknown ref android.support.v17.leanback.R.styleable#LeanbackGuidedStepTheme_guidanceIconStyle
...
public class GuidanceStylist implements android.support.v17.leanback.widget.FragmentAnimationProvider {
    /**
     * A data class representing contextual information for a {@link android.support.v17.leanback.app.GuidedStepFragment}. Guidance consists of a short title,
    ...
    public static class Guidance {
        ...
        private final java.lang.String mBreadcrumb;

        private final android.graphics.drawable.Drawable mIconDrawable;
         ...
         */
        public Guidance(java.lang.String title, java.lang.String description, java.lang.String breadcrumb, android.graphics.drawable.Drawable icon) {
    ...
    private android.widget.TextView mDescriptionView;

    private android.widget.TextView mBreadcrumbView;

    private android.widget.ImageView mIconView;

    private android.view.View mGuidanceContainer;
     ...
     */
    public android.view.View onCreateView(final android.view.LayoutInflater inflater, android.view.ViewGroup container, android.support.v17.leanback.widget.GuidanceStylist.Guidance guidance) {
        android.view.View guidanceView = inflater.inflate(onProvideLayoutId(), container, false);
        mTitleView = ((android.widget.TextView) (guidanceView.findViewById(R.id.guidance_title)));
        mBreadcrumbView = ((android.widget.TextView) (guidanceView.findViewById(R.id.guidance_breadcrumb)));
        mDescriptionView = ((android.widget.TextView) (guidanceView.findViewById(R.id.guidance_description)));
        mIconView = ((android.widget.ImageView) (guidanceView.findViewById(R.id.guidance_icon)));
        ...
        if (mGuidanceContainer != null) {
            java.lang.CharSequence contentDescription = mGuidanceContainer.getContentDescription();
            if (android.text.TextUtils.isEmpty(contentDescription)) {
                java.lang.StringBuilder builder = new java.lang.StringBuilder();
                if (!android.text.TextUtils.isEmpty(guidance.getBreadcrumb())) {
                    builder.append(guidance.getBreadcrumb()).append('\n');
                }
                if (!android.text.TextUtils.isEmpty(guidance.getTitle())) {
                    builder.append(guidance.getTitle()).append('\n');
                }
                if (!android.text.TextUtils.isEmpty(guidance.getDescription())) {
