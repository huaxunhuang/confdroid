...
public abstract class OnboardingSupportFragment extends android.support.v4.app.Fragment {
    private static final java.lang.String TAG = "OnboardingSupportFragment";
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, final android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        ...
        if (android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance == 0) {
            android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance = ((int) (android.support.v17.leanback.app.OnboardingSupportFragment.SLIDE_DISTANCE * getActivity().getResources().getDisplayMetrics().scaledDensity));
        }
        if (savedInstanceState == null) {
            ...
            mCurrentPageIndex = savedInstanceState.getInt(android.support.v17.leanback.app.OnboardingSupportFragment.KEY_CURRENT_PAGE_INDEX);
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        outState.putInt(android.support.v17.leanback.app.OnboardingSupportFragment.KEY_CURRENT_PAGE_INDEX, mCurrentPageIndex);
    }
    ...
    private void resolveTheme() {
        ...
        if (theme == (-1)) {
            ...
            if (android.support.v17.leanback.app.OnboardingSupportFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.OnboardingSupportFragment.TAG, "Found onboarding theme reference? " + found);
    ...
    boolean startLogoAnimation() {
        ...
        if (mLogoResourceId != 0) {
            ...
            outAnimator.setStartDelay(android.support.v17.leanback.app.OnboardingSupportFragment.LOGO_SPLASH_PAUSE_DURATION_MS);
    ...
    void startEnterAnimation() {
        ...
        animator.setStartDelay(android.support.v17.leanback.app.OnboardingSupportFragment.START_DELAY_TITLE_MS);
        ...
        animator.setStartDelay(android.support.v17.leanback.app.OnboardingSupportFragment.START_DELAY_DESCRIPTION_MS);
        animator.setTarget(view);
        animators.add(animator);
    ...
    private void onPageChangedInternal(int previousPage) {
        ...
        if (previousPage < getCurrentPageIndex()) {
            ...
            animators.add(fadeAnimator = createAnimator(mDescriptionView, false, android.view.Gravity.START, android.support.v17.leanback.app.OnboardingSupportFragment.DESCRIPTION_START_DELAY_MS));
            animators.add(createAnimator(mTitleView, true, android.view.Gravity.END, android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_DELAY_MS));
            animators.add(createAnimator(mDescriptionView, true, android.view.Gravity.END, android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_DELAY_MS + android.support.v17.leanback.app.OnboardingSupportFragment.DESCRIPTION_START_DELAY_MS));
        } else {
            // sliding to right
            animators.add(createAnimator(mTitleView, false, android.view.Gravity.END, 0));
            animators.add(fadeAnimator = createAnimator(mDescriptionView, false, android.view.Gravity.END, android.support.v17.leanback.app.OnboardingSupportFragment.DESCRIPTION_START_DELAY_MS));
            animators.add(createAnimator(mTitleView, true, android.view.Gravity.START, android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_DELAY_MS));
            animators.add(createAnimator(mDescriptionView, true, android.view.Gravity.START, android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_DELAY_MS + android.support.v17.leanback.app.OnboardingSupportFragment.DESCRIPTION_START_DELAY_MS));
        }
    ...
    private android.animation.Animator createAnimator(android.view.View view, boolean fadeIn, int slideDirection, long startDelay) {
        ...
        if (fadeIn) {
            ...
            slideAnimator = android.animation.ObjectAnimator.ofFloat(view, android.view.View.TRANSLATION_X, slideRight ? android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance : -android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance, 0);
            fadeAnimator.setInterpolator(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_INTERPOLATOR);
            slideAnimator.setInterpolator(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_APPEAR_INTERPOLATOR);
        } else {
            fadeAnimator = android.animation.ObjectAnimator.ofFloat(view, android.view.View.ALPHA, 1.0F, 0.0F);
            slideAnimator = android.animation.ObjectAnimator.ofFloat(view, android.view.View.TRANSLATION_X, 0, slideRight ? android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance : -android.support.v17.leanback.app.OnboardingSupportFragment.sSlideDistance);
            fadeAnimator.setInterpolator(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_DISAPPEAR_INTERPOLATOR);
            slideAnimator.setInterpolator(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_DISAPPEAR_INTERPOLATOR);
        }
        fadeAnimator.setDuration(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_ANIMATION_DURATION_MS);
        fadeAnimator.setTarget(view);
        slideAnimator.setDuration(android.support.v17.leanback.app.OnboardingSupportFragment.HEADER_ANIMATION_DURATION_MS);
