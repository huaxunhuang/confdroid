...
abstract class BaseRowFragment extends android.app.Fragment {
    ...
    private android.support.v17.leanback.app.BaseRowFragment.LateSelectionObserver mLateSelectionObserver = new android.support.v17.leanback.app.BaseRowFragment.LateSelectionObserver();
    ...
    public void onViewCreated(android.view.View view, android.os.Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            mSelectedPosition = savedInstanceState.getInt(android.support.v17.leanback.app.BaseRowFragment.CURRENT_SELECTED_POSITION, -1);
        }
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        outState.putInt(android.support.v17.leanback.app.BaseRowFragment.CURRENT_SELECTED_POSITION, mSelectedPosition);
    }
