...
public class PlaybackOverlayFragment extends android.support.v17.leanback.app.DetailsFragment {
    ...
    static final java.lang.String TAG = "PlaybackOverlayFragment";
    ...
    private int mBackgroundType = android.support.v17.leanback.app.PlaybackOverlayFragment.BG_DARK;
    ...
    android.support.v17.leanback.app.PlaybackOverlayFragment.OnFadeCompleteListener mFadeCompleteListener;

    private android.support.v17.leanback.app.PlaybackOverlayFragment.InputEventHandler mInputEventHandler;

    boolean mFadingEnabled = true;

    int mFadingStatus = android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE;
    ...
    private final android.animation.Animator.AnimatorListener mFadeListener = new android.animation.Animator.AnimatorListener() {
        ...
        public void onAnimationEnd(android.animation.Animator animation) {
            if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "onAnimationEnd " + mBgAlpha);
            ...
            mFadingStatus = android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE;
        }
    };
    ...
    static class FadeHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message message) {
            android.support.v17.leanback.app.PlaybackOverlayFragment fragment;
            if (message.what == android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT) {
                fragment = ((java.lang.ref.WeakReference<android.support.v17.leanback.app.PlaybackOverlayFragment>) (message.obj)).get();
    ...
    static final android.os.Handler sHandler = new android.support.v17.leanback.app.PlaybackOverlayFragment.FadeHandler();

    final java.lang.ref.WeakReference<android.support.v17.leanback.app.PlaybackOverlayFragment> mFragmentReference = new java.lang.ref.WeakReference(this);
    ...
    public void setFadingEnabled(boolean enabled) {
        if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "setFadingEnabled " + enabled);

        if (enabled != mFadingEnabled) {
            mFadingEnabled = enabled;
            if (mFadingEnabled) {
                if ((isResumed() && (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE)) && (!android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.hasMessages(android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT, mFragmentReference))) {
                    startFadeTimer();
                }
            } else {
                // Ensure fully opaque
                android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.removeMessages(android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT, mFragmentReference);
                fade(true);
            }
        }
    }
     ...
     */
    public void setFadeCompleteListener(android.support.v17.leanback.app.PlaybackOverlayFragment.OnFadeCompleteListener listener) {
     ...
     */
    public final void setInputEventHandler(android.support.v17.leanback.app.PlaybackOverlayFragment.InputEventHandler handler) {
     ...
     */
    public final android.support.v17.leanback.app.PlaybackOverlayFragment.InputEventHandler getInputEventHandler() {
    ...
    public void tickle() {
        if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, (("tickle enabled " + mFadingEnabled) + " isResumed ") + isResumed());

        if ((!mFadingEnabled) || (!isResumed())) {
            return;
        }
        if (android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.hasMessages(android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT, mFragmentReference)) {
            // Restart the timer
            startFadeTimer();
        } else {
            fade(true);
    ...
    private boolean areControlsHidden() {
        return (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE) && (mBgAlpha == 0);
    }

    boolean onInterceptInputEvent(android.view.InputEvent event) {
        final boolean controlsHidden = areControlsHidden();
        if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, (("onInterceptInputEvent hidden " + controlsHidden) + " ") + event);
    ...
    void startFadeTimer() {
        android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.removeMessages(android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT, mFragmentReference);
        android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.sendMessageDelayed(android.support.v17.leanback.app.PlaybackOverlayFragment.sHandler.obtainMessage(android.support.v17.leanback.app.PlaybackOverlayFragment.START_FADE_OUT, mFragmentReference), mShowTimeMs);
    }
    ...
    private static android.animation.ValueAnimator loadAnimator(android.content.Context context, int resId) {
        ...
        animator.setDuration(animator.getDuration() * android.support.v17.leanback.app.PlaybackOverlayFragment.ANIMATION_MULTIPLIER);
        return animator;
    }
    ...
    private void loadBgAnimator() {
        ...
        mBgFadeInAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_bg_fade_in);
        mBgFadeInAnimator.addUpdateListener(listener);
        mBgFadeInAnimator.addListener(mFadeListener);
        mBgFadeOutAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_bg_fade_out);
    ...
    private void loadControlRowAnimator() {
        final android.support.v17.leanback.app.PlaybackOverlayFragment.AnimatorListener listener = new android.support.v17.leanback.app.PlaybackOverlayFragment.AnimatorListener() {
            @java.lang.Override
        ...
        final android.animation.ValueAnimator.AnimatorUpdateListener updateListener = new android.animation.ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(android.animation.ValueAnimator arg0) {
                ...
                if (view != null) {
                    ...
                    if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                        android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "fraction " + fraction);
        ...
        mControlRowFadeInAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_controls_fade_in);
        ...
        mControlRowFadeOutAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_controls_fade_out);
    ...
    private void loadOtherRowAnimator() {
        ...
        mOtherRowFadeInAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_controls_fade_in);
        ...
        mOtherRowFadeOutAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_controls_fade_out);
    ...
    private void loadDescriptionAnimator() {
        ...
        mDescriptionFadeInAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_description_fade_in);
        ...
        mDescriptionFadeOutAnimator = android.support.v17.leanback.app.PlaybackOverlayFragment.loadAnimator(getActivity(), R.animator.lb_playback_description_fade_out);
        mDescriptionFadeOutAnimator.addUpdateListener(listener);
    }

    void fade(boolean fadeIn) {
        if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "fade " + fadeIn);

        if (getView() == null) {
            return;
        }
        if ((fadeIn && (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IN)) || ((!fadeIn) && (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.OUT))) {
            if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "requested fade in progress");

            return;
        }
        if ((fadeIn && (mBgAlpha == 255)) || ((!fadeIn) && (mBgAlpha == 0))) {
            if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "fade is no-op");

            return;
        }
        mAnimationTranslateY = (getVerticalGridView().getSelectedPosition() == 0) ? mMajorFadeTranslateY : mMinorFadeTranslateY;
        if (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE) {
            if (fadeIn) {
        ...
        if (fadeIn && (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE)) {
            final int count = getVerticalGridView().getChildCount();
            for (int i = 0; i < count; i++) {
                getVerticalGridView().getChildAt(i).setTranslationY(mAnimationTranslateY);
            }
        }
        mFadingStatus = (fadeIn) ? android.support.v17.leanback.app.PlaybackOverlayFragment.IN : android.support.v17.leanback.app.PlaybackOverlayFragment.OUT;
    }
    ...
    void setVerticalGridViewLayout(android.support.v17.leanback.widget.VerticalGridView listview) {
        ...
        android.support.v17.leanback.app.PlaybackOverlayFragment.setPadding(listview, mPaddingTop, mPaddingBottom);
    ...
    public void setBackgroundType(int type) {
        switch (type) {
            case android.support.v17.leanback.app.PlaybackOverlayFragment.BG_LIGHT :
            case android.support.v17.leanback.app.PlaybackOverlayFragment.BG_DARK :
            case android.support.v17.leanback.app.PlaybackOverlayFragment.BG_NONE :
    ...
    private final android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener mAdapterListener = new android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener() {
        ...
        public void onAttachedToWindow(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh) {
            if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "onAttachedToWindow " + vh.getViewHolder().view);

            if (((mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.IDLE) && (mBgAlpha == 0)) || (mFadingStatus == android.support.v17.leanback.app.PlaybackOverlayFragment.OUT)) {
                if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "setting alpha to 0");
        ...
        public void onDetachedFromWindow(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh) {
            if (android.support.v17.leanback.app.PlaybackOverlayFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackOverlayFragment.TAG, "onDetachedFromWindow " + vh.getViewHolder().view);
