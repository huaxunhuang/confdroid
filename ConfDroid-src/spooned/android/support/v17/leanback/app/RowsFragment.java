...
public class RowsFragment extends android.support.v17.leanback.app.BaseRowFragment implements android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapterProvider , android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapterProvider {
    private android.support.v17.leanback.app.RowsFragment.MainFragmentAdapter mMainFragmentAdapter;

    private android.support.v17.leanback.app.RowsFragment.MainFragmentRowsAdapter mMainFragmentRowsAdapter;
    ...
    public android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapter getMainFragmentAdapter() {
        if (mMainFragmentAdapter == null) {
            mMainFragmentAdapter = new android.support.v17.leanback.app.RowsFragment.MainFragmentAdapter(this);
        }
    ...
    public android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapter getMainFragmentRowsAdapter() {
        if (mMainFragmentRowsAdapter == null) {
            mMainFragmentRowsAdapter = new android.support.v17.leanback.app.RowsFragment.MainFragmentRowsAdapter(this);
        }
    ...
    static final java.lang.String TAG = "RowsFragment";
    ...
    public void setExpand(boolean expand) {
        ...
        if (listView != null) {
            ...
            if (android.support.v17.leanback.app.RowsFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.RowsFragment.TAG, (("setExpand " + expand) + " count ") + count);
            ...
            for (int i = 0; i < count; i++) {
                ...
                android.support.v17.leanback.app.RowsFragment.setRowViewExpanded(vh, mExpand);
            }
        }
    }
    ...
    public void setOnItemViewSelectedListener(android.support.v17.leanback.widget.BaseOnItemViewSelectedListener listener) {
        ...
        if (listView != null) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                android.support.v17.leanback.app.RowsFragment.getRowViewHolder(ibvh).setOnItemViewSelectedListener(mOnItemViewSelectedListener);
            }
        }
    }
    ...
    void onRowSelected(android.support.v7.widget.RecyclerView parent, android.support.v7.widget.RecyclerView.ViewHolder viewHolder, int position, int subposition) {
        if ((mSelectedViewHolder != viewHolder) || (mSubPosition != subposition)) {
            if (android.support.v17.leanback.app.RowsFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.RowsFragment.TAG, (((("new row selected position " + position) + " subposition ") + subposition) + " view ") + viewHolder.itemView);

            mSubPosition = subposition;
            if (mSelectedViewHolder != null) {
                android.support.v17.leanback.app.RowsFragment.setRowViewSelected(mSelectedViewHolder, false, false);
            }
            mSelectedViewHolder = ((android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder) (viewHolder));
            if (mSelectedViewHolder != null) {
                android.support.v17.leanback.app.RowsFragment.setRowViewSelected(mSelectedViewHolder, true, false);
            }
        }
    ...
    public android.support.v17.leanback.widget.RowPresenter.ViewHolder getRowViewHolder(int position) {
        ...
        return android.support.v17.leanback.app.RowsFragment.getRowViewHolder(((android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder) (verticalView.findViewHolderForAdapterPosition(position))));
    }
    ...
    public void onViewCreated(android.view.View view, android.os.Bundle savedInstanceState) {
        if (android.support.v17.leanback.app.RowsFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.RowsFragment.TAG, "onViewCreated");
    ...
    static void setRowViewSelected(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh, boolean selected, boolean immediate) {
        android.support.v17.leanback.app.RowsFragment.RowViewHolderExtra extra = ((android.support.v17.leanback.app.RowsFragment.RowViewHolderExtra) (vh.getExtraObject()));
    ...
    private final android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener mBridgeAdapterListener = new android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener() {
        ...
        public void onCreate(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh) {
            ...
            mViewsCreated = true;
            vh.setExtraObject(new android.support.v17.leanback.app.RowsFragment.RowViewHolderExtra(vh));
            ...
            android.support.v17.leanback.app.RowsFragment.setRowViewSelected(vh, false, true);
            if (mExternalAdapterListener != null) {
        ...
        public void onAttachedToWindow(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh) {
            if (android.support.v17.leanback.app.RowsFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.RowsFragment.TAG, "onAttachToWindow");
        ...
        public void onDetachedFromWindow(android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder vh) {
            if (mSelectedViewHolder == vh) {
                android.support.v17.leanback.app.RowsFragment.setRowViewSelected(mSelectedViewHolder, false, true);
            ...
            task = new android.support.v17.leanback.widget.ViewHolderTask() {
                ...
                public void run(final android.support.v7.widget.RecyclerView.ViewHolder rvh) {
                    rvh.itemView.post(new java.lang.Runnable() {
                        @java.lang.Override
                        public void run() {
                            rowHolderTask.run(android.support.v17.leanback.app.RowsFragment.getRowViewHolder(((android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder) (rvh))));
                        }
                    });
                }
            };
    ...
    public static class MainFragmentAdapter extends android.support.v17.leanback.app.BrowseFragment.MainFragmentAdapter<android.support.v17.leanback.app.RowsFragment> {
        public MainFragmentAdapter(android.support.v17.leanback.app.RowsFragment fragment) {
            super(fragment);
    ...
    public static class MainFragmentRowsAdapter extends android.support.v17.leanback.app.BrowseFragment.MainFragmentRowsAdapter<android.support.v17.leanback.app.RowsFragment> {
        public MainFragmentRowsAdapter(android.support.v17.leanback.app.RowsFragment fragment) {
            super(fragment);
        }
