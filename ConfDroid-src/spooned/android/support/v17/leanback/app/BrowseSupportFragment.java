 ...
 * when the user presses Back. For Activities that customize {@link android.support.v4.app.FragmentActivity#onBackPressed()}, you must disable this default Back key support by
...
public class BrowseSupportFragment extends android.support.v17.leanback.app.BaseSupportFragment {
    ...
    final class BackStackListener implements android.support.v4.app.FragmentManager.OnBackStackChangedListener {
        int mLastEntryCount;
        ...
        void load(android.os.Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                mIndexOfHeadersBackStack = savedInstanceState.getInt(android.support.v17.leanback.app.BrowseSupportFragment.HEADER_STACK_INDEX, -1);
        ...
        void save(android.os.Bundle outState) {
            outState.putInt(android.support.v17.leanback.app.BrowseSupportFragment.HEADER_STACK_INDEX, mIndexOfHeadersBackStack);
        }

        @java.lang.Override
        public void onBackStackChanged() {
            if (getFragmentManager() == null) {
                android.util.Log.w(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "getFragmentManager() is null, stack:", new java.lang.Exception());
                return;
            }
            ...
            if (count > mLastEntryCount) {
                android.support.v4.app.FragmentManager.BackStackEntry entry = getFragmentManager().getBackStackEntryAt(count - 1);
    ...
    private class SetSelectionRunnable implements java.lang.Runnable {
        ...
        private void reset() {
            mPosition = -1;
            mType = android.support.v17.leanback.app.BrowseSupportFragment.SetSelectionRunnable.TYPE_INVALID;
            mSmooth = false;
        }
    }
    ...
    public interface FragmentHost {
         ...
         */
        void notifyViewCreated(android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter fragmentAdapter);
         ...
         * 		{@link MainFragmentAdapter} used by the current fragment.
         */
        void notifyDataReady(android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter fragmentAdapter);
     ...
     */
    private final class FragmentHostImpl implements android.support.v17.leanback.app.BrowseSupportFragment.FragmentHost {
        ...
        @java.lang.Override
        public void notifyViewCreated(android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter fragmentAdapter) {
            performPendingStates();
        }

        @java.lang.Override
        public void notifyDataReady(android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter fragmentAdapter) {
            mDataReady = true;
     ...
     */
    public static class MainFragmentAdapter<T extends android.support.v4.app.Fragment> {
        private boolean mScalingEnabled;

        private final T mFragment;

        android.support.v17.leanback.app.BrowseSupportFragment.FragmentHostImpl mFragmentHost;
         ...
         * {@link BrowseSupportFragment}.
         */
        public final android.support.v17.leanback.app.BrowseSupportFragment.FragmentHost getFragmentHost() {
            return mFragmentHost;
        }

        void setFragmentHost(android.support.v17.leanback.app.BrowseSupportFragment.FragmentHostImpl fragmentHost) {
    ...
    public interface MainFragmentAdapterProvider {
         ...
         */
        android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter getMainFragmentAdapter();
    }
    ...
    public interface MainFragmentRowsAdapterProvider {
         ...
         * would use to communicate with the target fragment.
         */
        android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapter getMainFragmentRowsAdapter();
    }
     ...
     * the target fragment.
     */
    public static class MainFragmentRowsAdapter<T extends android.support.v4.app.Fragment> {
        private final T mFragment;
    ...
    private boolean createMainFragment(android.support.v17.leanback.widget.ObjectAdapter adapter, int position) {
        ...
        if (swap) {
            ...
            if (!(mMainFragment instanceof android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterProvider)) {
                throw new java.lang.IllegalArgumentException("Fragment must implement MainFragmentAdapterProvider");
            }
            mMainFragmentAdapter = ((android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterProvider) (mMainFragment)).getMainFragmentAdapter();
            mMainFragmentAdapter.setFragmentHost(new android.support.v17.leanback.app.BrowseSupportFragment.FragmentHostImpl());
            if (!mIsPageRow) {
                if (mMainFragment instanceof android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapterProvider) {
                    mMainFragmentRowsAdapter = ((android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapterProvider) (mMainFragment)).getMainFragmentRowsAdapter();
                } else {
     ...
     */
    public static abstract class FragmentFactory<T extends android.support.v4.app.Fragment> {
     ...
     */
    public static class ListRowFragmentFactory extends android.support.v17.leanback.app.BrowseSupportFragment.FragmentFactory<android.support.v17.leanback.app.RowsSupportFragment> {
        @java.lang.Override
        public android.support.v17.leanback.app.RowsSupportFragment createFragment(java.lang.Object row) {
            return new android.support.v17.leanback.app.RowsSupportFragment();
        }
    }
    ...
    public static final class MainFragmentAdapterRegistry {
        private final java.util.Map<java.lang.Class, android.support.v17.leanback.app.BrowseSupportFragment.FragmentFactory> mItemToFragmentFactoryMapping = new java.util.HashMap();

        private static final android.support.v17.leanback.app.BrowseSupportFragment.FragmentFactory sDefaultFragmentFactory = new android.support.v17.leanback.app.BrowseSupportFragment.ListRowFragmentFactory();

        public MainFragmentAdapterRegistry() {
            registerFragment(android.support.v17.leanback.widget.ListRow.class, android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterRegistry.sDefaultFragmentFactory);
        }

        public void registerFragment(java.lang.Class rowClass, android.support.v17.leanback.app.BrowseSupportFragment.FragmentFactory factory) {
            mItemToFragmentFactoryMapping.put(rowClass, factory);
        }

        public android.support.v4.app.Fragment createFragment(java.lang.Object item) {
            if (item == null) {
                throw new java.lang.IllegalArgumentException("Item can't be null");
            }
            android.support.v17.leanback.app.BrowseSupportFragment.FragmentFactory fragmentFactory = mItemToFragmentFactoryMapping.get(item.getClass());
            if ((fragmentFactory == null) && (!(item instanceof android.support.v17.leanback.widget.PageRow))) {
                fragmentFactory = android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterRegistry.sDefaultFragmentFactory;
            }
            return fragmentFactory.createFragment(item);
        }
    }

    static final java.lang.String TAG = "BrowseSupportFragment";
    ...
    private android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterRegistry mMainFragmentAdapterRegistry = new android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterRegistry();

    android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter mMainFragmentAdapter;

    android.support.v4.app.Fragment mMainFragment;

    android.support.v17.leanback.app.HeadersSupportFragment mHeadersSupportFragment;

    private android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapter mMainFragmentRowsAdapter;
    ...
    private int mHeadersState = android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_ENABLED;
    ...
    private final android.support.v17.leanback.app.BrowseSupportFragment.SetSelectionRunnable mSetSelectionRunnable = new android.support.v17.leanback.app.BrowseSupportFragment.SetSelectionRunnable();
    ...
    android.support.v17.leanback.app.BrowseSupportFragment.BackStackListener mBackStackChangedListener;

    android.support.v17.leanback.app.BrowseSupportFragment.BrowseTransitionListener mBrowseTransitionListener;

    private static final java.lang.String ARG_TITLE = android.support.v17.leanback.app.BrowseSupportFragment.class.getCanonicalName() + ".title";

    private static final java.lang.String ARG_HEADERS_STATE = android.support.v17.leanback.app.BrowseSupportFragment.class.getCanonicalName() + ".headersState";
     ...
     * 		BrowseSupportFragment. Must be one of {@link #HEADERS_ENABLED}, {@link #HEADERS_HIDDEN}, or {@link #HEADERS_DISABLED}.
    ...
    public static android.os.Bundle createArgs(android.os.Bundle args, java.lang.String title, int headersState) {
        ...
        args.putString(android.support.v17.leanback.app.BrowseSupportFragment.ARG_TITLE, title);
        args.putInt(android.support.v17.leanback.app.BrowseSupportFragment.ARG_HEADERS_STATE, headersState);
        return args;
    }
    ...
    public final android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterRegistry getMainFragmentRegistry() {
    ...
    public android.support.v17.leanback.app.RowsSupportFragment getRowsSupportFragment() {
        if (mMainFragment instanceof android.support.v17.leanback.app.RowsSupportFragment) {
            return ((android.support.v17.leanback.app.RowsSupportFragment) (mMainFragment));
        }
        return null;
    }
     ...
     */
    public android.support.v17.leanback.app.HeadersSupportFragment getHeadersSupportFragment() {
     ...
     * 		begins or ends.
     */
    public void setBrowseTransitionListener(android.support.v17.leanback.app.BrowseSupportFragment.BrowseTransitionListener listener) {
            ...
            public void run() {
                ...
                if (mHeadersBackStackEnabled) {
                    if (!withHeaders) {
                        ...
                        if (index >= 0) {
                            android.support.v4.app.FragmentManager.BackStackEntry entry = getFragmentManager().getBackStackEntryAt(index);
                            getFragmentManager().popBackStackImmediate(entry.getId(), android.support.v4.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
                        }
                    }
                }
            }
    ...
    private final android.support.v17.leanback.widget.BrowseFrameLayout.OnFocusSearchListener mOnFocusSearchListener = new android.support.v17.leanback.widget.BrowseFrameLayout.OnFocusSearchListener() {
        ...
        public android.view.View onFocusSearch(android.view.View focused, int direction) {
            ...
            if (android.support.v17.leanback.app.BrowseSupportFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.BrowseSupportFragment.TAG, (("onFocusSearch focused " + focused) + " + direction ") + direction);
    ...
    private final android.support.v17.leanback.widget.BrowseFrameLayout.OnChildFocusListener mOnChildFocusListener = new android.support.v17.leanback.widget.BrowseFrameLayout.OnChildFocusListener() {
        ...
        public boolean onRequestFocusInDescendants(int direction, android.graphics.Rect previouslyFocusedRect) {
            ...
            if (mCanShowHeaders && mShowingHeaders) {
                if (((mHeadersSupportFragment != null) && (mHeadersSupportFragment.getView() != null)) && mHeadersSupportFragment.getView().requestFocus(direction, previouslyFocusedRect)) {
                    return true;
                }
            }
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        outState.putInt(android.support.v17.leanback.app.BrowseSupportFragment.CURRENT_SELECTED_POSITION, mSelectedPosition);
        outState.putBoolean(android.support.v17.leanback.app.BrowseSupportFragment.IS_PAGE_ROW, mIsPageRow);
        if (mBackStackChangedListener != null) {
            mBackStackChangedListener.save(outState);
        } else {
            outState.putBoolean(android.support.v17.leanback.app.BrowseSupportFragment.HEADER_SHOW, mShowingHeaders);
        }
    }
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        if (mCanShowHeaders) {
            if (mHeadersBackStackEnabled) {
                mWithHeadersBackStackName = android.support.v17.leanback.app.BrowseSupportFragment.LB_HEADERS_BACKSTACK + this;
                mBackStackChangedListener = new android.support.v17.leanback.app.BrowseSupportFragment.BackStackListener();
                getFragmentManager().addOnBackStackChangedListener(mBackStackChangedListener);
                mBackStackChangedListener.load(savedInstanceState);
            } else {
                if (savedInstanceState != null) {
                    mShowingHeaders = savedInstanceState.getBoolean(android.support.v17.leanback.app.BrowseSupportFragment.HEADER_SHOW);
                }
            }
        }
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        if (getChildFragmentManager().findFragmentById(R.id.scale_frame) == null) {
            mHeadersSupportFragment = new android.support.v17.leanback.app.HeadersSupportFragment();
            createMainFragment(mAdapter, mSelectedPosition);
            android.support.v4.app.FragmentTransaction ft = getChildFragmentManager().beginTransaction().replace(R.id.browse_headers_dock, mHeadersSupportFragment);
            if (mMainFragment != null) {
                ...
                mMainFragmentAdapter = new android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter(null);
                mMainFragmentAdapter.setFragmentHost(new android.support.v17.leanback.app.BrowseSupportFragment.FragmentHostImpl());
            }
            ft.commit();
        } else {
            mHeadersSupportFragment = ((android.support.v17.leanback.app.HeadersSupportFragment) (getChildFragmentManager().findFragmentById(R.id.browse_headers_dock)));
            mMainFragment = getChildFragmentManager().findFragmentById(R.id.scale_frame);
            mMainFragmentAdapter = ((android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapterProvider) (mMainFragment)).getMainFragmentAdapter();
            mMainFragmentAdapter.setFragmentHost(new android.support.v17.leanback.app.BrowseSupportFragment.FragmentHostImpl());
            mIsPageRow = (savedInstanceState != null) && savedInstanceState.getBoolean(android.support.v17.leanback.app.BrowseSupportFragment.IS_PAGE_ROW, false);
            mSelectedPosition = (savedInstanceState != null) ? savedInstanceState.getInt(android.support.v17.leanback.app.BrowseSupportFragment.CURRENT_SELECTED_POSITION, 0) : 0;
            if (!mIsPageRow) {
                if (mMainFragment instanceof android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapterProvider) {
                    mMainFragmentRowsAdapter = ((android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapterProvider) (mMainFragment)).getMainFragmentRowsAdapter();
                } else {
    ...
    private void setupMainFragment() {
        if (mMainFragmentRowsAdapter != null) {
            ...
            mMainFragmentRowsAdapter.setOnItemViewSelectedListener(new android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentItemViewSelectedListener(mMainFragmentRowsAdapter));
        ...
        android.support.v17.leanback.transition.TransitionHelper.addTransitionListener(mHeadersTransition, new android.support.v17.leanback.transition.TransitionListener() {
            ...
            public void onTransitionEnd(java.lang.Object transition) {
                ...
                if (mHeadersSupportFragment != null) {
                    ...
                    if (mShowingHeaders) {
                        android.support.v17.leanback.widget.VerticalGridView headerGridView = mHeadersSupportFragment.getVerticalGridView();
    ...
    void showHeaders(boolean show) {
        if (android.support.v17.leanback.app.BrowseSupportFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "showHeaders " + show);
    ...
    private android.support.v17.leanback.app.HeadersSupportFragment.OnHeaderClickedListener mHeaderClickedListener = new android.support.v17.leanback.app.HeadersSupportFragment.OnHeaderClickedListener() {
        @java.lang.Override
    ...
    class MainFragmentItemViewSelectedListener implements android.support.v17.leanback.widget.OnItemViewSelectedListener {
        android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapter mMainFragmentRowsAdapter;

        public MainFragmentItemViewSelectedListener(android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentRowsAdapter fragmentRowsAdapter) {
        ...
        public void onItemSelected(android.support.v17.leanback.widget.Presenter.ViewHolder itemViewHolder, java.lang.Object item, android.support.v17.leanback.widget.RowPresenter.ViewHolder rowViewHolder, android.support.v17.leanback.widget.Row row) {
            ...
            if (android.support.v17.leanback.app.BrowseSupportFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "row selected position " + position);
    ...
    private android.support.v17.leanback.app.HeadersSupportFragment.OnHeaderViewSelectedListener mHeaderViewSelectedListener = new android.support.v17.leanback.app.HeadersSupportFragment.OnHeaderViewSelectedListener() {
        @java.lang.Override
        public void onHeaderSelected(android.support.v17.leanback.widget.RowHeaderPresenter.ViewHolder viewHolder, android.support.v17.leanback.widget.Row row) {
            ...
            if (android.support.v17.leanback.app.BrowseSupportFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "header selected position " + position);
    ...
    void onRowSelected(int position) {
        if (position != mSelectedPosition) {
            mSetSelectionRunnable.post(position, android.support.v17.leanback.app.BrowseSupportFragment.SetSelectionRunnable.TYPE_INTERNAL_SYNC, true);
        }
    }
    ...
    private void swapToMainFragment() {
        final android.support.v17.leanback.widget.VerticalGridView gridView = mHeadersSupportFragment.getVerticalGridView();
        if ((isShowingHeaders() && (gridView != null)) && (gridView.getScrollState() != android.support.v7.widget.RecyclerView.SCROLL_STATE_IDLE)) {
            ...
            // finishes.
            getChildFragmentManager().beginTransaction().replace(R.id.scale_frame, new android.support.v4.app.Fragment()).commit();
            gridView.addOnScrollListener(new android.support.v7.widget.RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(android.support.v7.widget.RecyclerView recyclerView, int newState) {
                    if (newState == android.support.v7.widget.RecyclerView.SCROLL_STATE_IDLE) {
                        ...
                        android.support.v4.app.Fragment currentFragment = fm.findFragmentById(R.id.scale_frame);
    ...
    public void setSelectedPosition(int position, boolean smooth) {
        mSetSelectionRunnable.post(position, android.support.v17.leanback.app.BrowseSupportFragment.SetSelectionRunnable.TYPE_USER_REQUEST, smooth);
    }
    ...
    private void onExpandTransitionStart(boolean expand, final java.lang.Runnable callback) {
        ...
        new android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout(callback, mMainFragmentAdapter, getView()).execute();
    }
    ...
    private void readArguments(android.os.Bundle args) {
        ...
        if (args.containsKey(android.support.v17.leanback.app.BrowseSupportFragment.ARG_TITLE)) {
            setTitle(args.getString(android.support.v17.leanback.app.BrowseSupportFragment.ARG_TITLE));
        }
        if (args.containsKey(android.support.v17.leanback.app.BrowseSupportFragment.ARG_HEADERS_STATE)) {
            setHeadersState(args.getInt(android.support.v17.leanback.app.BrowseSupportFragment.ARG_HEADERS_STATE));
        }
    }
    ...
    public void setHeadersState(int headersState) {
        if ((headersState < android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_ENABLED) || (headersState > android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_DISABLED)) {
            throw new java.lang.IllegalArgumentException("Invalid headers state: " + headersState);
        }
        if (android.support.v17.leanback.app.BrowseSupportFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "setHeadersState " + headersState);

        if (headersState != mHeadersState) {
            mHeadersState = headersState;
            switch (headersState) {
                case android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_ENABLED :
                    mCanShowHeaders = true;
                    mShowingHeaders = true;
                    break;
                case android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_HIDDEN :
                    mCanShowHeaders = true;
                    mShowingHeaders = false;
                    break;
                case android.support.v17.leanback.app.BrowseSupportFragment.HEADERS_DISABLED :
                    mCanShowHeaders = false;
                    mShowingHeaders = false;
                    break;
                default :
                    android.util.Log.w(android.support.v17.leanback.app.BrowseSupportFragment.TAG, "Unknown headers state: " + headersState);
                    break;
            }
            if (mHeadersSupportFragment != null) {
                mHeadersSupportFragment.setHeadersGone(!mCanShowHeaders);
    ...
    private class ExpandPreLayout implements android.view.ViewTreeObserver.OnPreDrawListener {
        ...
        private android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter mainFragmentAdapter;
        ...
        ExpandPreLayout(java.lang.Runnable callback, android.support.v17.leanback.app.BrowseSupportFragment.MainFragmentAdapter adapter, android.view.View view) {
            mView = view;
            mCallback = callback;
        ...
        void execute() {
            ...
            mView.invalidate();
            mState = android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout.STATE_INIT;
        }
        ...
        public boolean onPreDraw() {
            ...
            if (mState == android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout.STATE_INIT) {
                mainFragmentAdapter.setExpand(true);
                // always trigger onPreDraw even adapter setExpand() does nothing.
                mView.invalidate();
                mState = android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout.STATE_FIRST_DRAW;
            } else
                if (mState == android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout.STATE_FIRST_DRAW) {
                    mCallback.run();
                    mView.getViewTreeObserver().removeOnPreDrawListener(this);
                    mState = android.support.v17.leanback.app.BrowseSupportFragment.ExpandPreLayout.STATE_SECOND_DRAW;
                }
