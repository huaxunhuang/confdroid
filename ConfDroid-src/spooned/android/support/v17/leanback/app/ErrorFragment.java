...
public class ErrorFragment extends android.support.v17.leanback.app.BrandedFragment {
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        ...
        updateButton();
        android.graphics.Paint.FontMetricsInt metrics = android.support.v17.leanback.app.ErrorFragment.getFontMetricsInt(mTextView);
        int underImageBaselineMargin = container.getResources().getDimensionPixelSize(R.dimen.lb_error_under_image_baseline_margin);
        android.support.v17.leanback.app.ErrorFragment.setTopMargin(mTextView, underImageBaselineMargin + metrics.ascent);
        ...
        android.support.v17.leanback.app.ErrorFragment.setTopMargin(mButton, underMessageBaselineMargin - metrics.descent);
        return root;
    }
