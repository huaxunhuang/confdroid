...
public abstract class PlaybackControlGlue implements android.support.v17.leanback.widget.OnActionClickedListener , android.view.View.OnKeyListener {
    ...
    static final java.lang.String TAG = "PlaybackControlGlue";
    ...
    private static final int NUMBER_OF_SEEK_SPEEDS = (android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L4 - android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0) + 1;

    private final android.support.v17.leanback.app.PlaybackOverlayFragment mFragment;
    ...
    private int mPlaybackSpeed = android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL;
    ...
    static class UpdatePlaybackStateHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            if (msg.what == android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE) {
                android.support.v17.leanback.app.PlaybackControlGlue glue = ((java.lang.ref.WeakReference<android.support.v17.leanback.app.PlaybackControlGlue>) (msg.obj)).get();
                if (glue != null) {
    ...
    static final android.os.Handler sHandler = new android.support.v17.leanback.app.PlaybackControlGlue.UpdatePlaybackStateHandler();

    final java.lang.ref.WeakReference<android.support.v17.leanback.app.PlaybackControlGlue> mGlueWeakReference = new java.lang.ref.WeakReference(this);
    ...
    private final android.support.v17.leanback.widget.OnItemViewClickedListener mOnItemViewClickedListener = new android.support.v17.leanback.widget.OnItemViewClickedListener() {
        ...
        public void onItemClicked(android.support.v17.leanback.widget.Presenter.ViewHolder viewHolder, java.lang.Object object, android.support.v17.leanback.widget.RowPresenter.ViewHolder viewHolder2, android.support.v17.leanback.widget.Row row) {
            if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "onItemClicked " + object);
     ...
     */
    public PlaybackControlGlue(android.content.Context context, int[] seekSpeeds) {
     ...
     */
    public PlaybackControlGlue(android.content.Context context, int[] fastForwardSpeeds, int[] rewindSpeeds) {
     ...
     * 		
     * @param fragment
     * 		Optional; if using a {@link PlaybackOverlayFragment}, pass it in.
     * @param seekSpeeds
     * 		Array of seek speeds for fast forward and rewind.
     */
    public PlaybackControlGlue(android.content.Context context, android.support.v17.leanback.app.PlaybackOverlayFragment fragment, int[] seekSpeeds) {
     ...
     * 		Array of seek speeds for rewind.
     */
    public PlaybackControlGlue(android.content.Context context, android.support.v17.leanback.app.PlaybackOverlayFragment fragment, int[] fastForwardSpeeds, int[] rewindSpeeds) {
        mContext = context;
        mFragment = fragment;
        if (fragment != null) {
            attachToFragment();
        }
        if ((fastForwardSpeeds.length == 0) || (fastForwardSpeeds.length > android.support.v17.leanback.app.PlaybackControlGlue.NUMBER_OF_SEEK_SPEEDS)) {
            throw new java.lang.IllegalStateException("invalid fastForwardSpeeds array size");
        }
        mFastForwardSpeeds = fastForwardSpeeds;
        if ((rewindSpeeds.length == 0) || (rewindSpeeds.length > android.support.v17.leanback.app.PlaybackControlGlue.NUMBER_OF_SEEK_SPEEDS)) {
            throw new java.lang.IllegalStateException("invalid rewindSpeeds array size");
        }
        mRewindSpeeds = rewindSpeeds;
    }

    private final android.support.v17.leanback.app.PlaybackOverlayFragment.InputEventHandler mOnInputEventHandler = new android.support.v17.leanback.app.PlaybackOverlayFragment.InputEventHandler() {
        @java.lang.Override
    ...
    public android.support.v17.leanback.widget.PlaybackControlsRowPresenter createControlsRowAndPresenter() {
        ...
        android.support.v17.leanback.widget.AbstractDetailsDescriptionPresenter detailsPresenter = new android.support.v17.leanback.widget.AbstractDetailsDescriptionPresenter() {
            ...
            protected void onBindDescription(android.support.v17.leanback.widget.AbstractDetailsDescriptionPresenter.ViewHolder viewHolder, java.lang.Object object) {
                android.support.v17.leanback.app.PlaybackControlGlue glue = ((android.support.v17.leanback.app.PlaybackControlGlue) (object));
        ...
        return new android.support.v17.leanback.widget.PlaybackControlsRowPresenter(detailsPresenter) {
            ...
            protected void onBindRowViewHolder(android.support.v17.leanback.widget.RowPresenter.ViewHolder vh, java.lang.Object item) {
                ...
                vh.setOnKeyListener(android.support.v17.leanback.app.PlaybackControlGlue.this);
            }
     ...
     */
    public android.support.v17.leanback.app.PlaybackOverlayFragment getFragment() {
        return mFragment;
    }
    ...
    public void updateProgress() {
        ...
        if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "updateProgress " + position);
    ...
    public boolean onKey(android.view.View v, int keyCode, android.view.KeyEvent event) {
        switch (keyCode) {
            ...
            case android.view.KeyEvent.KEYCODE_ESCAPE :
                boolean abortSeek = (mPlaybackSpeed >= android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0) || (mPlaybackSpeed <= (-android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0));
                if (abortSeek) {
                    mPlaybackSpeed = android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL;
        ...
        if (action != null) {
            if (((((action == mPrimaryActionsAdapter.lookup(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_PLAY_PAUSE)) || (action == mPrimaryActionsAdapter.lookup(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_REWIND))) || (action == mPrimaryActionsAdapter.lookup(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_FAST_FORWARD))) || (action == mPrimaryActionsAdapter.lookup(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_PREVIOUS))) || (action == mPrimaryActionsAdapter.lookup(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_NEXT))) {
    ...
    boolean dispatchAction(android.support.v17.leanback.widget.Action action, android.view.KeyEvent keyEvent) {
        ...
        if (action == mPlayPauseAction) {
            ...
            if (canPause && (canPlay ? mPlaybackSpeed == android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL : mPlaybackSpeed != android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_PAUSED)) {
                mPlaybackSpeed = android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_PAUSED;
                pausePlayback();
            } else
                if (canPlay && (mPlaybackSpeed != android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL)) {
                    mPlaybackSpeed = android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL;
                    startPlayback(mPlaybackSpeed);
                }
                    ...
                    if (action == mFastForwardAction) {
                        if (mPlaybackSpeed < getMaxForwardSpeedId()) {
                            switch (mPlaybackSpeed) {
                                case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0 :
                                case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L1 :
                                case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L2 :
                                case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L3 :
                                    mPlaybackSpeed++;
                                    break;
                                default :
                                    mPlaybackSpeed = android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0;
                                    break;
                            }
                            startPlayback(mPlaybackSpeed);
                            updatePlaybackStatusAfterUserAction();
    ...
    private int getMaxForwardSpeedId() {
        return android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0 + (mFastForwardSpeeds.length - 1);
    }

    private int getMaxRewindSpeedId() {
        return android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0 + (mRewindSpeeds.length - 1);
    }

    private void updateControlsRow() {
        updateRowMetadata();
        android.support.v17.leanback.app.PlaybackControlGlue.sHandler.removeMessages(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference);
        updatePlaybackState();
    }
    ...
    private void updatePlaybackStatusAfterUserAction() {
        ...
        android.support.v17.leanback.app.PlaybackControlGlue.sHandler.removeMessages(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference);
        android.support.v17.leanback.app.PlaybackControlGlue.sHandler.sendMessageDelayed(android.support.v17.leanback.app.PlaybackControlGlue.sHandler.obtainMessage(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference), android.support.v17.leanback.app.PlaybackControlGlue.UPDATE_PLAYBACK_STATE_DELAY_MS);
    }
    ...
    private void updateRowMetadata() {
        ...
        if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "updateRowMetadata hasValidMedia " + hasValidMedia());
    ...
    private void updatePlaybackState(int playbackSpeed) {
        ...
        if ((actions & android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_PREVIOUS) != 0) {
            ...
            mPrimaryActionsAdapter.set(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_PREVIOUS, mSkipPreviousAction);
        } else {
            mPrimaryActionsAdapter.clear(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_PREVIOUS);
            mSkipPreviousAction = null;
        }
        if ((actions & android.support.v17.leanback.app.PlaybackControlGlue.ACTION_REWIND) != 0) {
            ...
            mPrimaryActionsAdapter.set(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_REWIND, mRewindAction);
        } else {
            mPrimaryActionsAdapter.clear(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_REWIND);
            mRewindAction = null;
        }
        if ((actions & android.support.v17.leanback.app.PlaybackControlGlue.ACTION_PLAY_PAUSE) != 0) {
            if (mPlayPauseAction == null) {
                mPlayPauseAction = new android.support.v17.leanback.widget.PlaybackControlsRow.PlayPauseAction(mContext);
            }
            mPrimaryActionsAdapter.set(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_PLAY_PAUSE, mPlayPauseAction);
        } else {
            mPrimaryActionsAdapter.clear(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_PLAY_PAUSE);
            mPlayPauseAction = null;
        }
        if ((actions & android.support.v17.leanback.app.PlaybackControlGlue.ACTION_FAST_FORWARD) != 0) {
            ...
            mPrimaryActionsAdapter.set(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_FAST_FORWARD, mFastForwardAction);
        } else {
            mPrimaryActionsAdapter.clear(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_FAST_FORWARD);
            mFastForwardAction = null;
        }
        if ((actions & android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_NEXT) != 0) {
            ...
            mPrimaryActionsAdapter.set(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_NEXT, mSkipNextAction);
        } else {
            mPrimaryActionsAdapter.clear(android.support.v17.leanback.app.PlaybackControlGlue.ACTION_SKIP_TO_NEXT);
            mSkipNextAction = null;
        }
        if (mFastForwardAction != null) {
            int index = 0;
            if (playbackSpeed >= android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0) {
                index = (playbackSpeed - android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L0) + 1;
            }
            if (mFastForwardAction.getIndex() != index) {
                mFastForwardAction.setIndex(index);
                android.support.v17.leanback.app.PlaybackControlGlue.notifyItemChanged(mPrimaryActionsAdapter, mFastForwardAction);
            }
        }
        if (mRewindAction != null) {
            int index = 0;
            ...
            if (mRewindAction.getIndex() != index) {
                ...
                android.support.v17.leanback.app.PlaybackControlGlue.notifyItemChanged(mPrimaryActionsAdapter, mRewindAction);
            }
        }
        if (playbackSpeed == android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_PAUSED) {
            updateProgress();
        ...
        if (mFadeWhenPlaying && (mFragment != null)) {
            mFragment.setFadingEnabled(playbackSpeed == android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL);
        }
        if (mPlayPauseAction != null) {
            int index = (playbackSpeed == android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_PAUSED) ? android.support.v17.leanback.widget.PlaybackControlsRow.PlayPauseAction.PLAY : android.support.v17.leanback.widget.PlaybackControlsRow.PlayPauseAction.PAUSE;
            if (mPlayPauseAction.getIndex() != index) {
                mPlayPauseAction.setIndex(index);
                android.support.v17.leanback.app.PlaybackControlGlue.notifyItemChanged(mPrimaryActionsAdapter, mPlayPauseAction);
            }
        }
    }
    ...
    private static java.lang.String getSpeedString(int speed) {
        switch (speed) {
            case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_INVALID :
                return "PLAYBACK_SPEED_INVALID";
            case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_PAUSED :
                return "PLAYBACK_SPEED_PAUSED";
            case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_NORMAL :
            ...
            case android.support.v17.leanback.app.PlaybackControlGlue.PLAYBACK_SPEED_FAST_L4 :
    ...
    protected void onStateChanged() {
        if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "onStateChanged");
        ...
        if (android.support.v17.leanback.app.PlaybackControlGlue.sHandler.hasMessages(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference)) {
            android.support.v17.leanback.app.PlaybackControlGlue.sHandler.removeMessages(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference);
            if (getCurrentSpeedId() != mPlaybackSpeed) {
                if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "Status expectation mismatch, delaying update");

                android.support.v17.leanback.app.PlaybackControlGlue.sHandler.sendMessageDelayed(android.support.v17.leanback.app.PlaybackControlGlue.sHandler.obtainMessage(android.support.v17.leanback.app.PlaybackControlGlue.MSG_UPDATE_PLAYBACK_STATE, mGlueWeakReference), android.support.v17.leanback.app.PlaybackControlGlue.UPDATE_PLAYBACK_STATE_DELAY_MS);
            } else {
                if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "Update state matches expectation");
    ...
    protected void onMetadataChanged() {
        if (android.support.v17.leanback.app.PlaybackControlGlue.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.PlaybackControlGlue.TAG, "onMetadataChanged");
