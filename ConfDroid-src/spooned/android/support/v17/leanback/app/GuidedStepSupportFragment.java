 ...
 * <p>
 * GuidedStepSupportFragment delegates its visual styling to classes called stylists. The {@link GuidanceStylist} is responsible for the left guidance view, while the {@link GuidedActionsStylist} is responsible for the right actions view. The stylists use theme
 ...
 * <li>Finally, custom subclasses of GuidedStepSupportFragment may provide a theme through the {@link #onProvideTheme} method. This can be useful if a subclass is used across multiple
 * Activities.</li>
 * </ul>
 * <p>
 ...
 * provided to the GuidedStepSupportFragment through the {@link #onCreateGuidanceStylist} and {@link #onCreateActionsStylist} methods.  The stylists have simple hooks so that subclasses
 ...
 */
public class GuidedStepSupportFragment extends android.support.v4.app.Fragment implements android.support.v17.leanback.widget.GuidedActionAdapter.FocusListener {
    private static final java.lang.String TAG_LEAN_BACK_ACTIONS_FRAGMENT = "leanBackGuidedStepSupportFragment";
    ...
    private static final java.lang.String TAG = "GuidedStepSupportFragment";
    ...
    private int entranceTransitionType = android.support.v17.leanback.app.GuidedStepSupportFragment.SLIDE_FROM_SIDE;
     ...
     */
    public static int add(android.support.v4.app.FragmentManager fragmentManager, android.support.v17.leanback.app.GuidedStepSupportFragment fragment) {
        return android.support.v17.leanback.app.GuidedStepSupportFragment.add(fragmentManager, fragment, android.R.id.content);
    }
     ...
     * @return The ID returned by the call FragmentTransaction.commit.
     */
    public static int add(android.support.v4.app.FragmentManager fragmentManager, android.support.v17.leanback.app.GuidedStepSupportFragment fragment, int id) {
        android.support.v17.leanback.app.GuidedStepSupportFragment current = android.support.v17.leanback.app.GuidedStepSupportFragment.getCurrentGuidedStepSupportFragment(fragmentManager);
        boolean inGuidedStep = current != null;
        if (((android.support.v17.leanback.app.GuidedStepSupportFragment.IS_FRAMEWORK_FRAGMENT && (android.os.Build.VERSION.SDK_INT >= 21)) && (android.os.Build.VERSION.SDK_INT < 23)) && (!inGuidedStep)) {
            // workaround b/22631964 for framework fragment
            fragmentManager.beginTransaction().replace(id, new android.support.v17.leanback.app.GuidedStepSupportFragment.DummyFragment(), android.support.v17.leanback.app.GuidedStepSupportFragment.TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
        }
        android.support.v4.app.FragmentTransaction ft = fragmentManager.beginTransaction();
        fragment.setUiStyle(inGuidedStep ? android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_REPLACE : android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE);
        ft.addToBackStack(fragment.generateStackEntryName());
        if (current != null) {
            fragment.onAddSharedElementTransition(ft, current);
        }
        return ft.replace(id, fragment, android.support.v17.leanback.app.GuidedStepSupportFragment.TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
    }
     ...
     */
    protected void onAddSharedElementTransition(android.support.v4.app.FragmentTransaction ft, android.support.v17.leanback.app.GuidedStepSupportFragment disappearing) {
        android.view.View fragmentView = disappearing.getView();
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.action_fragment_root), "action_fragment_root");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.action_fragment_background), "action_fragment_background");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.action_fragment), "action_fragment");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_root), "guidedactions_root");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_content), "guidedactions_content");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_list_background), "guidedactions_list_background");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_root2), "guidedactions_root2");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_content2), "guidedactions_content2");
        android.support.v17.leanback.app.GuidedStepSupportFragment.addNonNullSharedElementTransition(ft, fragmentView.findViewById(R.id.guidedactions_list_background2), "guidedactions_list_background2");
    }

    private static void addNonNullSharedElementTransition(android.support.v4.app.FragmentTransaction ft, android.view.View subView, java.lang.String transitionName) {
        if (subView != null)
    ...
    java.lang.String generateStackEntryName() {
        return android.support.v17.leanback.app.GuidedStepSupportFragment.generateStackEntryName(getUiStyle(), getClass());
    }
    ...
    static java.lang.String generateStackEntryName(int uiStyle, java.lang.Class guidedStepFragmentClass) {
        if (!android.support.v17.leanback.app.GuidedStepSupportFragment.class.isAssignableFrom(guidedStepFragmentClass)) {
            return "";
        }
        switch (uiStyle) {
            case android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_REPLACE :
                return android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_REPLACE + guidedStepFragmentClass.getName();
            case android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE :
                return android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_ENTRANCE + guidedStepFragmentClass.getName();
            case android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ACTIVITY_ROOT :
            default :
                return "";
        }
    }
    ...
    static boolean isStackEntryUiStyleEntrance(java.lang.String backStackEntryName) {
        return (backStackEntryName != null) && backStackEntryName.startsWith(android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_ENTRANCE);
    }
     ...
     */
    static java.lang.String getGuidedStepSupportFragmentClassName(java.lang.String backStackEntryName) {
        if (backStackEntryName.startsWith(android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_REPLACE)) {
            return backStackEntryName.substring(android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_REPLACE.length());
        } else
            if (backStackEntryName.startsWith(android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_ENTRANCE)) {
                return backStackEntryName.substring(android.support.v17.leanback.app.GuidedStepSupportFragment.ENTRY_NAME_ENTRANCE.length());
            } else {
                return "";
            }
     ...
     */
    public static int addAsRoot(android.support.v4.app.FragmentActivity activity, android.support.v17.leanback.app.GuidedStepSupportFragment fragment, int id) {
        // Workaround b/23764120: call getDecorView() to force requestFeature of ActivityTransition.
        activity.getWindow().getDecorView();
        android.support.v4.app.FragmentManager fragmentManager = activity.getSupportFragmentManager();
        if (fragmentManager.findFragmentByTag(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG_LEAN_BACK_ACTIONS_FRAGMENT) != null) {
            android.util.Log.w(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "Fragment is already exists, likely calling " + "addAsRoot() when savedInstanceState is not null in Activity.onCreate().");
            return -1;
        }
        android.support.v4.app.FragmentTransaction ft = fragmentManager.beginTransaction();
        fragment.setUiStyle(android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ACTIVITY_ROOT);
        return ft.replace(id, fragment, android.support.v17.leanback.app.GuidedStepSupportFragment.TAG_LEAN_BACK_ACTIONS_FRAGMENT).commit();
    }
     ...
     */
    public static android.support.v17.leanback.app.GuidedStepSupportFragment getCurrentGuidedStepSupportFragment(android.support.v4.app.FragmentManager fm) {
        android.support.v4.app.Fragment f = fm.findFragmentByTag(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG_LEAN_BACK_ACTIONS_FRAGMENT);
        if (f instanceof android.support.v17.leanback.app.GuidedStepSupportFragment) {
            return ((android.support.v17.leanback.app.GuidedStepSupportFragment) (f));
        }
        return null;
    }
    ...
    protected void onProvideFragmentTransitions() {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            ...
            if (uiStyle == android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_REPLACE) {
                ...
                if (uiStyle == android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE) {
                    if (entranceTransitionType == android.support.v17.leanback.app.GuidedStepSupportFragment.SLIDE_FROM_SIDE) {
                        java.lang.Object fade = android.support.v17.leanback.transition.TransitionHelper.createFadeTransition(android.support.v17.leanback.transition.TransitionHelper.FADE_IN | android.support.v17.leanback.transition.TransitionHelper.FADE_OUT);
                    ...
                    if (uiStyle == android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ACTIVITY_ROOT) {
    ...
    public void setUiStyle(int style) {
        ...
        arguments.putInt(android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_UI_STYLE, style);
    ...
    public int getUiStyle() {
        ...
        if (b == null)
            return android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE;

        return b.getInt(android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_UI_STYLE, android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE);
    }
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        if (android.support.v17.leanback.app.GuidedStepSupportFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "onCreate");
        ...
        if (state != null) {
            if (mSelectedIndex == (-1)) {
                mSelectedIndex = state.getInt(android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_ACTION_SELECTED_INDEX, -1);
            }
        }
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        if (android.support.v17.leanback.app.GuidedStepSupportFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "onCreateView");
        ...
        android.support.v17.leanback.widget.GuidedActionAdapter.EditListener editListener = new android.support.v17.leanback.widget.GuidedActionAdapter.EditListener() {
            ...
            @java.lang.Override
            public long onGuidedActionEditedAndProceed(android.support.v17.leanback.widget.GuidedAction action) {
                return android.support.v17.leanback.app.GuidedStepSupportFragment.this.onGuidedActionEditedAndProceed(action);
            }

            @java.lang.Override
            public void onGuidedActionEditCanceled(android.support.v17.leanback.widget.GuidedAction action) {
                android.support.v17.leanback.app.GuidedStepSupportFragment.this.onGuidedActionEditCanceled(action);
            }
        };
        mAdapter = new android.support.v17.leanback.widget.GuidedActionAdapter(mActions, new android.support.v17.leanback.widget.GuidedActionAdapter.ClickListener() {
            @java.lang.Override
            public void onGuidedActionClicked(android.support.v17.leanback.widget.GuidedAction action) {
                android.support.v17.leanback.app.GuidedStepSupportFragment.this.onGuidedActionClicked(action);
        ...
        mSubAdapter = new android.support.v17.leanback.widget.GuidedActionAdapter(null, new android.support.v17.leanback.widget.GuidedActionAdapter.ClickListener() {
            ...
            public void onGuidedActionClicked(android.support.v17.leanback.widget.GuidedAction action) {
                ...
                if (android.support.v17.leanback.app.GuidedStepSupportFragment.this.onSubGuidedActionClicked(action)) {
                    collapseSubActions();
                }
            }
    ...
    final java.lang.String getAutoRestoreKey(android.support.v17.leanback.widget.GuidedAction action) {
        return android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_ACTION_PREFIX + action.getId();
    }
    ...
    final java.lang.String getButtonAutoRestoreKey(android.support.v17.leanback.widget.GuidedAction action) {
        return android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_BUTTON_ACTION_PREFIX + action.getId();
    }
    ...
    final void onRestoreActions(java.util.List<android.support.v17.leanback.widget.GuidedAction> actions, android.os.Bundle savedInstanceState) {
        for (int i = 0, size = actions.size(); i < size; i++) {
            ...
            if (android.support.v17.leanback.app.GuidedStepSupportFragment.isSaveEnabled(action)) {
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        outState.putInt(android.support.v17.leanback.app.GuidedStepSupportFragment.EXTRA_ACTION_SELECTED_INDEX, mActionsStylist.getActionsGridView() != null ? getSelectedActionPosition() : mSelectedIndex);
    }
    ...
    private static boolean isGuidedStepTheme(android.content.Context context) {
        ...
        if (android.support.v17.leanback.app.GuidedStepSupportFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "Found guided step theme flag? " + found);
    ...
    public void finishGuidedStepSupportFragments() {
        ...
        if (entryCount > 0) {
            for (int i = entryCount - 1; i >= 0; i--) {
                android.support.v4.app.FragmentManager.BackStackEntry entry = fragmentManager.getBackStackEntryAt(i);
                if (android.support.v17.leanback.app.GuidedStepSupportFragment.isStackEntryUiStyleEntrance(entry.getName())) {
                    android.support.v17.leanback.app.GuidedStepSupportFragment top = android.support.v17.leanback.app.GuidedStepSupportFragment.getCurrentGuidedStepSupportFragment(fragmentManager);
                    if (top != null) {
                        top.setUiStyle(android.support.v17.leanback.app.GuidedStepSupportFragment.UI_STYLE_ENTRANCE);
                    }
                    fragmentManager.popBackStack(entry.getId(), android.support.v4.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
                    return;
                }
            }
        }
     ...
     */
    public void popBackStackToGuidedStepSupportFragment(java.lang.Class guidedStepFragmentClass, int flags) {
        if (!android.support.v17.leanback.app.GuidedStepSupportFragment.class.isAssignableFrom(guidedStepFragmentClass)) {
            return;
        }
        final android.support.v4.app.FragmentManager fragmentManager = getFragmentManager();
        ...
        if (entryCount > 0) {
            for (int i = entryCount - 1; i >= 0; i--) {
                android.support.v4.app.FragmentManager.BackStackEntry entry = fragmentManager.getBackStackEntryAt(i);
                java.lang.String entryClassName = android.support.v17.leanback.app.GuidedStepSupportFragment.getGuidedStepSupportFragmentClassName(entry.getName());
    ...
    private void resolveTheme() {
        ...
        if ((theme == (-1)) && (!android.support.v17.leanback.app.GuidedStepSupportFragment.isGuidedStepTheme(activity))) {
            ...
            if (android.support.v17.leanback.app.GuidedStepSupportFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "Found guided step theme reference? " + found);

            if (found) {
                android.view.ContextThemeWrapper themeWrapper = new android.view.ContextThemeWrapper(activity, typedValue.resourceId);
                if (android.support.v17.leanback.app.GuidedStepSupportFragment.isGuidedStepTheme(themeWrapper)) {
            ...
            if (!found) {
                android.util.Log.e(android.support.v17.leanback.app.GuidedStepSupportFragment.TAG, "GuidedStepSupportFragment does not have an appropriate theme set.");
            }
        } else
            if (theme != (-1)) {
