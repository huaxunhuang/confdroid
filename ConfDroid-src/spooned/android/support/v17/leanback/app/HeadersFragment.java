...
public class HeadersFragment extends android.support.v17.leanback.app.BaseRowFragment {
    ...
    private android.support.v17.leanback.app.HeadersFragment.OnHeaderViewSelectedListener mOnHeaderViewSelectedListener;

    android.support.v17.leanback.app.HeadersFragment.OnHeaderClickedListener mOnHeaderClickedListener;
    ...
    public HeadersFragment() {
        setPresenterSelector(android.support.v17.leanback.app.HeadersFragment.sHeaderPresenter);
    }
    ...
    public void setOnHeaderViewSelectedListener(android.support.v17.leanback.app.HeadersFragment.OnHeaderViewSelectedListener listener) {
    ...
    private final android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener mAdapterListener = new android.support.v17.leanback.widget.ItemBridgeAdapter.AdapterListener() {
        ...
        public void onCreate(final android.support.v17.leanback.widget.ItemBridgeAdapter.ViewHolder viewHolder) {
            ...
            if (mWrapper != null) {
                viewHolder.itemView.addOnLayoutChangeListener(android.support.v17.leanback.app.HeadersFragment.sLayoutChangeListener);
            } else {
                headerView.addOnLayoutChangeListener(android.support.v17.leanback.app.HeadersFragment.sLayoutChangeListener);
            }
        }
    };
    ...
    final android.support.v17.leanback.widget.ItemBridgeAdapter.Wrapper mWrapper = new android.support.v17.leanback.widget.ItemBridgeAdapter.Wrapper() {
        ...
        public android.view.View createWrapper(android.view.View root) {
            return new android.support.v17.leanback.app.HeadersFragment.NoOverlappingFrameLayout(root.getContext());
        }
    };
