 ...
 * @unknown 
 */
class BaseSupportFragment extends android.support.v17.leanback.app.BrandedSupportFragment {
    /**
     * Condition: {@link TransitionHelper#systemSupportsEntranceTransitions()} is true
     * Action: none
     */
    private final android.support.v17.leanback.util.StateMachine.State STATE_ALLOWED = new android.support.v17.leanback.util.StateMachine.State() {
        @java.lang.Override
        public boolean canRun() {
            return android.support.v17.leanback.transition.TransitionHelper.systemSupportsEntranceTransitions();
        }
     ...
     */
    private final android.support.v17.leanback.util.StateMachine.State STATE_PREPARE = new android.support.v17.leanback.util.StateMachine.State() {
        @java.lang.Override
        public boolean canRun() {
     ...
     */
    private final android.support.v17.leanback.util.StateMachine.State STATE_START = new android.support.v17.leanback.util.StateMachine.State() {
        @java.lang.Override
        public boolean canRun() {
    ...
    final android.support.v17.leanback.util.StateMachine mEnterTransitionStates;

    java.lang.Object mEntranceTransition;

    final android.support.v17.leanback.app.ProgressBarManager mProgressBarManager = new android.support.v17.leanback.app.ProgressBarManager();

    BaseSupportFragment() {
        mEnterTransitionStates = new android.support.v17.leanback.util.StateMachine();
    ...
    boolean isEntranceTransitionEnabled() {
        ...
        return STATE_ALLOWED.getStatus() == android.support.v17.leanback.util.StateMachine.STATUS_EXECUTED;
    }
    ...
    void internalCreateEntranceTransition() {
        ...
        android.support.v17.leanback.transition.TransitionHelper.addTransitionListener(mEntranceTransition, new android.support.v17.leanback.transition.TransitionListener() {
            @java.lang.Override
     ...
     */
    public final android.support.v17.leanback.app.ProgressBarManager getProgressBarManager() {
