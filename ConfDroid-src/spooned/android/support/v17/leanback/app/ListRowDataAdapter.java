 ...
 */
class ListRowDataAdapter extends android.support.v17.leanback.widget.ObjectAdapter {
    ...
    private final android.support.v17.leanback.widget.ObjectAdapter mAdapter;

    int mLastVisibleRowIndex;

    public ListRowDataAdapter(android.support.v17.leanback.widget.ObjectAdapter adapter) {
        ...
        if (adapter.isImmediateNotifySupported()) {
            mAdapter.registerObserver(new android.support.v17.leanback.app.ListRowDataAdapter.SimpleDataObserver());
        } else {
            mAdapter.registerObserver(new android.support.v17.leanback.app.ListRowDataAdapter.QueueBasedDataObserver());
        }
    }
    ...
    void initialize() {
        ...
        while (i >= 0) {
            android.support.v17.leanback.widget.Row item = ((android.support.v17.leanback.widget.Row) (mAdapter.get(i)));
    ...
    void doNotify(int eventType, int positionStart, int itemCount) {
        switch (eventType) {
            case android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_CHANGED :
                notifyItemRangeChanged(positionStart, itemCount);
                break;
            case android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_INSERTED :
                notifyItemRangeInserted(positionStart, itemCount);
                break;
            case android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_REMOVED :
                notifyItemRangeRemoved(positionStart, itemCount);
                break;
            case android.support.v17.leanback.app.ListRowDataAdapter.ON_CHANGED :
                notifyChanged();
            default :
    ...
    private class SimpleDataObserver extends android.support.v17.leanback.widget.ObjectAdapter.DataObserver {
        SimpleDataObserver() {
        }
        ...
        public void onItemRangeChanged(int positionStart, int itemCount) {
            if (positionStart <= mLastVisibleRowIndex) {
                onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_CHANGED, positionStart, java.lang.Math.min(itemCount, (mLastVisibleRowIndex - positionStart) + 1));
            }
        }
        ...
        public void onItemRangeInserted(int positionStart, int itemCount) {
            if (positionStart <= mLastVisibleRowIndex) {
                ...
                onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_INSERTED, positionStart, itemCount);
                return;
            }
            ...
            if (mLastVisibleRowIndex > lastVisibleRowIndex) {
                ...
                onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_INSERTED, lastVisibleRowIndex + 1, totalItems);
            }
        }
        ...
        public void onItemRangeRemoved(int positionStart, int itemCount) {
            if (((positionStart + itemCount) - 1) < mLastVisibleRowIndex) {
                mLastVisibleRowIndex -= itemCount;
                onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_REMOVED, positionStart, itemCount);
                return;
            }
            int lastVisibleRowIndex = mLastVisibleRowIndex;
            initialize();
            ...
            if (totalItems > 0) {
                onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_ITEM_RANGE_REMOVED, java.lang.Math.min(lastVisibleRowIndex + 1, positionStart), totalItems);
            }
        }
        ...
        public void onChanged() {
            initialize();
            onEventFired(android.support.v17.leanback.app.ListRowDataAdapter.ON_CHANGED, -1, -1);
        }
     ...
     */
    private class QueueBasedDataObserver extends android.support.v17.leanback.widget.ObjectAdapter.DataObserver {
