 ...
 * into a {@link RowsFragment}, in the same way that they are in a {@link BrowseFragment}.
 *
...
public class SearchFragment extends android.app.Fragment {
    static final java.lang.String TAG = android.support.v17.leanback.app.SearchFragment.class.getSimpleName();

    static final boolean DEBUG = false;

    private static final java.lang.String EXTRA_LEANBACK_BADGE_PRESENT = "LEANBACK_BADGE_PRESENT";

    private static final java.lang.String ARG_PREFIX = android.support.v17.leanback.app.SearchFragment.class.getCanonicalName();

    private static final java.lang.String ARG_QUERY = android.support.v17.leanback.app.SearchFragment.ARG_PREFIX + ".query";

    private static final java.lang.String ARG_TITLE = android.support.v17.leanback.app.SearchFragment.ARG_PREFIX + ".title";
    ...
    final java.lang.Runnable mResultsChangedCallback = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, "results changed, new size " + mResultAdapter.size());
            ...
            mStatus |= android.support.v17.leanback.app.SearchFragment.RESULTS_CHANGED;
            if ((mStatus & android.support.v17.leanback.app.SearchFragment.QUERY_COMPLETE) != 0) {
                updateFocus();
            }
    ...
    private final java.lang.Runnable mSetSearchResultProvider = new java.lang.Runnable() {
        ...
        public void run() {
            ...
            if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, "Got results adapter " + adapter);
            ...
            if (adapter != mResultAdapter) {
                ...
                if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, (("mResultAdapter " + mResultAdapter) + " size ") + (mResultAdapter == null ? 0 : mResultAdapter.size()));
            ...
            updateSearchBarNextFocusId();
            if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, (((("mAutoStartRecognition " + mAutoStartRecognition) + " mResultAdapter ") + mResultAdapter) + " adapter ") + mRowsFragment.getAdapter());

            if (mAutoStartRecognition) {
                mHandler.removeCallbacks(mStartRecognitionRunnable);
                mHandler.postDelayed(mStartRecognitionRunnable, android.support.v17.leanback.app.SearchFragment.SPEECH_RECOGNITION_DELAY_MS);
            } else {
                updateFocus();
            }
        }
    ...
    android.support.v17.leanback.app.RowsFragment mRowsFragment;

    android.support.v17.leanback.widget.SearchBar mSearchBar;

    android.support.v17.leanback.app.SearchFragment.SearchResultProvider mProvider;
    ...
    private android.support.v17.leanback.app.SearchFragment.ExternalQuery mExternalQuery;
    ...
    private android.support.v17.leanback.widget.SearchBar.SearchBarPermissionListener mPermissionListener = new android.support.v17.leanback.widget.SearchBar.SearchBarPermissionListener() {
        ...
        public void requestAudioPermission() {
            android.support.v17.leanback.app.PermissionHelper.requestPermissions(android.support.v17.leanback.app.SearchFragment.this, new java.lang.String[]{ Manifest.permission.RECORD_AUDIO }, android.support.v17.leanback.app.SearchFragment.AUDIO_PERMISSION_REQUEST_CODE);
        }
    };

    public void onRequestPermissionsResult(int requestCode, java.lang.String[] permissions, int[] grantResults) {
        if ((requestCode == android.support.v17.leanback.app.SearchFragment.AUDIO_PERMISSION_REQUEST_CODE) && (permissions.length > 0)) {
    ...
    public static android.os.Bundle createArgs(android.os.Bundle args, java.lang.String query) {
        return android.support.v17.leanback.app.SearchFragment.createArgs(args, query, null);
    }
    ...
    public static android.os.Bundle createArgs(android.os.Bundle args, java.lang.String query, java.lang.String title) {
        ...
        args.putString(android.support.v17.leanback.app.SearchFragment.ARG_QUERY, query);
        args.putString(android.support.v17.leanback.app.SearchFragment.ARG_TITLE, title);
        return args;
    }
     ...
     */
    public static android.support.v17.leanback.app.SearchFragment newInstance(java.lang.String query) {
        android.support.v17.leanback.app.SearchFragment fragment = new android.support.v17.leanback.app.SearchFragment();
        android.os.Bundle args = android.support.v17.leanback.app.SearchFragment.createArgs(null, query);
    ...
    public android.view.View onCreateView(android.view.LayoutInflater inflater, android.view.ViewGroup container, android.os.Bundle savedInstanceState) {
        ...
        mSearchBar.setSearchBarListener(new android.support.v17.leanback.widget.SearchBar.SearchBarListener() {
            ...
            public void onSearchQueryChange(java.lang.String query) {
                if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, java.lang.String.format("onSearchQueryChange %s %s", query, null == mProvider ? "(null)" : mProvider));
            ...
            public void onSearchQuerySubmit(java.lang.String query) {
                if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, java.lang.String.format("onSearchQuerySubmit %s", query));
            ...
            public void onKeyboardDismiss(java.lang.String query) {
                if (android.support.v17.leanback.app.SearchFragment.DEBUG)
                    android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, java.lang.String.format("onKeyboardDismiss %s", query));
        ...
        if (getChildFragmentManager().findFragmentById(R.id.lb_results_frame) == null) {
            mRowsFragment = new android.support.v17.leanback.app.RowsFragment();
            getChildFragmentManager().beginTransaction().replace(R.id.lb_results_frame, mRowsFragment).commit();
        } else {
            mRowsFragment = ((android.support.v17.leanback.app.RowsFragment) (getChildFragmentManager().findFragmentById(R.id.lb_results_frame)));
        }
        mRowsFragment.setOnItemViewSelectedListener(new android.support.v17.leanback.widget.OnItemViewSelectedListener() {
            @java.lang.Override
            public void onItemSelected(android.support.v17.leanback.widget.Presenter.ViewHolder itemViewHolder, java.lang.Object item, android.support.v17.leanback.widget.RowPresenter.ViewHolder rowViewHolder, android.support.v17.leanback.widget.Row row) {
                if (android.support.v17.leanback.app.SearchFragment.DEBUG) {
                    ...
                    android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, java.lang.String.format("onItemSelected %d", position));
                }
                updateSearchBarVisibility();
    ...
    public void onStart() {
        super.onStart();
        android.support.v17.leanback.widget.VerticalGridView list = mRowsFragment.getVerticalGridView();
     ...
     * search query.
     */
    public void setSearchResultProvider(android.support.v17.leanback.app.SearchFragment.SearchResultProvider searchResultProvider) {
    ...
    public void setSearchQuery(java.lang.String query, boolean submit) {
        if (android.support.v17.leanback.app.SearchFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, (("setSearchQuery " + query) + " submit ") + submit);

        if (query == null) {
            return;
        }
        mExternalQuery = new android.support.v17.leanback.app.SearchFragment.ExternalQuery(query, submit);
        applyExternalQuery();
        if (mAutoStartRecognition) {
            mAutoStartRecognition = false;
            mHandler.removeCallbacks(mStartRecognitionRunnable);
    ...
    public android.content.Intent getRecognizerIntent() {
        ...
        recognizerIntent.putExtra(android.support.v17.leanback.app.SearchFragment.EXTRA_LEANBACK_BADGE_PRESENT, mBadgeDrawable != null);
        return recognizerIntent;
    }

    void retrieveResults(java.lang.String searchQuery) {
        if (android.support.v17.leanback.app.SearchFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, "retrieveResults " + searchQuery);

        if (mProvider.onQueryTextChange(searchQuery)) {
            mStatus &= ~android.support.v17.leanback.app.SearchFragment.QUERY_COMPLETE;
        }
    }
    ...
    void queryComplete() {
        if (android.support.v17.leanback.app.SearchFragment.DEBUG)
            android.util.Log.v(android.support.v17.leanback.app.SearchFragment.TAG, "queryComplete");
    ...
    void updateSearchBarNextFocusId() {
        ...
        final int viewId = (((mResultAdapter.size() == 0) || (mRowsFragment == null)) || (mRowsFragment.getVerticalGridView() == null)) ? 0 : mRowsFragment.getVerticalGridView().getId();
    ...
    private void focusOnResults() {
        if (((mRowsFragment == null) || (mRowsFragment.getVerticalGridView() == null)) || (mResultAdapter.size() == 0)) {
            return;
        }
    ...
    private void readArguments(android.os.Bundle args) {
        ...
        if (args.containsKey(android.support.v17.leanback.app.SearchFragment.ARG_QUERY)) {
            setSearchQuery(args.getString(android.support.v17.leanback.app.SearchFragment.ARG_QUERY));
        }
        if (args.containsKey(android.support.v17.leanback.app.SearchFragment.ARG_TITLE)) {
            setTitle(args.getString(android.support.v17.leanback.app.SearchFragment.ARG_TITLE));
        }
    }
