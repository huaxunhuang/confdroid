...
public class BrandedSupportFragment extends android.support.v4.app.Fragment {
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        outState.putBoolean(android.support.v17.leanback.app.BrandedSupportFragment.TITLE_SHOW, mShowingTitle);
    }
    ...
    public void onViewCreated(android.view.View view, android.os.Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mShowingTitle = savedInstanceState.getBoolean(android.support.v17.leanback.app.BrandedSupportFragment.TITLE_SHOW);
        }
