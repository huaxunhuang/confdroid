...
public final class ColorOverlayDimmer {
     ...
     */
    public static android.support.v17.leanback.graphics.ColorOverlayDimmer createDefault(android.content.Context context) {
        ...
        a.recycle();
        return new android.support.v17.leanback.graphics.ColorOverlayDimmer(dimColor, activeLevel, dimmedLevel);
    }
     ...
     * 		state. Must be a float value between 0.0 and 1.0.
     */
    public static android.support.v17.leanback.graphics.ColorOverlayDimmer createColorOverlayDimmer(int dimColor, float activeLevel, float dimmedLevel) {
        return new android.support.v17.leanback.graphics.ColorOverlayDimmer(dimColor, activeLevel, dimmedLevel);
    }
    ...
    private ColorOverlayDimmer(int dimColor, float activeLevel, float dimmedLevel) {
        ...
        dimColor = android.graphics.Color.rgb(android.graphics.Color.red(dimColor), android.graphics.Color.green(dimColor), android.graphics.Color.blue(dimColor));
    ...
    public int applyToColor(int color) {
        ...
        return android.graphics.Color.argb(android.graphics.Color.alpha(color), ((int) (android.graphics.Color.red(color) * f)), ((int) (android.graphics.Color.green(color) * f)), ((int) (android.graphics.Color.blue(color) * f)));
    }
     ...
     * 		View.
     */
    public void drawColorOverlay(android.graphics.Canvas c, android.view.View v, boolean includePadding) {
        c.save();
        ...
        if (includePadding) {
            ...
            c.drawRect(v.getLeft() + v.getPaddingLeft(), v.getTop() + v.getPaddingTop(), v.getRight() - v.getPaddingRight(), v.getBottom() - v.getPaddingBottom(), mPaint);
        }
        c.restore();
    }
}
