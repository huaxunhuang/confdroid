...
public abstract class CursorMapper {
     ...
     */
    protected abstract void bindColumns(android.database.Cursor cursor);
     ...
     */
    protected abstract java.lang.Object bind(android.database.Cursor cursor);

    /**
     * Convert a {@link Cursor} at its current position to an Object.
     */
    public java.lang.Object convert(android.database.Cursor cursor) {
        if (cursor != mCursor) {
            mCursor = cursor;
            bindColumns(mCursor);
        }
