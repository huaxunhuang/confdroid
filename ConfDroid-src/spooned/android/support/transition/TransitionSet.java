...
public class TransitionSet extends android.support.transition.Transition {
    ...
    public TransitionSet() {
        ...
        if (android.os.Build.VERSION.SDK_INT < 19) {
            mImpl = new android.support.transition.TransitionSetIcs(this);
        } else {
            mImpl = new android.support.transition.TransitionSetKitKat(this);
        }
    }
    ...
    public int getOrdering() {
        return ((android.support.transition.TransitionSetImpl) (mImpl)).getOrdering();
    }
    ...
    public android.support.transition.TransitionSet setOrdering(int ordering) {
        ((android.support.transition.TransitionSetImpl) (mImpl)).setOrdering(ordering);
        return this;
    }
     ...
     */
    @android.support.annotation.NonNull
    public android.support.transition.TransitionSet addTransition(@android.support.annotation.NonNull
    android.support.transition.Transition transition) {
        ((android.support.transition.TransitionSetImpl) (mImpl)).addTransition(transition.mImpl);
        return this;
    }
     ...
     */
    @android.support.annotation.NonNull
    public android.support.transition.TransitionSet removeTransition(@android.support.annotation.NonNull
    android.support.transition.Transition transition) {
        ((android.support.transition.TransitionSetImpl) (mImpl)).removeTransition(transition.mImpl);
        return this;
    }
