...
class SceneStaticsKitKat extends android.support.transition.SceneStaticsImpl {
    @java.lang.Override
    public android.support.transition.SceneImpl getSceneForLayout(android.view.ViewGroup sceneRoot, int layoutId, android.content.Context context) {
        android.support.transition.SceneKitKat scene = new android.support.transition.SceneKitKat();
