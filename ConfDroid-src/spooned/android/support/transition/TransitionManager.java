...
public class TransitionManager {
    ...
    static {
        if (android.os.Build.VERSION.SDK_INT < 19) {
            android.support.transition.TransitionManager.sImpl = new android.support.transition.TransitionManagerStaticsIcs();
        } else {
            android.support.transition.TransitionManager.sImpl = new android.support.transition.TransitionManagerStaticsKitKat();
        }
    }
    ...
    public TransitionManager() {
        if (android.os.Build.VERSION.SDK_INT < 19) {
            mImpl = new android.support.transition.TransitionManagerIcs();
        } else {
            mImpl = new android.support.transition.TransitionManagerKitKat();
        }
    }
     ...
     */
    public static void go(@android.support.annotation.NonNull
    android.support.transition.Scene scene) {
        android.support.transition.TransitionManager.sImpl.go(scene.mImpl);
    }
     ...
     */
    public static void go(@android.support.annotation.NonNull
    android.support.transition.Scene scene, @android.support.annotation.Nullable
    android.support.transition.Transition transition) {
        android.support.transition.TransitionManager.sImpl.go(scene.mImpl, transition == null ? null : transition.mImpl);
    }
     ...
     */
    public static void beginDelayedTransition(@android.support.annotation.NonNull
    final android.view.ViewGroup sceneRoot) {
        android.support.transition.TransitionManager.sImpl.beginDelayedTransition(sceneRoot);
    }
     ...
     */
    public static void beginDelayedTransition(@android.support.annotation.NonNull
    final android.view.ViewGroup sceneRoot, @android.support.annotation.Nullable
    android.support.transition.Transition transition) {
        android.support.transition.TransitionManager.sImpl.beginDelayedTransition(sceneRoot, transition == null ? null : transition.mImpl);
    }
     ...
     */
    public void setTransition(@android.support.annotation.NonNull
    android.support.transition.Scene scene, @android.support.annotation.Nullable
    android.support.transition.Transition transition) {
     ...
     */
    public void setTransition(@android.support.annotation.NonNull
    android.support.transition.Scene fromScene, @android.support.annotation.NonNull
    android.support.transition.Scene toScene, @android.support.annotation.Nullable
    android.support.transition.Transition transition) {
        mImpl.setTransition(fromScene.mImpl, toScene.mImpl, transition == null ? null : transition.mImpl);
    }
     ...
     * 		The Scene to change to
     */
    public void transitionTo(@android.support.annotation.NonNull
    android.support.transition.Scene scene) {
