...
public class Fade extends android.support.transition.Visibility {
    ...
    public Fade(int fadingMode) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 19) {
            if (fadingMode > 0) {
                mImpl = new android.support.transition.FadeKitKat(this, fadingMode);
            } else {
                mImpl = new android.support.transition.FadeKitKat(this);
            }
        } else {
            if (fadingMode > 0) {
                mImpl = new android.support.transition.FadeIcs(this, fadingMode);
            } else {
                mImpl = new android.support.transition.FadeIcs(this);
            }
        }
    }
