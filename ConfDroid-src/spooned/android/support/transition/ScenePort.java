...
final class ScenePort {
     ...
     */
    public ScenePort(android.view.ViewGroup sceneRoot) {
     ...
     * 		the layout resource.
     */
    private ScenePort(android.view.ViewGroup sceneRoot, int layoutId, android.content.Context context) {
        mContext = context;
        mSceneRoot = sceneRoot;
        mLayoutId = layoutId;
    }
     ...
     */
    public ScenePort(android.view.ViewGroup sceneRoot, android.view.View layout) {
        mSceneRoot = sceneRoot;
        mLayout = layout;
    }
     ...
     */
    public static android.support.transition.ScenePort getSceneForLayout(android.view.ViewGroup sceneRoot, int layoutId, android.content.Context context) {
        // We don't cache ScenePort, but android.support.transition.Scene.
        return new android.support.transition.ScenePort(sceneRoot, layoutId, context);
    }
     ...
     *
     * @param view
     * 		The view on which the current scene is being set
     */
    static void setCurrentScene(android.view.View view, android.support.transition.ScenePort scene) {
     ...
     */
    static android.support.transition.ScenePort getCurrentScene(android.view.View view) {
        return ((android.support.transition.ScenePort) (view.getTag(R.id.transition_current_scene)));
    }
     ...
     */
    public void exit() {
        if (android.support.transition.ScenePort.getCurrentScene(mSceneRoot) == this) {
            if (mExitAction != null) {
                mExitAction.run();
            }
        }
    ...
    public void enter() {
        ...
        android.support.transition.ScenePort.setCurrentScene(mSceneRoot, this);
    }
