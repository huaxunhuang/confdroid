...
public class Scene {
    ...
    static {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            android.support.transition.Scene.sImpl = new android.support.transition.SceneStaticsApi21();
        } else
            if (android.os.Build.VERSION.SDK_INT >= 19) {
                android.support.transition.Scene.sImpl = new android.support.transition.SceneStaticsKitKat();
            } else {
                android.support.transition.Scene.sImpl = new android.support.transition.SceneStaticsIcs();
            }
     ...
     */
    public Scene(@android.support.annotation.NonNull
    ...
    private Scene(android.support.transition.SceneImpl scene) {
        mImpl = scene;
    }
    ...
    public static android.support.transition.Scene getSceneForLayout(@android.support.annotation.NonNull
    android.view.ViewGroup sceneRoot, @android.support.annotation.LayoutRes
    int layoutId, @android.support.annotation.NonNull
    android.content.Context context) {
        @java.lang.SuppressWarnings("unchecked")
        android.util.SparseArray<android.support.transition.Scene> scenes = ((android.util.SparseArray<android.support.transition.Scene>) (sceneRoot.getTag(R.id.transition_scene_layoutid_cache)));
        if (scenes == null) {
            scenes = new android.util.SparseArray<>();
            sceneRoot.setTag(R.id.transition_scene_layoutid_cache, scenes);
        }
        android.support.transition.Scene scene = scenes.get(layoutId);
        if (scene != null) {
            return scene;
        } else {
            scene = new android.support.transition.Scene(android.support.transition.Scene.sImpl.getSceneForLayout(sceneRoot, layoutId, context));
    ...
    private android.support.transition.SceneImpl createSceneImpl() {
        if (android.os.Build.VERSION.SDK_INT >= 21) {
            return new android.support.transition.SceneApi21();
        } else
            if (android.os.Build.VERSION.SDK_INT >= 19) {
                return new android.support.transition.SceneKitKat();
            } else {
                return new android.support.transition.SceneIcs();
            }
     ...
     */
    public void setEnterAction(@android.support.annotation.Nullable
     ...
     * @see android.support.transition.Scene(android.view.ViewGroup, android.view.ViewGroup)
     */
    public void setExitAction(@android.support.annotation.Nullable
    java.lang.Runnable action) {
