 ...
 */
abstract class VisibilityPort extends android.support.transition.TransitionPort {
    private static final java.lang.String PROPNAME_VISIBILITY = "android:visibility:visibility";

    private static final java.lang.String PROPNAME_PARENT = "android:visibility:parent";

    private static final java.lang.String[] sTransitionProperties = new java.lang.String[]{ android.support.transition.VisibilityPort.PROPNAME_VISIBILITY, android.support.transition.VisibilityPort.PROPNAME_PARENT };

    @java.lang.Override
    public java.lang.String[] getTransitionProperties() {
        return android.support.transition.VisibilityPort.sTransitionProperties;
    }

    private void captureValues(android.support.transition.TransitionValues transitionValues) {
        int visibility = transitionValues.view.getVisibility();
        transitionValues.values.put(android.support.transition.VisibilityPort.PROPNAME_VISIBILITY, visibility);
        transitionValues.values.put(android.support.transition.VisibilityPort.PROPNAME_PARENT, transitionValues.view.getParent());
    }
     ...
     * disappearing in the {@link TransitionPort#createAnimator(ViewGroup, TransitionValues, TransitionValues)}
    ...
    public boolean isVisible(android.support.transition.TransitionValues values) {
        ...
        int visibility = ((java.lang.Integer) (values.values.get(android.support.transition.VisibilityPort.PROPNAME_VISIBILITY)));
        android.view.View parent = ((android.view.View) (values.values.get(android.support.transition.VisibilityPort.PROPNAME_PARENT)));
        return (visibility == android.view.View.VISIBLE) && (parent != null);
    }

    private android.support.transition.VisibilityPort.VisibilityInfo getVisibilityChangeInfo(android.support.transition.TransitionValues startValues, android.support.transition.TransitionValues endValues) {
        final android.support.transition.VisibilityPort.VisibilityInfo visInfo = new android.support.transition.VisibilityPort.VisibilityInfo();
        visInfo.visibilityChange = false;
        visInfo.fadeIn = false;
        if (startValues != null) {
            visInfo.startVisibility = ((java.lang.Integer) (startValues.values.get(android.support.transition.VisibilityPort.PROPNAME_VISIBILITY)));
            visInfo.startParent = ((android.view.ViewGroup) (startValues.values.get(android.support.transition.VisibilityPort.PROPNAME_PARENT)));
        } else {
            visInfo.startVisibility = -1;
            visInfo.startParent = null;
        }
        if (endValues != null) {
            visInfo.endVisibility = ((java.lang.Integer) (endValues.values.get(android.support.transition.VisibilityPort.PROPNAME_VISIBILITY)));
            visInfo.endParent = ((android.view.ViewGroup) (endValues.values.get(android.support.transition.VisibilityPort.PROPNAME_PARENT)));
        } else {
    ...
    public android.animation.Animator createAnimator(android.view.ViewGroup sceneRoot, android.support.transition.TransitionValues startValues, android.support.transition.TransitionValues endValues) {
        android.support.transition.VisibilityPort.VisibilityInfo visInfo = getVisibilityChangeInfo(startValues, endValues);
