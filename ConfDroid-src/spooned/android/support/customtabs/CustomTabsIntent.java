...
public final class CustomTabsIntent {
    ...
    public void launchUrl(android.content.Context context, android.net.Uri url) {
        intent.setData(url);
        android.support.v4.content.ContextCompat.startActivity(context, intent, startAnimationBundle);
    }

    private CustomTabsIntent(android.content.Intent intent, android.os.Bundle startAnimationBundle) {
        this.intent = intent;
    ...
    public static final class Builder {
        private final android.content.Intent mIntent = new android.content.Intent(android.content.Intent.ACTION_VIEW);

        private java.util.ArrayList<android.os.Bundle> mMenuItems = null;

        private android.os.Bundle mStartAnimationBundle = null;

        private java.util.ArrayList<android.os.Bundle> mActionButtons = null;
         ...
         */
        public Builder(@android.support.annotation.Nullable
        android.support.customtabs.CustomTabsSession session) {
            if (session != null)
                mIntent.setPackage(session.getComponentName().getPackageName());

            android.os.Bundle bundle = new android.os.Bundle();
            android.support.v4.app.BundleCompat.putBinder(bundle, android.support.customtabs.CustomTabsIntent.EXTRA_SESSION, session == null ? null : session.getBinder());
         ...
         * 		{@link Color}
         */
        public android.support.customtabs.CustomTabsIntent.Builder setToolbarColor(@android.support.annotation.ColorInt
        int color) {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_TOOLBAR_COLOR, color);
            return this;
        }
        ...
        public android.support.customtabs.CustomTabsIntent.Builder enableUrlBarHiding() {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_ENABLE_URLBAR_HIDING, true);
            return this;
        }
         ...
         *
         * @param icon
         * 		The icon {@link Bitmap}
         */
        public android.support.customtabs.CustomTabsIntent.Builder setCloseButtonIcon(@android.support.annotation.NonNull
        android.graphics.Bitmap icon) {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_CLOSE_BUTTON_ICON, icon);
            return this;
        }
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setShowTitle(boolean showTitle) {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_TITLE_VISIBILITY_STATE, showTitle ? android.support.customtabs.CustomTabsIntent.SHOW_PAGE_TITLE : android.support.customtabs.CustomTabsIntent.NO_TITLE);
            return this;
        }
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder addMenuItem(@android.support.annotation.NonNull
        java.lang.String label, @android.support.annotation.NonNull
        android.app.PendingIntent pendingIntent) {
            if (mMenuItems == null)
                mMenuItems = new java.util.ArrayList<>();

            android.os.Bundle bundle = new android.os.Bundle();
            bundle.putString(android.support.customtabs.CustomTabsIntent.KEY_MENU_ITEM_TITLE, label);
            bundle.putParcelable(android.support.customtabs.CustomTabsIntent.KEY_PENDING_INTENT, pendingIntent);
        ...
        public android.support.customtabs.CustomTabsIntent.Builder addDefaultShareMenuItem() {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_DEFAULT_SHARE_MENU_ITEM, true);
            return this;
        }
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setActionButton(@android.support.annotation.NonNull
        android.graphics.Bitmap icon, @android.support.annotation.NonNull
        java.lang.String description, @android.support.annotation.NonNull
        android.app.PendingIntent pendingIntent, boolean shouldTint) {
            android.os.Bundle bundle = new android.os.Bundle();
            bundle.putInt(android.support.customtabs.CustomTabsIntent.KEY_ID, android.support.customtabs.CustomTabsIntent.TOOLBAR_ACTION_BUTTON_ID);
            ...
            bundle.putParcelable(android.support.customtabs.CustomTabsIntent.KEY_PENDING_INTENT, pendingIntent);
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_ACTION_BUTTON_BUNDLE, bundle);
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_TINT_ACTION_BUTTON, shouldTint);
            return this;
        }
        ...
        public android.support.customtabs.CustomTabsIntent.Builder addToolbarItem(int id, @android.support.annotation.NonNull
        android.graphics.Bitmap icon, @android.support.annotation.NonNull
        java.lang.String description, android.app.PendingIntent pendingIntent) throws java.lang.IllegalStateException {
            if (mActionButtons == null) {
                mActionButtons = new java.util.ArrayList<>();
            }
            if (mActionButtons.size() >= android.support.customtabs.CustomTabsIntent.MAX_TOOLBAR_ITEMS) {
                throw new java.lang.IllegalStateException("Exceeded maximum toolbar item count of " + android.support.customtabs.CustomTabsIntent.MAX_TOOLBAR_ITEMS);
            }
            android.os.Bundle bundle = new android.os.Bundle();
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setSecondaryToolbarColor(@android.support.annotation.ColorInt
        int color) {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_SECONDARY_TOOLBAR_COLOR, color);
            return this;
        }
         ...
         *
         * @param remoteViews
         * 		The {@link RemoteViews} that will be shown on the secondary toolbar.
         * @param clickableIDs
         * 		The IDs of clickable views. The onClick event of these views will be
         * 		handled by custom tabs.
         * @param pendingIntent
         * 		The {@link PendingIntent} that will be sent when the user clicks on
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setSecondaryToolbarViews(@android.support.annotation.NonNull
        ...
        android.app.PendingIntent pendingIntent) {
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_REMOTEVIEWS, remoteViews);
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_REMOTEVIEWS_VIEW_IDS, clickableIDs);
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_REMOTEVIEWS_PENDINGINTENT, pendingIntent);
            return this;
        }
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setInstantAppsEnabled(boolean enabled) {
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setStartAnimations(@android.support.annotation.NonNull
        android.content.Context context, @android.support.annotation.AnimRes
        int enterResId, @android.support.annotation.AnimRes
        int exitResId) {
            mStartAnimationBundle = android.support.v4.app.ActivityOptionsCompat.makeCustomAnimation(context, enterResId, exitResId).toBundle();
            return this;
        }
         ...
         */
        public android.support.customtabs.CustomTabsIntent.Builder setExitAnimations(@android.support.annotation.NonNull
        android.content.Context context, @android.support.annotation.AnimRes
        int enterResId, @android.support.annotation.AnimRes
        int exitResId) {
            android.os.Bundle bundle = android.support.v4.app.ActivityOptionsCompat.makeCustomAnimation(context, enterResId, exitResId).toBundle();
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_EXIT_ANIMATION_BUNDLE, bundle);
            return this;
        }
        ...
        public android.support.customtabs.CustomTabsIntent build() {
            if (mMenuItems != null) {
                mIntent.putParcelableArrayListExtra(android.support.customtabs.CustomTabsIntent.EXTRA_MENU_ITEMS, mMenuItems);
            }
            if (mActionButtons != null) {
                mIntent.putParcelableArrayListExtra(android.support.customtabs.CustomTabsIntent.EXTRA_TOOLBAR_ITEMS, mActionButtons);
            }
            mIntent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_ENABLE_INSTANT_APPS, mInstantAppsEnabled);
            return new android.support.customtabs.CustomTabsIntent(mIntent, mStartAnimationBundle);
        }
    }
    ...
    public static int getMaxToolbarItems() {
        return android.support.customtabs.CustomTabsIntent.MAX_TOOLBAR_ITEMS;
    }
    ...
    public static android.content.Intent setAlwaysUseBrowserUI(android.content.Intent intent) {
        ...
        intent.putExtra(android.support.customtabs.CustomTabsIntent.EXTRA_USER_OPT_OUT_FROM_CUSTOM_TABS, true);
        return intent;
    }
    ...
    public static boolean shouldAlwaysUseBrowserUI(android.content.Intent intent) {
        return intent.getBooleanExtra(android.support.customtabs.CustomTabsIntent.EXTRA_USER_OPT_OUT_FROM_CUSTOM_TABS, false) && ((intent.getFlags() & android.content.Intent.FLAG_ACTIVITY_NEW_TASK) != 0);
    }
}
