...
public abstract class CustomTabsServiceConnection implements android.content.ServiceConnection {
    @java.lang.Override
    public final void onServiceConnected(android.content.ComponentName name, android.os.IBinder service) {
        onCustomTabsServiceConnected(name, new android.support.customtabs.CustomTabsClient(ICustomTabsService.Stub.asInterface(service), name) {});
    }
     ...
     * @param client
     * 		{@link CustomTabsClient} that contains the {@link IBinder} with which the
     * 		connection have been established. All further communication should be initiated
     * 		using this client.
     */
    public abstract void onCustomTabsServiceConnected(android.content.ComponentName name, android.support.customtabs.CustomTabsClient client);
}
