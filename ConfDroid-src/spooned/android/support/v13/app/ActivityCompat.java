...
public class ActivityCompat extends android.support.v4.app.ActivityCompat {
    ...
    not be granted.
     */
    public static android.support.v13.view.DragAndDropPermissionsCompat requestDragAndDropPermissions(android.app.Activity activity, android.view.DragEvent dragEvent) {
        return android.support.v13.view.DragAndDropPermissionsCompat.request(activity, dragEvent);
    }
