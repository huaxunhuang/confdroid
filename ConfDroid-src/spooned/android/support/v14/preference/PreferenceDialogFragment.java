...
public abstract class PreferenceDialogFragment extends android.app.DialogFragment implements android.content.DialogInterface.OnClickListener {
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        final java.lang.String key = getArguments().getString(android.support.v14.preference.PreferenceDialogFragment.ARG_KEY);
        if (savedInstanceState == null) {
            ...
            mDialogTitle = savedInstanceState.getCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_TITLE);
            mPositiveButtonText = savedInstanceState.getCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_POSITIVE_TEXT);
            mNegativeButtonText = savedInstanceState.getCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_NEGATIVE_TEXT);
            mDialogMessage = savedInstanceState.getCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_MESSAGE);
            mDialogLayoutRes = savedInstanceState.getInt(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_LAYOUT, 0);
            final android.graphics.Bitmap bitmap = savedInstanceState.getParcelable(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_ICON);
            if (bitmap != null) {
                mDialogIcon = new android.graphics.drawable.BitmapDrawable(getResources(), bitmap);
            }
        }
    ...
    android.os.Bundle outState) {
        ...
        outState.putCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_TITLE, mDialogTitle);
        outState.putCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_POSITIVE_TEXT, mPositiveButtonText);
        outState.putCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_NEGATIVE_TEXT, mNegativeButtonText);
        outState.putCharSequence(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_MESSAGE, mDialogMessage);
        outState.putInt(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_LAYOUT, mDialogLayoutRes);
        if (mDialogIcon != null) {
            outState.putParcelable(android.support.v14.preference.PreferenceDialogFragment.SAVE_STATE_ICON, mDialogIcon.getBitmap());
        }
    }
    ...
    public android.app.Dialog onCreateDialog(android.os.Bundle savedInstanceState) {
        ...
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(context).setTitle(mDialogTitle).setIcon(mDialogIcon).setPositiveButton(mPositiveButtonText, this).setNegativeButton(mNegativeButtonText, this);
