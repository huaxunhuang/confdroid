...
public class FrameSequence {
    static {
        java.lang.System.loadLibrary("framesequence");
    }
    ...
    private static native android.support.rastermill.FrameSequence nativeDecodeByteBuffer(java.nio.ByteBuffer buffer, int offset, int capacity);
    ...
    public static android.support.rastermill.FrameSequence decodeByteArray(byte[] data) {
        return android.support.rastermill.FrameSequence.decodeByteArray(data, 0, data.length);
    }
    ...
    public static android.support.rastermill.FrameSequence decodeByteArray(byte[] data, int offset, int length) {
        ...
        if (((offset < 0) || (length < 0)) || ((offset + length) > data.length)) {
            throw new java.lang.IllegalArgumentException("invalid offset/length parameters");
        }
        return android.support.rastermill.FrameSequence.nativeDecodeByteArray(data, offset, length);
    }

    public static android.support.rastermill.FrameSequence decodeByteBuffer(java.nio.ByteBuffer buffer) {
        if (buffer == null)
            throw new java.lang.IllegalArgumentException();
        ...
        if (!buffer.isDirect()) {
            if (buffer.hasArray()) {
                ...
                return android.support.rastermill.FrameSequence.decodeByteArray(byteArray, buffer.position(), buffer.remaining());
            } else {
                throw new java.lang.IllegalArgumentException("Cannot have non-direct ByteBuffer with no byte array");
            }
        }
        return android.support.rastermill.FrameSequence.nativeDecodeByteBuffer(buffer, buffer.position(), buffer.remaining());
    }
    ...
    public static android.support.rastermill.FrameSequence decodeStream(java.io.InputStream stream) {
        ...
        return android.support.rastermill.FrameSequence.nativeDecodeStream(stream, tempStorage);
    }

    android.support.rastermill.FrameSequence.State createState() {
        if (mNativeFrameSequence == 0) {
            throw new java.lang.IllegalStateException("attempted to use incorrectly built FrameSequence");
        }
        long nativeState = android.support.rastermill.FrameSequence.nativeCreateState(mNativeFrameSequence);
        if (nativeState == 0) {
            return null;
        }
        return new android.support.rastermill.FrameSequence.State(nativeState);
    }
    ...
    protected void finalize() throws java.lang.Throwable {
        try {
            if (mNativeFrameSequence != 0)
                android.support.rastermill.FrameSequence.nativeDestroyFrameSequence(mNativeFrameSequence);
    ...
    static class State {
        ...
        public void destroy() {
            if (mNativeState != 0) {
                android.support.rastermill.FrameSequence.nativeDestroyState(mNativeState);
                mNativeState = 0;
            }
        }

        // TODO: consider adding alternate API for drawing into a SurfaceTexture
        public long getFrame(int frameNr, android.graphics.Bitmap output, int previousFrameNr) {
            if ((output == null) || (output.getConfig() != android.graphics.Bitmap.Config.ARGB_8888)) {
                throw new java.lang.IllegalArgumentException("Bitmap passed must be non-null and ARGB_8888");
            }
            if (mNativeState == 0) {
                throw new java.lang.IllegalStateException("attempted to draw destroyed FrameSequenceState");
            }
            return android.support.rastermill.FrameSequence.nativeGetFrame(mNativeState, frameNr, output, previousFrameNr);
        }
    }
}
