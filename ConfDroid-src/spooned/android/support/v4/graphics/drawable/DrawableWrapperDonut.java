 ...
 */
class DrawableWrapperDonut extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback , android.support.v4.graphics.drawable.DrawableWrapper , android.support.v4.graphics.drawable.TintAwareDrawable {
    ...
    android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperState mState;

    private boolean mMutated;

    android.graphics.drawable.Drawable mDrawable;

    DrawableWrapperDonut(@android.support.annotation.NonNull
    android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperState state, @android.support.annotation.Nullable
     ...
     */
    DrawableWrapperDonut(@android.support.annotation.Nullable
    ...
    android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperState mutateConstantState() {
        return new android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperStateDonut(mState, null);
    }
    ...
    protected static abstract class DrawableWrapperState extends android.graphics.drawable.Drawable.ConstantState {
        ...
        android.graphics.PorterDuff.Mode mTintMode = android.support.v4.graphics.drawable.DrawableWrapperDonut.DEFAULT_TINT_MODE;
    ...
    private static class DrawableWrapperStateDonut extends android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperState {
        DrawableWrapperStateDonut(@android.support.annotation.Nullable
        android.support.v4.graphics.drawable.DrawableWrapperDonut.DrawableWrapperState orig, @android.support.annotation.Nullable
        android.content.res.Resources res) {
            super(orig, res);
        }
        ...
        android.content.res.Resources res) {
            return new android.support.v4.graphics.drawable.DrawableWrapperDonut(this, res);
        }
    }
}
