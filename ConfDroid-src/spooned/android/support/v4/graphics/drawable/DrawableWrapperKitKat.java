...
class DrawableWrapperKitKat extends android.support.v4.graphics.drawable.DrawableWrapperHoneycomb {
    ...
    android.support.v4.graphics.drawable.DrawableWrapperGingerbread.DrawableWrapperState mutateConstantState() {
        return new android.support.v4.graphics.drawable.DrawableWrapperKitKat.DrawableWrapperStateKitKat(mState, null);
    }
    ...
    private static class DrawableWrapperStateKitKat extends android.support.v4.graphics.drawable.DrawableWrapperGingerbread.DrawableWrapperState {
        DrawableWrapperStateKitKat(@android.support.annotation.Nullable
