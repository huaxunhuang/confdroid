...
class CompoundButtonCompatDonut {
    private static final java.lang.String TAG = "CompoundButtonCompatDonut";
    ...
    static android.graphics.drawable.Drawable getButtonDrawable(android.widget.CompoundButton button) {
        if (!android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableFieldFetched) {
            try {
                android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableField = android.widget.CompoundButton.class.getDeclaredField("mButtonDrawable");
                android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableField.setAccessible(true);
            } catch (java.lang.NoSuchFieldException e) {
                android.util.Log.i(android.support.v4.widget.CompoundButtonCompatDonut.TAG, "Failed to retrieve mButtonDrawable field", e);
            }
            android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableFieldFetched = true;
        }
        if (android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableField != null) {
            try {
                return ((android.graphics.drawable.Drawable) (android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableField.get(button)));
            } catch (java.lang.IllegalAccessException e) {
                android.util.Log.i(android.support.v4.widget.CompoundButtonCompatDonut.TAG, "Failed to get button drawable via reflection", e);
                android.support.v4.widget.CompoundButtonCompatDonut.sButtonDrawableField = null;
            }
        }
        return null;
    }
