...
public class ContentLoadingProgressBar extends android.widget.ProgressBar {
    ...
    private final java.lang.Runnable mDelayedHide = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            mPostedHide = false;
            mStartTime = -1;
    ...
    private final java.lang.Runnable mDelayedShow = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            mPostedShow = false;
            if (!mDismissed) {
    ...
    public void hide() {
        ...
        if ((diff >= android.support.v4.widget.ContentLoadingProgressBar.MIN_SHOW_TIME) || (mStartTime == (-1))) {
            ...
            // shown long enough.
            if (!mPostedHide) {
                postDelayed(mDelayedHide, android.support.v4.widget.ContentLoadingProgressBar.MIN_SHOW_TIME - diff);
                mPostedHide = true;
            }
        }
    }
    ...
    public void show() {
        ...
        removeCallbacks(mDelayedHide);
        if (!mPostedShow) {
            postDelayed(mDelayedShow, android.support.v4.widget.ContentLoadingProgressBar.MIN_DELAY);
            mPostedShow = true;
        }
    }
}
