...
public abstract class ExploreByTouchHelper extends android.support.v4.view.AccessibilityDelegateCompat {
     ...
     */
    public static final int INVALID_ID = java.lang.Integer.MIN_VALUE;

    /**
     * Virtual node identifier value for the host view's node.
     */
    public static final int HOST_ID = android.view.View.NO_ID;
     ...
     */
    private static final android.graphics.Rect INVALID_PARENT_BOUNDS = new android.graphics.Rect(java.lang.Integer.MAX_VALUE, java.lang.Integer.MAX_VALUE, java.lang.Integer.MIN_VALUE, java.lang.Integer.MIN_VALUE);
     ...
     */
    private int mAccessibilityFocusedVirtualViewId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;

    /**
     * Identifier for the virtual view that holds keyboard focus.
     */
    private int mKeyboardFocusedVirtualViewId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;

    /**
     * Identifier for the virtual view that is currently hovered.
     */
    private int mHoveredVirtualViewId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;
    ...
    public ExploreByTouchHelper(android.view.View host) {
        ...
        mManager = ((android.view.accessibility.AccessibilityManager) (context.getSystemService(android.content.Context.ACCESSIBILITY_SERVICE)));
        // Host view must be focusable so that we can delegate to virtual
        // views.
        host.setFocusable(true);
        if (android.support.v4.view.ViewCompat.getImportantForAccessibility(host) == android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
            android.support.v4.view.ViewCompat.setImportantForAccessibility(host, android.support.v4.view.ViewCompat.IMPORTANT_FOR_ACCESSIBILITY_YES);
        }
    }
    ...
    public android.support.v4.view.accessibility.AccessibilityNodeProviderCompat getAccessibilityNodeProvider(android.view.View host) {
        if (mNodeProvider == null) {
            mNodeProvider = new android.support.v4.widget.ExploreByTouchHelper.MyNodeProvider();
        }
     ...
     */
    public final boolean dispatchHoverEvent(@android.support.annotation.NonNull
    android.view.MotionEvent event) {
        if ((!mManager.isEnabled()) || (!android.support.v4.view.accessibility.AccessibilityManagerCompat.isTouchExplorationEnabled(mManager))) {
            return false;
        }
        switch (event.getAction()) {
            case android.support.v4.view.MotionEventCompat.ACTION_HOVER_MOVE :
            case android.support.v4.view.MotionEventCompat.ACTION_HOVER_ENTER :
                final int virtualViewId = getVirtualViewAt(event.getX(), event.getY());
                updateHoveredVirtualView(virtualViewId);
                return virtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;
            case android.support.v4.view.MotionEventCompat.ACTION_HOVER_EXIT :
                if (mAccessibilityFocusedVirtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) {
                    updateHoveredVirtualView(android.support.v4.widget.ExploreByTouchHelper.INVALID_ID);
                    return true;
                }
                return false;
            default :
     ...
     * </pre>
     */
    public final boolean dispatchKeyEvent(@android.support.annotation.NonNull
            ...
            switch (keyCode) {
                ...
                case android.view.KeyEvent.KEYCODE_DPAD_DOWN :
                    if (android.support.v4.view.KeyEventCompat.hasNoModifiers(event)) {
                        final int direction = android.support.v4.widget.ExploreByTouchHelper.keyToDirection(keyCode);
                ...
                case android.view.KeyEvent.KEYCODE_TAB :
                    if (android.support.v4.view.KeyEventCompat.hasNoModifiers(event)) {
                        handled = moveFocus(android.view.View.FOCUS_FORWARD, null);
                    } else
                        if (android.support.v4.view.KeyEventCompat.hasModifiers(event, android.view.KeyEvent.META_SHIFT_ON)) {
                            handled = moveFocus(android.view.View.FOCUS_BACKWARD, null);
                        }
     ...
     * </pre>
     */
    public final void onFocusChanged(boolean gainFocus, int direction, @android.support.annotation.Nullable
    android.graphics.Rect previouslyFocusedRect) {
        if (mKeyboardFocusedVirtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) {
    ...
    private static int keyToDirection(int keyCode) {
        switch (keyCode) {
            case android.view.KeyEvent.KEYCODE_DPAD_LEFT :
                return android.view.View.FOCUS_LEFT;
            case android.view.KeyEvent.KEYCODE_DPAD_UP :
                return android.view.View.FOCUS_UP;
            case android.view.KeyEvent.KEYCODE_DPAD_RIGHT :
                return android.view.View.FOCUS_RIGHT;
            default :
                return android.view.View.FOCUS_DOWN;
        }
    }
     ...
     *
     * @param virtualViewId
     * 		the identifier of the virtual view
     * @param outBounds
     * 		the rect to populate with virtual view bounds
     */
    private void getBoundsInParent(int virtualViewId, android.graphics.Rect outBounds) {
        final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat node = obtainAccessibilityNodeInfo(virtualViewId);
     ...
     *
     * @param direction
     * 		the direction in which to move keyboard focus
     * @param previouslyFocusedRect
     * 		the bounds of the previously focused item,
     * 		or {@code null} if not available
     * @return {@code true} if keyboard focus moved to a virtual view managed
    by this helper, or {@code false} otherwise
     */
    private boolean moveFocus(@android.support.v4.view.ViewCompat.FocusDirection
    int direction, @android.support.annotation.Nullable
    android.graphics.Rect previouslyFocusedRect) {
        final android.support.v4.util.SparseArrayCompat<android.support.v4.view.accessibility.AccessibilityNodeInfoCompat> allNodes = getAllNodes();
        final int focusedNodeId = mKeyboardFocusedVirtualViewId;
        final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat focusedNode = (focusedNodeId == android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) ? null : allNodes.get(focusedNodeId);
        final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat nextFocusedNode;
        switch (direction) {
            case android.view.View.FOCUS_FORWARD :
            case android.view.View.FOCUS_BACKWARD :
                final boolean isLayoutRtl = android.support.v4.view.ViewCompat.getLayoutDirection(mHost) == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL;
                nextFocusedNode = android.support.v4.widget.FocusStrategy.findNextFocusInRelativeDirection(allNodes, android.support.v4.widget.ExploreByTouchHelper.SPARSE_VALUES_ADAPTER, android.support.v4.widget.ExploreByTouchHelper.NODE_ADAPTER, focusedNode, direction, isLayoutRtl, false);
                break;
            ...
            case android.view.View.FOCUS_DOWN :
                final android.graphics.Rect selectedRect = new android.graphics.Rect();
                if (mKeyboardFocusedVirtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) {
                    ...
                    if (previouslyFocusedRect != null) {
                        ...
                        android.support.v4.widget.ExploreByTouchHelper.guessPreviouslyFocusedRect(mHost, direction, selectedRect);
                    }

                nextFocusedNode = android.support.v4.widget.FocusStrategy.findNextFocusInAbsoluteDirection(allNodes, android.support.v4.widget.ExploreByTouchHelper.SPARSE_VALUES_ADAPTER, android.support.v4.widget.ExploreByTouchHelper.NODE_ADAPTER, focusedNode, selectedRect, direction);
                break;
            default :
        ...
        if (nextFocusedNode == null) {
            nextFocusedNodeId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;
        } else {
    ...
    private android.support.v4.util.SparseArrayCompat<android.support.v4.view.accessibility.AccessibilityNodeInfoCompat> getAllNodes() {
        final java.util.List<java.lang.Integer> virtualViewIds = new java.util.ArrayList<>();
        getVisibleVirtualViews(virtualViewIds);
        final android.support.v4.util.SparseArrayCompat<android.support.v4.view.accessibility.AccessibilityNodeInfoCompat> allNodes = new android.support.v4.util.SparseArrayCompat<>();
        for (int virtualViewId = 0; virtualViewId < virtualViewIds.size(); virtualViewId++) {
            final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat virtualView = createNodeForChild(virtualViewId);
     ...
     *
     * @param host
     * 		the view into which focus is moving
     * @param direction
     * 		the absolute direction in which focus is moving
     * @param outBounds
     * 		the rect to populate with the best-guess bounds for the
     * 		previous focus rect
     */
    private static android.graphics.Rect guessPreviouslyFocusedRect(@android.support.annotation.NonNull
    android.view.View host, @android.support.v4.view.ViewCompat.FocusRealDirection
    ...
    private boolean clickKeyboardFocusedVirtualView() {
        return (mKeyboardFocusedVirtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) && onPerformActionForVirtualView(mKeyboardFocusedVirtualViewId, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_CLICK, null);
    }
    ...
    public final boolean sendEventForVirtualView(int virtualViewId, int eventType) {
        if ((virtualViewId == android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) || (!mManager.isEnabled())) {
            return false;
        }
        final android.view.ViewParent parent = mHost.getParent();
        if (parent == null) {
            return false;
        }
        final android.view.accessibility.AccessibilityEvent event = createEvent(virtualViewId, eventType);
        return android.support.v4.view.ViewParentCompat.requestSendAccessibilityEvent(parent, mHost, event);
    }
    ...
    public final void invalidateRoot() {
        invalidateVirtualView(android.support.v4.widget.ExploreByTouchHelper.HOST_ID, android.support.v4.view.accessibility.AccessibilityEventCompat.CONTENT_CHANGE_TYPE_SUBTREE);
    }
    ...
    public final void invalidateVirtualView(int virtualViewId) {
        invalidateVirtualView(virtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.CONTENT_CHANGE_TYPE_UNDEFINED);
    }
     ...
     * 		{@link #HOST_ID} to invalidate the root view
     * @param changeTypes
     * 		the bit mask of change types. May be {@code 0} for the
    ...
    public final void invalidateVirtualView(int virtualViewId, int changeTypes) {
        if ((virtualViewId != android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) && mManager.isEnabled()) {
            ...
            if (parent != null) {
                ...
                final android.view.accessibility.AccessibilityEvent event = createEvent(virtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_WINDOW_CONTENT_CHANGED);
                android.support.v4.view.accessibility.AccessibilityEventCompat.setContentChangeTypes(event, changeTypes);
                android.support.v4.view.ViewParentCompat.requestSendAccessibilityEvent(parent, mHost, event);
            }
        }
    }
     ...
     * @param hasFocus
     * 		{@code true} if the view has focus, {@code false}
     * 		otherwise
     */
     ...
     *
     * @param virtualViewId
     * 		the virtual view id for the item currently being
    ...
    private void updateHoveredVirtualView(int virtualViewId) {
        ...
        sendEventForVirtualView(virtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_VIEW_HOVER_ENTER);
        sendEventForVirtualView(previousVirtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_VIEW_HOVER_EXIT);
    }
    ...
    private android.view.accessibility.AccessibilityEvent createEventForHost(int eventType) {
        final android.view.accessibility.AccessibilityEvent event = android.view.accessibility.AccessibilityEvent.obtain(eventType);
        android.support.v4.view.ViewCompat.onInitializeAccessibilityEvent(mHost, event);
        return event;
    }
    ...
    android.support.v4.view.accessibility.AccessibilityNodeInfoCompat obtainAccessibilityNodeInfo(int virtualViewId) {
        if (virtualViewId == android.support.v4.widget.ExploreByTouchHelper.HOST_ID) {
    ...
    private android.support.v4.view.accessibility.AccessibilityNodeInfoCompat createNodeForHost() {
        final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat info = android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.obtain(mHost);
        android.support.v4.view.ViewCompat.onInitializeAccessibilityNodeInfo(mHost, info);
        // Add the virtual descendants.
        final java.util.ArrayList<java.lang.Integer> virtualViewIds = new java.util.ArrayList<>();
        getVisibleVirtualViews(virtualViewIds);
     ...
     *
     * @param virtualViewId
     * 		the virtual view id for item for which to construct
     * 		a node
    ...
    private android.support.v4.view.accessibility.AccessibilityNodeInfoCompat createNodeForChild(int virtualViewId) {
        final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat node = android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.obtain();
        // Ensure the client has good defaults.
        node.setEnabled(true);
        node.setFocusable(true);
        node.setClassName(android.support.v4.widget.ExploreByTouchHelper.DEFAULT_CLASS_NAME);
        node.setBoundsInParent(android.support.v4.widget.ExploreByTouchHelper.INVALID_PARENT_BOUNDS);
        node.setBoundsInScreen(android.support.v4.widget.ExploreByTouchHelper.INVALID_PARENT_BOUNDS);
        ...
        if (mTempParentRect.equals(android.support.v4.widget.ExploreByTouchHelper.INVALID_PARENT_BOUNDS)) {
            throw new java.lang.RuntimeException("Callbacks must set parent bounds in " + "populateNodeForVirtualViewId()");
        }
        final int actions = node.getActions();
        if ((actions & android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS) != 0) {
            throw new java.lang.RuntimeException("Callbacks must not add ACTION_ACCESSIBILITY_FOCUS in " + "populateNodeForVirtualViewId()");
        }
        if ((actions & android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS) != 0) {
        ...
        if (mAccessibilityFocusedVirtualViewId == virtualViewId) {
            ...
            node.addAction(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_CLEAR_ACCESSIBILITY_FOCUS);
        } else {
            node.setAccessibilityFocused(false);
            node.addAction(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_ACCESSIBILITY_FOCUS);
        }
        // Manage internal keyboard focus state.
        final boolean isFocused = mKeyboardFocusedVirtualViewId == virtualViewId;
        if (isFocused) {
            node.addAction(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_CLEAR_FOCUS);
        } else
            if (node.isFocusable()) {
                node.addAction(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.ACTION_FOCUS);
            }
        ...
        if (mTempScreenRect.equals(android.support.v4.widget.ExploreByTouchHelper.INVALID_PARENT_BOUNDS)) {
    ...
    private boolean performActionForHost(int action, android.os.Bundle arguments) {
        return android.support.v4.view.ViewCompat.performAccessibilityAction(mHost, action, arguments);
    }
    ...
    private boolean intersectVisibleToUser(android.graphics.Rect localRect) {
        ...
        if (mHost.getWindowVisibility() != android.view.View.VISIBLE) {
            return false;
        }
        ...
        while (viewParent instanceof android.view.View) {
            ...
            if ((android.support.v4.view.ViewCompat.getAlpha(view) <= 0) || (view.getVisibility() != android.view.View.VISIBLE)) {
                return false;
            }
    ...
    private boolean requestAccessibilityFocus(int virtualViewId) {
        ...
        if (mAccessibilityFocusedVirtualViewId != virtualViewId) {
            ...
            mHost.invalidate();
            sendEventForVirtualView(virtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUSED);
            return true;
        }
        return false;
    }
    ...
    private boolean clearAccessibilityFocus(int virtualViewId) {
        if (mAccessibilityFocusedVirtualViewId == virtualViewId) {
            mAccessibilityFocusedVirtualViewId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;
            mHost.invalidate();
            sendEventForVirtualView(virtualViewId, android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_VIEW_ACCESSIBILITY_FOCUS_CLEARED);
            return true;
        }
        return false;
    }
    ...
    public final boolean requestKeyboardFocusForVirtualView(int virtualViewId) {
        ...
        sendEventForVirtualView(virtualViewId, android.view.accessibility.AccessibilityEvent.TYPE_VIEW_FOCUSED);
        return true;
    }
    ...
    public final boolean clearKeyboardFocusForVirtualView(int virtualViewId) {
        ...
        mKeyboardFocusedVirtualViewId = android.support.v4.widget.ExploreByTouchHelper.INVALID_ID;
     ...
     */
    protected void onPopulateEventForHost(android.view.accessibility.AccessibilityEvent event) {
        // Default implementation is no-op.
    }
     ...
     */
    protected abstract void onPopulateNodeForVirtualView(int virtualViewId, android.support.v4.view.accessibility.AccessibilityNodeInfoCompat node);
     ...
     */
    protected void onPopulateNodeForHost(android.support.v4.view.accessibility.AccessibilityNodeInfoCompat node) {
        // Default implementation is no-op.
    }
    ...
    private class MyNodeProvider extends android.support.v4.view.accessibility.AccessibilityNodeProviderCompat {
        ...
        public android.support.v4.view.accessibility.AccessibilityNodeInfoCompat createAccessibilityNodeInfo(int virtualViewId) {
            ...
            final android.support.v4.view.accessibility.AccessibilityNodeInfoCompat node = android.support.v4.widget.ExploreByTouchHelper.this.obtainAccessibilityNodeInfo(virtualViewId);
            return android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.obtain(node);
        }
        ...
        public android.support.v4.view.accessibility.AccessibilityNodeInfoCompat findFocus(int focusType) {
            int focusedId = (focusType == android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.FOCUS_ACCESSIBILITY) ? mAccessibilityFocusedVirtualViewId : mKeyboardFocusedVirtualViewId;
            if (focusedId == android.support.v4.widget.ExploreByTouchHelper.INVALID_ID) {
                return null;
            }
