...
public class ListViewAutoScrollHelper extends android.support.v4.widget.AutoScrollHelper {
    ...
    public void scrollTargetBy(int deltaX, int deltaY) {
        android.support.v4.widget.ListViewCompat.scrollListBy(mTarget, deltaY);
    }
    ...
    public boolean canTargetScrollVertically(int direction) {
        final android.widget.ListView target = mTarget;
        ...
        if (direction > 0) {
            ...
            if (lastPosition >= itemCount) {
                final android.view.View lastView = target.getChildAt(childCount - 1);
            ...
            if (direction < 0) {
                ...
                if (firstPosition <= 0) {
                    final android.view.View firstView = target.getChildAt(0);
