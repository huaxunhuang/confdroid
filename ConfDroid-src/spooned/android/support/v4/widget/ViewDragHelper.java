...
public class ViewDragHelper {
     ...
     */
    public static final int EDGE_ALL = ((android.support.v4.widget.ViewDragHelper.EDGE_LEFT | android.support.v4.widget.ViewDragHelper.EDGE_TOP) | android.support.v4.widget.ViewDragHelper.EDGE_RIGHT) | android.support.v4.widget.ViewDragHelper.EDGE_BOTTOM;
     ...
     */
    public static final int DIRECTION_ALL = android.support.v4.widget.ViewDragHelper.DIRECTION_HORIZONTAL | android.support.v4.widget.ViewDragHelper.DIRECTION_VERTICAL;
    ...
    private int mActivePointerId = android.support.v4.widget.ViewDragHelper.INVALID_POINTER;
    ...
    private final java.lang.Runnable mSetIdleRunnable = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            setDragState(android.support.v4.widget.ViewDragHelper.STATE_IDLE);
        }
    };
    ...
    public static android.support.v4.widget.ViewDragHelper create(android.view.ViewGroup forParent, android.support.v4.widget.ViewDragHelper.Callback cb) {
        return new android.support.v4.widget.ViewDragHelper(forParent.getContext(), forParent, cb);
    }
    ...
    public static android.support.v4.widget.ViewDragHelper create(android.view.ViewGroup forParent, float sensitivity, android.support.v4.widget.ViewDragHelper.Callback cb) {
        final android.support.v4.widget.ViewDragHelper helper = android.support.v4.widget.ViewDragHelper.create(forParent, cb);
     ...
     * 		Parent view to monitor
     */
    private ViewDragHelper(android.content.Context context, android.view.ViewGroup forParent, android.support.v4.widget.ViewDragHelper.Callback cb) {
        if (forParent == null) {
        ...
        mEdgeSize = ((int) ((android.support.v4.widget.ViewDragHelper.EDGE_SIZE * density) + 0.5F));
        mTouchSlop = vc.getScaledTouchSlop();
        mMaxVelocity = vc.getScaledMaximumFlingVelocity();
        mMinVelocity = vc.getScaledMinimumFlingVelocity();
        mScroller = android.support.v4.widget.ScrollerCompat.create(context, android.support.v4.widget.ViewDragHelper.sInterpolator);
    }
    ...
    public void captureChildView(android.view.View childView, int activePointerId) {
        ...
        setDragState(android.support.v4.widget.ViewDragHelper.STATE_DRAGGING);
    }
    ...
    public void abort() {
        cancel();
        if (mDragState == android.support.v4.widget.ViewDragHelper.STATE_SETTLING) {
    ...
    public boolean smoothSlideViewTo(android.view.View child, int finalLeft, int finalTop) {
        ...
        if (((!continueSliding) && (mDragState == android.support.v4.widget.ViewDragHelper.STATE_IDLE)) && (mCapturedView != null)) {
    ...
    private boolean forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
        ...
        setDragState(android.support.v4.widget.ViewDragHelper.STATE_SETTLING);
        return true;
    }
    ...
    private int computeAxisDuration(int delta, int velocity, int motionRange) {
        ...
        if (velocity > 0) {
            ...
            duration = ((int) ((range + 1) * android.support.v4.widget.ViewDragHelper.BASE_SETTLE_DURATION));
        }
        return java.lang.Math.min(duration, android.support.v4.widget.ViewDragHelper.MAX_SETTLE_DURATION);
    }
    ...
    public boolean continueSettling(boolean deferCallbacks) {
        if (mDragState == android.support.v4.widget.ViewDragHelper.STATE_SETTLING) {
            ...
            if (dx != 0) {
                android.support.v4.view.ViewCompat.offsetLeftAndRight(mCapturedView, dx);
            }
            if (dy != 0) {
                android.support.v4.view.ViewCompat.offsetTopAndBottom(mCapturedView, dy);
            }
            if ((dx != 0) || (dy != 0)) {
        ...
        return mDragState == android.support.v4.widget.ViewDragHelper.STATE_SETTLING;
    }
    ...
    private void dispatchViewReleased(float xvel, float yvel) {
        ...
        if (mDragState == android.support.v4.widget.ViewDragHelper.STATE_DRAGGING) {
    ...
    private void clearMotionHistory() {
        ...
        java.util.Arrays.fill(mInitialEdgesTouched, 0);
    ...
    private void ensureMotionHistorySizeForId(int pointerId) {
        if ((mInitialMotionX == null) || (mInitialMotionX.length <= pointerId)) {
            ...
            if (mInitialMotionX != null) {
                ...
                java.lang.System.arraycopy(mInitialEdgesTouched, 0, iit, 0, mInitialEdgesTouched.length);
    ...
    void setDragState(int state) {
        ...
        if (mDragState != state) {
            ...
            if (mDragState == android.support.v4.widget.ViewDragHelper.STATE_IDLE) {
                mCapturedView = null;
            }
        }
    }
    ...
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent ev) {
            ...
            case android.view.MotionEvent.ACTION_DOWN :
                {
                    ...
                    if ((toCapture == mCapturedView) && (mDragState == android.support.v4.widget.ViewDragHelper.STATE_SETTLING)) {
        ...
        return mDragState == android.support.v4.widget.ViewDragHelper.STATE_DRAGGING;
    }
    ...
    public void processTouchEvent(android.view.MotionEvent ev) {
        ...
        switch (action) {
            ...
            case android.support.v4.view.MotionEventCompat.ACTION_POINTER_UP :
                {
                    final int pointerId = ev.getPointerId(actionIndex);
                    if ((mDragState == android.support.v4.widget.ViewDragHelper.STATE_DRAGGING) && (pointerId == mActivePointerId)) {
                        // Try to find another pointer that's still holding on to the captured view.
                        int newActivePointer = android.support.v4.widget.ViewDragHelper.INVALID_POINTER;
                        final int pointerCount = ev.getPointerCount();
                        for (int i = 0; i < pointerCount; i++) {
                        ...
                        if (newActivePointer == android.support.v4.widget.ViewDragHelper.INVALID_POINTER) {
    ...
    private void reportNewEdgeDrags(float dx, float dy, int pointerId) {
        int dragsStarted = 0;
        if (checkNewEdgeDrag(dx, dy, pointerId, android.support.v4.widget.ViewDragHelper.EDGE_LEFT)) {
            dragsStarted |= android.support.v4.widget.ViewDragHelper.EDGE_LEFT;
        }
        if (checkNewEdgeDrag(dy, dx, pointerId, android.support.v4.widget.ViewDragHelper.EDGE_TOP)) {
            dragsStarted |= android.support.v4.widget.ViewDragHelper.EDGE_TOP;
        }
        if (checkNewEdgeDrag(dx, dy, pointerId, android.support.v4.widget.ViewDragHelper.EDGE_RIGHT)) {
            dragsStarted |= android.support.v4.widget.ViewDragHelper.EDGE_RIGHT;
        }
        if (checkNewEdgeDrag(dy, dx, pointerId, android.support.v4.widget.ViewDragHelper.EDGE_BOTTOM)) {
            dragsStarted |= android.support.v4.widget.ViewDragHelper.EDGE_BOTTOM;
        }
        if (dragsStarted != 0) {
    ...
    public boolean checkTouchSlop(int directions, int pointerId) {
        ...
        final boolean checkHorizontal = (directions & android.support.v4.widget.ViewDragHelper.DIRECTION_HORIZONTAL) == android.support.v4.widget.ViewDragHelper.DIRECTION_HORIZONTAL;
        final boolean checkVertical = (directions & android.support.v4.widget.ViewDragHelper.DIRECTION_VERTICAL) == android.support.v4.widget.ViewDragHelper.DIRECTION_VERTICAL;
    ...
    private void dragTo(int left, int top, int dx, int dy) {
        ...
        if (dx != 0) {
            ...
            android.support.v4.view.ViewCompat.offsetLeftAndRight(mCapturedView, clampedX - oldLeft);
        }
        if (dy != 0) {
            clampedY = mCallback.clampViewPositionVertical(mCapturedView, top, dy);
            android.support.v4.view.ViewCompat.offsetTopAndBottom(mCapturedView, clampedY - oldTop);
        }
        if ((dx != 0) || (dy != 0)) {
    ...
    private int getEdgesTouched(int x, int y) {
        ...
        if (x < (mParentView.getLeft() + mEdgeSize))
            result |= android.support.v4.widget.ViewDragHelper.EDGE_LEFT;

        if (y < (mParentView.getTop() + mEdgeSize))
            result |= android.support.v4.widget.ViewDragHelper.EDGE_TOP;

        if (x > (mParentView.getRight() - mEdgeSize))
            result |= android.support.v4.widget.ViewDragHelper.EDGE_RIGHT;

        if (y > (mParentView.getBottom() - mEdgeSize))
            result |= android.support.v4.widget.ViewDragHelper.EDGE_BOTTOM;
    ...
    private boolean isValidPointerForActionMove(int pointerId) {
        if (!isPointerDown(pointerId)) {
            android.util.Log.e(android.support.v4.widget.ViewDragHelper.TAG, ((("Ignoring pointerId=" + pointerId) + " because ACTION_DOWN was not received ") + "for this pointer before ACTION_MOVE. It likely happened because ") + " ViewDragHelper did not receive all the events in the event stream.");
            return false;
        }
        return true;
    }
