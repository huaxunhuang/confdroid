...
public abstract class AutoScrollHelper implements android.view.View.OnTouchListener {
     ...
     */
    public static final float NO_MAX = java.lang.Float.MAX_VALUE;
     ...
     */
    final android.support.v4.widget.AutoScrollHelper.ClampedScroller mScroller = new android.support.v4.widget.AutoScrollHelper.ClampedScroller();
     ...
     */
    private float[] mRelativeEdges = new float[]{ android.support.v4.widget.AutoScrollHelper.RELATIVE_UNSPECIFIED, android.support.v4.widget.AutoScrollHelper.RELATIVE_UNSPECIFIED };

    /**
     * Clamping values for edge insets used to activate auto-scrolling.
     */
    private float[] mMaximumEdges = new float[]{ android.support.v4.widget.AutoScrollHelper.NO_MAX, android.support.v4.widget.AutoScrollHelper.NO_MAX };
     ...
     */
    private float[] mRelativeVelocity = new float[]{ android.support.v4.widget.AutoScrollHelper.RELATIVE_UNSPECIFIED, android.support.v4.widget.AutoScrollHelper.RELATIVE_UNSPECIFIED };

    /**
     * Clamping values used for scrolling velocity.
     */
    private float[] mMinimumVelocity = new float[]{ android.support.v4.widget.AutoScrollHelper.NO_MIN, android.support.v4.widget.AutoScrollHelper.NO_MIN };

    /**
     * Clamping values used for scrolling velocity.
     */
    private float[] mMaximumVelocity = new float[]{ android.support.v4.widget.AutoScrollHelper.NO_MAX, android.support.v4.widget.AutoScrollHelper.NO_MAX };
    ...
    // Default values.
    private static final int DEFAULT_EDGE_TYPE = android.support.v4.widget.AutoScrollHelper.EDGE_TYPE_INSIDE_EXTEND;

    private static final int DEFAULT_MINIMUM_VELOCITY_DIPS = 315;

    private static final int DEFAULT_MAXIMUM_VELOCITY_DIPS = 1575;

    private static final float DEFAULT_MAXIMUM_EDGE = android.support.v4.widget.AutoScrollHelper.NO_MAX;
    ...
    public AutoScrollHelper(android.view.View target) {
        mTarget = target;
        final android.util.DisplayMetrics metrics = android.content.res.Resources.getSystem().getDisplayMetrics();
        final int maxVelocity = ((int) ((android.support.v4.widget.AutoScrollHelper.DEFAULT_MAXIMUM_VELOCITY_DIPS * metrics.density) + 0.5F));
        final int minVelocity = ((int) ((android.support.v4.widget.AutoScrollHelper.DEFAULT_MINIMUM_VELOCITY_DIPS * metrics.density) + 0.5F));
        setMaximumVelocity(maxVelocity, maxVelocity);
        setMinimumVelocity(minVelocity, minVelocity);
        setEdgeType(android.support.v4.widget.AutoScrollHelper.DEFAULT_EDGE_TYPE);
        setMaximumEdges(android.support.v4.widget.AutoScrollHelper.DEFAULT_MAXIMUM_EDGE, android.support.v4.widget.AutoScrollHelper.DEFAULT_MAXIMUM_EDGE);
        setRelativeEdges(android.support.v4.widget.AutoScrollHelper.DEFAULT_RELATIVE_EDGE, android.support.v4.widget.AutoScrollHelper.DEFAULT_RELATIVE_EDGE);
        setRelativeVelocity(android.support.v4.widget.AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY, android.support.v4.widget.AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY);
        setActivationDelay(android.support.v4.widget.AutoScrollHelper.DEFAULT_ACTIVATION_DELAY);
        setRampUpDuration(android.support.v4.widget.AutoScrollHelper.DEFAULT_RAMP_UP_DURATION);
        setRampDownDuration(android.support.v4.widget.AutoScrollHelper.DEFAULT_RAMP_DOWN_DURATION);
    }
    ...
    public android.support.v4.widget.AutoScrollHelper setMaximumVelocity(float horizontalMax, float verticalMax) {
        mMaximumVelocity[android.support.v4.widget.AutoScrollHelper.HORIZONTAL] = horizontalMax / 1000.0F;
        mMaximumVelocity[android.support.v4.widget.AutoScrollHelper.VERTICAL] = verticalMax / 1000.0F;
        return this;
    }
    ...
    public android.support.v4.widget.AutoScrollHelper setMinimumVelocity(float horizontalMin, float verticalMin) {
        mMinimumVelocity[android.support.v4.widget.AutoScrollHelper.HORIZONTAL] = horizontalMin / 1000.0F;
        mMinimumVelocity[android.support.v4.widget.AutoScrollHelper.VERTICAL] = verticalMin / 1000.0F;
        return this;
    }
    ...
    public android.support.v4.widget.AutoScrollHelper setRelativeVelocity(float horizontal, float vertical) {
        mRelativeVelocity[android.support.v4.widget.AutoScrollHelper.HORIZONTAL] = horizontal / 1000.0F;
        mRelativeVelocity[android.support.v4.widget.AutoScrollHelper.VERTICAL] = vertical / 1000.0F;
        return this;
    }
    ...
    public android.support.v4.widget.AutoScrollHelper setRelativeEdges(float horizontal, float vertical) {
        mRelativeEdges[android.support.v4.widget.AutoScrollHelper.HORIZONTAL] = horizontal;
        mRelativeEdges[android.support.v4.widget.AutoScrollHelper.VERTICAL] = vertical;
        return this;
    }
    ...
    public android.support.v4.widget.AutoScrollHelper setMaximumEdges(float horizontalMax, float verticalMax) {
        mMaximumEdges[android.support.v4.widget.AutoScrollHelper.HORIZONTAL] = horizontalMax;
        mMaximumEdges[android.support.v4.widget.AutoScrollHelper.VERTICAL] = verticalMax;
        return this;
    }
    ...
    public boolean onTouch(android.view.View v, android.view.MotionEvent event) {
        ...
        switch (action) {
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                final float xTargetVelocity = computeTargetVelocity(android.support.v4.widget.AutoScrollHelper.HORIZONTAL, event.getX(), v.getWidth(), mTarget.getWidth());
                final float yTargetVelocity = computeTargetVelocity(android.support.v4.widget.AutoScrollHelper.VERTICAL, event.getY(), v.getHeight(), mTarget.getHeight());
    ...
    boolean shouldAnimate() {
        final android.support.v4.widget.AutoScrollHelper.ClampedScroller scroller = mScroller;
    ...
    private void startAnimating() {
        if (mRunnable == null) {
            mRunnable = new android.support.v4.widget.AutoScrollHelper.ScrollAnimationRunnable();
        }
        mAnimating = true;
        mNeedsReset = true;
        if ((!mAlreadyDelayed) && (mActivationDelay > 0)) {
            android.support.v4.view.ViewCompat.postOnAnimationDelayed(mTarget, mRunnable, mActivationDelay);
        } else {
            mRunnable.run();
        }
    ...
    private float computeTargetVelocity(int direction, float coordinate, float srcSize, float dstSize) {
        ...
        if (value > 0) {
            return android.support.v4.widget.AutoScrollHelper.constrain(value * targetVelocity, minimumVelocity, maximumVelocity);
        } else {
            return -android.support.v4.widget.AutoScrollHelper.constrain((-value) * targetVelocity, minimumVelocity, maximumVelocity);
        }
    }
    ...
    private float getEdgeValue(float relativeValue, float size, float maxValue, float current) {
        ...
        final float edgeSize = android.support.v4.widget.AutoScrollHelper.constrain(relativeValue * size, android.support.v4.widget.AutoScrollHelper.NO_MIN, maxValue);
        ...
        return android.support.v4.widget.AutoScrollHelper.constrain(interpolated, -1, 1);
    }
    ...
    private float constrainEdgeValue(float current, float leading) {
        ...
        switch (mEdgeType) {
            case android.support.v4.widget.AutoScrollHelper.EDGE_TYPE_INSIDE :
            case android.support.v4.widget.AutoScrollHelper.EDGE_TYPE_INSIDE_EXTEND :
                if (current < leading) {
                    if (current >= 0) {
                        // Movement up to the edge is scaled.
                        return 1.0F - (current / leading);
                    } else
                        if (mAnimating && (mEdgeType == android.support.v4.widget.AutoScrollHelper.EDGE_TYPE_INSIDE_EXTEND)) {
                ...
                break;
            case android.support.v4.widget.AutoScrollHelper.EDGE_TYPE_OUTSIDE :
                if (current < 0) {
    ...
    void cancelTargetTouch() {
        ...
        final android.view.MotionEvent cancel = android.view.MotionEvent.obtain(eventTime, eventTime, android.view.MotionEvent.ACTION_CANCEL, 0, 0, 0);
    ...
    private class ScrollAnimationRunnable implements java.lang.Runnable {
        ...
        public void run() {
            ...
            android.support.v4.view.ViewCompat.postOnAnimation(mTarget, this);
        }
    }
    ...
    private static class ClampedScroller {
         ...
         */
        ClampedScroller() {
            mStartTime = java.lang.Long.MIN_VALUE;
            mStopTime = -1;
            mDeltaTime = 0;
            mDeltaX = 0;
            mDeltaY = 0;
        ...
        public void requestStop() {
            ...
            mEffectiveRampDown = android.support.v4.widget.AutoScrollHelper.constrain(((int) (currentTime - mStartTime)), 0, mRampDownDuration);
            mStopValue = getValueAt(currentTime);
            mStopTime = currentTime;
        }

        public boolean isFinished() {
            return (mStopTime > 0) && (android.view.animation.AnimationUtils.currentAnimationTimeMillis() > (mStopTime + mEffectiveRampDown));
        }
        ...
        private float getValueAt(long currentTime) {
            if (currentTime < mStartTime) {
                ...
                if ((mStopTime < 0) || (currentTime < mStopTime)) {
                    final long elapsedSinceStart = currentTime - mStartTime;
                    return 0.5F * android.support.v4.widget.AutoScrollHelper.constrain(elapsedSinceStart / ((float) (mRampUpDuration)), 0, 1);
                } else {
                    final long elapsedSinceEnd = currentTime - mStopTime;
                    return (1 - mStopValue) + (mStopValue * android.support.v4.widget.AutoScrollHelper.constrain(elapsedSinceEnd / ((float) (mEffectiveRampDown)), 0, 1));
                }
        ...
        public int getHorizontalDirection() {
            return ((int) (mTargetVelocityX / java.lang.Math.abs(mTargetVelocityX)));
        }

        public int getVerticalDirection() {
            return ((int) (mTargetVelocityY / java.lang.Math.abs(mTargetVelocityY)));
        }
