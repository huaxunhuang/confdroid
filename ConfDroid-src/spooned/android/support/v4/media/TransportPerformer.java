...
public abstract class TransportPerformer {
    ...
    public int onGetTransportControlFlags() {
        return ((android.support.v4.media.TransportMediator.FLAG_KEY_MEDIA_PLAY | android.support.v4.media.TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE) | android.support.v4.media.TransportMediator.FLAG_KEY_MEDIA_PAUSE) | android.support.v4.media.TransportMediator.FLAG_KEY_MEDIA_STOP;
    }
    ...
    static final int AUDIOFOCUS_LOSS = (-1) * android.support.v4.media.TransportPerformer.AUDIOFOCUS_GAIN;

    static final int AUDIOFOCUS_LOSS_TRANSIENT = (-1) * android.support.v4.media.TransportPerformer.AUDIOFOCUS_GAIN_TRANSIENT;

    static final int AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK = (-1) * android.support.v4.media.TransportPerformer.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK;
    ...
    public void onAudioFocusChange(int focusChange) {
        int keyCode = 0;
        switch (focusChange) {
            case android.support.v4.media.TransportPerformer.AUDIOFOCUS_LOSS :
        ...
        if (keyCode != 0) {
            ...
            onMediaButtonDown(keyCode, new android.view.KeyEvent(now, now, android.view.KeyEvent.ACTION_DOWN, keyCode, 0));
            onMediaButtonUp(keyCode, new android.view.KeyEvent(now, now, android.view.KeyEvent.ACTION_UP, keyCode, 0));
        }
    }
}
