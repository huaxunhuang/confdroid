...
public class TransportMediator extends android.support.v4.media.TransportController {
    ...
    final java.util.ArrayList<android.support.v4.media.TransportStateListener> mListeners = new java.util.ArrayList<android.support.v4.media.TransportStateListener>();

    final android.support.v4.media.TransportMediatorCallback mTransportKeyCallback = new android.support.v4.media.TransportMediatorCallback() {
        @java.lang.Override
    ...
    static boolean isMediaKey(int keyCode) {
        switch (keyCode) {
            case android.support.v4.media.TransportMediator.KEYCODE_MEDIA_PLAY :
            case android.support.v4.media.TransportMediator.KEYCODE_MEDIA_PAUSE :
            ...
            case android.support.v4.media.TransportMediator.KEYCODE_MEDIA_RECORD :
    ...
    final android.view.KeyEvent.Callback mKeyEventCallback = new android.view.KeyEvent.Callback() {
        @java.lang.Override
        public boolean onKeyDown(int keyCode, android.view.KeyEvent event) {
            return android.support.v4.media.TransportMediator.isMediaKey(keyCode) ? mCallbacks.onMediaButtonDown(keyCode, event) : false;
        }
        ...
        public boolean onKeyUp(int keyCode, android.view.KeyEvent event) {
            return android.support.v4.media.TransportMediator.isMediaKey(keyCode) ? mCallbacks.onMediaButtonUp(keyCode, event) : false;
        }
    ...
    private TransportMediator(android.app.Activity activity, android.view.View view, android.support.v4.media.TransportPerformer callbacks) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= 18) {
            // JellyBean MR2
            mController = new android.support.v4.media.TransportMediatorJellybeanMR2(mContext, mAudioManager, mView, mTransportKeyCallback);
        } else {
            mController = null;
        }
    }
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        return event.dispatch(mKeyEventCallback, ((android.view.KeyEvent.DispatcherState) (mDispatcherState)), this);
    }
    ...
    private android.support.v4.media.TransportStateListener[] getListeners() {
        ...
        android.support.v4.media.TransportStateListener[] listeners = new android.support.v4.media.TransportStateListener[mListeners.size()];
