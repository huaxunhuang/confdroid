...
public abstract class VolumeProviderCompat {
    ...
    @android.support.annotation.IntDef({ android.support.v4.media.VolumeProviderCompat.VOLUME_CONTROL_FIXED, android.support.v4.media.VolumeProviderCompat.VOLUME_CONTROL_RELATIVE, android.support.v4.media.VolumeProviderCompat.VOLUME_CONTROL_ABSOLUTE })
     ...
     * 		The current volume.
     */
    public VolumeProviderCompat(@android.support.v4.media.VolumeProviderCompat.ControlType
    ...
    public java.lang.Object getVolumeProvider() {
        ...
        mVolumeProviderObj = android.support.v4.media.VolumeProviderCompatApi21.createVolumeProvider(mControlType, mMaxVolume, mCurrentVolume, new android.support.v4.media.VolumeProviderCompatApi21.Delegate() {
            @java.lang.Override
            public void onSetVolumeTo(int volume) {
    ...
    public static abstract class Callback {
        public abstract void onVolumeChanged(android.support.v4.media.VolumeProviderCompat volumeProvider);
    }
}
