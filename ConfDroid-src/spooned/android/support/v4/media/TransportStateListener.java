...
public class TransportStateListener {
     ...
     */
    public void onPlayingChanged(android.support.v4.media.TransportController controller) {
    }
     ...
     */
    public void onTransportControlsChanged(android.support.v4.media.TransportController controller) {
    }
}
