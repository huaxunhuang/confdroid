...
public final class IntentCompat {
    interface IntentCompatImpl {
        ...
        android.content.Intent makeMainSelectorActivity(java.lang.String selectorAction, java.lang.String selectorCategory);

        android.content.Intent makeRestartActivityTask(android.content.ComponentName mainActivity);
    }
    ...
    static class IntentCompatImplBase implements android.support.v4.content.IntentCompat.IntentCompatImpl {
        ...
        public android.content.Intent makeRestartActivityTask(android.content.ComponentName mainActivity) {
            ...
            intent.addFlags(android.content.Intent.FLAG_ACTIVITY_NEW_TASK | android.support.v4.content.IntentCompat.FLAG_ACTIVITY_CLEAR_TASK);
            return intent;
        }
    }
    ...
    public static android.content.Intent makeMainActivity(android.content.ComponentName mainActivity) {
        return android.support.v4.content.IntentCompat.IMPL.makeMainActivity(mainActivity);
    }
    ...
    public static android.content.Intent makeMainSelectorActivity(java.lang.String selectorAction, java.lang.String selectorCategory) {
        return android.support.v4.content.IntentCompat.IMPL.makeMainSelectorActivity(selectorAction, selectorCategory);
    }
    ...
    public static android.content.Intent makeRestartActivityTask(android.content.ComponentName mainActivity) {
        return android.support.v4.content.IntentCompat.IMPL.makeRestartActivityTask(mainActivity);
    }
}
