...
public class ContextCompat {
    ...
    public static boolean startActivities(android.content.Context context, android.content.Intent[] intents) {
        return android.support.v4.content.ContextCompat.startActivities(context, intents, null);
    }
     ...
     */
    public static void startActivity(android.content.Context context, android.content.Intent intent, @android.support.annotation.Nullable
    ...
    public static java.io.File getDataDir(android.content.Context context) {
        if (android.support.v4.os.BuildCompat.isAtLeastN()) {
            ...
            final java.lang.String dataDir = context.getApplicationInfo().dataDir;
            return dataDir != null ? new java.io.File(dataDir) : null;
        }
    }
    ...
    public static java.io.File[] getObbDirs(android.content.Context context) {
        ...
        if (version >= 19) {
            ...
            final java.io.File single;
            if (version >= 11) {
                single = android.support.v4.content.ContextCompatHoneycomb.getObbDir(context);
            } else {
                single = android.support.v4.content.ContextCompat.buildPath(android.os.Environment.getExternalStorageDirectory(), android.support.v4.content.ContextCompat.DIR_ANDROID, android.support.v4.content.ContextCompat.DIR_OBB, context.getPackageName());
            }
     ...
     */
    public static final android.graphics.drawable.Drawable getDrawable(android.content.Context context, @android.support.annotation.DrawableRes
    int id) {
        final int version = android.os.Build.VERSION.SDK_INT;
        if (version >= 21) {
            ...
            if (version >= 16) {
                ...
                synchronized(android.support.v4.content.ContextCompat.sLock) {
                    ...
                    context.getResources().getValue(id, android.support.v4.content.ContextCompat.sTempValue, true);
                    resolvedId = android.support.v4.content.ContextCompat.sTempValue.resourceId;
                }
     ...
     * 		does not exist.
     */
    public static final android.content.res.ColorStateList getColorStateList(android.content.Context context, @android.support.annotation.ColorRes
    int id) {
        final int version = android.os.Build.VERSION.SDK_INT;
        if (version >= 23) {
    ...
    public static final int getColor(android.content.Context context, @android.support.annotation.ColorRes
    int id) {
        final int version = android.os.Build.VERSION.SDK_INT;
        if (version >= 23) {
    ...
    public static final java.io.File getNoBackupFilesDir(android.content.Context context) {
        ...
        if (version >= 21) {
            ...
            return android.support.v4.content.ContextCompat.createFilesDir(new java.io.File(appInfo.dataDir, "no_backup"));
        }
    }
    ...
    public static java.io.File getCodeCacheDir(android.content.Context context) {
        ...
        if (version >= 21) {
            ...
            android.content.pm.ApplicationInfo appInfo = context.getApplicationInfo();
            return android.support.v4.content.ContextCompat.createFilesDir(new java.io.File(appInfo.dataDir, "code_cache"));
        }
    }
    ...
    private static synchronized java.io.File createFilesDir(java.io.File file) {
        if (!file.exists()) {
            if (!file.mkdirs()) {
                ...
                android.util.Log.w(android.support.v4.content.ContextCompat.TAG, "Unable to create files subdir " + file.getPath());
                return null;
            }
        }
        return file;
