...
public class FileProvider extends android.content.ContentProvider {
    private static final java.lang.String[] COLUMNS = new java.lang.String[]{ android.provider.OpenableColumns.DISPLAY_NAME, android.provider.OpenableColumns.SIZE };
    ...
    // @GuardedBy("sCache")
    private static java.util.HashMap<java.lang.String, android.support.v4.content.FileProvider.PathStrategy> sCache = new java.util.HashMap<java.lang.String, android.support.v4.content.FileProvider.PathStrategy>();
     ...
     *
     * @param context
     * 		A {@link Context} for the current component.
     * @param info
     * 		A {@link ProviderInfo} for the new provider.
     */
    @java.lang.Override
    public void attachInfo(android.content.Context context, android.content.pm.ProviderInfo info) {
        ...
        mStrategy = android.support.v4.content.FileProvider.getPathStrategy(context, info.authority);
    }
     ...
     * @param file
     * 		A {@link File} pointing to the filename for which you want a
     * 		<code>content</code> {@link Uri}.
     * @return A content URI for the file.
     * @throws IllegalArgumentException
     * 		When the given {@link File} is outside
    ...
    public static android.net.Uri getUriForFile(android.content.Context context, java.lang.String authority, java.io.File file) {
        final android.support.v4.content.FileProvider.PathStrategy strategy = android.support.v4.content.FileProvider.getPathStrategy(context, authority);
     ...
     *
     * @param uri
     * 		A content URI returned by {@link #getUriForFile}.
     * @param projection
     * 		The list of columns to put into the {@link Cursor}. If null all columns are
     * 		included.
     * @param selection
     * 		Selection criteria to apply. If null then all data that matches the content
     * 		URI is returned.
     * @param selectionArgs
     * 		An array of {@link java.lang.String}, containing arguments to bind to
     * 		the <i>selection</i> parameter. The <i>query</i> method scans <i>selection</i> from left to
     * 		right and iterates through <i>selectionArgs</i>, replacing the current "?" character in
     * 		<i>selection</i> with the value at the current position in <i>selectionArgs</i>. The
     * 		values are bound to <i>selection</i> as {@link java.lang.String} values.
     * @param sortOrder
     * 		A {@link java.lang.String} containing the column name(s) on which to sort
    ...
    public android.database.Cursor query(android.net.Uri uri, java.lang.String[] projection, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String sortOrder) {
        ...
        final java.io.File file = mStrategy.getFileForUri(uri);
        if (projection == null) {
            projection = android.support.v4.content.FileProvider.COLUMNS;
        }
        ...
        int i = 0;
        for (java.lang.String col : projection) {
            if (android.provider.OpenableColumns.DISPLAY_NAME.equals(col)) {
                cols[i] = android.provider.OpenableColumns.DISPLAY_NAME;
                values[i++] = file.getName();
            } else
                if (android.provider.OpenableColumns.SIZE.equals(col)) {
                    cols[i] = android.provider.OpenableColumns.SIZE;
                    values[i++] = file.length();
                }

        }
        cols = android.support.v4.content.FileProvider.copyOf(cols, i);
        values = android.support.v4.content.FileProvider.copyOf(values, i);
        final android.database.MatrixCursor cursor = new android.database.MatrixCursor(cols, 1);
    ...
    public java.lang.String getType(android.net.Uri uri) {
        ...
        if (lastDot >= 0) {
            final java.lang.String extension = file.getName().substring(lastDot + 1);
    ...
    public android.os.ParcelFileDescriptor openFile(android.net.Uri uri, java.lang.String mode) throws java.io.FileNotFoundException {
        // ContentProvider has already checked granted permissions
        final java.io.File file = mStrategy.getFileForUri(uri);
        final int fileMode = android.support.v4.content.FileProvider.modeToMode(mode);
    ...
    private static android.support.v4.content.FileProvider.PathStrategy getPathStrategy(android.content.Context context, java.lang.String authority) {
        ...
        synchronized(android.support.v4.content.FileProvider.sCache) {
            strat = android.support.v4.content.FileProvider.sCache.get(authority);
            if (strat == null) {
                try {
                    strat = android.support.v4.content.FileProvider.parsePathStrategy(context, authority);
                } catch (java.io.IOException e) {
                    throw new java.lang.IllegalArgumentException(("Failed to parse " + android.support.v4.content.FileProvider.META_DATA_FILE_PROVIDER_PATHS) + " meta-data", e);
                } catch (org.xmlpull.v1.XmlPullParserException e) {
                    throw new java.lang.IllegalArgumentException(("Failed to parse " + android.support.v4.content.FileProvider.META_DATA_FILE_PROVIDER_PATHS) + " meta-data", e);
                }
                android.support.v4.content.FileProvider.sCache.put(authority, strat);
            }
        }
        return strat;
    }
    ...
    private static android.support.v4.content.FileProvider.PathStrategy parsePathStrategy(android.content.Context context, java.lang.String authority) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        final android.support.v4.content.FileProvider.SimplePathStrategy strat = new android.support.v4.content.FileProvider.SimplePathStrategy(authority);
        final android.content.pm.ProviderInfo info = context.getPackageManager().resolveContentProvider(authority, android.content.pm.PackageManager.GET_META_DATA);
        final android.content.res.XmlResourceParser in = info.loadXmlMetaData(context.getPackageManager(), android.support.v4.content.FileProvider.META_DATA_FILE_PROVIDER_PATHS);
        if (in == null) {
            throw new java.lang.IllegalArgumentException(("Missing " + android.support.v4.content.FileProvider.META_DATA_FILE_PROVIDER_PATHS) + " meta-data");
        }
        int type;
        while ((type = in.next()) != org.xmlpull.v1.XmlPullParser.END_DOCUMENT) {
            if (type == org.xmlpull.v1.XmlPullParser.START_TAG) {
                final java.lang.String tag = in.getName();
                final java.lang.String name = in.getAttributeValue(null, android.support.v4.content.FileProvider.ATTR_NAME);
                java.lang.String path = in.getAttributeValue(null, android.support.v4.content.FileProvider.ATTR_PATH);
                java.io.File target = null;
                if (android.support.v4.content.FileProvider.TAG_ROOT_PATH.equals(tag)) {
                    target = android.support.v4.content.FileProvider.DEVICE_ROOT;
                } else
                    if (android.support.v4.content.FileProvider.TAG_FILES_PATH.equals(tag)) {
                        target = context.getFilesDir();
                    } else
                        if (android.support.v4.content.FileProvider.TAG_CACHE_PATH.equals(tag)) {
                            target = context.getCacheDir();
                        } else
                            if (android.support.v4.content.FileProvider.TAG_EXTERNAL.equals(tag)) {
                                target = android.os.Environment.getExternalStorageDirectory();
                            } else
                                if (android.support.v4.content.FileProvider.TAG_EXTERNAL_FILES.equals(tag)) {
                                    java.io.File[] externalFilesDirs = android.support.v4.content.ContextCompat.getExternalFilesDirs(context, null);
                                    if (externalFilesDirs.length > 0) {
                                        target = externalFilesDirs[0];
                                    }
                                } else
                                    if (android.support.v4.content.FileProvider.TAG_EXTERNAL_CACHE.equals(tag)) {
                ...
                if (target != null) {
                    strat.addRoot(name, android.support.v4.content.FileProvider.buildPath(target, path));
                }
            }
        } 
        return strat;
    ...
    static class SimplePathStrategy implements android.support.v4.content.FileProvider.PathStrategy {
        ...
        private final java.util.HashMap<java.lang.String, java.io.File> mRoots = new java.util.HashMap<java.lang.String, java.io.File>();
        ...
        public android.net.Uri getUriForFile(java.io.File file) {
            ...
            for (java.util.Map.Entry<java.lang.String, java.io.File> root : mRoots.entrySet()) {
                final java.lang.String rootPath = root.getValue().getPath();
                if (path.startsWith(rootPath) && ((mostSpecific == null) || (rootPath.length() > mostSpecific.getValue().getPath().length()))) {
                    mostSpecific = root;
                }
            }
            if (mostSpecific == null) {
                throw new java.lang.IllegalArgumentException("Failed to find configured root that contains " + path);
            }
            // Start at first char of path under root
            final java.lang.String rootPath = mostSpecific.getValue().getPath();
            ...
            path = (android.net.Uri.encode(mostSpecific.getKey()) + '/') + android.net.Uri.encode(path, "/");
            return new android.net.Uri.Builder().scheme("content").authority(mAuthority).encodedPath(path).build();
        }
        ...
        public java.io.File getFileForUri(android.net.Uri uri) {
            ...
            final java.lang.String tag = android.net.Uri.decode(path.substring(1, splitIndex));
            path = android.net.Uri.decode(path.substring(splitIndex + 1));
            final java.io.File root = mRoots.get(tag);
            if (root == null) {
    ...
    private static java.lang.String[] copyOf(java.lang.String[] original, int newLength) {
        final java.lang.String[] result = new java.lang.String[newLength];
    ...
    private static java.lang.Object[] copyOf(java.lang.Object[] original, int newLength) {
        final java.lang.Object[] result = new java.lang.Object[newLength];
        java.lang.System.arraycopy(original, 0, result, 0, newLength);
        return result;
    }
}
