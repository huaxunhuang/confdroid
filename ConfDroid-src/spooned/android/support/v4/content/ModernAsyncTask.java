...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final java.util.concurrent.ThreadFactory sThreadFactory = new java.util.concurrent.ThreadFactory() {
        ...
        public java.lang.Thread newThread(java.lang.Runnable r) {
            return new java.lang.Thread(r, "ModernAsyncTask #" + mCount.getAndIncrement());
        }
    };

    private static final java.util.concurrent.BlockingQueue<java.lang.Runnable> sPoolWorkQueue = new java.util.concurrent.LinkedBlockingQueue<java.lang.Runnable>(10);

    /**
     * An {@link Executor} that can be used to execute tasks in parallel.
     */
    public static final java.util.concurrent.Executor THREAD_POOL_EXECUTOR = new java.util.concurrent.ThreadPoolExecutor(android.support.v4.content.ModernAsyncTask.CORE_POOL_SIZE, android.support.v4.content.ModernAsyncTask.MAXIMUM_POOL_SIZE, android.support.v4.content.ModernAsyncTask.KEEP_ALIVE, java.util.concurrent.TimeUnit.SECONDS, android.support.v4.content.ModernAsyncTask.sPoolWorkQueue, android.support.v4.content.ModernAsyncTask.sThreadFactory);
    ...
    private static volatile java.util.concurrent.Executor sDefaultExecutor = android.support.v4.content.ModernAsyncTask.THREAD_POOL_EXECUTOR;
    ...
    public static void setDefaultExecutor(java.util.concurrent.Executor exec) {
        android.support.v4.content.ModernAsyncTask.sDefaultExecutor = exec;
    }
    ...
    public ModernAsyncTask() {
        mWorker = new android.support.v4.content.ModernAsyncTask.WorkerRunnable<Params, Result>() {
            @java.lang.Override
    ...
    Result postResult(Result result) {
        android.os.Message message = android.support.v4.content.ModernAsyncTask.getHandler().obtainMessage(android.support.v4.content.ModernAsyncTask.MESSAGE_POST_RESULT, new android.support.v4.content.ModernAsyncTask.AsyncTaskResult<Result>(this, result));
    ...
    public final android.support.v4.content.ModernAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(android.support.v4.content.ModernAsyncTask.sDefaultExecutor, params);
    }
    ...
    public final android.support.v4.content.ModernAsyncTask<Params, Progress, Result> executeOnExecutor(java.util.concurrent.Executor exec, Params... params) {
        if (mStatus != android.support.v4.content.ModernAsyncTask.Status.PENDING) {
            switch (mStatus) {
                case RUNNING :
        ...
        mStatus = android.support.v4.content.ModernAsyncTask.Status.RUNNING;
        onPreExecute();
    ...
    public static void execute(java.lang.Runnable runnable) {
        android.support.v4.content.ModernAsyncTask.sDefaultExecutor.execute(runnable);
    }
    ...
    protected final void publishProgress(Progress... values) {
        if (!isCancelled()) {
            android.support.v4.content.ModernAsyncTask.getHandler().obtainMessage(android.support.v4.content.ModernAsyncTask.MESSAGE_POST_PROGRESS, new android.support.v4.content.ModernAsyncTask.AsyncTaskResult<Progress>(this, values)).sendToTarget();
        }
    }
    ...
    void finish(Result result) {
        ...
        mStatus = android.support.v4.content.ModernAsyncTask.Status.FINISHED;
    }
    ...
    private static class InternalHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                case android.support.v4.content.ModernAsyncTask.MESSAGE_POST_RESULT :
                    // There is only one result
                    result.mTask.finish(result.mData[0]);
                    break;
                case android.support.v4.content.ModernAsyncTask.MESSAGE_POST_PROGRESS :
