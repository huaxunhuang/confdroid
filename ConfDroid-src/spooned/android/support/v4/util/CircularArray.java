...
public final class CircularArray<E> {
    ...
    private void doubleCapacity() {
        ...
        java.lang.Object[] a = new java.lang.Object[newCapacity];
        java.lang.System.arraycopy(mElements, mHead, a, 0, r);
        java.lang.System.arraycopy(mElements, 0, a, r, mHead);
        mElements = ((E[]) (a));
        mHead = 0;
        mTail = n;
    ...
    public CircularArray(int minCapacity) {
        ...
        if (java.lang.Integer.bitCount(minCapacity) != 1) {
            arrayCapacity = java.lang.Integer.highestOneBit(minCapacity - 1) << 1;
        } else {
            arrayCapacity = minCapacity;
        }
        mCapacityBitmask = arrayCapacity - 1;
        mElements = ((E[]) (new java.lang.Object[arrayCapacity]));
    }
