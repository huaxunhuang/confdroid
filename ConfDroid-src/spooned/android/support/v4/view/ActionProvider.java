 ...
 * calling {@link android.support.v4.view.MenuItemCompat#setActionProvider(android.view.MenuItem, ActionProvider)}.
 * </li>
 *
...
public abstract class ActionProvider {
     ...
     * receive a call to {@link #onPrepareSubMenu(SubMenu)} after the call to {@link #onPerformDefaultAction()} and before a submenu is displayed to the user.
     *
     ...
     *
     * @unknown Pending future API approval
     */
    ...
    public void setVisibilityListener(android.support.v4.view.ActionProvider.VisibilityListener listener) {
        if ((mVisibilityListener != null) && (listener != null)) {
            android.util.Log.w(android.support.v4.view.ActionProvider.TAG, (("setVisibilityListener: Setting a new ActionProvider.VisibilityListener " + "when one is already set. Are you reusing this ") + getClass().getSimpleName()) + " instance while it is still in use somewhere else?");
        }
