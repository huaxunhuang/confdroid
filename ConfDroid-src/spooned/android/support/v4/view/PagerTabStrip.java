...
public class PagerTabStrip extends android.support.v4.view.PagerTitleStrip {
    ...
    private static final int MIN_PADDING_BOTTOM = android.support.v4.view.PagerTabStrip.INDICATOR_HEIGHT + 3;// dp
    ...
    private static final int MIN_TEXT_SPACING = android.support.v4.view.PagerTabStrip.TAB_SPACING + (android.support.v4.view.PagerTabStrip.TAB_PADDING * 2);// dp
    ...
    private final android.graphics.Paint mTabPaint = new android.graphics.Paint();
    ...
    public PagerTabStrip(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        mIndicatorHeight = ((int) ((android.support.v4.view.PagerTabStrip.INDICATOR_HEIGHT * density) + 0.5F));
        mMinPaddingBottom = ((int) ((android.support.v4.view.PagerTabStrip.MIN_PADDING_BOTTOM * density) + 0.5F));
        mMinTextSpacing = ((int) (android.support.v4.view.PagerTabStrip.MIN_TEXT_SPACING * density));
        mTabPadding = ((int) ((android.support.v4.view.PagerTabStrip.TAB_PADDING * density) + 0.5F));
        mFullUnderlineHeight = ((int) ((android.support.v4.view.PagerTabStrip.FULL_UNDERLINE_HEIGHT * density) + 0.5F));
        mMinStripHeight = ((int) ((android.support.v4.view.PagerTabStrip.MIN_STRIP_HEIGHT * density) + 0.5F));
     ...
     */
    public void setTabIndicatorColor(@android.support.annotation.ColorInt
    int color) {
     ...
     */
    public void setTabIndicatorColorResource(@android.support.annotation.ColorRes
    int resId) {
        setTabIndicatorColor(android.support.v4.content.ContextCompat.getColor(getContext(), resId));
    }
    ...
    @java.lang.Override
    int getMinHeight() {
        return java.lang.Math.max(super.getMinHeight(), mMinStripHeight);
    }

    @java.lang.Override
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        final int action = ev.getAction();
        if ((action != android.view.MotionEvent.ACTION_DOWN) && mIgnoreTap) {
            return false;
        }
        ...
        switch (action) {
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                if ((java.lang.Math.abs(x - mInitialMotionX) > mTouchSlop) || (java.lang.Math.abs(y - mInitialMotionY) > mTouchSlop)) {
                    mIgnoreTap = true;
                }
                break;
            case android.view.MotionEvent.ACTION_UP :
                if (x < (mCurrText.getLeft() - mTabPadding)) {
                    ...
                    if (x > (mCurrText.getRight() + mTabPadding)) {
                        mPager.setCurrentItem(mPager.getCurrentItem() + 1);
                    }
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        final android.graphics.Rect r = mTempRect;
        ...
        mTabAlpha = ((int) ((java.lang.Math.abs(positionOffset - 0.5F) * 2) * 0xff));
