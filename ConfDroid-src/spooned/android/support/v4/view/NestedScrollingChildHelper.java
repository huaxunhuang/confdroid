...
public class NestedScrollingChildHelper {
    ...
    public void setNestedScrollingEnabled(boolean enabled) {
        if (mIsNestedScrollingEnabled) {
            android.support.v4.view.ViewCompat.stopNestedScroll(mView);
        }
    ...
    public boolean startNestedScroll(int axes) {
        ...
        if (isNestedScrollingEnabled()) {
            android.view.ViewParent p = mView.getParent();
            android.view.View child = mView;
            while (p != null) {
                if (android.support.v4.view.ViewParentCompat.onStartNestedScroll(p, child, mView, axes)) {
                    mNestedScrollingParent = p;
                    android.support.v4.view.ViewParentCompat.onNestedScrollAccepted(p, child, mView, axes);
                    return true;
                }
    ...
    public void stopNestedScroll() {
        if (mNestedScrollingParent != null) {
            android.support.v4.view.ViewParentCompat.onStopNestedScroll(mNestedScrollingParent, mView);
    ...
    public boolean dispatchNestedScroll(int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed, int[] offsetInWindow) {
        if (isNestedScrollingEnabled() && (mNestedScrollingParent != null)) {
            if ((((dxConsumed != 0) || (dyConsumed != 0)) || (dxUnconsumed != 0)) || (dyUnconsumed != 0)) {
                ...
                android.support.v4.view.ViewParentCompat.onNestedScroll(mNestedScrollingParent, mView, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed);
                if (offsetInWindow != null) {
                    mView.getLocationInWindow(offsetInWindow);
    ...
    public boolean dispatchNestedPreScroll(int dx, int dy, int[] consumed, int[] offsetInWindow) {
        if (isNestedScrollingEnabled() && (mNestedScrollingParent != null)) {
            if ((dx != 0) || (dy != 0)) {
                ...
                consumed[0] = 0;
                consumed[1] = 0;
                android.support.v4.view.ViewParentCompat.onNestedPreScroll(mNestedScrollingParent, mView, dx, dy, consumed);
                if (offsetInWindow != null) {
                    mView.getLocationInWindow(offsetInWindow);
                    offsetInWindow[0] -= startX;
                    offsetInWindow[1] -= startY;
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        if (isNestedScrollingEnabled() && (mNestedScrollingParent != null)) {
            return android.support.v4.view.ViewParentCompat.onNestedFling(mNestedScrollingParent, mView, velocityX, velocityY, consumed);
        }
        return false;
    }
    ...
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        if (isNestedScrollingEnabled() && (mNestedScrollingParent != null)) {
            return android.support.v4.view.ViewParentCompat.onNestedPreFling(mNestedScrollingParent, mView, velocityX, velocityY);
        }
        return false;
    }
