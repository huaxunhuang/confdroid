...
public final class ViewParentCompat {
    interface ViewParentCompatImpl {
        ...
        boolean onStartNestedScroll(android.view.ViewParent parent, android.view.View child, android.view.View target, int nestedScrollAxes);

        void onNestedScrollAccepted(android.view.ViewParent parent, android.view.View child, android.view.View target, int nestedScrollAxes);

        void onStopNestedScroll(android.view.ViewParent parent, android.view.View target);

        void onNestedScroll(android.view.ViewParent parent, android.view.View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed);

        void onNestedPreScroll(android.view.ViewParent parent, android.view.View target, int dx, int dy, int[] consumed);

        boolean onNestedFling(android.view.ViewParent parent, android.view.View target, float velocityX, float velocityY, boolean consumed);

        boolean onNestedPreFling(android.view.ViewParent parent, android.view.View target, float velocityX, float velocityY);

        void notifySubtreeAccessibilityStateChanged(android.view.ViewParent parent, android.view.View child, android.view.View source, int changeType);
    }
    ...
    static class ViewParentCompatStubImpl implements android.support.v4.view.ViewParentCompat.ViewParentCompatImpl {
        ...
        public boolean requestSendAccessibilityEvent(android.view.ViewParent parent, android.view.View child, android.view.accessibility.AccessibilityEvent event) {
            ...
            final android.view.accessibility.AccessibilityManager manager = ((android.view.accessibility.AccessibilityManager) (child.getContext().getSystemService(android.content.Context.ACCESSIBILITY_SERVICE)));
    ...
    public static boolean requestSendAccessibilityEvent(android.view.ViewParent parent, android.view.View child, android.view.accessibility.AccessibilityEvent event) {
        return android.support.v4.view.ViewParentCompat.IMPL.requestSendAccessibilityEvent(parent, child, event);
    }
     ...
     * 		Flags consisting of {@link ViewCompat#SCROLL_AXIS_HORIZONTAL},
    ...
    public static boolean onStartNestedScroll(android.view.ViewParent parent, android.view.View child, android.view.View target, int nestedScrollAxes) {
        return android.support.v4.view.ViewParentCompat.IMPL.onStartNestedScroll(parent, child, target, nestedScrollAxes);
    }
    ...
    public static void onNestedScrollAccepted(android.view.ViewParent parent, android.view.View child, android.view.View target, int nestedScrollAxes) {
        android.support.v4.view.ViewParentCompat.IMPL.onNestedScrollAccepted(parent, child, target, nestedScrollAxes);
    }
    ...
    public static void onStopNestedScroll(android.view.ViewParent parent, android.view.View target) {
        android.support.v4.view.ViewParentCompat.IMPL.onStopNestedScroll(parent, target);
    }
    ...
    public static void onNestedScroll(android.view.ViewParent parent, android.view.View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        android.support.v4.view.ViewParentCompat.IMPL.onNestedScroll(parent, target, dxConsumed, dyConsumed, dxUnconsumed, dyUnconsumed);
    }
    ...
    public static void onNestedPreScroll(android.view.ViewParent parent, android.view.View target, int dx, int dy, int[] consumed) {
        android.support.v4.view.ViewParentCompat.IMPL.onNestedPreScroll(parent, target, dx, dy, consumed);
    }
    ...
    public static boolean onNestedFling(android.view.ViewParent parent, android.view.View target, float velocityX, float velocityY, boolean consumed) {
        return android.support.v4.view.ViewParentCompat.IMPL.onNestedFling(parent, target, velocityX, velocityY, consumed);
    }
    ...
    public static boolean onNestedPreFling(android.view.ViewParent parent, android.view.View target, float velocityX, float velocityY) {
        return android.support.v4.view.ViewParentCompat.IMPL.onNestedPreFling(parent, target, velocityX, velocityY);
    }
    ...
    public static void notifySubtreeAccessibilityStateChanged(android.view.ViewParent parent, android.view.View child, android.view.View source, int changeType) {
        android.support.v4.view.ViewParentCompat.IMPL.notifySubtreeAccessibilityStateChanged(parent, child, source, changeType);
    }
}
