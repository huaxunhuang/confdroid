...
public class ViewPager extends android.view.ViewGroup {
    ...
    private static final java.util.Comparator<android.support.v4.view.ViewPager.ItemInfo> COMPARATOR = new java.util.Comparator<android.support.v4.view.ViewPager.ItemInfo>() {
        @java.lang.Override
    ...
    private final java.util.ArrayList<android.support.v4.view.ViewPager.ItemInfo> mItems = new java.util.ArrayList<android.support.v4.view.ViewPager.ItemInfo>();

    private final android.support.v4.view.ViewPager.ItemInfo mTempItem = new android.support.v4.view.ViewPager.ItemInfo();
    ...
    private android.os.Parcelable mRestoredAdapterState = null;
    ...
    private float mFirstOffset = -java.lang.Float.MAX_VALUE;

    private float mLastOffset = java.lang.Float.MAX_VALUE;
    ...
    private int mOffscreenPageLimit = android.support.v4.view.ViewPager.DEFAULT_OFFSCREEN_PAGES;
     ...
     */
    private int mActivePointerId = android.support.v4.view.ViewPager.INVALID_POINTER;
    ...
    private final java.lang.Runnable mEndScrollRunnable = new java.lang.Runnable() {
        @java.lang.Override
        public void run() {
            setScrollState(android.support.v4.view.ViewPager.SCROLL_STATE_IDLE);
            populate();
        }
    };

    private int mScrollState = android.support.v4.view.ViewPager.SCROLL_STATE_IDLE;
    ...
    public interface OnAdapterChangeListener {
         ...
         *
         * @param viewPager
         * 		ViewPager where the adapter change has happened
         * @param oldAdapter
         * 		the previously set adapter
         * @param newAdapter
         * 		the newly set adapter
         */
        void onAdapterChanged(@android.support.annotation.NonNull
    ...
    void initViewPager() {
        ...
        mScroller = new android.widget.Scroller(context, android.support.v4.view.ViewPager.sInterpolator);
        final android.view.ViewConfiguration configuration = android.view.ViewConfiguration.get(context);
        final float density = context.getResources().getDisplayMetrics().density;
        mTouchSlop = configuration.getScaledPagingTouchSlop();
        mMinimumVelocity = ((int) (android.support.v4.view.ViewPager.MIN_FLING_VELOCITY * density));
        ...
        mFlingDistance = ((int) (android.support.v4.view.ViewPager.MIN_DISTANCE_FOR_FLING * density));
        mCloseEnough = ((int) (android.support.v4.view.ViewPager.CLOSE_ENOUGH * density));
        mDefaultGutterSize = ((int) (android.support.v4.view.ViewPager.DEFAULT_GUTTER_SIZE * density));
        ...
        android.support.v4.view.ViewCompat.setOnApplyWindowInsetsListener(this, new android.support.v4.view.OnApplyWindowInsetsListener() {
            ...
            @java.lang.Override
            public android.support.v4.view.WindowInsetsCompat onApplyWindowInsets(final android.view.View v, final android.support.v4.view.WindowInsetsCompat originalInsets) {
                // First let the ViewPager itself try and consume them...
                final android.support.v4.view.WindowInsetsCompat applied = android.support.v4.view.ViewCompat.onApplyWindowInsets(v, originalInsets);
                ...
                final android.graphics.Rect res = mTempRect;
                res.left = applied.getSystemWindowInsetLeft();
                res.top = applied.getSystemWindowInsetTop();
                res.right = applied.getSystemWindowInsetRight();
                res.bottom = applied.getSystemWindowInsetBottom();
                for (int i = 0, count = getChildCount(); i < count; i++) {
                    final android.support.v4.view.WindowInsetsCompat childInsets = android.support.v4.view.ViewCompat.dispatchApplyWindowInsets(getChildAt(i), applied);
                    // Now keep track of any consumed by tracking each dimension's min
                    // value
                    res.left = java.lang.Math.min(childInsets.getSystemWindowInsetLeft(), res.left);
                    res.top = java.lang.Math.min(childInsets.getSystemWindowInsetTop(), res.top);
                    res.right = java.lang.Math.min(childInsets.getSystemWindowInsetRight(), res.right);
                    res.bottom = java.lang.Math.min(childInsets.getSystemWindowInsetBottom(), res.bottom);
                }
    ...
    void setScrollState(int newState) {
        ...
        if (mPageTransformer != null) {
            ...
            enableLayers(newState != android.support.v4.view.ViewPager.SCROLL_STATE_IDLE);
        }
    ...
    public void setAdapter(android.support.v4.view.PagerAdapter adapter) {
        if (mAdapter != null) {
            ...
            for (int i = 0; i < mItems.size(); i++) {
                final android.support.v4.view.ViewPager.ItemInfo ii = mItems.get(i);
        ...
        if (mAdapter != null) {
            if (mObserver == null) {
                mObserver = new android.support.v4.view.ViewPager.PagerObserver();
            }
     ...
     * 		listener to add
     */
    public void addOnAdapterChangeListener(@android.support.annotation.NonNull
    android.support.v4.view.ViewPager.OnAdapterChangeListener listener) {
        if (mAdapterChangeListeners == null) {
            mAdapterChangeListeners = new java.util.ArrayList<>();
        }
     ...
     * 		listener to remove
     */
    public void removeOnAdapterChangeListener(@android.support.annotation.NonNull
    android.support.v4.view.ViewPager.OnAdapterChangeListener listener) {
        if (mAdapterChangeListeners != null) {
    ...
    private void scrollToItem(int item, boolean smoothScroll, int velocity, boolean dispatchSelected) {
        final android.support.v4.view.ViewPager.ItemInfo curInfo = infoForPosition(item);
        int destX = 0;
        if (curInfo != null) {
            final int width = getClientWidth();
            destX = ((int) (width * java.lang.Math.max(mFirstOffset, java.lang.Math.min(curInfo.offset, mLastOffset))));
        }
        if (smoothScroll) {
    ...
    public void addOnPageChangeListener(android.support.v4.view.ViewPager.OnPageChangeListener listener) {
        if (mOnPageChangeListeners == null) {
            mOnPageChangeListeners = new java.util.ArrayList<>();
        }
    ...
    public void setPageTransformer(boolean reverseDrawingOrder, android.support.v4.view.ViewPager.PageTransformer transformer) {
        setPageTransformer(reverseDrawingOrder, transformer, android.support.v4.view.ViewCompat.LAYER_TYPE_HARDWARE);
    }
     ...
     * 		PageTransformer that will modify each page's animation properties
     * @param pageLayerType
     * 		View layer type that should be used for ViewPager pages. It should be
     * 		either {@link ViewCompat#LAYER_TYPE_HARDWARE},
     * 		{@link ViewCompat#LAYER_TYPE_SOFTWARE}, or
     * 		{@link ViewCompat#LAYER_TYPE_NONE}.
     */
    public void setPageTransformer(boolean reverseDrawingOrder, android.support.v4.view.ViewPager.PageTransformer transformer, int pageLayerType) {
        if (android.os.Build.VERSION.SDK_INT >= 11) {
            ...
            if (hasTransformer) {
                mDrawingOrder = (reverseDrawingOrder) ? android.support.v4.view.ViewPager.DRAW_ORDER_REVERSE : android.support.v4.view.ViewPager.DRAW_ORDER_FORWARD;
                mPageTransformerLayerType = pageLayerType;
            } else {
                mDrawingOrder = android.support.v4.view.ViewPager.DRAW_ORDER_DEFAULT;
            }
            if (needsPopulate)
                populate();
    ...
    void setChildrenDrawingOrderEnabledCompat(boolean enable) {
        if (android.os.Build.VERSION.SDK_INT >= 7) {
            if (mSetChildrenDrawingOrderEnabled == null) {
                try {
                    mSetChildrenDrawingOrderEnabled = android.view.ViewGroup.class.getDeclaredMethod("setChildrenDrawingOrderEnabled", new java.lang.Class[]{ java.lang.Boolean.TYPE });
                } catch (java.lang.NoSuchMethodException e) {
                    android.util.Log.e(android.support.v4.view.ViewPager.TAG, "Can't find setChildrenDrawingOrderEnabled", e);
                }
            }
            try {
                mSetChildrenDrawingOrderEnabled.invoke(this, enable);
            } catch (java.lang.Exception e) {
                android.util.Log.e(android.support.v4.view.ViewPager.TAG, "Error changing children drawing order", e);
            }
        }
    }
    ...
    protected int getChildDrawingOrder(int childCount, int i) {
        final int index = (mDrawingOrder == android.support.v4.view.ViewPager.DRAW_ORDER_REVERSE) ? (childCount - 1) - i : i;
        final int result = ((android.support.v4.view.ViewPager.LayoutParams) (mDrawingOrderedChildren.get(index).getLayoutParams())).childIndex;
        return result;
    }
    ...
    public void setOffscreenPageLimit(int limit) {
        if (limit < android.support.v4.view.ViewPager.DEFAULT_OFFSCREEN_PAGES) {
            android.util.Log.w(android.support.v4.view.ViewPager.TAG, (("Requested offscreen page limit " + limit) + " too small; defaulting to ") + android.support.v4.view.ViewPager.DEFAULT_OFFSCREEN_PAGES);
            limit = android.support.v4.view.ViewPager.DEFAULT_OFFSCREEN_PAGES;
        }
     ...
     */
    public void setPageMarginDrawable(@android.support.annotation.DrawableRes
    int resId) {
        setPageMarginDrawable(android.support.v4.content.ContextCompat.getDrawable(getContext(), resId));
    }
    ...
    protected void drawableStateChanged() {
        ...
        final android.graphics.drawable.Drawable d = mMarginDrawable;
    ...
    void smoothScrollTo(int x, int y, int velocity) {
        ...
        setScrollState(android.support.v4.view.ViewPager.SCROLL_STATE_SETTLING);
        final int width = getClientWidth();
        final int halfWidth = width / 2;
        final float distanceRatio = java.lang.Math.min(1.0F, (1.0F * java.lang.Math.abs(dx)) / width);
        ...
        if (velocity > 0) {
            ...
            final float pageDelta = ((float) (java.lang.Math.abs(dx))) / (pageWidth + mPageMargin);
            duration = ((int) ((pageDelta + 1) * 100));
        }
        duration = java.lang.Math.min(duration, android.support.v4.view.ViewPager.MAX_SETTLE_DURATION);
    ...
    void dataSetChanged() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (newPos == android.support.v4.view.PagerAdapter.POSITION_NONE) {
                ...
                if (mCurItem == ii.position) {
                    ...
                    newCurrItem = java.lang.Math.max(0, java.lang.Math.min(mCurItem, adapterCount - 1));
                    needPopulate = true;
                }
                continue;
            }
        ...
        java.util.Collections.sort(mItems, android.support.v4.view.ViewPager.COMPARATOR);
        if (needPopulate) {
    ...
    void populate(int newCurrentItem) {
        ...
        if (mPopulatePending) {
            if (android.support.v4.view.ViewPager.DEBUG)
                android.util.Log.i(android.support.v4.view.ViewPager.TAG, "populate is pending, skipping for now...");
        ...
        mAdapter.startUpdate(this);
        final int pageLimit = mOffscreenPageLimit;
        final int startPos = java.lang.Math.max(0, mCurItem - pageLimit);
        final int N = mAdapter.getCount();
        final int endPos = java.lang.Math.min(N - 1, mCurItem + pageLimit);
        if (N != mExpectedAdapterCount) {
            ...
            throw new java.lang.IllegalStateException(((((((((("The application's PagerAdapter changed the adapter's" + (" contents without calling PagerAdapter#notifyDataSetChanged!" + " Expected adapter item count: ")) + mExpectedAdapterCount) + ", found: ") + N) + " Pager id: ") + resName) + " Pager class: ") + getClass()) + " Problematic adapter: ") + mAdapter.getClass());
        }
        // Locate the currently focused item or add it if needed.
        int curIndex = -1;
        android.support.v4.view.ViewPager.ItemInfo curItem = null;
        for (curIndex = 0; curIndex < mItems.size(); curIndex++) {
            final android.support.v4.view.ViewPager.ItemInfo ii = mItems.get(curIndex);
            if (ii.position >= mCurItem) {
                if (ii.position == mCurItem)
                    curItem = ii;
        ...
        if (curItem != null) {
            ...
            android.support.v4.view.ViewPager.ItemInfo ii = (itemIndex >= 0) ? mItems.get(itemIndex) : null;
            final int clientWidth = getClientWidth();
            final float leftWidthNeeded = (clientWidth <= 0) ? 0 : (2.0F - curItem.widthFactor) + (((float) (getPaddingLeft())) / ((float) (clientWidth)));
            for (int pos = mCurItem - 1; pos >= 0; pos--) {
                if ((extraWidthLeft >= leftWidthNeeded) && (pos < startPos)) {
                    ...
                    if ((pos == ii.position) && (!ii.scrolling)) {
                        ...
                        if (android.support.v4.view.ViewPager.DEBUG) {
                            android.util.Log.i(android.support.v4.view.ViewPager.TAG, (("populate() - destroyItem() with pos: " + pos) + " view: ") + ((android.view.View) (ii.object)));
                        }
                        itemIndex--;
                        curIndex--;
            ...
            if (extraWidthRight < 2.0F) {
                ...
                final float rightWidthNeeded = (clientWidth <= 0) ? 0 : (((float) (getPaddingRight())) / ((float) (clientWidth))) + 2.0F;
        ...
        if (android.support.v4.view.ViewPager.DEBUG) {
            android.util.Log.i(android.support.v4.view.ViewPager.TAG, "Current page list:");
            for (int i = 0; i < mItems.size(); i++) {
                android.util.Log.i(android.support.v4.view.ViewPager.TAG, (("#" + i) + ": page ") + mItems.get(i).position);
            }
        }
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if ((!lp.isDecor) && (lp.widthFactor == 0.0F)) {
                ...
                final android.support.v4.view.ViewPager.ItemInfo ii = infoForChild(child);
                if (ii != null) {
        ...
        if (hasFocus()) {
            ...
            android.support.v4.view.ViewPager.ItemInfo ii = (currentFocused != null) ? infoForAnyChild(currentFocused) : null;
            if ((ii == null) || (ii.position != mCurItem)) {
                for (int i = 0; i < getChildCount(); i++) {
                    android.view.View child = getChildAt(i);
                    ii = infoForChild(child);
                    if ((ii != null) && (ii.position == mCurItem)) {
                        if (child.requestFocus(android.view.View.FOCUS_FORWARD)) {
                            break;
                        }
                    }
                }
    ...
    private void sortChildDrawingOrder() {
        if (mDrawingOrder != android.support.v4.view.ViewPager.DRAW_ORDER_DEFAULT) {
            if (mDrawingOrderedChildren == null) {
                mDrawingOrderedChildren = new java.util.ArrayList<android.view.View>();
            } else {
            ...
            java.util.Collections.sort(mDrawingOrderedChildren, android.support.v4.view.ViewPager.sPositionComparator);
        }
    }
    ...
    private void calculatePageOffsets(android.support.v4.view.ViewPager.ItemInfo curItem, int curIndex, android.support.v4.view.ViewPager.ItemInfo oldCurInfo) {
        ...
        if (oldCurInfo != null) {
            ...
            if (oldCurPosition < curItem.position) {
                int itemIndex = 0;
                android.support.v4.view.ViewPager.ItemInfo ii = null;
        ...
        mFirstOffset = (curItem.position == 0) ? curItem.offset : -java.lang.Float.MAX_VALUE;
        mLastOffset = (curItem.position == (N - 1)) ? (curItem.offset + curItem.widthFactor) - 1 : java.lang.Float.MAX_VALUE;
        // Previous pages
    ...
    public static class SavedState extends android.support.v4.view.AbsSavedState {
        ...
        public java.lang.String toString() {
            return ((("FragmentPager.SavedState{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " position=") + position) + "}";
        }

        public static final android.os.Parcelable.Creator<android.support.v4.view.ViewPager.SavedState> CREATOR = android.support.v4.os.ParcelableCompat.newCreator(new android.support.v4.os.ParcelableCompatCreatorCallbacks<android.support.v4.view.ViewPager.SavedState>() {
            @java.lang.Override
    ...
    public void addView(android.view.View child, int index, android.view.ViewGroup.LayoutParams params) {
        ...
        final android.support.v4.view.ViewPager.LayoutParams lp = ((android.support.v4.view.ViewPager.LayoutParams) (params));
        // Any views added via inflation should be classed as part of the decor
        lp.isDecor |= android.support.v4.view.ViewPager.isDecorView(child);
        if (mInLayout) {
        ...
        if (android.support.v4.view.ViewPager.USE_CACHE) {
    ...
    private static boolean isDecorView(@android.support.annotation.NonNull
    android.view.View view) {
        java.lang.Class<?> clazz = view.getClass();
        return clazz.getAnnotation(android.support.v4.view.ViewPager.DecorView.class) != null;
    }
    ...
    android.support.v4.view.ViewPager.ItemInfo infoForChild(android.view.View child) {
        for (int i = 0; i < mItems.size(); i++) {
            android.support.v4.view.ViewPager.ItemInfo ii = mItems.get(i);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        setMeasuredDimension(android.view.View.getDefaultSize(0, widthMeasureSpec), android.view.View.getDefaultSize(0, heightMeasureSpec));
        final int measuredWidth = getMeasuredWidth();
        final int maxGutterSize = measuredWidth / 10;
        mGutterSize = java.lang.Math.min(maxGutterSize, mDefaultGutterSize);
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (child.getVisibility() != android.view.View.GONE) {
                final android.support.v4.view.ViewPager.LayoutParams lp = ((android.support.v4.view.ViewPager.LayoutParams) (child.getLayoutParams()));
                if ((lp != null) && lp.isDecor) {
                    final int hgrav = lp.gravity & android.view.Gravity.HORIZONTAL_GRAVITY_MASK;
                    final int vgrav = lp.gravity & android.view.Gravity.VERTICAL_GRAVITY_MASK;
                    int widthMode = android.view.View.MeasureSpec.AT_MOST;
                    int heightMode = android.view.View.MeasureSpec.AT_MOST;
                    boolean consumeVertical = (vgrav == android.view.Gravity.TOP) || (vgrav == android.view.Gravity.BOTTOM);
                    boolean consumeHorizontal = (hgrav == android.view.Gravity.LEFT) || (hgrav == android.view.Gravity.RIGHT);
                    if (consumeVertical) {
                    ...
                    if (lp.width != android.support.v4.view.ViewPager.LayoutParams.WRAP_CONTENT) {
                        widthMode = android.view.View.MeasureSpec.EXACTLY;
                        if (lp.width != android.support.v4.view.ViewPager.LayoutParams.MATCH_PARENT) {
                            widthSize = lp.width;
                        }
                    }
                    if (lp.height != android.support.v4.view.ViewPager.LayoutParams.WRAP_CONTENT) {
                        heightMode = android.view.View.MeasureSpec.EXACTLY;
                        if (lp.height != android.support.v4.view.ViewPager.LayoutParams.MATCH_PARENT) {
                            heightSize = lp.height;
                        }
                    }
                    final int widthSpec = android.view.View.MeasureSpec.makeMeasureSpec(widthSize, widthMode);
                    final int heightSpec = android.view.View.MeasureSpec.makeMeasureSpec(heightSize, heightMode);
        ...
        mChildWidthMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(childWidthSize, android.view.View.MeasureSpec.EXACTLY);
        mChildHeightMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(childHeightSize, android.view.View.MeasureSpec.EXACTLY);
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (child.getVisibility() != android.view.View.GONE) {
                if (android.support.v4.view.ViewPager.DEBUG) {
                    android.util.Log.v(android.support.v4.view.ViewPager.TAG, (((("Measuring #" + i) + " ") + child) + ": ") + mChildWidthMeasureSpec);
                }
                final android.support.v4.view.ViewPager.LayoutParams lp = ((android.support.v4.view.ViewPager.LayoutParams) (child.getLayoutParams()));
                if ((lp == null) || (!lp.isDecor)) {
                    final int widthSpec = android.view.View.MeasureSpec.makeMeasureSpec(((int) (childWidthSize * lp.widthFactor)), android.view.View.MeasureSpec.EXACTLY);
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        if ((oldWidth > 0) && (!mItems.isEmpty())) {
            ...
            final android.support.v4.view.ViewPager.ItemInfo ii = infoForPosition(mCurItem);
            final float scrollOffset = (ii != null) ? java.lang.Math.min(ii.offset, mLastOffset) : 0;
            ...
            if (child.getVisibility() != android.view.View.GONE) {
                ...
                if ((!lp.isDecor) && ((ii = infoForChild(child)) != null)) {
                    ...
                    if (lp.needsMeasure) {
                        ...
                        final int widthSpec = android.view.View.MeasureSpec.makeMeasureSpec(((int) (childWidth * lp.widthFactor)), android.view.View.MeasureSpec.EXACTLY);
                        final int heightSpec = android.view.View.MeasureSpec.makeMeasureSpec(((int) ((height - paddingTop) - paddingBottom)), android.view.View.MeasureSpec.EXACTLY);
                        child.measure(widthSpec, heightSpec);
                    }
                    if (android.support.v4.view.ViewPager.DEBUG) {
                        android.util.Log.v(android.support.v4.view.ViewPager.TAG, (((((((((((("Positioning #" + i) + " ") + child) + " f=") + ii.object) + ":") + childLeft) + ",") + childTop) + " ") + child.getMeasuredWidth()) + "x") + child.getMeasuredHeight());
                    }
                    child.layout(childLeft, childTop, childLeft + child.getMeasuredWidth(), childTop + child.getMeasuredHeight());
                }
            }
    ...
    private boolean pageScrolled(int xpos) {
        ...
        final android.support.v4.view.ViewPager.ItemInfo ii = infoForCurrentScrollPosition();
        final int width = getClientWidth();
    ...
    private void completeScroll(boolean postEvents) {
        boolean needPopulate = mScrollState == android.support.v4.view.ViewPager.SCROLL_STATE_SETTLING;
        if (needPopulate) {
    ...
    private void enableLayers(boolean enable) {
        final int childCount = getChildCount();
        for (int i = 0; i < childCount; i++) {
            final int layerType = (enable) ? mPageTransformerLayerType : android.support.v4.view.ViewCompat.LAYER_TYPE_NONE;
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent ev) {
        ...
        if ((action == android.view.MotionEvent.ACTION_CANCEL) || (action == android.view.MotionEvent.ACTION_UP)) {
            // Release the drag.
            if (android.support.v4.view.ViewPager.DEBUG)
                android.util.Log.v(android.support.v4.view.ViewPager.TAG, "Intercept done!");
        ...
        if (action != android.view.MotionEvent.ACTION_DOWN) {
            if (mIsBeingDragged) {
                if (android.support.v4.view.ViewPager.DEBUG)
                    android.util.Log.v(android.support.v4.view.ViewPager.TAG, "Intercept returning true!");

                return true;
            }
            if (mIsUnableToDrag) {
                if (android.support.v4.view.ViewPager.DEBUG)
                    android.util.Log.v(android.support.v4.view.ViewPager.TAG, "Intercept returning false!");
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                {
                    ...
                    if (activePointerId == android.support.v4.view.ViewPager.INVALID_POINTER) {
                    ...
                    final float xDiff = java.lang.Math.abs(dx);
                    final float y = ev.getY(pointerIndex);
                    final float yDiff = java.lang.Math.abs(y - mInitialMotionY);
                    if (android.support.v4.view.ViewPager.DEBUG)
                        android.util.Log.v(android.support.v4.view.ViewPager.TAG, (((((("Moved x to " + x) + ",") + y) + " diff=") + xDiff) + ",") + yDiff);
                    ...
                    if ((xDiff > mTouchSlop) && ((xDiff * 0.5F) > yDiff)) {
                        if (android.support.v4.view.ViewPager.DEBUG)
                            android.util.Log.v(android.support.v4.view.ViewPager.TAG, "Starting drag!");

                        mIsBeingDragged = true;
                        requestParentDisallowInterceptTouchEvent(true);
                        setScrollState(android.support.v4.view.ViewPager.SCROLL_STATE_DRAGGING);
                        ...
                        if (yDiff > mTouchSlop) {
                            ...
                            if (android.support.v4.view.ViewPager.DEBUG)
                                android.util.Log.v(android.support.v4.view.ViewPager.TAG, "Starting unable to drag!");
            ...
            case android.view.MotionEvent.ACTION_DOWN :
                {
                    ...
                    if ((mScrollState == android.support.v4.view.ViewPager.SCROLL_STATE_SETTLING) && (java.lang.Math.abs(mScroller.getFinalX() - mScroller.getCurrX()) > mCloseEnough)) {
                    ...
                    if (android.support.v4.view.ViewPager.DEBUG) {
                        android.util.Log.v(android.support.v4.view.ViewPager.TAG, (((((("Down at " + mLastMotionX) + ",") + mLastMotionY) + " mIsBeingDragged=") + mIsBeingDragged) + "mIsUnableToDrag=") + mIsUnableToDrag);
                    }
                    break;
                }
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        ...
        if ((ev.getAction() == android.view.MotionEvent.ACTION_DOWN) && (ev.getEdgeFlags() != 0)) {
        ...
        switch (action & android.support.v4.view.MotionEventCompat.ACTION_MASK) {
            ...
            case android.view.MotionEvent.ACTION_MOVE :
                if (!mIsBeingDragged) {
                    ...
                    final float x = ev.getX(pointerIndex);
                    final float xDiff = java.lang.Math.abs(x - mLastMotionX);
                    final float y = ev.getY(pointerIndex);
                    final float yDiff = java.lang.Math.abs(y - mLastMotionY);
                    if (android.support.v4.view.ViewPager.DEBUG) {
                        android.util.Log.v(android.support.v4.view.ViewPager.TAG, (((((("Moved x to " + x) + ",") + y) + " diff=") + xDiff) + ",") + yDiff);
                    }
            ...
            case android.view.MotionEvent.ACTION_UP :
                if (mIsBeingDragged) {
                    ...
                    int initialVelocity = ((int) (android.support.v4.view.VelocityTrackerCompat.getXVelocity(velocityTracker, mActivePointerId)));
    ...
    private boolean resetTouch() {
        ...
        mActivePointerId = android.support.v4.view.ViewPager.INVALID_POINTER;
        endDrag();
    ...
    private boolean performDrag(float x) {
        ...
        final android.support.v4.view.ViewPager.ItemInfo firstItem = mItems.get(0);
        final android.support.v4.view.ViewPager.ItemInfo lastItem = mItems.get(mItems.size() - 1);
        ...
        if (scrollX < leftBound) {
            if (leftAbsolute) {
                ...
                needsInvalidate = mLeftEdge.onPull(java.lang.Math.abs(over) / width);
            }
            scrollX = leftBound;
        } else
            if (scrollX > rightBound) {
                if (rightAbsolute) {
                    ...
                    needsInvalidate = mRightEdge.onPull(java.lang.Math.abs(over) / width);
                }
                scrollX = rightBound;
            }
    ...
    private int determineTargetPage(int currentPage, float pageOffset, int velocity, int deltaX) {
        int targetPage;
        if ((java.lang.Math.abs(deltaX) > mFlingDistance) && (java.lang.Math.abs(velocity) > mMinimumVelocity)) {
        ...
        if (mItems.size() > 0) {
            ...
            targetPage = java.lang.Math.max(firstItem.position, java.lang.Math.min(targetPage, lastItem.position));
        }
        return targetPage;
    }
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        if ((overScrollMode == android.view.View.OVER_SCROLL_ALWAYS) || (((overScrollMode == android.view.View.OVER_SCROLL_IF_CONTENT_SCROLLS) && (mAdapter != null)) && (mAdapter.getCount() > 1))) {
    ...
    protected void onDraw(android.graphics.Canvas canvas) {
        ...
        if ((((mPageMargin > 0) && (mMarginDrawable != null)) && (mItems.size() > 0)) && (mAdapter != null)) {
            ...
            final float marginOffset = ((float) (mPageMargin)) / width;
            int itemIndex = 0;
            android.support.v4.view.ViewPager.ItemInfo ii = mItems.get(0);
            ...
            for (int pos = firstPos; pos < lastPos; pos++) {
                ...
                if ((drawAt + mPageMargin) > scrollX) {
                    mMarginDrawable.setBounds(java.lang.Math.round(drawAt), mTopPageBounds, java.lang.Math.round(drawAt + mPageMargin), mBottomPageBounds);
    ...
    public boolean beginFakeDrag() {
        ...
        final android.view.MotionEvent ev = android.view.MotionEvent.obtain(time, time, android.view.MotionEvent.ACTION_DOWN, 0, 0, 0);
        mVelocityTracker.addMovement(ev);
        ev.recycle();
    ...
    public void fakeDragBy(float xOffset) {
        ...
        final long time = android.os.SystemClock.uptimeMillis();
        final android.view.MotionEvent ev = android.view.MotionEvent.obtain(mFakeDragBeginTime, time, android.view.MotionEvent.ACTION_MOVE, mLastMotionX, 0, 0);
        mVelocityTracker.addMovement(ev);
        ev.recycle();
    }
                ...
                case android.view.KeyEvent.KEYCODE_TAB :
                    if (android.os.Build.VERSION.SDK_INT >= 11) {
                        ...
                        if (android.support.v4.view.KeyEventCompat.hasNoModifiers(event)) {
                            handled = arrowScroll(android.view.View.FOCUS_FORWARD);
                        } else
                            if (android.support.v4.view.KeyEventCompat.hasModifiers(event, android.view.KeyEvent.META_SHIFT_ON)) {
                                handled = arrowScroll(android.view.View.FOCUS_BACKWARD);
                            }
     ...
     *
     * @param direction
     * 		The direction corresponding to the arrow key that was pressed. It should be
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (currentFocused == this) {
            ...
            if (currentFocused != null) {
                ...
                for (android.view.ViewParent parent = currentFocused.getParent(); parent instanceof android.view.ViewGroup; parent = parent.getParent()) {
                    if (parent == this) {
                        isChild = true;
                        break;
                    }
                ...
                if (!isChild) {
                    ...
                    android.util.Log.e(android.support.v4.view.ViewPager.TAG, ("arrowScroll tried to find focus based on non-child " + "current focused view ") + sb.toString());
                    currentFocused = null;
                }
            }
        ...
        if ((nextFocused != null) && (nextFocused != currentFocused)) {
            ...
            if ((direction == android.view.View.FOCUS_LEFT) || (direction == android.view.View.FOCUS_BACKWARD)) {
                // Trying to move left and nothing there; try to page.
                handled = pageLeft();
            } else
                if ((direction == android.view.View.FOCUS_RIGHT) || (direction == android.view.View.FOCUS_FORWARD)) {
    ...
    public void addFocusables(java.util.ArrayList<android.view.View> views, int direction, int focusableMode) {
        ...
        if (descendantFocusability != android.view.ViewGroup.FOCUS_BLOCK_DESCENDANTS) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (child.getVisibility() == android.view.View.VISIBLE) {
                    android.support.v4.view.ViewPager.ItemInfo ii = infoForChild(child);
                    if ((ii != null) && (ii.position == mCurItem)) {
        ...
        if ((descendantFocusability != android.view.ViewGroup.FOCUS_AFTER_DESCENDANTS) || (focusableCount == views.size())) {
            ...
            if ((((focusableMode & android.view.View.FOCUSABLES_TOUCH_MODE) == android.view.View.FOCUSABLES_TOUCH_MODE) && isInTouchMode()) && (!isFocusableInTouchMode())) {
                return;
            }
            if (views != null) {
                views.add(this);
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return (p instanceof android.support.v4.view.ViewPager.LayoutParams) && super.checkLayoutParams(p);
    }
    ...
    class MyAccessibilityDelegate extends android.support.v4.view.AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityEvent(android.view.View host, android.view.accessibility.AccessibilityEvent event) {
            ...
            final android.support.v4.view.accessibility.AccessibilityRecordCompat recordCompat = android.support.v4.view.accessibility.AccessibilityEventCompat.asRecord(event);
            recordCompat.setScrollable(canScroll());
            if ((event.getEventType() == android.support.v4.view.accessibility.AccessibilityEventCompat.TYPE_VIEW_SCROLLED) && (mAdapter != null)) {
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public LayoutParams(android.content.Context context, android.util.AttributeSet attrs) {
            super(context, attrs);
            final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, android.support.v4.view.ViewPager.LAYOUT_ATTRS);
            gravity = a.getInteger(0, android.view.Gravity.TOP);
            a.recycle();
        }
    }
    ...
    static class ViewPositionComparator implements java.util.Comparator<android.view.View> {
        ...
        public int compare(android.view.View lhs, android.view.View rhs) {
            final android.support.v4.view.ViewPager.LayoutParams llp = ((android.support.v4.view.ViewPager.LayoutParams) (lhs.getLayoutParams()));
            final android.support.v4.view.ViewPager.LayoutParams rlp = ((android.support.v4.view.ViewPager.LayoutParams) (rhs.getLayoutParams()));
