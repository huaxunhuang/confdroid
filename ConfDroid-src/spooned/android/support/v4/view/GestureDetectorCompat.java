...
public final class GestureDetectorCompat {
    ...
    static class GestureDetectorCompatImplBase implements android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImpl {
        ...
        private class GestureHandler extends android.os.Handler {
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.SHOW_PRESS :
                        mListener.onShowPress(mCurrentDownEvent);
                        break;
                    case android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.LONG_PRESS :
                        dispatchLongPress();
                        break;
                    case android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP :
        ...
        public GestureDetectorCompatImplBase(android.content.Context context, android.view.GestureDetector.OnGestureListener listener, android.os.Handler handler) {
            if (handler != null) {
                mHandler = new android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.GestureHandler(handler);
            } else {
                mHandler = new android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.GestureHandler();
            }
            mListener = listener;
        ...
        public boolean onTouchEvent(android.view.MotionEvent ev) {
            ...
            switch (action & android.support.v4.view.MotionEventCompat.ACTION_MASK) {
                ...
                case android.view.MotionEvent.ACTION_DOWN :
                    if (mDoubleTapListener != null) {
                        boolean hadTapMessage = mHandler.hasMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP);
                        if (hadTapMessage)
                            mHandler.removeMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP);
                        ...
                        if ((((mCurrentDownEvent != null) && (mPreviousUpEvent != null)) && hadTapMessage) && isConsideredDoubleTap(mCurrentDownEvent, mPreviousUpEvent, ev)) {
                            ...
                            // This is a first tap
                            mHandler.sendEmptyMessageDelayed(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP, android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT);
                        }
                    }
                    mDownFocusX = mLastFocusX = focusX;
                    mDownFocusY = mLastFocusY = focusY;
                    ...
                    if (mIsLongpressEnabled) {
                        mHandler.removeMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.LONG_PRESS);
                        mHandler.sendEmptyMessageAtTime(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.LONG_PRESS, (mCurrentDownEvent.getDownTime() + android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP_TIMEOUT) + android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.LONGPRESS_TIMEOUT);
                    }
                    mHandler.sendEmptyMessageAtTime(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.SHOW_PRESS, mCurrentDownEvent.getDownTime() + android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP_TIMEOUT);
                    ...
                    if (mIsDoubleTapping) {
                        ...
                        if (mAlwaysInTapRegion) {
                            ...
                            if (distance > mTouchSlopSquare) {
                                ...
                                mHandler.removeMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.TAP);
                                mHandler.removeMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.SHOW_PRESS);
                                mHandler.removeMessages(android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.LONG_PRESS);
                            }
                            if (distance > mTouchSlopSquare) {
        ...
        private boolean isConsideredDoubleTap(android.view.MotionEvent firstDown, android.view.MotionEvent firstUp, android.view.MotionEvent secondDown) {
            ...
            if ((secondDown.getEventTime() - firstUp.getEventTime()) > android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT) {
                return false;
            }
    ...
    public GestureDetectorCompat(android.content.Context context, android.view.GestureDetector.OnGestureListener listener, android.os.Handler handler) {
        if (android.os.Build.VERSION.SDK_INT > 17) {
            mImpl = new android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplJellybeanMr2(context, listener, handler);
        } else {
            mImpl = new android.support.v4.view.GestureDetectorCompat.GestureDetectorCompatImplBase(context, listener, handler);
        }
    }
