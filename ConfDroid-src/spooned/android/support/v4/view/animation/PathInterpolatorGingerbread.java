...
class PathInterpolatorGingerbread implements android.view.animation.Interpolator {
    ...
    public PathInterpolatorGingerbread(android.graphics.Path path) {
        final android.graphics.PathMeasure pathMeasure = /* forceClosed */
        new android.graphics.PathMeasure(path, false);
        final float pathLength = pathMeasure.getLength();
        final int numPoints = ((int) (pathLength / android.support.v4.view.animation.PathInterpolatorGingerbread.PRECISION)) + 1;
    ...
    public PathInterpolatorGingerbread(float controlX, float controlY) {
        this(android.support.v4.view.animation.PathInterpolatorGingerbread.createQuad(controlX, controlY));
    }

    public PathInterpolatorGingerbread(float controlX1, float controlY1, float controlX2, float controlY2) {
        this(android.support.v4.view.animation.PathInterpolatorGingerbread.createCubic(controlX1, controlY1, controlX2, controlY2));
    }
