...
public abstract class FragmentPagerAdapter extends android.support.v4.view.PagerAdapter {
    ...
    public java.lang.Object instantiateItem(android.view.ViewGroup container, int position) {
        ...
        java.lang.String name = android.support.v4.app.FragmentPagerAdapter.makeFragmentName(container.getId(), itemId);
        android.support.v4.app.Fragment fragment = mFragmentManager.findFragmentByTag(name);
        if (fragment != null) {
            if (android.support.v4.app.FragmentPagerAdapter.DEBUG)
                android.util.Log.v(android.support.v4.app.FragmentPagerAdapter.TAG, (("Attaching item #" + itemId) + ": f=") + fragment);

            mCurTransaction.attach(fragment);
        } else {
            fragment = getItem(position);
            if (android.support.v4.app.FragmentPagerAdapter.DEBUG)
                android.util.Log.v(android.support.v4.app.FragmentPagerAdapter.TAG, (("Adding item #" + itemId) + ": f=") + fragment);

            mCurTransaction.add(container.getId(), fragment, android.support.v4.app.FragmentPagerAdapter.makeFragmentName(container.getId(), itemId));
        }
    ...
    public void destroyItem(android.view.ViewGroup container, int position, java.lang.Object object) {
        ...
        if (android.support.v4.app.FragmentPagerAdapter.DEBUG)
            android.util.Log.v(android.support.v4.app.FragmentPagerAdapter.TAG, (((("Detaching item #" + getItemId(position)) + ": f=") + object) + " v=") + ((android.support.v4.app.Fragment) (object)).getView());
