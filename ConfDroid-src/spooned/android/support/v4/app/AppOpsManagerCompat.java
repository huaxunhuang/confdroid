...
public final class AppOpsManagerCompat {
    ...
    private static class AppOpsManagerImpl {
        ...
        public int noteOp(android.content.Context context, java.lang.String op, int uid, java.lang.String packageName) {
            return android.support.v4.app.AppOpsManagerCompat.MODE_IGNORED;
        }
     ...
     */
    public static java.lang.String permissionToOp(@android.support.annotation.NonNull
    java.lang.String permission) {
        return android.support.v4.app.AppOpsManagerCompat.IMPL.permissionToOp(permission);
    }
     ...
     */
    public static int noteOp(@android.support.annotation.NonNull
    android.content.Context context, @android.support.annotation.NonNull
    java.lang.String op, int uid, @android.support.annotation.NonNull
    java.lang.String packageName) {
        return android.support.v4.app.AppOpsManagerCompat.IMPL.noteOp(context, op, uid, packageName);
    }
     ...
     * 		If the app has been configured to crash on this op.
     */
    public static int noteProxyOp(@android.support.annotation.NonNull
    android.content.Context context, @android.support.annotation.NonNull
    java.lang.String op, @android.support.annotation.NonNull
    java.lang.String proxiedPackageName) {
        return android.support.v4.app.AppOpsManagerCompat.IMPL.noteProxyOp(context, op, proxiedPackageName);
    }
}
