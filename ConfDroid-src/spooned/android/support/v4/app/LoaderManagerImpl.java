...
class LoaderManagerImpl extends android.support.v4.app.LoaderManager {
    ...
    final android.support.v4.util.SparseArrayCompat<android.support.v4.app.LoaderManagerImpl.LoaderInfo> mLoaders = new android.support.v4.util.SparseArrayCompat<android.support.v4.app.LoaderManagerImpl.LoaderInfo>();
    ...
    final android.support.v4.util.SparseArrayCompat<android.support.v4.app.LoaderManagerImpl.LoaderInfo> mInactiveLoaders = new android.support.v4.util.SparseArrayCompat<android.support.v4.app.LoaderManagerImpl.LoaderInfo>();
    ...
    final class LoaderInfo implements android.support.v4.content.Loader.OnLoadCanceledListener<java.lang.Object> , android.support.v4.content.Loader.OnLoadCompleteListener<java.lang.Object> {
        final int mId;
        ...
        public void onLoadCanceled(android.support.v4.content.Loader<java.lang.Object> loader) {
            ...
            android.support.v4.app.LoaderManagerImpl.LoaderInfo pending = mPendingLoader;
            if (pending != null) {
        ...
        public void onLoadComplete(android.support.v4.content.Loader<java.lang.Object> loader, java.lang.Object data) {
            ...
            // clean it up.
            android.support.v4.app.LoaderManagerImpl.LoaderInfo info = mInactiveLoaders.get(mId);
        ...
        public java.lang.String toString() {
            ...
            sb.append(mId);
            sb.append(" : ");
            android.support.v4.util.DebugUtils.buildShortClassTag(mLoader, sb);
            sb.append("}}");
            return sb.toString();
        }
    ...
    void updateHostController(android.support.v4.app.FragmentHostCallback host) {
        mHost = host;
    }
    ...
    private android.support.v4.app.LoaderManagerImpl.LoaderInfo createLoader(int id, android.os.Bundle args, android.support.v4.app.LoaderManager.LoaderCallbacks<java.lang.Object> callback) {
        ...
        android.support.v4.content.Loader<java.lang.Object> loader = callback.onCreateLoader(id, args);
        info.mLoader = loader;
        return info;
    }
    ...
    public <D> android.support.v4.content.Loader<D> initLoader(int id, android.os.Bundle args, android.support.v4.app.LoaderManager.LoaderCallbacks<D> callback) {
        ...
        android.support.v4.app.LoaderManagerImpl.LoaderInfo info = mLoaders.get(id);
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, (("initLoader in " + this) + ": args=") + args);

        if (info == null) {
            // Loader doesn't already exist; create.
            info = createAndInstallLoader(id, args, ((android.support.v4.app.LoaderManager.LoaderCallbacks<java.lang.Object>) (callback)));
            if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Created new loader " + info);

        } else {
            if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Re-using existing loader " + info);

            info.mCallbacks = ((android.support.v4.app.LoaderManager.LoaderCallbacks<java.lang.Object>) (callback));
        }
        if (info.mHaveData && mStarted) {
            // If the loader has already generated its data, report it now.
            info.callOnLoadFinished(info.mLoader, info.mData);
        }
        return ((android.support.v4.content.Loader<D>) (info.mLoader));
    }
    ...
    public <D> android.support.v4.content.Loader<D> restartLoader(int id, android.os.Bundle args, android.support.v4.app.LoaderManager.LoaderCallbacks<D> callback) {
        ...
        android.support.v4.app.LoaderManagerImpl.LoaderInfo info = mLoaders.get(id);
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, (("restartLoader in " + this) + ": args=") + args);

        if (info != null) {
            android.support.v4.app.LoaderManagerImpl.LoaderInfo inactive = mInactiveLoaders.get(id);
            if (inactive != null) {
                if (info.mHaveData) {
                    ...
                    // that now.
                    if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                        android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Removing last inactive loader: " + info);
                    ...
                    if (!info.cancel()) {
                        ...
                        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Current loader is stopped; replacing");
                        ...
                        // finishes.
                        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Current loader is running; configuring pending loader");

                        if (info.mPendingLoader != null) {
                            if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                                android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Removing pending loader: " + info.mPendingLoader);

                            info.mPendingLoader.destroy();
                            info.mPendingLoader = null;
                        }
                        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Enqueuing as new pending loader");

                        info.mPendingLoader = createLoader(id, args, ((android.support.v4.app.LoaderManager.LoaderCallbacks<java.lang.Object>) (callback)));
                        return ((android.support.v4.content.Loader<D>) (info.mPendingLoader.mLoader));
                    }
                }
            } else {
                ...
                if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                    android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "  Making last loader inactive: " + info);
    ...
    public void destroyLoader(int id) {
        ...
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, (("destroyLoader in " + this) + " of ") + id);

        int idx = mLoaders.indexOfKey(id);
        if (idx >= 0) {
            android.support.v4.app.LoaderManagerImpl.LoaderInfo info = mLoaders.valueAt(idx);
            mLoaders.removeAt(idx);
            info.destroy();
        }
        idx = mInactiveLoaders.indexOfKey(id);
        if (idx >= 0) {
            android.support.v4.app.LoaderManagerImpl.LoaderInfo info = mInactiveLoaders.valueAt(idx);
    ...
    public <D> android.support.v4.content.Loader<D> getLoader(int id) {
        ...
        android.support.v4.app.LoaderManagerImpl.LoaderInfo loaderInfo = mLoaders.get(id);
        if (loaderInfo != null) {
    ...
    void doStart() {
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Starting in " + this);

        if (mStarted) {
            java.lang.RuntimeException e = new java.lang.RuntimeException("here");
            e.fillInStackTrace();
            android.util.Log.w(android.support.v4.app.LoaderManagerImpl.TAG, "Called doStart when already started: " + this, e);
            return;
        }
        mStarted = true;
    ...
    void doStop() {
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Stopping in " + this);

        if (!mStarted) {
            java.lang.RuntimeException e = new java.lang.RuntimeException("here");
            e.fillInStackTrace();
            android.util.Log.w(android.support.v4.app.LoaderManagerImpl.TAG, "Called doStop when not started: " + this, e);
            return;
        }
        for (int i = mLoaders.size() - 1; i >= 0; i--) {
    ...
    void doRetain() {
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Retaining in " + this);

        if (!mStarted) {
            java.lang.RuntimeException e = new java.lang.RuntimeException("here");
            e.fillInStackTrace();
            android.util.Log.w(android.support.v4.app.LoaderManagerImpl.TAG, "Called doRetain when not started: " + this, e);
            return;
        }
        mRetaining = true;
        mStarted = false;
    ...
    void finishRetain() {
        if (mRetaining) {
            if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Finished Retaining in " + this);
    ...
    void doDestroy() {
        if (!mRetaining) {
            if (android.support.v4.app.LoaderManagerImpl.DEBUG)
                android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Destroying Active in " + this);
        ...
        if (android.support.v4.app.LoaderManagerImpl.DEBUG)
            android.util.Log.v(android.support.v4.app.LoaderManagerImpl.TAG, "Destroying Inactive in " + this);
    ...
    public void dump(java.lang.String prefix, java.io.FileDescriptor fd, java.io.PrintWriter writer, java.lang.String[] args) {
        if (mLoaders.size() > 0) {
            ...
            for (int i = 0; i < mLoaders.size(); i++) {
                android.support.v4.app.LoaderManagerImpl.LoaderInfo li = mLoaders.valueAt(i);
                writer.print(prefix);
                writer.print("  #");
        ...
        if (mInactiveLoaders.size() > 0) {
            ...
            for (int i = 0; i < mInactiveLoaders.size(); i++) {
                android.support.v4.app.LoaderManagerImpl.LoaderInfo li = mInactiveLoaders.valueAt(i);
                writer.print(prefix);
                writer.print("  #");
    ...
    public boolean hasRunningLoaders() {
        ...
        for (int i = 0; i < count; i++) {
            final android.support.v4.app.LoaderManagerImpl.LoaderInfo li = mLoaders.valueAt(i);
