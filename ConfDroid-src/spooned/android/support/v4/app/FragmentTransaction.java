...
public abstract class FragmentTransaction {
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction add(android.support.v4.app.Fragment fragment, java.lang.String tag);

    /**
     * Calls {@link #add(int, Fragment, String)} with a null tag.
     */
    public abstract android.support.v4.app.FragmentTransaction add(@android.support.annotation.IdRes
    int containerViewId, android.support.v4.app.Fragment fragment);
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction add(@android.support.annotation.IdRes
    int containerViewId, android.support.v4.app.Fragment fragment, @android.support.annotation.Nullable
    java.lang.String tag);

    /**
     * Calls {@link #replace(int, Fragment, String)} with a null tag.
     */
    public abstract android.support.v4.app.FragmentTransaction replace(@android.support.annotation.IdRes
    int containerViewId, android.support.v4.app.Fragment fragment);
    ...
    @android.support.annotation.IntDef({ android.support.v4.app.FragmentTransaction.TRANSIT_NONE, android.support.v4.app.FragmentTransaction.TRANSIT_FRAGMENT_OPEN, android.support.v4.app.FragmentTransaction.TRANSIT_FRAGMENT_CLOSE, android.support.v4.app.FragmentTransaction.TRANSIT_FRAGMENT_FADE })
     ...
     */
    public static final int TRANSIT_FRAGMENT_OPEN = 1 | android.support.v4.app.FragmentTransaction.TRANSIT_ENTER_MASK;

    /**
     * Fragment is being removed from the stack
     */
    public static final int TRANSIT_FRAGMENT_CLOSE = 2 | android.support.v4.app.FragmentTransaction.TRANSIT_EXIT_MASK;

    /**
     * Fragment should simply fade in or out; that is, no strong navigation associated
     * with it except that it is appearing or disappearing for some reason.
     */
    public static final int TRANSIT_FRAGMENT_FADE = 3 | android.support.v4.app.FragmentTransaction.TRANSIT_ENTER_MASK;
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction setCustomAnimations(@android.support.annotation.AnimRes
    int enter, @android.support.annotation.AnimRes
    int exit);
    ...
    public abstract android.support.v4.app.FragmentTransaction setCustomAnimations(@android.support.annotation.AnimRes
    int enter, @android.support.annotation.AnimRes
    int exit, @android.support.annotation.AnimRes
    int popEnter, @android.support.annotation.AnimRes
    int popExit);
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction addSharedElement(android.view.View sharedElement, java.lang.String name);
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction setTransition(@android.support.v4.app.FragmentTransaction.Transit
    int transit);
     ...
     * animations.
     */
    public abstract android.support.v4.app.FragmentTransaction setTransitionStyle(@android.support.annotation.StyleRes
    int styleRes);
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction addToBackStack(@android.support.annotation.Nullable
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction setBreadCrumbTitle(@android.support.annotation.StringRes
    int res);
     ...
     */
    public abstract android.support.v4.app.FragmentTransaction setBreadCrumbTitle(java.lang.CharSequence text);
     ...
     * 		A string resource containing the title.
     */
    public abstract android.support.v4.app.FragmentTransaction setBreadCrumbShortTitle(@android.support.annotation.StringRes
    int res);
     ...
     * later if the locale changes.
     */
    public abstract android.support.v4.app.FragmentTransaction setBreadCrumbShortTitle(java.lang.CharSequence text);
