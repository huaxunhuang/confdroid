...
public class FragmentController {
    ...
    public int getActiveFragmentsCount() {
        final java.util.List<android.support.v4.app.Fragment> actives = mHost.mFragmentManager.mActive;
    ...
    public java.util.List<android.support.v4.app.Fragment> getActiveFragments(java.util.List<android.support.v4.app.Fragment> actives) {
        ...
        if (actives == null) {
            actives = new java.util.ArrayList<android.support.v4.app.Fragment>(getActiveFragmentsCount());
        }
    ...
    public void restoreAllState(android.os.Parcelable state, java.util.List<android.support.v4.app.Fragment> nonConfigList) {
        mHost.mFragmentManager.restoreAllState(state, new android.support.v4.app.FragmentManagerNonConfig(nonConfigList, null));
    }
    ...
    public java.util.List<android.support.v4.app.Fragment> retainNonConfig() {
        android.support.v4.app.FragmentManagerNonConfig nonconf = mHost.mFragmentManager.retainNonConfig();
