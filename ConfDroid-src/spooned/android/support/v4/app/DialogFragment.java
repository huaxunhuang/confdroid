...
public class DialogFragment extends android.support.v4.app.Fragment implements android.content.DialogInterface.OnCancelListener , android.content.DialogInterface.OnDismissListener {
    ...
    @android.support.annotation.IntDef({ android.support.v4.app.DialogFragment.STYLE_NORMAL, android.support.v4.app.DialogFragment.STYLE_NO_TITLE, android.support.v4.app.DialogFragment.STYLE_NO_FRAME, android.support.v4.app.DialogFragment.STYLE_NO_INPUT })
    ...
    int mStyle = android.support.v4.app.DialogFragment.STYLE_NORMAL;
     ...
     */
    public void setStyle(@android.support.v4.app.DialogFragment.DialogStyle
    int style, @android.support.annotation.StyleRes
    int theme) {
        mStyle = style;
        if ((mStyle == android.support.v4.app.DialogFragment.STYLE_NO_FRAME) || (mStyle == android.support.v4.app.DialogFragment.STYLE_NO_INPUT)) {
    ...
    void dismissInternal(boolean allowStateLoss) {
        ...
        mViewDestroyed = true;
        if (mBackStackId >= 0) {
            getFragmentManager().popBackStack(mBackStackId, android.support.v4.app.FragmentManager.POP_BACK_STACK_INCLUSIVE);
            mBackStackId = -1;
        } else {
    ...
    android.os.Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mStyle = savedInstanceState.getInt(android.support.v4.app.DialogFragment.SAVED_STYLE, android.support.v4.app.DialogFragment.STYLE_NORMAL);
            mTheme = savedInstanceState.getInt(android.support.v4.app.DialogFragment.SAVED_THEME, 0);
            mCancelable = savedInstanceState.getBoolean(android.support.v4.app.DialogFragment.SAVED_CANCELABLE, true);
            mShowsDialog = savedInstanceState.getBoolean(android.support.v4.app.DialogFragment.SAVED_SHOWS_DIALOG, mShowsDialog);
            mBackStackId = savedInstanceState.getInt(android.support.v4.app.DialogFragment.SAVED_BACK_STACK_ID, -1);
        }
    }
    ...
    public void onActivityCreated(android.os.Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            android.os.Bundle dialogState = savedInstanceState.getBundle(android.support.v4.app.DialogFragment.SAVED_DIALOG_STATE_TAG);
            if (dialogState != null) {
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        if (mDialog != null) {
            ...
            if (dialogState != null) {
                outState.putBundle(android.support.v4.app.DialogFragment.SAVED_DIALOG_STATE_TAG, dialogState);
            }
        }
        if (mStyle != android.support.v4.app.DialogFragment.STYLE_NORMAL) {
            outState.putInt(android.support.v4.app.DialogFragment.SAVED_STYLE, mStyle);
        }
        if (mTheme != 0) {
            outState.putInt(android.support.v4.app.DialogFragment.SAVED_THEME, mTheme);
        }
        if (!mCancelable) {
            outState.putBoolean(android.support.v4.app.DialogFragment.SAVED_CANCELABLE, mCancelable);
        }
        if (!mShowsDialog) {
            outState.putBoolean(android.support.v4.app.DialogFragment.SAVED_SHOWS_DIALOG, mShowsDialog);
        }
        if (mBackStackId != (-1)) {
            outState.putInt(android.support.v4.app.DialogFragment.SAVED_BACK_STACK_ID, mBackStackId);
        }
    }
