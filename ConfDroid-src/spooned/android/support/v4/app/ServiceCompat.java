...
public final class ServiceCompat {
    ...
    @android.support.annotation.IntDef(flag = true, value = { android.support.v4.app.ServiceCompat.STOP_FOREGROUND_REMOVE, android.support.v4.app.ServiceCompat.STOP_FOREGROUND_DETACH })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    public @interface StopForegroundFlags {}

    interface ServiceCompatImpl {
        void stopForeground(android.app.Service service, @android.support.v4.app.ServiceCompat.StopForegroundFlags
        int flags);
    }

    static class BaseServiceCompatImpl implements android.support.v4.app.ServiceCompat.ServiceCompatImpl {
        public void stopForeground(android.app.Service service, @android.support.v4.app.ServiceCompat.StopForegroundFlags
        int flags) {
            service.stopForeground((flags & android.support.v4.app.ServiceCompat.STOP_FOREGROUND_REMOVE) != 0);
        }
    }
     ...
     */
    public static void stopForeground(android.app.Service service, @android.support.v4.app.ServiceCompat.StopForegroundFlags
    int flags) {
        android.support.v4.app.ServiceCompat.IMPL.stopForeground(service, flags);
    }
}
