...
class ActivityCompat21 {
    ...
    public static void setEnterSharedElementCallback(android.app.Activity activity, android.support.v4.app.ActivityCompat21.SharedElementCallback21 callback) {
        activity.setEnterSharedElementCallback(android.support.v4.app.ActivityCompat21.createCallback(callback));
    }

    public static void setExitSharedElementCallback(android.app.Activity activity, android.support.v4.app.ActivityCompat21.SharedElementCallback21 callback) {
        activity.setExitSharedElementCallback(android.support.v4.app.ActivityCompat21.createCallback(callback));
    }
    ...
    private static android.app.SharedElementCallback createCallback(android.support.v4.app.ActivityCompat21.SharedElementCallback21 callback) {
        android.app.SharedElementCallback newListener = null;
        if (callback != null) {
            newListener = new android.support.v4.app.ActivityCompat21.SharedElementCallbackImpl(callback);
        }
        return newListener;
    }
    ...
    private static class SharedElementCallbackImpl extends android.app.SharedElementCallback {
        ...
        public SharedElementCallbackImpl(android.support.v4.app.ActivityCompat21.SharedElementCallback21 callback) {
            mCallback = callback;
        }
