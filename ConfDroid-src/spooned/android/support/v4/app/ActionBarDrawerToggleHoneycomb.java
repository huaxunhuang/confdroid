...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static java.lang.Object setActionBarUpIndicator(java.lang.Object info, android.app.Activity activity, android.graphics.drawable.Drawable drawable, int contentDescRes) {
        ...
        final android.support.v4.app.ActionBarDrawerToggleHoneycomb.SetIndicatorInfo sii = ((android.support.v4.app.ActionBarDrawerToggleHoneycomb.SetIndicatorInfo) (info));
        if (sii.setHomeAsUpIndicator != null) {
            try {
                ...
                android.util.Log.w(android.support.v4.app.ActionBarDrawerToggleHoneycomb.TAG, "Couldn't set home-as-up indicator via JB-MR2 API", e);
            }
        } else
            if (sii.upIndicatorView != null) {
                sii.upIndicatorView.setImageDrawable(drawable);
            } else {
                android.util.Log.w(android.support.v4.app.ActionBarDrawerToggleHoneycomb.TAG, "Couldn't set home-as-up indicator");
            }
    ...
    public static java.lang.Object setActionBarDescription(java.lang.Object info, android.app.Activity activity, int contentDescRes) {
        ...
        if (sii.setHomeAsUpIndicator != null) {
            try {
                ...
                android.util.Log.w(android.support.v4.app.ActionBarDrawerToggleHoneycomb.TAG, "Couldn't set content description via JB-MR2 API", e);
            }
        }
        return info;
    }
    ...
    public static android.graphics.drawable.Drawable getThemeUpIndicator(android.app.Activity activity) {
        final android.content.res.TypedArray a = activity.obtainStyledAttributes(android.support.v4.app.ActionBarDrawerToggleHoneycomb.THEME_ATTRS);
