...
class ShareCompatICS {
    ...
    public static void configureMenuItem(android.view.MenuItem item, android.app.Activity callingActivity, android.content.Intent intent) {
        ...
        android.widget.ShareActionProvider provider = null;
        ...
        provider.setShareHistoryFileName(android.support.v4.app.ShareCompatICS.HISTORY_FILENAME_PREFIX + callingActivity.getClass().getName());
