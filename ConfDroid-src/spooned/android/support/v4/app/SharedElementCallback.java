...
public abstract class SharedElementCallback {
    ...
    public android.os.Parcelable onCaptureSharedElementSnapshot(android.view.View sharedElement, android.graphics.Matrix viewToGlobalMatrix, android.graphics.RectF screenBounds) {
        if (sharedElement instanceof android.widget.ImageView) {
            ...
            if ((d != null) && (bg == null)) {
                android.graphics.Bitmap bitmap = android.support.v4.app.SharedElementCallback.createDrawableBitmap(d);
                if (bitmap != null) {
                    android.os.Bundle bundle = new android.os.Bundle();
                    bundle.putParcelable(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_BITMAP, bitmap);
                    bundle.putString(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_IMAGE_SCALETYPE, imageView.getScaleType().toString());
                    if (imageView.getScaleType() == android.widget.ImageView.ScaleType.MATRIX) {
                        ...
                        bundle.putFloatArray(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_IMAGE_MATRIX, values);
                    }
                    return bundle;
                }
            }
        ...
        if ((bitmapWidth > 0) && (bitmapHeight > 0)) {
            float scale = java.lang.Math.min(1.0F, ((float) (android.support.v4.app.SharedElementCallback.MAX_IMAGE_SIZE)) / (bitmapWidth * bitmapHeight));
            bitmapWidth *= scale;
            bitmapHeight *= scale;
            if (mTempMatrix == null) {
            ...
            bitmap = android.graphics.Bitmap.createBitmap(bitmapWidth, bitmapHeight, android.graphics.Bitmap.Config.ARGB_8888);
    ...
    private static android.graphics.Bitmap createDrawableBitmap(android.graphics.drawable.Drawable drawable) {
        ...
        float scale = java.lang.Math.min(1.0F, ((float) (android.support.v4.app.SharedElementCallback.MAX_IMAGE_SIZE)) / (width * height));
    ...
    public android.view.View onCreateSnapshotView(android.content.Context context, android.os.Parcelable snapshot) {
        ...
        if (snapshot instanceof android.os.Bundle) {
            ...
            android.graphics.Bitmap bitmap = ((android.graphics.Bitmap) (bundle.getParcelable(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_BITMAP)));
            if (bitmap == null) {
                return null;
            }
            ...
            imageView.setScaleType(android.widget.ImageView.ScaleType.valueOf(bundle.getString(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_IMAGE_SCALETYPE)));
            if (imageView.getScaleType() == android.widget.ImageView.ScaleType.MATRIX) {
                float[] values = bundle.getFloatArray(android.support.v4.app.SharedElementCallback.BUNDLE_SNAPSHOT_IMAGE_MATRIX);
     ...
     */
    public void onSharedElementsArrived(java.util.List<java.lang.String> sharedElementNames, java.util.List<android.view.View> sharedElements, android.support.v4.app.SharedElementCallback.OnSharedElementsReadyListener listener) {
