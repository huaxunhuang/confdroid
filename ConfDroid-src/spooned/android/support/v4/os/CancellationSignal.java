...
public final class CancellationSignal {
     ...
     */
    public void cancel() {
        final android.support.v4.os.CancellationSignal.OnCancelListener listener;
        ...
        try {
            ...
            if (obj != null) {
                android.support.v4.os.CancellationSignalCompatJellybean.cancel(obj);
            }
        } finally {
            synchronized(this) {
     ...
     */
    public void setOnCancelListener(android.support.v4.os.CancellationSignal.OnCancelListener listener) {
        synchronized(this) {
    ...
    public java.lang.Object getCancellationSignalObject() {
        ...
        synchronized(this) {
            if (mCancellationSignalObj == null) {
                mCancellationSignalObj = android.support.v4.os.CancellationSignalCompatJellybean.create();
                if (mIsCanceled) {
                    android.support.v4.os.CancellationSignalCompatJellybean.cancel(mCancellationSignalObj);
                }
            }
