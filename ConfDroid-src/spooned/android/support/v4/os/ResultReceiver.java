...
public class ResultReceiver implements android.os.Parcelable {
    ...
    class MyResultReceiver extends android.support.v4.os.IResultReceiver.Stub {
        ...
        public void send(int resultCode, android.os.Bundle resultData) {
            if (mHandler != null) {
                mHandler.post(new android.support.v4.os.ResultReceiver.MyRunnable(resultCode, resultData));
            } else {
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        synchronized(this) {
            if (mReceiver == null) {
                mReceiver = new android.support.v4.os.ResultReceiver.MyResultReceiver();
            }
