...
public final class BidiFormatter {
    ...
    private static final java.lang.String LRM_STRING = java.lang.Character.toString(android.support.v4.text.BidiFormatter.LRM);

    /* String representation of RLM */
    private static final java.lang.String RLM_STRING = java.lang.Character.toString(android.support.v4.text.BidiFormatter.RLM);
    ...
    public static final class Builder {
        ...
        private void initialize(boolean isRtlContext) {
            ...
            mTextDirectionHeuristicCompat = android.support.v4.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC;
            mFlags = android.support.v4.text.BidiFormatter.DEFAULT_FLAGS;
        }
        ...
        public android.support.v4.text.BidiFormatter.Builder stereoReset(boolean stereoReset) {
            if (stereoReset) {
                mFlags |= android.support.v4.text.BidiFormatter.FLAG_STEREO_RESET;
            } else {
                mFlags &= ~android.support.v4.text.BidiFormatter.FLAG_STEREO_RESET;
            }
            return this;
        ...
        public android.support.v4.text.BidiFormatter build() {
            if ((mFlags == android.support.v4.text.BidiFormatter.DEFAULT_FLAGS) && (mTextDirectionHeuristicCompat == android.support.v4.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC)) {
                return android.support.v4.text.BidiFormatter.Builder.getDefaultInstanceFromContext(mIsRtlContext);
            }
            return new android.support.v4.text.BidiFormatter(mIsRtlContext, mFlags, mTextDirectionHeuristicCompat);
        }
    }
    ...
    private static final int DEFAULT_FLAGS = android.support.v4.text.BidiFormatter.FLAG_STEREO_RESET;

    private static final android.support.v4.text.BidiFormatter DEFAULT_LTR_INSTANCE = /* LTR context */
    new android.support.v4.text.BidiFormatter(false, android.support.v4.text.BidiFormatter.DEFAULT_FLAGS, android.support.v4.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC);

    private static final android.support.v4.text.BidiFormatter DEFAULT_RTL_INSTANCE = /* RTL context */
    new android.support.v4.text.BidiFormatter(true, android.support.v4.text.BidiFormatter.DEFAULT_FLAGS, android.support.v4.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC);
    ...
    public boolean getStereoReset() {
        return (mFlags & android.support.v4.text.BidiFormatter.FLAG_STEREO_RESET) != 0;
    }
     ...
     */
    private java.lang.String markAfter(java.lang.CharSequence str, android.support.v4.text.TextDirectionHeuristicCompat heuristic) {
        final boolean isRtl = heuristic.isRtl(str, 0, str.length());
        // getExitDir() is called only if needed (short-circuit).
        if ((!mIsRtlContext) && (isRtl || (android.support.v4.text.BidiFormatter.getExitDir(str) == android.support.v4.text.BidiFormatter.DIR_RTL))) {
            return android.support.v4.text.BidiFormatter.LRM_STRING;
        }
        if (mIsRtlContext && ((!isRtl) || (android.support.v4.text.BidiFormatter.getExitDir(str) == android.support.v4.text.BidiFormatter.DIR_LTR))) {
            return android.support.v4.text.BidiFormatter.RLM_STRING;
        }
        return android.support.v4.text.BidiFormatter.EMPTY_STRING;
    }
     ...
     */
    private java.lang.String markBefore(java.lang.CharSequence str, android.support.v4.text.TextDirectionHeuristicCompat heuristic) {
        final boolean isRtl = heuristic.isRtl(str, 0, str.length());
        // getEntryDir() is called only if needed (short-circuit).
        if ((!mIsRtlContext) && (isRtl || (android.support.v4.text.BidiFormatter.getEntryDir(str) == android.support.v4.text.BidiFormatter.DIR_RTL))) {
            return android.support.v4.text.BidiFormatter.LRM_STRING;
        }
        if (mIsRtlContext && ((!isRtl) || (android.support.v4.text.BidiFormatter.getEntryDir(str) == android.support.v4.text.BidiFormatter.DIR_LTR))) {
            return android.support.v4.text.BidiFormatter.RLM_STRING;
        }
        return android.support.v4.text.BidiFormatter.EMPTY_STRING;
    }
     ...
     * 		heuristics.
     * @param isolate
     * 		Whether to directionally isolate the CharSequence to prevent it from garbling
     * 		the content around it
     * @return Input CharSequence after applying the above processing. {@code null} if {@code str}
    is {@code null}.
     */
    public java.lang.CharSequence unicodeWrap(java.lang.CharSequence str, android.support.v4.text.TextDirectionHeuristicCompat heuristic, boolean isolate) {
        if (str == null)
            return null;
        ...
        if (isRtl != mIsRtlContext) {
            result.append(isRtl ? android.support.v4.text.BidiFormatter.RLE : android.support.v4.text.BidiFormatter.LRE);
            result.append(str);
            result.append(android.support.v4.text.BidiFormatter.PDF);
        } else {
            result.append(str);
        }
        if (isolate) {
     ...
     */
    public java.lang.CharSequence unicodeWrap(java.lang.CharSequence str, android.support.v4.text.TextDirectionHeuristicCompat heuristic) {
        return /* isolate */
        unicodeWrap(str, heuristic, true);
    }
    ...
    public java.lang.String unicodeWrap(java.lang.String str) {
        return /* isolate */
        unicodeWrap(str, mDefaultTextDirectionHeuristicCompat, true);
    }
    ...
    private static boolean isRtlLocale(java.util.Locale locale) {
        return android.support.v4.text.TextUtilsCompat.getLayoutDirectionFromLocale(locale) == android.support.v4.view.ViewCompat.LAYOUT_DIRECTION_RTL;
    }
    ...
    private static int getExitDir(java.lang.CharSequence str) {
        return /* isHtml */
        new android.support.v4.text.BidiFormatter.DirectionalityEstimator(str, false).getExitDir();
    }
    ...
    private static int getEntryDir(java.lang.CharSequence str) {
        return /* isHtml */
        new android.support.v4.text.BidiFormatter.DirectionalityEstimator(str, false).getEntryDir();
    }
    ...
    private static class DirectionalityEstimator {
        ...
        static {
            DIR_TYPE_CACHE = new byte[android.support.v4.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE];
            for (int i = 0; i < android.support.v4.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE; i++) {
                android.support.v4.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE[i] = java.lang.Character.getDirectionality(i);
            }
        }
        ...
        int getEntryDir() {
            ...
            int embeddingLevelDir = android.support.v4.text.BidiFormatter.DIR_UNKNOWN;
            ...
            while ((charIndex < length) && (firstNonEmptyEmbeddingLevel == 0)) {
                switch (dirTypeForward()) {
                    ...
                    case java.lang.Character.DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE :
                        ++embeddingLevel;
                        embeddingLevelDir = android.support.v4.text.BidiFormatter.DIR_LTR;
                        break;
                    ...
                    case java.lang.Character.DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE :
                        ++embeddingLevel;
                        embeddingLevelDir = android.support.v4.text.BidiFormatter.DIR_RTL;
                        break;
                    case java.lang.Character.DIRECTIONALITY_POP_DIRECTIONAL_FORMAT :
                        ...
                        embeddingLevelDir = android.support.v4.text.BidiFormatter.DIR_UNKNOWN;
                        break;
                    case java.lang.Character.DIRECTIONALITY_BOUNDARY_NEUTRAL :
                        break;
                    case java.lang.Character.DIRECTIONALITY_LEFT_TO_RIGHT :
                        if (embeddingLevel == 0) {
                            return android.support.v4.text.BidiFormatter.DIR_LTR;
                        }
                    ...
                    case java.lang.Character.DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC :
                        if (embeddingLevel == 0) {
                            return android.support.v4.text.BidiFormatter.DIR_RTL;
                        }
                        firstNonEmptyEmbeddingLevel = embeddingLevel;
                        break;
                    default :
            ...
            if (firstNonEmptyEmbeddingLevel == 0) {
                ...
                return android.support.v4.text.BidiFormatter.DIR_UNKNOWN;
            }
            // We have found a non-empty embedding.
            if (embeddingLevelDir != android.support.v4.text.BidiFormatter.DIR_UNKNOWN) {
        ...
        private static byte getCachedDirectionality(char c) {
            return c < android.support.v4.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE ? android.support.v4.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE[c] : java.lang.Character.getDirectionality(c);
        }
        ...
        byte dirTypeForward() {
            ...
            charIndex++;
            byte dirType = android.support.v4.text.BidiFormatter.DirectionalityEstimator.getCachedDirectionality(lastChar);
            if (isHtml) {
