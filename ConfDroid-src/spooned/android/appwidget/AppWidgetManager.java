...
public class AppWidgetManager {
     ...
     * this widget. Can have the value {@link AppWidgetProviderInfo#WIDGET_CATEGORY_HOME_SCREEN} or {@link AppWidgetProviderInfo#WIDGET_CATEGORY_KEYGUARD} or {@link AppWidgetProviderInfo#WIDGET_CATEGORY_SEARCHBOX}.
     */
     ...
     * @unknown 
     */
    public AppWidgetManager(android.content.Context context, com.android.internal.appwidget.IAppWidgetService service) {
     ...
     */
    public void partiallyUpdateAppWidget(int[] appWidgetIds, android.widget.RemoteViews views) {
        if (mService == null) {
            return;
        }
        try {
     ...
     * 		The RemoteViews object containing the incremental update / command.
     */
    public void partiallyUpdateAppWidget(int appWidgetId, android.widget.RemoteViews views) {
        if (mService == null) {
            return;
        }
     ...
     *
     * @param provider
     * 		The {@link ComponentName} for the {@link android.content.BroadcastReceiver BroadcastReceiver} provider
     * 		for your AppWidget.
     * @param views
     * 		The RemoteViews object to show.
     */
    public void updateAppWidget(android.content.ComponentName provider, android.widget.RemoteViews views) {
        if (mService == null) {
            return;
        }
        try {
     ...
     */
    public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProvidersForProfile(@android.annotation.Nullable
    android.os.UserHandle profile) {
        if (mService == null) {
            return java.util.Collections.emptyList();
        }
        return getInstalledProvidersForProfile(android.appwidget.AppWidgetProviderInfo.WIDGET_CATEGORY_HOME_SCREEN, profile);
    }
    ...
    public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProviders() {
        ...
        return getInstalledProvidersForProfile(android.appwidget.AppWidgetProviderInfo.WIDGET_CATEGORY_HOME_SCREEN, null);
    }
     ...
     * @unknown 
     */
    public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProviders(int categoryFilter) {
        if (mService == null) {
            return java.util.Collections.emptyList();
        }
     ...
     * @unknown 
     */
    public java.util.List<android.appwidget.AppWidgetProviderInfo> getInstalledProvidersForProfile(int categoryFilter, android.os.UserHandle profile) {
        if (mService == null) {
            return java.util.Collections.emptyList();
        }
        if (profile == null) {
        ...
        try {
            android.content.pm.ParceledListSlice<android.appwidget.AppWidgetProviderInfo> providers = mService.getInstalledProvidersForProfile(categoryFilter, profile.getIdentifier());
            if (providers == null) {
                return java.util.Collections.emptyList();
            }
            for (android.appwidget.AppWidgetProviderInfo info : providers.getList()) {
    ...
    public android.appwidget.AppWidgetProviderInfo getAppWidgetInfo(int appWidgetId) {
        ...
        try {
            android.appwidget.AppWidgetProviderInfo info = mService.getAppWidgetInfo(mPackageName, appWidgetId);
            if (info != null) {
                // Converting complex to dp.
                convertSizesToPixels(info);
            }
     ...
     * 		The AppWidget instance for which to set the RemoteViews.
     * @param provider
     * 		The {@link android.content.BroadcastReceiver} that will be the AppWidget
     * 		provider for this AppWidget.
     * @unknown 
     */
    public void bindAppWidgetId(int appWidgetId, android.content.ComponentName provider) {
        if (mService == null) {
            return;
        }
     ...
     * @unknown 
     */
    public void bindAppWidgetId(int appWidgetId, android.content.ComponentName provider, android.os.Bundle options) {
        if (mService == null) {
            return;
        }
        bindAppWidgetIdIfAllowed(appWidgetId, android.os.Process.myUserHandle(), provider, options);
    }
    ...
    public boolean bindAppWidgetIdIfAllowed(int appWidgetId, android.content.ComponentName provider) {
        ...
        return bindAppWidgetIdIfAllowed(appWidgetId, android.os.UserHandle.myUserId(), provider, null);
    }
     ...
     * @return true if this component has permission to bind the AppWidget
     */
    public boolean bindAppWidgetIdIfAllowed(int appWidgetId, android.content.ComponentName provider, android.os.Bundle options) {
        if (mService == null) {
            return false;
        }
        return bindAppWidgetIdIfAllowed(appWidgetId, android.os.UserHandle.myUserId(), provider, options);
    }
     ...
     * @return true if this component has permission to bind the AppWidget
     */
    public boolean bindAppWidgetIdIfAllowed(int appWidgetId, android.os.UserHandle user, android.content.ComponentName provider, android.os.Bundle options) {
        if (mService == null) {
            return false;
        }
     ...
     *
     * @param packageName
     * 		The package for which the permission is being queried
     * @param userId
     * 		The user id of the user under which the package runs.
     * @return true if the package was granted permission by the user to bind app widgets
     * @unknown 
     */
    public boolean hasBindAppWidgetPermission(java.lang.String packageName, int userId) {
        if (mService == null) {
            return false;
        }
        try {
    ...
    public boolean hasBindAppWidgetPermission(java.lang.String packageName) {
        ...
        try {
            return mService.hasBindAppWidgetPermission(packageName, android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param packageName
     * 		The package whose permission is being changed
     * @param permission
     * 		Whether to give the package permission to bind widgets
     * @unknown 
     */
    public void setBindAppWidgetPermission(java.lang.String packageName, boolean permission) {
        if (mService == null) {
            return;
        }
        setBindAppWidgetPermission(packageName, android.os.UserHandle.myUserId(), permission);
    }
     ...
     * @unknown 
     */
    public void setBindAppWidgetPermission(java.lang.String packageName, int userId, boolean permission) {
        if (mService == null) {
            return;
        }
        try {
     ...
     *
     * @param packageName
     * 		The package from which the binding is requested.
     * @param appWidgetId
     * 		The AppWidget instance for which to bind the RemoteViewsService.
     * @param intent
     * 		The intent of the service which will be providing the data to the
     * 		RemoteViewsAdapter.
     * @param connection
     * 		The callback interface to be notified when a connection is made or lost.
     * @unknown 
     */
    public void bindRemoteViewsService(java.lang.String packageName, int appWidgetId, android.content.Intent intent, android.os.IBinder connection) {
        if (mService == null) {
            return;
        }
        try {
     ...
     * @unknown 
     */
    public void unbindRemoteViewsService(java.lang.String packageName, int appWidgetId, android.content.Intent intent) {
        if (mService == null) {
            return;
        }
        try {
     ...
     *
     * @param provider
     * 		The {@link android.content.BroadcastReceiver} that is the
    ...
    private boolean bindAppWidgetIdIfAllowed(int appWidgetId, int profileId, android.content.ComponentName provider, android.os.Bundle options) {
        ...
        try {
            return mService.bindAppWidgetId(mPackageName, appWidgetId, profileId, provider, options);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }

    private void convertSizesToPixels(android.appwidget.AppWidgetProviderInfo info) {
        // Converting complex to dp.
        info.minWidth = android.util.TypedValue.complexToDimensionPixelSize(info.minWidth, mDisplayMetrics);
        info.minHeight = android.util.TypedValue.complexToDimensionPixelSize(info.minHeight, mDisplayMetrics);
        info.minResizeWidth = android.util.TypedValue.complexToDimensionPixelSize(info.minResizeWidth, mDisplayMetrics);
        info.minResizeHeight = android.util.TypedValue.complexToDimensionPixelSize(info.minResizeHeight, mDisplayMetrics);
    }
}
