...
public class AppWidgetProviderInfo implements android.os.Parcelable {
     ...
     */
    public static final int RESIZE_BOTH = android.appwidget.AppWidgetProviderInfo.RESIZE_HORIZONTAL | android.appwidget.AppWidgetProviderInfo.RESIZE_VERTICAL;
    ...
    /**
     * Identity of this AppWidget component.  This component should be a {@link android.content.BroadcastReceiver}, and it will be sent the AppWidget intents
    ...
    public final java.lang.String loadLabel(android.content.pm.PackageManager packageManager) {
        java.lang.CharSequence label = providerInfo.loadLabel(packageManager);
        if (label != null) {
     ...
     */
    public final android.graphics.drawable.Drawable loadIcon(@android.annotation.NonNull
    android.content.Context context, int density) {
     ...
     */
    public final android.graphics.drawable.Drawable loadPreviewImage(@android.annotation.NonNull
    android.content.Context context, int density) {
    ...
    public final android.os.UserHandle getProfile() {
        return new android.os.UserHandle(android.os.UserHandle.getUserId(providerInfo.applicationInfo.uid));
    }
    ...
    public android.appwidget.AppWidgetProviderInfo clone() {
        android.appwidget.AppWidgetProviderInfo that = new android.appwidget.AppWidgetProviderInfo();
    ...
    private android.graphics.drawable.Drawable loadDrawable(android.content.Context context, int density, int resourceId, boolean loadDefaultIcon) {
        try {
            android.content.res.Resources resources = context.getPackageManager().getResourcesForApplication(providerInfo.applicationInfo);
            if (resourceId > 0) {
                if (density <= 0) {
     ...
     */
    public static final android.os.Parcelable.Creator<android.appwidget.AppWidgetProviderInfo> CREATOR = new android.os.Parcelable.Creator<android.appwidget.AppWidgetProviderInfo>() {
