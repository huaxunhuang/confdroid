        ...
        if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_UPDATE.equals(action)) {
            ...
            if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_DELETED.equals(action)) {
                ...
                if ((extras != null) && extras.containsKey(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_ID)) {
                    final int appWidgetId = extras.getInt(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_ID);
                    this.onDeleted(context, new int[]{ appWidgetId });
                }
            } else
                if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_OPTIONS_CHANGED.equals(action)) {
                    android.os.Bundle extras = intent.getExtras();
                    if (((extras != null) && extras.containsKey(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_ID)) && extras.containsKey(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_OPTIONS)) {
                        int appWidgetId = extras.getInt(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_ID);
                        android.os.Bundle widgetExtras = extras.getBundle(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_OPTIONS);
                        this.onAppWidgetOptionsChanged(context, android.appwidget.AppWidgetManager.getInstance(context), appWidgetId, widgetExtras);
                    }
                } else
                    if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_ENABLED.equals(action)) {
                        ...
                        if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_DISABLED.equals(action)) {
                            ...
                            if (android.appwidget.AppWidgetManager.ACTION_APPWIDGET_RESTORED.equals(action)) {
                                android.os.Bundle extras = intent.getExtras();
                                if (extras != null) {
                                    int[] oldIds = extras.getIntArray(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_OLD_IDS);
                                    int[] newIds = extras.getIntArray(android.appwidget.AppWidgetManager.EXTRA_APPWIDGET_IDS);
                                    if ((oldIds != null) && (oldIds.length > 0)) {
                                        this.onRestored(context, oldIds, newIds);
                                        this.onUpdate(context, android.appwidget.AppWidgetManager.getInstance(context), newIds);
                                    }
                                }
                            }
