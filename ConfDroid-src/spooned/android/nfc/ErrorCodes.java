    ...
    public static java.lang.String asString(int code) {
        switch (code) {
            ...
            case android.nfc.ErrorCodes.ERROR_IO :
                return "IO";
            case android.nfc.ErrorCodes.ERROR_CANCELLED :
                return "CANCELLED";
            case android.nfc.ErrorCodes.ERROR_TIMEOUT :
                return "TIMEOUT";
            case android.nfc.ErrorCodes.ERROR_BUSY :
                return "BUSY";
            case android.nfc.ErrorCodes.ERROR_CONNECT :
                return "CONNECT/DISCONNECT";
                // case ERROR_DISCONNECT: return "DISCONNECT";
            case android.nfc.ErrorCodes.ERROR_READ :
                return "READ";
            case android.nfc.ErrorCodes.ERROR_WRITE :
                return "WRITE";
            case android.nfc.ErrorCodes.ERROR_INVALID_PARAM :
                return "INVALID_PARAM";
            case android.nfc.ErrorCodes.ERROR_INSUFFICIENT_RESOURCES :
                return "INSUFFICIENT_RESOURCES";
            case android.nfc.ErrorCodes.ERROR_SOCKET_CREATION :
                return "SOCKET_CREATION";
            case android.nfc.ErrorCodes.ERROR_SOCKET_NOT_CONNECTED :
                return "SOCKET_NOT_CONNECTED";
            case android.nfc.ErrorCodes.ERROR_BUFFER_TO_SMALL :
                return "BUFFER_TO_SMALL";
            case android.nfc.ErrorCodes.ERROR_SAP_USED :
                return "SAP_USED";
            case android.nfc.ErrorCodes.ERROR_SERVICE_NAME_USED :
                return "SERVICE_NAME_USED";
            case android.nfc.ErrorCodes.ERROR_SOCKET_OPTIONS :
                return "SOCKET_OPTIONS";
            case android.nfc.ErrorCodes.ERROR_NFC_ON :
                return "NFC_ON";
            case android.nfc.ErrorCodes.ERROR_NOT_INITIALIZED :
                return "NOT_INITIALIZED";
            case android.nfc.ErrorCodes.ERROR_SE_ALREADY_SELECTED :
                return "SE_ALREADY_SELECTED";
            case android.nfc.ErrorCodes.ERROR_SE_CONNECTED :
                return "SE_CONNECTED";
            case android.nfc.ErrorCodes.ERROR_NO_SE_CONNECTED :
                return "NO_SE_CONNECTED";
            case android.nfc.ErrorCodes.ERROR_NOT_SUPPORTED :
