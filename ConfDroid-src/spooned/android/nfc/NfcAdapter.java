...
public final class NfcAdapter {
     ...
     * NfcAdapter object.
     */
    static java.util.HashMap<android.content.Context, android.nfc.NfcAdapter> sNfcAdapters = new java.util.HashMap();// guard by NfcAdapter.class
     ...
     */
    static android.nfc.NfcAdapter sNullContextNfcAdapter;// protected by NfcAdapter.class
    ...
    android.nfc.ITagRemovedCallback mTagRemovedListener;// protected by mLock


    /**
     * A callback to be invoked when the system finds a tag while the foreground activity is
     * operating in reader mode.
     * <p>Register your {@code ReaderCallback} implementation with {@link NfcAdapter#enableReaderMode} and disable it with {@link NfcAdapter#disableReaderMode}.
     *
    ...
    public interface OnNdefPushCompleteCallback {
         ...
         *
         * @param event
         * 		{@link NfcEvent} with the {@link NfcEvent#nfcAdapter} field set
     ...
     * is within range.
     * <p>Implement this interface and pass it to {@link NfcAdapter#setNdefPushMessageCallback setNdefPushMessageCallback()} in order to create an
     ...
     * content currently visible to the user. Alternatively, you can call {@link #setNdefPushMessage setNdefPushMessage()} if the {@link NdefMessage} always contains the
     * same data.
     */
    ...
    public interface NfcUnlockHandler {
         ...
         *
         * @param tag
         * 		the detected tag, to be used to unlock the device
         * @return true if the device was successfully unlocked
         */
        public boolean onUnlockAttempted(android.nfc.Tag tag);
    }
    ...
    private static boolean hasNfcFeature() {
        ...
        if (pm == null) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "Cannot get package manager, assuming no NFC feature");
            return false;
        }
        try {
            return pm.hasSystemFeature(android.content.pm.PackageManager.FEATURE_NFC, 0);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "Package manager query failed, assuming no NFC feature", e);
            return false;
        }
    }
    ...
    private static boolean hasNfcHceFeature() {
        ...
        try {
            return pm.hasSystemFeature(android.content.pm.PackageManager.FEATURE_NFC_HOST_CARD_EMULATION, 0) || pm.hasSystemFeature(android.content.pm.PackageManager.FEATURE_NFC_HOST_CARD_EMULATION_NFCF, 0);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "Package manager query failed, assuming no NFC feature", e);
            return false;
        }
    ...
    public static synchronized android.nfc.NfcAdapter getNfcAdapter(android.content.Context context) {
        if (!android.nfc.NfcAdapter.sIsInitialized) {
            android.nfc.NfcAdapter.sHasNfcFeature = android.nfc.NfcAdapter.hasNfcFeature();
            boolean hasHceFeature = android.nfc.NfcAdapter.hasNfcHceFeature();
            /* is this device meant to have NFC */
            if ((!android.nfc.NfcAdapter.sHasNfcFeature) && (!hasHceFeature)) {
                android.util.Log.v(android.nfc.NfcAdapter.TAG, "this device does not have NFC support");
                throw new java.lang.UnsupportedOperationException();
            }
            android.nfc.NfcAdapter.sService = android.nfc.NfcAdapter.getServiceInterface();
            if (android.nfc.NfcAdapter.sService == null) {
                android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC service");
                throw new java.lang.UnsupportedOperationException();
            }
            if (android.nfc.NfcAdapter.sHasNfcFeature) {
                try {
                    android.nfc.NfcAdapter.sTagService = android.nfc.NfcAdapter.sService.getNfcTagInterface();
                } catch (android.os.RemoteException e) {
                    android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC Tag service");
                    throw new java.lang.UnsupportedOperationException();
                }
            }
            if (hasHceFeature) {
                try {
                    android.nfc.NfcAdapter.sNfcFCardEmulationService = android.nfc.NfcAdapter.sService.getNfcFCardEmulationInterface();
                } catch (android.os.RemoteException e) {
                    android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC-F card emulation service");
                    throw new java.lang.UnsupportedOperationException();
                }
                try {
                    android.nfc.NfcAdapter.sCardEmulationService = android.nfc.NfcAdapter.sService.getNfcCardEmulationInterface();
                } catch (android.os.RemoteException e) {
                    android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve card emulation service");
                    throw new java.lang.UnsupportedOperationException();
                }
            }
            android.nfc.NfcAdapter.sIsInitialized = true;
        }
        if (context == null) {
            if (android.nfc.NfcAdapter.sNullContextNfcAdapter == null) {
                android.nfc.NfcAdapter.sNullContextNfcAdapter = new android.nfc.NfcAdapter(null);
            }
            return android.nfc.NfcAdapter.sNullContextNfcAdapter;
        }
        android.nfc.NfcAdapter adapter = android.nfc.NfcAdapter.sNfcAdapters.get(context);
        if (adapter == null) {
            adapter = new android.nfc.NfcAdapter(context);
            android.nfc.NfcAdapter.sNfcAdapters.put(context, adapter);
        }
        return adapter;
    }
    ...
    private static android.nfc.INfcAdapter getServiceInterface() {
        ...
        android.os.IBinder b = android.os.ServiceManager.getService("nfc");
        if (b == null) {
            return null;
        }
    ...
    public static android.nfc.NfcAdapter getDefaultAdapter() {
        ...
        android.util.Log.w(android.nfc.NfcAdapter.TAG, "WARNING: NfcAdapter.getDefaultAdapter() is deprecated, use " + "NfcAdapter.getDefaultAdapter(Context) instead", new java.lang.Exception());
        return android.nfc.NfcAdapter.getNfcAdapter(null);
    }

    NfcAdapter(android.content.Context context) {
        mContext = context;
        mNfcActivityManager = new android.nfc.NfcActivityManager(this);
        mNfcUnlockHandlers = new java.util.HashMap<android.nfc.NfcAdapter.NfcUnlockHandler, android.nfc.INfcUnlockHandler>();
    ...
    public android.nfc.INfcAdapter getService() {
        ...
        return android.nfc.NfcAdapter.sService;
    }
    ...
    public android.nfc.INfcTag getTagService() {
        ...
        return android.nfc.NfcAdapter.sTagService;
    }
    ...
    public android.nfc.INfcCardEmulation getCardEmulationService() {
        isEnabled();
        return android.nfc.NfcAdapter.sCardEmulationService;
    }
    ...
    public android.nfc.INfcFCardEmulation getNfcFCardEmulationService() {
        isEnabled();
        return android.nfc.NfcAdapter.sNfcFCardEmulationService;
    }
    ...
    public void attemptDeadServiceRecovery(java.lang.Exception e) {
        android.util.Log.e(android.nfc.NfcAdapter.TAG, "NFC service dead - attempting to recover", e);
        android.nfc.INfcAdapter service = android.nfc.NfcAdapter.getServiceInterface();
        if (service == null) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC service during service recovery");
        ...
        android.nfc.NfcAdapter.sService = service;
        try {
            android.nfc.NfcAdapter.sTagService = service.getNfcTagInterface();
        } catch (android.os.RemoteException ee) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC tag service during service recovery");
            // nothing more can be done now, sService is still stale, we'll hit
            // this recovery path again later
            return;
        }
        try {
            android.nfc.NfcAdapter.sCardEmulationService = service.getNfcCardEmulationInterface();
        } catch (android.os.RemoteException ee) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC card emulation service during service recovery");
        }
        try {
            android.nfc.NfcAdapter.sNfcFCardEmulationService = service.getNfcFCardEmulationInterface();
        } catch (android.os.RemoteException ee) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "could not retrieve NFC-F card emulation service during service recovery");
        }
        return;
    }
    ...
    public boolean isEnabled() {
        try {
            return android.nfc.NfcAdapter.sService.getState() == android.nfc.NfcAdapter.STATE_ON;
        } catch (android.os.RemoteException e) {
    ...
    public int getAdapterState() {
        try {
            return android.nfc.NfcAdapter.sService.getState();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return android.nfc.NfcAdapter.STATE_OFF;
        }
    }
    ...
    public boolean enable() {
        try {
            return android.nfc.NfcAdapter.sService.enable();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public boolean disable() {
        try {
            return android.nfc.NfcAdapter.sService.disable(true);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public boolean disable(boolean persist) {
        try {
            return android.nfc.NfcAdapter.sService.disable(persist);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public void pausePolling(int timeoutInMs) {
        try {
            android.nfc.NfcAdapter.sService.pausePolling(timeoutInMs);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
    ...
    public void resumePolling() {
        try {
            android.nfc.NfcAdapter.sService.resumePolling();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
    ...
    public void setBeamPushUris(android.net.Uri[] uris, android.app.Activity activity) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
        }
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public void setBeamPushUrisCallback(android.nfc.NfcAdapter.CreateBeamUrisCallback callback, android.app.Activity activity) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
     ...
     *
     * @param message
     * 		NDEF message to push over NFC, or null to disable
     * @param activity
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public void setNdefPushMessage(android.nfc.NdefMessage message, android.app.Activity activity, android.app.Activity... activities) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
        ...
        try {
            ...
            for (android.app.Activity a : activities) {
                if (a == null) {
            ...
            if (targetSdkVersion < android.os.Build.VERSION_CODES.JELLY_BEAN) {
                ...
                android.util.Log.e(android.nfc.NfcAdapter.TAG, "Cannot call API with Activity that has already " + "been destroyed", e);
            } else {
     ...
     */
    @android.annotation.SystemApi
    public void setNdefPushMessage(android.nfc.NdefMessage message, android.app.Activity activity, int flags) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public void setNdefPushMessageCallback(android.nfc.NfcAdapter.CreateNdefMessageCallback callback, android.app.Activity activity, android.app.Activity... activities) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public void setOnNdefPushCompleteCallback(android.nfc.NfcAdapter.OnNdefPushCompleteCallback callback, android.app.Activity activity, android.app.Activity... activities) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public void enableForegroundDispatch(android.app.Activity activity, android.app.PendingIntent intent, android.content.IntentFilter[] filters, java.lang.String[][] techLists) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
        ...
        if (!activity.isResumed()) {
            throw new java.lang.IllegalStateException("Foreground dispatch can only be enabled " + "when your activity is resumed");
        }
        try {
            android.nfc.TechListParcel parcel = null;
            if ((techLists != null) && (techLists.length > 0)) {
                parcel = new android.nfc.TechListParcel(techLists);
            }
            android.app.ActivityThread.currentActivityThread().registerOnActivityPausedListener(activity, mForegroundDispatchListener);
            android.nfc.NfcAdapter.sService.setForegroundDispatch(intent, filters, parcel);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
    ...
    public void disableForegroundDispatch(android.app.Activity activity) {
        ...
        android.app.ActivityThread.currentActivityThread().unregisterOnActivityPausedListener(activity, mForegroundDispatchListener);
        disableForegroundDispatchInternal(activity, false);
    }

    android.app.OnActivityPausedListener mForegroundDispatchListener = new android.app.OnActivityPausedListener() {
        @java.lang.Override
    ...
    void disableForegroundDispatchInternal(android.app.Activity activity, boolean force) {
        try {
            android.nfc.NfcAdapter.sService.setForegroundDispatch(null, null, null);
            if ((!force) && (!activity.isResumed())) {
                throw new java.lang.IllegalStateException("You must disable foreground dispatching " + "while your activity is still resumed");
            }
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
     ...
     * 		if FEATURE_NFC is unavailable.
     */
    public boolean invokeBeam(android.app.Activity activity) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
     ...
     * @unknown 
     */
    public boolean invokeBeam(android.nfc.BeamShareData shareData) {
        try {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "invokeBeamInternal()");
            android.nfc.NfcAdapter.sService.invokeBeamInternal(shareData);
            return true;
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "invokeBeam: NFC process has died.");
            attemptDeadServiceRecovery(e);
    ...
    public boolean enableNdefPush() {
        ...
        try {
            return android.nfc.NfcAdapter.sService.enableNdefPush();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public boolean disableNdefPush() {
        ...
        try {
            return android.nfc.NfcAdapter.sService.disableNdefPush();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
    ...
    public boolean isNdefPushEnabled() {
        ...
        try {
            return android.nfc.NfcAdapter.sService.isNdefPushEnabled();
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return false;
        }
     ...
     *
     * @param tag
     * 		the {@link android.nfc.Tag Tag} to ignore.
     * @param debounceMs
     * 		minimum amount of time the tag needs to be out of range before being
     * 		dispatched again.
     * @param tagRemovedListener
     ...
     */
    public boolean ignore(final android.nfc.Tag tag, int debounceMs, final android.nfc.NfcAdapter.OnTagRemovedListener tagRemovedListener, final android.os.Handler handler) {
        android.nfc.ITagRemovedCallback.Stub iListener = null;
        if (tagRemovedListener != null) {
            iListener = new android.nfc.ITagRemovedCallback.Stub() {
                @java.lang.Override
        ...
        try {
            return android.nfc.NfcAdapter.sService.ignore(tag.getServiceHandle(), debounceMs, iListener);
        } catch (android.os.RemoteException e) {
            return false;
        }
    }
    ...
    public void dispatch(android.nfc.Tag tag) {
        if (tag == null) {
            throw new java.lang.NullPointerException("tag cannot be null");
        }
        try {
            android.nfc.NfcAdapter.sService.dispatch(tag);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
    ...
    public void setP2pModes(int initiatorModes, int targetModes) {
        try {
            android.nfc.NfcAdapter.sService.setP2pModes(initiatorModes, targetModes);
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
        }
    }
     ...
     */
    @android.annotation.SystemApi
    public boolean addNfcUnlockHandler(final android.nfc.NfcAdapter.NfcUnlockHandler unlockHandler, java.lang.String[] tagTechnologies) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
        ...
        try {
            synchronized(mLock) {
                if (mNfcUnlockHandlers.containsKey(unlockHandler)) {
                    ...
                    android.nfc.NfcAdapter.sService.removeNfcUnlockHandler(mNfcUnlockHandlers.get(unlockHandler));
                    mNfcUnlockHandlers.remove(unlockHandler);
                }
                android.nfc.INfcUnlockHandler.Stub iHandler = new android.nfc.INfcUnlockHandler.Stub() {
                    @java.lang.Override
                    public boolean onUnlockAttempted(android.nfc.Tag tag) throws android.os.RemoteException {
                        return unlockHandler.onUnlockAttempted(tag);
                    }
                };
                android.nfc.NfcAdapter.sService.addNfcUnlockHandler(iHandler, android.nfc.Tag.getTechCodesFromStrings(tagTechnologies));
            ...
            android.util.Log.e(android.nfc.NfcAdapter.TAG, "Unable to register LockscreenDispatch", e);
            return false;
        }
        return true;
    }
     ...
     */
    @android.annotation.SystemApi
    public boolean removeNfcUnlockHandler(android.nfc.NfcAdapter.NfcUnlockHandler unlockHandler) {
        synchronized(android.nfc.NfcAdapter.class) {
            if (!android.nfc.NfcAdapter.sHasNfcFeature) {
                throw new java.lang.UnsupportedOperationException();
            }
        ...
        try {
            synchronized(mLock) {
                if (mNfcUnlockHandlers.containsKey(unlockHandler)) {
                    android.nfc.NfcAdapter.sService.removeNfcUnlockHandler(mNfcUnlockHandlers.remove(unlockHandler));
                }
                return true;
            }
        } catch (android.os.RemoteException e) {
    ...
    public android.nfc.INfcAdapterExtras getNfcAdapterExtrasInterface() {
        if (mContext == null) {
            throw new java.lang.UnsupportedOperationException("You need a context on NfcAdapter to use the " + " NFC extras APIs");
        }
        try {
            return android.nfc.NfcAdapter.sService.getNfcAdapterExtrasInterface(mContext.getPackageName());
        } catch (android.os.RemoteException e) {
            attemptDeadServiceRecovery(e);
            return null;
        }
    ...
    void enforceResumed(android.app.Activity activity) {
        if (!activity.isResumed()) {
            throw new java.lang.IllegalStateException("API cannot be called while activity is paused");
        }
    }
