...
public final class Ndef extends android.nfc.tech.BasicTagTechnology {
     ...
     *
     * @param tag
     * 		an NDEF compatible tag
     * @return Ndef object
     */
    public static android.nfc.tech.Ndef get(android.nfc.Tag tag) {
        if (!tag.hasTech(android.nfc.tech.TagTechnology.NDEF))
            return null;

        try {
            return new android.nfc.tech.Ndef(tag);
     ...
     * @unknown 
     */
    public Ndef(android.nfc.Tag tag) throws android.os.RemoteException {
        super(tag, android.nfc.tech.TagTechnology.NDEF);
        android.os.Bundle extras = tag.getTechExtras(android.nfc.tech.TagTechnology.NDEF);
        if (extras != null) {
            mMaxNdefSize = extras.getInt(android.nfc.tech.Ndef.EXTRA_NDEF_MAXLENGTH);
            mCardState = extras.getInt(android.nfc.tech.Ndef.EXTRA_NDEF_CARDSTATE);
            mNdefMsg = extras.getParcelable(android.nfc.tech.Ndef.EXTRA_NDEF_MSG);
            mNdefType = extras.getInt(android.nfc.tech.Ndef.EXTRA_NDEF_TYPE);
        } else {
            throw new java.lang.NullPointerException("NDEF tech extras are null.");
        }
    }
    ...
    public java.lang.String getType() {
        switch (mNdefType) {
            case android.nfc.tech.Ndef.TYPE_1 :
                return android.nfc.tech.Ndef.NFC_FORUM_TYPE_1;
            case android.nfc.tech.Ndef.TYPE_2 :
                return android.nfc.tech.Ndef.NFC_FORUM_TYPE_2;
            case android.nfc.tech.Ndef.TYPE_3 :
                return android.nfc.tech.Ndef.NFC_FORUM_TYPE_3;
            case android.nfc.tech.Ndef.TYPE_4 :
                return android.nfc.tech.Ndef.NFC_FORUM_TYPE_4;
            case android.nfc.tech.Ndef.TYPE_MIFARE_CLASSIC :
                return android.nfc.tech.Ndef.MIFARE_CLASSIC;
            case android.nfc.tech.Ndef.TYPE_ICODE_SLI :
                return android.nfc.tech.Ndef.ICODE_SLI;
            default :
                return android.nfc.tech.Ndef.UNKNOWN;
        }
    }
    ...
    public boolean isWritable() {
        return mCardState == android.nfc.tech.Ndef.NDEF_MODE_READ_WRITE;
    }
    ...
    public android.nfc.NdefMessage getNdefMessage() throws android.nfc.FormatException, java.io.IOException {
        ...
        try {
            ...
            if (tagService.isNdef(serviceHandle)) {
                android.nfc.NdefMessage msg = tagService.ndefRead(serviceHandle);
                if ((msg == null) && (!tagService.isPresent(serviceHandle))) {
                    throw new android.nfc.TagLostException();
                }
                return msg;
            } else
            ...
            android.util.Log.e(android.nfc.tech.Ndef.TAG, "NFC service dead", e);
            return null;
        }
    }
     ...
     *
     * @param msg
     * 		the NDEF Message to write, must not be null
     * @throws TagLostException
     * 		if the tag leaves the field
     * @throws IOException
     * 		if there is an I/O failure, or the operation is canceled
     ...
     */
    public void writeNdefMessage(android.nfc.NdefMessage msg) throws android.nfc.FormatException, java.io.IOException {
        checkConnected();
        try {
            android.nfc.INfcTag tagService = mTag.getTagService();
            if (tagService == null) {
            ...
            if (tagService.isNdef(serviceHandle)) {
                ...
                throw new java.io.IOException("Tag is not ndef");
            }
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.tech.Ndef.TAG, "NFC service dead", e);
        }
