...
public final class NfcBarcode extends android.nfc.tech.BasicTagTechnology {
     ...
     *
     * @param tag
     * 		an NfcBarcode compatible tag
     * @return NfcBarcode object
     */
    public static android.nfc.tech.NfcBarcode get(android.nfc.Tag tag) {
        if (!tag.hasTech(android.nfc.tech.TagTechnology.NFC_BARCODE))
            return null;

        try {
            return new android.nfc.tech.NfcBarcode(tag);
     ...
     * @unknown 
     */
    public NfcBarcode(android.nfc.Tag tag) throws android.os.RemoteException {
        super(tag, android.nfc.tech.TagTechnology.NFC_BARCODE);
        android.os.Bundle extras = tag.getTechExtras(android.nfc.tech.TagTechnology.NFC_BARCODE);
        if (extras != null) {
            mType = extras.getInt(android.nfc.tech.NfcBarcode.EXTRA_BARCODE_TYPE);
        } else {
            throw new java.lang.NullPointerException("NfcBarcode tech extras are null.");
        }
    }
    ...
    public byte[] getBarcode() {
        switch (mType) {
            case android.nfc.tech.NfcBarcode.TYPE_KOVIO :
