...
public final class NfcF extends android.nfc.tech.BasicTagTechnology {
    ...
    public static android.nfc.tech.NfcF get(android.nfc.Tag tag) {
        if (!tag.hasTech(android.nfc.tech.TagTechnology.NFC_F))
            return null;

        try {
            return new android.nfc.tech.NfcF(tag);
     ...
     * @unknown 
     */
    public NfcF(android.nfc.Tag tag) throws android.os.RemoteException {
        super(tag, android.nfc.tech.TagTechnology.NFC_F);
        android.os.Bundle extras = tag.getTechExtras(android.nfc.tech.TagTechnology.NFC_F);
        if (extras != null) {
            mSystemCode = extras.getByteArray(android.nfc.tech.NfcF.EXTRA_SC);
            mManufacturer = extras.getByteArray(android.nfc.tech.NfcF.EXTRA_PMM);
        }
    }
    ...
    public void setTimeout(int timeout) {
        try {
            int err = mTag.getTagService().setTimeout(android.nfc.tech.TagTechnology.NFC_F, timeout);
            if (err != android.nfc.ErrorCodes.SUCCESS) {
                throw new java.lang.IllegalArgumentException("The supplied timeout is not valid");
            }
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.tech.NfcF.TAG, "NFC service dead", e);
        }
    }
    ...
    public int getTimeout() {
        try {
            return mTag.getTagService().getTimeout(android.nfc.tech.TagTechnology.NFC_F);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.nfc.tech.NfcF.TAG, "NFC service dead", e);
            return 0;
        }
