...
public final class NfcV extends android.nfc.tech.BasicTagTechnology {
    ...
    public static android.nfc.tech.NfcV get(android.nfc.Tag tag) {
        if (!tag.hasTech(android.nfc.tech.TagTechnology.NFC_V))
            return null;

        try {
            return new android.nfc.tech.NfcV(tag);
     ...
     * @unknown 
     */
    public NfcV(android.nfc.Tag tag) throws android.os.RemoteException {
        super(tag, android.nfc.tech.TagTechnology.NFC_V);
        android.os.Bundle extras = tag.getTechExtras(android.nfc.tech.TagTechnology.NFC_V);
        mRespFlags = extras.getByte(android.nfc.tech.NfcV.EXTRA_RESP_FLAGS);
        mDsfId = extras.getByte(android.nfc.tech.NfcV.EXTRA_DSFID);
    }
