...
public final class NfcB extends android.nfc.tech.BasicTagTechnology {
    ...
    public static android.nfc.tech.NfcB get(android.nfc.Tag tag) {
        if (!tag.hasTech(android.nfc.tech.TagTechnology.NFC_B))
            return null;

        try {
            return new android.nfc.tech.NfcB(tag);
     ...
     * @unknown 
     */
    public NfcB(android.nfc.Tag tag) throws android.os.RemoteException {
        super(tag, android.nfc.tech.TagTechnology.NFC_B);
        android.os.Bundle extras = tag.getTechExtras(android.nfc.tech.TagTechnology.NFC_B);
        mAppData = extras.getByteArray(android.nfc.tech.NfcB.EXTRA_APPDATA);
        mProtInfo = extras.getByteArray(android.nfc.tech.NfcB.EXTRA_PROTINFO);
    }
