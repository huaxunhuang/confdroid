...
public abstract class HostApduService extends android.app.Service {
    ...
    final android.os.Messenger mMessenger = new android.os.Messenger(new android.nfc.cardemulation.HostApduService.MsgHandler());

    final class MsgHandler extends android.os.Handler {
        @java.lang.Override
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case android.nfc.cardemulation.HostApduService.MSG_COMMAND_APDU :
                    ...
                    byte[] apdu = dataBundle.getByteArray(android.nfc.cardemulation.HostApduService.KEY_DATA);
                    if (apdu != null) {
                        byte[] responseApdu = processCommandApdu(apdu, null);
                        if (responseApdu != null) {
                            if (mNfcService == null) {
                                android.util.Log.e(android.nfc.cardemulation.HostApduService.TAG, "Response not sent; service was deactivated.");
                                return;
                            }
                            android.os.Message responseMsg = android.os.Message.obtain(null, android.nfc.cardemulation.HostApduService.MSG_RESPONSE_APDU);
                            android.os.Bundle responseBundle = new android.os.Bundle();
                            responseBundle.putByteArray(android.nfc.cardemulation.HostApduService.KEY_DATA, responseApdu);
                            responseMsg.setData(responseBundle);
                            responseMsg.replyTo = android.nfc.cardemulation.HostApduService.this.mMessenger;
                            try {
                        ...
                        android.util.Log.e(android.nfc.cardemulation.HostApduService.TAG, "Received MSG_COMMAND_APDU without data.");
                    }
                    break;
                case android.nfc.cardemulation.HostApduService.MSG_RESPONSE_APDU :
                    if (mNfcService == null) {
                        android.util.Log.e(android.nfc.cardemulation.HostApduService.TAG, "Response not sent; service was deactivated.");
                        return;
                    }
                    try {
                        msg.replyTo = android.nfc.cardemulation.HostApduService.this.mMessenger;
                        mNfcService.send(msg);
                    } catch (android.os.RemoteException e) {
                        android.util.Log.e(android.nfc.cardemulation.HostApduService.TAG, "RemoteException calling into NfcService.");
                    }
                    break;
                case android.nfc.cardemulation.HostApduService.MSG_DEACTIVATED :
                    // Make sure we won't call into NfcService again
                    mNfcService = null;
                    onDeactivated(msg.arg1);
                    break;
                case android.nfc.cardemulation.HostApduService.MSG_UNHANDLED :
                    if (mNfcService == null) {
                        android.util.Log.e(android.nfc.cardemulation.HostApduService.TAG, "notifyUnhandled not sent; service was deactivated.");
                        return;
                    }
                    try {
                        msg.replyTo = android.nfc.cardemulation.HostApduService.this.mMessenger;
    ...
    public final void sendResponseApdu(byte[] responseApdu) {
        ...
        dataBundle.putByteArray(android.nfc.cardemulation.HostApduService.KEY_DATA, responseApdu);
    ...
    public final void notifyUnhandled() {
        android.os.Message unhandledMsg = android.os.Message.obtain(null, android.nfc.cardemulation.HostApduService.MSG_UNHANDLED);
        try {
     ...
     *
     * @param reason
     * 		Either {@link #DEACTIVATION_LINK_LOSS} or {@link #DEACTIVATION_DESELECTED}
     */
