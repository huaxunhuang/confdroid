...
public final class NdefMessage implements android.os.Parcelable {
     ...
     */
    public NdefMessage(byte[] data) throws android.nfc.FormatException {
        if (data == null)
            throw new java.lang.NullPointerException("data is null");

        java.nio.ByteBuffer buffer = java.nio.ByteBuffer.wrap(data);
        mRecords = android.nfc.NdefRecord.parse(buffer, false);
        if (buffer.remaining() > 0) {
            throw new android.nfc.FormatException("trailing data");
        }
    }
    ...
    public NdefMessage(android.nfc.NdefRecord record, android.nfc.NdefRecord... records) {
        // validate
        if (record == null)
            throw new java.lang.NullPointerException("record cannot be null");

        for (android.nfc.NdefRecord r : records) {
            if (r == null) {
                throw new java.lang.NullPointerException("record cannot be null");
            }
        }
        mRecords = new android.nfc.NdefRecord[1 + records.length];
        mRecords[0] = record;
        java.lang.System.arraycopy(records, 0, mRecords, 1, records.length);
    }
    ...
    public NdefMessage(android.nfc.NdefRecord[] records) {
        // validate
        if (records.length < 1) {
            throw new java.lang.IllegalArgumentException("must have at least one record");
        }
        for (android.nfc.NdefRecord r : records) {
            if (r == null) {
                throw new java.lang.NullPointerException("records cannot contain null");
            }
        }
        mRecords = records;
    }
    ...
    public int getByteArrayLength() {
        int length = 0;
        for (android.nfc.NdefRecord r : mRecords) {
    ...
    public static final android.os.Parcelable.Creator<android.nfc.NdefMessage> CREATOR = new android.os.Parcelable.Creator<android.nfc.NdefMessage>() {
        @java.lang.Override
        public android.nfc.NdefMessage createFromParcel(android.os.Parcel in) {
            int recordsLength = in.readInt();
            android.nfc.NdefRecord[] records = new android.nfc.NdefRecord[recordsLength];
            in.readTypedArray(records, android.nfc.NdefRecord.CREATOR);
            return new android.nfc.NdefMessage(records);
        }

        @java.lang.Override
        public android.nfc.NdefMessage[] newArray(int size) {
            return new android.nfc.NdefMessage[size];
        }
    };

    @java.lang.Override
    public int hashCode() {
        return java.util.Arrays.hashCode(mRecords);
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.nfc.NdefMessage other = ((android.nfc.NdefMessage) (obj));
        return java.util.Arrays.equals(mRecords, other.mRecords);
    }

    @java.lang.Override
    public java.lang.String toString() {
        return "NdefMessage " + java.util.Arrays.toString(mRecords);
    }
}
