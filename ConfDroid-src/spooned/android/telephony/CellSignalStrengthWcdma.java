...
public final class CellSignalStrengthWcdma extends android.telephony.CellSignalStrength implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public CellSignalStrengthWcdma(android.telephony.CellSignalStrengthWcdma s) {
        copyFrom(s);
    }
     ...
     * @unknown 
     */
    protected void copyFrom(android.telephony.CellSignalStrengthWcdma s) {
    ...
    public int getLevel() {
        ...
        if ((asu <= 2) || (asu == 99))
            ...
            if (asu >= android.telephony.CellSignalStrengthWcdma.WCDMA_SIGNAL_STRENGTH_GREAT)
                level = android.telephony.CellSignalStrength.SIGNAL_STRENGTH_GREAT;
            else
                if (asu >= android.telephony.CellSignalStrengthWcdma.WCDMA_SIGNAL_STRENGTH_GOOD)
                    level = android.telephony.CellSignalStrength.SIGNAL_STRENGTH_GOOD;
                else
                    if (asu >= android.telephony.CellSignalStrengthWcdma.WCDMA_SIGNAL_STRENGTH_MODERATE)
        ...
        if (android.telephony.CellSignalStrengthWcdma.DBG)
            android.telephony.CellSignalStrengthWcdma.log("getLevel=" + level);
    ...
    public int getDbm() {
        ...
        if (android.telephony.CellSignalStrengthWcdma.DBG)
            android.telephony.CellSignalStrengthWcdma.log("getDbm=" + dBm);
    ...
    public int getAsuLevel() {
        ...
        int level = mSignalStrength;
        if (android.telephony.CellSignalStrengthWcdma.DBG)
            android.telephony.CellSignalStrengthWcdma.log("getAsuLevel=" + level);
    ...
    public boolean equals(java.lang.Object o) {
        ...
        try {
            s = ((android.telephony.CellSignalStrengthWcdma) (o));
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        if (android.telephony.CellSignalStrengthWcdma.DBG)
            android.telephony.CellSignalStrengthWcdma.log("writeToParcel(Parcel, int): " + toString());
    ...
    private CellSignalStrengthWcdma(android.os.Parcel in) {
        ...
        if (android.telephony.CellSignalStrengthWcdma.DBG)
            android.telephony.CellSignalStrengthWcdma.log("CellSignalStrengthWcdma(Parcel): " + toString());
    ...
    public static final android.os.Parcelable.Creator<android.telephony.CellSignalStrengthWcdma> CREATOR = new android.os.Parcelable.Creator<android.telephony.CellSignalStrengthWcdma>() {
        @java.lang.Override
        public android.telephony.CellSignalStrengthWcdma createFromParcel(android.os.Parcel in) {
            return new android.telephony.CellSignalStrengthWcdma(in);
        }

        @java.lang.Override
        public android.telephony.CellSignalStrengthWcdma[] newArray(int size) {
            return new android.telephony.CellSignalStrengthWcdma[size];
        }
    };
    ...
    private static void log(java.lang.String s) {
        android.telephony.Rlog.w(android.telephony.CellSignalStrengthWcdma.LOG_TAG, s);
    }
}
