 ...
 * {@hide }
 */
public class SmsCbCmasInfo implements android.os.Parcelable {
     ...
     */
    public static final int CMAS_CLASS_PRESIDENTIAL_LEVEL_ALERT = 0x0;

    /**
     * Extreme threat to life and property (Korean Public Alert System Class 1 message).
     */
    public static final int CMAS_CLASS_EXTREME_THREAT = 0x1;

    /**
     * Severe threat to life and property (Korean Public Alert System Class 1 message).
     */
    public static final int CMAS_CLASS_SEVERE_THREAT = 0x2;

    /**
     * Child abduction emergency (AMBER Alert).
     */
    public static final int CMAS_CLASS_CHILD_ABDUCTION_EMERGENCY = 0x3;

    /**
     * CMAS test message.
     */
    public static final int CMAS_CLASS_REQUIRED_MONTHLY_TEST = 0x4;

    /**
     * CMAS exercise.
     */
    public static final int CMAS_CLASS_CMAS_EXERCISE = 0x5;

    /**
     * CMAS category for operator defined use.
     */
    public static final int CMAS_CLASS_OPERATOR_DEFINED_USE = 0x6;
     ...
     */
    public static final int CMAS_RESPONSE_TYPE_SHELTER = 0x0;

    /**
     * CMAS response type: Evacuate (Relocate).
     */
    public static final int CMAS_RESPONSE_TYPE_EVACUATE = 0x1;

    /**
     * CMAS response type: Make preparations.
     */
    public static final int CMAS_RESPONSE_TYPE_PREPARE = 0x2;

    /**
     * CMAS response type: Execute a pre-planned activity.
     */
    public static final int CMAS_RESPONSE_TYPE_EXECUTE = 0x3;

    /**
     * CMAS response type: Attend to information sources.
     */
    public static final int CMAS_RESPONSE_TYPE_MONITOR = 0x4;

    /**
     * CMAS response type: Avoid hazard.
     */
    public static final int CMAS_RESPONSE_TYPE_AVOID = 0x5;

    /**
     * CMAS response type: Evaluate the information in this message (not for public warnings).
     */
    public static final int CMAS_RESPONSE_TYPE_ASSESS = 0x6;

    /**
     * CMAS response type: No action recommended.
     */
    public static final int CMAS_RESPONSE_TYPE_NONE = 0x7;
    ...
    public java.lang.String toString() {
        return ((((((((((("SmsCbCmasInfo{messageClass=" + mMessageClass) + ", category=") + mCategory) + ", responseType=") + mResponseType) + ", severity=") + mSeverity) + ", urgency=") + mUrgency) + ", certainty=") + mCertainty) + '}';
    }
     ...
     */
    public static final android.os.Parcelable.Creator<android.telephony.SmsCbCmasInfo> CREATOR = new android.os.Parcelable.Creator<android.telephony.SmsCbCmasInfo>() {
        @java.lang.Override
        public android.telephony.SmsCbCmasInfo createFromParcel(android.os.Parcel in) {
            return new android.telephony.SmsCbCmasInfo(in);
        }

        @java.lang.Override
        public android.telephony.SmsCbCmasInfo[] newArray(int size) {
            return new android.telephony.SmsCbCmasInfo[size];
        }
    };
}
