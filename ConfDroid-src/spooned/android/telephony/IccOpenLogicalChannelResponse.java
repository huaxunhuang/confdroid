...
public class IccOpenLogicalChannelResponse implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<android.telephony.IccOpenLogicalChannelResponse> CREATOR = new android.os.Parcelable.Creator<android.telephony.IccOpenLogicalChannelResponse>() {
        @java.lang.Override
        public android.telephony.IccOpenLogicalChannelResponse createFromParcel(android.os.Parcel in) {
            return new android.telephony.IccOpenLogicalChannelResponse(in);
        }

        public android.telephony.IccOpenLogicalChannelResponse[] newArray(int size) {
            return new android.telephony.IccOpenLogicalChannelResponse[size];
        }
    };
