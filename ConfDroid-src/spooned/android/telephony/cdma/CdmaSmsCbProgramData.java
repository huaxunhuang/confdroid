...
public class CdmaSmsCbProgramData implements android.os.Parcelable {
     ...
     */
    public CdmaSmsCbProgramData(int operation, int category, int language, int maxMessages, int alertOption, java.lang.String categoryName) {
    ...
    public java.lang.String toString() {
        return ((((((((((("CdmaSmsCbProgramData{operation=" + mOperation) + ", category=") + mCategory) + ", language=") + mLanguage) + ", max messages=") + mMaxMessages) + ", alert option=") + mAlertOption) + ", category name=") + mCategoryName) + '}';
    }
     ...
     */
    public static final android.os.Parcelable.Creator<android.telephony.cdma.CdmaSmsCbProgramData> CREATOR = new android.os.Parcelable.Creator<android.telephony.cdma.CdmaSmsCbProgramData>() {
        @java.lang.Override
        public android.telephony.cdma.CdmaSmsCbProgramData createFromParcel(android.os.Parcel in) {
            return new android.telephony.cdma.CdmaSmsCbProgramData(in);
        }

        @java.lang.Override
        public android.telephony.cdma.CdmaSmsCbProgramData[] newArray(int size) {
            return new android.telephony.cdma.CdmaSmsCbProgramData[size];
        }
    };
}
