...
public class CdmaCellLocation extends android.telephony.CellLocation {
     ...
     * @unknown 
     */
    public static final int INVALID_LAT_LONG = java.lang.Integer.MAX_VALUE;
     ...
     */
    private int mBaseStationLatitude = android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG;
     ...
     */
    private int mBaseStationLongitude = android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG;
    ...
    public CdmaCellLocation() {
        ...
        this.mBaseStationLatitude = android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG;
        this.mBaseStationLongitude = android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG;
        this.mSystemId = -1;
        this.mNetworkId = -1;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        try {
            s = ((android.telephony.cdma.CdmaCellLocation) (o));
        ...
        return (((android.telephony.cdma.CdmaCellLocation.equalsHandlesNulls(this.mBaseStationId, s.mBaseStationId) && android.telephony.cdma.CdmaCellLocation.equalsHandlesNulls(this.mBaseStationLatitude, s.mBaseStationLatitude)) && android.telephony.cdma.CdmaCellLocation.equalsHandlesNulls(this.mBaseStationLongitude, s.mBaseStationLongitude)) && android.telephony.cdma.CdmaCellLocation.equalsHandlesNulls(this.mSystemId, s.mSystemId)) && android.telephony.cdma.CdmaCellLocation.equalsHandlesNulls(this.mNetworkId, s.mNetworkId);
    }
    ...
    public boolean isEmpty() {
        return ((((this.mBaseStationId == (-1)) && (this.mBaseStationLatitude == android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG)) && (this.mBaseStationLongitude == android.telephony.cdma.CdmaCellLocation.INVALID_LAT_LONG)) && (this.mSystemId == (-1))) && (this.mNetworkId == (-1));
    }
     ...
     * 		if value is less than -2592000,
     * 		greater than 2592000, or is not a number.
     */
    public static double convertQuartSecToDecDegrees(int quartSec) {
        if ((java.lang.Double.isNaN(quartSec) || (quartSec < (-2592000))) || (quartSec > 2592000)) {
            // Invalid value
            throw new java.lang.IllegalArgumentException("Invalid coordiante value:" + quartSec);
        }
