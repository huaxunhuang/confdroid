...
public class CdmaSmsCbProgramResults implements android.os.Parcelable {
    ...
    public java.lang.String toString() {
        return ((((("CdmaSmsCbProgramResults{category=" + mCategory) + ", language=") + mLanguage) + ", result=") + mCategoryResult) + '}';
    }
     ...
     */
    public static final android.os.Parcelable.Creator<android.telephony.cdma.CdmaSmsCbProgramResults> CREATOR = new android.os.Parcelable.Creator<android.telephony.cdma.CdmaSmsCbProgramResults>() {
        @java.lang.Override
        public android.telephony.cdma.CdmaSmsCbProgramResults createFromParcel(android.os.Parcel in) {
            return new android.telephony.cdma.CdmaSmsCbProgramResults(in);
        }

        @java.lang.Override
        public android.telephony.cdma.CdmaSmsCbProgramResults[] newArray(int size) {
            return new android.telephony.cdma.CdmaSmsCbProgramResults[size];
        }
    };
}
