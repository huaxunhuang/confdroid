 ...
 * @unknown 
 */
public class PreciseCallState implements android.os.Parcelable {
    /**
    ...
    private int mRingingCallState = android.telephony.PreciseCallState.PRECISE_CALL_STATE_NOT_VALID;

    private int mForegroundCallState = android.telephony.PreciseCallState.PRECISE_CALL_STATE_NOT_VALID;

    private int mBackgroundCallState = android.telephony.PreciseCallState.PRECISE_CALL_STATE_NOT_VALID;

    private int mDisconnectCause = android.telephony.DisconnectCause.NOT_VALID;

    private int mPreciseDisconnectCause = android.telephony.PreciseDisconnectCause.NOT_VALID;
    ...
    public static final android.os.Parcelable.Creator<android.telephony.PreciseCallState> CREATOR = new android.os.Parcelable.Creator<android.telephony.PreciseCallState>() {
        public android.telephony.PreciseCallState createFromParcel(android.os.Parcel in) {
            return new android.telephony.PreciseCallState(in);
        }

        public android.telephony.PreciseCallState[] newArray(int size) {
            return new android.telephony.PreciseCallState[size];
        }
    };
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.telephony.PreciseCallState other = ((android.telephony.PreciseCallState) (obj));
        return ((((mRingingCallState != other.mRingingCallState) && (mForegroundCallState != other.mForegroundCallState)) && (mBackgroundCallState != other.mBackgroundCallState)) && (mDisconnectCause != other.mDisconnectCause)) && (mPreciseDisconnectCause != other.mPreciseDisconnectCause);
    }
