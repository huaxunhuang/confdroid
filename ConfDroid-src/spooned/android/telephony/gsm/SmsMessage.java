...
public class SmsMessage {
     ...
     *
     * @deprecated Use android.telephony.SmsMessage.
     * @unknown pending API Council approval to extend the public API
     */
    @java.lang.Deprecated
    ...
    @java.lang.Deprecated
    public SmsMessage() {
        this(android.telephony.gsm.SmsMessage.getSmsFacility());
    }
    ...
    public static android.telephony.gsm.SmsMessage createFromPdu(byte[] pdu) {
        ...
        if (android.telephony.TelephonyManager.PHONE_TYPE_CDMA == activePhone) {
            wrappedMessage = com.android.internal.telephony.cdma.SmsMessage.createFromPdu(pdu);
        } else {
            wrappedMessage = com.android.internal.telephony.gsm.SmsMessage.createFromPdu(pdu);
        }
        return new android.telephony.gsm.SmsMessage(wrappedMessage);
    }
    ...
    public static int[] calculateLength(java.lang.CharSequence messageBody, boolean use7bitOnly) {
        com.android.internal.telephony.GsmAlphabet.TextEncodingDetails ted = com.android.internal.telephony.gsm.SmsMessage.calculateLength(messageBody, use7bitOnly);
        int[] ret = new int[4];
        ret[0] = ted.msgCount;
    ...
    public static int[] calculateLength(java.lang.String messageBody, boolean use7bitOnly) {
        return android.telephony.gsm.SmsMessage.calculateLength(((java.lang.CharSequence) (messageBody)), use7bitOnly);
    }
     ...
     */
    @java.lang.Deprecated
    public static android.telephony.gsm.SmsMessage.SubmitPdu getSubmitPdu(java.lang.String scAddress, java.lang.String destinationAddress, java.lang.String message, boolean statusReportRequested, byte[] header) {
        com.android.internal.telephony.SmsMessageBase.SubmitPduBase spb;
        int activePhone = android.telephony.TelephonyManager.getDefault().getCurrentPhoneType();
        if (android.telephony.TelephonyManager.PHONE_TYPE_CDMA == activePhone) {
            spb = com.android.internal.telephony.cdma.SmsMessage.getSubmitPdu(scAddress, destinationAddress, message, statusReportRequested, com.android.internal.telephony.SmsHeader.fromByteArray(header));
        } else {
        ...
        return new android.telephony.gsm.SmsMessage.SubmitPdu(spb);
    }
     ...
     */
    @java.lang.Deprecated
    public static android.telephony.gsm.SmsMessage.SubmitPdu getSubmitPdu(java.lang.String scAddress, java.lang.String destinationAddress, java.lang.String message, boolean statusReportRequested) {
        com.android.internal.telephony.SmsMessageBase.SubmitPduBase spb;
        int activePhone = android.telephony.TelephonyManager.getDefault().getCurrentPhoneType();
        if (android.telephony.TelephonyManager.PHONE_TYPE_CDMA == activePhone) {
     ...
     */
    @java.lang.Deprecated
    public static android.telephony.gsm.SmsMessage.SubmitPdu getSubmitPdu(java.lang.String scAddress, java.lang.String destinationAddress, short destinationPort, byte[] data, boolean statusReportRequested) {
        com.android.internal.telephony.SmsMessageBase.SubmitPduBase spb;
        int activePhone = android.telephony.TelephonyManager.getDefault().getCurrentPhoneType();
        if (android.telephony.TelephonyManager.PHONE_TYPE_CDMA == activePhone) {
    ...
    public android.telephony.gsm.SmsMessage.MessageClass getMessageClass() {
        ...
        return android.telephony.gsm.SmsMessage.MessageClass.values()[index];
    }
