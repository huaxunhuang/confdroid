...
public final class SmsManager {
    ...
    public static final android.telephony.gsm.SmsManager getDefault() {
        if (android.telephony.gsm.SmsManager.sInstance == null) {
            android.telephony.gsm.SmsManager.sInstance = new android.telephony.gsm.SmsManager();
        }
        return android.telephony.gsm.SmsManager.sInstance;
    }
     ...
     */
    @java.lang.Deprecated
    public final void sendTextMessage(java.lang.String destinationAddress, java.lang.String scAddress, java.lang.String text, android.app.PendingIntent sentIntent, android.app.PendingIntent deliveryIntent) {
        mSmsMgrProxy.sendTextMessage(destinationAddress, scAddress, text, sentIntent, deliveryIntent);
    }
     ...
     */
    @java.lang.Deprecated
    public final void sendMultipartTextMessage(java.lang.String destinationAddress, java.lang.String scAddress, java.util.ArrayList<java.lang.String> parts, java.util.ArrayList<android.app.PendingIntent> sentIntents, java.util.ArrayList<android.app.PendingIntent> deliveryIntents) {
        mSmsMgrProxy.sendMultipartTextMessage(destinationAddress, scAddress, parts, sentIntents, deliveryIntents);
    }
     ...
     */
    @java.lang.Deprecated
    public final void sendDataMessage(java.lang.String destinationAddress, java.lang.String scAddress, short destinationPort, byte[] data, android.app.PendingIntent sentIntent, android.app.PendingIntent deliveryIntent) {
        mSmsMgrProxy.sendDataMessage(destinationAddress, scAddress, destinationPort, data, sentIntent, deliveryIntent);
    }
     ...
     *
     * @param messageIndex
     * 		is the record index of the message on SIM
     * @return true for success
     * @deprecated Use android.telephony.SmsManager.
    {@hide }
     */
