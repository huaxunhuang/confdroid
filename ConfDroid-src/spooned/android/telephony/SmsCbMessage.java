...
public class SmsCbMessage implements android.os.Parcelable {
     ...
     */
    public SmsCbMessage(int messageFormat, int geographicalScope, int serialNumber, android.telephony.SmsCbLocation location, int serviceCategory, java.lang.String language, java.lang.String body, int priority, android.telephony.SmsCbEtwsInfo etwsWarningInfo, android.telephony.SmsCbCmasInfo cmasWarningInfo) {
     ...
     */
    public SmsCbMessage(android.os.Parcel in) {
        mMessageFormat = in.readInt();
        mGeographicalScope = in.readInt();
        mSerialNumber = in.readInt();
        mLocation = new android.telephony.SmsCbLocation(in);
        ...
        switch (type) {
            case 'E' :
                ...
                mEtwsWarningInfo = new android.telephony.SmsCbEtwsInfo(in);
                mCmasWarningInfo = null;
                break;
            case 'C' :
                // unparcel CMAS warning information
                mEtwsWarningInfo = null;
                mCmasWarningInfo = new android.telephony.SmsCbCmasInfo(in);
                break;
            default :
                mEtwsWarningInfo = null;
                mCmasWarningInfo = null;
    ...
    public static final android.os.Parcelable.Creator<android.telephony.SmsCbMessage> CREATOR = new android.os.Parcelable.Creator<android.telephony.SmsCbMessage>() {
        @java.lang.Override
        public android.telephony.SmsCbMessage createFromParcel(android.os.Parcel in) {
            return new android.telephony.SmsCbMessage(in);
        }

        @java.lang.Override
        public android.telephony.SmsCbMessage[] newArray(int size) {
            return new android.telephony.SmsCbMessage[size];
        }
    };
    ...
    public boolean isEmergencyMessage() {
        return mPriority == android.telephony.SmsCbMessage.MESSAGE_PRIORITY_EMERGENCY;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("SmsCbMessage{geographicalScope=" + mGeographicalScope) + ", serialNumber=") + mSerialNumber) + ", location=") + mLocation) + ", serviceCategory=") + mServiceCategory) + ", language=") + mLanguage) + ", body=") + mBody) + ", priority=") + mPriority) + (mEtwsWarningInfo != null ? ", " + mEtwsWarningInfo.toString() : "")) + (mCmasWarningInfo != null ? ", " + mCmasWarningInfo.toString() : "")) + '}';
    }
