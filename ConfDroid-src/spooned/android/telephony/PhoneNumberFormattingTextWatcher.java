...
public class PhoneNumberFormattingTextWatcher implements android.text.TextWatcher {
     ...
     */
    public PhoneNumberFormattingTextWatcher(java.lang.String countryCode) {
        if (countryCode == null)
            throw new java.lang.IllegalArgumentException();

        mFormatter = com.android.i18n.phonenumbers.PhoneNumberUtil.getInstance().getAsYouTypeFormatter(countryCode);
    }
    ...
    @java.lang.Override
    public synchronized void afterTextChanged(android.text.Editable s) {
        if (mStopFormatting) {
        ...
        java.lang.String formatted = reformat(s, android.text.Selection.getSelectionEnd(s));
        if (formatted != null) {
            ...
            if (formatted.equals(s.toString())) {
                android.text.Selection.setSelection(s, rememberedPos);
            }
            mSelfChange = false;
        }
        android.telephony.PhoneNumberUtils.ttsSpanAsPhoneNumber(s, 0, s.length());
    }
     ...
     */
    private java.lang.String reformat(java.lang.CharSequence s, int cursor) {
    ...
    private java.lang.String getFormattedNumber(char lastNonSeparator, boolean hasCursor) {
