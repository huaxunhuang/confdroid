...
public final class TelephonyHistogram implements android.os.Parcelable {
    ...
    public TelephonyHistogram(int category, int id, int bucketCount) {
        ...
        mCategory = category;
        mId = id;
        mMinTimeMs = java.lang.Integer.MAX_VALUE;
        mMaxTimeMs = 0;
        mAverageTimeMs = 0;
        mSampleCount = 0;
        mInitialTimings = new int[android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT];
        mBucketCount = bucketCount;
        mBucketEndPoints = new int[bucketCount - 1];
        mBucketCounters = new int[bucketCount];
    }

    public TelephonyHistogram(android.telephony.TelephonyHistogram th) {
    ...
    private int[] getDeepCopyOfArray(int[] array) {
        ...
        java.lang.System.arraycopy(array, 0, clone, 0, array.length);
        return clone;
    }
    ...
    public void addTimeTaken(int time) {
        ...
        if ((mSampleCount == 0) || (mSampleCount == java.lang.Integer.MAX_VALUE)) {
            if (mSampleCount == 0) {
                mMinTimeMs = time;
                mMaxTimeMs = time;
                mAverageTimeMs = time;
            ...
            mSampleCount = 1;
            java.util.Arrays.fill(mInitialTimings, 0);
            mInitialTimings[0] = time;
            java.util.Arrays.fill(mBucketEndPoints, 0);
            java.util.Arrays.fill(mBucketCounters, 0);
        } else {
            if (time < mMinTimeMs) {
                mMinTimeMs = time;
            }
            ...
            if (mSampleCount < android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT) {
                ...
                if (mSampleCount == android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT) {
                    ...
                    for (int j = 0; j < android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT; j++) {
    ...
    public java.lang.String toString() {
        java.lang.String basic = ((((((((" Histogram id = " + mId) + " Time(ms): min = ") + mMinTimeMs) + " max = ") + mMaxTimeMs) + " avg = ") + mAverageTimeMs) + " Count = ") + mSampleCount;
        if (mSampleCount < android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT) {
            return basic;
        } else {
            java.lang.StringBuffer intervals = new java.lang.StringBuffer(" Interval Endpoints:");
    ...
    public static final android.os.Parcelable.Creator<android.telephony.TelephonyHistogram> CREATOR = new android.os.Parcelable.Creator<android.telephony.TelephonyHistogram>() {
        @java.lang.Override
        public android.telephony.TelephonyHistogram createFromParcel(android.os.Parcel in) {
            return new android.telephony.TelephonyHistogram(in);
        }

        @java.lang.Override
        public android.telephony.TelephonyHistogram[] newArray(int size) {
            return new android.telephony.TelephonyHistogram[size];
        }
    };

    public TelephonyHistogram(android.os.Parcel in) {
        ...
        if (in.readInt() == android.telephony.TelephonyHistogram.PRESENT) {
            mInitialTimings = new int[android.telephony.TelephonyHistogram.RANGE_CALCULATION_COUNT];
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        ...
        if (mInitialTimings == null) {
            out.writeInt(android.telephony.TelephonyHistogram.ABSENT);
        } else {
            out.writeInt(android.telephony.TelephonyHistogram.PRESENT);
