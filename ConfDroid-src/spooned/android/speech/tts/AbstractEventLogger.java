...
abstract class AbstractEventLogger {
    ...
    AbstractEventLogger(int callerUid, int callerPid, java.lang.String serviceApp) {
        mCallerUid = callerUid;
        mCallerPid = callerPid;
        mServiceApp = serviceApp;
        mReceivedTime = android.os.SystemClock.elapsedRealtime();
    }
    ...
    public void onRequestProcessingStart() {
        mRequestProcessingStartTime = android.os.SystemClock.elapsedRealtime();
    }
    ...
    public void onEngineDataReceived() {
        if (mEngineStartTime == (-1)) {
            mEngineStartTime = android.os.SystemClock.elapsedRealtime();
        }
    }
    ...
    public void onEngineComplete() {
        mEngineCompleteTime = android.os.SystemClock.elapsedRealtime();
    }
    ...
    public void onAudioDataWritten() {
        ...
        if (mPlaybackStartTime == (-1)) {
            mPlaybackStartTime = android.os.SystemClock.elapsedRealtime();
        }
    }
    ...
    public void onCompleted(int statusCode) {
        ...
        long completionTime = android.os.SystemClock.elapsedRealtime();
        ...
        if (((statusCode != android.speech.tts.TextToSpeech.SUCCESS) || (mPlaybackStartTime == (-1))) || (mEngineCompleteTime == (-1))) {
