...
abstract class AbstractSynthesisCallback implements android.speech.tts.SynthesisCallback {
     ...
     * Constructor.
     *
     * @param clientIsUsingV2
     * 		If true, this callback will be used inside
     ...
     */
    int errorCodeOnStop() {
        return mClientIsUsingV2 ? android.speech.tts.TextToSpeech.STOPPED : android.speech.tts.TextToSpeech.ERROR;
    }
}
