...
public abstract class UtteranceProgressListener {
     ...
     * 		The utterance ID of the utterance.
     * @param errorCode
     * 		one of the ERROR_* codes from {@link TextToSpeech}
     */
     ...
     * @unknown 
     */
    static android.speech.tts.UtteranceProgressListener from(final android.speech.tts.TextToSpeech.OnUtteranceCompletedListener listener) {
        return new android.speech.tts.UtteranceProgressListener() {
            @java.lang.Override
            public synchronized void onDone(java.lang.String utteranceId) {
