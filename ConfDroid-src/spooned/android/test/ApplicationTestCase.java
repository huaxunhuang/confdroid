...
public abstract class ApplicationTestCase<T extends android.app.Application> extends android.test.AndroidTestCase {
    java.lang.Class<T> mApplicationClass;
    ...
    private void setupApplication() {
        mApplication = null;
        try {
            mApplication = ((T) (android.app.Instrumentation.newApplication(mApplicationClass, getContext())));
        } catch (java.lang.Exception e) {
            junit.framework.TestCase.assertNotNull(mApplication);
        }
        mAttached = true;
    }
    ...
    protected final void createApplication() {
        junit.framework.TestCase.assertFalse(mCreated);
        if (!mAttached) {
            setupApplication();
        }
        junit.framework.TestCase.assertNotNull(mApplication);
    ...
    protected void tearDown() throws java.lang.Exception {
        ...
        scrubClass(android.test.ApplicationTestCase.class);
        super.tearDown();
    }
    ...
    public final void testApplicationTestCaseSetUpProperly() throws java.lang.Exception {
        setupApplication();
        junit.framework.TestCase.assertNotNull("Application class could not be instantiated successfully", mApplication);
    }
}
