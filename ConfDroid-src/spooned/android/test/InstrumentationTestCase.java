...
public class InstrumentationTestCase extends junit.framework.TestCase {
     ...
     * 		the instrumentation to use with this instance
     */
     ...
     * @param extras
     * 		Optional extra stuff to pass to the activity.
     * @return The activity, or null if non launched.
     */
    public final <T extends android.app.Activity> T launchActivity(java.lang.String pkg, java.lang.Class<T> activityCls, android.os.Bundle extras) {
    ...
    public final <T extends android.app.Activity> T launchActivityWithIntent(java.lang.String pkg, java.lang.Class<T> activityCls, android.content.Intent intent) {
     ...
     *
     * @param r
     * 		runnable containing test code in the {@link Runnable#run()} method
     */
    public void runTestOnUiThread(final java.lang.Runnable r) throws java.lang.Throwable {
        final java.lang.Throwable[] exceptions = new java.lang.Throwable[1];
        getInstrumentation().runOnMainSync(new java.lang.Runnable() {
            public void run() {
                try {
                    r.run();
    ...
    protected void runTest() throws java.lang.Throwable {
        java.lang.String fName = getName();
        junit.framework.TestCase.assertNotNull(fName);
        ...
        try {
            ...
            // inherited ones.
            method = getClass().getMethod(fName, ((java.lang.Class[]) (null)));
        } catch (java.lang.NoSuchMethodException e) {
            junit.framework.TestCase.fail(("Method \"" + fName) + "\" not found");
        }
        if (!java.lang.reflect.Modifier.isPublic(method.getModifiers())) {
            junit.framework.TestCase.fail(("Method \"" + fName) + "\" should be public");
        }
        int runCount = 1;
        boolean isRepetitive = false;
        if (method.isAnnotationPresent(android.test.FlakyTest.class)) {
            runCount = method.getAnnotation(android.test.FlakyTest.class).tolerance();
        } else
            if (method.isAnnotationPresent(android.test.RepetitiveTest.class)) {
                runCount = method.getAnnotation(android.test.RepetitiveTest.class).numIterations();
                isRepetitive = true;
            }
        ...
        if (method.isAnnotationPresent(android.test.UiThreadTest.class)) {
            ...
            final java.lang.reflect.Method testMethod = method;
            final java.lang.Throwable[] exceptions = new java.lang.Throwable[1];
            getInstrumentation().runOnMainSync(new java.lang.Runnable() {
                public void run() {
                    try {
    ...
    private void runMethod(java.lang.reflect.Method runMethod, int tolerance) throws java.lang.Throwable {
        runMethod(runMethod, tolerance, false);
    }

    private void runMethod(java.lang.reflect.Method runMethod, int tolerance, boolean isRepetitive) throws java.lang.Throwable {
        ...
        do {
            try {
                ...
                if (isRepetitive) {
                    android.os.Bundle iterations = new android.os.Bundle();
    ...
    public void sendKeys(java.lang.String keysSequence) {
        final java.lang.String[] keys = keysSequence.split(" ");
        ...
        for (int i = 0; i < count; i++) {
            ...
            int keyCount;
            try {
                keyCount = (repeater == (-1)) ? 1 : java.lang.Integer.parseInt(key.substring(0, repeater));
            ...
            for (int j = 0; j < keyCount; j++) {
                try {
                    final java.lang.reflect.Field keyCodeField = android.view.KeyEvent.class.getField("KEYCODE_" + key);
     ...
     *
     * @param keys
     * 		The series of key codes to send through instrumentation.
     */
    ...
    public void sendRepeatedKeys(int... keys) {
        final int count = keys.length;
        if ((count & 0x1) == 0x1) {
            throw new java.lang.IllegalArgumentException("The size of the keys array must " + "be a multiple of 2");
        }
        final android.app.Instrumentation instrumentation = getInstrumentation();
