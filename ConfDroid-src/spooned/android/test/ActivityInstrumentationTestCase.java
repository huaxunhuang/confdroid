...
public abstract class ActivityInstrumentationTestCase<T extends android.app.Activity> extends android.test.ActivityTestCase {
     ...
     */
    public ActivityInstrumentationTestCase(java.lang.String pkg, java.lang.Class<T> activityClass) {
     ...
     * 		true = in touch mode
     */
    public ActivityInstrumentationTestCase(java.lang.String pkg, java.lang.Class<T> activityClass, boolean initialTouchMode) {
    ...
    protected void setUp() throws java.lang.Exception {
        ...
        final java.lang.String targetPackageName = getInstrumentation().getTargetContext().getPackageName();
    ...
    public void testActivityTestCaseSetUpProperly() throws java.lang.Exception {
        junit.framework.TestCase.assertNotNull("activity should be launched successfully", getActivity());
    }
}
