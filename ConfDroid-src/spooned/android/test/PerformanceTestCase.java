...
public interface PerformanceTestCase {
    ...
    public interface Intermediates {
        ...
        void addIntermediate(java.lang.String name);

        void addIntermediate(java.lang.String name, long timeInNS);
    ...
    decide.
     */
    int startPerformance(android.test.PerformanceTestCase.Intermediates intermediates);
