...
public abstract class ServiceTestCase<T extends android.app.Service> extends android.test.AndroidTestCase {
    java.lang.Class<T> mServiceClass;
     ...
     *
     * @param serviceClass
     * 		The type of the service under test.
     */
    ...
    private android.content.Intent mServiceIntent = null;
    ...
    protected void setupService() {
        ...
        try {
            ...
            junit.framework.TestCase.assertNotNull(mService);
        }
        if (getApplication() == null) {
            setApplication(new android.test.mock.MockApplication());
        }
        // ActivityThread not actually used in Service
        // token not needed when not talking with the activity manager
        // mocked services don't talk with the activity manager
        mService.attach(getContext(), null, mServiceClass.getName(), null, getApplication(), null);
        junit.framework.TestCase.assertNotNull(mService);
        mServiceId = new java.util.Random().nextInt();
    ...
    protected android.os.IBinder bindService(android.content.Intent intent) {
        ...
        android.os.IBinder result = mService.onBind(intent);
        mServiceBound = true;
        return result;
    }
    ...
    protected void tearDown() throws java.lang.Exception {
        ...
        scrubClass(android.test.ServiceTestCase.class);
        super.tearDown();
    }
     ...
     *
     * @param application
     * 		The Application object that is used by the service under test.
     * @see #getApplication()
     */
    ...
    public void testServiceTestCaseSetUpProperly() throws java.lang.Exception {
        setupService();
        junit.framework.TestCase.assertNotNull("service should be launched successfully", mService);
    }
}
