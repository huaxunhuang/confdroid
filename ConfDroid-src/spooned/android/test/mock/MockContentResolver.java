...
public class MockContentResolver extends android.content.ContentResolver {
    java.util.Map<java.lang.String, android.content.ContentProvider> mProviders;
    ...
    public MockContentResolver(android.content.Context context) {
        super(context);
        mProviders = com.google.android.collect.Maps.newHashMap();
    }
     ...
     * @param provider
     * 		An instance of {@link android.content.ContentProvider} or one of its
     * 		subclasses, or null.
     */
    public void addProvider(java.lang.String name, android.content.ContentProvider provider) {
    ...
    protected android.content.IContentProvider acquireExistingProvider(android.content.Context context, java.lang.String name) {
        ...
        final android.content.ContentProvider provider = mProviders.get(name);
        if (provider != null) {
     ...
     *
     * @param uri
     * 		(Ignored) The uri of the content provider.
     * @param observer
     * 		(Ignored) The observer that originated the change.
     * @param syncToNetwork
     * 		(Ignored) If true, attempt to sync the change to the network.
     */
    @java.lang.Override
