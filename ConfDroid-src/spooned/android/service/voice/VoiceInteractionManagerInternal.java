 ...
 *
 *
 * @unknown Private interface to the VoiceInteractionManagerService for use by ActivityManagerService.
 */
public abstract class VoiceInteractionManagerInternal {
     ...
     * 		The binder token representing the calling activity.
     * @param options
     * 		
     */
    public abstract void startLocalVoiceInteraction(android.os.IBinder callingActivity, android.os.Bundle options);
    ...
    public abstract void stopLocalVoiceInteraction(android.os.IBinder callingActivity);
}
