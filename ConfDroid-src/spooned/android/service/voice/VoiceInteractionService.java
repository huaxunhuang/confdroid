...
public class VoiceInteractionService extends android.app.Service {
    ...
    android.service.voice.IVoiceInteractionService mInterface = new android.service.voice.IVoiceInteractionService.Stub() {
        @java.lang.Override
        public void ready() {
            mHandler.sendEmptyMessage(android.service.voice.VoiceInteractionService.MSG_READY);
        }

        @java.lang.Override
        public void shutdown() {
            mHandler.sendEmptyMessage(android.service.voice.VoiceInteractionService.MSG_SHUTDOWN);
        }

        @java.lang.Override
        public void soundModelsChanged() {
            mHandler.sendEmptyMessage(android.service.voice.VoiceInteractionService.MSG_SOUND_MODELS_CHANGED);
        }

        @java.lang.Override
        public void launchVoiceAssistFromKeyguard() throws android.os.RemoteException {
            mHandler.sendEmptyMessage(android.service.voice.VoiceInteractionService.MSG_LAUNCH_VOICE_ASSIST_FROM_KEYGUARD);
        }
    };
    ...
    class MyHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case android.service.voice.VoiceInteractionService.MSG_READY :
                    onReady();
                    break;
                case android.service.voice.VoiceInteractionService.MSG_SHUTDOWN :
                    onShutdownInternal();
                    break;
                case android.service.voice.VoiceInteractionService.MSG_SOUND_MODELS_CHANGED :
                    onSoundModelsChangedInternal();
                    break;
                case android.service.voice.VoiceInteractionService.MSG_LAUNCH_VOICE_ASSIST_FROM_KEYGUARD :
     ...
     */
    public static boolean isActiveService(android.content.Context context, android.content.ComponentName service) {
        java.lang.String cur = android.provider.Settings.Secure.getString(context.getContentResolver(), android.provider.Settings.Secure.VOICE_INTERACTION_SERVICE);
        if ((cur == null) || cur.isEmpty()) {
            return false;
        }
        android.content.ComponentName curComp = android.content.ComponentName.unflattenFromString(cur);
        if (curComp == null) {
            return false;
        }
     ...
     */
    public void showSession(android.os.Bundle args, int flags) {
    ...
    public void onCreate() {
        super.onCreate();
        mHandler = new android.service.voice.VoiceInteractionService.MyHandler();
    }

    @java.lang.Override
    public android.os.IBinder onBind(android.content.Intent intent) {
        if (android.service.voice.VoiceInteractionService.SERVICE_INTERFACE.equals(intent.getAction())) {
    ...
    public void onReady() {
        ...
        mKeyphraseEnrollmentInfo = new android.hardware.soundtrigger.KeyphraseEnrollmentInfo(getPackageManager());
    }
     ...
     */
    public final android.service.voice.AlwaysOnHotwordDetector createAlwaysOnHotwordDetector(java.lang.String keyphrase, java.util.Locale locale, android.service.voice.AlwaysOnHotwordDetector.Callback callback) {
        if (mSystemService == null) {
            throw new java.lang.IllegalStateException("Not available until onReady() is called");
        }
        synchronized(mLock) {
            ...
            safelyShutdownHotwordDetector();
            mHotwordDetector = new android.service.voice.AlwaysOnHotwordDetector(keyphrase, locale, callback, mKeyphraseEnrollmentInfo, mInterface, mSystemService);
        }
