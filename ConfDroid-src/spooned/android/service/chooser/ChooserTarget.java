...
public final class ChooserTarget implements android.os.Parcelable {
     ...
     */
    public ChooserTarget(java.lang.CharSequence title, android.graphics.drawable.Icon icon, float score, android.content.ComponentName componentName, @android.annotation.Nullable
    android.os.Bundle intentExtras) {
        mTitle = title;
        mIcon = icon;
        if ((score > 1.0F) || (score < 0.0F)) {
            throw new java.lang.IllegalArgumentException((("Score " + score) + " out of range; ") + "must be between 0.0f and 1.0f");
        }
        mScore = score;
    ...
    ChooserTarget(android.os.Parcel in) {
        ...
        mScore = in.readFloat();
        mComponentName = android.content.ComponentName.readFromParcel(in);
    ...
    public java.lang.String toString() {
        return ((((((("ChooserTarget{" + mComponentName) + ", ") + mIntentExtras) + ", '") + mTitle) + "', ") + mScore) + "}";
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.content.ComponentName.writeToParcel(mComponentName, dest);
        dest.writeBundle(mIntentExtras);
    }

    public static final android.os.Parcelable.Creator<android.service.chooser.ChooserTarget> CREATOR = new android.os.Parcelable.Creator<android.service.chooser.ChooserTarget>() {
        @java.lang.Override
        public android.service.chooser.ChooserTarget createFromParcel(android.os.Parcel source) {
            return new android.service.chooser.ChooserTarget(source);
        }

        @java.lang.Override
        public android.service.chooser.ChooserTarget[] newArray(int size) {
            return new android.service.chooser.ChooserTarget[size];
        }
    };
}
