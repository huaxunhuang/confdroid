...
public interface WindowInsetsAnimationListener {
     ...
     */
    void onStarted(android.view.WindowInsetsAnimationListener.InsetsAnimation animation);
     ...
     */
    android.view.WindowInsets onProgress(android.view.WindowInsets insets);

    /**
     * Called when an inset animation has finished.
     *
     * @param animation
     * 		The animation that has finished running.
     */
    void onFinished(android.view.WindowInsetsAnimationListener.InsetsAnimation animation);
    ...
    class InsetsAnimation {
         ...
         * @unknown 
         */
        InsetsAnimation(int typeMask, android.graphics.Insets lowerBound, android.graphics.Insets upperBound) {
            mTypeMask = typeMask;
