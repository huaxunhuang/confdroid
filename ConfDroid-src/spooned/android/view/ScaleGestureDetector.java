...
public class ScaleGestureDetector {
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768938)
    ...
    private int mAnchoredScaleMode = android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_NONE;
     ...
     */
    public ScaleGestureDetector(android.content.Context context, android.view.ScaleGestureDetector.OnScaleGestureListener listener) {
     ...
     * 		if {@code listener} is null.
     */
    public ScaleGestureDetector(android.content.Context context, android.view.ScaleGestureDetector.OnScaleGestureListener listener, android.os.Handler handler) {
        mContext = context;
        mListener = listener;
        final android.view.ViewConfiguration viewConfiguration = android.view.ViewConfiguration.get(context);
    ...
    public boolean onTouchEvent(android.view.MotionEvent event) {
        ...
        final boolean isStylusButtonDown = (event.getButtonState() & android.view.MotionEvent.BUTTON_STYLUS_PRIMARY) != 0;
        final boolean anchoredScaleCancelled = (mAnchoredScaleMode == android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_STYLUS) && (!isStylusButtonDown);
        final boolean streamComplete = ((action == android.view.MotionEvent.ACTION_UP) || (action == android.view.MotionEvent.ACTION_CANCEL)) || anchoredScaleCancelled;
        if ((action == android.view.MotionEvent.ACTION_DOWN) || streamComplete) {
            ...
            if (mInProgress) {
                ...
                mInProgress = false;
                mInitialSpan = 0;
                mAnchoredScaleMode = android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_NONE;
            } else
                if (inAnchoredScaleMode() && streamComplete) {
                    mInProgress = false;
                    mInitialSpan = 0;
                    mAnchoredScaleMode = android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_NONE;
                }
        ...
        if (((((!mInProgress) && mStylusScaleEnabled) && (!inAnchoredScaleMode())) && (!streamComplete)) && isStylusButtonDown) {
            ...
            mAnchoredScaleMode = android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_STYLUS;
            mInitialSpan = 0;
        }
        final boolean configChanged = (((action == android.view.MotionEvent.ACTION_DOWN) || (action == android.view.MotionEvent.ACTION_POINTER_UP)) || (action == android.view.MotionEvent.ACTION_POINTER_DOWN)) || anchoredScaleCancelled;
        final boolean pointerUp = action == android.view.MotionEvent.ACTION_POINTER_UP;
        ...
        for (int i = 0; i < count; i++) {
            ...
            devSumX += java.lang.Math.abs(event.getX(i) - focusX);
            devSumY += java.lang.Math.abs(event.getY(i) - focusY);
        }
        ...
        if (inAnchoredScaleMode()) {
            ...
            span = ((float) (java.lang.Math.hypot(spanX, spanY)));
        }
        ...
        if (((!mInProgress) && (span >= minSpan)) && (wasInProgress || (java.lang.Math.abs(span - mInitialSpan) > mSpanSlop))) {
            mPrevSpanX = mCurrSpanX = spanX;
            mPrevSpanY = mCurrSpanY = spanY;
    ...
    private boolean inAnchoredScaleMode() {
        return mAnchoredScaleMode != android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_NONE;
    }
        ...
        if (mQuickScaleEnabled && (mGestureDetector == null)) {
            android.view.GestureDetector.SimpleOnGestureListener gestureListener = new android.view.GestureDetector.SimpleOnGestureListener() {
                ...
                public boolean onDoubleTap(android.view.MotionEvent e) {
                    ...
                    mAnchoredScaleMode = android.view.ScaleGestureDetector.ANCHORED_SCALE_MODE_DOUBLE_TAP;
                    return true;
                }
            };
            mGestureDetector = new android.view.GestureDetector(mContext, gestureListener, mHandler);
        }
    }
     ...
     *
     * @param scales
     * 		true to enable stylus scaling, false to disable.
     */
    ...
    public float getScaleFactor() {
        if (inAnchoredScaleMode()) {
            ...
            final float spanDiff = java.lang.Math.abs(1 - (mCurrSpan / mPrevSpan)) * android.view.ScaleGestureDetector.SCALE_FACTOR;
