...
public interface WindowInsetsAnimationController {
     ...
     *
     * @param insets
     * 		The new insets to apply. Based on the requested insets, the system will
     ...
     */
    void changeInsets(@android.annotation.NonNull
     ...
     *
     * @param shownTypes
     * 		The list of windows causing insets that should remain shown after finishing
     * 		the animation.
     */
    void finish(@android.view.WindowInsets.Type.InsetType
    int shownTypes);
}
