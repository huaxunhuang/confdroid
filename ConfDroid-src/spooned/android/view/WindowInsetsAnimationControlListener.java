...
public interface WindowInsetsAnimationControlListener {
     ...
     * @param types
     * 		The {@link InsetType}s it was able to gain control over. Note that this may be
     ...
     */
    void onReady(@android.annotation.NonNull
    android.view.WindowInsetsAnimationController controller, @android.view.WindowInsets.Type.InsetType
    int types);
