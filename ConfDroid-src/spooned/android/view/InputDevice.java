...
public final class InputDevice implements android.os.Parcelable {
    ...
    private final java.util.ArrayList<android.view.InputDevice.MotionRange> mMotionRanges = new java.util.ArrayList<android.view.InputDevice.MotionRange>();

    private android.os.Vibrator mVibrator;// guarded by mMotionRanges during initialization
     ...
     */
    public static final int SOURCE_CLASS_NONE = 0x0;
     ...
     */
    public static final int SOURCE_CLASS_BUTTON = 0x1;
     ...
     */
    public static final int SOURCE_CLASS_POINTER = 0x2;
     ...
     */
    public static final int SOURCE_CLASS_TRACKBALL = 0x4;
     ...
     */
    public static final int SOURCE_CLASS_POSITION = 0x8;
     ...
     */
    public static final int SOURCE_UNKNOWN = 0x0;
     ...
     */
    public static final int SOURCE_KEYBOARD = 0x100 | android.view.InputDevice.SOURCE_CLASS_BUTTON;
     ...
     * @see #SOURCE_CLASS_BUTTON
     */
    public static final int SOURCE_DPAD = 0x200 | android.view.InputDevice.SOURCE_CLASS_BUTTON;
     ...
     * @see #SOURCE_CLASS_BUTTON
     */
    public static final int SOURCE_GAMEPAD = 0x400 | android.view.InputDevice.SOURCE_CLASS_BUTTON;
     ...
     */
    public static final int SOURCE_TOUCHSCREEN = 0x1000 | android.view.InputDevice.SOURCE_CLASS_POINTER;
     ...
     * @see #SOURCE_CLASS_POINTER
     */
    public static final int SOURCE_MOUSE = 0x2000 | android.view.InputDevice.SOURCE_CLASS_POINTER;
     ...
     * @see #SOURCE_CLASS_POINTER
     */
    public static final int SOURCE_STYLUS = 0x4000 | android.view.InputDevice.SOURCE_CLASS_POINTER;
     ...
     * @see #SOURCE_CLASS_POINTER
     */
    public static final int SOURCE_BLUETOOTH_STYLUS = 0x8000 | android.view.InputDevice.SOURCE_STYLUS;
     ...
     */
    public static final int SOURCE_TRACKBALL = 0x10000 | android.view.InputDevice.SOURCE_CLASS_TRACKBALL;
     ...
     * @see #SOURCE_CLASS_TRACKBALL
     */
    public static final int SOURCE_MOUSE_RELATIVE = 0x20000 | android.view.InputDevice.SOURCE_CLASS_TRACKBALL;
     ...
     */
    public static final int SOURCE_TOUCHPAD = 0x100000 | android.view.InputDevice.SOURCE_CLASS_POSITION;
     ...
     */
    public static final int SOURCE_TOUCH_NAVIGATION = 0x200000 | android.view.InputDevice.SOURCE_CLASS_NONE;
     ...
     * @see #SOURCE_CLASS_NONE
     */
    public static final int SOURCE_ROTARY_ENCODER = 0x400000 | android.view.InputDevice.SOURCE_CLASS_NONE;
     ...
     */
    public static final int SOURCE_JOYSTICK = 0x1000000 | android.view.InputDevice.SOURCE_CLASS_JOYSTICK;
     ...
     */
    public static final int SOURCE_HDMI = 0x2000000 | android.view.InputDevice.SOURCE_CLASS_BUTTON;
    ...
    public static final int MOTION_RANGE_X = android.view.MotionEvent.AXIS_X;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_Y = android.view.MotionEvent.AXIS_Y;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_PRESSURE = android.view.MotionEvent.AXIS_PRESSURE;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_SIZE = android.view.MotionEvent.AXIS_SIZE;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_TOUCH_MAJOR = android.view.MotionEvent.AXIS_TOUCH_MAJOR;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_TOUCH_MINOR = android.view.MotionEvent.AXIS_TOUCH_MINOR;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_TOOL_MAJOR = android.view.MotionEvent.AXIS_TOOL_MAJOR;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_TOOL_MINOR = android.view.MotionEvent.AXIS_TOOL_MINOR;
     ...
     */
    @java.lang.Deprecated
    public static final int MOTION_RANGE_ORIENTATION = android.view.MotionEvent.AXIS_ORIENTATION;
    ...
    public static final android.os.Parcelable.Creator<android.view.InputDevice> CREATOR = new android.os.Parcelable.Creator<android.view.InputDevice>() {
        public android.view.InputDevice createFromParcel(android.os.Parcel in) {
            return new android.view.InputDevice(in);
        }

        public android.view.InputDevice[] newArray(int size) {
            return new android.view.InputDevice[size];
        }
    };

    // Called by native code.
    @android.annotation.UnsupportedAppUsage
    private InputDevice(int id, int generation, int controllerNumber, java.lang.String name, int vendorId, int productId, java.lang.String descriptor, boolean isExternal, int sources, int keyboardType, android.view.KeyCharacterMap keyCharacterMap, boolean hasVibrator, boolean hasMicrophone, boolean hasButtonUnderPad) {
        mId = id;
        ...
        mIdentifier = new android.hardware.input.InputDeviceIdentifier(descriptor, vendorId, productId);
    }
    ...
    private InputDevice(android.os.Parcel in) {
        ...
        mKeyCharacterMap = this.CREATOR.createFromParcel(in);
        mHasVibrator = in.readInt() != 0;
        mHasMicrophone = in.readInt() != 0;
        mHasButtonUnderPad = in.readInt() != 0;
        mIdentifier = new android.hardware.input.InputDeviceIdentifier(mDescriptor, mVendorId, mProductId);
        int numRanges = in.readInt();
        if (numRanges > android.view.InputDevice.MAX_RANGES) {
            numRanges = android.view.InputDevice.MAX_RANGES;
        }
    ...
    public static android.view.InputDevice getDevice(int id) {
        return android.hardware.input.InputManager.getInstance().getInputDevice(id);
    }
    ...
    public static int[] getDeviceIds() {
        return android.hardware.input.InputManager.getInstance().getInputDeviceIds();
    }
    ...
    public boolean isFullKeyboard() {
        return ((mSources & android.view.InputDevice.SOURCE_KEYBOARD) == android.view.InputDevice.SOURCE_KEYBOARD) && (mKeyboardType == android.view.InputDevice.KEYBOARD_TYPE_ALPHABETIC);
    }
    ...
    public boolean[] hasKeys(int... keys) {
        return android.hardware.input.InputManager.getInstance().deviceHasKeys(mId, keys);
    }
    ...
    public android.view.InputDevice.MotionRange getMotionRange(int axis) {
        ...
        for (int i = 0; i < numRanges; i++) {
            final android.view.InputDevice.MotionRange range = mMotionRanges.get(i);
            if (range.mAxis == axis) {
                return range;
            }
        }
    ...
    private void addMotionRange(int axis, int source, float min, float max, float flat, float fuzz, float resolution) {
        mMotionRanges.add(new android.view.InputDevice.MotionRange(axis, source, min, max, flat, fuzz, resolution));
    }
    ...
    public android.os.Vibrator getVibrator() {
        synchronized(mMotionRanges) {
            if (mVibrator == null) {
                if (mHasVibrator) {
                    mVibrator = android.hardware.input.InputManager.getInstance().getInputDeviceVibrator(mId);
                } else {
                    mVibrator = android.os.NullVibrator.getInstance();
                }
            }
            return mVibrator;
        }
    ...
    public boolean isEnabled() {
        return android.hardware.input.InputManager.getInstance().isInputDeviceEnabled(mId);
    }
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(android.Manifest.permission.DISABLE_INPUT_DEVICE)
    @android.annotation.TestApi
    public void enable() {
        android.hardware.input.InputManager.getInstance().enableInputDevice(mId);
    }
    ...
    @android.annotation.TestApi
    public void disable() {
        android.hardware.input.InputManager.getInstance().disableInputDevice(mId);
    }
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        ...
        for (int i = 0; i < numRanges; i++) {
            android.view.InputDevice.MotionRange range = mMotionRanges.get(i);
    ...
    public java.lang.String toString() {
        ...
        switch (mKeyboardType) {
            case android.view.InputDevice.KEYBOARD_TYPE_NONE :
                description.append("none");
                break;
            case android.view.InputDevice.KEYBOARD_TYPE_NON_ALPHABETIC :
                description.append("non-alphabetic");
                break;
            case android.view.InputDevice.KEYBOARD_TYPE_ALPHABETIC :
        ...
        description.append("  Sources: 0x").append(java.lang.Integer.toHexString(mSources)).append(" (");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_KEYBOARD, "keyboard");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_DPAD, "dpad");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_TOUCHSCREEN, "touchscreen");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_MOUSE, "mouse");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_STYLUS, "stylus");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_TRACKBALL, "trackball");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_MOUSE_RELATIVE, "mouse_relative");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_TOUCHPAD, "touchpad");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_JOYSTICK, "joystick");
        appendSourceDescriptionIfApplicable(description, android.view.InputDevice.SOURCE_GAMEPAD, "gamepad");
        description.append(" )\n");
        final int numAxes = mMotionRanges.size();
        for (int i = 0; i < numAxes; i++) {
            android.view.InputDevice.MotionRange range = mMotionRanges.get(i);
            description.append("    ").append(android.view.MotionEvent.axisToString(range.mAxis));
            description.append(": source=0x").append(java.lang.Integer.toHexString(range.mSource));
