...
public class KeyCharacterMap implements android.os.Parcelable {
    ...
    static {
        android.view.KeyCharacterMap.addCombining('\u0300', android.view.KeyCharacterMap.ACCENT_GRAVE);
        android.view.KeyCharacterMap.addCombining('\u0301', android.view.KeyCharacterMap.ACCENT_ACUTE);
        android.view.KeyCharacterMap.addCombining('\u0302', android.view.KeyCharacterMap.ACCENT_CIRCUMFLEX);
        android.view.KeyCharacterMap.addCombining('\u0303', android.view.KeyCharacterMap.ACCENT_TILDE);
        android.view.KeyCharacterMap.addCombining('\u0304', android.view.KeyCharacterMap.ACCENT_MACRON);
        android.view.KeyCharacterMap.addCombining('\u0306', android.view.KeyCharacterMap.ACCENT_BREVE);
        android.view.KeyCharacterMap.addCombining('\u0307', android.view.KeyCharacterMap.ACCENT_DOT_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u0308', android.view.KeyCharacterMap.ACCENT_UMLAUT);
        android.view.KeyCharacterMap.addCombining('\u0309', android.view.KeyCharacterMap.ACCENT_HOOK_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u030a', android.view.KeyCharacterMap.ACCENT_RING_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u030b', android.view.KeyCharacterMap.ACCENT_DOUBLE_ACUTE);
        android.view.KeyCharacterMap.addCombining('\u030c', android.view.KeyCharacterMap.ACCENT_CARON);
        android.view.KeyCharacterMap.addCombining('\u030d', android.view.KeyCharacterMap.ACCENT_VERTICAL_LINE_ABOVE);
        ...
        android.view.KeyCharacterMap.addCombining('\u0312', android.view.KeyCharacterMap.ACCENT_TURNED_COMMA_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u0313', android.view.KeyCharacterMap.ACCENT_COMMA_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u0314', android.view.KeyCharacterMap.ACCENT_REVERSED_COMMA_ABOVE);
        android.view.KeyCharacterMap.addCombining('\u0315', android.view.KeyCharacterMap.ACCENT_COMMA_ABOVE_RIGHT);
        android.view.KeyCharacterMap.addCombining('\u031b', android.view.KeyCharacterMap.ACCENT_HORN);
        android.view.KeyCharacterMap.addCombining('\u0323', android.view.KeyCharacterMap.ACCENT_DOT_BELOW);
        // addCombining('\u0326', ACCENT_COMMA_BELOW);
        android.view.KeyCharacterMap.addCombining('\u0327', android.view.KeyCharacterMap.ACCENT_CEDILLA);
        android.view.KeyCharacterMap.addCombining('\u0328', android.view.KeyCharacterMap.ACCENT_OGONEK);
        android.view.KeyCharacterMap.addCombining('\u0329', android.view.KeyCharacterMap.ACCENT_VERTICAL_LINE_BELOW);
        android.view.KeyCharacterMap.addCombining('\u0331', android.view.KeyCharacterMap.ACCENT_MACRON_BELOW);
        android.view.KeyCharacterMap.addCombining('\u0335', android.view.KeyCharacterMap.ACCENT_STROKE);
        ...
        android.view.KeyCharacterMap.sCombiningToAccent.append('\u0340', android.view.KeyCharacterMap.ACCENT_GRAVE);
        android.view.KeyCharacterMap.sCombiningToAccent.append('\u0341', android.view.KeyCharacterMap.ACCENT_ACUTE);
        android.view.KeyCharacterMap.sCombiningToAccent.append('\u0343', android.view.KeyCharacterMap.ACCENT_COMMA_ABOVE);
        // One-way legacy mappings to preserve compatibility with older applications.
        android.view.KeyCharacterMap.sAccentToCombining.append(android.view.KeyCharacterMap.ACCENT_GRAVE_LEGACY, '\u0300');
        android.view.KeyCharacterMap.sAccentToCombining.append(android.view.KeyCharacterMap.ACCENT_CIRCUMFLEX_LEGACY, '\u0302');
        android.view.KeyCharacterMap.sAccentToCombining.append(android.view.KeyCharacterMap.ACCENT_TILDE_LEGACY, '\u0303');
    }

    private static void addCombining(int combining, int accent) {
        android.view.KeyCharacterMap.sCombiningToAccent.append(combining, accent);
        android.view.KeyCharacterMap.sAccentToCombining.append(accent, combining);
    }
     ...
     */
    private static final android.util.SparseIntArray sDeadKeyCache = new android.util.SparseIntArray();

    private static final java.lang.StringBuilder sDeadKeyBuilder = new java.lang.StringBuilder();

    static {
        // Non-standard decompositions.
        // Stroke modifier for Finnish multilingual keyboard and others.
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'D', '\u0110');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'G', '\u01e4');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'H', '\u0126');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'I', '\u0197');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'L', '\u0141');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'O', '\u00d8');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'T', '\u0166');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'd', '\u0111');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'g', '\u01e5');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'h', '\u0127');
        android.view.KeyCharacterMap.addDeadKey(android.view.KeyCharacterMap.ACCENT_STROKE, 'i', '\u0268');
    ...
    private static void addDeadKey(int accent, int c, int result) {
        final int combining = android.view.KeyCharacterMap.sAccentToCombining.get(accent);
        if (combining == 0) {
            throw new java.lang.IllegalStateException("Invalid dead key declaration.");
        }
        final int combination = (combining << 16) | c;
        android.view.KeyCharacterMap.sDeadKeyCache.put(combination, result);
    }

    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.view.KeyCharacterMap> CREATOR = new android.os.Parcelable.Creator<android.view.KeyCharacterMap>() {
        public android.view.KeyCharacterMap createFromParcel(android.os.Parcel in) {
            return new android.view.KeyCharacterMap(in);
        }

        public android.view.KeyCharacterMap[] newArray(int size) {
            return new android.view.KeyCharacterMap[size];
        }
    };
    ...
    private static native android.view.KeyEvent[] nativeGetEvents(long ptr, char[] chars);

    private KeyCharacterMap(android.os.Parcel in) {
        if (in == null) {
            throw new java.lang.IllegalArgumentException("parcel must not be null");
        }
        mPtr = android.view.KeyCharacterMap.nativeReadFromParcel(in);
        if (mPtr == 0) {
    ...
    protected void finalize() throws java.lang.Throwable {
        if (mPtr != 0) {
            android.view.KeyCharacterMap.nativeDispose(mPtr);
            mPtr = 0;
        }
    }
    ...
    public static android.view.KeyCharacterMap load(int deviceId) {
        final android.hardware.input.InputManager im = android.hardware.input.InputManager.getInstance();
        android.view.InputDevice inputDevice = im.getInputDevice(deviceId);
        if (inputDevice == null) {
            inputDevice = im.getInputDevice(android.view.KeyCharacterMap.VIRTUAL_KEYBOARD);
            if (inputDevice == null) {
                throw new android.view.KeyCharacterMap.UnavailableException("Could not load key character map for device " + deviceId);
            }
        }
    ...
    public int get(int keyCode, int metaState) {
        metaState = android.view.KeyEvent.normalizeMetaState(metaState);
        char ch = android.view.KeyCharacterMap.nativeGetCharacter(mPtr, keyCode, metaState);
        int map = android.view.KeyCharacterMap.sCombiningToAccent.get(ch);
        if (map != 0) {
            return map | android.view.KeyCharacterMap.COMBINING_ACCENT;
        } else {
            return ch;
        }
    }
    ...
    public android.view.KeyCharacterMap.FallbackAction getFallbackAction(int keyCode, int metaState) {
        android.view.KeyCharacterMap.FallbackAction action = android.view.KeyCharacterMap.FallbackAction.obtain();
        metaState = android.view.KeyEvent.normalizeMetaState(metaState);
        if (android.view.KeyCharacterMap.nativeGetFallbackAction(mPtr, keyCode, metaState, action)) {
            action.metaState = android.view.KeyEvent.normalizeMetaState(action.metaState);
            return action;
        }
        action.recycle();
        return null;
    ...
    public char getNumber(int keyCode) {
        return android.view.KeyCharacterMap.nativeGetNumber(mPtr, keyCode);
    }
    ...
    public char getMatch(int keyCode, char[] chars, int metaState) {
        ...
        metaState = android.view.KeyEvent.normalizeMetaState(metaState);
        return android.view.KeyCharacterMap.nativeGetMatch(mPtr, keyCode, chars, metaState);
    }
    ...
    public char getDisplayLabel(int keyCode) {
        return android.view.KeyCharacterMap.nativeGetDisplayLabel(mPtr, keyCode);
    }
    ...
    public static int getDeadChar(int accent, int c) {
        if ((c == accent) || (android.view.KeyCharacterMap.CHAR_SPACE == c)) {
        ...
        int combining = android.view.KeyCharacterMap.sAccentToCombining.get(accent);
        if (combining == 0) {
            return 0;
        }
        final int combination = (combining << 16) | c;
        int combined;
        synchronized(android.view.KeyCharacterMap.sDeadKeyCache) {
            combined = android.view.KeyCharacterMap.sDeadKeyCache.get(combination, -1);
            if (combined == (-1)) {
                android.view.KeyCharacterMap.sDeadKeyBuilder.setLength(0);
                android.view.KeyCharacterMap.sDeadKeyBuilder.append(((char) (c)));
                android.view.KeyCharacterMap.sDeadKeyBuilder.append(((char) (combining)));
                java.lang.String result = java.text.Normalizer.normalize(android.view.KeyCharacterMap.sDeadKeyBuilder, java.text.Normalizer.Form.NFC);
                combined = (result.codePointCount(0, result.length()) == 1) ? result.codePointAt(0) : 0;
                android.view.KeyCharacterMap.sDeadKeyCache.put(combination, combined);
            }
        }
        return combined;
    }
    ...
    public static class KeyData {
         ...
         *      </table>
         */
        public char[] meta = new char[android.view.KeyCharacterMap.KeyData.META_LENGTH];
    }
     ...
     * @param results
     * 		A {@link KeyData} instance that will be filled with the results.
    ...
    public boolean getKeyData(int keyCode, android.view.KeyCharacterMap.KeyData results) {
        if (results.meta.length < android.view.KeyCharacterMap.KeyData.META_LENGTH) {
            throw new java.lang.IndexOutOfBoundsException("results.meta.length must be >= " + android.view.KeyCharacterMap.KeyData.META_LENGTH);
        }
        char displayLabel = android.view.KeyCharacterMap.nativeGetDisplayLabel(mPtr, keyCode);
        if (displayLabel == 0) {
            return false;
        }
        results.displayLabel = displayLabel;
        results.number = android.view.KeyCharacterMap.nativeGetNumber(mPtr, keyCode);
        results.meta[0] = android.view.KeyCharacterMap.nativeGetCharacter(mPtr, keyCode, 0);
        results.meta[1] = android.view.KeyCharacterMap.nativeGetCharacter(mPtr, keyCode, android.view.KeyEvent.META_SHIFT_ON);
        results.meta[2] = android.view.KeyCharacterMap.nativeGetCharacter(mPtr, keyCode, android.view.KeyEvent.META_ALT_ON);
        results.meta[3] = android.view.KeyCharacterMap.nativeGetCharacter(mPtr, keyCode, android.view.KeyEvent.META_ALT_ON | android.view.KeyEvent.META_SHIFT_ON);
        return true;
    }
    ...
    public android.view.KeyEvent[] getEvents(char[] chars) {
        ...
        return android.view.KeyCharacterMap.nativeGetEvents(mPtr, chars);
    }
    ...
    public boolean isPrintingKey(int keyCode) {
        int type = java.lang.Character.getType(android.view.KeyCharacterMap.nativeGetDisplayLabel(mPtr, keyCode));
        switch (type) {
    ...
    public int getKeyboardType() {
        return android.view.KeyCharacterMap.nativeGetKeyboardType(mPtr);
    }
    ...
    public int getModifierBehavior() {
        switch (getKeyboardType()) {
            case android.view.KeyCharacterMap.FULL :
            case android.view.KeyCharacterMap.SPECIAL_FUNCTION :
                return android.view.KeyCharacterMap.MODIFIER_BEHAVIOR_CHORDED;
            default :
                return android.view.KeyCharacterMap.MODIFIER_BEHAVIOR_CHORDED_OR_TOGGLED;
        }
    }
    ...
    public static boolean deviceHasKey(int keyCode) {
        return android.hardware.input.InputManager.getInstance().deviceHasKeys(new int[]{ keyCode })[0];
    }
    ...
    public static boolean[] deviceHasKeys(int[] keyCodes) {
        return android.hardware.input.InputManager.getInstance().deviceHasKeys(keyCodes);
    }
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        ...
        android.view.KeyCharacterMap.nativeWriteToParcel(mPtr, out);
    }
    ...
    public static final class FallbackAction {
        ...
        public static android.view.KeyCharacterMap.FallbackAction obtain() {
            final android.view.KeyCharacterMap.FallbackAction target;
            synchronized(android.view.KeyCharacterMap.FallbackAction.sRecycleLock) {
                if (android.view.KeyCharacterMap.FallbackAction.sRecycleBin == null) {
                    target = new android.view.KeyCharacterMap.FallbackAction();
                } else {
                    target = android.view.KeyCharacterMap.FallbackAction.sRecycleBin;
                    android.view.KeyCharacterMap.FallbackAction.sRecycleBin = target.next;
                    android.view.KeyCharacterMap.FallbackAction.sRecycledCount--;
                    target.next = null;
                }
            }
            return target;
        ...
        public void recycle() {
            synchronized(android.view.KeyCharacterMap.FallbackAction.sRecycleLock) {
                if (android.view.KeyCharacterMap.FallbackAction.sRecycledCount < android.view.KeyCharacterMap.FallbackAction.MAX_RECYCLED) {
                    next = android.view.KeyCharacterMap.FallbackAction.sRecycleBin;
                    android.view.KeyCharacterMap.FallbackAction.sRecycleBin = this;
                    android.view.KeyCharacterMap.FallbackAction.sRecycledCount += 1;
                } else {
                    next = null;
                }
            }
