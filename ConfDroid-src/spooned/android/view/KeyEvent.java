...
public class KeyEvent extends android.view.InputEvent implements android.os.Parcelable {
    ...
    public static final int LAST_KEYCODE = android.view.KeyEvent.KEYCODE_PROFILE_SWITCH;
     ...
     */
    public static final int META_SHIFT_MASK = (android.view.KeyEvent.META_SHIFT_ON | android.view.KeyEvent.META_SHIFT_LEFT_ON) | android.view.KeyEvent.META_SHIFT_RIGHT_ON;

    /**
     * This mask is a combination of {@link #META_ALT_ON}, {@link #META_ALT_LEFT_ON}
     * and {@link #META_ALT_RIGHT_ON}.
     */
    public static final int META_ALT_MASK = (android.view.KeyEvent.META_ALT_ON | android.view.KeyEvent.META_ALT_LEFT_ON) | android.view.KeyEvent.META_ALT_RIGHT_ON;

    /**
     * This mask is a combination of {@link #META_CTRL_ON}, {@link #META_CTRL_LEFT_ON}
     * and {@link #META_CTRL_RIGHT_ON}.
     */
    public static final int META_CTRL_MASK = (android.view.KeyEvent.META_CTRL_ON | android.view.KeyEvent.META_CTRL_LEFT_ON) | android.view.KeyEvent.META_CTRL_RIGHT_ON;

    /**
     * This mask is a combination of {@link #META_META_ON}, {@link #META_META_LEFT_ON}
     * and {@link #META_META_RIGHT_ON}.
     */
    public static final int META_META_MASK = (android.view.KeyEvent.META_META_ON | android.view.KeyEvent.META_META_LEFT_ON) | android.view.KeyEvent.META_META_RIGHT_ON;
    ...
    public static int getMaxKeyCode() {
        return android.view.KeyEvent.LAST_KEYCODE;
    }
     ...
     *
     * @param action
     * 		Action code: either {@link #ACTION_DOWN},
     ...
     *
     * @param downTime
     * 		The time (in {@link android.os.SystemClock#uptimeMillis})
     ...
     * 		The flags for this key event
     * @param source
     * 		The input source such as {@link InputDevice#SOURCE_KEYBOARD}.
     */
     ...
     * 		The flags for this key event
     */
    public KeyEvent(long time, java.lang.String characters, int deviceId, int flags) {
        mDownTime = time;
        mEventTime = time;
        mCharacters = characters;
        mAction = android.view.KeyEvent.ACTION_MULTIPLE;
    ...
    private static android.view.KeyEvent obtain() {
        final android.view.KeyEvent ev;
        synchronized(android.view.KeyEvent.gRecyclerLock) {
            ev = android.view.KeyEvent.gRecyclerTop;
            if (ev == null) {
                return new android.view.KeyEvent();
            }
            android.view.KeyEvent.gRecyclerTop = ev.mNext;
            android.view.KeyEvent.gRecyclerUsed -= 1;
        }
        ev.mNext = null;
        ev.prepareForReuse();
        return ev;
     ...
     * @unknown 
     */
    public static android.view.KeyEvent obtain(long downTime, long eventTime, int action, int code, int repeat, int metaState, int deviceId, int scancode, int flags, int source, int displayId, java.lang.String characters) {
        android.view.KeyEvent ev = android.view.KeyEvent.obtain();
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public static android.view.KeyEvent obtain(long downTime, long eventTime, int action, int code, int repeat, int metaState, int deviceId, int scancode, int flags, int source, java.lang.String characters) {
        return android.view.KeyEvent.obtain(downTime, eventTime, action, code, repeat, metaState, deviceId, scancode, flags, source, android.view.Display.INVALID_DISPLAY, characters);
    }
    ...
    public android.view.KeyEvent copy() {
        return android.view.KeyEvent.obtain(this);
    }
    ...
    public final void recycle() {
        ...
        mCharacters = null;
        synchronized(android.view.KeyEvent.gRecyclerLock) {
            if (android.view.KeyEvent.gRecyclerUsed < android.view.KeyEvent.MAX_RECYCLED) {
                android.view.KeyEvent.gRecyclerUsed++;
                mNext = android.view.KeyEvent.gRecyclerTop;
                android.view.KeyEvent.gRecyclerTop = this;
            }
        }
    }
     ...
     * 		The new repeat count of the event.
     */
    public static android.view.KeyEvent changeTimeRepeat(android.view.KeyEvent event, long eventTime, int newRepeat) {
     ...
     */
    public static android.view.KeyEvent changeTimeRepeat(android.view.KeyEvent event, long eventTime, int newRepeat, int newFlags) {
     ...
     * 		The new action code of the event.
     */
    public static android.view.KeyEvent changeAction(android.view.KeyEvent event, int action) {
     ...
     */
    public static android.view.KeyEvent changeFlags(android.view.KeyEvent event, int flags) {
    ...
    public final boolean isTainted() {
        return (mFlags & android.view.KeyEvent.FLAG_TAINTED) != 0;
    }
    ...
    public final void setTainted(boolean tainted) {
        mFlags = (tainted) ? mFlags | android.view.KeyEvent.FLAG_TAINTED : mFlags & (~android.view.KeyEvent.FLAG_TAINTED);
    }
    ...
    public final boolean isDown() {
        return mAction == android.view.KeyEvent.ACTION_DOWN;
    }
    ...
    public final boolean isSystem() {
        return android.view.KeyEvent.isSystemKey(mKeyCode);
    }
    ...
    public final boolean isWakeKey() {
        return android.view.KeyEvent.isWakeKey(mKeyCode);
    }
    ...
    public static final boolean isSystemKey(int keyCode) {
        switch (keyCode) {
            ...
            case android.view.KeyEvent.KEYCODE_SOFT_RIGHT :
            case android.view.KeyEvent.KEYCODE_HOME :
            case android.view.KeyEvent.KEYCODE_BACK :
            case android.view.KeyEvent.KEYCODE_CALL :
            case android.view.KeyEvent.KEYCODE_ENDCALL :
            ...
            case android.view.KeyEvent.KEYCODE_BRIGHTNESS_DOWN :
            case android.view.KeyEvent.KEYCODE_BRIGHTNESS_UP :
            case android.view.KeyEvent.KEYCODE_MEDIA_AUDIO_TRACK :
            case android.view.KeyEvent.KEYCODE_SYSTEM_NAVIGATION_UP :
            case android.view.KeyEvent.KEYCODE_SYSTEM_NAVIGATION_DOWN :
            case android.view.KeyEvent.KEYCODE_SYSTEM_NAVIGATION_LEFT :
            case android.view.KeyEvent.KEYCODE_SYSTEM_NAVIGATION_RIGHT :
                return true;
        }
        return false;
    }
    ...
    public static final boolean isWakeKey(int keyCode) {
        switch (keyCode) {
            case android.view.KeyEvent.KEYCODE_BACK :
            case android.view.KeyEvent.KEYCODE_MENU :
            case android.view.KeyEvent.KEYCODE_WAKEUP :
            case android.view.KeyEvent.KEYCODE_PAIRING :
            case android.view.KeyEvent.KEYCODE_STEM_1 :
            case android.view.KeyEvent.KEYCODE_STEM_2 :
            case android.view.KeyEvent.KEYCODE_STEM_3 :
                return true;
        }
        return false;
    }
    ...
    public static final boolean isMetaKey(int keyCode) {
        return (keyCode == android.view.KeyEvent.KEYCODE_META_LEFT) || (keyCode == android.view.KeyEvent.KEYCODE_META_RIGHT);
    }
    ...
    public static final boolean isAltKey(int keyCode) {
        return (keyCode == android.view.KeyEvent.KEYCODE_ALT_LEFT) || (keyCode == android.view.KeyEvent.KEYCODE_ALT_RIGHT);
    }
    ...
    public final int getModifiers() {
        return android.view.KeyEvent.normalizeMetaState(mMetaState) & android.view.KeyEvent.META_MODIFIER_MASK;
    }
    ...
    @android.annotation.UnsupportedAppUsage
    private static final int META_MODIFIER_MASK = ((((((((((((android.view.KeyEvent.META_SHIFT_ON | android.view.KeyEvent.META_SHIFT_LEFT_ON) | android.view.KeyEvent.META_SHIFT_RIGHT_ON) | android.view.KeyEvent.META_ALT_ON) | android.view.KeyEvent.META_ALT_LEFT_ON) | android.view.KeyEvent.META_ALT_RIGHT_ON) | android.view.KeyEvent.META_CTRL_ON) | android.view.KeyEvent.META_CTRL_LEFT_ON) | android.view.KeyEvent.META_CTRL_RIGHT_ON) | android.view.KeyEvent.META_META_ON) | android.view.KeyEvent.META_META_LEFT_ON) | android.view.KeyEvent.META_META_RIGHT_ON) | android.view.KeyEvent.META_SYM_ON) | android.view.KeyEvent.META_FUNCTION_ON;

    // Mask of all lock key meta states.
    @android.annotation.UnsupportedAppUsage
    private static final int META_LOCK_MASK = (android.view.KeyEvent.META_CAPS_LOCK_ON | android.view.KeyEvent.META_NUM_LOCK_ON) | android.view.KeyEvent.META_SCROLL_LOCK_ON;

    // Mask of all valid meta states.
    @android.annotation.UnsupportedAppUsage
    private static final int META_ALL_MASK = android.view.KeyEvent.META_MODIFIER_MASK | android.view.KeyEvent.META_LOCK_MASK;

    // Mask of all synthetic meta states that are reserved for API compatibility with
    // historical uses in MetaKeyKeyListener.
    @android.annotation.UnsupportedAppUsage
    private static final int META_SYNTHETIC_MASK = ((android.view.KeyEvent.META_CAP_LOCKED | android.view.KeyEvent.META_ALT_LOCKED) | android.view.KeyEvent.META_SYM_LOCKED) | android.view.KeyEvent.META_SELECTING;
    ...
    @android.annotation.UnsupportedAppUsage
    private static final int META_INVALID_MODIFIER_MASK = android.view.KeyEvent.META_LOCK_MASK | android.view.KeyEvent.META_SYNTHETIC_MASK;
    ...
    public static int getModifierMetaStateMask() {
        return android.view.KeyEvent.META_MODIFIER_MASK;
    }
    ...
    public static boolean isModifierKey(int keyCode) {
        switch (keyCode) {
            ...
            case android.view.KeyEvent.KEYCODE_META_LEFT :
            case android.view.KeyEvent.KEYCODE_META_RIGHT :
            case android.view.KeyEvent.KEYCODE_SYM :
            case android.view.KeyEvent.KEYCODE_NUM :
            case android.view.KeyEvent.KEYCODE_FUNCTION :
                return true;
            default :
                return false;
        }
    ...
    public static int normalizeMetaState(int metaState) {
        ...
        if ((metaState & (android.view.KeyEvent.META_CTRL_LEFT_ON | android.view.KeyEvent.META_CTRL_RIGHT_ON)) != 0) {
            metaState |= android.view.KeyEvent.META_CTRL_ON;
        }
        if ((metaState & (android.view.KeyEvent.META_META_LEFT_ON | android.view.KeyEvent.META_META_RIGHT_ON)) != 0) {
            metaState |= android.view.KeyEvent.META_META_ON;
        }
        if ((metaState & android.text.method.MetaKeyKeyListener.META_CAP_LOCKED) != 0) {
            metaState |= android.view.KeyEvent.META_CAPS_LOCK_ON;
        }
        ...
        if ((metaState & android.text.method.MetaKeyKeyListener.META_SYM_LOCKED) != 0) {
            metaState |= android.view.KeyEvent.META_SYM_ON;
        }
        return metaState & android.view.KeyEvent.META_ALL_MASK;
    }
    ...
    public static boolean metaStateHasNoModifiers(int metaState) {
        return (android.view.KeyEvent.normalizeMetaState(metaState) & android.view.KeyEvent.META_MODIFIER_MASK) == 0;
    }
    ...
    public static boolean metaStateHasModifiers(int metaState, int modifiers) {
        ...
        if ((modifiers & android.view.KeyEvent.META_INVALID_MODIFIER_MASK) != 0) {
        ...
        metaState = android.view.KeyEvent.normalizeMetaState(metaState) & android.view.KeyEvent.META_MODIFIER_MASK;
        metaState = android.view.KeyEvent.metaStateFilterDirectionalModifiers(metaState, modifiers, android.view.KeyEvent.META_SHIFT_ON, android.view.KeyEvent.META_SHIFT_LEFT_ON, android.view.KeyEvent.META_SHIFT_RIGHT_ON);
        metaState = android.view.KeyEvent.metaStateFilterDirectionalModifiers(metaState, modifiers, android.view.KeyEvent.META_ALT_ON, android.view.KeyEvent.META_ALT_LEFT_ON, android.view.KeyEvent.META_ALT_RIGHT_ON);
        metaState = android.view.KeyEvent.metaStateFilterDirectionalModifiers(metaState, modifiers, android.view.KeyEvent.META_CTRL_ON, android.view.KeyEvent.META_CTRL_LEFT_ON, android.view.KeyEvent.META_CTRL_RIGHT_ON);
        metaState = android.view.KeyEvent.metaStateFilterDirectionalModifiers(metaState, modifiers, android.view.KeyEvent.META_META_ON, android.view.KeyEvent.META_META_LEFT_ON, android.view.KeyEvent.META_META_RIGHT_ON);
    ...
    private static int metaStateFilterDirectionalModifiers(int metaState, int modifiers, int basic, int left, int right) {
        ...
        if (wantBasic) {
            if (wantLeftOrRight) {
                throw new java.lang.IllegalArgumentException((((("modifiers must not contain " + android.view.KeyEvent.metaStateToString(basic)) + " combined with ") + android.view.KeyEvent.metaStateToString(left)) + " or ") + android.view.KeyEvent.metaStateToString(right));
            }
    ...
    public final boolean hasNoModifiers() {
        return android.view.KeyEvent.metaStateHasNoModifiers(mMetaState);
    }
    ...
    public final boolean hasModifiers(int modifiers) {
        return android.view.KeyEvent.metaStateHasModifiers(mMetaState, modifiers);
    }
    ...
    public final boolean isAltPressed() {
        return (mMetaState & android.view.KeyEvent.META_ALT_ON) != 0;
    }
    ...
    public final boolean isShiftPressed() {
        return (mMetaState & android.view.KeyEvent.META_SHIFT_ON) != 0;
    }
    ...
    public final boolean isSymPressed() {
        return (mMetaState & android.view.KeyEvent.META_SYM_ON) != 0;
    }
    ...
    public final boolean isCtrlPressed() {
        return (mMetaState & android.view.KeyEvent.META_CTRL_ON) != 0;
    }
    ...
    public final boolean isMetaPressed() {
        return (mMetaState & android.view.KeyEvent.META_META_ON) != 0;
    }
    ...
    public final boolean isFunctionPressed() {
        return (mMetaState & android.view.KeyEvent.META_FUNCTION_ON) != 0;
    }
    ...
    public final boolean isCapsLockOn() {
        return (mMetaState & android.view.KeyEvent.META_CAPS_LOCK_ON) != 0;
    }
    ...
    public final boolean isNumLockOn() {
        return (mMetaState & android.view.KeyEvent.META_NUM_LOCK_ON) != 0;
    }
    ...
    public final boolean isScrollLockOn() {
        return (mMetaState & android.view.KeyEvent.META_SCROLL_LOCK_ON) != 0;
    }
    ...
    public final boolean isCanceled() {
        return (mFlags & android.view.KeyEvent.FLAG_CANCELED) != 0;
    }
    ...
    public final void cancel() {
        mFlags |= android.view.KeyEvent.FLAG_CANCELED;
    }
    ...
    public final void startTracking() {
        mFlags |= android.view.KeyEvent.FLAG_START_TRACKING;
    }
    ...
    public final boolean isTracking() {
        return (mFlags & android.view.KeyEvent.FLAG_TRACKING) != 0;
    }
    ...
    public final boolean isLongPress() {
        return (mFlags & android.view.KeyEvent.FLAG_LONG_PRESS) != 0;
    }
     ...
     *
     * @param downTime
     * 		The new down time (in {@link android.os.SystemClock#uptimeMillis}) of the
     * 		event.
     * @param eventTime
     * 		The new event time (in {@link android.os.SystemClock#uptimeMillis}) of the
     * 		event.
     * @unknown 
     */
     ...
     *
     * @param results
     * 		A {@link KeyCharacterMap.KeyData} instance that will be
     ...
     */
    public final boolean dispatch(android.view.KeyEvent.Callback receiver, android.view.KeyEvent.DispatcherState state, java.lang.Object target) {
        switch (mAction) {
            case android.view.KeyEvent.ACTION_DOWN :
                {
                    mFlags &= ~android.view.KeyEvent.FLAG_START_TRACKING;
                    if (android.view.KeyEvent.DEBUG)
                        android.util.Log.v(android.view.KeyEvent.TAG, (((("Key down to " + target) + " in ") + state) + ": ") + this);

                    boolean res = receiver.onKeyDown(mKeyCode, this);
                    if (state != null) {
                        if ((res && (mRepeatCount == 0)) && ((mFlags & android.view.KeyEvent.FLAG_START_TRACKING) != 0)) {
                            if (android.view.KeyEvent.DEBUG)
                                android.util.Log.v(android.view.KeyEvent.TAG, "  Start tracking!");
                            ...
                            if (isLongPress() && state.isTracking(this)) {
                                try {
                                    if (receiver.onKeyLongPress(mKeyCode, this)) {
                                        if (android.view.KeyEvent.DEBUG)
                                            android.util.Log.v(android.view.KeyEvent.TAG, "  Clear from long press!");
            ...
            case android.view.KeyEvent.ACTION_UP :
                if (android.view.KeyEvent.DEBUG)
                    android.util.Log.v(android.view.KeyEvent.TAG, (((("Key up to " + target) + " in ") + state) + ": ") + this);
            ...
            case android.view.KeyEvent.ACTION_MULTIPLE :
                ...
                if (code != android.view.KeyEvent.KEYCODE_UNKNOWN) {
                    mAction = android.view.KeyEvent.ACTION_DOWN;
                    mRepeatCount = 0;
                    boolean handled = receiver.onKeyDown(code, this);
                    if (handled) {
                        mAction = android.view.KeyEvent.ACTION_UP;
    ...
    public static class DispatcherState {
        ...
        public void reset() {
            if (android.view.KeyEvent.DEBUG)
                android.util.Log.v(android.view.KeyEvent.TAG, "Reset: " + this);
        ...
        public void reset(java.lang.Object target) {
            if (mDownTarget == target) {
                if (android.view.KeyEvent.DEBUG)
                    android.util.Log.v(android.view.KeyEvent.TAG, (("Reset in " + target) + ": ") + this);
         ...
         */
        public void startTracking(android.view.KeyEvent event, java.lang.Object target) {
            if (event.getAction() != android.view.KeyEvent.ACTION_DOWN) {
                throw new java.lang.IllegalArgumentException("Can only start tracking on a down event");
            }
            if (android.view.KeyEvent.DEBUG)
                android.util.Log.v(android.view.KeyEvent.TAG, (("Start trackingt in " + target) + ": ") + this);
        ...
        public void handleUpEvent(android.view.KeyEvent event) {
            ...
            if (android.view.KeyEvent.DEBUG)
                android.util.Log.v(android.view.KeyEvent.TAG, (("Handle key up " + event) + ": ") + this);

            int index = mActiveLongPresses.indexOfKey(keyCode);
            if (index >= 0) {
                if (android.view.KeyEvent.DEBUG)
                    android.util.Log.v(android.view.KeyEvent.TAG, "  Index: " + index);

                event.mFlags |= android.view.KeyEvent.FLAG_CANCELED | android.view.KeyEvent.FLAG_CANCELED_LONG_PRESS;
                mActiveLongPresses.removeAt(index);
            }
            if (mDownKeyCode == keyCode) {
                if (android.view.KeyEvent.DEBUG)
                    android.util.Log.v(android.view.KeyEvent.TAG, "  Tracking!");

                event.mFlags |= android.view.KeyEvent.FLAG_TRACKING;
                mDownKeyCode = 0;
                mDownTarget = null;
            }
        }
    ...
    public java.lang.String toString() {
        ...
        msg.append("KeyEvent { action=").append(android.view.KeyEvent.actionToString(mAction));
        msg.append(", keyCode=").append(android.view.KeyEvent.keyCodeToString(mKeyCode));
        msg.append(", scanCode=").append(mScanCode);
        if (mCharacters != null) {
            msg.append(", characters=\"").append(mCharacters).append("\"");
        }
        msg.append(", metaState=").append(android.view.KeyEvent.metaStateToString(mMetaState));
        msg.append(", flags=0x").append(java.lang.Integer.toHexString(mFlags));
        ...
        msg.append(", source=0x").append(java.lang.Integer.toHexString(mSource));
    ...
    public static java.lang.String keyCodeToString(int keyCode) {
        java.lang.String symbolicName = android.view.KeyEvent.nativeKeyCodeToString(keyCode);
        return symbolicName != null ? android.view.KeyEvent.LABEL_PREFIX + symbolicName : java.lang.Integer.toString(keyCode);
    }
     ...
     */
    public static int keyCodeFromString(@android.annotation.NonNull
    java.lang.String symbolicName) {
        try {
            int keyCode = java.lang.Integer.parseInt(symbolicName);
            if (android.view.KeyEvent.keyCodeIsValid(keyCode)) {
                return keyCode;
            }
        } catch (java.lang.NumberFormatException ex) {
        }
        if (symbolicName.startsWith(android.view.KeyEvent.LABEL_PREFIX)) {
            symbolicName = symbolicName.substring(android.view.KeyEvent.LABEL_PREFIX.length());
        }
        int keyCode = android.view.KeyEvent.nativeKeyCodeFromString(symbolicName);
        if (android.view.KeyEvent.keyCodeIsValid(keyCode)) {
            return keyCode;
        }
    ...
    private static boolean keyCodeIsValid(int keyCode) {
        return (keyCode >= android.view.KeyEvent.KEYCODE_UNKNOWN) && (keyCode <= android.view.KeyEvent.LAST_KEYCODE);
    }
    ...
    public static java.lang.String metaStateToString(int metaState) {
        ...
        while (metaState != 0) {
            ...
            if (isSet) {
                final java.lang.String name = android.view.KeyEvent.META_SYMBOLIC_NAMES[i];
                if (result == null) {
                    if (metaState == 0) {
                        return name;
                    }
    ...
    public static final android.os.Parcelable.Creator<android.view.KeyEvent> CREATOR = new android.os.Parcelable.Creator<android.view.KeyEvent>() {
        @java.lang.Override
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        out.writeInt(android.view.InputEvent.PARCEL_TOKEN_KEY_EVENT);
