...
public class WindowManagerGlobal_Delegate {
    private static android.view.IWindowManager sService;
    ...
    public static android.view.IWindowManager getWindowManagerService() {
        return android.view.WindowManagerGlobal_Delegate.sService;
    }

    // ---- internal implementation stuff ----
    public static void setWindowManagerService(android.view.IWindowManager service) {
        android.view.WindowManagerGlobal_Delegate.sService = service;
    }
}
