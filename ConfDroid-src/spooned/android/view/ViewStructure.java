...
public abstract class ViewStructure {
     ...
     *
     * @param id
     * 		The view's identifier, as per {@link View#getId View.getId()}.
     * @param packageName
     ...
     * @param style
     * 		Style flags, as defined by {@link android.app.assist.AssistStructure.ViewNode}.
     */
     ...
     *
     * @param charOffsets
     * 		The offset in to {@link #setText} where a line starts.
     * @param baselines
     ...
     */
    public void setTextIdEntry(@android.annotation.NonNull
    java.lang.String entryName) {
        com.android.internal.util.Preconditions.checkNotNull(entryName);
    }
     ...
     */
    public abstract void setAutofillId(@android.annotation.NonNull
     ...
     */
    public abstract void setAutofillId(@android.annotation.NonNull
    android.view.autofill.AutofillId parentId, int virtualId);

    /**
     * Sets the {@link View#getAutofillType()} that can be used to autofill this node.
     */
    public abstract void setAutofillType(@android.view.View.AutofillType
    int type);
     ...
     * view.
     */
    public abstract void setAutofillHints(@android.annotation.Nullable
     ...
     */
    public void setImportantForAutofill(@android.view.View.AutofillImportance
    int mode) {
    }
     ...
     *
     * @param inputType
     * 		inputType bits as defined by {@link android.text.InputType}.
     */
     ...
     * value, etc..) is striped before calls to {@link android.service.autofill.AutofillService#onFillRequest(android.service.autofill.FillRequest,
     ...
     * {@link android.service.autofill.AutofillService#onSaveRequest(android.service.autofill.SaveRequest,
     ...
     * when used for Assist.
     */
    public void setMinTextEms(@java.lang.SuppressWarnings("unused")
    int minEms) {
    }
     ...
     * when used for Assist.
     */
    public void setMaxTextEms(@java.lang.SuppressWarnings("unused")
    int maxEms) {
    }
     ...
     * when used for Assist.
     */
    public void setMaxTextLength(@java.lang.SuppressWarnings("unused")
    int maxLength) {
    }
     ...
     *
     * @param domain
     * 		RFC 2396-compliant URI representing the domain.
     */
    public abstract void setWebDomain(@android.annotation.Nullable
     ...
     */
    public abstract android.view.ViewStructure.HtmlInfo.Builder newHtmlInfoBuilder(@android.annotation.NonNull
     ...
     * 		HTML properties.
     */
    public abstract void setHtmlInfo(@android.annotation.NonNull
    android.view.ViewStructure.HtmlInfo htmlInfo);
    ...
    public static abstract class HtmlInfo {
        ...
        public static abstract class Builder {
             ...
             */
            public abstract android.view.ViewStructure.HtmlInfo.Builder addAttribute(@android.annotation.NonNull
