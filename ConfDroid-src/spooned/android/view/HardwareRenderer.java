...
public abstract class HardwareRenderer {
    static final java.lang.String LOG_TAG = "HardwareRenderer";
     ...
     */
    static final java.lang.String RENDER_DIRTY_REGIONS_PROPERTY = "debug.hwui.render_dirty_regions";
    ...
    public static void disable(boolean system) {
        android.view.HardwareRenderer.sRendererDisabled = true;
        if (system) {
            android.view.HardwareRenderer.sSystemRendererDisabled = true;
        }
    }
    ...
    public static void enableForegroundTrimming() {
        android.view.HardwareRenderer.sTrimForeground = true;
    }
    ...
    public static boolean isAvailable() {
        return android.view.DisplayListCanvas.isAvailable();
    }
     ...
     *
     * @param surface
     * 		The surface to hardware accelerate
     * @return True if the initialization was successful, false otherwise.
     */
    abstract boolean initialize(android.view.Surface surface) throws android.view.Surface.OutOfResourcesException;
     ...
     * 		The surface to hardware accelerate
     */
    abstract void updateSurface(android.view.Surface surface) throws android.view.Surface.OutOfResourcesException;
     ...
     */
    abstract boolean pauseSurface(android.view.Surface surface);
     ...
     */
    abstract void destroyHardwareResources(android.view.View view);
     ...
     * 		The surface to hardware accelerate
     */
    abstract void invalidate(android.view.Surface surface);
     ...
     */
    abstract void dumpGfxInfo(java.io.PrintWriter pw, java.io.FileDescriptor fd, java.lang.String[] args);
    ...
    public static void setupDiskCache(java.io.File cacheDir) {
        android.view.ThreadedRenderer.setupShadersDiskCache(new java.io.File(cacheDir, android.view.HardwareRenderer.CACHE_PATH_SHADERS).getAbsolutePath());
    }
     ...
     */
    abstract void pushLayerUpdate(android.view.HardwareLayer layer);

    /**
     * Tells the HardwareRenderer that the layer is destroyed. The renderer
     * should remove the layer from any update queues.
     */
    abstract void onLayerDestroyed(android.view.HardwareLayer layer);
    ...
    interface HardwareDrawCallbacks {
         ...
         */
        void onHardwarePreDraw(android.view.DisplayListCanvas canvas);
         ...
         * 		The Canvas used to render the view.
         */
        void onHardwarePostDraw(android.view.DisplayListCanvas canvas);
    }
     ...
     * @param callbacks
     * 		Callbacks invoked when drawing happens.
     */
    abstract void draw(android.view.View view, android.view.View.AttachInfo attachInfo, android.view.HardwareRenderer.HardwareDrawCallbacks callbacks);
    ...
    abstract void buildLayer(android.view.RenderNode node);

    abstract boolean copyLayerInto(android.view.HardwareLayer layer, android.graphics.Bitmap bitmap);
     ...
     * 		The drawing surface insets to apply
     */
    abstract void setup(int width, int height, android.view.View.AttachInfo attachInfo, android.graphics.Rect surfaceInsets);
     ...
     * 		Information about the window.
     */
    abstract void setLightCenter(android.view.View.AttachInfo attachInfo);
     ...
     */
    static android.view.HardwareRenderer create(android.content.Context context, boolean translucent) {
        android.view.HardwareRenderer renderer = null;
        if (android.view.DisplayListCanvas.isAvailable()) {
            renderer = new android.view.ThreadedRenderer(context, translucent);
        }
        return renderer;
    }
     ...
     *
     * @param enabled
     * 		True if the hardware renderer is in use, false otherwise.
     */
    ...
    abstract void registerAnimatingRenderNode(android.view.RenderNode animator);
}
