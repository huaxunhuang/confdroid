...
final class HardwareLayer {
    ...
    private HardwareLayer(android.view.ThreadedRenderer renderer, long deferredUpdater) {
    ...
    android.graphics.Paint paint) {
        android.view.HardwareLayer.nSetLayerPaint(mFinalizer.get(), paint != null ? paint.getNativeInstance() : 0);
    ...
    public boolean prepare(int width, int height, boolean isOpaque) {
        return android.view.HardwareLayer.nPrepare(mFinalizer.get(), width, height, isOpaque);
    }
    ...
    public void setTransform(android.graphics.Matrix matrix) {
        android.view.HardwareLayer.nSetTransform(mFinalizer.get(), matrix.native_instance);
        mRenderer.pushLayerUpdate(this);
    }
    ...
    public void setSurfaceTexture(android.graphics.SurfaceTexture surface) {
        android.view.HardwareLayer.nSetSurfaceTexture(mFinalizer.get(), surface);
        mRenderer.pushLayerUpdate(this);
    }

    public void updateSurfaceTexture() {
        android.view.HardwareLayer.nUpdateSurfaceTexture(mFinalizer.get());
        mRenderer.pushLayerUpdate(this);
    }

    static android.view.HardwareLayer adoptTextureLayer(android.view.ThreadedRenderer renderer, long layer) {
        return new android.view.HardwareLayer(renderer, layer);
    }
