...
public abstract class WindowManagerInternal {
    ...
    public interface WindowsForAccessibilityCallback {
         ...
         */
        public void onWindowsForAccessibilityChanged(java.util.List<android.view.WindowInfo> windows);
    }
    ...
    public interface MagnificationCallbacks {
         ...
         *
         * @param magnificationRegion
         * 		the current magnification region
         */
    ...
    public static abstract class AppTransitionListener {
         ...
         *
         * @param transit
         * 		transition type indicating what kind of transition got cancelled
         */
         ...
         *
         * @param transit
         * 		transition type indicating what kind of transition gets run, must be one
         * 		of AppTransition.TRANSIT_* values
         * @param openToken
         * 		the token for the opening app
         * @param closeToken
         * 		the token for the closing app
         * @param openAnimation
         * 		the animation for the opening app
         * @param closeAnimation
         * 		the animation for the closing app
         * @return Return any bit set of {@link WindowManagerPolicy#FINISH_LAYOUT_REDO_LAYOUT},
        {@link WindowManagerPolicy#FINISH_LAYOUT_REDO_CONFIG},
        {@link WindowManagerPolicy#FINISH_LAYOUT_REDO_WALLPAPER},
        or {@link WindowManagerPolicy#FINISH_LAYOUT_REDO_ANIM}.
         */
        public int onAppTransitionStartingLocked(int transit, android.os.IBinder openToken, android.os.IBinder closeToken, android.view.animation.Animation openAnimation, android.view.animation.Animation closeAnimation) {
            return 0;
        }
     ...
     */
    public abstract void setMagnificationCallbacks(@android.annotation.Nullable
     ...
     *
     * @param spec
     * 		The MagnficationSpec to set.
     * @see #setMagnificationCallbacks(MagnificationCallbacks)
     */
    public abstract void setMagnificationSpec(android.view.MagnificationSpec spec);
     ...
     *
     * @param show
     * 		{@code true} to show magnifiable region bounds, {@code false} to hide
     */
     ...
     * 		the current magnification region
     */
    public abstract void getMagnificationRegion(@android.annotation.NonNull
     ...
     * @see #setMagnificationCallbacks(MagnificationCallbacks)
     */
    public abstract android.view.MagnificationSpec getCompatibleMagnificationSpecForWindow(android.os.IBinder windowToken);
     ...
     * 		The callback.
     */
    public abstract void setWindowsForAccessibilityCallback(android.view.WindowManagerInternal.WindowsForAccessibilityCallback callback);
     ...
     */
    public abstract void setInputFilter(android.view.IInputFilter filter);
     ...
     */
    public abstract void getWindowFrame(android.os.IBinder token, android.graphics.Rect outBounds);
     ...
     * redrawn.
     */
    public abstract void waitForAllWindowsDrawn(java.lang.Runnable callback, long timeout);
     ...
     * 		The window type.
     * @param displayId
     * 		The display to add the token to.
     */
     ...
     * 		The toke to remove.
     * @param removeWindows
     * 		Whether to also remove the windows associated with the token.
     * @param displayId
     * 		The display to remove the token from.
     */
    public abstract void removeWindowToken(android.os.IBinder token, boolean removeWindows, int displayId);
     ...
     */
    public abstract void registerAppTransitionListener(android.view.WindowManagerInternal.AppTransitionListener listener);
     ...
     *
     * @param imeToken
     * 		token to track the active input method. Corresponding IME windows can be
     ...
     * 		created
     * @param imeWindowVisible
     * 		whether the active IME thinks that its window should be visible or
     ...
     * @param dismissImeOnBackKeyPressed
     * 		{@code true} if the software keyboard is shown and the back
     * 		key is expected to dismiss the software keyboard.
     * @param targetWindowToken
     * 		token to identify the target window that the IME is associated with.
     ...
     * 		window.
     */
    public abstract void updateInputMethodWindowStatus(@android.annotation.NonNull
    android.os.IBinder imeToken, boolean imeWindowVisible, boolean dismissImeOnBackKeyPressed, @android.annotation.Nullable
     ...
     * 		The listener to set.
     */
    public abstract void setOnHardKeyboardStatusChangeListener(android.view.WindowManagerInternal.OnHardKeyboardStatusChangeListener listener);
