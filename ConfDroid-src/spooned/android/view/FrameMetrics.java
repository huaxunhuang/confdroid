...
public final class FrameMetrics {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.view.FrameMetrics.Index.FLAGS, android.view.FrameMetrics.Index.INTENDED_VSYNC, android.view.FrameMetrics.Index.VSYNC, android.view.FrameMetrics.Index.OLDEST_INPUT_EVENT, android.view.FrameMetrics.Index.NEWEST_INPUT_EVENT, android.view.FrameMetrics.Index.HANDLE_INPUT_START, android.view.FrameMetrics.Index.ANIMATION_START, android.view.FrameMetrics.Index.PERFORM_TRAVERSALS_START, android.view.FrameMetrics.Index.DRAW_START, android.view.FrameMetrics.Index.SYNC_QUEUED, android.view.FrameMetrics.Index.SYNC_START, android.view.FrameMetrics.Index.ISSUE_DRAW_COMMANDS_START, android.view.FrameMetrics.Index.SWAP_BUFFERS, android.view.FrameMetrics.Index.FRAME_COMPLETED })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    in this list.
     */
    private static final int[] DURATIONS = new int[]{ // UNKNOWN_DELAY
    android.view.FrameMetrics.Index.INTENDED_VSYNC, android.view.FrameMetrics.Index.HANDLE_INPUT_START, // INPUT_HANDLING
    android.view.FrameMetrics.Index.HANDLE_INPUT_START, android.view.FrameMetrics.Index.ANIMATION_START, // ANIMATION
    android.view.FrameMetrics.Index.ANIMATION_START, android.view.FrameMetrics.Index.PERFORM_TRAVERSALS_START, // LAYOUT_MEASURE
    android.view.FrameMetrics.Index.PERFORM_TRAVERSALS_START, android.view.FrameMetrics.Index.DRAW_START, // DRAW
    android.view.FrameMetrics.Index.DRAW_START, android.view.FrameMetrics.Index.SYNC_QUEUED, // SYNC
    android.view.FrameMetrics.Index.SYNC_START, android.view.FrameMetrics.Index.ISSUE_DRAW_COMMANDS_START, // COMMAND_ISSUE
    android.view.FrameMetrics.Index.ISSUE_DRAW_COMMANDS_START, android.view.FrameMetrics.Index.SWAP_BUFFERS, // SWAP_BUFFERS
    android.view.FrameMetrics.Index.SWAP_BUFFERS, android.view.FrameMetrics.Index.FRAME_COMPLETED, // TOTAL_DURATION
    android.view.FrameMetrics.Index.INTENDED_VSYNC, android.view.FrameMetrics.Index.FRAME_COMPLETED };
     ...
     */
    public FrameMetrics(android.view.FrameMetrics other) {
        mTimingData = new long[android.view.FrameMetrics.Index.FRAME_STATS_COUNT];
        java.lang.System.arraycopy(other.mTimingData, 0, mTimingData, 0, mTimingData.length);
    }
     ...
     */
    public long getMetric(@android.view.FrameMetrics.Metric
    int id) {
        if ((id < android.view.FrameMetrics.UNKNOWN_DELAY_DURATION) || (id > android.view.FrameMetrics.VSYNC_TIMESTAMP)) {
            return -1;
        }
        if (mTimingData == null) {
            return -1;
        }
        if (id == android.view.FrameMetrics.FIRST_DRAW_FRAME) {
            return (mTimingData[android.view.FrameMetrics.Index.FLAGS] & android.view.FrameMetrics.FRAME_INFO_FLAG_FIRST_DRAW) != 0 ? 1 : 0;
        } else
            if (id == android.view.FrameMetrics.INTENDED_VSYNC_TIMESTAMP) {
                return mTimingData[android.view.FrameMetrics.Index.INTENDED_VSYNC];
            } else
                if (id == android.view.FrameMetrics.VSYNC_TIMESTAMP) {
                    return mTimingData[android.view.FrameMetrics.Index.VSYNC];
                }


        int durationsIdx = 2 * id;
        return mTimingData[android.view.FrameMetrics.DURATIONS[durationsIdx + 1]] - mTimingData[android.view.FrameMetrics.DURATIONS[durationsIdx]];
    }
}
