...
public abstract class Window {
    ...
    public static final int FEATURE_MAX = android.view.Window.FEATURE_ACTIVITY_TRANSITIONS;
    ...
    protected static final int DEFAULT_FEATURES = (1 << android.view.Window.FEATURE_OPTIONS_PANEL) | (1 << android.view.Window.FEATURE_CONTEXT_MENU);
    ...
    public interface Callback {
         ...
         */
        boolean onCreatePanelMenu(int featureId, @android.annotation.NonNull
         ...
         */
        boolean onPreparePanel(int featureId, @android.annotation.Nullable
         ...
         */
        boolean onMenuOpened(int featureId, @android.annotation.NonNull
        android.view.Menu menu);
         ...
         */
        boolean onMenuItemSelected(int featureId, @android.annotation.NonNull
         ...
         * 		being displayed in the panel.
         */
        void onPanelClosed(int featureId, @android.annotation.NonNull
        android.view.Menu menu);
         ...
         *
         * @param searchEvent
         * 		A {@link SearchEvent} describing the signal to
         * 		start a search.
         * @return true if search launched, false if activity refuses (blocks)
         */
         ...
         */
        public default void onProvideKeyboardShortcuts(java.util.List<android.view.KeyboardShortcutGroup> data, @android.annotation.Nullable
        android.view.Menu menu, int deviceId) {
        }
         ...
         */
        public default void onPointerCaptureChanged(boolean hasCapture) {
        }
    }
    ...
    public interface OnWindowDismissedCallback {
         ...
         *
         * @param finishTask
         * 		True if the task should also be finished.
         * @param suppressWindowTransition
         * 		True if the resulting exit and enter window transition
    ...
    public interface WindowControllerCallback {
         ...
         */
        void toggleFreeformWindowingMode() throws android.os.RemoteException;
    ...
    public interface OnFrameMetricsAvailableListener {
         ...
         *
         * @param window
         * 		The {@link Window} on which the frame was displayed.
         * @param frameMetrics
         ...
         */
        void onFrameMetricsAvailable(android.view.Window window, android.view.FrameMetrics frameMetrics, int dropCountSinceLastInvocation);
    }

    public Window(android.content.Context context) {
        mContext = context;
        mFeatures = mLocalFeatures = android.view.Window.getDefaultFeatures(context);
    }
    ...
    public void setContainer(android.view.Window container) {
        ...
        if (container != null) {
            ...
            mFeatures |= 1 << android.view.Window.FEATURE_NO_TITLE;
            mLocalFeatures |= 1 << android.view.Window.FEATURE_NO_TITLE;
     ...
     */
    public void setWindowManager(android.view.WindowManager wm, android.os.IBinder appToken, java.lang.String appName) {
     ...
     * 		The window manager for adding new windows.
     */
    public void setWindowManager(android.view.WindowManager wm, android.os.IBinder appToken, java.lang.String appName, boolean hardwareAccelerated) {
        mAppToken = appToken;
        mAppName = appName;
        ...
        mWindowManager = ((android.view.WindowManagerImpl) (wm)).createLocalWindowManager(this);
    }
    ...
    void adjustLayoutParamsForSubWindow(android.view.WindowManager.LayoutParams wp) {
        ...
        if ((wp.type >= android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW) && (wp.type <= android.view.WindowManager.LayoutParams.LAST_SUB_WINDOW)) {
            if (wp.token == null) {
                android.view.View decor = peekDecorView();
                if (decor != null) {
                    wp.token = decor.getWindowToken();
                }
            }
            if ((curTitle == null) || (curTitle.length() == 0)) {
                final java.lang.StringBuilder title = new java.lang.StringBuilder(32);
                if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_MEDIA) {
                    title.append("Media");
                } else
                    if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_MEDIA_OVERLAY) {
                        title.append("MediaOvr");
                    } else
                        if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_PANEL) {
                            title.append("Panel");
                        } else
                            if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_SUB_PANEL) {
                                title.append("SubPanel");
                            } else
                                if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_ABOVE_SUB_PANEL) {
                                    title.append("AboveSubPanel");
                                } else
                                    if (wp.type == android.view.WindowManager.LayoutParams.TYPE_APPLICATION_ATTACHED_DIALOG) {
            ...
            if ((wp.type >= android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW) && (wp.type <= android.view.WindowManager.LayoutParams.LAST_SYSTEM_WINDOW)) {
        ...
        if (mHardwareAccelerated || ((mWindowAttributes.flags & android.view.WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED) != 0)) {
            wp.flags |= android.view.WindowManager.LayoutParams.FLAG_HARDWARE_ACCELERATED;
        }
    }
     ...
     */
    public final void addOnFrameMetricsAvailableListener(@android.annotation.NonNull
    android.view.Window.OnFrameMetricsAvailableListener listener, android.os.Handler handler) {
        final android.view.View decorView = getDecorView();
        if (decorView == null) {
     ...
     */
    public final void removeOnFrameMetricsAvailableListener(android.view.Window.OnFrameMetricsAvailableListener listener) {
        final android.view.View decorView = getDecorView();
        if (decorView != null) {
     ...
     * @unknown 
     */
    public final void setOnWindowSwipeDismissedCallback(android.view.Window.OnWindowSwipeDismissedCallback sdcb) {
     ...
     * @unknown 
     */
    public final void setWindowControllerCallback(android.view.Window.WindowControllerCallback wccb) {
     ...
     *
     * @param listener
     * 		Callback that will be called when the area changes.
     */
    public final void setRestrictedCaptionAreaListener(android.view.Window.OnRestrictedCaptionAreaChangedListener listener) {
        mOnRestrictedCaptionAreaChangedListener = listener;
        mRestrictedCaptionAreaRect = (listener != null) ? new android.graphics.Rect() : null;
    }
    ...
    public void setLayout(int width, int height) {
        final android.view.WindowManager.LayoutParams attrs = getAttributes();
        attrs.width = width;
        attrs.height = height;
     ...
     */
    public void setWindowAnimations(@android.annotation.StyleRes
    int resId) {
        final android.view.WindowManager.LayoutParams attrs = getAttributes();
    ...
    public void setSoftInputMode(int mode) {
        final android.view.WindowManager.LayoutParams attrs = getAttributes();
        if (mode != android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_UNSPECIFIED) {
    ...
    public void addSystemFlags(@android.view.WindowManager.LayoutParams.SystemFlags
    int flags) {
     ...
     * {@hide }
     */
    protected void dispatchWindowAttributesChanged(android.view.WindowManager.LayoutParams attrs) {
        if (mCallback != null) {
    ...
    public boolean isWideColorGamut() {
        return (getColorMode() == android.content.pm.ActivityInfo.COLOR_MODE_WIDE_COLOR_GAMUT) && getContext().getResources().getConfiguration().isScreenWideColorGamut();
    }
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
    public boolean shouldCloseOnTouch(android.content.Context context, android.view.MotionEvent event) {
        final boolean isOutside = ((event.getAction() == android.view.MotionEvent.ACTION_UP) && isOutOfBounds(context, event)) || (event.getAction() == android.view.MotionEvent.ACTION_OUTSIDE);
    ...
    public void setSustainedPerformanceMode(boolean enable) {
        setPrivateFlags(enable ? android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SUSTAINED_PERFORMANCE_MODE : 0, android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SUSTAINED_PERFORMANCE_MODE);
    }

    private boolean isOutOfBounds(android.content.Context context, android.view.MotionEvent event) {
        final int x = ((int) (event.getX()));
        final int y = ((int) (event.getY()));
        final int slop = android.view.ViewConfiguration.get(context).getScaledWindowTouchSlop();
        final android.view.View decorView = getDecorView();
     ...
     *
     *
     * @unknown Used internally to help resolve conflicting features.
     */
     ...
     */
    @android.annotation.Nullable
    public <T extends android.view.View> T findViewById(@android.annotation.IdRes
    int id) {
    ...
    public final <T extends android.view.View> T requireViewById(@android.annotation.IdRes
    int id) {
     ...
     */
    public abstract void setContentView(@android.annotation.LayoutRes
    int layoutResID);
    ...
    @java.lang.Deprecated
    public abstract void setTitleColor(@android.annotation.ColorInt
    int textColor);
     ...
     */
    public void setBackgroundDrawableResource(@android.annotation.DrawableRes
    int resId) {
     ...
     */
    public abstract void setFeatureDrawableResource(int featureId, @android.annotation.DrawableRes
    int resId);
    ...
    public static int getDefaultFeatures(android.content.Context context) {
        ...
        if (res.getBoolean(com.android.internal.R.bool.config_defaultWindowFeatureOptionsPanel)) {
            features |= 1 << android.view.Window.FEATURE_OPTIONS_PANEL;
        }
        if (res.getBoolean(com.android.internal.R.bool.config_defaultWindowFeatureContextMenu)) {
            features |= 1 << android.view.Window.FEATURE_CONTEXT_MENU;
        }
        return features;
    }
     ...
     */
    public void setMediaController(android.media.session.MediaController controller) {
    }
     ...
     * @unknown 
     */
    public void setDefaultIcon(@android.annotation.DrawableRes
    int resId) {
    }
     ...
     * @unknown 
     */
    public void setDefaultLogo(@android.annotation.DrawableRes
    int resId) {
    }
     ...
     * @unknown ref android.R.styleable#Window_windowContentTransitionManager
     */
     ...
     * @unknown ref android.R.styleable#Window_windowEnterTransition
     */
     ...
     * @unknown ref android.R.styleable#Window_windowReturnTransition
     */
     ...
     * 		new Activity.
     * @unknown ref android.R.styleable#Window_windowExitTransition
     */
     ...
     * @unknown ref android.R.styleable#Window_windowReenterTransition
     */
     ...
     * 		Scene.
     * @unknown ref android.R.styleable#Window_windowSharedElementEnterTransition
     */
     ...
     * 		Scene.
     * @unknown ref android.R.styleable#Window_windowSharedElementReturnTransition
     */
     ...
     * @unknown ref android.R.styleable#Window_windowSharedElementExitTransition
     */
     ...
     * @unknown ref android.R.styleable#Window_windowSharedElementReenterTransition
     */
     ...
     * @unknown ref android.R.styleable#Window_windowAllowEnterTransitionOverlap
     */
     ...
     * @unknown ref android.R.styleable#Window_windowAllowReturnTransitionOverlap
     */
     ...
     * @unknown ref android.R.styleable#Window_windowTransitionBackgroundFadeDuration
     */
     ...
     * @unknown ref android.R.styleable#Window_windowSharedElementsUseOverlay
     */
     ...
     * The default value is true.
     *
     * @param sharedElementsUseOverlay
     ...
     * </p>
     */
    public abstract void setStatusBarColor(@android.annotation.ColorInt
    int color);
     ...
     * </p>
     *
     * @unknown ref android.R.styleable#Window_navigationBarColor
     */
    public abstract void setNavigationBarColor(@android.annotation.ColorInt
    int color);
     ...
     *
     * @param dividerColor
     * 		The color of the thin line.
     * @unknown ref android.R.styleable#Window_navigationBarDividerColor
     */
    public void setNavigationBarDividerColor(@android.annotation.ColorInt
    int dividerColor) {
    }
     ...
     *
     * @param rects
     * 		A list of precision gesture regions that this window needs to function correctly
     */
     ...
     */
    @android.annotation.NonNull
    public abstract android.view.WindowInsetsController getInsetsController();
}
