...
public class ViewGroupOverlay extends android.view.ViewOverlay {
    ViewGroupOverlay(android.content.Context context, android.view.View hostView) {
     ...
     *
     * @param view
     * 		The {@code View} to be added to the overlay. The added view will be
     ...
     *
     * @param view
     * 		The {@code View} to be removed from the overlay.
     * @see #add(View)
