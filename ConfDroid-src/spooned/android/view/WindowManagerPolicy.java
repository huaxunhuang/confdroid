...
public interface WindowManagerPolicy {
    ...
    public static final int FLAG_WAKE = 0x1;

    public static final int FLAG_VIRTUAL = 0x2;
    ...
    public static final int KEYGUARD_GOING_AWAY_FLAG_TO_SHADE = 1 << 0;

    public static final int KEYGUARD_GOING_AWAY_FLAG_NO_WINDOW_ANIMATIONS = 1 << 1;

    public static final int KEYGUARD_GOING_AWAY_FLAG_WITH_WALLPAPER = 1 << 2;

    // Flags used for indicating whether the internal and/or external input devices
    // of some type are available.
    public static final int PRESENCE_INTERNAL = 1 << 0;

    public static final int PRESENCE_EXTERNAL = 1 << 1;
     ...
     */
    public static final int ACTION_PASS_TO_USER = 0x1;
     ...
     * @unknown 
     */
    void registerShortcutKey(long shortcutCode, com.android.internal.policy.IShortcutService shortcutKeyReceiver) throws android.os.RemoteException;

    /**
     * Called when the Keyguard occluded state changed.
     *
     * @param occluded
     * 		Whether Keyguard is currently occluded or not.
     */
    ...
    public interface WindowState {
         ...
         * @param stableFrame
         * 		The frame around which stable system decoration is positioned.
         * @param outsetFrame
         * 		The frame that includes areas that aren't part of the surface but we
         * 		want to treat them as such.
         */
        public void computeFrameLw(android.graphics.Rect parentFrame, android.graphics.Rect displayFrame, android.graphics.Rect overlayFrame, android.graphics.Rect contentFrame, android.graphics.Rect visibleFrame, android.graphics.Rect decorFrame, android.graphics.Rect stableFrame, android.graphics.Rect outsetFrame);
         ...
         *
         * @param bottom
         * 		The bottom-most window to consider when determining this.
         */
    ...
    public interface WindowManagerFuncs {
         ...
         */
        public android.view.WindowManagerPolicy.InputConsumer createInputConsumer(android.os.Looper looper, java.lang.String name, android.view.InputEventReceiver.Factory inputEventReceiverFactory);
         ...
         * 		{@code true} to rotate in a forward direction.
         */
         ...
         */
        void registerPointerEventListener(android.view.WindowManagerPolicy.PointerEventListener listener);

        /**
         * Unregister a system listener for touch events
         */
        void unregisterPointerEventListener(android.view.WindowManagerPolicy.PointerEventListener listener);
         ...
         */
        void getStackBounds(int stackId, android.graphics.Rect outBounds);
         ...
         */
        android.view.WindowManagerPolicy.WindowState getInputMethodWindowLw();
         ...
         *
         * @param listener
         * 		callback to call when display can be turned off
         */
        void screenTurningOff(android.view.WindowManagerPolicy.ScreenOffListener listener);
    }
    ...
    public interface PointerEventListener {
         ...
         */
        default void onPointerEvent(android.view.MotionEvent motionEvent, int displayId) {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.view.WindowManagerPolicy.USER_ROTATION_FREE, android.view.WindowManagerPolicy.USER_ROTATION_LOCKED })
     ...
     */
    public void init(android.content.Context context, android.view.IWindowManager windowManager, android.view.WindowManagerPolicy.WindowManagerFuncs windowManagerFuncs);
     ...
     */
    public int checkAddPermission(android.view.WindowManager.LayoutParams attrs, int[] outAppOp);
     ...
     */
    default int getWindowLayerLw(android.view.WindowManagerPolicy.WindowState win) {
    ...
    default int getWindowLayerFromTypeLw(int type) {
        ...
        getWindowLayerFromTypeLw(type, false);
    }
     ...
     * @param type
     * 		The type of window being assigned.
     * @param canAddInternalSystemWindow
     * 		If the owner window associated with the type we are
    ...
    default int getWindowLayerFromTypeLw(int type, boolean canAddInternalSystemWindow) {
        if ((type >= android.view.WindowManager.LayoutParams.FIRST_APPLICATION_WINDOW) && (type <= android.view.WindowManager.LayoutParams.LAST_APPLICATION_WINDOW)) {
            return android.view.WindowManagerPolicy.APPLICATION_LAYER;
        }
        switch (type) {
            case android.view.WindowManager.LayoutParams.TYPE_WALLPAPER :
                // wallpaper is at the bottom, though the window manager may move it.
                return 1;
            case android.view.WindowManager.LayoutParams.TYPE_PRESENTATION :
            case android.view.WindowManager.LayoutParams.TYPE_PRIVATE_PRESENTATION :
                return android.view.WindowManagerPolicy.APPLICATION_LAYER;
            case android.view.WindowManager.LayoutParams.TYPE_DOCK_DIVIDER :
                return android.view.WindowManagerPolicy.APPLICATION_LAYER;
            case android.view.WindowManager.LayoutParams.TYPE_QS_DIALOG :
                return android.view.WindowManagerPolicy.APPLICATION_LAYER;
            case android.view.WindowManager.LayoutParams.TYPE_PHONE :
                return 3;
            case android.view.WindowManager.LayoutParams.TYPE_SEARCH_BAR :
            case android.view.WindowManager.LayoutParams.TYPE_VOICE_INTERACTION_STARTING :
                return 4;
            case android.view.WindowManager.LayoutParams.TYPE_VOICE_INTERACTION :
                // voice interaction layer is almost immediately above apps.
                return 5;
            case android.view.WindowManager.LayoutParams.TYPE_INPUT_CONSUMER :
                return 6;
            case android.view.WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG :
                return 7;
            case android.view.WindowManager.LayoutParams.TYPE_TOAST :
            ...
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY :
                return 12;
            case android.view.WindowManager.LayoutParams.TYPE_DREAM :
                // used for Dreams (screensavers with TYPE_DREAM windows)
                return 13;
            case android.view.WindowManager.LayoutParams.TYPE_INPUT_METHOD :
                // on-screen keyboards and other such input method user interfaces go here.
                return 14;
            case android.view.WindowManager.LayoutParams.TYPE_INPUT_METHOD_DIALOG :
                // on-screen keyboards and other such input method user interfaces go here.
                return 15;
            case android.view.WindowManager.LayoutParams.TYPE_STATUS_BAR_SUB_PANEL :
                return 17;
            case android.view.WindowManager.LayoutParams.TYPE_STATUS_BAR :
                return 18;
            case android.view.WindowManager.LayoutParams.TYPE_STATUS_BAR_PANEL :
                return 19;
            case android.view.WindowManager.LayoutParams.TYPE_KEYGUARD_DIALOG :
                return 20;
            case android.view.WindowManager.LayoutParams.TYPE_VOLUME_OVERLAY :
            ...
            case android.view.WindowManager.LayoutParams.TYPE_NAVIGATION_BAR :
                // the navigation bar, if available, shows atop most things
                return 23;
            case android.view.WindowManager.LayoutParams.TYPE_NAVIGATION_BAR_PANEL :
                // some panels (e.g. search) need to show on top of the navigation bar
                return 24;
            case android.view.WindowManager.LayoutParams.TYPE_SCREENSHOT :
            ...
            case android.view.WindowManager.LayoutParams.TYPE_MAGNIFICATION_OVERLAY :
                // used to highlight the magnified portion of a display
                return 27;
            case android.view.WindowManager.LayoutParams.TYPE_DISPLAY_OVERLAY :
                // used to simulate secondary display devices
                return 28;
            case android.view.WindowManager.LayoutParams.TYPE_DRAG :
                // the drag layer: input for drag-and-drop is associated with this window,
                // which sits above all other focusable windows
                return 29;
            case android.view.WindowManager.LayoutParams.TYPE_ACCESSIBILITY_OVERLAY :
                // overlay put by accessibility services to intercept user interaction
                return 30;
            case android.view.WindowManager.LayoutParams.TYPE_SECURE_SYSTEM_OVERLAY :
                return 31;
            case android.view.WindowManager.LayoutParams.TYPE_BOOT_PROGRESS :
                return 32;
            case android.view.WindowManager.LayoutParams.TYPE_POINTER :
                // the (mouse) pointer layer
                return 33;
            default :
                android.util.Slog.e("WindowManager", "Unknown window type: " + type);
                return android.view.WindowManagerPolicy.APPLICATION_LAYER;
        }
    }
     ...
     *
     * @param type
     * 		The sub-window type code.
     * @return int Layer in relation to the attached window, where positive is
    above and negative is below.
     */
    default int getSubWindowLayerFromTypeLw(int type) {
        switch (type) {
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_PANEL :
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_ATTACHED_DIALOG :
                return android.view.WindowManagerPolicy.APPLICATION_PANEL_SUBLAYER;
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_MEDIA :
                return android.view.WindowManagerPolicy.APPLICATION_MEDIA_SUBLAYER;
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_MEDIA_OVERLAY :
                return android.view.WindowManagerPolicy.APPLICATION_MEDIA_OVERLAY_SUBLAYER;
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_SUB_PANEL :
                return android.view.WindowManagerPolicy.APPLICATION_SUB_PANEL_SUBLAYER;
            case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_ABOVE_SUB_PANEL :
                return android.view.WindowManagerPolicy.APPLICATION_ABOVE_SUB_PANEL_SUBLAYER;
        }
        android.util.Slog.e("WindowManager", "Unknown sub-window type: " + type);
        return 0;
    }
     ...
     */
    public boolean canBeHiddenByKeyguardLw(android.view.WindowManagerPolicy.WindowState win);
     ...
     *
     * @param appToken
     * 		Token of the application being started.
     * @param packageName
     * 		The name of the application package being started.
     * @param theme
     * 		Resource defining the application's overall visual theme.
     * @param nonLocalizedLabel
     * 		The default title label of the application if
     * 		no data is found in the resource.
     * @param labelRes
     * 		The resource ID the application would like to use as its name.
     * @param icon
     ...
     * @param displayId
     * 		Id of the display to show the splash screen at.
     * @return The starting surface.
     */
    public android.view.WindowManagerPolicy.StartingSurface addSplashScreen(android.os.IBinder appToken, java.lang.String packageName, int theme, android.content.res.CompatibilityInfo compatInfo, java.lang.CharSequence nonLocalizedLabel, int labelRes, int icon, int logo, int windowFlags, android.content.res.Configuration overrideConfig, int displayId);
     ...
     */
    public int prepareAddWindowLw(android.view.WindowManagerPolicy.WindowState win, android.view.WindowManager.LayoutParams attrs);
     ...
     *
     * @param win
     * 		The window that is changing.
     * @param transit
     * 		What is happening to the window: {@link #TRANSIT_ENTER},
     * 		{@link #TRANSIT_EXIT}, {@link #TRANSIT_SHOW}, or
     * 		{@link #TRANSIT_HIDE}.
     * @return Resource ID of the actual animation to use, or 0 for none.
     */
    public int selectAnimationLw(android.view.WindowManagerPolicy.WindowState win, int transit);
     ...
     *
     * @param exitAnimId
     * 		exiting resource id from the previous window.
     * @param enterAnimId
     ...
     */
    public android.view.animation.Animation createHiddenByKeyguardExit(boolean onWallpaper, boolean goingToNotificationShade);
     ...
     * 		The key event.
     * @param policyFlags
     * 		The policy flags associated with the key.
    ...
    again.
     */
    public long interceptKeyBeforeDispatching(android.view.WindowManagerPolicy.WindowState win, android.view.KeyEvent event, int policyFlags);
     ...
     */
    public android.view.KeyEvent dispatchUnhandledKey(android.view.WindowManagerPolicy.WindowState win, android.view.KeyEvent event, int policyFlags);

    /**
     * Called when layout of the windows is about to start.
     *
     * @param isDefaultDisplay
     * 		true if window is on {@link Display#DEFAULT_DISPLAY}.
     * @param displayWidth
     * 		The current full width of the screen.
     * @param displayHeight
     * 		The current full height of the screen.
     * @param displayRotation
     * 		The current rotation being applied to the base window.
     * @param uiMode
     * 		The current uiMode in configuration.
     */
     ...
     */
    public void layoutWindowLw(android.view.WindowManagerPolicy.WindowState win, android.view.WindowManagerPolicy.WindowState attached);
     ...
     *
     * @param attrs
     * 		The LayoutParams of the window.
     * @param taskBounds
     * 		The bounds of the task this window is on or {@code null} if no task is
     ...
     * 		The areas covered by system windows, expressed as positive insets.
     * @param outStableInsets
     * 		The areas covered by stable system windows irrespective of their
     * 		current visibility. Expressed as positive insets.
     * @param outOutsets
     * 		The areas that are not real display, but we would like to treat as such.
     * @return Whether to always consume the navigation bar.
    See {@link #isNavBarForcedShownLw(WindowState)}.
     */
    public boolean getInsetHintLw(android.view.WindowManager.LayoutParams attrs, android.graphics.Rect taskBounds, int displayRotation, int displayWidth, int displayHeight, android.graphics.Rect outContentInsets, android.graphics.Rect outStableInsets, android.graphics.Rect outOutsets);
     ...
     */
    static final int FINISH_LAYOUT_REDO_LAYOUT = 0x1;

    /**
     * Configuration state may have changed
     */
    static final int FINISH_LAYOUT_REDO_CONFIG = 0x2;

    /**
     * Wallpaper may need to move
     */
    static final int FINISH_LAYOUT_REDO_WALLPAPER = 0x4;

    /**
     * Need to recompute animations
     */
    static final int FINISH_LAYOUT_REDO_ANIM = 0x8;
     ...
     */
    public void applyPostLayoutPolicyLw(android.view.WindowManagerPolicy.WindowState win, android.view.WindowManager.LayoutParams attrs, android.view.WindowManagerPolicy.WindowState attached, android.view.WindowManagerPolicy.WindowState imeTarget);
     ...
     */
    public int focusChangedLw(android.view.WindowManagerPolicy.WindowState lastFocus, android.view.WindowManagerPolicy.WindowState newFocus);
     ...
     *
     * @param why
     * 		{@link #OFF_BECAUSE_OF_USER}, {@link #OFF_BECAUSE_OF_ADMIN},
     ...
     * 		Must be called to tell that the display power state can actually be
     * 		changed now after policy has done its work.
     */
    public void screenTurningOff(android.view.WindowManagerPolicy.ScreenOffListener screenOffListener);
     ...
     *
     * @param whenNanos
     * 		The time when the change occurred in uptime nanoseconds.
     * @param lidOpen
     ...
     */
    @java.lang.SuppressWarnings("javadoc")
    void exitKeyguardSecurely(android.view.WindowManagerPolicy.OnKeyguardExitResult callback);
     ...
     *
     * @param callback
     * 		Callback to be informed about the result.
     */
    public void dismissKeyguardLw(@android.annotation.Nullable
     ...
     * @param lastRotation
     * 		The most recently used rotation.
     * @return The surface rotation to use.
     */
    public int rotationForOrientationLw(@android.content.pm.ActivityInfo.ScreenOrientation
    int orientation, int lastRotation);
     ...
     * 		{@link android.content.pm.ActivityInfo#SCREEN_ORIENTATION_LANDSCAPE}.
     * @param rotation
     * 		The rotation to check.
     * @return True if the rotation is compatible with the requested orientation.
     */
    public boolean rotationHasCompatibleMetricsLw(@android.content.pm.ActivityInfo.ScreenOrientation
     ...
     */
    public void showBootMessage(final java.lang.CharSequence msg, final boolean always);
    ...
    public void setCurrentOrientationLw(@android.content.pm.ActivityInfo.ScreenOrientation
    int newOrientation);

    /**
     * Call from application to perform haptic feedback on its window.
     */
    public boolean performHapticFeedbackLw(android.view.WindowManagerPolicy.WindowState win, int effectId, boolean always);
     ...
     */
    @android.view.WindowManagerPolicy.UserRotationMode
     ...
     *
     * @param mode
     * 		One of {@link WindowManagerPolicy#USER_ROTATION_LOCKED} or
     * 		{@link WindowManagerPolicy#USER_ROTATION_FREE}.
     * @param rotation
     * 		One of {@link Surface#ROTATION_0}, {@link Surface#ROTATION_90},
     * 		{@link Surface#ROTATION_180}, {@link Surface#ROTATION_270}.
     */
    public void setUserRotationMode(@android.view.WindowManagerPolicy.UserRotationMode
    int mode, @android.view.Surface.Rotation
    int rotation);
     ...
     *
     * @param visibility
     * 		The raw visibility reported by the status bar.
     ...
     * @unknown 
     */
    public void setLastInputMethodWindowLw(android.view.WindowManagerPolicy.WindowState ime, android.view.WindowManagerPolicy.WindowState target);
     ...
     *
     * @param newValue
     * 		{@code true} if the software keyboard is shown and the back key is expected
     ...
     *
     * @param switching
     * 		true if a user-switch is in progress
     */
     ...
     */
    public void dump(java.lang.String prefix, java.io.PrintWriter writer, java.lang.String[] args);
     ...
     *
     * @param startTime
     * 		the start time of the animation in uptime milliseconds
     ...
     * @param outInsets
     * 		the insets to return
     */
    public void getStableInsetsLw(int displayRotation, int displayWidth, int displayHeight, android.graphics.Rect outInsets);
     ...
     */
    public boolean isNavBarForcedShownLw(android.view.WindowManagerPolicy.WindowState win);
     ...
     * 		the insets to return
     */
    public void getNonDecorInsetsLw(int displayRotation, int displayWidth, int displayHeight, android.graphics.Rect outInsets);
