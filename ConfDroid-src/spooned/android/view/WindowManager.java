 ...
 * </p>
 */
@android.annotation.SystemService(android.content.Context.WINDOW_SERVICE)
public interface WindowManager extends android.view.ViewManager {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "TRANSIT_" }, value = { android.view.WindowManager.TRANSIT_UNSET, android.view.WindowManager.TRANSIT_NONE, android.view.WindowManager.TRANSIT_ACTIVITY_OPEN, android.view.WindowManager.TRANSIT_ACTIVITY_CLOSE, android.view.WindowManager.TRANSIT_TASK_OPEN, android.view.WindowManager.TRANSIT_TASK_CLOSE, android.view.WindowManager.TRANSIT_TASK_TO_FRONT, android.view.WindowManager.TRANSIT_TASK_TO_BACK, android.view.WindowManager.TRANSIT_WALLPAPER_CLOSE, android.view.WindowManager.TRANSIT_WALLPAPER_OPEN, android.view.WindowManager.TRANSIT_WALLPAPER_INTRA_OPEN, android.view.WindowManager.TRANSIT_WALLPAPER_INTRA_CLOSE, android.view.WindowManager.TRANSIT_TASK_OPEN_BEHIND, android.view.WindowManager.TRANSIT_TASK_IN_PLACE, android.view.WindowManager.TRANSIT_ACTIVITY_RELAUNCH, android.view.WindowManager.TRANSIT_DOCK_TASK_FROM_RECENTS, android.view.WindowManager.TRANSIT_KEYGUARD_GOING_AWAY, android.view.WindowManager.TRANSIT_KEYGUARD_GOING_AWAY_ON_WALLPAPER, android.view.WindowManager.TRANSIT_KEYGUARD_OCCLUDE, android.view.WindowManager.TRANSIT_KEYGUARD_UNOCCLUDE, android.view.WindowManager.TRANSIT_TRANSLUCENT_ACTIVITY_OPEN, android.view.WindowManager.TRANSIT_TRANSLUCENT_ACTIVITY_CLOSE, android.view.WindowManager.TRANSIT_CRASHING_ACTIVITY_CLOSE, android.view.WindowManager.TRANSIT_TASK_CHANGE_WINDOWING_MODE })
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "TRANSIT_FLAG_" }, value = { android.view.WindowManager.TRANSIT_FLAG_KEYGUARD_GOING_AWAY_TO_SHADE, android.view.WindowManager.TRANSIT_FLAG_KEYGUARD_GOING_AWAY_NO_ANIMATION, android.view.WindowManager.TRANSIT_FLAG_KEYGUARD_GOING_AWAY_WITH_WALLPAPER })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "REMOVE_CONTENT_MODE_" }, value = { android.view.WindowManager.REMOVE_CONTENT_MODE_UNDEFINED, android.view.WindowManager.REMOVE_CONTENT_MODE_MOVE_TO_PRIMARY, android.view.WindowManager.REMOVE_CONTENT_MODE_DESTROY })
    ...
    public static class BadTokenException extends java.lang.RuntimeException {
        ...
        public BadTokenException(java.lang.String name) {
            super(name);
        }
    }
    ...
    public static class InvalidDisplayException extends java.lang.RuntimeException {
        ...
        public InvalidDisplayException(java.lang.String name) {
            super(name);
        }
    }
    ...
    public interface KeyboardShortcutsReceiver {
         ...
         */
        void onKeyboardShortcutsReceived(java.util.List<android.view.KeyboardShortcutGroup> result);
    }
    ...
    @android.annotation.RequiresPermission(android.Manifest.permission.RESTRICTED_VR_ACCESS)
     ...
     * 		Display ID.
     * @param shouldShow
     * 		Indicates that the display should show its content when non-secure keyguard
     * 		is shown.
     ...
     * @param shouldShow
     * 		Indicates that the display should show system decors.
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams implements android.os.Parcelable {
         ...
         */
        public static final int TYPE_APPLICATION_PANEL = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW;

        /**
         * Window type: window for showing media (such as video).  These windows
         * are displayed behind their attached window.
         */
        public static final int TYPE_APPLICATION_MEDIA = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW + 1;
         ...
         */
        public static final int TYPE_APPLICATION_SUB_PANEL = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW + 2;
         ...
         */
        public static final int TYPE_APPLICATION_ATTACHED_DIALOG = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW + 3;
        ...
        public static final int TYPE_APPLICATION_MEDIA_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW + 4;
         ...
         * @unknown 
         */
        public static final int TYPE_APPLICATION_ABOVE_SUB_PANEL = android.view.WindowManager.LayoutParams.FIRST_SUB_WINDOW + 5;
         ...
         * In multiuser systems shows on all users' windows.
         */
        public static final int TYPE_STATUS_BAR = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW;
         ...
         * In multiuser systems shows on all users' windows.
         */
        public static final int TYPE_SEARCH_BAR = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 1;
        ...
        public static final int TYPE_PHONE = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 2;
         ...
         */
        @java.lang.Deprecated
        public static final int TYPE_SYSTEM_ALERT = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 3;
         ...
         * @unknown 
         */
        public static final int TYPE_KEYGUARD = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 4;
         ...
         */
        @java.lang.Deprecated
        public static final int TYPE_TOAST = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 5;
         ...
         */
        @java.lang.Deprecated
        public static final int TYPE_SYSTEM_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 6;
         ...
         */
        @java.lang.Deprecated
        public static final int TYPE_PRIORITY_PHONE = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 7;

        /**
         * Window type: panel that slides out from the status bar
         * In multiuser systems shows on all users' windows.
         */
        public static final int TYPE_SYSTEM_DIALOG = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 8;

        /**
         * Window type: dialogs that the keyguard shows
         * In multiuser systems shows on all users' windows.
         */
        public static final int TYPE_KEYGUARD_DIALOG = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 9;
         ...
         */
        @java.lang.Deprecated
        public static final int TYPE_SYSTEM_ERROR = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 10;
         ...
         * In multiuser systems shows only on the owning user's window.
         */
        public static final int TYPE_INPUT_METHOD = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 11;
         ...
         * In multiuser systems shows only on the owning user's window.
         */
        public static final int TYPE_INPUT_METHOD_DIALOG = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 12;
         ...
         * In multiuser systems shows only on the owning user's window.
         */
        public static final int TYPE_WALLPAPER = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 13;

        /**
         * Window type: panel that slides out from over the status bar
         * In multiuser systems shows on all users' windows.
         */
        public static final int TYPE_STATUS_BAR_PANEL = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 14;
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public static final int TYPE_SECURE_SYSTEM_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 15;
         ...
         * @unknown 
         */
        public static final int TYPE_DRAG = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 16;
         ...
         * @unknown 
         */
        public static final int TYPE_STATUS_BAR_SUB_PANEL = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 17;
         ...
         * @unknown 
         */
        public static final int TYPE_POINTER = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 18;
         ...
         * @unknown 
         */
        public static final int TYPE_NAVIGATION_BAR = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 19;
         ...
         * @unknown 
         */
        public static final int TYPE_BOOT_PROGRESS = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 21;
         ...
         * @unknown 
         */
        public static final int TYPE_INPUT_CONSUMER = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 22;
         ...
         * @unknown 
         */
        public static final int TYPE_DREAM = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 23;
         ...
         * @unknown 
         */
        public static final int TYPE_NAVIGATION_BAR_PANEL = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 24;
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public static final int TYPE_DISPLAY_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 26;
         ...
         * @unknown 
         */
        public static final int TYPE_MAGNIFICATION_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 27;

        /**
         * Window type: Window for Presentation on top of private
         * virtual display.
         */
        public static final int TYPE_PRIVATE_PRESENTATION = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 30;
         ...
         * @unknown 
         */
        public static final int TYPE_VOICE_INTERACTION = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 31;

        /**
         * Window type: Windows that are overlaid <em>only</em> by a connected {@link android.accessibilityservice.AccessibilityService} for interception of
         ...
         */
        public static final int TYPE_ACCESSIBILITY_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 32;
         ...
         * @unknown 
         */
        public static final int TYPE_VOICE_INTERACTION_STARTING = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 33;
         ...
         * @unknown 
         */
        public static final int TYPE_DOCK_DIVIDER = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 34;
         ...
         * @unknown 
         */
        public static final int TYPE_QS_DIALOG = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 35;
         ...
         * @unknown 
         */
        public static final int TYPE_SCREENSHOT = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 36;
         ...
         * @unknown 
         */
        public static final int TYPE_PRESENTATION = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 37;
         ...
         */
        public static final int TYPE_APPLICATION_OVERLAY = android.view.WindowManager.LayoutParams.FIRST_SYSTEM_WINDOW + 38;
         ...
         *
         *
         * @unknown Used internally when there is no suitable type available.
         */
        ...
        public static boolean isSystemAlertWindowType(int type) {
            switch (type) {
                case android.view.WindowManager.LayoutParams.TYPE_PHONE :
                case android.view.WindowManager.LayoutParams.TYPE_PRIORITY_PHONE :
                case android.view.WindowManager.LayoutParams.TYPE_SYSTEM_ALERT :
                case android.view.WindowManager.LayoutParams.TYPE_SYSTEM_ERROR :
                case android.view.WindowManager.LayoutParams.TYPE_SYSTEM_OVERLAY :
                case android.view.WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY :
                    return true;
            }
            return false;
        }
         ...
         */
        public static final int FLAG_ALLOW_LOCK_WHILE_SCREEN_ON = 0x1;

        /**
         * Window flag: everything behind this window will be dimmed.
         *  Use {@link #dimAmount} to control the amount of dim.
         */
        public static final int FLAG_DIM_BEHIND = 0x2;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_BLUR_BEHIND = 0x4;
         ...
         */
        public static final int FLAG_NOT_FOCUSABLE = 0x8;

        /**
         * Window flag: this window can never receive touch events.
         */
        public static final int FLAG_NOT_TOUCHABLE = 0x10;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_TOUCHABLE_WHEN_WAKING = 0x40;
         ...
         */
        public static final int FLAG_FULLSCREEN = 0x400;

        /**
         * Window flag: override {@link #FLAG_FULLSCREEN} and force the
         *  screen decorations (such as the status bar) to be shown.
         */
        public static final int FLAG_FORCE_NOT_FULLSCREEN = 0x800;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_DITHER = 0x1000;
         ...
         */
        public static final int FLAG_SECURE = 0x2000;
         ...
         * screen.
         */
        public static final int FLAG_SCALED = 0x4000;
         ...
         */
        public static final int FLAG_IGNORE_CHEEK_PRESSES = 0x8000;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED = 0x1;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_FORCE_HARDWARE_ACCELERATED = 0x2;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_WANTS_OFFSET_NOTIFICATIONS = 0x4;
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public static final int PRIVATE_FLAG_SHOW_FOR_ALL_USERS = 0x10;
         ...
         */
        @android.annotation.TestApi
        public static final int PRIVATE_FLAG_NO_MOVE_ANIMATION = 0x40;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_COMPATIBLE_WINDOW = 0x80;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_SYSTEM_ERROR = 0x100;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_INHERIT_TRANSLUCENT_DECOR = 0x200;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_KEYGUARD = 0x400;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_DISABLE_WALLPAPER_TOUCH_EVENTS = 0x800;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_FORCE_STATUS_BAR_VISIBLE_TRANSPARENT = 0x1000;
         ...
         * {@hide }
         */
        public static final int PRIVATE_FLAG_PRESERVE_GEOMETRY = 0x2000;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_FORCE_DECOR_VIEW_VISIBILITY = 0x4000;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_WILL_NOT_REPLACE_ON_RELAUNCH = 0x8000;
         ...
         * @unknown 
         */
        public static final int PRIVATE_FLAG_FORCE_DRAW_BAR_BACKGROUNDS = 0x20000;
         ...
         */
        @android.annotation.SystemApi
        @android.annotation.RequiresPermission(android.Manifest.permission.HIDE_NON_SYSTEM_OVERLAY_WINDOWS)
        public static final int SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS = 0x80000;
         ...
         * @unknown 
         */
        @android.annotation.RequiresPermission(android.Manifest.permission.STATUS_BAR_SERVICE)
        public static final int PRIVATE_FLAG_IS_SCREEN_DECOR = 0x400000;
        ...
        @android.annotation.SystemApi
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
        @android.annotation.IntDef(flag = true, prefix = { "SYSTEM_FLAG_" }, value = { android.view.WindowManager.LayoutParams.SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS })
         ...
         * @unknown 
         */
        @android.view.ViewDebug.ExportedProperty(flagMapping = { @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FAKE_HARDWARE_ACCELERATED, name = "FAKE_HARDWARE_ACCELERATED"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_HARDWARE_ACCELERATED, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_HARDWARE_ACCELERATED, name = "FORCE_HARDWARE_ACCELERATED"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_WANTS_OFFSET_NOTIFICATIONS, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_WANTS_OFFSET_NOTIFICATIONS, name = "WANTS_OFFSET_NOTIFICATIONS"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SHOW_FOR_ALL_USERS, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SHOW_FOR_ALL_USERS, name = "SHOW_FOR_ALL_USERS"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_NO_MOVE_ANIMATION, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_NO_MOVE_ANIMATION, name = "NO_MOVE_ANIMATION"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_COMPATIBLE_WINDOW, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_COMPATIBLE_WINDOW, name = "COMPATIBLE_WINDOW"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SYSTEM_ERROR, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SYSTEM_ERROR, name = "SYSTEM_ERROR"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_INHERIT_TRANSLUCENT_DECOR, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_INHERIT_TRANSLUCENT_DECOR, name = "INHERIT_TRANSLUCENT_DECOR"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_KEYGUARD, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_KEYGUARD, name = "KEYGUARD"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_DISABLE_WALLPAPER_TOUCH_EVENTS, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_DISABLE_WALLPAPER_TOUCH_EVENTS, name = "DISABLE_WALLPAPER_TOUCH_EVENTS"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_STATUS_BAR_VISIBLE_TRANSPARENT, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_STATUS_BAR_VISIBLE_TRANSPARENT, name = "FORCE_STATUS_BAR_VISIBLE_TRANSPARENT"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_PRESERVE_GEOMETRY, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_PRESERVE_GEOMETRY, name = "PRESERVE_GEOMETRY"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_DECOR_VIEW_VISIBILITY, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_DECOR_VIEW_VISIBILITY, name = "FORCE_DECOR_VIEW_VISIBILITY"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_WILL_NOT_REPLACE_ON_RELAUNCH, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_WILL_NOT_REPLACE_ON_RELAUNCH, name = "WILL_NOT_REPLACE_ON_RELAUNCH"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME, name = "LAYOUT_CHILD_WINDOW_IN_PARENT_FRAME"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_DRAW_BAR_BACKGROUNDS, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_FORCE_DRAW_BAR_BACKGROUNDS, name = "FORCE_DRAW_STATUS_BAR_BACKGROUND"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SUSTAINED_PERFORMANCE_MODE, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_SUSTAINED_PERFORMANCE_MODE, name = "SUSTAINED_PERFORMANCE_MODE"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS, equals = android.view.WindowManager.LayoutParams.SYSTEM_FLAG_HIDE_NON_SYSTEM_OVERLAY_WINDOWS, name = "HIDE_NON_SYSTEM_OVERLAY_WINDOWS"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_IS_ROUNDED_CORNERS_OVERLAY, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_IS_ROUNDED_CORNERS_OVERLAY, name = "IS_ROUNDED_CORNERS_OVERLAY"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_IS_SCREEN_DECOR, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_IS_SCREEN_DECOR, name = "IS_SCREEN_DECOR"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_STATUS_FORCE_SHOW_NAVIGATION, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_STATUS_FORCE_SHOW_NAVIGATION, name = "STATUS_FORCE_SHOW_NAVIGATION"), @android.view.ViewDebug.FlagToString(mask = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_COLOR_SPACE_AGNOSTIC, equals = android.view.WindowManager.LayoutParams.PRIVATE_FLAG_COLOR_SPACE_AGNOSTIC, name = "COLOR_SPACE_AGNOSTIC") })
        @android.annotation.TestApi
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public int needsMenuKey = android.view.WindowManager.LayoutParams.NEEDS_MENU_UNSET;
        ...
        public static boolean mayUseInputMethod(int flags) {
            switch (flags & (android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | android.view.WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM)) {
                case 0 :
                case android.view.WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | android.view.WindowManager.LayoutParams.FLAG_ALT_FOCUSABLE_IM :
                    return true;
            }
            return false;
        }
         ...
         */
        public static final int SOFT_INPUT_MASK_STATE = 0xf;
         ...
         */
        public static final int SOFT_INPUT_ADJUST_UNSPECIFIED = 0x0;
         ...
         * dark to full bright.
         */
        public float screenBrightness = android.view.WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE;
         ...
         */
        public float buttonBrightness = android.view.WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE;
         ...
         */
        public int rotationAnimation = android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_ROTATE;
         ...
         */
        public java.lang.String packageName = null;
         ...
         *
         *
         * @unknown The ui visibility as requested by the views in this hierarchy.
         ...
         */
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
        @android.annotation.IntDef(flag = true, value = { android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_DEFAULT, android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_SHORT_EDGES, android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_NEVER })
        ...
        public int layoutInDisplayCutoutMode = android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_DEFAULT;
         ...
         * @unknown 
         */
        public static final int INPUT_FEATURE_DISABLE_POINTER_GESTURES = 0x1;
         ...
         * @unknown 
         */
        public static final int INPUT_FEATURE_NO_INPUT_CHANNEL = 0x2;
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public static final int INPUT_FEATURE_DISABLE_USER_ACTIVITY = 0x4;
        ...
        private int mColorMode = android.content.pm.ActivityInfo.COLOR_MODE_DEFAULT;

        public LayoutParams() {
            super(android.view.WindowManager.LayoutParams.MATCH_PARENT, android.view.WindowManager.LayoutParams.MATCH_PARENT);
            type = android.view.WindowManager.LayoutParams.TYPE_APPLICATION;
         ...
         * @unknown 
         */
        public final void setSurfaceInsets(android.view.View view, boolean manual, boolean preservePrevious) {
            final int surfaceInset = ((int) (java.lang.Math.ceil(view.getZ() * 2)));
            ...
            if (surfaceInset == 0) {
                ...
                surfaceInsets.set(java.lang.Math.max(surfaceInset, surfaceInsets.left), java.lang.Math.max(surfaceInset, surfaceInsets.top), java.lang.Math.max(surfaceInset, surfaceInsets.right), java.lang.Math.max(surfaceInset, surfaceInsets.bottom));
            }
         ...
         * @see #getColorMode()
         */
        public void setColorMode(@android.content.pm.ActivityInfo.ColorMode
        int colorMode) {
        ...
        public void writeToParcel(android.os.Parcel out, int parcelableFlags) {
            ...
            android.text.TextUtils.writeToParcel(accessibilityTitle, out, parcelableFlags);
            out.writeInt(mColorMode);
            out.writeLong(hideTimeoutMilliseconds);
        }

        @android.annotation.NonNull
        public static final android.os.Parcelable.Creator<android.view.WindowManager.LayoutParams> CREATOR = new android.os.Parcelable.Creator<android.view.WindowManager.LayoutParams>() {
            public android.view.LayoutParams createFromParcel(android.os.Parcel in) {
                return new android.view.LayoutParams(in);
            }

            public android.view.LayoutParams[] newArray(int size) {
                return new android.view.LayoutParams[size];
            }
        };
        ...
        public final int copyFrom(android.view.WindowManager.LayoutParams o) {
            ...
            if (width != o.width) {
                width = o.width;
                changes |= android.view.WindowManager.LayoutParams.LAYOUT_CHANGED;
            }
            if (height != o.height) {
                height = o.height;
                changes |= android.view.WindowManager.LayoutParams.LAYOUT_CHANGED;
            ...
            if (type != o.type) {
                type = o.type;
                changes |= android.view.WindowManager.LayoutParams.TYPE_CHANGED;
            }
            if (flags != o.flags) {
                final int diff = flags ^ o.flags;
                if ((diff & (android.view.WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS | android.view.WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION)) != 0) {
                    changes |= android.view.WindowManager.LayoutParams.TRANSLUCENT_FLAGS_CHANGED;
                }
                flags = o.flags;
                changes |= android.view.WindowManager.LayoutParams.FLAGS_CHANGED;
            }
            if (privateFlags != o.privateFlags) {
                privateFlags = o.privateFlags;
                changes |= android.view.WindowManager.LayoutParams.PRIVATE_FLAGS_CHANGED;
            }
            if (softInputMode != o.softInputMode) {
                softInputMode = o.softInputMode;
                changes |= android.view.WindowManager.LayoutParams.SOFT_INPUT_MODE_CHANGED;
            }
            ...
            if (format != o.format) {
                format = o.format;
                changes |= android.view.WindowManager.LayoutParams.FORMAT_CHANGED;
            }
            if (windowAnimations != o.windowAnimations) {
                windowAnimations = o.windowAnimations;
                changes |= android.view.WindowManager.LayoutParams.ANIMATION_CHANGED;
            }
            if (token == null) {
            ...
            if ((!java.util.Objects.equals(mTitle, o.mTitle)) && (o.mTitle != null)) {
                // NOTE: mTitle only copied if the originator set one.
                mTitle = o.mTitle;
                changes |= android.view.WindowManager.LayoutParams.TITLE_CHANGED;
            }
            if (alpha != o.alpha) {
                alpha = o.alpha;
                changes |= android.view.WindowManager.LayoutParams.ALPHA_CHANGED;
            }
            if (dimAmount != o.dimAmount) {
                dimAmount = o.dimAmount;
                changes |= android.view.WindowManager.LayoutParams.DIM_AMOUNT_CHANGED;
            }
            if (screenBrightness != o.screenBrightness) {
                screenBrightness = o.screenBrightness;
                changes |= android.view.WindowManager.LayoutParams.SCREEN_BRIGHTNESS_CHANGED;
            }
            if (buttonBrightness != o.buttonBrightness) {
                buttonBrightness = o.buttonBrightness;
                changes |= android.view.WindowManager.LayoutParams.BUTTON_BRIGHTNESS_CHANGED;
            }
            if (rotationAnimation != o.rotationAnimation) {
                rotationAnimation = o.rotationAnimation;
                changes |= android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_CHANGED;
            }
            if (screenOrientation != o.screenOrientation) {
                screenOrientation = o.screenOrientation;
                changes |= android.view.WindowManager.LayoutParams.SCREEN_ORIENTATION_CHANGED;
            }
            if (preferredRefreshRate != o.preferredRefreshRate) {
                preferredRefreshRate = o.preferredRefreshRate;
                changes |= android.view.WindowManager.LayoutParams.PREFERRED_REFRESH_RATE_CHANGED;
            }
            if (preferredDisplayModeId != o.preferredDisplayModeId) {
                preferredDisplayModeId = o.preferredDisplayModeId;
                changes |= android.view.WindowManager.LayoutParams.PREFERRED_DISPLAY_MODE_ID;
            }
            if ((systemUiVisibility != o.systemUiVisibility) || (subtreeSystemUiVisibility != o.subtreeSystemUiVisibility)) {
                systemUiVisibility = o.systemUiVisibility;
                subtreeSystemUiVisibility = o.subtreeSystemUiVisibility;
                changes |= android.view.WindowManager.LayoutParams.SYSTEM_UI_VISIBILITY_CHANGED;
            }
            if (hasSystemUiListeners != o.hasSystemUiListeners) {
                hasSystemUiListeners = o.hasSystemUiListeners;
                changes |= android.view.WindowManager.LayoutParams.SYSTEM_UI_LISTENER_CHANGED;
            }
            if (inputFeatures != o.inputFeatures) {
                inputFeatures = o.inputFeatures;
                changes |= android.view.WindowManager.LayoutParams.INPUT_FEATURES_CHANGED;
            }
            if (userActivityTimeout != o.userActivityTimeout) {
                userActivityTimeout = o.userActivityTimeout;
                changes |= android.view.WindowManager.LayoutParams.USER_ACTIVITY_TIMEOUT_CHANGED;
            }
            if (!surfaceInsets.equals(o.surfaceInsets)) {
                surfaceInsets.set(o.surfaceInsets);
                changes |= android.view.WindowManager.LayoutParams.SURFACE_INSETS_CHANGED;
            }
            ...
            if (needsMenuKey != o.needsMenuKey) {
                ...
                changes |= android.view.WindowManager.LayoutParams.NEEDS_MENU_KEY_CHANGED;
            }
            if (accessibilityIdOfAnchor != o.accessibilityIdOfAnchor) {
                accessibilityIdOfAnchor = o.accessibilityIdOfAnchor;
                changes |= android.view.WindowManager.LayoutParams.ACCESSIBILITY_ANCHOR_CHANGED;
            }
            if ((!java.util.Objects.equals(accessibilityTitle, o.accessibilityTitle)) && (o.accessibilityTitle != null)) {
                // NOTE: accessibilityTitle only copied if the originator set one.
                accessibilityTitle = o.accessibilityTitle;
                changes |= android.view.WindowManager.LayoutParams.ACCESSIBILITY_TITLE_CHANGED;
            }
            if (mColorMode != o.mColorMode) {
                mColorMode = o.mColorMode;
                changes |= android.view.WindowManager.LayoutParams.COLOR_MODE_CHANGED;
            }
        ...
        public void dumpDimensions(java.lang.StringBuilder sb) {
            ...
            sb.append(y);
            sb.append(")(");
            sb.append(width == android.view.ViewGroup.LayoutParams.MATCH_PARENT ? "fill" : width == android.view.ViewGroup.LayoutParams.WRAP_CONTENT ? "wrap" : java.lang.String.valueOf(width));
            sb.append('x');
            sb.append(height == android.view.ViewGroup.LayoutParams.MATCH_PARENT ? "fill" : height == android.view.ViewGroup.LayoutParams.WRAP_CONTENT ? "wrap" : java.lang.String.valueOf(height));
            sb.append(")");
        }
        ...
        public java.lang.String toString(java.lang.String prefix) {
            ...
            if (gravity != 0) {
                sb.append(" gr=");
                sb.append(android.view.Gravity.toString(gravity));
            }
            if (softInputMode != 0) {
                sb.append(" sim={");
                sb.append(android.view.WindowManager.LayoutParams.softInputModeToString(softInputMode));
                sb.append('}');
            }
            if (layoutInDisplayCutoutMode != 0) {
                sb.append(" layoutInDisplayCutoutMode=");
                sb.append(android.view.WindowManager.LayoutParams.layoutInDisplayCutoutModeToString(layoutInDisplayCutoutMode));
            }
            sb.append(" ty=");
            sb.append(android.view.ViewDebug.intToString(android.view.WindowManager.LayoutParams.class, "type", type));
            if (format != android.graphics.PixelFormat.OPAQUE) {
                sb.append(" fmt=");
                sb.append(android.graphics.PixelFormat.formatToString(format));
            }
            if (windowAnimations != 0) {
                sb.append(" wanim=0x");
                sb.append(java.lang.Integer.toHexString(windowAnimations));
            }
            if (screenOrientation != android.content.pm.ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED) {
                sb.append(" or=");
                sb.append(android.content.pm.ActivityInfo.screenOrientationToString(screenOrientation));
            }
            if (alpha != 1.0F) {
                sb.append(" alpha=");
                sb.append(alpha);
            }
            if (screenBrightness != android.view.WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE) {
                sb.append(" sbrt=");
                sb.append(screenBrightness);
            }
            if (buttonBrightness != android.view.WindowManager.LayoutParams.BRIGHTNESS_OVERRIDE_NONE) {
                sb.append(" bbrt=");
                sb.append(buttonBrightness);
            }
            if (rotationAnimation != android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_ROTATE) {
                sb.append(" rotAnim=");
                sb.append(android.view.WindowManager.LayoutParams.rotationAnimationToString(rotationAnimation));
            }
            ...
            if (inputFeatures != 0) {
                sb.append(" if=").append(android.view.WindowManager.LayoutParams.inputFeatureToString(inputFeatures));
            }
            ...
            if (needsMenuKey == android.view.WindowManager.LayoutParams.NEEDS_MENU_SET_TRUE) {
                sb.append(" needsMenuKey");
            }
            if (mColorMode != android.content.pm.ActivityInfo.COLOR_MODE_DEFAULT) {
                sb.append(" colorMode=").append(android.content.pm.ActivityInfo.colorModeToString(mColorMode));
            }
            sb.append(java.lang.System.lineSeparator());
            sb.append(prefix).append("  fl=").append(android.view.ViewDebug.flagsToString(android.view.WindowManager.LayoutParams.class, "flags", flags));
            if (privateFlags != 0) {
                sb.append(java.lang.System.lineSeparator());
                sb.append(prefix).append("  pfl=").append(android.view.ViewDebug.flagsToString(android.view.WindowManager.LayoutParams.class, "privateFlags", privateFlags));
            }
            if (systemUiVisibility != 0) {
                sb.append(java.lang.System.lineSeparator());
                sb.append(prefix).append("  sysui=").append(android.view.ViewDebug.flagsToString(android.view.View.class, "mSystemUiVisibility", systemUiVisibility));
            }
            if (subtreeSystemUiVisibility != 0) {
                sb.append(java.lang.System.lineSeparator());
                sb.append(prefix).append("  vsysui=").append(android.view.ViewDebug.flagsToString(android.view.View.class, "mSystemUiVisibility", subtreeSystemUiVisibility));
            }
            sb.append('}');
            return sb.toString();
        }
        ...
        public void writeToProto(android.util.proto.ProtoOutputStream proto, long fieldId) {
            ...
            proto.write(android.view.WindowLayoutParamsProto.TYPE, type);
            proto.write(android.view.WindowLayoutParamsProto.X, x);
            proto.write(android.view.WindowLayoutParamsProto.Y, y);
            proto.write(android.view.WindowLayoutParamsProto.WIDTH, width);
            proto.write(android.view.WindowLayoutParamsProto.HEIGHT, height);
            proto.write(android.view.WindowLayoutParamsProto.HORIZONTAL_MARGIN, horizontalMargin);
            proto.write(android.view.WindowLayoutParamsProto.VERTICAL_MARGIN, verticalMargin);
            proto.write(android.view.WindowLayoutParamsProto.GRAVITY, gravity);
            proto.write(android.view.WindowLayoutParamsProto.SOFT_INPUT_MODE, softInputMode);
            proto.write(android.view.WindowLayoutParamsProto.FORMAT, format);
            proto.write(android.view.WindowLayoutParamsProto.WINDOW_ANIMATIONS, windowAnimations);
            proto.write(android.view.WindowLayoutParamsProto.ALPHA, alpha);
            proto.write(android.view.WindowLayoutParamsProto.SCREEN_BRIGHTNESS, screenBrightness);
            proto.write(android.view.WindowLayoutParamsProto.BUTTON_BRIGHTNESS, buttonBrightness);
            proto.write(android.view.WindowLayoutParamsProto.ROTATION_ANIMATION, rotationAnimation);
            proto.write(android.view.WindowLayoutParamsProto.PREFERRED_REFRESH_RATE, preferredRefreshRate);
            proto.write(WindowLayoutParamsProto.PREFERRED_DISPLAY_MODE_ID, preferredDisplayModeId);
            proto.write(android.view.WindowLayoutParamsProto.HAS_SYSTEM_UI_LISTENERS, hasSystemUiListeners);
            proto.write(android.view.WindowLayoutParamsProto.INPUT_FEATURE_FLAGS, inputFeatures);
            proto.write(android.view.WindowLayoutParamsProto.USER_ACTIVITY_TIMEOUT, userActivityTimeout);
            proto.write(android.view.WindowLayoutParamsProto.NEEDS_MENU_KEY, needsMenuKey);
            proto.write(android.view.WindowLayoutParamsProto.COLOR_MODE, mColorMode);
            proto.write(android.view.WindowLayoutParamsProto.FLAGS, flags);
            proto.write(android.view.WindowLayoutParamsProto.PRIVATE_FLAGS, privateFlags);
            proto.write(android.view.WindowLayoutParamsProto.SYSTEM_UI_VISIBILITY_FLAGS, systemUiVisibility);
            proto.write(android.view.WindowLayoutParamsProto.SUBTREE_SYSTEM_UI_VISIBILITY_FLAGS, subtreeSystemUiVisibility);
            proto.end(token);
        }
        ...
        public boolean isFullscreen() {
            return (((x == 0) && (y == 0)) && (width == android.view.WindowManager.LayoutParams.MATCH_PARENT)) && (height == android.view.WindowManager.LayoutParams.MATCH_PARENT);
        }

        private static java.lang.String layoutInDisplayCutoutModeToString(@android.view.WindowManager.LayoutParams.LayoutInDisplayCutoutMode
        int mode) {
            switch (mode) {
                case android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_DEFAULT :
                    return "default";
                case android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_ALWAYS :
                    return "always";
                case android.view.WindowManager.LayoutParams.LAYOUT_IN_DISPLAY_CUTOUT_MODE_NEVER :
                    return "never";
                default :
                    return ("unknown(" + mode) + ")";
            }
        ...
        private static java.lang.String softInputModeToString(@android.view.WindowManager.LayoutParams.SoftInputModeFlags
        int softInputMode) {
            final java.lang.StringBuilder result = new java.lang.StringBuilder();
            final int state = softInputMode & android.view.WindowManager.LayoutParams.SOFT_INPUT_MASK_STATE;
            if (state != 0) {
                result.append("state=");
                switch (state) {
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_UNCHANGED :
                        result.append("unchanged");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN :
                        result.append("hidden");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN :
                        result.append("always_hidden");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_VISIBLE :
                        result.append("visible");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_VISIBLE :
            ...
            final int adjust = softInputMode & android.view.WindowManager.LayoutParams.SOFT_INPUT_MASK_ADJUST;
            if (adjust != 0) {
                result.append("adjust=");
                switch (adjust) {
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE :
                        result.append("resize");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN :
                        result.append("pan");
                        break;
                    case android.view.WindowManager.LayoutParams.SOFT_INPUT_ADJUST_NOTHING :
            ...
            if ((softInputMode & android.view.WindowManager.LayoutParams.SOFT_INPUT_IS_FORWARD_NAVIGATION) != 0) {
        ...
        private static java.lang.String rotationAnimationToString(int rotationAnimation) {
            switch (rotationAnimation) {
                case android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_UNSPECIFIED :
                    return "UNSPECIFIED";
                case android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_ROTATE :
                    return "ROTATE";
                case android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_CROSSFADE :
                    return "CROSSFADE";
                case android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_JUMPCUT :
                    return "JUMPCUT";
                case android.view.WindowManager.LayoutParams.ROTATION_ANIMATION_SEAMLESS :
                    return "SEAMLESS";
                default :
                    return java.lang.Integer.toString(rotationAnimation);
            }
        }

        private static java.lang.String inputFeatureToString(int inputFeature) {
            switch (inputFeature) {
                case android.view.WindowManager.LayoutParams.INPUT_FEATURE_DISABLE_POINTER_GESTURES :
                    return "DISABLE_POINTER_GESTURES";
                case android.view.WindowManager.LayoutParams.INPUT_FEATURE_NO_INPUT_CHANNEL :
                    return "NO_INPUT_CHANNEL";
                case android.view.WindowManager.LayoutParams.INPUT_FEATURE_DISABLE_USER_ACTIVITY :
                    return "DISABLE_USER_ACTIVITY";
                default :
                    return java.lang.Integer.toString(inputFeature);
            }
        }
    }
}
