...
public abstract class ActionProvider {
    ...
    public void setVisibilityListener(android.view.ActionProvider.VisibilityListener listener) {
        if (mVisibilityListener != null) {
            android.util.Log.w(android.view.ActionProvider.TAG, (("setVisibilityListener: Setting a new ActionProvider.VisibilityListener " + "when one is already set. Are you reusing this ") + getClass().getSimpleName()) + " instance while it is still in use somewhere else?");
        }
