...
public abstract class OrientationEventListener {
    ...
    private int mOrientation = android.view.OrientationEventListener.ORIENTATION_UNKNOWN;
    ...
    public OrientationEventListener(android.content.Context context, int rate) {
        mSensorManager = ((android.hardware.SensorManager) (context.getSystemService(android.content.Context.SENSOR_SERVICE)));
        mRate = rate;
        mSensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);
        if (mSensor != null) {
            // Create listener only if sensors do exist
            mSensorEventListener = new android.view.OrientationEventListener.SensorEventListenerImpl();
        }
    }

    void registerListener(android.view.OrientationListener lis) {
        mOldListener = lis;
    }
    ...
    public void enable() {
        if (mSensor == null) {
            android.util.Log.w(android.view.OrientationEventListener.TAG, "Cannot detect sensors. Not enabled");
            return;
        }
        if (mEnabled == false) {
            if (android.view.OrientationEventListener.localLOGV)
                android.util.Log.d(android.view.OrientationEventListener.TAG, "OrientationEventListener enabled");
    ...
    public void disable() {
        if (mSensor == null) {
            android.util.Log.w(android.view.OrientationEventListener.TAG, "Cannot detect sensors. Invalid disable");
            return;
        }
        if (mEnabled == true) {
            if (android.view.OrientationEventListener.localLOGV)
                android.util.Log.d(android.view.OrientationEventListener.TAG, "OrientationEventListener disabled");
    ...
    class SensorEventListenerImpl implements android.hardware.SensorEventListener {
        ...
        public void onSensorChanged(android.hardware.SensorEvent event) {
            ...
            int orientation = android.view.OrientationEventListener.ORIENTATION_UNKNOWN;
            float X = -values[android.view.OrientationEventListener.SensorEventListenerImpl._DATA_X];
            float Y = -values[android.view.OrientationEventListener.SensorEventListenerImpl._DATA_Y];
            float Z = -values[android.view.OrientationEventListener.SensorEventListenerImpl._DATA_Z];
