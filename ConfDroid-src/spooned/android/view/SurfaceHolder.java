...
public interface SurfaceHolder {
    ...
    public static class BadSurfaceTypeException extends java.lang.RuntimeException {
        ...
        public BadSurfaceTypeException(java.lang.String name) {
            super(name);
        }
    }
    ...
    public interface Callback2 extends android.view.SurfaceHolder.Callback {
         ...
         * @param drawingFinished
         * 		A runnable to signal completion. This may be invoked
         * 		from any thread.
         */
        default void surfaceRedrawNeededAsync(android.view.SurfaceHolder holder, java.lang.Runnable drawingFinished) {
     ...
     *
     * @param callback
     * 		The Callback interface to remove.
     */
