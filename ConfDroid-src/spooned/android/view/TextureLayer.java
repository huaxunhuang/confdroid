...
public final class TextureLayer {
    ...
    private TextureLayer(android.graphics.HardwareRenderer renderer, long deferredUpdater) {
        if ((renderer == null) || (deferredUpdater == 0)) {
            throw new java.lang.IllegalArgumentException(((("Either hardware renderer: " + renderer) + " or deferredUpdater: ") + deferredUpdater) + " is invalid");
        }
        mRenderer = renderer;
        mFinalizer = new com.android.internal.util.VirtualRefBasePtr(deferredUpdater);
    }
     ...
     *
     * @param paint
     * 		The paint used when the layer is drawn into the destination canvas.
     * @see View#setLayerPaint(android.graphics.Paint)
     */
    public void setLayerPaint(@android.annotation.Nullable
    android.graphics.Paint paint) {
        android.view.TextureLayer.nSetLayerPaint(mFinalizer.get(), paint != null ? paint.getNativeInstance() : 0);
     ...
     *
     * @param bitmap
     * 		The bitmap to copy they layer into
     ...
     *
     * @param width
     * 		The new width of this layer
     * @param height
     * 		The new height of this layer
     * @param isOpaque
    ...
    public boolean prepare(int width, int height, boolean isOpaque) {
        return android.view.TextureLayer.nPrepare(mFinalizer.get(), width, height, isOpaque);
    }
     ...
     *
     * @param matrix
     * 		The transform to apply to the layer.
     */
    public void setTransform(android.graphics.Matrix matrix) {
        android.view.TextureLayer.nSetTransform(mFinalizer.get(), matrix.native_instance);
        mRenderer.pushLayerUpdate(this);
    }
    ...
    public void setSurfaceTexture(android.graphics.SurfaceTexture surface) {
        android.view.TextureLayer.nSetSurfaceTexture(mFinalizer.get(), surface);
        mRenderer.pushLayerUpdate(this);
    }

    public void updateSurfaceTexture() {
        android.view.TextureLayer.nUpdateSurfaceTexture(mFinalizer.get());
        mRenderer.pushLayerUpdate(this);
    }
     ...
     * @unknown 
     */
    public static android.view.TextureLayer adoptTextureLayer(android.graphics.HardwareRenderer renderer, long layer) {
        return new android.view.TextureLayer(renderer, layer);
    }
    ...
    private static native void nSetSurfaceTexture(long layerUpdater, android.graphics.SurfaceTexture surface);
