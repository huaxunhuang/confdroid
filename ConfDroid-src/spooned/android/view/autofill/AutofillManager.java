 ...
 */
@android.annotation.SystemService(android.content.Context.AUTOFILL_MANAGER_SERVICE)
@android.annotation.RequiresFeature(android.content.pm.PackageManager.FEATURE_AUTOFILL)
public final class AutofillManager {
     ...
     * @unknown 
     */
    public static final int FLAG_ADD_CLIENT_ENABLED = 0x1;
     ...
     * @unknown 
     */
    public static final int FLAG_ADD_CLIENT_DEBUG = 0x2;
     ...
     * @unknown 
     */
    public static final int FLAG_ADD_CLIENT_VERBOSE = 0x4;
     ...
     * @unknown 
     */
    public static final int FLAG_ADD_CLIENT_ENABLED_FOR_AUGMENTED_AUTOFILL_ONLY = 0x8;
     ...
     * @unknown 
     */
    public static final int RECEIVER_FLAG_SESSION_FOR_AUGMENTED_AUTOFILL_ONLY = 0x1;
     ...
     * @unknown 
     */
    public static final int DEFAULT_LOGGING_LEVEL = (android.os.Build.IS_DEBUGGABLE) ? android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_DEBUG : android.view.autofill.AutofillManager.NO_LOGGING;
     ...
     *
     *
     * @unknown The index for an undefined data set
     */
    ...
    public static final int MAX_TEMP_AUGMENTED_SERVICE_DURATION_MS = (1000 * 60) * 2;// 2 minutes
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = false, value = { android.view.autofill.AutofillManager.FLAG_SMART_SUGGESTION_OFF, android.view.autofill.AutofillManager.FLAG_SMART_SUGGESTION_SYSTEM })
    ...
    public static int makeAuthenticationId(int requestId, int datasetId) {
        return (requestId << android.view.autofill.AutofillManager.AUTHENTICATION_ID_DATASET_ID_SHIFT) | (datasetId & android.view.autofill.AutofillManager.AUTHENTICATION_ID_DATASET_ID_MASK);
    }
    ...
    public static int getRequestIdFromAuthenticationId(int authRequestId) {
        return authRequestId >> android.view.autofill.AutofillManager.AUTHENTICATION_ID_DATASET_ID_SHIFT;
    }
    ...
    public static int getDatasetIdFromAuthenticationId(int authRequestId) {
        return authRequestId & android.view.autofill.AutofillManager.AUTHENTICATION_ID_DATASET_ID_MASK;
    }
     ...
     * {@hide }
     */
    public static final int NO_SESSION = java.lang.Integer.MAX_VALUE;
    ...
    @com.android.internal.annotations.GuardedBy("mLock")
    private int mSessionId = android.view.autofill.AutofillManager.NO_SESSION;

    @com.android.internal.annotations.GuardedBy("mLock")
    private int mState = android.view.autofill.AutofillManager.STATE_UNKNOWN;
    ...
    public interface AutofillClient {
         ...
         * 		A unique id of the authentication operation.
         * @param intent
         * 		The authentication intent.
         * @param fillInIntent
         * 		The authentication fill-in intent.
         */
        void autofillClientAuthenticate(int authenticationId, android.content.IntentSender intent, android.content.Intent fillInIntent);
         ...
         *
         * @param anchor
         * 		The real view the UI needs to anchor to.
         * @param width
         * 		The width of the fill UI content.
         * @param height
         * 		The height of the fill UI content.
         * @param virtualBounds
         * 		The bounds of the virtual decendant of the anchor.
         * @param presenter
         * 		The presenter that controls the fill UI window.
         * @return Whether the UI was shown.
         */
        boolean autofillClientRequestShowFillUi(@android.annotation.NonNull
        android.view.View anchor, int width, int height, @android.annotation.Nullable
        android.graphics.Rect virtualBounds, android.view.autofill.IAutofillWindowPresenter presenter);
         ...
         * 		The real view the UI needs to anchor to.
         * @param keyEvent
         * 		Unhandled KeyEvent from autofill window.
         */
        void autofillClientDispatchUnhandledKey(@android.annotation.NonNull
        android.view.View anchor, @android.annotation.NonNull
        ...
        boolean[] autofillClientGetViewVisibility(@android.annotation.NonNull
         ...
         *
         * @param autofillIds
         * 		The autofill ids of the views to find
         * @return And array containing the views (empty if no views found).
         */
        @android.annotation.NonNull
        android.view.View[] autofillClientFindViewsByAutofillIdTraversal(@android.annotation.NonNull
        android.view.autofill.AutofillId[] autofillIds);
         ...
         *
         * @param autofillId
         * 		The autofill id of the views to find
         * @return The view, or {@code null} if not found
         */
        @android.annotation.Nullable
        android.view.View autofillClientFindViewByAutofillIdTraversal(@android.annotation.NonNull
         ...
         *
         * @param viewId
         * 		The accessibility id of the views to find
         * @param windowId
         * 		The accessibility window id where to search
         * @return The view, or {@code null} if not found
         */
        @android.annotation.Nullable
        android.view.View autofillClientFindViewByAccessibilityIdTraversal(int viewId, int windowId);

        /**
         * Runs the specified action on the UI thread.
         */
        void autofillClientRunOnUiThread(java.lang.Runnable action);
     ...
     * @unknown 
     */
    public AutofillManager(android.content.Context context, android.view.autofill.IAutoFillManager service) {
        mContext = com.android.internal.util.Preconditions.checkNotNull(context, "context cannot be null");
        mService = service;
        mOptions = context.getAutofillOptions();
        if (mOptions != null) {
            android.view.autofill.Helper.sDebug = (mOptions.loggingLevel & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_DEBUG) != 0;
            android.view.autofill.Helper.sVerbose = (mOptions.loggingLevel & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_VERBOSE) != 0;
        }
    }
    ...
    public void enableCompatibilityMode() {
        synchronized(mLock) {
            ...
            if (android.view.autofill.Helper.sDebug) {
                android.util.Slog.d(android.view.autofill.AutofillManager.TAG, "creating CompatibilityBridge for " + mContext);
            }
            mCompatibilityBridge = new android.view.autofill.AutofillManager.CompatibilityBridge();
        }
    }
    ...
    public void onCreate(android.os.Bundle savedInstanceState) {
        ...
        synchronized(mLock) {
            mLastAutofilledData = savedInstanceState.getParcelable(android.view.autofill.AutofillManager.LAST_AUTOFILLED_DATA_TAG);
            if (isActiveLocked()) {
                android.util.Log.w(android.view.autofill.AutofillManager.TAG, "New session was started before onCreate()");
                return;
            }
            mSessionId = savedInstanceState.getInt(android.view.autofill.AutofillManager.SESSION_ID_TAG, android.view.autofill.AutofillManager.NO_SESSION);
            mState = savedInstanceState.getInt(android.view.autofill.AutofillManager.STATE_TAG, android.view.autofill.AutofillManager.STATE_UNKNOWN);
            if (mSessionId != android.view.autofill.AutofillManager.NO_SESSION) {
                ensureServiceClientAddedIfNeededLocked();
                final android.view.autofill.AutofillManager.AutofillClient client = getClient();
                if (client != null) {
                    final com.android.internal.util.SyncResultReceiver receiver = new com.android.internal.util.SyncResultReceiver(android.view.autofill.AutofillManager.SYNC_CALLS_TIMEOUT_MS);
                    try {
                        ...
                        if (!sessionWasRestored) {
                            android.util.Log.w(android.view.autofill.AutofillManager.TAG, ("Session " + mSessionId) + " could not be restored");
                            mSessionId = android.view.autofill.AutofillManager.NO_SESSION;
                            mState = android.view.autofill.AutofillManager.STATE_UNKNOWN;
                        } else {
                            if (android.view.autofill.Helper.sDebug) {
                                android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("session " + mSessionId) + " was restored");
                            }
                            client.autofillClientResetableStateAvailable();
                        }
                    } catch (android.os.RemoteException e) {
                        android.util.Log.e(android.view.autofill.AutofillManager.TAG, "Could not figure out if there was an autofill session", e);
                    }
                }
            }
        }
    ...
    public void onVisibleForAutofill() {
        ...
        android.view.Choreographer.getInstance().postCallback(android.view.Choreographer.CALLBACK_COMMIT, () -> {
            synchronized(mLock) {
    ...
    public void onSaveInstanceState(android.os.Bundle outState) {
        ...
        synchronized(mLock) {
            if (mSessionId != android.view.autofill.AutofillManager.NO_SESSION) {
                outState.putInt(android.view.autofill.AutofillManager.SESSION_ID_TAG, mSessionId);
            }
            if (mState != android.view.autofill.AutofillManager.STATE_UNKNOWN) {
                outState.putInt(android.view.autofill.AutofillManager.STATE_TAG, mState);
            }
            if (mLastAutofilledData != null) {
                outState.putParcelable(android.view.autofill.AutofillManager.LAST_AUTOFILLED_DATA_TAG, mLastAutofilledData);
            }
        }
    }
     ...
     */
    public void requestAutofill(@android.annotation.NonNull
    android.view.View view) {
        notifyViewEntered(view, android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST);
    }
     ...
     */
    public void requestAutofill(@android.annotation.NonNull
    android.view.View view, int virtualId, @android.annotation.NonNull
    android.graphics.Rect absBounds) {
        notifyViewEntered(view, virtualId, absBounds, android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST);
    }
     ...
     *
     * @param view
     * 		{@link View} that was entered.
     */
    public void notifyViewEntered(@android.annotation.NonNull
    android.view.View view) {
        notifyViewEntered(view, 0);
    }

    @com.android.internal.annotations.GuardedBy("mLock")
    private boolean shouldIgnoreViewEnteredLocked(@android.annotation.NonNull
    android.view.autofill.AutofillId id, int flags) {
        if (isDisabledByServiceLocked()) {
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, ((((("ignoring notifyViewEntered(flags=" + flags) + ", view=") + id) + ") on state ") + getStateAsStringLocked()) + " because disabled by svc");
            }
            return true;
        }
        if (isFinishedLocked()) {
            // Session already finished: ignore if automatic request and view already entered
            if ((((flags & android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST) == 0) && (mEnteredIds != null)) && mEnteredIds.contains(id)) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((((("ignoring notifyViewEntered(flags=" + flags) + ", view=") + id) + ") on state ") + getStateAsStringLocked()) + " because view was already entered: ") + mEnteredIds);
                }
                return true;
            }
        }
    ...
    private void notifyViewEntered(@android.annotation.NonNull
    android.view.View view, int flags) {
        if (!hasAutofillFeature()) {
            return;
        }
        android.view.autofill.AutofillManager.AutofillCallback callback;
        synchronized(mLock) {
            callback = notifyViewEnteredLocked(view, flags);
        }
        if (callback != null) {
            mCallback.onAutofillEvent(view, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_UNAVAILABLE);
        }
    }
     ...
     */
    @com.android.internal.annotations.GuardedBy("mLock")
    private android.view.autofill.AutofillManager.AutofillCallback notifyViewEnteredLocked(@android.annotation.NonNull
    android.view.View view, int flags) {
        final android.view.autofill.AutofillId id = view.getAutofillId();
        if (shouldIgnoreViewEnteredLocked(id, flags))
            return null;

        android.view.autofill.AutofillManager.AutofillCallback callback = null;
        ensureServiceClientAddedIfNeededLocked();
        if ((!mEnabled) && (!mEnabledForAugmentedAutofillOnly)) {
            if (android.view.autofill.Helper.sVerbose)
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, ("ignoring notifyViewEntered(" + id) + "): disabled");
            ...
            if (!isClientDisablingEnterExitEvent()) {
                final android.view.autofill.AutofillValue value = view.getAutofillValue();
                if (!isActiveLocked()) {
                    // Starts new session.
                    startSessionLocked(id, null, value, flags);
                } else {
                    // Update focus on existing session.
                    if (mForAugmentedAutofillOnly && ((flags & android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST) != 0)) {
                        if (android.view.autofill.Helper.sDebug) {
                            android.util.Log.d(android.view.autofill.AutofillManager.TAG, (("notifyViewEntered(" + id) + "): resetting ") + "mForAugmentedAutofillOnly on manual request");
                        }
                        mForAugmentedAutofillOnly = false;
                    }
                    updateSessionLocked(id, null, value, android.view.autofill.AutofillManager.ACTION_VIEW_ENTERED, flags);
                }
     ...
     *
     * @param view
     * 		{@link View} that was exited.
     */
    public void notifyViewExited(@android.annotation.NonNull
    android.view.View view) {
        if (!hasAutofillFeature()) {
            return;
        }
    ...
    @com.android.internal.annotations.GuardedBy("mLock")
    void notifyViewExitedLocked(@android.annotation.NonNull
    android.view.View view) {
        ensureServiceClientAddedIfNeededLocked();
        if ((mEnabled || mEnabledForAugmentedAutofillOnly) && isActiveLocked()) {
            ...
            if (!isClientDisablingEnterExitEvent()) {
                final android.view.autofill.AutofillId id = view.getAutofillId();
                // Update focus on existing session.
                updateSessionLocked(id, null, null, android.view.autofill.AutofillManager.ACTION_VIEW_EXITED, 0);
            }
        }
    }
     ...
     */
    public void notifyViewVisibilityChanged(@android.annotation.NonNull
     ...
     */
    public void notifyViewVisibilityChanged(@android.annotation.NonNull
    android.view.View view, int virtualId, boolean isVisible) {
     ...
     * 		visible if the view is visible in the view hierarchy.
     * @param virtual
     * 		Whether the view is virtual.
     */
    private void notifyViewVisibilityChangedInternal(@android.annotation.NonNull
    android.view.View view, int virtualId, boolean isVisible, boolean virtual) {
        synchronized(mLock) {
            if (mForAugmentedAutofillOnly) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "notifyViewVisibilityChanged(): ignoring on augmented only mode");
                }
                return;
            }
            if (mEnabled && isActiveLocked()) {
                final android.view.autofill.AutofillId id = (virtual) ? android.view.autofill.AutofillManager.getAutofillId(view, virtualId) : view.getAutofillId();
                if (android.view.autofill.Helper.sVerbose)
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("visibility changed for " + id) + ": ") + isVisible);

                if ((!isVisible) && (mFillableIds != null)) {
                    if (mFillableIds.contains(id)) {
                        if (android.view.autofill.Helper.sDebug)
                            android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("Hidding UI when view " + id) + " became invisible");
                ...
                if (mTrackedViews != null) {
                    ...
                    if (android.view.autofill.Helper.sVerbose) {
                        android.util.Log.v(android.view.autofill.AutofillManager.TAG, ("Ignoring visibility change on " + id) + ": no tracked views");
                    }
    ...
    private void notifyViewEntered(android.view.View view, int virtualId, android.graphics.Rect bounds, int flags) {
        if (!hasAutofillFeature()) {
            return;
        }
        android.view.autofill.AutofillManager.AutofillCallback callback;
        ...
        if (callback != null) {
            callback.onAutofillEvent(view, virtualId, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_UNAVAILABLE);
        }
    }
     ...
     */
    @com.android.internal.annotations.GuardedBy("mLock")
    private android.view.autofill.AutofillManager.AutofillCallback notifyViewEnteredLocked(android.view.View view, int virtualId, android.graphics.Rect bounds, int flags) {
        final android.view.autofill.AutofillId id = android.view.autofill.AutofillManager.getAutofillId(view, virtualId);
        android.view.autofill.AutofillManager.AutofillCallback callback = null;
        if (shouldIgnoreViewEnteredLocked(id, flags))
            return callback;
        ...
        if ((!mEnabled) && (!mEnabledForAugmentedAutofillOnly)) {
            ...
            if (!isClientDisablingEnterExitEvent()) {
                if (!isActiveLocked()) {
                    ...
                    updateSessionLocked(id, bounds, null, android.view.autofill.AutofillManager.ACTION_VIEW_ENTERED, flags);
                }
                addEnteredIdLocked(id);
            }
        }
    ...
    @com.android.internal.annotations.GuardedBy("mLock")
    private void addEnteredIdLocked(@android.annotation.NonNull
    android.view.autofill.AutofillId id) {
        if (mEnteredIds == null) {
            mEnteredIds = new android.util.ArraySet(1);
        }
        id.resetSessionId();
        mEnteredIds.add(id);
    }
     ...
     */
    public void notifyViewExited(@android.annotation.NonNull
    android.view.View view, int virtualId) {
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("notifyViewExited(" + view.getAutofillId()) + ", ") + virtualId);
    ...
    @com.android.internal.annotations.GuardedBy("mLock")
    private void notifyViewExitedLocked(@android.annotation.NonNull
    android.view.View view, int virtualId) {
        ensureServiceClientAddedIfNeededLocked();
        if ((mEnabled || mEnabledForAugmentedAutofillOnly) && isActiveLocked()) {
    ...
    public void notifyValueChanged(android.view.View view) {
        ...
        android.view.autofill.AutofillId id = null;
        boolean valueWasRead = false;
        android.view.autofill.AutofillValue value = null;
        synchronized(mLock) {
            ...
            if (mLastAutofilledData == null) {
                ...
                if (mLastAutofilledData.containsKey(id)) {
                    ...
                    valueWasRead = true;
                    if (java.util.Objects.equals(mLastAutofilledData.get(id), value)) {
            ...
            if (mForAugmentedAutofillOnly) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "notifyValueChanged(): not notifying system server on " + "augmented-only mode");
                }
                return;
            }
            if ((!mEnabled) || (!isActiveLocked())) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("notifyValueChanged(" + view.getAutofillId()) + "): ignoring on state ") + getStateAsStringLocked());
                }
                return;
            }
            if (id == null) {
            ...
            updateSessionLocked(id, null, value, android.view.autofill.AutofillManager.ACTION_VALUE_CHANGED, 0);
        }
    }
     ...
     */
    public void notifyValueChanged(android.view.View view, int virtualId, android.view.autofill.AutofillValue value) {
        if (!hasAutofillFeature()) {
            return;
        }
        synchronized(mLock) {
            if (mForAugmentedAutofillOnly) {
                if (android.view.autofill.Helper.sVerbose)
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "notifyValueChanged(): ignoring on augmented only mode");

                return;
            }
            if ((!mEnabled) || (!isActiveLocked())) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("notifyValueChanged(" + view.getAutofillId()) + ":") + virtualId) + "): ignoring on state ") + getStateAsStringLocked());
                }
                return;
            }
            final android.view.autofill.AutofillId id = android.view.autofill.AutofillManager.getAutofillId(view, virtualId);
     ...
     */
    public void notifyViewClicked(@android.annotation.NonNull
    android.view.View view) {
    ...
    public void notifyViewClicked(@android.annotation.NonNull
    android.view.View view, int virtualId) {
        notifyViewClicked(android.view.autofill.AutofillManager.getAutofillId(view, virtualId));
    }

    private void notifyViewClicked(android.view.autofill.AutofillId id) {
        if (!hasAutofillFeature()) {
            return;
        }
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("notifyViewClicked(): id=" + id) + ", trigger=") + mSaveTriggerId);
        ...
        synchronized(mLock) {
            ...
            if ((mSaveTriggerId != null) && mSaveTriggerId.equals(id)) {
                if (android.view.autofill.Helper.sDebug)
                    android.util.Log.d(android.view.autofill.AutofillManager.TAG, "triggering commit by click of " + id);
    ...
    public void onActivityFinishing() {
        ...
        synchronized(mLock) {
            if (mSaveOnFinish) {
                if (android.view.autofill.Helper.sDebug)
                    android.util.Log.d(android.view.autofill.AutofillManager.TAG, "onActivityFinishing(): calling commitLocked()");

                commitLocked();
            } else {
                if (android.view.autofill.Helper.sDebug)
                    android.util.Log.d(android.view.autofill.AutofillManager.TAG, "onActivityFinishing(): calling cancelLocked()");
    ...
    public void commit() {
        ...
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, "commit() called by app");
    ...
    public void cancel() {
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, "cancel() called by app");
     ...
     * the user.
     */
    public void setUserData(@android.annotation.Nullable
    ...
    public java.util.List<java.lang.String> getAvailableFieldClassificationAlgorithms() {
        ...
        try {
            ...
            final java.lang.String[] algorithms = receiver.getStringArrayResult();
            return algorithms != null ? java.util.Arrays.asList(algorithms) : java.util.Collections.emptyList();
        } catch (android.os.RemoteException e) {
            e.rethrowFromSystemServer();
            return null;
        }
    ...
    private android.view.autofill.AutofillManager.AutofillClient getClient() {
        final android.view.autofill.AutofillManager.AutofillClient client = mContext.getAutofillClient();
        if ((client == null) && android.view.autofill.Helper.sVerbose) {
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("No AutofillClient for " + mContext.getPackageName()) + " on context ") + mContext);
        }
        return client;
    }
     ...
     * @unknown 
     */
    public void onAuthenticationResult(int authenticationId, android.content.Intent data, android.view.View focusView) {
        if (!hasAutofillFeature()) {
            return;
        }
        ...
        if (android.view.autofill.Helper.sDebug) {
            android.util.Log.d(android.view.autofill.AutofillManager.TAG, (("onAuthenticationResult(): id= " + authenticationId) + ", data=") + data);
        }
        synchronized(mLock) {
            if (!isActiveLocked()) {
                return;
            ...
            if (((!mOnInvisibleCalled) && (focusView != null)) && focusView.canNotifyAutofillEnterExitEvent()) {
            ...
            final android.os.Parcelable result = data.getParcelableExtra(android.view.autofill.AutofillManager.EXTRA_AUTHENTICATION_RESULT);
            final android.os.Bundle responseData = new android.os.Bundle();
            responseData.putParcelable(android.view.autofill.AutofillManager.EXTRA_AUTHENTICATION_RESULT, result);
            final android.os.Bundle newClientState = data.getBundleExtra(android.view.autofill.AutofillManager.EXTRA_CLIENT_STATE);
            if (newClientState != null) {
                responseData.putBundle(android.view.autofill.AutofillManager.EXTRA_CLIENT_STATE, newClientState);
            }
            try {
                mService.setAuthenticationResult(responseData, mSessionId, authenticationId, mContext.getUserId());
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.view.autofill.AutofillManager.TAG, "Error delivering authentication result", e);
            }
        }
    }
    ...
    public android.view.autofill.AutofillId getNextAutofillId() {
        ...
        final android.view.autofill.AutofillId id = client.autofillClientGetNextAutofillId();
        if ((id == null) && android.view.autofill.Helper.sDebug) {
            android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("getNextAutofillId(): client " + client) + " returned null");
        }
        return id;
    }

    private static android.view.autofill.AutofillId getAutofillId(android.view.View parent, int virtualId) {
        return new android.view.autofill.AutofillId(parent.getAutofillViewId(), virtualId);
    }

    @com.android.internal.annotations.GuardedBy("mLock")
    private void startSessionLocked(@android.annotation.NonNull
    android.view.autofill.AutofillId id, @android.annotation.NonNull
    android.graphics.Rect bounds, @android.annotation.NonNull
    android.view.autofill.AutofillValue value, int flags) {
        if (((mEnteredForAugmentedAutofillIds != null) && mEnteredForAugmentedAutofillIds.contains(id)) || mEnabledForAugmentedAutofillOnly) {
            if (android.view.autofill.Helper.sVerbose)
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, "Starting session for augmented autofill on " + id);

            flags |= android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_ENABLED_FOR_AUGMENTED_AUTOFILL_ONLY;
        }
        if (android.view.autofill.Helper.sVerbose) {
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((((((((((((((("startSessionLocked(): id=" + id) + ", bounds=") + bounds) + ", value=") + value) + ", flags=") + flags) + ", state=") + getStateAsStringLocked()) + ", compatMode=") + isCompatibilityModeEnabledLocked()) + ", augmentedOnly=") + mForAugmentedAutofillOnly) + ", enabledAugmentedOnly=") + mEnabledForAugmentedAutofillOnly) + ", enteredIds=") + mEnteredIds);
        }
        ...
        if ((mForAugmentedAutofillOnly && (!mEnabledForAugmentedAutofillOnly)) && ((flags & android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST) != 0)) {
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, "resetting mForAugmentedAutofillOnly on manual autofill request");
            }
            mForAugmentedAutofillOnly = false;
        }
        if (((mState != android.view.autofill.AutofillManager.STATE_UNKNOWN) && (!isFinishedLocked())) && ((flags & android.service.autofill.FillRequest.FLAG_MANUAL_REQUEST) == 0)) {
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("not automatically starting session for " + id) + " on state ") + getStateAsStringLocked()) + " and flags ") + flags);
            }
            return;
        }
        try {
            ...
            if (client == null)
                return;
            // NOTE: getClient() already logged it..

            final com.android.internal.util.SyncResultReceiver receiver = new com.android.internal.util.SyncResultReceiver(android.view.autofill.AutofillManager.SYNC_CALLS_TIMEOUT_MS);
            final android.content.ComponentName componentName = client.autofillClientGetComponentName();
            mService.startSession(client.autofillClientGetActivityToken(), mServiceClient.asBinder(), id, bounds, value, mContext.getUserId(), mCallback != null, flags, componentName, isCompatibilityModeEnabledLocked(), receiver);
            mSessionId = receiver.getIntResult();
            if (mSessionId != android.view.autofill.AutofillManager.NO_SESSION) {
                mState = android.view.autofill.AutofillManager.STATE_ACTIVE;
            }
            final int extraFlags = receiver.getOptionalExtraIntResult(0);
            if ((extraFlags & android.view.autofill.AutofillManager.RECEIVER_FLAG_SESSION_FOR_AUGMENTED_AUTOFILL_ONLY) != 0) {
                if (android.view.autofill.Helper.sDebug)
                    android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("startSession(" + componentName) + "): for augmented only");
    ...
    private void finishSessionLocked() {
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, "finishSessionLocked(): " + getStateAsStringLocked());
    ...
    private void cancelSessionLocked() {
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, "cancelSessionLocked(): " + getStateAsStringLocked());
    ...
    @com.android.internal.annotations.GuardedBy("mLock")
    private void updateSessionLocked(android.view.autofill.AutofillId id, android.graphics.Rect bounds, android.view.autofill.AutofillValue value, int action, int flags) {
        if (android.view.autofill.Helper.sVerbose) {
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((((((("updateSessionLocked(): id=" + id) + ", bounds=") + bounds) + ", value=") + value) + ", action=") + action) + ", flags=") + flags);
        }
        try {
            mService.updateSession(mSessionId, id, bounds, value, action, flags, mContext.getUserId());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    private void ensureServiceClientAddedIfNeededLocked() {
        ...
        if (mServiceClient == null) {
            mServiceClient = new android.view.autofill.AutofillManager.AutofillManagerClient(this);
            try {
                final int userId = mContext.getUserId();
                final com.android.internal.util.SyncResultReceiver receiver = new com.android.internal.util.SyncResultReceiver(android.view.autofill.AutofillManager.SYNC_CALLS_TIMEOUT_MS);
                mService.addClient(mServiceClient, client.autofillClientGetComponentName(), userId, receiver);
                final int flags = receiver.getIntResult();
                mEnabled = (flags & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_ENABLED) != 0;
                android.view.autofill.Helper.sDebug = (flags & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_DEBUG) != 0;
                android.view.autofill.Helper.sVerbose = (flags & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_VERBOSE) != 0;
                mEnabledForAugmentedAutofillOnly = (flags & android.view.autofill.AutofillManager.FLAG_ADD_CLIENT_ENABLED_FOR_AUGMENTED_AUTOFILL_ONLY) != 0;
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("receiver results: flags=" + flags) + " enabled=") + mEnabled) + ", enabledForAugmentedOnly: ") + mEnabledForAugmentedAutofillOnly);
                }
                final android.view.autofill.IAutoFillManager service = mService;
                final android.view.autofill.IAutoFillManagerClient serviceClient = mServiceClient;
                mServiceClientCleaner = sun.misc.Cleaner.create(this, () -> {
     ...
     */
    public void registerCallback(@android.annotation.Nullable
    android.view.autofill.AutofillManager.AutofillCallback callback) {
        if (!hasAutofillFeature()) {
            return;
        }
     ...
     */
    public void unregisterCallback(@android.annotation.Nullable
    android.view.autofill.AutofillManager.AutofillCallback callback) {
        if (!hasAutofillFeature()) {
            return;
        }
        synchronized(mLock) {
            if (((callback == null) || (mCallback == null)) || (callback != mCallback))
                return;
    ...
    @android.annotation.TestApi
    public void setAugmentedAutofillWhitelist(@android.annotation.Nullable
    java.util.Set<java.lang.String> packages, @android.annotation.Nullable
    java.util.Set<android.content.ComponentName> activities) {
        if (!hasAutofillFeature()) {
            return;
        }
        final com.android.internal.util.SyncResultReceiver resultReceiver = new com.android.internal.util.SyncResultReceiver(android.view.autofill.AutofillManager.SYNC_CALLS_TIMEOUT_MS);
        final int resultCode;
        try {
            mService.setAugmentedAutofillWhitelist(android.view.autofill.Helper.toList(packages), android.view.autofill.Helper.toList(activities), resultReceiver);
            resultCode = resultReceiver.getIntResult();
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
        switch (resultCode) {
            case android.view.autofill.AutofillManager.RESULT_OK :
                return;
            case android.view.autofill.AutofillManager.RESULT_CODE_NOT_SERVICE :
                throw new java.lang.SecurityException("caller is not user's Augmented Autofill Service");
            default :
                android.util.Log.wtf(android.view.autofill.AutofillManager.TAG, "setAugmentedAutofillWhitelist(): received invalid result: " + resultCode);
        }
    }
     ...
     * @unknown 
     */
    public void notifyViewEnteredForAugmentedAutofill(@android.annotation.NonNull
    android.view.View view) {
        final android.view.autofill.AutofillId id = view.getAutofillId();
        synchronized(mLock) {
            if (mEnteredForAugmentedAutofillIds == null) {
                mEnteredForAugmentedAutofillIds = new android.util.ArraySet(1);
            }
            mEnteredForAugmentedAutofillIds.add(id);
        }
    }

    private void requestShowFillUi(int sessionId, android.view.autofill.AutofillId id, int width, int height, android.graphics.Rect anchorBounds, android.view.autofill.IAutofillWindowPresenter presenter) {
        final android.view.View anchor = findView(id);
        if (anchor == null) {
            return;
        }
        android.view.autofill.AutofillManager.AutofillCallback callback = null;
        synchronized(mLock) {
            if (mSessionId == sessionId) {
                ...
                if (client != null) {
                    if (client.autofillClientRequestShowFillUi(anchor, width, height, anchorBounds, presenter)) {
                        callback = mCallback;
                        mIdShownFillUi = id;
                    }
                }
        ...
        if (callback != null) {
            if (id.isVirtualInt()) {
                callback.onAutofillEvent(anchor, id.getVirtualChildIntId(), android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_SHOWN);
            } else {
                callback.onAutofillEvent(anchor, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_SHOWN);
            }
        }
    }

    private void authenticate(int sessionId, int authenticationId, android.content.IntentSender intent, android.content.Intent fillInIntent) {
        synchronized(mLock) {
    ...
    private void dispatchUnhandledKey(int sessionId, android.view.autofill.AutofillId id, android.view.KeyEvent keyEvent) {
        final android.view.View anchor = findView(id);
        if (anchor == null) {
            return;
        }
     ...
     * @unknown 
     */
    public static final int SET_STATE_FLAG_ENABLED = 0x1;
     ...
     * @unknown 
     */
    public static final int SET_STATE_FLAG_RESET_SESSION = 0x2;
     ...
     * @unknown 
     */
    public static final int SET_STATE_FLAG_RESET_CLIENT = 0x4;
     ...
     * @unknown 
     */
    public static final int SET_STATE_FLAG_DEBUG = 0x8;
    ...
    private void setState(int flags) {
        if (android.view.autofill.Helper.sVerbose) {
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, ((("setState(" + flags) + ": ") + android.util.DebugUtils.flagsToString(android.view.autofill.AutofillManager.class, "SET_STATE_FLAG_", flags)) + ")");
        }
        synchronized(mLock) {
            if ((flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_FOR_AUTOFILL_ONLY) != 0) {
                mForAugmentedAutofillOnly = true;
                // NOTE: returning right away as this is the only flag set, at least currently...
                return;
            }
            mEnabled = (flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_ENABLED) != 0;
            if ((!mEnabled) || ((flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_RESET_SESSION) != 0)) {
                // Reset the session state
                /* resetEnteredIds= */
                resetSessionLocked(true);
            }
            if ((flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_RESET_CLIENT) != 0) {
        ...
        android.view.autofill.Helper.sDebug = (flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_DEBUG) != 0;
        android.view.autofill.Helper.sVerbose = (flags & android.view.autofill.AutofillManager.SET_STATE_FLAG_VERBOSE) != 0;
    }
     ...
     *
     * @param view
     * 		The view that is to be autofilled
     * @param targetValue
     * 		The value we want to fill into view
     */
    private void setAutofilledIfValuesIs(@android.annotation.NonNull
    android.view.View view, @android.annotation.Nullable
    android.view.autofill.AutofillValue targetValue) {
        android.view.autofill.AutofillValue currentValue = view.getAutofillValue();
        if (java.util.Objects.equals(currentValue, targetValue)) {
            synchronized(mLock) {
                if (mLastAutofilledData == null) {
                    mLastAutofilledData = new android.view.autofill.ParcelableMap(1);
                }
    ...
    private void autofill(int sessionId, java.util.List<android.view.autofill.AutofillId> ids, java.util.List<android.view.autofill.AutofillValue> values) {
        synchronized(mLock) {
            if (sessionId != mSessionId) {
                return;
            }
            ...
            int numApplied = 0;
            android.util.ArrayMap<android.view.View, android.util.SparseArray<android.view.autofill.AutofillValue>> virtualValues = null;
            final android.view.View[] views = client.autofillClientFindViewsByAutofillIdTraversal(android.view.autofill.Helper.toArray(ids));
            java.util.ArrayList<android.view.autofill.AutofillId> failedIds = null;
            for (int i = 0; i < itemCount; i++) {
                final android.view.autofill.AutofillId id = ids.get(i);
                final android.view.autofill.AutofillValue value = values.get(i);
                final android.view.View view = views[i];
                if (view == null) {
                    ...
                    android.util.Log.d(android.view.autofill.AutofillManager.TAG, "autofill(): no View with id " + id);
                    if (failedIds == null) {
                        failedIds = new java.util.ArrayList<>();
                    }
                    failedIds.add(id);
                    continue;
                }
                if (id.isVirtualInt()) {
                    if (virtualValues == null) {
                        ...
                        virtualValues = new android.util.ArrayMap(1);
                    }
                    android.util.SparseArray<android.view.autofill.AutofillValue> valuesByParent = virtualValues.get(view);
                    if (valuesByParent == null) {
                        // We don't know the size yet, but usually it will be just a few fields...
                        valuesByParent = new android.util.SparseArray(5);
                    ...
                    if (mLastAutofilledData == null) {
                        mLastAutofilledData = new android.view.autofill.ParcelableMap(itemCount - i);
                    }
            ...
            if (failedIds != null) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "autofill(): total failed views: " + failedIds);
                }
                try {
            ...
            if (virtualValues != null) {
                for (int i = 0; i < virtualValues.size(); i++) {
                    final android.view.View parent = virtualValues.keyAt(i);
                    final android.util.SparseArray<android.view.autofill.AutofillValue> childrenValues = virtualValues.valueAt(i);
            ...
            mMetricsLogger.write(newLog(MetricsEvent.AUTOFILL_DATASET_APPLIED).addTaggedData(MetricsEvent.FIELD_AUTOFILL_NUM_VALUES, itemCount).addTaggedData(MetricsEvent.FIELD_AUTOFILL_NUM_VIEWS_FILLED, numApplied));
        }
    }

    private android.metrics.LogMaker newLog(int category) {
        final android.metrics.LogMaker log = new android.metrics.LogMaker(category).addTaggedData(MetricsEvent.FIELD_AUTOFILL_SESSION_ID, mSessionId);
     ...
     *
     * @param trackedIds
     * 		The views to be tracked.
     * @param saveOnAllViewsInvisible
     * 		Finish the session once all tracked views are invisible.
     * @param saveOnFinish
     * 		Finish the session once the activity is finished.
     * @param fillableIds
     * 		Views that might anchor FillUI.
     * @param saveTriggerId
     * 		View that when clicked triggers commit().
     */
    private void setTrackedViews(int sessionId, @android.annotation.Nullable
    android.view.autofill.AutofillId[] trackedIds, boolean saveOnAllViewsInvisible, boolean saveOnFinish, @android.annotation.Nullable
    android.view.autofill.AutofillId[] fillableIds, @android.annotation.Nullable
    android.view.autofill.AutofillId saveTriggerId) {
        ...
        synchronized(mLock) {
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((((((((((((((("setTrackedViews(): sessionId=" + sessionId) + ", trackedIds=") + java.util.Arrays.toString(trackedIds)) + ", saveOnAllViewsInvisible=") + saveOnAllViewsInvisible) + ", saveOnFinish=") + saveOnFinish) + ", fillableIds=") + java.util.Arrays.toString(fillableIds)) + ", saveTrigerId=") + saveTriggerId) + ", mFillableIds=") + mFillableIds) + ", mEnabled=") + mEnabled) + ", mSessionId=") + mSessionId);
            }
            if (mEnabled && (mSessionId == sessionId)) {
                if (saveOnAllViewsInvisible) {
                    mTrackedViews = new android.view.autofill.AutofillManager.TrackedViews(trackedIds);
                } else {
                    mTrackedViews = null;
                }
                ...
                if (fillableIds != null) {
                    if (mFillableIds == null) {
                        mFillableIds = new android.util.ArraySet(fillableIds.length);
                    }
                    for (android.view.autofill.AutofillId id : fillableIds) {
                        id.resetSessionId();
                        mFillableIds.add(id);
                    }
                }
    ...
    private void setNotifyOnClickLocked(@android.annotation.NonNull
    android.view.autofill.AutofillId id, boolean notify) {
        final android.view.View view = findView(id);
        if (view == null) {
            android.util.Log.w(android.view.autofill.AutofillManager.TAG, "setNotifyOnClick(): invalid id: " + id);
            return;
        }
    ...
    private void setSaveUiState(int sessionId, boolean shown) {
        if (android.view.autofill.Helper.sDebug)
            android.util.Log.d(android.view.autofill.AutofillManager.TAG, (("setSaveUiState(" + sessionId) + "): ") + shown);
        ...
        synchronized(mLock) {
            if (mSessionId != android.view.autofill.AutofillManager.NO_SESSION) {
                ...
                android.util.Log.w(android.view.autofill.AutofillManager.TAG, ((((("setSaveUiState(" + sessionId) + ", ") + shown) + ") called on existing session ") + mSessionId) + "; cancelling it");
                cancelSessionLocked();
            }
            if (shown) {
                mSessionId = sessionId;
                mState = android.view.autofill.AutofillManager.STATE_SHOWING_SAVE_UI;
            } else {
                mSessionId = android.view.autofill.AutofillManager.NO_SESSION;
                mState = android.view.autofill.AutofillManager.STATE_UNKNOWN;
            }
     ...
     *
     * @param newState
     * 		{@link #STATE_FINISHED} (because the autofill service returned a {@code null}
     ...
     * @param autofillableIds
     * 		list of ids that could trigger autofill, use to not handle a new
     * 		session when they're entered.
     */
    private void setSessionFinished(int newState, @android.annotation.Nullable
    java.util.List<android.view.autofill.AutofillId> autofillableIds) {
        ...
        synchronized(mLock) {
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("setSessionFinished(): from " + getStateAsStringLocked()) + " to ") + android.view.autofill.AutofillManager.getStateAsString(newState)) + "; autofillableIds=") + autofillableIds);
            }
            if (autofillableIds != null) {
                mEnteredIds = new android.util.ArraySet(autofillableIds);
            }
            if ((newState == android.view.autofill.AutofillManager.STATE_UNKNOWN_COMPAT_MODE) || (newState == android.view.autofill.AutofillManager.STATE_UNKNOWN_FAILED)) {
                /* resetEnteredIds= */
                resetSessionLocked(true);
                mState = android.view.autofill.AutofillManager.STATE_UNKNOWN;
            } else {
     ...
     */
    private void getAugmentedAutofillClient(@android.annotation.NonNull
    com.android.internal.os.IResultReceiver result) {
        synchronized(mLock) {
            if (mAugmentedAutofillServiceClient == null) {
                mAugmentedAutofillServiceClient = new android.view.autofill.AutofillManager.AugmentedAutofillManagerClient(this);
            }
            final android.os.Bundle resultData = new android.os.Bundle();
            resultData.putBinder(android.view.autofill.AutofillManager.EXTRA_AUGMENTED_AUTOFILL_CLIENT, mAugmentedAutofillServiceClient.asBinder());
            try {
                result.send(0, resultData);
            } catch (android.os.RemoteException e) {
                android.util.Log.w(android.view.autofill.AutofillManager.TAG, "Could not send AugmentedAutofillClient back: " + e);
            }
        }
    }
    ...
    private void requestHideFillUi(android.view.autofill.AutofillId id, boolean force) {
        final android.view.View anchor = (id == null) ? null : findView(id);
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("requestHideFillUi(" + id) + "): anchor = ") + anchor);
    ...
    private void requestHideFillUi(android.view.autofill.AutofillId id, android.view.View anchor) {
        android.view.autofill.AutofillManager.AutofillCallback callback = null;
        synchronized(mLock) {
        ...
        if (callback != null) {
            if (id.isVirtualInt()) {
                callback.onAutofillEvent(anchor, id.getVirtualChildIntId(), android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_HIDDEN);
            } else {
                callback.onAutofillEvent(anchor, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_HIDDEN);
            }
        }
    }

    private void notifyNoFillUi(int sessionId, android.view.autofill.AutofillId id, int sessionFinishedState) {
        if (android.view.autofill.Helper.sVerbose) {
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("notifyNoFillUi(): sessionId=" + sessionId) + ", autofillId=") + id) + ", sessionFinishedState=") + sessionFinishedState);
        }
        final android.view.View anchor = findView(id);
        if (anchor == null) {
            return;
        ...
        if (callback != null) {
            if (id.isVirtualInt()) {
                callback.onAutofillEvent(anchor, id.getVirtualChildIntId(), android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_UNAVAILABLE);
            } else {
                callback.onAutofillEvent(anchor, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_UNAVAILABLE);
            }
        }
        if (sessionFinishedState != android.view.autofill.AutofillManager.STATE_UNKNOWN) {
     ...
     *
     * @param autofillId
     * 		The autofill id of the view
     * @return The view or {@code null} if view was not found
     */
    private android.view.View findView(@android.annotation.NonNull
    android.view.autofill.AutofillId autofillId) {
        final android.view.autofill.AutofillManager.AutofillClient client = getClient();
        if (client != null) {
    ...
    public void onPendingSaveUi(int operation, android.os.IBinder token) {
        if (android.view.autofill.Helper.sVerbose)
            android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("onPendingSaveUi(" + operation) + "): ") + token);
     ...
     * @unknown 
     */
    public void dump(java.lang.String outerPrefix, java.io.PrintWriter pw) {
        pw.print(outerPrefix);
        pw.println("AutofillManager:");
        final java.lang.String pfx = outerPrefix + "  ";
        pw.print(pfx);
        pw.print("sessionId: ");
        ...
        if (mTrackedViews == null) {
            ...
            final java.lang.String pfx2 = pfx + "  ";
            pw.println();
            pw.print(pfx2);
            pw.print("visible:");
        ...
        synchronized(mLock) {
            if (mCompatibilityBridge != null) {
                ...
                pw.print(pfx2);
                pw.print("virtualId: ");
                pw.println(android.view.accessibility.AccessibilityNodeInfo.getVirtualDescendantId(mCompatibilityBridge.mFocusedNodeId));
                pw.print(pfx2);
        ...
        pw.print(pfx);
        pw.print("debug: ");
        pw.print(android.view.autofill.Helper.sDebug);
        pw.print(" verbose: ");
        pw.println(android.view.autofill.Helper.sVerbose);
    }

    @com.android.internal.annotations.GuardedBy("mLock")
    private java.lang.String getStateAsStringLocked() {
        return android.view.autofill.AutofillManager.getStateAsString(mState);
    }

    @android.annotation.NonNull
    private static java.lang.String getStateAsString(int state) {
        switch (state) {
            case android.view.autofill.AutofillManager.STATE_UNKNOWN :
                return "UNKNOWN";
            case android.view.autofill.AutofillManager.STATE_ACTIVE :
                return "ACTIVE";
            case android.view.autofill.AutofillManager.STATE_FINISHED :
                return "FINISHED";
            case android.view.autofill.AutofillManager.STATE_SHOWING_SAVE_UI :
                return "SHOWING_SAVE_UI";
            case android.view.autofill.AutofillManager.STATE_DISABLED_BY_SERVICE :
                return "DISABLED_BY_SERVICE";
            case android.view.autofill.AutofillManager.STATE_UNKNOWN_COMPAT_MODE :
                return "UNKNOWN_COMPAT_MODE";
            case android.view.autofill.AutofillManager.STATE_UNKNOWN_FAILED :
     ...
     * @unknown 
     */
    public static java.lang.String getSmartSuggestionModeToString(@android.view.autofill.AutofillManager.SmartSuggestionMode
    int flags) {
        switch (flags) {
            case android.view.autofill.AutofillManager.FLAG_SMART_SUGGESTION_OFF :
                return "OFF";
            case android.view.autofill.AutofillManager.FLAG_SMART_SUGGESTION_SYSTEM :
                return "SYSTEM";
            default :
    ...
    private boolean isActiveLocked() {
        return mState == android.view.autofill.AutofillManager.STATE_ACTIVE;
    }

    @com.android.internal.annotations.GuardedBy("mLock")
    private boolean isDisabledByServiceLocked() {
        return mState == android.view.autofill.AutofillManager.STATE_DISABLED_BY_SERVICE;
    }

    @com.android.internal.annotations.GuardedBy("mLock")
    private boolean isFinishedLocked() {
        return mState == android.view.autofill.AutofillManager.STATE_FINISHED;
    }
    ...
    private void post(java.lang.Runnable runnable) {
        ...
        if (client == null) {
            if (android.view.autofill.Helper.sVerbose)
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, "ignoring post() because client is null");
    ...
    private final class CompatibilityBridge implements android.view.accessibility.AccessibilityManager.AccessibilityPolicy {
        ...
        @com.android.internal.annotations.GuardedBy("mLock")
        private int mFocusedWindowId = android.view.accessibility.AccessibilityWindowInfo.UNDEFINED_WINDOW_ID;
        ...
        CompatibilityBridge() {
            final android.view.accessibility.AccessibilityManager am = android.view.accessibility.AccessibilityManager.getInstance(mContext);
        ...
        private android.accessibilityservice.AccessibilityServiceInfo getCompatServiceInfo() {
            synchronized(mLock) {
                ...
                final android.content.pm.ResolveInfo resolveInfo = mContext.getPackageManager().resolveService(intent, android.content.pm.PackageManager.MATCH_SYSTEM_ONLY | android.content.pm.PackageManager.GET_META_DATA);
                try {
                    mCompatServiceInfo = new android.accessibilityservice.AccessibilityServiceInfo(resolveInfo, mContext);
                } catch (org.xmlpull.v1.XmlPullParserException | java.io.IOException e) {
                    android.util.Log.e(android.view.autofill.AutofillManager.TAG, "Cannot find compat autofill service:" + intent);
        ...
        public int getRelevantEventTypes(int relevantEventTypes) {
            return (((relevantEventTypes | android.view.accessibility.AccessibilityEvent.TYPE_VIEW_FOCUSED) | android.view.accessibility.AccessibilityEvent.TYPE_VIEW_TEXT_CHANGED) | android.view.accessibility.AccessibilityEvent.TYPE_VIEW_CLICKED) | android.view.accessibility.AccessibilityEvent.TYPE_WINDOW_CONTENT_CHANGED;
        }

        @java.lang.Override
        public java.util.List<android.accessibilityservice.AccessibilityServiceInfo> getInstalledAccessibilityServiceList(java.util.List<android.accessibilityservice.AccessibilityServiceInfo> installedServices) {
            if (installedServices == null) {
                installedServices = new java.util.ArrayList();
            }
        ...
        @java.lang.Override
        public java.util.List<android.accessibilityservice.AccessibilityServiceInfo> getEnabledAccessibilityServiceList(int feedbackTypeFlags, java.util.List<android.accessibilityservice.AccessibilityServiceInfo> enabledService) {
            if (enabledService == null) {
                enabledService = new java.util.ArrayList();
            }
        ...
        @java.lang.Override
        public android.view.accessibility.AccessibilityEvent onAccessibilityEvent(android.view.accessibility.AccessibilityEvent event, boolean accessibilityEnabled, int relevantEventTypes) {
            final int type = event.getEventType();
            if (android.view.autofill.Helper.sVerbose) {
                // NOTE: this is waaay spammy, but that's life.
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, (((("onAccessibilityEvent(" + android.view.accessibility.AccessibilityEvent.eventTypeToString(type)) + "): virtualId=") + android.view.accessibility.AccessibilityNodeInfo.getVirtualDescendantId(event.getSourceNodeId())) + ", client=") + getClient());
            }
            switch (type) {
                case android.view.accessibility.AccessibilityEvent.TYPE_VIEW_FOCUSED :
                    {
                        synchronized(mLock) {
                            ...
                            if ((mFocusedWindowId != android.view.accessibility.AccessibilityWindowInfo.UNDEFINED_WINDOW_ID) && (mFocusedNodeId != android.view.accessibility.AccessibilityNodeInfo.UNDEFINED_NODE_ID)) {
                                notifyViewExited(mFocusedWindowId, mFocusedNodeId);
                                mFocusedWindowId = android.view.accessibility.AccessibilityWindowInfo.UNDEFINED_WINDOW_ID;
                                mFocusedNodeId = android.view.accessibility.AccessibilityNodeInfo.UNDEFINED_NODE_ID;
        ...
        private boolean notifyViewEntered(int windowId, long nodeId, android.graphics.Rect focusedBounds) {
            final int virtualId = android.view.accessibility.AccessibilityNodeInfo.getVirtualDescendantId(nodeId);
            if (!isVirtualNode(virtualId)) {
                return false;
            }
            final android.view.View view = findViewByAccessibilityId(windowId, nodeId);
            if (view == null) {
                return false;
            }
            final android.view.accessibility.AccessibilityNodeInfo node = findVirtualNodeByAccessibilityId(view, virtualId);
            if (node == null) {
                return false;
            }
            if (!node.isEditable()) {
            ...
            final android.graphics.Rect newBounds = mTempBounds;
            node.getBoundsInScreen(newBounds);
            if (newBounds.equals(focusedBounds)) {
                return false;
            }
            focusedBounds.set(newBounds);
            android.view.autofill.AutofillManager.this.notifyViewEntered(view, virtualId, newBounds);
            return true;
        }
        ...
        private void notifyViewExited(int windowId, long nodeId) {
            ...
            android.view.autofill.AutofillManager.this.notifyViewExited(view, virtualId);
        }
        ...
        private void notifyValueChanged(int windowId, long nodeId) {
            ...
            android.view.autofill.AutofillManager.this.notifyValueChanged(view, virtualId, android.view.autofill.AutofillValue.forText(node.getText()));
        }
        ...
        private void notifyViewClicked(int windowId, long nodeId) {
            ...
            android.view.autofill.AutofillManager.this.notifyViewClicked(view, virtualId);
        }
        ...
        private android.view.View findViewByAccessibilityId(int windowId, long nodeId) {
            final android.view.autofill.AutofillManager.AutofillClient client = getClient();
            if (client == null) {
                return null;
            }
            final int viewId = android.view.accessibility.AccessibilityNodeInfo.getAccessibilityViewId(nodeId);
            return client.autofillClientFindViewByAccessibilityIdTraversal(viewId, windowId);
        }

        private android.view.accessibility.AccessibilityNodeInfo findVirtualNodeByAccessibilityId(android.view.View view, int virtualId) {
            final android.view.accessibility.AccessibilityNodeProvider provider = view.getAccessibilityNodeProvider();
            if (provider == null) {
                return null;
            }
        ...
        private boolean isVirtualNode(int nodeId) {
            return (nodeId != android.view.accessibility.AccessibilityNodeProvider.HOST_VIEW_ID) && (nodeId != android.view.accessibility.AccessibilityNodeInfo.UNDEFINED_ITEM_ID);
        }
    }
    ...
    private class TrackedViews {
         ...
         *
         * @param set
         * 		The set or null (== empty set)
         * @param value
         * 		The value that might be in the set
         * @return {@code true} iff set is not empty and value is in set
         */
        // TODO: move to Helper as static method
        private <T> boolean isInSet(@android.annotation.Nullable
        android.util.ArraySet<T> set, T value) {
        ...
        // TODO: move to Helper as static method
        @android.annotation.NonNull
        private <T> android.util.ArraySet<T> addToSet(@android.annotation.Nullable
        android.util.ArraySet<T> set, T valueToAdd) {
            if (set == null) {
                set = new android.util.ArraySet(1);
            }
            set.add(valueToAdd);
            return set;
        }
        ...
        // TODO: move to Helper as static method
        @android.annotation.Nullable
        private <T> android.util.ArraySet<T> removeFromSet(@android.annotation.Nullable
        android.util.ArraySet<T> set, T valueToRemove) {
            if (set == null) {
                return null;
            }
         ...
         * 		The views to be tracked
         */
        TrackedViews(@android.annotation.Nullable
        android.view.autofill.AutofillId[] trackedIds) {
            final android.view.autofill.AutofillManager.AutofillClient client = getClient();
            if ((!com.android.internal.util.ArrayUtils.isEmpty(trackedIds)) && (client != null)) {
                final boolean[] isVisible;
                if (client.autofillClientIsVisibleForAutofill()) {
                    if (android.view.autofill.Helper.sVerbose)
                        android.util.Log.v(android.view.autofill.AutofillManager.TAG, "client is visible, check tracked ids");
                ...
                for (int i = 0; i < numIds; i++) {
                    final android.view.autofill.AutofillId id = trackedIds[i];
                    id.resetSessionId();
                    if (isVisible[i]) {
            ...
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, ((((("TrackedViews(trackedIds=" + java.util.Arrays.toString(trackedIds)) + "): ") + " mVisibleTrackedIds=") + mVisibleTrackedIds) + " mInvisibleTrackedIds=") + mInvisibleTrackedIds);
            }
         ...
         *
         * @param id
         * 		the id of the view/virtual view whose visibility changed.
         * @param isVisible
         * 		visible if the view is visible in the view hierarchy.
         */
        @com.android.internal.annotations.GuardedBy("mLock")
        void notifyViewVisibilityChangedLocked(@android.annotation.NonNull
        android.view.autofill.AutofillId id, boolean isVisible) {
            if (android.view.autofill.Helper.sDebug) {
                android.util.Log.d(android.view.autofill.AutofillManager.TAG, (("notifyViewVisibilityChangedLocked(): id=" + id) + " isVisible=") + isVisible);
            }
            ...
            if (mVisibleTrackedIds == null) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "No more visible ids. Invisibile = " + mInvisibleTrackedIds);
                }
                finishSessionLocked();
            }
        }
        ...
        void onVisibleForAutofillChangedLocked() {
            ...
            android.view.autofill.AutofillManager.AutofillClient client = getClient();
            android.util.ArraySet<android.view.autofill.AutofillId> updatedVisibleTrackedIds = null;
            android.util.ArraySet<android.view.autofill.AutofillId> updatedInvisibleTrackedIds = null;
            if (client != null) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("onVisibleForAutofillChangedLocked(): inv= " + mInvisibleTrackedIds) + " vis=") + mVisibleTrackedIds);
                }
                if (mInvisibleTrackedIds != null) {
                    final java.util.ArrayList<android.view.autofill.AutofillId> orderedInvisibleIds = new java.util.ArrayList(mInvisibleTrackedIds);
                    final boolean[] isVisible = client.autofillClientGetViewVisibility(android.view.autofill.Helper.toArray(orderedInvisibleIds));
                    final int numInvisibleTrackedIds = orderedInvisibleIds.size();
                    for (int i = 0; i < numInvisibleTrackedIds; i++) {
                        final android.view.autofill.AutofillId id = orderedInvisibleIds.get(i);
                        if (isVisible[i]) {
                            updatedVisibleTrackedIds = addToSet(updatedVisibleTrackedIds, id);
                            if (android.view.autofill.Helper.sDebug) {
                                android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("onVisibleForAutofill() " + id) + " became visible");
                            }
                        } else {
                ...
                if (mVisibleTrackedIds != null) {
                    final java.util.ArrayList<android.view.autofill.AutofillId> orderedVisibleIds = new java.util.ArrayList(mVisibleTrackedIds);
                    final boolean[] isVisible = client.autofillClientGetViewVisibility(android.view.autofill.Helper.toArray(orderedVisibleIds));
                    final int numVisibleTrackedIds = orderedVisibleIds.size();
                    for (int i = 0; i < numVisibleTrackedIds; i++) {
                        final android.view.autofill.AutofillId id = orderedVisibleIds.get(i);
                        if (isVisible[i]) {
                            updatedVisibleTrackedIds = addToSet(updatedVisibleTrackedIds, id);
                        } else {
                            updatedInvisibleTrackedIds = addToSet(updatedInvisibleTrackedIds, id);
                            if (android.view.autofill.Helper.sDebug) {
                                android.util.Log.d(android.view.autofill.AutofillManager.TAG, ("onVisibleForAutofill() " + id) + " became invisible");
                            }
                        }
                    }
                }
            ...
            if (mVisibleTrackedIds == null) {
                if (android.view.autofill.Helper.sVerbose) {
                    android.util.Log.v(android.view.autofill.AutofillManager.TAG, "onVisibleForAutofillChangedLocked(): no more visible ids");
                }
                finishSessionLocked();
            }
        }
    ...
    public static abstract class AutofillCallback {
         ...
         * @unknown 
         */
        @android.annotation.IntDef(prefix = { "EVENT_INPUT_" }, value = { android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_SHOWN, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_HIDDEN, android.view.autofill.AutofillManager.AutofillCallback.EVENT_INPUT_UNAVAILABLE })
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
         ...
         * @param event
         * 		currently either {@link #EVENT_INPUT_SHOWN} or {@link #EVENT_INPUT_HIDDEN}.
         */
        public void onAutofillEvent(@android.annotation.NonNull
        android.view.View view, @android.view.autofill.AutofillManager.AutofillCallback.AutofillEventType
        int event) {
        }
         ...
         */
        public void onAutofillEvent(@android.annotation.NonNull
        android.view.View view, int virtualId, @android.view.autofill.AutofillManager.AutofillCallback.AutofillEventType
        int event) {
        }
    }
    ...
    private static final class AutofillManagerClient extends android.view.autofill.IAutoFillManagerClient.Stub {
        ...
        private AutofillManagerClient(android.view.autofill.AutofillManager autofillManager) {
            mAfm = new java.lang.ref.WeakReference<>(autofillManager);
        }

        @java.lang.Override
        public void setState(int flags) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void autofill(int sessionId, java.util.List<android.view.autofill.AutofillId> ids, java.util.List<android.view.autofill.AutofillValue> values) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void authenticate(int sessionId, int authenticationId, android.content.IntentSender intent, android.content.Intent fillInIntent) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void requestShowFillUi(int sessionId, android.view.autofill.AutofillId id, int width, int height, android.graphics.Rect anchorBounds, android.view.autofill.IAutofillWindowPresenter presenter) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
                afm.post(() -> afm.requestShowFillUi(sessionId, id, width, height, anchorBounds, presenter));
            }
        }

        @java.lang.Override
        public void requestHideFillUi(int sessionId, android.view.autofill.AutofillId id) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void notifyNoFillUi(int sessionId, android.view.autofill.AutofillId id, int sessionFinishedState) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void dispatchUnhandledKey(int sessionId, android.view.autofill.AutofillId id, android.view.KeyEvent fullScreen) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
            ...
            if (afm != null) {
                afm.post(() -> {
                    try {
                        ...
                        android.util.Log.e(android.view.autofill.AutofillManager.TAG, "startIntentSender() failed for intent:" + intentSender, e);
                    }
                });
            }
        }
        ...
        @java.lang.Override
        public void setTrackedViews(int sessionId, android.view.autofill.AutofillId[] ids, boolean saveOnAllViewsInvisible, boolean saveOnFinish, android.view.autofill.AutofillId[] fillableIds, android.view.autofill.AutofillId saveTriggerId) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void setSessionFinished(int newState, java.util.List<android.view.autofill.AutofillId> autofillableIds) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
        ...
        @java.lang.Override
        public void getAugmentedAutofillClient(com.android.internal.os.IResultReceiver result) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm != null) {
    ...
    private static final class AugmentedAutofillManagerClient extends android.view.autofill.IAugmentedAutofillManagerClient.Stub {
        ...
        @java.lang.Override
        public android.graphics.Rect getViewCoordinates(@android.annotation.NonNull
        android.view.autofill.AutofillId id) {
            final android.view.autofill.AutofillManager afm = mAfm.get();
            if (afm == null)
                return null;

            final android.view.autofill.AutofillManager.AutofillClient client = afm.getClient();
            if (client == null) {
                android.util.Log.w(android.view.autofill.AutofillManager.TAG, ("getViewCoordinates(" + id) + "): no autofill client");
                return null;
            }
            final android.view.View view = client.autofillClientFindViewByAutofillIdTraversal(id);
            if (view == null) {
                android.util.Log.w(android.view.autofill.AutofillManager.TAG, ("getViewCoordinates(" + id) + "): could not find view");
                return null;
            }
            final android.graphics.Rect windowVisibleDisplayFrame = new android.graphics.Rect();
            view.getWindowVisibleDisplayFrame(windowVisibleDisplayFrame);
            final int[] location = new int[2];
            view.getLocationOnScreen(location);
            final android.graphics.Rect rect = new android.graphics.Rect(location[0], location[1] - windowVisibleDisplayFrame.top, location[0] + view.getWidth(), (location[1] - windowVisibleDisplayFrame.top) + view.getHeight());
            if (android.view.autofill.Helper.sVerbose) {
                android.util.Log.v(android.view.autofill.AutofillManager.TAG, (("Coordinates for " + id) + ": ") + rect);
            }
            return rect;
        }
