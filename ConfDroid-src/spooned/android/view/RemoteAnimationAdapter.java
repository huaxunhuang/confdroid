...
public class RemoteAnimationAdapter implements android.os.Parcelable {
     ...
     *
     * @param runner
     * 		The interface that gets notified when we actually need to start the animation.
     * @param duration
     * 		The duration of the animation.
     * @param changeNeedsSnapshot
     * 		For change transitions, whether this should create a snapshot by
     * 		screenshotting the task.
     * @param statusBarTransitionDelay
     * 		The desired delay for all visual animations in the
     * 		status bar caused by this app animation in millis.
     */
    @android.annotation.UnsupportedAppUsage
    public RemoteAnimationAdapter(android.view.IRemoteAnimationRunner runner, long duration, long statusBarTransitionDelay, boolean changeNeedsSnapshot) {
        mRunner = runner;
        mDuration = duration;
    ...
    @android.annotation.UnsupportedAppUsage
    public RemoteAnimationAdapter(android.view.IRemoteAnimationRunner runner, long duration, long statusBarTransitionDelay) {
        /* changeNeedsSnapshot */
        this(runner, duration, statusBarTransitionDelay, false);
    }

    public RemoteAnimationAdapter(android.os.Parcel in) {
    ...
    public static final android.view.Creator<android.view.RemoteAnimationAdapter> CREATOR = new android.view.Creator<android.view.RemoteAnimationAdapter>() {
        public android.view.RemoteAnimationAdapter createFromParcel(android.os.Parcel in) {
            return new android.view.RemoteAnimationAdapter(in);
        }

        public android.view.RemoteAnimationAdapter[] newArray(int size) {
            return new android.view.RemoteAnimationAdapter[size];
        }
    };
}
