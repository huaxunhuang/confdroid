...
public final class WindowInsetsAnimation {
     ...
     *
     * @param typeMask
     * 		The bitmask of {@link WindowInsets.Type}s that are animating.
     * @param interpolator
     ...
     */
    public WindowInsetsAnimation(@android.view.WindowInsets.Type.InsetsType
    int typeMask, @android.annotation.Nullable
    android.view.animation.Interpolator interpolator, long durationMillis) {
        mTypeMask = typeMask;
     ...
     */
    @android.annotation.FloatRange(from = 0.0F, to = 1.0F)
     ...
     *
     * @param fraction
     * 		fractional progress between 0 and 1 where 0 represents hidden and
     * 		zero progress and 1 represent fully shown final state.
     * @see #getFraction()
     */
    public void setFraction(@android.annotation.FloatRange(from = 0.0F, to = 1.0F)
    float fraction) {
        mFraction = fraction;
    }
     ...
     * @see #getAlpha()
     */
    public void setAlpha(@android.annotation.FloatRange(from = 0.0F, to = 1.0F)
    float alpha) {
        mAlpha = alpha;
    }
    ...
    public static final class Bounds {
        ...
        public Bounds(@android.annotation.NonNull
        android.graphics.Insets lowerBound, @android.annotation.NonNull
         ...
         */
        @android.annotation.NonNull
        public android.view.WindowInsetsAnimation.Bounds inset(@android.annotation.NonNull
        android.graphics.Insets insets) {
            return // TODO: refactor so that WindowInsets.insetInsets() is in a more appropriate
            // place eventually.
            new android.view.WindowInsetsAnimation.Bounds(android.view.WindowInsets.insetInsets(mLowerBound, insets.left, insets.top, insets.right, insets.bottom), android.view.WindowInsets.insetInsets(mUpperBound, insets.left, insets.top, insets.right, insets.bottom));
        }
     ...
     * insets.
     */
    // TODO(b/149430296) Should be on method, not class.
    ...
    public static abstract class Callback {
         ...
         * @unknown 
         */
        @android.annotation.IntDef(prefix = { "DISPATCH_MODE_" }, value = { android.view.WindowInsetsAnimation.Callback.DISPATCH_MODE_STOP, android.view.WindowInsetsAnimation.Callback.DISPATCH_MODE_CONTINUE_ON_SUBTREE })
         ...
         *
         * @param dispatchMode
         * 		The dispatch mode for this callback. See {@link #getDispatchMode()}.
         */
        public Callback(@android.view.WindowInsetsAnimation.Callback.DispatchMode
        int dispatchMode) {
        ...
        dispatching.
         */
        // TODO(b/149430296) False positive: not a callback.
        @android.view.WindowInsetsAnimation.Callback.DispatchMode
        @android.annotation.SuppressLint("CallbackMethodName")
         ...
         */
        public void onPrepare(@android.annotation.NonNull
         ...
         */
        @android.annotation.NonNull
        public android.view.WindowInsetsAnimation.Bounds onStart(@android.annotation.NonNull
         ...
         * @param insets
         * 		The current insets.
         * @param runningAnimations
         * 		The currently running animations.
         * @return The insets to dispatch to the subtree of the hierarchy.
         */
        @android.annotation.NonNull
        public abstract android.view.WindowInsets onProgress(@android.annotation.NonNull
         ...
         */
        public void onEnd(@android.annotation.NonNull
        android.view.WindowInsetsAnimation animation) {
        }
    }
}
