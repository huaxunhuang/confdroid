 ...
 */
public class EditorInfo implements android.os.Parcelable , android.text.InputType {
    /**
     ...
     */
    public static final int IME_MASK_ACTION = 0xff;
     ...
     * it can.
     */
    public static final int IME_ACTION_UNSPECIFIED = 0x0;

    /**
     * Bits of {@link #IME_MASK_ACTION}: there is no available action.
     */
    public static final int IME_ACTION_NONE = 0x1;
     ...
     */
    public static final int IME_ACTION_GO = 0x2;
     ...
     */
    public static final int IME_ACTION_SEARCH = 0x3;
     ...
     */
    public static final int IME_ACTION_SEND = 0x4;

    /**
     * Bits of {@link #IME_MASK_ACTION}: the action key performs a "next"
     * operation, taking the user to the next field that will accept text.
     */
    public static final int IME_ACTION_NEXT = 0x5;
     ...
     * IME will be closed.
     */
    public static final int IME_ACTION_DONE = 0x6;
     ...
     */
    public static final int IME_ACTION_PREVIOUS = 0x7;
     ...
     */
    public static final int IME_NULL = 0x0;
     ...
     * integrate with it.
     */
    public int imeOptions = android.view.inputmethod.EditorInfo.IME_NULL;
    ...
    public void dump(android.util.Printer pw, java.lang.String prefix) {
        pw.println((((((prefix + "inputType=0x") + java.lang.Integer.toHexString(inputType)) + " imeOptions=0x") + java.lang.Integer.toHexString(imeOptions)) + " privateImeOptions=") + privateImeOptions);
        pw.println((((prefix + "actionLabel=") + actionLabel) + " actionId=") + actionId);
        pw.println((((((prefix + "initialSelStart=") + initialSelStart) + " initialSelEnd=") + initialSelEnd) + " initialCapsMode=0x") + java.lang.Integer.toHexString(initialCapsMode));
        ...
        pw.println((prefix + "contentMimeTypes=") + java.util.Arrays.toString(contentMimeTypes));
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.text.TextUtils.writeToParcel(actionLabel, dest, flags);
        dest.writeInt(actionId);
        dest.writeInt(initialSelStart);
        dest.writeInt(initialSelEnd);
        dest.writeInt(initialCapsMode);
        android.text.TextUtils.writeToParcel(hintText, dest, flags);
        android.text.TextUtils.writeToParcel(label, dest, flags);
        ...
        android.os.UserHandle.writeToParcel(targetInputMethodUser, dest);
    }
    ...
    public static final android.os.Parcelable.Creator<android.view.inputmethod.EditorInfo> CREATOR = new android.os.Parcelable.Creator<android.view.inputmethod.EditorInfo>() {
        public android.view.inputmethod.EditorInfo createFromParcel(android.os.Parcel source) {
            android.view.inputmethod.EditorInfo res = new android.view.inputmethod.EditorInfo();
            ...
            android.os.LocaleList hintLocales = LocaleList.CREATOR.createFromParcel(source);
            res.hintLocales = (hintLocales.isEmpty()) ? null : hintLocales;
            res.contentMimeTypes = source.readStringArray();
            res.targetInputMethodUser = android.os.UserHandle.readFromParcel(source);
            return res;
        }

        public android.view.inputmethod.EditorInfo[] newArray(int size) {
            return new android.view.inputmethod.EditorInfo[size];
        }
    };
