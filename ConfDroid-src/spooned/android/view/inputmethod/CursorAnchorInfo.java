...
public final class CursorAnchorInfo implements android.os.Parcelable {
     ...
     */
    public static final int FLAG_HAS_VISIBLE_REGION = 0x1;

    /**
     * Flag for {@link #getInsertionMarkerFlags()} and {@link #getCharacterBoundsFlags(int)}: the
     * insertion marker or character bounds have at least one invisible (clipped) region.
     */
    public static final int FLAG_HAS_INVISIBLE_REGION = 0x2;

    /**
     * Flag for {@link #getInsertionMarkerFlags()} and {@link #getCharacterBoundsFlags(int)}: the
     * insertion marker or character bounds is placed at right-to-left (RTL) character.
     */
    public static final int FLAG_IS_RTL = 0x4;

    public CursorAnchorInfo(final android.os.Parcel source) {
        ...
        mCharacterBoundsArray = source.readParcelable(android.view.inputmethod.SparseRectFArray.class.getClassLoader());
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.text.TextUtils.writeToParcel(mComposingText, dest, flags);
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        final android.view.inputmethod.CursorAnchorInfo that = ((android.view.inputmethod.CursorAnchorInfo) (obj));
        ...
        if (((((mInsertionMarkerFlags != that.mInsertionMarkerFlags) || (!android.view.inputmethod.CursorAnchorInfo.areSameFloatImpl(mInsertionMarkerHorizontal, that.mInsertionMarkerHorizontal))) || (!android.view.inputmethod.CursorAnchorInfo.areSameFloatImpl(mInsertionMarkerTop, that.mInsertionMarkerTop))) || (!android.view.inputmethod.CursorAnchorInfo.areSameFloatImpl(mInsertionMarkerBaseline, that.mInsertionMarkerBaseline))) || (!android.view.inputmethod.CursorAnchorInfo.areSameFloatImpl(mInsertionMarkerBottom, that.mInsertionMarkerBottom))) {
            return false;
        }
        if (!java.util.Objects.equals(mCharacterBoundsArray, that.mCharacterBoundsArray)) {
            return false;
        }
        // Following fields are (partially) covered by hashCode().
        if ((mComposingTextStart != that.mComposingTextStart) || (!java.util.Objects.equals(mComposingText, that.mComposingText))) {
            return false;
        }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((((((((("CursorAnchorInfo{mHashCode=" + mHashCode) + " mSelection=") + mSelectionStart) + ",") + mSelectionEnd) + " mComposingTextStart=") + mComposingTextStart) + " mComposingText=") + java.util.Objects.toString(mComposingText)) + " mInsertionMarkerFlags=") + mInsertionMarkerFlags) + " mInsertionMarkerHorizontal=") + mInsertionMarkerHorizontal) + " mInsertionMarkerTop=") + mInsertionMarkerTop) + " mInsertionMarkerBaseline=") + mInsertionMarkerBaseline) + " mInsertionMarkerBottom=") + mInsertionMarkerBottom) + " mCharacterBoundsArray=") + java.util.Objects.toString(mCharacterBoundsArray)) + " mMatrix=") + java.util.Arrays.toString(mMatrixValues)) + "}";
    }
    ...
    public static final class Builder {
        ...
        private float mInsertionMarkerHorizontal = java.lang.Float.NaN;

        private float mInsertionMarkerTop = java.lang.Float.NaN;

        private float mInsertionMarkerBaseline = java.lang.Float.NaN;

        private float mInsertionMarkerBottom = java.lang.Float.NaN;
         ...
         * selection.
         */
        public android.view.inputmethod.CursorAnchorInfo.Builder setSelectionRange(final int newStart, final int newEnd) {
         ...
         */
        public android.view.inputmethod.CursorAnchorInfo.Builder setComposingText(final int composingTextStart, final java.lang.CharSequence composingText) {
            mComposingTextStart = composingTextStart;
            if (composingText == null) {
                mComposingText = null;
            } else {
                // Make a snapshot of the given char sequence.
                mComposingText = new android.text.SpannedString(composingText);
            }
            return this;
        }
         ...
         * @param flags
         * 		flags of the insertion marker. See {@link #FLAG_HAS_VISIBLE_REGION} for
         * 		example.
         */
        public android.view.inputmethod.CursorAnchorInfo.Builder setInsertionMarkerLocation(final float horizontalPosition, final float lineTop, final float lineBaseline, final float lineBottom, final int flags) {
         ...
         * @param flags
         * 		flags for this character bounds. See {@link #FLAG_HAS_VISIBLE_REGION},
         ...
         */
        public android.view.inputmethod.CursorAnchorInfo.Builder addCharacterBounds(final int index, final float left, final float top, final float right, final float bottom, final int flags) {
            if (index < 0) {
                throw new java.lang.IllegalArgumentException("index must not be a negative integer.");
            }
            if (mCharacterBoundsArrayBuilder == null) {
                mCharacterBoundsArrayBuilder = new android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder();
            }
         ...
         */
        public android.view.inputmethod.CursorAnchorInfo.Builder setMatrix(final android.graphics.Matrix matrix) {
            if (mMatrixValues == null) {
                mMatrixValues = new float[9];
            }
            (matrix != null ? matrix : android.graphics.Matrix.IDENTITY_MATRIX).getValues(mMatrixValues);
        ...
        public android.view.inputmethod.CursorAnchorInfo build() {
            if (!mMatrixInitialized) {
                ...
                if ((((hasCharacterBounds || (!java.lang.Float.isNaN(mInsertionMarkerHorizontal))) || (!java.lang.Float.isNaN(mInsertionMarkerTop))) || (!java.lang.Float.isNaN(mInsertionMarkerBaseline))) || (!java.lang.Float.isNaN(mInsertionMarkerBottom))) {
        ...
        public void reset() {
            ...
            mInsertionMarkerHorizontal = java.lang.Float.NaN;
            mInsertionMarkerTop = java.lang.Float.NaN;
            mInsertionMarkerBaseline = java.lang.Float.NaN;
            mInsertionMarkerBottom = java.lang.Float.NaN;
    ...
    private static android.view.inputmethod.CursorAnchorInfo create(android.view.inputmethod.CursorAnchorInfo.Builder builder) {
        final android.view.inputmethod.SparseRectFArray characterBoundsArray = (builder.mCharacterBoundsArrayBuilder != null) ? builder.mCharacterBoundsArrayBuilder.build() : null;
        final float[] matrixValues = new float[9];
        if (builder.mMatrixInitialized) {
            java.lang.System.arraycopy(builder.mMatrixValues, 0, matrixValues, 0, 9);
        } else {
            android.graphics.Matrix.IDENTITY_MATRIX.getValues(matrixValues);
        }
    ...
    private CursorAnchorInfo(int selectionStart, int selectionEnd, int composingTextStart, @android.annotation.Nullable
    java.lang.CharSequence composingText, int insertionMarkerFlags, float insertionMarkerHorizontal, float insertionMarkerTop, float insertionMarkerBaseline, float insertionMarkerBottom, @android.annotation.Nullable
    android.view.inputmethod.SparseRectFArray characterBoundsArray, @android.annotation.NonNull
    float[] matrixValues) {
        ...
        int hashCode = java.util.Objects.hashCode(mComposingText);
        hashCode *= 31;
        hashCode += java.util.Arrays.hashCode(matrixValues);
        mHashCode = hashCode;
    }
     ...
     *
     * @param original
     * 		{@link CursorAnchorInfo} to be cloned from.
     * @param parentMatrix
     * 		{@link Matrix} to be applied to {@code original.getMatrix()}
     ...
     * @unknown 
     */
    public static android.view.inputmethod.CursorAnchorInfo createForAdditionalParentMatrix(android.view.inputmethod.CursorAnchorInfo original, @android.annotation.NonNull
    android.graphics.Matrix parentMatrix) {
        return new android.view.inputmethod.CursorAnchorInfo(original.mSelectionStart, original.mSelectionEnd, original.mComposingTextStart, original.mComposingText, original.mInsertionMarkerFlags, original.mInsertionMarkerHorizontal, original.mInsertionMarkerTop, original.mInsertionMarkerBaseline, original.mInsertionMarkerBottom, original.mCharacterBoundsArray, android.view.inputmethod.CursorAnchorInfo.computeMatrixValues(parentMatrix, original));
    }
     ...
     *
     * @param parentMatrix
     * 		{@link Matrix} to be multiplied.
     * @param info
     * 		{@link CursorAnchorInfo} to provide {@link Matrix} to be multiplied.
     * @return {@code parentMatrix * info.getMatrix()}.
     */
    private static float[] computeMatrixValues(@android.annotation.NonNull
    android.graphics.Matrix parentMatrix, @android.annotation.NonNull
    android.view.inputmethod.CursorAnchorInfo info) {
        if (parentMatrix.isIdentity()) {
            return info.mMatrixValues;
        }
        final android.graphics.Matrix newMatrix = new android.graphics.Matrix();
     ...
     */
    public android.graphics.RectF getCharacterBounds(final int index) {
     ...
     */
    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.view.inputmethod.CursorAnchorInfo> CREATOR = new android.os.Parcelable.Creator<android.view.inputmethod.CursorAnchorInfo>() {
        @java.lang.Override
        public android.view.inputmethod.CursorAnchorInfo createFromParcel(android.os.Parcel source) {
            return new android.view.inputmethod.CursorAnchorInfo(source);
        }

        @java.lang.Override
        public android.view.inputmethod.CursorAnchorInfo[] newArray(int size) {
            return new android.view.inputmethod.CursorAnchorInfo[size];
        }
    };
