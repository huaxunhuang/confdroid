...
public interface InputMethod {
     ...
     *
     * @param token
     * 		special token for the system to identify
     * 		{@link InputMethodService}
     * @param displayId
     * 		The id of the display that current IME shown.
     * 		Used for {{@link #updateInputMethodDisplay(int)}}
     * @param privilegedOperations
     * 		IPC endpoint to do some privileged
     * 		operations that are allowed only to the
     * 		current IME.
     * @unknown 
     */
    @android.annotation.MainThread
    default void initializeInternal(android.os.IBinder token, int displayId, com.android.internal.inputmethod.IInputMethodPrivilegedOperations privilegedOperations) {
     ...
     *
     * @param displayId
     * 		The id of the display that need to update for context.
     * @unknown 
     */
    @android.annotation.MainThread
     ...
     *
     * @param inputConnection
     * 		optional specific input connection for communicating with the text
     ...
     * @param restarting
     * 		{@code false} if this corresponds to
     * 		{@link #startInput(InputConnection, EditorInfo)}. Otherwise this
     * 		corresponds to {@link #restartInput(InputConnection, EditorInfo)}.
     * @param startInputToken
     * 		a token that identifies a logical session that starts with this method
     * 		call. Some internal IPCs such as {@link InputMethodManager#setImeWindowStatus(IBinder, IBinder, int, int)}
     ...
     */
    @android.annotation.MainThread
    default void dispatchStartInputWithToken(@android.annotation.Nullable
    android.view.inputmethod.InputConnection inputConnection, @android.annotation.NonNull
    android.view.inputmethod.EditorInfo editorInfo, boolean restarting, @android.annotation.NonNull
    android.os.IBinder startInputToken, boolean shouldPreRenderIme) {
        if (restarting) {
     ...
     *
     * @param session
     * 		The {@link InputMethodSession} previously provided through
     ...
     * in the UI.
     */
    public static final int SHOW_EXPLICIT = 0x1;
