...
public final class CompletionInfo implements android.os.Parcelable {
     ...
     * 		completions list.
     */
    public CompletionInfo(long id, int index, java.lang.CharSequence text, java.lang.CharSequence label) {
        mId = id;
        mPosition = index;
        mText = text;
        mLabel = label;
    ...
    public java.lang.String toString() {
        return ((((((("CompletionInfo{#" + mPosition) + " \"") + mText) + "\" id=") + mId) + " label=") + mLabel) + "}";
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.text.TextUtils.writeToParcel(mText, dest, flags);
    ...
    public static final android.os.Parcelable.Creator<android.view.inputmethod.CompletionInfo> CREATOR = new android.os.Parcelable.Creator<android.view.inputmethod.CompletionInfo>() {
        public android.view.inputmethod.CompletionInfo createFromParcel(android.os.Parcel source) {
            return new android.view.inputmethod.CompletionInfo(source);
        }

        public android.view.inputmethod.CompletionInfo[] newArray(int size) {
            return new android.view.inputmethod.CompletionInfo[size];
        }
    };
