...
public interface InputConnection {
    ...
    some reason.
     */
    android.view.inputmethod.ExtractedText getExtractedText(android.view.inputmethod.ExtractedTextRequest request, int flags);
    ...
    valid.
     */
    boolean setComposingText(java.lang.CharSequence text, int newCursorPosition);
    ...
    valid.
     */
    boolean commitText(java.lang.CharSequence text, int newCursorPosition);
    ...
    valid.
     */
    boolean commitCompletion(android.view.inputmethod.CompletionInfo text);
    ...
    valid.
     */
    boolean performPrivateCommand(java.lang.String action, android.os.Bundle data);
     ...
     *
     * @param cursorUpdateMode
     * 		{@link #CURSOR_UPDATE_IMMEDIATE} and/or
     ...
     */
    int INPUT_CONTENT_GRANT_READ_URI_PERMISSION = android.content.Intent.FLAG_GRANT_READ_URI_PERMISSION;// 0x00000001
     ...
     * @param flags
     * 		{@link #INPUT_CONTENT_GRANT_READ_URI_PERMISSION} if the content provider
     ...
     */
    boolean commitContent(@android.annotation.NonNull
    android.view.inputmethod.InputContentInfo inputContentInfo, int flags, @android.annotation.Nullable
