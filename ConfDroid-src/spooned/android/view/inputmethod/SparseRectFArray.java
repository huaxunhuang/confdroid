...
public final class SparseRectFArray implements android.os.Parcelable {
    ...
    public SparseRectFArray(final android.os.Parcel source) {
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        final android.view.inputmethod.SparseRectFArray that = ((android.view.inputmethod.SparseRectFArray) (obj));
        return (java.util.Arrays.equals(mKeys, that.mKeys) && java.util.Arrays.equals(mCoordinates, that.mCoordinates)) && java.util.Arrays.equals(mFlagsArray, that.mFlagsArray);
    }
    ...
    public static final class SparseRectFArrayBuilder {
        ...
        private void ensureBufferSize() {
            if (mKeys == null) {
                mKeys = new int[android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder.INITIAL_SIZE];
            }
            if (mCoordinates == null) {
                mCoordinates = new float[android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder.INITIAL_SIZE * 4];
            }
            if (mFlagsArray == null) {
                mFlagsArray = new int[android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder.INITIAL_SIZE];
            }
            ...
            if (mKeys.length <= requiredIndexArraySize) {
                ...
                java.lang.System.arraycopy(mKeys, 0, newArray, 0, mCount);
                mKeys = newArray;
            }
            ...
            if (mCoordinates.length <= requiredCoordinatesArraySize) {
                ...
                java.lang.System.arraycopy(mCoordinates, 0, newArray, 0, mCount * 4);
            ...
            if (mFlagsArray.length <= requiredFlagsArraySize) {
                ...
                java.lang.System.arraycopy(mFlagsArray, 0, newArray, 0, mCount);
         ...
         * 		If the index is not greater than all of existing keys.
         */
        public android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder append(final int key, final float left, final float top, final float right, final float bottom, final int flags) {
            checkIndex(key);
            ensureBufferSize();
    ...
    private SparseRectFArray(final android.view.inputmethod.SparseRectFArray.SparseRectFArrayBuilder builder) {
        if (builder.mCount == 0) {
            mKeys = null;
            mCoordinates = null;
            mFlagsArray = null;
            ...
            java.lang.System.arraycopy(builder.mKeys, 0, mKeys, 0, builder.mCount);
            java.lang.System.arraycopy(builder.mCoordinates, 0, mCoordinates, 0, builder.mCount * 4);
            java.lang.System.arraycopy(builder.mFlagsArray, 0, mFlagsArray, 0, builder.mCount);
        }
    }

    public android.graphics.RectF get(final int index) {
        if (mKeys == null) {
            return null;
        }
        if (index < 0) {
        ...
        final int arrayIndex = java.util.Arrays.binarySearch(mKeys, index);
        if (arrayIndex < 0) {
            return null;
        }
        final int baseCoordIndex = arrayIndex * 4;
        return new android.graphics.RectF(mCoordinates[baseCoordIndex], mCoordinates[baseCoordIndex + 1], mCoordinates[baseCoordIndex + 2], mCoordinates[baseCoordIndex + 3]);
    }
    ...
    public static final android.os.Parcelable.Creator<android.view.inputmethod.SparseRectFArray> CREATOR = new android.os.Parcelable.Creator<android.view.inputmethod.SparseRectFArray>() {
        @java.lang.Override
        public android.view.inputmethod.SparseRectFArray createFromParcel(android.os.Parcel source) {
            return new android.view.inputmethod.SparseRectFArray(source);
        }

        @java.lang.Override
        public android.view.inputmethod.SparseRectFArray[] newArray(int size) {
            return new android.view.inputmethod.SparseRectFArray[size];
        }
    };
