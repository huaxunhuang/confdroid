 ...
 * </ul>
 */
@android.annotation.SystemService(android.content.Context.INPUT_METHOD_SERVICE)
@android.annotation.RequiresFeature(android.content.pm.PackageManager.FEATURE_INPUT_METHODS)
public final class InputMethodManager {
    ...
    public static void ensureDefaultInstanceForDefaultDisplayIfNecessary() {
        android.view.inputmethod.InputMethodManager.forContextInternal(android.view.Display.DEFAULT_DISPLAY, android.os.Looper.getMainLooper());
    }
     ...
     */
    private android.graphics.Matrix mActivityViewToScreenMatrix = null;
     ...
     */
    private int mRequestUpdateCursorAnchorInfoMonitorMode = android.view.inputmethod.InputMethodManager.REQUEST_UPDATE_CURSOR_ANCHOR_INFO_NONE;
    ...
    final android.util.Pools.Pool<android.view.inputmethod.InputMethodManager.PendingEvent> mPendingEventPool = new android.util.Pools.SimplePool(20);

    final android.util.SparseArray<android.view.inputmethod.InputMethodManager.PendingEvent> mPendingEvents = new android.util.SparseArray(20);
    ...
    private static boolean isAutofillUIShowing(android.view.View servedView) {
        android.view.autofill.AutofillManager afm = servedView.getContext().getSystemService(android.view.autofill.AutofillManager.class);
    ...
    private android.view.inputmethod.InputMethodManager getFallbackInputMethodManagerIfNecessary(@android.annotation.Nullable
    android.view.View view) {
        ...
        // ApplicationContext.
        final android.view.ViewRootImpl viewRootImpl = view.getViewRootImpl();
        ...
        final android.view.inputmethod.InputMethodManager fallbackImm = viewRootImpl.mContext.getSystemService(android.view.inputmethod.InputMethodManager.class);
        if (fallbackImm == null) {
            android.util.Log.e(android.view.inputmethod.InputMethodManager.TAG, "b/117267690: Failed to get non-null fallback IMM. view=" + view);
            return null;
        }
        if (fallbackImm.mDisplayId != viewRootDisplayId) {
            android.util.Log.e(android.view.inputmethod.InputMethodManager.TAG, (((("b/117267690: Failed to get fallback IMM with expected displayId=" + viewRootDisplayId) + " actual IMM#displayId=") + fallbackImm.mDisplayId) + " view=") + view);
            return null;
        }
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, (((("b/117267690: Display ID mismatch found." + " ViewRootImpl displayId=") + viewRootDisplayId) + " InputMethodManager displayId=") + mDisplayId) + ". Use the right InputMethodManager instance to avoid performance overhead.", new java.lang.Throwable());
        return fallbackImm;
    }

    private static boolean canStartInput(android.view.View servedView) {
        // We can start input ether the servedView has window focus
        // or the activity is showing autofill ui.
        return servedView.hasWindowFocus() || android.view.inputmethod.InputMethodManager.isAutofillUIShowing(servedView);
    }
    ...
    class H extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            switch (msg.what) {
                case android.view.inputmethod.InputMethodManager.MSG_DUMP :
                    {
                        com.android.internal.os.SomeArgs args = ((com.android.internal.os.SomeArgs) (msg.obj));
                        try {
                            doDump(((java.io.FileDescriptor) (args.arg1)), ((java.io.PrintWriter) (args.arg2)), ((java.lang.String[]) (args.arg3)));
                ...
                case android.view.inputmethod.InputMethodManager.MSG_BIND :
                    {
                        final com.android.internal.view.InputBindResult res = ((com.android.internal.view.InputBindResult) (msg.obj));
                        if (android.view.inputmethod.InputMethodManager.DEBUG) {
                            android.util.Log.i(android.view.inputmethod.InputMethodManager.TAG, (("handleMessage: MSG_BIND " + res.sequence) + ",") + res.id);
                        }
                        synchronized(mH) {
                            if ((mBindSequence < 0) || (mBindSequence != res.sequence)) {
                                android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, (("Ignoring onBind: cur seq=" + mBindSequence) + ", given seq=") + res.sequence);
                                if ((res.channel != null) && (res.channel != mCurChannel)) {
                                    res.channel.dispose();
                                }
                                return;
                            }
                            mRequestUpdateCursorAnchorInfoMonitorMode = android.view.inputmethod.InputMethodManager.REQUEST_UPDATE_CURSOR_ANCHOR_INFO_NONE;
                ...
                case android.view.inputmethod.InputMethodManager.MSG_UNBIND :
                    {
                        final int sequence = msg.arg1;
                        @com.android.internal.inputmethod.UnbindReason
                        final int reason = msg.arg2;
                        if (android.view.inputmethod.InputMethodManager.DEBUG) {
                            android.util.Log.i(android.view.inputmethod.InputMethodManager.TAG, (("handleMessage: MSG_UNBIND " + sequence) + " reason=") + com.android.internal.inputmethod.InputMethodDebug.unbindReasonToString(reason));
                        }
                ...
                case android.view.inputmethod.InputMethodManager.MSG_SET_ACTIVE :
                    {
                        final boolean active = msg.arg1 != 0;
                        final boolean fullscreen = msg.arg2 != 0;
                        if (android.view.inputmethod.InputMethodManager.DEBUG) {
                            android.util.Log.i(android.view.inputmethod.InputMethodManager.TAG, (("handleMessage: MSG_SET_ACTIVE " + active) + ", was ") + mActive);
                        }
                        synchronized(mH) {
                            mActive = active;
                            ...
                            if ((mServedView != null) && android.view.inputmethod.InputMethodManager.canStartInput(mServedView)) {
                                if (checkFocusNoStartInput(mRestartOnNextWindowFocus)) {
                                    final int reason = (active) ? com.android.internal.inputmethod.StartInputReason.ACTIVATED_BY_IMMS : com.android.internal.inputmethod.StartInputReason.DEACTIVATED_BY_IMMS;
                ...
                case android.view.inputmethod.InputMethodManager.MSG_SEND_INPUT_EVENT :
                    {
                        sendInputEventAndReportResultOnMainLooper(((android.view.inputmethod.InputMethodManager.PendingEvent) (msg.obj)));
                        return;
                    }
                case android.view.inputmethod.InputMethodManager.MSG_TIMEOUT_INPUT_EVENT :
                    {
                        finishedInputEvent(msg.arg1, false, true);
                        return;
                    }
                case android.view.inputmethod.InputMethodManager.MSG_FLUSH_INPUT_EVENT :
                    {
                        finishedInputEvent(msg.arg1, false, false);
                        return;
                    }
                case android.view.inputmethod.InputMethodManager.MSG_REPORT_FULLSCREEN_MODE :
                    {
                ...
                case android.view.inputmethod.InputMethodManager.MSG_REPORT_PRE_RENDERED :
                    {
                        synchronized(mH) {
                            if (mImeInsetsConsumer != null) {
                                mImeInsetsConsumer.onPreRendered(((android.view.inputmethod.EditorInfo) (msg.obj)));
                            }
                        }
                        return;
                    }
                case android.view.inputmethod.InputMethodManager.MSG_APPLY_IME_VISIBILITY :
                    {
                        synchronized(mH) {
                            if (mImeInsetsConsumer != null) {
                ...
                case android.view.inputmethod.InputMethodManager.MSG_UPDATE_ACTIVITY_VIEW_TO_SCREEN_MATRIX :
                    {
                        ...
                        synchronized(mH) {
                            ...
                            if (java.util.Arrays.equals(currentValues, matrixValues)) {
                                return;
                            }
                            ...
                            final boolean isMonitoring = (mRequestUpdateCursorAnchorInfoMonitorMode & android.view.inputmethod.InputConnection.CURSOR_UPDATE_MONITOR) != 0;
                            if (!isMonitoring) {
                                return;
                            }
                            ...
                            try {
                                mCurMethod.updateCursorAnchorInfo(android.view.inputmethod.CursorAnchorInfo.createForAdditionalParentMatrix(mCursorAnchorInfo, mActivityViewToScreenMatrix));
                            } catch (android.os.RemoteException e) {
                                android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "IME died: " + mCurId, e);
                            }
                        }
                        return;
                    }
    ...
    private static class ControlledInputConnectionWrapper extends com.android.internal.view.IInputConnectionWrapper {
        ...
        public ControlledInputConnectionWrapper(final android.os.Looper mainLooper, final android.view.inputmethod.InputConnection conn, final android.view.inputmethod.InputMethodManager inputMethodManager) {
    ...
    final IInputMethodClient.Stub mClient = new com.android.internal.view.IInputMethodClient.Stub() {
        @java.lang.Override
        protected void dump(java.io.FileDescriptor fd, java.io.PrintWriter fout, java.lang.String[] args) {
            ...
            com.android.internal.os.SomeArgs sargs = com.android.internal.os.SomeArgs.obtain();
            sargs.arg1 = fd;
            sargs.arg2 = fout;
            sargs.arg3 = args;
            sargs.arg4 = latch;
            mH.sendMessage(mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_DUMP, sargs));
            try {
        ...
        @java.lang.Override
        public void onBindMethod(com.android.internal.view.InputBindResult res) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_BIND, res).sendToTarget();
        }

        @java.lang.Override
        public void onUnbindMethod(int sequence, @com.android.internal.inputmethod.UnbindReason
        int unbindReason) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_UNBIND, sequence, unbindReason).sendToTarget();
        }

        @java.lang.Override
        public void setActive(boolean active, boolean fullscreen) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_SET_ACTIVE, active ? 1 : 0, fullscreen ? 1 : 0).sendToTarget();
        }

        @java.lang.Override
        public void reportFullscreenMode(boolean fullscreen) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_REPORT_FULLSCREEN_MODE, fullscreen ? 1 : 0, 0).sendToTarget();
        }

        @java.lang.Override
        public void reportPreRendered(android.view.inputmethod.EditorInfo info) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_REPORT_PRE_RENDERED, 0, 0, info).sendToTarget();
        }

        @java.lang.Override
        public void applyImeVisibility(boolean setVisible) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_APPLY_IME_VISIBILITY, setVisible ? 1 : 0, 0).sendToTarget();
        }

        @java.lang.Override
        public void updateActivityViewToScreenMatrix(int bindSequence, float[] matrixValues) {
            mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_UPDATE_ACTIVITY_VIEW_TO_SCREEN_MATRIX, bindSequence, 0, matrixValues).sendToTarget();
        }
    };

    final android.view.inputmethod.InputConnection mDummyInputConnection = new android.view.inputmethod.BaseInputConnection(this, false);

    /**
     * For layoutlib to clean up static objects inside {@link InputMethodManager}.
     */
    static void tearDownEditMode() {
        if (!android.view.inputmethod.InputMethodManager.isInEditMode()) {
            throw new java.lang.UnsupportedOperationException("This method must be called only from layoutlib");
        }
        synchronized(android.view.inputmethod.InputMethodManager.sLock) {
            android.view.inputmethod.InputMethodManager.sInstance = null;
        }
    }
    ...
    private static android.view.inputmethod.InputMethodManager createInstance(int displayId, android.os.Looper looper) {
        return android.view.inputmethod.InputMethodManager.isInEditMode() ? android.view.inputmethod.InputMethodManager.createStubInstance(displayId, looper) : android.view.inputmethod.InputMethodManager.createRealInstance(displayId, looper);
    }

    @android.annotation.NonNull
    private static android.view.inputmethod.InputMethodManager createRealInstance(int displayId, android.os.Looper looper) {
        final com.android.internal.view.IInputMethodManager service;
        try {
            service = IInputMethodManager.Stub.asInterface(android.os.ServiceManager.getServiceOrThrow(android.content.Context.INPUT_METHOD_SERVICE));
        } catch (android.os.ServiceManager.ServiceNotFoundException e) {
            throw new java.lang.IllegalStateException(e);
        }
        final android.view.inputmethod.InputMethodManager imm = new android.view.inputmethod.InputMethodManager(service, displayId, looper);
    ...
    @android.annotation.NonNull
    private static android.view.inputmethod.InputMethodManager createStubInstance(int displayId, android.os.Looper looper) {
        // If InputMethodManager is running for layoutlib, stub out IPCs into IMMS.
        final java.lang.Class<com.android.internal.view.IInputMethodManager> c = com.android.internal.view.IInputMethodManager.class;
        final com.android.internal.view.IInputMethodManager stubInterface = ((com.android.internal.view.IInputMethodManager) (java.lang.reflect.Proxy.newProxyInstance(c.getClassLoader(), new java.lang.Class[]{ c }, ( proxy, method, args) -> {
        ...
        return new android.view.inputmethod.InputMethodManager(stubInterface, displayId, looper);
    }

    private InputMethodManager(com.android.internal.view.IInputMethodManager service, int displayId, android.os.Looper looper) {
        mService = service;
        mMainLooper = looper;
        mH = new android.view.inputmethod.InputMethodManager.H(looper);
        mDisplayId = displayId;
        mIInputContext = new android.view.inputmethod.InputMethodManager.ControlledInputConnectionWrapper(looper, mDummyInputConnection, this);
    }
     ...
     *
     * @param context
     * 		{@link Context} for which IME APIs need to work
    ...
    public static android.view.inputmethod.InputMethodManager forContext(android.content.Context context) {
        ...
        // display case.
        final android.os.Looper looper = (displayId == android.view.Display.DEFAULT_DISPLAY) ? android.os.Looper.getMainLooper() : context.getMainLooper();
        return android.view.inputmethod.InputMethodManager.forContextInternal(displayId, looper);
    }

    @android.annotation.NonNull
    private static android.view.inputmethod.InputMethodManager forContextInternal(int displayId, android.os.Looper looper) {
        final boolean isDefaultDisplay = displayId == android.view.Display.DEFAULT_DISPLAY;
        synchronized(android.view.inputmethod.InputMethodManager.sLock) {
            android.view.inputmethod.InputMethodManager instance = android.view.inputmethod.InputMethodManager.sInstanceMap.get(displayId);
            if (instance != null) {
                return instance;
            }
            instance = android.view.inputmethod.InputMethodManager.createInstance(displayId, looper);
            // For backward compatibility, store the instance also to sInstance for default display.
            if ((android.view.inputmethod.InputMethodManager.sInstance == null) && isDefaultDisplay) {
                android.view.inputmethod.InputMethodManager.sInstance = instance;
            }
            android.view.inputmethod.InputMethodManager.sInstanceMap.put(displayId, instance);
            return instance;
        }
    }
    ...
    public static android.view.inputmethod.InputMethodManager getInstance() {
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "InputMethodManager.getInstance() is deprecated because it cannot be" + (" compatible with multi-display." + " Use context.getSystemService(InputMethodManager.class) instead."), new java.lang.Throwable());
        android.view.inputmethod.InputMethodManager.ensureDefaultInstanceForDefaultDisplayIfNecessary();
        return android.view.inputmethod.InputMethodManager.peekInstance();
    }
    ...
    public static android.view.inputmethod.InputMethodManager peekInstance() {
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "InputMethodManager.peekInstance() is deprecated because it cannot be" + (" compatible with multi-display." + " Use context.getSystemService(InputMethodManager.class) instead."), new java.lang.Throwable());
        synchronized(android.view.inputmethod.InputMethodManager.sLock) {
            return android.view.inputmethod.InputMethodManager.sInstance;
        }
    }
    ...
    public java.util.List<android.view.inputmethod.InputMethodInfo> getInputMethodList() {
        try {
            ...
            // instead.
            return mService.getInputMethodList(android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException e) {
    ...
    public java.util.List<android.view.inputmethod.InputMethodInfo> getInputMethodListAsUser(@android.annotation.UserIdInt
    int userId) {
        try {
    ...
    public java.util.List<android.view.inputmethod.InputMethodInfo> getEnabledInputMethodList() {
        try {
            ...
            // instead.
            return mService.getEnabledInputMethodList(android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     */
    @android.annotation.RequiresPermission(android.Manifest.permission.INTERACT_ACROSS_USERS_FULL)
    public java.util.List<android.view.inputmethod.InputMethodInfo> getEnabledInputMethodListAsUser(@android.annotation.UserIdInt
    int userId) {
        try {
     ...
     * @param allowsImplicitlySelectedSubtypes
     * 		A boolean flag to allow to return the implicitly
     * 		selected subtypes. If an input method info doesn't have enabled subtypes, the framework
     * 		will implicitly enable subtypes according to the current system language.
     */
    public java.util.List<android.view.inputmethod.InputMethodSubtype> getEnabledInputMethodSubtypeList(android.view.inputmethod.InputMethodInfo imi, boolean allowsImplicitlySelectedSubtypes) {
        try {
     ...
     */
    @java.lang.Deprecated
    public void showStatusIcon(android.os.IBinder imeToken, java.lang.String packageName, @android.annotation.DrawableRes
    int iconId) {
        com.android.internal.inputmethod.InputMethodPrivilegedOperationsRegistry.get(imeToken).updateStatusIcon(packageName, iconId);
    }
    ...
    public void hideStatusIcon(android.os.IBinder imeToken) {
        com.android.internal.inputmethod.InputMethodPrivilegedOperationsRegistry.get(imeToken).updateStatusIcon(null, 0);
    }
    ...
    public void registerSuggestionSpansForNotification(android.text.style.SuggestionSpan[] spans) {
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "registerSuggestionSpansForNotification() is deprecated.  Does nothing.");
    }
    ...
    public void notifySuggestionPicked(android.text.style.SuggestionSpan span, java.lang.String originalString, int index) {
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "notifySuggestionPicked() is deprecated.  Does nothing.");
    }
    ...
    public boolean isActive(android.view.View view) {
        ...
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
    ...
    void clearBindingLocked() {
        if (android.view.inputmethod.InputMethodManager.DEBUG)
            android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Clearing binding!");
    ...
    void finishInputLocked() {
        ...
        if (mServedView != null) {
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "FINISH INPUT: mServedView=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(mServedView));
    ...
    public void displayCompletions(android.view.View view, android.view.inputmethod.CompletionInfo[] completions) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
     ...
     * 		{@link #RESULT_HIDDEN}.
     */
    public boolean showSoftInput(android.view.View view, int flags, android.os.ResultReceiver resultReceiver) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
     ...
     */
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768499)
    public void showSoftInputUnchecked(int flags, android.os.ResultReceiver resultReceiver) {
        try {
            android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "showSoftInputUnchecked() is a hidden method, which will be removed " + ("soon. If you are using android.support.v7.widget.SearchView, please update " + "to version 26.0 or newer version."));
    ...
    boolean startInputInner(@com.android.internal.inputmethod.StartInputReason
    int startInputReason, @android.annotation.Nullable
    android.os.IBinder windowGainingFocus, @com.android.internal.inputmethod.StartInputFlags
    ...
    int softInputMode, int windowFlags) {
        ...
        synchronized(mH) {
            ...
            if (android.view.inputmethod.InputMethodManager.DEBUG) {
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (("Starting input: view=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(view)) + " reason=") + com.android.internal.inputmethod.InputMethodDebug.startInputReasonToString(startInputReason));
            }
            if (view == null) {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "ABORT input: no served view!");
        ...
        if (windowGainingFocus == null) {
            ...
            startInputFlags |= com.android.internal.inputmethod.StartInputFlags.VIEW_HAS_FOCUS;
            if (view.onCheckIsTextEditor()) {
                startInputFlags |= com.android.internal.inputmethod.StartInputFlags.IS_TEXT_EDITOR;
            }
        ...
        if (vh == null) {
            ...
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "ABORT input: no handler for view! Close current input.");
        ...
        if (vh.getLooper() != android.os.Looper.myLooper()) {
            ...
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Starting input: reschedule to view thread");
        ...
        if (android.view.inputmethod.InputMethodManager.DEBUG)
            android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (("Starting input: tba=" + tba) + " ic=") + ic);
        ...
        synchronized(mH) {
            ...
            if ((mServedView != view) || (!mServedConnecting)) {
                ...
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (((("Starting input: finished by someone else. view=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(view)) + " mServedView=") + android.view.inputmethod.InputMethodManager.dumpViewInfo(mServedView)) + " mServedConnecting=") + mServedConnecting);
            ...
            if (mCurrentTextBoxAttribute == null) {
                startInputFlags |= com.android.internal.inputmethod.StartInputFlags.INITIAL_CONNECTION;
            }
            ...
            if (ic != null) {
                ...
                final android.os.Handler icHandler;
                missingMethodFlags = android.view.inputmethod.InputConnectionInspector.getMissingMethodFlags(ic);
                if ((missingMethodFlags & android.view.inputmethod.InputConnectionInspector.MissingMethodFlags.GET_HANDLER) != 0) {
                    // InputConnection#getHandler() is not implemented.
                    icHandler = null;
                } else {
                    icHandler = ic.getHandler();
                }
                servedContext = new android.view.inputmethod.InputMethodManager.ControlledInputConnectionWrapper(icHandler != null ? icHandler.getLooper() : vh.getLooper(), ic, this);
            } else {
                servedContext = null;
            ...
            try {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (((((("START INPUT: view=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(view)) + " ic=") + ic) + " tba=") + tba) + " startInputFlags=") + com.android.internal.inputmethod.InputMethodDebug.startInputFlagsToString(startInputFlags));

                final com.android.internal.view.InputBindResult res = mService.startInputOrWindowGainedFocus(startInputReason, mClient, windowGainingFocus, startInputFlags, softInputMode, windowFlags, tba, servedContext, missingMethodFlags, view.getContext().getApplicationInfo().targetSdkVersion);
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Starting input: Bind result=" + res);

                if (res == null) {
                    android.util.Log.wtf(android.view.inputmethod.InputMethodManager.TAG, ((((("startInputOrWindowGainedFocus must not return" + " null. startInputReason=") + com.android.internal.inputmethod.InputMethodDebug.startInputReasonToString(startInputReason)) + " editorInfo=") + tba) + " startInputFlags=") + com.android.internal.inputmethod.InputMethodDebug.startInputFlagsToString(startInputFlags));
                    return false;
                }
                mActivityViewToScreenMatrix = res.getActivityViewToScreenMatrix();
                if (res.id != null) {
    ...
    public void windowDismissed(android.os.IBinder appWindowToken) {
        ...
        synchronized(mH) {
            ...
            if ((mCurRootView != null) && (mCurRootView.getWindowToken() == appWindowToken)) {
                mCurRootView = null;
            }
        }
    }
    ...
    void focusInLocked(android.view.View view) {
        if (android.view.inputmethod.InputMethodManager.DEBUG)
            android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "focusIn: " + android.view.inputmethod.InputMethodManager.dumpViewInfo(view));

        if ((view != null) && view.isTemporarilyDetached()) {
            // This is a request from a view that is temporarily detached from a window.
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Temporarily detached view, ignoring");
        ...
        if (mCurRootView != view.getRootView()) {
            ...
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Not IME target window, ignoring");

            return;
        }
        mNextServedView = view;
        android.view.inputmethod.InputMethodManager.scheduleCheckFocusLocked(view);
    }
    ...
    public void focusOut(android.view.View view) {
        synchronized(mH) {
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (("focusOut: view=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(view)) + " mServedView=") + android.view.inputmethod.InputMethodManager.dumpViewInfo(mServedView));
            ...
            if (mServedView != view) {
                ...
                if (false && android.view.inputmethod.InputMethodManager.canStartInput(view)) {
                    mNextServedView = null;
                    android.view.inputmethod.InputMethodManager.scheduleCheckFocusLocked(view);
                }
            }
    ...
    public void onViewDetachedFromWindow(android.view.View view) {
        synchronized(mH) {
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (("onViewDetachedFromWindow: view=" + android.view.inputmethod.InputMethodManager.dumpViewInfo(view)) + " mServedView=") + android.view.inputmethod.InputMethodManager.dumpViewInfo(mServedView));
    ...
    private boolean checkFocusNoStartInput(boolean forceNewFocus) {
        ...
        final android.view.inputmethod.InputMethodManager.ControlledInputConnectionWrapper ic;
        synchronized(mH) {
            if ((mServedView == mNextServedView) && (!forceNewFocus)) {
                return false;
            }
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (((((("checkFocus: view=" + mServedView) + " next=") + mNextServedView) + " forceNewFocus=") + forceNewFocus) + " package=") + (mServedView != null ? mServedView.getContext().getPackageName() : "<none>"));
    ...
    void closeCurrentInput() {
        try {
            mService.hideSoftInput(mClient, android.view.inputmethod.InputMethodManager.HIDE_NOT_ALWAYS, null);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     * @unknown 
     */
    public void onPostWindowFocus(android.view.View rootView, android.view.View focusedView, @android.view.WindowManager.LayoutParams.SoftInputModeFlags
    int softInputMode, boolean first, int windowFlags) {
        boolean forceNewFocus = false;
        synchronized(mH) {
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (((((("onWindowFocus: " + focusedView) + " softInputMode=") + com.android.internal.inputmethod.InputMethodDebug.softInputModeToString(softInputMode)) + " first=") + first) + " flags=#") + java.lang.Integer.toHexString(windowFlags));

            if (mRestartOnNextWindowFocus) {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Restarting due to mRestartOnNextWindowFocus");
        ...
        if (first) {
            startInputFlags |= com.android.internal.inputmethod.StartInputFlags.FIRST_WINDOW_FOCUS_GAIN;
        }
        if (checkFocusNoStartInput(forceNewFocus)) {
            ...
            // smooth.
            if (startInputInner(StartInputReason.WINDOW_FOCUS_GAIN, rootView.getWindowToken(), startInputFlags, softInputMode, windowFlags)) {
                return;
            }
        }
        ...
        synchronized(mH) {
            try {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "Reporting focus gain, without startInput");

                /* missingMethodFlags */
                mService.startInputOrWindowGainedFocus(StartInputReason.WINDOW_FOCUS_GAIN_REPORT_ONLY, mClient, rootView.getWindowToken(), startInputFlags, softInputMode, windowFlags, null, null, 0, rootView.getContext().getApplicationInfo().targetSdkVersion);
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public void onPreWindowFocus(android.view.View rootView, boolean hasWindowFocus) {
        synchronized(mH) {
            if (rootView == null) {
                mCurRootView = null;
            }
            if (hasWindowFocus) {
                ...
                if (rootView == mCurRootView) {
                    ...
                    if (android.view.inputmethod.InputMethodManager.DEBUG) {
                        android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, ((("Ignoring onPreWindowFocus()." + " mCurRootView=") + mCurRootView) + " rootView=") + rootView);
                    }
                }
     ...
     * @unknown 
     */
    public void registerImeConsumer(@android.annotation.NonNull
    android.view.ImeInsetsSourceConsumer imeInsetsConsumer) {
     ...
     * @unknown 
     */
    public void unregisterImeConsumer(@android.annotation.NonNull
    android.view.ImeInsetsSourceConsumer imeInsetsConsumer) {
        if (imeInsetsConsumer == null) {
            throw new java.lang.IllegalStateException("ImeInsetsSourceConsumer cannot be null.");
        }
     ...
     * @unknown 
     */
    public boolean requestImeShow(android.os.ResultReceiver resultReceiver) {
        synchronized(mH) {
            if (mServedView == null) {
                return false;
            }
            /* flags */
            showSoftInput(mServedView, 0, resultReceiver);
            return true;
        }
    }
     ...
     */
    public void updateSelection(android.view.View view, int selStart, int selEnd, int candidatesStart, int candidatesEnd) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
        ...
        synchronized(mH) {
            ...
            if ((((mCursorSelStart != selStart) || (mCursorSelEnd != selEnd)) || (mCursorCandStart != candidatesStart)) || (mCursorCandEnd != candidatesEnd)) {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.d(android.view.inputmethod.InputMethodManager.TAG, "updateSelection");

                try {
                    if (android.view.inputmethod.InputMethodManager.DEBUG)
                        android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "SELECTION CHANGE: " + mCurMethod);
     ...
     *
     * @param view
     * 		{@link View} which is being clicked.
    ...
    public void viewClicked(android.view.View view) {
        ...
        synchronized(mH) {
            ...
            try {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "onViewClicked: " + focusChanged);
    ...
    public boolean isCursorAnchorInfoEnabled() {
        synchronized(mH) {
            final boolean isImmediate = (mRequestUpdateCursorAnchorInfoMonitorMode & android.view.inputmethod.InputConnection.CURSOR_UPDATE_IMMEDIATE) != 0;
            final boolean isMonitoring = (mRequestUpdateCursorAnchorInfoMonitorMode & android.view.inputmethod.InputConnection.CURSOR_UPDATE_MONITOR) != 0;
     ...
     */
    @java.lang.Deprecated
    public void updateCursor(android.view.View view, int left, int top, int right, int bottom) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
        ...
        synchronized(mH) {
            ...
            if (!mCursorRect.equals(mTmpCursorRect)) {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.d(android.view.inputmethod.InputMethodManager.TAG, "updateCursor");

                try {
                    if (android.view.inputmethod.InputMethodManager.DEBUG)
                        android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "CURSOR CHANGE: " + mCurMethod);
     ...
     * string.
     */
    public void updateCursorAnchorInfo(android.view.View view, final android.view.inputmethod.CursorAnchorInfo cursorAnchorInfo) {
        ...
        synchronized(mH) {
            ...
            final boolean isImmediate = (mRequestUpdateCursorAnchorInfoMonitorMode & android.view.inputmethod.InputConnection.CURSOR_UPDATE_IMMEDIATE) != 0;
            if ((!isImmediate) && java.util.Objects.equals(mCursorAnchorInfo, cursorAnchorInfo)) {
                // TODO: Consider always emitting this message once we have addressed redundant
                // calls of this method from android.widget.Editor.
                if (android.view.inputmethod.InputMethodManager.DEBUG) {
                    android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "Ignoring redundant updateCursorAnchorInfo: info=" + cursorAnchorInfo);
                }
                return;
            }
            if (android.view.inputmethod.InputMethodManager.DEBUG)
                android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "updateCursorAnchorInfo: " + cursorAnchorInfo);

            try {
                if (mActivityViewToScreenMatrix != null) {
                    mCurMethod.updateCursorAnchorInfo(android.view.inputmethod.CursorAnchorInfo.createForAdditionalParentMatrix(cursorAnchorInfo, mActivityViewToScreenMatrix));
                } else {
                    mCurMethod.updateCursorAnchorInfo(cursorAnchorInfo);
                }
                mCursorAnchorInfo = cursorAnchorInfo;
                // Clear immediate bit (if any).
                mRequestUpdateCursorAnchorInfoMonitorMode &= ~android.view.inputmethod.InputConnection.CURSOR_UPDATE_IMMEDIATE;
            } catch (android.os.RemoteException e) {
                android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "IME died: " + mCurId, e);
            }
        }
     ...
     */
    public void sendAppPrivateCommand(android.view.View view, java.lang.String action, android.os.Bundle data) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(view);
        if (fallbackImm != null) {
        ...
        synchronized(mH) {
            ...
            try {
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, (("APP PRIVATE COMMAND " + action) + ": ") + data);
    ...
    public void setInputMethod(android.os.IBinder token, java.lang.String id) {
        if (token == null) {
            ...
            if (java.lang.Process.myUid() == SYSTEM_UID) {
                android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "System process should not be calling setInputMethod() because almost " + (("always it is a bug under multi-user / multi-profile environment. " + "Consider interacting with InputMethodManagerService directly via ") + "LocalServices."));
                return;
            }
            final android.content.Context fallbackContext = android.app.ActivityThread.currentApplication();
            if (fallbackContext == null) {
                return;
            }
            if (fallbackContext.checkSelfPermission(android.Manifest.permission.WRITE_SECURE_SETTINGS) != android.content.pm.PackageManager.PERMISSION_GRANTED) {
                return;
            }
            final java.util.List<android.view.inputmethod.InputMethodInfo> imis = getEnabledInputMethodList();
            final int numImis = imis.size();
            boolean found = false;
            for (int i = 0; i < numImis; ++i) {
                final android.view.inputmethod.InputMethodInfo imi = imis.get(i);
            ...
            if (!found) {
                android.util.Log.e(android.view.inputmethod.InputMethodManager.TAG, (("Ignoring setInputMethod(null, " + id) + ") because the specified ") + "id not found in enabled IMEs.");
                return;
            }
            android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "The undocumented behavior that setInputMethod() accepts null token " + (("when the caller has WRITE_SECURE_SETTINGS is deprecated. This behavior may " + "be completely removed in a future version.  Update secure settings directly ") + "instead."));
            final android.content.ContentResolver resolver = fallbackContext.getContentResolver();
            Settings.Secure.putInt(resolver, Settings.Secure.SELECTED_INPUT_METHOD_SUBTYPE, android.view.inputmethod.InputMethodManager.NOT_A_SUBTYPE_ID);
     ...
     */
    @java.lang.Deprecated
    public void setInputMethodAndSubtype(@android.annotation.NonNull
    android.os.IBinder token, java.lang.String id, android.view.inputmethod.InputMethodSubtype subtype) {
        if (token == null) {
            android.util.Log.e(android.view.inputmethod.InputMethodManager.TAG, "setInputMethodAndSubtype() does not accept null token on Android Q " + "and later.");
            return;
        }
    ...
    public void hideSoftInputFromInputMethod(android.os.IBinder token, int flags) {
        com.android.internal.inputmethod.InputMethodPrivilegedOperationsRegistry.get(token).hideMySoftInput(flags);
    }
    ...
    public void showSoftInputFromInputMethod(android.os.IBinder token, int flags) {
        com.android.internal.inputmethod.InputMethodPrivilegedOperationsRegistry.get(token).showMySoftInput(flags);
    }
     ...
     * @unknown 
     */
    public int dispatchInputEvent(android.view.InputEvent event, java.lang.Object token, android.view.inputmethod.InputMethodManager.FinishedInputEventCallback callback, android.os.Handler handler) {
        synchronized(mH) {
            if (mCurMethod != null) {
                if (event instanceof android.view.KeyEvent) {
                    android.view.KeyEvent keyEvent = ((android.view.KeyEvent) (event));
                    if (((keyEvent.getAction() == android.view.KeyEvent.ACTION_DOWN) && (keyEvent.getKeyCode() == android.view.KeyEvent.KEYCODE_SYM)) && (keyEvent.getRepeatCount() == 0)) {
                        showInputMethodPickerLocked();
                        return android.view.inputmethod.InputMethodManager.DISPATCH_HANDLED;
                    }
                }
                if (android.view.inputmethod.InputMethodManager.DEBUG)
                    android.util.Log.v(android.view.inputmethod.InputMethodManager.TAG, "DISPATCH INPUT EVENT: " + mCurMethod);

                android.view.inputmethod.InputMethodManager.PendingEvent p = obtainPendingEventLocked(event, token, mCurId, callback, handler);
                ...
                android.os.Message msg = mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_SEND_INPUT_EVENT, p);
                msg.setAsynchronous(true);
                mH.sendMessage(msg);
                return android.view.inputmethod.InputMethodManager.DISPATCH_IN_PROGRESS;
            }
        }
     ...
     *
     * @param targetView
     * 		the default target view. If {@code null} is specified, then this method
     * 		tries to find a good event target based on the current focus state.
     * @param event
     * 		the key event to be dispatched.
     */
    public void dispatchKeyEventFromInputMethod(@android.annotation.Nullable
    android.view.View targetView, @android.annotation.NonNull
    android.view.KeyEvent event) {
        // Re-dispatch if there is a context mismatch.
        final android.view.inputmethod.InputMethodManager fallbackImm = getFallbackInputMethodManagerIfNecessary(targetView);
        if (fallbackImm != null) {
            fallbackImm.dispatchKeyEventFromInputMethod(targetView, event);
            return;
        }
        synchronized(mH) {
            android.view.ViewRootImpl viewRootImpl = (targetView != null) ? targetView.getViewRootImpl() : null;
            if (viewRootImpl == null) {
                if (mServedView != null) {
    ...
    void sendInputEventAndReportResultOnMainLooper(android.view.inputmethod.InputMethodManager.PendingEvent p) {
        ...
        synchronized(mH) {
            ...
            if (result == android.view.inputmethod.InputMethodManager.DISPATCH_IN_PROGRESS) {
                return;
            }
            handled = result == android.view.inputmethod.InputMethodManager.DISPATCH_HANDLED;
        }
    ...
    int sendInputEventOnMainLooperLocked(android.view.inputmethod.InputMethodManager.PendingEvent p) {
        if (mCurChannel != null) {
            if (mCurSender == null) {
                mCurSender = new android.view.inputmethod.InputMethodManager.ImeInputEventSender(mCurChannel, mH.getLooper());
            }
            final android.view.InputEvent event = p.mEvent;
            final int seq = event.getSequenceNumber();
            if (mCurSender.sendInputEvent(seq, event)) {
                mPendingEvents.put(seq, p);
                android.os.Trace.traceCounter(Trace.TRACE_TAG_INPUT, android.view.inputmethod.InputMethodManager.PENDING_EVENT_COUNTER, mPendingEvents.size());
                android.os.Message msg = mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_TIMEOUT_INPUT_EVENT, seq, 0, p);
                msg.setAsynchronous(true);
                mH.sendMessageDelayed(msg, android.view.inputmethod.InputMethodManager.INPUT_METHOD_NOT_RESPONDING_TIMEOUT);
                return android.view.inputmethod.InputMethodManager.DISPATCH_IN_PROGRESS;
            }
            android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, (("Unable to send input event to IME: " + mCurId) + " dropping: ") + event);
        }
        return android.view.inputmethod.InputMethodManager.DISPATCH_NOT_HANDLED;
    }

    void finishedInputEvent(int seq, boolean handled, boolean timeout) {
        final android.view.inputmethod.InputMethodManager.PendingEvent p;
        synchronized(mH) {
            ...
            android.os.Trace.traceCounter(Trace.TRACE_TAG_INPUT, android.view.inputmethod.InputMethodManager.PENDING_EVENT_COUNTER, mPendingEvents.size());
            if (timeout) {
                android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, (("Timeout waiting for IME to handle input event after " + android.view.inputmethod.InputMethodManager.INPUT_METHOD_NOT_RESPONDING_TIMEOUT) + " ms: ") + p.mInputMethodId);
            } else {
                mH.removeMessages(android.view.inputmethod.InputMethodManager.MSG_TIMEOUT_INPUT_EVENT, p);
            }
        }
        invokeFinishedInputEventCallback(p, handled);
    }
    ...
    void invokeFinishedInputEventCallback(android.view.inputmethod.InputMethodManager.PendingEvent p, boolean handled) {
        ...
        if (p.mHandler.getLooper().isCurrentThread()) {
            ...
            android.os.Message msg = android.os.Message.obtain(p.mHandler, p);
            msg.setAsynchronous(true);
            msg.sendToTarget();
        }
    }
    ...
    private void flushPendingEventsLocked() {
        mH.removeMessages(android.view.inputmethod.InputMethodManager.MSG_FLUSH_INPUT_EVENT);
        final int count = mPendingEvents.size();
        for (int i = 0; i < count; i++) {
            int seq = mPendingEvents.keyAt(i);
            android.os.Message msg = mH.obtainMessage(android.view.inputmethod.InputMethodManager.MSG_FLUSH_INPUT_EVENT, seq, 0);
            msg.setAsynchronous(true);
            msg.sendToTarget();
        }
    }
    ...
    private android.view.inputmethod.InputMethodManager.PendingEvent obtainPendingEventLocked(android.view.InputEvent event, java.lang.Object token, java.lang.String inputMethodId, android.view.inputmethod.InputMethodManager.FinishedInputEventCallback callback, android.os.Handler handler) {
        android.view.inputmethod.InputMethodManager.PendingEvent p = mPendingEventPool.acquire();
        if (p == null) {
            p = new android.view.inputmethod.InputMethodManager.PendingEvent();
        }
        p.mEvent = event;
        p.mToken = token;
     ...
     * 		Set true to show auxiliary input methods.
     * @param displayId
     * 		The ID of the display where the chooser dialog should be shown.
     * @unknown 
     */
    @android.annotation.RequiresPermission(android.Manifest.permission.WRITE_SECURE_SETTINGS)
    public void showInputMethodPickerFromSystem(boolean showAuxiliarySubtypes, int displayId) {
        final int mode = (showAuxiliarySubtypes) ? android.view.inputmethod.InputMethodManager.SHOW_IM_PICKER_MODE_INCLUDE_AUXILIARY_SUBTYPES : android.view.inputmethod.InputMethodManager.SHOW_IM_PICKER_MODE_EXCLUDE_AUXILIARY_SUBTYPES;
        try {
    ...
    private void showInputMethodPickerLocked() {
        try {
            mService.showInputMethodPickerFromClient(mClient, android.view.inputmethod.InputMethodManager.SHOW_IM_PICKER_MODE_AUTO);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean setCurrentInputMethodSubtype(android.view.inputmethod.InputMethodSubtype subtype) {
        if (java.lang.Process.myUid() == SYSTEM_UID) {
            android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "System process should not call setCurrentInputMethodSubtype() because " + (("almost always it is a bug under multi-user / multi-profile environment. " + "Consider directly interacting with InputMethodManagerService ") + "via LocalServices."));
            return false;
        }
        if (subtype == null) {
        ...
        final android.content.ContentResolver contentResolver = fallbackContext.getContentResolver();
        final java.lang.String imeId = Settings.Secure.getString(contentResolver, Settings.Secure.DEFAULT_INPUT_METHOD);
        if (android.content.ComponentName.unflattenFromString(imeId) == null) {
            // Null or invalid IME ID format.
            return false;
        }
        final java.util.List<android.view.inputmethod.InputMethodSubtype> enabledSubtypes;
        try {
        ...
        for (int i = 0; i < numSubtypes; ++i) {
            final android.view.inputmethod.InputMethodSubtype enabledSubtype = enabledSubtypes.get(i);
     ...
     */
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage(trackingBug = 114740982, maxTargetSdk = Build.VERSION_CODES.P)
    public void notifyUserAction() {
        android.util.Log.w(android.view.inputmethod.InputMethodManager.TAG, "notifyUserAction() is a hidden method, which is now just a stub method" + (" that does nothing.  Leave comments in b.android.com/114740982 if your " + " application still depends on the previous behavior of this method."));
    }
    ...
    public java.util.Map<android.view.inputmethod.InputMethodInfo, java.util.List<android.view.inputmethod.InputMethodSubtype>> getShortcutInputMethodsAndSubtypes() {
        final java.util.List<android.view.inputmethod.InputMethodInfo> enabledImes = getEnabledInputMethodList();
        // Ensure we check system IMEs first.
        enabledImes.sort(java.util.Comparator.comparingInt(( imi) -> imi.isSystem() ? 0 : 1));
        final int numEnabledImes = enabledImes.size();
        for (int imiIndex = 0; imiIndex < numEnabledImes; ++imiIndex) {
            final android.view.inputmethod.InputMethodInfo imi = enabledImes.get(imiIndex);
            final java.util.List<android.view.inputmethod.InputMethodSubtype> subtypes = getEnabledInputMethodSubtypeList(imi, true);
            final int subtypeCount = subtypes.size();
            for (int subtypeIndex = 0; subtypeIndex < subtypeCount; ++subtypeIndex) {
                final android.view.inputmethod.InputMethodSubtype subtype = imi.getSubtypeAt(subtypeIndex);
                if (android.view.inputmethod.InputMethodManager.SUBTYPE_MODE_VOICE.equals(subtype.getMode())) {
                    return java.util.Collections.singletonMap(imi, java.util.Collections.singletonList(subtype));
                }
            }
        }
     ...
     * display is placed.
     *
     * @param childDisplayId
     * 		Display ID of the embedded virtual display.
     * @param matrix
     * 		{@link Matrix} to convert virtual display screen coordinates to
     * 		the host screen coordinates. {@code null} to clear the relationship.
     * @unknown 
     */
    public void reportActivityView(int childDisplayId, @android.annotation.Nullable
    ...
    public boolean switchToLastInputMethod(android.os.IBinder imeToken) {
        return com.android.internal.inputmethod.InputMethodPrivilegedOperationsRegistry.get(imeToken).switchToPreviousInputMethod();
    }
     ...
     */
    @java.lang.Deprecated
    public void setAdditionalInputMethodSubtypes(java.lang.String imiId, android.view.inputmethod.InputMethodSubtype[] subtypes) {
        try {
    ...
    private void maybeCallServedViewChangedLocked(android.view.inputmethod.EditorInfo tba) {
        if (mImeInsetsConsumer != null) {
    ...
    void doDump(java.io.FileDescriptor fd, java.io.PrintWriter fout, java.lang.String[] args) {
        ...
        p.println("  mCompletions=" + java.util.Arrays.toString(mCompletions));
    ...
    private static java.lang.String dumpViewInfo(@android.annotation.Nullable
    final android.view.View view) {
        if (view == null) {
            return "null";
        }
        ...
        sb.append(",autofillUiShowing=" + android.view.inputmethod.InputMethodManager.isAutofillUIShowing(view));
