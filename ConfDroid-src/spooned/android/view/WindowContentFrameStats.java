 ...
 * has to draw a frame at a specific time interval obtained by calling {@link #getRefreshPeriodNano()}. If the application does not render a frame every refresh
...
public final class WindowContentFrameStats extends android.view.FrameStats implements android.os.Parcelable {
     ...
     * @param framesPostedTimeNano
     * 		The times in milliseconds for when the frame contents were posted.
     * @param framesPresentedTimeNano
     * 		The times in milliseconds for when the frame contents were presented.
     * @param framesReadyTimeNano
    ...
    public static final android.os.Parcelable.Creator<android.view.WindowContentFrameStats> CREATOR = new android.view.Creator<android.view.WindowContentFrameStats>() {
        @java.lang.Override
        ...
        @java.lang.Override
        public android.view.WindowContentFrameStats[] newArray(int size) {
            return new android.view.WindowContentFrameStats[size];
        }
    };
}
