...
public interface PropertyReader {
     ...
     *
     * @param id
     * 		Identifier of the property from a {@link PropertyMapper}
     * @param value
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code boolean}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code byte}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code char}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code double}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code float}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as an {@code int}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code long}
     */
     ...
     * 		Value of the property
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a {@code short}
     */
     ...
     */
    void readObject(int id, @android.annotation.Nullable
     ...
     */
    void readColor(int id, @android.annotation.ColorInt
    int value);
     ...
     * 		Identifier of the property from a {@link PropertyMapper}
     * @param value
     * 		Value of the property packed as a {@code ColorLong}. See the
     * 		{@link Color} class for details of the packing.
     * @throws PropertyTypeMismatchException
     * 		If the property ID is not mapped as a color
     */
    void readColor(int id, @android.annotation.ColorLong
    long value);
     ...
     * 		If the property ID is not mapped as a color
     */
    void readColor(int id, @android.annotation.Nullable
     ...
     */
    void readResourceId(int id, @android.annotation.AnyRes
    int value);

    /**
     * Thrown if a client calls a typed read method for a property of a different type.
     */
    class PropertyTypeMismatchException extends java.lang.RuntimeException {
        public PropertyTypeMismatchException(int id, @android.annotation.NonNull
        java.lang.String expectedPropertyType, @android.annotation.NonNull
        java.lang.String actualPropertyType, @android.annotation.Nullable
        java.lang.String propertyName) {
            super(android.view.inspector.PropertyReader.PropertyTypeMismatchException.formatMessage(id, expectedPropertyType, actualPropertyType, propertyName));
        }

        public PropertyTypeMismatchException(int id, @android.annotation.NonNull
        java.lang.String expectedPropertyType, @android.annotation.NonNull
        java.lang.String actualPropertyType) {
            super(android.view.inspector.PropertyReader.PropertyTypeMismatchException.formatMessage(id, expectedPropertyType, actualPropertyType, null));
        }

        @android.annotation.NonNull
        private static java.lang.String formatMessage(int id, @android.annotation.NonNull
        java.lang.String expectedPropertyType, @android.annotation.NonNull
        java.lang.String actualPropertyType, @android.annotation.Nullable
        java.lang.String propertyName) {
            if (propertyName == null) {
                return java.lang.String.format("Attempted to read property with ID 0x%08X as type %s, " + "but the ID is of type %s.", id, expectedPropertyType, actualPropertyType);
            } else {
                return java.lang.String.format("Attempted to read property \"%s\" with ID 0x%08X as type %s, " + "but the ID is of type %s.", propertyName, id, expectedPropertyType, actualPropertyType);
            }
        }
    }
}
