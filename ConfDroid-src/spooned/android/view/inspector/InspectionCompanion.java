 ...
 *
 * @param <T>
 * 		The type of inspectable this is the companion to
 */
public interface InspectionCompanion<T> {
     ...
     * 		A {@link PropertyMapper} maps string names to IDs.
     */
    void mapProperties(@android.annotation.NonNull
     ...
     */
    void readProperties(@android.annotation.NonNull
    T inspectable, @android.annotation.NonNull
     ...
     */
    class UninitializedPropertyMapException extends java.lang.RuntimeException {
