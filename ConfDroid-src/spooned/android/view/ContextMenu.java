...
public interface ContextMenu extends android.view.Menu {
     ...
     */
    public android.view.ContextMenu setHeaderTitle(@android.annotation.StringRes
    int titleRes);
     ...
     * @return This ContextMenu so additional setters can be called.
     */
    public android.view.ContextMenu setHeaderIcon(@android.annotation.DrawableRes
    int iconRes);
