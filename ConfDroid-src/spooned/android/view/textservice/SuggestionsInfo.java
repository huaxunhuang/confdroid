...
public final class SuggestionsInfo implements android.os.Parcelable {
    private static final java.lang.String[] EMPTY = com.android.internal.util.ArrayUtils.emptyArray(java.lang.String.class);
     ...
     */
    public static final int RESULT_ATTR_IN_THE_DICTIONARY = 0x1;
     ...
     */
    public static final int RESULT_ATTR_LOOKS_LIKE_TYPO = 0x2;
     ...
     */
    public static final int RESULT_ATTR_HAS_RECOMMENDED_SUGGESTIONS = 0x4;
     ...
     * Constructor.
     *
     * @param suggestionsAttributes
     * 		from the text service
     * @param suggestions
     * 		from the text service
     */
    public SuggestionsInfo(int suggestionsAttributes, java.lang.String[] suggestions) {
     ...
     * 		the cookie of the input TextInfo
     */
    public SuggestionsInfo(int suggestionsAttributes, java.lang.String[] suggestions, int cookie, int sequence) {
        if (suggestions == null) {
            mSuggestions = android.view.textservice.SuggestionsInfo.EMPTY;
    ...
    public static final android.os.Parcelable.Creator<android.view.textservice.SuggestionsInfo> CREATOR = new android.os.Parcelable.Creator<android.view.textservice.SuggestionsInfo>() {
        @java.lang.Override
        public android.view.textservice.SuggestionsInfo createFromParcel(android.os.Parcel source) {
            return new android.view.textservice.SuggestionsInfo(source);
        }

        @java.lang.Override
        public android.view.textservice.SuggestionsInfo[] newArray(int size) {
            return new android.view.textservice.SuggestionsInfo[size];
        }
    };
