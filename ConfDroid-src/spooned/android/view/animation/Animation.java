...
public abstract class Animation implements java.lang.Cloneable {
     ...
     */
    int mRepeatMode = android.view.animation.Animation.RESTART;
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 117519981)
    ...
    public Animation(android.content.Context context, android.util.AttributeSet attrs) {
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, android.view.animation.com.android.internal.R.styleable.Animation);
        setDuration(((long) (a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_duration, 0))));
        setStartOffset(((long) (a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_startOffset, 0))));
        setFillEnabled(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_fillEnabled, mFillEnabled));
        setFillBefore(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_fillBefore, mFillBefore));
        setFillAfter(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_fillAfter, mFillAfter));
        setRepeatCount(a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_repeatCount, mRepeatCount));
        setRepeatMode(a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_repeatMode, android.view.animation.Animation.RESTART));
        setZAdjustment(a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_zAdjustment, android.view.animation.Animation.ZORDER_NORMAL));
        setBackgroundColor(a.getInt(android.view.animation.com.android.internal.R.styleable.Animation_background, 0));
        setDetachWallpaper(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_detachWallpaper, false));
        setShowWallpaper(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_showWallpaper, false));
        setHasRoundedCorners(a.getBoolean(android.view.animation.com.android.internal.R.styleable.Animation_hasRoundedCorners, false));
        final int resID = a.getResourceId(android.view.animation.com.android.internal.R.styleable.Animation_interpolator, 0);
        a.recycle();
        if (resID > 0) {
    ...
    protected android.view.animation.Animation clone() throws java.lang.CloneNotSupportedException {
        final android.view.animation.Animation animation = ((android.view.animation.Animation) (super.clone()));
    ...
    public void setListenerHandler(android.os.Handler handler) {
        if (mListenerHandler == null) {
            mOnStart = new java.lang.Runnable() {
                public void run() {
                    dispatchAnimationStart();
                }
            };
            mOnRepeat = new java.lang.Runnable() {
                public void run() {
                    dispatchAnimationRepeat();
                }
            };
            mOnEnd = new java.lang.Runnable() {
                public void run() {
     ...
     * @unknown ref android.R.styleable#Animation_interpolator
     */
    public void setInterpolator(android.content.Context context, @android.annotation.AnimRes
     ...
     * @unknown ref android.R.styleable#Animation_startOffset
     */
     ...
     * @unknown ref android.R.styleable#Animation_duration
     */
     ...
     * @param repeatMode
     * 		{@link #RESTART} or {@link #REVERSE}
     * @unknown ref android.R.styleable#Animation_repeatMode
     */
     ...
     * @unknown ref android.R.styleable#Animation_repeatCount
     */
     ...
     * @unknown ref android.R.styleable#Animation_fillEnabled
     */
     ...
     *
     * @param fillEnabled
     * 		true if the animation should take the value of fillBefore into account
     * @unknown ref android.R.styleable#Animation_fillEnabled
     ...
     * Note that this applies when using an {@link android.view.animation.AnimationSet AnimationSet} to chain
     * animations. The transformation is not applied before the AnimationSet
     * itself starts.
     *
     * @param fillBefore
     * 		true if the animation should apply its transformation before it starts
     * @unknown ref android.R.styleable#Animation_fillBefore
     ...
     * Note that this applies to individual animations and when using an {@link android.view.animation.AnimationSet AnimationSet} to chain
     * animations.
     *
     * @param fillAfter
     * 		true if the animation should apply its transformation after it ends
     * @unknown ref android.R.styleable#Animation_fillAfter
     * @see #setFillEnabled(boolean)
     */
     ...
     * @unknown ref android.R.styleable#Animation_zAdjustment
     */
     ...
     */
    public void setBackgroundColor(@android.annotation.ColorInt
    int bg) {
        mBackgroundColor = bg;
    }
     ...
     * @unknown ref android.R.styleable#Animation_detachWallpaper
     ...
     *
     * @param showWallpaper
     * 		Whether the wallpaper should be shown during the animation.
     * @unknown ref android.R.styleable#Animation_detachWallpaper
     * @unknown 
     */
     ...
     * corner radius.
     *
     * @param hasRoundedCorners
     * 		Whether the window should have rounded corners or not.
     * @unknown ref android.R.styleable#Animation_hasRoundedCorners
     ...
     * @unknown ref android.R.styleable#Animation_showWallpaper
     * @unknown 
     */
     ...
     */
    public boolean getTransformation(long currentTime, android.view.animation.Transformation outTransformation) {
        if (mStartTime == (-1)) {
        ...
        mMore = !expired;
        if (!mFillEnabled)
            normalizedTime = java.lang.Math.max(java.lang.Math.min(normalizedTime, 1.0F), 0.0F);
        ...
        if (expired) {
            if ((mRepeatCount == mRepeated) || isCanceled()) {
                ...
                if (mRepeatMode == android.view.animation.Animation.REVERSE) {
    ...
    private boolean isCanceled() {
        return mStartTime == java.lang.Long.MIN_VALUE;
    }
     ...
     * @return True if the animation is still running
     */
    public boolean getTransformation(long currentTime, android.view.animation.Transformation outTransformation, float scale) {
        mScaleFactor = scale;
    ...
    protected float resolveSize(int type, float value, int size, int parentSize) {
        switch (type) {
            case android.view.animation.Animation.ABSOLUTE :
                return value;
            case android.view.animation.Animation.RELATIVE_TO_SELF :
                return size * value;
            case android.view.animation.Animation.RELATIVE_TO_PARENT :
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public void getInvalidateRegion(int left, int top, int right, int bottom, android.graphics.RectF invalidate, android.view.animation.Transformation transformation) {
        final android.graphics.RectF tempRegion = mRegion;
        final android.graphics.RectF previousRegion = mPreviousRegion;
        ...
        final android.view.animation.Transformation tempTransformation = mTransformation;
    ...
    protected static class Description {
         ...
         */
        static android.view.animation.Animation.Description parseValue(android.util.TypedValue value) {
            android.view.animation.Animation.Description d = new android.view.animation.Animation.Description();
            if (value == null) {
                d.type = android.view.animation.Animation.ABSOLUTE;
                d.value = 0;
            } else {
                if (value.type == android.util.TypedValue.TYPE_FRACTION) {
                    d.type = ((value.data & android.util.TypedValue.COMPLEX_UNIT_MASK) == android.util.TypedValue.COMPLEX_UNIT_FRACTION_PARENT) ? android.view.animation.Animation.RELATIVE_TO_PARENT : android.view.animation.Animation.RELATIVE_TO_SELF;
