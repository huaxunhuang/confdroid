...
public class PathInterpolator extends android.view.animation.BaseInterpolator implements com.android.internal.view.animation.NativeInterpolatorFactory {
     ...
     *
     * @param path
     * 		The <code>Path</code> to use to make the line representing the interpolator.
     */
    ...
    private void parseInterpolatorFromTypeArray(android.content.res.TypedArray a) {
        ...
        if (a.hasValue(R.styleable.PathInterpolator_pathData)) {
            java.lang.String pathData = a.getString(R.styleable.PathInterpolator_pathData);
            android.graphics.Path path = android.util.PathParser.createPathFromPathData(pathData);
            if (path == null) {
                throw new android.view.InflateException(("The path is null, which is created" + " from ") + pathData);
            }
            initPath(path);
        } else {
            if (!a.hasValue(R.styleable.PathInterpolator_controlX1)) {
                ...
                if (!a.hasValue(R.styleable.PathInterpolator_controlY1)) {
    ...
    private void initPath(android.graphics.Path path) {
        float[] pointComponents = path.approximate(android.view.animation.PathInterpolator.PRECISION);
    ...
    public long createNativeInterpolator() {
        return com.android.internal.view.animation.NativeInterpolatorFactoryHelper.createPathInterpolator(mX, mY);
    }
}
