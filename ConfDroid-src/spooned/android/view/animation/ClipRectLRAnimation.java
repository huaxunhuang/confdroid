...
public class ClipRectLRAnimation extends android.view.animation.ClipRectAnimation {
    ...
    protected void applyTransformation(float it, android.view.animation.Transformation tr) {
        android.graphics.Rect oldClipRect = tr.getClipRect();
        tr.setClipRect(mFromRect.left + ((int) ((mToRect.left - mFromRect.left) * it)), oldClipRect.top, mFromRect.right + ((int) ((mToRect.right - mFromRect.right) * it)), oldClipRect.bottom);
    }
}
