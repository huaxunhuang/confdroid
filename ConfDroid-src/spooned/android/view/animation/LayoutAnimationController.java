 ...
 *
 * @unknown ref android.R.styleable#LayoutAnimation_delay
 * @unknown ref android.R.styleable#LayoutAnimation_animationOrder
 * @unknown ref android.R.styleable#LayoutAnimation_interpolator
 * @unknown ref android.R.styleable#LayoutAnimation_animation
 */
public class LayoutAnimationController {
    ...
    public LayoutAnimationController(android.content.Context context, android.util.AttributeSet attrs) {
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, android.view.animation.com.android.internal.R.styleable.LayoutAnimation);
        android.view.animation.Animation.Description d = android.view.animation.Animation.Description.parseValue(a.peekValue(android.view.animation.com.android.internal.R.styleable.LayoutAnimation_delay));
        mDelay = d.value;
        mOrder = a.getInt(android.view.animation.com.android.internal.R.styleable.LayoutAnimation_animationOrder, android.view.animation.LayoutAnimationController.ORDER_NORMAL);
        int resource = a.getResourceId(android.view.animation.com.android.internal.R.styleable.LayoutAnimation_animation, 0);
        if (resource > 0) {
            setAnimation(context, resource);
        }
        resource = a.getResourceId(android.view.animation.com.android.internal.R.styleable.LayoutAnimation_interpolator, 0);
        if (resource > 0) {
     ...
     * @unknown ref android.R.styleable#LayoutAnimation_animation
     */
    public void setAnimation(android.content.Context context, @android.annotation.AnimRes
    int resourceID) {
    ...
    public void start() {
        ...
        mMaxDelay = java.lang.Long.MIN_VALUE;
    ...
    public final android.view.animation.Animation getAnimationForView(android.view.View view) {
        ...
        mMaxDelay = java.lang.Math.max(mMaxDelay, delay);
        try {
            final android.view.animation.Animation animation = mAnimation.clone();
    ...
    public boolean isDone() {
        return android.view.animation.AnimationUtils.currentAnimationTimeMillis() > ((mAnimation.getStartTime() + mMaxDelay) + mDuration);
    }
    ...
    protected long getDelayForView(android.view.View view) {
        ...
        android.view.animation.LayoutAnimationController.AnimationParameters params = lp.layoutAnimationParameters;
        if (params == null) {
            return 0;
        }
