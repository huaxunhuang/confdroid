...
public class TranslateYAnimation extends android.view.animation.TranslateAnimation {
    ...
    public TranslateYAnimation(int fromYType, float fromYValue, int toYType, float toYValue) {
        super(android.view.animation.Animation.ABSOLUTE, 0, android.view.animation.Animation.ABSOLUTE, 0, fromYType, fromYValue, toYType, toYValue);
    }
    ...
    protected void applyTransformation(float interpolatedTime, android.view.animation.Transformation t) {
        ...
        t.getMatrix().setTranslate(mTmpValues[android.graphics.Matrix.MTRANS_X], dy);
    }
}
