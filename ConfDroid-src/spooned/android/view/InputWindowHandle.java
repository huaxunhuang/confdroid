...
public final class InputWindowHandle {
    ...
    public final android.view.InputApplicationHandle inputApplicationHandle;
    ...
    public int portalToDisplayId = android.view.Display.INVALID_DISPLAY;
     ...
     */
    public java.lang.ref.WeakReference<android.os.IBinder> touchableRegionCropHandle = new java.lang.ref.WeakReference<>(null);
    ...
    public InputWindowHandle(android.view.InputApplicationHandle inputApplicationHandle, android.view.IWindow clientWindow, int displayId) {
    ...
    public java.lang.String toString() {
        return new java.lang.StringBuilder(name != null ? name : "").append(", layer=").append(layer).append(", frame=[").append(frameLeft).append(",").append(frameTop).append(",").append(frameRight).append(",").append(frameBottom).append("]").append(", touchableRegion=").append(touchableRegion).append(", visible=").append(visible).toString();
    }
     ...
     *
     * @param bounds
     * 		surface to set the touchable region to. Set to {@code null} to set the bounds
     * 		to the current surface.
     */
    public void replaceTouchableRegionWithCrop(@android.annotation.Nullable
    android.view.SurfaceControl bounds) {
     ...
     */
    public void setTouchableRegionCrop(@android.annotation.Nullable
    android.view.SurfaceControl bounds) {
        if (bounds != null) {
            touchableRegionCropHandle = new java.lang.ref.WeakReference(bounds.getHandle());
        }
    }
}
