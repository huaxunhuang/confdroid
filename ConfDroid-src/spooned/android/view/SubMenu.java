...
public interface SubMenu extends android.view.Menu {
     ...
     */
    public android.view.SubMenu setHeaderTitle(@android.annotation.StringRes
    int titleRes);
     ...
     * @return This SubMenu so additional setters can be called.
     */
    public android.view.SubMenu setHeaderIcon(@android.annotation.DrawableRes
    int iconRes);
     ...
     * @return This SubMenu so additional setters can be called.
     */
    public android.view.SubMenu setIcon(@android.annotation.DrawableRes
    int iconRes);
