...
public final class ViewAnimationUtils {
     ...
     */
    public static android.animation.Animator createCircularReveal(android.view.View view, int centerX, int centerY, float startRadius, float endRadius) {
        return new android.animation.RevealAnimator(view, centerX, centerY, startRadius, endRadius);
    }
}
