...
public interface Menu {
     ...
     * @unknown 
     */
    static final int USER_MASK = 0xffff;
     ...
     */
    static final int SUPPORTED_MODIFIERS_MASK = ((((android.view.KeyEvent.META_META_ON | android.view.KeyEvent.META_CTRL_ON) | android.view.KeyEvent.META_ALT_ON) | android.view.KeyEvent.META_SHIFT_ON) | android.view.KeyEvent.META_SYM_ON) | android.view.KeyEvent.META_FUNCTION_ON;
     ...
     * your base value.
     */
    static final int CATEGORY_SECONDARY = 0x30000;
     ...
     * the prepared state.
     */
    static final int FLAG_ALWAYS_PERFORM_CLOSE = 0x2;
     ...
     * @return The newly added menu item.
     */
    public android.view.MenuItem add(@android.annotation.StringRes
    int titleRes);
     ...
     * 		group.
     * @param itemId
     * 		Unique item ID. Use {@link #NONE} if you do not need a
     * 		unique ID.
     * @param order
     ...
     * @return The newly added menu item.
     */
    public android.view.MenuItem add(int groupId, int itemId, int order, @android.annotation.StringRes
    int titleRes);
     ...
     */
    android.view.SubMenu addSubMenu(final java.lang.CharSequence title);
     ...
     * @return The newly added sub-menu
     */
    android.view.SubMenu addSubMenu(@android.annotation.StringRes
    final int titleRes);
     ...
     * @return The newly added sub-menu
     */
    android.view.SubMenu addSubMenu(final int groupId, final int itemId, int order, final java.lang.CharSequence title);
     ...
     * @param order
     * 		The order for the item. Use {@link #NONE} if you do not care about the
     * 		order. See {@link MenuItem#getOrder()}.
     * @param titleRes
     * 		Resource identifier of title string.
     * @return The newly added sub-menu
     */
    android.view.SubMenu addSubMenu(int groupId, int itemId, int order, @android.annotation.StringRes
    int titleRes);
     ...
     * 		unique ID.
     * @param order
     * 		The order for the items. Use {@link #NONE} if you do not
