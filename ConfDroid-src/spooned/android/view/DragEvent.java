...
public class DragEvent implements android.os.Parcelable {
    ...
    private void init(int action, float x, float y, android.content.ClipDescription description, android.content.ClipData data, com.android.internal.view.IDragAndDropPermissions dragAndDropPermissions, java.lang.Object localState, boolean result) {
        mAction = action;
        mX = x;
        mY = y;
    ...
    static android.view.DragEvent obtain() {
        return android.view.DragEvent.obtain(0, 0.0F, 0.0F, null, null, null, null, false);
    }
     ...
     * @unknown 
     */
    public static android.view.DragEvent obtain(int action, float x, float y, java.lang.Object localState, android.content.ClipDescription description, android.content.ClipData data, com.android.internal.view.IDragAndDropPermissions dragAndDropPermissions, boolean result) {
        final android.view.DragEvent ev;
        synchronized(android.view.DragEvent.gRecyclerLock) {
            if (android.view.DragEvent.gRecyclerTop == null) {
                ev = new android.view.DragEvent();
                ev.init(action, x, y, description, data, dragAndDropPermissions, localState, result);
                return ev;
            }
            ev = android.view.DragEvent.gRecyclerTop;
            android.view.DragEvent.gRecyclerTop = ev.mNext;
            android.view.DragEvent.gRecyclerUsed -= 1;
        }
    ...
    public static android.view.DragEvent obtain(android.view.DragEvent source) {
        return android.view.DragEvent.obtain(source.mAction, source.mX, source.mY, source.mLocalState, source.mClipDescription, source.mClipData, source.mDragAndDropPermissions, source.mDragResult);
    }
    ...
    public final void recycle() {
        ...
        if (android.view.DragEvent.TRACK_RECYCLED_LOCATION) {
            if (mRecycledLocation != null) {
                throw new java.lang.RuntimeException(toString() + " recycled twice!", mRecycledLocation);
            }
            mRecycledLocation = new java.lang.RuntimeException("Last recycled here");
        } else {
            if (mRecycled) {
        ...
        synchronized(android.view.DragEvent.gRecyclerLock) {
            if (android.view.DragEvent.gRecyclerUsed < android.view.DragEvent.MAX_RECYCLED) {
                android.view.DragEvent.gRecyclerUsed++;
                mNext = android.view.DragEvent.gRecyclerTop;
                android.view.DragEvent.gRecyclerTop = this;
            }
        }
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("DragEvent{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " action=") + mAction) + " @ (") + mX) + ", ") + mY) + ") desc=") + mClipDescription) + " data=") + mClipData) + " local=") + mLocalState) + " result=") + mDragResult) + "}";
    }
     ...
     *
     * @param dest
     * 		A {@link android.os.Parcel} object in which to put the DragEvent object.
     * @param flags
    ...
    public static final android.os.Parcelable.Creator<android.view.DragEvent> CREATOR = new android.os.Parcelable.Creator<android.view.DragEvent>() {
