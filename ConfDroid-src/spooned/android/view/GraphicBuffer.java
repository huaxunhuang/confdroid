...
public class GraphicBuffer implements android.os.Parcelable {
    ...
    public static final int USAGE_SOFTWARE_MASK = android.view.GraphicBuffer.USAGE_SW_READ_MASK | android.view.GraphicBuffer.USAGE_SW_WRITE_MASK;
     ...
     */
    public static android.view.GraphicBuffer create(int width, int height, int format, int usage) {
        long nativeObject = android.view.GraphicBuffer.nCreateGraphicBuffer(width, height, format, usage);
        if (nativeObject != 0) {
            return new android.view.GraphicBuffer(width, height, format, usage, nativeObject);
        }
        return null;
    }
    ...
    public android.graphics.Canvas lockCanvas(android.graphics.Rect dirty) {
        ...
        if (android.view.GraphicBuffer.nLockCanvas(mNativeObject, mCanvas, dirty)) {
    ...
    public void unlockCanvasAndPost(android.graphics.Canvas canvas) {
        if (((!mDestroyed) && (mCanvas != null)) && (canvas == mCanvas)) {
            ...
            mSaveCount = 0;
            android.view.GraphicBuffer.nUnlockCanvasAndPost(mNativeObject, mCanvas);
        }
    }
    ...
    public void destroy() {
        if (!mDestroyed) {
            mDestroyed = true;
            android.view.GraphicBuffer.nDestroyGraphicBuffer(mNativeObject);
        }
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        android.view.GraphicBuffer.nWriteGraphicBufferToParcel(mNativeObject, dest);
    }

    public static final android.os.Parcelable.Creator<android.view.GraphicBuffer> CREATOR = new android.os.Parcelable.Creator<android.view.GraphicBuffer>() {
        public android.view.GraphicBuffer createFromParcel(android.os.Parcel in) {
            int width = in.readInt();
            int height = in.readInt();
            int format = in.readInt();
            int usage = in.readInt();
            long nativeObject = android.view.GraphicBuffer.nReadGraphicBufferFromParcel(in);
            if (nativeObject != 0) {
                return new android.view.GraphicBuffer(width, height, format, usage, nativeObject);
            }
            return null;
        ...
        public android.view.GraphicBuffer[] newArray(int size) {
            return new android.view.GraphicBuffer[size];
        }
    };
