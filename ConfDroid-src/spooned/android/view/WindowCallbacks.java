...
public interface WindowCallbacks {
     ...
     *
     * @param newBounds
     * 		The new window frame bounds.
     * @param fullscreen
     * 		Whether the window is currently drawing in fullscreen.
     * @param systemInsets
     * 		The current visible system insets for the window.
     * @param stableInsets
     * 		The stable insets for the window.
     */
    void onWindowSizeIsChanging(android.graphics.Rect newBounds, boolean fullscreen, android.graphics.Rect systemInsets, android.graphics.Rect stableInsets);

    /**
     * Called when a drag resize starts.
     *
     * @param initialBounds
     * 		The initial bounds where the window will be.
     * @param fullscreen
     * 		Whether the window is currently drawing in fullscreen.
     * @param systemInsets
     * 		The current visible system insets for the window.
     ...
     * 		The stable insets for the window.
     */
    void onWindowDragResizeStart(android.graphics.Rect initialBounds, boolean fullscreen, android.graphics.Rect systemInsets, android.graphics.Rect stableInsets, int resizeMode);
     ...
     *
     * @param reportNextDraw
     * 		Whether it should report when the requested draw finishes.
     */
