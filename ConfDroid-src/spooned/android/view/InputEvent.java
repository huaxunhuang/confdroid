...
public abstract class InputEvent implements android.os.Parcelable {
    ...
    /* package */
    InputEvent() {
        mSeq = android.view.InputEvent.mNextSeq.getAndIncrement();
    }
     ...
     */
    public void recycle() {
        if (android.view.InputEvent.TRACK_RECYCLED_LOCATION) {
    ...
    public static final android.os.Parcelable.Creator<android.view.InputEvent> CREATOR = new android.os.Parcelable.Creator<android.view.InputEvent>() {
