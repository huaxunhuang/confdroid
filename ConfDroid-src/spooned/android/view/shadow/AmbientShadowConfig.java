...
class AmbientShadowConfig {
    ...
    private AmbientShadowConfig(android.view.shadow.AmbientShadowConfig.Builder builder) {
    ...
    public static class Builder {
        ...
        public android.view.shadow.AmbientShadowConfig.Builder setEdgeScale(float edgeScale) {
            mEdgeScale = edgeScale;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setShadowBoundRatio(float shadowBoundRatio) {
            mShadowBoundRatio = shadowBoundRatio;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setShadowStrength(float shadowStrength) {
            mShadowStrength = shadowStrength;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setRays(int rays) {
            mRays = rays;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setLayers(int layers) {
            mLayers = layers;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setSize(int width, int height) {
            mWidth = width;
            mHeight = height;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig.Builder setPolygon(float[] polygon) {
            mPolygon = polygon;
            return this;
        }

        public android.view.shadow.AmbientShadowConfig build() {
            return new android.view.shadow.AmbientShadowConfig(this);
        }
    }
}
