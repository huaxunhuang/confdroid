...
class SpotShadowConfig {
    ...
    private SpotShadowConfig(android.view.shadow.SpotShadowConfig.Builder builder) {
     ...
     *
     * @param x
     * 		- x in {@link #getWidth()} coordinate
     * @param y
     * 		- y in {@link #getHeight()} coordinate
     */
    ...
    public static class Builder {
         ...
         * 		from 0 to 1
         */
        public android.view.shadow.SpotShadowConfig.Builder setShadowStrength(float shadowStrength) {
            this.mShadowStrength = shadowStrength;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setSize(int width, int height) {
            mWidth = width;
            mHeight = height;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setLightRadius(int mLightRadius) {
            this.mLightRadius = mLightRadius;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setLightSourcePoints(int mLightSourcePoints) {
            this.mLightSourcePoints = mLightSourcePoints;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setRays(int mRays) {
            this.mRays = mRays;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setLayers(int mLayers) {
            this.mLayers = mLayers;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setPolygon(float[] poly, int polyLength) {
            this.mPoly = poly;
            this.mPolyLength = polyLength;
            return this;
        }

        public android.view.shadow.SpotShadowConfig.Builder setLightCoord(float lightX, float lightY, float lightHeight) {
            this.mLightX = lightX;
            this.mLightY = lightY;
        ...
        public android.view.shadow.SpotShadowConfig build() {
            return new android.view.shadow.SpotShadowConfig(this);
        }
    }
}
