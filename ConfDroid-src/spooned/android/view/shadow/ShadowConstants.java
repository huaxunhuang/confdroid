...
class ShadowConstants {
    ...
    public static final int SPOT_SHADOW_LIGHT_Z_HEIGHT_DP = 50 / android.view.shadow.ShadowConstants.SCALE_DOWN;

    public static final int SPOT_SHADOW_LIGHT_Z_EPSILON = 10 / android.view.shadow.ShadowConstants.SCALE_DOWN;

    public static final float SPOT_SHADOW_STRENGTH = 0.3F;

    public static final float AMBIENT_SHADOW_EDGE_SCALE = 60.0F;

    public static final float AMBIENT_SHADOW_SHADOW_BOUND = 0.02F * android.view.shadow.ShadowConstants.SCALE_DOWN;
