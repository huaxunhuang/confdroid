...
public final class VelocityTracker {
    private static final android.util.Pools.SynchronizedPool<android.view.VelocityTracker> sPool = new android.util.Pools.SynchronizedPool<android.view.VelocityTracker>(2);
    ...
    private static native void nativeAddMovement(long ptr, android.view.MotionEvent event);
    ...
    public static android.view.VelocityTracker obtain() {
        android.view.VelocityTracker instance = android.view.VelocityTracker.sPool.acquire();
        return instance != null ? instance : new android.view.VelocityTracker(null);
    }
     ...
     *
     * @param strategy
     * 		The strategy, or null to use the default.
    ...
    public static android.view.VelocityTracker obtain(java.lang.String strategy) {
        ...
        return new android.view.VelocityTracker(strategy);
    }
    ...
    private VelocityTracker(java.lang.String strategy) {
        mPtr = android.view.VelocityTracker.nativeInitialize(strategy);
        mStrategy = strategy;
    }
    ...
    protected void finalize() throws java.lang.Throwable {
        try {
            if (mPtr != 0) {
                android.view.VelocityTracker.nativeDispose(mPtr);
                mPtr = 0;
            }
        } finally {
            super.finalize();
     ...
     */
    public void clear() {
        android.view.VelocityTracker.nativeClear(mPtr);
    }
    ...
    public void addMovement(android.view.MotionEvent event) {
        ...
        android.view.VelocityTracker.nativeAddMovement(mPtr, event);
    }
    ...
    public void computeCurrentVelocity(int units) {
        android.view.VelocityTracker.nativeComputeCurrentVelocity(mPtr, units, java.lang.Float.MAX_VALUE);
    }
    ...
    public void computeCurrentVelocity(int units, float maxVelocity) {
        android.view.VelocityTracker.nativeComputeCurrentVelocity(mPtr, units, maxVelocity);
    }
    ...
    public float getXVelocity() {
        return android.view.VelocityTracker.nativeGetXVelocity(mPtr, android.view.VelocityTracker.ACTIVE_POINTER_ID);
    }
    ...
    public float getYVelocity() {
        return android.view.VelocityTracker.nativeGetYVelocity(mPtr, android.view.VelocityTracker.ACTIVE_POINTER_ID);
    }
    ...
    public float getXVelocity(int id) {
        return android.view.VelocityTracker.nativeGetXVelocity(mPtr, id);
    }
    ...
    public float getYVelocity(int id) {
        return android.view.VelocityTracker.nativeGetYVelocity(mPtr, id);
    }
     ...
     * @unknown For internal use only.  Not a final API.
     */
    public boolean getEstimator(int id, android.view.VelocityTracker.Estimator outEstimator) {
        if (outEstimator == null) {
            throw new java.lang.IllegalArgumentException("outEstimator must not be null");
        }
        return android.view.VelocityTracker.nativeGetEstimator(mPtr, id, outEstimator);
    }
    ...
    public static final class Estimator {
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public final float[] xCoeff = new float[android.view.VelocityTracker.Estimator.MAX_DEGREE + 1];

        /**
         * Polynomial coefficients describing motion in Y.
         */
        @android.annotation.UnsupportedAppUsage
        public final float[] yCoeff = new float[android.view.VelocityTracker.Estimator.MAX_DEGREE + 1];
         ...
         *
         * @param time
         * 		The time point in seconds, 0 is the last recorded time.
