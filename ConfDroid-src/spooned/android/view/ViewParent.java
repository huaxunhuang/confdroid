...
public interface ViewParent {
     ...
     */
    default void onDescendantInvalidated(@android.annotation.NonNull
     ...
     * 		The starting point of the search. Null means the current cluster is not
     * 		found yet
     * @param direction
     * 		Direction to look
    ...
    can be found
     */
    android.view.View keyboardNavigationClusterSearch(android.view.View currentCluster, int direction);
    ...
    otherwise
     */
    boolean showContextMenuForChild(android.view.View originalView, float x, float y);
     ...
     * @param source
     * 		The descendant view that changed. May not be {@code null}.
     * @param changeType
     ...
     * 		</ul>
     */
    public void notifySubtreeAccessibilityStateChanged(android.view.View child, @android.annotation.NonNull
    android.view.View source, int changeType);
     ...
     * 		Flags consisting of {@link View#SCROLL_AXIS_HORIZONTAL},
     ...
     *
     * @param touchableRegion
     * 		The touchable region we want to modify.
     * @param view
     * 		A child view of this ViewGroup which indicates the z-order of the touchable
     * 		region.
     * @unknown 
     */
    default void subtractObscuredTouchableRegion(android.graphics.Region touchableRegion, android.view.View view) {
    }
}
