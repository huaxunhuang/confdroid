...
public interface ScrollCaptureCallback {
     ...
     */
    void onScrollCaptureSearch(@android.annotation.NonNull
    java.util.function.Consumer<android.graphics.Rect> onReady);
     ...
     */
    void onScrollCaptureStart(@android.annotation.NonNull
    android.view.ScrollCaptureSession session, @android.annotation.NonNull
    java.lang.Runnable onReady);
     ...
     * here.
     * <p>
     * A series of requests will step by a constant vertical amount relative to {@code scrollBounds}, moving through the scrolling range of content, above and below the current
     ...
     * visible content to capture. If the rectangle is completely clipped, set it to {@link Rect#setEmpty() empty} and skip the next step.
     * <p>
     ...
     *
     * @param captureArea
     * 		the area to capture, a rectangle within {@code scrollBounds}
     */
    void onScrollCaptureImageRequest(@android.annotation.NonNull
    android.view.ScrollCaptureSession session, @android.annotation.NonNull
    android.graphics.Rect captureArea);
     ...
     *
     * @param onReady
     * 		a callback to inform the system that the application has completed any
     * 		cleanup and is ready to become visible
     */
    void onScrollCaptureEnd(@android.annotation.NonNull
    java.lang.Runnable onReady);
}
