...
public class TouchDelegate {
     ...
     *
     * @param event
     * 		The hover event to forward
     * @return True if the event was consumed by the delegate, false otherwise.
     * @see android.view.accessibility.AccessibilityManager#isTouchExplorationEnabled
     */
    public boolean onTouchExplorationHoverEvent(@android.annotation.NonNull
    android.view.MotionEvent event) {
        if (mBounds == null) {
            return false;
        }
    ...
    public android.view.accessibility.AccessibilityNodeInfo.TouchDelegateInfo getTouchDelegateInfo() {
        if (mTouchDelegateInfo == null) {
            final android.util.ArrayMap<android.graphics.Region, android.view.View> targetMap = new android.util.ArrayMap(1);
            android.graphics.Rect bounds = mBounds;
            if (bounds == null) {
                bounds = new android.graphics.Rect();
            }
            targetMap.put(new android.graphics.Region(bounds), mDelegateView);
            mTouchDelegateInfo = new android.view.accessibility.AccessibilityNodeInfo.TouchDelegateInfo(targetMap);
        }
