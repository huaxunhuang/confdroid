...
public abstract class AccessibilityRequestPreparer {
    public static final int REQUEST_TYPE_EXTRA_DATA = 0x1;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "REQUEST_TYPE_" }, value = { android.view.accessibility.AccessibilityRequestPreparer.REQUEST_TYPE_EXTRA_DATA })
     ...
     *
     * @param view
     * 		The view whose requests need preparation. It must be attached to a
     ...
     * 		itself.
     * @param requestTypes
     * 		The types of requests that require preparation. Different types may
     * 		be ORed together.
     * @throws IllegalStateException
     * 		if the view is not attached to a window.
     */
    public AccessibilityRequestPreparer(android.view.View view, @android.view.accessibility.AccessibilityRequestPreparer.RequestTypes
    int requestTypes) {
        if (!view.isAttachedToWindow()) {
            throw new java.lang.IllegalStateException("View must be attached to a window");
        }
        mViewRef = new java.lang.ref.WeakReference<>(view);
     ...
     *
     * @param virtualViewId
     * 		The ID of a virtual child node, if the {@link View} for this preparer
     ...
     * @param preparationFinishedMessage
     * 		A message that must be sent to its target when preparations
     * 		are complete.
    ...
    private class ViewAttachStateListener implements android.view.View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(android.view.View v) {
            ...
            if (context != null) {
                context.getSystemService(android.view.accessibility.AccessibilityManager.class).removeAccessibilityRequestPreparer(android.view.accessibility.AccessibilityRequestPreparer.this);
            }
