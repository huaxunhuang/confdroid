...
public final class AccessibilityManager {
    private static android.view.accessibility.AccessibilityManager sInstance = new android.view.accessibility.AccessibilityManager(null, null, 0);
    ...
    public interface HighTextContrastChangeListener {
         ...
         *
         * @param enabled
         * 		Whether high text contrast is enabled.
         */
    ...
    public interface AccessibilityPolicy {
         ...
         * 		Whether the accessibility layer is enabled.
         ...
         * 		The events relevant events.
         * @return The event to dispatch or null.
         */
        @android.annotation.Nullable
        android.view.accessibility.AccessibilityEvent onAccessibilityEvent(@android.annotation.NonNull
        android.view.accessibility.AccessibilityEvent event, boolean accessibilityEnabled, @android.view.accessibility.AccessibilityEvent.EventType
        ...
        int getRelevantEventTypes(@android.view.accessibility.AccessibilityEvent.EventType
        int relevantEventTypes);
        ...
        java.util.List<android.accessibilityservice.AccessibilityServiceInfo> getInstalledAccessibilityServiceList(@android.annotation.Nullable
        java.util.List<android.accessibilityservice.AccessibilityServiceInfo> installedService);

        /**
         * Gets the list of enabled accessibility services.
         *
         * @param feedbackTypeFlags
         * 		The feedback type to query for.
         * @param enabledService
         * 		The enabled services.
         * @return The services to report.
         */
        @android.annotation.Nullable
        java.util.List<android.accessibilityservice.AccessibilityServiceInfo> getEnabledAccessibilityServiceList(@android.accessibilityservice.AccessibilityServiceInfo.FeedbackType
        int feedbackTypeFlags, @android.annotation.Nullable
        java.util.List<android.accessibilityservice.AccessibilityServiceInfo> enabledService);
    }

    private final IAccessibilityManagerClient.Stub mClient = new android.view.accessibility.IAccessibilityManagerClient.Stub() {
     ...
     * 		A {@link Context}.
     */
    public AccessibilityManager(android.content.Context context, android.view.accessibility.IAccessibilityManager service, int userId) {
    }
     ...
     */
    public boolean isObservedEventType(@android.view.accessibility.AccessibilityEvent.EventType
    int type) {
        return false;
    }
     ...
     */
    public java.util.List<android.accessibilityservice.AccessibilityServiceInfo> getEnabledAccessibilityServiceList(int feedbackTypeFlags) {
        return java.util.Collections.emptyList();
    }
     ...
     * 		The listener.
     * @param handler
     * 		The handler on which the listener should be called back, or {@code null}
     * 		for a callback on the process's main handler.
     */
    public void addAccessibilityStateChangeListener(@android.annotation.NonNull
    android.view.accessibility.AccessibilityManager.AccessibilityStateChangeListener listener, @android.annotation.Nullable
     ...
     * @return True if successfully registered.
     */
    public boolean addTouchExplorationStateChangeListener(@android.annotation.NonNull
     ...
     * 		for a callback on the process's main handler.
     */
    public void addTouchExplorationStateChangeListener(@android.annotation.NonNull
    android.view.accessibility.AccessibilityManager.TouchExplorationStateChangeListener listener, @android.annotation.Nullable
    android.os.Handler handler) {
    }
     ...
     */
    public boolean removeTouchExplorationStateChangeListener(@android.annotation.NonNull
    android.view.accessibility.AccessibilityManager.TouchExplorationStateChangeListener listener) {
        return true;
    }
     ...
     * @unknown 
     */
    public void addHighTextContrastStateChangeListener(@android.annotation.NonNull
    android.view.accessibility.AccessibilityManager.HighTextContrastChangeListener listener, @android.annotation.Nullable
    android.os.Handler handler) {
    }
     ...
     * @unknown 
     */
    public void removeHighTextContrastStateChangeListener(@android.annotation.NonNull
    ...
    public int addAccessibilityInteractionConnection(android.view.IWindow windowToken, android.view.accessibility.IAccessibilityInteractionConnection connection) {
