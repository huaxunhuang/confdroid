...
public class ViewOverlay {
    ...
    ViewOverlay(android.content.Context context, android.view.View hostView) {
        mOverlayViewGroup = new android.view.ViewOverlay.OverlayViewGroup(context, hostView);
    }
     ...
     *
     * @param drawable
     * 		The {@link Drawable} to be added to the overlay. This drawable will be
     * 		drawn when the view redraws its overlay. {@link Drawable}s will be drawn in the order that
     * 		they were added.
     * @see #remove(Drawable)
     */
    public void add(@android.annotation.NonNull
     ...
     *
     * @param drawable
     * 		The {@link Drawable} to be removed from the overlay.
     * @see #add(Drawable)
     */
    ...
    static class OverlayViewGroup extends android.view.ViewGroup {
        ...
        OverlayViewGroup(android.content.Context context, android.view.View hostView) {
            super(context);
            mHostView = hostView;
        ...
        android.graphics.drawable.Drawable drawable) {
            ...
            if (mDrawables == null) {
                mDrawables = new java.util.ArrayList<>();
            }
        ...
        public void clear() {
            removeAllViews();
            if (mDrawables != null) {
                for (android.graphics.drawable.Drawable drawable : mDrawables) {
                    drawable.setCallback(null);
                }
                mDrawables.clear();
            }
        ...
        android.view.View target) {
            if (mHostView != null) {
                if (mHostView instanceof android.view.ViewGroup) {
                    ...
                    ((android.view.ViewGroup) (mHostView)).onDescendantInvalidated(mHostView, target);
        ...
        public android.view.ViewParent invalidateChildInParent(int[] location, android.graphics.Rect dirty) {
            if (mHostView != null) {
                ...
                if (mHostView instanceof android.view.ViewGroup) {
                    ...
                    return ((android.view.ViewGroup) (mHostView)).invalidateChildInParent(location, dirty);
                } else {
                    invalidate(dirty);
                }
            }
