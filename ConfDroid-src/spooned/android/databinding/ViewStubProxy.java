...
public class ViewStubProxy {
    ...
    private android.databinding.ViewDataBinding mContainingBinding;

    private android.view.ViewStub.OnInflateListener mProxyListener = new android.view.ViewStub.OnInflateListener() {
        @java.lang.Override
        public void onInflate(android.view.ViewStub stub, android.view.View inflated) {
            mRoot = inflated;
            mViewDataBinding = android.databinding.DataBindingUtil.bind(mContainingBinding.mBindingComponent, inflated, stub.getLayoutResource());
            mViewStub = null;
    ...
    public void setContainingBinding(android.databinding.ViewDataBinding containingBinding) {
     ...
     */
    public void setOnInflateListener(android.view.ViewStub.OnInflateListener listener) {
        if (mViewStub != null) {
