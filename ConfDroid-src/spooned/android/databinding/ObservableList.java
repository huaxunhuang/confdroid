...
public interface ObservableList<T> extends java.util.List<T> {
     ...
     *
     * @param callback
     * 		The callback to be notified on list changes
     */
    void addOnListChangedCallback(android.databinding.ObservableList.OnListChangedCallback<? extends android.databinding.ObservableList<T>> callback);
     ...
     */
    void removeOnListChangedCallback(android.databinding.ObservableList.OnListChangedCallback<? extends android.databinding.ObservableList<T>> callback);

    /**
     * The callback that is called by ObservableList when the list has changed.
     */
    abstract class OnListChangedCallback<T extends android.databinding.ObservableList> {
        /**
         ...
         * 		The changing list.
         * @param positionStart
         * 		The starting index that has changed.
         * @param itemCount
         ...
         * 		The changing list.
         * @param fromPosition
         * 		The position from which the items were moved
         * @param toPosition
         ...
         * 		The changing list.
         * @param positionStart
         * 		The starting index of the deleted items.
         * @param itemCount
