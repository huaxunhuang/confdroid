 ...
 * 		The callback type.
 * @param <T>
 * 		The notification sender type. Typically this is the containing class.
 * @param <A>
 * 		Opaque argument used to pass additional data beyond an int.
 */
public class CallbackRegistry<C, T, A> implements java.lang.Cloneable {
     ...
     */
    private java.util.List<C> mCallbacks = new java.util.ArrayList<C>();
     ...
     */
    private final android.databinding.CallbackRegistry.NotifierCallback<C, T, A> mNotifier;

    /**
     * Creates an EventRegistry that notifies the event with notifier.
     *
     * @param notifier
     * 		The class to use to notify events.
     */
    public CallbackRegistry(android.databinding.CallbackRegistry.NotifierCallback<C, T, A> notifier) {
        mNotifier = notifier;
    }
    ...
    private void notifyFirst64(T sender, int arg, A arg2) {
        final int maxNotified = java.lang.Math.min(java.lang.Long.SIZE, mCallbacks.size());
    ...
    private void notifyRecurse(T sender, int arg, A arg2) {
        ...
        final int startCallbackIndex = (remainderIndex + 2) * java.lang.Long.SIZE;
     ...
     * 		The index into mRemainderRemoved that should be notified.
     */
    private void notifyRemainder(T sender, int arg, A arg2, int remainderIndex) {
        if (remainderIndex < 0) {
            ...
            final int startIndex = (remainderIndex + 1) * java.lang.Long.SIZE;
            final int endIndex = java.lang.Math.min(mCallbacks.size(), startIndex + java.lang.Long.SIZE);
     ...
     * 		{@link CallbackRegistry.NotifierCallback#onNotifyCallback(Object, Object, int, Object)}
     * @param startIndex
     * 		The index into the mCallbacks to start notifying.
     * @param endIndex
     ...
     *
     * @param index
     * 		The index into mCallbacks to check.
    ...
    private boolean isRemoved(int index) {
        if (index < java.lang.Long.SIZE) {
            ...
            if (mRemainderRemoved == null) {
                ...
                final int maskIndex = (index / java.lang.Long.SIZE) - 1;
                if (maskIndex >= mRemainderRemoved.length) {
                    ...
                    final long bitMask = 1L << (index % java.lang.Long.SIZE);
     ...
     *
     * @param startIndex
     * 		The index into the mCallbacks to start removing callbacks.
     * @param removed
    ...
    private void removeRemovedCallbacks(int startIndex, long removed) {
        ...
        final int endIndex = startIndex + java.lang.Long.SIZE;
        long bitMask = 1L << (java.lang.Long.SIZE - 1);
    ...
    private void setRemovalBit(int index) {
        if (index < java.lang.Long.SIZE) {
            ...
            final int remainderIndex = (index / java.lang.Long.SIZE) - 1;
            if (mRemainderRemoved == null) {
                mRemainderRemoved = new long[mCallbacks.size() / java.lang.Long.SIZE];
            } else
                if (mRemainderRemoved.length < remainderIndex) {
                    // need to make it bigger
                    long[] newRemainders = new long[mCallbacks.size() / java.lang.Long.SIZE];
                    java.lang.System.arraycopy(mRemainderRemoved, 0, newRemainders, 0, mRemainderRemoved.length);
    ...
    public synchronized java.util.ArrayList<C> copyCallbacks() {
        java.util.ArrayList<C> callbacks = new java.util.ArrayList<C>(mCallbacks.size());
     ...
     *
     * @param callbacks
     * 		modified to contain all callbacks registered to receive events.
     */
    public synchronized void copyCallbacks(java.util.List<C> callbacks) {
        callbacks.clear();
        int numListeners = mCallbacks.size();
        for (int i = 0; i < numListeners; i++) {
            if (!isRemoved(i)) {
    ...
    public synchronized android.databinding.CallbackRegistry<C, T, A> clone() {
        android.databinding.CallbackRegistry<C, T, A> clone = null;
        try {
            clone = ((android.databinding.CallbackRegistry<C, T, A>) (super.clone()));
            clone.mFirst64Removed = 0;
            clone.mRemainderRemoved = null;
            clone.mNotificationLevel = 0;
            clone.mCallbacks = new java.util.ArrayList<C>();
     ...
     * 		The notification sender type. Typically this is the containing class.
     * @param <A>
     * 		An opaque argument to pass to the notifier
     */
    public static abstract class NotifierCallback<C, T, A> {
         ...
         * @param sender
         * 		The opaque sender object.
         * @param arg
         * 		The opaque notification parameter.
         * @param arg2
