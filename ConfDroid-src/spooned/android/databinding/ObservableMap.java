...
public interface ObservableMap<K, V> extends java.util.Map<K, V> {
     ...
     */
    void addOnMapChangedCallback(android.databinding.ObservableMap.OnMapChangedCallback<? extends android.databinding.ObservableMap<K, V>, K, V> callback);
     ...
     */
    void removeOnMapChangedCallback(android.databinding.ObservableMap.OnMapChangedCallback<? extends android.databinding.ObservableMap<K, V>, K, V> callback);

    /**
     * A callback receiving notifications when an ObservableMap changes.
     */
    abstract class OnMapChangedCallback<T extends android.databinding.ObservableMap<K, V>, K, V> {
        /**
         ...
         * 		The changing map.
         * @param key
         * 		The key of the value inserted, removed, or changed.
         */
