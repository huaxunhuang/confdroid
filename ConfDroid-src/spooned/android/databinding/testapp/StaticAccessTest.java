...
public class StaticAccessTest extends android.databinding.testapp.BaseDataBinderTest<android.databinding.testapp.databinding.StaticAccessTestBinding> {
    public StaticAccessTest() {
        super(android.databinding.testapp.databinding.StaticAccessTestBinding.class);
    }
    ...
    private void assertStaticContents() {
        ...
        assertText(android.databinding.testapp.vo.StaticTestsVo.ourStaticField, mBinder.staticFieldOverClass);
        assertText(android.databinding.testapp.vo.StaticTestsVo.ourStaticMethod(), mBinder.staticMethodOverClass);
        assertText(android.databinding.testapp.vo.StaticTestsVo.ourStaticObservable.get(), mBinder.obsStaticOverClass);
