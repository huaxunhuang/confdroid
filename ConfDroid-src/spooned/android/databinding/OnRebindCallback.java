 ...
 * is called when bound values must be reevaluated in {@link ViewDataBinding#executePendingBindings()}.
 */
public abstract class OnRebindCallback<T extends android.databinding.ViewDataBinding> {
    /**
     ...
     * OnRebindListener implementer to explicitly call {@link ViewDataBinding#executePendingBindings()}.
     * <p>
    ...
    /**
     * Called after values have been reevaluated in {@link ViewDataBinding#executePendingBindings()}. This is only called if all listeners have
