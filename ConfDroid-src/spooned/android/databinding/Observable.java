...
public interface Observable {
     ...
     *
     * @param callback
     * 		The callback to start listening.
     */
    void addOnPropertyChangedCallback(android.databinding.Observable.OnPropertyChangedCallback callback);
     ...
     */
    void removeOnPropertyChangedCallback(android.databinding.Observable.OnPropertyChangedCallback callback);
    ...
    abstract class OnPropertyChangedCallback {
         ...
         *
         * @param sender
         * 		The Observable that is changing.
         * @param propertyId
         * 		The BR identifier of the property that has changed. The getter
         * 		for this property should be annotated with {@link Bindable}.
         */
        public abstract void onPropertyChanged(android.databinding.Observable sender, int propertyId);
    }
}
