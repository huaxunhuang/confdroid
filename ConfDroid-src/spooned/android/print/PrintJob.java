...
public final class PrintJob {
    ...
    android.print.PrintJobInfo info, @android.annotation.NonNull
    ...
    public android.print.PrintJobInfo getInfo() {
        ...
        android.print.PrintJobInfo info = mPrintManager.getPrintJobInfo(mCachedInfo.getId());
        if (info != null) {
            mCachedInfo = info;
        }
        return mCachedInfo;
    ...
    public void cancel() {
        ...
        if ((((state == android.print.PrintJobInfo.STATE_QUEUED) || (state == android.print.PrintJobInfo.STATE_STARTED)) || (state == android.print.PrintJobInfo.STATE_BLOCKED)) || (state == android.print.PrintJobInfo.STATE_FAILED)) {
    ...
    private boolean isInImmutableState() {
        ...
        return (state == android.print.PrintJobInfo.STATE_COMPLETED) || (state == android.print.PrintJobInfo.STATE_CANCELED);
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.print.PrintJob other = ((android.print.PrintJob) (obj));
        return java.util.Objects.equals(mCachedInfo.getId(), other.mCachedInfo.getId());
    }

    @java.lang.Override
    public int hashCode() {
        android.print.PrintJobId printJobId = mCachedInfo.getId();
        if (printJobId == null) {
            return 0;
        } else {
