...
public final class PrintDocumentInfo implements android.os.Parcelable {
    ...
    @android.annotation.IntDef({ android.print.PrintDocumentInfo.CONTENT_TYPE_UNKNOWN, android.print.PrintDocumentInfo.CONTENT_TYPE_DOCUMENT, android.print.PrintDocumentInfo.CONTENT_TYPE_PHOTO })
     ...
     * 		from which to clone.
     */
    private PrintDocumentInfo(@android.annotation.NonNull
     ...
     *
     * @param parcel
     * 		Data from which to initialize.
     */
    private PrintDocumentInfo(android.os.Parcel parcel) {
        mName = com.android.internal.util.Preconditions.checkStringNotEmpty(parcel.readString());
        mPageCount = parcel.readInt();
        com.android.internal.util.Preconditions.checkArgument((mPageCount == android.print.PrintDocumentInfo.PAGE_COUNT_UNKNOWN) || (mPageCount > 0));
        mContentType = parcel.readInt();
        mDataSize = com.android.internal.util.Preconditions.checkArgumentNonnegative(parcel.readLong());
    }
     ...
     * @unknown 
     */
    public void setDataSize(@android.annotation.IntRange(from = 0)
    long dataSize) {
        mDataSize = dataSize;
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.print.PrintDocumentInfo other = ((android.print.PrintDocumentInfo) (obj));
        if (!android.text.TextUtils.equals(mName, other.mName)) {
            return false;
        }
    ...
    private java.lang.String contentTypeToString(int contentType) {
        switch (contentType) {
            case android.print.PrintDocumentInfo.CONTENT_TYPE_DOCUMENT :
                {
                    return "CONTENT_TYPE_DOCUMENT";
                }
            case android.print.PrintDocumentInfo.CONTENT_TYPE_PHOTO :
                {
    ...
    public static final class Builder {
        ...
        java.lang.String name) {
            ...
            mPrototype = new android.print.PrintDocumentInfo();
         ...
         */
        @android.annotation.NonNull
        public android.print.PrintDocumentInfo.Builder setPageCount(@android.annotation.IntRange(from = -1)
        int pageCount) {
            if ((pageCount < 0) && (pageCount != android.print.PrintDocumentInfo.PAGE_COUNT_UNKNOWN)) {
         ...
         */
        @android.annotation.NonNull
        public android.print.PrintDocumentInfo.Builder setContentType(@android.print.PrintDocumentInfo.ContentType
        int type) {
        ...
        public android.print.PrintDocumentInfo build() {
            ...
            if (mPrototype.mPageCount == 0) {
                mPrototype.mPageCount = android.print.PrintDocumentInfo.PAGE_COUNT_UNKNOWN;
            }
            return new android.print.PrintDocumentInfo(mPrototype);
        }
    }

    public static final android.os.Parcelable.Creator<android.print.PrintDocumentInfo> CREATOR = new android.os.Parcelable.Creator<android.print.PrintDocumentInfo>() {
        @java.lang.Override
        ...
        @java.lang.Override
        public android.print.PrintDocumentInfo[] newArray(int size) {
            return new android.print.PrintDocumentInfo[size];
        }
    };
}
