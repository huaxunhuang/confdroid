...
public abstract class PrintDocumentAdapter {
     ...
     * This extra is provided in the {@link Bundle} argument of the {@link #onLayout(PrintAttributes, PrintAttributes, CancellationSignal,
     ...
     * <p>
     * After you are done laying out, you <strong>must</strong> invoke: {@link LayoutResultCallback#onLayoutFinished(PrintDocumentInfo, boolean)} with
     * the last argument <code>true</code> or <code>false</code> depending on
     * whether the layout changed the content or not, respectively; or {@link LayoutResultCallback#onLayoutFailed(CharSequence)}, if an error occurred;
    ...
    /**
     * Base class for implementing a callback for the result of {@link PrintDocumentAdapter#onWrite(PageRange[], ParcelFileDescriptor, CancellationSignal,
     * WriteResultCallback)}.
     */
    ...
    /**
     * Base class for implementing a callback for the result of {@link PrintDocumentAdapter#onLayout(PrintAttributes, PrintAttributes,
