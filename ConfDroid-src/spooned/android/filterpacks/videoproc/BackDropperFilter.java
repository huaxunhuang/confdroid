...
public class BackDropperFilter extends android.filterfw.core.Filter {
    ...
    private int mLearningDuration = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_LEARNING_DURATION;

    @android.filterfw.core.GenerateFieldPort(name = "learningVerifyDuration", hasDefault = true)
    private int mLearningVerifyDuration = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_LEARNING_VERIFY_DURATION;

    @android.filterfw.core.GenerateFieldPort(name = "acceptStddev", hasDefault = true)
    private float mAcceptStddev = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_ACCEPT_STDDEV;

    @android.filterfw.core.GenerateFieldPort(name = "hierLrgScale", hasDefault = true)
    private float mHierarchyLrgScale = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_LRG_SCALE;

    @android.filterfw.core.GenerateFieldPort(name = "hierMidScale", hasDefault = true)
    private float mHierarchyMidScale = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_MID_SCALE;

    @android.filterfw.core.GenerateFieldPort(name = "hierSmlScale", hasDefault = true)
    private float mHierarchySmlScale = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_SML_SCALE;
    ...
    private int mMaskWidthExp = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_MASK_WIDTH_EXPONENT;

    @android.filterfw.core.GenerateFieldPort(name = "maskHeightExp", hasDefault = true)
    private int mMaskHeightExp = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_MASK_HEIGHT_EXPONENT;
    ...
    private int mHierarchyLrgExp = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_LRG_EXPONENT;

    @android.filterfw.core.GenerateFieldPort(name = "hierMidExp", hasDefault = true)
    private int mHierarchyMidExp = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_MID_EXPONENT;

    @android.filterfw.core.GenerateFieldPort(name = "hierSmlExp", hasDefault = true)
    private int mHierarchySmlExp = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_HIER_SML_EXPONENT;

    @android.filterfw.core.GenerateFieldPort(name = "lumScale", hasDefault = true)
    private float mLumScale = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_Y_SCALE_FACTOR;

    @android.filterfw.core.GenerateFieldPort(name = "chromaScale", hasDefault = true)
    private float mChromaScale = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_UV_SCALE_FACTOR;

    @android.filterfw.core.GenerateFieldPort(name = "maskBg", hasDefault = true)
    private float mMaskBg = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_MASK_BLEND_BG;

    @android.filterfw.core.GenerateFieldPort(name = "maskFg", hasDefault = true)
    private float mMaskFg = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_MASK_BLEND_FG;

    @android.filterfw.core.GenerateFieldPort(name = "exposureChange", hasDefault = true)
    private float mExposureChange = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_EXPOSURE_CHANGE;

    @android.filterfw.core.GenerateFieldPort(name = "whitebalanceredChange", hasDefault = true)
    private float mWhiteBalanceRedChange = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_WHITE_BALANCE_RED_CHANGE;

    @android.filterfw.core.GenerateFieldPort(name = "whitebalanceblueChange", hasDefault = true)
    private float mWhiteBalanceBlueChange = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_WHITE_BALANCE_BLUE_CHANGE;

    @android.filterfw.core.GenerateFieldPort(name = "autowbToggle", hasDefault = true)
    private int mAutoWBToggle = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_WHITE_BALANCE_TOGGLE;

    // TODO: These are not updatable:
    @android.filterfw.core.GenerateFieldPort(name = "learningAdaptRate", hasDefault = true)
    private float mAdaptRateLearning = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_LEARNING_ADAPT_RATE;

    @android.filterfw.core.GenerateFieldPort(name = "adaptRateBg", hasDefault = true)
    private float mAdaptRateBg = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_ADAPT_RATE_BG;

    @android.filterfw.core.GenerateFieldPort(name = "adaptRateFg", hasDefault = true)
    private float mAdaptRateFg = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_ADAPT_RATE_FG;

    @android.filterfw.core.GenerateFieldPort(name = "maskVerifyRate", hasDefault = true)
    private float mVerifyRate = android.filterpacks.videoproc.BackDropperFilter.DEFAULT_MASK_VERIFY_RATE;

    @android.filterfw.core.GenerateFieldPort(name = "learningDoneListener", hasDefault = true)
    private android.filterpacks.videoproc.BackDropperFilter.LearningDoneListener mLearningDoneListener = null;
     ...
     * Stream names
     */
    private static final java.lang.String[] mInputNames = new java.lang.String[]{ "video", "background" };

    private static final java.lang.String[] mOutputNames = new java.lang.String[]{ "video" };

    private static final java.lang.String[] mDebugOutputNames = new java.lang.String[]{ "debug1", "debug2" };
    ...
    private static java.lang.String mSharedUtilShader = ((((((((((((((((((((((((((((("precision mediump float;\n" + (("uniform float fg_adapt_rate;\n" + "uniform float bg_adapt_rate;\n") + "const mat4 coeff_yuv = mat4(")) + android.filterpacks.videoproc.BackDropperFilter.RGB_TO_YUV_MATRIX) + ");\n") + "const float dist_scale = ") + android.filterpacks.videoproc.BackDropperFilter.DISTANCE_STORAGE_SCALE) + ";\n") + "const float inv_dist_scale = 1. / dist_scale;\n") + "const float var_scale=") + android.filterpacks.videoproc.BackDropperFilter.VARIANCE_STORAGE_SCALE) + ";\n") + "const float inv_var_scale = 1. / var_scale;\n") + "const float min_variance = inv_var_scale *") + android.filterpacks.videoproc.BackDropperFilter.MIN_VARIANCE) + "/ 256.;\n") + "const float auto_wb_scale = ") + android.filterpacks.videoproc.BackDropperFilter.DEFAULT_AUTO_WB_SCALE) + ";\n") + "\n") + // Variance distance in luminance between current pixel and background model
     ...
     */
    public BackDropperFilter(java.lang.String name) {
        super(name);
        mLogVerbose = android.util.Log.isLoggable(android.filterpacks.videoproc.BackDropperFilter.TAG, android.util.Log.VERBOSE);
        java.lang.String adjStr = android.os.SystemProperties.get("ro.media.effect.bgdropper.adj");
        if (adjStr.length() > 0) {
            try {
                mAcceptStddev += java.lang.Float.parseFloat(adjStr);
                if (mLogVerbose) {
                    android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (("Adjusting accept threshold by " + adjStr) + ", now ") + mAcceptStddev);
                }
            } catch (java.lang.NumberFormatException e) {
                android.util.Log.e(android.filterpacks.videoproc.BackDropperFilter.TAG, "Badly formatted property ro.media.effect.bgdropper.adj: " + adjStr);
            }
        }
    }
    ...
    public void setupPorts() {
        ...
        android.filterfw.core.FrameFormat imageFormat = android.filterfw.format.ImageFormat.create(android.filterfw.format.ImageFormat.COLORSPACE_RGBA, android.filterfw.core.FrameFormat.TARGET_UNSPECIFIED);
        for (java.lang.String inputName : android.filterpacks.videoproc.BackDropperFilter.mInputNames) {
            addMaskedInputPort(inputName, imageFormat);
        }
        // Normal outputs
        for (java.lang.String outputName : android.filterpacks.videoproc.BackDropperFilter.mOutputNames) {
            addOutputBasedOnInput(outputName, "video");
        }
        // Debug outputs
        if (mProvideDebugOutputs) {
            for (java.lang.String outputName : android.filterpacks.videoproc.BackDropperFilter.mDebugOutputNames) {
                addOutputBasedOnInput(outputName, "video");
            }
        }
    }
    ...
    public android.filterfw.core.FrameFormat getOutputFormat(java.lang.String portName, android.filterfw.core.FrameFormat inputFormat) {
        ...
        android.filterfw.core.MutableFrameFormat format = inputFormat.mutableCopy();
        // Is this a debug output port? If so, leave dimensions unspecified.
        if (!java.util.Arrays.asList(android.filterpacks.videoproc.BackDropperFilter.mOutputNames).contains(portName)) {
            format.setDimensions(android.filterfw.core.FrameFormat.SIZE_UNSPECIFIED, android.filterfw.core.FrameFormat.SIZE_UNSPECIFIED);
        }
        return format;
    }
    ...
    private boolean createMemoryFormat(android.filterfw.core.FrameFormat inputFormat) {
        ...
        if ((inputFormat.getWidth() == android.filterfw.core.FrameFormat.SIZE_UNSPECIFIED) || (inputFormat.getHeight() == android.filterfw.core.FrameFormat.SIZE_UNSPECIFIED)) {
        ...
        int maskWidth = ((int) (java.lang.Math.pow(2, mMaskWidthExp)));
        int maskHeight = ((int) (java.lang.Math.pow(2, mMaskHeightExp)));
        mMaskFormat.setDimensions(maskWidth, maskHeight);
        mPyramidDepth = java.lang.Math.max(mMaskWidthExp, mMaskHeightExp);
        mMemoryFormat = mMaskFormat.mutableCopy();
        int widthExp = java.lang.Math.max(mMaskWidthExp, pyramidLevel(inputFormat.getWidth()));
        int heightExp = java.lang.Math.max(mMaskHeightExp, pyramidLevel(inputFormat.getHeight()));
        mPyramidDepth = java.lang.Math.max(widthExp, heightExp);
        int memWidth = java.lang.Math.max(maskWidth, ((int) (java.lang.Math.pow(2, widthExp))));
        int memHeight = java.lang.Math.max(maskHeight, ((int) (java.lang.Math.pow(2, heightExp))));
        mMemoryFormat.setDimensions(memWidth, memHeight);
        mSubsampleLevel = mPyramidDepth - java.lang.Math.max(mMaskWidthExp, mMaskHeightExp);
        if (mLogVerbose) {
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (("Mask frames size " + maskWidth) + " x ") + maskHeight);
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (("Pyramid levels " + widthExp) + " x ") + heightExp);
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (("Memory frames size " + memWidth) + " x ") + memHeight);
        }
    ...
    public void prepare(android.filterfw.core.FilterContext context) {
        if (mLogVerbose)
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Preparing BackDropperFilter!");

        mBgMean = new android.filterfw.core.GLFrame[2];
        mBgVariance = new android.filterfw.core.GLFrame[2];
        mMaskVerify = new android.filterfw.core.GLFrame[2];
        copyShaderProgram = android.filterfw.core.ShaderProgram.createIdentity(context);
    }
    ...
    private void allocateFrames(android.filterfw.core.FrameFormat inputFormat, android.filterfw.core.FilterContext context) {
        ...
        if (mLogVerbose)
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Allocating BackDropperFilter frames");
        ...
        for (int i = 0; i < 2; i++) {
            mBgMean[i] = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMaskFormat)));
            mBgMean[i].setData(initialBgMean, 0, numBytes);
            mBgVariance[i] = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMaskFormat)));
            mBgVariance[i].setData(initialBgVariance, 0, numBytes);
            mMaskVerify[i] = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMaskFormat)));
            mMaskVerify[i].setData(initialMaskVerify, 0, numBytes);
        }
        // Get frames to store other textures in
        if (mLogVerbose)
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Done allocating texture for Mean and Variance objects!");

        mDistance = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMaskFormat)));
        mMask = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMaskFormat)));
        mAutoWB = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mAverageFormat)));
        mVideoInput = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMemoryFormat)));
        mBgInput = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mMemoryFormat)));
        mMaskAverage = ((android.filterfw.core.GLFrame) (context.getFrameManager().newFrame(mAverageFormat)));
        // Create shader programs
        mBgDistProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mBgDistanceShader);
        mBgDistProgram.setHostValue("subsample_level", ((float) (mSubsampleLevel)));
        mBgMaskProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mBgMaskShader);
        mBgMaskProgram.setHostValue("accept_variance", mAcceptStddev * mAcceptStddev);
        float[] yuvWeights = new float[]{ mLumScale, mChromaScale };
        ...
        if (mUseTheForce) {
            mBgSubtractProgram = new android.filterfw.core.ShaderProgram(context, (android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mBgSubtractShader) + android.filterpacks.videoproc.BackDropperFilter.mBgSubtractForceShader);
        } else {
            mBgSubtractProgram = new android.filterfw.core.ShaderProgram(context, (android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mBgSubtractShader) + "}\n");
        }
        mBgSubtractProgram.setHostValue("bg_fit_transform", android.filterpacks.videoproc.BackDropperFilter.DEFAULT_BG_FIT_TRANSFORM);
        ...
        mBgUpdateMeanProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mUpdateBgModelMeanShader);
        mBgUpdateMeanProgram.setHostValue("subsample_level", ((float) (mSubsampleLevel)));
        mBgUpdateVarianceProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mUpdateBgModelVarianceShader);
        mBgUpdateVarianceProgram.setHostValue("subsample_level", ((float) (mSubsampleLevel)));
        mCopyOutProgram = android.filterfw.core.ShaderProgram.createIdentity(context);
        mAutomaticWhiteBalanceProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mAutomaticWhiteBalance);
        ...
        mMaskVerifyProgram = new android.filterfw.core.ShaderProgram(context, android.filterpacks.videoproc.BackDropperFilter.mSharedUtilShader + android.filterpacks.videoproc.BackDropperFilter.mMaskVerifyShader);
        mMaskVerifyProgram.setHostValue("verify_rate", mVerifyRate);
        if (mLogVerbose)
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Shader width set to " + mMemoryFormat.getWidth());
    ...
    public void process(android.filterfw.core.FilterContext context) {
        ...
        android.filterfw.core.Frame video = pullInput("video");
        android.filterfw.core.Frame background = pullInput("background");
        allocateFrames(video.getFormat(), context);
        // Update learning rate after initial learning period
        if (mStartLearning) {
            if (mLogVerbose)
                android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Starting learning");
        ...
        mVideoInput.setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
        mBgInput.generateMipMap();
        mBgInput.setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
        if (mStartLearning) {
            copyShaderProgram.process(mVideoInput, mBgMean[inputIndex]);
            mStartLearning = false;
        }
        // Process shaders
        android.filterfw.core.Frame[] distInputs = new android.filterfw.core.Frame[]{ mVideoInput, mBgMean[inputIndex], mBgVariance[inputIndex] };
        mBgDistProgram.process(distInputs, mDistance);
        mDistance.generateMipMap();
        mDistance.setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
        mBgMaskProgram.process(mDistance, mMask);
        mMask.generateMipMap();
        mMask.setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
        android.filterfw.core.Frame[] autoWBInputs = new android.filterfw.core.Frame[]{ mVideoInput, mBgInput };
        ...
        if (mFrameCount <= mLearningDuration) {
            ...
            if (mFrameCount == (mLearningDuration - mLearningVerifyDuration)) {
                ...
                if (mFrameCount > (mLearningDuration - mLearningVerifyDuration)) {
                    ...
                    android.filterfw.core.Frame[] maskVerifyInputs = new android.filterfw.core.Frame[]{ mMaskVerify[inputIndex], mMask };
                    mMaskVerifyProgram.process(maskVerifyInputs, mMaskVerify[outputIndex]);
                    mMaskVerify[outputIndex].generateMipMap();
                    mMaskVerify[outputIndex].setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
                }
            ...
            if (mFrameCount == mLearningDuration) {
                ...
                java.nio.ByteBuffer mMaskAverageByteBuffer = mMaskAverage.getData();
                byte[] mask_average = mMaskAverageByteBuffer.array();
                int bi = ((int) (mask_average[3] & 0xff));
                if (mLogVerbose) {
                    android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, java.lang.String.format("Mask_average is %d, threshold is %d", bi, android.filterpacks.videoproc.BackDropperFilter.DEFAULT_LEARNING_DONE_THRESHOLD));
                }
                if (bi >= android.filterpacks.videoproc.BackDropperFilter.DEFAULT_LEARNING_DONE_THRESHOLD) {
                    mStartLearning = true;// Restart learning

                } else {
                    if (mLogVerbose)
                        android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Learning done");
            ...
            android.filterfw.core.Frame output = context.getFrameManager().newFrame(video.getFormat());
            android.filterfw.core.Frame[] subtractInputs = new android.filterfw.core.Frame[]{ video, background, mMask, mAutoWB };
        ...
        if (((mFrameCount < (mLearningDuration - mLearningVerifyDuration)) || (mAdaptRateBg > 0.0)) || (mAdaptRateFg > 0.0)) {
            android.filterfw.core.Frame[] meanUpdateInputs = new android.filterfw.core.Frame[]{ mVideoInput, mBgMean[inputIndex], mMask };
            mBgUpdateMeanProgram.process(meanUpdateInputs, mBgMean[outputIndex]);
            mBgMean[outputIndex].generateMipMap();
            mBgMean[outputIndex].setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
            android.filterfw.core.Frame[] varianceUpdateInputs = new android.filterfw.core.Frame[]{ mVideoInput, mBgMean[inputIndex], mBgVariance[inputIndex], mMask };
            mBgUpdateVarianceProgram.process(varianceUpdateInputs, mBgVariance[outputIndex]);
            mBgVariance[outputIndex].generateMipMap();
            mBgVariance[outputIndex].setTextureParameter(android.opengl.GLES20.GL_TEXTURE_MIN_FILTER, android.opengl.GLES20.GL_LINEAR_MIPMAP_NEAREST);
        }
        // Provide debug output to two smaller viewers
        if (mProvideDebugOutputs) {
            android.filterfw.core.Frame dbg1 = context.getFrameManager().newFrame(video.getFormat());
            mCopyOutProgram.process(video, dbg1);
            pushOutput("debug1", dbg1);
            dbg1.release();
            android.filterfw.core.Frame dbg2 = context.getFrameManager().newFrame(mMemoryFormat);
        ...
        if (mLogVerbose) {
            if ((mFrameCount % 30) == 0) {
                if (startTime == (-1)) {
                    ...
                    android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (("Avg. frame duration: " + java.lang.String.format("%.2f", (endTime - startTime) / 30.0)) + " ms. Avg. fps: ") + java.lang.String.format("%.2f", 1000.0 / ((endTime - startTime) / 30.0)));
                    startTime = endTime;
                }
            }
        }
    ...
    public void close(android.filterfw.core.FilterContext context) {
        ...
        if (mLogVerbose)
            android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Filter Closing!");
                                                ...
                                                if (name.equals("maskFg")) {
                                                    ...
                                                    if (name.equals("exposureChange")) {
                                                        ...
                                                        if (name.equals("whitebalanceredChange")) {
                                                            ...
                                                            if (name.equals("whitebalanceblueChange")) {
                                                                mBgSubtractProgram.setHostValue("whitebalanceblue_change", mWhiteBalanceBlueChange);
                                                            } else
    ...
    private void updateBgScaling(android.filterfw.core.Frame video, android.filterfw.core.Frame background, boolean fitModeChanged) {
        ...
        if ((currentRelativeAspect != mRelativeAspect) || fitModeChanged) {
            ...
            if (mMirrorBg) {
                if (mLogVerbose)
                    android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, "Mirroring the background!");
            ...
            if (mLogVerbose)
                android.util.Log.v(android.filterpacks.videoproc.BackDropperFilter.TAG, (((((((("bgTransform: xMin, yMin, xWidth, yWidth : " + xMin) + ", ") + yMin) + ", ") + xWidth) + ", ") + yWidth) + ", mRelAspRatio = ") + mRelativeAspect);
    ...
    private int pyramidLevel(int size) {
        return ((int) (java.lang.Math.floor(java.lang.Math.log10(size) / java.lang.Math.log10(2)))) - 1;
    }
}
