...
public class AutoFixFilter extends android.filterfw.core.Filter {
    ...
    public AutoFixFilter(java.lang.String name) {
        super(name);
    }
    ...
    public void initProgram(android.filterfw.core.FilterContext context, int target) {
        switch (target) {
            case android.filterfw.core.FrameFormat.TARGET_GPU :
                android.filterfw.core.ShaderProgram shaderProgram = new android.filterfw.core.ShaderProgram(context, mAutoFixShader);
    ...
    private void initParameters() {
        mShaderProgram.setHostValue("shift_scale", 1.0F / 256.0F);
        mShaderProgram.setHostValue("hist_offset", 0.5F / 766.0F);
        mShaderProgram.setHostValue("hist_scale", 765.0F / 766.0F);
        mShaderProgram.setHostValue("density_offset", 0.5F / 1024.0F);
        mShaderProgram.setHostValue("density_scale", 1023.0F / 1024.0F);
    ...
    protected void prepare(android.filterfw.core.FilterContext context) {
        ...
        for (int i = 0; i < densityDim; ++i) {
            long temp = (android.filterpacks.imageproc.AutoFixFilter.normal_cdf[i] * precision) / histDim;
            densityTable[i] = ((int) (temp));
        }
        android.filterfw.core.FrameFormat densityFormat = android.filterfw.format.ImageFormat.create(densityDim, 1, android.filterfw.format.ImageFormat.COLORSPACE_RGBA, android.filterfw.core.FrameFormat.TARGET_GPU);
    ...
    public void process(android.filterfw.core.FilterContext context) {
        ...
        // Process
        android.filterfw.core.Frame[] inputs = new android.filterfw.core.Frame[]{ input, mHistFrame, mDensityFrame };
    ...
    private void createHistogramFrame(android.filterfw.core.FilterContext context, int width, int height, int[] data) {
        ...
        android.filterfw.core.FrameFormat shaderHistFormat = android.filterfw.format.ImageFormat.create(histDims, 1, android.filterfw.format.ImageFormat.COLORSPACE_RGBA, android.filterfw.core.FrameFormat.TARGET_GPU);
        if (mHistFrame != null)
            mHistFrame.release();
