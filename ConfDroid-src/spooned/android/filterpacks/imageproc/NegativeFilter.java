...
public class NegativeFilter extends android.filterfw.core.Filter {
    ...
    private final java.lang.String mNegativeShader = "precision mediump float;\n" + ((((("uniform sampler2D tex_sampler_0;\n" + "varying vec2 v_texcoord;\n") + "void main() {\n") + "  vec4 color = texture2D(tex_sampler_0, v_texcoord);\n") + "  gl_FragColor = vec4(1.0 - color.rgb, color.a);\n") + "}\n");

    public NegativeFilter(java.lang.String name) {
        super(name);
    }
    ...
    public void initProgram(android.filterfw.core.FilterContext context, int target) {
        switch (target) {
            case android.filterfw.core.FrameFormat.TARGET_GPU :
                android.filterfw.core.ShaderProgram shaderProgram = new android.filterfw.core.ShaderProgram(context, mNegativeShader);
