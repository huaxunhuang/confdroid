...
public class LomoishFilter extends android.filterfw.core.Filter {
    ...
    public LomoishFilter(java.lang.String name) {
        super(name);
    ...
    public void initProgram(android.filterfw.core.FilterContext context, int target) {
        switch (target) {
            case android.filterfw.core.FrameFormat.TARGET_GPU :
                android.filterfw.core.ShaderProgram shaderProgram = new android.filterfw.core.ShaderProgram(context, mLomoishShader);
