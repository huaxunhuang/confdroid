...
public class ToRGBFilter extends android.filterfw.core.Filter {
    ...
    public ToRGBFilter(java.lang.String name) {
        super(name);
    }
    ...
    public android.filterfw.core.FrameFormat getConvertedFormat(android.filterfw.core.FrameFormat format) {
        ...
        result.setMetaValue(android.filterfw.format.ImageFormat.COLORSPACE_KEY, android.filterfw.format.ImageFormat.COLORSPACE_RGB);
    ...
    public void createProgram(android.filterfw.core.FilterContext context, android.filterfw.core.FrameFormat format) {
        ...
        switch (mInputBPP) {
            case 1 :
                mProgram = new android.filterfw.core.NativeProgram("filterpack_imageproc", "gray_to_rgb");
                break;
            case 4 :
                mProgram = new android.filterfw.core.NativeProgram("filterpack_imageproc", "rgba_to_rgb");
                break;
            default :
