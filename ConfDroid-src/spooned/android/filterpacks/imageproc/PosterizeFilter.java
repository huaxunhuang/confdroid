...
public class PosterizeFilter extends android.filterfw.core.Filter {
    ...
    private final java.lang.String mPosterizeShader = "precision mediump float;\n" + ((((((((("uniform sampler2D tex_sampler_0;\n" + "varying vec2 v_texcoord;\n") + "void main() {\n") + "  vec4 color = texture2D(tex_sampler_0, v_texcoord);\n") + "  vec3 pcolor;\n") + "  pcolor.r = (color.r >= 0.5) ? 0.75 : 0.25;\n") + "  pcolor.g = (color.g >= 0.5) ? 0.75 : 0.25;\n") + "  pcolor.b = (color.b >= 0.5) ? 0.75 : 0.25;\n") + "  gl_FragColor = vec4(pcolor, color.a);\n") + "}\n");

    public PosterizeFilter(java.lang.String name) {
        super(name);
    }
    ...
    public void initProgram(android.filterfw.core.FilterContext context, int target) {
        switch (target) {
            case android.filterfw.core.FrameFormat.TARGET_GPU :
                android.filterfw.core.ShaderProgram shaderProgram = new android.filterfw.core.ShaderProgram(context, mPosterizeShader);
