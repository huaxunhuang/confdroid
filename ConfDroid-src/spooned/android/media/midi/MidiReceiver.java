...
public abstract class MidiReceiver {
     ...
     */
    public MidiReceiver() {
        mMaxMessageSize = java.lang.Integer.MAX_VALUE;
    }
     ...
     * @param timestamp
     * 		the timestamp of the message (based on {@link java.lang.System#nanoTime}
     * @throws IOException
     * 		
     */
     ...
     */
    public void send(byte[] msg, int offset, int count) throws java.io.IOException {
     ...
     * 		if the data could not be sent in entirety
     */
    public void send(byte[] msg, int offset, int count, long timestamp) throws java.io.IOException {
