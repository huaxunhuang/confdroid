...
public final class MidiDeviceInfo implements android.os.Parcelable {
    ...
    public static final class PortInfo {
        ...
        PortInfo(int type, int portNumber, java.lang.String name) {
            mPortType = type;
     ...
     * @unknown 
     */
    public MidiDeviceInfo(int type, int id, int numInputPorts, int numOutputPorts, java.lang.String[] inputPortNames, java.lang.String[] outputPortNames, android.os.Bundle properties, boolean isPrivate) {
        mType = type;
        mId = id;
        mInputPortCount = numInputPorts;
        mOutputPortCount = numOutputPorts;
        if (inputPortNames == null) {
            mInputPortNames = new java.lang.String[numInputPorts];
        } else {
            mInputPortNames = inputPortNames;
        }
        if (outputPortNames == null) {
            mOutputPortNames = new java.lang.String[numOutputPorts];
        } else {
    ...
    public android.media.midi.MidiDeviceInfo.PortInfo[] getPorts() {
        android.media.midi.MidiDeviceInfo.PortInfo[] ports = new android.media.midi.MidiDeviceInfo.PortInfo[mInputPortCount + mOutputPortCount];
        int index = 0;
        for (int i = 0; i < mInputPortCount; i++) {
            ports[index++] = new android.media.midi.MidiDeviceInfo.PortInfo(android.media.midi.MidiDeviceInfo.PortInfo.TYPE_INPUT, i, mInputPortNames[i]);
        }
        for (int i = 0; i < mOutputPortCount; i++) {
            ports[index++] = new android.media.midi.MidiDeviceInfo.PortInfo(android.media.midi.MidiDeviceInfo.PortInfo.TYPE_OUTPUT, i, mOutputPortNames[i]);
        }
        return ports;
    }
    ...
    public boolean equals(java.lang.Object o) {
        if (o instanceof android.media.midi.MidiDeviceInfo) {
            return ((android.media.midi.MidiDeviceInfo) (o)).mId == mId;
        } else {
            return false;
        }
    }
    ...
    public java.lang.String toString() {
        ...
        mProperties.getString(android.media.midi.MidiDeviceInfo.PROPERTY_NAME);
        return (((((((("MidiDeviceInfo[mType=" + mType) + ",mInputPortCount=") + mInputPortCount) + ",mOutputPortCount=") + mOutputPortCount) + ",mProperties=") + mProperties) + ",mIsPrivate=") + mIsPrivate;
    }

    public static final android.os.Parcelable.Creator<android.media.midi.MidiDeviceInfo> CREATOR = new android.os.Parcelable.Creator<android.media.midi.MidiDeviceInfo>() {
        public android.media.midi.MidiDeviceInfo createFromParcel(android.os.Parcel in) {
            int type = in.readInt();
            int id = in.readInt();
            int inputPorts = in.readInt();
            int outputPorts = in.readInt();
            java.lang.String[] inputPortNames = in.createStringArray();
            java.lang.String[] outputPortNames = in.createStringArray();
            android.os.Bundle properties = in.readBundle();
            boolean isPrivate = in.readInt() == 1;
            return new android.media.midi.MidiDeviceInfo(type, id, inputPorts, outputPorts, inputPortNames, outputPortNames, properties, isPrivate);
        }

        public android.media.midi.MidiDeviceInfo[] newArray(int size) {
            return new android.media.midi.MidiDeviceInfo[size];
        }
    };
