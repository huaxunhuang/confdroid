...
public class MediaMetadataRetriever {
    ...
    public void setDataSource(java.lang.String path) throws java.lang.IllegalArgumentException {
        ...
        try (java.io.FileInputStream is = new java.io.FileInputStream(path)) {
     ...
     */
    public void setDataSource(java.lang.String uri, java.util.Map<java.lang.String, java.lang.String> headers) throws java.lang.IllegalArgumentException {
        int i = 0;
        java.lang.String[] keys = new java.lang.String[headers.size()];
        java.lang.String[] values = new java.lang.String[headers.size()];
        for (java.util.Map.Entry<java.lang.String, java.lang.String> entry : headers.entrySet()) {
            keys[i] = entry.getKey();
            values[i] = entry.getValue();
            ++i;
        }
        _setDataSource(android.media.MediaHTTPService.createHttpServiceBinderIfNecessary(uri), uri, keys, values);
    }

    private native void _setDataSource(android.os.IBinder httpServiceBinder, java.lang.String uri, java.lang.String[] keys, java.lang.String[] values) throws java.lang.IllegalArgumentException;
     ...
     */
    public void setDataSource(java.io.FileDescriptor fd) throws java.lang.IllegalArgumentException {
    ...
    public void setDataSource(android.content.Context context, android.net.Uri uri) throws java.lang.IllegalArgumentException, java.lang.SecurityException {
        ...
        try {
            ...
            java.io.FileDescriptor descriptor = fd.getFileDescriptor();
            if (!descriptor.valid()) {
                throw new java.lang.IllegalArgumentException();
            }
     ...
     */
    public void setDataSource(android.media.MediaDataSource dataSource) throws java.lang.IllegalArgumentException {
        _setDataSource(dataSource);
    }

    private native void _setDataSource(android.media.MediaDataSource dataSource) throws java.lang.IllegalArgumentException;
    ...
    public android.graphics.Bitmap getFrameAtTime(long timeUs, int option) {
        if ((option < android.media.MediaMetadataRetriever.OPTION_PREVIOUS_SYNC) || (option > android.media.MediaMetadataRetriever.OPTION_CLOSEST)) {
            throw new java.lang.IllegalArgumentException("Unsupported option: " + option);
        }
    ...
    public android.graphics.Bitmap getFrameAtTime(long timeUs) {
        return getFrameAtTime(timeUs, android.media.MediaMetadataRetriever.OPTION_CLOSEST_SYNC);
    }
    ...
    public android.graphics.Bitmap getFrameAtTime() {
        return getFrameAtTime(-1, android.media.MediaMetadataRetriever.OPTION_CLOSEST_SYNC);
    }
    ...
    public byte[] getEmbeddedPicture() {
        return getEmbeddedPicture(android.media.MediaMetadataRetriever.EMBEDDED_PICTURE_TYPE_ANY);
    }
     ...
     * @see #getFrameAtTime(long, int)
     */
    public static final int OPTION_PREVIOUS_SYNC = 0x0;
     ...
     * @see #getFrameAtTime(long, int)
     */
    public static final int OPTION_NEXT_SYNC = 0x1;
     ...
     * @see #getFrameAtTime(long, int)
     */
    public static final int OPTION_CLOSEST_SYNC = 0x2;
     ...
     * @see #getFrameAtTime(long, int)
     */
    public static final int OPTION_CLOSEST = 0x3;
