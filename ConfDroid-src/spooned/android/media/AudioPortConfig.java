...
public class AudioPortConfig {
    ...
    AudioPortConfig(android.media.AudioPort port, int samplingRate, int channelMask, int format, android.media.AudioGainConfig gain) {
        mPort = port;
    ...
    public java.lang.String toString() {
        return ((((((((("{mPort:" + mPort) + ", mSamplingRate:") + mSamplingRate) + ", mChannelMask: ") + mChannelMask) + ", mFormat:") + mFormat) + ", mGain:") + mGain) + "}";
    }
}
