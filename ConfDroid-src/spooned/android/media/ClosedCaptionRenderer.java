...
public class ClosedCaptionRenderer extends android.media.SubtitleController.Renderer {
    ...
    public boolean supports(android.media.MediaFormat format) {
        if (format.containsKey(android.media.MediaFormat.KEY_MIME)) {
            ...
            return android.media.MediaPlayer.MEDIA_MIMETYPE_TEXT_CEA_608.equals(mimeType);
        }
        return false;
    }
    ...
    public android.media.SubtitleTrack createTrack(android.media.MediaFormat format) {
        java.lang.String mimeType = format.getString(android.media.MediaFormat.KEY_MIME);
        if (android.media.MediaPlayer.MEDIA_MIMETYPE_TEXT_CEA_608.equals(mimeType)) {
            if (mCCWidget == null) {
                mCCWidget = new android.media.Cea608CCWidget(mContext);
            }
            return new android.media.Cea608CaptionTrack(mCCWidget, format);
        }
