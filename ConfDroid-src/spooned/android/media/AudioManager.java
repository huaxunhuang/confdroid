...
public class AudioManager {
    ...
    private static java.lang.String TAG = "AudioManager";
     ...
     *
     *
     * @unknown Sticky broadcast intent action indicating that the internal ringer mode has
    changed. Includes the new ringer mode.
     * @see #EXTRA_RINGER_MODE
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
     ...
     *
     *
     * @unknown Broadcast intent when the volume for a particular stream type changes.
     ...
     *
     *
     * @unknown Broadcast intent when the devices for a particular stream type changes.
     ...
     *
     *
     * @unknown Broadcast intent when a stream mute state changes.
     ...
     *
     *
     * @unknown Broadcast intent when the master mute state changes.
     ...
     *
     *
     * @unknown The stream type for the volume changed intent.
     */
     ...
     *
     *
     * @unknown The stream type alias for the volume changed intent.
     ...
     *
     *
     * @unknown The volume associated with the stream for the volume changed intent.
     */
     ...
     *
     *
     * @unknown The previous volume associated with the stream for the volume changed intent.
     */
     ...
     *
     *
     * @unknown The devices associated with the stream for the stream devices changed intent.
     */
     ...
     *
     *
     * @unknown The previous devices associated with the stream for the stream devices changed intent.
     */
     ...
     *
     *
     * @unknown The new master volume mute state for the master mute changed intent.
    Value is boolean
     */
     ...
     *
     *
     * @unknown The new stream volume mute state for the stream mute changed intent.
    Value is boolean
     */
     ...
     */
    public static final int STREAM_VOICE_CALL = android.media.AudioSystem.STREAM_VOICE_CALL;

    /**
     * The audio stream for system sounds
     */
    public static final int STREAM_SYSTEM = android.media.AudioSystem.STREAM_SYSTEM;

    /**
     * The audio stream for the phone ring
     */
    public static final int STREAM_RING = android.media.AudioSystem.STREAM_RING;

    /**
     * The audio stream for music playback
     */
    public static final int STREAM_MUSIC = android.media.AudioSystem.STREAM_MUSIC;

    /**
     * The audio stream for alarms
     */
    public static final int STREAM_ALARM = android.media.AudioSystem.STREAM_ALARM;

    /**
     * The audio stream for notifications
     */
    public static final int STREAM_NOTIFICATION = android.media.AudioSystem.STREAM_NOTIFICATION;

    /**
     *
     *
     * @unknown The audio stream for phone calls when connected to bluetooth
     */
    public static final int STREAM_BLUETOOTH_SCO = android.media.AudioSystem.STREAM_BLUETOOTH_SCO;

    /**
     *
     *
     * @unknown The audio stream for enforced system sounds in certain countries (e.g camera in Japan)
     */
    public static final int STREAM_SYSTEM_ENFORCED = android.media.AudioSystem.STREAM_SYSTEM_ENFORCED;

    /**
     * The audio stream for DTMF Tones
     */
    public static final int STREAM_DTMF = android.media.AudioSystem.STREAM_DTMF;

    /**
     *
     *
     * @unknown The audio stream for text to speech (TTS)
     */
    public static final int STREAM_TTS = android.media.AudioSystem.STREAM_TTS;
    ...
    public static final int NUM_STREAMS = android.media.AudioSystem.NUM_STREAMS;
    ...
    public static java.lang.String flagsToString(int flags) {
        ...
        for (int i = 0; i < android.media.AudioManager.FLAG_NAMES.length; i++) {
            final int flag = 1 << i;
            if ((flags & flag) != 0) {
                if (sb.length() > 0) {
                    sb.append(',');
                }
                sb.append(android.media.AudioManager.FLAG_NAMES[i]);
                flags &= ~flag;
            }
        }
        if (flags != 0) {
     ...
     * @unknown 
     */
    public static final int RINGER_MODE_MAX = android.media.AudioManager.RINGER_MODE_NORMAL;
     ...
     */
    public static final int USE_DEFAULT_STREAM_TYPE = java.lang.Integer.MIN_VALUE;
    ...
    public AudioManager(android.content.Context context) {
        setContext(context);
        mUseVolumeKeySounds = getContext().getResources().getBoolean(com.android.internal.R.bool.config_useVolumeKeySounds);
        mUseFixedVolume = getContext().getResources().getBoolean(com.android.internal.R.bool.config_useFixedVolume);
    }
    ...
    private static android.media.IAudioService getService() {
        if (android.media.AudioManager.sService != null) {
            return android.media.AudioManager.sService;
        }
        android.os.IBinder b = android.os.ServiceManager.getService(android.content.Context.AUDIO_SERVICE);
        android.media.AudioManager.sService = IAudioService.Stub.asInterface(b);
        return android.media.AudioManager.sService;
    }
    ...
    public void dispatchMediaKeyEvent(android.view.KeyEvent keyEvent) {
        android.media.session.MediaSessionLegacyHelper helper = android.media.session.MediaSessionLegacyHelper.getHelper(getContext());
     ...
     * @unknown 
     */
    public void preDispatchKeyEvent(android.view.KeyEvent event, int stream) {
        /* If the user hits another key within the play sound delay, then
        cancel the sound
         */
        int keyCode = event.getKeyCode();
        if ((((keyCode != android.view.KeyEvent.KEYCODE_VOLUME_DOWN) && (keyCode != android.view.KeyEvent.KEYCODE_VOLUME_UP)) && (keyCode != android.view.KeyEvent.KEYCODE_VOLUME_MUTE)) && ((mVolumeKeyUpTime + android.media.AudioSystem.PLAY_SOUND_DELAY) > android.os.SystemClock.uptimeMillis())) {
            /* The user has hit another key during the delay (e.g., 300ms)
            since the last volume key up, so cancel any sounds.
             */
            adjustSuggestedStreamVolume(android.media.AudioManager.ADJUST_SAME, stream, android.media.AudioManager.FLAG_REMOVE_SOUND_AND_VIBRATE);
        }
    }
     ...
     * @unknown 
     */
    public void handleKeyDown(android.view.KeyEvent event, int stream) {
        int keyCode = event.getKeyCode();
        switch (keyCode) {
            ...
            case android.view.KeyEvent.KEYCODE_VOLUME_DOWN :
                 ...
                 */
                adjustSuggestedStreamVolume(keyCode == android.view.KeyEvent.KEYCODE_VOLUME_UP ? android.media.AudioManager.ADJUST_RAISE : android.media.AudioManager.ADJUST_LOWER, stream, android.media.AudioManager.FLAG_SHOW_UI | android.media.AudioManager.FLAG_VIBRATE);
                break;
            case android.view.KeyEvent.KEYCODE_VOLUME_MUTE :
                if (event.getRepeatCount() == 0) {
                    android.media.session.MediaSessionLegacyHelper.getHelper(getContext()).sendVolumeKeyEvent(event, false);
                }
                break;
        }
    }
     ...
     * @unknown 
     */
    public void handleKeyUp(android.view.KeyEvent event, int stream) {
        int keyCode = event.getKeyCode();
        switch (keyCode) {
            case android.view.KeyEvent.KEYCODE_VOLUME_UP :
            case android.view.KeyEvent.KEYCODE_VOLUME_DOWN :
                ...
                if (mUseVolumeKeySounds) {
                    adjustSuggestedStreamVolume(android.media.AudioManager.ADJUST_SAME, stream, android.media.AudioManager.FLAG_PLAY_SOUND);
                }
                mVolumeKeyUpTime = android.os.SystemClock.uptimeMillis();
                break;
            case android.view.KeyEvent.KEYCODE_VOLUME_MUTE :
                android.media.session.MediaSessionLegacyHelper.getHelper(getContext()).sendVolumeKeyEvent(event, false);
                break;
     ...
     *
     * @param streamType
     * 		The stream type to adjust. One of {@link #STREAM_VOICE_CALL},
    ...
    public void adjustStreamVolume(int streamType, int direction, int flags) {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
    ...
    public void adjustVolume(int direction, int flags) {
        android.media.session.MediaSessionLegacyHelper helper = android.media.session.MediaSessionLegacyHelper.getHelper(getContext());
        helper.sendAdjustVolumeBy(android.media.AudioManager.USE_DEFAULT_STREAM_TYPE, direction, flags);
    }
    ...
    public void setMasterMute(boolean mute, int flags) {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
            service.setMasterMute(mute, flags, getContext().getOpPackageName(), android.os.UserHandle.getCallingUserId());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public static boolean isValidRingerMode(int ringerMode) {
        if ((ringerMode < 0) || (ringerMode > android.media.AudioManager.RINGER_MODE_MAX)) {
            return false;
        }
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
     ...
     *
     * @param ringerMode
     * 		The ringer mode, one of {@link #RINGER_MODE_NORMAL},
     * 		{@link #RINGER_MODE_SILENT}, or {@link #RINGER_MODE_VIBRATE}.
     * @see #getRingerMode()
     * @see #isVolumeFixed()
     */
    ...
    public void setStreamSolo(int streamType, boolean state) {
        android.util.Log.w(android.media.AudioManager.TAG, "setStreamSolo has been deprecated. Do not use.");
    }
    ...
    public void setStreamMute(int streamType, boolean state) {
        android.util.Log.w(android.media.AudioManager.TAG, "setStreamMute is deprecated. adjustStreamVolume should be used instead.");
        int direction = (state) ? android.media.AudioManager.ADJUST_MUTE : android.media.AudioManager.ADJUST_UNMUTE;
        if (streamType == android.media.AudioManager.USE_DEFAULT_STREAM_TYPE) {
     ...
     *
     *
     * @unknown Start bluetooth SCO audio connection in virtual call mode.
    <p>Requires Permission:
    {@link android.Manifest.permission#MODIFY_AUDIO_SETTINGS}.
     ...
     *
     * @param on
     * 		set <var>true</var> to route A2DP audio to/from Bluetooth
    ...
    public boolean isBluetoothA2dpOn() {
        if (android.media.AudioSystem.getDeviceConnectionState(android.media.AudioManager.DEVICE_OUT_BLUETOOTH_A2DP, "") == android.media.AudioSystem.DEVICE_STATE_AVAILABLE) {
            return true;
        } else
            if (android.media.AudioSystem.getDeviceConnectionState(android.media.AudioManager.DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES, "") == android.media.AudioSystem.DEVICE_STATE_AVAILABLE) {
                return true;
            } else
                if (android.media.AudioSystem.getDeviceConnectionState(android.media.AudioManager.DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER, "") == android.media.AudioSystem.DEVICE_STATE_AVAILABLE) {
                    return true;
                }
    ...
    public boolean isWiredHeadsetOn() {
        if ((android.media.AudioSystem.getDeviceConnectionState(android.media.AudioManager.DEVICE_OUT_WIRED_HEADSET, "") == android.media.AudioSystem.DEVICE_STATE_UNAVAILABLE) && (android.media.AudioSystem.getDeviceConnectionState(android.media.AudioManager.DEVICE_OUT_WIRED_HEADPHONE, "") == android.media.AudioSystem.DEVICE_STATE_UNAVAILABLE)) {
            return false;
        } else {
            return true;
        }
    ...
    public void setMicrophoneMute(boolean on) {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
            service.setMicrophoneMute(on, getContext().getOpPackageName(), android.os.UserHandle.getCallingUserId());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param mode
     * 		the requested audio mode ({@link #MODE_NORMAL}, {@link #MODE_RINGTONE},
     ...
     * Invalid audio mode.
     */
    public static final int MODE_INVALID = android.media.AudioSystem.MODE_INVALID;

    /**
     * Current audio mode. Used to apply audio routing to current mode.
     */
    public static final int MODE_CURRENT = android.media.AudioSystem.MODE_CURRENT;

    /**
     * Normal audio mode: not ringing and no call established.
     */
    public static final int MODE_NORMAL = android.media.AudioSystem.MODE_NORMAL;

    /**
     * Ringing audio mode. An incoming is being signaled.
     */
    public static final int MODE_RINGTONE = android.media.AudioSystem.MODE_RINGTONE;

    /**
     * In call audio mode. A telephony call is established.
     */
    public static final int MODE_IN_CALL = android.media.AudioSystem.MODE_IN_CALL;

    /**
     * In communication audio mode. An audio/video chat or VoIP call is established.
     */
    public static final int MODE_IN_COMMUNICATION = android.media.AudioSystem.MODE_IN_COMMUNICATION;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_EARPIECE = android.media.AudioSystem.ROUTE_EARPIECE;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_SPEAKER = android.media.AudioSystem.ROUTE_SPEAKER;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_BLUETOOTH = android.media.AudioSystem.ROUTE_BLUETOOTH_SCO;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_BLUETOOTH_SCO = android.media.AudioSystem.ROUTE_BLUETOOTH_SCO;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_HEADSET = android.media.AudioSystem.ROUTE_HEADSET;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_BLUETOOTH_A2DP = android.media.AudioSystem.ROUTE_BLUETOOTH_A2DP;
     ...
     */
    @java.lang.Deprecated
    public static final int ROUTE_ALL = android.media.AudioSystem.ROUTE_ALL;
    ...
    public boolean isMusicActive() {
        return android.media.AudioSystem.isStreamActive(android.media.AudioManager.STREAM_MUSIC, 0);
    }

    /**
     *
     *
     * @unknown Checks whether any music or media is actively playing on a remote device (e.g. wireless
    ...
    public boolean isMusicActiveRemotely() {
        return android.media.AudioSystem.isStreamActiveRemotely(android.media.AudioManager.STREAM_MUSIC, 0);
    }

    /**
     *
     *
     * @unknown Checks whether the current audio focus is exclusive.
    ...
    public boolean isAudioFocusExclusive() {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
            return service.getCurrentAudioFocus() == android.media.AudioManager.AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE;
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int generateAudioSessionId() {
        int session = android.media.AudioSystem.newAudioSessionId();
        if (session > 0) {
            return session;
        } else {
            android.util.Log.e(android.media.AudioManager.TAG, "Failure to generate a new audio session ID");
     ...
     */
    public static final int AUDIO_SESSION_ID_GENERATE = android.media.AudioSystem.AUDIO_SESSION_ALLOCATE;
    ...
    ** Temporary interface - DO NOT USE
    ...
    public void setParameters(java.lang.String keyValuePairs) {
        android.media.AudioSystem.setParameters(keyValuePairs);
    }
     ...
     *
     *
     * @unknown Number of sound effects
     */
    ...
    public void playSoundEffect(int effectType) {
        if ((effectType < 0) || (effectType >= android.media.AudioManager.NUM_SOUND_EFFECTS)) {
            return;
        }
        if (!querySoundEffectsEnabled(android.os.Process.myUserHandle().getIdentifier())) {
            return;
        }
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
    ...
    private boolean querySoundEffectsEnabled(int user) {
        return android.provider.Settings.System.getIntForUser(getContext().getContentResolver(), android.provider.Settings.System.SOUND_EFFECTS_ENABLED, 0, user) != 0;
    }
     ...
     *
     *
     * @unknown Used to indicate no audio focus has been gained or lost.
     */
     ...
     * @see OnAudioFocusChangeListener#onAudioFocusChange(int)
     */
    public static final int AUDIOFOCUS_LOSS = (-1) * android.media.AudioManager.AUDIOFOCUS_GAIN;
     ...
     * @see OnAudioFocusChangeListener#onAudioFocusChange(int)
     */
    public static final int AUDIOFOCUS_LOSS_TRANSIENT = (-1) * android.media.AudioManager.AUDIOFOCUS_GAIN_TRANSIENT;
     ...
     * @see OnAudioFocusChangeListener#onAudioFocusChange(int)
     */
    public static final int AUDIOFOCUS_LOSS_TRANSIENT_CAN_DUCK = (-1) * android.media.AudioManager.AUDIOFOCUS_GAIN_TRANSIENT_MAY_DUCK;
    ...
    public interface OnAudioFocusChangeListener {
         ...
         *
         * @param focusChange
         * 		the type of focus change, one of {@link AudioManager#AUDIOFOCUS_GAIN},
     ...
     */
    private final java.util.HashMap<java.lang.String, android.media.AudioManager.OnAudioFocusChangeListener> mAudioFocusIdListenerMap = new java.util.HashMap<java.lang.String, android.media.AudioManager.OnAudioFocusChangeListener>();

    /**
     * Lock to prevent concurrent changes to the list of focus listeners for this AudioManager
     * instance.
     */
    private final java.lang.Object mFocusListenerLock = new java.lang.Object();

    private android.media.AudioManager.OnAudioFocusChangeListener findFocusListener(java.lang.String id) {
            ...
            if (looper != null) {
                ...
                mHandler = new android.os.Handler(looper) {
                    ...
                    public void handleMessage(android.os.Message msg) {
                        switch (msg.what) {
                            case android.media.AudioManager.MSSG_FOCUS_CHANGE :
                                android.media.AudioManager.OnAudioFocusChangeListener listener = null;
                                synchronized(mFocusListenerLock) {
                                    listener = findFocusListener(((java.lang.String) (msg.obj)));
                                }
                                if (listener != null) {
                                    android.util.Log.d(android.media.AudioManager.TAG, (("AudioManager dispatching onAudioFocusChange(" + msg.arg1) + ") for ") + msg.obj);
                                    listener.onAudioFocusChange(msg.arg1);
                                }
                                break;
                            case android.media.AudioManager.MSSG_RECORDING_CONFIG_CHANGE :
                                final android.media.AudioManager.RecordConfigChangeCallbackData cbData = ((android.media.AudioManager.RecordConfigChangeCallbackData) (msg.obj));
                                if (cbData.mCb != null) {
                                    cbData.mCb.onRecordingConfigChanged(cbData.mConfigs);
                                }
                                break;
                            default :
                                android.util.Log.e(android.media.AudioManager.TAG, "Unknown event " + msg.what);
                        }
                    }
                };
            } else {
    ...
    private final android.media.IAudioFocusDispatcher mAudioFocusDispatcher = new android.media.IAudioFocusDispatcher.Stub() {
        public void dispatchAudioFocusChange(int focusChange, java.lang.String id) {
            final android.os.Message m = /* what */
            /* arg1 */
            /* arg2 ignored */
            /* obj */
            mServiceEventHandlerDelegate.getHandler().obtainMessage(android.media.AudioManager.MSSG_FOCUS_CHANGE, focusChange, 0, id);
            mServiceEventHandlerDelegate.getHandler().sendMessage(m);
        }
    };

    private java.lang.String getIdForAudioFocusListener(android.media.AudioManager.OnAudioFocusChangeListener l) {
        if (l == null) {
            return new java.lang.String(this.toString());
        } else {
            return new java.lang.String(this.toString() + l.toString());
        }
    }
     ...
     *
     *
     * @unknown Registers a listener to be called when audio focus changes. Calling this method is optional
     ...
     */
    public void registerAudioFocusListener(android.media.AudioManager.OnAudioFocusChangeListener l) {
        synchronized(mFocusListenerLock) {
     ...
     *
     *
     * @unknown Causes the specified listener to not be called anymore when focus is gained or lost.
     * @param l
     * 		the listener to unregister.
     */
    public void unregisterAudioFocusListener(android.media.AudioManager.OnAudioFocusChangeListener l) {
        // remove locally
        synchronized(mFocusListenerLock) {
     ...
     *
     *
     * @unknown A focus change request whose granting is delayed: the request was successful, but the
     ...
     * @param durationHint
     * 		use {@link #AUDIOFOCUS_GAIN_TRANSIENT} to indicate this focus request
    ...
    public int requestAudioFocus(android.media.AudioManager.OnAudioFocusChangeListener l, int streamType, int durationHint) {
        int status = android.media.AudioManager.AUDIOFOCUS_REQUEST_FAILED;
        try {
            ...
            status = /* flags, legacy behavior */
            requestAudioFocus(l, new android.media.AudioAttributes.Builder().setInternalLegacyStreamType(streamType).build(), durationHint, 0);
        } catch (java.lang.IllegalArgumentException e) {
            android.util.Log.e(android.media.AudioManager.TAG, "Audio focus request denied due to ", e);
        }
        return status;
    }
     ...
     *
     *
     * @unknown Use this flag when requesting audio focus to indicate it is ok for the requester to not be
     ...
     *
     *
     * @unknown Use this flag when requesting audio focus to indicate that the requester
     ...
     *
     *
     * @unknown Use this flag to lock audio focus so granting is temporarily disabled.
     ...
     * @unknown 
     */
    public static final int AUDIOFOCUS_FLAGS_APPS = android.media.AudioManager.AUDIOFOCUS_FLAG_DELAY_OK | android.media.AudioManager.AUDIOFOCUS_FLAG_PAUSES_ON_DUCKABLE_LOSS;
     ...
     * @unknown 
     */
    public static final int AUDIOFOCUS_FLAGS_SYSTEM = (android.media.AudioManager.AUDIOFOCUS_FLAG_DELAY_OK | android.media.AudioManager.AUDIOFOCUS_FLAG_PAUSES_ON_DUCKABLE_LOSS) | android.media.AudioManager.AUDIOFOCUS_FLAG_LOCK;

    /**
     *
     *
     * @unknown Request audio focus.
     ...
     * 		non null {@link AudioAttributes} describing the main reason for
     ...
     */
    @android.annotation.SystemApi
    public int requestAudioFocus(android.media.AudioManager.OnAudioFocusChangeListener l, @android.annotation.NonNull
    android.media.AudioAttributes requestAttributes, int durationHint, int flags) throws java.lang.IllegalArgumentException {
        if (flags != (flags & android.media.AudioManager.AUDIOFOCUS_FLAGS_APPS)) {
            throw new java.lang.IllegalArgumentException("Invalid flags 0x" + java.lang.Integer.toHexString(flags).toUpperCase());
        }
        return /* no AudioPolicy */
        requestAudioFocus(l, requestAttributes, durationHint, flags & android.media.AudioManager.AUDIOFOCUS_FLAGS_APPS, null);
    }

    /**
     *
     *
     * @unknown Request or lock audio focus.
     ...
     * 		state where focus cannot change (e.g. a phone call).
     * @param ap
     * 		a registered {@link android.media.audiopolicy.AudioPolicy} instance when locking
     * 		focus, or null.
    ...
    @android.annotation.SystemApi
    public int requestAudioFocus(android.media.AudioManager.OnAudioFocusChangeListener l, @android.annotation.NonNull
    android.media.AudioAttributes requestAttributes, int durationHint, int flags, android.media.audiopolicy.AudioPolicy ap) throws java.lang.IllegalArgumentException {
        // parameter checking
        if (requestAttributes == null) {
            throw new java.lang.IllegalArgumentException("Illegal null AudioAttributes argument");
        }
        if ((durationHint < android.media.AudioManager.AUDIOFOCUS_GAIN) || (durationHint > android.media.AudioManager.AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE)) {
            throw new java.lang.IllegalArgumentException("Invalid duration hint");
        }
        if (flags != (flags & android.media.AudioManager.AUDIOFOCUS_FLAGS_SYSTEM)) {
            throw new java.lang.IllegalArgumentException("Illegal flags 0x" + java.lang.Integer.toHexString(flags).toUpperCase());
        }
        if (((flags & android.media.AudioManager.AUDIOFOCUS_FLAG_DELAY_OK) == android.media.AudioManager.AUDIOFOCUS_FLAG_DELAY_OK) && (l == null)) {
            throw new java.lang.IllegalArgumentException("Illegal null focus listener when flagged as accepting delayed focus grant");
        }
        if (((flags & android.media.AudioManager.AUDIOFOCUS_FLAG_LOCK) == android.media.AudioManager.AUDIOFOCUS_FLAG_LOCK) && (ap == null)) {
        ...
        try {
            status = /* package name */
            service.requestAudioFocus(requestAttributes, durationHint, mICallBack, mAudioFocusDispatcher, getIdForAudioFocusListener(l), getContext().getOpPackageName(), flags, ap != null ? ap.cb() : null);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
        return status;
     ...
     *
     *
     * @unknown Used internally by telephony package to request audio focus. Will cause the focus request
    ...
    public void requestAudioFocusForCall(int streamType, int durationHint) {
        ...
        try {
            /* policy token */
            service.requestAudioFocus(new android.media.AudioAttributes.Builder().setInternalLegacyStreamType(streamType).build(), durationHint, mICallBack, null, android.media.AudioSystem.IN_VOICE_COMM_FOCUS_ID, getContext().getOpPackageName(), android.media.AudioManager.AUDIOFOCUS_FLAG_LOCK, null);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     *
     * @unknown Used internally by telephony package to abandon audio focus, typically after a call or
    ...
    public void abandonAudioFocusForCall() {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
            /* AudioAttributes, legacy behavior */
            service.abandonAudioFocus(null, android.media.AudioSystem.IN_VOICE_COMM_FOCUS_ID, null);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int abandonAudioFocus(android.media.AudioManager.OnAudioFocusChangeListener l) {
        return /* AudioAttributes, legacy behavior */
        abandonAudioFocus(l, null);
    }

    /**
     *
     *
     * @unknown Abandon audio focus. Causes the previous focus owner, if any, to receive focus.
     * @param l
     * 		the listener with which focus was requested.
     * @param aa
     * 		the {@link AudioAttributes} with which audio focus was requested
     * @return {@link #AUDIOFOCUS_REQUEST_FAILED} or {@link #AUDIOFOCUS_REQUEST_GRANTED}
     */
    @android.annotation.SystemApi
    public int abandonAudioFocus(android.media.AudioManager.OnAudioFocusChangeListener l, android.media.AudioAttributes aa) {
        int status = android.media.AudioManager.AUDIOFOCUS_REQUEST_FAILED;
     ...
     *
     * @param eventReceiver
     * 		identifier of a {@link android.content.BroadcastReceiver}
    ...
    public void registerMediaButtonEventReceiver(android.content.ComponentName eventReceiver) {
        ...
        if (!eventReceiver.getPackageName().equals(getContext().getPackageName())) {
            android.util.Log.e(android.media.AudioManager.TAG, "registerMediaButtonEventReceiver() error: " + "receiver and context package names don't match");
            return;
        }
        ...
        android.app.PendingIntent pi = /* requestCode, ignored */
        /* flags */
        android.app.PendingIntent.getBroadcast(getContext(), 0, mediaButtonIntent, 0);
     ...
     *
     *
     * @unknown no-op if (pi == null) or (eventReceiver == null)
     */
    public void registerMediaButtonIntent(android.app.PendingIntent pi, android.content.ComponentName eventReceiver) {
        if (pi == null) {
            android.util.Log.e(android.media.AudioManager.TAG, "Cannot call registerMediaButtonIntent() with a null parameter");
            return;
        }
        android.media.session.MediaSessionLegacyHelper helper = android.media.session.MediaSessionLegacyHelper.getHelper(getContext());
     ...
     * @unknown 
     */
    public void unregisterMediaButtonIntent(android.app.PendingIntent pi) {
        android.media.session.MediaSessionLegacyHelper helper = android.media.session.MediaSessionLegacyHelper.getHelper(getContext());
    ...
    public void registerRemoteControlClient(android.media.RemoteControlClient rcClient) {
        ...
        rcClient.registerWithSession(android.media.session.MediaSessionLegacyHelper.getHelper(getContext()));
    }
    ...
    public void unregisterRemoteControlClient(android.media.RemoteControlClient rcClient) {
        ...
        rcClient.unregisterWithSession(android.media.session.MediaSessionLegacyHelper.getHelper(getContext()));
    }
     ...
     */
    @android.annotation.SystemApi
    public int registerAudioPolicy(@android.annotation.NonNull
    android.media.audiopolicy.AudioPolicy policy) {
        ...
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
            java.lang.String regId = service.registerAudioPolicy(policy.getConfig(), policy.cb(), policy.hasFocusListener());
            if (regId == null) {
                return android.media.AudioManager.ERROR;
            } else {
        ...
        return android.media.AudioManager.SUCCESS;
    }
     ...
     * @unknown 
     * @param policy
     * 		the non-null {@link AudioPolicy} to unregister.
     */
    @android.annotation.SystemApi
    public void unregisterAudioPolicyAsync(@android.annotation.NonNull
    android.media.audiopolicy.AudioPolicy policy) {
        if (policy == null) {
            throw new java.lang.IllegalArgumentException("Illegal null AudioPolicy argument");
        }
    ...
    private static class AudioRecordingCallbackInfo {
        ...
        AudioRecordingCallbackInfo(android.media.AudioManager.AudioRecordingCallback cb, android.os.Handler handler) {
            mCb = cb;
            mHandler = handler;
        }
    }
    ...
    private static final class RecordConfigChangeCallbackData {
        ...
        RecordConfigChangeCallbackData(android.media.AudioManager.AudioRecordingCallback cb, java.util.List<android.media.AudioRecordingConfiguration> configs) {
            mCb = cb;
            mConfigs = configs;
        }
    }
     ...
     *
     * @param cb
     * 		non-null callback to register
     * @param handler
     * 		the {@link Handler} object for the thread on which to execute
     * 		the callback. If <code>null</code>, the {@link Handler} associated with the main
     * 		{@link Looper} will be used.
     */
    public void registerAudioRecordingCallback(@android.annotation.NonNull
    android.media.AudioManager.AudioRecordingCallback cb, android.os.Handler handler) {
        if (cb == null) {
        ...
        synchronized(mRecordCallbackLock) {
            ...
            if (mRecordCallbackList == null) {
                mRecordCallbackList = new java.util.ArrayList<android.media.AudioManager.AudioRecordingCallbackInfo>();
            }
            final int oldCbCount = mRecordCallbackList.size();
            if (!hasRecordCallback_sync(cb)) {
                mRecordCallbackList.add(new android.media.AudioManager.AudioRecordingCallbackInfo(cb, new android.media.AudioManager.ServiceEventHandlerDelegate(handler).getHandler()));
                final int newCbCount = mRecordCallbackList.size();
                if ((oldCbCount == 0) && (newCbCount > 0)) {
                    // register binder for callbacks
                    final android.media.IAudioService service = android.media.AudioManager.getService();
                    try {
                ...
                android.util.Log.w(android.media.AudioManager.TAG, "attempt to call registerAudioRecordingCallback() on a previously" + "registered callback");
            }
        }
    }
     ...
     *
     * @param cb
     * 		non-null callback to unregister
     */
    public void unregisterAudioRecordingCallback(@android.annotation.NonNull
    android.media.AudioManager.AudioRecordingCallback cb) {
        ...
        synchronized(mRecordCallbackLock) {
            ...
            if (removeRecordCallback_sync(cb)) {
                ...
                android.util.Log.w(android.media.AudioManager.TAG, "attempt to call unregisterAudioRecordingCallback() on a callback" + " already unregistered or never registered");
            }
        }
    }
     ...
     */
    private boolean hasRecordCallback_sync(@android.annotation.NonNull
    android.media.AudioManager.AudioRecordingCallback cb) {
        if (mRecordCallbackList != null) {
     ...
     * Must be called synchronized on mRecordCallbackLock
     */
    private boolean removeRecordCallback_sync(@android.annotation.NonNull
    android.media.AudioManager.AudioRecordingCallback cb) {
        if (mRecordCallbackList != null) {
            for (int i = 0; i < mRecordCallbackList.size(); i++) {
                if (cb.equals(mRecordCallbackList.get(i).mCb)) {
    ...
    private final android.media.IRecordingConfigDispatcher mRecCb = new android.media.IRecordingConfigDispatcher.Stub() {
        public void dispatchRecordingConfigChange(java.util.List<android.media.AudioRecordingConfiguration> configs) {
            synchronized(mRecordCallbackLock) {
                if (mRecordCallbackList != null) {
                    for (int i = 0; i < mRecordCallbackList.size(); i++) {
                        final android.media.AudioManager.AudioRecordingCallbackInfo arci = mRecordCallbackList.get(i);
                        if (arci.mHandler != null) {
                            final android.os.Message m = /* what */
                            /* obj */
                            arci.mHandler.obtainMessage(android.media.AudioManager.MSSG_RECORDING_CONFIG_CHANGE, new android.media.AudioManager.RecordConfigChangeCallbackData(arci.mCb, configs));
     ...
     *
     *
     * @unknown Reload audio settings. This method is called by Settings backup
     ...
     *
     *
     * @unknown Notifies AudioService that it is connected to an A2DP device that supports absolute volume,
    ...
    public boolean isSilentMode() {
        ...
        boolean silentMode = (ringerMode == android.media.AudioManager.RINGER_MODE_SILENT) || (ringerMode == android.media.AudioManager.RINGER_MODE_VIBRATE);
        return silentMode;
    }
     ...
     *
     *
     * @unknown The audio device code for representing "no device."
     */
    public static final int DEVICE_NONE = android.media.AudioSystem.DEVICE_NONE;

    /**
     *
     *
     * @unknown The audio output device code for the small speaker at the front of the device used
     ...
     */
    public static final int DEVICE_OUT_EARPIECE = android.media.AudioSystem.DEVICE_OUT_EARPIECE;

    /**
     *
     *
     * @unknown The audio output device code for the built-in speaker
     */
    public static final int DEVICE_OUT_SPEAKER = android.media.AudioSystem.DEVICE_OUT_SPEAKER;

    /**
     *
     *
     * @unknown The audio output device code for a wired headset with attached microphone
     */
    public static final int DEVICE_OUT_WIRED_HEADSET = android.media.AudioSystem.DEVICE_OUT_WIRED_HEADSET;

    /**
     *
     *
     * @unknown The audio output device code for a wired headphone without attached microphone
     */
    public static final int DEVICE_OUT_WIRED_HEADPHONE = android.media.AudioSystem.DEVICE_OUT_WIRED_HEADPHONE;

    /**
     *
     *
     * @unknown The audio output device code for generic Bluetooth SCO, for voice
     */
    public static final int DEVICE_OUT_BLUETOOTH_SCO = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_SCO;

    /**
     *
     *
     * @unknown The audio output device code for Bluetooth SCO Headset Profile (HSP) and
    Hands-Free Profile (HFP), for voice
     */
    public static final int DEVICE_OUT_BLUETOOTH_SCO_HEADSET = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_SCO_HEADSET;

    /**
     *
     *
     * @unknown The audio output device code for Bluetooth SCO car audio, for voice
     */
    public static final int DEVICE_OUT_BLUETOOTH_SCO_CARKIT = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_SCO_CARKIT;

    /**
     *
     *
     * @unknown The audio output device code for generic Bluetooth A2DP, for music
     */
    public static final int DEVICE_OUT_BLUETOOTH_A2DP = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_A2DP;

    /**
     *
     *
     * @unknown The audio output device code for Bluetooth A2DP headphones, for music
     */
    public static final int DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_A2DP_HEADPHONES;

    /**
     *
     *
     * @unknown The audio output device code for Bluetooth A2DP external speaker, for music
     */
    public static final int DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER = android.media.AudioSystem.DEVICE_OUT_BLUETOOTH_A2DP_SPEAKER;

    /**
     *
     *
     * @unknown The audio output device code for S/PDIF (legacy) or HDMI
    Deprecated: replaced by {@link #DEVICE_OUT_HDMI}
     */
    public static final int DEVICE_OUT_AUX_DIGITAL = android.media.AudioSystem.DEVICE_OUT_AUX_DIGITAL;

    /**
     *
     *
     * @unknown The audio output device code for HDMI
     */
    public static final int DEVICE_OUT_HDMI = android.media.AudioSystem.DEVICE_OUT_HDMI;

    /**
     *
     *
     * @unknown The audio output device code for an analog wired headset attached via a
    docking station
     */
    public static final int DEVICE_OUT_ANLG_DOCK_HEADSET = android.media.AudioSystem.DEVICE_OUT_ANLG_DOCK_HEADSET;

    /**
     *
     *
     * @unknown The audio output device code for a digital wired headset attached via a
    docking station
     */
    public static final int DEVICE_OUT_DGTL_DOCK_HEADSET = android.media.AudioSystem.DEVICE_OUT_DGTL_DOCK_HEADSET;

    /**
     *
     *
     * @unknown The audio output device code for a USB audio accessory. The accessory is in USB host
    mode and the Android device in USB device mode
     */
    public static final int DEVICE_OUT_USB_ACCESSORY = android.media.AudioSystem.DEVICE_OUT_USB_ACCESSORY;

    /**
     *
     *
     * @unknown The audio output device code for a USB audio device. The device is in USB device
    mode and the Android device in USB host mode
     */
    public static final int DEVICE_OUT_USB_DEVICE = android.media.AudioSystem.DEVICE_OUT_USB_DEVICE;

    /**
     *
     *
     * @unknown The audio output device code for projection output.
     */
    public static final int DEVICE_OUT_REMOTE_SUBMIX = android.media.AudioSystem.DEVICE_OUT_REMOTE_SUBMIX;

    /**
     *
     *
     * @unknown The audio output device code the telephony voice TX path.
     */
    public static final int DEVICE_OUT_TELEPHONY_TX = android.media.AudioSystem.DEVICE_OUT_TELEPHONY_TX;

    /**
     *
     *
     * @unknown The audio output device code for an analog jack with line impedance detected.
     */
    public static final int DEVICE_OUT_LINE = android.media.AudioSystem.DEVICE_OUT_LINE;

    /**
     *
     *
     * @unknown The audio output device code for HDMI Audio Return Channel.
     */
    public static final int DEVICE_OUT_HDMI_ARC = android.media.AudioSystem.DEVICE_OUT_HDMI_ARC;

    /**
     *
     *
     * @unknown The audio output device code for S/PDIF digital connection.
     */
    public static final int DEVICE_OUT_SPDIF = android.media.AudioSystem.DEVICE_OUT_SPDIF;

    /**
     *
     *
     * @unknown The audio output device code for built-in FM transmitter.
     */
    public static final int DEVICE_OUT_FM = android.media.AudioSystem.DEVICE_OUT_FM;

    /**
     *
     *
     * @unknown This is not used as a returned value from {@link #getDevicesForStream}, but could be
    used in the future in a set method to select whatever default device is chosen by the
    platform-specific implementation.
     */
    public static final int DEVICE_OUT_DEFAULT = android.media.AudioSystem.DEVICE_OUT_DEFAULT;

    /**
     *
     *
     * @unknown The audio input device code for default built-in microphone
     */
    public static final int DEVICE_IN_BUILTIN_MIC = android.media.AudioSystem.DEVICE_IN_BUILTIN_MIC;

    /**
     *
     *
     * @unknown The audio input device code for a Bluetooth SCO headset
     */
    public static final int DEVICE_IN_BLUETOOTH_SCO_HEADSET = android.media.AudioSystem.DEVICE_IN_BLUETOOTH_SCO_HEADSET;

    /**
     *
     *
     * @unknown The audio input device code for wired headset microphone
     */
    public static final int DEVICE_IN_WIRED_HEADSET = android.media.AudioSystem.DEVICE_IN_WIRED_HEADSET;

    /**
     *
     *
     * @unknown The audio input device code for HDMI
     */
    public static final int DEVICE_IN_HDMI = android.media.AudioSystem.DEVICE_IN_HDMI;

    /**
     *
     *
     * @unknown The audio input device code for telephony voice RX path
     */
    public static final int DEVICE_IN_TELEPHONY_RX = android.media.AudioSystem.DEVICE_IN_TELEPHONY_RX;

    /**
     *
     *
     * @unknown The audio input device code for built-in microphone pointing to the back
     */
    public static final int DEVICE_IN_BACK_MIC = android.media.AudioSystem.DEVICE_IN_BACK_MIC;

    /**
     *
     *
     * @unknown The audio input device code for analog from a docking station
     */
    public static final int DEVICE_IN_ANLG_DOCK_HEADSET = android.media.AudioSystem.DEVICE_IN_ANLG_DOCK_HEADSET;

    /**
     *
     *
     * @unknown The audio input device code for digital from a docking station
     */
    public static final int DEVICE_IN_DGTL_DOCK_HEADSET = android.media.AudioSystem.DEVICE_IN_DGTL_DOCK_HEADSET;

    /**
     *
     *
     * @unknown The audio input device code for a USB audio accessory. The accessory is in USB host
    mode and the Android device in USB device mode
     */
    public static final int DEVICE_IN_USB_ACCESSORY = android.media.AudioSystem.DEVICE_IN_USB_ACCESSORY;

    /**
     *
     *
     * @unknown The audio input device code for a USB audio device. The device is in USB device
    mode and the Android device in USB host mode
     */
    public static final int DEVICE_IN_USB_DEVICE = android.media.AudioSystem.DEVICE_IN_USB_DEVICE;

    /**
     *
     *
     * @unknown The audio input device code for a FM radio tuner
     */
    public static final int DEVICE_IN_FM_TUNER = android.media.AudioSystem.DEVICE_IN_FM_TUNER;

    /**
     *
     *
     * @unknown The audio input device code for a TV tuner
     */
    public static final int DEVICE_IN_TV_TUNER = android.media.AudioSystem.DEVICE_IN_TV_TUNER;

    /**
     *
     *
     * @unknown The audio input device code for an analog jack with line impedance detected
     */
    public static final int DEVICE_IN_LINE = android.media.AudioSystem.DEVICE_IN_LINE;

    /**
     *
     *
     * @unknown The audio input device code for a S/PDIF digital connection
     */
    public static final int DEVICE_IN_SPDIF = android.media.AudioSystem.DEVICE_IN_SPDIF;

    /**
     *
     *
     * @unknown The audio input device code for audio loopback
     */
    public static final int DEVICE_IN_LOOPBACK = android.media.AudioSystem.DEVICE_IN_LOOPBACK;
    ...
    public static boolean isOutputDevice(int device) {
        return (device & android.media.AudioSystem.DEVICE_BIT_IN) == 0;
    }
    ...
    public static boolean isInputDevice(int device) {
        return (device & android.media.AudioSystem.DEVICE_BIT_IN) == android.media.AudioSystem.DEVICE_BIT_IN;
    }
    ...
    public int getDevicesForStream(int streamType) {
        switch (streamType) {
            ...
            case android.media.AudioManager.STREAM_SYSTEM :
            ...
            case android.media.AudioManager.STREAM_DTMF :
                return android.media.AudioSystem.getDevicesForStream(streamType);
            default :
                return 0;
        }
    }
     ...
     *
     * @param device
     * 		type of device connected/disconnected (AudioManager.DEVICE_OUT_xxx)
     * @param state
     * 		new connection state: 1 connected, 0 disconnected
     * @param name
     * 		device name
     * 		{@hide }
     */
    public void setWiredDeviceConnectionState(int type, int state, java.lang.String address, java.lang.String name) {
        android.media.IAudioService service = android.media.AudioManager.getService();
        try {
    ...
    public android.media.IRingtonePlayer getRingtonePlayer() {
        try {
            return android.media.AudioManager.getService().getRingtonePlayer();
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public java.lang.String getProperty(java.lang.String key) {
        if (android.media.AudioManager.PROPERTY_OUTPUT_SAMPLE_RATE.equals(key)) {
            int outputSampleRate = android.media.AudioSystem.getPrimaryOutputSamplingRate();
            return outputSampleRate > 0 ? java.lang.Integer.toString(outputSampleRate) : null;
        } else
            if (android.media.AudioManager.PROPERTY_OUTPUT_FRAMES_PER_BUFFER.equals(key)) {
                int outputFramesPerBuffer = android.media.AudioSystem.getPrimaryOutputFrameCount();
                return outputFramesPerBuffer > 0 ? java.lang.Integer.toString(outputFramesPerBuffer) : null;
            } else
                if (android.media.AudioManager.PROPERTY_SUPPORT_MIC_NEAR_ULTRASOUND.equals(key)) {
                    ...
                    if (android.media.AudioManager.PROPERTY_SUPPORT_SPEAKER_NEAR_ULTRASOUND.equals(key)) {
                        ...
                        if (android.media.AudioManager.PROPERTY_SUPPORT_AUDIO_SOURCE_UNPROCESSED.equals(key)) {
    ...
    public int getOutputLatency(int streamType) {
        return android.media.AudioSystem.getOutputLatency(streamType);
    }
    ...
    public void setVolumeController(android.media.IVolumeController controller) {
        try {
            android.media.AudioManager.getService().setVolumeController(controller);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void notifyVolumeControllerVisible(android.media.IVolumeController controller, boolean visible) {
        try {
            android.media.AudioManager.getService().notifyVolumeControllerVisible(controller, visible);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isStreamAffectedByRingerMode(int streamType) {
        try {
            return android.media.AudioManager.getService().isStreamAffectedByRingerMode(streamType);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isStreamAffectedByMute(int streamType) {
        try {
            return android.media.AudioManager.getService().isStreamAffectedByMute(streamType);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void disableSafeMediaVolume() {
        try {
            android.media.AudioManager.getService().disableSafeMediaVolume(mApplicationContext.getOpPackageName());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setRingerModeInternal(int ringerMode) {
        try {
            android.media.AudioManager.getService().setRingerModeInternal(ringerMode, getContext().getOpPackageName());
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public int getRingerModeInternal() {
        try {
            return android.media.AudioManager.getService().getRingerModeInternal();
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public void setVolumePolicy(android.media.VolumePolicy policy) {
        try {
            android.media.AudioManager.getService().setVolumePolicy(policy);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param on
     * 		whether to be on system audio mode
     * @return output device type. 0 (DEVICE_NONE) if failed to set device.
     * @unknown 
     */
    public int setHdmiSystemAudioSupported(boolean on) {
        try {
            return android.media.AudioManager.getService().setHdmiSystemAudioSupported(on);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isHdmiSystemAudioSupported() {
        try {
            return android.media.AudioManager.getService().isHdmiSystemAudioSupported();
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     * @unknown 
     */
    public static final int ERROR_PERMISSION_DENIED = android.media.AudioSystem.PERMISSION_DENIED;
     ...
     * @unknown 
     */
    public static final int ERROR_NO_INIT = android.media.AudioSystem.NO_INIT;
     ...
     *
     * @param ports
     * 		An AudioPort ArrayList where the list will be returned.
     * @unknown 
     */
    public static int listAudioPorts(java.util.ArrayList<android.media.AudioPort> ports) {
        return android.media.AudioManager.updateAudioPortCache(ports, null, null);
    }
     ...
     * @unknown 
     */
    public static int listPreviousAudioPorts(java.util.ArrayList<android.media.AudioPort> ports) {
        return android.media.AudioManager.updateAudioPortCache(null, null, ports);
    }
     ...
     * @unknown 
     */
    public static int listAudioDevicePorts(java.util.ArrayList<android.media.AudioDevicePort> devices) {
        if (devices == null) {
            return android.media.AudioManager.ERROR_BAD_VALUE;
        }
        java.util.ArrayList<android.media.AudioPort> ports = new java.util.ArrayList<android.media.AudioPort>();
        int status = android.media.AudioManager.updateAudioPortCache(ports, null, null);
        if (status == android.media.AudioManager.SUCCESS) {
            android.media.AudioManager.filterDevicePorts(ports, devices);
        }
        return status;
    }
     ...
     * @unknown 
     */
    public static int listPreviousAudioDevicePorts(java.util.ArrayList<android.media.AudioDevicePort> devices) {
        if (devices == null) {
            return android.media.AudioManager.ERROR_BAD_VALUE;
        }
        java.util.ArrayList<android.media.AudioPort> ports = new java.util.ArrayList<android.media.AudioPort>();
        int status = android.media.AudioManager.updateAudioPortCache(null, null, ports);
        if (status == android.media.AudioManager.SUCCESS) {
            android.media.AudioManager.filterDevicePorts(ports, devices);
        }
        return status;
    ...
    private static void filterDevicePorts(java.util.ArrayList<android.media.AudioPort> ports, java.util.ArrayList<android.media.AudioDevicePort> devices) {
        devices.clear();
        for (int i = 0; i < ports.size(); i++) {
            if (ports.get(i) instanceof android.media.AudioDevicePort) {
                devices.add(((android.media.AudioDevicePort) (ports.get(i))));
            }
        }
    }
     ...
     * @param sinks
     * 		List of sink audio ports. All must be AudioPort.ROLE_SINK.
     ...
     * @unknown 
     */
    public static int createAudioPatch(android.media.AudioPatch[] patch, android.media.AudioPortConfig[] sources, android.media.AudioPortConfig[] sinks) {
        return android.media.AudioSystem.createAudioPatch(patch, sources, sinks);
    }
     ...
     * @unknown 
     */
    public static int releaseAudioPatch(android.media.AudioPatch patch) {
        return android.media.AudioSystem.releaseAudioPatch(patch);
    }
     ...
     * @unknown 
     */
    public static int listAudioPatches(java.util.ArrayList<android.media.AudioPatch> patches) {
        return android.media.AudioManager.updateAudioPortCache(null, patches, null);
    }
     ...
     * @unknown 
     */
    public static int setAudioPortGain(android.media.AudioPort port, android.media.AudioGainConfig gain) {
        if ((port == null) || (gain == null)) {
            return android.media.AudioManager.ERROR_BAD_VALUE;
        }
        android.media.AudioPortConfig activeConfig = port.activeConfig();
        android.media.AudioPortConfig config = new android.media.AudioPortConfig(port, activeConfig.samplingRate(), activeConfig.channelMask(), activeConfig.format(), gain);
        config.mConfigMask = android.media.AudioPortConfig.GAIN;
        return android.media.AudioSystem.setAudioPortConfig(config);
    }
    ...
    public interface OnAudioPortUpdateListener {
         ...
         *
         * @param patchList
         * 		the updated list of audio patches
         */
     ...
     * @unknown 
     */
    public void registerAudioPortUpdateListener(android.media.AudioManager.OnAudioPortUpdateListener l) {
        android.media.AudioManager.sAudioPortEventHandler.init();
        android.media.AudioManager.sAudioPortEventHandler.registerListener(l);
    }
     ...
     * @unknown 
     */
    public void unregisterAudioPortUpdateListener(android.media.AudioManager.OnAudioPortUpdateListener l) {
        android.media.AudioManager.sAudioPortEventHandler.unregisterListener(l);
    }
    ...
    static java.lang.Integer sAudioPortGeneration = new java.lang.Integer(android.media.AudioManager.AUDIOPORT_GENERATION_INIT);

    static java.util.ArrayList<android.media.AudioPort> sAudioPortsCached = new java.util.ArrayList<android.media.AudioPort>();

    static java.util.ArrayList<android.media.AudioPort> sPreviousAudioPortsCached = new java.util.ArrayList<android.media.AudioPort>();

    static java.util.ArrayList<android.media.AudioPatch> sAudioPatchesCached = new java.util.ArrayList<android.media.AudioPatch>();

    static int resetAudioPortGeneration() {
        int generation;
        synchronized(android.media.AudioManager.sAudioPortGeneration) {
            generation = android.media.AudioManager.sAudioPortGeneration;
            android.media.AudioManager.sAudioPortGeneration = android.media.AudioManager.AUDIOPORT_GENERATION_INIT;
        }
        return generation;
    }

    static int updateAudioPortCache(java.util.ArrayList<android.media.AudioPort> ports, java.util.ArrayList<android.media.AudioPatch> patches, java.util.ArrayList<android.media.AudioPort> previousPorts) {
        android.media.AudioManager.sAudioPortEventHandler.init();
        synchronized(android.media.AudioManager.sAudioPortGeneration) {
            if (android.media.AudioManager.sAudioPortGeneration == android.media.AudioManager.AUDIOPORT_GENERATION_INIT) {
                int[] patchGeneration = new int[1];
                int[] portGeneration = new int[1];
                int status;
                java.util.ArrayList<android.media.AudioPort> newPorts = new java.util.ArrayList<android.media.AudioPort>();
                java.util.ArrayList<android.media.AudioPatch> newPatches = new java.util.ArrayList<android.media.AudioPatch>();
                do {
                    newPorts.clear();
                    status = android.media.AudioSystem.listAudioPorts(newPorts, portGeneration);
                    if (status != android.media.AudioManager.SUCCESS) {
                        android.util.Log.w(android.media.AudioManager.TAG, "updateAudioPortCache: listAudioPorts failed");
                        return status;
                    }
                    newPatches.clear();
                    status = android.media.AudioSystem.listAudioPatches(newPatches, patchGeneration);
                    if (status != android.media.AudioManager.SUCCESS) {
                        android.util.Log.w(android.media.AudioManager.TAG, "updateAudioPortCache: listAudioPatches failed");
                        return status;
                    }
                } while (patchGeneration[0] != portGeneration[0] );
                for (int i = 0; i < newPatches.size(); i++) {
                    for (int j = 0; j < newPatches.get(i).sources().length; j++) {
                        android.media.AudioPortConfig portCfg = android.media.AudioManager.updatePortConfig(newPatches.get(i).sources()[j], newPorts);
                        newPatches.get(i).sources()[j] = portCfg;
                    }
                    for (int j = 0; j < newPatches.get(i).sinks().length; j++) {
                        android.media.AudioPortConfig portCfg = android.media.AudioManager.updatePortConfig(newPatches.get(i).sinks()[j], newPorts);
                        newPatches.get(i).sinks()[j] = portCfg;
                    }
                }
                for (java.util.Iterator<android.media.AudioPatch> i = newPatches.iterator(); i.hasNext();) {
                    android.media.AudioPatch newPatch = i.next();
                    boolean hasInvalidPort = false;
                    for (android.media.AudioPortConfig portCfg : newPatch.sources()) {
                        if (portCfg == null) {
                            hasInvalidPort = true;
                            break;
                        }
                    }
                    for (android.media.AudioPortConfig portCfg : newPatch.sinks()) {
                        if (portCfg == null) {
                            hasInvalidPort = true;
                            break;
                        }
                ...
                android.media.AudioManager.sAudioPortsCached = newPorts;
                android.media.AudioManager.sAudioPatchesCached = newPatches;
                android.media.AudioManager.sAudioPortGeneration = portGeneration[0];
            }
            if (ports != null) {
                ports.clear();
                ports.addAll(android.media.AudioManager.sAudioPortsCached);
            }
            if (patches != null) {
                patches.clear();
                patches.addAll(android.media.AudioManager.sAudioPatchesCached);
            }
            if (previousPorts != null) {
                previousPorts.clear();
                previousPorts.addAll(android.media.AudioManager.sPreviousAudioPortsCached);
            }
        }
        return android.media.AudioManager.SUCCESS;
    }

    static android.media.AudioPortConfig updatePortConfig(android.media.AudioPortConfig portCfg, java.util.ArrayList<android.media.AudioPort> ports) {
        android.media.AudioPort port = portCfg.port();
        int k;
        ...
        if (k == ports.size()) {
            ...
            android.util.Log.e(android.media.AudioManager.TAG, "updatePortConfig port not found for handle: " + port.handle().id());
            return null;
        }
        android.media.AudioGainConfig gainCfg = portCfg.gain();
        if (gainCfg != null) {
            android.media.AudioGain gain = port.gain(gainCfg.index());
     ...
     */
    private android.util.ArrayMap<android.media.AudioDeviceCallback, android.media.AudioManager.NativeEventHandlerDelegate> mDeviceCallbacks = new android.util.ArrayMap<android.media.AudioDeviceCallback, android.media.AudioManager.NativeEventHandlerDelegate>();
     ...
     */
    public static final int GET_DEVICES_ALL = android.media.AudioManager.GET_DEVICES_OUTPUTS | android.media.AudioManager.GET_DEVICES_INPUTS;
     ...
     */
    private static boolean checkFlags(android.media.AudioDevicePort port, int flags) {
        return ((port.role() == android.media.AudioPort.ROLE_SINK) && ((flags & android.media.AudioManager.GET_DEVICES_OUTPUTS) != 0)) || ((port.role() == android.media.AudioPort.ROLE_SOURCE) && ((flags & android.media.AudioManager.GET_DEVICES_INPUTS) != 0));
    }

    private static boolean checkTypes(android.media.AudioDevicePort port) {
        return (android.media.AudioDeviceInfo.convertInternalDeviceToDeviceType(port.type()) != android.media.AudioDeviceInfo.TYPE_UNKNOWN) && (port.type() != android.media.AudioSystem.DEVICE_IN_BACK_MIC);
    }
     ...
     */
    public android.media.AudioDeviceInfo[] getDevices(int flags) {
        return android.media.AudioManager.getDevicesStatic(flags);
    }
     ...
     */
    private static android.media.AudioDeviceInfo[] infoListFromPortList(java.util.ArrayList<android.media.AudioDevicePort> ports, int flags) {
        // figure out how many AudioDeviceInfo we need space for...
        int numRecs = 0;
        for (android.media.AudioDevicePort port : ports) {
            if (android.media.AudioManager.checkTypes(port) && android.media.AudioManager.checkFlags(port, flags)) {
                numRecs++;
            }
        }
        // Now load them up...
        android.media.AudioDeviceInfo[] deviceList = new android.media.AudioDeviceInfo[numRecs];
        int slot = 0;
        for (android.media.AudioDevicePort port : ports) {
            if (android.media.AudioManager.checkTypes(port) && android.media.AudioManager.checkFlags(port, flags)) {
                deviceList[slot++] = new android.media.AudioDeviceInfo(port);
            }
        }
        return deviceList;
    }
     ...
     */
    private static android.media.AudioDeviceInfo[] calcListDeltas(java.util.ArrayList<android.media.AudioDevicePort> ports_A, java.util.ArrayList<android.media.AudioDevicePort> ports_B, int flags) {
        java.util.ArrayList<android.media.AudioDevicePort> delta_ports = new java.util.ArrayList<android.media.AudioDevicePort>();
        android.media.AudioDevicePort cur_port = null;
        ...
        return android.media.AudioManager.infoListFromPortList(delta_ports, flags);
    }
     ...
     * @unknown 
     */
    public static android.media.AudioDeviceInfo[] getDevicesStatic(int flags) {
        java.util.ArrayList<android.media.AudioDevicePort> ports = new java.util.ArrayList<android.media.AudioDevicePort>();
        int status = android.media.AudioManager.listAudioDevicePorts(ports);
        if (status != android.media.AudioManager.SUCCESS) {
            // fail and bail!
            return new android.media.AudioDeviceInfo[0];// Always return an array.

        }
        return android.media.AudioManager.infoListFromPortList(ports, flags);
    }
     ...
     *
     * @param callback
     * 		The {@link AudioDeviceCallback} object to receive connect/disconnect
     * 		notifications.
     * @param handler
     ...
     * 		{@link Looper} will be used.
     */
    public void registerAudioDeviceCallback(android.media.AudioDeviceCallback callback, android.os.Handler handler) {
        synchronized(mDeviceCallbacks) {
            if ((callback != null) && (!mDeviceCallbacks.containsKey(callback))) {
                if (mDeviceCallbacks.size() == 0) {
                    if (mPortListener == null) {
                        mPortListener = new android.media.AudioManager.OnAmPortUpdateListener();
                    }
                    registerAudioPortUpdateListener(mPortListener);
                }
                android.media.AudioManager.NativeEventHandlerDelegate delegate = new android.media.AudioManager.NativeEventHandlerDelegate(callback, handler);
     ...
     *
     * @param callback
     * 		The {@link AudioDeviceCallback} object that was previously registered
     * 		with {@link AudioManager#registerAudioDeviceCallback) to be unregistered.
     */
    public void unregisterAudioDeviceCallback(android.media.AudioDeviceCallback callback) {
        synchronized(mDeviceCallbacks) {
    ...
    private java.util.ArrayList<android.media.AudioDevicePort> mPreviousPorts = new java.util.ArrayList<android.media.AudioDevicePort>();

    /**
     * Internal method to compute and generate add/remove messages and then send to any
     * registered callbacks.
     */
    private void broadcastDeviceListChange(android.os.Handler handler) {
        int status;
        // Get the new current set of ports
        java.util.ArrayList<android.media.AudioDevicePort> current_ports = new java.util.ArrayList<android.media.AudioDevicePort>();
        status = android.media.AudioManager.listAudioDevicePorts(current_ports);
        if (status != android.media.AudioManager.SUCCESS) {
            return;
        }
        if (handler != null) {
            // This is the callback for the registration, so send the current list
            android.media.AudioDeviceInfo[] deviceList = android.media.AudioManager.infoListFromPortList(current_ports, android.media.AudioManager.GET_DEVICES_ALL);
            handler.sendMessage(android.os.Message.obtain(handler, android.media.AudioManager.MSG_DEVICES_CALLBACK_REGISTERED, deviceList));
        } else {
            android.media.AudioDeviceInfo[] added_devices = android.media.AudioManager.calcListDeltas(mPreviousPorts, current_ports, android.media.AudioManager.GET_DEVICES_ALL);
            android.media.AudioDeviceInfo[] removed_devices = android.media.AudioManager.calcListDeltas(current_ports, mPreviousPorts, android.media.AudioManager.GET_DEVICES_ALL);
                    ...
                    for (int i = 0; i < mDeviceCallbacks.size(); i++) {
                        ...
                        if (handler != null) {
                            if (added_devices.length != 0) {
                                handler.sendMessage(android.os.Message.obtain(handler, android.media.AudioManager.MSG_DEVICES_DEVICES_ADDED, added_devices));
                            }
                            if (removed_devices.length != 0) {
                                handler.sendMessage(android.os.Message.obtain(handler, android.media.AudioManager.MSG_DEVICES_DEVICES_REMOVED, removed_devices));
                            }
                        }
                    }
                }
    ...
    private class NativeEventHandlerDelegate {
        ...
        NativeEventHandlerDelegate(final android.media.AudioDeviceCallback callback, android.os.Handler handler) {
            ...
            if (looper != null) {
                ...
                mHandler = new android.os.Handler(looper) {
                    ...
                    public void handleMessage(android.os.Message msg) {
                        switch (msg.what) {
                            case android.media.AudioManager.MSG_DEVICES_CALLBACK_REGISTERED :
                            case android.media.AudioManager.MSG_DEVICES_DEVICES_ADDED :
                                if (callback != null) {
                                    callback.onAudioDevicesAdded(((android.media.AudioDeviceInfo[]) (msg.obj)));
                                }
                                break;
                            case android.media.AudioManager.MSG_DEVICES_DEVICES_REMOVED :
                                if (callback != null) {
                                    callback.onAudioDevicesRemoved(((android.media.AudioDeviceInfo[]) (msg.obj)));
                                }
                                break;
                            default :
                                android.util.Log.e(android.media.AudioManager.TAG, "Unknown native event type: " + msg.what);
                                break;
                        }
                    }
                };
