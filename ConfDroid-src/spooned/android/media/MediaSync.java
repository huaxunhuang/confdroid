...
public final class MediaSync {
    ...
    public static abstract class Callback {
         ...
         */
        public abstract void onAudioBufferConsumed(@android.annotation.NonNull
        android.media.MediaSync sync, @android.annotation.NonNull
        java.nio.ByteBuffer audioBuffer, int bufferId);
    }
    ...
    public interface OnErrorListener {
         ...
         */
        void onError(@android.annotation.NonNull
        android.media.MediaSync sync, int what, int extra);
    }
    ...
    private static class AudioBuffer {
        ...
        public AudioBuffer(@android.annotation.NonNull
        java.nio.ByteBuffer byteBuffer, int bufferId, long presentationTimeUs) {
    ...
    private java.util.List<android.media.MediaSync.AudioBuffer> mAudioBuffers = new java.util.LinkedList<android.media.MediaSync.AudioBuffer>();
     ...
     *
     * @param cb
     * 		The callback that will run. Use {@code null} to stop receiving callbacks.
     * @param handler
     * 		The Handler that will run the callback. Use {@code null} to use MediaSync's
     * 		internal handler if it exists.
     */
    public void setCallback(/* MediaSync. */
    @android.annotation.Nullable
    android.media.MediaSync.Callback cb, @android.annotation.Nullable
        ...
        synchronized(mCallbackLock) {
            if (handler != null) {
                ...
                if (looper == null) {
                    ...
                    mCallbackHandler = new android.os.Handler(looper);
                }
            }
            mCallback = cb;
        }
     ...
     * 		internal handler if it exists.
     */
    public void setOnErrorListener(/* MediaSync. */
    @android.annotation.Nullable
    android.media.MediaSync.OnErrorListener listener, @android.annotation.Nullable
    android.os.Handler handler) {
        synchronized(mOnErrorListenerLock) {
            if (handler != null) {
                ...
                if (looper == null) {
                    ...
                    mOnErrorListenerHandler = new android.os.Handler(looper);
                }
            }
    ...
    private final native void native_setSurface(@android.annotation.Nullable
    android.view.Surface surface);
     ...
     */
    public void setAudioTrack(@android.annotation.Nullable
    ...
    private final native void native_setAudioTrack(@android.annotation.Nullable
    android.media.AudioTrack audioTrack);
     ...
     *
     * @param params
     * 		the playback params to use. {@link PlaybackParams#getSpeed
    ...
    private native float native_setPlaybackParams(@android.annotation.NonNull
    android.media.PlaybackParams params);
     ...
     */
    public void setSyncParams(@android.annotation.NonNull
    ...
    private native float native_setSyncParams(@android.annotation.NonNull
    android.media.SyncParams params);
    ...
    public android.media.MediaTimestamp getTimestamp() {
        try {
            ...
            android.media.MediaTimestamp timestamp = new android.media.MediaTimestamp();
    ...
    private final native boolean native_getTimestamp(@android.annotation.NonNull
     ...
     */
    public void queueAudio(@android.annotation.NonNull
    java.nio.ByteBuffer audioData, int bufferId, long presentationTimeUs) {
        ...
        synchronized(mAudioLock) {
            mAudioBuffers.add(new android.media.MediaSync.AudioBuffer(audioData, bufferId, presentationTimeUs));
        }
    ...
    private void postRenderAudio(long delayMillis) {
        mAudioHandler.postDelayed(new java.lang.Runnable() {
            public void run() {
                synchronized(mAudioLock) {
                    if (mPlaybackRate == 0.0) {
                        return;
                    ...
                    android.media.MediaSync.AudioBuffer audioBuffer = mAudioBuffers.get(0);
                    int size = audioBuffer.mByteBuffer.remaining();
                    // restart audio track after flush
                    if ((size > 0) && (mAudioTrack.getPlayState() != android.media.AudioTrack.PLAYSTATE_PLAYING)) {
                        try {
                            mAudioTrack.play();
                        } catch (java.lang.IllegalStateException e) {
                    ...
                    int sizeWritten = mAudioTrack.write(audioBuffer.mByteBuffer, size, android.media.AudioTrack.WRITE_NON_BLOCKING);
                    if (sizeWritten > 0) {
                    ...
                    long pendingTimeMs = java.util.concurrent.TimeUnit.MICROSECONDS.toMillis(native_getPlayTimeForPendingAudioFrames());
    ...
    private final native void native_updateQueuedAudioData(int sizeInBytes, long presentationTimeUs);

    private final native long native_getPlayTimeForPendingAudioFrames();

    private final void postReturnByteBuffer(@android.annotation.NonNull
    final android.media.MediaSync.AudioBuffer audioBuffer) {
        synchronized(mCallbackLock) {
            if (mCallbackHandler != null) {
                final android.media.MediaSync sync = this;
                mCallbackHandler.post(new java.lang.Runnable() {
                    public void run() {
                        android.media.MediaSync.Callback callback;
                        synchronized(mCallbackLock) {
                            callback = mCallback;
                            if ((mCallbackHandler == null) || (mCallbackHandler.getLooper().getThread() != java.lang.Thread.currentThread())) {
    ...
    private final void returnAudioBuffers() {
        synchronized(mAudioLock) {
            for (android.media.MediaSync.AudioBuffer audioBuffer : mAudioBuffers) {
                postReturnByteBuffer(audioBuffer);
            }
            mAudioBuffers.clear();
        }
    ...
    private void createAudioThread() {
        mAudioThread = new java.lang.Thread() {
            @java.lang.Override
            public void run() {
                android.os.Looper.prepare();
                synchronized(mAudioLock) {
                    mAudioLooper = android.os.Looper.myLooper();
                    mAudioHandler = new android.os.Handler();
                    mAudioLock.notify();
                }
