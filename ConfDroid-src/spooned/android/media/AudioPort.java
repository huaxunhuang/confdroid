...
public class AudioPort {
    ...
    AudioPort(android.media.AudioHandle handle, int role, java.lang.String name, int[] samplingRates, int[] channelMasks, int[] channelIndexMasks, int[] formats, android.media.AudioGain[] gains) {
        mHandle = handle;
        mRole = role;
        mName = name;
     ...
     */
    android.media.AudioGain gain(int index) {
     ...
     * 		from active configuration requested.
     * @param gain
     * 		The desired gain. null if no gain changed requested.
     */
    public android.media.AudioPortConfig buildConfig(int samplingRate, int channelMask, int format, android.media.AudioGainConfig gain) {
        return new android.media.AudioPortConfig(this, samplingRate, channelMask, format, gain);
    }
    ...
    public boolean equals(java.lang.Object o) {
        if ((o == null) || (!(o instanceof android.media.AudioPort))) {
            return false;
        }
        android.media.AudioPort ap = ((android.media.AudioPort) (o));
    ...
    public java.lang.String toString() {
        java.lang.String role = java.lang.Integer.toString(mRole);
        switch (mRole) {
            case android.media.AudioPort.ROLE_NONE :
                role = "NONE";
                break;
            case android.media.AudioPort.ROLE_SOURCE :
                role = "SOURCE";
                break;
            case android.media.AudioPort.ROLE_SINK :
                role = "SINK";
                break;
        }
        return ((("{mHandle: " + mHandle) + ", mRole: ") + role) + "}";
    }
}
