...
public class LoudnessEnhancer extends android.media.audiofx.AudioEffect {
     ...
     */
    private android.media.audiofx.LoudnessEnhancer.OnParameterChangeListener mParamListener = null;

    /**
     * Listener used internally to to receive raw parameter change events
     * from AudioEffect super class
     */
    private android.media.audiofx.LoudnessEnhancer.BaseParameterListener mBaseParamListener = null;
     ...
     * 		
     */
    public LoudnessEnhancer(int audioSession) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_LOUDNESS_ENHANCER, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, 0, audioSession);
        if (audioSession == 0) {
            android.util.Log.w(android.media.audiofx.LoudnessEnhancer.TAG, "WARNING: attaching a LoudnessEnhancer to global output mix is deprecated!");
        }
    }
     ...
     *
     *
     * @unknown Class constructor for the LoudnessEnhancer audio effect.
     * @param priority
     ...
     * 		
     */
    public LoudnessEnhancer(int priority, int audioSession) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_LOUDNESS_ENHANCER, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, priority, audioSession);
        if (audioSession == 0) {
            android.util.Log.w(android.media.audiofx.LoudnessEnhancer.TAG, "WARNING: attaching a LoudnessEnhancer to global output mix is deprecated!");
        }
    }
     ...
     * 		
     */
    public void setTargetGain(int gainmB) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        checkStatus(setParameter(android.media.audiofx.LoudnessEnhancer.PARAM_TARGET_GAIN_MB, gainmB));
    }
    ...
    public float getTargetGain() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] value = new int[1];
        checkStatus(getParameter(android.media.audiofx.LoudnessEnhancer.PARAM_TARGET_GAIN_MB, value));
        return value[0];
    }
     ...
     *
     *
     * @unknown The OnParameterChangeListener interface defines a method called by the LoudnessEnhancer
    ...
    public interface OnParameterChangeListener {
         ...
         *
         * @param effect
         * 		the LoudnessEnhancer on which the interface is registered.
         * @param param
         * 		ID of the modified parameter. See {@link #PARAM_GENERIC_PARAM1} ...
         * @param value
         * 		the new parameter value.
         */
        void onParameterChange(android.media.audiofx.LoudnessEnhancer effect, int param, int value);
    }
    ...
    private class BaseParameterListener implements android.media.audiofx.AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(android.media.audiofx.AudioEffect effect, int status, byte[] param, byte[] value) {
            ...
            android.media.audiofx.LoudnessEnhancer.OnParameterChangeListener l = null;
            ...
            if (l != null) {
                int p = -1;
                int v = java.lang.Integer.MIN_VALUE;
                if (param.length == 4) {
                ...
                if ((p != (-1)) && (v != java.lang.Integer.MIN_VALUE)) {
                    l.onParameterChange(android.media.audiofx.LoudnessEnhancer.this, p, v);
                }
            }
        }
    }
     ...
     *
     *
     * @unknown Registers an OnParameterChangeListener interface.
     * @param listener
    ...
    public void setParameterListener(android.media.audiofx.LoudnessEnhancer.OnParameterChangeListener listener) {
        synchronized(mParamListenerLock) {
            if (mParamListener == null) {
                mBaseParamListener = new android.media.audiofx.LoudnessEnhancer.BaseParameterListener();
     ...
     *
     *
     * @unknown The Settings class regroups the LoudnessEnhancer parameters. It is used in
    ...
    public static class Settings {
        ...
        public Settings(java.lang.String settings) {
            ...
            if (!key.equals("LoudnessEnhancer")) {
                throw new java.lang.IllegalArgumentException("invalid settings for LoudnessEnhancer: " + key);
            }
            try {
                key = st.nextToken();
                ...
                targetGainmB = java.lang.Integer.parseInt(st.nextToken());
        ...
        public java.lang.String toString() {
            java.lang.String str = new java.lang.String(("LoudnessEnhancer" + ";targetGainmB=") + java.lang.Integer.toString(targetGainmB));
            return str;
        }
    }
     ...
     *
     *
     * @unknown Gets the LoudnessEnhancer properties. This method is useful when a snapshot of current
     ...
     * 		
     */
    public android.media.audiofx.LoudnessEnhancer.Settings getProperties() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
     ...
     *
     *
     * @unknown Sets the LoudnessEnhancer properties. This method is useful when bass boost settings
    have to be applied from a previous backup.
     * @param settings
     * 		a LoudnessEnhancer.Settings object containing the properties to apply
     * @throws IllegalStateException
     * 		
     * @throws IllegalArgumentException
     * 		
     ...
     * 		
     */
    public void setProperties(android.media.audiofx.LoudnessEnhancer.Settings settings) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        checkStatus(setParameter(android.media.audiofx.LoudnessEnhancer.PARAM_TARGET_GAIN_MB, settings.targetGainmB));
    }
}
