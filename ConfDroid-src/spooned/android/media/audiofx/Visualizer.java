...
public class Visualizer {
     ...
     */
    private int mState = android.media.audiofx.Visualizer.STATE_UNINITIALIZED;
     ...
     */
    private android.media.audiofx.Visualizer.NativeEventHandler mNativeEventHandler = null;
     ...
     * 		
     */
    public Visualizer(int audioSession) throws java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        int[] id = new int[1];
        synchronized(mStateLock) {
            mState = android.media.audiofx.Visualizer.STATE_UNINITIALIZED;
            // native initialization
            int result = native_setup(new java.lang.ref.WeakReference<android.media.audiofx.Visualizer>(this), audioSession, id, android.app.ActivityThread.currentOpPackageName());
            if ((result != android.media.audiofx.Visualizer.SUCCESS) && (result != android.media.audiofx.Visualizer.ALREADY_EXISTS)) {
                android.util.Log.e(android.media.audiofx.Visualizer.TAG, ("Error code " + result) + " when initializing Visualizer.");
                switch (result) {
                    case android.media.audiofx.Visualizer.ERROR_INVALID_OPERATION :
                        throw new java.lang.UnsupportedOperationException("Effect library not loaded");
                    default :
                        throw new java.lang.RuntimeException("Cannot initialize Visualizer engine, error: " + result);
                }
            }
            mId = id[0];
            if (native_getEnabled()) {
                mState = android.media.audiofx.Visualizer.STATE_ENABLED;
            } else {
                mState = android.media.audiofx.Visualizer.STATE_INITIALIZED;
            }
        }
    }
    ...
    public int setEnabled(boolean enabled) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("setEnabled() called in wrong state: " + mState);
            }
            int status = android.media.audiofx.Visualizer.SUCCESS;
            if ((enabled && (mState == android.media.audiofx.Visualizer.STATE_INITIALIZED)) || ((!enabled) && (mState == android.media.audiofx.Visualizer.STATE_ENABLED))) {
                status = native_setEnabled(enabled);
                if (status == android.media.audiofx.Visualizer.SUCCESS) {
                    mState = (enabled) ? android.media.audiofx.Visualizer.STATE_ENABLED : android.media.audiofx.Visualizer.STATE_INITIALIZED;
                }
            }
            return status;
        }
    ...
    public boolean getEnabled() {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("getEnabled() called in wrong state: " + mState);
            }
     ...
     * 		
     */
    public int setCaptureSize(int size) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState != android.media.audiofx.Visualizer.STATE_INITIALIZED) {
                throw new java.lang.IllegalStateException("setCaptureSize() called in wrong state: " + mState);
            }
    ...
    public int getCaptureSize() throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("getCaptureSize() called in wrong state: " + mState);
            }
     ...
     *
     * @param mode
     * 		see {@link #SCALING_MODE_NORMALIZED}
     ...
     * 		
     */
    public int setScalingMode(int mode) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("setScalingMode() called in wrong state: " + mState);
            }
    ...
    public int getScalingMode() throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("getScalingMode() called in wrong state: " + mState);
            }
     ...
     * 		
     */
    public int setMeasurementMode(int mode) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("setMeasurementMode() called in wrong state: " + mState);
            }
    ...
    public int getMeasurementMode() throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("getMeasurementMode() called in wrong state: " + mState);
            }
    ...
    public int getSamplingRate() throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState == android.media.audiofx.Visualizer.STATE_UNINITIALIZED) {
                throw new java.lang.IllegalStateException("getSamplingRate() called in wrong state: " + mState);
            }
     ...
     * 		
     */
    public int getWaveForm(byte[] waveform) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState != android.media.audiofx.Visualizer.STATE_ENABLED) {
                throw new java.lang.IllegalStateException("getWaveForm() called in wrong state: " + mState);
            }
     ...
     * 		
     */
    public int getFft(byte[] fft) throws java.lang.IllegalStateException {
        synchronized(mStateLock) {
            if (mState != android.media.audiofx.Visualizer.STATE_ENABLED) {
                throw new java.lang.IllegalStateException("getFft() called in wrong state: " + mState);
            }
     ...
     *
     * @param measurement
     * 		a non-null {@link Visualizer.MeasurementPeakRms} instance to store
    ...
    public int getMeasurementPeakRms(android.media.audiofx.Visualizer.MeasurementPeakRms measurement) {
        if (measurement == null) {
            android.util.Log.e(android.media.audiofx.Visualizer.TAG, "Cannot store measurements in a null object");
            return android.media.audiofx.Visualizer.ERROR_BAD_VALUE;
        }
        synchronized(mStateLock) {
            if (mState != android.media.audiofx.Visualizer.STATE_ENABLED) {
                throw new java.lang.IllegalStateException("getMeasurementPeakRms() called in wrong state: " + mState);
            }
    ...
    public interface OnDataCaptureListener {
         ...
         */
        void onWaveFormDataCapture(android.media.audiofx.Visualizer visualizer, byte[] waveform, int samplingRate);
         ...
         * 		sampling rate of the audio visualized.
         */
        void onFftDataCapture(android.media.audiofx.Visualizer visualizer, byte[] fft, int samplingRate);
    }
     ...
     */
    public int setDataCaptureListener(android.media.audiofx.Visualizer.OnDataCaptureListener listener, int rate, boolean waveform, boolean fft) {
        ...
        if (status == android.media.audiofx.Visualizer.SUCCESS) {
            if ((listener != null) && (mNativeEventHandler == null)) {
                ...
                if ((looper = android.os.Looper.myLooper()) != null) {
                    mNativeEventHandler = new android.media.audiofx.Visualizer.NativeEventHandler(this, looper);
                } else
                    if ((looper = android.os.Looper.getMainLooper()) != null) {
                        mNativeEventHandler = new android.media.audiofx.Visualizer.NativeEventHandler(this, looper);
                    } else {
                        mNativeEventHandler = null;
                        status = android.media.audiofx.Visualizer.ERROR_NO_INIT;
                    }
     ...
     *
     *
     * @unknown The OnServerDiedListener interface defines a method called by the Visualizer to indicate that
    ...
    public interface OnServerDiedListener {
         ...
         *
         *
         * @unknown Method called when the native media server has died.
     ...
     *
     *
     * @unknown Registers an OnServerDiedListener interface.
    ...
    public int setServerDiedListener(android.media.audiofx.Visualizer.OnServerDiedListener listener) {
        ...
        return android.media.audiofx.Visualizer.SUCCESS;
    }
    ...
    private class NativeEventHandler extends android.os.Handler {
        ...
        public NativeEventHandler(android.media.audiofx.Visualizer v, android.os.Looper looper) {
            super(looper);
            mVisualizer = v;
        }

        private void handleCaptureMessage(android.os.Message msg) {
            android.media.audiofx.Visualizer.OnDataCaptureListener l = null;
            synchronized(mListenerLock) {
            ...
            if (l != null) {
                ...
                switch (msg.what) {
                    case android.media.audiofx.Visualizer.NATIVE_EVENT_PCM_CAPTURE :
                        l.onWaveFormDataCapture(mVisualizer, data, samplingRate);
                        break;
                    case android.media.audiofx.Visualizer.NATIVE_EVENT_FFT_CAPTURE :
                        l.onFftDataCapture(mVisualizer, data, samplingRate);
                        break;
                    default :
                        android.util.Log.e(android.media.audiofx.Visualizer.TAG, "Unknown native event in handleCaptureMessge: " + msg.what);
                        break;
                }
            }
        }

        private void handleServerDiedMessage(android.os.Message msg) {
            android.media.audiofx.Visualizer.OnServerDiedListener l = null;
            synchronized(mListenerLock) {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                ...
                case android.media.audiofx.Visualizer.NATIVE_EVENT_FFT_CAPTURE :
                    ...
                    break;
                case android.media.audiofx.Visualizer.NATIVE_EVENT_SERVER_DIED :
                    handleServerDiedMessage(msg);
                    break;
                default :
                    android.util.Log.e(android.media.audiofx.Visualizer.TAG, "Unknown native event: " + msg.what);
                    break;
            }
        }
    }
    ...
    private final native int native_setup(java.lang.Object audioeffect_this, int audioSession, int[] id, java.lang.String opPackageName);
    ...
    private static void postEventFromNative(java.lang.Object effect_ref, int what, int arg1, int arg2, java.lang.Object obj) {
        android.media.audiofx.Visualizer visu = ((android.media.audiofx.Visualizer) (((java.lang.ref.WeakReference) (effect_ref)).get()));
        if (visu == null) {
            return;
        }
        if (visu.mNativeEventHandler != null) {
            android.os.Message m = visu.mNativeEventHandler.obtainMessage(what, arg1, arg2, obj);
