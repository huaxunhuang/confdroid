...
public class PresetReverb extends android.media.audiofx.AudioEffect {
     ...
     */
    private android.media.audiofx.PresetReverb.OnParameterChangeListener mParamListener = null;

    /**
     * Listener used internally to to receive raw parameter change event from AudioEffect super class
     */
    private android.media.audiofx.PresetReverb.BaseParameterListener mBaseParamListener = null;
     ...
     * 		
     */
    public PresetReverb(int priority, int audioSession) throws java.lang.IllegalArgumentException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_PRESET_REVERB, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, priority, audioSession);
    }
     ...
     * 		
     */
    public void setPreset(short preset) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        checkStatus(setParameter(android.media.audiofx.PresetReverb.PARAM_PRESET, preset));
    }
    ...
    public short getPreset() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        ...
        checkStatus(getParameter(android.media.audiofx.PresetReverb.PARAM_PRESET, value));
        return value[0];
    }
    ...
    public interface OnParameterChangeListener {
         ...
         * @param param
         * 		ID of the modified parameter. See {@link #PARAM_PRESET} ...
         * @param value
         * 		the new parameter value.
         */
        void onParameterChange(android.media.audiofx.PresetReverb effect, int status, int param, short value);
    }
    ...
    private class BaseParameterListener implements android.media.audiofx.AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(android.media.audiofx.AudioEffect effect, int status, byte[] param, byte[] value) {
            android.media.audiofx.PresetReverb.OnParameterChangeListener l = null;
            ...
            if (l != null) {
                ...
                if ((p != (-1)) && (v != (-1))) {
                    l.onParameterChange(android.media.audiofx.PresetReverb.this, status, p, v);
                }
            }
        }
    }
     ...
     */
    public void setParameterListener(android.media.audiofx.PresetReverb.OnParameterChangeListener listener) {
        synchronized(mParamListenerLock) {
            if (mParamListener == null) {
                mParamListener = listener;
                mBaseParamListener = new android.media.audiofx.PresetReverb.BaseParameterListener();
    ...
    public static class Settings {
        ...
        public Settings(java.lang.String settings) {
            ...
            if (!key.equals("PresetReverb")) {
                throw new java.lang.IllegalArgumentException("invalid settings for PresetReverb: " + key);
            }
            try {
                key = st.nextToken();
                ...
                preset = java.lang.Short.parseShort(st.nextToken());
        ...
        public java.lang.String toString() {
            java.lang.String str = new java.lang.String(("PresetReverb" + ";preset=") + java.lang.Short.toString(preset));
            return str;
        }
    }
     ...
     * 		
     */
    public void setProperties(android.media.audiofx.PresetReverb.Settings settings) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        checkStatus(setParameter(android.media.audiofx.PresetReverb.PARAM_PRESET, settings.preset));
    }
}
