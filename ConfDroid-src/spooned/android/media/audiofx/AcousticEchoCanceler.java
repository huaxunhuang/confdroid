...
public class AcousticEchoCanceler extends android.media.audiofx.AudioEffect {
     ...
     *
     * @param audioSession
     * 		system wide unique audio session identifier. The AcousticEchoCanceler
    ...
    public static android.media.audiofx.AcousticEchoCanceler create(int audioSession) {
        ...
        try {
            aec = new android.media.audiofx.AcousticEchoCanceler(audioSession);
        } catch (java.lang.IllegalArgumentException e) {
            android.util.Log.w(android.media.audiofx.AcousticEchoCanceler.TAG, "not implemented on this device" + aec);
        } catch (java.lang.UnsupportedOperationException e) {
            android.util.Log.w(android.media.audiofx.AcousticEchoCanceler.TAG, "not enough resources");
        } catch (java.lang.RuntimeException e) {
            android.util.Log.w(android.media.audiofx.AcousticEchoCanceler.TAG, "not enough memory");
        }
        return aec;
    }
     ...
     * 		
     */
    private AcousticEchoCanceler(int audioSession) throws java.lang.IllegalArgumentException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_AEC, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, 0, audioSession);
    }
}
