...
public class NoiseSuppressor extends android.media.audiofx.AudioEffect {
     ...
     *
     * @param audioSession
     * 		system wide unique audio session identifier. The NoiseSuppressor
     * 		will be applied to the AudioRecord with the same audio session.
     * @return NoiseSuppressor created or null if the device does not implement noise
    suppression.
     */
    public static android.media.audiofx.NoiseSuppressor create(int audioSession) {
        android.media.audiofx.NoiseSuppressor ns = null;
        try {
            ns = new android.media.audiofx.NoiseSuppressor(audioSession);
        } catch (java.lang.IllegalArgumentException e) {
            android.util.Log.w(android.media.audiofx.NoiseSuppressor.TAG, "not implemented on this device " + ns);
        } catch (java.lang.UnsupportedOperationException e) {
            android.util.Log.w(android.media.audiofx.NoiseSuppressor.TAG, "not enough resources");
        } catch (java.lang.RuntimeException e) {
            android.util.Log.w(android.media.audiofx.NoiseSuppressor.TAG, "not enough memory");
        }
        return ns;
    }
     ...
     * 		
     */
    private NoiseSuppressor(int audioSession) throws java.lang.IllegalArgumentException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_NS, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, 0, audioSession);
    }
}
