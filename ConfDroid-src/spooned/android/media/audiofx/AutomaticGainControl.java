...
public class AutomaticGainControl extends android.media.audiofx.AudioEffect {
     ...
     */
    public static android.media.audiofx.AutomaticGainControl create(int audioSession) {
        android.media.audiofx.AutomaticGainControl agc = null;
        try {
            agc = new android.media.audiofx.AutomaticGainControl(audioSession);
        } catch (java.lang.IllegalArgumentException e) {
            android.util.Log.w(android.media.audiofx.AutomaticGainControl.TAG, "not implemented on this device " + agc);
        } catch (java.lang.UnsupportedOperationException e) {
            android.util.Log.w(android.media.audiofx.AutomaticGainControl.TAG, "not enough resources");
        } catch (java.lang.RuntimeException e) {
            android.util.Log.w(android.media.audiofx.AutomaticGainControl.TAG, "not enough memory");
        }
        return agc;
    }
     ...
     * 		
     */
    private AutomaticGainControl(int audioSession) throws java.lang.IllegalArgumentException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_AGC, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, 0, audioSession);
    }
}
