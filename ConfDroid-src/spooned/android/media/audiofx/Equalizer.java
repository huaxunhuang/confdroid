...
public class Equalizer extends android.media.audiofx.AudioEffect {
     ...
     */
    private android.media.audiofx.Equalizer.OnParameterChangeListener mParamListener = null;

    /**
     * Listener used internally to to receive raw parameter change event from AudioEffect super class
     */
    private android.media.audiofx.Equalizer.BaseParameterListener mBaseParamListener = null;
     ...
     * 		
     */
    public Equalizer(int priority, int audioSession) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.RuntimeException, java.lang.UnsupportedOperationException {
        super(android.media.audiofx.AudioEffect.EFFECT_TYPE_EQUALIZER, android.media.audiofx.AudioEffect.EFFECT_TYPE_NULL, priority, audioSession);
        if (audioSession == 0) {
            android.util.Log.w(android.media.audiofx.Equalizer.TAG, "WARNING: attaching an Equalizer to global output mix is deprecated!");
        }
        getNumberOfBands();
        mNumPresets = ((int) (getNumberOfPresets()));
        if (mNumPresets != 0) {
            mPresetNames = new java.lang.String[mNumPresets];
            byte[] value = new byte[android.media.audiofx.Equalizer.PARAM_STRING_SIZE_MAX];
            int[] param = new int[2];
            param[0] = android.media.audiofx.Equalizer.PARAM_GET_PRESET_NAME;
            for (int i = 0; i < mNumPresets; i++) {
                ...
                try {
                    mPresetNames[i] = new java.lang.String(value, 0, length, "ISO-8859-1");
                } catch (java.io.UnsupportedEncodingException e) {
                    android.util.Log.e(android.media.audiofx.Equalizer.TAG, "preset name decode error");
                }
            }
        }
    }
    ...
    public short getNumberOfBands() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        ...
        int[] param = new int[1];
        param[0] = android.media.audiofx.Equalizer.PARAM_NUM_BANDS;
    ...
    public short[] getBandLevelRange() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        ...
        checkStatus(getParameter(android.media.audiofx.Equalizer.PARAM_LEVEL_RANGE, result));
        return result;
    }
     ...
     */
    public void setBandLevel(short band, short level) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] param = new int[2];
        short[] value = new short[1];
        param[0] = android.media.audiofx.Equalizer.PARAM_BAND_LEVEL;
        param[1] = ((int) (band));
        value[0] = level;
     ...
     * 		
     */
    public short getBandLevel(short band) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] param = new int[2];
        short[] result = new short[1];
        param[0] = android.media.audiofx.Equalizer.PARAM_BAND_LEVEL;
        param[1] = ((int) (band));
     ...
     * 		
     */
    public int getCenterFreq(short band) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] param = new int[2];
        int[] result = new int[1];
        param[0] = android.media.audiofx.Equalizer.PARAM_CENTER_FREQ;
        param[1] = ((int) (band));
        checkStatus(getParameter(param, result));
        return result[0];
    }
     ...
     * 		
     */
    public int[] getBandFreqRange(short band) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] param = new int[2];
        int[] result = new int[2];
        param[0] = android.media.audiofx.Equalizer.PARAM_BAND_FREQ_RANGE;
        param[1] = ((int) (band));
        checkStatus(getParameter(param, result));
        return result;
    }
     ...
     * 		
     */
    public short getBand(int frequency) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        int[] param = new int[2];
        short[] result = new short[1];
        param[0] = android.media.audiofx.Equalizer.PARAM_GET_BAND;
        param[1] = frequency;
        checkStatus(getParameter(param, result));
        return result[0];
    }
    ...
    public short getCurrentPreset() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        short[] result = new short[1];
        checkStatus(getParameter(android.media.audiofx.Equalizer.PARAM_CURRENT_PRESET, result));
        return result[0];
    }
     ...
     */
    public void usePreset(short preset) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        checkStatus(setParameter(android.media.audiofx.Equalizer.PARAM_CURRENT_PRESET, preset));
    }
    ...
    public short getNumberOfPresets() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        short[] result = new short[1];
        checkStatus(getParameter(android.media.audiofx.Equalizer.PARAM_GET_NUM_OF_PRESETS, result));
        return result[0];
    }
    ...
    public interface OnParameterChangeListener {
         ...
         * @param param1
         * 		ID of the modified parameter. See {@link #PARAM_BAND_LEVEL} ...
         * @param param2
         * 		additional parameter qualifier (e.g the band for band level parameter).
         * @param value
         * 		the new parameter value.
         */
        void onParameterChange(android.media.audiofx.Equalizer effect, int status, int param1, int param2, int value);
    }
    ...
    private class BaseParameterListener implements android.media.audiofx.AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(android.media.audiofx.AudioEffect effect, int status, byte[] param, byte[] value) {
            android.media.audiofx.Equalizer.OnParameterChangeListener l = null;
            ...
            if (l != null) {
                ...
                int v = -1;
                if (param.length >= 4) {
                    p1 = android.media.audiofx.AudioEffect.byteArrayToInt(param, 0);
                    if (param.length >= 8) {
                        p2 = android.media.audiofx.AudioEffect.byteArrayToInt(param, 4);
                    }
                }
                if (value.length == 2) {
                ...
                if ((p1 != (-1)) && (v != (-1))) {
                    l.onParameterChange(android.media.audiofx.Equalizer.this, status, p1, p2, v);
                }
            }
        }
    }
    ...
    public void setParameterListener(android.media.audiofx.Equalizer.OnParameterChangeListener listener) {
        synchronized(mParamListenerLock) {
            if (mParamListener == null) {
                ...
                mBaseParamListener = new android.media.audiofx.Equalizer.BaseParameterListener();
    ...
    public static class Settings {
        ...
        public Settings(java.lang.String settings) {
            ...
            if (!key.equals("Equalizer")) {
                throw new java.lang.IllegalArgumentException("invalid settings for Equalizer: " + key);
            }
            try {
                key = st.nextToken();
                ...
                curPreset = java.lang.Short.parseShort(st.nextToken());
                key = st.nextToken();
                if (!key.equals("numBands")) {
                    throw new java.lang.IllegalArgumentException("invalid key name: " + key);
                }
                numBands = java.lang.Short.parseShort(st.nextToken());
                ...
                for (int i = 0; i < numBands; i++) {
                    ...
                    bandLevels[i] = java.lang.Short.parseShort(st.nextToken());
                }
        ...
        public java.lang.String toString() {
            java.lang.String str = new java.lang.String(((("Equalizer" + ";curPreset=") + java.lang.Short.toString(curPreset)) + ";numBands=") + java.lang.Short.toString(numBands));
            for (int i = 0; i < numBands; i++) {
                str = str.concat(((";band" + (i + 1)) + "Level=") + java.lang.Short.toString(bandLevels[i]));
            }
            return str;
        }
    }
    ...
    public android.media.audiofx.Equalizer.Settings getProperties() throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        ...
        checkStatus(getParameter(android.media.audiofx.Equalizer.PARAM_PROPERTIES, param));
        android.media.audiofx.Equalizer.Settings settings = new android.media.audiofx.Equalizer.Settings();
        settings.curPreset = android.media.audiofx.AudioEffect.byteArrayToShort(param, 0);
        settings.numBands = android.media.audiofx.AudioEffect.byteArrayToShort(param, 2);
        settings.bandLevels = new short[mNumBands];
        for (int i = 0; i < mNumBands; i++) {
            settings.bandLevels[i] = android.media.audiofx.AudioEffect.byteArrayToShort(param, 4 + (2 * i));
        }
        return settings;
    }
     ...
     * 		
     */
    public void setProperties(android.media.audiofx.Equalizer.Settings settings) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException, java.lang.UnsupportedOperationException {
        if ((settings.numBands != settings.bandLevels.length) || (settings.numBands != mNumBands)) {
            throw new java.lang.IllegalArgumentException("settings invalid band count: " + settings.numBands);
        }
        byte[] param = android.media.audiofx.AudioEffect.concatArrays(android.media.audiofx.AudioEffect.shortToByteArray(settings.curPreset), android.media.audiofx.AudioEffect.shortToByteArray(mNumBands));
        for (int i = 0; i < mNumBands; i++) {
            param = android.media.audiofx.AudioEffect.concatArrays(param, android.media.audiofx.AudioEffect.shortToByteArray(settings.bandLevels[i]));
        }
        checkStatus(setParameter(android.media.audiofx.Equalizer.PARAM_PROPERTIES, param));
    }
}
