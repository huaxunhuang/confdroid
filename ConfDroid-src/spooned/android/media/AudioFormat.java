...
public final class AudioFormat implements android.os.Parcelable {
    ...
    public static final int CHANNEL_OUT_MONO = android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT;

    public static final int CHANNEL_OUT_STEREO = android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT;

    // aka QUAD_BACK
    public static final int CHANNEL_OUT_QUAD = ((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_BACK_LEFT) | android.media.AudioFormat.CHANNEL_OUT_BACK_RIGHT;
     ...
     * @unknown 
     */
    public static final int CHANNEL_OUT_QUAD_SIDE = ((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_SIDE_LEFT) | android.media.AudioFormat.CHANNEL_OUT_SIDE_RIGHT;

    public static final int CHANNEL_OUT_SURROUND = ((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_FRONT_CENTER) | android.media.AudioFormat.CHANNEL_OUT_BACK_CENTER;

    // aka 5POINT1_BACK
    public static final int CHANNEL_OUT_5POINT1 = ((((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_FRONT_CENTER) | android.media.AudioFormat.CHANNEL_OUT_LOW_FREQUENCY) | android.media.AudioFormat.CHANNEL_OUT_BACK_LEFT) | android.media.AudioFormat.CHANNEL_OUT_BACK_RIGHT;
     ...
     * @unknown 
     */
    public static final int CHANNEL_OUT_5POINT1_SIDE = ((((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_FRONT_CENTER) | android.media.AudioFormat.CHANNEL_OUT_LOW_FREQUENCY) | android.media.AudioFormat.CHANNEL_OUT_SIDE_LEFT) | android.media.AudioFormat.CHANNEL_OUT_SIDE_RIGHT;
     ...
     */
    @java.lang.Deprecated
    public static final int CHANNEL_OUT_7POINT1 = ((((((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_FRONT_CENTER) | android.media.AudioFormat.CHANNEL_OUT_LOW_FREQUENCY) | android.media.AudioFormat.CHANNEL_OUT_BACK_LEFT) | android.media.AudioFormat.CHANNEL_OUT_BACK_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT_OF_CENTER) | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT_OF_CENTER;

    // matches AUDIO_CHANNEL_OUT_7POINT1
    public static final int CHANNEL_OUT_7POINT1_SURROUND = ((((((android.media.AudioFormat.CHANNEL_OUT_FRONT_LEFT | android.media.AudioFormat.CHANNEL_OUT_FRONT_CENTER) | android.media.AudioFormat.CHANNEL_OUT_FRONT_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_SIDE_LEFT) | android.media.AudioFormat.CHANNEL_OUT_SIDE_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_BACK_LEFT) | android.media.AudioFormat.CHANNEL_OUT_BACK_RIGHT) | android.media.AudioFormat.CHANNEL_OUT_LOW_FREQUENCY;
     ...
     *
     *
     * @unknown Return the input channel mask corresponding to an output channel mask.
    This can be used for submix rerouting for the mask of the recorder to map to that of the mix.
     * @param outMask
     * 		a combination of the CHANNEL_OUT_* definitions, but not CHANNEL_OUT_DEFAULT
     * @return a combination of CHANNEL_IN_* definitions matching an output channel mask
     * @throws IllegalArgumentException
     * 		
     */
    public static int inChannelMaskFromOutChannelMask(int outMask) throws java.lang.IllegalArgumentException {
        if (outMask == android.media.AudioFormat.CHANNEL_OUT_DEFAULT) {
            throw new java.lang.IllegalArgumentException("Illegal CHANNEL_OUT_DEFAULT channel mask for input.");
        }
        switch (android.media.AudioFormat.channelCountFromOutChannelMask(outMask)) {
            case 1 :
     ...
     *
     *
     * @unknown Return the number of channels from an input channel mask
     * @param mask
     * 		a combination of the CHANNEL_IN_* definitions, even CHANNEL_IN_DEFAULT
     * @return number of channels for the mask
     */
    public static int channelCountFromInChannelMask(int mask) {
        return java.lang.Integer.bitCount(mask);
    }

    /**
     *
     *
     * @unknown Return the number of channels from an output channel mask
     * @param mask
     * 		a combination of the CHANNEL_OUT_* definitions, but not CHANNEL_OUT_DEFAULT
     * @return number of channels for the mask
     */
     ...
     *
     *
     * @unknown Return a channel mask ready to be used by native code
     * @param mask
     * 		a combination of the CHANNEL_OUT_* definitions, but not CHANNEL_OUT_DEFAULT
     ...
     *
     *
     * @unknown Return a java output channel mask
     * @param mask
    ...
    public static final int CHANNEL_IN_MONO = android.media.AudioFormat.CHANNEL_IN_FRONT;

    public static final int CHANNEL_IN_STEREO = android.media.AudioFormat.CHANNEL_IN_LEFT | android.media.AudioFormat.CHANNEL_IN_RIGHT;
     ...
     * @unknown 
     */
    public static final int CHANNEL_IN_FRONT_BACK = android.media.AudioFormat.CHANNEL_IN_FRONT | android.media.AudioFormat.CHANNEL_IN_BACK;
    ...
    public static int getBytesPerSample(int audioFormat) {
        switch (audioFormat) {
            ...
            case android.media.AudioFormat.ENCODING_IEC61937 :
            case android.media.AudioFormat.ENCODING_DEFAULT :
                return 2;
            case android.media.AudioFormat.ENCODING_PCM_FLOAT :
                return 4;
            case android.media.AudioFormat.ENCODING_INVALID :
            default :
                throw new java.lang.IllegalArgumentException("Bad audio format " + audioFormat);
        }
    }
    ...
    public static boolean isValidEncoding(int audioFormat) {
        switch (audioFormat) {
            ...
            case android.media.AudioFormat.ENCODING_PCM_16BIT :
            case android.media.AudioFormat.ENCODING_PCM_FLOAT :
            case android.media.AudioFormat.ENCODING_AC3 :
            case android.media.AudioFormat.ENCODING_E_AC3 :
            case android.media.AudioFormat.ENCODING_DTS :
            case android.media.AudioFormat.ENCODING_DTS_HD :
            case android.media.AudioFormat.ENCODING_MP3 :
            case android.media.AudioFormat.ENCODING_AAC_LC :
            case android.media.AudioFormat.ENCODING_AAC_HE_V1 :
            case android.media.AudioFormat.ENCODING_AAC_HE_V2 :
            case android.media.AudioFormat.ENCODING_IEC61937 :
                return true;
            default :
                return false;
    ...
    public static int[] filterPublicFormats(int[] formats) {
        ...
        int[] myCopy = java.util.Arrays.copyOf(formats, formats.length);
        int size = 0;
        for (int i = 0; i < myCopy.length; i++) {
            if (android.media.AudioFormat.isPublicEncoding(myCopy[i])) {
                if (size != i) {
        ...
        return java.util.Arrays.copyOf(myCopy, size);
    }
    ...
    private AudioFormat(int encoding, int sampleRate, int channelMask, int channelIndexMask) {
        ...
        mPropertySetMask = ((android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_ENCODING | android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_SAMPLE_RATE) | android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_MASK) | android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_INDEX_MASK;
    }
     ...
     * @unknown 
     */
    public static final int AUDIO_FORMAT_HAS_PROPERTY_NONE = 0x0;
     ...
     * @unknown 
     */
    public static final int AUDIO_FORMAT_HAS_PROPERTY_ENCODING = 0x1 << 0;
     ...
     * @unknown 
     */
    public static final int AUDIO_FORMAT_HAS_PROPERTY_SAMPLE_RATE = 0x1 << 1;
     ...
     * @unknown 
     */
    public static final int AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_MASK = 0x1 << 2;
     ...
     * @unknown 
     */
    public static final int AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_INDEX_MASK = 0x1 << 3;
    ...
    public int getEncoding() {
        if ((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_ENCODING) == 0) {
            return android.media.AudioFormat.ENCODING_INVALID;
        }
        return mEncoding;
    }
    ...
    public int getChannelMask() {
        if ((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_MASK) == 0) {
            return android.media.AudioFormat.CHANNEL_INVALID;
        }
        return mChannelMask;
    }
    ...
    public int getChannelIndexMask() {
        if ((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_INDEX_MASK) == 0) {
            return android.media.AudioFormat.CHANNEL_INVALID;
        }
    ...
    public int getChannelCount() {
        final int channelIndexCount = java.lang.Integer.bitCount(getChannelIndexMask());
        int channelCount = android.media.AudioFormat.channelCountFromOutChannelMask(getChannelMask());
        if (channelCount == 0) {
    ...
    public static class Builder {
        private int mEncoding = android.media.AudioFormat.ENCODING_INVALID;

        private int mSampleRate = android.media.AudioFormat.SAMPLE_RATE_UNSPECIFIED;

        private int mChannelMask = android.media.AudioFormat.CHANNEL_INVALID;

        private int mChannelIndexMask = 0;

        private int mPropertySetMask = android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_NONE;
         ...
         *
         * @param af
         * 		the {@link AudioFormat} object whose data will be reused in the new Builder.
         */
        ...
        public android.media.AudioFormat build() {
            android.media.AudioFormat af = /* ignored */
            new android.media.AudioFormat(1980);
         ...
         *
         * @param encoding
         * 		one of {@link AudioFormat#ENCODING_DEFAULT},
         ...
         * 		
         */
        public android.media.AudioFormat.Builder setEncoding(@android.media.AudioFormat.Encoding
        int encoding) throws java.lang.IllegalArgumentException {
            switch (encoding) {
                case android.media.AudioFormat.ENCODING_DEFAULT :
                    mEncoding = android.media.AudioFormat.ENCODING_PCM_16BIT;
                    break;
                case android.media.AudioFormat.ENCODING_PCM_8BIT :
                case android.media.AudioFormat.ENCODING_PCM_16BIT :
                case android.media.AudioFormat.ENCODING_PCM_FLOAT :
                ...
                case android.media.AudioFormat.ENCODING_INVALID :
                default :
                    throw new java.lang.IllegalArgumentException("Invalid encoding " + encoding);
            }
            mPropertySetMask |= android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_ENCODING;
            return this;
        }
        ...
        public android.media.AudioFormat.Builder setChannelMask(int channelMask) {
            if (channelMask == android.media.AudioFormat.CHANNEL_INVALID) {
                throw new java.lang.IllegalArgumentException("Invalid zero channel mask");
            } else
                /* channelMask != 0 && */
                if ((mChannelIndexMask != 0) && (java.lang.Integer.bitCount(channelMask) != java.lang.Integer.bitCount(mChannelIndexMask))) {
                    throw new java.lang.IllegalArgumentException("Mismatched channel count for mask " + java.lang.Integer.toHexString(channelMask).toUpperCase());
                }

            mChannelMask = channelMask;
            mPropertySetMask |= android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_MASK;
            return this;
        }
         ...
         */
        @android.annotation.NonNull
        public android.media.AudioFormat.Builder setChannelIndexMask(int channelIndexMask) {
            if (channelIndexMask == 0) {
                throw new java.lang.IllegalArgumentException("Invalid zero channel index mask");
            } else
                /* channelIndexMask != 0 && */
                if ((mChannelMask != 0) && (java.lang.Integer.bitCount(channelIndexMask) != java.lang.Integer.bitCount(mChannelMask))) {
                    throw new java.lang.IllegalArgumentException("Mismatched channel count for index mask " + java.lang.Integer.toHexString(channelIndexMask).toUpperCase());
                }

            mChannelIndexMask = channelIndexMask;
            mPropertySetMask |= android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_INDEX_MASK;
            return this;
        }
         ...
         * 		
         */
        public android.media.AudioFormat.Builder setSampleRate(int sampleRate) throws java.lang.IllegalArgumentException {
            ...
            if (((sampleRate < android.media.AudioFormat.SAMPLE_RATE_HZ_MIN) || (sampleRate > android.media.AudioFormat.SAMPLE_RATE_HZ_MAX)) && (sampleRate != android.media.AudioFormat.SAMPLE_RATE_UNSPECIFIED)) {
                throw new java.lang.IllegalArgumentException("Invalid sample rate " + sampleRate);
            }
            mSampleRate = sampleRate;
            mPropertySetMask |= android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_SAMPLE_RATE;
            return this;
        }
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        android.media.AudioFormat that = ((android.media.AudioFormat) (o));
        if (mPropertySetMask != that.mPropertySetMask)
            return false;

        // return false if any of the properties is set and the values differ
        return !((((((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_ENCODING) != 0) && (mEncoding != that.mEncoding)) || (((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_SAMPLE_RATE) != 0) && (mSampleRate != that.mSampleRate))) || (((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_MASK) != 0) && (mChannelMask != that.mChannelMask))) || (((mPropertySetMask & android.media.AudioFormat.AUDIO_FORMAT_HAS_PROPERTY_CHANNEL_INDEX_MASK) != 0) && (mChannelIndexMask != that.mChannelIndexMask)));
    }

    @java.lang.Override
    public int hashCode() {
        return java.util.Objects.hash(mPropertySetMask, mSampleRate, mEncoding, mChannelMask, mChannelIndexMask);
    }
    ...
    private AudioFormat(android.os.Parcel in) {
    ...
    public static final android.os.Parcelable.Creator<android.media.AudioFormat> CREATOR = new android.os.Parcelable.Creator<android.media.AudioFormat>() {
        public android.media.AudioFormat createFromParcel(android.os.Parcel p) {
            return new android.media.AudioFormat(p);
        }

        public android.media.AudioFormat[] newArray(int size) {
            return new android.media.AudioFormat[size];
        }
    };

    @java.lang.Override
    public java.lang.String toString() {
        return new java.lang.String(((((((((("AudioFormat:" + " props=") + mPropertySetMask) + " enc=") + mEncoding) + " chan=0x") + java.lang.Integer.toHexString(mChannelMask).toUpperCase()) + " chan_index=0x") + java.lang.Integer.toHexString(mChannelIndexMask).toUpperCase()) + " rate=") + mSampleRate);
    }
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.media.AudioFormat.ENCODING_DEFAULT, android.media.AudioFormat.ENCODING_PCM_8BIT, android.media.AudioFormat.ENCODING_PCM_16BIT, android.media.AudioFormat.ENCODING_PCM_FLOAT, android.media.AudioFormat.ENCODING_AC3, android.media.AudioFormat.ENCODING_E_AC3, android.media.AudioFormat.ENCODING_DTS, android.media.AudioFormat.ENCODING_DTS_HD, android.media.AudioFormat.ENCODING_IEC61937 })
