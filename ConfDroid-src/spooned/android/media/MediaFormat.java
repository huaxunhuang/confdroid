...
public final class MediaFormat {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.media.MediaFormat.COLOR_STANDARD_BT709, android.media.MediaFormat.COLOR_STANDARD_BT601_PAL, android.media.MediaFormat.COLOR_STANDARD_BT601_NTSC, android.media.MediaFormat.COLOR_STANDARD_BT2020 })
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.media.MediaFormat.COLOR_TRANSFER_LINEAR, android.media.MediaFormat.COLOR_TRANSFER_SDR_VIDEO, android.media.MediaFormat.COLOR_TRANSFER_ST2084, android.media.MediaFormat.COLOR_TRANSFER_HLG })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.media.MediaFormat.COLOR_RANGE_LIMITED, android.media.MediaFormat.COLOR_RANGE_FULL })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    public final int getInteger(java.lang.String name) {
        return ((java.lang.Integer) (mMap.get(name))).intValue();
    }
     ...
     * @unknown 
     */
    public final int getInteger(java.lang.String name, int defaultValue) {
        try {
            return getInteger(name);
        } catch (java.lang.NullPointerException e) {
            /* no such field */
        } catch (java.lang.ClassCastException e) {
            /* field of different type */
        }
        return defaultValue;
    }
    ...
    public final long getLong(java.lang.String name) {
        return ((java.lang.Long) (mMap.get(name))).longValue();
    }
    ...
    public final float getFloat(java.lang.String name) {
        return ((java.lang.Float) (mMap.get(name))).floatValue();
    }
    ...
    public final java.lang.String getString(java.lang.String name) {
        return ((java.lang.String) (mMap.get(name)));
    }
    ...
    public final java.nio.ByteBuffer getByteBuffer(java.lang.String name) {
        return ((java.nio.ByteBuffer) (mMap.get(name)));
    }
     ...
     *
     * @param feature
     * 		the name of a {@link MediaCodecInfo.CodecCapabilities} feature.
     * @throws IllegalArgumentException
     * 		if the feature was neither set to be enabled
     * 		nor to be disabled.
     */
    public boolean getFeatureEnabled(java.lang.String feature) {
        java.lang.Integer enabled = ((java.lang.Integer) (mMap.get(android.media.MediaFormat.KEY_FEATURE_ + feature)));
        if (enabled == null) {
     ...
     */
    public final void setInteger(java.lang.String name, int value) {
        mMap.put(name, java.lang.Integer.valueOf(value));
    }

    /**
     * Sets the value of a long key.
     */
    public final void setLong(java.lang.String name, long value) {
        mMap.put(name, java.lang.Long.valueOf(value));
    }

    /**
     * Sets the value of a float key.
     */
    public final void setFloat(java.lang.String name, float value) {
        mMap.put(name, new java.lang.Float(value));
    }

    /**
     * Sets the value of a string key.
     */
    public final void setString(java.lang.String name, java.lang.String value) {
        mMap.put(name, value);
    }
     ...
     */
    public final void setByteBuffer(java.lang.String name, java.nio.ByteBuffer bytes) {
        mMap.put(name, bytes);
    }
     ...
     * @see MediaCodecInfo.CodecCapabilities#isFormatSupported
     */
    public void setFeatureEnabled(java.lang.String feature, boolean enabled) {
        setInteger(android.media.MediaFormat.KEY_FEATURE_ + feature, enabled ? 1 : 0);
    }
     ...
     */
    public static final android.media.MediaFormat createAudioFormat(java.lang.String mime, int sampleRate, int channelCount) {
        android.media.MediaFormat format = new android.media.MediaFormat();
        format.setString(android.media.MediaFormat.KEY_MIME, mime);
        format.setInteger(android.media.MediaFormat.KEY_SAMPLE_RATE, sampleRate);
        format.setInteger(android.media.MediaFormat.KEY_CHANNEL_COUNT, channelCount);
        return format;
    }
     ...
     */
    public static final android.media.MediaFormat createSubtitleFormat(java.lang.String mime, java.lang.String language) {
        android.media.MediaFormat format = new android.media.MediaFormat();
        format.setString(android.media.MediaFormat.KEY_MIME, mime);
        format.setString(android.media.MediaFormat.KEY_LANGUAGE, language);
        return format;
    }
     ...
     */
    public static final android.media.MediaFormat createVideoFormat(java.lang.String mime, int width, int height) {
        android.media.MediaFormat format = new android.media.MediaFormat();
        format.setString(android.media.MediaFormat.KEY_MIME, mime);
