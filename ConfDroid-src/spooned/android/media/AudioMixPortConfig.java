...
public class AudioMixPortConfig extends android.media.AudioPortConfig {
    AudioMixPortConfig(android.media.AudioMixPort mixPort, int samplingRate, int channelMask, int format, android.media.AudioGainConfig gain) {
        super(((android.media.AudioPort) (mixPort)), samplingRate, channelMask, format, gain);
    }
    ...
    public android.media.AudioMixPort port() {
        return ((android.media.AudioMixPort) (mPort));
    }
}
