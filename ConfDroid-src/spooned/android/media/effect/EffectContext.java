...
public class EffectContext {
    ...
    public static android.media.effect.EffectContext createWithCurrentGlContext() {
        android.media.effect.EffectContext result = new android.media.effect.EffectContext();
    ...
    private EffectContext() {
        mFilterContext = new android.filterfw.core.FilterContext();
        mFilterContext.setFrameManager(new android.filterfw.core.CachedFrameManager());
        mFactory = new android.media.effect.EffectFactory(this);
    }
    ...
    final void saveGLState() {
        android.opengl.GLES20.glGetIntegerv(android.opengl.GLES20.GL_FRAMEBUFFER_BINDING, mOldState, GL_STATE_FBO);
        android.opengl.GLES20.glGetIntegerv(android.opengl.GLES20.GL_CURRENT_PROGRAM, mOldState, GL_STATE_PROGRAM);
        android.opengl.GLES20.glGetIntegerv(android.opengl.GLES20.GL_ARRAY_BUFFER_BINDING, mOldState, GL_STATE_ARRAYBUFFER);
    }

    final void restoreGLState() {
        android.opengl.GLES20.glBindFramebuffer(android.opengl.GLES20.GL_FRAMEBUFFER, mOldState[GL_STATE_FBO]);
        android.opengl.GLES20.glUseProgram(mOldState[GL_STATE_PROGRAM]);
        android.opengl.GLES20.glBindBuffer(android.opengl.GLES20.GL_ARRAY_BUFFER, mOldState[GL_STATE_ARRAYBUFFER]);
    }
}
