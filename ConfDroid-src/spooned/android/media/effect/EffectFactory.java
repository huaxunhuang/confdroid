...
public class EffectFactory {
    ...
    private static final java.lang.String[] EFFECT_PACKAGES = new java.lang.String[]{ "android.media.effect.effects."// Default effect package
     ...
     * 		not known.
     */
    public android.media.effect.Effect createEffect(java.lang.String effectName) {
        java.lang.Class effectClass = android.media.effect.EffectFactory.getEffectClassByName(effectName);
        if (effectClass == null) {
            throw new java.lang.IllegalArgumentException(("Cannot instantiate unknown effect '" + effectName) + "'!");
        }
     ...
     */
    public static boolean isEffectSupported(java.lang.String effectName) {
        return android.media.effect.EffectFactory.getEffectClassByName(effectName) != null;
    }

    private static java.lang.Class getEffectClassByName(java.lang.String className) {
        java.lang.Class effectClass = null;
        ...
        for (java.lang.String packageName : android.media.effect.EffectFactory.EFFECT_PACKAGES) {
            try {
    ...
    private android.media.effect.Effect instantiateEffect(java.lang.Class effectClass, java.lang.String name) {
        // Make sure this is an Effect subclass
        try {
            effectClass.asSubclass(android.media.effect.Effect.class);
        } catch (java.lang.ClassCastException e) {
            throw new java.lang.IllegalArgumentException(("Attempting to allocate effect '" + effectClass) + "' which is not a subclass of Effect!", e);
        }
        // Look for the correct constructor
        java.lang.reflect.Constructor effectConstructor = null;
        try {
            effectConstructor = effectClass.getConstructor(android.media.effect.EffectContext.class, java.lang.String.class);
        } catch (java.lang.NoSuchMethodException e) {
            throw new java.lang.RuntimeException((("The effect class '" + effectClass) + "' does not have ") + "the required constructor.", e);
        }
        // Construct the effect
        android.media.effect.Effect effect = null;
        try {
            effect = ((android.media.effect.Effect) (effectConstructor.newInstance(mEffectContext, name)));
        } catch (java.lang.Throwable t) {
            throw new java.lang.RuntimeException(("There was an error constructing the effect '" + effectClass) + "'!", t);
        }
        return effect;
    }
}
