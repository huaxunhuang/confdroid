...
public class AudioGain {
     ...
     * @param rampDurationMs:
     * 		ramp duration if mode MODE_RAMP is set.
     * 		ignored if MODE_JOINT.
     */
    public android.media.AudioGainConfig buildConfig(int mode, int channelMask, int[] values, int rampDurationMs) {
        // TODO: check params here
        return new android.media.AudioGainConfig(mIndex, this, mode, channelMask, values, rampDurationMs);
    }
}
