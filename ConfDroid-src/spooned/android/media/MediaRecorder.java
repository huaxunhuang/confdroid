...
public class MediaRecorder {
    ...
    public MediaRecorder() {
        ...
        if ((looper = android.os.Looper.myLooper()) != null) {
            mEventHandler = new android.media.MediaRecorder.EventHandler(this, looper);
        } else
        ...
        java.lang.String packageName = android.app.ActivityThread.currentPackageName();
        /* Native setup requires a weak reference to our object.
        It's easier to create it here than in C++.
         */
        native_setup(new java.lang.ref.WeakReference<android.media.MediaRecorder>(this), packageName, android.app.ActivityThread.currentOpPackageName());
    }
     ...
     * 		if it is called before {@link #prepare}, after
     ...
     * @throws IllegalStateException
     * 		if it is called after {@link #prepare} and before
     * 		{@link #stop}.
    ...
    public static boolean isSystemOnlyAudioSource(int source) {
        switch (source) {
            ...
            case android.media.MediaRecorder.AudioSource.VOICE_UPLINK :
            case android.media.MediaRecorder.AudioSource.VOICE_DOWNLINK :
            case android.media.MediaRecorder.AudioSource.VOICE_CALL :
    ...
    public final class OutputFormat {
         ...
         *
         *
         * @unknown Stream over a socket, limited to a single stream
         */
         ...
         *
         *
         * @unknown H.264/AAC data encapsulated in MPEG2/TS
         */
    ...
    public void setProfile(android.media.CamcorderProfile profile) {
        ...
        if ((profile.quality >= android.media.CamcorderProfile.QUALITY_TIME_LAPSE_LOW) && (profile.quality <= android.media.CamcorderProfile.QUALITY_TIME_LAPSE_QVGA)) {
     ...
     * @unknown 
     * @param profile
     * 		declared in {@link MediaCodecInfo.CodecProfileLevel}.
     * @param level
     * 		declared in {@link MediaCodecInfo.CodecProfileLevel}.
     */
    ...
    public void setAuxiliaryOutputFile(java.io.FileDescriptor fd) {
        android.util.Log.w(android.media.MediaRecorder.TAG, "setAuxiliaryOutputFile(FileDescriptor) is no longer supported.");
    }
    ...
    public void setAuxiliaryOutputFile(java.lang.String path) {
        android.util.Log.w(android.media.MediaRecorder.TAG, "setAuxiliaryOutputFile(String) is no longer supported.");
    }
    ...
    private native void _setOutputFile(java.io.FileDescriptor fd, long offset, long length) throws java.io.IOException, java.lang.IllegalStateException;
    ...
    public void prepare() throws java.io.IOException, java.lang.IllegalStateException {
        if (mPath != null) {
            java.io.RandomAccessFile file = new java.io.RandomAccessFile(mPath, "rws");
            try {
    ...
    public interface OnErrorListener {
         ...
         */
        void onError(android.media.MediaRecorder mr, int what, int extra);
    }
    ...
    public interface OnInfoListener {
         ...
         * 		an extra code, specific to the error type
         */
        void onInfo(android.media.MediaRecorder mr, int what, int extra);
    }
    ...
    private class EventHandler extends android.os.Handler {
        ...
        public EventHandler(android.media.MediaRecorder mr, android.os.Looper looper) {
            super(looper);
            mMediaRecorder = mr;
        }
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            switch (msg.what) {
                case android.media.MediaRecorder.EventHandler.MEDIA_RECORDER_EVENT_ERROR :
                case android.media.MediaRecorder.EventHandler.MEDIA_RECORDER_TRACK_EVENT_ERROR :
                    if (mOnErrorListener != null)
                        mOnErrorListener.onError(mMediaRecorder, msg.arg1, msg.arg2);

                    return;
                case android.media.MediaRecorder.EventHandler.MEDIA_RECORDER_EVENT_INFO :
                case android.media.MediaRecorder.EventHandler.MEDIA_RECORDER_TRACK_EVENT_INFO :
                    if (mOnInfoListener != null)
                        mOnInfoListener.onInfo(mMediaRecorder, msg.arg1, msg.arg2);

                    return;
                default :
                    android.util.Log.e(android.media.MediaRecorder.TAG, "Unknown message type " + msg.what);
                    return;
            }
        }
    }
     ...
     */
    private static void postEventFromNative(java.lang.Object mediarecorder_ref, int what, int arg1, int arg2, java.lang.Object obj) {
        android.media.MediaRecorder mr = ((android.media.MediaRecorder) (((java.lang.ref.WeakReference) (mediarecorder_ref)).get()));
        if (mr == null) {
            return;
        }
        if (mr.mEventHandler != null) {
            android.os.Message m = mr.mEventHandler.obtainMessage(what, arg1, arg2, obj);
    ...
    private final native void native_setup(java.lang.Object mediarecorder_this, java.lang.String clientName, java.lang.String opPackageName) throws java.lang.IllegalStateException;
