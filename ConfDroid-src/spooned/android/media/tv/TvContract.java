...
public final class TvContract {
     ...
     *
     * @param name
     * 		The {@link ComponentName} of the TV input service to build ID for.
     * @return the ID for the given TV input service.
     */
    public static final java.lang.String buildInputId(android.content.ComponentName name) {
     ...
     */
    public static final android.net.Uri buildChannelUri(long channelId) {
        return android.content.ContentUris.withAppendedId(android.media.tv.TvContract.Channels.CONTENT_URI, channelId);
    }
     ...
     */
    public static final android.net.Uri buildChannelUriForPassthroughInput(java.lang.String inputId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(android.media.tv.TvContract.AUTHORITY).appendPath(android.media.tv.TvContract.PATH_PASSTHROUGH).appendPath(inputId).build();
    }
     ...
     */
    public static final android.net.Uri buildChannelLogoUri(long channelId) {
        return android.media.tv.TvContract.buildChannelLogoUri(android.media.tv.TvContract.buildChannelUri(channelId));
    }
     ...
     */
    public static final android.net.Uri buildChannelLogoUri(android.net.Uri channelUri) {
        if (!android.media.tv.TvContract.isChannelUriForTunerInput(channelUri)) {
            throw new java.lang.IllegalArgumentException("Not a channel: " + channelUri);
        }
        return android.net.Uri.withAppendedPath(channelUri, android.media.tv.TvContract.Channels.Logo.CONTENT_DIRECTORY);
    }
     ...
     *
     * @param inputId
     * 		The ID of the TV input to build a channels URI for. If {@code null}, builds a
     * 		URI for all the TV inputs.
     */
    public static final android.net.Uri buildChannelsUriForInput(@android.annotation.Nullable
    java.lang.String inputId) {
        return android.media.tv.TvContract.buildChannelsUriForInput(inputId, false);
    }
     ...
     * 		URI for all the TV inputs.
     * @param browsableOnly
     * 		If set to {@code true} the URI points to only browsable channels. If set
    ...
    public static final android.net.Uri buildChannelsUriForInput(@android.annotation.Nullable
    java.lang.String inputId, boolean browsableOnly) {
        android.net.Uri.Builder builder = android.media.tv.TvContract.Channels.CONTENT_URI.buildUpon();
        if (inputId != null) {
            builder.appendQueryParameter(android.media.tv.TvContract.PARAM_INPUT, inputId);
        }
        return builder.appendQueryParameter(android.media.tv.TvContract.PARAM_BROWSABLE_ONLY, java.lang.String.valueOf(browsableOnly)).build();
    }
     ...
     * 		URI for all the TV inputs.
     * @param genre
     * 		{@link Programs.Genres} to search. If {@code null}, builds a URI for all genres.
     * @param browsableOnly
     * 		If set to {@code true} the URI points to only browsable channels. If set
     * 		to {@code false} the URI points to all channels regardless of whether they are
     * 		browsable or not.
    ...
    @android.annotation.SystemApi
    public static final android.net.Uri buildChannelsUriForInput(@android.annotation.Nullable
    java.lang.String inputId, @android.annotation.Nullable
    java.lang.String genre, boolean browsableOnly) {
        if (genre == null) {
            return android.media.tv.TvContract.buildChannelsUriForInput(inputId, browsableOnly);
        }
        if (!android.media.tv.TvContract.Programs.Genres.isCanonical(genre)) {
            throw new java.lang.IllegalArgumentException(("Not a canonical genre: '" + genre) + "'");
        }
        return android.media.tv.TvContract.buildChannelsUriForInput(inputId, browsableOnly).buildUpon().appendQueryParameter(android.media.tv.TvContract.PARAM_CANONICAL_GENRE, genre).build();
    }
     ...
     */
    public static final android.net.Uri buildProgramUri(long programId) {
        return android.content.ContentUris.withAppendedId(android.media.tv.TvContract.Programs.CONTENT_URI, programId);
    }
     ...
     */
    public static final android.net.Uri buildProgramsUriForChannel(long channelId) {
        return android.media.tv.TvContract.Programs.CONTENT_URI.buildUpon().appendQueryParameter(android.media.tv.TvContract.PARAM_CHANNEL, java.lang.String.valueOf(channelId)).build();
    }
     ...
     */
    public static final android.net.Uri buildProgramsUriForChannel(android.net.Uri channelUri) {
        if (!android.media.tv.TvContract.isChannelUriForTunerInput(channelUri)) {
            throw new java.lang.IllegalArgumentException("Not a channel: " + channelUri);
        }
        return android.media.tv.TvContract.buildProgramsUriForChannel(android.content.ContentUris.parseId(channelUri));
    }
     ...
     */
    public static final android.net.Uri buildProgramsUriForChannel(long channelId, long startTime, long endTime) {
        android.net.Uri uri = android.media.tv.TvContract.buildProgramsUriForChannel(channelId);
        return uri.buildUpon().appendQueryParameter(android.media.tv.TvContract.PARAM_START_TIME, java.lang.String.valueOf(startTime)).appendQueryParameter(android.media.tv.TvContract.PARAM_END_TIME, java.lang.String.valueOf(endTime)).build();
    }
     ...
     * 		{@link Programs#COLUMN_START_TIME_UTC_MILLIS} that is less than this time.
     */
    public static final android.net.Uri buildProgramsUriForChannel(android.net.Uri channelUri, long startTime, long endTime) {
        if (!android.media.tv.TvContract.isChannelUriForTunerInput(channelUri)) {
            throw new java.lang.IllegalArgumentException("Not a channel: " + channelUri);
        }
        return android.media.tv.TvContract.buildProgramsUriForChannel(android.content.ContentUris.parseId(channelUri), startTime, endTime);
    }

    /**
     * Builds a URI that points to a specific recorded program.
     *
     * @param recordedProgramId
     * 		The ID of the recorded program to point to.
     */
    public static final android.net.Uri buildRecordedProgramUri(long recordedProgramId) {
        return android.content.ContentUris.withAppendedId(android.media.tv.TvContract.RecordedPrograms.CONTENT_URI, recordedProgramId);
    }

    /**
     * Builds a URI that points to a specific program the user watched.
     *
     * @param watchedProgramId
     * 		The ID of the watched program to point to.
     * @unknown 
     */
    public static final android.net.Uri buildWatchedProgramUri(long watchedProgramId) {
        return android.content.ContentUris.withAppendedId(android.media.tv.TvContract.WatchedPrograms.CONTENT_URI, watchedProgramId);
    }

    private static boolean isTvUri(android.net.Uri uri) {
        return ((uri != null) && android.content.ContentResolver.SCHEME_CONTENT.equals(uri.getScheme())) && android.media.tv.TvContract.AUTHORITY.equals(uri.getAuthority());
    }

    private static boolean isTwoSegmentUriStartingWith(android.net.Uri uri, java.lang.String pathSegment) {
     ...
     */
    public static final boolean isChannelUri(android.net.Uri uri) {
        return android.media.tv.TvContract.isChannelUriForTunerInput(uri) || android.media.tv.TvContract.isChannelUriForPassthroughInput(uri);
    }

    /**
     * Returns {@code true}, if {@code uri} is a channel URI for a tuner input.
     */
    public static final boolean isChannelUriForTunerInput(android.net.Uri uri) {
        return android.media.tv.TvContract.isTvUri(uri) && android.media.tv.TvContract.isTwoSegmentUriStartingWith(uri, android.media.tv.TvContract.PATH_CHANNEL);
    }

    /**
     * Returns {@code true}, if {@code uri} is a channel URI for a pass-through input.
     */
    public static final boolean isChannelUriForPassthroughInput(android.net.Uri uri) {
        return android.media.tv.TvContract.isTvUri(uri) && android.media.tv.TvContract.isTwoSegmentUriStartingWith(uri, android.media.tv.TvContract.PATH_PASSTHROUGH);
    }

    /**
     * Returns {@code true}, if {@code uri} is a program URI.
     */
    public static final boolean isProgramUri(android.net.Uri uri) {
        return android.media.tv.TvContract.isTvUri(uri) && android.media.tv.TvContract.isTwoSegmentUriStartingWith(uri, android.media.tv.TvContract.PATH_PROGRAM);
    }
    ...
    public interface BaseTvColumns extends android.provider.BaseColumns {
         ...
         * <p>Type: TEXT
         */
        java.lang.String COLUMN_PACKAGE_NAME = "package_name";
    }
    ...
    public static final class Channels implements android.media.tv.TvContract.BaseTvColumns {
         ...
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse((("content://" + android.media.tv.TvContract.AUTHORITY) + "/") + android.media.tv.TvContract.PATH_CHANNEL);
        ...
        static {
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_480I, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_SD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_480P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_ED);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_576I, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_SD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_576P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_ED);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_720P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_HD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_1080I, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_HD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_1080P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_FHD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_2160P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_UHD);
            android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.put(android.media.tv.TvContract.Channels.VIDEO_FORMAT_4320P, android.media.tv.TvContract.Channels.VIDEO_RESOLUTION_UHD);
        }
         ...
         *
         * @param videoFormat
         * 		The video format defined in {@link Channels}.
        ...
        public static final java.lang.String getVideoResolution(java.lang.String videoFormat) {
            return android.media.tv.TvContract.Channels.VIDEO_FORMAT_TO_RESOLUTION_MAP.get(videoFormat);
        }
    ...
    public static final class Programs implements android.media.tv.TvContract.BaseTvColumns {
         ...
         * The content:// style URI for this table.
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse((("content://" + android.media.tv.TvContract.AUTHORITY) + "/") + android.media.tv.TvContract.PATH_PROGRAM);
        ...
        public static final class Genres {
            ...
            static {
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.FAMILY_KIDS);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.SPORTS);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.SHOPPING);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.MOVIES);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.COMEDY);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.TRAVEL);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.DRAMA);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.EDUCATION);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.ANIMAL_WILDLIFE);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.NEWS);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.GAMING);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.ARTS);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.ENTERTAINMENT);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.LIFE_STYLE);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.MUSIC);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.PREMIER);
                android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.add(android.media.tv.TvContract.Programs.Genres.TECH_SCIENCE);
            }
             ...
             */
            public static java.lang.String encode(@android.annotation.NonNull
            java.lang.String... genres) {
                ...
                for (java.lang.String genre : genres) {
                    sb.append(separator).append(android.media.tv.TvContract.Programs.Genres.encodeToCsv(genre));
                    separator = android.media.tv.TvContract.Programs.Genres.DELIMITER;
                }
                return sb.toString();
            }

            private static java.lang.String encodeToCsv(java.lang.String genre) {
                java.lang.StringBuilder sb = new java.lang.StringBuilder();
                int length = genre.length();
                for (int i = 0; i < length; ++i) {
                    char c = genre.charAt(i);
                    switch (c) {
                        case android.media.tv.TvContract.Programs.Genres.DOUBLE_QUOTE :
                            sb.append(android.media.tv.TvContract.Programs.Genres.DOUBLE_QUOTE);
                            break;
                        case android.media.tv.TvContract.Programs.Genres.COMMA :
                            sb.append(android.media.tv.TvContract.Programs.Genres.DOUBLE_QUOTE);
                            break;
                    }
                    sb.append(c);
             ...
             */
            public static java.lang.String[] decode(@android.annotation.NonNull
            java.lang.String genres) {
                if (android.text.TextUtils.isEmpty(genres)) {
                    // MNC and before will throw a NPE for {@code null} genres.
                    return android.media.tv.TvContract.Programs.Genres.EMPTY_STRING_ARRAY;
                }
                if ((genres.indexOf(android.media.tv.TvContract.Programs.Genres.COMMA) == (-1)) && (genres.indexOf(android.media.tv.TvContract.Programs.Genres.DOUBLE_QUOTE) == (-1))) {
                    return new java.lang.String[]{ genres.trim() };
                }
                java.lang.StringBuilder sb = new java.lang.StringBuilder();
                ...
                for (int i = 0; i < length; ++i) {
                    ...
                    switch (c) {
                        ...
                        case android.media.tv.TvContract.Programs.Genres.COMMA :
                            if (!escape) {
                                java.lang.String string = sb.toString().trim();
                                if (string.length() > 0) {
                                    results.add(string);
                                }
                ...
                return results.toArray(new java.lang.String[results.size()]);
            }
            ...
            public static boolean isCanonical(java.lang.String genre) {
                return android.media.tv.TvContract.Programs.Genres.CANONICAL_GENRES.contains(genre);
            }
        }
    }
    ...
    public static final class RecordedPrograms implements android.media.tv.TvContract.BaseTvColumns {
         ...
         * The content:// style URI for this table.
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse((("content://" + android.media.tv.TvContract.AUTHORITY) + "/") + android.media.tv.TvContract.PATH_RECORDED_PROGRAM);
    ...
    public static final class WatchedPrograms implements android.media.tv.TvContract.BaseTvColumns {
         ...
         * The content:// style URI for this table.
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse(("content://" + android.media.tv.TvContract.AUTHORITY) + "/watched_program");
