...
public class TvRecordingClient {
     ...
     */
    public TvRecordingClient(android.content.Context context, java.lang.String tag, @android.annotation.NonNull
    android.media.tv.TvRecordingClient.RecordingCallback callback, android.os.Handler handler) {
        mCallback = callback;
        mHandler = (handler == null) ? new android.os.Handler(android.os.Looper.getMainLooper()) : handler;
        mTvInputManager = ((android.media.tv.TvInputManager) (context.getSystemService(android.content.Context.TV_INPUT_SERVICE)));
    }
     ...
     */
    public void tune(java.lang.String inputId, android.net.Uri channelUri) {
    ...
    public void tune(java.lang.String inputId, android.net.Uri channelUri, android.os.Bundle params) {
        if (android.media.tv.TvRecordingClient.DEBUG)
            android.util.Log.d(android.media.tv.TvRecordingClient.TAG, ("tune(" + channelUri) + ")");
        ...
        if ((mSessionCallback != null) && android.text.TextUtils.equals(mSessionCallback.mInputId, inputId)) {
            ...
            resetInternal();
            mSessionCallback = new android.media.tv.TvRecordingClient.MySessionCallback(inputId, channelUri, params);
    ...
    public void release() {
        if (android.media.tv.TvRecordingClient.DEBUG)
            android.util.Log.d(android.media.tv.TvRecordingClient.TAG, "release()");
     ...
     * @throws IllegalStateException
     * 		If {@link #tune} request hasn't been handled yet.
     */
    public void startRecording(@android.annotation.Nullable
    android.net.Uri programUri) {
        if (!mIsTuned) {
            throw new java.lang.IllegalStateException("startRecording failed - not yet tuned");
        }
        if (mSession != null) {
    ...
    public void stopRecording() {
        if (!mIsRecordingStarted) {
            android.util.Log.w(android.media.tv.TvRecordingClient.TAG, "stopRecording failed - recording not yet started");
        }
        if (mSession != null) {
    ...
    java.lang.String action, android.os.Bundle data) {
        ...
        if (mSession != null) {
            ...
            android.util.Log.w(android.media.tv.TvRecordingClient.TAG, ("sendAppPrivateCommand - session not yet created (action \"" + action) + "\" pending)");
    ...
    public static abstract class RecordingCallback {
         ...
         * 		</ul>
         */
        public void onError(@android.media.tv.TvInputManager.RecordingError
        int error) {
        }
         ...
         *
         * @param inputId
         * 		The ID of the TV input bound to this client.
         * @param eventType
    ...
    private class MySessionCallback extends android.media.tv.TvInputManager.SessionCallback {
        ...
        MySessionCallback(java.lang.String inputId, android.net.Uri channelUri, android.os.Bundle connectionParams) {
            mInputId = inputId;
        ...
        public void onSessionCreated(android.media.tv.TvInputManager.Session session) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, "onSessionCreated()");
            }
        ...
        void onTuned(android.media.tv.TvInputManager.Session session, android.net.Uri channelUri) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, "onTuned()");
            }
            if (this != mSessionCallback) {
        ...
        public void onSessionReleased(android.media.tv.TvInputManager.Session session) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, "onSessionReleased()");
            }
            if (this != mSessionCallback) {
        ...
        @java.lang.Override
        public void onRecordingStopped(android.media.tv.TvInputManager.Session session, android.net.Uri recordedProgramUri) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, ("onRecordingStopped(recordedProgramUri= " + recordedProgramUri) + ")");
            }
            if (this != mSessionCallback) {
        ...
        @java.lang.Override
        public void onError(android.media.tv.TvInputManager.Session session, int error) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, ("onError(error=" + error) + ")");
            }
            if (this != mSessionCallback) {
        ...
        public void onSessionEvent(android.media.tv.TvInputManager.Session session, java.lang.String eventType, android.os.Bundle eventArgs) {
            if (android.media.tv.TvRecordingClient.DEBUG) {
                android.util.Log.d(android.media.tv.TvRecordingClient.TAG, ((("onSessionEvent(eventType=" + eventType) + ", eventArgs=") + eventArgs) + ")");
            }
            if (this != mSessionCallback) {
