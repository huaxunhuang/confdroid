 ...
 *
 *
 * @unknown A class to encapsulate information about an audio focus owner or request.
 */
...
public final class AudioFocusInfo implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public AudioFocusInfo(android.media.AudioAttributes aa, java.lang.String clientId, java.lang.String packageName, int gainRequest, int lossReceived, int flags) {
        mAttributes = (aa == null) ? new android.media.AudioAttributes.Builder().build() : aa;
    ...
    @java.lang.Override
    public int hashCode() {
        return java.util.Objects.hash(mAttributes, mClientId, mPackageName, mGainRequest, mFlags);
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        android.media.AudioFocusInfo other = ((android.media.AudioFocusInfo) (obj));
    ...
    public static final android.os.Parcelable.Creator<android.media.AudioFocusInfo> CREATOR = new android.os.Parcelable.Creator<android.media.AudioFocusInfo>() {
        public android.media.AudioFocusInfo createFromParcel(android.os.Parcel in) {
            return // AudioAttributes aa
            // String clientId
            // String packageName
            // int gainRequest
            // int lossReceived
            // int flags
            new android.media.AudioFocusInfo(android.media.AudioAttributes.CREATOR.createFromParcel(in), in.readString(), in.readString(), in.readInt(), in.readInt(), in.readInt());
        }

        public android.media.AudioFocusInfo[] newArray(int size) {
            return new android.media.AudioFocusInfo[size];
        }
    };
}
