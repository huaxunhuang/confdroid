...
public class CamcorderProfile {
    ...
    private static final int QUALITY_LIST_START = android.media.CamcorderProfile.QUALITY_LOW;

    private static final int QUALITY_LIST_END = android.media.CamcorderProfile.QUALITY_2160P;
    ...
    private static final int QUALITY_TIME_LAPSE_LIST_START = android.media.CamcorderProfile.QUALITY_TIME_LAPSE_LOW;

    private static final int QUALITY_TIME_LAPSE_LIST_END = android.media.CamcorderProfile.QUALITY_TIME_LAPSE_2160P;
    ...
    private static final int QUALITY_HIGH_SPEED_LIST_START = android.media.CamcorderProfile.QUALITY_HIGH_SPEED_LOW;

    private static final int QUALITY_HIGH_SPEED_LIST_END = android.media.CamcorderProfile.QUALITY_HIGH_SPEED_2160P;
     ...
     * @see #get(int, int)
     */
    public static android.media.CamcorderProfile get(int quality) {
        int numberOfCameras = android.hardware.Camera.getNumberOfCameras();
        android.hardware.Camera.CameraInfo cameraInfo = new android.hardware.Camera.CameraInfo();
        for (int i = 0; i < numberOfCameras; i++) {
            android.hardware.Camera.getCameraInfo(i, cameraInfo);
            if (cameraInfo.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK) {
                return android.media.CamcorderProfile.get(i, quality);
            }
        }
        return null;
    }
     ...
     */
    public static android.media.CamcorderProfile get(int cameraId, int quality) {
        if (!((((quality >= android.media.CamcorderProfile.QUALITY_LIST_START) && (quality <= android.media.CamcorderProfile.QUALITY_LIST_END)) || ((quality >= android.media.CamcorderProfile.QUALITY_TIME_LAPSE_LIST_START) && (quality <= android.media.CamcorderProfile.QUALITY_TIME_LAPSE_LIST_END))) || ((quality >= android.media.CamcorderProfile.QUALITY_HIGH_SPEED_LIST_START) && (quality <= android.media.CamcorderProfile.QUALITY_HIGH_SPEED_LIST_END)))) {
            java.lang.String errMessage = "Unsupported quality level: " + quality;
            throw new java.lang.IllegalArgumentException(errMessage);
        }
        return android.media.CamcorderProfile.native_get_camcorder_profile(cameraId, quality);
    }
    ...
    public static boolean hasProfile(int quality) {
        ...
        for (int i = 0; i < numberOfCameras; i++) {
            android.hardware.Camera.getCameraInfo(i, cameraInfo);
            if (cameraInfo.facing == android.hardware.Camera.CameraInfo.CAMERA_FACING_BACK) {
                return android.media.CamcorderProfile.hasProfile(i, quality);
            }
        }
        return false;
    }
    ...
    public static boolean hasProfile(int cameraId, int quality) {
        return android.media.CamcorderProfile.native_has_camcorder_profile(cameraId, quality);
    }
