 ...
 * <pre> {@code SecretKey key = ...; // AES key
 *
 ...
 * <pre> {@code SecretKey key = ...; // HMAC key of algorithm "HmacSHA512".
 *
 * KeyStore keyStore = KeyStore.getInstance("AndroidKeyStore");
 * keyStore.load(null);
 * keyStore.setEntry(
 ...
 * respectively.
 * <pre> {@code PrivateKey privateKey = ...;   // EC private key
 ...
 * <pre> {@code PrivateKey privateKey = ...;   // RSA private key
 * Certificate[] certChain = ...; // Certificate chain with the first certificate
...
public final class KeyProtection implements java.security.KeyStore.ProtectionParameter {
    ...
    private KeyProtection(java.util.Date keyValidityStart, java.util.Date keyValidityForOriginationEnd, java.util.Date keyValidityForConsumptionEnd, @android.security.keystore.KeyProperties.PurposeEnum
    ...
    java.lang.String[] blockModes, boolean randomizedEncryptionRequired, boolean userAuthenticationRequired, int userAuthenticationValidityDurationSeconds, boolean userAuthenticationValidWhileOnBody, boolean invalidatedByBiometricEnrollment) {
    ...
    public static final class Builder {
         ...
         * 		<p>See {@link KeyProperties}.{@code PURPOSE} flags.
         */
        public Builder(@android.security.keystore.KeyProperties.PurposeEnum
        int purposes) {
            mPurposes = purposes;
        }
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setKeyValidityStart(java.util.Date startDate) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setKeyValidityForOriginationEnd(java.util.Date endDate) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setKeyValidityForConsumptionEnd(java.util.Date endDate) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setEncryptionPaddings(@android.security.keystore.KeyProperties.EncryptionPaddingEnum
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setSignaturePaddings(@android.security.keystore.KeyProperties.SignaturePaddingEnum
        java.lang.String... paddings) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setDigests(@android.security.keystore.KeyProperties.DigestEnum
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setBlockModes(@android.security.keystore.KeyProperties.BlockModeEnum
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setRandomizedEncryptionRequired(boolean required) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setUserAuthenticationRequired(boolean required) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setUserAuthenticationValidityDurationSeconds(@android.annotation.IntRange(from = -1)
        int seconds) {
            if (seconds < (-1)) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setUserAuthenticationValidWhileOnBody(boolean remainsValid) {
         ...
         */
        @android.annotation.NonNull
        public android.security.keystore.KeyProtection.Builder setInvalidatedByBiometricEnrollment(boolean invalidateKey) {
        ...
        public android.security.keystore.KeyProtection build() {
            return new android.security.keystore.KeyProtection(mKeyValidityStart, mKeyValidityForOriginationEnd, mKeyValidityForConsumptionEnd, mPurposes, mEncryptionPaddings, mSignaturePaddings, mDigests, mBlockModes, mRandomizedEncryptionRequired, mUserAuthenticationRequired, mUserAuthenticationValidityDurationSeconds, mUserAuthenticationValidWhileOnBody, mInvalidatedByBiometricEnrollment);
        }
    }
}
