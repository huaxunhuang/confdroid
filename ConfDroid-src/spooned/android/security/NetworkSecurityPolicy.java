...
import static libcore.net.NetworkSecurityPolicy.getInstance;
...
public class NetworkSecurityPolicy {
    ...
    public static android.security.NetworkSecurityPolicy getInstance() {
        return android.security.NetworkSecurityPolicy.INSTANCE;
    }
    ...
    public boolean isCleartextTrafficPermitted(java.lang.String hostname) {
        return getInstance().isCleartextTrafficPermitted(hostname);
    }
    ...
    public void setCleartextTrafficPermitted(boolean permitted) {
        android.security.FrameworkNetworkSecurityPolicy policy = new android.security.FrameworkNetworkSecurityPolicy(permitted);
    ...
    public void handleTrustStorageUpdate() {
        android.security.net.config.ApplicationConfig.getDefaultInstance().handleTrustStorageUpdate();
    }
     ...
     * @unknown 
     */
    public static android.security.net.config.ApplicationConfig getApplicationConfigForPackage(android.content.Context context, java.lang.String packageName) throws android.content.pm.PackageManager.NameNotFoundException {
        android.content.Context appContext = context.createPackageContext(packageName, 0);
        android.security.net.config.ManifestConfigSource source = new android.security.net.config.ManifestConfigSource(appContext);
        return new android.security.net.config.ApplicationConfig(source);
    }
}
