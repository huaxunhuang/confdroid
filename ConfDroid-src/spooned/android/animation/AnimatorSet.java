...
public final class AnimatorSet extends android.animation.Animator {
     ...
     */
    private java.util.ArrayList<android.animation.Animator> mPlayingSet = new java.util.ArrayList<android.animation.Animator>();
     ...
     */
    private android.util.ArrayMap<android.animation.Animator, android.animation.AnimatorSet.Node> mNodeMap = new android.util.ArrayMap<android.animation.Animator, android.animation.AnimatorSet.Node>();
     ...
     */
    private java.util.ArrayList<android.animation.AnimatorSet.Node> mNodes = new java.util.ArrayList<android.animation.AnimatorSet.Node>();
     ...
     */
    private android.animation.AnimatorSet.AnimatorSetListener mSetListener = new android.animation.AnimatorSet.AnimatorSetListener(this);
    ...
    private android.animation.ValueAnimator mDelayAnim = android.animation.ValueAnimator.ofFloat(0.0F, 1.0F).setDuration(0);
    ...
    // same time.
    private android.animation.AnimatorSet.Node mRootNode = new android.animation.AnimatorSet.Node(mDelayAnim);
    ...
    public AnimatorSet() {
        ...
        if ((app == null) || (app.getApplicationInfo() == null)) {
            ...
            if (app.getApplicationInfo().targetSdkVersion < android.os.Build.VERSION_CODES.N) {
                mShouldIgnoreEndWithoutStart = true;
            } else {
    ...
    public void playTogether(android.animation.Animator... items) {
        if (items != null) {
            android.animation.AnimatorSet.Builder builder = play(items[0]);
    ...
    public void playTogether(java.util.Collection<android.animation.Animator> items) {
        if ((items != null) && (items.size() > 0)) {
            ...
            for (android.animation.Animator anim : items) {
                if (builder == null) {
                    builder = play(anim);
                } else {
                    builder.with(anim);
    ...
    public java.util.ArrayList<android.animation.Animator> getChildAnimations() {
        java.util.ArrayList<android.animation.Animator> childList = new java.util.ArrayList<android.animation.Animator>();
        int size = mNodes.size();
        for (int i = 0; i < size; i++) {
            android.animation.AnimatorSet.Node node = mNodes.get(i);
            if (node != mRootNode) {
    ...
    public void setTarget(java.lang.Object target) {
        ...
        for (int i = 0; i < size; i++) {
            android.animation.AnimatorSet.Node node = mNodes.get(i);
            android.animation.Animator animation = node.mAnimation;
            if (animation instanceof android.animation.AnimatorSet) {
                ((android.animation.AnimatorSet) (animation)).setTarget(target);
            } else
                if (animation instanceof android.animation.ObjectAnimator) {
                    ((android.animation.ObjectAnimator) (animation)).setTarget(target);
                }
    ...
    public android.animation.AnimatorSet.Builder play(android.animation.Animator anim) {
        if (anim != null) {
            return new android.animation.AnimatorSet.Builder(anim);
        }
        return null;
    }
    ...
    public void cancel() {
        mTerminated = true;
        if (isStarted()) {
            java.util.ArrayList<android.animation.Animator.AnimatorListener> tmpListeners = null;
            if (mListeners != null) {
                tmpListeners = ((java.util.ArrayList<android.animation.Animator.AnimatorListener>) (mListeners.clone()));
                int size = tmpListeners.size();
                for (int i = 0; i < size; i++) {
                    tmpListeners.get(i).onAnimationCancel(this);
                }
            }
            java.util.ArrayList<android.animation.Animator> playingSet = new java.util.ArrayList<>(mPlayingSet);
    ...
    public void end() {
        ...
        if (mListeners != null) {
            java.util.ArrayList<android.animation.Animator.AnimatorListener> tmpListeners = ((java.util.ArrayList<android.animation.Animator.AnimatorListener>) (mListeners.clone()));
    ...
    private void endRemainingAnimations() {
        java.util.ArrayList<android.animation.Animator> remainingList = new java.util.ArrayList<android.animation.Animator>(mNodes.size());
        remainingList.addAll(mPlayingSet);
        int index = 0;
        while (index < remainingList.size()) {
            android.animation.Animator anim = remainingList.get(index);
            anim.end();
            index++;
            android.animation.AnimatorSet.Node node = mNodeMap.get(anim);
            if (node.mChildNodes != null) {
                int childSize = node.mChildNodes.size();
                for (int i = 0; i < childSize; i++) {
                    android.animation.AnimatorSet.Node child = node.mChildNodes.get(i);
    ...
    public void setStartDelay(long startDelay) {
        ...
        if (startDelay < 0) {
            android.util.Log.w(android.animation.AnimatorSet.TAG, "Start delay should always be non-negative");
            startDelay = 0;
        }
        ...
        if (!mDependencyDirty) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (node == mRootNode) {
                    ...
                    node.mStartTime = (node.mStartTime == android.animation.Animator.DURATION_INFINITE) ? android.animation.Animator.DURATION_INFINITE : node.mStartTime + delta;
                    node.mEndTime = (node.mEndTime == android.animation.Animator.DURATION_INFINITE) ? android.animation.Animator.DURATION_INFINITE : node.mEndTime + delta;
                }
            }
            // Update total duration, if necessary.
            if (mTotalDuration != android.animation.Animator.DURATION_INFINITE) {
    ...
    void start(final android.animation.AnimatorSet.Node node) {
        final android.animation.Animator anim = node.mAnimation;
    ...
    public android.animation.AnimatorSet clone() {
        final android.animation.AnimatorSet anim = ((android.animation.AnimatorSet) (super.clone()));
        ...
        anim.mStarted = false;
        anim.mPlayingSet = new java.util.ArrayList<android.animation.Animator>();
        anim.mNodeMap = new android.util.ArrayMap<android.animation.Animator, android.animation.AnimatorSet.Node>();
        anim.mNodes = new java.util.ArrayList<android.animation.AnimatorSet.Node>(nodeCount);
        anim.mReversible = mReversible;
        anim.mSetListener = new android.animation.AnimatorSet.AnimatorSetListener(anim);
        // Walk through the old nodes list, cloning each node and adding it to the new nodemap.
        // One problem is that the old node dependencies point to nodes in the old AnimatorSet.
        // We need to track the old/new nodes in order to reconstruct the dependencies in the clone.
        for (int n = 0; n < nodeCount; n++) {
            final android.animation.AnimatorSet.Node node = mNodes.get(n);
            android.animation.AnimatorSet.Node nodeClone = node.clone();
            node.mTmpClone = nodeClone;
            anim.mNodes.add(nodeClone);
            anim.mNodeMap.put(nodeClone.mAnimation, nodeClone);
            // clear out any listeners that were set up by the AnimatorSet
            final java.util.ArrayList<android.animation.Animator.AnimatorListener> cloneListeners = nodeClone.mAnimation.getListeners();
            if (cloneListeners != null) {
                for (int i = cloneListeners.size() - 1; i >= 0; i--) {
                    final android.animation.Animator.AnimatorListener listener = cloneListeners.get(i);
                    if (listener instanceof android.animation.AnimatorSet.AnimatorSetListener) {
        ...
        anim.mDelayAnim = ((android.animation.ValueAnimator) (anim.mRootNode.mAnimation));
    ...
    private static class AnimatorSetListener implements android.animation.Animator.AnimatorListener {
        private android.animation.AnimatorSet mAnimatorSet;

        AnimatorSetListener(android.animation.AnimatorSet animatorSet) {
        ...
        public void onAnimationCancel(android.animation.Animator animation) {
            if (!mAnimatorSet.mTerminated) {
                ...
                if (mAnimatorSet.mPlayingSet.size() == 0) {
                    java.util.ArrayList<android.animation.Animator.AnimatorListener> listeners = mAnimatorSet.mListeners;
                    if (listeners != null) {
    ...
    private void onChildAnimatorEnded(android.animation.Animator animation) {
        android.animation.AnimatorSet.Node animNode = mNodeMap.get(animation);
        animNode.mEnded = true;
        if (!mTerminated) {
            java.util.List<android.animation.AnimatorSet.Node> children = animNode.mChildNodes;
    ...
    public java.lang.String toString() {
        java.lang.String returnVal = ("AnimatorSet@" + java.lang.Integer.toHexString(hashCode())) + "{";
        int size = mNodes.size();
        for (int i = 0; i < size; i++) {
            android.animation.AnimatorSet.Node node = mNodes.get(i);
    ...
    private void printChildCount() {
        ...
        java.util.ArrayList<android.animation.AnimatorSet.Node> list = new java.util.ArrayList<>(mNodes.size());
        list.add(mRootNode);
        android.util.Log.d(android.animation.AnimatorSet.TAG, "Current tree: ");
        int index = 0;
        while (index < list.size()) {
            int listSize = list.size();
            java.lang.StringBuilder builder = new java.lang.StringBuilder();
            for (; index < listSize; index++) {
                android.animation.AnimatorSet.Node node = list.get(index);
                int num = 0;
                if (node.mChildNodes != null) {
            ...
            android.util.Log.d(android.animation.AnimatorSet.TAG, builder.toString());
        } 
    }
    ...
    private void createDependencyGraph() {
        if (!mDependencyDirty) {
            ...
            for (int i = 0; i < mNodes.size(); i++) {
                android.animation.Animator anim = mNodes.get(i).mAnimation;
        ...
        for (int i = 0; i < size; i++) {
            ...
            for (int j = 0; j < siblingSize; j++) {
                android.animation.AnimatorSet.Node sibling = node.mSiblings.get(j);
        ...
        java.util.ArrayList<android.animation.AnimatorSet.Node> visited = new java.util.ArrayList<android.animation.AnimatorSet.Node>(mNodes.size());
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (node.mEndTime == android.animation.Animator.DURATION_INFINITE) {
                maxEndTime = android.animation.Animator.DURATION_INFINITE;
                break;
            } else {
     ...
     */
    private void updatePlayTime(android.animation.AnimatorSet.Node parent, java.util.ArrayList<android.animation.AnimatorSet.Node> visited) {
        if (parent.mChildNodes == null) {
            if (parent == mRootNode) {
                ...
                for (int i = 0; i < mNodes.size(); i++) {
                    android.animation.AnimatorSet.Node node = mNodes.get(i);
                    if (node != mRootNode) {
                        node.mStartTime = android.animation.Animator.DURATION_INFINITE;
                        node.mEndTime = android.animation.Animator.DURATION_INFINITE;
                    }
                }
            }
            return;
        ...
        for (int i = 0; i < childrenSize; i++) {
            android.animation.AnimatorSet.Node child = parent.mChildNodes.get(i);
            ...
            if (index >= 0) {
                ...
                for (int j = index; j < visited.size(); j++) {
                    ...
                    visited.get(j).mStartTime = android.animation.Animator.DURATION_INFINITE;
                    visited.get(j).mEndTime = android.animation.Animator.DURATION_INFINITE;
                }
                child.mStartTime = android.animation.Animator.DURATION_INFINITE;
                child.mEndTime = android.animation.Animator.DURATION_INFINITE;
                child.mLatestParent = null;
                android.util.Log.w(android.animation.AnimatorSet.TAG, "Cycle found in AnimatorSet: " + this);
                continue;
            }
            if (child.mStartTime != android.animation.Animator.DURATION_INFINITE) {
                if (parent.mEndTime == android.animation.Animator.DURATION_INFINITE) {
                    ...
                    child.mEndTime = (duration == android.animation.Animator.DURATION_INFINITE) ? android.animation.Animator.DURATION_INFINITE : child.mStartTime + duration;
                }
            }
    ...
    private void findSiblings(android.animation.AnimatorSet.Node node, java.util.ArrayList<android.animation.AnimatorSet.Node> siblings) {
     ...
     *
     *
     * @unknown TODO: For animatorSet defined in XML, we can use a flag to indicate what the play order
    ...
    private android.animation.AnimatorSet.Node getNodeForAnimation(android.animation.Animator anim) {
        android.animation.AnimatorSet.Node node = mNodeMap.get(anim);
        if (node == null) {
            node = new android.animation.AnimatorSet.Node(anim);
    ...
    private static class Node implements java.lang.Cloneable {
         ...
         */
        private android.animation.AnimatorSet.Node mTmpClone = null;
        ...
        public android.animation.AnimatorSet.Node clone() {
            try {
                ...
                if (mChildNodes != null) {
                    node.mChildNodes = new java.util.ArrayList<>(mChildNodes);
                }
                if (mSiblings != null) {
                    node.mSiblings = new java.util.ArrayList<>(mSiblings);
                }
                if (mParents != null) {
                    node.mParents = new java.util.ArrayList<>(mParents);
                }
                node.mEnded = false;
                return node;
        ...
        void addChild(android.animation.AnimatorSet.Node node) {
            if (mChildNodes == null) {
                mChildNodes = new java.util.ArrayList<>();
            }
        ...
        public void addSibling(android.animation.AnimatorSet.Node node) {
            if (mSiblings == null) {
                mSiblings = new java.util.ArrayList<android.animation.AnimatorSet.Node>();
            }
        ...
        public void addParent(android.animation.AnimatorSet.Node node) {
            if (mParents == null) {
                mParents = new java.util.ArrayList<android.animation.AnimatorSet.Node>();
            }
        ...
        public void addParents(java.util.ArrayList<android.animation.AnimatorSet.Node> parents) {
            if (parents == null) {
                return;
            }
     ...
     * intention of the <code>Builder</code> methods, along with the {@link AnimatorSet#play(Animator) play()} method of <code>AnimatorSet</code> is to make it possible
     * to express the dependency relationships of animations in a natural way. Developers can also
     * use the {@link AnimatorSet#playTogether(Animator[]) playTogether()} and {@link AnimatorSet#playSequentially(Animator[]) playSequentially()} methods if these suit the need,
     ...
     * </pre>
     * <p/>
     * <p>Note in the example that both {@link Builder#before(Animator)} and {@link Builder#after(Animator)} are used. These are just different ways of expressing the same
    ...
    public class Builder {
         ...
         */
        Builder(android.animation.Animator anim) {
            mDependencyDirty = true;
        ...
        public android.animation.AnimatorSet.Builder with(android.animation.Animator anim) {
            android.animation.AnimatorSet.Node node = getNodeForAnimation(anim);
        ...
        public android.animation.AnimatorSet.Builder after(long delay) {
            ...
            android.animation.ValueAnimator anim = android.animation.ValueAnimator.ofFloat(0.0F, 1.0F);
