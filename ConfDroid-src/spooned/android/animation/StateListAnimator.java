 ...
 * @unknown ref android.R.styleable#StateListAnimatorItem_animation
 */
public class StateListAnimator implements java.lang.Cloneable {
    private java.util.ArrayList<android.animation.StateListAnimator.Tuple> mTuples = new java.util.ArrayList<android.animation.StateListAnimator.Tuple>();
     ...
     */
    public void addState(int[] specs, android.animation.Animator animator) {
        android.animation.StateListAnimator.Tuple tuple = new android.animation.StateListAnimator.Tuple(specs, animator);
    ...
    public void setTarget(android.view.View view) {
        final android.view.View current = getTarget();
        if (current == view) {
            return;
        }
        if (current != null) {
    ...
    public android.animation.StateListAnimator clone() {
        try {
            android.animation.StateListAnimator clone = ((android.animation.StateListAnimator) (super.clone()));
            clone.mTuples = new java.util.ArrayList<android.animation.StateListAnimator.Tuple>(mTuples.size());
            ...
            for (int i = 0; i < tupleSize; i++) {
                final android.animation.StateListAnimator.Tuple tuple = mTuples.get(i);
                final android.animation.Animator animatorClone = tuple.mAnimator.clone();
    ...
    public void setState(int[] state) {
        android.animation.StateListAnimator.Tuple match = null;
        final int count = mTuples.size();
        for (int i = 0; i < count; i++) {
            final android.animation.StateListAnimator.Tuple tuple = mTuples.get(i);
            if (android.util.StateSet.stateSetMatches(tuple.mSpecs, state)) {
                match = tuple;
                break;
            }
        }
     ...
     * @unknown 
     */
    public void appendChangingConfigurations(@android.content.pm.ActivityInfo.Config
    int configs) {
        mChangingConfigurations |= configs;
    }
    ...
    public static class Tuple {
        ...
        private Tuple(int[] specs, android.animation.Animator animator) {
            mSpecs = specs;
            mAnimator = animator;
        }
    ...
    private static class StateListAnimatorConstantState extends android.content.res.ConstantState<android.animation.StateListAnimator> {
        ...
        public StateListAnimatorConstantState(android.animation.StateListAnimator animator) {
            mAnimator = animator;
        ...
        public android.animation.StateListAnimator newInstance() {
            final android.animation.StateListAnimator clone = mAnimator.clone();
