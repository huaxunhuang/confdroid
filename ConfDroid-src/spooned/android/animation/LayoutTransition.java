...
public class LayoutTransition {
     ...
     * mTransitionTypes.
     */
    private static final int FLAG_APPEARING = 0x1;

    private static final int FLAG_DISAPPEARING = 0x2;

    private static final int FLAG_CHANGE_APPEARING = 0x4;

    private static final int FLAG_CHANGE_DISAPPEARING = 0x8;
    ...
    private android.animation.Animator mChangingAnim = null;
     ...
     */
    private long mChangingAppearingDuration = android.animation.LayoutTransition.DEFAULT_DURATION;

    private long mChangingDisappearingDuration = android.animation.LayoutTransition.DEFAULT_DURATION;

    private long mChangingDuration = android.animation.LayoutTransition.DEFAULT_DURATION;

    private long mAppearingDuration = android.animation.LayoutTransition.DEFAULT_DURATION;

    private long mDisappearingDuration = android.animation.LayoutTransition.DEFAULT_DURATION;
     ...
     */
    private long mAppearingDelay = android.animation.LayoutTransition.DEFAULT_DURATION;

    private long mDisappearingDelay = 0;

    private long mChangingAppearingDelay = 0;

    private long mChangingDisappearingDelay = android.animation.LayoutTransition.DEFAULT_DURATION;
    ...
    private static android.animation.TimeInterpolator sAppearingInterpolator = android.animation.LayoutTransition.ACCEL_DECEL_INTERPOLATOR;

    private static android.animation.TimeInterpolator sDisappearingInterpolator = android.animation.LayoutTransition.ACCEL_DECEL_INTERPOLATOR;

    private static android.animation.TimeInterpolator sChangingAppearingInterpolator = android.animation.LayoutTransition.DECEL_INTERPOLATOR;

    private static android.animation.TimeInterpolator sChangingDisappearingInterpolator = android.animation.LayoutTransition.DECEL_INTERPOLATOR;

    private static android.animation.TimeInterpolator sChangingInterpolator = android.animation.LayoutTransition.DECEL_INTERPOLATOR;

    /**
     * The default interpolators used for the animations
     */
    private android.animation.TimeInterpolator mAppearingInterpolator = android.animation.LayoutTransition.sAppearingInterpolator;

    private android.animation.TimeInterpolator mDisappearingInterpolator = android.animation.LayoutTransition.sDisappearingInterpolator;

    private android.animation.TimeInterpolator mChangingAppearingInterpolator = android.animation.LayoutTransition.sChangingAppearingInterpolator;

    private android.animation.TimeInterpolator mChangingDisappearingInterpolator = android.animation.LayoutTransition.sChangingDisappearingInterpolator;

    private android.animation.TimeInterpolator mChangingInterpolator = android.animation.LayoutTransition.sChangingInterpolator;
     ...
     */
    private final java.util.HashMap<android.view.View, android.animation.Animator> pendingAnimations = new java.util.HashMap<android.view.View, android.animation.Animator>();

    private final java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentChangingAnimations = new java.util.LinkedHashMap<android.view.View, android.animation.Animator>();

    private final java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentAppearingAnimations = new java.util.LinkedHashMap<android.view.View, android.animation.Animator>();

    private final java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentDisappearingAnimations = new java.util.LinkedHashMap<android.view.View, android.animation.Animator>();
     ...
     */
    private final java.util.HashMap<android.view.View, android.view.View.OnLayoutChangeListener> layoutChangeListenerMap = new java.util.HashMap<android.view.View, android.view.View.OnLayoutChangeListener>();
     ...
     */
    private int mTransitionTypes = ((android.animation.LayoutTransition.FLAG_CHANGE_APPEARING | android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING) | android.animation.LayoutTransition.FLAG_APPEARING) | android.animation.LayoutTransition.FLAG_DISAPPEARING;
    ...
    public LayoutTransition() {
        if (android.animation.LayoutTransition.defaultChangeIn == null) {
            // "left" is just a placeholder; we'll put real properties/values in when needed
            android.animation.PropertyValuesHolder pvhLeft = android.animation.PropertyValuesHolder.ofInt("left", 0, 1);
            android.animation.PropertyValuesHolder pvhTop = android.animation.PropertyValuesHolder.ofInt("top", 0, 1);
            android.animation.PropertyValuesHolder pvhRight = android.animation.PropertyValuesHolder.ofInt("right", 0, 1);
            android.animation.PropertyValuesHolder pvhBottom = android.animation.PropertyValuesHolder.ofInt("bottom", 0, 1);
            android.animation.PropertyValuesHolder pvhScrollX = android.animation.PropertyValuesHolder.ofInt("scrollX", 0, 1);
            android.animation.PropertyValuesHolder pvhScrollY = android.animation.PropertyValuesHolder.ofInt("scrollY", 0, 1);
            android.animation.LayoutTransition.defaultChangeIn = android.animation.ObjectAnimator.ofPropertyValuesHolder(((java.lang.Object) (null)), pvhLeft, pvhTop, pvhRight, pvhBottom, pvhScrollX, pvhScrollY);
            android.animation.LayoutTransition.defaultChangeIn.setDuration(android.animation.LayoutTransition.DEFAULT_DURATION);
            android.animation.LayoutTransition.defaultChangeIn.setStartDelay(mChangingAppearingDelay);
            android.animation.LayoutTransition.defaultChangeIn.setInterpolator(mChangingAppearingInterpolator);
            android.animation.LayoutTransition.defaultChangeOut = android.animation.LayoutTransition.defaultChangeIn.clone();
            android.animation.LayoutTransition.defaultChangeOut.setStartDelay(mChangingDisappearingDelay);
            android.animation.LayoutTransition.defaultChangeOut.setInterpolator(mChangingDisappearingInterpolator);
            android.animation.LayoutTransition.defaultChange = android.animation.LayoutTransition.defaultChangeIn.clone();
            android.animation.LayoutTransition.defaultChange.setStartDelay(mChangingDelay);
            android.animation.LayoutTransition.defaultChange.setInterpolator(mChangingInterpolator);
            android.animation.LayoutTransition.defaultFadeIn = android.animation.ObjectAnimator.ofFloat(null, "alpha", 0.0F, 1.0F);
            android.animation.LayoutTransition.defaultFadeIn.setDuration(android.animation.LayoutTransition.DEFAULT_DURATION);
            android.animation.LayoutTransition.defaultFadeIn.setStartDelay(mAppearingDelay);
            android.animation.LayoutTransition.defaultFadeIn.setInterpolator(mAppearingInterpolator);
            android.animation.LayoutTransition.defaultFadeOut = android.animation.ObjectAnimator.ofFloat(null, "alpha", 1.0F, 0.0F);
            android.animation.LayoutTransition.defaultFadeOut.setDuration(android.animation.LayoutTransition.DEFAULT_DURATION);
            android.animation.LayoutTransition.defaultFadeOut.setStartDelay(mDisappearingDelay);
            android.animation.LayoutTransition.defaultFadeOut.setInterpolator(mDisappearingInterpolator);
        }
        mChangingAppearingAnim = android.animation.LayoutTransition.defaultChangeIn;
        mChangingDisappearingAnim = android.animation.LayoutTransition.defaultChangeOut;
        mChangingAnim = android.animation.LayoutTransition.defaultChange;
        mAppearingAnim = android.animation.LayoutTransition.defaultFadeIn;
        mDisappearingAnim = android.animation.LayoutTransition.defaultFadeOut;
    }
     ...
     * 		One of {@link #CHANGE_APPEARING}, {@link #CHANGE_DISAPPEARING},
     * 		{@link #CHANGING}, {@link #APPEARING}, or {@link #DISAPPEARING}.
     */
    public void enableTransitionType(int transitionType) {
        switch (transitionType) {
            case android.animation.LayoutTransition.APPEARING :
                mTransitionTypes |= android.animation.LayoutTransition.FLAG_APPEARING;
                break;
            case android.animation.LayoutTransition.DISAPPEARING :
                mTransitionTypes |= android.animation.LayoutTransition.FLAG_DISAPPEARING;
                break;
            case android.animation.LayoutTransition.CHANGE_APPEARING :
                mTransitionTypes |= android.animation.LayoutTransition.FLAG_CHANGE_APPEARING;
                break;
            case android.animation.LayoutTransition.CHANGE_DISAPPEARING :
                mTransitionTypes |= android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING;
                break;
            case android.animation.LayoutTransition.CHANGING :
                mTransitionTypes |= android.animation.LayoutTransition.FLAG_CHANGING;
                break;
        }
    }
    ...
    public boolean isTransitionTypeEnabled(int transitionType) {
        switch (transitionType) {
            case android.animation.LayoutTransition.APPEARING :
                return (mTransitionTypes & android.animation.LayoutTransition.FLAG_APPEARING) == android.animation.LayoutTransition.FLAG_APPEARING;
            case android.animation.LayoutTransition.DISAPPEARING :
                return (mTransitionTypes & android.animation.LayoutTransition.FLAG_DISAPPEARING) == android.animation.LayoutTransition.FLAG_DISAPPEARING;
            case android.animation.LayoutTransition.CHANGE_APPEARING :
                return (mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_APPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_APPEARING;
            case android.animation.LayoutTransition.CHANGE_DISAPPEARING :
                return (mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING;
            case android.animation.LayoutTransition.CHANGING :
                return (mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGING) == android.animation.LayoutTransition.FLAG_CHANGING;
        }
        return false;
    }
     ...
     *
     * @param transitionType
     * 		A value of {@link #CHANGE_APPEARING}, {@link #CHANGE_DISAPPEARING}, or
     * 		{@link #CHANGING}.
     * @param duration
     ...
     *
     * @param parent
     * 		The container which is undergoing a change.
     * @param newView
     * 		The view being added to or removed from the parent. May be null if the
     * 		changeReason is CHANGING.
     * @param changeReason
     * 		A value of APPEARING, DISAPPEARING, or CHANGING, indicating whether the
     ...
     */
    private void runChangeTransition(final android.view.ViewGroup parent, android.view.View newView, final int changeReason) {
        android.animation.Animator baseAnimator = null;
        android.animation.Animator parentAnimator = null;
        final long duration;
        switch (changeReason) {
            case android.animation.LayoutTransition.APPEARING :
                baseAnimator = mChangingAppearingAnim;
                duration = mChangingAppearingDuration;
                parentAnimator = android.animation.LayoutTransition.defaultChangeIn;
                break;
            case android.animation.LayoutTransition.DISAPPEARING :
                baseAnimator = mChangingDisappearingAnim;
                duration = mChangingDisappearingDuration;
                parentAnimator = android.animation.LayoutTransition.defaultChangeOut;
                break;
            case android.animation.LayoutTransition.CHANGING :
                baseAnimator = mChangingAnim;
                duration = mChangingDuration;
                parentAnimator = android.animation.LayoutTransition.defaultChange;
                break;
            default :
                // Shouldn't reach here
                duration = 0;
        ...
        staggerDelay = 0;
        final android.view.ViewTreeObserver observer = parent.getViewTreeObserver();
        if (!observer.isAlive()) {
        ...
        if (mAnimateParentHierarchy) {
            android.view.ViewGroup tempParent = parent;
            while (tempParent != null) {
                android.view.ViewParent parentParent = tempParent.getParent();
                if (parentParent instanceof android.view.ViewGroup) {
                    setupChangeAnimation(((android.view.ViewGroup) (parentParent)), changeReason, parentAnimator, duration, tempParent);
                    tempParent = ((android.view.ViewGroup) (parentParent));
                } else {
                    tempParent = null;
                }
            } 
        ...
        // layout listeners.
        android.animation.LayoutTransition.CleanupCallback callback = new android.animation.LayoutTransition.CleanupCallback(layoutChangeListenerMap, parent);
     ...
     * hierarchy.
     */
    private void setupChangeAnimation(final android.view.ViewGroup parent, final int changeReason, android.animation.Animator baseAnimator, final long duration, final android.view.View child) {
        ...
        final android.animation.Animator anim = baseAnimator.clone();
        ...
        android.animation.Animator currentAnimation = pendingAnimations.get(child);
        ...
        android.animation.ValueAnimator pendingAnimRemover = android.animation.ValueAnimator.ofFloat(0.0F, 1.0F).setDuration(duration + 100);
        pendingAnimRemover.addListener(new android.animation.AnimatorListenerAdapter() {
            @java.lang.Override
        ...
        final android.view.View.OnLayoutChangeListener listener = new android.view.View.OnLayoutChangeListener() {
            public void onLayoutChange(android.view.View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (anim instanceof android.animation.ValueAnimator) {
                    ...
                    android.animation.PropertyValuesHolder[] oldValues = valueAnim.getValues();
                    for (int i = 0; i < oldValues.length; ++i) {
                        android.animation.PropertyValuesHolder pvh = oldValues[i];
                        if (pvh.mKeyframes instanceof android.animation.KeyframeSet) {
                            android.animation.KeyframeSet keyframeSet = ((android.animation.KeyframeSet) (pvh.mKeyframes));
                            ...
                            if (!pvh.mKeyframes.getValue(0).equals(pvh.mKeyframes.getValue(1))) {
                                valuesDiffer = true;
                            }
                ...
                switch (changeReason) {
                    case android.animation.LayoutTransition.APPEARING :
                        ...
                        if (mChangingAppearingInterpolator != android.animation.LayoutTransition.sChangingAppearingInterpolator) {
                    ...
                    case android.animation.LayoutTransition.DISAPPEARING :
                        ...
                        if (mChangingDisappearingInterpolator != android.animation.LayoutTransition.sChangingDisappearingInterpolator) {
                    ...
                    case android.animation.LayoutTransition.CHANGING :
                        ...
                        if (mChangingInterpolator != android.animation.LayoutTransition.sChangingInterpolator) {
                ...
                android.animation.Animator prevAnimation = currentChangingAnimations.get(child);
                if (prevAnimation != null) {
                    prevAnimation.cancel();
                }
                android.animation.Animator pendingAnimation = pendingAnimations.get(child);
                if (pendingAnimation != null) {
                    pendingAnimations.remove(child);
                }
                // Cache the animation in case we need to cancel it later
                currentChangingAnimations.put(child, anim);
                parent.requestTransitionStart(android.animation.LayoutTransition.this);
        ...
        anim.addListener(new android.animation.AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(android.animation.Animator animator) {
                if (hasListeners()) {
                    java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                    for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                        listener.startTransition(android.animation.LayoutTransition.this, parent, child, changeReason == android.animation.LayoutTransition.APPEARING ? android.animation.LayoutTransition.CHANGE_APPEARING : changeReason == android.animation.LayoutTransition.DISAPPEARING ? android.animation.LayoutTransition.CHANGE_DISAPPEARING : android.animation.LayoutTransition.CHANGING);
                    }
                }
            }
            ...
            public void onAnimationEnd(android.animation.Animator animator) {
                ...
                if (hasListeners()) {
                    java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                    for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                        listener.endTransition(android.animation.LayoutTransition.this, parent, child, changeReason == android.animation.LayoutTransition.APPEARING ? android.animation.LayoutTransition.CHANGE_APPEARING : changeReason == android.animation.LayoutTransition.DISAPPEARING ? android.animation.LayoutTransition.CHANGE_DISAPPEARING : android.animation.LayoutTransition.CHANGING);
                    }
                }
            }
        });
    ...
    public void startChangingAnimations() {
        java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentAnimCopy = ((java.util.LinkedHashMap<android.view.View, android.animation.Animator>) (currentChangingAnimations.clone()));
        for (android.animation.Animator anim : currentAnimCopy.values()) {
            if (anim instanceof android.animation.ObjectAnimator) {
                ((android.animation.ObjectAnimator) (anim)).setCurrentPlayTime(0);
            }
            anim.start();
        }
    }
    ...
    public boolean isRunning() {
        return ((currentChangingAnimations.size() > 0) || (currentAppearingAnimations.size() > 0)) || (currentDisappearingAnimations.size() > 0);
    }
    ...
    public void cancel() {
        ...
        if (currentAppearingAnimations.size() > 0) {
            java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentAnimCopy = ((java.util.LinkedHashMap<android.view.View, android.animation.Animator>) (currentAppearingAnimations.clone()));
            for (android.animation.Animator anim : currentAnimCopy.values()) {
                anim.end();
            }
        ...
        if (currentDisappearingAnimations.size() > 0) {
            java.util.LinkedHashMap<android.view.View, android.animation.Animator> currentAnimCopy = ((java.util.LinkedHashMap<android.view.View, android.animation.Animator>) (currentDisappearingAnimations.clone()));
            for (android.animation.Animator anim : currentAnimCopy.values()) {
                anim.end();
            }
     ...
     */
    private void runAppearingTransition(final android.view.ViewGroup parent, final android.view.View child) {
        android.animation.Animator currentAnimation = currentDisappearingAnimations.get(child);
        if (currentAnimation != null) {
            currentAnimation.cancel();
        }
        if (mAppearingAnim == null) {
            if (hasListeners()) {
                java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                    listener.endTransition(this, parent, child, android.animation.LayoutTransition.APPEARING);
                }
            }
            return;
        }
        android.animation.Animator anim = mAppearingAnim.clone();
        anim.setTarget(child);
        anim.setStartDelay(mAppearingDelay);
        anim.setDuration(mAppearingDuration);
        if (mAppearingInterpolator != android.animation.LayoutTransition.sAppearingInterpolator) {
        ...
        anim.addListener(new android.animation.AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(android.animation.Animator anim) {
                ...
                if (hasListeners()) {
                    java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                    for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                        listener.endTransition(android.animation.LayoutTransition.this, parent, child, android.animation.LayoutTransition.APPEARING);
                    }
                }
            }
        });
     ...
     */
    private void runDisappearingTransition(final android.view.ViewGroup parent, final android.view.View child) {
        android.animation.Animator currentAnimation = currentAppearingAnimations.get(child);
        if (currentAnimation != null) {
            currentAnimation.cancel();
        }
        if (mDisappearingAnim == null) {
            if (hasListeners()) {
                java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                    listener.endTransition(this, parent, child, android.animation.LayoutTransition.DISAPPEARING);
                }
            }
            return;
        }
        android.animation.Animator anim = mDisappearingAnim.clone();
        anim.setStartDelay(mDisappearingDelay);
        anim.setDuration(mDisappearingDuration);
        if (mDisappearingInterpolator != android.animation.LayoutTransition.sDisappearingInterpolator) {
        ...
        anim.addListener(new android.animation.AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(android.animation.Animator anim) {
                ...
                if (hasListeners()) {
                    java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
                    for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                        listener.endTransition(android.animation.LayoutTransition.this, parent, child, android.animation.LayoutTransition.DISAPPEARING);
                    }
                }
            }
        });
     ...
     * 		The View being added to the ViewGroup.
     * @param changesLayout
     * 		Whether the removal will cause changes in the layout of other views
     ...
     */
    private void addChild(android.view.ViewGroup parent, android.view.View child, boolean changesLayout) {
        if (parent.getWindowVisibility() != android.view.View.VISIBLE) {
            return;
        }
        if ((mTransitionTypes & android.animation.LayoutTransition.FLAG_APPEARING) == android.animation.LayoutTransition.FLAG_APPEARING) {
            // Want disappearing animations to finish up before proceeding
            cancel(android.animation.LayoutTransition.DISAPPEARING);
        }
        if (changesLayout && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_APPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_APPEARING)) {
            // Also, cancel changing animations so that we start fresh ones from current locations
            cancel(android.animation.LayoutTransition.CHANGE_APPEARING);
            cancel(android.animation.LayoutTransition.CHANGING);
        }
        if (hasListeners() && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_APPEARING) == android.animation.LayoutTransition.FLAG_APPEARING)) {
            java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
            for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                listener.startTransition(this, parent, child, android.animation.LayoutTransition.APPEARING);
            }
        }
        if (changesLayout && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_APPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_APPEARING)) {
            runChangeTransition(parent, child, android.animation.LayoutTransition.APPEARING);
        }
        if ((mTransitionTypes & android.animation.LayoutTransition.FLAG_APPEARING) == android.animation.LayoutTransition.FLAG_APPEARING) {
     ...
     *
     * @param parent
     * 		The ViewGroup whose layout() method has been called.
     * @unknown 
     */
    public void layoutChange(android.view.ViewGroup parent) {
        ...
        if (((mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGING) == android.animation.LayoutTransition.FLAG_CHANGING) && (!isRunning())) {
            ...
            runChangeTransition(parent, null, android.animation.LayoutTransition.CHANGING);
        }
    }
     ...
     * 		The View being added to the ViewGroup.
     */
    public void addChild(android.view.ViewGroup parent, android.view.View child) {
    ...
    public void showChild(android.view.ViewGroup parent, android.view.View child) {
        addChild(parent, child, true);
    }
     ...
     */
    public void showChild(android.view.ViewGroup parent, android.view.View child, int oldVisibility) {
        addChild(parent, child, oldVisibility == android.view.View.GONE);
    }
     ...
     * 		affect CHANGE_APPEARING or CHANGE_DISAPPEARING animations.
     */
    private void removeChild(android.view.ViewGroup parent, android.view.View child, boolean changesLayout) {
        if (parent.getWindowVisibility() != android.view.View.VISIBLE) {
            return;
        }
        if ((mTransitionTypes & android.animation.LayoutTransition.FLAG_DISAPPEARING) == android.animation.LayoutTransition.FLAG_DISAPPEARING) {
            // Want appearing animations to finish up before proceeding
            cancel(android.animation.LayoutTransition.APPEARING);
        }
        if (changesLayout && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING)) {
            // Also, cancel changing animations so that we start fresh ones from current locations
            cancel(android.animation.LayoutTransition.CHANGE_DISAPPEARING);
            cancel(android.animation.LayoutTransition.CHANGING);
        }
        if (hasListeners() && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_DISAPPEARING) == android.animation.LayoutTransition.FLAG_DISAPPEARING)) {
            java.util.ArrayList<android.animation.LayoutTransition.TransitionListener> listeners = ((java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>) (mListeners.clone()));
            for (android.animation.LayoutTransition.TransitionListener listener : listeners) {
                listener.startTransition(this, parent, child, android.animation.LayoutTransition.DISAPPEARING);
            }
        }
        if (changesLayout && ((mTransitionTypes & android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING) == android.animation.LayoutTransition.FLAG_CHANGE_DISAPPEARING)) {
            runChangeTransition(parent, child, android.animation.LayoutTransition.DISAPPEARING);
        }
        if ((mTransitionTypes & android.animation.LayoutTransition.FLAG_DISAPPEARING) == android.animation.LayoutTransition.FLAG_DISAPPEARING) {
     ...
     * 		The View being removed from the ViewGroup.
     */
    public void removeChild(android.view.ViewGroup parent, android.view.View child) {
     ...
     */
    @java.lang.Deprecated
    public void hideChild(android.view.ViewGroup parent, android.view.View child) {
        removeChild(parent, child, true);
    }
     ...
     * 		{@link View#GONE} or {@link View#INVISIBLE}.
     */
    public void hideChild(android.view.ViewGroup parent, android.view.View child, int newVisibility) {
        removeChild(parent, child, newVisibility == android.view.View.GONE);
    }
    ...
    public void addTransitionListener(android.animation.LayoutTransition.TransitionListener listener) {
        if (mListeners == null) {
            mListeners = new java.util.ArrayList<android.animation.LayoutTransition.TransitionListener>();
        }
     ...
     */
    private static final class CleanupCallback implements android.view.View.OnAttachStateChangeListener , android.view.ViewTreeObserver.OnPreDrawListener {
        ...
        CleanupCallback(java.util.Map<android.view.View, android.view.View.OnLayoutChangeListener> listenerMap, android.view.ViewGroup parent) {
        ...
        private void cleanup() {
            ...
            if (count > 0) {
                java.util.Collection<android.view.View> views = layoutChangeListenerMap.keySet();
                for (android.view.View view : views) {
                    android.view.View.OnLayoutChangeListener listener = layoutChangeListenerMap.get(view);
