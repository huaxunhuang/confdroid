...
public class ValueAnimator extends android.animation.Animator implements android.animation.AnimationHandler.AnimationFrameCallback {
     ...
     */
    private int mRepeatMode = android.animation.ValueAnimator.RESTART;
     ...
     */
    private android.animation.TimeInterpolator mInterpolator = android.animation.ValueAnimator.sDefaultInterpolator;
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.animation.ValueAnimator.RESTART, android.animation.ValueAnimator.REVERSE })
    ...
    public static void setDurationScale(float durationScale) {
        android.animation.ValueAnimator.sDurationScale = durationScale;
    }
    ...
    public static float getDurationScale() {
        return android.animation.ValueAnimator.sDurationScale;
    }
     ...
     * @return A ValueAnimator object that is set up to animate between the given values.
     */
    public static android.animation.ValueAnimator ofArgb(int... values) {
        android.animation.ValueAnimator anim = new android.animation.ValueAnimator();
        anim.setIntValues(values);
        anim.setEvaluator(android.animation.ArgbEvaluator.getInstance());
        return anim;
    }
     ...
     * @return A ValueAnimator object that is set up to animate between the given values.
     */
    public static android.animation.ValueAnimator ofObject(android.animation.TypeEvaluator evaluator, java.lang.Object... values) {
        android.animation.ValueAnimator anim = new android.animation.ValueAnimator();
    ...
    public void setIntValues(int... values) {
        ...
        if ((mValues == null) || (mValues.length == 0)) {
            setValues(android.animation.PropertyValuesHolder.ofInt("", values));
        } else {
    ...
    public void setFloatValues(float... values) {
        ...
        if ((mValues == null) || (mValues.length == 0)) {
            setValues(android.animation.PropertyValuesHolder.ofFloat("", values));
        } else {
            android.animation.PropertyValuesHolder valuesHolder = mValues[0];
    ...
    public void setObjectValues(java.lang.Object... values) {
        ...
        if ((mValues == null) || (mValues.length == 0)) {
            setValues(android.animation.PropertyValuesHolder.ofObject("", null, values));
        } else {
            android.animation.PropertyValuesHolder valuesHolder = mValues[0];
    ...
    public void setValues(android.animation.PropertyValuesHolder... values) {
        ...
        mValues = values;
        mValuesMap = new java.util.HashMap<java.lang.String, android.animation.PropertyValuesHolder>(numValues);
        for (int i = 0; i < numValues; ++i) {
            android.animation.PropertyValuesHolder valuesHolder = values[i];
    ...
    private long getScaledDuration() {
        return ((long) (mDuration * android.animation.ValueAnimator.sDurationScale));
    }
    ...
    public long getTotalDuration() {
        if (mRepeatCount == android.animation.ValueAnimator.INFINITE) {
            return android.animation.Animator.DURATION_INFINITE;
        } else {
    ...
    private int getCurrentIteration(float fraction) {
        ...
        double iteration = java.lang.Math.floor(fraction);
    ...
    private float clampFraction(float fraction) {
        if (fraction < 0) {
            ...
            if (mRepeatCount != android.animation.ValueAnimator.INFINITE) {
                fraction = java.lang.Math.min(fraction, mRepeatCount + 1);
            }
    ...
    private boolean shouldPlayBackward(int iteration) {
        if (((iteration > 0) && (mRepeatMode == android.animation.ValueAnimator.REVERSE)) && ((iteration < (mRepeatCount + 1)) || (mRepeatCount == android.animation.ValueAnimator.INFINITE))) {
    ...
    public long getCurrentPlayTime() {
        ...
        float durationScale = (android.animation.ValueAnimator.sDurationScale == 0) ? 1 : android.animation.ValueAnimator.sDurationScale;
        return ((long) ((android.view.animation.AnimationUtils.currentAnimationTimeMillis() - mStartTime) / durationScale));
    }
    ...
    public void setStartDelay(long startDelay) {
        ...
        if (startDelay < 0) {
            android.util.Log.w(android.animation.ValueAnimator.TAG, "Start delay should always be non-negative");
            startDelay = 0;
        }
    ...
    public java.lang.Object getAnimatedValue(java.lang.String propertyName) {
        android.animation.PropertyValuesHolder valuesHolder = mValuesMap.get(propertyName);
     ...
     */
    public void setRepeatMode(@android.animation.ValueAnimator.RepeatMode
    int value) {
        mRepeatMode = value;
    }
    ...
    public void addUpdateListener(android.animation.ValueAnimator.AnimatorUpdateListener listener) {
        if (mUpdateListeners == null) {
            mUpdateListeners = new java.util.ArrayList<android.animation.ValueAnimator.AnimatorUpdateListener>();
        }
     ...
     *
     * @param value
     * 		the interpolator to be used by this animation. A value of <code>null</code>
    ...
    private void start(boolean playBackwards) {
        ...
        if ((playBackwards && (mSeekFraction != (-1))) && (mSeekFraction != 0)) {
            if (mRepeatCount == android.animation.ValueAnimator.INFINITE) {
                ...
                float fraction = ((float) (mSeekFraction - java.lang.Math.floor(mSeekFraction)));
        ...
        mLastFrameTime = 0;
        android.animation.AnimationHandler animationHandler = android.animation.AnimationHandler.getInstance();
        animationHandler.addAnimationFrameCallback(this, ((long) (mStartDelay * android.animation.ValueAnimator.sDurationScale)));
    ...
    public void end() {
        ...
        animateValue(shouldPlayBackward(mRepeatCount) ? 0.0F : 1.0F);
        endAnimation();
    }
    ...
    public void resume() {
        ...
        if (mPaused && (!mResumed)) {
            mResumed = true;
            if (mPauseTime > 0) {
                android.animation.AnimationHandler handler = android.animation.AnimationHandler.getInstance();
    ...
    private void endAnimation() {
        ...
        if (android.os.Trace.isTagEnabled(android.os.Trace.TRACE_TAG_VIEW)) {
            android.os.Trace.asyncTraceEnd(android.os.Trace.TRACE_TAG_VIEW, getNameForTrace(), java.lang.System.identityHashCode(this));
        }
    }
    ...
    private void startAnimation() {
        if (android.os.Trace.isTagEnabled(android.os.Trace.TRACE_TAG_VIEW)) {
            android.os.Trace.asyncTraceBegin(android.os.Trace.TRACE_TAG_VIEW, getNameForTrace(), java.lang.System.identityHashCode(this));
        }
        mAnimationEndRequested = false;
        initAnimation();
        mRunning = true;
    ...
    public void commitAnimationFrame(long frameTime) {
        if (!mStartTimeCommitted) {
            ...
            if (adjustment > 0) {
                ...
                if (android.animation.ValueAnimator.DEBUG) {
                    android.util.Log.d(android.animation.ValueAnimator.TAG, (("Adjusted start time by " + adjustment) + " ms: ") + toString());
                }
            }
        }
    }
    ...
    boolean animateBasedOnTime(long currentTime) {
        ...
        if (mRunning) {
            ...
            final float fraction = (scaledDuration > 0) ? ((float) (currentTime - mStartTime)) / scaledDuration : 1.0F;
            final float lastFraction = mOverallFraction;
            final boolean newIteration = ((int) (fraction)) > ((int) (lastFraction));
            final boolean lastIterationFinished = (fraction >= (mRepeatCount + 1)) && (mRepeatCount != android.animation.ValueAnimator.INFINITE);
            if (scaledDuration == 0) {
    ...
    public final void doAnimationFrame(long frameTime) {
        ...
        final long currentTime = java.lang.Math.max(frameTime, mStartTime);
    ...
    public android.animation.ValueAnimator clone() {
        final android.animation.ValueAnimator anim = ((android.animation.ValueAnimator) (super.clone()));
        if (mUpdateListeners != null) {
            anim.mUpdateListeners = new java.util.ArrayList<android.animation.ValueAnimator.AnimatorUpdateListener>(mUpdateListeners);
        }
        ...
        android.animation.PropertyValuesHolder[] oldValues = mValues;
        if (oldValues != null) {
            int numValues = oldValues.length;
            anim.mValues = new android.animation.PropertyValuesHolder[numValues];
            anim.mValuesMap = new java.util.HashMap<java.lang.String, android.animation.PropertyValuesHolder>(numValues);
            for (int i = 0; i < numValues; ++i) {
                android.animation.PropertyValuesHolder newValuesHolder = oldValues[i].clone();
    ...
    public java.lang.String toString() {
        java.lang.String returnVal = "ValueAnimator@" + java.lang.Integer.toHexString(hashCode());
        if (mValues != null) {
