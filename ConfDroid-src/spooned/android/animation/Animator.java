...
public abstract class Animator implements java.lang.Cloneable {
     ...
     * which the animation was started. If the animation has not yet been {@link #isStarted() started} or has since ended, then the call is ignored. Paused
    ...
    public void pause() {
        if (isStarted() && (!mPaused)) {
            ...
            if (mPauseListeners != null) {
                java.util.ArrayList<android.animation.Animator.AnimatorPauseListener> tmpListeners = ((java.util.ArrayList<android.animation.Animator.AnimatorPauseListener>) (mPauseListeners.clone()));
    ...
    public long getTotalDuration() {
        ...
        if (duration == android.animation.Animator.DURATION_INFINITE) {
    ...
    public void addPauseListener(android.animation.Animator.AnimatorPauseListener listener) {
        if (mPauseListeners == null) {
            mPauseListeners = new java.util.ArrayList<android.animation.Animator.AnimatorPauseListener>();
        }
    ...
    public android.animation.Animator clone() {
        try {
            final android.animation.Animator anim = ((android.animation.Animator) (super.clone()));
            if (mListeners != null) {
                anim.mListeners = new java.util.ArrayList<android.animation.Animator.AnimatorListener>(mListeners);
            }
            if (mPauseListeners != null) {
                anim.mPauseListeners = new java.util.ArrayList<android.animation.Animator.AnimatorPauseListener>(mPauseListeners);
            }
            return anim;
    ...
    public static interface AnimatorPauseListener {
         ...
         * @see #pause()
         */
        void onAnimationPause(android.animation.Animator animation);
         ...
         * @see #resume()
         */
        void onAnimationResume(android.animation.Animator animation);
    }
    ...
    private static class AnimatorConstantState extends android.content.res.ConstantState<android.animation.Animator> {
        ...
        public android.animation.Animator newInstance() {
            final android.animation.Animator clone = mAnimator.clone();
