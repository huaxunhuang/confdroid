...
public abstract class Keyframe implements java.lang.Cloneable {
    ...
    public static android.animation.Keyframe ofInt(float fraction, int value) {
        return new android.animation.Keyframe.IntKeyframe(fraction, value);
    }
    ...
    public static android.animation.Keyframe ofInt(float fraction) {
        return new android.animation.Keyframe.IntKeyframe(fraction);
    }
    ...
    public static android.animation.Keyframe ofFloat(float fraction, float value) {
        return new android.animation.Keyframe.FloatKeyframe(fraction, value);
    }
    ...
    public static android.animation.Keyframe ofFloat(float fraction) {
        return new android.animation.Keyframe.FloatKeyframe(fraction);
    }
    ...
    public static android.animation.Keyframe ofObject(float fraction, java.lang.Object value) {
        return new android.animation.Keyframe.ObjectKeyframe(fraction, value);
    }
    ...
    public static android.animation.Keyframe ofObject(float fraction) {
        return new android.animation.Keyframe.ObjectKeyframe(fraction, null);
    }
    ...
    static class ObjectKeyframe extends android.animation.Keyframe {
        ...
        ObjectKeyframe(float fraction, java.lang.Object value) {
            mFraction = fraction;
            mValue = value;
            mHasValue = value != null;
            mValueType = (mHasValue) ? value.getClass() : java.lang.Object.class;
        }
        ...
        public android.animation.Keyframe.ObjectKeyframe clone() {
            android.animation.Keyframe.ObjectKeyframe kfClone = new android.animation.Keyframe.ObjectKeyframe(getFraction(), hasValue() ? mValue : null);
    ...
    static class IntKeyframe extends android.animation.Keyframe {
        ...
        public void setValue(java.lang.Object value) {
            if ((value != null) && (value.getClass() == java.lang.Integer.class)) {
                mValue = ((java.lang.Integer) (value)).intValue();
                mHasValue = true;
            }
        }
        ...
        public android.animation.Keyframe.IntKeyframe clone() {
            android.animation.Keyframe.IntKeyframe kfClone = (mHasValue) ? new android.animation.Keyframe.IntKeyframe(getFraction(), mValue) : new android.animation.Keyframe.IntKeyframe(getFraction());
            kfClone.setInterpolator(getInterpolator());
            kfClone.mValueWasSetOnStart = mValueWasSetOnStart;
            return kfClone;
        }
    ...
    static class FloatKeyframe extends android.animation.Keyframe {
        ...
        public void setValue(java.lang.Object value) {
            if ((value != null) && (value.getClass() == java.lang.Float.class)) {
                mValue = ((java.lang.Float) (value)).floatValue();
                mHasValue = true;
            }
        }
        ...
        public android.animation.Keyframe.FloatKeyframe clone() {
            android.animation.Keyframe.FloatKeyframe kfClone = (mHasValue) ? new android.animation.Keyframe.FloatKeyframe(getFraction(), mValue) : new android.animation.Keyframe.FloatKeyframe(getFraction());
            kfClone.setInterpolator(getInterpolator());
            kfClone.mValueWasSetOnStart = mValueWasSetOnStart;
            return kfClone;
        }
