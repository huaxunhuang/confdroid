...
public final class DnsEvent implements android.os.Parcelable {
    ...
    private DnsEvent(android.os.Parcel in) {
    ...
    public java.lang.String toString() {
        return java.lang.String.format("DnsEvent(%d, %d events)", netId, eventTypes.length);
    }

    public static final android.os.Parcelable.Creator<android.net.metrics.DnsEvent> CREATOR = new android.os.Parcelable.Creator<android.net.metrics.DnsEvent>() {
        @java.lang.Override
        public android.net.metrics.DnsEvent createFromParcel(android.os.Parcel in) {
            return new android.net.metrics.DnsEvent(in);
        }

        @java.lang.Override
        public android.net.metrics.DnsEvent[] newArray(int size) {
            return new android.net.metrics.DnsEvent[size];
        }
    };
