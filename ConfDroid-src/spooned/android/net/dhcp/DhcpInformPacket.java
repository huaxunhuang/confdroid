 ...
 */
class DhcpInformPacket extends android.net.dhcp.DhcpPacket {
    /**
     * Generates an INFORM packet with the specified parameters.
     */
    DhcpInformPacket(int transId, short secs, java.net.Inet4Address clientIp, java.net.Inet4Address yourIp, java.net.Inet4Address nextIp, java.net.Inet4Address relayIp, byte[] clientMac) {
    ...
    void finishPacket(java.nio.ByteBuffer buffer) {
        android.net.dhcp.DhcpPacket.addTlv(buffer, android.net.dhcp.DhcpPacket.DHCP_MESSAGE_TYPE, android.net.dhcp.DhcpPacket.DHCP_MESSAGE_TYPE_INFORM);
