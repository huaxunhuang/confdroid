...
public class WifiConfiguration implements android.os.Parcelable {
     ...
     * {@hide }
     */
    public static final java.lang.String[] wepKeyVarNames = new java.lang.String[]{ "wep_key0", "wep_key1", "wep_key2", "wep_key3" };
    ...
    public static class KeyMgmt {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "NONE", "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN" };
    }
    ...
    public static class Protocol {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "WPA", "RSN", "OSEN" };
    }
    ...
    public static class AuthAlgorithm {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "OPEN", "SHARED", "LEAP" };
    }
    ...
    public static class PairwiseCipher {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "NONE", "TKIP", "CCMP" };
    }
    ...
    public static class GroupCipher {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "WEP40", "WEP104", "TKIP", "CCMP", "GTK_NOT_USED" };
    }
    ...
    public static class Status {
        ...
        public static final java.lang.String[] strings = new java.lang.String[]{ "current", "disabled", "enabled" };
    }
     ...
     * @unknown 
     */
    public int apBand = android.net.wifi.WifiConfiguration.AP_BAND_2GHZ;
     ...
     *
     *
     * @unknown This network configuration is visible to and usable by other users on the
    same device.
     */
     ...
     *
     *
     * @unknown dhcp server MAC address if known
     */
     ...
     *
     *
     * @unknown default Gateway MAC address if known
     */
     ...
     *
     *
     * @unknown last failure
     */
    public java.lang.String lastFailure;

    /**
     *
     *
     * @unknown last time we connected, this configuration had validated internet access
     */
     ...
     *
     *
     * @unknown The number of beacon intervals between Delivery Traffic Indication Maps (DTIM)
     ...
     *
     *
     * @unknown Uid of app creating the configuration
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Uid of last app issuing a connection related command
     */
     ...
     *
     *
     * @unknown Uid of last app modifying the configuration
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Universal name for app creating the configuration
     ...
     *
     *
     * @unknown Universal name for app updating the configuration
    see {#link {@link PackageManager#getNameForUid(int)}
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Status of user approval for connection
     */
    public int userApproved = android.net.wifi.WifiConfiguration.USER_UNSPECIFIED;
     ...
     *
     *
     * @unknown A summary of the RSSI and Band status for that configuration
    ...
    public static final class Visibility {
        ...
        public java.lang.String BSSID24;

        public java.lang.String BSSID5;
        ...
        public java.lang.String lastChoiceConfig;// Debug only, indicate last choice applied to this configuration


        public Visibility() {
            rssi5 = android.net.wifi.WifiConfiguration.INVALID_RSSI;
            rssi24 = android.net.wifi.WifiConfiguration.INVALID_RSSI;
        }

        public Visibility(android.net.wifi.WifiConfiguration.Visibility source) {
            rssi5 = source.rssi5;
        ...
        public java.lang.String toString() {
            ...
            sbuf.append("[");
            if (rssi24 > android.net.wifi.WifiConfiguration.INVALID_RSSI) {
                sbuf.append(java.lang.Integer.toString(rssi24));
                sbuf.append(",");
                sbuf.append(java.lang.Integer.toString(num24));
                if (BSSID24 != null)
                    sbuf.append(",").append(BSSID24);

            }
            sbuf.append("; ");
            if (rssi5 > android.net.wifi.WifiConfiguration.INVALID_RSSI) {
                sbuf.append(java.lang.Integer.toString(rssi5));
                sbuf.append(",");
                sbuf.append(java.lang.Integer.toString(num5));
                if (BSSID5 != null)
                    sbuf.append(",").append(BSSID5);
     ...
     *
     *
     * @unknown Cache the visibility status of this configuration.
    ...
    *
     ...
     *
     *
     * @unknown calculate and set Visibility for that configuration.

    age in milliseconds: we will consider only ScanResults that are more recent,
    i.e. younger.
    *
     */
    public void setVisibility(android.net.wifi.WifiConfiguration.Visibility status) {
        visibility = status;
    }
     ...
     *
     *
     * @unknown User hasn't specified if connection is okay
     */
     ...
     *
     *
     * @unknown User has approved this for connection
     */
     ...
     *
     *
     * @unknown User has banned this from connection
     */
     ...
     *
     *
     * @unknown Waiting for user input
     */
     ...
     *
     *
     * @unknown Number of reports indicating no Internet Access
     */
     ...
     *
     *
     * @unknown For debug: date at which the config was last updated
     */
     ...
     *
     *
     * @unknown The WiFi configuration is considered to have no internet access for purpose of autojoining
     ...
     *
     *
     * @unknown Last time the system was connected to this configuration.
     */
     ...
     *
     *
     * @unknown Last time the system tried to connect and failed.
     */
     ...
     *
     *
     * @unknown Last time the system tried to roam and failed because of authentication failure or DHCP
    RENEW failure.
     */
     ...
     *
     *
     * @unknown Initial amount of time this Wifi configuration gets blacklisted for network switching
     ...
     *
     *
     * @unknown Last roaming failure reason code
     */
     ...
     *
     *
     * @unknown Last time the system was disconnected to this configuration.
     */
     ...
     *
     *
     * @unknown Indicate that a WifiConfiguration is temporary and should not be saved
     ...
     *
     *
     * @unknown A hint about whether or not the network represented by this WifiConfiguration
    is metered.
     */
     ...
     *
     *
     * @unknown Setting this value will force scan results associated with this configuration to
     ...
     *
     *
     * @unknown Number of time the scorer overrode a the priority based choice, when comparing two
     ...
     *
     *
     * @unknown Number of time the scorer overrode a the priority based choice, and the comparison
     ...
     *
     *
     * @unknown Number of time we associated to this configuration.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Number of time user disabled WiFi while associated to this configuration with Low RSSI.
     */
     ...
     *
     *
     * @unknown Number of time user disabled WiFi while associated to this configuration with Bad RSSI.
     */
     ...
     *
     *
     * @unknown Number of time user disabled WiFi while associated to this configuration
     ...
     *
     *
     * @unknown Number of ticks associated to this configuration with Low RSSI.
     */
     ...
     *
     *
     * @unknown Number of ticks associated to this configuration with Bad RSSI.
     */
     ...
     *
     *
     * @unknown Number of ticks associated to this configuration
    and RSSI was not HIGH.
     */
     ...
     *
     *
     * @unknown Number of time user (WifiManager) triggered association to this configuration.
     ...
     *
     *
     * @unknown Boost given to RSSI on a home network for the purpose of calculating the score
    ...
    *
     ...
     *
     *
     * @unknown This class is used to contain all the information and API used for quality network selection
     */
    public static class NetworkSelectionStatus {
         ...
         */
        private static final java.lang.String[] QUALITY_NETWORK_SELECTION_STATUS = new java.lang.String[]{ "NETWORK_SELECTION_ENABLED", "NETWORK_SELECTION_TEMPORARY_DISABLED", "NETWORK_SELECTION_PERMANENTLY_DISABLED" };
         ...
         */
        private static final java.lang.String[] QUALITY_NETWORK_SELECTION_DISABLE_REASON = new java.lang.String[]{ "NETWORK_SELECTION_ENABLE", "NETWORK_SELECTION_DISABLED_BAD_LINK"// deprecated
         ...
         */
        private long mTemporarilyDisabledTimestamp = android.net.wifi.WifiConfiguration.NetworkSelectionStatus.INVALID_NETWORK_SELECTION_DISABLE_TIMESTAMP;

        /**
         * counter for each Network selection disable reason
         */
        private int[] mNetworkSeclectionDisableCounter = new int[android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX];
         ...
         */
        private long mConnectChoiceTimestamp = android.net.wifi.WifiConfiguration.NetworkSelectionStatus.INVALID_NETWORK_SELECTION_DISABLE_TIMESTAMP;
         ...
         */
        public void setCandidate(android.net.wifi.ScanResult scanCandidate) {
         ...
         *
         * @param newConnectChoice,
         * 		the configKey of user preferred choice over this configuration
         */
        public void setConnectChoice(java.lang.String newConnectChoice) {
        ...
        public java.lang.String getNetworkStatusString() {
            return android.net.wifi.WifiConfiguration.NetworkSelectionStatus.QUALITY_NETWORK_SELECTION_STATUS[mStatus];
        }
         ...
         */
        public static java.lang.String getNetworkDisableReasonString(int reason) {
            if ((reason >= android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLE) && (reason < android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX)) {
                return android.net.wifi.WifiConfiguration.NetworkSelectionStatus.QUALITY_NETWORK_SELECTION_DISABLE_REASON[reason];
            } else {
                return null;
            }
        }
        ...
        public java.lang.String getNetworkDisableReasonString() {
            return android.net.wifi.WifiConfiguration.NetworkSelectionStatus.QUALITY_NETWORK_SELECTION_DISABLE_REASON[mNetworkSelectionDisableReason];
        }
        ...
        public boolean isNetworkEnabled() {
            return mStatus == android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLED;
        }
        ...
        public boolean isNetworkTemporaryDisabled() {
            return mStatus == android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_TEMPORARY_DISABLED;
        }
        ...
        public boolean isNetworkPermanentlyDisabled() {
            return mStatus == android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_PERMANENTLY_DISABLED;
        }
         ...
         *
         * @param status
         * 		network selection status to set
         */
        public void setNetworkSelectionStatus(int status) {
            if ((status >= 0) && (status < android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_STATUS_MAX)) {
                mStatus = status;
            }
        }
        ...
        public void setNetworkSelectionDisableReason(int reason) {
            if ((reason >= 0) && (reason < android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX)) {
                mNetworkSelectionDisableReason = reason;
            } else {
                throw new java.lang.IllegalArgumentException("Illegal reason value: " + reason);
            }
        }
         ...
         * @exception throw
         * 		IllegalArgumentException for illegal input
         ...
         *
         * @param reason
         * 		reason for disable error
         * @param value
         * 		the counter value for this specific reason
         * @exception throw
         * 		IllegalArgumentException for illegal input
         */
        ...
        public void clearDisableReasonCounter(int reason) {
            if ((reason >= android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLE) && (reason < android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX)) {
                mNetworkSeclectionDisableCounter[reason] = android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLE;
            } else {
                throw new java.lang.IllegalArgumentException("Illegal reason value: " + reason);
            }
        }
        ...
        public void clearDisableReasonCounter() {
            java.util.Arrays.fill(mNetworkSeclectionDisableCounter, android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLE);
        }
         ...
         *
         * @param bssid
         * 		The target BSSID for assocaition
         */
        public void setNetworkSelectionBSSID(java.lang.String bssid) {
            mNetworkSelectionBSSID = bssid;
        }

        public void copy(android.net.wifi.WifiConfiguration.NetworkSelectionStatus source) {
            mStatus = source.mStatus;
            mNetworkSelectionDisableReason = source.mNetworkSelectionDisableReason;
            for (int index = android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_ENABLE; index < android.net.wifi.WifiConfiguration.NetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX; index++) {
        ...
        public void writeToParcel(android.os.Parcel dest) {
            ...
            if (getConnectChoice() != null) {
                dest.writeInt(android.net.wifi.WifiConfiguration.NetworkSelectionStatus.CONNECT_CHOICE_EXISTS);
                dest.writeString(getConnectChoice());
                dest.writeLong(getConnectChoiceTimestamp());
            } else {
                dest.writeInt(android.net.wifi.WifiConfiguration.NetworkSelectionStatus.CONNECT_CHOICE_NOT_EXISTS);
            }
        ...
        public void readFromParcel(android.os.Parcel in) {
            ...
            if (in.readInt() == android.net.wifi.WifiConfiguration.NetworkSelectionStatus.CONNECT_CHOICE_EXISTS) {
                setConnectChoice(in.readString());
                setConnectChoiceTimestamp(in.readLong());
            } else {
                setConnectChoice(null);
                setConnectChoiceTimestamp(android.net.wifi.WifiConfiguration.NetworkSelectionStatus.INVALID_NETWORK_SELECTION_DISABLE_TIMESTAMP);
            }
     ...
     *
     *
     * @unknown network selection related member
     */
    private final android.net.wifi.WifiConfiguration.NetworkSelectionStatus mNetworkSelectionStatus = new android.net.wifi.WifiConfiguration.NetworkSelectionStatus();
     ...
     *
     *
     * @unknown Linked Configurations: represent the set of Wificonfigurations that are equivalent
    ...
    public WifiConfiguration() {
        networkId = android.net.wifi.WifiConfiguration.INVALID_NETWORK_ID;
        SSID = null;
        BSSID = null;
        FQDN = null;
        ...
        priority = 0;
        hiddenSSID = false;
        allowedKeyManagement = new java.util.BitSet();
        allowedProtocols = new java.util.BitSet();
        allowedAuthAlgorithms = new java.util.BitSet();
        allowedPairwiseCiphers = new java.util.BitSet();
        allowedGroupCiphers = new java.util.BitSet();
        wepKeys = new java.lang.String[4];
        for (int i = 0; i < wepKeys.length; i++) {
            wepKeys[i] = null;
        }
        enterpriseConfig = new android.net.wifi.WifiEnterpriseConfig();
        selfAdded = false;
        didSelfAdd = false;
        ephemeral = false;
        meteredHint = false;
        ...
        mIpConfiguration = new android.net.IpConfiguration();
        lastUpdateUid = -1;
        creatorUid = -1;
        shared = true;
        dtimInterval = 0;
    ...
    public boolean isPasspoint() {
        return (((!android.text.TextUtils.isEmpty(FQDN)) && (!android.text.TextUtils.isEmpty(providerFriendlyName))) && (enterpriseConfig != null)) && (enterpriseConfig.getEapMethod() != android.net.wifi.WifiEnterpriseConfig.Eap.NONE);
    }
     ...
     * @unknown 
     */
    public boolean isLinked(android.net.wifi.WifiConfiguration config) {
        if (config != null) {
    ...
    public boolean isEnterprise() {
        return allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP) || allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X);
    }

    @java.lang.Override
    public java.lang.String toString() {
        java.lang.StringBuilder sbuf = new java.lang.StringBuilder();
        if (this.status == android.net.wifi.WifiConfiguration.Status.CURRENT) {
            sbuf.append("* ");
        } else
            if (this.status == android.net.wifi.WifiConfiguration.Status.DISABLED) {
                sbuf.append("- DSBLE ");
            }
        ...
        if (mNetworkSelectionStatus.getNetworkSelectionDisableReason() > 0) {
            ...
            for (int index = mNetworkSelectionStatus.NETWORK_SELECTION_ENABLE; index < mNetworkSelectionStatus.NETWORK_SELECTION_DISABLED_MAX; index++) {
                if (mNetworkSelectionStatus.getDisableReasonCounter(index) != 0) {
                    sbuf.append(((android.net.wifi.WifiConfiguration.NetworkSelectionStatus.getNetworkDisableReasonString(index) + " counter:") + mNetworkSelectionStatus.getDisableReasonCounter(index)) + "\n");
                }
            }
        }
        ...
        for (int k = 0; k < this.allowedKeyManagement.size(); k++) {
            if (this.allowedKeyManagement.get(k)) {
                sbuf.append(" ");
                if (k < android.net.wifi.WifiConfiguration.KeyMgmt.strings.length) {
                    sbuf.append(android.net.wifi.WifiConfiguration.KeyMgmt.strings[k]);
                } else {
                    sbuf.append("??");
                }
            }
        ...
        for (int p = 0; p < this.allowedProtocols.size(); p++) {
            if (this.allowedProtocols.get(p)) {
                sbuf.append(" ");
                if (p < android.net.wifi.WifiConfiguration.Protocol.strings.length) {
                    sbuf.append(android.net.wifi.WifiConfiguration.Protocol.strings[p]);
                } else {
                    sbuf.append("??");
                }
            }
        ...
        for (int a = 0; a < this.allowedAuthAlgorithms.size(); a++) {
            if (this.allowedAuthAlgorithms.get(a)) {
                sbuf.append(" ");
                if (a < android.net.wifi.WifiConfiguration.AuthAlgorithm.strings.length) {
                    sbuf.append(android.net.wifi.WifiConfiguration.AuthAlgorithm.strings[a]);
                } else {
                    sbuf.append("??");
                }
            }
        ...
        for (int pc = 0; pc < this.allowedPairwiseCiphers.size(); pc++) {
            if (this.allowedPairwiseCiphers.get(pc)) {
                sbuf.append(" ");
                if (pc < android.net.wifi.WifiConfiguration.PairwiseCipher.strings.length) {
                    sbuf.append(android.net.wifi.WifiConfiguration.PairwiseCipher.strings[pc]);
                } else {
                    sbuf.append("??");
                }
            }
        ...
        for (int gc = 0; gc < this.allowedGroupCiphers.size(); gc++) {
            if (this.allowedGroupCiphers.get(gc)) {
                sbuf.append(" ");
                if (gc < android.net.wifi.WifiConfiguration.GroupCipher.strings.length) {
                    sbuf.append(android.net.wifi.WifiConfiguration.GroupCipher.strings[gc]);
                } else {
                    sbuf.append("??");
                }
            }
        ...
        long now_ms = java.lang.System.currentTimeMillis();
        if (mNetworkSelectionStatus.getDisableTime() != android.net.wifi.WifiConfiguration.NetworkSelectionStatus.INVALID_NETWORK_SELECTION_DISABLE_TIMESTAMP) {
            sbuf.append('\n');
            long diff = now_ms - mNetworkSelectionStatus.getDisableTime();
            if (diff <= 0) {
                sbuf.append(" blackListed since <incorrect>");
            } else {
                sbuf.append(" blackListed: ").append(java.lang.Long.toString(diff / 1000)).append("sec ");
            }
        }
        if (creatorUid != 0)
        ...
        sbuf.append(" userApproved=" + android.net.wifi.WifiConfiguration.userApprovedAsString(userApproved));
        ...
        if (this.lastConnected != 0) {
            ...
            if (diff <= 0) {
                ...
                sbuf.append("lastConnected: ").append(java.lang.Long.toString(diff / 1000)).append("sec ");
            }
        }
        if (this.lastConnectionFailure != 0) {
            ...
            if (diff <= 0) {
                ...
                sbuf.append("lastConnectionFailure: ").append(java.lang.Long.toString(diff / 1000));
                sbuf.append("sec ");
            }
        }
        if (this.lastRoamingFailure != 0) {
            ...
            if (diff <= 0) {
                ...
                sbuf.append("lastRoamingFailure: ").append(java.lang.Long.toString(diff / 1000));
                sbuf.append("sec ");
            }
        }
        sbuf.append("roamingFailureBlackListTimeMilli: ").append(java.lang.Long.toString(this.roamingFailureBlackListTimeMilli));
        sbuf.append('\n');
        if (this.linkedConfigurations != null) {
            for (java.lang.String key : this.linkedConfigurations.keySet()) {
    ...
    public java.lang.String getPrintableSsid() {
        ...
        if ((((length > 3) && (SSID.charAt(0) == 'P')) && (SSID.charAt(1) == '"')) && (SSID.charAt(length - 1) == '"')) {
            android.net.wifi.WifiSsid wifiSsid = android.net.wifi.WifiSsid.createFromAsciiEncoded(SSID.substring(2, length - 1));
     ...
     * @unknown *
     */
    public static java.lang.String userApprovedAsString(int userApproved) {
        switch (userApproved) {
            case android.net.wifi.WifiConfiguration.USER_APPROVED :
                return "USER_APPROVED";
            case android.net.wifi.WifiConfiguration.USER_BANNED :
                return "USER_BANNED";
            case android.net.wifi.WifiConfiguration.USER_UNSPECIFIED :
     ...
     * @unknown 
     */
    public java.lang.String getKeyIdForCredentials(android.net.wifi.WifiConfiguration current) {
        java.lang.String keyMgmt = null;
        try {
            ...
            if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP)) {
                keyMgmt = android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP];
            }
            if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.OSEN)) {
                keyMgmt = android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.OSEN];
            }
            if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X)) {
                keyMgmt += android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X];
            }
            if (android.text.TextUtils.isEmpty(keyMgmt)) {
                throw new java.lang.IllegalStateException("Not an EAP network");
            }
            ...
            throw new java.lang.IllegalStateException("Invalid config details");
        }
    }

    private java.lang.String trimStringForKeyId(java.lang.String string) {
        // Remove quotes and spaces
        return string.replace("\"", "").replace(" ", "");
    }

    private static java.util.BitSet readBitSet(android.os.Parcel src) {
    ...
    public int getAuthType() {
        if (allowedKeyManagement.cardinality() > 1) {
            throw new java.lang.IllegalStateException("More than one auth type set");
        }
        if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_PSK)) {
            return android.net.wifi.WifiConfiguration.KeyMgmt.WPA_PSK;
        } else
            if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA2_PSK)) {
                return android.net.wifi.WifiConfiguration.KeyMgmt.WPA2_PSK;
            } else
                if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP)) {
                    return android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP;
                } else
                    if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X)) {
                        return android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X;
                    }



        return android.net.wifi.WifiConfiguration.KeyMgmt.NONE;
    }
     ...
     *
     *
     * @unknown return the string used to calculate the hash in WifiConfigStore
    and uniquely identify this WifiConfiguration
     */
    public java.lang.String configKey(boolean allowCached) {
        java.lang.String key;
        if (allowCached && (mCachedConfigKey != null)) {
            key = mCachedConfigKey;
        } else
            if (providerFriendlyName != null) {
                key = FQDN + android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP];
                if (!shared) {
                    key += "-" + java.lang.Integer.toString(android.os.UserHandle.getUserId(creatorUid));
                }
            } else {
                if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_PSK)) {
                    key = SSID + android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.WPA_PSK];
                } else
                    if (allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP) || allowedKeyManagement.get(android.net.wifi.WifiConfiguration.KeyMgmt.IEEE8021X)) {
                        key = SSID + android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.WPA_EAP];
                    } else
                        if (wepKeys[0] != null) {
                            key = SSID + "WEP";
                        } else {
                            key = SSID + android.net.wifi.WifiConfiguration.KeyMgmt.strings[android.net.wifi.WifiConfiguration.KeyMgmt.NONE];
                        }
     ...
     *
     *
     * @unknown get configKey, force calculating the config string
     */
     ...
     * @unknown 
     */
    public void setIpConfiguration(android.net.IpConfiguration ipConfiguration) {
     ...
     * @unknown 
     */
    public void setProxy(android.net.IpConfiguration.ProxySettings settings, android.net.ProxyInfo proxy) {
     ...
     * @unknown 
     */
    public void setPasspointManagementObjectTree(java.lang.String passpointManagementObjectTree) {
     ...
     */
    public WifiConfiguration(android.net.wifi.WifiConfiguration source) {
        if (source != null) {
            ...
            allowedKeyManagement = ((java.util.BitSet) (source.allowedKeyManagement.clone()));
            allowedProtocols = ((java.util.BitSet) (source.allowedProtocols.clone()));
            allowedAuthAlgorithms = ((java.util.BitSet) (source.allowedAuthAlgorithms.clone()));
            allowedPairwiseCiphers = ((java.util.BitSet) (source.allowedPairwiseCiphers.clone()));
            allowedGroupCiphers = ((java.util.BitSet) (source.allowedGroupCiphers.clone()));
            enterpriseConfig = new android.net.wifi.WifiEnterpriseConfig(source.enterpriseConfig);
            defaultGwMacAddress = source.defaultGwMacAddress;
            mIpConfiguration = new android.net.IpConfiguration(source.mIpConfiguration);
            if ((source.linkedConfigurations != null) && (source.linkedConfigurations.size() > 0)) {
                linkedConfigurations = new java.util.HashMap<java.lang.String, java.lang.Integer>();
            ...
            if (source.visibility != null) {
                visibility = new android.net.wifi.WifiConfiguration.Visibility(source.visibility);
            }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        for (java.lang.String wepKey : wepKeys) {
        ...
        android.net.wifi.WifiConfiguration.writeBitSet(dest, allowedKeyManagement);
        android.net.wifi.WifiConfiguration.writeBitSet(dest, allowedProtocols);
        android.net.wifi.WifiConfiguration.writeBitSet(dest, allowedAuthAlgorithms);
        android.net.wifi.WifiConfiguration.writeBitSet(dest, allowedPairwiseCiphers);
        android.net.wifi.WifiConfiguration.writeBitSet(dest, allowedGroupCiphers);
     ...
     * Implement the Parcelable interface {@hide }
     */
    public static final android.os.Parcelable.Creator<android.net.wifi.WifiConfiguration> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.WifiConfiguration>() {
        public android.net.wifi.WifiConfiguration createFromParcel(android.os.Parcel in) {
            ...
            config.allowedKeyManagement = android.net.wifi.WifiConfiguration.readBitSet(in);
            config.allowedProtocols = android.net.wifi.WifiConfiguration.readBitSet(in);
            config.allowedAuthAlgorithms = android.net.wifi.WifiConfiguration.readBitSet(in);
            config.allowedPairwiseCiphers = android.net.wifi.WifiConfiguration.readBitSet(in);
            config.allowedGroupCiphers = android.net.wifi.WifiConfiguration.readBitSet(in);
        ...
        public android.net.wifi.WifiConfiguration[] newArray(int size) {
            return new android.net.wifi.WifiConfiguration[size];
        }
    };
    ...
    public byte[] getBytesForBackup() throws java.io.IOException {
        ...
        out.writeInt(android.net.wifi.WifiConfiguration.BACKUP_VERSION);
        android.util.BackupUtils.writeString(out, SSID);
        out.writeInt(apBand);
        out.writeInt(apChannel);
        android.util.BackupUtils.writeString(out, preSharedKey);
     ...
     * @unknown 
     */
    public static android.net.wifi.WifiConfiguration getWifiConfigFromBackup(java.io.DataInputStream in) throws android.util.BackupUtils.BadVersionException, java.io.IOException {
        android.net.wifi.WifiConfiguration config = new android.net.wifi.WifiConfiguration();
        int version = in.readInt();
        if ((version < 1) || (version > android.net.wifi.WifiConfiguration.BACKUP_VERSION)) {
        ...
        config.SSID = android.util.BackupUtils.readString(in);
        config.apBand = in.readInt();
        config.apChannel = in.readInt();
        config.preSharedKey = android.util.BackupUtils.readString(in);
