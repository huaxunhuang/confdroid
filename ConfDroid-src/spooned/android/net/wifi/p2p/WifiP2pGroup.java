...
public class WifiP2pGroup implements android.os.Parcelable {
     ...
     * Group clients
     */
    private java.util.List<android.net.wifi.p2p.WifiP2pDevice> mClients = new java.util.ArrayList<android.net.wifi.p2p.WifiP2pDevice>();
     ...
     */
    private static final java.util.regex.Pattern groupStartedPattern = java.util.regex.Pattern.compile("ssid=\"(.+)\" " + (((("freq=(\\d+) " + "(?:psk=)?([0-9a-fA-F]{64})?") + "(?:passphrase=)?(?:\"(.{0,63})\")? ") + "go_dev_addr=((?:[0-9a-f]{2}:){5}[0-9a-f]{2})") + " ?(\\[PERSISTENT\\])?"));
     ...
     * @unknown 
     */
    public WifiP2pGroup(java.lang.String supplicantEvent) throws java.lang.IllegalArgumentException {
        ...
        if (tokens[0].startsWith("P2P-GROUP")) {
            ...
            java.util.regex.Matcher match = android.net.wifi.p2p.WifiP2pGroup.groupStartedPattern.matcher(supplicantEvent);
            if (!match.find()) {
                return;
            }
            ...
            mOwner = new android.net.wifi.p2p.WifiP2pDevice(match.group(5));
            if (match.group(6) != null) {
                mNetId = android.net.wifi.p2p.WifiP2pGroup.PERSISTENT_NET_ID;
            } else {
                mNetId = android.net.wifi.p2p.WifiP2pGroup.TEMPORARY_NET_ID;
            }
        } else
            if (tokens[0].equals("P2P-INVITATION-RECEIVED")) {
                java.lang.String sa = null;
                mNetId = android.net.wifi.p2p.WifiP2pGroup.PERSISTENT_NET_ID;
                for (java.lang.String token : tokens) {
                    java.lang.String[] nameValue = token.split("=");
                    ...
                    if (nameValue[0].equals("go_dev_addr")) {
                        mOwner = new android.net.wifi.p2p.WifiP2pDevice(nameValue[1]);
                        continue;
                    }
                    if (nameValue[0].equals("persistent")) {
                        mNetId = java.lang.Integer.parseInt(nameValue[1]);
                        continue;
                    }
                }
            } else {
     ...
     * @unknown 
     */
    public void setOwner(android.net.wifi.p2p.WifiP2pDevice device) {
        mOwner = device;
    }
    ...
    public void addClient(java.lang.String address) {
        addClient(new android.net.wifi.p2p.WifiP2pDevice(address));
    }
     ...
     * @unknown 
     */
    public void addClient(android.net.wifi.p2p.WifiP2pDevice device) {
        for (android.net.wifi.p2p.WifiP2pDevice client : mClients) {
    ...
    public boolean removeClient(java.lang.String address) {
        return mClients.remove(new android.net.wifi.p2p.WifiP2pDevice(address));
    }
     ...
     * @unknown 
     */
    public boolean removeClient(android.net.wifi.p2p.WifiP2pDevice device) {
     ...
     *
     *
     * @unknown Returns {@code true} if the device is part of the group
     */
    public boolean contains(android.net.wifi.p2p.WifiP2pDevice device) {
        if (mOwner.equals(device) || mClients.contains(device))
            return true;
    ...
    public java.util.Collection<android.net.wifi.p2p.WifiP2pDevice> getClientList() {
        return java.util.Collections.unmodifiableCollection(mClients);
    }
     ...
     * copy constructor
     */
    public WifiP2pGroup(android.net.wifi.p2p.WifiP2pGroup source) {
        if (source != null) {
            mNetworkName = source.getNetworkName();
            mOwner = new android.net.wifi.p2p.WifiP2pDevice(source.getOwner());
            mIsGroupOwner = source.mIsGroupOwner;
            for (android.net.wifi.p2p.WifiP2pDevice d : source.getClientList())
                mClients.add(d);
     ...
     * Implement the Parcelable interface
     */
    public static final android.os.Parcelable.Creator<android.net.wifi.p2p.WifiP2pGroup> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.p2p.WifiP2pGroup>() {
        public android.net.wifi.p2p.WifiP2pGroup createFromParcel(android.os.Parcel in) {
            android.net.wifi.p2p.WifiP2pGroup group = new android.net.wifi.p2p.WifiP2pGroup();
            group.setNetworkName(in.readString());
            group.setOwner(((android.net.wifi.p2p.WifiP2pDevice) (in.readParcelable(null))));
            group.setIsGroupOwner(in.readByte() == ((byte) (1)));
            int clientCount = in.readInt();
            for (int i = 0; i < clientCount; i++) {
                group.addClient(((android.net.wifi.p2p.WifiP2pDevice) (in.readParcelable(null))));
            }
        ...
        public android.net.wifi.p2p.WifiP2pGroup[] newArray(int size) {
            return new android.net.wifi.p2p.WifiP2pGroup[size];
        }
    };
}
