...
public class WifiP2pServiceRequest implements android.os.Parcelable {
     ...
     * @unknown 
     */
    protected WifiP2pServiceRequest(int protocolType, java.lang.String query) {
        validateQuery(query);
     ...
     * 		The part of service specific query.
     */
    private WifiP2pServiceRequest(int serviceType, int length, int transId, java.lang.String query) {
    ...
    public java.lang.String getSupplicantQuery() {
        ...
        sb.append(java.lang.String.format(java.util.Locale.US, "%02x", mLength & 0xff));
        sb.append(java.lang.String.format(java.util.Locale.US, "%02x", (mLength >> 8) & 0xff));
        sb.append(java.lang.String.format(java.util.Locale.US, "%02x", mProtocolType));
        sb.append(java.lang.String.format(java.util.Locale.US, "%02x", mTransId));
        if (mQuery != null) {
            sb.append(mQuery);
        }
        return sb.toString();
     ...
     * 		The part of service specific query.
     */
    private void validateQuery(java.lang.String query) {
        if (query == null) {
            return;
        }
        int UNSIGNED_SHORT_MAX = 0xffff;
        if ((query.length() % 2) == 1) {
            throw new java.lang.IllegalArgumentException("query size is invalid. query=" + query);
        }
        if ((query.length() / 2) > UNSIGNED_SHORT_MAX) {
            throw new java.lang.IllegalArgumentException("query size is too large. len=" + query.length());
        }
        ...
        for (char c : chars) {
            if (!(((c >= '0') && (c <= '9')) || ((c >= 'a') && (c <= 'f')))) {
                throw new java.lang.IllegalArgumentException("query should be hex string. query=" + query);
            }
        }
    }
     ...
     *
     * @param protocolType
     * 		can be {@link WifiP2pServiceInfo#SERVICE_TYPE_ALL}
     ...
     */
    public static android.net.wifi.p2p.nsd.WifiP2pServiceRequest newInstance(int protocolType, java.lang.String queryData) {
        return new android.net.wifi.p2p.nsd.WifiP2pServiceRequest(protocolType, queryData);
    }
     ...
     * @return service discovery request.
     */
    public static android.net.wifi.p2p.nsd.WifiP2pServiceRequest newInstance(int protocolType) {
        return new android.net.wifi.p2p.nsd.WifiP2pServiceRequest(protocolType, null);
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        if (!(o instanceof android.net.wifi.p2p.nsd.WifiP2pServiceRequest)) {
            return false;
        }
        android.net.wifi.p2p.nsd.WifiP2pServiceRequest req = ((android.net.wifi.p2p.nsd.WifiP2pServiceRequest) (o));
        /* Not compare transaction id.
        Transaction id may be changed on each service discovery operation.
         */
        if ((req.mProtocolType != mProtocolType) || (req.mLength != mLength)) {
            return false;
        }
     ...
     * Implement the Parcelable interface {@hide }
     */
    public static final android.os.Parcelable.Creator<android.net.wifi.p2p.nsd.WifiP2pServiceRequest> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.p2p.nsd.WifiP2pServiceRequest>() {
        public android.net.wifi.p2p.nsd.WifiP2pServiceRequest createFromParcel(android.os.Parcel in) {
            int servType = in.readInt();
            int length = in.readInt();
            int transId = in.readInt();
            java.lang.String query = in.readString();
            return new android.net.wifi.p2p.nsd.WifiP2pServiceRequest(servType, length, transId, query);
        }

        public android.net.wifi.p2p.nsd.WifiP2pServiceRequest[] newArray(int size) {
            return new android.net.wifi.p2p.nsd.WifiP2pServiceRequest[size];
        }
    };
}
