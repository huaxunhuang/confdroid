...
public class WifiManager {
     ...
     * @unknown 
     */
    public static final java.lang.String PASSPOINT_ICON_RECEIVED_ACTION = "android.net.wifi.PASSPOINT_ICON_RECEIVED";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_ICON_BSSID = "bssid";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_ICON_FILE = "file";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_ICON_DATA = "icon";
     ...
     * @unknown 
     */
    public static final java.lang.String PASSPOINT_WNM_FRAME_RECEIVED_ACTION = "android.net.wifi.PASSPOINT_WNM_FRAME_RECEIVED";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_BSSID = "bssid";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_METHOD = "method";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_PPOINT_MATCH = "match";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_URL = "url";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_ESS = "ess";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_PASSPOINT_WNM_DELAY = "delay";
     ...
     * @unknown 
     */
    public static final int DATA_ACTIVITY_INOUT = 0x3;
     ...
     * @unknown - hide this because it takes in a parameter of type IWifiManager, which
    is a system private class.
     */
    public WifiManager(android.content.Context context, android.net.wifi.IWifiManager service, android.os.Looper looper) {
        mContext = context;
        mService = service;
        mLooper = looper;
     ...
     *
     * @param scanResult
     * 		scanResult that represents the BSSID
     * @return {@link WifiConfiguration} that matches this BSSID or null
     * @unknown 
     */
    public android.net.wifi.WifiConfiguration getMatchingWifiConfig(android.net.wifi.ScanResult scanResult) {
        try {
     ...
     *
     * @param config
     * 		The possibly sparse object containing the variables that
     * 		are to set or updated in the network description.
     * @return the ID of the network on success, {@code -1} on failure.
     */
    private int addOrUpdateNetwork(android.net.wifi.WifiConfiguration config) {
        try {
     ...
     * @unknown 
     */
    public int addPasspointManagementObject(java.lang.String mo) {
        try {
     ...
     *
     * @param fqdn
     * 		The FQDN of the service provider
     * @param mos
     * 		A List of MO definitions to be updated
     * @return the number of nodes updated, or -1 for failure
     * @unknown 
     */
    public int modifyPasspointManagementObject(java.lang.String fqdn, java.util.List<android.net.wifi.PasspointManagementObjectDefinition> mos) {
        try {
     ...
     * @unknown 
     */
    public void queryPasspointIcon(long bssid, java.lang.String fileName) {
        try {
     ...
     * @unknown 
     */
    public int matchProviderWithCurrentNetwork(java.lang.String fqdn) {
        try {
    ...
    public boolean enableNetwork(int netId, boolean disableOthers) {
        final boolean pin = disableOthers && (mTargetSdkVersion < android.os.Build.VERSION_CODES.LOLLIPOP);
        if (pin) {
            android.net.NetworkRequest request = new android.net.NetworkRequest.Builder().clearCapabilities().addTransportType(android.net.NetworkCapabilities.TRANSPORT_WIFI).build();
            com.android.server.net.NetworkPinner.pin(mContext, request);
        }
        boolean success;
        try {
     ...
     *
     * @param netId
     * 		the ID of the network as returned by {@link #addNetwork}.
     * @return {@code true} if the operation succeeded
     */
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_INFRA = 0x1;// Basic infrastructure mode
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_INFRA_5G = 0x2;// Support for 5 GHz Band
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_PASSPOINT = 0x4;// Support for GAS/ANQP
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_P2P = 0x8;// Wifi-Direct
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_MOBILE_HOTSPOT = 0x10;// Soft AP
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_SCANNER = 0x20;// WifiScanner APIs
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_NAN = 0x40;// Neighbor Awareness Networking
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_D2D_RTT = 0x80;// Device-to-device RTT
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_D2AP_RTT = 0x100;// Device-to-AP RTT
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_BATCH_SCAN = 0x200;// Batched Scan (deprecated)
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_PNO = 0x400;// Preferred network offload
     ...
     * @unknown 
     */
    public static final int WIFI_FEATURE_ADDITIONAL_STA = 0x800;// Support for two STAs
    ...
    public boolean is5GHzBandSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_INFRA_5G);
    }
    ...
    public boolean isPasspointSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_PASSPOINT);
    }
    ...
    public boolean isP2pSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_P2P);
    }
    ...
    public boolean isPortableHotspotSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_MOBILE_HOTSPOT);
    }
    ...
    public boolean isWifiScannerSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_SCANNER);
    }
    ...
    public boolean isNanSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_NAN);
    }
    ...
    public boolean isDeviceToDeviceRttSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_D2D_RTT);
    }
    ...
    public boolean isDeviceToApRttSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_D2AP_RTT);
    }
    ...
    public boolean isPreferredNetworkOffloadSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_PNO);
    }
    ...
    public boolean isAdditionalStaSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_ADDITIONAL_STA);
    }
    ...
    public boolean isTdlsSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_TDLS);
    }
    ...
    public boolean isOffChannelTdlsSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_TDLS_OFFCHANNEL);
    }
    ...
    public boolean isEnhancedPowerReportingSupported() {
        return isFeatureSupported(android.net.wifi.WifiManager.WIFI_FEATURE_LINK_LAYER_STATS);
    }
     ...
     * @unknown 
     */
    public android.net.wifi.WifiActivityEnergyInfo getControllerActivityEnergyInfo(int updateType) {
        if (mService == null)
            return null;
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    public boolean startLocationRestrictedScan(android.os.WorkSource workSource) {
        return false;
    }
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    public java.util.List<android.net.wifi.BatchedScanResult> getBatchedScanResults() {
        return null;
    }
     ...
     * @param persist
     * 		{@code true} if this needs to be remembered
     * @unknown 
     */
    public void setCountryCode(java.lang.String country, boolean persist) {
        try {
    ...
    public java.lang.String getCountryCode() {
        try {
            java.lang.String country = mService.getCountryCode();
            return country;
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public boolean isWifiEnabled() {
        return getWifiState() == android.net.wifi.WifiManager.WIFI_STATE_ENABLED;
    }
     ...
     *
     * @param listener
     * 		is the interface to receive result
     * @unknown for CTS test only
     */
    public void getTxPacketCount(android.net.wifi.WifiManager.TxPacketCountListener listener) {
        getChannel().sendMessage(android.net.wifi.WifiManager.RSSI_PKTCNT_FETCH, 0, putListener(listener));
    }
    ...
    public static int calculateSignalLevel(int rssi, int numLevels) {
        if (rssi <= android.net.wifi.WifiManager.MIN_RSSI) {
            return 0;
        } else
            if (rssi >= android.net.wifi.WifiManager.MAX_RSSI) {
                return numLevels - 1;
            } else {
                float inputRange = android.net.wifi.WifiManager.MAX_RSSI - android.net.wifi.WifiManager.MIN_RSSI;
                float outputRange = numLevels - 1;
                return ((int) ((((float) (rssi - android.net.wifi.WifiManager.MIN_RSSI)) * outputRange) / inputRange));
            }
     ...
     */
    @android.annotation.SystemApi
    public boolean setWifiApEnabled(android.net.wifi.WifiConfiguration wifiConfig, boolean enabled) {
        try {
    ...
    public boolean isWifiApEnabled() {
        return getWifiApState() == android.net.wifi.WifiManager.WIFI_AP_STATE_ENABLED;
    }
     ...
     *
     * @return AP details in WifiConfiguration
     * @unknown Dont open yet
     */
    public android.net.wifi.WifiConfiguration buildWifiConfig(java.lang.String uriString, java.lang.String mimeType, byte[] data) {
        try {
     ...
     */
    @android.annotation.SystemApi
    public boolean setWifiApConfiguration(android.net.wifi.WifiConfiguration wifiConfig) {
        try {
     ...
     */
    public void setTdlsEnabled(java.net.InetAddress remoteIPAddress, boolean enable) {
        try {
     ...
     * 		true = setup and false = tear down TDLS
     */
    public void setTdlsEnabledWithMacAddress(java.lang.String remoteMacAddress, boolean enable) {
        try {
    ...
    private static final int BASE = com.android.internal.util.Protocol.BASE_WIFI_MANAGER;
     ...
     * @unknown 
     */
    public static final int CONNECT_NETWORK = android.net.wifi.WifiManager.BASE + 1;
     ...
     * @unknown 
     */
    public static final int CONNECT_NETWORK_FAILED = android.net.wifi.WifiManager.BASE + 2;
     ...
     * @unknown 
     */
    public static final int CONNECT_NETWORK_SUCCEEDED = android.net.wifi.WifiManager.BASE + 3;
     ...
     * @unknown 
     */
    public static final int FORGET_NETWORK = android.net.wifi.WifiManager.BASE + 4;
     ...
     * @unknown 
     */
    public static final int FORGET_NETWORK_FAILED = android.net.wifi.WifiManager.BASE + 5;
     ...
     * @unknown 
     */
    public static final int FORGET_NETWORK_SUCCEEDED = android.net.wifi.WifiManager.BASE + 6;
     ...
     * @unknown 
     */
    public static final int SAVE_NETWORK = android.net.wifi.WifiManager.BASE + 7;
     ...
     * @unknown 
     */
    public static final int SAVE_NETWORK_FAILED = android.net.wifi.WifiManager.BASE + 8;
     ...
     * @unknown 
     */
    public static final int SAVE_NETWORK_SUCCEEDED = android.net.wifi.WifiManager.BASE + 9;
     ...
     * @unknown 
     */
    public static final int START_WPS = android.net.wifi.WifiManager.BASE + 10;
     ...
     * @unknown 
     */
    public static final int START_WPS_SUCCEEDED = android.net.wifi.WifiManager.BASE + 11;
     ...
     * @unknown 
     */
    public static final int WPS_FAILED = android.net.wifi.WifiManager.BASE + 12;
     ...
     * @unknown 
     */
    public static final int WPS_COMPLETED = android.net.wifi.WifiManager.BASE + 13;
     ...
     * @unknown 
     */
    public static final int CANCEL_WPS = android.net.wifi.WifiManager.BASE + 14;
     ...
     * @unknown 
     */
    public static final int CANCEL_WPS_FAILED = android.net.wifi.WifiManager.BASE + 15;
     ...
     * @unknown 
     */
    public static final int CANCEL_WPS_SUCCEDED = android.net.wifi.WifiManager.BASE + 16;
     ...
     * @unknown 
     */
    public static final int DISABLE_NETWORK = android.net.wifi.WifiManager.BASE + 17;
     ...
     * @unknown 
     */
    public static final int DISABLE_NETWORK_FAILED = android.net.wifi.WifiManager.BASE + 18;
     ...
     * @unknown 
     */
    public static final int DISABLE_NETWORK_SUCCEEDED = android.net.wifi.WifiManager.BASE + 19;
     ...
     * @unknown 
     */
    public static final int RSSI_PKTCNT_FETCH = android.net.wifi.WifiManager.BASE + 20;
     ...
     * @unknown 
     */
    public static final int RSSI_PKTCNT_FETCH_SUCCEEDED = android.net.wifi.WifiManager.BASE + 21;
     ...
     * @unknown 
     */
    public static final int RSSI_PKTCNT_FETCH_FAILED = android.net.wifi.WifiManager.BASE + 22;
    ...
    private static final java.lang.Object sServiceHandlerDispatchLock = new java.lang.Object();
    ...
    private class ServiceHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message message) {
            synchronized(android.net.wifi.WifiManager.sServiceHandlerDispatchLock) {
                dispatchMessageToListeners(message);
            }
        }

        private void dispatchMessageToListeners(android.os.Message message) {
            java.lang.Object listener = removeListener(message.arg2);
            switch (message.what) {
                case com.android.internal.util.AsyncChannel.CMD_CHANNEL_HALF_CONNECTED :
                    if (message.arg1 == com.android.internal.util.AsyncChannel.STATUS_SUCCESSFUL) {
                        mAsyncChannel.sendMessage(AsyncChannel.CMD_CHANNEL_FULL_CONNECTION);
                    } else {
                        android.util.Log.e(android.net.wifi.WifiManager.TAG, "Failed to set up channel connection");
                ...
                case com.android.internal.util.AsyncChannel.CMD_CHANNEL_DISCONNECTED :
                    android.util.Log.e(android.net.wifi.WifiManager.TAG, "Channel connection lost");
                    // This will cause all further async API calls on the WifiManager
                    // to fail and throw an exception
                    mAsyncChannel = null;
                    getLooper().quit();
                ...
                case android.net.wifi.WifiManager.CONNECT_NETWORK_FAILED :
                case android.net.wifi.WifiManager.FORGET_NETWORK_FAILED :
                case android.net.wifi.WifiManager.SAVE_NETWORK_FAILED :
                case android.net.wifi.WifiManager.DISABLE_NETWORK_FAILED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.ActionListener) (listener)).onFailure(message.arg1);
                    }
                    break;
                    /* ActionListeners grouped together */
                case android.net.wifi.WifiManager.CONNECT_NETWORK_SUCCEEDED :
                case android.net.wifi.WifiManager.FORGET_NETWORK_SUCCEEDED :
                case android.net.wifi.WifiManager.SAVE_NETWORK_SUCCEEDED :
                case android.net.wifi.WifiManager.DISABLE_NETWORK_SUCCEEDED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.ActionListener) (listener)).onSuccess();
                    }
                    break;
                case android.net.wifi.WifiManager.START_WPS_SUCCEEDED :
                    if (listener != null) {
                        android.net.wifi.WpsResult result = ((android.net.wifi.WpsResult) (message.obj));
                        ((android.net.wifi.WifiManager.WpsCallback) (listener)).onStarted(result.pin);
                    ...
                    break;
                case android.net.wifi.WifiManager.WPS_COMPLETED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.WpsCallback) (listener)).onSucceeded();
                    }
                    break;
                case android.net.wifi.WifiManager.WPS_FAILED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.WpsCallback) (listener)).onFailed(message.arg1);
                    }
                    break;
                case android.net.wifi.WifiManager.CANCEL_WPS_SUCCEDED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.WpsCallback) (listener)).onSucceeded();
                    }
                    break;
                case android.net.wifi.WifiManager.CANCEL_WPS_FAILED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.WpsCallback) (listener)).onFailed(message.arg1);
                    }
                    break;
                case android.net.wifi.WifiManager.RSSI_PKTCNT_FETCH_SUCCEEDED :
                    if (listener != null) {
                        android.net.wifi.RssiPacketCountInfo info = ((android.net.wifi.RssiPacketCountInfo) (message.obj));
                        if (info != null)
                            ((android.net.wifi.WifiManager.TxPacketCountListener) (listener)).onSuccess(info.txgood + info.txbad);
                        else
                            ((android.net.wifi.WifiManager.TxPacketCountListener) (listener)).onFailure(android.net.wifi.WifiManager.ERROR);

                    }
                    break;
                case android.net.wifi.WifiManager.RSSI_PKTCNT_FETCH_FAILED :
                    if (listener != null) {
                        ((android.net.wifi.WifiManager.TxPacketCountListener) (listener)).onFailure(message.arg1);
                    }
                    break;
                default :
                    // ignore
    ...
    private int putListener(java.lang.Object listener) {
        if (listener == null)
            return android.net.wifi.WifiManager.INVALID_KEY;

        int key;
        synchronized(mListenerMapLock) {
            do {
                key = mListenerKey++;
            } while (key == android.net.wifi.WifiManager.INVALID_KEY );
    ...
    private java.lang.Object removeListener(int key) {
        if (key == android.net.wifi.WifiManager.INVALID_KEY)
            return null;
    ...
    private synchronized com.android.internal.util.AsyncChannel getChannel() {
        if (mAsyncChannel == null) {
            android.os.Messenger messenger = getWifiServiceMessenger();
            if (messenger == null) {
                throw new java.lang.IllegalStateException("getWifiServiceMessenger() returned null!  This is invalid.");
            }
            mAsyncChannel = new com.android.internal.util.AsyncChannel();
            mConnected = new java.util.concurrent.CountDownLatch(1);
            android.os.Handler handler = new android.net.wifi.WifiManager.ServiceHandler(mLooper);
            mAsyncChannel.connect(mContext, handler, messenger);
            try {
                mConnected.await();
            } catch (java.lang.InterruptedException e) {
                android.util.Log.e(android.net.wifi.WifiManager.TAG, "interrupted wait at init");
            }
        }
     ...
     * @unknown 
     */
    public void connect(android.net.wifi.WifiConfiguration config, android.net.wifi.WifiManager.ActionListener listener) {
        if (config == null)
            throw new java.lang.IllegalArgumentException("config cannot be null");

        // Use INVALID_NETWORK_ID for arg1 when passing a config object
        // arg1 is used to pass network id when the network already exists
        getChannel().sendMessage(android.net.wifi.WifiManager.CONNECT_NETWORK, android.net.wifi.WifiConfiguration.INVALID_NETWORK_ID, putListener(listener), config);
    }
     ...
     * @unknown 
     */
    public void connect(int networkId, android.net.wifi.WifiManager.ActionListener listener) {
        if (networkId < 0)
            throw new java.lang.IllegalArgumentException("Network id cannot be negative");

        getChannel().sendMessage(android.net.wifi.WifiManager.CONNECT_NETWORK, networkId, putListener(listener));
    }
     ...
     * @unknown 
     */
    public void save(android.net.wifi.WifiConfiguration config, android.net.wifi.WifiManager.ActionListener listener) {
        if (config == null)
            throw new java.lang.IllegalArgumentException("config cannot be null");

        getChannel().sendMessage(android.net.wifi.WifiManager.SAVE_NETWORK, 0, putListener(listener), config);
    }
     ...
     * @unknown 
     */
    public void forget(int netId, android.net.wifi.WifiManager.ActionListener listener) {
        if (netId < 0)
            throw new java.lang.IllegalArgumentException("Network id cannot be negative");

        getChannel().sendMessage(android.net.wifi.WifiManager.FORGET_NETWORK, netId, putListener(listener));
    }
     ...
     * @unknown 
     */
    public void disable(int netId, android.net.wifi.WifiManager.ActionListener listener) {
        if (netId < 0)
            throw new java.lang.IllegalArgumentException("Network id cannot be negative");

        getChannel().sendMessage(android.net.wifi.WifiManager.DISABLE_NETWORK, netId, putListener(listener));
    }
     ...
     * @unknown 
     */
    public void disableEphemeralNetwork(java.lang.String SSID) {
        if (SSID == null)
            throw new java.lang.IllegalArgumentException("SSID cannot be null");
     ...
     *
     * @param config
     * 		WPS configuration (does not support {@link WpsInfo#LABEL})
     * @param listener
     * 		for callbacks on success or failure. Can be null.
     * @throws IllegalStateException
     * 		if the WifiManager instance needs to be
     * 		initialized again
     */
    public void startWps(android.net.wifi.WpsInfo config, android.net.wifi.WifiManager.WpsCallback listener) {
        if (config == null)
            throw new java.lang.IllegalArgumentException("config cannot be null");

        getChannel().sendMessage(android.net.wifi.WifiManager.START_WPS, 0, putListener(listener), config);
    }
    ...
    public void cancelWps(android.net.wifi.WifiManager.WpsCallback listener) {
        getChannel().sendMessage(android.net.wifi.WifiManager.CANCEL_WPS, 0, putListener(listener));
    }
    ...
    public class WifiLock {
        ...
        private WifiLock(int lockType, java.lang.String tag) {
            mTag = tag;
            mLockType = lockType;
            ...
            synchronized(mBinder) {
                if (mRefCounted ? (++mRefCount) == 1 : !mHeld) {
                    try {
                        ...
                        synchronized(android.net.wifi.WifiManager.this) {
                            if (mActiveLockCount >= android.net.wifi.WifiManager.MAX_ACTIVE_LOCKS) {
        ...
        public void release() {
            synchronized(mBinder) {
                ...
                if (mRefCount < 0) {
                    throw new java.lang.RuntimeException("WifiLock under-locked " + mTag);
                }
            }
        }
            ...
            synchronized(mBinder) {
                ...
                if (ws == null) {
                    ...
                    if (mWorkSource == null) {
                        ...
                        mWorkSource = new android.os.WorkSource(ws);
                    } else {
        ...
        public java.lang.String toString() {
            ...
            java.lang.String s3;
            synchronized(mBinder) {
                s1 = java.lang.Integer.toHexString(java.lang.System.identityHashCode(this));
                s2 = (mHeld) ? "held; " : "";
                if (mRefCounted) {
     ...
     *
     * @param lockType
     * 		the type of lock to create. See {@link #WIFI_MODE_FULL},
    ...
    public android.net.wifi.WifiManager.WifiLock createWifiLock(int lockType, java.lang.String tag) {
        return new android.net.wifi.WifiManager.WifiLock(lockType, tag);
    }
    ...
    public android.net.wifi.WifiManager.WifiLock createWifiLock(java.lang.String tag) {
        return new android.net.wifi.WifiManager.WifiLock(android.net.wifi.WifiManager.WIFI_MODE_FULL, tag);
    }
    ...
    public android.net.wifi.WifiManager.MulticastLock createMulticastLock(java.lang.String tag) {
        return new android.net.wifi.WifiManager.MulticastLock(tag);
    }
    ...
    public class MulticastLock {
        ...
        private MulticastLock(java.lang.String tag) {
            mTag = tag;
            mBinder = new android.os.Binder();
            mRefCount = 0;
            mRefCounted = true;
        ...
        public void release() {
            synchronized(mBinder) {
                ...
                if (mRefCount < 0) {
                    throw new java.lang.RuntimeException("MulticastLock under-locked " + mTag);
                }
            }
        }
    ...
    public void enableVerboseLogging(int verbose) {
        try {
            ...
            android.util.Log.e(android.net.wifi.WifiManager.TAG, "enableVerboseLogging " + e.toString());
        }
    }
