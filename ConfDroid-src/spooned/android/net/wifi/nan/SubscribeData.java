 ...
 */
public class SubscribeData implements android.os.Parcelable {
    /**
     *
     *
     * @unknown 
    ...
    private SubscribeData(java.lang.String serviceName, byte[] serviceSpecificInfo, int serviceSpecificInfoLength, byte[] txFilter, int txFilterLength, byte[] rxFilter, int rxFilterLength) {
    ...
    public static final android.os.Parcelable.Creator<android.net.wifi.nan.SubscribeData> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.nan.SubscribeData>() {
        @java.lang.Override
        public android.net.wifi.nan.SubscribeData[] newArray(int size) {
            return new android.net.wifi.nan.SubscribeData[size];
        }

        @java.lang.Override
        public android.net.wifi.nan.SubscribeData createFromParcel(android.os.Parcel in) {
            ...
            return new android.net.wifi.nan.SubscribeData(serviceName, ssi, ssiLength, txFilter, txFilterLength, rxFilter, rxFilterLength);
        }
    };
    ...
    public boolean equals(java.lang.Object o) {
        ...
        if (!(o instanceof android.net.wifi.nan.SubscribeData)) {
            return false;
        }
        android.net.wifi.nan.SubscribeData lhs = ((android.net.wifi.nan.SubscribeData) (o));
    ...
    public static final class Builder {
         ...
         */
        public android.net.wifi.nan.SubscribeData.Builder setServiceName(java.lang.String serviceName) {
            mServiceName = serviceName;
            return this;
        }
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.SubscribeData.Builder setServiceSpecificInfo(byte[] serviceSpecificInfo, int serviceSpecificInfoLength) {
            mServiceSpecificInfoLength = serviceSpecificInfoLength;
            mServiceSpecificInfo = serviceSpecificInfo;
            return this;
        }
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.SubscribeData.Builder setServiceSpecificInfo(java.lang.String serviceSpecificInfoStr) {
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.SubscribeData.Builder setTxFilter(byte[] txFilter, int txFilterLength) {
            mTxFilter = txFilter;
            mTxFilterLength = txFilterLength;
            return this;
        }
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.SubscribeData.Builder setRxFilter(byte[] rxFilter, int rxFilterLength) {
            mRxFilter = rxFilter;
            mRxFilterLength = rxFilterLength;
            return this;
        }
        ...
        public android.net.wifi.nan.SubscribeData build() {
            return new android.net.wifi.nan.SubscribeData(mServiceName, mServiceSpecificInfo, mServiceSpecificInfoLength, mTxFilter, mTxFilterLength, mRxFilter, mRxFilterLength);
        }
    }
}
