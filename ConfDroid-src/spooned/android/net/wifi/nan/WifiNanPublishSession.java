 ...
 */
public class WifiNanPublishSession extends android.net.wifi.nan.WifiNanSession {
    /**
     * {@hide }
     */
    public WifiNanPublishSession(android.net.wifi.nan.WifiNanManager manager, int sessionId) {
     ...
     *
     * @param publishData
     * 		The data ({@link PublishData}) to publish.
     * @param publishSettings
     * 		The settings ({@link PublishSettings}) of the
     * 		publish session.
     */
    public void publish(android.net.wifi.nan.PublishData publishData, android.net.wifi.nan.PublishSettings publishSettings) {
