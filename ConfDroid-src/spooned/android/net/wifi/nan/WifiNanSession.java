...
public class WifiNanSession {
    private static final java.lang.String TAG = "WifiNanSession";
     ...
     * {@hide }
     */
    public WifiNanSession(android.net.wifi.nan.WifiNanManager manager, int sessionId) {
        if (android.net.wifi.nan.WifiNanSession.VDBG)
            android.util.Log.v(android.net.wifi.nan.WifiNanSession.TAG, (("New client created: manager=" + manager) + ", sessionId=") + sessionId);
    ...
    protected void finalize() throws java.lang.Throwable {
        if (!mDestroyed) {
            android.util.Log.w(android.net.wifi.nan.WifiNanSession.TAG, (("WifiNanSession mSessionId=" + mSessionId) + " was not explicitly destroyed. The session may use resources until ") + "destroyed so step should be done explicitly");
        }
        destroy();
    }
     ...
     * @param messageLength
     * 		The number of bytes from the {@code message} to be
     * 		transmitted.
     * @param messageId
