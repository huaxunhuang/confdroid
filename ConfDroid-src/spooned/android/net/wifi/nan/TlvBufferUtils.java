...
public class TlvBufferUtils {
    ...
    public static class TlvConstructor {
        ...
        public TlvConstructor(int typeSize, int lengthSize) {
            if ((((typeSize < 0) || (typeSize > 2)) || (lengthSize <= 0)) || (lengthSize > 2)) {
                throw new java.lang.IllegalArgumentException((("Invalid sizes - typeSize=" + typeSize) + ", lengthSize=") + lengthSize);
            }
            mTypeSize = typeSize;
         ...
         *
         * @param array
         * 		Byte array to be formatted.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor wrap(byte[] array) {
            mArray = array;
         ...
         *
         * @param capacity
         * 		The size of the byte array to be allocated.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor allocate(int capacity) {
         ...
         *
         * @param type
         * 		The value to be placed into the Type field.
         * @param b
         * 		The byte to be inserted into the structure.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putByte(int type, byte b) {
            checkLength(1);
            addHeader(type, 1);
            mArray[mPosition++] = b;
            return this;
         ...
         * 		The value to be placed into the Type field.
         * @param array
         * 		The array to be copied into the TLV structure.
         * @param offset
         * 		Start copying from the array at the specified offset.
         * @param length
        ...
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putByteArray(int type, byte[] array, int offset, int length) {
            checkLength(length);
            addHeader(type, length);
            java.lang.System.arraycopy(array, offset, mArray, mPosition, length);
            mPosition += length;
            return this;
        }
         ...
         * 		The value to be placed into the Type field.
         * @param array
         * 		The array to be copied (in full) into the TLV structure.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putByteArray(int type, byte[] array) {
        ...
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putZeroLengthElement(int type) {
            checkLength(0);
            addHeader(type, 0);
            return this;
        }
         ...
         * 		The value to be placed into the Type field.
         * @param data
         * 		The short to be inserted into the structure.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putShort(int type, short data) {
            checkLength(2);
            addHeader(type, 2);
            libcore.io.Memory.pokeShort(mArray, mPosition, data, java.nio.ByteOrder.BIG_ENDIAN);
            mPosition += 2;
            return this;
        }
         ...
         * 		The value to be placed into the Type field.
         * @param data
         * 		The integer to be inserted into the structure.
         * @return The constructor to facilitate chaining
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putInt(int type, int data) {
            checkLength(4);
            addHeader(type, 4);
            libcore.io.Memory.pokeInt(mArray, mPosition, data, java.nio.ByteOrder.BIG_ENDIAN);
            mPosition += 4;
            return this;
        }
        ...
        {@code ctr.putXXX(..).putXXX(..)}.
         */
        public android.net.wifi.nan.TlvBufferUtils.TlvConstructor putString(int type, java.lang.String data) {
        ...
        private void addHeader(int type, int length) {
            if (mTypeSize == 1) {
                ...
                if (mTypeSize == 2) {
                    libcore.io.Memory.pokeShort(mArray, mPosition, ((short) (type)), java.nio.ByteOrder.BIG_ENDIAN);
                }
            ...
            if (mLengthSize == 1) {
                ...
                if (mLengthSize == 2) {
                    libcore.io.Memory.pokeShort(mArray, mPosition, ((short) (length)), java.nio.ByteOrder.BIG_ENDIAN);
                }
    ...
    public static class TlvElement {
        ...
        public byte getByte() {
            if (mLength != 1) {
                throw new java.lang.IllegalArgumentException("Accesing a byte from a TLV element of length " + mLength);
            }
        ...
        public short getShort() {
            if (mLength != 2) {
                throw new java.lang.IllegalArgumentException("Accesing a short from a TLV element of length " + mLength);
            }
            return libcore.io.Memory.peekShort(mRefArray, mOffset, java.nio.ByteOrder.BIG_ENDIAN);
        }
        ...
        public int getInt() {
            if (mLength != 4) {
                throw new java.lang.IllegalArgumentException("Accesing an int from a TLV element of length " + mLength);
            }
            return libcore.io.Memory.peekInt(mRefArray, mOffset, java.nio.ByteOrder.BIG_ENDIAN);
        }
        ...
        public java.lang.String getString() {
            return new java.lang.String(mRefArray, mOffset, mLength);
        }
    }
     ...
     */
    public static class TlvIterable implements java.lang.Iterable<android.net.wifi.nan.TlvBufferUtils.TlvElement> {
        private int mTypeSize;
         ...
         * @param array
         * 		The TLV formatted byte-array to parse.
         * @param length
        ...
        public java.lang.String toString() {
            ...
            builder.append("[");
            boolean first = true;
            for (android.net.wifi.nan.TlvBufferUtils.TlvElement tlv : this) {
                if (!first) {
                    builder.append(",");
                }
                first = false;
         ...
         */
        @java.lang.Override
        public java.util.Iterator<android.net.wifi.nan.TlvBufferUtils.TlvElement> iterator() {
            return new java.util.Iterator<android.net.wifi.nan.TlvBufferUtils.TlvElement>() {
                ...
                public android.net.wifi.nan.TlvBufferUtils.TlvElement next() {
                    ...
                    if (mTypeSize == 1) {
                        ...
                        if (mTypeSize == 2) {
                            type = libcore.io.Memory.peekShort(mArray, mOffset, java.nio.ByteOrder.BIG_ENDIAN);
                        }
                    ...
                    if (mLengthSize == 1) {
                        ...
                        if (mLengthSize == 2) {
                            length = libcore.io.Memory.peekShort(mArray, mOffset, java.nio.ByteOrder.BIG_ENDIAN);
                        }

                    mOffset += mLengthSize;
                    android.net.wifi.nan.TlvBufferUtils.TlvElement tlv = new android.net.wifi.nan.TlvBufferUtils.TlvElement(type, length, mArray, mOffset);
                    mOffset += length;
                    return tlv;
                }
