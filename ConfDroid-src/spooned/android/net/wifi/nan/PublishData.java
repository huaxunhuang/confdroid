 ...
 */
public class PublishData implements android.os.Parcelable {
    /**
     *
     *
     * @unknown 
    ...
    private PublishData(java.lang.String serviceName, byte[] serviceSpecificInfo, int serviceSpecificInfoLength, byte[] txFilter, int txFilterLength, byte[] rxFilter, int rxFilterLength) {
    ...
    public java.lang.String toString() {
        return ((((((("PublishData [mServiceName='" + mServiceName) + "', mServiceSpecificInfo='") + new java.lang.String(mServiceSpecificInfo, 0, mServiceSpecificInfoLength)) + "', mTxFilter=") + new android.net.wifi.nan.TlvBufferUtils.TlvIterable(0, 1, mTxFilter, mTxFilterLength).toString()) + ", mRxFilter=") + new android.net.wifi.nan.TlvBufferUtils.TlvIterable(0, 1, mRxFilter, mRxFilterLength).toString()) + "']";
    }
    ...
    public static final android.os.Parcelable.Creator<android.net.wifi.nan.PublishData> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.nan.PublishData>() {
        @java.lang.Override
        public android.net.wifi.nan.PublishData[] newArray(int size) {
            return new android.net.wifi.nan.PublishData[size];
        }

        @java.lang.Override
        public android.net.wifi.nan.PublishData createFromParcel(android.os.Parcel in) {
            ...
            return new android.net.wifi.nan.PublishData(serviceName, ssi, ssiLength, txFilter, txFilterLength, rxFilter, rxFilterLength);
        }
    };
    ...
    public boolean equals(java.lang.Object o) {
        ...
        if (!(o instanceof android.net.wifi.nan.PublishData)) {
            return false;
        }
        android.net.wifi.nan.PublishData lhs = ((android.net.wifi.nan.PublishData) (o));
        if ((((!mServiceName.equals(lhs.mServiceName)) || (mServiceSpecificInfoLength != lhs.mServiceSpecificInfoLength)) || (mTxFilterLength != lhs.mTxFilterLength)) || (mRxFilterLength != lhs.mRxFilterLength)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        result = (31 * result) + java.util.Arrays.hashCode(mServiceSpecificInfo);
        result = (31 * result) + mTxFilterLength;
        result = (31 * result) + java.util.Arrays.hashCode(mTxFilter);
        result = (31 * result) + mRxFilterLength;
        result = (31 * result) + java.util.Arrays.hashCode(mRxFilter);
        return result;
    }
    ...
    public static final class Builder {
         ...
         *
         * @param serviceName
         * 		The service name for the publish session.
         * @return The builder to facilitate chaining
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.PublishData.Builder setServiceName(java.lang.String serviceName) {
            mServiceName = serviceName;
            return this;
        }
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.PublishData.Builder setServiceSpecificInfo(byte[] serviceSpecificInfo, int serviceSpecificInfoLength) {
            if ((serviceSpecificInfoLength != 0) && ((serviceSpecificInfo == null) || (serviceSpecificInfo.length < serviceSpecificInfoLength))) {
                throw new java.lang.IllegalArgumentException("Non-matching combination of " + "serviceSpecificInfo and serviceSpecificInfoLength");
            }
            mServiceSpecificInfoLength = serviceSpecificInfoLength;
            mServiceSpecificInfo = serviceSpecificInfo;
            return this;
        ...
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.PublishData.Builder setServiceSpecificInfo(java.lang.String serviceSpecificInfoStr) {
         ...
         * 		filter.
         * @param txFilterLength
         * 		The number of bytes in the transmit filter
         * 		argument.
         * @return The builder to facilitate chaining
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.PublishData.Builder setTxFilter(byte[] txFilter, int txFilterLength) {
            if ((txFilterLength != 0) && ((txFilter == null) || (txFilter.length < txFilterLength))) {
                throw new java.lang.IllegalArgumentException("Non-matching combination of txFilter and txFilterLength");
            }
            mTxFilter = txFilter;
            mTxFilterLength = txFilterLength;
            return this;
         ...
         * 		filter.
         * @param rxFilterLength
         * 		The number of bytes in the receive filter
         * 		argument.
         * @return The builder to facilitate chaining
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.PublishData.Builder setRxFilter(byte[] rxFilter, int rxFilterLength) {
            if ((rxFilterLength != 0) && ((rxFilter == null) || (rxFilter.length < rxFilterLength))) {
                throw new java.lang.IllegalArgumentException("Non-matching combination of rxFilter and rxFilterLength");
            }
            mRxFilter = rxFilter;
            mRxFilterLength = rxFilterLength;
            return this;
        ...
        public android.net.wifi.nan.PublishData build() {
            return new android.net.wifi.nan.PublishData(mServiceName, mServiceSpecificInfo, mServiceSpecificInfoLength, mTxFilter, mTxFilterLength, mRxFilter, mRxFilterLength);
        }
    }
}
