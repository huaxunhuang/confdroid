 ...
 */
public class WifiNanSubscribeSession extends android.net.wifi.nan.WifiNanSession {
    /**
     * {@hide }
     */
    public WifiNanSubscribeSession(android.net.wifi.nan.WifiNanManager manager, int sessionId) {
     ...
     *
     * @param subscribeData
     * 		The data ({@link SubscribeData}) to subscribe.
     * @param subscribeSettings
     * 		The settings ({@link SubscribeSettings}) of the
     * 		subscribe session.
     */
    public void subscribe(android.net.wifi.nan.SubscribeData subscribeData, android.net.wifi.nan.SubscribeSettings subscribeSettings) {
