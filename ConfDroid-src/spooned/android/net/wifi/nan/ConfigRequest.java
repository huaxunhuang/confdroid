 ...
 */
public class ConfigRequest implements android.os.Parcelable {
    /**
    ...
    public java.lang.String toString() {
        return ((((((("ConfigRequest [mSupport5gBand=" + mSupport5gBand) + ", mMasterPreference=") + mMasterPreference) + ", mClusterLow=") + mClusterLow) + ", mClusterHigh=") + mClusterHigh) + "]";
    }
    ...
    public static final android.os.Parcelable.Creator<android.net.wifi.nan.ConfigRequest> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.nan.ConfigRequest>() {
        @java.lang.Override
        public android.net.wifi.nan.ConfigRequest[] newArray(int size) {
            return new android.net.wifi.nan.ConfigRequest[size];
        }

        @java.lang.Override
        public android.net.wifi.nan.ConfigRequest createFromParcel(android.os.Parcel in) {
            boolean support5gBand = in.readInt() != 0;
            int masterPreference = in.readInt();
            int clusterLow = in.readInt();
            int clusterHigh = in.readInt();
            return new android.net.wifi.nan.ConfigRequest(support5gBand, masterPreference, clusterLow, clusterHigh);
        }
    };
    ...
    public boolean equals(java.lang.Object o) {
        ...
        if (!(o instanceof android.net.wifi.nan.ConfigRequest)) {
            return false;
        }
        android.net.wifi.nan.ConfigRequest lhs = ((android.net.wifi.nan.ConfigRequest) (o));
        return (((mSupport5gBand == lhs.mSupport5gBand) && (mMasterPreference == lhs.mMasterPreference)) && (mClusterLow == lhs.mClusterLow)) && (mClusterHigh == lhs.mClusterHigh);
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            mMasterPreference = 0;
            mClusterLow = 0;
            mClusterHigh = android.net.wifi.nan.ConfigRequest.CLUSTER_ID_MAX;
        }
         ...
         *
         * @param support5gBand
         * 		Support for 5G band is required.
         * @return The builder to facilitate chaining
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.ConfigRequest.Builder setSupport5gBand(boolean support5gBand) {
            mSupport5gBand = support5gBand;
            return this;
        }
         ...
         *
         * @param masterPreference
         * 		The requested master preference
         * @return The builder to facilitate chaining
        {@code builder.setXXX(..).setXXX(..)}.
         */
        public android.net.wifi.nan.ConfigRequest.Builder setMasterPreference(int masterPreference) {
            if (masterPreference < 0) {
                throw new java.lang.IllegalArgumentException("Master Preference specification must be non-negative");
            }
            if (((masterPreference == 1) || (masterPreference == 255)) || (masterPreference > 255)) {
                throw new java.lang.IllegalArgumentException("Master Preference specification must not " + "exceed 255 or use 1 or 255 (reserved values)");
            }
            mMasterPreference = masterPreference;
            return this;
        }
         ...
         *
         * @param clusterLow
         * 		The lower range of the generated cluster ID.
         * @return The builder to facilitate chaining
        {@code builder.setClusterLow(..).setClusterHigh(..)}.
         */
        public android.net.wifi.nan.ConfigRequest.Builder setClusterLow(int clusterLow) {
            if (clusterLow < android.net.wifi.nan.ConfigRequest.CLUSTER_ID_MIN) {
                throw new java.lang.IllegalArgumentException("Cluster specification must be non-negative");
            }
            if (clusterLow > android.net.wifi.nan.ConfigRequest.CLUSTER_ID_MAX) {
                throw new java.lang.IllegalArgumentException("Cluster specification must not exceed 0xFFFF");
            }
            mClusterLow = clusterLow;
            return this;
        }
         ...
         *
         * @param clusterHigh
         * 		The upper range of the generated cluster ID.
         * @return The builder to facilitate chaining
        {@code builder.setClusterLow(..).setClusterHigh(..)}.
         */
        public android.net.wifi.nan.ConfigRequest.Builder setClusterHigh(int clusterHigh) {
            if (clusterHigh < android.net.wifi.nan.ConfigRequest.CLUSTER_ID_MIN) {
                throw new java.lang.IllegalArgumentException("Cluster specification must be non-negative");
            }
            if (clusterHigh > android.net.wifi.nan.ConfigRequest.CLUSTER_ID_MAX) {
                throw new java.lang.IllegalArgumentException("Cluster specification must not exceed 0xFFFF");
            }
            mClusterHigh = clusterHigh;
            return this;
        ...
        public android.net.wifi.nan.ConfigRequest build() {
            if (mClusterLow > mClusterHigh) {
                throw new java.lang.IllegalArgumentException("Invalid argument combination - must have Cluster Low <= Cluster High");
            }
            return new android.net.wifi.nan.ConfigRequest(mSupport5gBand, mMasterPreference, mClusterLow, mClusterHigh);
        }
    }
}
