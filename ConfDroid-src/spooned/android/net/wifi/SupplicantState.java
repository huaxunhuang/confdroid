...
public enum SupplicantState implements android.os.Parcelable {
    ...
    otherwise.
     */
    public static boolean isValidState(android.net.wifi.SupplicantState state) {
        return (state != android.net.wifi.SupplicantState.UNINITIALIZED) && (state != android.net.wifi.SupplicantState.INVALID);
    }

    /**
     * Supplicant associating or authenticating is considered a handshake state {@hide }
     */
    public static boolean isHandshakeState(android.net.wifi.SupplicantState state) {
        switch (state) {
            case AUTHENTICATING :
            case ASSOCIATING :
            case ASSOCIATED :
            ...
            case INVALID :
                return false;
            default :
                throw new java.lang.IllegalArgumentException("Unknown supplicant state");
        }
    }
     ...
     * @unknown 
     */
    public static boolean isConnecting(android.net.wifi.SupplicantState state) {
        switch (state) {
            case AUTHENTICATING :
            case ASSOCIATING :
            case ASSOCIATED :
     ...
     * @unknown 
     */
    public static boolean isDriverActive(android.net.wifi.SupplicantState state) {
        switch (state) {
            case DISCONNECTED :
            case DORMANT :
            case INACTIVE :
     ...
     * Implement the Parcelable interface {@hide }
     */
    public static final android.os.Parcelable.Creator<android.net.wifi.SupplicantState> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.SupplicantState>() {
        public android.net.wifi.SupplicantState createFromParcel(android.os.Parcel in) {
            return android.net.wifi.SupplicantState.valueOf(in.readString());
        }

        public android.net.wifi.SupplicantState[] newArray(int size) {
            return new android.net.wifi.SupplicantState[size];
        }
    };
}
