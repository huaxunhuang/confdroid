 ...
 * @unknown 
 */
public class WifiWakeReasonAndCounts implements android.os.Parcelable {
    private static final java.lang.String TAG = "WifiWakeReasonAndCounts";
    ...
    {@hide}
     */
    public static final android.os.Parcelable.Creator<android.net.wifi.WifiWakeReasonAndCounts> CREATOR = new android.os.Parcelable.Creator<android.net.wifi.WifiWakeReasonAndCounts>() {
        public android.net.wifi.WifiWakeReasonAndCounts createFromParcel(android.os.Parcel in) {
            android.net.wifi.WifiWakeReasonAndCounts counts = new android.net.wifi.WifiWakeReasonAndCounts();
         ...
         */
        @java.lang.Override
        public android.net.wifi.WifiWakeReasonAndCounts[] newArray(int size) {
            return new android.net.wifi.WifiWakeReasonAndCounts[size];
        }
    };
}
