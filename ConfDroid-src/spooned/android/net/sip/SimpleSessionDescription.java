...
public class SimpleSessionDescription {
    private final android.net.sip.SimpleSessionDescription.Fields mFields = new android.net.sip.SimpleSessionDescription.Fields("voscbtka");

    private final java.util.ArrayList<android.net.sip.SimpleSessionDescription.Media> mMedia = new java.util.ArrayList<android.net.sip.SimpleSessionDescription.Media>();
     ...
     */
    public SimpleSessionDescription(long sessionId, java.lang.String address) {
        address = (address.indexOf(':') < 0 ? "IN IP4 " : "IN IP6 ") + address;
        mFields.parse("v=0");
        mFields.parse(java.lang.String.format(java.util.Locale.US, "o=- %d %d %s", sessionId, java.lang.System.currentTimeMillis(), address));
        mFields.parse("s=-");
        mFields.parse("t=0 0");
     ...
     */
    public SimpleSessionDescription(java.lang.String message) {
        java.lang.String[] lines = message.trim().replaceAll(" +", " ").split("[\r\n]+");
        android.net.sip.SimpleSessionDescription.Fields fields = mFields;
        for (java.lang.String line : lines) {
            try {
                ...
                if (line.charAt(0) == 'm') {
                    java.lang.String[] parts = line.substring(2).split(" ", 4);
                    java.lang.String[] ports = parts[1].split("/", 2);
                    android.net.sip.SimpleSessionDescription.Media media = newMedia(parts[0], java.lang.Integer.parseInt(ports[0]), ports.length < 2 ? 1 : java.lang.Integer.parseInt(ports[1]), parts[2]);
                    for (java.lang.String format : parts[3].split(" ")) {
                ...
                throw new java.lang.IllegalArgumentException("Invalid SDP: " + line);
            }
        }
    }
     ...
     *
     * @param type
     * 		The media type, e.g. {@code "audio"}.
     * @param port
     * 		The first transport port used by this media.
     * @param portCount
     * 		The number of contiguous ports used by this media.
     * @param protocol
     * 		The transport protocol, e.g. {@code "RTP/AVP"}.
     */
    public android.net.sip.SimpleSessionDescription.Media newMedia(java.lang.String type, int port, int portCount, java.lang.String protocol) {
        android.net.sip.SimpleSessionDescription.Media media = new android.net.sip.SimpleSessionDescription.Media(type, port, portCount, protocol);
        mMedia.add(media);
        return media;
    }
    ...
    public android.net.sip.SimpleSessionDescription.Media[] getMedia() {
        return mMedia.toArray(new android.net.sip.SimpleSessionDescription.Media[mMedia.size()]);
    }
    ...
    public java.lang.String encode() {
        ...
        for (android.net.sip.SimpleSessionDescription.Media media : mMedia) {
            media.write(buffer);
        }
     ...
     */
    public void setEncryption(java.lang.String method, java.lang.String key) {
     ...
     * present.
     */
    public int getBandwidth(java.lang.String type) {
     ...
     */
    public void setBandwidth(java.lang.String type, int value) {
     ...
     * example of its usage.
     */
    public static class Media extends android.net.sip.SimpleSessionDescription.Fields {
        ...
        private final java.lang.String mProtocol;

        private java.util.ArrayList<java.lang.String> mFormats = new java.util.ArrayList<java.lang.String>();

        private Media(java.lang.String type, int port, int portCount, java.lang.String protocol) {
            super("icbka");
            mType = type;
            mPort = port;
        ...
        public java.lang.String[] getFormats() {
            return mFormats.toArray(new java.lang.String[mFormats.size()]);
        }
         ...
         */
        public java.lang.String getFmtp(java.lang.String format) {
         ...
         */
        public void setFormat(java.lang.String format, java.lang.String fmtp) {
        ...
        public int[] getRtpPayloadTypes() {
            ...
            int length = 0;
            for (java.lang.String format : mFormats) {
                try {
                    types[length] = java.lang.Integer.parseInt(format);
                    ++length;
                } catch (java.lang.NumberFormatException e) {
                }
            }
            return java.util.Arrays.copyOf(types, length);
        }
         ...
         */
        public java.lang.String getRtpmap(int type) {
         ...
         * {@code null} if it is not present.
         */
        public java.lang.String getFmtp(int type) {
         ...
         */
        public void setRtpPayload(int type, java.lang.String rtpmap, java.lang.String fmtp) {
            java.lang.String format = java.lang.String.valueOf(type);
            mFormats.remove(format);
            mFormats.add(format);
        ...
        public void removeRtpPayload(int type) {
            removeFormat(java.lang.String.valueOf(type));
        }

        private void write(java.lang.StringBuilder buffer) {
    ...
    private static class Fields {
        private final java.lang.String mOrder;

        private final java.util.ArrayList<java.lang.String> mLines = new java.util.ArrayList<java.lang.String>();

        Fields(java.lang.String order) {
            mOrder = order;
        }
         ...
         */
        public java.lang.String getAddress() {
            java.lang.String address = get("c", '=');
            if (address == null) {
                return null;
            }
            java.lang.String[] parts = address.split(" ");
            if (parts.length != 3) {
                return null;
            }
         ...
         */
        public java.lang.String getEncryptionMethod() {
            java.lang.String encryption = get("k", '=');
            if (encryption == null) {
                return null;
            }
         ...
         */
        public int getBandwidth(java.lang.String type) {
            java.lang.String value = get("b=" + type, ':');
            if (value != null) {
                try {
         ...
         */
        public void setBandwidth(java.lang.String type, int value) {
            set("b=" + type, ':', value < 0 ? null : java.lang.String.valueOf(value));
        }
        ...
        private void write(java.lang.StringBuilder buffer) {
            for (int i = 0; i < mOrder.length(); ++i) {
                ...
                for (java.lang.String line : mLines) {
         ...
         */
        private java.lang.String[] cut(java.lang.String prefix, char delimiter) {
            java.lang.String[] names = new java.lang.String[mLines.size()];
            int length = 0;
            for (java.lang.String line : mLines) {
         ...
         */
        private int find(java.lang.String key, char delimiter) {
            int length = key.length();
            for (int i = mLines.size() - 1; i >= 0; --i) {
                java.lang.String line = mLines.get(i);
         ...
         * {@code null}.
         */
        private void set(java.lang.String key, char delimiter, java.lang.String value) {
         ...
         */
        private java.lang.String get(java.lang.String key, char delimiter) {
            int index = find(key, delimiter);
            if (index == (-1)) {
                return null;
            }
            java.lang.String line = mLines.get(index);
            int length = key.length();
