...
public class SipErrorCode {
    ...
    public static java.lang.String toString(int errorCode) {
        switch (errorCode) {
            case android.net.sip.SipErrorCode.NO_ERROR :
                return "NO_ERROR";
            case android.net.sip.SipErrorCode.SOCKET_ERROR :
                return "SOCKET_ERROR";
            case android.net.sip.SipErrorCode.SERVER_ERROR :
                return "SERVER_ERROR";
            case android.net.sip.SipErrorCode.TRANSACTION_TERMINTED :
                return "TRANSACTION_TERMINTED";
            case android.net.sip.SipErrorCode.CLIENT_ERROR :
                return "CLIENT_ERROR";
            case android.net.sip.SipErrorCode.TIME_OUT :
                return "TIME_OUT";
            case android.net.sip.SipErrorCode.INVALID_REMOTE_URI :
                return "INVALID_REMOTE_URI";
            case android.net.sip.SipErrorCode.PEER_NOT_REACHABLE :
                return "PEER_NOT_REACHABLE";
            case android.net.sip.SipErrorCode.INVALID_CREDENTIALS :
                return "INVALID_CREDENTIALS";
            case android.net.sip.SipErrorCode.IN_PROGRESS :
                return "IN_PROGRESS";
            case android.net.sip.SipErrorCode.DATA_CONNECTION_LOST :
                return "DATA_CONNECTION_LOST";
            case android.net.sip.SipErrorCode.CROSS_DOMAIN_AUTHENTICATION :
                return "CROSS_DOMAIN_AUTHENTICATION";
            case android.net.sip.SipErrorCode.SERVER_UNREACHABLE :
