...
public class NetworkConfig {
    ...
    public NetworkConfig(java.lang.String init) {
        java.lang.String[] fragments = init.split(",");
        name = fragments[0].trim().toLowerCase(java.util.Locale.ROOT);
        type = java.lang.Integer.parseInt(fragments[1]);
        radio = java.lang.Integer.parseInt(fragments[2]);
        priority = java.lang.Integer.parseInt(fragments[3]);
        restoreTime = java.lang.Integer.parseInt(fragments[4]);
        dependencyMet = java.lang.Boolean.parseBoolean(fragments[5]);
    }
