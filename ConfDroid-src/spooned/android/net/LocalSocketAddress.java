...
public class LocalSocketAddress {
     ...
     */
    public LocalSocketAddress(java.lang.String name, android.net.LocalSocketAddress.Namespace namespace) {
        this.name = name;
    ...
    public LocalSocketAddress(java.lang.String name) {
        this(name, android.net.LocalSocketAddress.Namespace.ABSTRACT);
    }
