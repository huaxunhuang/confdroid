 ...
 * from it.
 * <pre> {@code PskKeyManager pskKeyManager = ...;
 *
 ...
 * }</pre>
 */
public abstract class PskKeyManager implements com.android.org.conscrypt.PSKKeyManager {
     ...
     */
    public static final int MAX_IDENTITY_HINT_LENGTH_BYTES = com.android.org.conscrypt.PSKKeyManager.MAX_IDENTITY_HINT_LENGTH_BYTES;

    /**
     * Maximum supported length (in bytes) for PSK identity (in modified UTF-8 representation).
     */
    public static final int MAX_IDENTITY_LENGTH_BYTES = com.android.org.conscrypt.PSKKeyManager.MAX_IDENTITY_LENGTH_BYTES;

    /**
     * Maximum supported length (in bytes) for PSK.
     */
    public static final int MAX_KEY_LENGTH_BYTES = com.android.org.conscrypt.PSKKeyManager.MAX_KEY_LENGTH_BYTES;
     ...
     *
     * @param identityHint
     * 		identity hint provided by the server or {@code null} if none provided.
     * @return PSK identity to provide to the server. {@code null} is permitted but will be
    converted into an empty string.
     */
    @java.lang.Override
    public java.lang.String chooseClientKeyIdentity(java.lang.String identityHint, java.net.Socket socket) {
        return "";
    }
     ...
     */
    @java.lang.Override
    public java.lang.String chooseClientKeyIdentity(java.lang.String identityHint, javax.net.ssl.SSLEngine engine) {
        return "";
    }
     ...
     *
     * @param identityHint
     * 		identity hint provided by the server to help select the key or
     ...
     */
    @java.lang.Override
    public javax.crypto.SecretKey getKey(java.lang.String identityHint, java.lang.String identity, java.net.Socket socket) {
        return null;
    }
     ...
     */
    @java.lang.Override
    public javax.crypto.SecretKey getKey(java.lang.String identityHint, java.lang.String identity, javax.net.ssl.SSLEngine engine) {
        return null;
    }
}
