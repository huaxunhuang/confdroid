...
public class Stopwatch {
    ...
    public android.net.util.Stopwatch start() {
        if (!isStarted()) {
            mStartTimeMs = android.os.SystemClock.elapsedRealtime();
        }
        return this;
    }
    ...
    public long stop() {
        if (isRunning()) {
            mStopTimeMs = android.os.SystemClock.elapsedRealtime();
        }
    ...
    public long lap() {
        if (isRunning()) {
            return android.os.SystemClock.elapsedRealtime() - mStartTimeMs;
        } else {
            return stop();
        }
    }
