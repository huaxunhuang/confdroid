...
public class NetworkScoreManager {
    ...
    public NetworkScoreManager(android.content.Context context) {
        mContext = context;
        android.os.IBinder iBinder = android.os.ServiceManager.getService(android.content.Context.NETWORK_SCORE_SERVICE);
    ...
    public java.lang.String getActiveScorerPackage() {
        android.net.NetworkScorerAppManager.NetworkScorerAppData app = android.net.NetworkScorerAppManager.getActiveScorer(mContext);
        if (app == null) {
            return null;
        }
     ...
     *
     * @param networks
     * 		the networks which have been scored by the scorer.
     * @return whether the update was successful.
     * @throws SecurityException
     * 		if the caller is not the active scorer.
     */
    public boolean updateScores(android.net.ScoredNetwork[] networks) throws java.lang.SecurityException {
        try {
     ...
     * @throws SecurityException
     * 		if the caller is not the active scorer or privileged.
     */
     ...
     */
    @android.annotation.SystemApi
    public boolean setActiveScorer(java.lang.String packageName) throws java.lang.SecurityException {
        try {
     ...
     *
     * @throws SecurityException
     * 		if the caller is neither the active scorer nor the system.
     */
     ...
     * @unknown 
     */
    public boolean requestScores(android.net.NetworkKey[] networks) throws java.lang.SecurityException {
        java.lang.String activeScorer = getActiveScorerPackage();
        if (activeScorer == null) {
            return false;
        }
        android.content.Intent intent = new android.content.Intent(android.net.NetworkScoreManager.ACTION_SCORE_NETWORKS);
        intent.setPackage(activeScorer);
        intent.setFlags(android.content.Intent.FLAG_RECEIVER_REGISTERED_ONLY_BEFORE_BOOT);
        intent.putExtra(android.net.NetworkScoreManager.EXTRA_NETWORKS_TO_SCORE, networks);
        ...
        mContext.sendBroadcastAsUser(intent, android.os.UserHandle.SYSTEM, Manifest.permission.SCORE_NETWORKS);
        return true;
    }
     ...
     *
     * @param networkType
     * 		the type of network this cache can handle. See {@link NetworkKey#type}.
     * @param scoreCache
     * 		implementation of {@link INetworkScoreCache} to store the scores.
     * @throws SecurityException
     * 		if the caller does not hold the
     * 		{@link android.Manifest.permission#BROADCAST_NETWORK_PRIVILEGED} permission.
     ...
     * @unknown 
     */
    public void registerNetworkScoreCache(int networkType, android.net.INetworkScoreCache scoreCache) {
        try {
