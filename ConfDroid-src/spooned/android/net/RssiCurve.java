...
public class RssiCurve implements android.os.Parcelable {
    ...
    public RssiCurve(int start, int bucketWidth, byte[] rssiBuckets) {
        this(start, bucketWidth, rssiBuckets, android.net.RssiCurve.DEFAULT_ACTIVE_NETWORK_RSSI_BOOST);
    }
     ...
     * @param rssiBuckets
     * 		the score for each RSSI bucket.
     * @param activeNetworkRssiBoost
     * 		the RSSI boost to apply when this network is active, in dBm.
     */
    ...
    public boolean equals(java.lang.Object o) {
        ...
        android.net.RssiCurve rssiCurve = ((android.net.RssiCurve) (o));
        return (((start == rssiCurve.start) && (bucketWidth == rssiCurve.bucketWidth)) && java.util.Arrays.equals(rssiBuckets, rssiCurve.rssiBuckets)) && (activeNetworkRssiBoost == rssiCurve.activeNetworkRssiBoost);
    }

    @java.lang.Override
    public int hashCode() {
        return java.util.Objects.hash(start, bucketWidth, rssiBuckets, activeNetworkRssiBoost);
    }
    ...
    public static final android.os.Parcelable.Creator<android.net.RssiCurve> CREATOR = new android.os.Parcelable.Creator<android.net.RssiCurve>() {
        @java.lang.Override
        public android.net.RssiCurve createFromParcel(android.os.Parcel in) {
            return new android.net.RssiCurve(in);
        }

        @java.lang.Override
        public android.net.RssiCurve[] newArray(int size) {
            return new android.net.RssiCurve[size];
        }
    };
}
