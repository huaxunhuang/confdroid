...
public class SslError {
     ...
     */
    @java.lang.Deprecated
    public SslError(int error, android.net.http.SslCertificate certificate) {
     ...
     */
    @java.lang.Deprecated
    public SslError(int error, java.security.cert.X509Certificate certificate) {
        this(error, certificate, "");
    }
     ...
     * 		The associated URL
     */
    public SslError(int error, android.net.http.SslCertificate certificate, java.lang.String url) {
     ...
     * 		The associated URL
     */
    public SslError(int error, java.security.cert.X509Certificate certificate, java.lang.String url) {
        this(error, new android.net.http.SslCertificate(certificate), url);
    }
     ...
     * @param url
     * 		The associated URL.
     * @unknown chromium error codes only available inside the framework
     */
    public static android.net.http.SslError SslErrorFromChromiumErrorCode(int error, android.net.http.SslCertificate cert, java.lang.String url) {
    ...
    public boolean addError(int error) {
        boolean rval = (0 <= error) && (error < android.net.http.SslError.SSL_MAX_ERROR);
        if (rval) {
            mErrors |= 0x1 << error;
        }
        return rval;
    ...
    public int getPrimaryError() {
        if (mErrors != 0) {
            ...
            for (int error = android.net.http.SslError.SSL_MAX_ERROR - 1; error >= 0; --error) {
