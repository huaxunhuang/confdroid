...
public class AudioStream extends android.net.rtp.RtpStream {
     ...
     */
    public AudioStream(java.net.InetAddress address) throws java.net.SocketException {
        super(address);
    }
     ...
     *
     * @param group
     * 		The AudioGroup to join or {@code null} to leave.
    ...
    public void setCodec(android.net.rtp.AudioCodec codec) {
        ...
        if (codec.type == mDtmfType) {
            throw new java.lang.IllegalArgumentException("The type is used by DTMF");
        }
        mCodec = codec;
    }
     ...
     *
     * @param type
     * 		The RTP payload type to be used or {@code -1} to disable it.
     * @throws IllegalArgumentException
    ...
    public void setDtmfType(int type) {
        ...
        if (type != (-1)) {
            ...
            if ((mCodec != null) && (type == mCodec.type)) {
                throw new java.lang.IllegalArgumentException("The type is used by codec");
            }
        }
        mDtmfType = type;
    }
