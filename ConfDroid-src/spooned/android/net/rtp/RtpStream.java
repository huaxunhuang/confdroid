...
public class RtpStream {
    ...
    private int mMode = android.net.rtp.RtpStream.MODE_NORMAL;
     ...
     */
    RtpStream(java.net.InetAddress address) throws java.net.SocketException {
        mLocalPort = create(address.getHostAddress());
        mLocalAddress = address;
    }

    private native int create(java.lang.String address) throws java.net.SocketException;
    ...
    public void setMode(int mode) {
        if (isBusy()) {
            throw new java.lang.IllegalStateException("Busy");
        }
        if ((mode < 0) || (mode > android.net.rtp.RtpStream.MODE_LAST)) {
     ...
     * @see #isBusy()
     */
    public void associate(java.net.InetAddress address, int port) {
        if (isBusy()) {
            throw new java.lang.IllegalStateException("Busy");
        }
        if ((!((address instanceof java.net.Inet4Address) && (mLocalAddress instanceof java.net.Inet4Address))) && (!((address instanceof java.net.Inet6Address) && (mLocalAddress instanceof java.net.Inet6Address)))) {
            throw new java.lang.IllegalArgumentException("Unsupported address");
        }
