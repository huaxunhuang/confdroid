...
public class LinkAddress implements android.os.Parcelable {
     ...
     * @unknown 
     */
    static int scopeForUnicastAddress(java.net.InetAddress addr) {
        if (addr.isAnyLocalAddress()) {
            return android.system.OsConstants.RT_SCOPE_HOST;
        }
        if (addr.isLoopbackAddress() || addr.isLinkLocalAddress()) {
            return android.system.OsConstants.RT_SCOPE_LINK;
        }
        ...
        if ((!(addr instanceof java.net.Inet4Address)) && addr.isSiteLocalAddress()) {
            return android.system.OsConstants.RT_SCOPE_SITE;
        }
        return android.system.OsConstants.RT_SCOPE_UNIVERSE;
    }
    ...
    private boolean isIPv6ULA() {
        if ((address != null) && (address instanceof java.net.Inet6Address)) {
     ...
     */
    private void init(java.net.InetAddress address, int prefixLength, int flags, int scope) {
        if (((((address == null) || address.isMulticastAddress()) || (prefixLength < 0)) || ((address instanceof java.net.Inet4Address) && (prefixLength > 32))) || (prefixLength > 128)) {
            throw new java.lang.IllegalArgumentException((("Bad LinkAddress params " + address) + "/") + prefixLength);
        }
     ...
     * 		The prefix length.
     * @param flags
     * 		A bitmask of {@code IFA_F_*} values representing properties of the address.
     * @param scope
    ...
    public LinkAddress(java.net.InetAddress address, int prefixLength) {
        ...
        this.scope = android.net.LinkAddress.scopeForUnicastAddress(address);
    }
    ...
    public LinkAddress(java.lang.String address) {
        this(address, 0, 0);
        this.scope = android.net.LinkAddress.scopeForUnicastAddress(this.address);
    }
     ...
     * @unknown 
     */
    public LinkAddress(java.lang.String address, int flags, int scope) {
        // This may throw an IllegalArgumentException; catching it is the caller's responsibility.
        android.util.Pair<java.net.InetAddress, java.lang.Integer> ipAndMask = android.net.NetworkUtils.parseIpAndMask(address);
    ...
    public boolean equals(java.lang.Object obj) {
        if (!(obj instanceof android.net.LinkAddress)) {
            return false;
        }
        android.net.LinkAddress linkAddress = ((android.net.LinkAddress) (obj));
     ...
     *
     * @param other
     * 		the {@code LinkAddress} to compare to.
     * @return {@code true} if both objects have the same address and prefix length, {@code false}
    otherwise.
     * @unknown 
     */
    public boolean isSameAddressAs(android.net.LinkAddress other) {
    ...
    public boolean isGlobalPreferred() {
         ...
         */
        return (((scope == android.system.OsConstants.RT_SCOPE_UNIVERSE) && (!isIPv6ULA())) && ((flags & (android.system.OsConstants.IFA_F_DADFAILED | android.system.OsConstants.IFA_F_DEPRECATED)) == 0L)) && (((flags & android.system.OsConstants.IFA_F_TENTATIVE) == 0L) || ((flags & android.system.OsConstants.IFA_F_OPTIMISTIC) != 0L));
    }
     ...
     * Implement the Parcelable interface.
     */
    public static final android.os.Parcelable.Creator<android.net.LinkAddress> CREATOR = new android.os.Parcelable.Creator<android.net.LinkAddress>() {
        public android.net.LinkAddress createFromParcel(android.os.Parcel in) {
            java.net.InetAddress address = null;
            try {
                address = java.net.InetAddress.getByAddress(in.createByteArray());
            ...
            return new android.net.LinkAddress(address, prefixLength, flags, scope);
        }

        public android.net.LinkAddress[] newArray(int size) {
            return new android.net.LinkAddress[size];
        }
    };
}
