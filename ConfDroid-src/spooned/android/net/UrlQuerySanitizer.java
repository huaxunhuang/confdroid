...
public class UrlQuerySanitizer {
    ...
    public class ParameterValuePair {
         ...
         *
         * @param parameter
         * 		an unencoded parameter
         * @param value
         * 		an unencoded value
         */
        public ParameterValuePair(java.lang.String parameter, java.lang.String value) {
    ...
    private final java.util.HashMap<java.lang.String, android.net.UrlQuerySanitizer.ValueSanitizer> mSanitizers = new java.util.HashMap<java.lang.String, android.net.UrlQuerySanitizer.ValueSanitizer>();

    private final java.util.HashMap<java.lang.String, java.lang.String> mEntries = new java.util.HashMap<java.lang.String, java.lang.String>();

    private final java.util.ArrayList<android.net.UrlQuerySanitizer.ParameterValuePair> mEntriesList = new java.util.ArrayList<android.net.UrlQuerySanitizer.ParameterValuePair>();

    private boolean mAllowUnregisteredParamaters;

    private boolean mPreferFirstRepeatedParameter;

    private android.net.UrlQuerySanitizer.ValueSanitizer mUnregisteredParameterValueSanitizer = android.net.UrlQuerySanitizer.getAllIllegal();
    ...
    public static class IllegalCharacterValueSanitizer implements android.net.UrlQuerySanitizer.ValueSanitizer {
         ...
         */
        public static final int SPACE_OK = 1 << 0;
         ...
         */
        public static final int OTHER_WHITESPACE_OK = 1 << 1;

        /**
         * Allow characters with character codes 128 to 255.
         */
        public static final int NON_7_BIT_ASCII_OK = 1 << 2;

        /**
         * Allow double quote characters. ('"')
         */
        public static final int DQUOTE_OK = 1 << 3;

        /**
         * Allow single quote characters. ('\'')
         */
        public static final int SQUOTE_OK = 1 << 4;

        /**
         * Allow less-than characters. ('<')
         */
        public static final int LT_OK = 1 << 5;

        /**
         * Allow greater-than characters. ('>')
         */
        public static final int GT_OK = 1 << 6;

        /**
         * Allow ampersand characters ('&')
         */
        public static final int AMP_OK = 1 << 7;

        /**
         * Allow percent-sign characters ('%')
         */
        public static final int PCT_OK = 1 << 8;

        /**
         * Allow nul characters ('\0')
         */
        public static final int NUL_OK = 1 << 9;

        /**
         * Allow text to start with a script URL
         * such as "javascript:" or "vbscript:"
         */
        public static final int SCRIPT_URL_OK = 1 << 10;

        /**
         * Mask with all fields set to OK
         */
        public static final int ALL_OK = 0x7ff;

        /**
         * Mask with both regular space and other whitespace OK
         */
        public static final int ALL_WHITESPACE_OK = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.OTHER_WHITESPACE_OK;
         ...
         * </ul>
         */
        public static final int ALL_BUT_NUL_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_OK & (~android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NUL_OK);
         ...
         * </ul>
         */
        public static final int ALL_BUT_WHITESPACE_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_OK & (~(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_WHITESPACE_OK | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NUL_OK));
         ...
         * </ul>
         */
        public static final int URL_LEGAL = ((android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NON_7_BIT_ASCII_OK | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SQUOTE_OK) | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_OK) | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.PCT_OK;
         ...
         * </ul>
         */
        public static final int URL_AND_SPACE_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.URL_LEGAL | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK;
         ...
         * </ul>
         */
        public static final int AMP_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_OK;
         ...
         * </ul>
         */
        public static final int AMP_AND_SPACE_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_OK | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK;
         ...
         * </ul>
         */
        public static final int SPACE_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK;
         ...
         * </ul>
         */
        public static final int ALL_BUT_NUL_AND_ANGLE_BRACKETS_LEGAL = android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_OK & (~((android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NUL_OK | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.LT_OK) | android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.GT_OK));
        ...
        private static final int MIN_SCRIPT_PREFIX_LENGTH = java.lang.Math.min(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.JAVASCRIPT_PREFIX.length(), android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.VBSCRIPT_PREFIX.length());
        ...
        public java.lang.String sanitize(java.lang.String value) {
            ...
            if ((mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SCRIPT_URL_OK) != 0) {
                if (length >= android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.MIN_SCRIPT_PREFIX_LENGTH) {
                    java.lang.String asLower = value.toLowerCase(java.util.Locale.ROOT);
                    if (asLower.startsWith(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.JAVASCRIPT_PREFIX) || asLower.startsWith(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.VBSCRIPT_PREFIX)) {
                        return "";
                    }
                }
            }
            ...
            // and end of value.
            if ((mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_WHITESPACE_OK) == 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!characterIsLegal(c)) {
                    if ((mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK) != 0) {
                        c = ' ';
                    } else {
                        c = '_';
                    }
         ...
         */
        private java.lang.String trimWhitespace(java.lang.String value) {
            int start = 0;
        ...
        private boolean characterIsLegal(char c) {
            switch (c) {
                case ' ' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_OK) != 0;
                case '\t' :
                case '\f' :
                case '\n' :
                case '\r' :
                case 11 :
                    /* VT */
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.OTHER_WHITESPACE_OK) != 0;
                case '\"' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.DQUOTE_OK) != 0;
                case '\'' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SQUOTE_OK) != 0;
                case '<' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.LT_OK) != 0;
                case '>' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.GT_OK) != 0;
                case '&' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_OK) != 0;
                case '%' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.PCT_OK) != 0;
                case '\u0000' :
                    return (mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NUL_OK) != 0;
                default :
                    return ((c >= 32) && (c < 127)) || ((c >= 128) && ((mFlags & android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.NON_7_BIT_ASCII_OK) != 0));
            }
        }
    }
    ...
    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAllIllegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_ILLEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAllButNulLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_BUT_NUL_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAllButWhitespaceLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_BUT_WHITESPACE_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sURLLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.URL_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sUrlAndSpaceLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.URL_AND_SPACE_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAmpLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAmpAndSpaceLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.AMP_AND_SPACE_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sSpaceLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.SPACE_LEGAL);

    private static final android.net.UrlQuerySanitizer.ValueSanitizer sAllButNulAndAngleBracketsLegal = new android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer(android.net.UrlQuerySanitizer.IllegalCharacterValueSanitizer.ALL_BUT_NUL_AND_ANGLE_BRACKETS_LEGAL);
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAllIllegal() {
        return android.net.UrlQuerySanitizer.sAllIllegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAllButNulLegal() {
        return android.net.UrlQuerySanitizer.sAllButNulLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAllButWhitespaceLegal() {
        return android.net.UrlQuerySanitizer.sAllButWhitespaceLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getUrlLegal() {
        return android.net.UrlQuerySanitizer.sURLLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getUrlAndSpaceLegal() {
        return android.net.UrlQuerySanitizer.sUrlAndSpaceLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAmpLegal() {
        return android.net.UrlQuerySanitizer.sAmpLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAmpAndSpaceLegal() {
        return android.net.UrlQuerySanitizer.sAmpAndSpaceLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getSpaceLegal() {
        return android.net.UrlQuerySanitizer.sSpaceLegal;
    }
    ...
    public static final android.net.UrlQuerySanitizer.ValueSanitizer getAllButNulAndAngleBracketsLegal() {
        return android.net.UrlQuerySanitizer.sAllButNulAndAngleBracketsLegal;
    }
    ...
    public void parseQuery(java.lang.String query) {
        ...
        while (tokenizer.hasMoreElements()) {
            java.lang.String attributeValuePair = tokenizer.nextToken();
     ...
     */
    public void registerParameter(java.lang.String parameter, android.net.UrlQuerySanitizer.ValueSanitizer valueSanitizer) {
     ...
     */
    public void registerParameters(java.lang.String[] parameters, android.net.UrlQuerySanitizer.ValueSanitizer valueSanitizer) {
     ...
     * Defaults to false.
     *
     * @param allowUnregisteredParamaters
     ...
     * defaults to false.
     *
     * @param preferFirstRepeatedParameter
     ...
     */
    protected void parseEntry(java.lang.String parameter, java.lang.String value) {
        java.lang.String unescapedParameter = unescape(parameter);
        android.net.UrlQuerySanitizer.ValueSanitizer valueSanitizer = getEffectiveValueSanitizer(unescapedParameter);
        if (valueSanitizer == null) {
            return;
        }
        java.lang.String unescapedValue = unescape(value);
        java.lang.String sanitizedValue = valueSanitizer.sanitize(unescapedValue);
     ...
     * @param value
     * 		a sanitized unescaped value
     */
    protected void addSanitizedEntry(java.lang.String parameter, java.lang.String value) {
        mEntriesList.add(new android.net.UrlQuerySanitizer.ParameterValuePair(parameter, value));
    ...
    public android.net.UrlQuerySanitizer.ValueSanitizer getEffectiveValueSanitizer(java.lang.String parameter) {
        android.net.UrlQuerySanitizer.ValueSanitizer sanitizer = getValueSanitizer(parameter);
