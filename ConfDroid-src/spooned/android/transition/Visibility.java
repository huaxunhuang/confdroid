...
public abstract class Visibility extends android.transition.Transition {
    ...
    @android.annotation.IntDef(flag = true, value = { android.transition.Visibility.MODE_IN, android.transition.Visibility.MODE_OUT, android.transition.Fade.IN, android.transition.Fade.OUT })
    ...
    private static final java.lang.String[] sTransitionProperties = new java.lang.String[]{ android.transition.Visibility.PROPNAME_VISIBILITY, android.transition.Visibility.PROPNAME_PARENT };
    ...
    private int mMode = android.transition.Visibility.MODE_IN | android.transition.Visibility.MODE_OUT;
    ...
    public Visibility(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.VisibilityTransition);
     ...
     *
     * @param mode
     * 		The behavior supported by this transition, a combination of
     * 		{@link #MODE_IN} and {@link #MODE_OUT}.
     * @unknown ref android.R.styleable#VisibilityTransition_transitionVisibilityMode
     */
    public void setMode(@android.transition.Visibility.VisibilityMode
    int mode) {
        if ((mode & (~(android.transition.Visibility.MODE_IN | android.transition.Visibility.MODE_OUT))) != 0) {
    ...
    public java.lang.String[] getTransitionProperties() {
        return android.transition.Visibility.sTransitionProperties;
    }

    private void captureValues(android.transition.TransitionValues transitionValues) {
        int visibility = transitionValues.view.getVisibility();
        transitionValues.values.put(android.transition.Visibility.PROPNAME_VISIBILITY, visibility);
        transitionValues.values.put(android.transition.Visibility.PROPNAME_PARENT, transitionValues.view.getParent());
        int[] loc = new int[2];
        transitionValues.view.getLocationOnScreen(loc);
        transitionValues.values.put(android.transition.Visibility.PROPNAME_SCREEN_LOCATION, loc);
    }
    ...
    public boolean isVisible(android.transition.TransitionValues values) {
        ...
        int visibility = ((java.lang.Integer) (values.values.get(android.transition.Visibility.PROPNAME_VISIBILITY)));
        android.view.View parent = ((android.view.View) (values.values.get(android.transition.Visibility.PROPNAME_PARENT)));
        return (visibility == android.view.View.VISIBLE) && (parent != null);
    }

    private static android.transition.Visibility.VisibilityInfo getVisibilityChangeInfo(android.transition.TransitionValues startValues, android.transition.TransitionValues endValues) {
        final android.transition.Visibility.VisibilityInfo visInfo = new android.transition.Visibility.VisibilityInfo();
        visInfo.visibilityChange = false;
        visInfo.fadeIn = false;
        if ((startValues != null) && startValues.values.containsKey(android.transition.Visibility.PROPNAME_VISIBILITY)) {
            visInfo.startVisibility = ((java.lang.Integer) (startValues.values.get(android.transition.Visibility.PROPNAME_VISIBILITY)));
            visInfo.startParent = ((android.view.ViewGroup) (startValues.values.get(android.transition.Visibility.PROPNAME_PARENT)));
        } else {
            visInfo.startVisibility = -1;
            visInfo.startParent = null;
        }
        if ((endValues != null) && endValues.values.containsKey(android.transition.Visibility.PROPNAME_VISIBILITY)) {
            visInfo.endVisibility = ((java.lang.Integer) (endValues.values.get(android.transition.Visibility.PROPNAME_VISIBILITY)));
            visInfo.endParent = ((android.view.ViewGroup) (endValues.values.get(android.transition.Visibility.PROPNAME_PARENT)));
        } else {
        ...
        if ((startValues != null) && (endValues != null)) {
            if ((visInfo.startVisibility == visInfo.endVisibility) && (visInfo.startParent == visInfo.endParent)) {
                ...
                if (visInfo.startVisibility != visInfo.endVisibility) {
                    if (visInfo.startVisibility == android.view.View.VISIBLE) {
                        visInfo.fadeIn = false;
                        visInfo.visibilityChange = true;
                    } else
                        if (visInfo.endVisibility == android.view.View.VISIBLE) {
                            visInfo.fadeIn = true;
                            visInfo.visibilityChange = true;
                        }
            ...
            if ((startValues == null) && (visInfo.endVisibility == android.view.View.VISIBLE)) {
                visInfo.fadeIn = true;
                visInfo.visibilityChange = true;
            } else
                if ((endValues == null) && (visInfo.startVisibility == android.view.View.VISIBLE)) {
                    visInfo.fadeIn = false;
                    visInfo.visibilityChange = true;
                }
    ...
    public android.animation.Animator createAnimator(android.view.ViewGroup sceneRoot, android.transition.TransitionValues startValues, android.transition.TransitionValues endValues) {
        android.transition.Visibility.VisibilityInfo visInfo = android.transition.Visibility.getVisibilityChangeInfo(startValues, endValues);
    ...
    public android.animation.Animator onAppear(android.view.ViewGroup sceneRoot, android.transition.TransitionValues startValues, int startVisibility, android.transition.TransitionValues endValues, int endVisibility) {
        if (((mMode & android.transition.Visibility.MODE_IN) != android.transition.Visibility.MODE_IN) || (endValues == null)) {
            return null;
        }
        if (startValues == null) {
            android.transition.Visibility.VisibilityInfo parentVisibilityInfo = null;
            android.view.View endParent = ((android.view.View) (endValues.view.getParent()));
            android.transition.TransitionValues startParentValues = getMatchedTransitionValues(endParent, false);
            android.transition.TransitionValues endParentValues = getTransitionValues(endParent, false);
            parentVisibilityInfo = android.transition.Visibility.getVisibilityChangeInfo(startParentValues, endParentValues);
    ...
    public android.animation.Animator onDisappear(android.view.ViewGroup sceneRoot, android.transition.TransitionValues startValues, int startVisibility, android.transition.TransitionValues endValues, int endVisibility) {
        if ((mMode & android.transition.Visibility.MODE_OUT) != android.transition.Visibility.MODE_OUT) {
            return null;
        }
        if (startValues == null) {
        ...
        final android.view.View startView = startValues.view;
        final android.view.View endView = (endValues != null) ? endValues.view : null;
        android.view.View overlayView = null;
        android.view.View viewToKeep = null;
        boolean reusingOverlayView = false;
        android.view.View savedOverlayView = ((android.view.View) (startView.getTag(R.id.transition_overlay_view_tag)));
        if (savedOverlayView != null) {
            ...
            if (needOverlayForStartView) {
                ...
                if (startView.getParent() == null) {
                    ...
                    if (startView.getParent() instanceof android.view.View) {
                        android.view.View startParent = ((android.view.View) (startView.getParent()));
                        android.transition.TransitionValues startParentValues = getTransitionValues(startParent, true);
                        android.transition.TransitionValues endParentValues = getMatchedTransitionValues(startParent, true);
                        android.transition.Visibility.VisibilityInfo parentVisibilityInfo = android.transition.Visibility.getVisibilityChangeInfo(startParentValues, endParentValues);
                        if (!parentVisibilityInfo.visibilityChange) {
                            overlayView = android.transition.TransitionUtils.copyViewImage(sceneRoot, startView, startParent);
                        } else {
                            int id = startParent.getId();
                            if ((((startParent.getParent() == null) && (id != android.view.View.NO_ID)) && (sceneRoot.findViewById(id) != null)) && mCanRemoveViews) {
        ...
        if (overlayView != null) {
            ...
            final android.view.ViewGroupOverlay overlay;
            if (!reusingOverlayView) {
                overlay = sceneRoot.getOverlay();
                int[] screenLoc = ((int[]) (startValues.values.get(android.transition.Visibility.PROPNAME_SCREEN_LOCATION)));
            ...
            android.animation.Animator animator = onDisappear(sceneRoot, overlayView, startValues, endValues);
            if (!reusingOverlayView) {
                if (animator == null) {
        ...
        if (viewToKeep != null) {
            ...
            viewToKeep.setTransitionVisibility(android.view.View.VISIBLE);
            android.animation.Animator animator = onDisappear(sceneRoot, viewToKeep, startValues, endValues);
            if (animator != null) {
                android.transition.Visibility.DisappearListener disappearListener = new android.transition.Visibility.DisappearListener(viewToKeep, endVisibility, mSuppressLayout);
    ...
    @java.lang.Override
    public boolean isTransitionRequired(android.transition.TransitionValues startValues, android.transition.TransitionValues newValues) {
        if ((startValues == null) && (newValues == null)) {
            return false;
        }
        if (((startValues != null) && (newValues != null)) && (newValues.values.containsKey(android.transition.Visibility.PROPNAME_VISIBILITY) != startValues.values.containsKey(android.transition.Visibility.PROPNAME_VISIBILITY))) {
            // The transition wasn't targeted in either the start or end, so it couldn't
            // have changed.
            return false;
        }
        android.transition.Visibility.VisibilityInfo changeInfo = android.transition.Visibility.getVisibilityChangeInfo(startValues, newValues);
        return changeInfo.visibilityChange && ((changeInfo.startVisibility == android.view.View.VISIBLE) || (changeInfo.endVisibility == android.view.View.VISIBLE));
    }
    ...
    private static class DisappearListener extends android.transition.TransitionListenerAdapter implements android.animation.Animator.AnimatorListener , android.animation.Animator.AnimatorPauseListener {
        ...
        public DisappearListener(android.view.View view, int finalVisibility, boolean suppressLayout) {
            this.mView = view;
