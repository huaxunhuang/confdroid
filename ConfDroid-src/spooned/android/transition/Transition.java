...
public abstract class Transition implements java.lang.Cloneable {
    ...
    private static final int MATCH_FIRST = android.transition.Transition.MATCH_INSTANCE;
    ...
    private static final int MATCH_LAST = android.transition.Transition.MATCH_ITEM_ID;
    ...
    private static final int[] DEFAULT_MATCH_ORDER = new int[]{ android.transition.Transition.MATCH_NAME, android.transition.Transition.MATCH_INSTANCE, android.transition.Transition.MATCH_ID, android.transition.Transition.MATCH_ITEM_ID };

    private static final android.transition.PathMotion STRAIGHT_PATH_MOTION = new android.transition.PathMotion() {
        @java.lang.Override
    ...
    java.util.ArrayList<java.lang.Integer> mTargetIds = new java.util.ArrayList<java.lang.Integer>();

    java.util.ArrayList<android.view.View> mTargets = new java.util.ArrayList<android.view.View>();
    ...
    int[] mMatchOrder = android.transition.Transition.DEFAULT_MATCH_ORDER;

    java.util.ArrayList<android.transition.TransitionValues> mStartValuesList;// only valid after playTransition starts


    java.util.ArrayList<android.transition.TransitionValues> mEndValuesList;// only valid after playTransitions starts


    // Per-animator information used for later canceling when future transitions overlap
    private static java.lang.ThreadLocal<android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo>> sRunningAnimators = new java.lang.ThreadLocal<android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo>>();
    ...
    private java.util.ArrayList<android.animation.Animator> mCurrentAnimators = new java.util.ArrayList<android.animation.Animator>();
    ...
    java.util.ArrayList<android.animation.Animator> mAnimators = new java.util.ArrayList<android.animation.Animator>();
    ...
    android.transition.PathMotion mPathMotion = android.transition.Transition.STRAIGHT_PATH_MOTION;
    ...
    public Transition(android.content.Context context, android.util.AttributeSet attrs) {
        android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Transition);
        ...
        java.lang.String matchOrder = a.getString(R.styleable.Transition_matchOrder);
        if (matchOrder != null) {
            setMatchOrder(android.transition.Transition.parseMatchOrder(matchOrder));
        }
        a.recycle();
    }

    private static int[] parseMatchOrder(java.lang.String matchOrderString) {
        java.util.StringTokenizer st = new java.util.StringTokenizer(matchOrderString, ",");
        int[] matches = new int[st.countTokens()];
        int index = 0;
        while (st.hasMoreTokens()) {
            java.lang.String token = st.nextToken().trim();
            if (android.transition.Transition.MATCH_ID_STR.equalsIgnoreCase(token)) {
                matches[index] = android.transition.Transition.MATCH_ID;
            } else
                if (android.transition.Transition.MATCH_INSTANCE_STR.equalsIgnoreCase(token)) {
                    matches[index] = android.transition.Transition.MATCH_INSTANCE;
                } else
                    if (android.transition.Transition.MATCH_NAME_STR.equalsIgnoreCase(token)) {
                        matches[index] = android.transition.Transition.MATCH_NAME;
                    } else
                        if (android.transition.Transition.MATCH_VIEW_NAME_STR.equalsIgnoreCase(token)) {
                            matches[index] = android.transition.Transition.MATCH_NAME;
                        } else
                            if (android.transition.Transition.MATCH_ITEM_ID_STR.equalsIgnoreCase(token)) {
                                matches[index] = android.transition.Transition.MATCH_ITEM_ID;
                            } else
                                if (token.isEmpty()) {
                                    int[] smallerMatches = new int[matches.length - 1];
                                    java.lang.System.arraycopy(matches, 0, smallerMatches, 0, index);
                                    matches = smallerMatches;
                                    index--;
                                } else {
                                    throw new android.view.InflateException(("Unknown match type in matchOrder: '" + token) + "'");
                                }
     ...
     * @unknown ref android.R.styleable#Transition_duration
     */
     ...
     * @return This transition object.
     * @unknown ref android.R.styleable#Transition_startDelay
     */
     ...
     * @return This transition object.
     * @unknown ref android.R.styleable#Transition_interpolator
     */
     ...
     *
     * @param matches
     * 		A list of zero or more of {@link #MATCH_INSTANCE},
    ...
    public void setMatchOrder(int... matches) {
        if ((matches == null) || (matches.length == 0)) {
            mMatchOrder = android.transition.Transition.DEFAULT_MATCH_ORDER;
        } else {
            for (int i = 0; i < matches.length; i++) {
                int match = matches[i];
                if (!android.transition.Transition.isValidMatch(match)) {
                    throw new java.lang.IllegalArgumentException("matches contains invalid value");
                }
                if (android.transition.Transition.alreadyContains(matches, i)) {
    ...
    private static boolean isValidMatch(int match) {
        return (match >= android.transition.Transition.MATCH_FIRST) && (match <= android.transition.Transition.MATCH_LAST);
    }
     ...
     */
    private void matchInstances(android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart, android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd) {
        for (int i = unmatchedStart.size() - 1; i >= 0; i--) {
            android.view.View view = unmatchedStart.keyAt(i);
            if ((view != null) && isValidTarget(view)) {
                android.transition.TransitionValues end = unmatchedEnd.remove(view);
                if ((end != null) && isValidTarget(end.view)) {
                    android.transition.TransitionValues start = unmatchedStart.removeAt(i);
     ...
     */
    private void matchItemIds(android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart, android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd, android.util.LongSparseArray<android.view.View> startItemIds, android.util.LongSparseArray<android.view.View> endItemIds) {
        int numStartIds = startItemIds.size();
        for (int i = 0; i < numStartIds; i++) {
            android.view.View startView = startItemIds.valueAt(i);
            if ((startView != null) && isValidTarget(startView)) {
                android.view.View endView = endItemIds.get(startItemIds.keyAt(i));
                if ((endView != null) && isValidTarget(endView)) {
                    android.transition.TransitionValues startValues = unmatchedStart.get(startView);
                    android.transition.TransitionValues endValues = unmatchedEnd.get(endView);
     ...
     */
    private void matchIds(android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart, android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd, android.util.SparseArray<android.view.View> startIds, android.util.SparseArray<android.view.View> endIds) {
        int numStartIds = startIds.size();
        for (int i = 0; i < numStartIds; i++) {
            android.view.View startView = startIds.valueAt(i);
            if ((startView != null) && isValidTarget(startView)) {
                android.view.View endView = endIds.get(startIds.keyAt(i));
                if ((endView != null) && isValidTarget(endView)) {
                    android.transition.TransitionValues startValues = unmatchedStart.get(startView);
                    android.transition.TransitionValues endValues = unmatchedEnd.get(endView);
                    if ((startValues != null) && (endValues != null)) {
     ...
     */
    private void matchNames(android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart, android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd, android.util.ArrayMap<java.lang.String, android.view.View> startNames, android.util.ArrayMap<java.lang.String, android.view.View> endNames) {
        int numStartNames = startNames.size();
        for (int i = 0; i < numStartNames; i++) {
            android.view.View startView = startNames.valueAt(i);
            if ((startView != null) && isValidTarget(startView)) {
                android.view.View endView = endNames.get(startNames.keyAt(i));
                if ((endView != null) && isValidTarget(endView)) {
                    android.transition.TransitionValues startValues = unmatchedStart.get(startView);
                    android.transition.TransitionValues endValues = unmatchedEnd.get(endView);
                    if ((startValues != null) && (endValues != null)) {
     ...
     */
    private void addUnmatched(android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart, android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd) {
        // Views that only exist in the start Scene
        for (int i = 0; i < unmatchedStart.size(); i++) {
            final android.transition.TransitionValues start = unmatchedStart.valueAt(i);
        ...
        for (int i = 0; i < unmatchedEnd.size(); i++) {
            final android.transition.TransitionValues end = unmatchedEnd.valueAt(i);
    ...
    private void matchStartAndEnd(android.transition.TransitionValuesMaps startValues, android.transition.TransitionValuesMaps endValues) {
        android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedStart = new android.util.ArrayMap<android.view.View, android.transition.TransitionValues>(startValues.viewValues);
        android.util.ArrayMap<android.view.View, android.transition.TransitionValues> unmatchedEnd = new android.util.ArrayMap<android.view.View, android.transition.TransitionValues>(endValues.viewValues);
        for (int i = 0; i < mMatchOrder.length; i++) {
            switch (mMatchOrder[i]) {
                case android.transition.Transition.MATCH_INSTANCE :
                    matchInstances(unmatchedStart, unmatchedEnd);
                    break;
                case android.transition.Transition.MATCH_NAME :
                    matchNames(unmatchedStart, unmatchedEnd, startValues.nameValues, endValues.nameValues);
                    break;
                case android.transition.Transition.MATCH_ID :
                    matchIds(unmatchedStart, unmatchedEnd, startValues.idValues, endValues.idValues);
                    break;
                case android.transition.Transition.MATCH_ITEM_ID :
    ...
    protected void createAnimators(android.view.ViewGroup sceneRoot, android.transition.TransitionValuesMaps startValues, android.transition.TransitionValuesMaps endValues, java.util.ArrayList<android.transition.TransitionValues> startValuesList, java.util.ArrayList<android.transition.TransitionValues> endValuesList) {
        if (android.transition.Transition.DBG) {
            android.util.Log.d(android.transition.Transition.LOG_TAG, "createAnimators() for " + this);
        }
        android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> runningAnimators = android.transition.Transition.getRunningAnimators();
        long minStartDelay = java.lang.Long.MAX_VALUE;
        int minAnimator = mAnimators.size();
        android.util.SparseLongArray startDelays = new android.util.SparseLongArray();
        int startValuesListCount = startValuesList.size();
        for (int i = 0; i < startValuesListCount; ++i) {
            android.transition.TransitionValues start = startValuesList.get(i);
            android.transition.TransitionValues end = endValuesList.get(i);
            ...
            if (isChanged) {
                if (android.transition.Transition.DBG) {
                    ...
                    android.util.Log.d(android.transition.Transition.LOG_TAG, "  differing start/end values for view " + view);
                    if ((start == null) || (end == null)) {
                        android.util.Log.d(android.transition.Transition.LOG_TAG, "    " + (start == null ? "start null, end non-null" : "start non-null, end null"));
                    } else {
                        for (java.lang.String key : start.values.keySet()) {
                            ...
                            if ((startValue != endValue) && (!startValue.equals(endValue))) {
                                android.util.Log.d(android.transition.Transition.LOG_TAG, ((((("    " + key) + ": start(") + startValue) + "), end(") + endValue) + ")");
                            }
                        }
                    }
                }
                ...
                if (animator != null) {
                    ...
                    android.transition.TransitionValues infoValues = null;
                    if (end != null) {
                        view = end.view;
                        java.lang.String[] properties = getTransitionProperties();
                        if ((properties != null) && (properties.length > 0)) {
                            infoValues = new android.transition.TransitionValues(view);
                            android.transition.TransitionValues newValues = endValues.viewValues.get(view);
                            if (newValues != null) {
                            ...
                            for (int j = 0; j < numExistingAnims; ++j) {
                                ...
                                android.transition.Transition.AnimationInfo info = runningAnimators.get(anim);
                    ...
                    if (animator != null) {
                        if (mPropagation != null) {
                            ...
                            minStartDelay = java.lang.Math.min(delay, minStartDelay);
                        }
                        android.transition.Transition.AnimationInfo info = new android.transition.Transition.AnimationInfo(view, getName(), this, sceneRoot.getWindowId(), infoValues);
        ...
        if (startDelays.size() != 0) {
            for (int i = 0; i < startDelays.size(); i++) {
                ...
                android.animation.Animator animator = mAnimators.get(index);
     ...
     * @unknown 
     */
    public boolean isValidTarget(android.view.View target) {
        if (target == null) {
            return false;
        }
    ...
    private static android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> getRunningAnimators() {
        android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> runningAnimators = android.transition.Transition.sRunningAnimators.get();
        if (runningAnimators == null) {
            runningAnimators = new android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo>();
            android.transition.Transition.sRunningAnimators.set(runningAnimators);
        }
    ...
    protected void runAnimators() {
        if (android.transition.Transition.DBG) {
            android.util.Log.d(android.transition.Transition.LOG_TAG, "runAnimators() on " + this);
        }
        start();
        android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> runningAnimators = android.transition.Transition.getRunningAnimators();
        ...
        for (android.animation.Animator anim : mAnimators) {
            if (android.transition.Transition.DBG) {
                android.util.Log.d(android.transition.Transition.LOG_TAG, "  anim: " + anim);
            }
    ...
    private void runAnimator(android.animation.Animator animator, final android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> runningAnimators) {
        if (animator != null) {
    ...
    public android.transition.Transition addTarget(java.lang.String targetName) {
        if (targetName != null) {
            if (mTargetNames == null) {
                mTargetNames = new java.util.ArrayList<java.lang.String>();
            }
    ...
    public android.transition.Transition addTarget(java.lang.Class targetType) {
        if (targetType != null) {
            if (mTargetTypes == null) {
                mTargetTypes = new java.util.ArrayList<java.lang.Class>();
            }
    ...
    public android.transition.Transition excludeTarget(int targetId, boolean exclude) {
        if (targetId >= 0) {
            mTargetIdExcludes = android.transition.Transition.excludeObject(mTargetIdExcludes, targetId, exclude);
        }
        return this;
    }
    ...
    public android.transition.Transition excludeTarget(java.lang.String targetName, boolean exclude) {
        mTargetNameExcludes = android.transition.Transition.excludeObject(mTargetNameExcludes, targetName, exclude);
        return this;
    }
    ...
    public android.transition.Transition excludeChildren(int targetId, boolean exclude) {
        if (targetId >= 0) {
            mTargetIdChildExcludes = android.transition.Transition.excludeObject(mTargetIdChildExcludes, targetId, exclude);
        }
        return this;
    }
    ...
    public android.transition.Transition excludeTarget(android.view.View target, boolean exclude) {
        mTargetExcludes = android.transition.Transition.excludeObject(mTargetExcludes, target, exclude);
        return this;
    }
    ...
    public android.transition.Transition excludeChildren(android.view.View target, boolean exclude) {
        mTargetChildExcludes = android.transition.Transition.excludeObject(mTargetChildExcludes, target, exclude);
        return this;
    }
     ...
     */
    private static <T> java.util.ArrayList<T> excludeObject(java.util.ArrayList<T> list, T target, boolean exclude) {
        if (target != null) {
            if (exclude) {
                list = android.transition.Transition.ArrayListManager.add(list, target);
            } else {
                list = android.transition.Transition.ArrayListManager.remove(list, target);
            }
        }
        return list;
    }
    ...
    public android.transition.Transition excludeTarget(java.lang.Class type, boolean exclude) {
        mTargetTypeExcludes = android.transition.Transition.excludeObject(mTargetTypeExcludes, type, exclude);
        return this;
    }
    ...
    public android.transition.Transition excludeChildren(java.lang.Class type, boolean exclude) {
        mTargetTypeChildExcludes = android.transition.Transition.excludeObject(mTargetTypeChildExcludes, type, exclude);
        return this;
    }
    ...
    void captureValues(android.view.ViewGroup sceneRoot, boolean start) {
        ...
        if ((((mTargetIds.size() > 0) || (mTargets.size() > 0)) && ((mTargetNames == null) || mTargetNames.isEmpty())) && ((mTargetTypes == null) || mTargetTypes.isEmpty())) {
            for (int i = 0; i < mTargetIds.size(); ++i) {
                ...
                if (view != null) {
                    android.transition.TransitionValues values = new android.transition.TransitionValues(view);
                    if (start) {
                    ...
                    if (start) {
                        android.transition.Transition.addViewValues(mStartValues, view, values);
                    } else {
                        android.transition.Transition.addViewValues(mEndValues, view, values);
                    }
                }
            }
        ...
        if ((!start) && (mNameOverrides != null)) {
            ...
            java.util.ArrayList<android.view.View> overriddenViews = new java.util.ArrayList<android.view.View>(numOverrides);
            for (int i = 0; i < numOverrides; i++) {
                java.lang.String fromName = mNameOverrides.keyAt(i);
                overriddenViews.add(mStartValues.nameValues.remove(fromName));
            }
            for (int i = 0; i < numOverrides; i++) {
                android.view.View view = overriddenViews.get(i);
                if (view != null) {
                    java.lang.String toName = mNameOverrides.valueAt(i);
        ...
        if (view.getParent() instanceof android.widget.ListView) {
            ...
            if (listview.getAdapter().hasStableIds()) {
                ...
                if (transitionValuesMaps.itemIdValues.indexOfKey(itemId) >= 0) {
                    ...
                    android.view.View alreadyMatched = transitionValuesMaps.itemIdValues.get(itemId);
     ...
     */
    public android.transition.TransitionValues getTransitionValues(android.view.View view, boolean start) {
        if (mParent != null) {
            return mParent.getTransitionValues(view, start);
        }
        android.transition.TransitionValuesMaps valuesMaps = (start) ? mStartValues : mEndValues;
     ...
     *
     * @param view
     * 		The view to find the match for.
     * @param viewInStart
     * 		Is View from the start values or end values.
     ...
     */
    android.transition.TransitionValues getMatchedTransitionValues(android.view.View view, boolean viewInStart) {
        if (mParent != null) {
            return mParent.getMatchedTransitionValues(view, viewInStart);
        }
        java.util.ArrayList<android.transition.TransitionValues> lookIn = (viewInStart) ? mStartValuesList : mEndValuesList;
        if (lookIn == null) {
            return null;
        }
        ...
        for (int i = 0; i < count; i++) {
            android.transition.TransitionValues values = lookIn.get(i);
            if (values == null) {
        ...
        android.transition.TransitionValues values = null;
        if (index >= 0) {
            java.util.ArrayList<android.transition.TransitionValues> matchIn = (viewInStart) ? mEndValuesList : mStartValuesList;
    ...
    /**
     * Pauses this transition, sending out calls to {@link TransitionListener#onTransitionPause(Transition)} to all listeners
    ...
    public void pause(android.view.View sceneRoot) {
        if (!mEnded) {
            ...
            if (sceneRoot != null) {
                android.view.WindowId windowId = sceneRoot.getWindowId();
                for (int i = numOldAnims - 1; i >= 0; i--) {
                    android.transition.Transition.AnimationInfo info = runningAnimators.valueAt(i);
            ...
            if ((mListeners != null) && (mListeners.size() > 0)) {
                java.util.ArrayList<android.transition.Transition.TransitionListener> tmpListeners = ((java.util.ArrayList<android.transition.Transition.TransitionListener>) (mListeners.clone()));
    ...
    /**
     * Resumes this transition, sending out calls to {@link TransitionListener#onTransitionPause(Transition)} to all listeners
     * and pausing all running animators started by this transition.
     *
     * @unknown 
     */
    ...
    void playTransition(android.view.ViewGroup sceneRoot) {
        mStartValuesList = new java.util.ArrayList<android.transition.TransitionValues>();
        mEndValuesList = new java.util.ArrayList<android.transition.TransitionValues>();
        ...
        for (int i = numOldAnims - 1; i >= 0; i--) {
            android.animation.Animator anim = runningAnimators.keyAt(i);
            if (anim != null) {
                android.transition.Transition.AnimationInfo oldInfo = runningAnimators.get(anim);
                if (((oldInfo != null) && (oldInfo.view != null)) && (oldInfo.windowId == windowId)) {
                    android.transition.TransitionValues oldValues = oldInfo.values;
                    android.view.View oldView = oldInfo.view;
                    android.transition.TransitionValues startValues = getTransitionValues(oldView, true);
                    android.transition.TransitionValues endValues = getMatchedTransitionValues(oldView, true);
                    if ((startValues == null) && (endValues == null)) {
                    ...
                    if (cancel) {
                        if (anim.isRunning() || anim.isStarted()) {
                            if (android.transition.Transition.DBG) {
                                android.util.Log.d(android.transition.Transition.LOG_TAG, "Canceling anim " + anim);
                            }
                            anim.cancel();
                        } else {
                            if (android.transition.Transition.DBG) {
                                android.util.Log.d(android.transition.Transition.LOG_TAG, "removing anim from info list: " + anim);
                            }
     ...
     *
     * @param startValues
     * 		the values from captureStartValues, This may be {@code null} if the
     * 		View did not exist in the start state.
     * @param endValues
     * 		the values from captureEndValues. This may be {@code null} if the View
     * 		did not exist in the end state.
     */
    public boolean isTransitionRequired(@android.annotation.Nullable
    android.transition.TransitionValues startValues, @android.annotation.Nullable
    android.transition.TransitionValues endValues) {
        ...
        if ((startValues != null) && (endValues != null)) {
            ...
            if (properties != null) {
                ...
                for (int i = 0; i < count; i++) {
                    if (android.transition.Transition.isValueChanged(startValues, endValues, properties[i])) {
                        valuesChanged = true;
                        break;
                    }
                }
            } else {
                for (java.lang.String key : startValues.values.keySet()) {
                    if (android.transition.Transition.isValueChanged(startValues, endValues, key)) {
                        valuesChanged = true;
                        break;
                    }
                }
    ...
    private static boolean isValueChanged(android.transition.TransitionValues oldValues, android.transition.TransitionValues newValues, java.lang.String key) {
        ...
        if (android.transition.Transition.DBG && changed) {
            android.util.Log.d(android.transition.Transition.LOG_TAG, ((((("Transition.playTransition: " + "oldValue != newValue for ") + key) + ": old, new = ") + oldValue) + ", ") + newValue);
        }
        return changed;
    }
    ...
    protected void end() {
        ...
        if (mNumInstances == 0) {
            ...
            for (int i = 0; i < mStartValues.itemIdValues.size(); ++i) {
                android.view.View view = mStartValues.itemIdValues.valueAt(i);
                if (view != null) {
                    view.setHasTransientState(false);
                }
            }
            for (int i = 0; i < mEndValues.itemIdValues.size(); ++i) {
                android.view.View view = mEndValues.itemIdValues.valueAt(i);
                if (view != null) {
                    view.setHasTransientState(false);
                }
            }
    ...
    void forceToEnd(android.view.ViewGroup sceneRoot) {
        final android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> runningAnimators = android.transition.Transition.getRunningAnimators();
        int numOldAnims = runningAnimators.size();
        if ((sceneRoot == null) || (numOldAnims == 0)) {
            return;
        }
        android.view.WindowId windowId = sceneRoot.getWindowId();
        final android.util.ArrayMap<android.animation.Animator, android.transition.Transition.AnimationInfo> oldAnimators = new android.util.ArrayMap(runningAnimators);
        runningAnimators.clear();
        for (int i = numOldAnims - 1; i >= 0; i--) {
            android.transition.Transition.AnimationInfo info = oldAnimators.valueAt(i);
            if (((info.view != null) && (windowId != null)) && windowId.equals(info.windowId)) {
                android.animation.Animator anim = oldAnimators.keyAt(i);
                anim.end();
            }
        }
    }
    ...
    public android.transition.Transition addListener(android.transition.Transition.TransitionListener listener) {
        if (mListeners == null) {
            mListeners = new java.util.ArrayList<android.transition.Transition.TransitionListener>();
        }
    ...
    public void setPathMotion(android.transition.PathMotion pathMotion) {
        if (pathMotion == null) {
            mPathMotion = android.transition.Transition.STRAIGHT_PATH_MOTION;
        } else {
    ...
    void capturePropagationValues(android.transition.TransitionValues transitionValues) {
        if ((mPropagation != null) && (!transitionValues.values.isEmpty())) {
            java.lang.String[] propertyNames = mPropagation.getPropagationProperties();
     ...
     * @unknown 
     */
    public void setNameOverrides(android.util.ArrayMap<java.lang.String, java.lang.String> overrides) {
    ...
    public android.transition.Transition clone() {
        android.transition.Transition clone = null;
        try {
            clone = ((android.transition.Transition) (super.clone()));
            clone.mAnimators = new java.util.ArrayList<android.animation.Animator>();
            clone.mStartValues = new android.transition.TransitionValuesMaps();
            clone.mEndValues = new android.transition.TransitionValuesMaps();
    ...
    public static class AnimationInfo {
        ...
        AnimationInfo(android.view.View view, java.lang.String name, android.transition.Transition transition, android.view.WindowId windowId, android.transition.TransitionValues values) {
            this.view = view;
            this.name = name;
            this.values = values;
