...
public class AutoTransition extends android.transition.TransitionSet {
    ...
    private void init() {
        setOrdering(android.transition.TransitionSet.ORDERING_SEQUENTIAL);
        addTransition(new android.transition.Fade(android.transition.Fade.OUT)).addTransition(new android.transition.ChangeBounds()).addTransition(new android.transition.Fade(android.transition.Fade.IN));
    }
}
