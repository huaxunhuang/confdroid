...
public final class Scene {
     ...
     */
    public static android.transition.Scene getSceneForLayout(android.view.ViewGroup sceneRoot, int layoutId, android.content.Context context) {
        android.util.SparseArray<android.transition.Scene> scenes = ((android.util.SparseArray<android.transition.Scene>) (sceneRoot.getTag(com.android.internal.R.id.scene_layoutid_cache)));
        if (scenes == null) {
            scenes = new android.util.SparseArray<android.transition.Scene>();
            sceneRoot.setTagInternal(com.android.internal.R.id.scene_layoutid_cache, scenes);
        }
        android.transition.Scene scene = scenes.get(layoutId);
        if (scene != null) {
            return scene;
        } else {
            scene = new android.transition.Scene(sceneRoot, layoutId, context);
     ...
     * 		and transitions will take place.
     * @param layoutId
     * 		The id of a resource file that defines the view
     * 		hierarchy of this scene.
     * @param context
     * 		The context used in the process of inflating
     * 		the layout resource.
     */
    private Scene(android.view.ViewGroup sceneRoot, int layoutId, android.content.Context context) {
        mContext = context;
        mSceneRoot = sceneRoot;
        mLayoutId = layoutId;
    }
     ...
     */
    public Scene(android.view.ViewGroup sceneRoot, android.view.View layout) {
        mSceneRoot = sceneRoot;
        mLayout = layout;
    }
    ...
    public Scene(android.view.ViewGroup sceneRoot, android.view.ViewGroup layout) {
        mSceneRoot = sceneRoot;
        mLayout = layout;
    }
     ...
     */
    public void exit() {
        if (android.transition.Scene.getCurrentScene(mSceneRoot) == this) {
            if (mExitAction != null) {
                mExitAction.run();
            }
        }
    ...
    public void enter() {
        ...
        if ((mLayoutId > 0) || (mLayout != null)) {
            ...
            if (mLayoutId > 0) {
                android.view.LayoutInflater.from(mContext).inflate(mLayoutId, mSceneRoot);
            } else {
        ...
        android.transition.Scene.setCurrentScene(mSceneRoot, this);
    }
     ...
     *
     * @param sceneRoot
     * 		The ViewGroup on which the current scene is being set
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P)
    static void setCurrentScene(@android.annotation.NonNull
    android.view.ViewGroup sceneRoot, @android.annotation.Nullable
    ...
    public static android.transition.Scene getCurrentScene(@android.annotation.NonNull
    android.view.ViewGroup sceneRoot) {
        return ((android.transition.Scene) (sceneRoot.getTag(com.android.internal.R.id.current_scene)));
    }
     ...
     *
     * @param action
     * 		The runnable whose {@link Runnable#run() run()} method will
