...
public final class BluetoothActivityEnergyInfo implements android.os.Parcelable {
    ...
    BluetoothActivityEnergyInfo(android.os.Parcel in) {
        ...
        mUidTraffic = in.createTypedArray(android.bluetooth.UidTraffic.CREATOR);
    }

    @java.lang.Override
    public java.lang.String toString() {
        return (((((((((((((("BluetoothActivityEnergyInfo{" + " mTimestamp=") + mTimestamp) + " mBluetoothStackState=") + mBluetoothStackState) + " mControllerTxTimeMs=") + mControllerTxTimeMs) + " mControllerRxTimeMs=") + mControllerRxTimeMs) + " mControllerIdleTimeMs=") + mControllerIdleTimeMs) + " mControllerEnergyUsed=") + mControllerEnergyUsed) + " mUidTraffic=") + java.util.Arrays.toString(mUidTraffic)) + " }";
    }

    public static final android.os.Parcelable.Creator<android.bluetooth.BluetoothActivityEnergyInfo> CREATOR = new android.os.Parcelable.Creator<android.bluetooth.BluetoothActivityEnergyInfo>() {
        public android.bluetooth.BluetoothActivityEnergyInfo createFromParcel(android.os.Parcel in) {
            return new android.bluetooth.BluetoothActivityEnergyInfo(in);
        }

        public android.bluetooth.BluetoothActivityEnergyInfo[] newArray(int size) {
            return new android.bluetooth.BluetoothActivityEnergyInfo[size];
        }
    };
    ...
    public void setUidTraffic(android.bluetooth.UidTraffic[] traffic) {
        mUidTraffic = traffic;
    }
