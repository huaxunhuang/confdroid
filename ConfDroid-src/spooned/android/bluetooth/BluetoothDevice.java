 ...
 * {@link BluetoothAdapter} that was used to create this {@link BluetoothDevice}.
 *
...
public final class BluetoothDevice implements android.os.Parcelable {
     ...
     * <p>Always contains the extra fields {@link #EXTRA_DEVICE} and {@link #EXTRA_CLASS}. Can contain the extra fields {@link #EXTRA_NAME} and/or
     ...
     * <p>Always contains the extra fields {@link #EXTRA_DEVICE}, {@link #EXTRA_BOND_STATE} and {@link #EXTRA_PREVIOUS_BOND_STATE}.
     * <p>Requires {@link android.Manifest.permission#BLUETOOTH} to receive.
     */
    ...
    /**
     * Used as a String extra field in {@link #ACTION_NAME_CHANGED} and {@link #ACTION_FOUND} intents. It contains the friendly Bluetooth name.
     */
    ...
    /**
     * Used as a Parcelable {@link BluetoothClass} extra field in {@link #ACTION_FOUND} and {@link #ACTION_CLASS_CHANGED} intents.
     */
    ...
    static android.bluetooth.IBluetooth getService() {
        synchronized(android.bluetooth.BluetoothDevice.class) {
            if (android.bluetooth.BluetoothDevice.sService == null) {
                android.bluetooth.BluetoothAdapter adapter = android.bluetooth.BluetoothAdapter.getDefaultAdapter();
                android.bluetooth.BluetoothDevice.sService = adapter.getBluetoothService(android.bluetooth.BluetoothDevice.mStateChangeCallback);
            }
        }
        return android.bluetooth.BluetoothDevice.sService;
    }

    static android.bluetooth.IBluetoothManagerCallback mStateChangeCallback = new android.bluetooth.IBluetoothManagerCallback.Stub() {
        public void onBluetoothServiceUp(android.bluetooth.IBluetooth bluetoothService) throws android.os.RemoteException {
            synchronized(android.bluetooth.BluetoothDevice.class) {
                if (android.bluetooth.BluetoothDevice.sService == null) {
                    android.bluetooth.BluetoothDevice.sService = bluetoothService;
                }
            }
        }
        ...
        public void onBluetoothServiceDown() throws android.os.RemoteException {
            synchronized(android.bluetooth.BluetoothDevice.class) {
                android.bluetooth.BluetoothDevice.sService = null;
            }
        }

        public void onBrEdrDown() {
            if (android.bluetooth.BluetoothDevice.DBG)
                android.util.Log.d(android.bluetooth.BluetoothDevice.TAG, "onBrEdrDown: reached BLE ON state");
     ...
     */
    /* package */
    BluetoothDevice(java.lang.String address) {
        android.bluetooth.BluetoothDevice.getService();// ensures sService is initialized

        if (!android.bluetooth.BluetoothAdapter.checkBluetoothAddress(address)) {
            throw new java.lang.IllegalArgumentException(address + " is not a valid Bluetooth address");
        }
        mAddress = address;
    }
    ...
    public boolean equals(java.lang.Object o) {
        if (o instanceof android.bluetooth.BluetoothDevice) {
            return mAddress.equals(((android.bluetooth.BluetoothDevice) (o)).getAddress());
        }
        return false;
    }
    ...
    public static final android.os.Parcelable.Creator<android.bluetooth.BluetoothDevice> CREATOR = new android.os.Parcelable.Creator<android.bluetooth.BluetoothDevice>() {
        public android.bluetooth.BluetoothDevice createFromParcel(android.os.Parcel in) {
            return new android.bluetooth.BluetoothDevice(in.readString());
        }

        public android.bluetooth.BluetoothDevice[] newArray(int size) {
            return new android.bluetooth.BluetoothDevice[size];
        }
    };
    ...
    public java.lang.String getAddress() {
        if (android.bluetooth.BluetoothDevice.DBG)
            android.util.Log.d(android.bluetooth.BluetoothDevice.TAG, "mAddress: " + mAddress);
    ...
    public java.lang.String getName() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get Remote Device name");
            return null;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getRemoteName(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return null;
    }
    ...
    public int getType() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get Remote Device type");
            return android.bluetooth.BluetoothDevice.DEVICE_TYPE_UNKNOWN;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getRemoteType(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return android.bluetooth.BluetoothDevice.DEVICE_TYPE_UNKNOWN;
    ...
    public java.lang.String getAlias() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get Remote Device Alias");
            return null;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getRemoteAlias(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return null;
    ...
    public boolean setAlias(java.lang.String alias) {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot set Remote Device name");
            return false;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.setRemoteAlias(this, alias);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public java.lang.String getAliasName() {
        java.lang.String name = getAlias();
        if (name == null) {
            name = getName();
        }
        return name;
    ...
    public boolean createBond() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot create bond to Remote Device");
            return false;
        }
        try {
            android.util.Log.i(android.bluetooth.BluetoothDevice.TAG, (((("createBond() for device " + getAddress()) + " called by pid: ") + android.os.Process.myPid()) + " tid: ") + android.os.Process.myTid());
            return android.bluetooth.BluetoothDevice.sService.createBond(this, android.bluetooth.BluetoothDevice.TRANSPORT_AUTO);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
     ...
     *
     * @param transport
     * 		The transport to use for the pairing procedure.
     * @return false on immediate error, true if bonding will begin
     * @throws IllegalArgumentException
     * 		if an invalid transport was specified
     * @unknown 
     */
    public boolean createBond(int transport) {
        ...
        if ((android.bluetooth.BluetoothDevice.TRANSPORT_AUTO > transport) || (transport > android.bluetooth.BluetoothDevice.TRANSPORT_LE)) {
            throw new java.lang.IllegalArgumentException(transport + " is not a valid Bluetooth transport");
        }
        try {
            android.util.Log.i(android.bluetooth.BluetoothDevice.TAG, (((("createBond() for device " + getAddress()) + " called by pid: ") + android.os.Process.myPid()) + " tid: ") + android.os.Process.myTid());
            return android.bluetooth.BluetoothDevice.sService.createBond(this, transport);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
     ...
     * @unknown 
     */
    public boolean createBondOutOfBand(int transport, android.bluetooth.OobData oobData) {
        try {
            return android.bluetooth.BluetoothDevice.sService.createBondOutOfBand(this, transport, oobData);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public boolean cancelBondProcess() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot cancel Remote Device bond");
            return false;
        }
        try {
            android.util.Log.i(android.bluetooth.BluetoothDevice.TAG, (((("cancelBondProcess() for device " + getAddress()) + " called by pid: ") + android.os.Process.myPid()) + " tid: ") + android.os.Process.myTid());
            return android.bluetooth.BluetoothDevice.sService.cancelBondProcess(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public boolean removeBond() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot remove Remote Device bond");
            return false;
        }
        try {
            android.util.Log.i(android.bluetooth.BluetoothDevice.TAG, (((("removeBond() for device " + getAddress()) + " called by pid: ") + android.os.Process.myPid()) + " tid: ") + android.os.Process.myTid());
            return android.bluetooth.BluetoothDevice.sService.removeBond(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public int getBondState() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get bond state");
            return android.bluetooth.BluetoothDevice.BOND_NONE;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getBondState(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        } catch (java.lang.NullPointerException npe) {
            // Handle case where bluetooth service proxy
            // is already null.
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, ("NullPointerException for getBondState() of device (" + getAddress()) + ")", npe);
        }
        return android.bluetooth.BluetoothDevice.BOND_NONE;
    }
    ...
    public boolean isConnected() {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.getConnectionState(this) != android.bluetooth.BluetoothDevice.CONNECTION_STATE_DISCONNECTED;
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
            return false;
        }
    ...
    public boolean isEncrypted() {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.getConnectionState(this) > android.bluetooth.BluetoothDevice.CONNECTION_STATE_CONNECTED;
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
            return false;
        }
    ...
    public android.bluetooth.BluetoothClass getBluetoothClass() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get Bluetooth Class");
            return null;
        }
        try {
            int classInt = android.bluetooth.BluetoothDevice.sService.getRemoteClass(this);
            if (classInt == android.bluetooth.BluetoothClass.ERROR)
                return null;

            return new android.bluetooth.BluetoothClass(classInt);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return null;
    ...
    public android.os.ParcelUuid[] getUuids() {
        if ((android.bluetooth.BluetoothDevice.sService == null) || (isBluetoothEnabled() == false)) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot get remote device Uuids");
            return null;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getRemoteUuids(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return null;
    ...
    public boolean fetchUuidsWithSdp() {
        android.bluetooth.IBluetooth service = android.bluetooth.BluetoothDevice.sService;
        if ((service == null) || (isBluetoothEnabled() == false)) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot fetchUuidsWithSdp");
            return false;
        }
        try {
     ...
     * @unknown 
     */
    public boolean sdpSearch(android.os.ParcelUuid uuid) {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot query remote device sdp records");
            return false;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.sdpSearch(this, uuid);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public boolean setPin(byte[] pin) {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot set Remote Device pin");
            return false;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.setPin(this, true, pin.length, pin);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    false for error
     */
    @android.annotation.RequiresPermission(Manifest.permission.BLUETOOTH_PRIVILEGED)
    public boolean setPairingConfirmation(boolean confirm) {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot set pairing confirmation");
            return false;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.setPairingConfirmation(this, confirm);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public boolean cancelPairingUserInput() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "BT not enabled. Cannot create pairing user input");
            return false;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.cancelBondProcess(this);
    ...
    public int getPhonebookAccessPermission() {
        if (android.bluetooth.BluetoothDevice.sService == null) {
            return android.bluetooth.BluetoothDevice.ACCESS_UNKNOWN;
        }
        try {
            return android.bluetooth.BluetoothDevice.sService.getPhonebookAccessPermission(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return android.bluetooth.BluetoothDevice.ACCESS_UNKNOWN;
     ...
     *
     * @param value
     * 		Can be {@link #ACCESS_UNKNOWN}, {@link #ACCESS_ALLOWED} or
    ...
    public boolean setPhonebookAccessPermission(int value) {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.setPhonebookAccessPermission(this, value);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public int getMessageAccessPermission() {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.getMessageAccessPermission(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return android.bluetooth.BluetoothDevice.ACCESS_UNKNOWN;
    ...
    public boolean setMessageAccessPermission(int value) {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.setMessageAccessPermission(this, value);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
    ...
    public int getSimAccessPermission() {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.getSimAccessPermission(this);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return android.bluetooth.BluetoothDevice.ACCESS_UNKNOWN;
    ...
    public boolean setSimAccessPermission(int value) {
        ...
        try {
            return android.bluetooth.BluetoothDevice.sService.setSimAccessPermission(this, value);
        } catch (android.os.RemoteException e) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "", e);
        }
        return false;
     ...
     * @unknown 
     */
    public android.bluetooth.BluetoothSocket createRfcommSocket(int channel) throws java.io.IOException {
        if (isBluetoothEnabled() == false) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "Bluetooth is not enabled");
            throw new java.io.IOException();
        }
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_RFCOMM, -1, true, true, this, channel, null);
    }
     ...
     *
     * @param channel
     * 		L2cap PSM/channel to connect to
     * @return a RFCOMM BluetoothServerSocket ready for an outgoing connection
     * @throws IOException
     * 		on error, for example Bluetooth not available, or
     * 		insufficient permissions
     * @unknown 
     */
    public android.bluetooth.BluetoothSocket createL2capSocket(int channel) throws java.io.IOException {
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_L2CAP, -1, true, true, this, channel, null);
    }

    /**
     * Create an RFCOMM {@link BluetoothSocket} ready to start a secure
     * outgoing connection to this remote device using SDP lookup of uuid.
     * <p>This is designed to be used with {@link BluetoothAdapter#listenUsingRfcommWithServiceRecord} for peer-peer
     ...
     */
    @android.annotation.RequiresPermission(Manifest.permission.BLUETOOTH)
    public android.bluetooth.BluetoothSocket createRfcommSocketToServiceRecord(java.util.UUID uuid) throws java.io.IOException {
        if (isBluetoothEnabled() == false) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "Bluetooth is not enabled");
            throw new java.io.IOException();
        }
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_RFCOMM, -1, true, true, this, -1, new android.os.ParcelUuid(uuid));
    }
     ...
     * <p>This is designed to be used with {@link BluetoothAdapter#listenUsingInsecureRfcommWithServiceRecord} for peer-peer
     * Bluetooth applications.
     * <p>Use {@link BluetoothSocket#connect} to initiate the outgoing
     * connection. This will also perform an SDP lookup of the given uuid to
     * determine which channel to connect to.
     ...
     */
    @android.annotation.RequiresPermission(Manifest.permission.BLUETOOTH)
    public android.bluetooth.BluetoothSocket createInsecureRfcommSocketToServiceRecord(java.util.UUID uuid) throws java.io.IOException {
        if (isBluetoothEnabled() == false) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "Bluetooth is not enabled");
            throw new java.io.IOException();
        }
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_RFCOMM, -1, false, false, this, -1, new android.os.ParcelUuid(uuid));
    }
     ...
     * @unknown 
     */
    public android.bluetooth.BluetoothSocket createInsecureRfcommSocket(int port) throws java.io.IOException {
        if (isBluetoothEnabled() == false) {
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "Bluetooth is not enabled");
            throw new java.io.IOException();
        }
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_RFCOMM, -1, false, false, this, port, null);
    }
    ...
    public android.bluetooth.BluetoothSocket createScoSocket() throws java.io.IOException {
        ...
        return new android.bluetooth.BluetoothSocket(android.bluetooth.BluetoothSocket.TYPE_SCO, -1, true, true, this, -1, null);
    }
    ...
    public static byte[] convertPinToBytes(java.lang.String pin) {
        ...
        try {
            ...
            android.util.Log.e(android.bluetooth.BluetoothDevice.TAG, "UTF-8 not supported?!?");// this should not happen
     ...
     * 		if callback is null
     */
    public android.bluetooth.BluetoothGatt connectGatt(android.content.Context context, boolean autoConnect, android.bluetooth.BluetoothGattCallback callback) {
        return connectGatt(context, autoConnect, callback, android.bluetooth.BluetoothDevice.TRANSPORT_AUTO);
    }
     ...
     * 		if callback is null
     */
    public android.bluetooth.BluetoothGatt connectGatt(android.content.Context context, boolean autoConnect, android.bluetooth.BluetoothGattCallback callback, int transport) {
        // TODO(Bluetooth) check whether platform support BLE
        // Do the check here or in GattServer?
        android.bluetooth.BluetoothAdapter adapter = android.bluetooth.BluetoothAdapter.getDefaultAdapter();
        android.bluetooth.IBluetoothManager managerService = adapter.getBluetoothManager();
        try {
            ...
            android.bluetooth.BluetoothGatt gatt = new android.bluetooth.BluetoothGatt(iGatt, this, transport);
