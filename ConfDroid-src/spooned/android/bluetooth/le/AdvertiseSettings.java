...
public final class AdvertiseSettings implements android.os.Parcelable {
    ...
    public java.lang.String toString() {
        return ((((((("Settings [mAdvertiseMode=" + mAdvertiseMode) + ", mAdvertiseTxPowerLevel=") + mAdvertiseTxPowerLevel) + ", mAdvertiseConnectable=") + mAdvertiseConnectable) + ", mAdvertiseTimeoutMillis=") + mAdvertiseTimeoutMillis) + "]";
    }
    ...
    public static final android.os.Parcelable.Creator<android.bluetooth.le.AdvertiseSettings> CREATOR = new android.os.Parcelable.Creator<android.bluetooth.le.AdvertiseSettings>() {
        @java.lang.Override
        public android.bluetooth.le.AdvertiseSettings[] newArray(int size) {
            return new android.bluetooth.le.AdvertiseSettings[size];
        }

        @java.lang.Override
        public android.bluetooth.le.AdvertiseSettings createFromParcel(android.os.Parcel in) {
            return new android.bluetooth.le.AdvertiseSettings(in);
        }
    };
    ...
    public static final class Builder {
        private int mMode = android.bluetooth.le.AdvertiseSettings.ADVERTISE_MODE_LOW_POWER;

        private int mTxPowerLevel = android.bluetooth.le.AdvertiseSettings.ADVERTISE_TX_POWER_MEDIUM;
         ...
         */
        public android.bluetooth.le.AdvertiseSettings.Builder setAdvertiseMode(int advertiseMode) {
            if ((advertiseMode < android.bluetooth.le.AdvertiseSettings.ADVERTISE_MODE_LOW_POWER) || (advertiseMode > android.bluetooth.le.AdvertiseSettings.ADVERTISE_MODE_LOW_LATENCY)) {
                throw new java.lang.IllegalArgumentException("unknown mode " + advertiseMode);
            }
            mMode = advertiseMode;
            return this;
        }
         ...
         */
        public android.bluetooth.le.AdvertiseSettings.Builder setTxPowerLevel(int txPowerLevel) {
            if ((txPowerLevel < android.bluetooth.le.AdvertiseSettings.ADVERTISE_TX_POWER_ULTRA_LOW) || (txPowerLevel > android.bluetooth.le.AdvertiseSettings.ADVERTISE_TX_POWER_HIGH)) {
                throw new java.lang.IllegalArgumentException("unknown tx power level " + txPowerLevel);
            }
         ...
         */
        public android.bluetooth.le.AdvertiseSettings.Builder setConnectable(boolean connectable) {
        ...
        public android.bluetooth.le.AdvertiseSettings.Builder setTimeout(int timeoutMillis) {
            if ((timeoutMillis < 0) || (timeoutMillis > android.bluetooth.le.AdvertiseSettings.LIMITED_ADVERTISING_MAX_MILLIS)) {
                throw new java.lang.IllegalArgumentException(("timeoutMillis invalid (must be 0-" + android.bluetooth.le.AdvertiseSettings.LIMITED_ADVERTISING_MAX_MILLIS) + " milliseconds)");
            }
        ...
        public android.bluetooth.le.AdvertiseSettings build() {
            return new android.bluetooth.le.AdvertiseSettings(mMode, mTxPowerLevel, mConnectable, mTimeoutMillis);
        }
    }
}
