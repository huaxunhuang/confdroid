...
public class BluetoothMapMessage {
    ...
    private final java.lang.String mSubject;

    private final java.util.Date mDateTime;

    private final java.lang.String mSenderName;

    private final java.lang.String mSenderAddressing;

    private final java.lang.String mReplytoAddressing;

    private final java.lang.String mRecipientName;

    private final java.lang.String mRecipientAddressing;

    private final android.bluetooth.client.map.BluetoothMapMessage.Type mType;

    private final int mSize;

    private final boolean mText;

    private final android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus mReceptionStatus;
    ...
    BluetoothMapMessage(java.util.HashMap<java.lang.String, java.lang.String> attrs) throws java.lang.IllegalArgumentException {
        int size;
        try {
            /* just to validate */
        ...
        java.lang.String dateTime = attrs.get("datetime");
        // Handle possible NPE when not able to retreive datetime attribute
        if (dateTime != null) {
            mDateTime = new android.bluetooth.client.map.utils.ObexTime(dateTime).getTime();
        } else {
            mDateTime = null;
        }
        ...
        try {
            size = java.lang.Integer.parseInt(attrs.get("size"));
        } catch (java.lang.NumberFormatException e) {
            size = 0;
        }
        mSize = size;
        ...
        try {
            size = java.lang.Integer.parseInt(attrs.get("attachment_size"));
        } catch (java.lang.NumberFormatException e) {
            size = 0;
        }
    ...
    private boolean yesnoToBoolean(java.lang.String yesno) {
        return "yes".equals(yesno);
    }

    private android.bluetooth.client.map.BluetoothMapMessage.Type strToType(java.lang.String s) {
        if ("EMAIL".equals(s)) {
            return android.bluetooth.client.map.BluetoothMapMessage.Type.EMAIL;
        } else
            if ("SMS_GSM".equals(s)) {
                return android.bluetooth.client.map.BluetoothMapMessage.Type.SMS_GSM;
            } else
                if ("SMS_CDMA".equals(s)) {
                    return android.bluetooth.client.map.BluetoothMapMessage.Type.SMS_CDMA;
                } else
                    if ("MMS".equals(s)) {
                        return android.bluetooth.client.map.BluetoothMapMessage.Type.MMS;
                    }



        return android.bluetooth.client.map.BluetoothMapMessage.Type.UNKNOWN;
    }

    private android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus strToReceptionStatus(java.lang.String s) {
        if ("complete".equals(s)) {
            return android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus.COMPLETE;
        } else
            if ("fractioned".equals(s)) {
                return android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus.FRACTIONED;
            } else
                if ("notification".equals(s)) {
                    return android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus.NOTIFICATION;
                }


        return android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus.UNKNOWN;
    }
     ...
     */
    public java.lang.String getSenderAddressing() {
    ...
    in MAP specification
     */
    public java.lang.String getReplytoAddressing() {
    ...
    parameter in MAP specification
     */
    public java.lang.String getRecipientAddressing() {
    ...
    in MAP specification
     */
    public android.bluetooth.client.map.BluetoothMapMessage.Type getType() {
        return mType;
    }
     ...
     */
    public android.bluetooth.client.map.BluetoothMapMessage.ReceptionStatus getReceptionStatus() {
