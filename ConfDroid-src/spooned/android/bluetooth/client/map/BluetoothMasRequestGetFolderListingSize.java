...
final class BluetoothMasRequestGetFolderListingSize extends android.bluetooth.client.map.BluetoothMasRequest {
    private static final java.lang.String TYPE = "x-obex/folder-listing";

    private int mSize;

    public BluetoothMasRequestGetFolderListingSize() {
        mHeaderSet.setHeader(HeaderSet.TYPE, android.bluetooth.client.map.BluetoothMasRequestGetFolderListingSize.TYPE);
        android.bluetooth.client.map.utils.ObexAppParameters oap = new android.bluetooth.client.map.utils.ObexAppParameters();
        oap.add(android.bluetooth.client.map.BluetoothMasRequest.OAP_TAGID_MAX_LIST_COUNT, 0);
    ...
    protected void readResponseHeaders(javax.obex.HeaderSet headerset) {
        ...
        mSize = oap.getShort(android.bluetooth.client.map.BluetoothMasRequest.OAP_TAGID_FOLDER_LISTING_SIZE);
    }
