...
final class BluetoothOutputStream extends java.io.OutputStream {
    ...
    /* package */
    BluetoothOutputStream(android.bluetooth.BluetoothSocket s) {
        mSocket = s;
    }
    ...
    public void write(byte[] b, int offset, int count) throws java.io.IOException {
        if (b == null) {
            throw new java.lang.NullPointerException("buffer is null");
        }
        if (((offset | count) < 0) || (count > (b.length - offset))) {
            throw new java.lang.IndexOutOfBoundsException("invalid offset or length");
        }
