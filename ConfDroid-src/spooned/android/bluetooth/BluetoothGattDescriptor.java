...
public class BluetoothGattDescriptor implements android.os.Parcelable {
     ...
     */
    public static final byte[] ENABLE_NOTIFICATION_VALUE = new byte[]{ 0x1, 0x0 };

    /**
     * Value used to enable indication for a client configuration descriptor
     */
    public static final byte[] ENABLE_INDICATION_VALUE = new byte[]{ 0x2, 0x0 };

    /**
     * Value used to disable notifications or indicatinos
     */
    public static final byte[] DISABLE_NOTIFICATION_VALUE = new byte[]{ 0x0, 0x0 };
     ...
     * 		Permissions for this descriptor
     */
    public BluetoothGattDescriptor(java.util.UUID uuid, int permissions) {
     ...
     */
    /* package */
    BluetoothGattDescriptor(android.bluetooth.BluetoothGattCharacteristic characteristic, java.util.UUID uuid, int instance, int permissions) {
     ...
     * @unknown 
     */
    public BluetoothGattDescriptor(java.util.UUID uuid, int instance, int permissions) {
        initDescriptor(null, uuid, instance, permissions);
    }

    private void initDescriptor(android.bluetooth.BluetoothGattCharacteristic characteristic, java.util.UUID uuid, int instance, int permissions) {
    ...
    public static final android.os.Parcelable.Creator<android.bluetooth.BluetoothGattDescriptor> CREATOR = new android.os.Parcelable.Creator<android.bluetooth.BluetoothGattDescriptor>() {
        public android.bluetooth.BluetoothGattDescriptor createFromParcel(android.os.Parcel in) {
            return new android.bluetooth.BluetoothGattDescriptor(in);
        }

        public android.bluetooth.BluetoothGattDescriptor[] newArray(int size) {
            return new android.bluetooth.BluetoothGattDescriptor[size];
        }
    };

    private BluetoothGattDescriptor(android.os.Parcel in) {
     ...
     */
    /* package */
    void setCharacteristic(android.bluetooth.BluetoothGattCharacteristic characteristic) {
        mCharacteristic = characteristic;
    }
