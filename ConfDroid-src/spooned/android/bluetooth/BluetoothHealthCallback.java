...
public abstract class BluetoothHealthCallback {
    private static final java.lang.String TAG = "BluetoothHealthCallback";
    ...
    public void onHealthAppConfigurationStatusChange(android.bluetooth.BluetoothHealthAppConfiguration config, int status) {
        android.util.Log.d(android.bluetooth.BluetoothHealthCallback.TAG, (("onHealthAppConfigurationStatusChange: " + config) + "Status: ") + status);
    }
    ...
    public void onHealthChannelStateChange(android.bluetooth.BluetoothHealthAppConfiguration config, android.bluetooth.BluetoothDevice device, int prevState, int newState, android.os.ParcelFileDescriptor fd, int channelId) {
        android.util.Log.d(android.bluetooth.BluetoothHealthCallback.TAG, (((((((((("onHealthChannelStateChange: " + config) + "Device: ") + device) + "prevState:") + prevState) + "newState:") + newState) + "ParcelFd:") + fd) + "ChannelId:") + channelId);
    }
}
