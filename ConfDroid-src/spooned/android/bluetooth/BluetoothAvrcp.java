...
public final class BluetoothAvrcp {
    ...
    public static final int PASSTHROUGH_ID_SELECT = 0x0;/* select */


    public static final int PASSTHROUGH_ID_UP = 0x1;/* up */


    public static final int PASSTHROUGH_ID_DOWN = 0x2;/* down */


    public static final int PASSTHROUGH_ID_LEFT = 0x3;/* left */


    public static final int PASSTHROUGH_ID_RIGHT = 0x4;/* right */


    public static final int PASSTHROUGH_ID_RIGHT_UP = 0x5;/* right-up */


    public static final int PASSTHROUGH_ID_RIGHT_DOWN = 0x6;/* right-down */


    public static final int PASSTHROUGH_ID_LEFT_UP = 0x7;/* left-up */


    public static final int PASSTHROUGH_ID_LEFT_DOWN = 0x8;/* left-down */


    public static final int PASSTHROUGH_ID_ROOT_MENU = 0x9;/* root menu */


    public static final int PASSTHROUGH_ID_SETUP_MENU = 0xa;/* setup menu */


    public static final int PASSTHROUGH_ID_CONT_MENU = 0xb;/* contents menu */


    public static final int PASSTHROUGH_ID_FAV_MENU = 0xc;/* favorite menu */


    public static final int PASSTHROUGH_ID_EXIT = 0xd;/* exit */
