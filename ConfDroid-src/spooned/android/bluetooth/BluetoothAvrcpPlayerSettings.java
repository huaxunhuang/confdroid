...
public final class BluetoothAvrcpPlayerSettings implements android.os.Parcelable {
     ...
     * Equalizer setting.
     */
    public static final int SETTING_EQUALIZER = 0x1;

    /**
     * Repeat setting.
     */
    public static final int SETTING_REPEAT = 0x2;

    /**
     * Shuffle setting.
     */
    public static final int SETTING_SHUFFLE = 0x4;

    /**
     * Scan mode setting.
     */
    public static final int SETTING_SCAN = 0x8;
     ...
     */
    public static final int STATE_SINGLE_TRACK = 0x2;
     ...
     */
    public static final int STATE_ALL_TRACK = 0x3;
     ...
     * Applies to {@link SETTING_REPEAT}, {@link SETTING_SHUFFLE} and {@link SETTING_SCAN}.
     */
    public static final int STATE_GROUP = 0x4;
     ...
     */
    private java.util.Map<java.lang.Integer, java.lang.Integer> mSettingsValue = new java.util.HashMap<java.lang.Integer, java.lang.Integer>();
    ...
    public static final android.os.Parcelable.Creator<android.bluetooth.BluetoothAvrcpPlayerSettings> CREATOR = new android.os.Parcelable.Creator<android.bluetooth.BluetoothAvrcpPlayerSettings>() {
        public android.bluetooth.BluetoothAvrcpPlayerSettings createFromParcel(android.os.Parcel in) {
            return new android.bluetooth.BluetoothAvrcpPlayerSettings(in);
        }

        public android.bluetooth.BluetoothAvrcpPlayerSettings[] newArray(int size) {
            return new android.bluetooth.BluetoothAvrcpPlayerSettings[size];
        }
    };

    private BluetoothAvrcpPlayerSettings(android.os.Parcel in) {
     ...
     *
     * @param settings
     * 		a ORed value of SETTINGS_* defined above.
     */
    ...
    public void addSettingValue(int setting, int value) {
        if ((setting & mSettings) == 0) {
            android.util.Log.e(android.bluetooth.BluetoothAvrcpPlayerSettings.TAG, (("Setting not supported: " + setting) + " ") + mSettings);
            throw new java.lang.IllegalStateException("Setting not supported: " + setting);
        }
    ...
    public int getSettingValue(int setting) {
        ...
        java.lang.Integer i = mSettingsValue.get(setting);
        if (i == null)
            return -1;
