...
public abstract class AbstractInputMethodService extends android.app.Service implements android.view.KeyEvent.Callback {
    ...
    public abstract class AbstractInputMethodImpl implements android.view.inputmethod.InputMethod {
        ...
        public void setSessionEnabled(android.view.inputmethod.InputMethodSession session, boolean enabled) {
            ((android.inputmethodservice.AbstractInputMethodService.AbstractInputMethodSessionImpl) (session)).setEnabled(enabled);
        }
        ...
        public void revokeSession(android.view.inputmethod.InputMethodSession session) {
            ((android.inputmethodservice.AbstractInputMethodService.AbstractInputMethodSessionImpl) (session)).revokeSelf();
        }
    }
    ...
    public abstract class AbstractInputMethodSessionImpl implements android.view.inputmethod.InputMethodSession {
        ...
        public void dispatchKeyEvent(int seq, android.view.KeyEvent event, android.view.inputmethod.InputMethodSession.EventCallback callback) {
            boolean handled = event.dispatch(android.inputmethodservice.AbstractInputMethodService.this, mDispatcherState, this);
            if (callback != null) {
    ...
    public final android.os.IBinder onBind(android.content.Intent intent) {
        ...
        return new android.inputmethodservice.IInputMethodWrapper(this, mInputMethod);
    }
     ...
     * @unknown 
     */
    public void exposeContent(@android.annotation.NonNull
