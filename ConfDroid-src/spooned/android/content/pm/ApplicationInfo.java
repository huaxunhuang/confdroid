...
public class ApplicationInfo extends android.content.pm.PackageItemInfo implements android.os.Parcelable {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "PRIVATE_FLAG_" }, value = { android.content.pm.ApplicationInfo.PRIVATE_FLAG_ACTIVITIES_RESIZE_MODE_RESIZEABLE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ACTIVITIES_RESIZE_MODE_RESIZEABLE_VIA_SDK_VERSION, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ACTIVITIES_RESIZE_MODE_UNRESIZEABLE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_BACKUP_IN_FOREGROUND, android.content.pm.ApplicationInfo.PRIVATE_FLAG_CANT_SAVE_STATE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_DEFAULT_TO_DEVICE_PROTECTED_STORAGE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_DIRECT_BOOT_AWARE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_HAS_DOMAIN_URLS, android.content.pm.ApplicationInfo.PRIVATE_FLAG_HIDDEN, android.content.pm.ApplicationInfo.PRIVATE_FLAG_INSTANT, android.content.pm.ApplicationInfo.PRIVATE_FLAG_IS_RESOURCE_OVERLAY, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ISOLATED_SPLIT_LOADING, android.content.pm.ApplicationInfo.PRIVATE_FLAG_OEM, android.content.pm.ApplicationInfo.PRIVATE_FLAG_PARTIALLY_DIRECT_BOOT_AWARE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_USE_EMBEDDED_DEX, android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRIVILEGED, android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRODUCT, android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRODUCT_SERVICES, android.content.pm.ApplicationInfo.PRIVATE_FLAG_PROFILEABLE_BY_SHELL, android.content.pm.ApplicationInfo.PRIVATE_FLAG_REQUIRED_FOR_SYSTEM_USER, android.content.pm.ApplicationInfo.PRIVATE_FLAG_SIGNED_WITH_PLATFORM_KEY, android.content.pm.ApplicationInfo.PRIVATE_FLAG_STATIC_SHARED_LIBRARY, android.content.pm.ApplicationInfo.PRIVATE_FLAG_VENDOR, android.content.pm.ApplicationInfo.PRIVATE_FLAG_VIRTUAL_PRELOAD, android.content.pm.ApplicationInfo.PRIVATE_FLAG_HAS_FRAGILE_USER_DATA, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ALLOW_CLEAR_USER_DATA_ON_FAILED_RESTORE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ALLOW_AUDIO_PLAYBACK_CAPTURE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_REQUEST_LEGACY_EXTERNAL_STORAGE, android.content.pm.ApplicationInfo.PRIVATE_FLAG_ODM })
     ...
     *
     * @unknown For platform use only; we don't expect developers to need to read this value.
     */
     ...
     * @see #category
     */
    public static java.lang.CharSequence getCategoryTitle(android.content.Context context, @android.content.pm.ApplicationInfo.Category
    int category) {
        switch (category) {
    ...
    private static final int HIDDEN_API_ENFORCEMENT_MIN = android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DEFAULT;

    private static final int HIDDEN_API_ENFORCEMENT_MAX = android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_ENABLED;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "HIDDEN_API_ENFORCEMENT_" }, value = { android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DEFAULT, android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DISABLED, android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_JUST_WARN, android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_ENABLED })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    public static boolean isValidHiddenApiEnforcementPolicy(int policy) {
        return (policy >= android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_MIN) && (policy <= android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_MAX);
    }

    private int mHiddenApiPolicy = android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DEFAULT;
    ...
    public void dump(android.util.Printer pw, java.lang.String prefix, int dumpFlags) {
        ...
        if (((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) && (className != null)) {
        ...
        pw.println((((((((prefix + "uid=") + uid) + " flags=0x") + java.lang.Integer.toHexString(flags)) + " privateFlags=0x") + java.lang.Integer.toHexString(privateFlags)) + " theme=0x") + java.lang.Integer.toHexString(theme));
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
        ...
        if (!java.util.Objects.equals(sourceDir, publicSourceDir)) {
            pw.println((prefix + "publicSourceDir=") + publicSourceDir);
        }
        if (!com.android.internal.util.ArrayUtils.isEmpty(splitSourceDirs)) {
            pw.println((prefix + "splitSourceDirs=") + java.util.Arrays.toString(splitSourceDirs));
        }
        if ((!com.android.internal.util.ArrayUtils.isEmpty(splitPublicSourceDirs)) && (!java.util.Arrays.equals(splitSourceDirs, splitPublicSourceDirs))) {
            pw.println((prefix + "splitPublicSourceDirs=") + java.util.Arrays.toString(splitPublicSourceDirs));
        }
        if (resourceDirs != null) {
            pw.println((prefix + "resourceDirs=") + java.util.Arrays.toString(resourceDirs));
        }
        if (((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) && (seInfo != null)) {
        ...
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
            ...
            if (sharedLibraryFiles != null) {
                pw.println((prefix + "sharedLibraryFiles=") + java.util.Arrays.toString(sharedLibraryFiles));
            }
        }
        if (classLoaderName != null) {
            pw.println((prefix + "classLoaderName=") + classLoaderName);
        }
        if (!com.android.internal.util.ArrayUtils.isEmpty(splitClassLoaderNames)) {
            pw.println((prefix + "splitClassLoaderNames=") + java.util.Arrays.toString(splitClassLoaderNames));
        }
        ...
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
            ...
            if (descriptionRes != 0) {
                pw.println((prefix + "description=0x") + java.lang.Integer.toHexString(descriptionRes));
            }
            if (uiOptions != 0) {
            ...
            if (networkSecurityConfigRes != 0) {
                pw.println((prefix + "networkSecurityConfigRes=0x") + java.lang.Integer.toHexString(networkSecurityConfigRes));
            }
    ...
    public void writeToProto(android.util.proto.ProtoOutputStream proto, long fieldId, int dumpFlags) {
        ...
        if ((!com.android.internal.util.ArrayUtils.isEmpty(splitPublicSourceDirs)) && (!java.util.Arrays.equals(splitSourceDirs, splitPublicSourceDirs))) {
            for (java.lang.String dir : splitPublicSourceDirs) {
                proto.write(ApplicationInfoProto.SPLIT_PUBLIC_SOURCE_DIRS, dir);
            }
        }
        if (resourceDirs != null) {
            for (java.lang.String dir : resourceDirs) {
        ...
        if (!com.android.internal.util.ArrayUtils.isEmpty(splitClassLoaderNames)) {
            for (java.lang.String name : splitClassLoaderNames) {
        ...
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
            ...
            if (sharedLibraryFiles != null) {
                for (java.lang.String f : sharedLibraryFiles) {
    ...
    public boolean hasRtlSupport() {
        return (flags & android.content.pm.ApplicationInfo.FLAG_SUPPORTS_RTL) == android.content.pm.ApplicationInfo.FLAG_SUPPORTS_RTL;
    }
    ...
    public boolean hasCode() {
        return (flags & android.content.pm.ApplicationInfo.FLAG_HAS_CODE) != 0;
    }
    ...
    public static class DisplayNameComparator implements java.util.Comparator<android.content.pm.ApplicationInfo> {
        ...
        public final int compare(android.content.pm.ApplicationInfo aa, android.content.pm.ApplicationInfo ab) {
    ...
    public java.lang.String toString() {
        return ((("ApplicationInfo{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " ") + packageName) + "}";
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int parcelableFlags) {
        ...
        dest.writeSparseArray(((android.util.SparseArray) (splitDependencies)));
    ...
    public static final android.os.Parcelable.Creator<android.content.pm.ApplicationInfo> CREATOR = new android.os.Parcelable.Creator<android.content.pm.ApplicationInfo>() {
    ...
    @java.lang.SuppressWarnings("unchecked")
    private ApplicationInfo(android.os.Parcel source) {
        super(source);
        ...
        if (source.readInt() != 0) {
            storageUuid = new java.util.UUID(source.readLong(), source.readLong());
            volumeUuid = android.os.storage.StorageManager.convert(storageUuid);
        }
        ...
        sharedLibraryInfos = source.createTypedArrayList(this.CREATOR);
    ...
    public void disableCompatibilityMode() {
        flags |= ((((android.content.pm.ApplicationInfo.FLAG_SUPPORTS_LARGE_SCREENS | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_NORMAL_SCREENS) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_SMALL_SCREENS) | android.content.pm.ApplicationInfo.FLAG_RESIZEABLE_FOR_SCREENS) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_SCREEN_DENSITIES) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_XLARGE_SCREENS;
    }
    ...
    public boolean usesCompatibilityMode() {
        return (targetSdkVersion < android.os.Build.VERSION_CODES.DONUT) || ((flags & (((((android.content.pm.ApplicationInfo.FLAG_SUPPORTS_LARGE_SCREENS | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_NORMAL_SCREENS) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_SMALL_SCREENS) | android.content.pm.ApplicationInfo.FLAG_RESIZEABLE_FOR_SCREENS) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_SCREEN_DENSITIES) | android.content.pm.ApplicationInfo.FLAG_SUPPORTS_XLARGE_SCREENS)) == 0);
    }
    ...
    public void initForUser(int userId) {
        ...
        if ("android".equals(packageName)) {
            dataDir = android.os.Environment.getDataSystemDirectory().getAbsolutePath();
            return;
        }
        deviceProtectedDataDir = android.os.Environment.getDataUserDePackageDirectory(volumeUuid, userId, packageName).getAbsolutePath();
        credentialProtectedDataDir = android.os.Environment.getDataUserCePackageDirectory(volumeUuid, userId, packageName).getAbsolutePath();
        if (((privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_DEFAULT_TO_DEVICE_PROTECTED_STORAGE) != 0) && android.content.pm.PackageManager.APPLY_DEFAULT_TO_DEVICE_PROTECTED_STORAGE) {
    ...
    private boolean isPackageWhitelistedForHiddenApis() {
        return com.android.server.SystemConfig.getInstance().getHiddenApiWhitelistedApps().contains(packageName);
    }
    ...
    public boolean usesNonSdkApi() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_USES_NON_SDK_API) != 0;
    }
    ...
    public boolean hasFragileUserData() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_HAS_FRAGILE_USER_DATA) != 0;
    }
    ...
    public boolean isAudioPlaybackCaptureAllowed() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_ALLOW_AUDIO_PLAYBACK_CAPTURE) != 0;
    }
    ...
    public boolean hasRequestedLegacyExternalStorage() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_REQUEST_LEGACY_EXTERNAL_STORAGE) != 0;
    }
    ...
    public int getHiddenApiEnforcementPolicy() {
        if (isAllowedToUseHiddenApis()) {
            return android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DISABLED;
        }
        if (mHiddenApiPolicy != android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_DEFAULT) {
            return mHiddenApiPolicy;
        }
        return android.content.pm.ApplicationInfo.HIDDEN_API_ENFORCEMENT_ENABLED;
    }
     ...
     * @unknown 
     */
    public void setHiddenApiEnforcementPolicy(@android.content.pm.ApplicationInfo.HiddenApiEnforcementPolicy
    int policy) {
        if (!android.content.pm.ApplicationInfo.isValidHiddenApiEnforcementPolicy(policy)) {
            throw new java.lang.IllegalArgumentException("Invalid API enforcement policy: " + policy);
        }
     ...
     *
     * @param policy
     * 		configured policy for this app, or {@link #HIDDEN_API_ENFORCEMENT_DEFAULT}
     * 		if nothing configured.
     * @unknown 
     */
    public void maybeUpdateHiddenApiEnforcementPolicy(@android.content.pm.ApplicationInfo.HiddenApiEnforcementPolicy
    int policy) {
    ...
    public android.graphics.drawable.Drawable loadDefaultIcon(android.content.pm.PackageManager pm) {
        if (((flags & android.content.pm.ApplicationInfo.FLAG_EXTERNAL_STORAGE) != 0) && isPackageUnavailable(pm)) {
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
    private boolean isPackageUnavailable(android.content.pm.PackageManager pm) {
        try {
    ...
    public boolean isDefaultToDeviceProtectedStorage() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_DEFAULT_TO_DEVICE_PROTECTED_STORAGE) != 0;
    }
    ...
    public boolean isDirectBootAware() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_DIRECT_BOOT_AWARE) != 0;
    }
    ...
    public boolean isExternal() {
        return (flags & android.content.pm.ApplicationInfo.FLAG_EXTERNAL_STORAGE) != 0;
    }
    ...
    public boolean isInstantApp() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_INSTANT) != 0;
    }
    ...
    public boolean isOem() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_OEM) != 0;
    }
    ...
    public boolean isOdm() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_ODM) != 0;
    }
    ...
    public boolean isPartiallyDirectBootAware() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_PARTIALLY_DIRECT_BOOT_AWARE) != 0;
    }
    ...
    public boolean isSignedWithPlatformKey() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_SIGNED_WITH_PLATFORM_KEY) != 0;
    }
    ...
    public boolean isPrivilegedApp() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRIVILEGED) != 0;
    }
    ...
    public boolean isRequiredForSystemUser() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_REQUIRED_FOR_SYSTEM_USER) != 0;
    }
    ...
    public boolean isStaticSharedLibrary() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_STATIC_SHARED_LIBRARY) != 0;
    }
    ...
    public boolean isUpdatedSystemApp() {
        return (flags & android.content.pm.ApplicationInfo.FLAG_UPDATED_SYSTEM_APP) != 0;
    }
    ...
    public boolean isVendor() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_VENDOR) != 0;
    }
    ...
    public boolean isProduct() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRODUCT) != 0;
    }
    ...
    public boolean isProductServices() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_PRODUCT_SERVICES) != 0;
    }
    ...
    public boolean isEmbeddedDexUsed() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_USE_EMBEDDED_DEX) != 0;
    }
    ...
    public boolean isVirtualPreload() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_VIRTUAL_PRELOAD) != 0;
    }
    ...
    public boolean isProfileableByShell() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_PROFILEABLE_BY_SHELL) != 0;
    }
    ...
    public boolean requestsIsolatedSplitLoading() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_ISOLATED_SPLIT_LOADING) != 0;
    }
    ...
    public boolean isResourceOverlay() {
        return (privateFlags & android.content.pm.ApplicationInfo.PRIVATE_FLAG_IS_RESOURCE_OVERLAY) != 0;
    }
    ...
    public java.lang.String[] getAllApkPaths() {
        final java.lang.String[][] inputLists = new java.lang.String[][]{ splitSourceDirs, sharedLibraryFiles, resourceDirs };
        final java.util.List<java.lang.String> output = new java.util.ArrayList<>(10);
        if (sourceDir != null) {
            output.add(sourceDir);
        }
        for (java.lang.String[] inputList : inputLists) {
            if (inputList != null) {
                for (java.lang.String input : inputList) {
                    output.add(input);
                }
            }
        }
        return output.toArray(new java.lang.String[output.size()]);
    }
     ...
     * {@hide }
     */
    public void setSplitCodePaths(java.lang.String[] splitCodePaths) {
     ...
     * {@hide }
     */
    public void setBaseResourcePath(java.lang.String baseResourcePath) {
     ...
     * {@hide }
     */
    public void setSplitResourcePaths(java.lang.String[] splitResourcePaths) {
