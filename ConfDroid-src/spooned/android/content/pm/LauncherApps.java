 ...
 */
@android.annotation.SystemService(android.content.Context.LAUNCHER_APPS_SERVICE)
public class LauncherApps {
    ...
    private final java.util.List<android.content.pm.LauncherApps.CallbackMessageHandler> mCallbacks = new java.util.ArrayList<>();

    private final java.util.List<android.content.pm.PackageInstaller.SessionCallbackDelegate> mDelegates = new java.util.ArrayList<>();
    ...
    public static abstract class Callback {
         ...
         * 		The UserHandle of the profile that generated the change.
         */
        public void onPackagesSuspended(java.lang.String[] packageNames, android.os.UserHandle user) {
        }
         ...
         * 		A {@link Bundle} of extras for the launcher, if provided to the
         * 		system, {@code null} otherwise.
         * @see PackageManager#isPackageSuspended()
         * @see #getSuspendedPackageLauncherExtras(String, UserHandle)
         */
        public void onPackagesSuspended(java.lang.String[] packageNames, android.os.UserHandle user, @android.annotation.Nullable
         ...
         * 		The UserHandle of the profile that generated the change.
         */
        public void onPackagesUnsuspended(java.lang.String[] packageNames, android.os.UserHandle user) {
        }
         ...
         * @see ShortcutManager
         */
        public void onShortcutsChanged(@android.annotation.NonNull
        java.lang.String packageName, @android.annotation.NonNull
        java.util.List<android.content.pm.ShortcutInfo> shortcuts, @android.annotation.NonNull
    ...
    public static class ShortcutQuery {
        ...
        public static final int FLAG_GET_DYNAMIC = android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_DYNAMIC;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_GET_PINNED = android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_PINNED;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_GET_MANIFEST = android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_MANIFEST;
         ...
         * @unknown 
         */
        public static final int FLAG_MATCH_ALL_KINDS = (android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_DYNAMIC | android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_PINNED) | android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_MANIFEST;
         ...
         * @unknown 
         */
        public static final int FLAG_MATCH_ALL_KINDS_WITH_ALL_PINNED = android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_ALL_KINDS | android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_PINNED_BY_ANY_LAUNCHER;
         ...
         */
        @java.lang.Deprecated
        public static final int FLAG_GET_ALL_KINDS = android.content.pm.LauncherApps.ShortcutQuery.FLAG_MATCH_ALL_KINDS;
         ...
         */
        public android.content.pm.LauncherApps.ShortcutQuery setChangedSince(long changedSince) {
         ...
         */
        public android.content.pm.LauncherApps.ShortcutQuery setPackage(@android.annotation.Nullable
         ...
         */
        public android.content.pm.LauncherApps.ShortcutQuery setShortcutIds(@android.annotation.Nullable
         ...
         * to {@code activity}.
         */
        public android.content.pm.LauncherApps.ShortcutQuery setActivity(@android.annotation.Nullable
         ...
         * </ul>
         */
        public android.content.pm.LauncherApps.ShortcutQuery setQueryFlags(@android.content.pm.LauncherApps.ShortcutQuery.QueryFlags
        int queryFlags) {
    ...
    public LauncherApps(android.content.Context context) {
        this(context, ILauncherApps.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.LAUNCHER_APPS_SERVICE)));
    }
     ...
     */
    private void logErrorForInvalidProfileAccess(@android.annotation.NonNull
    android.os.UserHandle target) {
        if ((android.os.UserHandle.myUserId() != target.getIdentifier()) && mUserManager.isManagedProfile()) {
            android.util.Log.w(android.content.pm.LauncherApps.TAG, "Accessing other profiles/users from managed profile is no longer allowed.");
        }
    }
    ...
    public java.util.List<android.os.UserHandle> getProfiles() {
        if (mUserManager.isManagedProfile()) {
            ...
            result.add(android.content.pm.android.os.Process.myUserHandle());
            return result;
        } else {
     ...
     */
    public java.util.List<android.content.pm.LauncherActivityInfo> getActivityList(java.lang.String packageName, android.os.UserHandle user) {
     ...
     */
    public android.content.pm.LauncherActivityInfo resolveActivity(android.content.Intent intent, android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
            android.content.pm.ActivityInfo ai = mService.resolveActivity(mContext.getPackageName(), intent.getComponent(), user);
            if (ai != null) {
                android.content.pm.LauncherActivityInfo info = new android.content.pm.LauncherActivityInfo(mContext, ai, user);
                return info;
            }
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
     ...
     */
    public void startMainActivity(android.content.ComponentName component, android.os.UserHandle user, android.graphics.Rect sourceBounds, android.os.Bundle opts) {
        logErrorForInvalidProfileAccess(user);
        if (android.content.pm.LauncherApps.DEBUG) {
            android.util.Log.i(android.content.pm.LauncherApps.TAG, (("StartMainActivity " + component) + " ") + user.getIdentifier());
        }
        try {
     ...
     * 		Options to pass to startActivity
     */
    public void startPackageInstallerSessionDetailsActivity(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionInfo sessionInfo, @android.annotation.Nullable
    android.graphics.Rect sourceBounds, @android.annotation.Nullable
     ...
     * 		Options to pass to startActivity
     */
    public void startAppDetailsActivity(android.content.ComponentName component, android.os.UserHandle user, android.graphics.Rect sourceBounds, android.os.Bundle opts) {
        logErrorForInvalidProfileAccess(user);
        try {
     ...
     */
    public java.util.List<android.content.pm.LauncherActivityInfo> getShortcutConfigActivityList(@android.annotation.Nullable
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
            return convertToActivityList(mService.getShortcutConfigActivities(mContext.getPackageName(), packageName, user), user);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }

    private java.util.List<android.content.pm.LauncherActivityInfo> convertToActivityList(@android.annotation.Nullable
    android.content.pm.ParceledListSlice<android.content.pm.ResolveInfo> activities, android.os.UserHandle user) {
        if (activities == null) {
            return java.util.Collections.EMPTY_LIST;
        }
        java.util.ArrayList<android.content.pm.LauncherActivityInfo> lais = new java.util.ArrayList<>();
        for (android.content.pm.ResolveInfo ri : activities.getList()) {
            android.content.pm.LauncherActivityInfo lai = new android.content.pm.LauncherActivityInfo(mContext, ri.activityInfo, user);
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.v(android.content.pm.LauncherApps.TAG, (("Returning activity for profile " + user) + " : ") + lai.getComponentName());
            }
            lais.add(lai);
        }
        return lais;
     ...
     *
     * <p>Callers must be allowed to access the shortcut information, as defined in {@link #hasShortcutHostPermission()}.
     *
     * @param info
     * 		a configuration activity returned by {@link #getShortcutConfigActivityList}
     * @throws IllegalStateException
     * 		when the user is locked or not running.
     * @throws SecurityException
     * 		if {@link #hasShortcutHostPermission()} is false.
     * @see #getPinItemRequest(Intent)
     * @see Intent#ACTION_CREATE_SHORTCUT
     * @see android.app.Activity#startIntentSenderForResult
     */
    @android.annotation.Nullable
    public android.content.IntentSender getShortcutConfigActivityIntent(@android.annotation.NonNull
    android.content.pm.LauncherActivityInfo info) {
        try {
            return mService.getShortcutConfigActivityIntent(mContext.getPackageName(), info.getComponentName(), info.getUser());
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     */
    public boolean isPackageEnabled(java.lang.String packageName, android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
     ...
     * @param user
     * 		The {@link UserHandle} of the profile.
     ...
     * @return 
     */
    public boolean shouldHideFromSuggestions(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user) {
        com.android.internal.util.Preconditions.checkNotNull(packageName, "packageName");
        com.android.internal.util.Preconditions.checkNotNull(user, "user");
        try {
     ...
     * @param flags
     * 		Additional option flags {@link PackageManager#getApplicationInfo}
     * @param user
     * 		The UserHandle of the profile.
    ...
    isn't enabled.
     */
    public android.content.pm.ApplicationInfo getApplicationInfo(@android.annotation.NonNull
    ...
    android.os.UserHandle user) throws android.content.pm.PackageManager.NameNotFoundException {
        ...
        logErrorForInvalidProfileAccess(user);
        try {
            final android.content.pm.ApplicationInfo ai = mService.getApplicationInfo(mContext.getPackageName(), packageName, flags, user);
            if (ai == null) {
                throw new android.content.pm.PackageManager.NameNotFoundException((("Package " + packageName) + " not found for user ") + user.getIdentifier());
            }
            return ai;
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
     ...
     *
     * @param packageName
     * 		name of the package whose app usage limit will be returned
     * @param user
     ...
     * @throws SecurityException
     * 		when the caller is not the recents app.
     * @unknown 
     */
    @android.annotation.Nullable
    @android.annotation.SystemApi
    public android.content.pm.LauncherApps.AppUsageLimit getAppUsageLimit(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user) {
        try {
     ...
     */
    public boolean isActivityEnabled(android.content.ComponentName component, android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
    ...
    private java.util.List<android.content.pm.ShortcutInfo> maybeUpdateDisabledMessage(java.util.List<android.content.pm.ShortcutInfo> shortcuts) {
        if (shortcuts == null) {
            return null;
        }
        for (int i = shortcuts.size() - 1; i >= 0; i--) {
            final android.content.pm.ShortcutInfo si = shortcuts.get(i);
            final java.lang.String message = android.content.pm.ShortcutInfo.getDisabledReasonForRestoreIssue(mContext, si.getDisabledReason());
            if (message != null) {
     ...
     */
    @android.annotation.Nullable
    public java.util.List<android.content.pm.ShortcutInfo> getShortcuts(@android.annotation.NonNull
    android.content.pm.LauncherApps.ShortcutQuery query, @android.annotation.NonNull
    android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
     ...
     *
     *
     * @unknown // No longer used.  Use getShortcuts() instead.  Kept for unit tests.
     */
    @android.annotation.Nullable
    @java.lang.Deprecated
    public java.util.List<android.content.pm.ShortcutInfo> getShortcutInfo(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.util.List<java.lang.String> ids, @android.annotation.NonNull
    android.os.UserHandle user) {
        final android.content.pm.LauncherApps.ShortcutQuery q = new android.content.pm.LauncherApps.ShortcutQuery();
        q.setPackage(packageName);
        q.setShortcutIds(ids);
        q.setQueryFlags(android.content.pm.LauncherApps.ShortcutQuery.FLAG_GET_ALL_KINDS);
     ...
     * @see ShortcutManager
     */
    public void pinShortcuts(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.util.List<java.lang.String> shortcutIds, @android.annotation.NonNull
    android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
        try {
     ...
     */
    @java.lang.Deprecated
    public int getShortcutIconResId(@android.annotation.NonNull
    ...
    public int getShortcutIconResId(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String shortcutId, @android.annotation.NonNull
    android.os.UserHandle user) {
        final android.content.pm.LauncherApps.ShortcutQuery q = new android.content.pm.LauncherApps.ShortcutQuery();
        q.setPackage(packageName);
        q.setShortcutIds(java.util.Arrays.asList(shortcutId));
        q.setQueryFlags(android.content.pm.LauncherApps.ShortcutQuery.FLAG_GET_ALL_KINDS);
        final java.util.List<android.content.pm.ShortcutInfo> shortcuts = getShortcuts(q, user);
     ...
     */
    public android.os.ParcelFileDescriptor getShortcutIconFd(@android.annotation.NonNull
    android.content.pm.ShortcutInfo shortcut) {
    ...
    private android.os.ParcelFileDescriptor getShortcutIconFd(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String shortcutId, int userId) {
        try {
            return mService.getShortcutIconFd(mContext.getPackageName(), packageName, shortcutId, userId);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     * @see DisplayMetrics
     */
    public android.graphics.drawable.Drawable getShortcutIconDrawable(@android.annotation.NonNull
    android.content.pm.ShortcutInfo shortcut, int density) {
        if (shortcut.hasIconFile()) {
            final android.os.ParcelFileDescriptor pfd = getShortcutIconFd(shortcut);
            if (pfd == null) {
                return null;
            }
            try {
                final android.graphics.Bitmap bmp = android.graphics.BitmapFactory.decodeFileDescriptor(pfd.getFileDescriptor());
                if (bmp != null) {
                    android.graphics.drawable.BitmapDrawable dr = new android.graphics.drawable.BitmapDrawable(mContext.getResources(), bmp);
                    if (shortcut.hasAdaptiveBitmap()) {
                        return new android.graphics.drawable.AdaptiveIconDrawable(null, dr);
                    } else {
                        return dr;
                    }
                }
            ...
            if (shortcut.hasIconResource()) {
                ...
                if (shortcut.getIcon() != null) {
                    ...
                    final android.graphics.drawable.Icon icon = shortcut.getIcon();
                    switch (icon.getType()) {
    ...
    private android.graphics.drawable.Drawable loadDrawableResourceFromPackage(java.lang.String packageName, int resId, android.os.UserHandle user, int density) {
        try {
            if (resId == 0) {
                return null;// Shouldn't happen but just in case.

            }
            final android.content.pm.ApplicationInfo ai = /* flags = */
            getApplicationInfo(packageName, 0, user);
            final android.content.res.Resources res = mContext.getPackageManager().getResourcesForApplication(ai);
     ...
     * @see DisplayMetrics
     */
    public android.graphics.drawable.Drawable getShortcutBadgedIconDrawable(android.content.pm.ShortcutInfo shortcut, int density) {
        final android.graphics.drawable.Drawable originalIcon = getShortcutIconDrawable(shortcut, density);
        return originalIcon == null ? null : mContext.getPackageManager().getUserBadgedIcon(originalIcon, shortcut.getUserHandle());
    }
     ...
     */
    public void startShortcut(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String shortcutId, @android.annotation.Nullable
    android.graphics.Rect sourceBounds, @android.annotation.Nullable
    android.os.Bundle startActivityOptions, @android.annotation.NonNull
    android.os.UserHandle user) {
        logErrorForInvalidProfileAccess(user);
    ...
    @android.annotation.UnsupportedAppUsage
    private void startShortcut(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String shortcutId, @android.annotation.Nullable
    android.graphics.Rect sourceBounds, @android.annotation.Nullable
    android.os.Bundle startActivityOptions, int userId) {
        try {
            final boolean success = mService.startShortcut(mContext.getPackageName(), packageName, shortcutId, sourceBounds, startActivityOptions, userId);
            if (!success) {
    ...
    private void addCallbackLocked(android.content.pm.LauncherApps.Callback callback, android.os.Handler handler) {
        ...
        android.content.pm.LauncherApps.CallbackMessageHandler toAdd = new android.content.pm.LauncherApps.CallbackMessageHandler(handler.getLooper(), callback);
        mCallbacks.add(toAdd);
    }

    private IOnAppsChangedListener.Stub mAppsChangedListener = new android.content.pm.IOnAppsChangedListener.Stub() {
        @java.lang.Override
        public void onPackageRemoved(android.os.UserHandle user, java.lang.String packageName) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackageRemoved " + user.getIdentifier()) + ",") + packageName);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackageChanged(android.os.UserHandle user, java.lang.String packageName) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackageChanged " + user.getIdentifier()) + ",") + packageName);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackageAdded(android.os.UserHandle user, java.lang.String packageName) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackageAdded " + user.getIdentifier()) + ",") + packageName);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackagesAvailable(android.os.UserHandle user, java.lang.String[] packageNames, boolean replacing) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackagesAvailable " + user.getIdentifier()) + ",") + packageNames);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackagesUnavailable(android.os.UserHandle user, java.lang.String[] packageNames, boolean replacing) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackagesUnavailable " + user.getIdentifier()) + ",") + packageNames);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackagesSuspended(android.os.UserHandle user, java.lang.String[] packageNames, android.os.Bundle launcherExtras) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackagesSuspended " + user.getIdentifier()) + ",") + packageNames);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        public void onPackagesUnsuspended(android.os.UserHandle user, java.lang.String[] packageNames) throws android.os.RemoteException {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onPackagesUnsuspended " + user.getIdentifier()) + ",") + packageNames);
            }
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
        ...
        @java.lang.Override
        public void onShortcutChanged(android.os.UserHandle user, java.lang.String packageName, android.content.pm.ParceledListSlice shortcuts) {
            if (android.content.pm.LauncherApps.DEBUG) {
                android.util.Log.d(android.content.pm.LauncherApps.TAG, (("onShortcutChanged " + user.getIdentifier()) + ",") + packageName);
            }
            final java.util.List<android.content.pm.ShortcutInfo> list = shortcuts.getList();
            synchronized(android.content.pm.LauncherApps.this) {
                for (android.content.pm.LauncherApps.CallbackMessageHandler callback : mCallbacks) {
    ...
    private static class CallbackMessageHandler extends android.os.Handler {
        ...
        public void handleMessage(android.os.Message msg) {
            if ((mCallback == null) || (!(msg.obj instanceof android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo))) {
                return;
            }
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = ((android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo) (msg.obj));
            switch (msg.what) {
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_ADDED :
                    mCallback.onPackageAdded(info.packageName, info.user);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_REMOVED :
                    mCallback.onPackageRemoved(info.packageName, info.user);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_CHANGED :
                    mCallback.onPackageChanged(info.packageName, info.user);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_AVAILABLE :
                    mCallback.onPackagesAvailable(info.packageNames, info.user, info.replacing);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_UNAVAILABLE :
                    mCallback.onPackagesUnavailable(info.packageNames, info.user, info.replacing);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_SUSPENDED :
                    mCallback.onPackagesSuspended(info.packageNames, info.user, info.launcherExtras);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_UNSUSPENDED :
                    mCallback.onPackagesUnsuspended(info.packageNames, info.user);
                    break;
                case android.content.pm.LauncherApps.CallbackMessageHandler.MSG_SHORTCUT_CHANGED :
                    mCallback.onShortcutsChanged(info.packageName, info.shortcuts, info.user);
                    break;
            }
        }

        public void postOnPackageAdded(java.lang.String packageName, android.os.UserHandle user) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageName = packageName;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_ADDED, info).sendToTarget();
        }

        public void postOnPackageRemoved(java.lang.String packageName, android.os.UserHandle user) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageName = packageName;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_REMOVED, info).sendToTarget();
        }

        public void postOnPackageChanged(java.lang.String packageName, android.os.UserHandle user) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageName = packageName;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_CHANGED, info).sendToTarget();
        }

        public void postOnPackagesAvailable(java.lang.String[] packageNames, android.os.UserHandle user, boolean replacing) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageNames = packageNames;
            info.replacing = replacing;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_AVAILABLE, info).sendToTarget();
        }

        public void postOnPackagesUnavailable(java.lang.String[] packageNames, android.os.UserHandle user, boolean replacing) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageNames = packageNames;
            info.replacing = replacing;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_UNAVAILABLE, info).sendToTarget();
        }

        public void postOnPackagesSuspended(java.lang.String[] packageNames, android.os.Bundle launcherExtras, android.os.UserHandle user) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageNames = packageNames;
            info.user = user;
            info.launcherExtras = launcherExtras;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_SUSPENDED, info).sendToTarget();
        }

        public void postOnPackagesUnsuspended(java.lang.String[] packageNames, android.os.UserHandle user) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageNames = packageNames;
            info.user = user;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_UNSUSPENDED, info).sendToTarget();
        }

        public void postOnShortcutChanged(java.lang.String packageName, android.os.UserHandle user, java.util.List<android.content.pm.ShortcutInfo> shortcuts) {
            android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo info = new android.content.pm.LauncherApps.CallbackMessageHandler.CallbackInfo();
            info.packageName = packageName;
            info.user = user;
            info.shortcuts = shortcuts;
            obtainMessage(android.content.pm.LauncherApps.CallbackMessageHandler.MSG_SHORTCUT_CHANGED, info).sendToTarget();
        }
    }
     ...
     * 		The callback to register.
     * @param executor
     * 		{@link Executor} to handle the callbacks, cannot be null.
     * @see PackageInstaller#registerSessionCallback(SessionCallback)
     */
    public void registerPackageInstallerSessionCallback(@android.annotation.NonNull
    ...
    android.content.pm.PackageInstaller.SessionCallback callback) {
        ...
        synchronized(mDelegates) {
            final android.content.pm.PackageInstaller.SessionCallbackDelegate delegate = new android.content.pm.PackageInstaller.SessionCallbackDelegate(callback, executor);
            try {
                mService.registerPackageInstallerCallback(mContext.getPackageName(), delegate);
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
     ...
     */
    public void unregisterPackageInstallerSessionCallback(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionCallback callback) {
        synchronized(mDelegates) {
            for (java.util.Iterator<android.content.pm.PackageInstaller.SessionCallbackDelegate> i = mDelegates.iterator(); i.hasNext();) {
                final android.content.pm.PackageInstaller.SessionCallbackDelegate delegate = i.next();
    ...
    public android.content.pm.LauncherApps.PinItemRequest getPinItemRequest(android.content.Intent intent) {
        return intent.getParcelableExtra(android.content.pm.LauncherApps.EXTRA_PIN_ITEM_REQUEST);
    }
    ...
    public static final class PinItemRequest implements android.os.Parcelable {
         ...
         * @unknown 
         */
        @android.annotation.IntDef(prefix = { "REQUEST_TYPE_" }, value = { android.content.pm.LauncherApps.PinItemRequest.REQUEST_TYPE_SHORTCUT, android.content.pm.LauncherApps.PinItemRequest.REQUEST_TYPE_APPWIDGET })
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
         ...
         * @unknown 
         */
        public PinItemRequest(android.content.pm.IPinItemRequest inner, int type) {
            mInner = inner;
            mRequestType = type;
        }
        ...
        public android.appwidget.AppWidgetProviderInfo getAppWidgetProviderInfo(android.content.Context context) {
            try {
                final android.appwidget.AppWidgetProviderInfo info = mInner.getAppWidgetProviderInfo();
                if (info == null) {
                    return null;
                }
         ...
         *
         * @param options
         * 		must be set for a {@link #REQUEST_TYPE_APPWIDGET} request.
         ...
         */
        public boolean accept(@android.annotation.Nullable
        ...
        private PinItemRequest(android.os.Parcel source) {
        ...
        @android.annotation.NonNull
        public static final android.content.pm.Creator<android.content.pm.LauncherApps.PinItemRequest> CREATOR = new android.content.pm.Creator<android.content.pm.LauncherApps.PinItemRequest>() {
            public android.content.pm.LauncherApps.PinItemRequest createFromParcel(android.os.Parcel source) {
                return new android.content.pm.LauncherApps.PinItemRequest(source);
            }

            public android.content.pm.LauncherApps.PinItemRequest[] newArray(int size) {
                return new android.content.pm.LauncherApps.PinItemRequest[size];
            }
        };
    ...
    public static final class AppUsageLimit implements android.os.Parcelable {
        ...
        private AppUsageLimit(android.os.Parcel source) {
            mTotalUsageLimit = source.readLong();
            mUsageRemaining = source.readLong();
        }

        @android.annotation.NonNull
        public static final android.content.pm.Creator<android.content.pm.LauncherApps.AppUsageLimit> CREATOR = new android.content.pm.Creator<android.content.pm.LauncherApps.AppUsageLimit>() {
            @java.lang.Override
            public android.content.pm.LauncherApps.AppUsageLimit createFromParcel(android.os.Parcel source) {
                return new android.content.pm.LauncherApps.AppUsageLimit(source);
            }

            @java.lang.Override
            public android.content.pm.LauncherApps.AppUsageLimit[] newArray(int size) {
                return new android.content.pm.LauncherApps.AppUsageLimit[size];
            }
        };
