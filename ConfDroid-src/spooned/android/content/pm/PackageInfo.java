...
public class PackageInfo implements android.os.Parcelable {
     ...
     *
     *
     * @unknown The major version number of this package, as specified by the &lt;manifest&gt;
     ...
     *
     *
     * @unknown Internal implementation for composing a minor and major version code in to
     ...
     *
     * @unknown We do not support required permissions.
     */
    ...
    public java.lang.String toString() {
        return ((("PackageInfo{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " ") + packageName) + "}";
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int parcelableFlags) {
        ...
        dest.writeTypedArray(activities, parcelableFlags | android.os.Parcelable.PARCELABLE_ELIDE_DUPLICATES);
        dest.writeTypedArray(receivers, parcelableFlags | android.os.Parcelable.PARCELABLE_ELIDE_DUPLICATES);
        dest.writeTypedArray(services, parcelableFlags | android.os.Parcelable.PARCELABLE_ELIDE_DUPLICATES);
        dest.writeTypedArray(providers, parcelableFlags | android.os.Parcelable.PARCELABLE_ELIDE_DUPLICATES);
    ...
    public static final android.os.Parcelable.Creator<android.content.pm.PackageInfo> CREATOR = new android.os.Parcelable.Creator<android.content.pm.PackageInfo>() {
        @java.lang.Override
    ...
    private PackageInfo(android.os.Parcel source) {
        ...
        activities = source.createTypedArray(this.CREATOR);
        receivers = source.createTypedArray(this.CREATOR);
        services = source.createTypedArray(android.content.pm.ServiceInfo.CREATOR);
        providers = source.createTypedArray(this.CREATOR);
        instrumentation = source.createTypedArray(this.CREATOR);
        permissions = source.createTypedArray(android.content.pm.PermissionInfo.CREATOR);
        requestedPermissions = source.createStringArray();
        requestedPermissionsFlags = source.createIntArray();
        signatures = source.createTypedArray(this.CREATOR);
        configPreferences = source.createTypedArray(android.content.pm.ConfigurationInfo.CREATOR);
        reqFeatures = source.createTypedArray(android.content.pm.FeatureInfo.CREATOR);
        featureGroups = source.createTypedArray(android.content.pm.FeatureGroupInfo.CREATOR);
        ...
        if (hasSigningInfo != 0) {
            signingInfo = this.CREATOR.createFromParcel(source);
        }
    ...
    private void propagateApplicationInfo(android.content.pm.ApplicationInfo appInfo, android.content.pm.ComponentInfo[] components) {
        if (components != null) {
            for (android.content.pm.ComponentInfo ci : components) {
