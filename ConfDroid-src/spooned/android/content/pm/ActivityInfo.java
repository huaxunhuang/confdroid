...
public class ActivityInfo extends android.content.pm.ComponentInfo implements android.os.Parcelable {
     ...
     * and DOCUMENT_LAUNCH_INTO_EXISTING are equivalent to {@link android.content.Intent#FLAG_ACTIVITY_NEW_DOCUMENT
     * Intent.FLAG_ACTIVITY_NEW_DOCUMENT} with and without {@link android.content.Intent#FLAG_ACTIVITY_MULTIPLE_TASK
    ...
    public int resizeMode = android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE;
     ...
     * 0 means unset.
     *
     * @unknown {@link android.R.attr#maxAspectRatio}.
     * @unknown 
     */
     ...
     * 0 means unset.
     *
     * @unknown {@link android.R.attr#minAspectRatio}.
     * @unknown 
     */
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "COLOR_MODE_" }, value = { android.content.pm.ActivityInfo.COLOR_MODE_DEFAULT, android.content.pm.ActivityInfo.COLOR_MODE_WIDE_COLOR_GAMUT, android.content.pm.ActivityInfo.COLOR_MODE_HDR })
    ...
    public int colorMode = android.content.pm.ActivityInfo.COLOR_MODE_DEFAULT;
     ...
     */
    public static final int FLAG_MULTIPROCESS = 0x1;
     ...
     */
    public static final int FLAG_FINISH_ON_TASK_LAUNCH = 0x2;
     ...
     */
    public static final int FLAG_CLEAR_TASK_ON_LAUNCH = 0x4;
     ...
     */
    public static final int FLAG_ALWAYS_RETAIN_TASK_STATE = 0x8;
     ...
     */
    public static final int FLAG_STATE_NOT_NEEDED = 0x10;
     ...
     */
    public static final int FLAG_EXCLUDE_FROM_RECENTS = 0x20;
     ...
     */
    public static final int FLAG_ALLOW_TASK_REPARENTING = 0x40;
     ...
     */
    public static final int FLAG_NO_HISTORY = 0x80;
     ...
     */
    public static final int FLAG_FINISH_ON_CLOSE_SYSTEM_DIALOGS = 0x100;

    /**
     * Value for {@link #flags}: true when the application's rendering should
     * be hardware accelerated.
     */
    public static final int FLAG_HARDWARE_ACCELERATED = 0x200;
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public static final int FLAG_SHOW_FOR_ALL_USERS = 0x400;
     ...
     */
    public static final int FLAG_IMMERSIVE = 0x800;
     ...
     *
     *
     * @unknown Bit in {@link #flags}: If set, this component will only be seen
     ...
     *
     *
     * @unknown Bit in {@link #flags}: If set, this activity may be launched into an
     ...
     */
    public static final int CONFIG_MCC = 0x1;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_MNC = 0x2;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_LOCALE = 0x4;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_TOUCHSCREEN = 0x8;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_KEYBOARD = 0x10;
     ...
     */
    public static final int CONFIG_KEYBOARD_HIDDEN = 0x20;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_NAVIGATION = 0x40;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_ORIENTATION = 0x80;
     ...
     * {@link android.R.attr#configChanges} attribute.
     */
    public static final int CONFIG_SCREEN_LAYOUT = 0x100;
     ...
     */
    public static final int CONFIG_SCREEN_SIZE = 0x400;
     ...
     * they are interested in.  Please don't do that, thanks.
     */
    public static final int CONFIG_SMALLEST_SCREEN_SIZE = 0x800;
     ...
     *
     * @unknown We do not want apps handling this yet, but we do need some kind of bit for diffs.
     */
     ...
     *
     *
     * @unknown Unfortunately the constants for config changes in native code are
     ...
     */
    public static int[] CONFIG_NATIVE_BITS = new int[]{ android.content.res.Configuration.NATIVE_CONFIG_MNC, // MNC
    android.content.res.Configuration.NATIVE_CONFIG_MCC, // MCC
    android.content.res.Configuration.NATIVE_CONFIG_LOCALE, // LOCALE
    android.content.res.Configuration.NATIVE_CONFIG_TOUCHSCREEN, // TOUCH SCREEN
    android.content.res.Configuration.NATIVE_CONFIG_KEYBOARD, // KEYBOARD
    android.content.res.Configuration.NATIVE_CONFIG_KEYBOARD_HIDDEN// KEYBOARD HIDDEN
    , android.content.res.Configuration.NATIVE_CONFIG_NAVIGATION, // NAVIGATION
    android.content.res.Configuration.NATIVE_CONFIG_ORIENTATION, // ORIENTATION
    android.content.res.Configuration.NATIVE_CONFIG_SCREEN_LAYOUT, // SCREEN LAYOUT
    android.content.res.Configuration.NATIVE_CONFIG_UI_MODE, // UI MODE
    android.content.res.Configuration.NATIVE_CONFIG_SCREEN_SIZE, // SCREEN SIZE
    android.content.res.Configuration.NATIVE_CONFIG_SMALLEST_SCREEN_SIZE// SMALLEST SCREEN SIZE
    , android.content.res.Configuration.NATIVE_CONFIG_DENSITY, // DENSITY
    android.content.res.Configuration.NATIVE_CONFIG_LAYOUTDIR, // LAYOUT DIRECTION
    android.content.res.Configuration.NATIVE_CONFIG_COLOR_MODE// COLOR_MODE
     };
    ...
    public static int activityInfoConfigJavaToNative(@android.content.pm.ActivityInfo.Config
    int input) {
        int output = 0;
        for (int i = 0; i < android.content.pm.ActivityInfo.CONFIG_NATIVE_BITS.length; i++) {
            if ((input & (1 << i)) != 0) {
                output |= android.content.pm.ActivityInfo.CONFIG_NATIVE_BITS[i];
            }
        }
        return output;
    }
    ...
    public static int activityInfoConfigNativeToJava(@android.content.res.Configuration.NativeConfig
    int input) {
        int output = 0;
        for (int i = 0; i < android.content.pm.ActivityInfo.CONFIG_NATIVE_BITS.length; i++) {
            if ((input & android.content.pm.ActivityInfo.CONFIG_NATIVE_BITS[i]) != 0) {
                output |= 1 << i;
            }
        }
        return output;
     ...
     *
     *
     * @unknown Unfortunately some developers (OpenFeint I am looking at you) have
    ...
    public int getRealConfigChanged() {
        return applicationInfo.targetSdkVersion < android.os.Build.VERSION_CODES.HONEYCOMB_MR2 ? (configChanges | android.content.pm.ActivityInfo.CONFIG_SCREEN_SIZE) | android.content.pm.ActivityInfo.CONFIG_SMALLEST_SCREEN_SIZE : configChanges;
    }
     ...
     * @unknown 
     */
    public static final java.lang.String lockTaskLaunchModeToString(int lockTaskLaunchMode) {
        switch (lockTaskLaunchMode) {
            case android.content.pm.ActivityInfo.LOCK_TASK_LAUNCH_MODE_DEFAULT :
                return "LOCK_TASK_LAUNCH_MODE_DEFAULT";
            case android.content.pm.ActivityInfo.LOCK_TASK_LAUNCH_MODE_NEVER :
                return "LOCK_TASK_LAUNCH_MODE_NEVER";
            case android.content.pm.ActivityInfo.LOCK_TASK_LAUNCH_MODE_ALWAYS :
                return "LOCK_TASK_LAUNCH_MODE_ALWAYS";
            case android.content.pm.ActivityInfo.LOCK_TASK_LAUNCH_MODE_IF_WHITELISTED :
    ...
    private java.lang.String persistableModeToString() {
        switch (persistableMode) {
            case android.content.pm.ActivityInfo.PERSIST_ROOT_ONLY :
                return "PERSIST_ROOT_ONLY";
            case android.content.pm.ActivityInfo.PERSIST_NEVER :
                return "PERSIST_NEVER";
            case android.content.pm.ActivityInfo.PERSIST_ACROSS_REBOOTS :
    ...
    public boolean isFixedOrientation() {
        return (isFixedOrientationLandscape() || isFixedOrientationPortrait()) || (screenOrientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_LOCKED);
    }
    ...
    boolean isFixedOrientationLandscape() {
        return android.content.pm.ActivityInfo.isFixedOrientationLandscape(screenOrientation);
    }
     ...
     * @unknown 
     */
    public static boolean isFixedOrientationLandscape(@android.content.pm.ActivityInfo.ScreenOrientation
    int orientation) {
        return (((orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_SENSOR_LANDSCAPE)) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE)) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_USER_LANDSCAPE);
    }
    ...
    boolean isFixedOrientationPortrait() {
        return android.content.pm.ActivityInfo.isFixedOrientationPortrait(screenOrientation);
    }
     ...
     * @unknown 
     */
    public static boolean isFixedOrientationPortrait(@android.content.pm.ActivityInfo.ScreenOrientation
    int orientation) {
        return (((orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_PORTRAIT) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_SENSOR_PORTRAIT)) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_REVERSE_PORTRAIT)) || (orientation == android.content.pm.ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT);
    }
    ...
    public boolean supportsPictureInPicture() {
        return (flags & android.content.pm.ActivityInfo.FLAG_SUPPORTS_PICTURE_IN_PICTURE) != 0;
    }
    ...
    public static boolean isResizeableMode(int mode) {
        return (((((mode == android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZEABLE)) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PORTRAIT_ONLY)) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_LANDSCAPE_ONLY)) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PRESERVE_ORIENTATION)) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE_VIA_SDK_VERSION);
    }
    ...
    public static boolean isPreserveOrientationMode(int mode) {
        return ((mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PORTRAIT_ONLY) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_LANDSCAPE_ONLY)) || (mode == android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PRESERVE_ORIENTATION);
    }
     ...
     * @unknown 
     */
    public static java.lang.String resizeModeToString(int mode) {
        switch (mode) {
            case android.content.pm.ActivityInfo.RESIZE_MODE_UNRESIZEABLE :
                return "RESIZE_MODE_UNRESIZEABLE";
            case android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE_VIA_SDK_VERSION :
                return "RESIZE_MODE_RESIZEABLE_VIA_SDK_VERSION";
            case android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE :
                return "RESIZE_MODE_RESIZEABLE";
            case android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZEABLE :
                return "RESIZE_MODE_FORCE_RESIZEABLE";
            case android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PORTRAIT_ONLY :
                return "RESIZE_MODE_FORCE_RESIZABLE_PORTRAIT_ONLY";
            case android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_LANDSCAPE_ONLY :
                return "RESIZE_MODE_FORCE_RESIZABLE_LANDSCAPE_ONLY";
            case android.content.pm.ActivityInfo.RESIZE_MODE_FORCE_RESIZABLE_PRESERVE_ORIENTATION :
    ...
    public void dump(android.util.Printer pw, java.lang.String prefix, int dumpFlags) {
        ...
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
            pw.println((((((prefix + "taskAffinity=") + taskAffinity) + " targetActivity=") + targetActivity) + " persistableMode=") + persistableModeToString());
        }
        if ((((launchMode != 0) || (flags != 0)) || (privateFlags != 0)) || (theme != 0)) {
            pw.println((((((((prefix + "launchMode=") + launchMode) + " flags=0x") + java.lang.Integer.toHexString(flags)) + " privateFlags=0x") + java.lang.Integer.toHexString(privateFlags)) + " theme=0x") + java.lang.Integer.toHexString(theme));
        }
        if (((screenOrientation != android.content.pm.ActivityInfo.SCREEN_ORIENTATION_UNSPECIFIED) || (configChanges != 0)) || (softInputMode != 0)) {
            pw.println((((((prefix + "screenOrientation=") + screenOrientation) + " configChanges=0x") + java.lang.Integer.toHexString(configChanges)) + " softInputMode=0x") + java.lang.Integer.toHexString(softInputMode));
        }
        if (uiOptions != 0) {
            pw.println((prefix + " uiOptions=0x") + java.lang.Integer.toHexString(uiOptions));
        }
        if ((dumpFlags & android.content.pm.PackageItemInfo.DUMP_FLAG_DETAILS) != 0) {
            pw.println((prefix + "lockTaskLaunchMode=") + android.content.pm.ActivityInfo.lockTaskLaunchModeToString(lockTaskLaunchMode));
        }
        if (windowLayout != null) {
            pw.println((((((((((prefix + "windowLayout=") + windowLayout.width) + "|") + windowLayout.widthFraction) + ", ") + windowLayout.height) + "|") + windowLayout.heightFraction) + ", ") + windowLayout.gravity);
        }
        pw.println((prefix + "resizeMode=") + android.content.pm.ActivityInfo.resizeModeToString(resizeMode));
    ...
    public java.lang.String toString() {
        return ((("ActivityInfo{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " ") + name) + "}";
    }
     ...
     */
    @android.annotation.TestApi
    public static boolean isTranslucentOrFloating(android.content.res.TypedArray attributes) {
        final boolean isTranslucent = attributes.getBoolean(android.content.pm.com.android.internal.R.styleable.Window_windowIsTranslucent, false);
        final boolean isSwipeToDismiss = (!attributes.hasValue(android.content.pm.com.android.internal.R.styleable.Window_windowIsTranslucent)) && attributes.getBoolean(android.content.pm.com.android.internal.R.styleable.Window_windowSwipeToDismiss, false);
        final boolean isFloating = attributes.getBoolean(android.content.pm.com.android.internal.R.styleable.Window_windowIsFloating, false);
     ...
     * @unknown 
     */
    public static java.lang.String screenOrientationToString(int orientation) {
        switch (orientation) {
            case android.content.pm.ActivityInfo.SCREEN_ORIENTATION_UNSET :
            ...
            case android.content.pm.ActivityInfo.SCREEN_ORIENTATION_USER_PORTRAIT :
            ...
            case android.content.pm.ActivityInfo.SCREEN_ORIENTATION_LOCKED :
                return "SCREEN_ORIENTATION_LOCKED";
            default :
                return java.lang.Integer.toString(orientation);
        }
    }
     ...
     * @unknown 
     */
    public static java.lang.String colorModeToString(@android.content.pm.ActivityInfo.ColorMode
    int colorMode) {
        switch (colorMode) {
            case android.content.pm.ActivityInfo.COLOR_MODE_DEFAULT :
                return "COLOR_MODE_DEFAULT";
            case android.content.pm.ActivityInfo.COLOR_MODE_WIDE_COLOR_GAMUT :
                return "COLOR_MODE_WIDE_COLOR_GAMUT";
            case android.content.pm.ActivityInfo.COLOR_MODE_HDR :
                return "COLOR_MODE_HDR";
            default :
                return java.lang.Integer.toString(colorMode);
        }
    }

    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.content.pm.ActivityInfo> CREATOR = new android.os.Parcelable.Creator<android.content.pm.ActivityInfo>() {
    ...
    private ActivityInfo(android.os.Parcel source) {
        ...
        if (source.readInt() == 1) {
            windowLayout = new android.content.pm.ActivityInfo.WindowLayout(source);
        }
     ...
     *
     * @unknown ref android.R.styleable#AndroidManifestLayout_defaultWidth
     * @unknown ref android.R.styleable#AndroidManifestLayout_defaultHeight
     * @unknown ref android.R.styleable#AndroidManifestLayout_gravity
     * @unknown ref android.R.styleable#AndroidManifestLayout_minWidth
     * @unknown ref android.R.styleable#AndroidManifestLayout_minHeight
     */
    public static final class WindowLayout {
        ...
        WindowLayout(android.os.Parcel source) {
