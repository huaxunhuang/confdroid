...
public abstract class PackageManagerInternal {
    ...
    @android.annotation.IntDef({ android.content.pm.PackageManagerInternal.PACKAGE_SYSTEM, android.content.pm.PackageManagerInternal.PACKAGE_SETUP_WIZARD, android.content.pm.PackageManagerInternal.PACKAGE_INSTALLER, android.content.pm.PackageManagerInternal.PACKAGE_VERIFIER, android.content.pm.PackageManagerInternal.PACKAGE_BROWSER, android.content.pm.PackageManagerInternal.PACKAGE_SYSTEM_TEXT_CLASSIFIER, android.content.pm.PackageManagerInternal.PACKAGE_PERMISSION_CONTROLLER, android.content.pm.PackageManagerInternal.PACKAGE_WELLBEING, android.content.pm.PackageManagerInternal.PACKAGE_DOCUMENTER, android.content.pm.PackageManagerInternal.PACKAGE_CONFIGURATOR, android.content.pm.PackageManagerInternal.PACKAGE_INCIDENT_REPORT_APPROVER, android.content.pm.PackageManagerInternal.PACKAGE_APP_PREDICTOR })
    ...
    public interface PackageListObserver {
         ...
         */
        void onPackageRemoved(@android.annotation.NonNull
        java.lang.String packageName, int uid);
    }
    ...
    public interface CheckPermissionDelegate {
         ...
         */
        int checkPermission(java.lang.String permName, java.lang.String pkgName, int userId, com.android.internal.util.function.TriFunction<java.lang.String, java.lang.String, java.lang.Integer, java.lang.Integer> superImpl);
         ...
         * @return The check permission result.
         */
        int checkUidPermission(java.lang.String permName, int uid, java.util.function.BiFunction<java.lang.String, java.lang.Integer, java.lang.Integer> superImpl);
    }
    ...
    public interface SyncAdapterPackagesProvider {
         ...
         * @return The package names.
         */
        public java.lang.String[] getPackages(java.lang.String authority, int userId);
    }
    ...
    public interface DefaultBrowserProvider {
        ...
        java.lang.String getDefaultBrowser(@android.annotation.UserIdInt
        int userId);
         ...
         *
         * @param packageName
         * 		package name of the default browser, or {@code null} to remove
         * @param userId
         * 		the user id
         * @return whether the default browser was successfully set.
         */
        boolean setDefaultBrowser(@android.annotation.Nullable
         ...
         * 		the user id
         */
        void setDefaultBrowserAsync(@android.annotation.Nullable
        java.lang.String packageName, @android.annotation.UserIdInt
        int userId);
    }
    ...
    public interface DefaultDialerProvider {
         ...
         */
        @android.annotation.Nullable
        java.lang.String getDefaultDialer(@android.annotation.UserIdInt
        int userId);
    }
    ...
    public interface DefaultHomeProvider {
         ...
         */
        @android.annotation.Nullable
        java.lang.String getDefaultHome(@android.annotation.UserIdInt
        int userId);
         ...
         *
         * @param packageName
         * 		package name of the default home, or {@code null} to remove
         * @param userId
         * 		the user id
         * @param callback
         * 		the callback made after the default home as been updated
         */
        void setDefaultHomeAsync(@android.annotation.Nullable
        java.lang.String packageName, @android.annotation.UserIdInt
        int userId, @android.annotation.NonNull
     ...
     */
    public abstract void setLocationPackagesProvider(android.content.pm.PackageManagerInternal.PackagesProvider provider);
     ...
     * 		The packages provider.
     */
    public abstract void setLocationExtraPackagesProvider(android.content.pm.PackageManagerInternal.PackagesProvider provider);
     ...
     * 		The packages provider.
     */
    public abstract void setVoiceInteractionPackagesProvider(android.content.pm.PackageManagerInternal.PackagesProvider provider);
     ...
     * 		The packages provider.
     */
    public abstract void setUseOpenWifiAppPackagesProvider(android.content.pm.PackageManagerInternal.PackagesProvider provider);
     ...
     * 		The provider.
     */
    public abstract void setSyncAdapterPackagesprovider(android.content.pm.PackageManagerInternal.SyncAdapterPackagesProvider provider);
     ...
     * 		the new sms package
     * @param userId
     * 		user for which the change was made
     */
     ...
     *
     * @param packageName
     * 		The default use open wifi package name.
     * @param userId
     * 		The user for which to grant the permissions.
     */
    public abstract void grantDefaultPermissionsToDefaultUseOpenWifiApp(java.lang.String packageName, int userId);
     ...
     */
    public abstract void setKeepUninstalledPackages(java.util.List<java.lang.String> packageList);
     ...
     *
     * @param packageName
     * 		The package name for which to check.
     * @param userId
     * 		The user under which to check.
     * @return True a permissions review is required.
     */
    public abstract boolean isPermissionsReviewRequired(java.lang.String packageName, int userId);

    /**
     * Retrieve all of the information we know about a particular package/application.
     *
     * @param filterCallingUid
     * 		The results will be filtered in the context of this UID instead
     * 		of the calling UID.
     * @see PackageManager#getPackageInfo(String, int)
     */
    public abstract android.content.pm.PackageInfo getPackageInfo(java.lang.String packageName, @android.content.pm.PackageManager.PackageInfoFlags
     ...
     * 		listed
     * @param callingUid
     * 		The uid of the original caller app
     ...
     *
     * @param packageName
     * 		The package for which to return launcher extras.
     * @param userId
     * 		The user for which to check.
     ...
     */
    public abstract android.os.Bundle getSuspendedPackageLauncherExtras(java.lang.String packageName, int userId);
     ...
     */
    public abstract boolean isPackageSuspended(java.lang.String packageName, int userId);
     ...
     *
     * @param suspendedPackage
     * 		The package that has been suspended.
     * @param userId
     * 		The user for which to check.
     ...
     */
    public abstract java.lang.String getSuspendingPackage(java.lang.String suspendedPackage, int userId);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.SuspendDialogInfo getSuspendedDialogInfo(java.lang.String suspendedPackage, int userId);
    ...
    public abstract int getDistractingPackageRestrictions(java.lang.String packageName, int userId);
     ...
     */
    public abstract int getPackageUid(java.lang.String packageName, @android.content.pm.PackageManager.PackageInfoFlags
     ...
     */
    public abstract android.content.pm.ApplicationInfo getApplicationInfo(java.lang.String packageName, @android.content.pm.PackageManager.ApplicationInfoFlags
    int flags, int filterCallingUid, int userId);
     ...
     */
    public abstract android.content.pm.ActivityInfo getActivityInfo(android.content.ComponentName component, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags, int filterCallingUid, int userId);
     ...
     */
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentActivities(android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, int filterCallingUid, int userId);
     ...
     */
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentServices(android.content.Intent intent, int flags, int callingUid, int userId);

    /**
     * Interface to {@link com.android.server.pm.PackageManagerService#getHomeActivitiesAsUser}.
     */
    public abstract android.content.ComponentName getHomeActivitiesAsUser(java.util.List<android.content.pm.ResolveInfo> allHomeCandidates, int userId);
     ...
     */
    public abstract android.content.ComponentName getDefaultHomeActivity(int userId);

    /**
     * Called by DeviceOwnerManagerService to set the package names of device owner and profile
     * owners.
     */
    public abstract void setDeviceAndProfileOwnerPackages(int deviceOwnerUserId, java.lang.String deviceOwner, android.util.SparseArray<java.lang.String> profileOwners);

    /**
     * Returns {@code true} if a given package can't be wiped. Otherwise, returns {@code false}.
     */
    public abstract boolean isPackageDataProtected(int userId, java.lang.String packageName);
     ...
     */
    public abstract boolean isPackageStateProtected(java.lang.String packageName, int userId);

    /**
     * Returns {@code true} if a given package is installed as ephemeral. Otherwise, returns
     * {@code false}.
     */
    public abstract boolean isPackageEphemeral(int userId, java.lang.String packageName);
     ...
     */
    public abstract boolean wasPackageEverLaunched(java.lang.String packageName, int userId);
     ...
     * @param userId
     * 		The userId for which to grant the permission.
     * @param overridePolicy
     * 		If true, grant this permission even if it is fixed by policy.
     */
    public abstract void grantRuntimePermission(java.lang.String packageName, java.lang.String name, int userId, boolean overridePolicy);
     ...
     * 		The name of the permission.
     * @param userId
     * 		The userId for which to revoke the permission.
     * @param overridePolicy
     * 		If true, revoke this permission even if it is fixed by policy.
     */
    public abstract void revokeRuntimePermission(java.lang.String packageName, java.lang.String name, int userId, boolean overridePolicy);
     ...
     *
     * @param responseObj
     * 		The response of the first phase of ephemeral resolution
     * @param origIntent
     * 		The original intent that triggered ephemeral resolution
     * @param resolvedType
     * 		The resolved type of the intent
     * @param callingPackage
     * 		The name of the package requesting the ephemeral application
     * @param verificationBundle
     * 		Optional bundle to pass to the installer for additional
     * 		verification
     * @param userId
     * 		The ID of the user that triggered ephemeral resolution
     */
    public abstract void requestInstantAppResolutionPhaseTwo(android.content.pm.AuxiliaryResolveInfo responseObj, android.content.Intent origIntent, java.lang.String resolvedType, java.lang.String callingPackage, android.os.Bundle verificationBundle, int userId);
     ...
     * 		the user
     * @param intent
     * 		the intent that triggered the grant
     * @param targetAppId
     * 		The app ID of the fully installed application
     * @param ephemeralAppId
     * 		The app ID of the ephemeral application
     */
    public abstract void grantEphemeralAccess(int userId, android.content.Intent intent, int targetAppId, int ephemeralAppId);

    public abstract boolean isInstantAppInstallerComponent(android.content.ComponentName component);
    ...
    public interface ExternalSourcesPolicy {
         ...
         * @param uid
         * 		the uid in which the package is running
         ...
         */
        int getPackageTrustedToInstallApps(java.lang.String packageName, int uid);
    }

    public abstract void setExternalSourcesPolicy(android.content.pm.PackageManagerInternal.ExternalSourcesPolicy policy);

    /**
     * Return true if the given package is a persistent app process.
     */
    public abstract boolean isPackagePersistent(java.lang.String packageName);

    /**
     * Returns whether or not the given package represents a legacy system application released
     * prior to runtime permissions.
     */
    public abstract boolean isLegacySystemApp(android.content.pm.PackageParser.Package pkg);

    /**
     * Get all overlay packages for a user.
     *
     * @param userId
     * 		The user for which to get the overlays.
     * @return A list of overlay packages. An empty list is returned if the
    user has no installed overlay packages.
     */
    public abstract java.util.List<android.content.pm.PackageInfo> getOverlayPackages(int userId);

    /**
     * Get the names of all target packages for a user.
     *
     * @param userId
     * 		The user for which to get the package names.
     * @return A list of target package names. This list includes the "android" package.
     */
    public abstract java.util.List<java.lang.String> getTargetPackageNames(int userId);

    /**
     * Set which overlay to use for a package.
     *
     * @param userId
     * 		The user for which to update the overlays.
     * @param targetPackageName
     * 		The package name of the package for which to update the overlays.
     * @param overlayPackageNames
     * 		The complete list of overlay packages that should be enabled for
     ...
     */
    public abstract boolean setEnabledOverlayPackages(int userId, java.lang.String targetPackageName, java.util.List<java.lang.String> overlayPackageNames);

    /**
     * Resolves an activity intent, allowing instant apps to be resolved.
     */
    public abstract android.content.pm.ResolveInfo resolveIntent(android.content.Intent intent, java.lang.String resolvedType, int flags, int userId, boolean resolveForStart, int filterCallingUid);

    /**
     * Resolves a service intent, allowing instant apps to be resolved.
     */
    public abstract android.content.pm.ResolveInfo resolveService(android.content.Intent intent, java.lang.String resolvedType, int flags, int userId, int callingUid);

    /**
     * Resolves a content provider intent.
     */
    public abstract android.content.pm.ProviderInfo resolveContentProvider(java.lang.String name, int flags, int userId);

    /**
     * Track the creator of a new isolated uid.
     *
     * @param isolatedUid
     * 		The newly created isolated uid.
     * @param ownerUid
     * 		The uid of the app that created the isolated process.
     */
     ...
     *
     * @param isolatedUid
     * 		isolated uid that is no longer being used.
     */
     ...
     */
    public abstract int getPackageTargetSdkVersion(java.lang.String packageName);
     ...
     */
    public abstract boolean canAccessComponent(int callingUid, android.content.ComponentName component, int userId);
     ...
     */
    public abstract boolean hasInstantApplicationMetadata(java.lang.String packageName, int userId);

    /**
     * Updates a package last used time.
     */
    public abstract void notifyPackageUse(java.lang.String packageName, int reason);

    /**
     * Returns a package object for the given package name.
     */
    @android.annotation.Nullable
    public abstract android.content.pm.PackageParser.Package getPackage(@android.annotation.NonNull
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.PackageList getPackageList(@android.annotation.Nullable
     ...
     */
    public abstract void removePackageListObserver(@android.annotation.NonNull
    android.content.pm.PackageManagerInternal.PackageListObserver observer);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.PackageParser.Package getDisabledSystemPackage(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @android.annotation.Nullable
    public abstract java.lang.String getDisabledSystemPackageName(@android.annotation.NonNull
    java.lang.String packageName);

    /**
     * Returns whether or not the component is the resolver activity.
     */
    public abstract boolean isResolveActivityComponent(@android.annotation.NonNull
    android.content.pm.ComponentInfo component);

    /**
     * Returns the package name for a known package.
     */
    @android.annotation.Nullable
    public abstract java.lang.String getKnownPackageName(@android.content.pm.PackageManagerInternal.KnownPackage
    int knownPackage, int userId);

    /**
     * Returns whether the package is an instant app.
     */
    public abstract boolean isInstantApp(java.lang.String packageName, int userId);

    /**
     * Returns whether the package is an instant app.
     */
    @android.annotation.Nullable
    public abstract java.lang.String getInstantAppPackageName(int uid);
     ...
     */
    public abstract boolean filterAppAccess(@android.annotation.Nullable
    android.content.pm.PackageParser.Package pkg, int callingUid, int userId);
     ...
     */
    @android.annotation.Nullable
    public abstract int getPermissionFlagsTEMP(@android.annotation.NonNull
    java.lang.String permName, @android.annotation.NonNull
    java.lang.String packageName, int userId);

    /**
     * Updates the flags for the given permission.
     */
    public abstract void updatePermissionFlagsTEMP(@android.annotation.NonNull
    java.lang.String permName, @android.annotation.NonNull
    java.lang.String packageName, int flagMask, int flagValues, int userId);

    /**
     * Returns whether the given package was signed by the platform
     */
    public abstract boolean isPlatformSigned(java.lang.String pkg);
     ...
     */
    public abstract boolean isDataRestoreSafe(@android.annotation.NonNull
    byte[] restoringFromSigHash, @android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    public abstract boolean isDataRestoreSafe(@android.annotation.NonNull
    android.content.pm.Signature restoringFromSig, @android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    public abstract boolean hasSignatureCapability(int serverUid, int clientUid, @android.content.pm.PackageParser.SigningDetails.CertCapabilities
    int capability);
     ...
     *
     * @param delegate
     * 		A delegate instance or null to clear.
     */
    public abstract void setCheckPermissionDelegate(@android.annotation.Nullable
    android.content.pm.PackageManagerInternal.CheckPermissionDelegate delegate);
     ...
     * otherwise {@code null}.
     */
    public abstract java.lang.String getSharedUserIdForPackage(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    public abstract java.lang.String[] getPackagesForSharedUserId(@android.annotation.NonNull
    java.lang.String sharedUserId, int userId);
     ...
     *
     * @throws IOException
     * 		if the request was unable to be fulfilled.
     */
    public abstract void freeStorage(java.lang.String volumeUuid, long bytes, int storageFlags) throws java.io.IOException;

    /**
     * Returns {@code true} if the specified component is enabled and matches the given flags.
     */
    public abstract boolean isEnabledAndMatches(@android.annotation.NonNull
    android.content.pm.ComponentInfo info, int flags, int userId);
     ...
     */
    public abstract void forEachPackage(java.util.function.Consumer<android.content.pm.PackageParser.Package> actionLocked);

    /**
     * Perform the given action for each installed package for a user.
     * Note that packages lock will be held while performin the actions.
     */
    public abstract void forEachInstalledPackage(@android.annotation.NonNull
    java.util.function.Consumer<android.content.pm.PackageParser.Package> actionLocked, @android.annotation.UserIdInt
    int userId);

    /**
     * Returns the list of enabled components
     */
    public abstract android.util.ArraySet<java.lang.String> getEnabledComponents(java.lang.String packageName, int userId);

    /**
     * Returns the list of disabled components
     */
    public abstract android.util.ArraySet<java.lang.String> getDisabledComponents(java.lang.String packageName, int userId);

    /**
     * Returns whether the given package is enabled for the given user
     */
    @android.content.pm.PackageManager.EnabledState
    public abstract int getApplicationEnabledState(java.lang.String packageName, int userId);
     ...
     * @param enableRollbackCode
     * 		the status code result of enabling rollback
     ...
     */
    public abstract boolean compileLayouts(java.lang.String packageName);
     ...
     */
    @android.annotation.Nullable
    public abstract java.lang.String removeLegacyDefaultBrowserPackageName(int userId);
     ...
     * 		the provider
     */
    public abstract void setDefaultBrowserProvider(@android.annotation.NonNull
    android.content.pm.PackageManagerInternal.DefaultBrowserProvider provider);
     ...
     * 		the provider
     */
    public abstract void setDefaultDialerProvider(@android.annotation.NonNull
    android.content.pm.PackageManagerInternal.DefaultDialerProvider provider);
     ...
     * 		the provider
     */
    public abstract void setDefaultHomeProvider(@android.annotation.NonNull
    android.content.pm.PackageManagerInternal.DefaultHomeProvider provider);

    /**
     * Returns {@code true} if given {@code packageName} is an apex package.
     */
    public abstract boolean isApexPackage(java.lang.String packageName);

    /**
     * Uninstalls given {@code packageName}.
     *
     * @param packageName
     * 		apex package to uninstall.
     * @param versionCode
     * 		version of a package to uninstall.
     * @param userId
     * 		user to uninstall apex package for. Must be
     * 		{@link android.os.UserHandle#USER_ALL}, otherwise failure will be reported.
     * @param intentSender
     * 		a {@link IntentSender} to send result of an uninstall to.
     */
    public abstract void uninstallApex(java.lang.String packageName, long versionCode, int userId, android.content.IntentSender intentSender);
     ...
     */
    public abstract void setRuntimePermissionsFingerPrint(@android.annotation.NonNull
    java.lang.String fingerPrint, @android.annotation.UserIdInt
    int userId);
