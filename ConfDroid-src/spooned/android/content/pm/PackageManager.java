...
public abstract class PackageManager {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "GET_", "MATCH_" }, value = { android.content.pm.PackageManager.GET_META_DATA, android.content.pm.PackageManager.GET_SHARED_LIBRARY_FILES, android.content.pm.PackageManager.MATCH_ALL, android.content.pm.PackageManager.MATCH_DEBUG_TRIAGED_MISSING, android.content.pm.PackageManager.MATCH_DEFAULT_ONLY, android.content.pm.PackageManager.MATCH_DISABLED_COMPONENTS, android.content.pm.PackageManager.MATCH_DISABLED_UNTIL_USED_COMPONENTS, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AUTO, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AWARE, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_UNAWARE, android.content.pm.PackageManager.MATCH_SYSTEM_ONLY, android.content.pm.PackageManager.MATCH_UNINSTALLED_PACKAGES, android.content.pm.PackageManager.MATCH_INSTANT, android.content.pm.PackageManager.MATCH_STATIC_SHARED_LIBRARIES, android.content.pm.PackageManager.GET_DISABLED_COMPONENTS, android.content.pm.PackageManager.GET_DISABLED_UNTIL_USED_COMPONENTS, android.content.pm.PackageManager.GET_UNINSTALLED_PACKAGES })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "GET_", "MATCH_" }, value = { android.content.pm.PackageManager.GET_META_DATA, android.content.pm.PackageManager.GET_RESOLVED_FILTER, android.content.pm.PackageManager.GET_SHARED_LIBRARY_FILES, android.content.pm.PackageManager.MATCH_ALL, android.content.pm.PackageManager.MATCH_DEBUG_TRIAGED_MISSING, android.content.pm.PackageManager.MATCH_DISABLED_COMPONENTS, android.content.pm.PackageManager.MATCH_DISABLED_UNTIL_USED_COMPONENTS, android.content.pm.PackageManager.MATCH_DEFAULT_ONLY, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AUTO, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AWARE, android.content.pm.PackageManager.MATCH_DIRECT_BOOT_UNAWARE, android.content.pm.PackageManager.MATCH_SYSTEM_ONLY, android.content.pm.PackageManager.MATCH_UNINSTALLED_PACKAGES, android.content.pm.PackageManager.MATCH_INSTANT, android.content.pm.PackageManager.GET_DISABLED_COMPONENTS, android.content.pm.PackageManager.GET_DISABLED_UNTIL_USED_COMPONENTS, android.content.pm.PackageManager.GET_UNINSTALLED_PACKAGES })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "GET_", "MATCH_" }, value = { android.content.pm.PackageManager.MATCH_ALL })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public static final int GET_RECEIVERS = 0x2;

    /**
     * {@link PackageInfo} flag: return information about
     * services in the package in {@link PackageInfo#services}.
     */
    public static final int GET_SERVICES = 0x4;
     ...
     */
    public static final int GET_PROVIDERS = 0x8;
     ...
     */
    public static final int GET_INSTRUMENTATION = 0x10;

    /**
     * {@link PackageInfo} flag: return information about the
     * intent filters supported by the activity.
     */
    public static final int GET_INTENT_FILTERS = 0x20;
    ...
    public static final int GET_SIGNATURES = 0x40;
     ...
     */
    public static final int GET_RESOLVED_FILTER = 0x40;
     ...
     */
    public static final int GET_GIDS = 0x100;
     ...
     */
    @java.lang.Deprecated
    public static final int GET_DISABLED_COMPONENTS = 0x200;

    /**
     * {@link PackageInfo} flag: include disabled components in the returned info.
     */
    public static final int MATCH_DISABLED_COMPONENTS = 0x200;
     ...
     * directly or nested inside of another.
     */
    public static final int GET_SHARED_LIBRARY_FILES = 0x400;
     ...
     * directly or nested inside of another.
     */
    public static final int GET_URI_PERMISSION_PATTERNS = 0x800;
     ...
     */
    @java.lang.Deprecated
    public static final int GET_UNINSTALLED_PACKAGES = 0x2000;
     ...
     */
    public static final int MATCH_UNINSTALLED_PACKAGES = 0x2000;
     ...
     */
    public static final int GET_CONFIGURATIONS = 0x4000;
     ...
     */
    @java.lang.Deprecated
    public static final int GET_DISABLED_UNTIL_USED_COMPONENTS = 0x8000;
     ...
     */
    public static final int MATCH_DISABLED_UNTIL_USED_COMPONENTS = 0x8000;
     ...
     */
    @android.annotation.TestApi
    public static final int MATCH_KNOWN_PACKAGES = android.content.pm.PackageManager.MATCH_UNINSTALLED_PACKAGES | android.content.pm.PackageManager.MATCH_ANY_USER;
     ...
     */
    @java.lang.Deprecated
    public static final int MATCH_DEBUG_TRIAGED_MISSING = android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AUTO;
     ...
     * @unknown 
     */
    public static final int SKIP_CURRENT_PROFILE = 0x2;
     ...
     * @unknown 
     */
    public static final int ONLY_IF_NO_MATCH_FOUND = 0x4;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "PERMISSION_" }, value = { android.content.pm.PackageManager.PERMISSION_GRANTED, android.content.pm.PackageManager.PERMISSION_DENIED })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    public static final int INSTALL_REPLACE_EXISTING = 0x2;
     ...
     * @unknown 
     */
    public static final int INSTALL_ALLOW_TEST = 0x4;
     ...
     * @unknown 
     */
    public static final int INSTALL_INTERNAL = 0x10;
     ...
     * @unknown 
     */
    public static final int INSTALL_FROM_ADB = 0x20;
     ...
     * @unknown 
     */
    public static final int INSTALL_ALL_USERS = 0x40;
     ...
     * @unknown 
     */
    public static final int INSTALL_REQUEST_DOWNGRADE = 0x80;
     ...
     * @unknown 
     */
    public static final int INSTALL_GRANT_RUNTIME_PERMISSIONS = 0x100;
     ...
     * {@hide }
     */
    public static final int INSTALL_FORCE_VOLUME_UUID = 0x200;
     ...
     * @unknown 
     */
    public static final int INSTALL_FORCE_PERMISSION_PROMPT = 0x400;
     ...
     * @unknown 
     */
    public static final int INSTALL_INSTANT_APP = 0x800;
     ...
     * @unknown 
     */
    public static final int INSTALL_DONT_KILL_APP = 0x1000;
     ...
     * @unknown 
     */
    public static final int INSTALL_FULL_APP = 0x4000;
     ...
     * @unknown 
     */
    public static final int INSTALL_ALLOCATE_AGGRESSIVE = 0x8000;
     ...
     * @unknown 
     */
    public static final int INSTALL_APEX = 0x20000;
     ...
     * @unknown 
     */
    public static final int INSTALL_ENABLE_ROLLBACK = 0x40000;
     ...
     * @unknown 
     */
    public static final int INSTALL_DISABLE_VERIFICATION = 0x80000;
     ...
     * @unknown 
     */
    public static final int INSTALL_DRY_RUN = 0x800000;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "DONT_KILL_APP" }, value = { android.content.pm.PackageManager.DONT_KILL_APP })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public static final int DONT_KILL_APP = 0x1;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "INSTALL_REASON_" }, value = { android.content.pm.PackageManager.INSTALL_REASON_UNKNOWN, android.content.pm.PackageManager.INSTALL_REASON_POLICY, android.content.pm.PackageManager.INSTALL_REASON_DEVICE_RESTORE, android.content.pm.PackageManager.INSTALL_REASON_DEVICE_SETUP, android.content.pm.PackageManager.INSTALL_REASON_USER })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * @unknown 
     */
    public static final int DELETE_KEEP_DATA = 0x1;
     ...
     * @unknown 
     */
    public static final int DELETE_ALL_USERS = 0x2;
     ...
     * @unknown 
     */
    public static final int DELETE_SYSTEM_APP = 0x4;
     ...
     * @unknown 
     */
    public static final int DELETE_DONT_KILL_APP = 0x8;
     ...
     * @unknown 
     */
    public static final int DELETE_CONTRIBUTED_MEDIA = 0x10;
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public static final int MOVE_INTERNAL = 0x1;
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public static final int MOVE_EXTERNAL_MEDIA = 0x2;
     ...
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.FEATURE)
     ...
     *
     *
     * @unknown Feature for {@link #getSystemAvailableFeatures} and
     ...
     *
     *
     * @unknown TODO: Remove after dependencies updated b/17392243
     */
     ...
     * @unknown 
     */
    public static final int FLAGS_PERMISSION_RESTRICTION_ANY_EXEMPT = (android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_INSTALLER_EXEMPT | android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_SYSTEM_EXEMPT) | android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_UPGRADE_EXEMPT;
     ...
     * @unknown 
     */
    public static final int MASK_PERMISSION_FLAGS_ALL = (((((((((((((android.content.pm.PackageManager.FLAG_PERMISSION_USER_SET | android.content.pm.PackageManager.FLAG_PERMISSION_USER_FIXED) | android.content.pm.PackageManager.FLAG_PERMISSION_POLICY_FIXED) | android.content.pm.PackageManager.FLAG_PERMISSION_REVOKE_ON_UPGRADE) | android.content.pm.PackageManager.FLAG_PERMISSION_SYSTEM_FIXED) | android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_DEFAULT) | android.content.pm.PackageManager.FLAG_PERMISSION_REVIEW_REQUIRED) | android.content.pm.PackageManager.FLAG_PERMISSION_REVOKE_WHEN_REQUESTED) | android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_GRANTED) | android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_DENIED) | android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_INSTALLER_EXEMPT) | android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_SYSTEM_EXEMPT) | android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_UPGRADE_EXEMPT) | android.content.pm.PackageManager.FLAG_PERMISSION_APPLY_RESTRICTION) | android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_ROLE;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "FLAG_PERMISSION_WHITELIST_" }, value = { android.content.pm.PackageManager.FLAG_PERMISSION_WHITELIST_SYSTEM, android.content.pm.PackageManager.FLAG_PERMISSION_WHITELIST_INSTALLER, android.content.pm.PackageManager.FLAG_PERMISSION_WHITELIST_UPGRADE })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * 		found on the system.
     */
    public abstract android.content.pm.PackageInfo getPackageInfo(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.PackageInfoFlags
     ...
     */
    public abstract android.content.pm.PackageInfo getPackageInfo(@android.annotation.NonNull
    android.content.pm.VersionedPackage versionedPackage, @android.content.pm.PackageManager.PackageInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.PackageInfo getPackageInfoAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.PackageInfoFlags
     ...
     */
    public abstract java.lang.String[] currentToCanonicalPackageNames(@android.annotation.NonNull
     ...
     */
    public abstract java.lang.String[] canonicalToCurrentPackageNames(@android.annotation.NonNull
    java.lang.String[] packageNames);
    ...
    public abstract android.content.Intent getLaunchIntentForPackage(@android.annotation.NonNull
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.Intent getLeanbackLaunchIntentForPackage(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.Intent getCarLaunchIntentForPackage(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     * 		found on the system.
     */
    public abstract int[] getPackageGids(@android.annotation.NonNull
    java.lang.String packageName) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     * 		found on the system.
     */
    public abstract int getPackageUid(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.PackageInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     * 		desired package.
     * @param userId
     * 		The user handle identifier to look up the package under.
     * @return Returns an integer UID who owns the given package name.
     * @throws NameNotFoundException
     * 		if a package with the given name can not be
     * 		found on the system.
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract int getPackageUidAsUser(@android.annotation.NonNull
     ...
     * 		found on the system.
     */
    public abstract android.content.pm.PermissionInfo getPermissionInfo(@android.annotation.NonNull
    java.lang.String permissionName, @android.content.pm.PackageManager.PermissionInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    public abstract java.util.List<android.content.pm.PermissionInfo> queryPermissionsByGroup(@android.annotation.NonNull
    java.lang.String permissionGroup, @android.content.pm.PackageManager.PermissionInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.PermissionGroupInfo getPermissionGroupInfo(@android.annotation.NonNull
    java.lang.String permissionName, @android.content.pm.PackageManager.PermissionGroupInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.PermissionGroupInfo> getAllPermissionGroups(@android.content.pm.PackageManager.PermissionGroupInfoFlags
    int flags);
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.ApplicationInfo getApplicationInfo(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.ApplicationInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.ApplicationInfo getApplicationInfoAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.ApplicationInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    @android.annotation.SystemApi
    public android.content.pm.ApplicationInfo getApplicationInfoAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.ApplicationInfoFlags
    int flags, @android.annotation.NonNull
    android.os.UserHandle user) throws android.content.pm.PackageManager.NameNotFoundException {
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.ActivityInfo getActivityInfo(@android.annotation.NonNull
    android.content.ComponentName component, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.ActivityInfo getReceiverInfo(@android.annotation.NonNull
    android.content.ComponentName component, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.ServiceInfo getServiceInfo(@android.annotation.NonNull
    android.content.ComponentName component, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.ProviderInfo getProviderInfo(@android.annotation.NonNull
    android.content.ComponentName component, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    module.
     * @throws NameNotFoundException
     * 		if a module with the given name cannot be
     * 		found on the system.
     */
    @android.annotation.NonNull
    public android.content.pm.ModuleInfo getModuleInfo(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.ModuleInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException {
     ...
     */
    @android.annotation.NonNull
    public java.util.List<android.content.pm.ModuleInfo> getInstalledModules(@android.content.pm.PackageManager.ModuleInfoFlags
    int flags) {
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.PackageInfo> getInstalledPackages(@android.content.pm.PackageManager.PackageInfoFlags
    int flags);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.PackageInfo> getPackagesHoldingPermissions(@android.annotation.NonNull
    java.lang.String[] permissions, @android.content.pm.PackageManager.PackageInfoFlags
    int flags);
     ...
     * 		Additional option flags to modify the data returned.
     * @param userId
     * 		The user for whom the installed packages are to be listed
     * @return A List of PackageInfo objects, one for each installed package,
    containing information about the package. In the unlikely case
    there are no installed packages, an empty list is returned. If
    flag {@code MATCH_UNINSTALLED_PACKAGES} is set, the package
    ...
    @android.annotation.TestApi
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.INTERACT_ACROSS_USERS_FULL.class)
    public abstract java.util.List<android.content.pm.PackageInfo> getInstalledPackagesAsUser(@android.content.pm.PackageManager.PackageInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
    ...
    java.lang.String permissionName, @android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @android.annotation.CheckResult
    public abstract boolean isPermissionRevokedByPolicy(@android.annotation.NonNull
    java.lang.String permissionName, @android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    public abstract boolean addPermission(@android.annotation.NonNull
     ...
     */
    public abstract boolean addPermissionAsync(@android.annotation.NonNull
    android.content.pm.PermissionInfo info);
     ...
     */
    public abstract void removePermission(@android.annotation.NonNull
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.IntDef(prefix = { "FLAG_PERMISSION_" }, value = { android.content.pm.PackageManager.FLAG_PERMISSION_USER_SET, android.content.pm.PackageManager.FLAG_PERMISSION_USER_FIXED, android.content.pm.PackageManager.FLAG_PERMISSION_POLICY_FIXED, android.content.pm.PackageManager.FLAG_PERMISSION_REVOKE_ON_UPGRADE, android.content.pm.PackageManager.FLAG_PERMISSION_SYSTEM_FIXED, android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_DEFAULT, android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_GRANTED, android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_DENIED, /* FLAG_PERMISSION_REVOKE_WHEN_REQUESED */
    android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_UPGRADE_EXEMPT, android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_SYSTEM_EXEMPT, android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_INSTALLER_EXEMPT, android.content.pm.PackageManager.FLAG_PERMISSION_APPLY_RESTRICTION, android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_ROLE })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     *
     * @param packageName
     * 		The package to which to grant the permission.
     * @param permissionName
     * 		The permission name to grant.
     * @param user
     * 		The user for which to grant the permission.
     * @see #revokeRuntimePermission(String, String, android.os.UserHandle)
     * @unknown 
     */
    @android.annotation.TestApi
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.GRANT_RUNTIME_PERMISSIONS.class)
    public abstract void grantRuntimePermission(@android.annotation.NonNull
     ...
     *
     * @param packageName
     * 		The package from which to revoke the permission.
     * @param permissionName
     * 		The permission name to revoke.
     * @param user
     * 		The user for which to revoke the permission.
     * @see #grantRuntimePermission(String, String, android.os.UserHandle)
     * @unknown 
     */
    @android.annotation.TestApi
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.REVOKE_RUNTIME_PERMISSIONS.class)
    public abstract void revokeRuntimePermission(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String permissionName, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     * @param packageName
     * 		The package name for which to get the flags.
     * @param user
     * 		The user for which to get permission flags.
     * @return The permission flags.
     * @unknown 
     */
    @android.annotation.SystemApi
    @android.annotation.TestApi
    @android.annotation.RequiresPermission(anyOf = { android.content.pm.android.Manifest.permission.GRANT_RUNTIME_PERMISSIONS, android.content.pm.android.Manifest.permission.REVOKE_RUNTIME_PERMISSIONS, android.content.pm.android.Manifest.permission.GET_RUNTIME_PERMISSIONS })
    @android.content.pm.PackageManager.PermissionFlags
    public abstract int getPermissionFlags(@android.annotation.NonNull
    java.lang.String permissionName, @android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     *
     * @param permissionName
     * 		The permission for which to update the flags.
     * @param packageName
     * 		The package name for which to update the flags.
     * @param flagMask
     * 		The flags which to replace.
     * @param flagValues
     * 		The flags with which to replace.
     * @param user
     * 		The user for which to update the permission flags.
     * @unknown 
     */
    @android.annotation.SystemApi
    @android.annotation.TestApi
    @android.annotation.RequiresPermission(anyOf = { android.content.pm.android.Manifest.permission.GRANT_RUNTIME_PERMISSIONS, android.content.pm.android.Manifest.permission.REVOKE_RUNTIME_PERMISSIONS })
    public abstract void updatePermissionFlags(@android.annotation.NonNull
    java.lang.String permissionName, @android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.PermissionFlags
    int flagMask, @android.content.pm.PackageManager.PermissionFlags
    int flagValues, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     * @param whitelistFlag
     * 		The flag to determine which whitelist to query. Only one flag
     * 		can be passed.s
     ...
     */
    @android.annotation.RequiresPermission(value = Manifest.permission.WHITELIST_RESTRICTED_PERMISSIONS, conditional = true)
    @android.annotation.NonNull
    public java.util.Set<java.lang.String> getWhitelistedRestrictedPermissions(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.PermissionWhitelistFlags
    int whitelistFlag) {
     ...
     * @param whitelistFlags
     * 		The whitelists to which to add. Passing multiple flags
     ...
     */
    @android.annotation.RequiresPermission(value = Manifest.permission.WHITELIST_RESTRICTED_PERMISSIONS, conditional = true)
    public boolean addWhitelistedRestrictedPermission(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String permission, @android.content.pm.PackageManager.PermissionWhitelistFlags
    int whitelistFlags) {
        return false;
    }
     ...
     * @param whitelistFlags
     * 		The whitelists from which to remove. Passing multiple flags
     * 		updates all specified whitelists.
     ...
     */
    @android.annotation.RequiresPermission(value = Manifest.permission.WHITELIST_RESTRICTED_PERMISSIONS, conditional = true)
    public boolean removeWhitelistedRestrictedPermission(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    java.lang.String permission, @android.content.pm.PackageManager.PermissionWhitelistFlags
    int whitelistFlags) {
        return false;
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean shouldShowRequestPermissionRationale(@android.annotation.NonNull
    java.lang.String permissionName);
     ...
     * 		if {@code permissions} is {@code null} or empty.
     * @unknown 
     */
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public android.content.Intent buildRequestPermissionsIntent(@android.annotation.NonNull
    java.lang.String[] permissions) {
        if (com.android.internal.util.ArrayUtils.isEmpty(permissions)) {
            throw new java.lang.IllegalArgumentException("permission cannot be null or empty");
        }
        android.content.Intent intent = new android.content.Intent(android.content.pm.PackageManager.ACTION_REQUEST_PERMISSIONS);
        intent.putExtra(android.content.pm.PackageManager.EXTRA_REQUEST_PERMISSIONS_NAMES, permissions);
    ...
    all signatures match or < 0 if there is not a match ({@link #SIGNATURE_NO_MATCH} or {@link #SIGNATURE_UNKNOWN_PACKAGE}).
     * @see #checkSignatures(int, int)
     */
    @android.annotation.CheckResult
    @android.content.pm.PackageManager.SignatureResult
    public abstract int checkSignatures(@android.annotation.NonNull
    java.lang.String packageName1, @android.annotation.NonNull
     ...
     *
     * @param uid
     * 		The uid for which you would like to retrieve a name.
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract int getUidForSharedUser(@android.annotation.NonNull
    java.lang.String sharedUserName) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ApplicationInfo> getInstalledApplications(@android.content.pm.PackageManager.ApplicationInfoFlags
    int flags);
     ...
     * 		Additional option flags to modify the data returned.
     * @param userId
     * 		The user for whom the installed applications are to be
     * 		listed
     * @return A List of ApplicationInfo objects, one for each installed
    application. In the unlikely case there are no installed
    packages, an empty list is returned. If flag
    ...
    @android.annotation.NonNull
    @android.annotation.TestApi
    public abstract java.util.List<android.content.pm.ApplicationInfo> getInstalledApplicationsAsUser(@android.content.pm.PackageManager.ApplicationInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.ACCESS_INSTANT_APPS)
    @android.annotation.NonNull
     ...
     */
    public abstract boolean isInstantApp(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    public abstract void updateInstantAppCookie(@android.annotation.Nullable
    byte[] cookie);
     ...
     * @unknown 
     */
    public abstract boolean setInstantAppCookie(@android.annotation.Nullable
    byte[] cookie);
     ...
     *
     * @param flags
     * 		To filter the libraries to return.
     * @return The shared library list.
     * @see #MATCH_UNINSTALLED_PACKAGES
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.SharedLibraryInfo> getSharedLibraries(@android.content.pm.PackageManager.InstallFlags
    int flags);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.SharedLibraryInfo> getSharedLibrariesAsUser(@android.content.pm.PackageManager.InstallFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     * @param flags
     * 		the flags to filter packages
     * @return the shared library list
     * @unknown 
     */
    @android.annotation.NonNull
    @android.annotation.RequiresPermission(Manifest.permission.ACCESS_SHARED_LIBRARIES)
    @android.annotation.SystemApi
    public java.util.List<android.content.pm.SharedLibraryInfo> getDeclaredSharedLibraries(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.InstallFlags
    int flags) {
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.ChangedPackages getChangedPackages(@android.annotation.IntRange(from = 0)
    int sequenceNumber);
     ...
     */
    public abstract boolean hasSystemFeature(@android.annotation.NonNull
     ...
     */
    public abstract boolean hasSystemFeature(@android.annotation.NonNull
    java.lang.String featureName, int version);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.ResolveInfo resolveActivity(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
    ...
    @android.annotation.Nullable
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.ResolveInfo resolveActivityAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentActivities(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentActivitiesAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
    ...
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    @android.annotation.SystemApi
    public java.util.List<android.content.pm.ResolveInfo> queryIntentActivitiesAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.NonNull
    android.os.UserHandle user) {
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentActivityOptions(@android.annotation.Nullable
    android.content.ComponentName caller, @android.annotation.Nullable
    android.content.Intent[] specifics, @android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ResolveInfo> queryBroadcastReceivers(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
     ...
     * 		Additional option flags to modify the data returned.
     * @param userHandle
     * 		UserHandle of the user being queried.
     * @return Returns a List of ResolveInfo objects containing one entry for
    each matching receiver, ordered from best to worst. If there are
    no matching receivers, an empty list or null is returned.
     * @unknown 
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    public java.util.List<android.content.pm.ResolveInfo> queryBroadcastReceiversAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, android.os.UserHandle userHandle) {
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract java.util.List<android.content.pm.ResolveInfo> queryBroadcastReceiversAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public java.util.List<android.content.pm.ResolveInfo> queryBroadcastReceivers(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId) {
        final java.lang.String msg = "Shame on you for calling the hidden API " + "queryBroadcastReceivers(). Shame!";
        if (dalvik.system.VMRuntime.getRuntime().getTargetSdkVersion() >= Build.VERSION_CODES.O) {
            throw new java.lang.UnsupportedOperationException(msg);
        } else {
            android.util.Log.d(android.content.pm.PackageManager.TAG, msg);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.ResolveInfo resolveService(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.ResolveInfo resolveServiceAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentServices(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentServicesAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
    ...
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    @android.annotation.SystemApi
    public java.util.List<android.content.pm.ResolveInfo> queryIntentServicesAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.NonNull
    android.os.UserHandle user) {
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentContentProvidersAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
    ...
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS)
    @android.annotation.SystemApi
    public java.util.List<android.content.pm.ResolveInfo> queryIntentContentProvidersAsUser(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags, @android.annotation.NonNull
    android.os.UserHandle user) {
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ResolveInfo> queryIntentContentProviders(@android.annotation.NonNull
    android.content.Intent intent, @android.content.pm.PackageManager.ResolveInfoFlags
    int flags);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.pm.ProviderInfo resolveContentProvider(@android.annotation.NonNull
    java.lang.String authority, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags);
    ...
    @android.annotation.Nullable
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.ProviderInfo resolveContentProviderAsUser(@android.annotation.NonNull
    java.lang.String providerName, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.ProviderInfo> queryContentProviders(@android.annotation.Nullable
    java.lang.String processName, int uid, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags);
     ...
     */
    @android.annotation.NonNull
    public java.util.List<android.content.pm.ProviderInfo> queryContentProviders(@android.annotation.Nullable
    java.lang.String processName, int uid, @android.content.pm.PackageManager.ComponentInfoFlags
    int flags, java.lang.String metaDataKey) {
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.pm.InstrumentationInfo getInstrumentationInfo(@android.annotation.NonNull
    android.content.ComponentName className, @android.content.pm.PackageManager.InstrumentationInfoFlags
    int flags) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract java.util.List<android.content.pm.InstrumentationInfo> queryInstrumentation(@android.annotation.NonNull
    java.lang.String targetPackage, @android.content.pm.PackageManager.InstrumentationInfoFlags
    int flags);
     ...
     */
    @android.annotation.Nullable
    public abstract android.graphics.drawable.Drawable getDrawable(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.DrawableRes
     ...
     */
    @android.annotation.NonNull
    public abstract android.graphics.drawable.Drawable getActivityIcon(@android.annotation.NonNull
    android.content.ComponentName activityName) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    @android.annotation.NonNull
    public abstract android.graphics.drawable.Drawable getActivityIcon(@android.annotation.NonNull
    android.content.Intent intent) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.Nullable
    public abstract android.graphics.drawable.Drawable getActivityBanner(@android.annotation.NonNull
    android.content.ComponentName activityName) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.graphics.drawable.Drawable getApplicationIcon(@android.annotation.NonNull
     ...
     */
    @android.annotation.Nullable
    public abstract android.graphics.drawable.Drawable getApplicationBanner(@android.annotation.NonNull
    android.content.pm.ApplicationInfo info);
     ...
     */
    @android.annotation.Nullable
    public abstract android.graphics.drawable.Drawable getActivityLogo(@android.annotation.NonNull
    android.content.ComponentName activityName) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.Nullable
    public abstract android.graphics.drawable.Drawable getApplicationLogo(@android.annotation.NonNull
    android.content.pm.ApplicationInfo info);
     ...
     */
    @android.annotation.NonNull
    public abstract android.graphics.drawable.Drawable getUserBadgedIcon(@android.annotation.NonNull
    android.graphics.drawable.Drawable drawable, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     */
    @android.annotation.NonNull
    public abstract android.graphics.drawable.Drawable getUserBadgedDrawableForDensity(@android.annotation.NonNull
    android.graphics.drawable.Drawable drawable, @android.annotation.NonNull
    android.os.UserHandle user, @android.annotation.Nullable
    ...
    @android.annotation.Nullable
    @android.annotation.UnsupportedAppUsage
    public abstract android.graphics.drawable.Drawable getUserBadgeForDensity(@android.annotation.NonNull
    android.os.UserHandle user, int density);
    ...
    @android.annotation.Nullable
    @android.annotation.UnsupportedAppUsage
    public abstract android.graphics.drawable.Drawable getUserBadgeForDensityNoBackground(@android.annotation.NonNull
    android.os.UserHandle user, int density);
     ...
     */
    @android.annotation.NonNull
    public abstract java.lang.CharSequence getUserBadgedLabel(@android.annotation.NonNull
     ...
     */
    @android.annotation.Nullable
    public abstract java.lang.CharSequence getText(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.StringRes
    int resid, @android.annotation.Nullable
    android.content.pm.ApplicationInfo appInfo);
     ...
     */
    @android.annotation.Nullable
    public abstract android.content.res.XmlResourceParser getXml(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.XmlRes
    int resid, @android.annotation.Nullable
    android.content.pm.ApplicationInfo appInfo);
     ...
     */
    @android.annotation.NonNull
    public abstract java.lang.CharSequence getApplicationLabel(@android.annotation.NonNull
    android.content.pm.ApplicationInfo info);
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.res.Resources getResourcesForActivity(@android.annotation.NonNull
    android.content.ComponentName activityName) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.content.res.Resources getResourcesForApplication(@android.annotation.NonNull
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.res.Resources getResourcesForApplicationAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @android.annotation.Nullable
    public android.content.pm.PackageInfo getPackageArchiveInfo(@android.annotation.NonNull
    java.lang.String archiveFilePath, @android.content.pm.PackageManager.PackageInfoFlags
    int flags) {
        final android.content.pm.PackageParser parser = new android.content.pm.PackageParser();
        parser.setCallback(new android.content.pm.PackageParser.CallbackImpl(this));
        final java.io.File apkFile = new java.io.File(archiveFilePath);
        try {
            if ((flags & (android.content.pm.PackageManager.MATCH_DIRECT_BOOT_UNAWARE | android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AWARE)) != 0) {
                // Caller expressed an explicit opinion about what encryption
                // aware/unaware components they want to see, so fall through and
                // give them what they want
            } else {
                // Caller expressed no opinion, so match everything
                flags |= android.content.pm.PackageManager.MATCH_DIRECT_BOOT_AWARE | android.content.pm.PackageManager.MATCH_DIRECT_BOOT_UNAWARE;
            }
            android.content.pm.PackageParser.Package pkg = parser.parseMonolithicPackage(apkFile, 0);
            if ((flags & android.content.pm.PackageManager.GET_SIGNATURES) != 0) {
                /* skipVerify */
                android.content.pm.PackageParser.collectCertificates(pkg, false);
            }
            android.content.pm.PackageUserState state = new android.content.pm.PackageUserState();
            return android.content.pm.PackageParser.generatePackageInfo(pkg, null, flags, 0, 0, null, state);
    ...
    @java.lang.Deprecated
    @android.annotation.SystemApi
    public abstract int installExistingPackage(@android.annotation.NonNull
    java.lang.String packageName) throws android.content.pm.PackageManager.NameNotFoundException;
    ...
    @android.annotation.SystemApi
    public abstract int installExistingPackage(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.InstallReason
    int installReason) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     */
    @java.lang.Deprecated
    @android.annotation.RequiresPermission(anyOf = { Manifest.permission.INSTALL_EXISTING_PACKAGES, Manifest.permission.INSTALL_PACKAGES, Manifest.permission.INTERACT_ACROSS_USERS_FULL })
    @android.annotation.UnsupportedAppUsage
    public abstract int installExistingPackageAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId) throws android.content.pm.PackageManager.NameNotFoundException;
     ...
     * 		either {@link PackageManager#VERIFICATION_ALLOW}
     ...
     * 		pending package identifier as passed via the
     * 		{@link PackageManager#EXTRA_VERIFICATION_ID} Intent extra.
     * @param verificationCodeAtTimeout
     * 		either
     * 		{@link PackageManager#VERIFICATION_ALLOW} or
     ...
     * 		{@link PackageManager#EXTRA_VERIFICATION_ID} Intent extra.
     * @param verificationCode
     * 		either {@link PackageManager#INTENT_FILTER_VERIFICATION_SUCCESS}
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.INTENT_FILTER_VERIFICATION_AGENT.class)
    public abstract void verifyIntentFilter(int verificationId, int verificationCode, @android.annotation.NonNull
     ...
     *
     * @param packageName
     * 		The package name of the Activity associated with the IntentFilter.
     * @param userId
     * 		The user id.
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS_FULL)
    public abstract int getIntentVerificationStatusAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.SET_PREFERRED_APPLICATIONS.class)
    public abstract boolean updateIntentVerificationStatusAsUser(@android.annotation.NonNull
    java.lang.String packageName, int status, @android.annotation.UserIdInt
    int userId);
    ...
    @android.annotation.NonNull
    @android.annotation.SystemApi
    public abstract java.util.List<android.content.pm.IntentFilterVerificationInfo> getIntentFilterVerifications(@android.annotation.NonNull
    java.lang.String packageName);
    ...
    @android.annotation.NonNull
    @android.annotation.SystemApi
    public abstract java.util.List<android.content.IntentFilter> getAllIntentFilters(@android.annotation.NonNull
    java.lang.String packageName);
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.INTERACT_ACROSS_USERS_FULL)
    public abstract java.lang.String getDefaultBrowserPackageNameAsUser(@android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(allOf = { Manifest.permission.SET_PREFERRED_APPLICATIONS, Manifest.permission.INTERACT_ACROSS_USERS_FULL })
    public abstract boolean setDefaultBrowserPackageNameAsUser(@android.annotation.Nullable
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId);
     ...
     */
    public abstract void setInstallerPackageName(@android.annotation.NonNull
    java.lang.String targetPackage, @android.annotation.Nullable
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.INSTALL_PACKAGES)
    public abstract void setUpdateAvailable(@android.annotation.NonNull
    java.lang.String packageName, boolean updateAvaialble);
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(Manifest.permission.DELETE_PACKAGES)
    @android.annotation.UnsupportedAppUsage
    public abstract void deletePackage(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.Nullable
    android.content.pm.IPackageDeleteObserver observer, @android.content.pm.PackageManager.DeleteFlags
    int flags);
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(anyOf = { Manifest.permission.DELETE_PACKAGES, Manifest.permission.INTERACT_ACROSS_USERS_FULL })
    @android.annotation.UnsupportedAppUsage
    public abstract void deletePackageAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.Nullable
    android.content.pm.IPackageDeleteObserver observer, @android.content.pm.PackageManager.DeleteFlags
    int flags, @android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.Nullable
    public abstract java.lang.String getInstallerPackageName(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void clearApplicationUserData(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.Nullable
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void deleteApplicationCacheFiles(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.Nullable
    android.content.pm.IPackageDataObserver observer);
     ...
     * 		The name of the package to delete
     * @param userId
     * 		the user for which the cache files needs to be deleted
     * @param observer
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void deleteApplicationCacheFilesAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId, @android.annotation.Nullable
    android.content.pm.IPackageDataObserver observer);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public void freeStorageAndNotify(long freeStorageSize, @android.annotation.Nullable
    android.content.pm.IPackageDataObserver observer) {
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void freeStorageAndNotify(@android.annotation.Nullable
    java.lang.String volumeUuid, long freeStorageSize, @android.annotation.Nullable
    android.content.pm.IPackageDataObserver observer);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public void freeStorage(long freeStorageSize, @android.annotation.Nullable
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void freeStorage(@android.annotation.Nullable
    java.lang.String volumeUuid, long freeStorageSize, @android.annotation.Nullable
    android.content.IntentSender pi);
     ...
     *
     * @param packageName
     * 		The name of the package whose size information is to be retrieved
     * @param userId
     * 		The user whose size information should be retrieved.
     * @param observer
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public abstract void getPackageSizeInfoAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId, @android.annotation.Nullable
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public void getPackageSizeInfo(@android.annotation.NonNull
    java.lang.String packageName, android.content.pm.IPackageStatsObserver observer) {
     ...
     */
    @java.lang.Deprecated
    public abstract void addPackageToPreferred(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @java.lang.Deprecated
    public abstract void removePackageFromPreferred(@android.annotation.NonNull
    java.lang.String packageName);
    ...
    @android.annotation.NonNull
    @java.lang.Deprecated
    public abstract java.util.List<android.content.pm.PackageInfo> getPreferredPackages(@android.content.pm.PackageManager.PackageInfoFlags
    int flags);
     ...
     */
    @java.lang.Deprecated
    public abstract void addPreferredActivity(@android.annotation.NonNull
    android.content.IntentFilter filter, int match, @android.annotation.Nullable
    android.content.ComponentName[] set, @android.annotation.NonNull
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public void addPreferredActivityAsUser(@android.annotation.NonNull
    android.content.IntentFilter filter, int match, @android.annotation.Nullable
    android.content.ComponentName[] set, @android.annotation.NonNull
    android.content.ComponentName activity, @android.annotation.UserIdInt
    int userId) {
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public abstract void replacePreferredActivity(@android.annotation.NonNull
    android.content.IntentFilter filter, int match, @android.annotation.Nullable
    android.content.ComponentName[] set, @android.annotation.NonNull
    android.content.ComponentName activity);
     ...
     * @param match
     * 		The IntentFilter match category that this preference applies to. Should be a
     * 		combination of {@link IntentFilter#MATCH_CATEGORY_MASK} and
     * 		{@link IntentFilter#MATCH_ADJUSTMENT_MASK}).
     * @param set
     * 		The set of activities that the user was picking from when this preference was
     * 		made.
     * @param activity
     ...
     */
    @android.annotation.SystemApi
    public void replacePreferredActivity(@android.annotation.NonNull
    android.content.IntentFilter filter, int match, @android.annotation.NonNull
    java.util.List<android.content.ComponentName> set, @android.annotation.NonNull
    android.content.ComponentName activity) {
        replacePreferredActivity(filter, match, set.toArray(new android.content.ComponentName[0]), activity);
    }
    ...
    @java.lang.Deprecated
    @android.annotation.UnsupportedAppUsage
    public void replacePreferredActivityAsUser(@android.annotation.NonNull
    android.content.IntentFilter filter, int match, @android.annotation.Nullable
    android.content.ComponentName[] set, @android.annotation.NonNull
    android.content.ComponentName activity, @android.annotation.UserIdInt
    int userId) {
     ...
     */
    @java.lang.Deprecated
    public abstract void clearPackagePreferredActivities(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @java.lang.Deprecated
    public abstract int getPreferredActivities(@android.annotation.NonNull
    java.util.List<android.content.IntentFilter> outFilters, @android.annotation.NonNull
    java.util.List<android.content.ComponentName> outActivities, @android.annotation.Nullable
    java.lang.String packageName);
    ...
    @android.annotation.Nullable
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.ComponentName getHomeActivities(@android.annotation.NonNull
    java.util.List<android.content.pm.ResolveInfo> outActivities);
     ...
     */
    @android.annotation.RequiresPermission(value = android.content.pm.android.Manifest.permission.CHANGE_COMPONENT_ENABLED_STATE.class, conditional = true)
    public abstract void setComponentEnabledSetting(@android.annotation.NonNull
    android.content.ComponentName componentName, @android.content.pm.PackageManager.EnabledState
    int newState, @android.content.pm.PackageManager.EnabledFlags
    int flags);
    ...
    public abstract int getComponentEnabledSetting(@android.annotation.NonNull
     ...
     * @param enabled
     * 		The new enabled state for the synthetic app details activity.
     * @unknown 
     */
    @android.annotation.RequiresPermission(value = android.content.pm.android.Manifest.permission.CHANGE_COMPONENT_ENABLED_STATE.class, conditional = true)
    @android.annotation.SystemApi
    public void setSyntheticAppDetailsActivityEnabled(@android.annotation.NonNull
     ...
     */
    public boolean getSyntheticAppDetailsActivityEnabled(@android.annotation.NonNull
    java.lang.String packageName) {
     ...
     */
    @android.annotation.RequiresPermission(value = android.content.pm.android.Manifest.permission.CHANGE_COMPONENT_ENABLED_STATE.class, conditional = true)
    public abstract void setApplicationEnabledSetting(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.EnabledState
    int newState, @android.content.pm.PackageManager.EnabledFlags
    int flags);
     ...
     */
    @android.content.pm.PackageManager.EnabledState
    public abstract int getApplicationEnabledSetting(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     *
     * @param userId
     * 		Ther userId of the user whose restrictions are to be flushed.
     * @unknown 
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void flushPackageRestrictionsAsUser(@android.annotation.UserIdInt
    int userId);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean setApplicationHiddenSettingAsUser(@android.annotation.NonNull
    java.lang.String packageName, boolean hidden, @android.annotation.NonNull
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean getApplicationHiddenSettingAsUser(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle userHandle);
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.OBSERVE_GRANT_REVOKE_PERMISSIONS)
    public abstract void addOnPermissionsChangeListener(@android.annotation.NonNull
    ...
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(Manifest.permission.OBSERVE_GRANT_REVOKE_PERMISSIONS)
    public abstract void removeOnPermissionsChangeListener(@android.annotation.NonNull
    android.content.pm.PackageManager.OnPermissionsChangedListener listener);
     ...
     *
     * @param alias
     * 		The alias for a given {@link KeySet} as defined in the
     * 		application's AndroidManifest.xml.
     * @unknown 
     */
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.KeySet getKeySetByAlias(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.content.pm.KeySet getSigningKeySet(@android.annotation.NonNull
    java.lang.String packageName);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean isSignedBy(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean isSignedByExactly(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.content.pm.KeySet ks);
     ...
     */
    @android.annotation.SystemApi
    public static final int RESTRICTION_HIDE_FROM_SUGGESTIONS = 0x1;
     ...
     */
    @android.annotation.SystemApi
    public static final int RESTRICTION_HIDE_NOTIFICATIONS = 0x2;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "RESTRICTION_" }, value = { android.content.pm.PackageManager.RESTRICTION_NONE, android.content.pm.PackageManager.RESTRICTION_HIDE_FROM_SUGGESTIONS, android.content.pm.PackageManager.RESTRICTION_HIDE_NOTIFICATIONS })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     *
     * @param packages
     * 		Packages to mark as distracting.
     * @param restrictionFlags
     * 		Any combination of restrictions to impose on the given packages.
     ...
     */
    @android.annotation.SystemApi
    @android.annotation.RequiresPermission(android.content.pm.android.Manifest.permission.SUSPEND_APPS.class)
    @android.annotation.NonNull
    public java.lang.String[] setDistractingPackageRestrictions(@android.annotation.NonNull
    java.lang.String[] packages, @android.content.pm.PackageManager.DistractionRestriction
     ...
     *
     * @param packageNames
     * 		The names of the packages to set the suspended status.
     * @param suspended
     * 		If set to {@code true}, the packages will be suspended, if set to
     * 		{@code false}, the packages will be unsuspended.
     * @param appExtras
     * 		An optional {@link PersistableBundle} that the suspending app can provide
     * 		which will be shared with the apps being suspended. Ignored if
     * 		{@code suspended} is false.
     * @param launcherExtras
     * 		An optional {@link PersistableBundle} that the suspending app can
     * 		provide which will be shared with the launcher. Ignored if
     * 		{@code suspended} is false.
     * @param dialogMessage
     * 		The message to be displayed to the user, when they try to launch a
     * 		suspended app.
    ...
    @android.annotation.SystemApi
    @java.lang.Deprecated
    @android.annotation.RequiresPermission(Manifest.permission.SUSPEND_APPS)
    @android.annotation.Nullable
    public java.lang.String[] setPackagesSuspended(@android.annotation.Nullable
    java.lang.String[] packageNames, boolean suspended, @android.annotation.Nullable
    android.os.PersistableBundle appExtras, @android.annotation.Nullable
    android.os.PersistableBundle launcherExtras, @android.annotation.Nullable
     ...
     * 		{@code suspended} is false.
     * @param dialogInfo
     * 		An optional {@link SuspendDialogInfo} object describing the dialog that
    ...
    android.os.PersistableBundle appExtras, @android.annotation.Nullable
    android.os.PersistableBundle launcherExtras, @android.annotation.Nullable
    android.content.pm.SuspendDialogInfo dialogInfo) {
        throw new java.lang.UnsupportedOperationException("setPackagesSuspended not implemented");
    }
    ...
    @android.annotation.RequiresPermission(Manifest.permission.SUSPEND_APPS)
    @android.annotation.NonNull
    public java.lang.String[] getUnsuspendablePackages(@android.annotation.NonNull
    java.lang.String[] packageNames) {
        throw new java.lang.UnsupportedOperationException("canSuspendPackages not implemented");
    }
     ...
     * @param packageName
     * 		The name of the package to get the suspended status of.
     * @param userId
     * 		The user id.
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean isPackageSuspendedForUser(@android.annotation.NonNull
     ...
     * @see #isPackageSuspended()
     */
    public boolean isPackageSuspended(@android.annotation.NonNull
    java.lang.String packageName) throws android.content.pm.PackageManager.NameNotFoundException {
     ...
     */
    public abstract void setApplicationCategoryHint(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.ApplicationInfo.Category
    int categoryHint);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void registerMoveCallback(@android.annotation.NonNull
    android.content.pm.PackageManager.MoveCallback callback, @android.annotation.NonNull
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void unregisterMoveCallback(@android.annotation.NonNull
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract int movePackage(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    ...
    @android.annotation.UnsupportedAppUsage
    @android.annotation.Nullable
    public abstract android.os.storage.VolumeInfo getPackageCurrentVolume(@android.annotation.NonNull
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract java.util.List<android.os.storage.VolumeInfo> getPackageCandidateVolumes(@android.annotation.NonNull
    android.content.pm.ApplicationInfo app);

    /**
     * {@hide }
     */
    public abstract int movePrimaryStorage(@android.annotation.NonNull
    android.os.storage.VolumeInfo vol);
     ...
     *
     * @param filter
     * 		The {@link IntentFilter} the intent has to match
     * @param sourceUserId
     * 		The source user id.
     * @param targetUserId
     * 		The target user id.
     * @param flags
     * 		The possible values are {@link #SKIP_CURRENT_PROFILE} and
     * 		{@link #ONLY_IF_NO_MATCH_FOUND}.
     * @unknown 
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void addCrossProfileIntentFilter(@android.annotation.NonNull
    android.content.IntentFilter filter, @android.annotation.UserIdInt
    int sourceUserId, @android.annotation.UserIdInt
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract void clearCrossProfileIntentFilters(@android.annotation.UserIdInt
    int sourceUserId);
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.graphics.drawable.Drawable loadItemIcon(@android.annotation.NonNull
    android.content.pm.PackageItemInfo itemInfo, @android.annotation.Nullable
    android.content.pm.ApplicationInfo appInfo);
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public abstract android.graphics.drawable.Drawable loadUnbadgedItemIcon(@android.annotation.NonNull
    android.content.pm.PackageItemInfo itemInfo, @android.annotation.Nullable
    android.content.pm.ApplicationInfo appInfo);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public abstract boolean isPackageAvailable(@android.annotation.NonNull
    java.lang.String packageName);
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public static java.lang.String installStatusToString(int status, @android.annotation.Nullable
    java.lang.String msg) {
        final java.lang.String str = android.content.pm.PackageManager.installStatusToString(status);
        if (msg != null) {
            return (str + ": ") + msg;
        } else {
            return str;
    ...
    public static java.lang.String installStatusToString(int status) {
        switch (status) {
            case android.content.pm.PackageManager.INSTALL_SUCCEEDED :
                return "INSTALL_SUCCEEDED";
            case android.content.pm.PackageManager.INSTALL_FAILED_ALREADY_EXISTS :
                return "INSTALL_FAILED_ALREADY_EXISTS";
            case android.content.pm.PackageManager.INSTALL_FAILED_INVALID_APK :
                return "INSTALL_FAILED_INVALID_APK";
            case android.content.pm.PackageManager.INSTALL_FAILED_INVALID_URI :
                return "INSTALL_FAILED_INVALID_URI";
            case android.content.pm.PackageManager.INSTALL_FAILED_INSUFFICIENT_STORAGE :
                return "INSTALL_FAILED_INSUFFICIENT_STORAGE";
            case android.content.pm.PackageManager.INSTALL_FAILED_DUPLICATE_PACKAGE :
                return "INSTALL_FAILED_DUPLICATE_PACKAGE";
            case android.content.pm.PackageManager.INSTALL_FAILED_NO_SHARED_USER :
                return "INSTALL_FAILED_NO_SHARED_USER";
            case android.content.pm.PackageManager.INSTALL_FAILED_UPDATE_INCOMPATIBLE :
                return "INSTALL_FAILED_UPDATE_INCOMPATIBLE";
            case android.content.pm.PackageManager.INSTALL_FAILED_SHARED_USER_INCOMPATIBLE :
                return "INSTALL_FAILED_SHARED_USER_INCOMPATIBLE";
            case android.content.pm.PackageManager.INSTALL_FAILED_MISSING_SHARED_LIBRARY :
                return "INSTALL_FAILED_MISSING_SHARED_LIBRARY";
            case android.content.pm.PackageManager.INSTALL_FAILED_REPLACE_COULDNT_DELETE :
                return "INSTALL_FAILED_REPLACE_COULDNT_DELETE";
            case android.content.pm.PackageManager.INSTALL_FAILED_DEXOPT :
                return "INSTALL_FAILED_DEXOPT";
            case android.content.pm.PackageManager.INSTALL_FAILED_OLDER_SDK :
                return "INSTALL_FAILED_OLDER_SDK";
            case android.content.pm.PackageManager.INSTALL_FAILED_CONFLICTING_PROVIDER :
                return "INSTALL_FAILED_CONFLICTING_PROVIDER";
            case android.content.pm.PackageManager.INSTALL_FAILED_NEWER_SDK :
                return "INSTALL_FAILED_NEWER_SDK";
            case android.content.pm.PackageManager.INSTALL_FAILED_TEST_ONLY :
                return "INSTALL_FAILED_TEST_ONLY";
            case android.content.pm.PackageManager.INSTALL_FAILED_CPU_ABI_INCOMPATIBLE :
                return "INSTALL_FAILED_CPU_ABI_INCOMPATIBLE";
            case android.content.pm.PackageManager.INSTALL_FAILED_MISSING_FEATURE :
                return "INSTALL_FAILED_MISSING_FEATURE";
            case android.content.pm.PackageManager.INSTALL_FAILED_CONTAINER_ERROR :
                return "INSTALL_FAILED_CONTAINER_ERROR";
            case android.content.pm.PackageManager.INSTALL_FAILED_INVALID_INSTALL_LOCATION :
                return "INSTALL_FAILED_INVALID_INSTALL_LOCATION";
            case android.content.pm.PackageManager.INSTALL_FAILED_MEDIA_UNAVAILABLE :
                return "INSTALL_FAILED_MEDIA_UNAVAILABLE";
            case android.content.pm.PackageManager.INSTALL_FAILED_VERIFICATION_TIMEOUT :
                return "INSTALL_FAILED_VERIFICATION_TIMEOUT";
            case android.content.pm.PackageManager.INSTALL_FAILED_VERIFICATION_FAILURE :
                return "INSTALL_FAILED_VERIFICATION_FAILURE";
            case android.content.pm.PackageManager.INSTALL_FAILED_PACKAGE_CHANGED :
                return "INSTALL_FAILED_PACKAGE_CHANGED";
            case android.content.pm.PackageManager.INSTALL_FAILED_UID_CHANGED :
                return "INSTALL_FAILED_UID_CHANGED";
            case android.content.pm.PackageManager.INSTALL_FAILED_VERSION_DOWNGRADE :
                return "INSTALL_FAILED_VERSION_DOWNGRADE";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_NOT_APK :
                return "INSTALL_PARSE_FAILED_NOT_APK";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_BAD_MANIFEST :
                return "INSTALL_PARSE_FAILED_BAD_MANIFEST";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION :
                return "INSTALL_PARSE_FAILED_UNEXPECTED_EXCEPTION";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_NO_CERTIFICATES :
                return "INSTALL_PARSE_FAILED_NO_CERTIFICATES";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES :
                return "INSTALL_PARSE_FAILED_INCONSISTENT_CERTIFICATES";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING :
                return "INSTALL_PARSE_FAILED_CERTIFICATE_ENCODING";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME :
                return "INSTALL_PARSE_FAILED_BAD_PACKAGE_NAME";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID :
                return "INSTALL_PARSE_FAILED_BAD_SHARED_USER_ID";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_MANIFEST_MALFORMED :
                return "INSTALL_PARSE_FAILED_MANIFEST_MALFORMED";
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_MANIFEST_EMPTY :
                return "INSTALL_PARSE_FAILED_MANIFEST_EMPTY";
            case android.content.pm.PackageManager.INSTALL_FAILED_INTERNAL_ERROR :
                return "INSTALL_FAILED_INTERNAL_ERROR";
            case android.content.pm.PackageManager.INSTALL_FAILED_USER_RESTRICTED :
                return "INSTALL_FAILED_USER_RESTRICTED";
            case android.content.pm.PackageManager.INSTALL_FAILED_DUPLICATE_PERMISSION :
                return "INSTALL_FAILED_DUPLICATE_PERMISSION";
            case android.content.pm.PackageManager.INSTALL_FAILED_NO_MATCHING_ABIS :
                return "INSTALL_FAILED_NO_MATCHING_ABIS";
            case android.content.pm.PackageManager.INSTALL_FAILED_ABORTED :
                return "INSTALL_FAILED_ABORTED";
            case android.content.pm.PackageManager.INSTALL_FAILED_BAD_DEX_METADATA :
                return "INSTALL_FAILED_BAD_DEX_METADATA";
            case android.content.pm.PackageManager.INSTALL_FAILED_MISSING_SPLIT :
                return "INSTALL_FAILED_MISSING_SPLIT";
            case android.content.pm.PackageManager.INSTALL_FAILED_BAD_SIGNATURE :
                return "INSTALL_FAILED_BAD_SIGNATURE";
            case android.content.pm.PackageManager.INSTALL_FAILED_WRONG_INSTALLED_VERSION :
                return "INSTALL_FAILED_WRONG_INSTALLED_VERSION";
            default :
                return java.lang.Integer.toString(status);
        }
    }
    ...
    public static int installStatusToPublicStatus(int status) {
        switch (status) {
            case android.content.pm.PackageManager.INSTALL_SUCCEEDED :
                return android.content.pm.PackageInstaller.STATUS_SUCCESS;
            case android.content.pm.PackageManager.INSTALL_FAILED_ALREADY_EXISTS :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
            case android.content.pm.PackageManager.INSTALL_FAILED_INVALID_APK :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_FAILED_INVALID_URI :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_FAILED_INSUFFICIENT_STORAGE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_STORAGE;
            case android.content.pm.PackageManager.INSTALL_FAILED_DUPLICATE_PACKAGE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
            case android.content.pm.PackageManager.INSTALL_FAILED_NO_SHARED_USER :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
            ...
            case android.content.pm.PackageManager.INSTALL_FAILED_SHARED_USER_INCOMPATIBLE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
            case android.content.pm.PackageManager.INSTALL_FAILED_MISSING_SHARED_LIBRARY :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INCOMPATIBLE;
            case android.content.pm.PackageManager.INSTALL_FAILED_REPLACE_COULDNT_DELETE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
            case android.content.pm.PackageManager.INSTALL_FAILED_DEXOPT :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            ...
            case android.content.pm.PackageManager.INSTALL_FAILED_MEDIA_UNAVAILABLE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_STORAGE;
            case android.content.pm.PackageManager.INSTALL_FAILED_VERIFICATION_TIMEOUT :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_ABORTED;
            case android.content.pm.PackageManager.INSTALL_FAILED_VERIFICATION_FAILURE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_ABORTED;
            case android.content.pm.PackageManager.INSTALL_FAILED_PACKAGE_CHANGED :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            ...
            case android.content.pm.PackageManager.INSTALL_FAILED_VERSION_DOWNGRADE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_FAILED_PERMISSION_MODEL_DOWNGRADE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_NOT_APK :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_PARSE_FAILED_BAD_MANIFEST :
            ...
            case android.content.pm.PackageManager.INSTALL_FAILED_BAD_SIGNATURE :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INVALID;
            case android.content.pm.PackageManager.INSTALL_FAILED_INTERNAL_ERROR :
                return android.content.pm.PackageInstaller.STATUS_FAILURE;
            case android.content.pm.PackageManager.INSTALL_FAILED_USER_RESTRICTED :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_INCOMPATIBLE;
            case android.content.pm.PackageManager.INSTALL_FAILED_DUPLICATE_PERMISSION :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_CONFLICT;
     ...
     */
    @android.annotation.NonNull
    public static java.lang.String deleteStatusToString(int status, @android.annotation.Nullable
    java.lang.String msg) {
        final java.lang.String str = android.content.pm.PackageManager.deleteStatusToString(status);
        if (msg != null) {
            return (str + ": ") + msg;
        } else {
            return str;
    ...
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage
    public static java.lang.String deleteStatusToString(int status) {
        switch (status) {
            case android.content.pm.PackageManager.DELETE_SUCCEEDED :
                return "DELETE_SUCCEEDED";
            case android.content.pm.PackageManager.DELETE_FAILED_INTERNAL_ERROR :
                return "DELETE_FAILED_INTERNAL_ERROR";
            case android.content.pm.PackageManager.DELETE_FAILED_DEVICE_POLICY_MANAGER :
                return "DELETE_FAILED_DEVICE_POLICY_MANAGER";
            case android.content.pm.PackageManager.DELETE_FAILED_USER_RESTRICTED :
                return "DELETE_FAILED_USER_RESTRICTED";
            case android.content.pm.PackageManager.DELETE_FAILED_OWNER_BLOCKED :
                return "DELETE_FAILED_OWNER_BLOCKED";
            case android.content.pm.PackageManager.DELETE_FAILED_ABORTED :
                return "DELETE_FAILED_ABORTED";
            case android.content.pm.PackageManager.DELETE_FAILED_USED_SHARED_LIBRARY :
    ...
    public static int deleteStatusToPublicStatus(int status) {
        switch (status) {
            ...
            case android.content.pm.PackageManager.DELETE_FAILED_INTERNAL_ERROR :
                return android.content.pm.PackageInstaller.STATUS_FAILURE;
            case android.content.pm.PackageManager.DELETE_FAILED_DEVICE_POLICY_MANAGER :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_BLOCKED;
            case android.content.pm.PackageManager.DELETE_FAILED_USER_RESTRICTED :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_BLOCKED;
            case android.content.pm.PackageManager.DELETE_FAILED_OWNER_BLOCKED :
                return android.content.pm.PackageInstaller.STATUS_FAILURE_BLOCKED;
     ...
     */
    @android.annotation.NonNull
    public static java.lang.String permissionFlagToString(int flag) {
        switch (flag) {
            case android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_DEFAULT :
                return "GRANTED_BY_DEFAULT";
            case android.content.pm.PackageManager.FLAG_PERMISSION_POLICY_FIXED :
                return "POLICY_FIXED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_SYSTEM_FIXED :
                return "SYSTEM_FIXED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_USER_SET :
                return "USER_SET";
            case android.content.pm.PackageManager.FLAG_PERMISSION_REVOKE_ON_UPGRADE :
                return "REVOKE_ON_UPGRADE";
            case android.content.pm.PackageManager.FLAG_PERMISSION_USER_FIXED :
                return "USER_FIXED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_REVIEW_REQUIRED :
                return "REVIEW_REQUIRED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_REVOKE_WHEN_REQUESTED :
                return "REVOKE_WHEN_REQUESTED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_GRANTED :
                return "USER_SENSITIVE_WHEN_GRANTED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_USER_SENSITIVE_WHEN_DENIED :
                return "USER_SENSITIVE_WHEN_DENIED";
            case android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_INSTALLER_EXEMPT :
                return "RESTRICTION_INSTALLER_EXEMPT";
            case android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_SYSTEM_EXEMPT :
                return "RESTRICTION_SYSTEM_EXEMPT";
            case android.content.pm.PackageManager.FLAG_PERMISSION_RESTRICTION_UPGRADE_EXEMPT :
                return "RESTRICTION_UPGRADE_EXEMPT";
            case android.content.pm.PackageManager.FLAG_PERMISSION_APPLY_RESTRICTION :
                return "APPLY_RESTRICTION";
            case android.content.pm.PackageManager.FLAG_PERMISSION_GRANTED_BY_ROLE :
                return "GRANTED_BY_ROLE";
            default :
                return java.lang.Integer.toString(flag);
        }
    }
    ...
    public static class LegacyPackageDeleteObserver extends android.app.PackageDeleteObserver {
        ...
        public LegacyPackageDeleteObserver(android.content.pm.IPackageDeleteObserver legacy) {
            mLegacy = legacy;
        }
     ...
     *
     * @param packageName
     * 		The package for which to retrieve the install reason
     * @param user
     * 		The user for whom to retrieve the install reason
    ...
    public abstract int getInstallReason(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     */
    @android.annotation.Nullable
    public abstract java.lang.String getInstantAppAndroidId(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    android.os.UserHandle user);
     ...
     *
     * @param dexModulePath
     * 		the absolute path of the dex module.
     * @param callback
     * 		if not null, {@link DexModuleRegisterCallback#onDexModuleRegistered} will
     * 		be called once the registration finishes.
     * @unknown 
     */
    @android.annotation.SystemApi
    public abstract void registerDexModule(@android.annotation.NonNull
    java.lang.String dexModulePath, @android.annotation.Nullable
     ...
     *
     * @param packageName
     * 		The full name of the package to warn on.
     * @param warning
     * 		A warning string to display to the user describing the threat posed by the
     * 		application, or null to clear the warning.
     * @unknown 
     */
    @android.annotation.RequiresPermission(Manifest.permission.SET_HARMFUL_APP_WARNINGS)
    @android.annotation.SystemApi
    public void setHarmfulAppWarning(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.Nullable
    java.lang.CharSequence warning) {
     ...
     *
     * @param packageName
     * 		The full name of the desired package.
     * @unknown 
     */
    @android.annotation.RequiresPermission(Manifest.permission.SET_HARMFUL_APP_WARNINGS)
    @android.annotation.Nullable
    @android.annotation.SystemApi
    public java.lang.CharSequence getHarmfulAppWarning(@android.annotation.NonNull
    java.lang.String packageName) {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "CERT_INPUT_" }, value = { android.content.pm.PackageManager.CERT_INPUT_RAW_X509, android.content.pm.PackageManager.CERT_INPUT_SHA256 })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     * {@code GET_SIGNING_CERTIFICATES} and then searching through the resulting {@code signingInfo} field to see if the desired certificate is present.
     *
     * @param packageName
     ...
     * @param type
     * 		representation of the {@code certificate}
     * @return true if this package was or is signed by exactly the certificate {@code certificate}
     */
    public boolean hasSigningCertificate(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.NonNull
    byte[] certificate, @android.content.pm.PackageManager.CertificateInputType
    int type) {
     ...
     * @return true if this package was or is signed by exactly the certificate {@code certificate}
     */
    public boolean hasSigningCertificate(int uid, @android.annotation.NonNull
    byte[] certificate, @android.content.pm.PackageManager.CertificateInputType
    int type) {
        throw new java.lang.UnsupportedOperationException("hasSigningCertificate not implemented in subclass");
    }
     ...
     * @unknown 
     */
    public boolean isPackageStateProtected(@android.annotation.NonNull
    java.lang.String packageName, @android.annotation.UserIdInt
    int userId) {
