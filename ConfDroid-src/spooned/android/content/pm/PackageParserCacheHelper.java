...
public class PackageParserCacheHelper {
    ...
    public static class ReadHelper extends android.os.Parcel.ReadWriteHelper {
        ...
        public ReadHelper(android.os.Parcel p) {
            mParcel = p;
        }
        ...
        public void startAndInstall() {
            ...
            if (android.content.pm.PackageParserCacheHelper.DEBUG) {
                android.util.Log.i(android.content.pm.PackageParserCacheHelper.TAG, ("Read " + mStrings.size()) + " strings");
                for (int i = 0; i < mStrings.size(); i++) {
                    android.util.Log.i(android.content.pm.PackageParserCacheHelper.TAG, ((("  " + i) + ": \"") + mStrings.get(i)) + "\"");
                }
            }
         ...
         */
        @java.lang.Override
        public java.lang.String readString(android.os.Parcel p) {
    ...
    public static class WriteHelper extends android.os.Parcel.ReadWriteHelper {
         ...
         */
        public WriteHelper(android.os.Parcel p) {
            mParcel = p;
         ...
         */
        @java.lang.Override
        public void writeString(android.os.Parcel p, java.lang.String s) {
            final java.lang.Integer cur = mIndexes.get(s);
            if (cur != null) {
                // String already in the pool. Just write the index.
                p.writeInt(cur);// Already in the pool.

                if (android.content.pm.PackageParserCacheHelper.DEBUG) {
                    android.util.Log.i(android.content.pm.PackageParserCacheHelper.TAG, (("Duplicate '" + s) + "' at ") + cur);
                }
            } else {
                ...
                mStrings.add(s);
                if (android.content.pm.PackageParserCacheHelper.DEBUG) {
                    android.util.Log.i(android.content.pm.PackageParserCacheHelper.TAG, (("New '" + s) + "' at ") + index);
                }
                p.writeInt(index);
            }
        }
        ...
        public void finishAndUninstall() {
            ...
            if (android.content.pm.PackageParserCacheHelper.DEBUG) {
                android.util.Log.i(android.content.pm.PackageParserCacheHelper.TAG, ("Wrote " + mStrings.size()) + " strings");
            }
        }
    }
}
