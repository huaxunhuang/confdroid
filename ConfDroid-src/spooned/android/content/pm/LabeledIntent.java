...
public class LabeledIntent extends android.content.Intent {
     ...
     */
    public LabeledIntent(android.content.Intent origIntent, java.lang.String sourcePackage, int labelRes, int icon) {
        super(origIntent);
     ...
     * 		Resource containing the icon, or 0 if none.
     */
    public LabeledIntent(android.content.Intent origIntent, java.lang.String sourcePackage, java.lang.CharSequence nonLocalizedLabel, int icon) {
        super(origIntent);
        mSourcePackage = sourcePackage;
        mLabelRes = 0;
     ...
     * 		Resource containing the icon, or 0 if none.
     */
    public LabeledIntent(java.lang.String sourcePackage, int labelRes, int icon) {
        mSourcePackage = sourcePackage;
        mLabelRes = labelRes;
        mNonLocalizedLabel = null;
        mIcon = icon;
     ...
     * 		Resource containing the icon, or 0 if none.
     */
    public LabeledIntent(java.lang.String sourcePackage, java.lang.CharSequence nonLocalizedLabel, int icon) {
        mSourcePackage = sourcePackage;
        mLabelRes = 0;
        mNonLocalizedLabel = nonLocalizedLabel;
        mIcon = icon;
    ...
    public java.lang.CharSequence loadLabel(android.content.pm.PackageManager pm) {
        ...
        if ((mLabelRes != 0) && (mSourcePackage != null)) {
            java.lang.CharSequence label = pm.getText(mSourcePackage, mLabelRes, null);
            if (label != null) {
                return label;
            }
        }
    ...
    public android.graphics.drawable.Drawable loadIcon(android.content.pm.PackageManager pm) {
        if ((mIcon != 0) && (mSourcePackage != null)) {
            android.graphics.drawable.Drawable icon = pm.getDrawable(mSourcePackage, mIcon, null);
            if (icon != null) {
                return icon;
            }
        }
    ...
    public void writeToParcel(android.os.Parcel dest, int parcelableFlags) {
        ...
        android.text.TextUtils.writeToParcel(mNonLocalizedLabel, dest, parcelableFlags);
        dest.writeInt(mIcon);
    }
    ...
    public static final android.content.pm.Creator<android.content.pm.LabeledIntent> CREATOR = new android.content.pm.Creator<android.content.pm.LabeledIntent>() {
        public android.content.pm.LabeledIntent createFromParcel(android.os.Parcel source) {
            return new android.content.pm.LabeledIntent(source);
        }

        public android.content.pm.LabeledIntent[] newArray(int size) {
            return new android.content.pm.LabeledIntent[size];
        }
    };
}
