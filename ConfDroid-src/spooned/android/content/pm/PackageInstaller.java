...
public class PackageInstaller {
     ...
     * {@hide }
     */
    public PackageInstaller(android.content.pm.IPackageInstaller installer, java.lang.String installerPackageName, int userId) {
     ...
     * 		when {@link SessionParams} is invalid.
     * @return positive, non-zero unique ID that represents the created session.
    This ID remains consistent across device reboots until the
    session is finalized. IDs are not reused during a given boot.
     */
    public int createSession(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionParams params) throws java.io.IOException {
        try {
            final java.lang.String installerPackage;
    ...
    public android.content.pm.PackageInstaller.Session openSession(int sessionId) throws java.io.IOException {
        try {
            try {
                return new android.content.pm.PackageInstaller.Session(mInstaller.openSession(sessionId));
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        } catch (java.lang.RuntimeException e) {
     ...
     * 		the session is invalid.
     */
    public void updateSessionAppIcon(int sessionId, @android.annotation.Nullable
     ...
     * 		the session is invalid.
     */
    public void updateSessionAppLabel(int sessionId, @android.annotation.Nullable
    java.lang.CharSequence appLabel) {
        try {
            final java.lang.String val = (appLabel != null) ? appLabel.toString() : null;
     ...
     *     <li>it is not applied, i.e. {@link SessionInfo#isStagedSessionApplied()} is {@code false}, and
    ...
    public android.content.pm.PackageInstaller.SessionInfo getActiveStagedSession() {
        final java.util.List<android.content.pm.PackageInstaller.SessionInfo> stagedSessions = getStagedSessions();
        for (android.content.pm.PackageInstaller.SessionInfo s : stagedSessions) {
            if (s.isStagedSessionApplied() || s.isStagedSessionFailed()) {
                // Finalized session.
                continue;
            }
            if (s.getParentSessionId() != android.content.pm.PackageInstaller.SessionInfo.INVALID_ID) {
                // Child session.
                continue;
            }
            if (s.isCommitted()) {
     ...
     */
    @android.annotation.RequiresPermission(anyOf = { Manifest.permission.DELETE_PACKAGES, Manifest.permission.REQUEST_DELETE_PACKAGES })
    public void uninstall(@android.annotation.NonNull
     ...
     */
    public void uninstall(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.DeleteFlags
    int flags, @android.annotation.NonNull
    android.content.IntentSender statusReceiver) {
        uninstall(new android.content.pm.VersionedPackage(packageName, android.content.pm.PackageManager.VERSION_CODE_HIGHEST), flags, statusReceiver);
    }
    ...
    @android.annotation.RequiresPermission(anyOf = { Manifest.permission.DELETE_PACKAGES, Manifest.permission.REQUEST_DELETE_PACKAGES })
    public void uninstall(@android.annotation.NonNull
    android.content.pm.VersionedPackage versionedPackage, @android.annotation.NonNull
    android.content.IntentSender statusReceiver) {
        /* flags */
    ...
    @android.annotation.RequiresPermission(anyOf = { Manifest.permission.DELETE_PACKAGES, Manifest.permission.REQUEST_DELETE_PACKAGES })
    public void uninstall(@android.annotation.NonNull
    android.content.pm.VersionedPackage versionedPackage, @android.content.pm.PackageManager.DeleteFlags
    int flags, @android.annotation.NonNull
    android.content.IntentSender statusReceiver) {
        com.android.internal.util.Preconditions.checkNotNull(versionedPackage, "versionedPackage cannot be null");
        try {
            mInstaller.uninstall(versionedPackage, mInstallerPackageName, flags, statusReceiver, mUserId);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     * 		Where to deliver the result.
     */
    @android.annotation.RequiresPermission(allOf = { Manifest.permission.INSTALL_PACKAGES, Manifest.permission.INSTALL_EXISTING_PACKAGES })
    public void installExistingPackage(@android.annotation.NonNull
    java.lang.String packageName, @android.content.pm.PackageManager.InstallReason
    int installReason, @android.annotation.Nullable
    android.content.IntentSender statusReceiver) {
        com.android.internal.util.Preconditions.checkNotNull(packageName, "packageName cannot be null");
        try {
            mInstaller.installExistingPackage(packageName, android.content.pm.PackageManager.INSTALL_ALL_WHITELIST_RESTRICTED_PERMISSIONS, installReason, statusReceiver, mUserId, null);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    @android.annotation.RequiresPermission(android.Manifest.permission.INSTALL_PACKAGES)
    ...
    static class SessionCallbackDelegate extends android.content.pm.IPackageInstallerCallback.Stub {
        ...
        SessionCallbackDelegate(android.content.pm.PackageInstaller.SessionCallback callback, java.util.concurrent.Executor executor) {
            mCallback = callback;
            mExecutor = executor;
        }
        ...
        public void onSessionCreated(int sessionId) {
            mExecutor.execute(com.android.internal.util.function.pooled.PooledLambda.obtainRunnable(android.content.pm.PackageInstaller.SessionCallback::onCreated, mCallback, sessionId).recycleOnUse());
        }

        @java.lang.Override
        public void onSessionBadgingChanged(int sessionId) {
            mExecutor.execute(com.android.internal.util.function.pooled.PooledLambda.obtainRunnable(android.content.pm.PackageInstaller.SessionCallback::onBadgingChanged, mCallback, sessionId).recycleOnUse());
        }

        @java.lang.Override
        public void onSessionActiveChanged(int sessionId, boolean active) {
            mExecutor.execute(com.android.internal.util.function.pooled.PooledLambda.obtainRunnable(android.content.pm.PackageInstaller.SessionCallback::onActiveChanged, mCallback, sessionId, active).recycleOnUse());
        }

        @java.lang.Override
        public void onSessionProgressChanged(int sessionId, float progress) {
            mExecutor.execute(com.android.internal.util.function.pooled.PooledLambda.obtainRunnable(android.content.pm.PackageInstaller.SessionCallback::onProgressChanged, mCallback, sessionId, progress).recycleOnUse());
        }

        @java.lang.Override
        public void onSessionFinished(int sessionId, boolean success) {
            mExecutor.execute(com.android.internal.util.function.pooled.PooledLambda.obtainRunnable(android.content.pm.PackageInstaller.SessionCallback::onFinished, mCallback, sessionId, success).recycleOnUse());
        }
    }
     ...
     */
    @java.lang.Deprecated
    public void addSessionCallback(@android.annotation.NonNull
     ...
     */
    public void registerSessionCallback(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionCallback callback) {
        registerSessionCallback(callback, new android.os.Handler());
    }
    ...
    @java.lang.Deprecated
    public void addSessionCallback(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionCallback callback, @android.annotation.NonNull
    ...
    android.os.Handler handler) {
        synchronized(mDelegates) {
            final android.content.pm.PackageInstaller.SessionCallbackDelegate delegate = new android.content.pm.PackageInstaller.SessionCallbackDelegate(callback, new android.os.HandlerExecutor(handler));
            try {
     ...
     */
    @java.lang.Deprecated
    public void removeSessionCallback(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionCallback callback) {
     ...
     */
    public void unregisterSessionCallback(@android.annotation.NonNull
    android.content.pm.PackageInstaller.SessionCallback callback) {
        synchronized(mDelegates) {
    ...
    public static class Session implements java.io.Closeable {
         ...
         * {@hide }
         */
        public Session(android.content.pm.IPackageInstallerSession session) {
            mSession = session;
        }
         ...
         */
        @android.annotation.NonNull
        public java.io.OutputStream openWrite(@android.annotation.NonNull
        java.lang.String name, long offsetBytes, long lengthBytes) throws java.io.IOException {
            try {
                if (android.content.pm.PackageInstaller.ENABLE_REVOCABLE_FD) {
                    return new android.os.ParcelFileDescriptor.AutoCloseOutputStream(mSession.openWrite(name, offsetBytes, lengthBytes));
                } else {
                    final android.os.ParcelFileDescriptor clientSocket = mSession.openWrite(name, offsetBytes, lengthBytes);
                    return new android.os.FileBridge.FileBridgeOutputStream(clientSocket);
                }
            } catch (java.lang.RuntimeException e) {
                android.util.ExceptionUtils.maybeUnwrapIOException(e);
                throw e;
         ...
         * {@hide }
         */
        public void write(@android.annotation.NonNull
        java.lang.String name, long offsetBytes, long lengthBytes, @android.annotation.NonNull
        android.os.ParcelFileDescriptor fd) throws java.io.IOException {
            try {
         ...
         */
        public void fsync(@android.annotation.NonNull
        java.io.OutputStream out) throws java.io.IOException {
            if (android.content.pm.PackageInstaller.ENABLE_REVOCABLE_FD) {
                if (out instanceof android.os.ParcelFileDescriptor.AutoCloseOutputStream) {
                    try {
                        android.system.Os.fsync(((android.os.ParcelFileDescriptor.AutoCloseOutputStream) (out)).getFD());
                ...
                if (out instanceof android.os.FileBridge.FileBridgeOutputStream) {
                    fsync();
                } else {
                    throw new java.lang.IllegalArgumentException("Unrecognized stream");
                }
         ...
         */
        @android.annotation.NonNull
        public java.io.InputStream openRead(@android.annotation.NonNull
        java.lang.String name) throws java.io.IOException {
            try {
                final android.os.ParcelFileDescriptor pfd = mSession.openRead(name);
         ...
         * identical.
         */
        public void removeSplit(@android.annotation.NonNull
         ...
         * @see android.app.admin.DevicePolicyManager
         */
        public void commit(@android.annotation.NonNull
        android.content.IntentSender statusReceiver) {
            try {
        ...
        @android.annotation.SystemApi
        @android.annotation.RequiresPermission(android.Manifest.permission.INSTALL_PACKAGES)
        public void commitTransferred(@android.annotation.NonNull
        android.content.IntentSender statusReceiver) {
            try {
         ...
         * 		{@link #openWrite(String, long, long) are still open.
         */
        public void transfer(@android.annotation.NonNull
    ...
    public static class SessionParams implements android.os.Parcelable {
        ...
        public int mode = android.content.pm.PackageInstaller.SessionParams.MODE_INVALID;

        /**
         * {@hide }
         */
        @android.annotation.UnsupportedAppUsage
        public int installFlags = android.content.pm.PackageManager.INSTALL_ALL_WHITELIST_RESTRICTED_PERMISSIONS;

        /**
         * {@hide }
         */
        public int installLocation = android.content.pm.PackageInfo.INSTALL_LOCATION_INTERNAL_ONLY;

        /**
         * {@hide }
         */
        @android.content.pm.PackageManager.InstallReason
        public int installReason = android.content.pm.PackageManager.INSTALL_REASON_UNKNOWN;
         ...
         */
        @android.annotation.UnsupportedAppUsage
        public int originatingUid = android.content.pm.PackageInstaller.SessionParams.UID_UNKNOWN;
         ...
         * {@hide }
         */
        public long requiredInstalledVersionCode = android.content.pm.PackageManager.VERSION_CODE_HIGHEST;

        /**
         * Construct parameters for a new package install session.
         *
         * @param mode
         * 		one of {@link #MODE_FULL_INSTALL} or
         ...
         * {@hide }
         */
        public SessionParams(android.os.Parcel source) {
            mode = source.readInt();
        ...
        public android.content.pm.PackageInstaller.SessionParams copy() {
            android.content.pm.PackageInstaller.SessionParams ret = new android.content.pm.PackageInstaller.SessionParams(mode);
        ...
        public boolean areHiddenOptionsSet() {
            return (((installFlags & ((((((android.content.pm.PackageManager.INSTALL_REQUEST_DOWNGRADE | android.content.pm.PackageManager.INSTALL_ALLOW_DOWNGRADE) | android.content.pm.PackageManager.INSTALL_DONT_KILL_APP) | android.content.pm.PackageManager.INSTALL_INSTANT_APP) | android.content.pm.PackageManager.INSTALL_FULL_APP) | android.content.pm.PackageManager.INSTALL_VIRTUAL_PRELOAD) | android.content.pm.PackageManager.INSTALL_ALLOCATE_AGGRESSIVE)) != installFlags) || (abiOverride != null)) || (volumeUuid != null);
        }
         ...
         */
        public void setAppPackageName(@android.annotation.Nullable
         ...
         * dimensions.
         */
        public void setAppIcon(@android.annotation.Nullable
        android.graphics.Bitmap appIcon) {
         ...
         */
        public void setAppLabel(@android.annotation.Nullable
        java.lang.CharSequence appLabel) {
         ...
         */
        public void setOriginatingUri(@android.annotation.Nullable
         ...
         */
        public void setReferrerUri(@android.annotation.Nullable
        ...
        @android.annotation.SystemApi
        @android.annotation.RequiresPermission(android.Manifest.permission.INSTALL_GRANT_RUNTIME_PERMISSIONS)
        public void setGrantedRuntimePermissions(java.lang.String[] permissions) {
            installFlags |= android.content.pm.PackageManager.INSTALL_GRANT_RUNTIME_PERMISSIONS;
         ...
         */
        public void setWhitelistedRestrictedPermissions(@android.annotation.Nullable
        java.util.Set<java.lang.String> permissions) {
            if (permissions == android.content.pm.PackageInstaller.SessionParams.RESTRICTED_PERMISSIONS_ALL) {
                installFlags |= android.content.pm.PackageManager.INSTALL_ALL_WHITELIST_RESTRICTED_PERMISSIONS;
                whitelistedRestrictedPermissions = null;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_ALL_WHITELIST_RESTRICTED_PERMISSIONS;
                whitelistedRestrictedPermissions = (permissions != null) ? new java.util.ArrayList<>(permissions) : null;
            }
        }
        ...
        public void setEnableRollback(boolean enable) {
            if (enable) {
                installFlags |= android.content.pm.PackageManager.INSTALL_ENABLE_ROLLBACK;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_ENABLE_ROLLBACK;
            }
        }
        ...
        public void setRequestDowngrade(boolean requestDowngrade) {
            if (requestDowngrade) {
                installFlags |= android.content.pm.PackageManager.INSTALL_REQUEST_DOWNGRADE;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_REQUEST_DOWNGRADE;
            }
        }
        ...
        public void setInstallFlagsForcePermissionPrompt() {
            installFlags |= android.content.pm.PackageManager.INSTALL_FORCE_PERMISSION_PROMPT;
        }
        ...
        public void setDontKillApp(boolean dontKillApp) {
            if (dontKillApp) {
                installFlags |= android.content.pm.PackageManager.INSTALL_DONT_KILL_APP;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_DONT_KILL_APP;
            }
        }
        ...
        public void setInstallAsInstantApp(boolean isInstantApp) {
            if (isInstantApp) {
                installFlags |= android.content.pm.PackageManager.INSTALL_INSTANT_APP;
                installFlags &= ~android.content.pm.PackageManager.INSTALL_FULL_APP;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_INSTANT_APP;
                installFlags |= android.content.pm.PackageManager.INSTALL_FULL_APP;
            }
        ...
        public void setInstallAsVirtualPreload() {
            installFlags |= android.content.pm.PackageManager.INSTALL_VIRTUAL_PRELOAD;
        }
         ...
         */
        public void setInstallReason(@android.content.pm.PackageManager.InstallReason
        int installReason) {
         ...
         */
        @android.annotation.SystemApi
        @android.annotation.RequiresPermission(android.Manifest.permission.ALLOCATE_AGGRESSIVE)
        public void setAllocateAggressive(boolean allocateAggressive) {
            if (allocateAggressive) {
                installFlags |= android.content.pm.PackageManager.INSTALL_ALLOCATE_AGGRESSIVE;
            } else {
                installFlags &= ~android.content.pm.PackageManager.INSTALL_ALLOCATE_AGGRESSIVE;
            }
        }
         ...
         * 		{@hide }
         */
        public void setInstallerPackageName(java.lang.String installerPackageName) {
        ...
        public void setInstallAsApex() {
            installFlags |= android.content.pm.PackageManager.INSTALL_APEX;
        }
        ...
        public boolean getEnableRollback() {
            return (installFlags & android.content.pm.PackageManager.INSTALL_ENABLE_ROLLBACK) != 0;
        }
        ...
        public static final android.os.Parcelable.Creator<android.content.pm.PackageInstaller.SessionParams> CREATOR = new android.os.Parcelable.Creator<android.content.pm.PackageInstaller.SessionParams>() {
            @java.lang.Override
            public android.content.pm.SessionParams createFromParcel(android.os.Parcel p) {
                return new android.content.pm.SessionParams(p);
            }

            @java.lang.Override
            public android.content.pm.SessionParams[] newArray(int size) {
                return new android.content.pm.SessionParams[size];
            }
        };
    }
    ...
    public static class SessionInfo implements android.os.Parcelable {
         ...
         * {@hide }
         */
        private static final int[] NO_SESSIONS = new int[]{  };
         ...
         * @unknown 
         */
        @android.annotation.IntDef(prefix = { "STAGED_SESSION_" }, value = { android.content.pm.PackageInstaller.SessionInfo.STAGED_SESSION_NO_ERROR, android.content.pm.PackageInstaller.SessionInfo.STAGED_SESSION_VERIFICATION_FAILED, android.content.pm.PackageInstaller.SessionInfo.STAGED_SESSION_ACTIVATION_FAILED, android.content.pm.PackageInstaller.SessionInfo.STAGED_SESSION_UNKNOWN })
         ...
         * {@hide }
         */
        public int parentSessionId = android.content.pm.PackageInstaller.SessionInfo.INVALID_ID;

        /**
         * {@hide }
         */
        public int[] childSessionIds = android.content.pm.PackageInstaller.SessionInfo.NO_SESSIONS;
         ...
         * {@hide }
         */
        public SessionInfo(android.os.Parcel source) {
            ...
            if (childSessionIds == null) {
                childSessionIds = android.content.pm.PackageInstaller.SessionInfo.NO_SESSIONS;
            }
        ...
        public android.graphics.Bitmap getAppIcon() {
            if (appIcon == null) {
                ...
                try {
                    final android.content.pm.PackageInstaller.SessionInfo info = android.app.AppGlobals.getPackageManager().getPackageInstaller().getSessionInfo(sessionId);
        ...
        public android.content.Intent createDetailsIntent() {
            final android.content.Intent intent = new android.content.Intent(android.content.pm.PackageInstaller.ACTION_SESSION_DETAILS);
            intent.putExtra(android.content.pm.PackageInstaller.EXTRA_SESSION_ID, sessionId);
         ...
         * Note that if all permissions are whitelisted this method returns {@link SessionParams#RESTRICTED_PERMISSIONS_ALL}.
         *
         * @unknown 
         */
        @android.annotation.TestApi
        ...
        public java.util.Set<java.lang.String> getWhitelistedRestrictedPermissions() {
            if ((installFlags & android.content.pm.PackageManager.INSTALL_ALL_WHITELIST_RESTRICTED_PERMISSIONS) != 0) {
                return android.content.pm.PackageInstaller.SessionParams.RESTRICTED_PERMISSIONS_ALL;
            }
            if (whitelistedRestrictedPermissions != null) {
                return new android.util.ArraySet(whitelistedRestrictedPermissions);
            }
        ...
        public boolean getRequestDowngrade() {
            return (installFlags & android.content.pm.PackageManager.INSTALL_REQUEST_DOWNGRADE) != 0;
        }
        ...
        public boolean getDontKillApp() {
            return (installFlags & android.content.pm.PackageManager.INSTALL_DONT_KILL_APP) != 0;
        }
        ...
        public boolean getInstallAsInstantApp(boolean isInstantApp) {
            return (installFlags & android.content.pm.PackageManager.INSTALL_INSTANT_APP) != 0;
        }
        ...
        public boolean getInstallAsFullApp(boolean isInstantApp) {
            return (installFlags & android.content.pm.PackageManager.INSTALL_FULL_APP) != 0;
        }
        ...
        public boolean getInstallAsVirtualPreload() {
            return (installFlags & android.content.pm.PackageManager.INSTALL_VIRTUAL_PRELOAD) != 0;
        }
        ...
        public boolean getAllocateAggressive() {
            return (installFlags & android.content.pm.PackageManager.INSTALL_ALLOCATE_AGGRESSIVE) != 0;
        }
         ...
         * {@hide }
         */
        public void setStagedSessionErrorCode(@android.content.pm.PackageInstaller.SessionInfo.StagedSessionErrorCode
        int errorCode, java.lang.String errorMessage) {
        ...
        public static final android.os.Parcelable.Creator<android.content.pm.PackageInstaller.SessionInfo> CREATOR = new android.os.Parcelable.Creator<android.content.pm.PackageInstaller.SessionInfo>() {
            @java.lang.Override
            public android.content.pm.SessionInfo createFromParcel(android.os.Parcel p) {
                return new android.content.pm.SessionInfo(p);
            }

            @java.lang.Override
            public android.content.pm.SessionInfo[] newArray(int size) {
                return new android.content.pm.SessionInfo[size];
            }
        };
    }
}
