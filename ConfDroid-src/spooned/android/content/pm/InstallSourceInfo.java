...
public final class InstallSourceInfo implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public InstallSourceInfo(@android.annotation.Nullable
    java.lang.String initiatingPackageName, @android.annotation.Nullable
    android.content.pm.SigningInfo initiatingPackageSigningInfo, @android.annotation.Nullable
    java.lang.String originatingPackageName, @android.annotation.Nullable
    ...
    public int describeContents() {
        return mInitiatingPackageSigningInfo == null ? 0 : mInitiatingPackageSigningInfo.describeContents();
    }
    ...
    private InstallSourceInfo(android.os.Parcel source) {
        mInitiatingPackageName = source.readString();
        mInitiatingPackageSigningInfo = source.readParcelable(android.content.pm.SigningInfo.class.getClassLoader());
    ...
    public static final android.os.Parcelable.Creator<android.content.pm.InstallSourceInfo> CREATOR = new android.content.pm.Creator<android.content.pm.InstallSourceInfo>() {
        @java.lang.Override
        public android.content.pm.InstallSourceInfo createFromParcel(android.os.Parcel source) {
            return new android.content.pm.InstallSourceInfo(source);
        }

        @java.lang.Override
        public android.content.pm.InstallSourceInfo[] newArray(int size) {
            return new android.content.pm.InstallSourceInfo[size];
        }
    };
}
