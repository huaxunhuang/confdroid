...
public class OperationApplicationException extends java.lang.Exception {
    ...
    public OperationApplicationException(java.lang.String message) {
        super(message);
        mNumSuccessfulYieldPoints = 0;
    }

    public OperationApplicationException(java.lang.String message, java.lang.Throwable cause) {
        super(message, cause);
        mNumSuccessfulYieldPoints = 0;
    }
    ...
    public OperationApplicationException(java.lang.String message, int numSuccessfulYieldPoints) {
        super(message);
        mNumSuccessfulYieldPoints = numSuccessfulYieldPoints;
    }
