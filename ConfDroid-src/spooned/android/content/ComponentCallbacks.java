 ...
 *
 * <p class="note"><strong>Note:</strong> You should also implement the {@link ComponentCallbacks2} interface, which provides the {@link ComponentCallbacks2#onTrimMemory} callback to help your app manage its memory usage more
 * effectively.</p>
 */
public interface ComponentCallbacks {
     ...
     */
    void onConfigurationChanged(@android.annotation.NonNull
     ...
     * treated the same as {@link ComponentCallbacks2#onTrimMemory} with the {@link ComponentCallbacks2#TRIM_MEMORY_COMPLETE} level.</p>
     */
    void onLowMemory();
}
