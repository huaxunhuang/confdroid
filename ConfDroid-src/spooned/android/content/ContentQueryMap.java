...
public class ContentQueryMap extends java.util.Observable {
     ...
     * @param handlerForUpdateNotifications
     ...
     */
    public ContentQueryMap(android.database.Cursor cursor, java.lang.String columnNameOfKey, boolean keepUpdated, android.os.Handler handlerForUpdateNotifications) {
        mCursor = cursor;
    ...
    public void setKeepUpdated(boolean keepUpdated) {
        ...
        if (!mKeepUpdated) {
            ...
            if (mHandlerForUpdateNotifications == null) {
                mHandlerForUpdateNotifications = new android.os.Handler();
            }
            if (mContentObserver == null) {
                mContentObserver = new android.database.ContentObserver(mHandlerForUpdateNotifications) {
                    @java.lang.Override
     ...
     */
    public void requery() {
        final android.database.Cursor cursor = mCursor;
        if (cursor == null) {
    ...
    private synchronized void readCursorIntoCache(android.database.Cursor cursor) {
        ...
        mValues = new java.util.HashMap<java.lang.String, android.content.ContentValues>(capacity);
