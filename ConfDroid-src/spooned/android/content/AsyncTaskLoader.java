...
public abstract class AsyncTaskLoader<D> extends android.content.Loader<D> {
    ...
    final class LoadTask extends android.os.AsyncTask<java.lang.Void, java.lang.Void, D> implements java.lang.Runnable {
        ...
        protected D doInBackground(java.lang.Void... params) {
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, this + " >>> doInBackground");

            try {
                D data = android.content.AsyncTaskLoader.this.onLoadInBackground();
                if (android.content.AsyncTaskLoader.DEBUG)
                    android.util.Log.v(android.content.AsyncTaskLoader.TAG, this + "  <<< doInBackground");

                return data;
            } catch (android.os.OperationCanceledException ex) {
                if (!android.content.AsyncTaskLoader.LoadTask.isCancelled()) {
                ...
                if (android.content.AsyncTaskLoader.DEBUG)
                    android.util.Log.v(android.content.AsyncTaskLoader.TAG, this + "  <<< doInBackground (was canceled)", ex);
        ...
        protected void onPostExecute(D data) {
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, this + " onPostExecute");

            try {
                android.content.AsyncTaskLoader.this.dispatchOnLoadComplete(this, data);
            } finally {
                mDone.countDown();
            }
        }
        ...
        protected void onCancelled(D data) {
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, this + " onCancelled");

            try {
                android.content.AsyncTaskLoader.this.dispatchOnCancelled(this, data);
            } finally {
                mDone.countDown();
            }
        }
    ...
    protected void onForceLoad() {
        ...
        mTask = new LoadTask();
        if (android.content.AsyncTaskLoader.DEBUG)
            android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Preparing load: mTask=" + mTask);
    ...
    protected boolean onCancelLoad() {
        if (android.content.AsyncTaskLoader.DEBUG)
            android.util.Log.v(android.content.AsyncTaskLoader.TAG, "onCancelLoad: mTask=" + mTask);
        ...
        if (mTask != null) {
            ...
            if (mCancellingTask != null) {
                ...
                if (android.content.AsyncTaskLoader.DEBUG)
                    android.util.Log.v(android.content.AsyncTaskLoader.TAG, "cancelLoad: still waiting for cancelled task; dropping next");
                ...
                if (mTask.waiting) {
                    ...
                    if (android.content.AsyncTaskLoader.DEBUG)
                        android.util.Log.v(android.content.AsyncTaskLoader.TAG, "cancelLoad: task is waiting, dropping it");
                    ...
                    if (android.content.AsyncTaskLoader.DEBUG)
                        android.util.Log.v(android.content.AsyncTaskLoader.TAG, "cancelLoad: cancelled=" + cancelled);
        ...
        if ((mCancellingTask == null) && (mTask != null)) {
            ...
            if (mUpdateThrottle > 0) {
                ...
                if (now < (mLastLoadCompleteTime + mUpdateThrottle)) {
                    ...
                    if (android.content.AsyncTaskLoader.DEBUG)
                        android.util.Log.v(android.content.AsyncTaskLoader.TAG, (("Waiting until " + (mLastLoadCompleteTime + mUpdateThrottle)) + " to execute: ") + mTask);
            ...
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Executing: " + mTask);

            mTask.executeOnExecutor(mExecutor, ((java.lang.Void[]) (null)));
        }
    }

    void dispatchOnCancelled(android.content.AsyncTaskLoader<D>.LoadTask task, D data) {
        onCanceled(data);
        if (mCancellingTask == task) {
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Cancelled task is now canceled!");

            rollbackContentChanged();
            mLastLoadCompleteTime = android.os.SystemClock.uptimeMillis();
            mCancellingTask = null;
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Delivering cancellation");
    ...
    void dispatchOnLoadComplete(android.content.AsyncTaskLoader<D>.LoadTask task, D data) {
        if (mTask != task) {
            if (android.content.AsyncTaskLoader.DEBUG)
                android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Load complete of old task, trying to cancel");
            ...
            if (isAbandoned()) {
                ...
                mTask = null;
                if (android.content.AsyncTaskLoader.DEBUG)
                    android.util.Log.v(android.content.AsyncTaskLoader.TAG, "Delivering result");
    ...
    @android.annotation.UnsupportedAppUsage
    public void waitForLoader() {
        android.content.AsyncTaskLoader<D>.LoadTask task = mTask;
        if (task != null) {
            task.waitForLoader();
        }
    }
    ...
    public void dump(java.lang.String prefix, java.io.FileDescriptor fd, java.io.PrintWriter writer, java.lang.String[] args) {
        ...
        if (mUpdateThrottle != 0) {
            ...
            android.util.TimeUtils.formatDuration(mUpdateThrottle, writer);
            writer.print(" mLastLoadCompleteTime=");
            android.util.TimeUtils.formatDuration(mLastLoadCompleteTime, android.os.SystemClock.uptimeMillis(), writer);
            writer.println();
        }
    }
}
