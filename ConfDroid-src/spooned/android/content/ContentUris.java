...
public class ContentUris {
    ...
    empty
     */
    public static long parseId(@android.annotation.NonNull
    android.net.Uri contentUri) {
        java.lang.String last = contentUri.getLastPathSegment();
        return last == null ? -1 : java.lang.Long.parseLong(last);
    }
    ...
    public static Uri.Builder appendId(@android.annotation.NonNull
    android.net.Uri.Builder builder, long id) {
        return builder.appendEncodedPath(java.lang.String.valueOf(id));
    }
     ...
     */
    @android.annotation.NonNull
    public static android.net.Uri withAppendedId(@android.annotation.NonNull
    android.net.Uri contentUri, long id) {
     ...
     * 		when the given URI has no ID to remove
     * 		from the end of the path
     */
    @android.annotation.NonNull
    public static android.net.Uri removeId(@android.annotation.NonNull
    android.net.Uri contentUri) {
        // Verify that we have a valid ID to actually remove
        final java.lang.String last = contentUri.getLastPathSegment();
        if (last == null) {
            throw new java.lang.IllegalArgumentException("No path segments to remove");
        } else {
            java.lang.Long.parseLong(last);
        }
        final java.util.List<java.lang.String> segments = contentUri.getPathSegments();
        final android.net.Uri.Builder builder = contentUri.buildUpon();
        builder.path(null);
