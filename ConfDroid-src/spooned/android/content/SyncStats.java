...
public class SyncStats implements android.os.Parcelable {
    ...
    public static final android.content.Creator<android.content.SyncStats> CREATOR = new android.content.Creator<android.content.SyncStats>() {
        public android.content.SyncStats createFromParcel(android.os.Parcel in) {
            return new android.content.SyncStats(in);
        }

        public android.content.SyncStats[] newArray(int size) {
            return new android.content.SyncStats[size];
        }
    };
}
