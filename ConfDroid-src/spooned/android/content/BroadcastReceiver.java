...
public abstract class BroadcastReceiver {
    ...
    public static class PendingResult {
         ...
         */
        @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
        public PendingResult(int resultCode, java.lang.String resultData, android.os.Bundle resultExtras, int type, boolean ordered, boolean sticky, android.os.IBinder token, int userId, int flags) {
        ...
        public final android.os.Bundle getResultExtras(boolean makeMap) {
            android.os.Bundle e = mResultExtras;
            if (!makeMap)
                return e;

            if (e == null)
                mResultExtras = e = new android.os.Bundle();
        ...
        public final void finish() {
            if (mType == android.content.BroadcastReceiver.PendingResult.TYPE_COMPONENT) {
                final android.app.IActivityManager mgr = android.app.ActivityManager.getService();
                if (android.app.QueuedWork.hasPendingWork()) {
                    ...
                    // executor gets to it.
                    android.app.QueuedWork.queue(new java.lang.Runnable() {
                        @java.lang.Override
                        public void run() {
                            if (android.app.ActivityThread.DEBUG_BROADCAST)
                                android.util.Slog.i(ActivityThread.TAG, "Finishing broadcast after work to component " + mToken);
                    ...
                    if (android.app.ActivityThread.DEBUG_BROADCAST)
                        android.util.Slog.i(ActivityThread.TAG, "Finishing broadcast to component " + mToken);

                    sendFinished(mgr);
                }
            } else
                if (mOrderedHint && (mType != android.content.BroadcastReceiver.PendingResult.TYPE_UNREGISTERED)) {
                    if (android.app.ActivityThread.DEBUG_BROADCAST)
                        android.util.Slog.i(ActivityThread.TAG, "Finishing broadcast to " + mToken);
        ...
        void checkSynchronousHint() {
            ...
            java.lang.RuntimeException e = new java.lang.RuntimeException("BroadcastReceiver trying to return result during a non-ordered broadcast");
            e.fillInStackTrace();
     ...
     *
     * @param myContext
     * 		The Context that had been passed to {@link #onReceive(Context, Intent)}
     * @param service
    ...
    public final android.os.Bundle getResultExtras(boolean makeMap) {
        ...
        android.os.Bundle e = mPendingResult.mResultExtras;
        if (!makeMap)
            return e;

        if (e == null)
            mPendingResult.mResultExtras = e = new android.os.Bundle();
     ...
     * 		actual meaning of this value is ultimately up to the broadcaster.
     * @param data
     * 		The new result data.  This is an arbitrary
     * 		string whose interpretation is up to the broadcaster; may be null.
     * @param extras
     * 		The new extra data map.  This is a Bundle
     * 		holding arbitrary data, whose interpretation is up to the
