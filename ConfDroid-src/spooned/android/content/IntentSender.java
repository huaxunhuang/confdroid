...
public class IntentSender implements android.os.Parcelable {
    ...
    public static class SendIntentException extends android.util.AndroidException {
        ...
        public SendIntentException(java.lang.String name) {
            super(name);
        }
    ...
    public interface OnFinished {
         ...
         */
        void onSendFinished(android.content.IntentSender IntentSender, android.content.Intent intent, int resultCode, java.lang.String resultData, android.os.Bundle resultExtras);
    }
    ...
    private static class FinishedDispatcher extends android.content.IIntentReceiver.Stub implements java.lang.Runnable {
        ...
        FinishedDispatcher(android.content.IntentSender pi, android.content.IntentSender.OnFinished who, android.os.Handler handler) {
            mIntentSender = pi;
            mWho = who;
            mHandler = handler;
        }
     ...
     */
    public void sendIntent(android.content.Context context, int code, android.content.Intent intent, android.content.IntentSender.OnFinished onFinished, android.os.Handler handler) throws android.content.IntentSender.SendIntentException {
     ...
     * 		is no longer allowing more intents to be sent through it.
     */
    public void sendIntent(android.content.Context context, int code, android.content.Intent intent, android.content.IntentSender.OnFinished onFinished, android.os.Handler handler, java.lang.String requiredPermission) throws android.content.IntentSender.SendIntentException {
        try {
            java.lang.String resolvedType = (intent != null) ? intent.resolveTypeIfNeeded(context.getContentResolver()) : null;
            int res = android.app.ActivityManager.getService().sendIntentSender(mTarget, mWhitelistToken, code, intent, resolvedType, onFinished != null ? new android.content.IntentSender.FinishedDispatcher(this, onFinished, handler) : null, requiredPermission, null);
            if (res < 0) {
    ...
    public java.lang.String getTargetPackage() {
        try {
            return android.app.ActivityManager.getService().getPackageForIntentSender(mTarget);
        } catch (android.os.RemoteException e) {
            // Should never happen.
            return null;
        }
    ...
    public int getCreatorUid() {
        try {
            return android.app.ActivityManager.getService().getUidForIntentSender(mTarget);
        } catch (android.os.RemoteException e) {
            // Should never happen.
            return -1;
        }
    ...
    public android.os.UserHandle getCreatorUserHandle() {
        try {
            int uid = android.app.ActivityManager.getService().getUidForIntentSender(mTarget);
    ...
    public boolean equals(java.lang.Object otherObj) {
        if (otherObj instanceof android.content.IntentSender) {
            return equals(((android.content.IntentSender) (otherObj)).mTarget.asBinder());
        }
        return false;
    }
    ...
    public static final android.os.Parcelable.Creator<android.content.IntentSender> CREATOR = new android.os.Parcelable.Creator<android.content.IntentSender>() {
        public android.content.IntentSender createFromParcel(android.os.Parcel in) {
            android.os.IBinder target = in.readStrongBinder();
            return target != null ? new android.content.IntentSender(target) : null;
        }

        public android.content.IntentSender[] newArray(int size) {
            return new android.content.IntentSender[size];
        }
    };
    ...
    public static android.content.IntentSender readIntentSenderOrNullFromParcel(android.os.Parcel in) {
        ...
        return b != null ? new android.content.IntentSender(b) : null;
    }
     ...
     * @unknown 
     */
    public IntentSender(android.content.IIntentSender target, android.os.IBinder whitelistToken) {
        mTarget = target;
