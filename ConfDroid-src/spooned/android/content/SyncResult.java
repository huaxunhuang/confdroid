...
public final class SyncResult implements android.os.Parcelable {
    ...
    static {
        ALREADY_IN_PROGRESS = new android.content.SyncResult(true);
    }
     ...
     *
     * @param syncAlreadyInProgress
     * 		if true then set the {@link #syncAlreadyInProgress} flag
     */
    ...
    private SyncResult(android.os.Parcel parcel) {
        ...
        stats = new android.content.SyncStats(parcel);
    }
    ...
    public boolean hasHardError() {
        return (((((stats.numParseExceptions > 0) || (stats.numConflictDetectedExceptions > 0)) || (stats.numAuthExceptions > 0)) || tooManyDeletions) || tooManyRetries) || databaseError;
    }
    ...
    public boolean madeSomeProgress() {
        return (((stats.numDeletes > 0) && (!tooManyDeletions)) || (stats.numInserts > 0)) || (stats.numUpdates > 0);
    }
    ...
    public static final android.content.Creator<android.content.SyncResult> CREATOR = new android.content.Creator<android.content.SyncResult>() {
        public android.content.SyncResult createFromParcel(android.os.Parcel in) {
            return new android.content.SyncResult(in);
        }

        public android.content.SyncResult[] newArray(int size) {
            return new android.content.SyncResult[size];
        }
    };
