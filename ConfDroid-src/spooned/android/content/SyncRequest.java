...
public class SyncRequest implements android.os.Parcelable {
    ...
    public static final android.content.Creator<android.content.SyncRequest> CREATOR = new android.content.Creator<android.content.SyncRequest>() {
        @java.lang.Override
        public android.content.SyncRequest createFromParcel(android.os.Parcel in) {
            return new android.content.SyncRequest(in);
        }

        @java.lang.Override
        public android.content.SyncRequest[] newArray(int size) {
            return new android.content.SyncRequest[size];
        }
    };
    ...
    protected SyncRequest(android.content.SyncRequest.Builder b) {
        ...
        mIsPeriodic = b.mSyncType == android.content.SyncRequest.Builder.SYNC_TYPE_PERIODIC;
        mIsAuthority = b.mSyncTarget == android.content.SyncRequest.Builder.SYNC_TARGET_ADAPTER;
        mIsExpedited = b.mExpedited;
        mExtras = new android.os.Bundle(b.mCustomExtras);
    ...
    public static class Builder {
         ...
         */
        private int mSyncType = android.content.SyncRequest.Builder.SYNC_TYPE_UNKNOWN;

        /**
         * Whether this will go to a sync adapter.
         */
        private int mSyncTarget = android.content.SyncRequest.Builder.SYNC_TARGET_UNKNOWN;
        ...
        public android.content.SyncRequest.Builder syncOnce() {
            if (mSyncType != android.content.SyncRequest.Builder.SYNC_TYPE_UNKNOWN) {
                throw new java.lang.IllegalArgumentException("Sync type has already been defined.");
            }
            mSyncType = android.content.SyncRequest.Builder.SYNC_TYPE_ONCE;
            setupInterval(0, 0);
            return this;
        }
         ...
         */
        public android.content.SyncRequest.Builder syncPeriodic(long pollFrequency, long beforeSeconds) {
            if (mSyncType != android.content.SyncRequest.Builder.SYNC_TYPE_UNKNOWN) {
                throw new java.lang.IllegalArgumentException("Sync type has already been defined.");
            }
            mSyncType = android.content.SyncRequest.Builder.SYNC_TYPE_PERIODIC;
         ...
         *
         * @param disallow
         * 		true to allow this transfer on metered networks. Default false.
         */
         ...
         */
        public android.content.SyncRequest.Builder setSyncAdapter(android.accounts.Account account, java.lang.String authority) {
            if (mSyncTarget != android.content.SyncRequest.Builder.SYNC_TARGET_UNKNOWN) {
            ...
            mSyncTarget = android.content.SyncRequest.Builder.SYNC_TARGET_ADAPTER;
            mAccount = account;
         ...
         *
         * @param noRetry
         * 		true to not retry a failed sync. Default false.
         */
        ...
        public android.content.SyncRequest build() {
            ...
            android.content.ContentResolver.validateSyncExtrasBundle(mCustomExtras);
            if (mCustomExtras == null) {
                mCustomExtras = new android.os.Bundle();
            }
            // Combine builder extra flags into the config bundle.
            mSyncConfigExtras = new android.os.Bundle();
            if (mIgnoreBackoff) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_IGNORE_BACKOFF, true);
            }
            if (mDisallowMetered) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_DISALLOW_METERED, true);
            }
            if (mRequiresCharging) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_REQUIRE_CHARGING, true);
            }
            if (mIgnoreSettings) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_IGNORE_SETTINGS, true);
            }
            if (mNoRetry) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_DO_NOT_RETRY, true);
            }
            if (mExpedited) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_EXPEDITED, true);
            }
            if (mIsManual) {
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_IGNORE_BACKOFF, true);
                mSyncConfigExtras.putBoolean(android.content.ContentResolver.SYNC_EXTRAS_IGNORE_SETTINGS, true);
            }
            if (mSyncType == android.content.SyncRequest.Builder.SYNC_TYPE_PERIODIC) {
                // If this is a periodic sync ensure than invalid extras were not set.
                if (android.content.ContentResolver.invalidPeriodicExtras(mCustomExtras) || android.content.ContentResolver.invalidPeriodicExtras(mSyncConfigExtras)) {
