...
public final class Entity {
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
    private final java.util.ArrayList<android.content.Entity.NamedContentValues> mSubValues;

    public Entity(android.content.ContentValues values) {
        mValues = values;
        mSubValues = new java.util.ArrayList<android.content.Entity.NamedContentValues>();
    }
    ...
    public void addSubValue(android.net.Uri uri, android.content.ContentValues values) {
        mSubValues.add(new android.content.Entity.NamedContentValues(uri, values));
    }
    ...
    public static class NamedContentValues {
        ...
        public NamedContentValues(android.net.Uri uri, android.content.ContentValues values) {
            this.uri = uri;
            this.values = values;
        }
    }
    ...
    public java.lang.String toString() {
        ...
        for (android.content.Entity.NamedContentValues namedValue : getSubValues()) {
