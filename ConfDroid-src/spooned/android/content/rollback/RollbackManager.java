...
@android.annotation.SystemService(android.content.Context.ROLLBACK_SERVICE)
public final class RollbackManager {
     ...
     * {@hide }
     */
    public RollbackManager(android.content.Context context, android.content.rollback.IRollbackManager binder) {
     ...
     * 		if the caller does not have appropriate permissions.
     */
    @android.annotation.RequiresPermission(anyOf = { android.content.rollback.android.Manifest.permission.MANAGE_ROLLBACKS, android.content.rollback.android.Manifest.permission.TEST_MANAGE_ROLLBACKS })
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = "STATUS_", value = { android.content.rollback.RollbackManager.STATUS_SUCCESS, android.content.rollback.RollbackManager.STATUS_FAILURE, android.content.rollback.RollbackManager.STATUS_FAILURE_ROLLBACK_UNAVAILABLE, android.content.rollback.RollbackManager.STATUS_FAILURE_INSTALL })
     ...
     *
     * @param rollbackId
     * 		ID of the rollback to commit
     * @param causePackages
     * 		package versions to record as the motivation for this
     * 		rollback.
     * @param statusReceiver
     * 		where to deliver the results. Intents sent to
     ...
     */
    @android.annotation.RequiresPermission(anyOf = { android.content.rollback.android.Manifest.permission.MANAGE_ROLLBACKS, android.content.rollback.android.Manifest.permission.TEST_MANAGE_ROLLBACKS })
    public void commitRollback(int rollbackId, @android.annotation.NonNull
    java.util.List<android.content.pm.VersionedPackage> causePackages, @android.annotation.NonNull
    android.content.IntentSender statusReceiver) {
        try {
            mBinder.commitRollback(rollbackId, new android.content.pm.ParceledListSlice(causePackages), mCallerPackageName, statusReceiver);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(android.content.rollback.android.Manifest.permission.TEST_MANAGE_ROLLBACKS.class)
    @android.annotation.TestApi
     ...
     *
     * @param packageName
     * 		the name of the package to expire data for.
     * @throws SecurityException
     * 		if the caller does not have appropriate permissions.
     * @unknown 
     */
    @android.annotation.RequiresPermission(android.content.rollback.android.Manifest.permission.TEST_MANAGE_ROLLBACKS.class)
    @android.annotation.TestApi
    public void expireRollbackForPackage(@android.annotation.NonNull
