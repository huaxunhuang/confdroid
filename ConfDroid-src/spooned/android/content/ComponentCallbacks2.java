...
public interface ComponentCallbacks2 extends android.content.ComponentCallbacks {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "TRIM_MEMORY_" }, value = { android.content.ComponentCallbacks2.TRIM_MEMORY_COMPLETE, android.content.ComponentCallbacks2.TRIM_MEMORY_MODERATE, android.content.ComponentCallbacks2.TRIM_MEMORY_BACKGROUND, android.content.ComponentCallbacks2.TRIM_MEMORY_UI_HIDDEN, android.content.ComponentCallbacks2.TRIM_MEMORY_RUNNING_CRITICAL, android.content.ComponentCallbacks2.TRIM_MEMORY_RUNNING_LOW, android.content.ComponentCallbacks2.TRIM_MEMORY_RUNNING_MODERATE })
     ...
     */
    void onTrimMemory(@android.content.ComponentCallbacks2.TrimMemoryLevel
    int level);
}
