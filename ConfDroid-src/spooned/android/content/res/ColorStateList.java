 ...
 * List Resource</a>.
 *
 * @unknown ref android.R.styleable#ColorStateListItem_alpha
 * @unknown ref android.R.styleable#ColorStateListItem_color
 */
public class ColorStateList extends android.content.res.ComplexColor implements android.os.Parcelable {
     ...
     * states to colors.
     */
    public ColorStateList(int[][] states, @android.annotation.ColorInt
    int[] colors) {
        mStateSpecs = states;
        mColors = colors;
        onColorsChanged();
    ...
    public static android.content.res.ColorStateList valueOf(@android.annotation.ColorInt
    int color) {
        synchronized(android.content.res.ColorStateList.sCache) {
            final int index = android.content.res.ColorStateList.sCache.indexOfKey(color);
            if (index >= 0) {
                final android.content.res.ColorStateList cached = android.content.res.ColorStateList.sCache.valueAt(index).get();
                if (cached != null) {
                    return cached;
                }
                // Prune missing entry.
                android.content.res.ColorStateList.sCache.removeAt(index);
            }
            // Prune the cache before adding new items.
            final int N = android.content.res.ColorStateList.sCache.size();
            for (int i = N - 1; i >= 0; i--) {
                if (android.content.res.ColorStateList.sCache.valueAt(i).get() == null) {
                    android.content.res.ColorStateList.sCache.removeAt(i);
                }
            }
            final android.content.res.ColorStateList csl = new android.content.res.ColorStateList(android.content.res.ColorStateList.EMPTY, new int[]{ color });
     ...
     */
    private ColorStateList(android.content.res.ColorStateList orig) {
        if (orig != null) {
    ...
    public static android.content.res.ColorStateList createFromXml(android.content.res.Resources r, org.xmlpull.v1.XmlPullParser parser) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        return android.content.res.ColorStateList.createFromXml(r, parser, null);
    }
     ...
     */
    @android.annotation.NonNull
    public static android.content.res.ColorStateList createFromXml(@android.annotation.NonNull
     ...
     */
    @android.annotation.NonNull
    static android.content.res.ColorStateList createFromXmlInner(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    ...
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        final android.content.res.ColorStateList colorStateList = new android.content.res.ColorStateList();
    ...
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        int defaultColor = android.content.res.ColorStateList.DEFAULT_COLOR;
        boolean hasUnresolvedAttrs = false;
        int[][] stateSpecList = com.android.internal.util.ArrayUtils.newUnpaddedArray(int[].class, 20);
        ...
        while (((type = parser.next()) != org.xmlpull.v1.XmlPullParser.END_DOCUMENT) && (((depth = parser.getDepth()) >= innerDepth) || (type != org.xmlpull.v1.XmlPullParser.END_TAG))) {
            ...
            final android.content.res.TypedArray a = android.content.res.Resources.obtainAttributes(r, theme, attrs, R.styleable.ColorStateListItem);
            final int[] themeAttrs = a.extractThemeAttrs();
            final int baseColor = a.getColor(R.styleable.ColorStateListItem_color, android.graphics.Color.MAGENTA);
            ...
            stateSpecList = com.android.internal.util.GrowingArrayUtils.append(stateSpecList, listSize, stateSpec);
            listSize++;
        } 
        ...
        if (hasUnresolvedAttrs) {
            ...
            java.lang.System.arraycopy(themeAttrsList, 0, mThemeAttrs, 0, listSize);
        } else {
            mThemeAttrs = null;
        }
        mColors = new int[listSize];
        mStateSpecs = new int[listSize][];
        java.lang.System.arraycopy(colorList, 0, mColors, 0, listSize);
        java.lang.System.arraycopy(stateSpecList, 0, mStateSpecs, 0, listSize);
        onColorsChanged();
    }
    ...
    private void applyTheme(android.content.res.Resources.Theme t) {
        ...
        for (int i = 0; i < N; i++) {
            if (themeAttrsList[i] != null) {
                final android.content.res.TypedArray a = t.resolveAttributes(themeAttrsList[i], R.styleable.ColorStateListItem);
                ...
                if (themeAttrsList[i][R.styleable.ColorStateListItem_color] != 0) {
                    ...
                    defaultAlphaMod = android.graphics.Color.alpha(mColors[i]) / 255.0F;
                } else {
    ...
    @java.lang.Override
    @android.annotation.UnsupportedAppUsage
    public android.content.res.ColorStateList obtainForTheme(android.content.res.Resources.Theme t) {
        if ((t == null) || (!canApplyTheme())) {
            return this;
        }
        final android.content.res.ColorStateList clone = new android.content.res.ColorStateList(this);
        clone.applyTheme(t);
        return clone;
    }
    ...
    private int modulateColorAlpha(int baseColor, float alphaMod) {
        ...
        final int alpha = android.util.MathUtils.constrain(((int) ((baseAlpha * alphaMod) + 0.5F)), 0, 255);
    ...
    public boolean hasFocusStateSpecified() {
        return android.util.StateSet.containsAttribute(mStateSpecs, R.attr.state_focused);
    }
     ...
     *
     * @param stateSet
     * 		an array of {@link android.view.View} states
     * @param defaultColor
     ...
     */
    public int getColorForState(@android.annotation.Nullable
    int[] stateSet, int defaultColor) {
    ...
    public java.lang.String toString() {
        return (((((((((("ColorStateList{" + "mThemeAttrs=") + java.util.Arrays.deepToString(mThemeAttrs)) + "mChangingConfigurations=") + mChangingConfigurations) + "mStateSpecs=") + java.util.Arrays.deepToString(mStateSpecs)) + "mColors=") + java.util.Arrays.toString(mColors)) + "mDefaultColor=") + mDefaultColor) + '}';
    }
    ...
    private void onColorsChanged() {
        ...
        if (N > 0) {
            ...
            for (int i = 0; i < N; i++) {
                if (android.graphics.Color.alpha(colors[i]) != 0xff) {
                    isOpaque = false;
                    break;
                }
            }
    ...
    public android.content.res.ConstantState<android.content.res.ComplexColor> getConstantState() {
        if (mFactory == null) {
            mFactory = new android.content.res.ColorStateList.ColorStateListFactory(this);
        }
        return mFactory;
    }
    ...
    private static class ColorStateListFactory extends android.content.res.ConstantState<android.content.res.ComplexColor> {
        ...
        @android.annotation.UnsupportedAppUsage
        public ColorStateListFactory(android.content.res.ColorStateList src) {
            mSrc = src;
        }
        ...
        @java.lang.Override
        public android.content.res.ColorStateList newInstance(android.content.res.Resources res, android.content.res.Resources.Theme theme) {
            return ((android.content.res.ColorStateList) (mSrc.obtainForTheme(theme)));
        }
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        if (canApplyTheme()) {
            android.util.Log.w(android.content.res.ColorStateList.TAG, "Wrote partially-resolved ColorStateList to parcel!");
        }
    ...
    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.content.res.ColorStateList> CREATOR = new android.os.Parcelable.Creator<android.content.res.ColorStateList>() {
        @java.lang.Override
