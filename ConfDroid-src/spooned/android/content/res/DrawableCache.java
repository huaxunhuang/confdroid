...
class DrawableCache extends android.content.res.ThemedResourceCache<android.graphics.drawable.Drawable.ConstantState> {
    ...
    public android.graphics.drawable.Drawable getInstance(long key, android.content.res.Resources resources, android.content.res.Resources.Theme theme) {
        final android.graphics.drawable.Drawable.ConstantState entry = get(key, theme);
        if (entry != null) {
    ...
    @java.lang.Override
    public boolean shouldInvalidateEntry(android.graphics.drawable.Drawable.ConstantState entry, int configChanges) {
