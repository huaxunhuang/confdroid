...
public abstract class ConstantState<T> {
     ...
     */
    public T newInstance(android.content.res.Resources res) {
        return newInstance();
    }
     ...
     */
    public T newInstance(android.content.res.Resources res, android.content.res.Resources.Theme theme) {
