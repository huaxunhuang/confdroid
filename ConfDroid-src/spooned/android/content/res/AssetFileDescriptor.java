...
public class AssetFileDescriptor implements android.os.Parcelable , java.io.Closeable {
    ...
    public long getLength() {
        ...
        return len >= 0 ? len : android.content.res.AssetFileDescriptor.UNKNOWN_LENGTH;
    }
    ...
    public static class AutoCloseInputStream extends android.os.ParcelFileDescriptor.AutoCloseInputStream {
        ...
        public AutoCloseInputStream(android.content.res.AssetFileDescriptor fd) throws java.io.IOException {
        ...
        public int available() throws java.io.IOException {
            return mRemaining >= 0 ? mRemaining < 0x7fffffff ? ((int) (mRemaining)) : 0x7fffffff : available();
        }
        ...
        public int read(byte[] buffer, int offset, int count) throws java.io.IOException {
            if (mRemaining >= 0) {
                ...
                int res = read(buffer, offset, count);
                if (res >= 0)
                    mRemaining -= res;
    ...
    public static class AutoCloseOutputStream extends android.os.ParcelFileDescriptor.AutoCloseOutputStream {
        ...
        public AutoCloseOutputStream(android.content.res.AssetFileDescriptor fd) throws java.io.IOException {
            super(fd.getParcelFileDescriptor());
    ...
    public static final android.os.Parcelable.Creator<android.content.res.AssetFileDescriptor> CREATOR = new android.os.Parcelable.Creator<android.content.res.AssetFileDescriptor>() {
        public android.content.res.AssetFileDescriptor createFromParcel(android.os.Parcel in) {
            return new android.content.res.AssetFileDescriptor(in);
        }

        public android.content.res.AssetFileDescriptor[] newArray(int size) {
            return new android.content.res.AssetFileDescriptor[size];
        }
    };
}
