...
public interface AssetsProvider {
     ...
     * @param accessMode
     * 		the {@link AssetManager} access mode
     * @see AssetManager#open
     */
    @android.annotation.Nullable
    default android.content.res.AssetFileDescriptor loadAssetFd(@android.annotation.NonNull
    java.lang.String path, int accessMode) {
        return null;
    }
}
