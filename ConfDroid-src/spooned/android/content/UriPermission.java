...
public final class UriPermission implements android.os.Parcelable {
     ...
     */
    public static final long INVALID_TIME = java.lang.Long.MIN_VALUE;
    ...
    public boolean isReadPermission() {
        return (mModeFlags & android.content.Intent.FLAG_GRANT_READ_URI_PERMISSION) != 0;
    }
    ...
    public boolean isWritePermission() {
        return (mModeFlags & android.content.Intent.FLAG_GRANT_WRITE_URI_PERMISSION) != 0;
    }
    ...
    public java.lang.String toString() {
        return ((((("UriPermission {uri=" + mUri) + ", modeFlags=") + mModeFlags) + ", persistedTime=") + mPersistedTime) + "}";
    }
    ...
    public static final android.content.Creator<android.content.UriPermission> CREATOR = new android.content.Creator<android.content.UriPermission>() {
        @java.lang.Override
        public android.content.UriPermission createFromParcel(android.os.Parcel source) {
            return new android.content.UriPermission(source);
        }

        @java.lang.Override
        public android.content.UriPermission[] newArray(int size) {
            return new android.content.UriPermission[size];
        }
    };
}
