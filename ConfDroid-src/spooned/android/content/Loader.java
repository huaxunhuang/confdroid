 ...
 *
 * @param <D>
 * 		The result returned when the load is complete
...
public class Loader<D> {
     ...
     */
    public void registerListener(int id, android.content.Loader.OnLoadCompleteListener<D> listener) {
        if (mListener != null) {
    ...
    public java.lang.String dataToString(D data) {
        ...
        android.util.DebugUtils.buildShortClassTag(data, sb);
        sb.append("}");
        return sb.toString();
    }
