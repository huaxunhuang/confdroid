...
public interface DialogInterface {
    ...
    int BUTTON1 = android.content.DialogInterface.BUTTON_POSITIVE;
     ...
     */
    @java.lang.Deprecated
    int BUTTON2 = android.content.DialogInterface.BUTTON_NEGATIVE;
     ...
     */
    @java.lang.Deprecated
    int BUTTON3 = android.content.DialogInterface.BUTTON_NEUTRAL;
    ...
    interface OnMultiChoiceClickListener {
         ...
         * @param isChecked
         * 		{@code true} if the click checked the item, else
         * 		{@code false}
         */
        void onClick(android.content.DialogInterface dialog, int which, boolean isChecked);
    }
    ...
    interface OnKeyListener {
         ...
         */
        boolean onKey(android.content.DialogInterface dialog, int keyCode, android.view.KeyEvent event);
    }
}
