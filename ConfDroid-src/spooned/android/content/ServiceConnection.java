...
public interface ServiceConnection {
     ...
     * 		connection is dead.
     */
    default void onBindingDied(android.content.ComponentName name) {
    }
     ...
     *
     * @param name
     * 		The concrete component name of the service whose binding
     * 		has been rejected by the Service implementation.
     */
    default void onNullBinding(android.content.ComponentName name) {
    }
}
