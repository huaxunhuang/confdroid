...
public abstract class AccessibilityService extends android.app.Service {
    ...
    public interface Callbacks {
        ...
        public void init(int connectionId, android.os.IBinder windowToken);

        public boolean onGesture(int gestureId);

        public boolean onKeyEvent(android.view.KeyEvent event);

        public void onMagnificationChanged(@android.annotation.NonNull
        android.graphics.Region region, float scale, float centerX, float centerY);
    ...
    @android.annotation.IntDef({ android.accessibilityservice.AccessibilityService.SHOW_MODE_AUTO, android.accessibilityservice.AccessibilityService.SHOW_MODE_HIDDEN })
    ...
    public java.util.List<android.view.accessibility.AccessibilityWindowInfo> getWindows() {
        return android.view.accessibility.AccessibilityInteractionClient.getInstance().getWindows(mConnectionId);
    }
    ...
    public android.view.accessibility.AccessibilityNodeInfo getRootInActiveWindow() {
        return android.view.accessibility.AccessibilityInteractionClient.getInstance().getRootInActiveWindow(mConnectionId);
    }
    ...
    public final void disableSelf() {
        final android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mConnectionId);
        if (connection != null) {
            try {
    ...
    public final android.accessibilityservice.AccessibilityService.MagnificationController getMagnificationController() {
        synchronized(mLock) {
            if (mMagnificationController == null) {
                mMagnificationController = new android.accessibilityservice.AccessibilityService.MagnificationController(this, mLock);
            }
     ...
     * @param handler
     * 		The handler on which to call back the {@code callback} object. If
     ...
     */
    public final boolean dispatchGesture(@android.annotation.NonNull
    android.accessibilityservice.GestureDescription gesture, @android.annotation.Nullable
    android.accessibilityservice.AccessibilityService.GestureResultCallback callback, @android.annotation.Nullable
    android.os.Handler handler) {
        final android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mConnectionId);
        if (connection == null) {
            return false;
        }
        java.util.List<android.accessibilityservice.GestureDescription.GestureStep> steps = android.accessibilityservice.GestureDescription.MotionEventGenerator.getGestureStepsFromGestureDescription(gesture, 100);
        try {
            synchronized(mLock) {
                mGestureStatusCallbackSequence++;
                if (callback != null) {
                    if (mGestureStatusCallbackInfos == null) {
                        mGestureStatusCallbackInfos = new android.util.SparseArray<>();
                    }
                    android.accessibilityservice.AccessibilityService.GestureResultCallbackInfo callbackInfo = new android.accessibilityservice.AccessibilityService.GestureResultCallbackInfo(gesture, callback, handler);
                    mGestureStatusCallbackInfos.put(mGestureStatusCallbackSequence, callbackInfo);
                }
                connection.sendGesture(mGestureStatusCallbackSequence, new android.content.pm.ParceledListSlice(steps));
            }
        } catch (android.os.RemoteException re) {
            throw new java.lang.RuntimeException(re);
        }
    ...
    void onPerformGestureResult(int sequence, final boolean completedSuccessfully) {
        ...
        final android.accessibilityservice.AccessibilityService.GestureResultCallbackInfo finalCallbackInfo = callbackInfo;
        if (((callbackInfo != null) && (callbackInfo.gestureDescription != null)) && (callbackInfo.callback != null)) {
            if (callbackInfo.handler != null) {
                callbackInfo.handler.post(new java.lang.Runnable() {
                    @java.lang.Override
                    public void run() {
    ...
    private void onMagnificationChanged(@android.annotation.NonNull
    android.graphics.Region region, float scale, float centerX, float centerY) {
        if (mMagnificationController != null) {
            mMagnificationController.dispatchMagnificationChanged(region, scale, centerX, centerY);
        }
    }
    ...
    public static final class MagnificationController {
        ...
        MagnificationController(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService service, @android.annotation.NonNull
         ...
         *
         * @param listener
         * 		the listener to add, must be non-{@code null}
         */
        public void addListener(@android.annotation.NonNull
         ...
         */
        public void addListener(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener listener, @android.annotation.Nullable
        android.os.Handler handler) {
            synchronized(mLock) {
                if (mListeners == null) {
                    mListeners = new android.util.ArrayMap<>();
                }
         ...
         *
         * @param listener
         * 		the listener to remove, must be non-null
         * @return {@code true} if at least one instance of the listener was
        removed
         */
        public boolean removeListener(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener listener) {
            if (mListeners == null) {
                return false;
            }
        ...
        private void setMagnificationCallbackEnabled(boolean enabled) {
            final android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mService.mConnectionId);
            if (connection != null) {
                try {
         ...
         */
        void dispatchMagnificationChanged(@android.annotation.NonNull
        final android.graphics.Region region, final float scale, final float centerX, final float centerY) {
            final android.util.ArrayMap<android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener, android.os.Handler> entries;
            synchronized(mLock) {
                if ((mListeners == null) || mListeners.isEmpty()) {
                    android.util.Slog.d(android.accessibilityservice.AccessibilityService.LOG_TAG, "Received magnification changed " + "callback with no listeners registered!");
                    setMagnificationCallbackEnabled(false);
                    return;
                }
                // Listeners may remove themselves. Perform a shallow copy to avoid concurrent
                // modification.
                entries = new android.util.ArrayMap<>(mListeners);
            }
            for (int i = 0, count = entries.size(); i < count; i++) {
                final android.accessibilityservice.AccessibilityService.MagnificationController.OnMagnificationChangedListener listener = entries.keyAt(i);
                final android.os.Handler handler = entries.valueAt(i);
                if (handler != null) {
                    handler.post(new java.lang.Runnable() {
                        @java.lang.Override
                        public void run() {
                            listener.onMagnificationChanged(android.accessibilityservice.AccessibilityService.MagnificationController.this, region, scale, centerX, centerY);
                        }
                    });
                } else {
        ...
        public float getScale() {
            ...
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to obtain scale", re);
        ...
        public float getCenterX() {
            ...
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to obtain center X", re);
                    re.rethrowFromSystemServer();
                }
            }
            return 0.0F;
        ...
        public float getCenterY() {
            ...
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to obtain center Y", re);
                    re.rethrowFromSystemServer();
                }
            }
            return 0.0F;
        ...
        public android.graphics.Region getMagnificationRegion() {
            ...
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to obtain magnified region", re);
                    re.rethrowFromSystemServer();
                }
            }
         ...
         *
         * @param animate
         * 		{@code true} to animate from the current scale and
        ...
        public boolean reset(boolean animate) {
            ...
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to reset", re);
                    re.rethrowFromSystemServer();
                }
            }
            return false;
         ...
         *
         * @param scale
         * 		the magnification scale to set, must be >= 1 and <= 5
         * @param animate
         * 		{@code true} to animate from the current scale or
        ...
        public boolean setScale(float scale, boolean animate) {
            ...
            if (connection != null) {
                try {
                    return connection.setMagnificationScaleAndCenter(scale, java.lang.Float.NaN, java.lang.Float.NaN, animate);
                } catch (android.os.RemoteException re) {
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to set scale", re);
                    re.rethrowFromSystemServer();
                }
            }
            return false;
         ...
         * 		center the viewport
         * @param animate
         * 		{@code true} to animate from the current viewport
        ...
        public boolean setCenter(float centerX, float centerY, boolean animate) {
            ...
            if (connection != null) {
                try {
                    return connection.setMagnificationScaleAndCenter(java.lang.Float.NaN, centerX, centerY, animate);
                } catch (android.os.RemoteException re) {
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to set center", re);
                    re.rethrowFromSystemServer();
                }
            }
            return false;
        ...
        public interface OnMagnificationChangedListener {
             ...
             * 		magnification is focused
             */
            void onMagnificationChanged(@android.annotation.NonNull
            android.accessibilityservice.AccessibilityService.MagnificationController controller, @android.annotation.NonNull
            android.graphics.Region region, float scale, float centerX, float centerY);
        }
    }
    ...
    public final android.accessibilityservice.AccessibilityService.SoftKeyboardController getSoftKeyboardController() {
        synchronized(mLock) {
            if (mSoftKeyboardController == null) {
                mSoftKeyboardController = new android.accessibilityservice.AccessibilityService.SoftKeyboardController(this, mLock);
            }
    ...
    public static final class SoftKeyboardController {
        ...
        SoftKeyboardController(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService service, @android.annotation.NonNull
        java.lang.Object lock) {
            mService = service;
            mLock = lock;
         ...
         */
        public void addOnShowModeChangedListener(@android.annotation.NonNull
         ...
         * 		the listener to add, must be non-null
         * @param handler
         * 		the handler on which to callback should execute, or {@code null} to
         * 		execute on the service's main thread
         */
        public void addOnShowModeChangedListener(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService.SoftKeyboardController.OnShowModeChangedListener listener, @android.annotation.Nullable
        android.os.Handler handler) {
            synchronized(mLock) {
                if (mListeners == null) {
                    mListeners = new android.util.ArrayMap<>();
         ...
         */
        public boolean removeOnShowModeChangedListener(@android.annotation.NonNull
        android.accessibilityservice.AccessibilityService.SoftKeyboardController.OnShowModeChangedListener listener) {
            if (mListeners == null) {
                return false;
            }
        ...
        void dispatchSoftKeyboardShowModeChanged(final int showMode) {
            final android.util.ArrayMap<android.accessibilityservice.AccessibilityService.SoftKeyboardController.OnShowModeChangedListener, android.os.Handler> entries;
            synchronized(mLock) {
                if ((mListeners == null) || mListeners.isEmpty()) {
                    android.util.Slog.d(android.accessibilityservice.AccessibilityService.LOG_TAG, "Received soft keyboard show mode changed callback" + " with no listeners registered!");
                    setSoftKeyboardCallbackEnabled(false);
                    return;
                }
                // Listeners may remove themselves. Perform a shallow copy to avoid concurrent
            ...
            for (int i = 0, count = entries.size(); i < count; i++) {
                final android.accessibilityservice.AccessibilityService.SoftKeyboardController.OnShowModeChangedListener listener = entries.keyAt(i);
                final android.os.Handler handler = entries.valueAt(i);
                if (handler != null) {
                    handler.post(new java.lang.Runnable() {
                        @java.lang.Override
                        public void run() {
                            listener.onShowModeChanged(android.accessibilityservice.AccessibilityService.SoftKeyboardController.this, showMode);
                        }
                    });
                } else {
                    // We're already on the main thread, just run the listener.
        ...
        public int getShowMode() {
            try {
                return android.provider.Settings.Secure.getInt(mService.getContentResolver(), android.provider.Settings.Secure.ACCESSIBILITY_SOFT_KEYBOARD_MODE);
            } catch (android.provider.Settings.SettingNotFoundException e) {
                android.util.Log.v(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to obtain the soft keyboard mode", e);
         ...
         */
        public boolean setShowMode(@android.accessibilityservice.AccessibilityService.SoftKeyboardShowMode
        int showMode) {
            final android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mService.mConnectionId);
            if (connection != null) {
                try {
                    ...
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Failed to set soft keyboard behavior", re);
                    re.rethrowFromSystemServer();
                }
            }
            return false;
        ...
        public interface OnShowModeChangedListener {
             ...
             */
            void onShowModeChanged(@android.annotation.NonNull
            android.accessibilityservice.AccessibilityService.SoftKeyboardController controller, @android.accessibilityservice.AccessibilityService.SoftKeyboardShowMode
            int showMode);
        }
    }
    ...
    public final boolean performGlobalAction(int action) {
        android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mConnectionId);
        if (connection != null) {
            try {
                return connection.performGlobalAction(action);
            } catch (android.os.RemoteException re) {
                android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Error while calling performGlobalAction", re);
                re.rethrowFromSystemServer();
            }
        }
        return false;
     ...
     *
     * @param focus
     * 		The focus to find. One of {@link AccessibilityNodeInfo#FOCUS_INPUT} or
    ...
    public android.view.accessibility.AccessibilityNodeInfo findFocus(int focus) {
        return android.view.accessibility.AccessibilityInteractionClient.getInstance().findFocus(mConnectionId, android.view.accessibility.AccessibilityNodeInfo.ANY_WINDOW_ID, android.view.accessibility.AccessibilityNodeInfo.ROOT_NODE_ID, focus);
    }
    ...
    public final android.accessibilityservice.AccessibilityServiceInfo getServiceInfo() {
        ...
        if (connection != null) {
            try {
                ...
                android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Error while getting AccessibilityServiceInfo", re);
                re.rethrowFromSystemServer();
            }
        }
        return null;
    ...
    private void sendServiceInfo() {
        ...
        if ((mInfo != null) && (connection != null)) {
            try {
                ...
                android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Error while setting AccessibilityServiceInfo", re);
                re.rethrowFromSystemServer();
            }
        }
    }
    ...
    java.lang.String name) {
        ...
        if (android.content.Context.WINDOW_SERVICE.equals(name)) {
            if (mWindowManager == null) {
                mWindowManager = ((android.view.WindowManager) (getBaseContext().getSystemService(name)));
            }
    ...
    public final android.os.IBinder onBind(android.content.Intent intent) {
        return new android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper(this, getMainLooper(), new android.accessibilityservice.AccessibilityService.Callbacks() {
            @java.lang.Override
            public void onServiceConnected() {
            ...
            @java.lang.Override
            public void onAccessibilityEvent(android.view.accessibility.AccessibilityEvent event) {
                android.accessibilityservice.AccessibilityService.this.onAccessibilityEvent(event);
            }
            ...
            public void init(int connectionId, android.os.IBinder windowToken) {
                ...
                final android.view.WindowManagerImpl wm = ((android.view.WindowManagerImpl) (getSystemService(android.content.Context.WINDOW_SERVICE)));
                wm.setDefaultToken(windowToken);
            }

            @java.lang.Override
            public boolean onGesture(int gestureId) {
                return android.accessibilityservice.AccessibilityService.this.onGesture(gestureId);
            }

            @java.lang.Override
            public boolean onKeyEvent(android.view.KeyEvent event) {
                return android.accessibilityservice.AccessibilityService.this.onKeyEvent(event);
            }

            @java.lang.Override
            public void onMagnificationChanged(@android.annotation.NonNull
            android.graphics.Region region, float scale, float centerX, float centerY) {
                android.accessibilityservice.AccessibilityService.this.onMagnificationChanged(region, scale, centerX, centerY);
            }

            @java.lang.Override
            public void onSoftKeyboardShowModeChanged(int showMode) {
                android.accessibilityservice.AccessibilityService.this.onSoftKeyboardShowModeChanged(showMode);
            }

            @java.lang.Override
            public void onPerformGestureResult(int sequence, boolean completedSuccessfully) {
                android.accessibilityservice.AccessibilityService.this.onPerformGestureResult(sequence, completedSuccessfully);
            }
        });
    }
    ...
    public static class IAccessibilityServiceClientWrapper extends android.accessibilityservice.IAccessibilityServiceClient.Stub implements com.android.internal.os.HandlerCaller.Callback {
        ...
        public IAccessibilityServiceClientWrapper(android.content.Context context, android.os.Looper looper, android.accessibilityservice.AccessibilityService.Callbacks callback) {
            mCallback = callback;
            mCaller = /* asyncHandler */
            new com.android.internal.os.HandlerCaller(context, looper, this, true);
        }

        public void init(android.accessibilityservice.IAccessibilityServiceConnection connection, int connectionId, android.os.IBinder windowToken) {
            android.os.Message message = mCaller.obtainMessageIOO(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_INIT, connectionId, connection, windowToken);
            mCaller.sendMessage(message);
        }

        public void onInterrupt() {
            android.os.Message message = mCaller.obtainMessage(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_INTERRUPT);
            mCaller.sendMessage(message);
        }

        public void onAccessibilityEvent(android.view.accessibility.AccessibilityEvent event) {
            android.os.Message message = mCaller.obtainMessageO(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_ACCESSIBILITY_EVENT, event);
            mCaller.sendMessage(message);
        }

        public void onGesture(int gestureId) {
            android.os.Message message = mCaller.obtainMessageI(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_GESTURE, gestureId);
            mCaller.sendMessage(message);
        }

        public void clearAccessibilityCache() {
            android.os.Message message = mCaller.obtainMessage(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_CLEAR_ACCESSIBILITY_CACHE);
            mCaller.sendMessage(message);
        }

        @java.lang.Override
        public void onKeyEvent(android.view.KeyEvent event, int sequence) {
            android.os.Message message = mCaller.obtainMessageIO(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_KEY_EVENT, sequence, event);
            mCaller.sendMessage(message);
        }
        ...
        android.graphics.Region region, float scale, float centerX, float centerY) {
            ...
            args.arg3 = centerX;
            args.arg4 = centerY;
            final android.os.Message message = mCaller.obtainMessageO(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_MAGNIFICATION_CHANGED, args);
            mCaller.sendMessage(message);
        }

        public void onSoftKeyboardShowModeChanged(int showMode) {
            final android.os.Message message = mCaller.obtainMessageI(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_SOFT_KEYBOARD_SHOW_MODE_CHANGED, showMode);
            mCaller.sendMessage(message);
        }

        public void onPerformGestureResult(int sequence, boolean successfully) {
            android.os.Message message = mCaller.obtainMessageII(android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_GESTURE_COMPLETE, sequence, successfully ? 1 : 0);
            mCaller.sendMessage(message);
        }
        ...
        public void executeMessage(android.os.Message message) {
            switch (message.what) {
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_ACCESSIBILITY_EVENT :
                    {
                        android.view.accessibility.AccessibilityEvent event = ((android.view.accessibility.AccessibilityEvent) (message.obj));
                        if (event != null) {
                            android.view.accessibility.AccessibilityInteractionClient.getInstance().onAccessibilityEvent(event);
                    ...
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_INTERRUPT :
                    {
                        mCallback.onInterrupt();
                    }
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_INIT :
                    {
                        mConnectionId = message.arg1;
                        com.android.internal.os.SomeArgs args = ((com.android.internal.os.SomeArgs) (message.obj));
                        android.accessibilityservice.IAccessibilityServiceConnection connection = ((android.accessibilityservice.IAccessibilityServiceConnection) (args.arg1));
                        android.os.IBinder windowToken = ((android.os.IBinder) (args.arg2));
                        args.recycle();
                        if (connection != null) {
                            android.view.accessibility.AccessibilityInteractionClient.getInstance().addConnection(mConnectionId, connection);
                            mCallback.init(mConnectionId, windowToken);
                            mCallback.onServiceConnected();
                        } else {
                            android.view.accessibility.AccessibilityInteractionClient.getInstance().removeConnection(mConnectionId);
                            mConnectionId = android.view.accessibility.AccessibilityInteractionClient.NO_ID;
                            android.view.accessibility.AccessibilityInteractionClient.getInstance().clearCache();
                            mCallback.init(android.view.accessibility.AccessibilityInteractionClient.NO_ID, null);
                        }
                    }
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_GESTURE :
                    {
                        final int gestureId = message.arg1;
                        mCallback.onGesture(gestureId);
                    }
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_CLEAR_ACCESSIBILITY_CACHE :
                    {
                        android.view.accessibility.AccessibilityInteractionClient.getInstance().clearCache();
                    }
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_KEY_EVENT :
                    {
                        android.view.KeyEvent event = ((android.view.KeyEvent) (message.obj));
                        try {
                            android.accessibilityservice.IAccessibilityServiceConnection connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mConnectionId);
                            if (connection != null) {
                    ...
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_MAGNIFICATION_CHANGED :
                    {
                        final com.android.internal.os.SomeArgs args = ((com.android.internal.os.SomeArgs) (message.obj));
                        final android.graphics.Region region = ((android.graphics.Region) (args.arg1));
                    ...
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_ON_SOFT_KEYBOARD_SHOW_MODE_CHANGED :
                    {
                        final int showMode = ((int) (message.arg1));
                        mCallback.onSoftKeyboardShowModeChanged(showMode);
                    }
                    return;
                case android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper.DO_GESTURE_COMPLETE :
                    {
                    ...
                    return;
                default :
                    android.util.Log.w(android.accessibilityservice.AccessibilityService.LOG_TAG, "Unknown message type " + message.what);
            }
        }
    }
    ...
    private static class GestureResultCallbackInfo {
        ...
        GestureResultCallbackInfo(android.accessibilityservice.GestureDescription gestureDescription, android.accessibilityservice.AccessibilityService.GestureResultCallback callback, android.os.Handler handler) {
