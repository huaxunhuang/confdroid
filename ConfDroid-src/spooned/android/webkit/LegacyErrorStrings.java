...
class LegacyErrorStrings {
     ...
     */
    static java.lang.String getString(int errorCode, android.content.Context context) {
        return context.getText(android.webkit.LegacyErrorStrings.getResource(errorCode)).toString();
    }
    ...
    private static int getResource(int errorCode) {
        switch (errorCode) {
            ...
            case -11 :
                /* EventHandler.ERROR_FAILED_SSL_HANDSHAKE: */
            ...
            case -15 :
                /* EventHandler.TOO_MANY_REQUESTS_ERROR: */
                return com.android.internal.R.string.httpErrorTooManyRequests;
            default :
                android.util.Log.w(android.webkit.LegacyErrorStrings.LOGTAG, "Using generic message for unknown error code: " + errorCode);
                return com.android.internal.R.string.httpError;
        }
    }
}
