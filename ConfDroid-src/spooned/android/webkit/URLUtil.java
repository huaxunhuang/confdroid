...
public final class URLUtil {
    ...
    public static java.lang.String guessUrl(java.lang.String inUrl) {
        java.lang.String retVal = inUrl;
        android.net.WebAddress webAddress;
        if (android.webkit.URLUtil.TRACE)
            android.util.Log.v(android.webkit.URLUtil.LOGTAG, "guessURL before queueRequest: " + inUrl);
        ...
        try {
            webAddress = new android.net.WebAddress(inUrl);
        } catch (android.net.ParseException ex) {
            if (android.webkit.URLUtil.TRACE) {
                android.util.Log.v(android.webkit.URLUtil.LOGTAG, "smartUrlFilter: failed to parse url = " + inUrl);
            }
            return retVal;
        }
        // Check host
    ...
    public static java.lang.String composeSearchUrl(java.lang.String inQuery, java.lang.String template, java.lang.String queryPlaceHolder) {
    ...
    public static byte[] decode(byte[] url) throws java.lang.IllegalArgumentException {
        ...
        for (int i = 0; i < url.length; i++) {
            ...
            if (b == '%') {
                if ((url.length - i) > 2) {
                    b = ((byte) ((android.webkit.URLUtil.parseHex(url[i + 1]) * 16) + android.webkit.URLUtil.parseHex(url[i + 2])));
                    i += 2;
                } else {
        ...
        java.lang.System.arraycopy(tempData, 0, retData, 0, tempCount);
        return retData;
    }
     ...
     */
    static boolean verifyURLEncoding(java.lang.String url) {
        ...
        while ((index >= 0) && (index < count)) {
            if (index < (count - 2)) {
                try {
                    android.webkit.URLUtil.parseHex(((byte) (url.charAt(++index))));
                    android.webkit.URLUtil.parseHex(((byte) (url.charAt(++index))));
    ...
    private static int parseHex(byte b) {
        ...
        throw new java.lang.IllegalArgumentException(("Invalid hex char '" + b) + "'");
    }
    ...
    public static boolean isAssetUrl(java.lang.String url) {
        return (null != url) && url.startsWith(android.webkit.URLUtil.ASSET_BASE);
    }
    ...
    public static boolean isResourceUrl(java.lang.String url) {
        return (null != url) && url.startsWith(android.webkit.URLUtil.RESOURCE_BASE);
    }
    ...
    public static boolean isCookielessProxyUrl(java.lang.String url) {
        return (null != url) && url.startsWith(android.webkit.URLUtil.PROXY_BASE);
    }
    ...
    public static boolean isFileUrl(java.lang.String url) {
        return (null != url) && ((url.startsWith(android.webkit.URLUtil.FILE_BASE) && (!url.startsWith(android.webkit.URLUtil.ASSET_BASE))) && (!url.startsWith(android.webkit.URLUtil.PROXY_BASE)));
    }
    ...
    public static boolean isNetworkUrl(java.lang.String url) {
        ...
        return android.webkit.URLUtil.isHttpUrl(url) || android.webkit.URLUtil.isHttpsUrl(url);
    }
    ...
    public static boolean isContentUrl(java.lang.String url) {
        return (null != url) && url.startsWith(android.webkit.URLUtil.CONTENT_BASE);
    }
    ...
    public static boolean isValidUrl(java.lang.String url) {
        ...
        return ((((((android.webkit.URLUtil.isAssetUrl(url) || android.webkit.URLUtil.isResourceUrl(url)) || android.webkit.URLUtil.isFileUrl(url)) || android.webkit.URLUtil.isAboutUrl(url)) || android.webkit.URLUtil.isHttpUrl(url)) || android.webkit.URLUtil.isHttpsUrl(url)) || android.webkit.URLUtil.isJavaScriptUrl(url)) || android.webkit.URLUtil.isContentUrl(url);
    }
     ...
     */
    public static final java.lang.String guessFileName(java.lang.String url, java.lang.String contentDisposition, java.lang.String mimeType) {
        ...
        if (filename == null) {
            java.lang.String decodedUrl = android.net.Uri.decode(url);
            if (decodedUrl != null) {
        ...
        if (dotIndex < 0) {
            ...
            if (mimeType != null) {
                ...
                java.lang.String typeFromExt = android.webkit.MimeTypeMap.getSingleton().getMimeTypeFromExtension(filename.substring(lastDotIndex + 1));
     ...
     */
    private static final java.util.regex.Pattern CONTENT_DISPOSITION_PATTERN = java.util.regex.Pattern.compile("attachment;\\s*filename\\s*=\\s*(\"?)([^\"]*)\\1\\s*$", java.util.regex.Pattern.CASE_INSENSITIVE);
     ...
     */
    static java.lang.String parseContentDisposition(java.lang.String contentDisposition) {
        try {
            java.util.regex.Matcher m = android.webkit.URLUtil.CONTENT_DISPOSITION_PATTERN.matcher(contentDisposition);
            if (m.find()) {
                return m.group(2);
            }
