...
public abstract class WebSettings {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.webkit.WebSettings.LOAD_DEFAULT, android.webkit.WebSettings.LOAD_NORMAL, android.webkit.WebSettings.LOAD_CACHE_ELSE_NETWORK, android.webkit.WebSettings.LOAD_NO_CACHE, android.webkit.WebSettings.LOAD_CACHE_ONLY })
     ...
     *
     * @param t
     * 		the text size as a {@link TextSize} value
    ...
    public synchronized android.webkit.WebSettings.TextSize getTextSize() {
        android.webkit.WebSettings.TextSize closestSize = null;
        int smallestDelta = java.lang.Integer.MAX_VALUE;
        int textSize = getTextZoom();
        for (android.webkit.WebSettings.TextSize size : android.webkit.WebSettings.TextSize.values()) {
            int delta = java.lang.Math.abs(textSize - size.value);
            if (delta == 0) {
                return size;
            }
        ...
        return closestSize != null ? closestSize : android.webkit.WebSettings.TextSize.NORMAL;
    }
     ...
     *
     * @param support
     * 		whether to suport multiple windows
     */
     ...
     *
     * @param l
     * 		the layout algorithm to use, as a {@link LayoutAlgorithm} value
     */
     ...
     *
     * @param flag
     * 		true means block network loads by the WebView
    ...
    {@link #setPluginState}
     * @unknown Since API level {@link android.os.Build.VERSION_CODES#JELLY_BEAN_MR2}
     */
    @android.annotation.SystemApi
    @java.lang.Deprecated
     ...
     *
     * @param flag
     * 		true if the WebView should use the database storage API
     */
     ...
     * 		the mode to use
     */
    public abstract void setCacheMode(@android.webkit.WebSettings.CacheMode
    int mode);
     ...
     *
     * @param mode
     * 		The mixed content mode to use. One of {@link #MIXED_CONTENT_NEVER_ALLOW},
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, value = { android.webkit.WebSettings.MENU_ITEM_NONE, android.webkit.WebSettings.MENU_ITEM_SHARE, android.webkit.WebSettings.MENU_ITEM_WEB_SEARCH, android.webkit.WebSettings.MENU_ITEM_PROCESS_TEXT })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public abstract void setDisabledActionModeMenuItems(@android.webkit.WebSettings.MenuItemFlags
    int menuItems);
     ...
     * action mode menu. If this flag is set via {@link #setDisabledActionModeMenuItems}, these menu items will be disabled.
     */
