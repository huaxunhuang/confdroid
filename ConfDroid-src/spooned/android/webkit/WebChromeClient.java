...
public class WebChromeClient {
     ...
     * @param quotaUpdater
     * 		An instance of {@link WebStorage.QuotaUpdater} which
     * 		must be used to inform the WebView of the new quota.
     * @deprecated This method is no longer called; WebView now uses the HTML5 / JavaScript Quota
    Management API.
     */
    @java.lang.Deprecated
    public void onExceededDatabaseQuota(java.lang.String url, java.lang.String databaseIdentifier, long quota, long estimatedDatabaseSize, long totalQuota, android.webkit.WebStorage.QuotaUpdater quotaUpdater) {
    ...
    public static abstract class FileChooserParams {
        ...
        public static android.net.Uri[] parseResult(int resultCode, android.content.Intent data) {
            return android.webkit.WebViewFactory.getProvider().getStatics().parseFileChooserResult(resultCode, data);
        }
     ...
     * @unknown This method was not published in any SDK version.
     */
    @android.annotation.SystemApi
    @java.lang.Deprecated
    public void openFileChooser(android.webkit.ValueCallback<android.net.Uri> uploadFile, java.lang.String acceptType, java.lang.String capture) {
