 ...
 * default scaling factor used for the current device. For example, if the value of {@code window.devicePixelRatio} is "1.0", then the device is considered a medium density (mdpi) device
...
public class WebView extends android.widget.AbsoluteLayout implements android.view.ViewDebug.HierarchyHandler , android.view.ViewGroup.OnHierarchyChangeListener , android.view.ViewTreeObserver.OnGlobalFocusChangeListener {
    /**
    ...
    public static abstract class VisualStateCallback {
         ...
         *
         * @param requestId
         * 		The identifier passed to {@link #postVisualStateCallback} when this
         * 		callback was posted.
         */
    ...
    public static class HitTestResult {
        ...
        public HitTestResult() {
            mType = android.webkit.WebView.HitTestResult.UNKNOWN_TYPE;
        }
     ...
     * 		whether this WebView will be initialized in
     * 		private mode
     * @unknown This is used internally by dumprendertree, as it requires the javaScript interfaces to
    be added synchronously, before a subsequent loadUrl call takes effect.
     */
    protected WebView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, java.util.Map<java.lang.String, java.lang.Object> javaScriptInterfaces, boolean privateBrowsing) {
    ...
    protected WebView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes, java.util.Map<java.lang.String, java.lang.Object> javaScriptInterfaces, boolean privateBrowsing) {
        super(context, attrs, defStyleAttr, defStyleRes);
        if (context == null) {
            throw new java.lang.IllegalArgumentException("Invalid context argument");
        }
        android.webkit.WebView.sEnforceThreadChecking = context.getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.JELLY_BEAN_MR2;
        checkThread();
     ...
     *
     * @deprecated This method is now obsolete.
     * @unknown Since API level {@link android.os.Build.VERSION_CODES#JELLY_BEAN_MR1}
     */
     ...
     * </ul></p>
     *
     * <p>When using this API it is also recommended to enable pre-rasterization if the {@link WebView} is offscreen to avoid flickering. See {@link WebSettings#setOffscreenPreRaster} for
     ...
     */
    public void postVisualStateCallback(long requestId, android.webkit.WebView.VisualStateCallback callback) {
        checkThread();
     ...
     */
    public static void clearClientCertPreferences(java.lang.Runnable onCleared) {
        android.webkit.WebView.getFactory().getStatics().clearClientCertPreferences(onCleared);
    }
    ...
    public static java.lang.String findAddress(java.lang.String addr) {
        ...
        return android.webkit.WebView.getFactory().getStatics().findAddress(addr);
    }
    ...
    public static void enableSlowWholeDocumentDraw() {
        android.webkit.WebView.getFactory().getStatics().enableSlowWholeDocumentDraw();
    }
     ...
     */
    public void postWebMessage(android.webkit.WebMessage message, android.net.Uri targetOrigin) {
        checkThread();
    ...
    public static void setWebContentsDebuggingEnabled(boolean enabled) {
        android.webkit.WebView.getFactory().getStatics().setWebContentsDebuggingEnabled(enabled);
    }
    ...
    public static synchronized android.webkit.PluginList getPluginList() {
        return new android.webkit.PluginList();
    }
     ...
     * @unknown Since API level {@link android.os.Build.VERSION_CODES#JELLY_BEAN}
     */
    @java.lang.Deprecated
     ...
     *
     * @unknown WebViewProvider is not public API.
     */
    @android.annotation.SystemApi
    ...
    public class PrivateAccess {
        ...
        public boolean super_performAccessibilityAction(int action, android.os.Bundle arguments) {
        ...
        public boolean super_requestFocus(int direction, android.graphics.Rect previouslyFocusedRect) {
        ...
        public void super_startActivityForResult(android.content.Intent intent, int requestCode) {
            android.webkit.WebView.super.startActivityForResult(intent, requestCode);
        }
        ...
        public void overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX, int scrollRangeY, int maxOverScrollX, int maxOverScrollY, boolean isTouchEvent) {
            android.webkit.WebView.this.overScrollBy(deltaX, deltaY, scrollX, scrollY, scrollRangeX, scrollRangeY, maxOverScrollX, maxOverScrollY, isTouchEvent);
        }
        ...
        public void super_onDrawVerticalScrollBar(android.graphics.Canvas canvas, android.graphics.drawable.Drawable scrollBar, int l, int t, int r, int b) {
    ...
    void setFindDialogFindListener(android.webkit.WebView.FindListener listener) {
        checkThread();
        setupFindListenerIfNeeded();
    ...
    private class FindListenerDistributor implements android.webkit.WebView.FindListener {
        ...
        public void onFindResultReceived(int activeMatchOrdinal, int numberOfMatches, boolean isDoneCounting) {
            if (mFindDialogFindListener != null) {
                mFindDialogFindListener.onFindResultReceived(activeMatchOrdinal, numberOfMatches, isDoneCounting);
            }
            if (mUserFindListener != null) {
                mUserFindListener.onFindResultReceived(activeMatchOrdinal, numberOfMatches, isDoneCounting);
            }
        }
    }
    ...
    private void setupFindListenerIfNeeded() {
        if (mFindListener == null) {
            mFindListener = new android.webkit.WebView.FindListenerDistributor();
    ...
    private void ensureProviderCreated() {
        ...
        if (mProvider == null) {
            ...
            mProvider = android.webkit.WebView.getFactory().createWebView(this, new android.webkit.WebView.PrivateAccess());
        }
    }
    ...
    private final android.os.Looper mWebViewThread = android.os.Looper.myLooper();
    ...
    private void checkThread() {
        ...
        if ((mWebViewThread != null) && (android.os.Looper.myLooper() != mWebViewThread)) {
            java.lang.Throwable throwable = new java.lang.Throwable(((((((((("A WebView method was called on thread '" + java.lang.Thread.currentThread().getName()) + "'. ") + "All WebView methods must be called on the same thread. ") + "(Expected Looper ") + mWebViewThread) + " called on ") + android.os.Looper.myLooper()) + ", FYI main Looper is ") + android.os.Looper.getMainLooper()) + ")");
            android.util.Log.w(android.webkit.WebView.LOGTAG, android.util.Log.getStackTraceString(throwable));
            android.os.StrictMode.onWebViewMethodCalledOnWrongThread(throwable);
            if (android.webkit.WebView.sEnforceThreadChecking) {
    ...
    public android.view.accessibility.AccessibilityNodeProvider getAccessibilityNodeProvider() {
        android.view.accessibility.AccessibilityNodeProvider provider = mProvider.getViewDelegate().getAccessibilityNodeProvider();
     ...
     */
    @java.lang.Override
    protected void onDrawVerticalScrollBar(android.graphics.Canvas canvas, android.graphics.drawable.Drawable scrollBar, int l, int t, int r, int b) {
