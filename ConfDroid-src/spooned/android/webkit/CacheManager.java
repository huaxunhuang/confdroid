 ...
 * @unknown Since {@link android.os.Build.VERSION_CODES#JELLY_BEAN_MR1}
 */
...
public final class CacheManager {
     ...
     */
    @java.lang.Deprecated
    public static android.webkit.CacheManager.CacheResult getCacheFile(java.lang.String url, java.util.Map<java.lang.String, java.lang.String> headers) {
        return null;
    }
     ...
     *
     * @param url
     * 		the URL for which the cache entry should be added
     * @param cacheResult
     * 		the cache entry to add
     * @deprecated Access to the HTTP cache will be removed in a future release.
     */
    @java.lang.Deprecated
    public static void saveCacheFile(java.lang.String url, android.webkit.CacheManager.CacheResult cacheResult) {
        android.webkit.CacheManager.saveCacheFile(url, 0, cacheResult);
    }
