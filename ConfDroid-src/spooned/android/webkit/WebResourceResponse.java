...
public class WebResourceResponse {
     ...
     */
    public WebResourceResponse(java.lang.String mimeType, java.lang.String encoding, java.io.InputStream data) {
        mMimeType = mimeType;
        mEncoding = encoding;
        setData(data);
    }
     ...
     * 		StringBufferInputStream.
     */
    public WebResourceResponse(java.lang.String mimeType, java.lang.String encoding, int statusCode, java.lang.String reasonPhrase, java.util.Map<java.lang.String, java.lang.String> responseHeaders, java.io.InputStream data) {
     ...
     * 		and not empty.
     */
    public void setStatusCodeAndReasonPhrase(int statusCode, java.lang.String reasonPhrase) {
        checkImmutable();
        if (statusCode < 100)
    ...
    public void setData(java.io.InputStream data) {
        ...
        if ((data != null) && java.io.StringBufferInputStream.class.isAssignableFrom(data.getClass())) {
    ...
    public WebResourceResponse(boolean immutable, java.lang.String mimeType, java.lang.String encoding, int statusCode, java.lang.String reasonPhrase, java.util.Map<java.lang.String, java.lang.String> responseHeaders, java.io.InputStream data) {
