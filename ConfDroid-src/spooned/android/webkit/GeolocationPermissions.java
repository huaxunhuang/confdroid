...
public class GeolocationPermissions {
     ...
     * 		Geolocation API.
     */
    public void getAllowed(java.lang.String origin, android.webkit.ValueCallback<java.lang.Boolean> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
     ...
     *
     * @param origin
     * 		the origin for which Geolocation permissions are cleared
     */
     ...
     *
     * @param origin
     * 		the origin for which Geolocation API use is allowed
     */
