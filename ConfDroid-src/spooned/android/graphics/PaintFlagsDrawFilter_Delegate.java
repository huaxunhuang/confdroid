...
public class PaintFlagsDrawFilter_Delegate extends android.graphics.DrawFilter_Delegate {
    // ---- delegate data ----
    ...
    static long nativeConstructor(int clearBits, int setBits) {
        android.graphics.PaintFlagsDrawFilter_Delegate newDelegate = new android.graphics.PaintFlagsDrawFilter_Delegate();
        return android.graphics.DrawFilter_Delegate.sManager.addNewDelegate(newDelegate);
    }
}
