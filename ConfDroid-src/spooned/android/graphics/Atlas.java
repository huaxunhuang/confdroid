...
public class Atlas {
     ...
     */
    public static final int FLAG_DEFAULTS = android.graphics.Atlas.FLAG_ADD_PADDING;
     ...
     *
     * @param type
     * 		The algorithm to use to pack rectangles in the atlas
     * @param width
     ...
     */
    public Atlas(android.graphics.Atlas.Type type, int width, int height) {
        this(type, width, height, android.graphics.Atlas.FLAG_DEFAULTS);
    }
     ...
     */
    public Atlas(android.graphics.Atlas.Type type, int width, int height, int flags) {
        mPolicy = android.graphics.Atlas.findPolicy(type, width, height, flags);
    }
     ...
     * @param height
     * 		The height of the rectangle to pack in the atlas
     ...
     */
    public android.graphics.Atlas.Entry pack(int width, int height) {
     ...
     * @see #pack(int, int)
     */
    public android.graphics.Atlas.Entry pack(int width, int height, android.graphics.Atlas.Entry entry) {
        if (entry == null)
            entry = new android.graphics.Atlas.Entry();
    ...
    private static android.graphics.Atlas.Policy findPolicy(android.graphics.Atlas.Type type, int width, int height, int flags) {
        switch (type) {
            case SliceMinArea :
                return new android.graphics.Atlas.SlicePolicy(width, height, flags, new android.graphics.Atlas.SlicePolicy.MinAreaSplitDecision());
            case SliceMaxArea :
                return new android.graphics.Atlas.SlicePolicy(width, height, flags, new android.graphics.Atlas.SlicePolicy.MaxAreaSplitDecision());
            case SliceShortAxis :
                return new android.graphics.Atlas.SlicePolicy(width, height, flags, new android.graphics.Atlas.SlicePolicy.ShorterFreeAxisSplitDecision());
            case SliceLongAxis :
                return new android.graphics.Atlas.SlicePolicy(width, height, flags, new android.graphics.Atlas.SlicePolicy.LongerFreeAxisSplitDecision());
        }
        return null;
    }
    ...
    private static abstract class Policy {
        abstract android.graphics.Atlas.Entry pack(int width, int height, android.graphics.Atlas.Entry entry);
    }
     ...
     * the next bitmap.
     */
    private static class SlicePolicy extends android.graphics.Atlas.Policy {
        private final android.graphics.Atlas.SlicePolicy.Cell mRoot = new android.graphics.Atlas.SlicePolicy.Cell();
        ...
        private static class Cell {
            ...
            public java.lang.String toString() {
                return java.lang.String.format("cell[x=%d y=%d width=%d height=%d", x, y, width, height);
            }
        }

        SlicePolicy(int width, int height, int flags, android.graphics.Atlas.SlicePolicy.SplitDecision splitDecision) {
            mPadding = ((flags & android.graphics.Atlas.FLAG_ADD_PADDING) != 0) ? 1 : 0;
            // The entire atlas is empty at first, minus padding
            android.graphics.Atlas.SlicePolicy.Cell first = new android.graphics.Atlas.SlicePolicy.Cell();
        ...
        @java.lang.Override
        android.graphics.Atlas.Entry pack(int width, int height, android.graphics.Atlas.Entry entry) {
            android.graphics.Atlas.SlicePolicy.Cell cell = mRoot.next;
            android.graphics.Atlas.SlicePolicy.Cell prev = mRoot;
            while (cell != null) {
        ...
        private static interface SplitDecision {
             ...
             * @param freeHeight
             * 		The rectHeight of the free space after packing a rectangle
             * @param rectWidth
             * 		The rectWidth of the rectangle that was packed in a cell
             * @param rectHeight
             * 		The rectHeight of the rectangle that was packed in a cell
             */
            boolean splitHorizontal(int freeWidth, int freeHeight, int rectWidth, int rectHeight);
        }

        // Splits the free area horizontally to minimize the horizontal section area
        private static class MinAreaSplitDecision implements android.graphics.Atlas.SlicePolicy.SplitDecision {
            @java.lang.Override
        ...
        private static class MaxAreaSplitDecision implements android.graphics.Atlas.SlicePolicy.SplitDecision {
            @java.lang.Override
            public boolean splitHorizontal(int freeWidth, int freeHeight, int rectWidth, int rectHeight) {
                return (rectWidth * freeHeight) <= (freeWidth * rectHeight);
            }
        ...
        private static class ShorterFreeAxisSplitDecision implements android.graphics.Atlas.SlicePolicy.SplitDecision {
            @java.lang.Override
            public boolean splitHorizontal(int freeWidth, int freeHeight, int rectWidth, int rectHeight) {
        ...
        private static class LongerFreeAxisSplitDecision implements android.graphics.Atlas.SlicePolicy.SplitDecision {
            @java.lang.Override
            public boolean splitHorizontal(int freeWidth, int freeHeight, int rectWidth, int rectHeight) {
                return freeWidth > freeHeight;
            }
         ...
         *
         * @param cell
         * 		The cell representing free space in which to pack the rectangle
         * @param prev
         ...
         */
        private boolean insert(android.graphics.Atlas.SlicePolicy.Cell cell, android.graphics.Atlas.SlicePolicy.Cell prev, int width, int height, android.graphics.Atlas.Entry entry) {
            ...
            android.graphics.Atlas.SlicePolicy.Cell first = new android.graphics.Atlas.SlicePolicy.Cell();
            android.graphics.Atlas.SlicePolicy.Cell second = new android.graphics.Atlas.SlicePolicy.Cell();
            ...
            if (mSplitDecision.splitHorizontal(deltaWidth, deltaHeight, width, height)) {
                ...
                android.graphics.Atlas.SlicePolicy.Cell temp = first;
                first = second;
                second = temp;
            }
