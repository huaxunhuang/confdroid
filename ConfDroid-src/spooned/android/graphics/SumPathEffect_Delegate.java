...
public class SumPathEffect_Delegate extends android.graphics.PathEffect_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(long first, long second) {
        android.graphics.SumPathEffect_Delegate newDelegate = new android.graphics.SumPathEffect_Delegate();
