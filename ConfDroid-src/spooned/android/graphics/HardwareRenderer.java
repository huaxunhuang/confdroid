...
public class HardwareRenderer {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.graphics.HardwareRenderer.SYNC_OK, android.graphics.HardwareRenderer.SYNC_REDRAW_REQUESTED, android.graphics.HardwareRenderer.SYNC_LOST_SURFACE_REWARD_IF_FOUND, android.graphics.HardwareRenderer.SYNC_CONTEXT_IS_STOPPED, android.graphics.HardwareRenderer.SYNC_FRAME_DROPPED })
     ...
     * @unknown 
     */
    public static final int FLAG_DUMP_ALL = android.graphics.HardwareRenderer.FLAG_DUMP_FRAMESTATS;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, prefix = { "FLAG_DUMP_" }, value = { android.graphics.HardwareRenderer.FLAG_DUMP_FRAMESTATS, android.graphics.HardwareRenderer.FLAG_DUMP_RESET })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    public HardwareRenderer() {
        mRootNode = android.graphics.RenderNode.adopt(android.graphics.HardwareRenderer.nCreateRootRenderNode());
        mRootNode.setClipToBounds(false);
        mNativeProxy = android.graphics.HardwareRenderer.nCreateProxy(!mOpaque, mRootNode.mNativeRenderNode);
        if (mNativeProxy == 0) {
            throw new java.lang.OutOfMemoryError("Unable to create hardware renderer");
        }
        sun.misc.Cleaner.create(this, new android.graphics.HardwareRenderer.DestroyContextRunnable(mNativeProxy));
        android.graphics.HardwareRenderer.ProcessInitializer.sInstance.init(mNativeProxy);
    }
     ...
     */
    public void destroy() {
        android.graphics.HardwareRenderer.nDestroy(mNativeProxy, mRootNode.mNativeRenderNode);
    }
     ...
     */
    public void setName(@android.annotation.NonNull
    java.lang.String name) {
        android.graphics.HardwareRenderer.nSetName(mNativeProxy, name);
    }
     ...
     * @param lightRadius
     * 		The radius of the light source. Smaller radius will have sharper edges,
     * 		larger radius will have softer shadows.
     */
    public void setLightSourceGeometry(float lightX, float lightY, float lightZ, float lightRadius) {
        android.graphics.HardwareRenderer.validateFinite(lightX, "lightX");
        android.graphics.HardwareRenderer.validateFinite(lightY, "lightY");
        android.graphics.HardwareRenderer.validatePositive(lightZ, "lightZ");
        android.graphics.HardwareRenderer.validatePositive(lightRadius, "lightRadius");
        android.graphics.HardwareRenderer.nSetLightGeometry(mNativeProxy, lightX, lightY, lightZ, lightRadius);
    }
     ...
     *
     * @param ambientShadowAlpha
     * 		The alpha for the ambient shadow. If unsure, a reasonable default
     * 		is 0.039f.
     * @param spotShadowAlpha
     * 		The alpha for the spot shadow. If unsure, a reasonable default is
     * 		0.19f.
     */
    public void setLightSourceAlpha(@android.annotation.FloatRange(from = 0.0F, to = 1.0F)
    float ambientShadowAlpha, @android.annotation.FloatRange(from = 0.0F, to = 1.0F)
    float spotShadowAlpha) {
        android.graphics.HardwareRenderer.validateAlpha(ambientShadowAlpha, "ambientShadowAlpha");
        android.graphics.HardwareRenderer.validateAlpha(spotShadowAlpha, "spotShadowAlpha");
        android.graphics.HardwareRenderer.nSetLightAlpha(mNativeProxy, ambientShadowAlpha, spotShadowAlpha);
    }
     ...
     *
     * @param content
     * 		The content to set as the root RenderNode. If null the content root is removed
     * 		and the renderer will draw nothing.
     */
    public void setContentRoot(@android.annotation.Nullable
    android.graphics.RenderNode content) {
        android.graphics.RecordingCanvas canvas = mRootNode.beginRecording();
        if (content != null) {
     ...
     */
    public void setSurface(@android.annotation.Nullable
    android.view.Surface surface) {
        if ((surface != null) && (!surface.isValid())) {
            throw new java.lang.IllegalArgumentException("Surface is invalid. surface.isValid() == false.");
        }
        android.graphics.HardwareRenderer.nSetSurface(mNativeProxy, surface);
    }
    ...
    public final class FrameRenderRequest {
        private android.graphics.FrameInfo mFrameInfo = new android.graphics.FrameInfo();
        ...
        private void reset() {
            ...
            mRenderRequest.setVsyncTime(android.view.animation.AnimationUtils.currentAnimationTimeMillis() * android.util.TimeUtils.NANOS_PER_MS);
        }
         ...
         * @unknown 
         */
        public void setFrameInfo(android.graphics.FrameInfo info) {
            java.lang.System.arraycopy(info.frameInfo, 0, mFrameInfo.frameInfo, 0, info.frameInfo.length);
        }
         ...
         *
         * @param vsyncTime
         * 		The vsync timestamp for this frame. The timestamp is in nanoseconds
        ...
        public android.graphics.HardwareRenderer.FrameRenderRequest setVsyncTime(long vsyncTime) {
            ...
            mFrameInfo.addFlags(android.graphics.FrameInfo.FLAG_SURFACE_CANVAS);
            return this;
        }
         ...
         *
         * @param executor
         * 		The executor to run the callback on. It is strongly recommended that
         * 		this executor post to a different thread, as the calling thread is
         * 		highly sensitive to being blocked.
         * @param frameCommitCallback
         * 		The callback to invoke when the frame content has been drawn.
         * 		Will be invoked on the given {@link Executor}.
         * @return this instance
         */
        @android.annotation.NonNull
        public android.graphics.HardwareRenderer.FrameRenderRequest setFrameCommitCallback(@android.annotation.NonNull
        java.util.concurrent.Executor executor, @android.annotation.NonNull
        java.lang.Runnable frameCommitCallback) {
         ...
         *
         * @param shouldWait
         * 		If true the next call to {@link #syncAndDraw()} will block until
         * 		completion.
         * @return this instance
         */
        @android.annotation.NonNull
        public android.graphics.HardwareRenderer.FrameRenderRequest setWaitForPresent(boolean shouldWait) {
        ...
        public int syncAndDraw() {
            ...
            if (mWaitForPresent && ((syncResult & android.graphics.HardwareRenderer.SYNC_FRAME_DROPPED) == 0)) {
                fence();
            }
            return syncResult;
        }
     ...
     */
    @android.graphics.HardwareRenderer.SyncAndDrawResult
    public int syncAndDrawFrame(@android.annotation.NonNull
    android.graphics.FrameInfo frameInfo) {
        return android.graphics.HardwareRenderer.nSyncAndDrawFrame(mNativeProxy, frameInfo.frameInfo, frameInfo.frameInfo.length);
    }
    ...
    public boolean pause() {
        return android.graphics.HardwareRenderer.nPause(mNativeProxy);
    }
     ...
     *
     * @param stopped
     * 		true to stop all rendering, false to resume
     * @unknown 
     */
    public void setStopped(boolean stopped) {
        android.graphics.HardwareRenderer.nSetStopped(mNativeProxy, stopped);
    }
     ...
     */
    public void stop() {
        android.graphics.HardwareRenderer.nSetStopped(mNativeProxy, true);
    }
     ...
     */
    public void start() {
        android.graphics.HardwareRenderer.nSetStopped(mNativeProxy, false);
    }
    ...
    public void clearContent() {
        android.graphics.HardwareRenderer.nDestroyHardwareResources(mNativeProxy);
    }
    ...
    public boolean setForceDark(boolean enable) {
        if (mForceDark != enable) {
            mForceDark = enable;
            android.graphics.HardwareRenderer.nSetForceDark(mNativeProxy, enable);
            return true;
        }
        return false;
    }
    ...
    public void allocateBuffers() {
        android.graphics.HardwareRenderer.nAllocateBuffers(mNativeProxy);
    }
    ...
    public void notifyFramePending() {
        android.graphics.HardwareRenderer.nNotifyFramePending(mNativeProxy);
    }
     ...
     *
     * @param opaque
     * 		true if the content rendered is opaque, false if the renderer should clear
     * 		to transparent before rendering
     */
    public void setOpaque(boolean opaque) {
        if (mOpaque != opaque) {
            mOpaque = opaque;
            android.graphics.HardwareRenderer.nSetOpaque(mNativeProxy, mOpaque);
        }
    }
     ...
     * @unknown 
     */
    public void setFrameCompleteCallback(android.graphics.HardwareRenderer.FrameCompleteCallback callback) {
        android.graphics.HardwareRenderer.nSetFrameCompleteCallback(mNativeProxy, callback);
    }
     ...
     * @unknown 
     */
    public void addFrameMetricsObserver(android.view.FrameMetricsObserver observer) {
        long nativeObserver = android.graphics.HardwareRenderer.nAddFrameMetricsObserver(mNativeProxy, observer);
        observer.mNative = new com.android.internal.util.VirtualRefBasePtr(nativeObserver);
    }
     ...
     * @unknown 
     */
    public void removeFrameMetricsObserver(android.view.FrameMetricsObserver observer) {
        android.graphics.HardwareRenderer.nRemoveFrameMetricsObserver(mNativeProxy, observer.mNative.get());
     ...
     *
     * @param wideGamut
     * 		true if this renderer should render in wide gamut, false if it should
     * 		render in sRGB
    ...
    public void setWideGamut(boolean wideGamut) {
        ...
        android.graphics.HardwareRenderer.nSetWideGamut(mNativeProxy, wideGamut);
    }
     ...
     */
    public void fence() {
        android.graphics.HardwareRenderer.nFence(mNativeProxy);
    }
    ...
    public void registerAnimatingRenderNode(android.graphics.RenderNode animator) {
        android.graphics.HardwareRenderer.nRegisterAnimatingRenderNode(mRootNode.mNativeRenderNode, animator.mNativeRenderNode);
    }
    ...
    public void registerVectorDrawableAnimator(android.view.NativeVectorDrawableAnimator animator) {
        android.graphics.HardwareRenderer.nRegisterVectorDrawableAnimator(mRootNode.mNativeRenderNode, animator.getAnimatorNativePtr());
    }
    ...
    public void stopDrawing() {
        android.graphics.HardwareRenderer.nStopDrawing(mNativeProxy);
    }
    ...
    public android.view.TextureLayer createTextureLayer() {
        long layer = android.graphics.HardwareRenderer.nCreateTextureLayer(mNativeProxy);
        return android.view.TextureLayer.adoptTextureLayer(this, layer);
    }
    ...
    public void detachSurfaceTexture(long hardwareLayer) {
        android.graphics.HardwareRenderer.nDetachSurfaceTexture(mNativeProxy, hardwareLayer);
    }
    ...
    public void buildLayer(android.graphics.RenderNode node) {
        if (node.hasDisplayList()) {
            android.graphics.HardwareRenderer.nBuildLayer(mNativeProxy, node.mNativeRenderNode);
        }
    }
     ...
     * @unknown 
     */
    public boolean copyLayerInto(final android.view.TextureLayer layer, final android.graphics.Bitmap bitmap) {
        return android.graphics.HardwareRenderer.nCopyLayerInto(mNativeProxy, layer.getDeferredLayerUpdater(), bitmap.getNativeInstance());
    }
     ...
     *
     * @param layer
     * 		The hardware layer that needs an update
     * @unknown 
     */
    public void pushLayerUpdate(android.view.TextureLayer layer) {
        android.graphics.HardwareRenderer.nPushLayerUpdate(mNativeProxy, layer.getDeferredLayerUpdater());
    }
     ...
     * @unknown 
     */
    public void onLayerDestroyed(android.view.TextureLayer layer) {
        android.graphics.HardwareRenderer.nCancelLayerUpdate(mNativeProxy, layer.getDeferredLayerUpdater());
    }
     ...
     * @unknown 
     */
    public void setFrameCallback(android.graphics.HardwareRenderer.FrameDrawingCallback callback) {
        android.graphics.HardwareRenderer.nSetFrameCallback(mNativeProxy, callback);
    }
    ...
    public void addRenderNode(android.graphics.RenderNode node, boolean placeFront) {
        android.graphics.HardwareRenderer.nAddRenderNode(mNativeProxy, node.mNativeRenderNode, placeFront);
    }
     ...
     *
     * @param node
     * 		The node which was added via addRenderNode which should get removed again.
     * @unknown 
     */
    public void removeRenderNode(android.graphics.RenderNode node) {
        android.graphics.HardwareRenderer.nRemoveRenderNode(mNativeProxy, node.mNativeRenderNode);
    }
    ...
    public void drawRenderNode(android.graphics.RenderNode node) {
        android.graphics.HardwareRenderer.nDrawRenderNode(mNativeProxy, node.mNativeRenderNode);
    }
    ...
    public boolean loadSystemProperties() {
        return android.graphics.HardwareRenderer.nLoadSystemProperties(mNativeProxy);
    }
     ...
     * @unknown 
     */
    public void dumpProfileInfo(java.io.FileDescriptor fd, @android.graphics.HardwareRenderer.DumpFlags
    int dumpFlags) {
        android.graphics.HardwareRenderer.nDumpProfileInfo(mNativeProxy, fd, dumpFlags);
    }
     ...
     *
     * @param left
     * 		The left side of the protected bounds.
     * @param top
     * 		The top side of the protected bounds.
     * @param right
     * 		The right side of the protected bounds.
     * @param bottom
     * 		The bottom side of the protected bounds.
     * @unknown 
     */
    public void setContentDrawBounds(int left, int top, int right, int bottom) {
        android.graphics.HardwareRenderer.nSetContentDrawBounds(mNativeProxy, left, top, right, bottom);
    }
     ...
     * @unknown 
     */
    public void setPictureCaptureCallback(@android.annotation.Nullable
    android.graphics.HardwareRenderer.PictureCapturedCallback callback) {
        android.graphics.HardwareRenderer.nSetPictureCaptureCallback(mNativeProxy, callback);
    }
     ...
     * called by native
     */
    static void invokePictureCapturedCallback(long picturePtr, android.graphics.HardwareRenderer.PictureCapturedCallback callback) {
    ...
    public interface FrameDrawingCallback {
         ...
         *
         * @param frame
         * 		The id of the frame being drawn.
         */
    ...
    public interface FrameCompleteCallback {
         ...
         *
         * @param frameNr
         * 		The id of the frame that was drawn.
         */
    ...
    private static void validateAlpha(float alpha, java.lang.String argumentName) {
        if (!((alpha >= 0.0F) && (alpha <= 1.0F))) {
            throw new java.lang.IllegalArgumentException(((argumentName + " must be a valid alpha, ") + alpha) + " is not in the range of 0.0f to 1.0f");
        }
    }

    private static void validatePositive(float f, java.lang.String argumentName) {
        if (!(java.lang.Float.isFinite(f) && (f >= 0.0F))) {
            throw new java.lang.IllegalArgumentException((argumentName + " must be a finite positive, given=") + f);
        }
    }

    private static void validateFinite(float f, java.lang.String argumentName) {
        if (!java.lang.Float.isFinite(f)) {
            throw new java.lang.IllegalArgumentException((argumentName + " must be finite, given=") + f);
        }
    }
    ...
    public static void invokeFunctor(long functor, boolean waitForCompletion) {
        android.graphics.HardwareRenderer.nInvokeFunctor(functor, waitForCompletion);
    }
    ...
    public static void setFPSDivisor(int divisor) {
        android.graphics.HardwareRenderer.nHackySetRTAnimationsEnabled(divisor <= 1);
    }
     ...
     *
     * @param priority
     * 		The priority to use. Must be one of EGL_CONTEXT_PRIORITY_* values.
     * @unknown 
     */
    public static void setContextPriority(int priority) {
        android.graphics.HardwareRenderer.nSetContextPriority(priority);
    }
    ...
    public static void setHighContrastText(boolean highContrastText) {
        android.graphics.HardwareRenderer.nSetHighContrastText(highContrastText);
    }
    ...
    public static void setIsolatedProcess(boolean isIsolated) {
        android.graphics.HardwareRenderer.nSetIsolatedProcess(isIsolated);
    }
    ...
    public static void setDebuggingEnabled(boolean enable) {
        android.graphics.HardwareRenderer.nSetDebuggingEnabled(enable);
    }
     ...
     * @unknown 
     */
    public static int copySurfaceInto(android.view.Surface surface, android.graphics.Rect srcRect, android.graphics.Bitmap bitmap) {
        if (srcRect == null) {
            // Empty rect means entire surface
            return android.graphics.HardwareRenderer.nCopySurfaceInto(surface, 0, 0, 0, 0, bitmap.getNativeInstance());
        } else {
            return android.graphics.HardwareRenderer.nCopySurfaceInto(surface, srcRect.left, srcRect.top, srcRect.right, srcRect.bottom, bitmap.getNativeInstance());
        }
    }
     ...
     * @unknown 
     */
    public static android.graphics.Bitmap createHardwareBitmap(android.graphics.RenderNode node, int width, int height) {
        return android.graphics.HardwareRenderer.nCreateHardwareBitmap(node.mNativeRenderNode, width, height);
    }
    ...
    public static void trimMemory(int level) {
        android.graphics.HardwareRenderer.nTrimMemory(level);
    }
     ...
     * @unknown 
     */
    public static void overrideProperty(@android.annotation.NonNull
    ...
    java.lang.String value) {
        ...
        android.graphics.HardwareRenderer.nOverrideProperty(name, value);
    }
    ...
    public static void setupDiskCache(java.io.File cacheDir) {
        android.graphics.HardwareRenderer.setupShadersDiskCache(new java.io.File(cacheDir, android.graphics.HardwareRenderer.CACHE_PATH_SHADERS).getAbsolutePath(), new java.io.File(cacheDir, android.graphics.HardwareRenderer.CACHE_PATH_SKIASHADERS).getAbsolutePath());
    }
    ...
    public static void setPackageName(java.lang.String packageName) {
        android.graphics.HardwareRenderer.ProcessInitializer.sInstance.setPackageName(packageName);
    }
    ...
    private static final class DestroyContextRunnable implements java.lang.Runnable {
        ...
        @java.lang.Override
        public void run() {
            android.graphics.HardwareRenderer.nDeleteProxy(mNativeInstance);
        }
    }
    ...
    private static class ProcessInitializer {
        ...
        private android.view.IGraphicsStatsCallback mGraphicsStatsCallback = new android.view.IGraphicsStatsCallback.Stub() {
            @java.lang.Override
        ...
        synchronized void setPackageName(java.lang.String name) {
            if (mInitialized)
                return;
        ...
        private void initSched(long renderProxy) {
            try {
                int tid = android.graphics.HardwareRenderer.nGetRenderThreadTid(renderProxy);
                android.app.ActivityManager.getService().setRenderThread(tid);
            } catch (java.lang.Throwable t) {
                android.util.Log.w(android.graphics.HardwareRenderer.LOG_TAG, "Failed to set scheduler for RenderThread", t);
            }
        }
        ...
        private void initGraphicsStats() {
            ...
            try {
                android.os.IBinder binder = android.os.ServiceManager.getService("graphicsstats");
                if (binder == null)
                    return;
                ...
                android.util.Log.w(android.graphics.HardwareRenderer.LOG_TAG, "Could not acquire gfx stats buffer", t);
            }
        }
        ...
        private void requestBuffer() {
            try {
                android.os.ParcelFileDescriptor pfd = mGraphicsStatsService.requestBufferForProcess(mPackageName, mGraphicsStatsCallback);
                android.graphics.HardwareRenderer.nSetProcessStatsBuffer(pfd.getFd());
                pfd.close();
            } catch (java.lang.Throwable t) {
                android.util.Log.w(android.graphics.HardwareRenderer.LOG_TAG, "Could not acquire gfx stats buffer", t);
            }
     ...
     * @unknown 
     */
    protected static native void setupShadersDiskCache(java.lang.String cacheFile, java.lang.String skiaCacheFile);
    ...
    private static native void nSetName(long nativeProxy, java.lang.String name);

    private static native void nSetSurface(long nativeProxy, android.view.Surface window);
    ...
    private static native void nSetLightGeometry(long nativeProxy, float lightX, float lightY, float lightZ, float lightRadius);

    private static native void nSetLightAlpha(long nativeProxy, float ambientShadowAlpha, float spotShadowAlpha);
    ...
    private static native void nOverrideProperty(java.lang.String name, java.lang.String value);
    ...
    private static native void nDumpProfileInfo(long nativeProxy, java.io.FileDescriptor fd, @android.graphics.HardwareRenderer.DumpFlags
    int dumpFlags);

    private static native void nAddRenderNode(long nativeProxy, long rootRenderNode, boolean placeFront);

    private static native void nRemoveRenderNode(long nativeProxy, long rootRenderNode);

    private static native void nDrawRenderNode(long nativeProxy, long rootRenderNode);

    private static native void nSetContentDrawBounds(long nativeProxy, int left, int top, int right, int bottom);

    private static native void nSetPictureCaptureCallback(long nativeProxy, android.graphics.HardwareRenderer.PictureCapturedCallback callback);

    private static native void nSetFrameCallback(long nativeProxy, android.graphics.HardwareRenderer.FrameDrawingCallback callback);

    private static native void nSetFrameCompleteCallback(long nativeProxy, android.graphics.HardwareRenderer.FrameCompleteCallback callback);

    private static native long nAddFrameMetricsObserver(long nativeProxy, android.view.FrameMetricsObserver observer);

    private static native void nRemoveFrameMetricsObserver(long nativeProxy, long nativeObserver);

    private static native int nCopySurfaceInto(android.view.Surface surface, int srcLeft, int srcTop, int srcRight, int srcBottom, long bitmapHandle);

    private static native android.graphics.Bitmap nCreateHardwareBitmap(long renderNode, int width, int height);
