 ...
 *     0, 0, 0, 1, 0 ]</pre>
 */
@java.lang.SuppressWarnings({ "MismatchedReadAndWriteOfArray", "PointlessArithmeticExpression" })
public class ColorMatrix {
    ...
    public ColorMatrix(float[] src) {
        java.lang.System.arraycopy(src, 0, mArray, 0, 20);
    }
    ...
    public ColorMatrix(android.graphics.ColorMatrix src) {
        java.lang.System.arraycopy(src.mArray, 0, mArray, 0, 20);
    }
    ...
    public void setRotate(int axis, float degrees) {
        reset();
        double radians = (degrees * java.lang.Math.PI) / 180.0;
        float cosine = ((float) (java.lang.Math.cos(radians)));
        float sine = ((float) (java.lang.Math.sin(radians)));
        switch (axis) {
    ...
    public void setConcat(android.graphics.ColorMatrix matA, android.graphics.ColorMatrix matB) {
        ...
        if (tmp != mArray) {
            java.lang.System.arraycopy(tmp, 0, mArray, 0, 20);
        }
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        if (!(obj instanceof android.graphics.ColorMatrix)) {
            return false;
        }
        // we don't use Arrays.equals(), since that considers NaN == NaN
        final float[] other = ((android.graphics.ColorMatrix) (obj)).mArray;
        for (int i = 0; i < 20; i++) {
            if (other[i] != mArray[i]) {
                return false;
            }
