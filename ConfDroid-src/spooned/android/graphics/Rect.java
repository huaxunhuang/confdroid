...
public final class Rect implements android.os.Parcelable {
    ...
    private static final class UnflattenHelper {
        ...
        static java.util.regex.Matcher getMatcher(java.lang.String str) {
            return android.graphics.Rect.UnflattenHelper.FLATTENED_PATTERN.matcher(str);
        }
    }
     ...
     * 		rectangle.
     */
    public Rect(@android.annotation.Nullable
    ...
    public static android.graphics.Rect copyOrNull(@android.annotation.Nullable
    android.graphics.Rect r) {
        return r == null ? null : new android.graphics.Rect(r);
    }
     ...
     */
    @android.annotation.NonNull
    public java.lang.String toShortString(@android.annotation.NonNull
     ...
     */
    @android.annotation.Nullable
    public static android.graphics.Rect unflattenFromString(@android.annotation.Nullable
     ...
     *
     * @param proto
     * 		Stream to read the Rect object from.
     * @param fieldId
     * 		Field Id of the Rect as defined in the parent message
     * @unknown 
     */
    public void readFromProto(@android.annotation.NonNull
    android.util.proto.ProtoInputStream proto, long fieldId) throws android.util.proto.WireTypeMismatchException, java.io.IOException {
        final long token = proto.start(fieldId);
        try {
            while (proto.nextField() != android.util.proto.ProtoInputStream.NO_MORE_FIELDS) {
     ...
     */
    public void inset(@android.annotation.NonNull
    ...
    rectangle
     */
    public boolean contains(@android.annotation.NonNull
    android.graphics.Rect r) {
        // check for empty first
        return (((((this.left < this.right) && (this.top < this.bottom)) && // now check for containment
     ...
     */
    @android.annotation.CheckResult
    public boolean intersect(@android.annotation.NonNull
    android.graphics.Rect r) {
     ...
     * @unknown 
     */
    public void intersectUnchecked(@android.annotation.NonNull
    android.graphics.Rect other) {
        left = java.lang.Math.max(left, other.left);
        top = java.lang.Math.max(top, other.top);
        right = java.lang.Math.min(right, other.right);
        bottom = java.lang.Math.min(bottom, other.bottom);
    }
     ...
     */
    @android.annotation.CheckResult
    public boolean setIntersect(@android.annotation.NonNull
    android.graphics.Rect a, @android.annotation.NonNull
    android.graphics.Rect b) {
        if ((((a.left < b.right) && (b.left < a.right)) && (a.top < b.bottom)) && (b.top < a.bottom)) {
            left = java.lang.Math.max(a.left, b.left);
            top = java.lang.Math.max(a.top, b.top);
            right = java.lang.Math.min(a.right, b.right);
            bottom = java.lang.Math.min(a.bottom, b.bottom);
            return true;
        }
        return false;
    }
     ...
     */
    public static boolean intersects(@android.annotation.NonNull
    android.graphics.Rect a, @android.annotation.NonNull
    android.graphics.Rect b) {
     ...
     */
    public void union(@android.annotation.NonNull
    android.graphics.Rect r) {
    ...
    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.graphics.Rect> CREATOR = new android.os.Parcelable.Creator<android.graphics.Rect>() {
        /**
