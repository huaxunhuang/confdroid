...
public class PathDashPathEffect_Delegate extends android.graphics.PathEffect_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(long native_path, float advance, float phase, int native_style) {
        android.graphics.PathDashPathEffect_Delegate newDelegate = new android.graphics.PathDashPathEffect_Delegate();
