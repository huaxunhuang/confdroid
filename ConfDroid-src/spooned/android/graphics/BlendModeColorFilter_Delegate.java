 ...
 */
public class BlendModeColorFilter_Delegate extends android.graphics.ColorFilter_Delegate {
    @java.lang.Override
    ...
    static long native_CreateBlendModeFilter(int srcColor, int blendmode) {
        return android.graphics.PorterDuffColorFilter_Delegate.native_CreateBlendModeFilter(srcColor, blendmode);
    }
}
