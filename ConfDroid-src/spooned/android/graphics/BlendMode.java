...
public enum BlendMode {
     ...
     */
    LUMINOSITY(28);
    private static final android.graphics.BlendMode[] BLEND_MODES = android.graphics.BlendMode.values();
    ...
    public static android.graphics.BlendMode fromValue(int value) {
        for (android.graphics.BlendMode mode : android.graphics.BlendMode.BLEND_MODES) {
     ...
     * @unknown 
     */
    public static int toValue(android.graphics.BlendMode mode) {
     ...
     */
    @android.annotation.Nullable
    public static android.graphics.PorterDuff.Mode blendModeToPorterDuffMode(@android.annotation.Nullable
