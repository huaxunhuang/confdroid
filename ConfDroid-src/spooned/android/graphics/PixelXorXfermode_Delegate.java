...
public class PixelXorXfermode_Delegate extends android.graphics.Xfermode_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(int opColor) {
        android.graphics.PixelXorXfermode_Delegate newDelegate = new android.graphics.PixelXorXfermode_Delegate();
