...
public class SurfaceTexture {
     ...
     * @param texName
     * 		the OpenGL texture object name (e.g. generated via glGenTextures)
     * @param singleBufferMode
     * 		whether the SurfaceTexture will be in single buffered mode.
     * @throws android.view.Surface.OutOfResourcesException
     * 		If the SurfaceTexture cannot be created.
     */
    public SurfaceTexture(int texName, boolean singleBufferMode) {
        mCreatorLooper = android.os.Looper.myLooper();
        mIsSingleBuffered = singleBufferMode;
        nativeInit(false, texName, singleBufferMode, new java.lang.ref.WeakReference<android.graphics.SurfaceTexture>(this));
    }
    ...
    public SurfaceTexture(boolean singleBufferMode) {
        mCreatorLooper = android.os.Looper.myLooper();
        mIsSingleBuffered = singleBufferMode;
        nativeInit(true, 0, singleBufferMode, new java.lang.ref.WeakReference<android.graphics.SurfaceTexture>(this));
    }
     ...
     *
     * @param listener
     * 		The listener to use, or null to remove the listener.
     */
    public void setOnFrameAvailableListener(@android.annotation.Nullable
     ...
     */
    public void setOnFrameAvailableListener(@android.annotation.Nullable
    final android.graphics.SurfaceTexture.OnFrameAvailableListener listener, @android.annotation.Nullable
    android.os.Handler handler) {
        if (listener != null) {
            ...
            android.os.Looper looper = (handler != null) ? handler.getLooper() : mCreatorLooper != null ? mCreatorLooper : android.os.Looper.getMainLooper();
            mOnFrameAvailableHandler = /* async */
            new android.os.Handler(looper, null, true) {
                @java.lang.Override
                public void handleMessage(android.os.Message msg) {
                    listener.onFrameAvailable(android.graphics.SurfaceTexture.this);
                }
            };
        } else {
    ...
    @android.annotation.UnsupportedAppUsage
    private static void postEventFromNative(java.lang.ref.WeakReference<android.graphics.SurfaceTexture> weakSelf) {
        android.graphics.SurfaceTexture st = weakSelf.get();
        if (st != null) {
            android.os.Handler handler = st.mOnFrameAvailableHandler;
            if (handler != null) {
    ...
    private native void nativeInit(boolean isDetached, int texName, boolean singleBufferMode, java.lang.ref.WeakReference<android.graphics.SurfaceTexture> weakSelf) throws android.view.Surface.OutOfResourcesException;
