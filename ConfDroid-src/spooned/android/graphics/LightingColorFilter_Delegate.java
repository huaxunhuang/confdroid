...
public class LightingColorFilter_Delegate extends android.graphics.ColorFilter_Delegate {
    // ---- delegate data ----
    ...
    static long native_CreateLightingFilter(int mul, int add) {
        android.graphics.LightingColorFilter_Delegate newDelegate = new android.graphics.LightingColorFilter_Delegate();
