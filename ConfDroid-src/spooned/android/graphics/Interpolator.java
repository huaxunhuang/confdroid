...
public class Interpolator {
    public Interpolator(int valueCount) {
        ...
        mFrameCount = 2;
        native_instance = android.graphics.Interpolator.nativeConstructor(valueCount, 2);
    }

    public Interpolator(int valueCount, int frameCount) {
        mValueCount = valueCount;
        mFrameCount = frameCount;
        native_instance = android.graphics.Interpolator.nativeConstructor(valueCount, frameCount);
    }
    ...
    public void reset(int valueCount, int frameCount) {
        mValueCount = valueCount;
        mFrameCount = frameCount;
        android.graphics.Interpolator.nativeReset(native_instance, valueCount, frameCount);
    }
    ...
    public void setKeyFrame(int index, int msec, float[] values, float[] blend) {
        ...
        android.graphics.Interpolator.nativeSetKeyFrame(native_instance, index, msec, values, blend);
    }
    ...
    public void setRepeatMirror(float repeatCount, boolean mirror) {
        if (repeatCount >= 0) {
            android.graphics.Interpolator.nativeSetRepeatMirror(native_instance, repeatCount, mirror);
        }
    }
     ...
     */
    public android.graphics.Interpolator.Result timeToValues(int msec, float[] values) {
        if ((values != null) && (values.length < mValueCount)) {
            throw new java.lang.ArrayStoreException();
        }
        switch (android.graphics.Interpolator.nativeTimeToValues(native_instance, msec, values)) {
            case 0 :
    ...
    protected void finalize() throws java.lang.Throwable {
        android.graphics.Interpolator.nativeDestructor(native_instance);
