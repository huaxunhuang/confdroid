...
public class Shader {
     ...
     * @unknown 
     */
    public Shader(android.graphics.ColorSpace colorSpace) {
     ...
     * @return true if the shader has a non-identity local matrix
     */
    public boolean getLocalMatrix(@android.annotation.NonNull
     ...
     */
    public void setLocalMatrix(@android.annotation.Nullable
    android.graphics.Matrix localM) {
        if ((localM == null) || localM.isIdentity()) {
            ...
            if (mLocalMatrix == null) {
                mLocalMatrix = new android.graphics.Matrix(localM);
                discardNativeInstance();
            } else
                if (!mLocalMatrix.equals(localM)) {
    ...
    public final long getNativeInstance() {
        ...
        if (mNativeInstance == 0) {
            ...
            if (mNativeInstance != 0) {
                mCleaner = android.graphics.Shader.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativeInstance);
            }
        }
    ...
    public static long[] convertColors(@android.annotation.NonNull
     ...
     * 		if the colors do not all share the same,
     * 		valid ColorSpace, or if there are less than 2 colors.
     * @unknown 
     */
    public static android.graphics.ColorSpace detectColorSpace(@android.annotation.NonNull
    @android.annotation.ColorLong
    long[] colors) {
        if (colors.length < 2) {
            throw new java.lang.IllegalArgumentException("needs >= 2 number of colors");
        }
        final android.graphics.ColorSpace colorSpace = android.graphics.Color.colorSpace(colors[0]);
        for (int i = 1; i < colors.length; ++i) {
            if (android.graphics.Color.colorSpace(colors[i]) != colorSpace) {
