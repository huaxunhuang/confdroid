...
public final class RenderNode {
     ...
     */
    public RenderNode(@android.annotation.Nullable
    java.lang.String name) {
        this(name, null);
    }

    private RenderNode(java.lang.String name, android.graphics.RenderNode.AnimationHost animationHost) {
        mNativeRenderNode = android.graphics.RenderNode.nCreate(name);
        android.graphics.RenderNode.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativeRenderNode);
     ...
     * @unknown 
     */
    public static android.graphics.RenderNode create(java.lang.String name, @android.annotation.Nullable
    android.graphics.RenderNode.AnimationHost animationHost) {
        return new android.graphics.RenderNode(name, animationHost);
    }
     ...
     * @unknown 
     */
    public static android.graphics.RenderNode adopt(long nativePtr) {
        return new android.graphics.RenderNode(nativePtr);
    }
    ...
    private static final class CompositePositionUpdateListener implements android.graphics.RenderNode.PositionUpdateListener {
        ...
        CompositePositionUpdateListener(android.graphics.RenderNode.PositionUpdateListener... listeners) {
            mListeners = (listeners != null) ? listeners : android.graphics.RenderNode.CompositePositionUpdateListener.sEmpty;
        }

        public android.graphics.RenderNode.CompositePositionUpdateListener with(android.graphics.RenderNode.PositionUpdateListener listener) {
            return new android.graphics.RenderNode.CompositePositionUpdateListener(com.android.internal.util.ArrayUtils.appendElement(android.graphics.RenderNode.PositionUpdateListener.class, mListeners, listener));
        }

        public android.graphics.RenderNode.CompositePositionUpdateListener without(android.graphics.RenderNode.PositionUpdateListener listener) {
            return new android.graphics.RenderNode.CompositePositionUpdateListener(com.android.internal.util.ArrayUtils.removeElement(android.graphics.RenderNode.PositionUpdateListener.class, mListeners, listener));
        }

        @java.lang.Override
        public void positionChanged(long frameNumber, int left, int top, int right, int bottom) {
            for (android.graphics.RenderNode.PositionUpdateListener pul : mListeners) {
     ...
     * @unknown 
     */
    public void addPositionUpdateListener(@android.annotation.NonNull
    android.graphics.RenderNode.PositionUpdateListener listener) {
        android.graphics.RenderNode.CompositePositionUpdateListener comp = mCompositePositionUpdateListener;
        if (comp == null) {
            comp = new android.graphics.RenderNode.CompositePositionUpdateListener(listener);
        } else {
            comp = comp.with(listener);
        }
        mCompositePositionUpdateListener = comp;
        android.graphics.RenderNode.nRequestPositionUpdates(mNativeRenderNode, comp);
    }
     ...
     * @unknown 
     */
    public void removePositionUpdateListener(@android.annotation.NonNull
    android.graphics.RenderNode.PositionUpdateListener listener) {
        android.graphics.RenderNode.CompositePositionUpdateListener comp = mCompositePositionUpdateListener;
        if (comp != null) {
     ...
     * 		If a recording is already in progress. That is, the previous
    ...
    public android.graphics.RecordingCanvas beginRecording(int width, int height) {
        ...
        mCurrentRecordingCanvas = android.graphics.RecordingCanvas.obtain(this, width, height);
    ...
    public android.graphics.RecordingCanvas beginRecording() {
        return beginRecording(android.graphics.RenderNode.nGetWidth(mNativeRenderNode), android.graphics.RenderNode.nGetHeight(mNativeRenderNode));
    }
    ...
    public void endRecording() {
        ...
        android.graphics.RecordingCanvas canvas = mCurrentRecordingCanvas;
        mCurrentRecordingCanvas = null;
        long displayList = canvas.finishRecording();
        android.graphics.RenderNode.nSetDisplayList(mNativeRenderNode, displayList);
        canvas.recycle();
    }
    ...
    public android.graphics.RecordingCanvas start(int width, int height) {
     ...
     */
    @java.lang.Deprecated
    public void end(android.graphics.RecordingCanvas canvas) {
    ...
    public void discardDisplayList() {
        android.graphics.RenderNode.nSetDisplayList(mNativeRenderNode, 0);
    }
    ...
    public boolean hasDisplayList() {
        return android.graphics.RenderNode.nIsValid(mNativeRenderNode);
    }
    ...
    public boolean hasIdentityMatrix() {
        return android.graphics.RenderNode.nHasIdentityMatrix(mNativeRenderNode);
    }
    ...
    android.graphics.Matrix outMatrix) {
        android.graphics.RenderNode.nGetTransformMatrix(mNativeRenderNode, outMatrix.native_instance);
    }
    ...
    android.graphics.Matrix outMatrix) {
        android.graphics.RenderNode.nGetInverseTransformMatrix(mNativeRenderNode, outMatrix.native_instance);
    }
    ...
    public boolean setLayerType(int layerType) {
        return android.graphics.RenderNode.nSetLayerType(mNativeRenderNode, layerType);
    }
    ...
    android.graphics.Paint paint) {
        return android.graphics.RenderNode.nSetLayerPaint(mNativeRenderNode, paint != null ? paint.getNativeInstance() : 0);
    }
     ...
     *
     * @param forceToLayer
     * 		if true this forces the RenderNode to use an intermediate buffer.
     ...
     */
    public boolean setUseCompositingLayer(boolean forceToLayer, @android.annotation.Nullable
    android.graphics.Paint paint) {
        boolean didChange = android.graphics.RenderNode.nSetLayerType(mNativeRenderNode, forceToLayer ? 2 : 0);
        didChange |= android.graphics.RenderNode.nSetLayerPaint(mNativeRenderNode, paint != null ? paint.getNativeInstance() : 0);
        return didChange;
    }
    ...
    public boolean getUseCompositingLayer() {
        return android.graphics.RenderNode.nGetLayerType(mNativeRenderNode) != 0;
    }
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setClipRect(@android.annotation.Nullable
    android.graphics.Rect rect) {
        if (rect == null) {
            return android.graphics.RenderNode.nSetClipBoundsEmpty(mNativeRenderNode);
        } else {
            return android.graphics.RenderNode.nSetClipBounds(mNativeRenderNode, rect.left, rect.top, rect.right, rect.bottom);
        }
    }
     ...
     *
     * @param clipToBounds
     * 		true if the display list should clip to its bounds, false otherwise.
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setClipToBounds(boolean clipToBounds) {
        return android.graphics.RenderNode.nSetClipToBounds(mNativeRenderNode, clipToBounds);
    }
    ...
    public boolean getClipToBounds() {
        return android.graphics.RenderNode.nGetClipToBounds(mNativeRenderNode);
    }
    ...
    public boolean setProjectBackwards(boolean shouldProject) {
        return android.graphics.RenderNode.nSetProjectBackwards(mNativeRenderNode, shouldProject);
    }
    ...
    public boolean setProjectionReceiver(boolean shouldRecieve) {
        return android.graphics.RenderNode.nSetProjectionReceiver(mNativeRenderNode, shouldRecieve);
    }
    ...
    android.graphics.Outline outline) {
        if (outline == null) {
            return android.graphics.RenderNode.nSetOutlineNone(mNativeRenderNode);
        }
        switch (outline.mMode) {
            case android.graphics.Outline.MODE_EMPTY :
                return android.graphics.RenderNode.nSetOutlineEmpty(mNativeRenderNode);
            case android.graphics.Outline.MODE_ROUND_RECT :
                return android.graphics.RenderNode.nSetOutlineRoundRect(mNativeRenderNode, outline.mRect.left, outline.mRect.top, outline.mRect.right, outline.mRect.bottom, outline.mRadius, outline.mAlpha);
            case android.graphics.Outline.MODE_CONVEX_PATH :
                return android.graphics.RenderNode.nSetOutlineConvexPath(mNativeRenderNode, outline.mPath.mNativePath, outline.mAlpha);
        }
    ...
    public boolean hasShadow() {
        return android.graphics.RenderNode.nHasShadow(mNativeRenderNode);
    }
     ...
     *
     * @param color
     * 		The color this RenderNode will cast for its elevation spot shadow.
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setSpotShadowColor(@android.annotation.ColorInt
    int color) {
        return android.graphics.RenderNode.nSetSpotShadowColor(mNativeRenderNode, color);
    }
    ...
    public int getSpotShadowColor() {
        return android.graphics.RenderNode.nGetSpotShadowColor(mNativeRenderNode);
    }
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setAmbientShadowColor(@android.annotation.ColorInt
    int color) {
        return android.graphics.RenderNode.nSetAmbientShadowColor(mNativeRenderNode, color);
    }
    ...
    public int getAmbientShadowColor() {
        return android.graphics.RenderNode.nGetAmbientShadowColor(mNativeRenderNode);
    }
    ...
    public boolean setClipToOutline(boolean clipToOutline) {
        return android.graphics.RenderNode.nSetClipToOutline(mNativeRenderNode, clipToOutline);
    }
    ...
    public boolean getClipToOutline() {
        return android.graphics.RenderNode.nGetClipToOutline(mNativeRenderNode);
    }
    ...
    public boolean setRevealClip(boolean shouldClip, float x, float y, float radius) {
        return android.graphics.RenderNode.nSetRevealClip(mNativeRenderNode, shouldClip, x, y, radius);
    }
     ...
     * @unknown TODO Do we want this?
     */
    public boolean setStaticMatrix(android.graphics.Matrix matrix) {
        return android.graphics.RenderNode.nSetStaticMatrix(mNativeRenderNode, matrix.native_instance);
    }
     ...
     * @unknown TODO Do we want this?
     */
    public boolean setAnimationMatrix(@android.annotation.Nullable
    android.graphics.Matrix matrix) {
        return android.graphics.RenderNode.nSetAnimationMatrix(mNativeRenderNode, matrix != null ? matrix.native_instance : 0);
    }
    ...
    public android.graphics.Matrix getAnimationMatrix() {
        android.graphics.Matrix output = new android.graphics.Matrix();
        if (android.graphics.RenderNode.nGetAnimationMatrix(mNativeRenderNode, output.native_instance)) {
            return output;
        } else {
            return null;
        }
    ...
    public boolean setAlpha(float alpha) {
        return android.graphics.RenderNode.nSetAlpha(mNativeRenderNode, alpha);
    }
    ...
    public float getAlpha() {
        return android.graphics.RenderNode.nGetAlpha(mNativeRenderNode);
    }
    ...
    public boolean setHasOverlappingRendering(boolean hasOverlappingRendering) {
        return android.graphics.RenderNode.nSetHasOverlappingRendering(mNativeRenderNode, hasOverlappingRendering);
    }
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.graphics.RenderNode.USAGE_BACKGROUND })
     ...
     * @unknown 
     */
    public void setUsageHint(@android.graphics.RenderNode.UsageHint
    int usageHint) {
        android.graphics.RenderNode.nSetUsageHint(mNativeRenderNode, usageHint);
    }
    ...
    public boolean hasOverlappingRendering() {
        return android.graphics.RenderNode.nHasOverlappingRendering(mNativeRenderNode);
    }
    ...
    public boolean setElevation(float lift) {
        return android.graphics.RenderNode.nSetElevation(mNativeRenderNode, lift);
    }
    ...
    public float getElevation() {
        return android.graphics.RenderNode.nGetElevation(mNativeRenderNode);
    }
    ...
    public boolean setTranslationX(float translationX) {
        return android.graphics.RenderNode.nSetTranslationX(mNativeRenderNode, translationX);
    }
    ...
    public float getTranslationX() {
        return android.graphics.RenderNode.nGetTranslationX(mNativeRenderNode);
    }
    ...
    public boolean setTranslationY(float translationY) {
        return android.graphics.RenderNode.nSetTranslationY(mNativeRenderNode, translationY);
    }
    ...
    public float getTranslationY() {
        return android.graphics.RenderNode.nGetTranslationY(mNativeRenderNode);
    }
    ...
    public boolean setTranslationZ(float translationZ) {
        return android.graphics.RenderNode.nSetTranslationZ(mNativeRenderNode, translationZ);
    }
    ...
    public float getTranslationZ() {
        return android.graphics.RenderNode.nGetTranslationZ(mNativeRenderNode);
    }
    ...
    public boolean setRotationZ(float rotation) {
        return android.graphics.RenderNode.nSetRotation(mNativeRenderNode, rotation);
    }
    ...
    public float getRotationZ() {
        return android.graphics.RenderNode.nGetRotation(mNativeRenderNode);
    }
    ...
    public boolean setRotationX(float rotationX) {
        return android.graphics.RenderNode.nSetRotationX(mNativeRenderNode, rotationX);
    }
    ...
    public float getRotationX() {
        return android.graphics.RenderNode.nGetRotationX(mNativeRenderNode);
    }
    ...
    public boolean setRotationY(float rotationY) {
        return android.graphics.RenderNode.nSetRotationY(mNativeRenderNode, rotationY);
    }
    ...
    public float getRotationY() {
        return android.graphics.RenderNode.nGetRotationY(mNativeRenderNode);
    }
    ...
    public boolean setScaleX(float scaleX) {
        return android.graphics.RenderNode.nSetScaleX(mNativeRenderNode, scaleX);
    }
    ...
    public float getScaleX() {
        return android.graphics.RenderNode.nGetScaleX(mNativeRenderNode);
    }
    ...
    public boolean setScaleY(float scaleY) {
        return android.graphics.RenderNode.nSetScaleY(mNativeRenderNode, scaleY);
    }
    ...
    public float getScaleY() {
        return android.graphics.RenderNode.nGetScaleY(mNativeRenderNode);
    }
    ...
    public boolean setPivotX(float pivotX) {
        return android.graphics.RenderNode.nSetPivotX(mNativeRenderNode, pivotX);
    }
    ...
    public float getPivotX() {
        return android.graphics.RenderNode.nGetPivotX(mNativeRenderNode);
    }
    ...
    public boolean setPivotY(float pivotY) {
        return android.graphics.RenderNode.nSetPivotY(mNativeRenderNode, pivotY);
    }
    ...
    public float getPivotY() {
        return android.graphics.RenderNode.nGetPivotY(mNativeRenderNode);
    }
    ...
    public boolean isPivotExplicitlySet() {
        return android.graphics.RenderNode.nIsPivotExplicitlySet(mNativeRenderNode);
    }
    ...
    public boolean resetPivot() {
        return android.graphics.RenderNode.nResetPivot(mNativeRenderNode);
    }
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setCameraDistance(@android.annotation.FloatRange(from = 0.0F, to = java.lang.Float.MAX_VALUE)
    float distance) {
        if ((!java.lang.Float.isFinite(distance)) || (distance < 0.0F)) {
            throw new java.lang.IllegalArgumentException("distance must be finite & positive, given=" + distance);
        }
        // Native actually wants this to be negative not positive, so we flip it.
        return android.graphics.RenderNode.nSetCameraDistance(mNativeRenderNode, -distance);
    }
     ...
     */
    @android.annotation.FloatRange(from = 0.0F, to = java.lang.Float.MAX_VALUE)
    public float getCameraDistance() {
        return -android.graphics.RenderNode.nGetCameraDistance(mNativeRenderNode);
    }
     ...
     *
     * @param left
     * 		The left position, in pixels, of the RenderNode
     * @return true if the value changed, false otherwise
     * @unknown 
     */
    public boolean setLeft(int left) {
        return android.graphics.RenderNode.nSetLeft(mNativeRenderNode, left);
    }
     ...
     *
     * @param top
     * 		The top position, in pixels, of the RenderNode
     * @return true if the value changed, false otherwise.
     * @unknown 
     */
    public boolean setTop(int top) {
        return android.graphics.RenderNode.nSetTop(mNativeRenderNode, top);
    }
     ...
     *
     * @param right
     * 		The right position, in pixels, of the RenderNode
     * @return true if the value changed, false otherwise.
     * @unknown 
     */
    public boolean setRight(int right) {
        return android.graphics.RenderNode.nSetRight(mNativeRenderNode, right);
    }
     ...
     *
     * @param bottom
     * 		The bottom position, in pixels, of the RenderNode
     * @return true if the value changed, false otherwise.
     * @unknown 
     */
    public boolean setBottom(int bottom) {
        return android.graphics.RenderNode.nSetBottom(mNativeRenderNode, bottom);
    }
     ...
     */
    public int getLeft() {
        return android.graphics.RenderNode.nGetLeft(mNativeRenderNode);
    }
     ...
     */
    public int getTop() {
        return android.graphics.RenderNode.nGetTop(mNativeRenderNode);
    }
     ...
     */
    public int getRight() {
        return android.graphics.RenderNode.nGetRight(mNativeRenderNode);
    }
    ...
    public int getBottom() {
        return android.graphics.RenderNode.nGetBottom(mNativeRenderNode);
    }
     ...
     */
    public int getWidth() {
        return android.graphics.RenderNode.nGetWidth(mNativeRenderNode);
    }
    ...
    public int getHeight() {
        return android.graphics.RenderNode.nGetHeight(mNativeRenderNode);
    }
    ...
    public boolean setLeftTopRightBottom(int left, int top, int right, int bottom) {
        return android.graphics.RenderNode.nSetLeftTopRightBottom(mNativeRenderNode, left, top, right, bottom);
    }
     ...
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean setPosition(@android.annotation.NonNull
    android.graphics.Rect position) {
        return android.graphics.RenderNode.nSetLeftTopRightBottom(mNativeRenderNode, position.left, position.top, position.right, position.bottom);
    }
     ...
     *
     * @param offset
     * 		The amount that the left and right positions are offset in pixels
     * @return True if the value changed, false if the new value was the same as the previous value.
     */
    public boolean offsetLeftAndRight(int offset) {
        return android.graphics.RenderNode.nOffsetLeftAndRight(mNativeRenderNode, offset);
    }
    ...
    public boolean offsetTopAndBottom(int offset) {
        return android.graphics.RenderNode.nOffsetTopAndBottom(mNativeRenderNode, offset);
    }
     ...
     *
     * @unknown TODO: Expose? Should the shape of this be different than forced dump to logcat?
     */
    public void output() {
        android.graphics.RenderNode.nOutput(mNativeRenderNode);
    }
    ...
    public long computeApproximateMemoryUsage() {
        return android.graphics.RenderNode.nGetDebugSize(mNativeRenderNode);
    }
    ...
    public boolean setForceDarkAllowed(boolean allow) {
        return android.graphics.RenderNode.nSetAllowForceDark(mNativeRenderNode, allow);
    }
    ...
    public boolean isForceDarkAllowed() {
        return android.graphics.RenderNode.nGetAllowForceDark(mNativeRenderNode);
    }
    ...
    public long getUniqueId() {
        return android.graphics.RenderNode.nGetUniqueId(mNativeRenderNode);
    }
    ...
    public interface AnimationHost {
         ...
         * @unknown 
         */
        void registerAnimatingRenderNode(android.graphics.RenderNode animator);
         ...
         * @unknown 
         */
        void registerVectorDrawableAnimator(android.view.NativeVectorDrawableAnimator animator);
    ...
    public void addAnimator(android.view.RenderNodeAnimator animator) {
        ...
        android.graphics.RenderNode.nAddAnimator(mNativeRenderNode, animator.getNativeAnimator());
     ...
     * @unknown 
     */
    public void registerVectorDrawableAnimator(android.view.NativeVectorDrawableAnimator animatorSet) {
        if (!isAttached()) {
            throw new java.lang.IllegalStateException("Cannot start this animator on a detached view!");
        }
    ...
    public void endAllAnimators() {
        android.graphics.RenderNode.nEndAllAnimators(mNativeRenderNode);
    }
    ...
    private static native void nRequestPositionUpdates(long renderNode, android.graphics.RenderNode.PositionUpdateListener callback);
