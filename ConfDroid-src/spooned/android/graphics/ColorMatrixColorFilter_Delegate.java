...
public class ColorMatrixColorFilter_Delegate extends android.graphics.ColorFilter_Delegate {
    // ---- delegate data ----
    ...
    static long nativeColorMatrixFilter(float[] array) {
        android.graphics.ColorMatrixColorFilter_Delegate newDelegate = new android.graphics.ColorMatrixColorFilter_Delegate();
