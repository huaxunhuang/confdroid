 ...
 * </div>
 *
 * @unknown ref android.R.styleable#AnimationDrawable_visible
 * @unknown ref android.R.styleable#AnimationDrawable_variablePadding
 * @unknown ref android.R.styleable#AnimationDrawable_oneshot
 * @unknown ref android.R.styleable#AnimationDrawableItem_duration
 * @unknown ref android.R.styleable#AnimationDrawableItem_drawable
 */
public class AnimationDrawable extends android.graphics.drawable.DrawableContainer implements android.graphics.drawable.Animatable , java.lang.Runnable {
     ...
     */
    public void addFrame(@android.annotation.NonNull
    android.graphics.drawable.Drawable frame, int duration) {
    ...
    private void setFrame(int frame, boolean unschedule, boolean animate) {
        ...
        if (animate) {
            ...
            mCurFrame = frame;
            mRunning = true;
            scheduleSelf(this, android.os.SystemClock.uptimeMillis() + mAnimationState.mDurations[frame]);
        }
    }
    ...
    public void inflate(android.content.res.Resources r, org.xmlpull.v1.XmlPullParser parser, android.util.AttributeSet attrs, android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        final android.content.res.TypedArray a = android.graphics.drawable.Drawable.obtainAttributes(r, theme, attrs, R.styleable.AnimationDrawable);
    ...
    private void inflateChildElements(android.content.res.Resources r, org.xmlpull.v1.XmlPullParser parser, android.util.AttributeSet attrs, android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        while (((type = parser.next()) != org.xmlpull.v1.XmlPullParser.END_DOCUMENT) && (((depth = parser.getDepth()) >= innerDepth) || (type != org.xmlpull.v1.XmlPullParser.END_TAG))) {
            ...
            final android.content.res.TypedArray a = android.graphics.drawable.Drawable.obtainAttributes(r, theme, attrs, R.styleable.AnimationDrawableItem);
    ...
    private void updateStateFromTypedArray(android.content.res.TypedArray a) {
        mAnimationState.mVariablePadding = a.getBoolean(R.styleable.AnimationDrawable_variablePadding, mAnimationState.mVariablePadding);
        mAnimationState.mOneShot = a.getBoolean(R.styleable.AnimationDrawable_oneshot, mAnimationState.mOneShot);
    }
    ...
    android.graphics.drawable.AnimationDrawable.AnimationState cloneConstantState() {
        return new android.graphics.drawable.AnimationDrawable.AnimationState(mAnimationState, this, null);
    }
    ...
    private static final class AnimationState extends android.graphics.drawable.DrawableContainer.DrawableContainerState {
        ...
        AnimationState(android.graphics.drawable.AnimationDrawable.AnimationState orig, android.graphics.drawable.AnimationDrawable owner, android.content.res.Resources res) {
        ...
        public void growArray(int oldSize, int newSize) {
            ...
            java.lang.System.arraycopy(mDurations, 0, newDurations, 0, oldSize);
    ...
    android.graphics.drawable.DrawableContainer.DrawableContainerState state) {
        ...
        if (state instanceof android.graphics.drawable.AnimationDrawable.AnimationState) {
            mAnimationState = ((android.graphics.drawable.AnimationDrawable.AnimationState) (state));
        }
    }

    private AnimationDrawable(android.graphics.drawable.AnimationDrawable.AnimationState state, android.content.res.Resources res) {
        final android.graphics.drawable.AnimationDrawable.AnimationState as = new android.graphics.drawable.AnimationDrawable.AnimationState(state, this, res);
        setConstantState(as);
        if (state != null) {
            setFrame(0, true, false);
        }
