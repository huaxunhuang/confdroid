...
public abstract class Drawable {
    ...
    private android.graphics.Rect mBounds = android.graphics.drawable.Drawable.ZERO_BOUNDS_RECT;// lazily becomes a new Rect()
     ...
     * will draw when its draw() method is called.
     */
    public void setBounds(@android.annotation.NonNull
     ...
     * 		caller).
     */
    public final void copyBounds(@android.annotation.NonNull
    android.graphics.Rect bounds) {
        bounds.set(mBounds);
    }
    ...
    public final android.graphics.Rect getBounds() {
        if (mBounds == android.graphics.drawable.Drawable.ZERO_BOUNDS_RECT) {
     ...
     */
    public void setChangingConfigurations(@android.content.pm.ActivityInfo.Config
    int configs) {
    ...
    public interface Callback {
         ...
         */
        void invalidateDrawable(@android.annotation.NonNull
         ...
         */
        void scheduleDrawable(@android.annotation.NonNull
         ...
         */
        void unscheduleDrawable(@android.annotation.NonNull
        android.graphics.drawable.Drawable who, @android.annotation.NonNull
     ...
     * @see #getCallback()
     */
    public final void setCallback(@android.annotation.Nullable
    android.graphics.drawable.Drawable.Callback cb) {
        mCallback = (cb != null) ? new java.lang.ref.WeakReference<>(cb) : null;
    }
     ...
     */
    public void scheduleSelf(@android.annotation.NonNull
    java.lang.Runnable what, long when) {
        final android.graphics.drawable.Drawable.Callback callback = getCallback();
        if (callback != null) {
     ...
     */
    public void unscheduleSelf(@android.annotation.NonNull
    java.lang.Runnable what) {
        final android.graphics.drawable.Drawable.Callback callback = getCallback();
        if (callback != null) {
     ...
     */
    public final boolean setLayoutDirection(@android.view.View.ResolvedLayoutDir
    int layoutDirection) {
     ...
     */
    public abstract void setAlpha(@android.annotation.IntRange(from = 0, to = 255)
    int alpha);
     ...
     *
     *
     * @unknown Internal-only method for setting xfermode on certain supported drawables.
     ...
     *
     * @param colorFilter
     * 		The color filter to apply, or {@code null} to remove the
     * 		existing color filter
     */
    public abstract void setColorFilter(@android.annotation.Nullable
     ...
     */
    @java.lang.Deprecated
    public void setColorFilter(@android.annotation.ColorInt
    int color, @android.annotation.NonNull
    android.graphics.PorterDuff.Mode mode) {
        if (getColorFilter() instanceof android.graphics.PorterDuffColorFilter) {
            android.graphics.PorterDuffColorFilter existing = ((android.graphics.PorterDuffColorFilter) (getColorFilter()));
     ...
     */
    public void setTint(@android.annotation.ColorInt
    int tintColor) {
        setTintList(android.content.res.ColorStateList.valueOf(tintColor));
    }
     ...
     * @see #setTintList(ColorStateList)
     */
    public void setTintMode(@android.annotation.Nullable
    android.graphics.PorterDuff.Mode tintMode) {
        if (!mSetTintModeInvoked) {
            mSetTintModeInvoked = true;
            android.graphics.BlendMode mode = (tintMode != null) ? android.graphics.BlendMode.fromValue(tintMode.nativeInt) : null;
            setTintBlendMode(mode != null ? mode : android.graphics.drawable.Drawable.DEFAULT_BLEND_MODE);
    ...
    android.graphics.BlendMode blendMode) {
        if (!mSetBlendModeInvoked) {
            ...
            setTintMode(mode != null ? mode : android.graphics.drawable.Drawable.DEFAULT_TINT_MODE);
    ...
    returns false.
     */
    public boolean setState(@android.annotation.NonNull
    final int[] stateSet) {
    ...
    returns false.
     */
    public final boolean setLevel(@android.annotation.IntRange(from = 0, to = 10000)
    int level) {
        if (mLevel != level) {
            mLevel = level;
     ...
     */
    @android.annotation.IntRange(from = 0, to = 10000)
     ...
     */
    @android.graphics.PixelFormat.Opacity
    public static int resolveOpacity(@android.graphics.PixelFormat.Opacity
    int op1, @android.graphics.PixelFormat.Opacity
    int op2) {
        if (op1 == op2) {
            return op1;
        }
        if ((op1 == android.graphics.PixelFormat.UNKNOWN) || (op2 == android.graphics.PixelFormat.UNKNOWN)) {
            return android.graphics.PixelFormat.UNKNOWN;
        }
        if ((op1 == android.graphics.PixelFormat.TRANSLUCENT) || (op2 == android.graphics.PixelFormat.TRANSLUCENT)) {
            return android.graphics.PixelFormat.TRANSLUCENT;
        }
        if ((op1 == android.graphics.PixelFormat.TRANSPARENT) || (op2 == android.graphics.PixelFormat.TRANSPARENT)) {
    ...
    public static android.graphics.drawable.Drawable createFromStream(java.io.InputStream is, java.lang.String srcName) {
        android.os.Trace.traceBegin(Trace.TRACE_TAG_RESOURCES, srcName != null ? srcName : "Unknown drawable");
        try {
            return android.graphics.drawable.Drawable.createFromResourceStream(null, null, is, srcName);
        } finally {
     ...
     */
    @android.annotation.Nullable
    public static android.graphics.drawable.Drawable createFromResourceStream(@android.annotation.Nullable
    android.content.res.Resources res, @android.annotation.Nullable
    android.util.TypedValue value, @android.annotation.Nullable
    java.io.InputStream is, @android.annotation.Nullable
    java.lang.String srcName, @android.annotation.Nullable
    android.graphics.BitmapFactory.Options opts) {
        if (is == null) {
            return null;
        }
        if (opts == null) {
            return android.graphics.drawable.Drawable.getBitmapDrawable(res, value, is);
        }
        ...
        // drawn to the screen.
        opts.inScreenDensity = android.graphics.drawable.Drawable.resolveDensity(res, 0);
        android.graphics.Bitmap bm = android.graphics.BitmapFactory.decodeResourceStream(res, value, is, pad, opts);
        if (bm != null) {
            ...
            return android.graphics.drawable.Drawable.drawableFromBitmap(res, bm, np, pad, opticalInsets, srcName);
        }
        return null;
    }

    private static android.graphics.drawable.Drawable getBitmapDrawable(android.content.res.Resources res, android.util.TypedValue value, java.io.InputStream is) {
        try {
            android.graphics.ImageDecoder.Source source = null;
            if (value != null) {
                ...
                source = android.graphics.ImageDecoder.createSource(res, is, density);
            } else {
                source = android.graphics.ImageDecoder.createSource(res, is);
            }
     ...
     */
    @android.annotation.NonNull
    public static android.graphics.drawable.Drawable createFromXml(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    org.xmlpull.v1.XmlPullParser parser) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        return android.graphics.drawable.Drawable.createFromXml(r, parser, null);
    }
    ...
    public static android.graphics.drawable.Drawable createFromXml(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    org.xmlpull.v1.XmlPullParser parser, @android.annotation.Nullable
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        return android.graphics.drawable.Drawable.createFromXmlForDensity(r, parser, 0, theme);
    }
     ...
     */
    @android.annotation.NonNull
    public static android.graphics.drawable.Drawable createFromXmlForDensity(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    org.xmlpull.v1.XmlPullParser parser, int density, @android.annotation.Nullable
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        ...
        android.graphics.drawable.Drawable drawable = android.graphics.drawable.Drawable.createFromXmlInnerForDensity(r, parser, attrs, density, theme);
        if (drawable == null) {
     ...
     */
    @android.annotation.NonNull
    public static android.graphics.drawable.Drawable createFromXmlInner(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    org.xmlpull.v1.XmlPullParser parser, @android.annotation.NonNull
    android.util.AttributeSet attrs) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        return android.graphics.drawable.Drawable.createFromXmlInner(r, parser, attrs, null);
    }
    ...
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        return android.graphics.drawable.Drawable.createFromXmlInnerForDensity(r, parser, attrs, 0, theme);
    }
     ...
     */
    @android.annotation.NonNull
    static android.graphics.drawable.Drawable createFromXmlInnerForDensity(@android.annotation.NonNull
    android.content.res.Resources r, @android.annotation.NonNull
    org.xmlpull.v1.XmlPullParser parser, @android.annotation.NonNull
    ...
    public static android.graphics.drawable.Drawable createFromPath(java.lang.String pathName) {
        ...
        android.os.Trace.traceBegin(Trace.TRACE_TAG_RESOURCES, pathName);
        try (java.io.FileInputStream stream = new java.io.FileInputStream(pathName)) {
            return android.graphics.drawable.Drawable.getBitmapDrawable(null, null, stream);
        } catch (java.io.IOException e) {
    ...
    android.util.AttributeSet attrs, @android.annotation.Nullable
    android.content.res.Resources.Theme theme) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
        final android.content.res.TypedArray a = android.graphics.drawable.Drawable.obtainAttributes(r, theme, attrs, R.styleable.Drawable);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    void inflateWithAttributes(@android.annotation.NonNull
    @java.lang.SuppressWarnings("unused")
    android.content.res.Resources r, @android.annotation.NonNull
    @java.lang.SuppressWarnings("unused")
    org.xmlpull.v1.XmlPullParser parser, @android.annotation.NonNull
    android.content.res.TypedArray attrs, @android.annotation.AttrRes
    int visibleAttr) throws java.io.IOException, org.xmlpull.v1.XmlPullParserException {
    ...
    private static android.graphics.drawable.Drawable drawableFromBitmap(android.content.res.Resources res, android.graphics.Bitmap bm, byte[] np, android.graphics.Rect pad, android.graphics.Rect layoutBounds, java.lang.String srcName) {
        if (np != null) {
            return new android.graphics.drawable.NinePatchDrawable(res, bm, np, pad, layoutBounds, srcName);
        }
    ...
    @android.annotation.UnsupportedAppUsage
    @android.annotation.Nullable
    android.graphics.PorterDuffColorFilter updateTintFilter(@android.annotation.Nullable
    android.graphics.PorterDuffColorFilter tintFilter, @android.annotation.Nullable
    android.content.res.ColorStateList tint, @android.annotation.Nullable
    android.graphics.PorterDuff.Mode tintMode) {
    ...
    @android.annotation.Nullable
    android.graphics.BlendModeColorFilter updateBlendModeFilter(@android.annotation.Nullable
    android.graphics.BlendModeColorFilter blendFilter, @android.annotation.Nullable
    android.content.res.ColorStateList tint, @android.annotation.Nullable
    android.graphics.BlendMode blendMode) {
        ...
        if (((blendFilter == null) || (blendFilter.getColor() != color)) || (blendFilter.getMode() != blendMode)) {
            return new android.graphics.BlendModeColorFilter(color, blendMode);
        }
        return blendFilter;
    }
     ...
     */
    @android.annotation.NonNull
    protected static android.content.res.TypedArray obtainAttributes(@android.annotation.NonNull
    android.content.res.Resources res, @android.annotation.Nullable
     ...
     *
     * @param pixels
     * 		the pixel value for use in source density
     * @param sourceDensity
     * 		the source density
     * @param targetDensity
     * 		the target density
     ...
     * 		the target density
     * @param isSize
     * 		{@code true} to handle the resulting scaled value as a
    ...
    static int scaleFromDensity(int pixels, int sourceDensity, int targetDensity, boolean isSize) {
        ...
        final int rounded = java.lang.Math.round(result);
        if (rounded != 0) {
            return rounded;
        } else
            if (pixels > 0) {
    ...
    static int resolveDensity(@android.annotation.Nullable
    android.content.res.Resources r, int parentDensity) {
     ...
     * 		
     */
    static void rethrowAsRuntimeException(@android.annotation.NonNull
    java.lang.Exception cause) throws java.lang.RuntimeException {
        final java.lang.RuntimeException e = new java.lang.RuntimeException(cause);
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public static android.graphics.BlendMode parseBlendMode(int value, android.graphics.BlendMode defaultMode) {
        switch (value) {
            case 3 :
