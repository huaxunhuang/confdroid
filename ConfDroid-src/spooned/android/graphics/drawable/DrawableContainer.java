...
public class DrawableContainer extends android.graphics.drawable.Drawable implements android.graphics.drawable.Drawable.Callback {
    ...
    public boolean getPadding(android.graphics.Rect padding) {
        final android.graphics.Rect r = mDrawableContainerState.getConstantPadding();
        boolean result;
        if (r != null) {
            padding.set(r);
    ...
    public int getOpacity() {
        return (mCurrDrawable == null) || (!mCurrDrawable.isVisible()) ? android.graphics.PixelFormat.TRANSPARENT : mDrawableContainerState.getOpacity();
    }
    ...
    public boolean selectDrawable(int index) {
        ...
        if (android.graphics.drawable.DrawableContainer.DEBUG)
            android.graphics.drawable.android.util.Log.i(android.graphics.drawable.DrawableContainer.TAG, (((((((toString() + " from ") + mCurIndex) + " to ") + index) + ": exit=") + mDrawableContainerState.mExitFadeDuration) + " enter=") + mDrawableContainerState.mEnterFadeDuration);
        ...
        if ((mEnterAnimationEnd != 0) || (mExitAnimationEnd != 0)) {
            if (mAnimationRunnable == null) {
                mAnimationRunnable = new java.lang.Runnable() {
                    @java.lang.Override
                    public void run() {
                        animate(true);
                        invalidateSelf();
     ...
     *
     * @param d
     * 		The drawable to initialize.
     */
    private void initializeDrawableForDisplay(android.graphics.drawable.Drawable d) {
        if (mBlockInvalidateCallback == null) {
            mBlockInvalidateCallback = new android.graphics.drawable.DrawableContainer.BlockInvalidateCallback();
        }
     ...
     *
     * @param res
     * 		the resources used to inflate density-dependent values
     * @unknown 
     */
    protected final void updateDensity(android.content.res.Resources res) {
    ...
    public android.graphics.drawable.Drawable mutate() {
        if ((!mMutated) && (super.mutate() == this)) {
            final android.graphics.drawable.DrawableContainer.DrawableContainerState clone = cloneConstantState();
            clone.mutate();
    ...
    public static abstract class DrawableContainerState extends android.graphics.drawable.Drawable.ConstantState {
        ...
        boolean mDither = android.graphics.drawable.DrawableContainer.DEFAULT_DITHER;
        ...
        protected DrawableContainerState(android.graphics.drawable.DrawableContainer.DrawableContainerState orig, android.graphics.drawable.DrawableContainer owner, android.content.res.Resources res) {
            mOwner = owner;
            ...
            if (orig != null) {
                ...
                final android.util.SparseArray<android.graphics.drawable.Drawable.ConstantState> origDf = orig.mDrawableFutures;
                if (origDf != null) {
                    mDrawableFutures = origDf.clone();
                } else {
                    mDrawableFutures = new android.util.SparseArray(mNumChildren);
                }
                ...
                for (int i = 0; i < N; i++) {
                    if (origDr[i] != null) {
                        final android.graphics.drawable.Drawable.ConstantState cs = origDr[i].getConstantState();
                        if (cs != null) {
        ...
        private void createAllFutures() {
            if (mDrawableFutures != null) {
                ...
                for (int keyIndex = 0; keyIndex < futureCount; keyIndex++) {
                    ...
                    final android.graphics.drawable.Drawable.ConstantState cs = mDrawableFutures.valueAt(keyIndex);
         ...
         * 		the resources used to inflate density-dependent values
         */
        final void updateDensity(android.content.res.Resources res) {
            if (res != null) {
                mSourceRes = res;
        ...
        public boolean canApplyTheme() {
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (d != null) {
                    ...
                    final android.graphics.drawable.Drawable.ConstantState future = mDrawableFutures.get(i);
        ...
        public final android.graphics.Rect getConstantPadding() {
            ...
            final android.graphics.Rect t = new android.graphics.Rect();
            final int N = mNumChildren;
            final android.graphics.drawable.Drawable[] drawables = mDrawables;
            for (int i = 0; i < N; i++) {
        ...
        public void growArray(int oldSize, int newSize) {
            ...
            java.lang.System.arraycopy(mDrawables, 0, newDrawables, 0, oldSize);
    ...
    private static class BlockInvalidateCallback implements android.graphics.drawable.Drawable.Callback {
        ...
        public android.graphics.drawable.Drawable.Callback unwrap() {
            final android.graphics.drawable.Drawable.Callback callback = mCallback;
            mCallback = null;
            return callback;
        }
