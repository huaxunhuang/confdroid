...
public class EmbossMaskFilter_Delegate extends android.graphics.MaskFilter_Delegate {
    // ---- delegate data ----
    ...
    static long nativeConstructor(float[] direction, float ambient, float specular, float blurRadius) {
        android.graphics.EmbossMaskFilter_Delegate newDelegate = new android.graphics.EmbossMaskFilter_Delegate();
        return android.graphics.MaskFilter_Delegate.sManager.addNewDelegate(newDelegate);
    }
}
