...
public final class NativeInterpolatorFactory {
    ...
    public static long createNativeInterpolator(android.animation.TimeInterpolator interpolator, long duration) {
        if (interpolator == null) {
            ...
            if (android.graphics.animation.RenderNodeAnimator.isNativeInterpolator(interpolator)) {
                return ((android.graphics.animation.NativeInterpolator) (interpolator)).createNativeInterpolator();
            } else {
                return android.graphics.animation.FallbackLUTInterpolator.createNativeInterpolator(interpolator, duration);
            }
