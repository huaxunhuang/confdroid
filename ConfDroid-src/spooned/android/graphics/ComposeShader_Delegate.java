 ...
 * @see Shader_Delegate
 */
public class ComposeShader_Delegate extends android.graphics.Shader_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(long nativeMatrix, long native_shaderA, long native_shaderB, int native_mode) {
        // FIXME not supported yet.
        android.graphics.ComposeShader_Delegate newDelegate = new android.graphics.ComposeShader_Delegate(nativeMatrix);
