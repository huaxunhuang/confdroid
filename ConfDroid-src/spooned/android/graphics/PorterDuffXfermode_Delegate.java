 ...
 */
public class PorterDuffXfermode_Delegate extends android.graphics.Xfermode_Delegate {
    // ---- delegate data ----
    ...
    public java.awt.Composite getComposite(int alpha) {
        return com.android.layoutlib.bridge.impl.PorterDuffUtility.getComposite(mMode, alpha);
    }
    ...
    static long nativeCreateXfermode(int mode) {
        android.graphics.PorterDuffXfermode_Delegate newDelegate = new android.graphics.PorterDuffXfermode_Delegate(mode);
