 ...
 * @see Shader_Delegate
 */
public class RadialGradient_Delegate extends android.graphics.Gradient_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(long matrix, float x, float y, float radius, long[] colors, float[] positions, int tileMode, long colorSpaceHandle) {
        android.graphics.RadialGradient_Delegate newDelegate = new android.graphics.RadialGradient_Delegate(matrix, x, y, radius, colors, positions, android.graphics.Shader_Delegate.getTileMode(tileMode));
     ...
     * @param radius
     * 		Must be positive. The radius of the circle for this
     * 		gradient
     * @param colors
     * 		The colors to be distributed between the center and edge of
     * 		the circle
     * @param positions
     * 		May be NULL. The relative position of each corresponding
     ...
     */
    private RadialGradient_Delegate(long nativeMatrix, float x, float y, float radius, long[] colors, float[] positions, android.graphics.Shader.TileMode tile) {
        super(nativeMatrix, colors, positions);
        mJavaPaint = new android.graphics.RadialGradient_Delegate.RadialGradientPaint(x, y, radius, mColors, mPositions, tile);
    }

    private class RadialGradientPaint extends android.graphics.Gradient_Delegate.GradientPaint {
        ...
        public RadialGradientPaint(float x, float y, float radius, int[] colors, float[] positions, android.graphics.Shader.TileMode mode) {
        ...
        public java.awt.PaintContext createContext(java.awt.image.ColorModel colorModel, java.awt.Rectangle deviceBounds, java.awt.geom.Rectangle2D userBounds, java.awt.geom.AffineTransform xform, java.awt.RenderingHints hints) {
            ...
            try {
                ...
                /* data */
                com.android.layoutlib.bridge.Bridge.getLog().fidelityWarning(LayoutLog.TAG_MATRIX_INVERSE, "Unable to inverse matrix in RadialGradient", e, null);
            ...
            return new android.graphics.RadialGradient_Delegate.RadialGradientPaint.RadialGradientPaintContext(canvasMatrix, localMatrix, colorModel);
        }
        ...
        private class RadialGradientPaintContext implements java.awt.PaintContext {
            ...
            public RadialGradientPaintContext(java.awt.geom.AffineTransform canvasMatrix, java.awt.geom.AffineTransform localMatrix, java.awt.image.ColorModel colorModel) {
                mCanvasMatrix = canvasMatrix;
                mLocalMatrix = localMatrix;
                mColorModel = (colorModel.hasAlpha()) ? colorModel : java.awt.image.ColorModel.getRGBdefault();
            }
            ...
            public java.awt.image.Raster getRaster(int x, int y, int w, int h) {
                ...
                for (int iy = 0; iy < h; iy++) {
                    for (int ix = 0; ix < w; ix++) {
                        ...
                        float _x = pt2[0] - mX;
                        float _y = pt2[1] - mY;
                        float distance = ((float) (java.lang.Math.hypot(_x, _y)));
