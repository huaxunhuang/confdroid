...
public final class LargeBitmap {
    ...
    public android.graphics.Bitmap decodeRegion(android.graphics.Rect rect, android.graphics.BitmapFactory.Options options) {
        ...
        return android.graphics.LargeBitmap.nativeDecodeRegion(mNativeLargeBitmap, rect.left, rect.top, rect.right - rect.left, rect.bottom - rect.top, options);
    }
    ...
    public int getWidth() {
        ...
        return android.graphics.LargeBitmap.nativeGetWidth(mNativeLargeBitmap);
    }
    ...
    public int getHeight() {
        ...
        return android.graphics.LargeBitmap.nativeGetHeight(mNativeLargeBitmap);
    }
    ...
    public void recycle() {
        if (!mRecycled) {
            android.graphics.LargeBitmap.nativeClean(mNativeLargeBitmap);
            mRecycled = true;
        }
    }
    ...
    private static native android.graphics.Bitmap nativeDecodeRegion(long nativeLbm, int start_x, int start_y, int width, int height, android.graphics.BitmapFactory.Options options);
