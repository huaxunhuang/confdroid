 ...
 * @see Shader_Delegate
 */
public class SweepGradient_Delegate extends android.graphics.Gradient_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(long matrix, float x, float y, long[] colors, float[] positions, long colorSpaceHandle) {
        android.graphics.SweepGradient_Delegate newDelegate = new android.graphics.SweepGradient_Delegate(matrix, x, y, colors, positions);
     ...
     * 		spaced evenly.
     */
    private SweepGradient_Delegate(long nativeMatrix, float cx, float cy, long[] colors, float[] positions) {
        super(nativeMatrix, colors, positions);
        mJavaPaint = new android.graphics.SweepGradient_Delegate.SweepGradientPaint(cx, cy, mColors, mPositions);
    }

    private class SweepGradientPaint extends android.graphics.Gradient_Delegate.GradientPaint {
        ...
        public java.awt.PaintContext createContext(java.awt.image.ColorModel colorModel, java.awt.Rectangle deviceBounds, java.awt.geom.Rectangle2D userBounds, java.awt.geom.AffineTransform xform, java.awt.RenderingHints hints) {
            ...
            try {
                ...
                /* data */
                com.android.layoutlib.bridge.Bridge.getLog().fidelityWarning(LayoutLog.TAG_MATRIX_INVERSE, "Unable to inverse matrix in SweepGradient", e, null);
            ...
            return new android.graphics.SweepGradient_Delegate.SweepGradientPaint.SweepGradientPaintContext(canvasMatrix, localMatrix, colorModel);
        }
        ...
        private class SweepGradientPaintContext implements java.awt.PaintContext {
            ...
            public SweepGradientPaintContext(java.awt.geom.AffineTransform canvasMatrix, java.awt.geom.AffineTransform localMatrix, java.awt.image.ColorModel colorModel) {
            ...
            public java.awt.image.Raster getRaster(int x, int y, int w, int h) {
                ...
                for (int iy = 0; iy < h; iy++) {
                    for (int ix = 0; ix < w; ix++) {
                        ...
                        float angle;
                        if (dx == 0) {
                            angle = ((float) ((dy < 0) ? (3 * java.lang.Math.PI) / 2 : java.lang.Math.PI / 2));
                        } else
                            if (dy == 0) {
                                angle = ((float) ((dx < 0) ? java.lang.Math.PI : 0));
                            } else {
                                angle = ((float) (java.lang.Math.atan(dy / dx)));
                                if (dx > 0) {
                                    if (dy < 0) {
                        ...
                        data[index++] = getGradientColor(((float) (angle / (2 * java.lang.Math.PI))));
                    }
                }
