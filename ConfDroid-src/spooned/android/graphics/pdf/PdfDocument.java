...
public class PdfDocument {
    ...
    private final java.util.List<android.graphics.pdf.PdfDocument.PageInfo> mPages = new java.util.ArrayList<android.graphics.pdf.PdfDocument.PageInfo>();
    ...
    public android.graphics.pdf.PdfDocument.Page startPage(android.graphics.pdf.PdfDocument.PageInfo pageInfo) {
        ...
        android.graphics.Canvas canvas = new android.graphics.pdf.PdfDocument.PdfCanvas(android.graphics.pdf.PdfDocument.nativeStartPage(mNativeDocument, pageInfo.mPageWidth, pageInfo.mPageHeight, pageInfo.mContentRect.left, pageInfo.mContentRect.top, pageInfo.mContentRect.right, pageInfo.mContentRect.bottom));
        mCurrentPage = new android.graphics.pdf.PdfDocument.Page(canvas, pageInfo);
        return mCurrentPage;
    }
    ...
    public java.util.List<android.graphics.pdf.PdfDocument.PageInfo> getPages() {
        return java.util.Collections.unmodifiableList(mPages);
    }
    ...
    public static final class PageInfo {
        ...
        public static final class Builder {
             ...
             */
            public android.graphics.pdf.PdfDocument.PageInfo.Builder setContentRect(android.graphics.Rect contentRect) {
                if ((contentRect != null) && ((((contentRect.left < 0) || (contentRect.top < 0)) || (contentRect.right > mPageInfo.mPageWidth)) || (contentRect.bottom > mPageInfo.mPageHeight))) {
            ...
            public android.graphics.pdf.PdfDocument.PageInfo create() {
                if (mPageInfo.mContentRect == null) {
                    mPageInfo.mContentRect = new android.graphics.Rect(0, 0, mPageInfo.mPageWidth, mPageInfo.mPageHeight);
                }
                return mPageInfo;
            }
        }
    ...
    public static final class Page {
         ...
         *     android.graphics.Region.Op)} for {@link android.graphics.Region.Op#REVERSE_DIFFERENCE
