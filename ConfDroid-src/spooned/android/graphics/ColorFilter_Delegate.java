...
public abstract class ColorFilter_Delegate {
    // ---- delegate manager ----
    protected static final com.android.layoutlib.bridge.impl.DelegateManager<android.graphics.ColorFilter_Delegate> sManager = new com.android.layoutlib.bridge.impl.DelegateManager<android.graphics.ColorFilter_Delegate>(android.graphics.ColorFilter_Delegate.class);
    ...
    public static android.graphics.ColorFilter_Delegate getDelegate(long nativeShader) {
        return android.graphics.ColorFilter_Delegate.sManager.getDelegate(nativeShader);
    }
    ...
    static long nativeGetFinalizer() {
        synchronized(android.graphics.ColorFilter_Delegate.class) {
            if (android.graphics.ColorFilter_Delegate.sFinalizer == (-1)) {
                android.graphics.ColorFilter_Delegate.sFinalizer = libcore.util.NativeAllocationRegistry_Delegate.createFinalizer(android.graphics.ColorFilter_Delegate.sManager::removeJavaReferenceFor);
            }
        }
        return android.graphics.ColorFilter_Delegate.sFinalizer;
    }
}
