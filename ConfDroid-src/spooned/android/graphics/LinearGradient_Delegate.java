 ...
 * @see Shader_Delegate
 */
public final class LinearGradient_Delegate extends android.graphics.Gradient_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(android.graphics.LinearGradient thisGradient, long matrix, float x0, float y0, float x1, float y1, long[] colors, float[] positions, int tileMode, long colorSpaceHandle) {
        android.graphics.LinearGradient_Delegate newDelegate = new android.graphics.LinearGradient_Delegate(matrix, x0, y0, x1, y1, colors, positions, android.graphics.Shader_Delegate.getTileMode(tileMode));
     ...
     */
    private LinearGradient_Delegate(long nativeMatrix, float x0, float y0, float x1, float y1, long[] colors, float[] positions, android.graphics.Shader.TileMode tile) {
        super(nativeMatrix, colors, positions);
        mJavaPaint = new android.graphics.LinearGradient_Delegate.LinearGradientPaint(x0, y0, x1, y1, mColors, mPositions, tile);
    }
     ...
     * modes.
     */
    private class LinearGradientPaint extends android.graphics.Gradient_Delegate.GradientPaint {
        ...
        public LinearGradientPaint(float x0, float y0, float x1, float y1, int[] colors, float[] positions, android.graphics.Shader.TileMode tile) {
        ...
        public java.awt.PaintContext createContext(java.awt.image.ColorModel colorModel, java.awt.Rectangle deviceBounds, java.awt.geom.Rectangle2D userBounds, java.awt.geom.AffineTransform xform, java.awt.RenderingHints hints) {
            ...
            try {
                ...
                /* data */
                com.android.layoutlib.bridge.Bridge.getLog().fidelityWarning(LayoutLog.TAG_MATRIX_INVERSE, "Unable to inverse matrix in LinearGradient", e, null);
            ...
            return new android.graphics.LinearGradient_Delegate.LinearGradientPaint.LinearGradientPaintContext(canvasMatrix, localMatrix, colorModel);
        }
        ...
        private class LinearGradientPaintContext implements java.awt.PaintContext {
            ...
            private LinearGradientPaintContext(java.awt.geom.AffineTransform canvasMatrix, java.awt.geom.AffineTransform localMatrix, java.awt.image.ColorModel colorModel) {
