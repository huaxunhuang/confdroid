 ...
 */
public final class DashPathEffect_Delegate extends android.graphics.PathEffect_Delegate {
    // ---- delegate data ----
    ...
    public java.awt.Stroke getStroke(android.graphics.Paint_Delegate paint) {
        return new java.awt.BasicStroke(paint.getStrokeWidth(), paint.getJavaCap(), paint.getJavaJoin(), paint.getJavaStrokeMiter(), mIntervals, mPhase);
    }
    ...
    static long nativeCreate(float[] intervals, float phase) {
        android.graphics.DashPathEffect_Delegate newDelegate = new android.graphics.DashPathEffect_Delegate(intervals, phase);
    ...
    private DashPathEffect_Delegate(float[] intervals, float phase) {
        ...
        java.lang.System.arraycopy(intervals, 0, mIntervals, 0, intervals.length);
        mPhase = phase;
    }
}
