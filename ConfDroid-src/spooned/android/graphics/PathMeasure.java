...
public class PathMeasure {
    ...
    public PathMeasure() {
        mPath = null;
        native_instance = android.graphics.PathMeasure.native_create(0, false);
    }
    ...
    public PathMeasure(android.graphics.Path path, boolean forceClosed) {
        ...
        mPath = path;
        native_instance = android.graphics.PathMeasure.native_create(path != null ? path.readOnlyNI() : 0, forceClosed);
    }
    ...
    public void setPath(android.graphics.Path path, boolean forceClosed) {
        mPath = path;
        android.graphics.PathMeasure.native_setPath(native_instance, path != null ? path.readOnlyNI() : 0, forceClosed);
    }
    ...
    public float getLength() {
        return android.graphics.PathMeasure.native_getLength(native_instance);
    }
    ...
    public boolean getPosTan(float distance, float[] pos, float[] tan) {
        ...
        return android.graphics.PathMeasure.native_getPosTan(native_instance, distance, pos, tan);
    }

    public static final int POSITION_MATRIX_FLAG = 0x1;// must match flags in SkPathMeasure.h


    public static final int TANGENT_MATRIX_FLAG = 0x2;// must match flags in SkPathMeasure.h
     ...
     */
    public boolean getMatrix(float distance, android.graphics.Matrix matrix, int flags) {
        return android.graphics.PathMeasure.native_getMatrix(native_instance, distance, matrix.native_instance, flags);
    }
    ...
    public boolean getSegment(float startD, float stopD, android.graphics.Path dst, boolean startWithMoveTo) {
        ...
        return android.graphics.PathMeasure.native_getSegment(native_instance, startD, stopD, dst.mutateNI(), startWithMoveTo);
    }
    ...
    public boolean isClosed() {
        return android.graphics.PathMeasure.native_isClosed(native_instance);
    }
    ...
    public boolean nextContour() {
        return android.graphics.PathMeasure.native_nextContour(native_instance);
    }

    protected void finalize() throws java.lang.Throwable {
        android.graphics.PathMeasure.native_destroy(native_instance);
