...
public class RegionIterator {
     ...
     *
     * @param region
     * 		the region that will be iterated
     */
    public RegionIterator(android.graphics.Region region) {
        mNativeIter = android.graphics.RegionIterator.nativeConstructor(region.ni());
    }
    ...
    public final boolean next(android.graphics.Rect r) {
        ...
        return android.graphics.RegionIterator.nativeNext(mNativeIter, r);
    }

    protected void finalize() throws java.lang.Throwable {
        android.graphics.RegionIterator.nativeDestructor(mNativeIter);
    ...
    private static native boolean nativeNext(long native_iter, android.graphics.Rect r);
