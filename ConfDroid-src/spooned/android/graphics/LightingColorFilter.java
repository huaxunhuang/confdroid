...
public class LightingColorFilter extends android.graphics.ColorFilter {
     ...
     */
    public LightingColorFilter(@android.annotation.ColorInt
    int mul, @android.annotation.ColorInt
    int add) {
        mMul = mul;
        mAdd = add;
    }
    ...
    public void setColorMultiply(@android.annotation.ColorInt
    int mul) {
        if (mMul != mul) {
            mMul = mul;
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public void setColorAdd(@android.annotation.ColorInt
    int add) {
        if (mAdd != add) {
            mAdd = add;
            discardNativeInstance();
    ...
    long createNativeInstance() {
        return android.graphics.LightingColorFilter.native_CreateLightingFilter(mMul, mAdd);
    }
