...
public class CornerPathEffect_Delegate extends android.graphics.PathEffect_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(float radius) {
        android.graphics.CornerPathEffect_Delegate newDelegate = new android.graphics.CornerPathEffect_Delegate();
