...
public final class Bitmap implements android.os.Parcelable {
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769491)
    private byte[] mNinePatchChunk;// may be null


    @android.annotation.UnsupportedAppUsage
    private android.graphics.NinePatch.InsetStruct mNinePatchInsets;// may be null
     ...
     * @unknown 
     */
    public int mDensity = android.graphics.Bitmap.getDefaultDensity();
     ...
     *
     *
     * @unknown Used only when ResourcesImpl.TRACE_FOR_DETAILED_PRELOAD is true.
     */
    ...
    public static void setDefaultDensity(int density) {
        android.graphics.Bitmap.sDefaultDensity = density;
    }
    ...
    static int getDefaultDensity() {
        ...
        android.graphics.Bitmap.sDefaultDensity = android.util.DisplayMetrics.DENSITY_DEVICE;
        return android.graphics.Bitmap.sDefaultDensity;
    }
    ...
    Bitmap(long nativeBitmap, int width, int height, int density, boolean requestPremultiplied, byte[] ninePatchChunk, android.graphics.NinePatch.InsetStruct ninePatchInsets) {
        this(nativeBitmap, width, height, density, requestPremultiplied, ninePatchChunk, ninePatchInsets, true);
    }

    // called from JNI and Bitmap_Delegate.
    Bitmap(long nativeBitmap, int width, int height, int density, boolean requestPremultiplied, byte[] ninePatchChunk, android.graphics.NinePatch.InsetStruct ninePatchInsets, boolean fromMalloc) {
        if (nativeBitmap == 0) {
        ...
        if (fromMalloc) {
            registry = libcore.util.NativeAllocationRegistry.createMalloced(android.graphics.Bitmap.class.getClassLoader(), android.graphics.Bitmap.nativeGetNativeFinalizer(), allocationByteCount);
        } else {
            registry = libcore.util.NativeAllocationRegistry.createNonmalloced(android.graphics.Bitmap.class.getClassLoader(), android.graphics.Bitmap.nativeGetNativeFinalizer(), allocationByteCount);
        }
        registry.registerNativeAllocation(this, nativeBitmap);
        if (android.content.res.ResourcesImpl.TRACE_FOR_DETAILED_PRELOAD) {
            android.graphics.Bitmap.sPreloadTracingNumInstantiatedBitmaps++;
            long nativeSize = android.graphics.Bitmap.NATIVE_ALLOCATION_SIZE + allocationByteCount;
            android.graphics.Bitmap.sPreloadTracingTotalBitmapsSize += nativeSize;
        }
    }
    ...
    public int getDensity() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getDensity() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return mDensity;
    }
    ...
    /**
     * <p>Modifies the bitmap to have a specified width, height, and {@link Config}, without affecting the underlying allocation backing the bitmap.
    ...
    public void reconfigure(int width, int height, android.graphics.Bitmap.Config config) {
        ...
        android.graphics.Bitmap.nativeReconfigure(mNativePtr, width, height, config.nativeInt, mRequestPremultiplied);
        mWidth = width;
        mHeight = height;
        mColorSpace = null;
    }
     ...
     *
     * @param chunk
     * 		The definition of the nine patch
     * @unknown 
     */
    @android.annotation.UnsupportedAppUsage
    ...
    public void recycle() {
        if (!mRecycled) {
            android.graphics.Bitmap.nativeRecycle(mNativePtr);
    ...
    public int getGenerationId() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getGenerationId() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.nativeGenerationId(mNativePtr);
    }
     ...
     */
    private void checkHardware(java.lang.String errorMessage) {
     ...
     *
     * @param x
     * 		x coordinate to ensure is >= 0
     * @param y
     * 		y coordinate to ensure is >= 0
     */
     ...
     *
     * @param width
     * 		width to ensure is > 0
     * @param height
     * 		height to ensure is > 0
     */
    ...
    public enum Config {
        ...
        private static android.graphics.Bitmap.Config[] sConfigs = new android.graphics.Bitmap.Config[]{ null, android.graphics.Bitmap.Config.ALPHA_8, null, android.graphics.Bitmap.Config.RGB_565, android.graphics.Bitmap.Config.ARGB_4444, android.graphics.Bitmap.Config.ARGB_8888, android.graphics.Bitmap.Config.RGBA_F16, android.graphics.Bitmap.Config.HARDWARE };
        ...
        @android.annotation.UnsupportedAppUsage
        static android.graphics.Bitmap.Config nativeToConfig(int ni) {
            return android.graphics.Bitmap.Config.sConfigs[ni];
        }
    }
     ...
     * 		if the bitmap's config is {@link Config#HARDWARE}
     */
    public void copyPixelsToBuffer(java.nio.Buffer dst) {
        ...
        if (dst instanceof java.nio.ByteBuffer) {
            ...
            if (dst instanceof java.nio.ShortBuffer) {
                shift = 1;
            } else
                if (dst instanceof java.nio.IntBuffer) {
                    shift = 2;
                } else {
        ...
        android.graphics.Bitmap.nativeCopyPixelsToBuffer(mNativePtr, dst);
    ...
    public void copyPixelsFromBuffer(java.nio.Buffer src) {
        ...
        int shift;
        if (src instanceof java.nio.ByteBuffer) {
            shift = 0;
        } else
        ...
        android.graphics.Bitmap.nativeCopyPixelsFromBuffer(mNativePtr, src);
        // now update the buffer's position
     ...
     * 		if config is {@link Config#HARDWARE} and isMutable is true
     */
    public android.graphics.Bitmap copy(android.graphics.Bitmap.Config config, boolean isMutable) {
        checkRecycled("Can't copy a recycled bitmap");
        if ((config == android.graphics.Bitmap.Config.HARDWARE) && isMutable) {
            throw new java.lang.IllegalArgumentException("Hardware bitmaps are always immutable");
        }
        noteHardwareBitmapSlowCall();
        android.graphics.Bitmap b = android.graphics.Bitmap.nativeCopy(mNativePtr, config.nativeInt, isMutable);
        if (b != null) {
    ...
    public android.graphics.Bitmap createAshmemBitmap() {
        checkRecycled("Can't copy a recycled bitmap");
        noteHardwareBitmapSlowCall();
        android.graphics.Bitmap b = android.graphics.Bitmap.nativeCopyAshmem(mNativePtr);
        if (b != null) {
            b.setPremultiplied(mRequestPremultiplied);
            b.mDensity = mDensity;
        }
     ...
     */
    @android.annotation.UnsupportedAppUsage
    public android.graphics.Bitmap createAshmemBitmap(android.graphics.Bitmap.Config config) {
        checkRecycled("Can't copy a recycled bitmap");
        noteHardwareBitmapSlowCall();
        android.graphics.Bitmap b = android.graphics.Bitmap.nativeCopyAshmemConfig(mNativePtr, config.nativeInt);
        if (b != null) {
            b.setPremultiplied(mRequestPremultiplied);
            b.mDensity = mDensity;
        }
     ...
     * @param colorSpace
     * 		The color space of the bitmap. Must be a {@link ColorSpace.Rgb} colorspace.
     * 		If null, SRGB is assumed.
     * @return A bitmap wrapping the buffer, or null if there was a problem creating the bitmap.
     * @throws IllegalArgumentException
     * 		if the HardwareBuffer has an invalid usage, or an invalid
     * 		colorspace is given.
     */
    @android.annotation.Nullable
    public static android.graphics.Bitmap wrapHardwareBuffer(@android.annotation.NonNull
    android.hardware.HardwareBuffer hardwareBuffer, @android.annotation.Nullable
    android.graphics.ColorSpace colorSpace) {
        if ((hardwareBuffer.getUsage() & android.hardware.HardwareBuffer.USAGE_GPU_SAMPLED_IMAGE) == 0) {
        ...
        return android.graphics.Bitmap.nativeWrapHardwareBufferBitmap(hardwareBuffer, colorSpace.getNativeInstance());
    }
    ...
    @android.annotation.Nullable
    public static android.graphics.Bitmap wrapHardwareBuffer(@android.annotation.NonNull
    android.graphics.GraphicBuffer graphicBuffer, @android.annotation.Nullable
    android.graphics.ColorSpace colorSpace) {
        try (android.hardware.HardwareBuffer hb = android.hardware.HardwareBuffer.createFromGraphicBuffer(graphicBuffer)) {
            return android.graphics.Bitmap.wrapHardwareBuffer(hb, colorSpace);
        }
    }
     ...
     */
    public static android.graphics.Bitmap createScaledBitmap(@android.annotation.NonNull
    android.graphics.Bitmap src, int dstWidth, int dstHeight, boolean filter) {
        ...
        return android.graphics.Bitmap.createBitmap(src, 0, 0, width, height, m, filter);
    }
     ...
     */
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
     ...
     */
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    android.graphics.Bitmap source, int x, int y, int width, int height) {
     ...
     */
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    android.graphics.Bitmap source, int x, int y, int width, int height, @android.annotation.Nullable
    android.graphics.Matrix m, boolean filter) {
        ...
        boolean isHardware = source.getConfig() == android.graphics.Bitmap.Config.HARDWARE;
        if (isHardware) {
            source.noteHardwareBitmapSlowCall();
            source = android.graphics.Bitmap.nativeCopyPreserveInternalConfig(source.mNativePtr);
        }
        int neww = width;
        int newh = height;
        ...
        final android.graphics.Bitmap.Config config = source.getConfig();
        ...
        if (config != null) {
            switch (config) {
                ...
                case ALPHA_8 :
                    ...
                    break;
                case RGBA_F16 :
                    newConfig = android.graphics.Bitmap.Config.RGBA_F16;
                    break;
        ...
        android.graphics.ColorSpace cs = source.getColorSpace();
        if ((m == null) || m.isIdentity()) {
            bitmap = android.graphics.Bitmap.createBitmap(null, neww, newh, newConfig, source.hasAlpha(), cs);
            paint = null;// not needed

        } else {
            final boolean transformed = !m.rectStaysRect();
            m.mapRect(deviceR, dstR);
            neww = java.lang.Math.round(deviceR.width());
            newh = java.lang.Math.round(deviceR.height());
            android.graphics.Bitmap.Config transformedConfig = newConfig;
            if (transformed) {
                if ((transformedConfig != android.graphics.Bitmap.Config.ARGB_8888) && (transformedConfig != android.graphics.Bitmap.Config.RGBA_F16)) {
                    transformedConfig = android.graphics.Bitmap.Config.ARGB_8888;
                    if (cs == null) {
                        cs = android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB);
                    }
                }
            }
            bitmap = android.graphics.Bitmap.createBitmap(null, neww, newh, transformedConfig, transformed || source.hasAlpha(), cs);
        ...
        if (isHardware) {
            return bitmap.copy(android.graphics.Bitmap.Config.HARDWARE, false);
        }
        return bitmap;
    }
     ...
     */
    public static android.graphics.Bitmap createBitmap(int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        return android.graphics.Bitmap.createBitmap(width, height, config, true);
    }
    ...
    android.util.DisplayMetrics display, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        return android.graphics.Bitmap.createBitmap(display, width, height, config, true);
    }
     ...
     * 		The bitmap config to create.
     * @param hasAlpha
     * 		If the bitmap is ARGB_8888 or RGBA_16F this flag can be used to
     ...
     */
    public static android.graphics.Bitmap createBitmap(int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config, boolean hasAlpha) {
        return android.graphics.Bitmap.createBitmap(null, width, height, config, hasAlpha);
    }
     ...
     * 		instead of transparent.
     * @param colorSpace
     * 		The color space of the bitmap. If the config is {@link Config#RGBA_F16}
     ...
     * @throws IllegalArgumentException
     * 		if the width or height are <= 0, if
     ...
     */
    public static android.graphics.Bitmap createBitmap(int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config, boolean hasAlpha, @android.annotation.NonNull
    android.graphics.ColorSpace colorSpace) {
        return android.graphics.Bitmap.createBitmap(null, width, height, config, hasAlpha, colorSpace);
    }
    ...
    android.util.DisplayMetrics display, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config, boolean hasAlpha) {
        return android.graphics.Bitmap.createBitmap(display, width, height, config, hasAlpha, android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB));
    }
    ...
    android.graphics.ColorSpace colorSpace) {
        ...
        android.graphics.Bitmap bm = android.graphics.Bitmap.nativeCreate(null, 0, width, width, height, config.nativeInt, true, colorSpace == null ? 0 : colorSpace.getNativeInstance());
        if (display != null) {
            bm.mDensity = display.densityDpi;
        }
        bm.setHasAlpha(hasAlpha);
        if (((config == android.graphics.Bitmap.Config.ARGB_8888) || (config == android.graphics.Bitmap.Config.RGBA_F16)) && (!hasAlpha)) {
            android.graphics.Bitmap.nativeErase(bm.mNativePtr, 0xff000000);
        }
     ...
     *
     * @param colors
     * 		Array of sRGB {@link Color colors} used to initialize the pixels.
     * @param offset
    ...
    int[] colors, int offset, int stride, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        return android.graphics.Bitmap.createBitmap(null, colors, offset, stride, width, height, config);
    }
     ...
     */
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    android.util.DisplayMetrics display, @android.annotation.NonNull
    @android.annotation.ColorInt
    int[] colors, int offset, int stride, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        android.graphics.Bitmap.checkWidthHeight(width, height);
        ...
        android.graphics.Bitmap bm = android.graphics.Bitmap.nativeCreate(colors, offset, stride, width, height, config.nativeInt, false, sRGB.getNativeInstance());
        if (display != null) {
            bm.mDensity = display.densityDpi;
        }
        return bm;
    ...
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    @android.annotation.ColorInt
    int[] colors, int width, int height, android.graphics.Bitmap.Config config) {
        return android.graphics.Bitmap.createBitmap(null, colors, 0, width, width, height, config);
    }
    ...
    android.util.DisplayMetrics display, @android.annotation.NonNull
    @android.annotation.ColorInt
    int[] colors, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        return android.graphics.Bitmap.createBitmap(display, colors, 0, width, width, height, config);
    }
     ...
     *
     * @param source
     * 		The recorded {@link Picture} of drawing commands that will be
    ...
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    android.graphics.Picture source) {
        return android.graphics.Bitmap.createBitmap(source, source.getWidth(), source.getHeight(), android.graphics.Bitmap.Config.HARDWARE);
    }
     ...
     * 		drawn into the returned Bitmap.
     * @param width
     * 		The width of the bitmap to create. The picture's width will be
     * 		scaled to match if necessary.
     * @param height
     * 		The height of the bitmap to create. The picture's height will be
     * 		scaled to match if necessary.
     * @param config
     * 		The {@link Config} of the created bitmap.
     * @return An immutable bitmap with a configuration specified by the config parameter
     */
    @android.annotation.NonNull
    public static android.graphics.Bitmap createBitmap(@android.annotation.NonNull
    android.graphics.Picture source, int width, int height, @android.annotation.NonNull
    android.graphics.Bitmap.Config config) {
        if ((width <= 0) || (height <= 0)) {
        ...
        source.endRecording();
        if (source.requiresHardwareAcceleration() && (config != android.graphics.Bitmap.Config.HARDWARE)) {
            android.os.StrictMode.noteSlowCall("GPU readback");
        }
        if ((config == android.graphics.Bitmap.Config.HARDWARE) || source.requiresHardwareAcceleration()) {
            final android.graphics.RenderNode node = android.graphics.RenderNode.create("BitmapTemporary", null);
            node.setLeftTopRightBottom(0, 0, width, height);
            node.setClipToBounds(false);
            node.setForceDarkAllowed(false);
            final android.graphics.RecordingCanvas canvas = node.beginRecording(width, height);
            if ((source.getWidth() != width) || (source.getHeight() != height)) {
                canvas.scale(width / ((float) (source.getWidth())), height / ((float) (source.getHeight())));
            }
            canvas.drawPicture(source);
            node.endRecording();
            android.graphics.Bitmap bitmap = android.view.ThreadedRenderer.createHardwareBitmap(node, width, height);
            if (config != android.graphics.Bitmap.Config.HARDWARE) {
     ...
     *
     * @param outInsets
     * 		Rect to populate with optical insets
     * @unknown 
     */
    public void getOpticalInsets(@android.annotation.NonNull
    ...
    public boolean compress(android.graphics.Bitmap.CompressFormat format, int quality, java.io.OutputStream stream) {
        ...
        android.os.Trace.traceBegin(Trace.TRACE_TAG_RESOURCES, "Bitmap.compress");
        boolean result = android.graphics.Bitmap.nativeCompress(mNativePtr, format.nativeInt, quality, stream, new byte[android.graphics.Bitmap.WORKING_COMPRESS_STORAGE]);
    ...
    public final boolean isMutable() {
        return !android.graphics.Bitmap.nativeIsImmutable(mNativePtr);
    }
    ...
    public void setImmutable() {
        if (isMutable()) {
            android.graphics.Bitmap.nativeSetImmutable(mNativePtr);
        }
    }
    ...
    public final boolean isPremultiplied() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called isPremultiplied() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.nativeIsPremultiplied(mNativePtr);
    }
     ...
     * a Bitmap (through {@link #setPixel}, {@link #setPixels}, or {@link BitmapFactory.Options#inPremultiplied BitmapFactory.Options.inPremultiplied})
    ...
    public final void setPremultiplied(boolean premultiplied) {
        ...
        android.graphics.Bitmap.nativeSetPremultiplied(mNativePtr, premultiplied);
    }
    ...
    public final int getWidth() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getWidth() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return mWidth;
    }
    ...
    public final int getHeight() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getHeight() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return mHeight;
    }
    ...
    public int getScaledWidth(android.graphics.Canvas canvas) {
        return android.graphics.Bitmap.scaleFromDensity(getWidth(), mDensity, canvas.mDensity);
    }
    ...
    public int getScaledHeight(android.graphics.Canvas canvas) {
        return android.graphics.Bitmap.scaleFromDensity(getHeight(), mDensity, canvas.mDensity);
    }
    ...
    public int getScaledWidth(android.util.DisplayMetrics metrics) {
        return android.graphics.Bitmap.scaleFromDensity(getWidth(), mDensity, metrics.densityDpi);
    }
    ...
    public int getScaledHeight(android.util.DisplayMetrics metrics) {
        return android.graphics.Bitmap.scaleFromDensity(getHeight(), mDensity, metrics.densityDpi);
    }
    ...
    public int getScaledWidth(int targetDensity) {
        return android.graphics.Bitmap.scaleFromDensity(getWidth(), mDensity, targetDensity);
    }
    ...
    public int getScaledHeight(int targetDensity) {
        return android.graphics.Bitmap.scaleFromDensity(getHeight(), mDensity, targetDensity);
    }
    ...
    public static int scaleFromDensity(int size, int sdensity, int tdensity) {
        if (((sdensity == android.graphics.Bitmap.DENSITY_NONE) || (tdensity == android.graphics.Bitmap.DENSITY_NONE)) || (sdensity == tdensity)) {
            return size;
        }
    ...
    public final int getRowBytes() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getRowBytes() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.nativeRowBytes(mNativePtr);
    }
    ...
    public final int getByteCount() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getByteCount() on a recycle()'d bitmap! " + "This is undefined behavior!");
            return 0;
        }
     ...
     * decode other bitmaps of smaller size, or by manual reconfiguration. See {@link #reconfigure(int, int, Config)}, {@link #setWidth(int)}, {@link #setHeight(int)}, {@link #setConfig(Bitmap.Config)}, and {@link BitmapFactory.Options#inBitmap
    ...
    public final int getAllocationByteCount() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getAllocationByteCount() on a recycle()'d bitmap! " + "This is undefined behavior!");
            return 0;
        }
        return android.graphics.Bitmap.nativeGetAllocationByteCount(mNativePtr);
    }
    ...
    public final android.graphics.Bitmap.Config getConfig() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called getConfig() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.Config.nativeToConfig(android.graphics.Bitmap.nativeConfig(mNativePtr));
    }
    ...
    public final boolean hasAlpha() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called hasAlpha() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.nativeHasAlpha(mNativePtr);
    }
    ...
    public void setHasAlpha(boolean hasAlpha) {
        ...
        android.graphics.Bitmap.nativeSetHasAlpha(mNativePtr, hasAlpha, mRequestPremultiplied);
    }
    ...
    public final boolean hasMipMap() {
        if (mRecycled) {
            android.util.Log.w(android.graphics.Bitmap.TAG, "Called hasMipMap() on a recycle()'d bitmap! This is undefined behavior!");
        }
        return android.graphics.Bitmap.nativeHasMipMap(mNativePtr);
    }
    ...
    public final void setHasMipMap(boolean hasMipMap) {
        ...
        android.graphics.Bitmap.nativeSetHasMipMap(mNativePtr, hasMipMap);
    }
    ...
    public final android.graphics.ColorSpace getColorSpace() {
        ...
        if (mColorSpace == null) {
            mColorSpace = android.graphics.Bitmap.nativeComputeColorSpace(mNativePtr);
        }
        return mColorSpace;
    }
     ...
     *
     * @throws IllegalArgumentException
     * 		If the specified color space is {@code null}, not
     ...
     * @throws IllegalArgumentException
     * 		If the {@code Config} (returned by {@link #getConfig()})
     * 		is {@link Config#ALPHA_8}.
     * @param colorSpace
     * 		to assign to the bitmap
     */
    public void setColorSpace(@android.annotation.NonNull
    android.graphics.ColorSpace colorSpace) {
        ...
        // Exception.
        final android.graphics.ColorSpace oldColorSpace = getColorSpace();
        android.graphics.Bitmap.nativeSetColorSpace(mNativePtr, colorSpace.getNativeInstance());
        // This will update mColorSpace. It may not be the same as |colorSpace|, e.g. if we
        // corrected it because the Bitmap is F16.
        mColorSpace = null;
        final android.graphics.ColorSpace newColorSpace = getColorSpace();
        try {
            ...
            android.graphics.Bitmap.nativeSetColorSpace(mNativePtr, mColorSpace.getNativeInstance());
            throw e;
        }
    }
     ...
     */
    public void eraseColor(@android.annotation.ColorInt
    int c) {
        checkRecycled("Can't erase a recycled bitmap");
        if (!isMutable()) {
            throw new java.lang.IllegalStateException("cannot erase immutable bitmaps");
        }
        android.graphics.Bitmap.nativeErase(mNativePtr, c);
    }
     ...
     *
     * @param color
     * 		The color to fill as packed by the {@link Color} class.
     * @throws IllegalStateException
     * 		if the bitmap is not mutable.
     * @throws IllegalArgumentException
     ...
     */
    public void eraseColor(@android.annotation.ColorLong
    long color) {
        checkRecycled("Can't erase a recycled bitmap");
        if (!isMutable()) {
            throw new java.lang.IllegalStateException("cannot erase immutable bitmaps");
        ...
        android.graphics.Bitmap.nativeErase(mNativePtr, cs.getNativeInstance(), color);
    }
    ...
    public int getPixel(int x, int y) {
        ...
        return android.graphics.Bitmap.nativeGetPixel(mNativePtr, x, y);
    }

    private static float clamp(float value, @android.annotation.NonNull
    android.graphics.ColorSpace cs, int index) {
        return java.lang.Math.max(java.lang.Math.min(value, cs.getMaxValue(index)), cs.getMinValue(index));
    }
    ...
    public android.graphics.Color getColor(int x, int y) {
        ...
        checkPixelAccess(x, y);
        final android.graphics.ColorSpace cs = getColorSpace();
        if (cs.equals(android.graphics.ColorSpace.get(android.graphics.ColorSpace.Named.SRGB))) {
            return android.graphics.Color.valueOf(android.graphics.Bitmap.nativeGetPixel(mNativePtr, x, y));
        }
        // The returned value is in kRGBA_F16_SkColorType, which is packed as
        // four half-floats, r,g,b,a.
        long rgba = android.graphics.Bitmap.nativeGetColor(mNativePtr, x, y);
        float r = android.util.Half.toFloat(((short) ((rgba >> 0) & 0xffff)));
        float g = android.util.Half.toFloat(((short) ((rgba >> 16) & 0xffff)));
        float b = android.util.Half.toFloat(((short) ((rgba >> 32) & 0xffff)));
        float a = android.util.Half.toFloat(((short) ((rgba >> 48) & 0xffff)));
        // Skia may draw outside of the numerical range of the colorSpace.
        // Clamp to get an expected value.
        return android.graphics.Color.valueOf(android.graphics.Bitmap.clamp(r, cs, 0), android.graphics.Bitmap.clamp(g, cs, 1), android.graphics.Bitmap.clamp(b, cs, 2), a, cs);
    }
     ...
     * 		if the bitmap's config is {@link Config#HARDWARE}
     */
    public void getPixels(@android.annotation.ColorInt
    int[] pixels, int offset, int stride, int x, int y, int width, int height) {
        ...
        android.graphics.Bitmap.nativeGetPixels(mNativePtr, pixels, offset, stride, x, y, width, height);
    }
     ...
     *
     * @param x
     * 		left edge of the area of pixels to access
     * @param y
     * 		top edge of the area of pixels to access
     * @param width
     * 		width of the area of pixels to access
     * @param height
     * 		height of the area of pixels to access
     * @param offset
     * 		offset into pixels[] array
     * @param stride
     * 		number of elements in pixels[] between each logical row
     * @param pixels
     ...
     * 		bounds.
     */
    public void setPixel(int x, int y, @android.annotation.ColorInt
    int color) {
        ...
        checkPixelAccess(x, y);
        android.graphics.Bitmap.nativeSetPixel(mNativePtr, x, y, color);
    }
     ...
     * 		to receive the specified number of pixels.
     */
    public void setPixels(@android.annotation.ColorInt
    int[] pixels, int offset, int stride, int x, int y, int width, int height) {
        ...
        checkPixelsAccess(x, y, width, height, offset, stride, pixels);
        android.graphics.Bitmap.nativeSetPixels(mNativePtr, pixels, offset, stride, x, y, width, height);
    }

    @android.annotation.NonNull
    public static final android.os.Parcelable.Creator<android.graphics.Bitmap> CREATOR = new android.os.Parcelable.Creator<android.graphics.Bitmap>() {
        /**
         * Rebuilds a bitmap previously stored with writeToParcel().
         *
         * @param p
         * 		Parcel object to read the bitmap from
         * @return a new bitmap created from the data in the parcel
         */
        public android.graphics.Bitmap createFromParcel(android.os.Parcel p) {
            android.graphics.Bitmap bm = nativeCreateFromParcel(p);
            if (bm == null) {
        ...
        public android.graphics.Bitmap[] newArray(int size) {
            return new android.graphics.Bitmap[size];
        }
    };
    ...
    public void writeToParcel(android.os.Parcel p, int flags) {
        ...
        noteHardwareBitmapSlowCall();
        if (!android.graphics.Bitmap.nativeWriteToParcel(mNativePtr, isMutable(), mDensity, p)) {
    ...
    public android.graphics.Bitmap extractAlpha(android.graphics.Paint paint, int[] offsetXY) {
        ...
        noteHardwareBitmapSlowCall();
        android.graphics.Bitmap bm = android.graphics.Bitmap.nativeExtractAlpha(mNativePtr, nativePaint, offsetXY);
        if (bm == null) {
    ...
    public boolean sameAs(android.graphics.Bitmap other) {
        ...
        return android.graphics.Bitmap.nativeSameAs(mNativePtr, other.mNativePtr);
    }
    ...
    public void prepareToDraw() {
        ...
        // draw path.
        android.graphics.Bitmap.nativePrepareToDraw(mNativePtr);
    }
    ...
    public android.graphics.GraphicBuffer createGraphicBufferHandle() {
        return android.graphics.Bitmap.nativeCreateGraphicBufferHandle(mNativePtr);
    }

    // ////////// native methods
    private static native android.graphics.Bitmap nativeCreate(int[] colors, int offset, int stride, int width, int height, int nativeConfig, boolean mutable, long nativeColorSpace);

    private static native android.graphics.Bitmap nativeCopy(long nativeSrcBitmap, int nativeConfig, boolean isMutable);

    private static native android.graphics.Bitmap nativeCopyAshmem(long nativeSrcBitmap);

    private static native android.graphics.Bitmap nativeCopyAshmemConfig(long nativeSrcBitmap, int nativeConfig);
    ...
    @android.annotation.UnsupportedAppUsage
    private static native void nativeReconfigure(long nativeBitmap, int width, int height, int config, boolean isPremultiplied);

    private static native boolean nativeCompress(long nativeBitmap, int format, int quality, java.io.OutputStream stream, byte[] tempStorage);
    ...
    private static native void nativeGetPixels(long nativeBitmap, int[] pixels, int offset, int stride, int x, int y, int width, int height);

    private static native void nativeSetPixel(long nativeBitmap, int x, int y, int color);

    private static native void nativeSetPixels(long nativeBitmap, int[] colors, int offset, int stride, int x, int y, int width, int height);

    private static native void nativeCopyPixelsToBuffer(long nativeBitmap, java.nio.Buffer dst);

    private static native void nativeCopyPixelsFromBuffer(long nativeBitmap, java.nio.Buffer src);
    ...
    private static native boolean nativeWriteToParcel(long nativeBitmap, boolean isMutable, int density, android.os.Parcel p);

    // returns a new bitmap built from the native bitmap's alpha, and the paint
    private static native android.graphics.Bitmap nativeExtractAlpha(long nativeBitmap, long nativePaint, int[] offsetXY);
    ...
    private static native android.graphics.Bitmap nativeCopyPreserveInternalConfig(long nativeBitmap);

    private static native android.graphics.Bitmap nativeWrapHardwareBufferBitmap(android.hardware.HardwareBuffer buffer, long nativeColorSpace);

    private static native android.graphics.GraphicBuffer nativeCreateGraphicBufferHandle(long nativeBitmap);

    private static native android.graphics.ColorSpace nativeComputeColorSpace(long nativePtr);
