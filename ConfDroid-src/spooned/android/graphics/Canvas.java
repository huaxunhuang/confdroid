...
public class Canvas extends android.graphics.BaseCanvas {
    ...
    // may be null
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 117521088)
    ...
    public Canvas() {
        if (!isHardwareAccelerated()) {
            ...
            mNativeCanvasWrapper = android.graphics.Canvas.nInitRaster(0);
            mFinalizer = android.graphics.Canvas.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativeCanvasWrapper);
        } else {
            mFinalizer = null;
        }
    }
     ...
     */
    public Canvas(@android.annotation.NonNull
    android.graphics.Bitmap bitmap) {
        if (!bitmap.isMutable()) {
            throw new java.lang.IllegalStateException("Immutable bitmap passed to Canvas constructor");
        }
        throwIfCannotDraw(bitmap);
        mNativeCanvasWrapper = android.graphics.Canvas.nInitRaster(bitmap.getNativeInstance());
        mFinalizer = android.graphics.Canvas.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativeCanvasWrapper);
        mBitmap = bitmap;
     ...
     * @see #getDensity()
     */
    public void setBitmap(@android.annotation.Nullable
    android.graphics.Bitmap bitmap) {
        if (isHardwareAccelerated()) {
            throw new java.lang.RuntimeException("Can't set a bitmap device on a HW accelerated canvas");
        }
        android.graphics.Matrix preservedMatrix = null;
        if ((bitmap != null) && android.graphics.Canvas.sCompatibilitySetBitmap) {
            preservedMatrix = getMatrix();
        }
        if (bitmap == null) {
            android.graphics.Canvas.nSetBitmap(mNativeCanvasWrapper, 0);
            ...
            throwIfCannotDraw(bitmap);
            android.graphics.Canvas.nSetBitmap(mNativeCanvasWrapper, bitmap.getNativeInstance());
            mDensity = bitmap.mDensity;
        }
    ...
    public boolean isOpaque() {
        return android.graphics.Canvas.nIsOpaque(mNativeCanvasWrapper);
    }
     ...
     */
    public int getWidth() {
        return android.graphics.Canvas.nGetWidth(mNativeCanvasWrapper);
    }
    ...
    public int getHeight() {
        return android.graphics.Canvas.nGetHeight(mNativeCanvasWrapper);
    }
    ...
    public int getMaximumBitmapWidth() {
        return android.graphics.Canvas.MAXMIMUM_BITMAP_SIZE;
    }
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, value = { android.graphics.Canvas.ALL_SAVE_FLAG })
     ...
     */
    public static final int MATRIX_SAVE_FLAG = 0x1;
    ...
    behavior for all canvas types.
     */
    public static final int CLIP_SAVE_FLAG = 0x2;
     ...
     */
    public static final int HAS_ALPHA_LAYER_SAVE_FLAG = 0x4;
    ...
    {@link #saveLayerAlpha(RectF, int)}.
     */
    public static final int FULL_COLOR_LAYER_SAVE_FLAG = 0x8;
    ...
    private static void checkValidSaveFlags(int saveFlags) {
        if ((android.graphics.Canvas.sCompatiblityVersion >= Build.VERSION_CODES.P) && (saveFlags != android.graphics.Canvas.ALL_SAVE_FLAG)) {
     ...
     */
    public int save() {
        return android.graphics.Canvas.nSave(mNativeCanvasWrapper, android.graphics.Canvas.MATRIX_SAVE_FLAG | android.graphics.Canvas.CLIP_SAVE_FLAG);
    }
     ...
     * @return The value to pass to restoreToCount() to balance this save()
     */
    public int save(@android.graphics.Canvas.Saveflags
    int saveFlags) {
        return android.graphics.Canvas.nSave(mNativeCanvasWrapper, saveFlags);
    }
     ...
     * 		restore() is called.
     * @param saveFlags
     * 		see _SAVE_FLAG constants, generally {@link #ALL_SAVE_FLAG} is recommended
     * 		for performance reasons.
     * @return value to pass to restoreToCount() to balance this save()
     */
    public int saveLayer(@android.annotation.Nullable
    android.graphics.RectF bounds, @android.annotation.Nullable
    android.graphics.Paint paint, @android.graphics.Canvas.Saveflags
    int saveFlags) {
        if (bounds == null) {
            bounds = new android.graphics.RectF(getClipBounds());
        }
        android.graphics.Canvas.checkValidSaveFlags(saveFlags);
        return saveLayer(bounds.left, bounds.top, bounds.right, bounds.bottom, paint, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
     ...
     *
     * @param bounds
     * 		May be null. The maximum size the offscreen render target
     * 		needs to be (in local coordinates)
     * @param paint
     * 		This is copied, and is applied to the offscreen when
     * 		restore() is called.
    ...
    android.graphics.Paint paint) {
        return saveLayer(bounds, paint, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
    ...
    public int saveUnclippedLayer(int left, int top, int right, int bottom) {
        return android.graphics.Canvas.nSaveUnclippedLayer(mNativeCanvasWrapper, left, top, right, bottom);
    }
     ...
     * @param paint
     * 		This is copied and is applied to the area within the unclipped layer's
    ...
    public void restoreUnclippedLayer(int saveCount, android.graphics.Paint paint) {
        android.graphics.Canvas.nRestoreUnclippedLayer(mNativeCanvasWrapper, saveCount, paint.getNativeInstance());
    }
     ...
     */
    public int saveLayer(float left, float top, float right, float bottom, @android.annotation.Nullable
    android.graphics.Paint paint, @android.graphics.Canvas.Saveflags
    int saveFlags) {
        android.graphics.Canvas.checkValidSaveFlags(saveFlags);
        return android.graphics.Canvas.nSaveLayer(mNativeCanvasWrapper, left, top, right, bottom, paint != null ? paint.getNativeInstance() : 0, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
    ...
    public int saveLayer(float left, float top, float right, float bottom, @android.annotation.Nullable
    android.graphics.Paint paint) {
        return saveLayer(left, top, right, bottom, paint, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
     ...
     */
    public int saveLayerAlpha(@android.annotation.Nullable
    android.graphics.RectF bounds, int alpha, @android.graphics.Canvas.Saveflags
    int saveFlags) {
        if (bounds == null) {
            bounds = new android.graphics.RectF(getClipBounds());
        }
        android.graphics.Canvas.checkValidSaveFlags(saveFlags);
        return saveLayerAlpha(bounds.left, bounds.top, bounds.right, bounds.bottom, alpha, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
    ...
    android.graphics.RectF bounds, int alpha) {
        return saveLayerAlpha(bounds, alpha, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
     ...
     */
    public int saveLayerAlpha(float left, float top, float right, float bottom, int alpha, @android.graphics.Canvas.Saveflags
    int saveFlags) {
        android.graphics.Canvas.checkValidSaveFlags(saveFlags);
        alpha = java.lang.Math.min(255, java.lang.Math.max(0, alpha));
        return android.graphics.Canvas.nSaveLayerAlpha(mNativeCanvasWrapper, left, top, right, bottom, alpha, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
    ...
    public int saveLayerAlpha(float left, float top, float right, float bottom, int alpha) {
        return saveLayerAlpha(left, top, right, bottom, alpha, android.graphics.Canvas.ALL_SAVE_FLAG);
    }
     ...
     */
    public void restore() {
        if ((!android.graphics.Canvas.nRestore(mNativeCanvasWrapper)) && ((!android.graphics.Canvas.sCompatibilityRestore) || (!isHardwareAccelerated()))) {
    ...
    public int getSaveCount() {
        return android.graphics.Canvas.nGetSaveCount(mNativeCanvasWrapper);
    }
    ...
    public void restoreToCount(int saveCount) {
        if (saveCount < 1) {
            if ((!android.graphics.Canvas.sCompatibilityRestore) || (!isHardwareAccelerated())) {
        ...
        android.graphics.Canvas.nRestoreToCount(mNativeCanvasWrapper, saveCount);
    }
    ...
    public void translate(float dx, float dy) {
        ...
        android.graphics.Canvas.nTranslate(mNativeCanvasWrapper, dx, dy);
    }
    ...
    public void scale(float sx, float sy) {
        ...
        android.graphics.Canvas.nScale(mNativeCanvasWrapper, sx, sy);
    }
    ...
    public void rotate(float degrees) {
        ...
        android.graphics.Canvas.nRotate(mNativeCanvasWrapper, degrees);
    }
    ...
    public void skew(float sx, float sy) {
        ...
        android.graphics.Canvas.nSkew(mNativeCanvasWrapper, sx, sy);
    }
     ...
     */
    public void concat(@android.annotation.Nullable
    android.graphics.Matrix matrix) {
        if (matrix != null)
            android.graphics.Canvas.nConcat(mNativeCanvasWrapper, matrix.native_instance);
     ...
     * @see #concat(Matrix)
     */
    public void setMatrix(@android.annotation.Nullable
    android.graphics.Matrix matrix) {
        android.graphics.Canvas.nSetMatrix(mNativeCanvasWrapper, matrix == null ? 0 : matrix.native_instance);
    }
    ...
    android.graphics.Matrix ctm) {
        android.graphics.Canvas.nGetMatrix(mNativeCanvasWrapper, ctm.native_instance);
    }
    ...
    private static void checkValidClipOp(@android.annotation.NonNull
    android.graphics.Region.Op op) {
        if (((android.graphics.Canvas.sCompatiblityVersion >= Build.VERSION_CODES.P) && (op != android.graphics.Region.Op.INTERSECT)) && (op != android.graphics.Region.Op.DIFFERENCE)) {
     ...
     */
    @java.lang.Deprecated
    public boolean clipRect(@android.annotation.NonNull
    android.graphics.RectF rect, @android.annotation.NonNull
    android.graphics.Region.Op op) {
        android.graphics.Canvas.checkValidClipOp(op);
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, op.nativeInt);
    }
     ...
     * @unknown 
     */
    public boolean clipRectUnion(@android.annotation.NonNull
    android.graphics.Rect rect) {
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, android.graphics.Region.Op.UNION.nativeInt);
    }
    ...
    android.graphics.RectF rect) {
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, android.graphics.Region.Op.INTERSECT.nativeInt);
    }
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipOutRect(@android.annotation.NonNull
    android.graphics.RectF rect) {
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom, android.graphics.Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     */
    @java.lang.Deprecated
    public boolean clipRect(float left, float top, float right, float bottom, @android.annotation.NonNull
    android.graphics.Region.Op op) {
        android.graphics.Canvas.checkValidClipOp(op);
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, left, top, right, bottom, op.nativeInt);
    }
    ...
    public boolean clipRect(float left, float top, float right, float bottom) {
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, left, top, right, bottom, android.graphics.Region.Op.INTERSECT.nativeInt);
    }
    ...
    public boolean clipOutRect(float left, float top, float right, float bottom) {
        return android.graphics.Canvas.nClipRect(mNativeCanvasWrapper, left, top, right, bottom, android.graphics.Region.Op.DIFFERENCE.nativeInt);
    }
     ...
     */
    @java.lang.Deprecated
    public boolean clipPath(@android.annotation.NonNull
    android.graphics.Path path, @android.annotation.NonNull
    android.graphics.Region.Op op) {
        android.graphics.Canvas.checkValidClipOp(op);
        return android.graphics.Canvas.nClipPath(mNativeCanvasWrapper, path.readOnlyNI(), op.nativeInt);
    }
     ...
     * @return true if the resulting clip is non-empty
     */
    public boolean clipOutPath(@android.annotation.NonNull
    android.graphics.Path path) {
     ...
     */
    @java.lang.Deprecated
    public boolean clipRegion(@android.annotation.NonNull
    ...
    public void setDrawFilter(@android.annotation.Nullable
    android.graphics.DrawFilter filter) {
        ...
        mDrawFilter = filter;
        android.graphics.Canvas.nSetDrawFilter(mNativeCanvasWrapper, nativeFilter);
    }
     ...
     * @param type
     * 		{@link Canvas.EdgeType#AA} if the path should be considered antialiased,
    ...
    android.graphics.Canvas.EdgeType type) {
        return android.graphics.Canvas.nQuickReject(mNativeCanvasWrapper, rect.left, rect.top, rect.right, rect.bottom);
    }
    ...
    android.graphics.Path path, @android.annotation.NonNull
    android.graphics.Canvas.EdgeType type) {
        return android.graphics.Canvas.nQuickReject(mNativeCanvasWrapper, path.readOnlyNI());
    }
    ...
    does not intersect with the canvas' clip
     */
    public boolean quickReject(float left, float top, float right, float bottom, @android.annotation.NonNull
    android.graphics.Canvas.EdgeType type) {
        return android.graphics.Canvas.nQuickReject(mNativeCanvasWrapper, left, top, right, bottom);
    }
     ...
     */
    public boolean getClipBounds(@android.annotation.Nullable
    android.graphics.Rect bounds) {
        return android.graphics.Canvas.nGetClipBounds(mNativeCanvasWrapper, bounds);
    }
     ...
     */
    public void drawPicture(@android.annotation.NonNull
    ...
    public static void setCompatibilityVersion(int apiLevel) {
        android.graphics.Canvas.sCompatiblityVersion = apiLevel;
        android.graphics.Canvas.nSetCompatibilityVersion(apiLevel);
    }
    ...
    @dalvik.annotation.optimization.CriticalNative
    private static native int nSaveLayer(long nativeCanvas, float l, float t, float r, float b, long nativePaint, int layerFlags);

    @dalvik.annotation.optimization.CriticalNative
    private static native int nSaveLayerAlpha(long nativeCanvas, float l, float t, float r, float b, int alpha, int layerFlags);

    @dalvik.annotation.optimization.CriticalNative
    private static native int nSaveUnclippedLayer(long nativeCanvas, int l, int t, int r, int b);

    @dalvik.annotation.optimization.CriticalNative
    private static native void nRestoreUnclippedLayer(long nativeCanvas, int saveCount, long nativePaint);
    ...
    @dalvik.annotation.optimization.CriticalNative
    private static native boolean nClipRect(long nativeCanvas, float left, float top, float right, float bottom, int regionOp);
    ...
    @dalvik.annotation.optimization.CriticalNative
    private static native boolean nQuickReject(long nativeCanvas, float left, float top, float right, float bottom);
     ...
     * @param useCenter
     * 		If true, include the center of the oval in the arc, and close it if it is
     ...
     *
     * @param color
     * 		the {@code ColorLong} to draw onto the canvas. See the {@link Color}
     * 		class for details about {@code ColorLong}s.
     * @throws IllegalArgumentException
     * 		if the color space encoded in the {@code ColorLong}
     * 		is invalid or unknown.
     */
    public void drawColor(@android.annotation.ColorLong
    long color) {
        super.drawColor(color, android.graphics.BlendMode.SRC_OVER);
    }
     ...
     * 		The outer rectangular bounds of the roundRect to be drawn
     * @param outerRadii
     * 		Array of 8 float representing the x, y corner radii for top left,
     ...
     * @param contextCount
     * 		the number of characters in the context for shaping. contexIndex +
     ...
     * 		the text to render
     * @param start
     * 		the start of the text to render. Data before this position can be used for
     * 		shaping context.
     * @param end
     ...
     */
    public void drawTextRun(@android.annotation.NonNull
    android.graphics.text.MeasuredText text, int start, int end, int contextStart, int contextEnd, float x, float y, boolean isRtl, @android.annotation.NonNull
    android.graphics.Paint paint) {
        super.drawTextRun(text, start, end, contextStart, contextEnd, x, y, isRtl, paint);
    }
     ...
     * @param vertexCount
     * 		The number of values in the vertices array (and corresponding texs and
     ...
     * @param indices
     * 		If not null, array of indices to reference into the vertex (texs, colors)
     * 		array.
     * @param indexCount
