...
public class BitmapFactory {
    ...
    public static class Options {
         ...
         * byte count} of the decoded bitmap is less than or equal to the {@link Bitmap#getAllocationByteCount() allocated byte count} of the reused
        ...
        static void validate(android.graphics.BitmapFactory.Options opts) {
            if (opts == null)
                return;
            ...
            if (opts.inPreferredColorSpace != null) {
                ...
                if (((android.graphics.ColorSpace.Rgb) (opts.inPreferredColorSpace)).getTransferParameters() == null) {
         ...
         */
        static long nativeInBitmap(android.graphics.BitmapFactory.Options opts) {
         ...
         * 		if the ColorSpace is not Rgb or does
         * 		not have TransferParameters.
         */
        static long nativeColorSpace(android.graphics.BitmapFactory.Options opts) {
     ...
     * @throws IllegalArgumentException
     * 		if {@link BitmapFactory.Options#inPreferredConfig}
     * 		is {@link android.graphics.Bitmap.Config#HARDWARE}
     * 		and {@link BitmapFactory.Options#inMutable} is set, if the specified color space
     * 		is not {@link ColorSpace.Model#RGB RGB}, or if the specified color space's transfer
     * 		function is not an {@link ColorSpace.Rgb.TransferParameters ICC parametric curve}
     */
    public static android.graphics.Bitmap decodeFile(java.lang.String pathName, android.graphics.BitmapFactory.Options opts) {
        android.graphics.BitmapFactory.Options.validate(opts);
        ...
        try {
             ...
             */
            android.util.Log.e("BitmapFactory", "Unable to decode stream: " + e);
        } finally {
            if (stream != null) {
                try {
                    stream.close();
    ...
    public static android.graphics.Bitmap decodeResourceStream(@android.annotation.Nullable
    ...
    android.graphics.Rect pad, @android.annotation.Nullable
    ...
    public static android.graphics.Bitmap decodeByteArray(byte[] data, int offset, int length, android.graphics.BitmapFactory.Options opts) {
        ...
        android.os.Trace.traceBegin(Trace.TRACE_TAG_GRAPHICS, "decodeBitmap");
        try {
            bm = android.graphics.BitmapFactory.nativeDecodeByteArray(data, offset, length, opts, android.graphics.BitmapFactory.Options.nativeInBitmap(opts), android.graphics.BitmapFactory.Options.nativeColorSpace(opts));
            if (((bm == null) && (opts != null)) && (opts.inBitmap != null)) {
                throw new java.lang.IllegalArgumentException("Problem decoding into existing bitmap");
            }
            android.graphics.BitmapFactory.setDensityFromOptions(bm, opts);
        } finally {
            android.os.Trace.traceEnd(Trace.TRACE_TAG_GRAPHICS);
        }
        return bm;
    }
     ...
     */
    private static void setDensityFromOptions(android.graphics.Bitmap outputBitmap, android.graphics.BitmapFactory.Options opts) {
        ...
        if (density != 0) {
            ...
            final boolean isNinePatch = (np != null) && android.graphics.NinePatch.isNinePatchChunk(np);
     ...
     */
    @android.annotation.Nullable
    public static android.graphics.Bitmap decodeStream(@android.annotation.Nullable
    java.io.InputStream is, @android.annotation.Nullable
    android.graphics.Rect outPadding, @android.annotation.Nullable
    android.graphics.BitmapFactory.Options opts) {
        ...
        try {
            if (is instanceof android.content.res.AssetManager.AssetInputStream) {
                ...
                bm = android.graphics.BitmapFactory.nativeDecodeAsset(asset, outPadding, opts, android.graphics.BitmapFactory.Options.nativeInBitmap(opts), android.graphics.BitmapFactory.Options.nativeColorSpace(opts));
            } else {
                bm = android.graphics.BitmapFactory.decodeStreamInternal(is, outPadding, opts);
            }
            if (((bm == null) && (opts != null)) && (opts.inBitmap != null)) {
                throw new java.lang.IllegalArgumentException("Problem decoding into existing bitmap");
            }
     ...
     */
    private static android.graphics.Bitmap decodeStreamInternal(@android.annotation.NonNull
    java.io.InputStream is, @android.annotation.Nullable
    android.graphics.Rect outPadding, @android.annotation.Nullable
    android.graphics.BitmapFactory.Options opts) {
        // ASSERT(is != null);
        ...
        return android.graphics.BitmapFactory.nativeDecodeStream(is, tempStorage, outPadding, opts, android.graphics.BitmapFactory.Options.nativeInBitmap(opts), android.graphics.BitmapFactory.Options.nativeColorSpace(opts));
    }
    ...
    public static android.graphics.Bitmap decodeFileDescriptor(java.io.FileDescriptor fd, android.graphics.Rect outPadding, android.graphics.BitmapFactory.Options opts) {
        android.graphics.BitmapFactory.Options.validate(opts);
        android.graphics.Bitmap bm;
        android.os.Trace.traceBegin(Trace.TRACE_TAG_GRAPHICS, "decodeFileDescriptor");
        try {
            if (android.graphics.BitmapFactory.nativeIsSeekable(fd)) {
                bm = android.graphics.BitmapFactory.nativeDecodeFileDescriptor(fd, outPadding, opts, android.graphics.BitmapFactory.Options.nativeInBitmap(opts), android.graphics.BitmapFactory.Options.nativeColorSpace(opts));
            } else {
                java.io.FileInputStream fis = new java.io.FileInputStream(fd);
                try {
                    bm = android.graphics.BitmapFactory.decodeStreamInternal(fis, outPadding, opts);
                } finally {
                    try {
                        fis.close();
    ...
    private static native android.graphics.Bitmap nativeDecodeStream(java.io.InputStream is, byte[] storage, android.graphics.Rect padding, android.graphics.BitmapFactory.Options opts, long inBitmapHandle, long colorSpaceHandle);

    @android.annotation.UnsupportedAppUsage
    private static native android.graphics.Bitmap nativeDecodeFileDescriptor(java.io.FileDescriptor fd, android.graphics.Rect padding, android.graphics.BitmapFactory.Options opts, long inBitmapHandle, long colorSpaceHandle);

    @android.annotation.UnsupportedAppUsage
    private static native android.graphics.Bitmap nativeDecodeAsset(long nativeAsset, android.graphics.Rect padding, android.graphics.BitmapFactory.Options opts, long inBitmapHandle, long colorSpaceHandle);

    @android.annotation.UnsupportedAppUsage
    private static native android.graphics.Bitmap nativeDecodeByteArray(byte[] data, int offset, int length, android.graphics.BitmapFactory.Options opts, long inBitmapHandle, long colorSpaceHandle);
