...
public class Paint {
     ...
     * @unknown 
     */
    public int mBidiFlags = android.graphics.Paint.BIDI_DEFAULT_LTR;

    static final android.graphics.Paint.Style[] sStyleArray = new android.graphics.Paint.Style[]{ android.graphics.Paint.Style.FILL, android.graphics.Paint.Style.STROKE, android.graphics.Paint.Style.FILL_AND_STROKE };

    static final android.graphics.Paint.Cap[] sCapArray = new android.graphics.Paint.Cap[]{ android.graphics.Paint.Cap.BUTT, android.graphics.Paint.Cap.ROUND, android.graphics.Paint.Cap.SQUARE };

    static final android.graphics.Paint.Join[] sJoinArray = new android.graphics.Paint.Join[]{ android.graphics.Paint.Join.MITER, android.graphics.Paint.Join.ROUND, android.graphics.Paint.Join.BEVEL };

    static final android.graphics.Paint.Align[] sAlignArray = new android.graphics.Paint.Align[]{ android.graphics.Paint.Align.LEFT, android.graphics.Paint.Align.CENTER, android.graphics.Paint.Align.RIGHT };
     ...
     * @see #setFlags(int)
     */
    public static final int ANTI_ALIAS_FLAG = 0x1;
     ...
     * @see #setFlags(int)
     */
    public static final int FILTER_BITMAP_FLAG = 0x2;
     ...
     * @see #setFlags(int)
     */
    public static final int DITHER_FLAG = 0x4;
     ...
     * @see #setFlags(int)
     */
    public static final int UNDERLINE_TEXT_FLAG = 0x8;
     ...
     *
     *
     * @unknown bit mask for the flag enabling subpixel glyph rendering for text
     */
     ...
     *
     *
     * @unknown bit mask for the flag forcing freetype's autohinter on for text
     */
     ...
     *
     *
     * @unknown bit mask for the flag enabling vertical rendering for text
     */
    public static final int VERTICAL_TEXT_FLAG = 0x1000;

    // These flags are always set on a new/reset paint, even if flags 0 is passed.
    static final int HIDDEN_DEFAULT_PAINT_FLAGS = (android.graphics.Paint.DEV_KERN_TEXT_FLAG | android.graphics.Paint.EMBEDDED_BITMAP_TEXT_FLAG) | android.graphics.Paint.FILTER_BITMAP_FLAG;
     ...
     * @unknown 
     */
    private static final int BIDI_MAX_FLAG_VALUE = android.graphics.Paint.BIDI_FORCE_RTL;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "CURSOR_" }, value = { android.graphics.Paint.CURSOR_AFTER, android.graphics.Paint.CURSOR_AT_OR_AFTER, android.graphics.Paint.CURSOR_BEFORE, android.graphics.Paint.CURSOR_AT_OR_BEFORE })
     ...
     */
    private static final int CURSOR_OPT_MAX_VALUE = android.graphics.Paint.CURSOR_AT;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "START_HYPHEN_EDIT_" }, value = { android.graphics.Paint.START_HYPHEN_EDIT_NO_EDIT, android.graphics.Paint.START_HYPHEN_EDIT_INSERT_HYPHEN, android.graphics.Paint.START_HYPHEN_EDIT_INSERT_ZWJ })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public static final int START_HYPHEN_EDIT_NO_EDIT = 0x0;

    /**
     * An integer representing the starting of the line has normal hyphen character (U+002D).
     */
    public static final int START_HYPHEN_EDIT_INSERT_HYPHEN = 0x1;

    /**
     * An integer representing the starting of the line has Zero-Width-Joiner (U+200D).
     */
    public static final int START_HYPHEN_EDIT_INSERT_ZWJ = 0x2;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "END_HYPHEN_EDIT_" }, value = { android.graphics.Paint.END_HYPHEN_EDIT_NO_EDIT, android.graphics.Paint.END_HYPHEN_EDIT_REPLACE_WITH_HYPHEN, android.graphics.Paint.END_HYPHEN_EDIT_INSERT_HYPHEN, android.graphics.Paint.END_HYPHEN_EDIT_INSERT_ARMENIAN_HYPHEN, android.graphics.Paint.END_HYPHEN_EDIT_INSERT_MAQAF, android.graphics.Paint.END_HYPHEN_EDIT_INSERT_UCAS_HYPHEN, android.graphics.Paint.END_HYPHEN_EDIT_INSERT_ZWJ_AND_HYPHEN })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    public Paint(int flags) {
        mNativePaint = android.graphics.Paint.nInit();
        android.graphics.Paint.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativePaint);
        setFlags(flags | android.graphics.Paint.HIDDEN_DEFAULT_PAINT_FLAGS);
    ...
    public Paint(android.graphics.Paint paint) {
        mNativePaint = android.graphics.Paint.nInitWithPaint(paint.getNativeInstance());
        android.graphics.Paint.NoImagePreloadHolder.sRegistry.registerNativeAllocation(this, mNativePaint);
     ...
     */
    public void reset() {
        android.graphics.Paint.nReset(mNativePaint);
        setFlags(android.graphics.Paint.HIDDEN_DEFAULT_PAINT_FLAGS);
        // TODO: Turning off hinting has undesirable side effects, we need to
        // revisit hinting once we add support for subpixel positioning
        // setHinting(DisplayMetrics.DENSITY_DEVICE >= DisplayMetrics.DENSITY_TV
        // ? HINTING_OFF : HINTING_ON);
        ...
        mCompatScaling = 1;
        mInvCompatScaling = 1;
        mBidiFlags = android.graphics.Paint.BIDI_DEFAULT_LTR;
        setTextLocales(android.os.LocaleList.getAdjustedDefault());
    ...
    public void set(android.graphics.Paint src) {
        if (this != src) {
            ...
            android.graphics.Paint.nSet(mNativePaint, src.mNativePaint);
    ...
    public long getNativeInstance() {
        ...
        if (newNativeShader != mNativeShader) {
            ...
            android.graphics.Paint.nSetShader(mNativePaint, mNativeShader);
        }
        ...
        if (newNativeColorFilter != mNativeColorFilter) {
            ...
            android.graphics.Paint.nSetColorFilter(mNativePaint, mNativeColorFilter);
        }
        return mNativePaint;
    }
    ...
    public void setBidiFlags(int flags) {
        ...
        flags &= android.graphics.Paint.BIDI_FLAG_MASK;
        if (flags > android.graphics.Paint.BIDI_MAX_FLAG_VALUE) {
            throw new java.lang.IllegalArgumentException("unknown bidi flag: " + flags);
        }
        mBidiFlags = flags;
    }
     ...
     */
    public int getFlags() {
        return android.graphics.Paint.nGetFlags(mNativePaint);
    }
    ...
    public void setFlags(int flags) {
        android.graphics.Paint.nSetFlags(mNativePaint, flags);
    }
    ...
    public int getHinting() {
        return android.graphics.Paint.nGetHinting(mNativePaint);
    }
    ...
    public void setHinting(int mode) {
        android.graphics.Paint.nSetHinting(mNativePaint, mode);
    }
    ...
    public final boolean isAntiAlias() {
        return (getFlags() & android.graphics.Paint.ANTI_ALIAS_FLAG) != 0;
    }
    ...
    public void setAntiAlias(boolean aa) {
        android.graphics.Paint.nSetAntiAlias(mNativePaint, aa);
    }
    ...
    public final boolean isDither() {
        return (getFlags() & android.graphics.Paint.DITHER_FLAG) != 0;
    }
    ...
    public void setDither(boolean dither) {
        android.graphics.Paint.nSetDither(mNativePaint, dither);
    }
    ...
    public final boolean isLinearText() {
        return (getFlags() & android.graphics.Paint.LINEAR_TEXT_FLAG) != 0;
    }
    ...
    public void setLinearText(boolean linearText) {
        android.graphics.Paint.nSetLinearText(mNativePaint, linearText);
    }
    ...
    public final boolean isSubpixelText() {
        return (getFlags() & android.graphics.Paint.SUBPIXEL_TEXT_FLAG) != 0;
    }
    ...
    public void setSubpixelText(boolean subpixelText) {
        android.graphics.Paint.nSetSubpixelText(mNativePaint, subpixelText);
    }
    ...
    public final boolean isUnderlineText() {
        return (getFlags() & android.graphics.Paint.UNDERLINE_TEXT_FLAG) != 0;
    }
    ...
    public float getUnderlinePosition() {
        return android.graphics.Paint.nGetUnderlinePosition(mNativePaint);
    }
    ...
    public float getUnderlineThickness() {
        return android.graphics.Paint.nGetUnderlineThickness(mNativePaint);
    }
    ...
    public void setUnderlineText(boolean underlineText) {
        android.graphics.Paint.nSetUnderlineText(mNativePaint, underlineText);
    }
    ...
    public final boolean isStrikeThruText() {
        return (getFlags() & android.graphics.Paint.STRIKE_THRU_TEXT_FLAG) != 0;
    }
    ...
    public float getStrikeThruPosition() {
        return android.graphics.Paint.nGetStrikeThruPosition(mNativePaint);
    }
    ...
    public float getStrikeThruThickness() {
        return android.graphics.Paint.nGetStrikeThruThickness(mNativePaint);
    }
    ...
    public void setStrikeThruText(boolean strikeThruText) {
        android.graphics.Paint.nSetStrikeThruText(mNativePaint, strikeThruText);
    }
    ...
    public final boolean isFakeBoldText() {
        return (getFlags() & android.graphics.Paint.FAKE_BOLD_TEXT_FLAG) != 0;
    }
    ...
    public void setFakeBoldText(boolean fakeBoldText) {
        android.graphics.Paint.nSetFakeBoldText(mNativePaint, fakeBoldText);
    }
    ...
    public final boolean isFilterBitmap() {
        return (getFlags() & android.graphics.Paint.FILTER_BITMAP_FLAG) != 0;
    }
    ...
    public void setFilterBitmap(boolean filter) {
        android.graphics.Paint.nSetFilterBitmap(mNativePaint, filter);
    }
    ...
    public android.graphics.Paint.Style getStyle() {
        return android.graphics.Paint.sStyleArray[android.graphics.Paint.nGetStyle(mNativePaint)];
    }
    ...
    public void setStyle(android.graphics.Paint.Style style) {
        android.graphics.Paint.nSetStyle(mNativePaint, style.nativeInt);
    }
    ...
    int color) {
        android.graphics.Paint.nSetColor(mNativePaint, color);
     ...
     *
     * @param color
     * 		The new color (including alpha and {@link ColorSpace})
     * 		to set in the paint.
     * @throws IllegalArgumentException
     * 		if the color space encoded in the
     * 		{@code ColorLong} is invalid or unknown.
     */
    public void setColor(@android.annotation.ColorLong
    long color) {
        android.graphics.ColorSpace cs = android.graphics.Color.colorSpace(color);
        android.graphics.Paint.nSetColor(mNativePaint, cs.getNativeInstance(), color);
        mColor = color;
    }
     ...
     */
    public int getAlpha() {
        return java.lang.Math.round(android.graphics.Color.alpha(mColor) * 255.0F);
    }
    ...
    public void setAlpha(int a) {
        ...
        // b/122959599
        android.graphics.ColorSpace cs = android.graphics.Color.colorSpace(mColor);
        ...
        android.graphics.Paint.nSetAlpha(mNativePaint, a);
    }
    ...
    public float getStrokeWidth() {
        return android.graphics.Paint.nGetStrokeWidth(mNativePaint);
    }
    ...
    public void setStrokeWidth(float width) {
        android.graphics.Paint.nSetStrokeWidth(mNativePaint, width);
    }
    ...
    public float getStrokeMiter() {
        return android.graphics.Paint.nGetStrokeMiter(mNativePaint);
    }
    ...
    public void setStrokeMiter(float miter) {
        android.graphics.Paint.nSetStrokeMiter(mNativePaint, miter);
    }
    ...
    public android.graphics.Paint.Cap getStrokeCap() {
        return android.graphics.Paint.sCapArray[android.graphics.Paint.nGetStrokeCap(mNativePaint)];
    }
    ...
    public void setStrokeCap(android.graphics.Paint.Cap cap) {
        android.graphics.Paint.nSetStrokeCap(mNativePaint, cap.nativeInt);
    }
    ...
    public android.graphics.Paint.Join getStrokeJoin() {
        return android.graphics.Paint.sJoinArray[android.graphics.Paint.nGetStrokeJoin(mNativePaint)];
    }
    ...
    public void setStrokeJoin(android.graphics.Paint.Join join) {
        android.graphics.Paint.nSetStrokeJoin(mNativePaint, join.nativeInt);
    }
    ...
    public boolean getFillPath(android.graphics.Path src, android.graphics.Path dst) {
        return android.graphics.Paint.nGetFillPath(mNativePaint, src.readOnlyNI(), dst.mutateNI());
    }
    ...
    public android.graphics.Shader setShader(android.graphics.Shader shader) {
        ...
        if (mShader != shader) {
            ...
            android.graphics.Paint.nSetShader(mNativePaint, 0);
        }
    ...
    public android.graphics.BlendMode getBlendMode() {
        if (mXfermode == null) {
            ...
            return android.graphics.BlendMode.fromValue(mXfermode.porterDuffMode);
        }
    }
    ...
    private android.graphics.Xfermode installXfermode(android.graphics.Xfermode xfermode) {
        int newMode = (xfermode != null) ? xfermode.porterDuffMode : android.graphics.Xfermode.DEFAULT;
        int curMode = (mXfermode != null) ? mXfermode.porterDuffMode : android.graphics.Xfermode.DEFAULT;
        if (newMode != curMode) {
            android.graphics.Paint.nSetXfermode(mNativePaint, newMode);
        }
        mXfermode = xfermode;
        return xfermode;
    }
    ...
    public android.graphics.PathEffect setPathEffect(android.graphics.PathEffect effect) {
        ...
        android.graphics.Paint.nSetPathEffect(mNativePaint, effectNative);
        mPathEffect = effect;
        return effect;
    }
    ...
    public android.graphics.MaskFilter setMaskFilter(android.graphics.MaskFilter maskfilter) {
        ...
        android.graphics.Paint.nSetMaskFilter(mNativePaint, maskfilterNative);
    ...
    public android.graphics.Typeface setTypeface(android.graphics.Typeface typeface) {
        ...
        android.graphics.Paint.nSetTypeface(mNativePaint, typefaceNative);
        mTypeface = typeface;
        return typeface;
    }
     ...
     */
    public void setShadowLayer(float radius, float dx, float dy, @android.annotation.ColorInt
    int shadowColor) {
     ...
     * 		{@code ColorLong} is invalid or unknown.
     */
    public void setShadowLayer(float radius, float dx, float dy, @android.annotation.ColorLong
    long shadowColor) {
        android.graphics.ColorSpace cs = android.graphics.Color.colorSpace(shadowColor);
        android.graphics.Paint.nSetShadowLayer(mNativePaint, radius, dx, dy, cs.getNativeInstance(), shadowColor);
    ...
    public boolean hasShadowLayer() {
        return android.graphics.Paint.nHasShadowLayer(mNativePaint);
    }
    ...
    public android.graphics.Paint.Align getTextAlign() {
        return android.graphics.Paint.sAlignArray[android.graphics.Paint.nGetTextAlign(mNativePaint)];
    }
    ...
    public void setTextAlign(android.graphics.Paint.Align align) {
        android.graphics.Paint.nSetTextAlign(mNativePaint, align.nativeInt);
    }
    ...
    java.util.Locale locale) {
        ...
        mLocales = new android.os.LocaleList(locale);
     ...
     *
     * @param locales
     * 		the paint's locale list for drawing text, must not be null or empty.
     */
    ...
    private void syncTextLocalesWithMinikin() {
        final java.lang.String languageTags = mLocales.toLanguageTags();
        final java.lang.Integer minikinLocaleListId;
        synchronized(android.graphics.Paint.sCacheLock) {
            minikinLocaleListId = android.graphics.Paint.sMinikinLocaleListIdCache.get(languageTags);
            if (minikinLocaleListId == null) {
                final int newID = android.graphics.Paint.nSetTextLocales(mNativePaint, languageTags);
                android.graphics.Paint.sMinikinLocaleListIdCache.put(languageTags, newID);
                return;
            }
        }
        android.graphics.Paint.nSetTextLocalesByMinikinLocaleListId(mNativePaint, minikinLocaleListId.intValue());
    }
    ...
    public boolean isElegantTextHeight() {
        return android.graphics.Paint.nIsElegantTextHeight(mNativePaint);
    }
     ...
     *
     * @param elegant
     * 		set the paint's elegant metrics flag for drawing text.
     */
    public void setElegantTextHeight(boolean elegant) {
        android.graphics.Paint.nSetElegantTextHeight(mNativePaint, elegant);
    }
    ...
    public float getTextSize() {
        return android.graphics.Paint.nGetTextSize(mNativePaint);
    }
    ...
    public void setTextSize(float textSize) {
        android.graphics.Paint.nSetTextSize(mNativePaint, textSize);
    }
    ...
    public float getTextScaleX() {
        return android.graphics.Paint.nGetTextScaleX(mNativePaint);
    }
    ...
    public void setTextScaleX(float scaleX) {
        android.graphics.Paint.nSetTextScaleX(mNativePaint, scaleX);
    }
    ...
    public float getTextSkewX() {
        return android.graphics.Paint.nGetTextSkewX(mNativePaint);
    }
    ...
    public void setTextSkewX(float skewX) {
        android.graphics.Paint.nSetTextSkewX(mNativePaint, skewX);
    }
    ...
    public float getLetterSpacing() {
        return android.graphics.Paint.nGetLetterSpacing(mNativePaint);
    }
     ...
     *
     * @param letterSpacing
     * 		set the paint's letter-spacing for drawing text.
     */
    public void setLetterSpacing(float letterSpacing) {
        android.graphics.Paint.nSetLetterSpacing(mNativePaint, letterSpacing);
    }
    ...
    public float getWordSpacing() {
        return android.graphics.Paint.nGetWordSpacing(mNativePaint);
    }
     ...
     *
     * @param wordSpacing
     * 		set the paint's extra word-spacing for drawing text in pixels.
     * @see #getWordSpacing()
     */
    public void setWordSpacing(@android.annotation.Px
    float wordSpacing) {
        android.graphics.Paint.nSetWordSpacing(mNativePaint, wordSpacing);
    }
     ...
     */
    public void setFontFeatureSettings(java.lang.String settings) {
        if ((settings != null) && settings.equals("")) {
            settings = null;
        }
        if (((settings == null) && (mFontFeatureSettings == null)) || ((settings != null) && settings.equals(mFontFeatureSettings))) {
            return;
        }
        mFontFeatureSettings = settings;
        android.graphics.Paint.nSetFontFeatureSettings(mNativePaint, settings);
    }
     ...
     */
    public boolean setFontVariationSettings(java.lang.String fontVariationSettings) {
        final java.lang.String settings = android.text.TextUtils.nullIfEmpty(fontVariationSettings);
        if ((settings == mFontVariationSettings) || ((settings != null) && settings.equals(mFontVariationSettings))) {
            return true;
        }
        if ((settings == null) || (settings.length() == 0)) {
            mFontVariationSettings = null;
            setTypeface(android.graphics.Typeface.createFromTypefaceWithVariation(mTypeface, java.util.Collections.emptyList()));
            return true;
        }
        ...
        android.graphics.Typeface targetTypeface = (mTypeface == null) ? android.graphics.Typeface.DEFAULT : mTypeface;
        ...
        final java.util.ArrayList<android.graphics.fonts.FontVariationAxis> filteredAxes = new java.util.ArrayList<android.graphics.fonts.FontVariationAxis>();
        for (final android.graphics.fonts.FontVariationAxis axis : axes) {
        ...
        setTypeface(android.graphics.Typeface.createFromTypefaceWithVariation(targetTypeface, filteredAxes));
        return true;
    }
    ...
    public int getStartHyphenEdit() {
        return android.graphics.Paint.nGetStartHyphenEdit(mNativePaint);
    }
    ...
    public int getEndHyphenEdit() {
        return android.graphics.Paint.nGetEndHyphenEdit(mNativePaint);
    }
     ...
     *
     * @param startHyphen
     * 		a start hyphen edit value.
     * @see #getStartHyphenEdit()
     */
    public void setStartHyphenEdit(@android.graphics.Paint.StartHyphenEdit
    int startHyphen) {
        android.graphics.Paint.nSetStartHyphenEdit(mNativePaint, startHyphen);
    }
     ...
     *
     * @param endHyphen
     * 		a end hyphen edit value.
     * @see #getEndHyphenEdit()
     */
    public void setEndHyphenEdit(@android.graphics.Paint.EndHyphenEdit
    int endHyphen) {
        android.graphics.Paint.nSetEndHyphenEdit(mNativePaint, endHyphen);
    }
     ...
     */
    public float ascent() {
        return android.graphics.Paint.nAscent(mNativePaint);
    }
    ...
    public float descent() {
        return android.graphics.Paint.nDescent(mNativePaint);
    }
    ...
    public float getFontMetrics(android.graphics.Paint.FontMetrics metrics) {
        return android.graphics.Paint.nGetFontMetrics(mNativePaint, metrics);
    }
    ...
    public int getFontMetricsInt(android.graphics.Paint.FontMetricsInt fmi) {
        return android.graphics.Paint.nGetFontMetricsInt(mNativePaint, fmi);
    }
    ...
    public float measureText(char[] text, int index, int count) {
        ...
        if (!mHasCompatScaling) {
            return ((float) (java.lang.Math.ceil(android.graphics.Paint.nGetTextAdvances(mNativePaint, text, index, count, index, count, mBidiFlags, null, 0))));
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
        final float w = android.graphics.Paint.nGetTextAdvances(mNativePaint, text, index, count, index, count, mBidiFlags, null, 0);
        setTextSize(oldSize);
        return ((float) (java.lang.Math.ceil(w * mInvCompatScaling)));
    }
     ...
     * @return The width of the text
     */
    public float measureText(java.lang.String text, int start, int end) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        ...
        if (!mHasCompatScaling) {
            return ((float) (java.lang.Math.ceil(android.graphics.Paint.nGetTextAdvances(mNativePaint, text, start, end, start, end, mBidiFlags, null, 0))));
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
        final float w = android.graphics.Paint.nGetTextAdvances(mNativePaint, text, start, end, start, end, mBidiFlags, null, 0);
        setTextSize(oldSize);
        return ((float) (java.lang.Math.ceil(w * mInvCompatScaling)));
    }
     ...
     * @return The width of the text
     */
    public float measureText(java.lang.CharSequence text, int start, int end) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
        ...
        if (text instanceof java.lang.String) {
            return measureText(((java.lang.String) (text)), start, end);
        }
        if ((text instanceof android.text.SpannedString) || (text instanceof android.text.SpannableString)) {
            return measureText(text.toString(), start, end);
        }
        if (text instanceof android.text.GraphicsOperations) {
            return measureText(start, end, this);
        }
    ...
    public int breakText(char[] text, int index, int count, float maxWidth, float[] measuredWidth) {
        ...
        if ((index < 0) || ((text.length - index) < java.lang.Math.abs(count))) {
            throw new java.lang.ArrayIndexOutOfBoundsException();
        }
        if ((text.length == 0) || (count == 0)) {
            return 0;
        ...
        if (!mHasCompatScaling) {
            return android.graphics.Paint.nBreakText(mNativePaint, text, index, count, maxWidth, mBidiFlags, measuredWidth);
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
        final int res = android.graphics.Paint.nBreakText(mNativePaint, text, index, count, maxWidth * mCompatScaling, mBidiFlags, measuredWidth);
        setTextSize(oldSize);
    ...
    abs(end - start).
     */
    public int breakText(java.lang.CharSequence text, int start, int end, boolean measureForwards, float maxWidth, float[] measuredWidth) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
        ...
        if (((start == 0) && (text instanceof java.lang.String)) && (end == text.length())) {
            return breakText(((java.lang.String) (text)), measureForwards, maxWidth, measuredWidth);
        }
        char[] buf = android.graphics.TemporaryBuffer.obtain(end - start);
        int result;
        android.text.TextUtils.getChars(text, start, end, buf, 0);
    ...
    abs(count).
     */
    public int breakText(java.lang.String text, boolean measureForwards, float maxWidth, float[] measuredWidth) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if (text.length() == 0) {
        ...
        if (!mHasCompatScaling) {
            return android.graphics.Paint.nBreakText(mNativePaint, text, measureForwards, maxWidth, mBidiFlags, measuredWidth);
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
        final int res = android.graphics.Paint.nBreakText(mNativePaint, text, measureForwards, maxWidth * mCompatScaling, mBidiFlags, measuredWidth);
        setTextSize(oldSize);
        if (measuredWidth != null)
            measuredWidth[0] *= mInvCompatScaling;
    ...
    public int getTextWidths(char[] text, int index, int count, float[] widths) {
        ...
        if (!mHasCompatScaling) {
            android.graphics.Paint.nGetTextAdvances(mNativePaint, text, index, count, index, count, mBidiFlags, widths, 0);
            return count;
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
     ...
     * @return the actual number of widths returned.
     */
    public int getTextWidths(java.lang.CharSequence text, int start, int end, float[] widths) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
        ...
        if (text instanceof java.lang.String) {
            return getTextWidths(((java.lang.String) (text)), start, end, widths);
        }
        if ((text instanceof android.text.SpannedString) || (text instanceof android.text.SpannableString)) {
            return getTextWidths(text.toString(), start, end, widths);
        }
        if (text instanceof android.text.GraphicsOperations) {
            return getTextWidths(start, end, widths, this);
        }
        char[] buf = android.graphics.TemporaryBuffer.obtain(end - start);
        android.text.TextUtils.getChars(text, start, end, buf, 0);
     ...
     */
    public int getTextWidths(java.lang.String text, int start, int end, float[] widths) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
        ...
        if (!mHasCompatScaling) {
            android.graphics.Paint.nGetTextAdvances(mNativePaint, text, start, end, start, end, mBidiFlags, widths, 0);
            return end - start;
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
     ...
     * @return the number of code units in the specified text.
     */
    public int getTextWidths(java.lang.String text, float[] widths) {
     ...
     * @param contextCount
     * 		the number of character to use for shaping context.
     * 		Context must cover the measureing target.
     * @param isRtl
     ...
     * @param advancesIndex
     * 		the position in advances at which to put the advance corresponding to
     * 		the character at start
     * @return the total advance in pixels
     */
    public float getTextRunAdvances(@android.annotation.NonNull
    char[] chars, @android.annotation.IntRange(from = 0)
    int index, @android.annotation.IntRange(from = 0)
    int count, @android.annotation.IntRange(from = 0)
    int contextIndex, @android.annotation.IntRange(from = 0)
    int contextCount, boolean isRtl, @android.annotation.Nullable
    float[] advances, @android.annotation.IntRange(from = 0)
    int advancesIndex) {
        if (chars == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        ...
        if (!mHasCompatScaling) {
            return android.graphics.Paint.nGetTextAdvances(mNativePaint, chars, index, count, contextIndex, contextCount, isRtl ? android.graphics.Paint.BIDI_FORCE_RTL : android.graphics.Paint.BIDI_FORCE_LTR, advances, advancesIndex);
        }
        final float oldSize = getTextSize();
        setTextSize(oldSize * mCompatScaling);
        final float res = android.graphics.Paint.nGetTextAdvances(mNativePaint, chars, index, count, contextIndex, contextCount, isRtl ? android.graphics.Paint.BIDI_FORCE_RTL : android.graphics.Paint.BIDI_FORCE_LTR, advances, advancesIndex);
        setTextSize(oldSize);
        if (advances != null) {
     ...
     */
    public int getTextRunCursor(@android.annotation.NonNull
    char[] text, @android.annotation.IntRange(from = 0)
    int contextStart, @android.annotation.IntRange(from = 0)
    int contextLength, boolean isRtl, @android.annotation.IntRange(from = 0)
    int offset, @android.graphics.Paint.CursorOption
    int cursorOpt) {
        int contextEnd = contextStart + contextLength;
        if (((((((((contextStart | contextEnd) | offset) | (contextEnd - contextStart)) | (offset - contextStart)) | (contextEnd - offset)) | (text.length - contextEnd)) | cursorOpt) < 0) || (cursorOpt > android.graphics.Paint.CURSOR_OPT_MAX_VALUE)) {
            throw new java.lang.IndexOutOfBoundsException();
        }
        return nGetTextRunCursor(mNativePaint, text, contextStart, contextLength, isRtl ? android.graphics.Paint.DIRECTION_RTL : android.graphics.Paint.DIRECTION_LTR, offset, cursorOpt);
    }
    ...
    int contextStart, @android.annotation.IntRange(from = 0)
    int contextEnd, boolean isRtl, @android.annotation.IntRange(from = 0)
    int offset, @android.graphics.Paint.CursorOption
    int cursorOpt) {
        ...
        if (text instanceof android.text.GraphicsOperations) {
            return getTextRunCursor(contextStart, contextEnd, isRtl, offset, cursorOpt, this);
        }
     ...
     */
    public int getTextRunCursor(@android.annotation.NonNull
    java.lang.String text, @android.annotation.IntRange(from = 0)
    int contextStart, @android.annotation.IntRange(from = 0)
    int contextEnd, boolean isRtl, @android.annotation.IntRange(from = 0)
    int offset, @android.graphics.Paint.CursorOption
    int cursorOpt) {
        ...
        return nGetTextRunCursor(mNativePaint, text, contextStart, contextEnd, isRtl ? android.graphics.Paint.DIRECTION_RTL : android.graphics.Paint.DIRECTION_LTR, offset, cursorOpt);
    }
     ...
     */
    public void getTextPath(char[] text, int index, int count, float x, float y, android.graphics.Path path) {
        if (((index | count) < 0) || ((index + count) > text.length)) {
            throw new java.lang.ArrayIndexOutOfBoundsException();
        }
        android.graphics.Paint.nGetTextPath(mNativePaint, mBidiFlags, text, index, count, x, y, path.mutateNI());
    }
     ...
     * 		the path to receive the data describing the text. Must be allocated by the caller
     */
    public void getTextPath(java.lang.String text, int start, int end, float x, float y, android.graphics.Path path) {
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
            throw new java.lang.IndexOutOfBoundsException();
        }
        android.graphics.Paint.nGetTextPath(mNativePaint, mBidiFlags, text, start, end, x, y, path.mutateNI());
    }
     ...
     */
    public void getTextBounds(java.lang.String text, int start, int end, android.graphics.Rect bounds) {
        if ((((start | end) | (end - start)) | (text.length() - end)) < 0) {
            throw new java.lang.IndexOutOfBoundsException();
        }
        if (bounds == null) {
        ...
        android.graphics.Paint.nGetStringBounds(mNativePaint, text, start, end, mBidiFlags, bounds);
    }
     ...
     * 		returns the unioned bounds of all the text. Must be allocated by the caller
     */
    public void getTextBounds(@android.annotation.NonNull
    java.lang.CharSequence text, int start, int end, @android.annotation.NonNull
    ...
    public void getTextBounds(char[] text, int index, int count, android.graphics.Rect bounds) {
        ...
        android.graphics.Paint.nGetCharArrayBounds(mNativePaint, text, index, count, mBidiFlags, bounds);
    }
     ...
     */
    public boolean hasGlyph(java.lang.String string) {
        return android.graphics.Paint.nHasGlyph(mNativePaint, mBidiFlags, string);
    }
    ...
    public float getRunAdvance(char[] text, int start, int end, int contextStart, int contextEnd, boolean isRtl, int offset) {
        ...
        return android.graphics.Paint.nGetRunAdvance(mNativePaint, text, start, end, contextStart, contextEnd, isRtl, offset);
    }
     ...
     * @return width measurement between start and offset
     */
    public float getRunAdvance(java.lang.CharSequence text, int start, int end, int contextStart, int contextEnd, boolean isRtl, int offset) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((((((((contextStart | start) | offset) | end) | contextEnd) | (start - contextStart)) | (offset - start)) | (end - offset)) | (contextEnd - end)) | (text.length() - contextEnd)) < 0) {
        ...
        char[] buf = android.graphics.TemporaryBuffer.obtain(contextEnd - contextStart);
        android.text.TextUtils.getChars(text, contextStart, contextEnd, buf, 0);
    ...
    public int getOffsetForAdvance(char[] text, int start, int end, int contextStart, int contextEnd, boolean isRtl, float advance) {
        ...
        // TODO: take mCompatScaling into account (or eliminate compat scaling)?
        return android.graphics.Paint.nGetOffsetForAdvance(mNativePaint, text, start, end, contextStart, contextEnd, isRtl, advance);
    }
     ...
     * @return index of offset
     */
    public int getOffsetForAdvance(java.lang.CharSequence text, int start, int end, int contextStart, int contextEnd, boolean isRtl, float advance) {
        if (text == null) {
            throw new java.lang.IllegalArgumentException("text cannot be null");
        }
        if ((((((((contextStart | start) | end) | contextEnd) | (start - contextStart)) | (end - start)) | (contextEnd - end)) | (text.length() - contextEnd)) < 0) {
     ...
     */
    public boolean equalsForTextMeasurement(@android.annotation.NonNull
    android.graphics.Paint other) {
        return android.graphics.Paint.nEqualsForTextMeasurement(mNativePaint, other.mNativePaint);
    }
    ...
    private static native int nBreakText(long nObject, char[] text, int index, int count, float maxWidth, int bidiFlags, float[] measuredWidth);

    private static native int nBreakText(long nObject, java.lang.String text, boolean measureForwards, float maxWidth, int bidiFlags, float[] measuredWidth);

    private static native float nGetTextAdvances(long paintPtr, char[] text, int index, int count, int contextIndex, int contextCount, int bidiFlags, float[] advances, int advancesIndex);

    private static native float nGetTextAdvances(long paintPtr, java.lang.String text, int start, int end, int contextStart, int contextEnd, int bidiFlags, float[] advances, int advancesIndex);

    private native int nGetTextRunCursor(long paintPtr, char[] text, int contextStart, int contextLength, int dir, int offset, int cursorOpt);

    private native int nGetTextRunCursor(long paintPtr, java.lang.String text, int contextStart, int contextEnd, int dir, int offset, int cursorOpt);

    private static native void nGetTextPath(long paintPtr, int bidiFlags, char[] text, int index, int count, float x, float y, long path);

    private static native void nGetTextPath(long paintPtr, int bidiFlags, java.lang.String text, int start, int end, float x, float y, long path);

    private static native void nGetStringBounds(long nativePaint, java.lang.String text, int start, int end, int bidiFlags, android.graphics.Rect bounds);

    private static native void nGetCharArrayBounds(long nativePaint, char[] text, int index, int count, int bidiFlags, android.graphics.Rect bounds);

    private static native boolean nHasGlyph(long paintPtr, int bidiFlags, java.lang.String string);

    private static native float nGetRunAdvance(long paintPtr, char[] text, int start, int end, int contextStart, int contextEnd, boolean isRtl, int offset);

    private static native int nGetOffsetForAdvance(long paintPtr, char[] text, int start, int end, int contextStart, int contextEnd, boolean isRtl, float advance);

    // ---------------- @FastNative ------------------------
    @dalvik.annotation.optimization.FastNative
    private static native int nSetTextLocales(long paintPtr, java.lang.String locales);

    @dalvik.annotation.optimization.FastNative
    private static native void nSetFontFeatureSettings(long paintPtr, java.lang.String settings);

    @dalvik.annotation.optimization.FastNative
    private static native float nGetFontMetrics(long paintPtr, android.graphics.Paint.FontMetrics metrics);

    @dalvik.annotation.optimization.FastNative
    private static native int nGetFontMetricsInt(long paintPtr, android.graphics.Paint.FontMetricsInt fmi);
    ...
    @dalvik.annotation.optimization.CriticalNative
    private static native void nSetTextLocalesByMinikinLocaleListId(long paintPtr, int mMinikinLocaleListId);

    @dalvik.annotation.optimization.CriticalNative
    private static native void nSetShadowLayer(long paintPtr, float radius, float dx, float dy, long colorSpaceHandle, @android.annotation.ColorLong
    long shadowColor);
    ...
    @dalvik.annotation.optimization.CriticalNative
    private static native void nSetColor(long paintPtr, long colorSpaceHandle, @android.annotation.ColorLong
    long color);

    @dalvik.annotation.optimization.CriticalNative
    private static native void nSetColor(long paintPtr, @android.annotation.ColorInt
    int color);
