...
public class ImageFormat {
    ...
    @android.annotation.IntDef({ android.graphics.ImageFormat.UNKNOWN, android.graphics.ImageFormat.RGB_565, android.graphics.ImageFormat.YV12, android.graphics.ImageFormat.Y8, android.graphics.ImageFormat.Y16, android.graphics.ImageFormat.NV16, android.graphics.ImageFormat.NV21, android.graphics.ImageFormat.YUY2, android.graphics.ImageFormat.JPEG, android.graphics.ImageFormat.DEPTH_JPEG, android.graphics.ImageFormat.YUV_420_888, android.graphics.ImageFormat.YUV_422_888, android.graphics.ImageFormat.YUV_444_888, android.graphics.ImageFormat.FLEX_RGB_888, android.graphics.ImageFormat.FLEX_RGBA_8888, android.graphics.ImageFormat.RAW_SENSOR, android.graphics.ImageFormat.RAW_PRIVATE, android.graphics.ImageFormat.RAW10, android.graphics.ImageFormat.RAW12, android.graphics.ImageFormat.DEPTH16, android.graphics.ImageFormat.DEPTH_POINT_CLOUD, android.graphics.ImageFormat.RAW_DEPTH, android.graphics.ImageFormat.PRIVATE, android.graphics.ImageFormat.HEIC })
     ...
     */
    public static int getBitsPerPixel(@android.graphics.ImageFormat.Format
    int format) {
        switch (format) {
            ...
            case android.graphics.ImageFormat.YUV_420_888 :
                return 12;
            case android.graphics.ImageFormat.YUV_422_888 :
                return 16;
            case android.graphics.ImageFormat.YUV_444_888 :
                return 24;
            case android.graphics.ImageFormat.FLEX_RGB_888 :
                return 24;
            case android.graphics.ImageFormat.FLEX_RGBA_8888 :
                return 32;
            case android.graphics.ImageFormat.RAW_DEPTH :
     ...
     * @unknown 
     */
    public static boolean isPublicFormat(@android.graphics.ImageFormat.Format
    int format) {
        switch (format) {
            case android.graphics.ImageFormat.RGB_565 :
            case android.graphics.ImageFormat.NV16 :
            ...
            case android.graphics.ImageFormat.RAW_DEPTH :
            case android.graphics.ImageFormat.Y8 :
            case android.graphics.ImageFormat.DEPTH_JPEG :
            case android.graphics.ImageFormat.HEIC :
                return true;
        }
        return false;
    }
