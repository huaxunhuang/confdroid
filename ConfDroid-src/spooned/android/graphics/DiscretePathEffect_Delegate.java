...
public class DiscretePathEffect_Delegate extends android.graphics.PathEffect_Delegate {
    // ---- delegate data ----
    ...
    static long nativeCreate(float length, float deviation) {
        android.graphics.DiscretePathEffect_Delegate newDelegate = new android.graphics.DiscretePathEffect_Delegate();
