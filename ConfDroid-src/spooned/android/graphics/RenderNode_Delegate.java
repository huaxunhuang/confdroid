...
public class RenderNode_Delegate {
    // ---- delegate manager ----
    private static final com.android.layoutlib.bridge.impl.DelegateManager<android.graphics.RenderNode_Delegate> sManager = new com.android.layoutlib.bridge.impl.DelegateManager<android.graphics.RenderNode_Delegate>(android.graphics.RenderNode_Delegate.class);
    ...
    static long nCreate(java.lang.String name) {
        android.graphics.RenderNode_Delegate renderNodeDelegate = new android.graphics.RenderNode_Delegate();
        renderNodeDelegate.mName = name;
        return android.graphics.RenderNode_Delegate.sManager.addNewDelegate(renderNodeDelegate);
    }

    /* package */
    @com.android.tools.layoutlib.annotations.LayoutlibDelegate
    static long nGetNativeFinalizer() {
        synchronized(android.graphics.RenderNode_Delegate.class) {
            if (android.graphics.RenderNode_Delegate.sFinalizer == (-1)) {
                android.graphics.RenderNode_Delegate.sFinalizer = libcore.util.NativeAllocationRegistry_Delegate.createFinalizer(android.graphics.RenderNode_Delegate.sManager::removeJavaReferenceFor);
            }
        }
        return android.graphics.RenderNode_Delegate.sFinalizer;
    }

    /* package */
    @com.android.tools.layoutlib.annotations.LayoutlibDelegate
    static boolean nSetElevation(long renderNode, float lift) {
        android.graphics.RenderNode_Delegate delegate = android.graphics.RenderNode_Delegate.sManager.getDelegate(renderNode);
    ...
    /* package */
    @com.android.tools.layoutlib.annotations.LayoutlibDelegate
    static void getMatrix(android.graphics.RenderNode renderNode, android.graphics.Matrix outMatrix) {
        outMatrix.reset();
        if (renderNode != null) {
