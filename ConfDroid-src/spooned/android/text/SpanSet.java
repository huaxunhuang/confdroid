...
public class SpanSet<E> {
    ...
    SpanSet(java.lang.Class<? extends E> type) {
        classType = type;
        numberOfSpans = 0;
    }

    @java.lang.SuppressWarnings("unchecked")
    public void init(android.text.Spanned spanned, int start, int limit) {
        ...
        if ((length > 0) && ((spans == null) || (spans.length < length))) {
            ...
            spans = ((E[]) (java.lang.reflect.Array.newInstance(classType, length)));
        ...
        if (numberOfSpans < prevNumberOfSpans) {
            ...
            java.util.Arrays.fill(spans, numberOfSpans, prevNumberOfSpans, null);
        }
    }
    ...
    public void recycle() {
        if (spans != null) {
            java.util.Arrays.fill(spans, 0, numberOfSpans, null);
        }
    }
}
