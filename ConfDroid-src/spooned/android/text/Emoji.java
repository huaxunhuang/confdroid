...
public class Emoji {
    ...
    public static boolean isEmojiModifierBase(int codePoint) {
        return java.util.Arrays.binarySearch(android.text.Emoji.EMOJI_MODIFIER_BASE, codePoint) >= 0;
    }

    // Returns true if the character has Emoji property.
    public static boolean isEmoji(int codePoint) {
        return java.util.Arrays.binarySearch(android.text.Emoji.EMOJI_LIST, codePoint) >= 0;
    }
