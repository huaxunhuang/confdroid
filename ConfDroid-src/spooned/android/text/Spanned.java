...
public interface Spanned extends java.lang.CharSequence {
     ...
     */
    public static final int SPAN_INCLUSIVE_EXCLUSIVE = android.text.Spanned.SPAN_MARK_MARK;

    /**
     * Spans of type SPAN_INCLUSIVE_INCLUSIVE expand
     * to include text inserted at either their starting or ending point.
     */
    public static final int SPAN_INCLUSIVE_INCLUSIVE = android.text.Spanned.SPAN_MARK_POINT;
     ...
     */
    public static final int SPAN_EXCLUSIVE_EXCLUSIVE = android.text.Spanned.SPAN_POINT_MARK;
     ...
     */
    public static final int SPAN_EXCLUSIVE_INCLUSIVE = android.text.Spanned.SPAN_POINT_POINT;
     ...
     * span object.
     */
    public static final int SPAN_USER = 0xffffffff << android.text.Spanned.SPAN_USER_SHIFT;
     ...
     * callbacks can inquire about the layout of the text.
     */
    public static final int SPAN_PRIORITY = 0xff << android.text.Spanned.SPAN_PRIORITY_SHIFT;
