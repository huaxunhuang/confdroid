...
class PackedIntVector {
    ...
    public int getValue(int row, int column) {
        ...
        if ((((row | column) < 0) || (row >= size())) || (column >= columns)) {
            throw new java.lang.IndexOutOfBoundsException((row + ", ") + column);
        }
        if (row >= mRowGapStart) {
            row += mRowGapLength;
        }
    ...
    public void adjustValuesBelow(int startRow, int column, int delta) {
        if ((((startRow | column) < 0) || (startRow > size())) || (column >= width())) {
            throw new java.lang.IndexOutOfBoundsException((startRow + ", ") + column);
        }
    ...
    public void insertAt(int row, int[] values) {
        ...
        if ((values != null) && (values.length < width())) {
            throw new java.lang.IndexOutOfBoundsException("value count " + values.length);
        }
        moveRowGapTo(row);
        if (mRowGapLength == 0) {
            growBuffer();
    ...
    public void deleteAt(int row, int count) {
        if (((row | count) < 0) || ((row + count) > size())) {
            throw new java.lang.IndexOutOfBoundsException((row + ", ") + count);
        }
    ...
    private final void growBuffer() {
        final int columns = mColumns;
        int[] newvalues = com.android.internal.util.ArrayUtils.newUnpaddedIntArray(com.android.internal.util.GrowingArrayUtils.growSize(size()) * columns);
        ...
        if (mValues != null) {
            java.lang.System.arraycopy(mValues, 0, newvalues, 0, columns * rowgapstart);
            java.lang.System.arraycopy(mValues, (mRows - after) * columns, newvalues, (newsize - after) * columns, after * columns);
        }
