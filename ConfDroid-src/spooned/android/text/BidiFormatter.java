...
public final class BidiFormatter {
    ...
    private static final java.lang.String LRM_STRING = java.lang.Character.toString(android.text.BidiFormatter.LRM);

    /* String representation of RLM */
    private static final java.lang.String RLM_STRING = java.lang.Character.toString(android.text.BidiFormatter.RLM);
    ...
    public static final class Builder {
         ...
         *
         * @param isRtlContext
         * 		Whether the context is RTL or not.
         */
        private void initialize(boolean isRtlContext) {
            mIsRtlContext = isRtlContext;
            mTextDirectionHeuristic = android.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC;
            mFlags = android.text.BidiFormatter.DEFAULT_FLAGS;
        }
        ...
        public android.text.BidiFormatter.Builder stereoReset(boolean stereoReset) {
            if (stereoReset) {
                mFlags |= android.text.BidiFormatter.FLAG_STEREO_RESET;
            } else {
                mFlags &= ~android.text.BidiFormatter.FLAG_STEREO_RESET;
            }
            return this;
         ...
         *
         * @param heuristic
         * 		the {@code TextDirectionHeuristic} to use.
        ...
        public android.text.BidiFormatter build() {
            if ((mFlags == android.text.BidiFormatter.DEFAULT_FLAGS) && (mTextDirectionHeuristic == android.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC)) {
                return android.text.BidiFormatter.getDefaultInstanceFromContext(mIsRtlContext);
            }
            return new android.text.BidiFormatter(mIsRtlContext, mFlags, mTextDirectionHeuristic);
        }
    }
    ...
    private static final int DEFAULT_FLAGS = android.text.BidiFormatter.FLAG_STEREO_RESET;

    private static final android.text.BidiFormatter DEFAULT_LTR_INSTANCE = /* LTR context */
    new android.text.BidiFormatter(false, android.text.BidiFormatter.DEFAULT_FLAGS, android.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC);

    private static final android.text.BidiFormatter DEFAULT_RTL_INSTANCE = /* RTL context */
    new android.text.BidiFormatter(true, android.text.BidiFormatter.DEFAULT_FLAGS, android.text.BidiFormatter.DEFAULT_TEXT_DIRECTION_HEURISTIC);
    ...
    public static android.text.BidiFormatter getInstance() {
        return android.text.BidiFormatter.getDefaultInstanceFromContext(android.text.BidiFormatter.isRtlLocale(java.util.Locale.getDefault()));
    }
    ...
    public static android.text.BidiFormatter getInstance(boolean rtlContext) {
        return android.text.BidiFormatter.getDefaultInstanceFromContext(rtlContext);
    }
    ...
    public static android.text.BidiFormatter getInstance(java.util.Locale locale) {
        return android.text.BidiFormatter.getDefaultInstanceFromContext(android.text.BidiFormatter.isRtlLocale(locale));
    }
     ...
     * 		The default text direction heuristic.
     */
    private BidiFormatter(boolean isRtlContext, int flags, android.text.TextDirectionHeuristic heuristic) {
        mIsRtlContext = isRtlContext;
        mFlags = flags;
    ...
    public boolean getStereoReset() {
        return (mFlags & android.text.BidiFormatter.FLAG_STEREO_RESET) != 0;
    }
     ...
     *
     * @param str
     * 		CharSequence after which the mark may need to appear.
     * @param heuristic
     * 		The text direction heuristic that will be used to estimate the {@code str}'s
     * 		directionality.
     * @return LRM for RTL text in LTR context; RLM for LTR text in RTL context;
    else, the empty string.
     * @unknown 
     */
    public java.lang.String markAfter(java.lang.CharSequence str, android.text.TextDirectionHeuristic heuristic) {
        final boolean isRtl = heuristic.isRtl(str, 0, str.length());
        // getExitDir() is called only if needed (short-circuit).
        if ((!mIsRtlContext) && (isRtl || (android.text.BidiFormatter.getExitDir(str) == android.text.BidiFormatter.DIR_RTL))) {
            return android.text.BidiFormatter.LRM_STRING;
        }
        if (mIsRtlContext && ((!isRtl) || (android.text.BidiFormatter.getExitDir(str) == android.text.BidiFormatter.DIR_LTR))) {
            return android.text.BidiFormatter.RLM_STRING;
        }
        return android.text.BidiFormatter.EMPTY_STRING;
    }
     ...
     *
     * @param str
     * 		CharSequence before which the mark may need to appear.
     * @param heuristic
     * 		The text direction heuristic that will be used to estimate the {@code str}'s
     * 		directionality.
     * @return LRM for RTL text in LTR context; RLM for LTR text in RTL context;
     ...
     * @unknown 
     */
    public java.lang.String markBefore(java.lang.CharSequence str, android.text.TextDirectionHeuristic heuristic) {
        final boolean isRtl = heuristic.isRtl(str, 0, str.length());
        // getEntryDir() is called only if needed (short-circuit).
        if ((!mIsRtlContext) && (isRtl || (android.text.BidiFormatter.getEntryDir(str) == android.text.BidiFormatter.DIR_RTL))) {
            return android.text.BidiFormatter.LRM_STRING;
        }
        if (mIsRtlContext && ((!isRtl) || (android.text.BidiFormatter.getEntryDir(str) == android.text.BidiFormatter.DIR_LTR))) {
            return android.text.BidiFormatter.RLM_STRING;
        }
        return android.text.BidiFormatter.EMPTY_STRING;
    }
    ...
    public java.lang.String unicodeWrap(@android.annotation.Nullable
    java.lang.String str, android.text.TextDirectionHeuristic heuristic, boolean isolate) {
        if (str == null)
            return null;

        return unicodeWrap(((java.lang.CharSequence) (str)), heuristic, isolate).toString();
    }
     ...
     */
    @android.annotation.Nullable
    public java.lang.CharSequence unicodeWrap(@android.annotation.Nullable
    java.lang.CharSequence str, android.text.TextDirectionHeuristic heuristic, boolean isolate) {
        if (str == null)
            return null;
        ...
        if (getStereoReset() && isolate) {
            result.append(markBefore(str, isRtl ? android.text.TextDirectionHeuristics.RTL : android.text.TextDirectionHeuristics.LTR));
        }
        if (isRtl != mIsRtlContext) {
            result.append(isRtl ? android.text.BidiFormatter.RLE : android.text.BidiFormatter.LRE);
            result.append(str);
            result.append(android.text.BidiFormatter.PDF);
        } else {
            result.append(str);
        }
        if (isolate) {
            result.append(markAfter(str, isRtl ? android.text.TextDirectionHeuristics.RTL : android.text.TextDirectionHeuristics.LTR));
        }
        return result;
    }
     ...
     */
    public java.lang.String unicodeWrap(java.lang.String str, android.text.TextDirectionHeuristic heuristic) {
        return /* isolate */
        unicodeWrap(str, heuristic, true);
    }
     ...
     * @unknown 
     */
    public java.lang.CharSequence unicodeWrap(java.lang.CharSequence str, android.text.TextDirectionHeuristic heuristic) {
        return /* isolate */
        unicodeWrap(str, heuristic, true);
    }
    ...
    public java.lang.String unicodeWrap(java.lang.String str) {
        return /* isolate */
        unicodeWrap(str, mDefaultTextDirectionHeuristic, true);
    }
    ...
    private static android.text.BidiFormatter getDefaultInstanceFromContext(boolean isRtlContext) {
        return isRtlContext ? android.text.BidiFormatter.DEFAULT_RTL_INSTANCE : android.text.BidiFormatter.DEFAULT_LTR_INSTANCE;
    }
    ...
    private static int getExitDir(java.lang.CharSequence str) {
        return /* isHtml */
        new android.text.BidiFormatter.DirectionalityEstimator(str, false).getExitDir();
    }
    ...
    private static int getEntryDir(java.lang.CharSequence str) {
        return /* isHtml */
        new android.text.BidiFormatter.DirectionalityEstimator(str, false).getEntryDir();
    }
    ...
    private static class DirectionalityEstimator {
        ...
        static {
            DIR_TYPE_CACHE = new byte[android.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE];
            for (int i = 0; i < android.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE; i++) {
                android.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE[i] = java.lang.Character.getDirectionality(i);
            }
        }
        ...
        int getEntryDir() {
            ...
            int embeddingLevelDir = android.text.BidiFormatter.DIR_UNKNOWN;
            ...
            while ((charIndex < length) && (firstNonEmptyEmbeddingLevel == 0)) {
                switch (dirTypeForward()) {
                    ...
                    case java.lang.Character.DIRECTIONALITY_LEFT_TO_RIGHT_OVERRIDE :
                        ++embeddingLevel;
                        embeddingLevelDir = android.text.BidiFormatter.DIR_LTR;
                        break;
                    ...
                    case java.lang.Character.DIRECTIONALITY_RIGHT_TO_LEFT_OVERRIDE :
                        ++embeddingLevel;
                        embeddingLevelDir = android.text.BidiFormatter.DIR_RTL;
                        break;
                    case java.lang.Character.DIRECTIONALITY_POP_DIRECTIONAL_FORMAT :
                        --embeddingLevel;
                        ...
                        embeddingLevelDir = android.text.BidiFormatter.DIR_UNKNOWN;
                        break;
                    case java.lang.Character.DIRECTIONALITY_BOUNDARY_NEUTRAL :
                        break;
                    case java.lang.Character.DIRECTIONALITY_LEFT_TO_RIGHT :
                        if (embeddingLevel == 0) {
                            return android.text.BidiFormatter.DIR_LTR;
                        }
                    ...
                    case java.lang.Character.DIRECTIONALITY_RIGHT_TO_LEFT_ARABIC :
                        if (embeddingLevel == 0) {
                            return android.text.BidiFormatter.DIR_RTL;
                        }
                        firstNonEmptyEmbeddingLevel = embeddingLevel;
                        break;
                    default :
            ...
            if (firstNonEmptyEmbeddingLevel == 0) {
                ...
                return android.text.BidiFormatter.DIR_UNKNOWN;
            }
            // We have found a non-empty embedding.
            if (embeddingLevelDir != android.text.BidiFormatter.DIR_UNKNOWN) {
        ...
        private static byte getCachedDirectionality(char c) {
            return c < android.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE_SIZE ? android.text.BidiFormatter.DirectionalityEstimator.DIR_TYPE_CACHE[c] : java.lang.Character.getDirectionality(c);
        }
         ...
         * 		if called when charIndex >= length or < 0.
         */
        byte dirTypeForward() {
            lastChar = text.charAt(charIndex);
            if (java.lang.Character.isHighSurrogate(lastChar)) {
                int codePoint = java.lang.Character.codePointAt(text, charIndex);
                charIndex += java.lang.Character.charCount(codePoint);
                return java.lang.Character.getDirectionality(codePoint);
            }
            charIndex++;
            byte dirType = android.text.BidiFormatter.DirectionalityEstimator.getCachedDirectionality(lastChar);
            if (isHtml) {
        ...
        byte dirTypeBackward() {
            ...
            if (java.lang.Character.isLowSurrogate(lastChar)) {
                int codePoint = java.lang.Character.codePointBefore(text, charIndex);
                charIndex -= java.lang.Character.charCount(codePoint);
                return java.lang.Character.getDirectionality(codePoint);
            }
            charIndex--;
        ...
        private byte skipTagForward() {
            ...
            while (charIndex < length) {
                ...
                if (lastChar == '>') {
                    // The end of the tag.
                    return java.lang.Character.DIRECTIONALITY_WHITESPACE;
                }
            ...
            lastChar = '<';
            return java.lang.Character.DIRECTIONALITY_OTHER_NEUTRALS;
        }
