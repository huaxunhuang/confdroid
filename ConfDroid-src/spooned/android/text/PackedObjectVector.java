...
class PackedObjectVector<E> {
    ...
    public E getValue(int row, int column) {
        ...
        java.lang.Object value = mValues[(row * mColumns) + column];
        return ((E) (value));
    }
    ...
    private void growBuffer() {
        java.lang.Object[] newvalues = com.android.internal.util.ArrayUtils.newUnpaddedObjectArray(com.android.internal.util.GrowingArrayUtils.growSize(size()) * mColumns);
        int newsize = newvalues.length / mColumns;
        int after = mRows - (mRowGapStart + mRowGapLength);
        java.lang.System.arraycopy(mValues, 0, newvalues, 0, mColumns * mRowGapStart);
        java.lang.System.arraycopy(mValues, (mRows - after) * mColumns, newvalues, (newsize - after) * mColumns, after * mColumns);
        ...
        if (where > mRowGapStart) {
            ...
            for (int i = mRowGapStart + mRowGapLength; i < ((mRowGapStart + mRowGapLength) + moving); i++) {
                ...
                for (int j = 0; j < mColumns; j++) {
                    java.lang.Object val = mValues[(i * mColumns) + j];
