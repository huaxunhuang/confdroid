...
public abstract class LoginFilter implements android.text.InputFilter {
     ...
     *
     * @param appendInvalid
     * 		whether or not to append invalid characters.
     */
    ...
    public static class UsernameFilterGeneric extends android.text.LoginFilter {
        private static final java.lang.String mAllowed = "@_-+.";// Additional characters
        ...
        public boolean isAllowed(char c) {
            ...
            if (android.text.LoginFilter.UsernameFilterGeneric.mAllowed.indexOf(c) != (-1))
                return true;
