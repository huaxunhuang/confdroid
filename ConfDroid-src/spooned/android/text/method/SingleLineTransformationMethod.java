...
public class SingleLineTransformationMethod extends android.text.method.ReplacementTransformationMethod {
    ...
    protected char[] getOriginal() {
        return android.text.method.SingleLineTransformationMethod.ORIGINAL;
    }
    ...
    protected char[] getReplacement() {
        return android.text.method.SingleLineTransformationMethod.REPLACEMENT;
    }

    public static android.text.method.SingleLineTransformationMethod getInstance() {
        if (android.text.method.SingleLineTransformationMethod.sInstance != null)
            return android.text.method.SingleLineTransformationMethod.sInstance;

        android.text.method.SingleLineTransformationMethod.sInstance = new android.text.method.SingleLineTransformationMethod();
        return android.text.method.SingleLineTransformationMethod.sInstance;
    }
