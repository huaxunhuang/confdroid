...
public final class InCallAdapter {
     ...
     *
     * @param callId
     * 		The identifier of the call to answer.
     * @param videoState
     * 		The video state in which to answer the call.
     */
    public void answerCall(java.lang.String callId, int videoState) {
        try {
     ...
     *
     * @param callId
     * 		The identifier of the call to reject.
     * @param rejectWithMessage
     * 		Whether to reject with a text message.
     * @param textMessage
     * 		An optional text message with which to respond.
     */
    public void rejectCall(java.lang.String callId, boolean rejectWithMessage, java.lang.String textMessage) {
        try {
     ...
     *
     * @param callId
     * 		The identifier of the call to disconnect.
     */
     ...
     *
     * @param callId
     * 		The identifier of the call to put on hold.
     */
    public void holdCall(java.lang.String callId) {
        try {
     ...
     *
     * @param callId
     * 		The identifier of the call to release from hold.
     */
    public void unholdCall(java.lang.String callId) {
        try {
     ...
     *
     * @param shouldMute
     * 		True if the microphone should be muted.
     */
     ...
     *
     * @param callId
     * 		The unique ID of the call in which the tone will be played.
     * @param digit
     ...
     *
     * @param callId
     * 		The unique ID of the call in which any currently playing tone will be stopped.
     */
     ...
     *
     * @param callId
     * 		The unique ID of the call for which postdial string playing should continue.
     * @param proceed
     * 		Whether or not to continue with the post-dial sequence.
     */
    public void postDialContinue(java.lang.String callId, boolean proceed) {
        try {
     ...
     * @param accountHandle
     * 		The PhoneAccountHandle through which to place the call.
     * @param setDefault
     * 		{@code True} if this account should be set as the default for calls.
     */
    public void phoneAccountSelected(java.lang.String callId, android.telecom.PhoneAccountHandle accountHandle, boolean setDefault) {
        try {
     ...
     * @unknown 
     */
    public void conference(java.lang.String callId, java.lang.String otherCallId) {
        try {
     ...
     *
     * @param callId
     * 		The callId to send the event for.
     * @param event
     * 		The event.
     * @param extras
     ...
     *
     * @param callId
     * 		The callId to add the extras to.
     * @param extras
     * 		The extras.
     */
     ...
     * 		The extra value.
     */
    public void putExtra(java.lang.String callId, java.lang.String key, boolean value) {
        try {
     ...
     * 		The extra value.
     */
    public void putExtra(java.lang.String callId, java.lang.String key, int value) {
        try {
            android.os.Bundle bundle = new android.os.Bundle();
     ...
     * 		The extra value.
     */
    public void putExtra(java.lang.String callId, java.lang.String key, java.lang.String value) {
        try {
            android.os.Bundle bundle = new android.os.Bundle();
     ...
     *
     * @param callId
     * 		The callId to remove the extras from.
     * @param keys
