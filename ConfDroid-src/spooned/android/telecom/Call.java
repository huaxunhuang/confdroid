...
public final class Call {
    ...
    public static final int STATE_PRE_DIAL_WAIT = android.telecom.Call.STATE_SELECT_PHONE_ACCOUNT;
    ...
    public static class Details {
         ...
         * @unknown 
         */
        public static final int CAPABILITY_UNUSED_1 = 0x10;
         ...
         */
        public static final int CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL = android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_LOCAL_RX | android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_LOCAL_TX;
         ...
         */
        public static final int CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL = android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_REMOTE_RX | android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_REMOTE_TX;
         ...
         */
        public static final int PROPERTY_CONFERENCE = 0x1;

        /**
         * Whether the call is a generic conference, where we do not know the precise state of
         * participants in the conference (eg. on CDMA).
         */
        public static final int PROPERTY_GENERIC_CONFERENCE = 0x2;

        /**
         * Whether the call is made while the device is in emergency callback mode.
         */
        public static final int PROPERTY_EMERGENCY_CALLBACK_MODE = 0x4;

        /**
         * Connection is using WIFI.
         */
        public static final int PROPERTY_WIFI = 0x8;

        /**
         * Call is using high definition audio.
         */
        public static final int PROPERTY_HIGH_DEF_AUDIO = 0x10;

        /**
         * Whether the call is associated with the work profile.
         */
        public static final int PROPERTY_ENTERPRISE_CALL = 0x20;
         ...
         */
        public static final int PROPERTY_IS_EXTERNAL_CALL = 0x40;

        /**
         * Indicates that the call has CDMA Enhanced Voice Privacy enabled.
         */
        public static final int PROPERTY_HAS_CDMA_VOICE_PRIVACY = 0x80;
        ...
        public boolean can(int capability) {
            return android.telecom.Call.Details.can(mCallCapabilities, capability);
        }
        ...
        public static java.lang.String capabilitiesToString(int capabilities) {
            ...
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_HOLD)) {
                builder.append(" CAPABILITY_HOLD");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORT_HOLD)) {
                builder.append(" CAPABILITY_SUPPORT_HOLD");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_MERGE_CONFERENCE)) {
                builder.append(" CAPABILITY_MERGE_CONFERENCE");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SWAP_CONFERENCE)) {
                builder.append(" CAPABILITY_SWAP_CONFERENCE");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_RESPOND_VIA_TEXT)) {
                builder.append(" CAPABILITY_RESPOND_VIA_TEXT");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_MUTE)) {
                builder.append(" CAPABILITY_MUTE");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_MANAGE_CONFERENCE)) {
                builder.append(" CAPABILITY_MANAGE_CONFERENCE");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_LOCAL_RX)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_LOCAL_RX");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_LOCAL_TX)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_LOCAL_TX");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_REMOTE_RX)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_REMOTE_RX");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_REMOTE_TX)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_REMOTE_TX");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_CANNOT_DOWNGRADE_VIDEO_TO_AUDIO)) {
                builder.append(" CAPABILITY_CANNOT_DOWNGRADE_VIDEO_TO_AUDIO");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL)) {
                builder.append(" CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_SPEED_UP_MT_AUDIO)) {
                builder.append(" CAPABILITY_SPEED_UP_MT_AUDIO");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_CAN_UPGRADE_TO_VIDEO)) {
                builder.append(" CAPABILITY_CAN_UPGRADE_TO_VIDEO");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_CAN_PAUSE_VIDEO)) {
                builder.append(" CAPABILITY_CAN_PAUSE_VIDEO");
            }
            if (android.telecom.Call.Details.can(capabilities, android.telecom.Call.Details.CAPABILITY_CAN_PULL_CALL)) {
        ...
        public boolean hasProperty(int property) {
            return android.telecom.Call.Details.hasProperty(mCallProperties, property);
        }
        ...
        public static java.lang.String propertiesToString(int properties) {
            ...
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_CONFERENCE)) {
                builder.append(" PROPERTY_CONFERENCE");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_GENERIC_CONFERENCE)) {
                builder.append(" PROPERTY_GENERIC_CONFERENCE");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_WIFI)) {
                builder.append(" PROPERTY_WIFI");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_HIGH_DEF_AUDIO)) {
                builder.append(" PROPERTY_HIGH_DEF_AUDIO");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_EMERGENCY_CALLBACK_MODE)) {
                builder.append(" PROPERTY_EMERGENCY_CALLBACK_MODE");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_IS_EXTERNAL_CALL)) {
                builder.append(" PROPERTY_IS_EXTERNAL_CALL");
            }
            if (android.telecom.Call.Details.hasProperty(properties, android.telecom.Call.Details.PROPERTY_HAS_CDMA_VOICE_PRIVACY)) {
        ...
        public boolean equals(java.lang.Object o) {
            if (o instanceof android.telecom.Call.Details) {
                android.telecom.Call.Details d = ((android.telecom.Call.Details) (o));
                return ((((((((((((java.util.Objects.equals(mHandle, d.mHandle) && java.util.Objects.equals(mHandlePresentation, d.mHandlePresentation)) && java.util.Objects.equals(mCallerDisplayName, d.mCallerDisplayName)) && java.util.Objects.equals(mCallerDisplayNamePresentation, d.mCallerDisplayNamePresentation)) && java.util.Objects.equals(mAccountHandle, d.mAccountHandle)) && java.util.Objects.equals(mCallCapabilities, d.mCallCapabilities)) && java.util.Objects.equals(mCallProperties, d.mCallProperties)) && java.util.Objects.equals(mDisconnectCause, d.mDisconnectCause)) && java.util.Objects.equals(mConnectTimeMillis, d.mConnectTimeMillis)) && java.util.Objects.equals(mGatewayInfo, d.mGatewayInfo)) && java.util.Objects.equals(mVideoState, d.mVideoState)) && java.util.Objects.equals(mStatusHints, d.mStatusHints)) && android.telecom.Call.areBundlesEqual(mExtras, d.mExtras)) && android.telecom.Call.areBundlesEqual(mIntentExtras, d.mIntentExtras);
            }
            return false;
        }
        ...
        @java.lang.Override
        public int hashCode() {
            return ((((((((((((java.util.Objects.hashCode(mHandle) + java.util.Objects.hashCode(mHandlePresentation)) + java.util.Objects.hashCode(mCallerDisplayName)) + java.util.Objects.hashCode(mCallerDisplayNamePresentation)) + java.util.Objects.hashCode(mAccountHandle)) + java.util.Objects.hashCode(mCallCapabilities)) + java.util.Objects.hashCode(mCallProperties)) + java.util.Objects.hashCode(mDisconnectCause)) + java.util.Objects.hashCode(mConnectTimeMillis)) + java.util.Objects.hashCode(mGatewayInfo)) + java.util.Objects.hashCode(mVideoState)) + java.util.Objects.hashCode(mStatusHints)) + java.util.Objects.hashCode(mExtras)) + java.util.Objects.hashCode(mIntentExtras);
        }

        /**
         * {@hide }
         */
        public Details(java.lang.String telecomCallId, android.net.Uri handle, int handlePresentation, java.lang.String callerDisplayName, int callerDisplayNamePresentation, android.telecom.PhoneAccountHandle accountHandle, int capabilities, int properties, android.telecom.DisconnectCause disconnectCause, long connectTimeMillis, android.telecom.GatewayInfo gatewayInfo, int videoState, android.telecom.StatusHints statusHints, android.os.Bundle extras, android.os.Bundle intentExtras) {
        ...
        public java.lang.String toString() {
            ...
            sb.append(", caps: ");
            sb.append(android.telecom.Call.Details.capabilitiesToString(mCallCapabilities));
            sb.append(", props: ");
            sb.append(android.telecom.Call.Details.propertiesToString(mCallProperties));
            sb.append("]");
            return sb.toString();
        }
    }
    ...
    public static abstract class Callback {
         ...
         *
         * @param call
         * 		The {@code Call} invoking this method.
         * @param state
         * 		The new state of the {@code Call}.
         */
         ...
         * 		The {@code Call} invoking this method.
         * @param parent
         * 		The new parent of the {@code Call}.
         */
         ...
         * 		The {@code Call} invoking this method.
         * @param children
         * 		The new children of the {@code Call}.
         */
        public void onChildrenChanged(android.telecom.Call call, java.util.List<android.telecom.Call> children) {
        }
         ...
         * 		The {@code Call} invoking this method.
         * @param details
         * 		A {@code Details} object describing the {@code Call}.
         */
         ...
         * @param call
         * 		The {@code Call} invoking this method.
         * @param cannedTextResponses
         * 		The text messages useable as responses.
         */
        public void onCannedTextResponsesLoaded(android.telecom.Call call, java.util.List<java.lang.String> cannedTextResponses) {
        }
         ...
         */
        public void onPostDialWait(android.telecom.Call call, java.lang.String remainingPostDialSequence) {
        }
         ...
         * 		The {@code Call} invoking this method.
         * @param videoCall
         * 		The {@code Call.VideoCall} associated with the {@code Call}.
         */
         ...
         *
         * @param call
         * 		The {@code Call} being updated.
         * @param conferenceableCalls
         * 		The {@code Call}s with which this {@code Call} can be
         * 		conferenced.
         */
        public void onConferenceableCallsChanged(android.telecom.Call call, java.util.List<android.telecom.Call> conferenceableCalls) {
        }
         ...
         *
         * @param call
         * 		The {@code Call} receiving the event.
         * @param event
         * 		The event.
         * @param extras
    ...
    private final java.util.List<java.lang.String> mChildrenIds = new java.util.ArrayList<>();

    private final java.util.List<android.telecom.Call> mChildren = new java.util.ArrayList<>();

    private final java.util.List<android.telecom.Call> mUnmodifiableChildren = java.util.Collections.unmodifiableList(mChildren);

    private final java.util.List<android.telecom.CallbackRecord<android.telecom.Call.Callback>> mCallbackRecords = new java.util.concurrent.CopyOnWriteArrayList<>();

    private final java.util.List<android.telecom.Call> mConferenceableCalls = new java.util.ArrayList<>();

    private final java.util.List<android.telecom.Call> mUnmodifiableConferenceableCalls = java.util.Collections.unmodifiableList(mConferenceableCalls);

    private boolean mChildrenCached;

    private java.lang.String mParentId = null;

    private int mState;

    private java.util.List<java.lang.String> mCannedTextResponses = null;
     ...
     *
     * @param rejectWithMessage
     * 		Whether to reject with a text message.
     * @param textMessage
     * 		An optional text message with which to respond.
     */
    public void reject(boolean rejectWithMessage, java.lang.String textMessage) {
     ...
     */
    public void phoneAccountSelected(android.telecom.PhoneAccountHandle accountHandle, boolean setDefault) {
     ...
     *
     * @param callToConferenceWith
     * 		The other call with which to conference.
     */
    public void conference(android.telecom.Call callToConferenceWith) {
    ...
    public void pullExternalCall() {
        ...
        if (!mDetails.hasProperty(android.telecom.Call.Details.PROPERTY_IS_EXTERNAL_CALL)) {
            return;
        }
     ...
     */
    public void sendCallEvent(java.lang.String event, android.os.Bundle extras) {
     ...
     * 		The extras to add.
     */
    public final void putExtras(android.os.Bundle extras) {
        if (extras == null) {
            return;
        }
        if (mExtras == null) {
    ...
    public java.util.List<android.telecom.Call> getChildren() {
        if (!mChildrenCached) {
            ...
            mChildren.clear();
            for (java.lang.String id : mChildrenIds) {
                android.telecom.Call call = mPhone.internalGetCallByTelecomId(id);
                if (call == null) {
    ...
    public void registerCallback(android.telecom.Call.Callback callback, android.os.Handler handler) {
        ...
        if (((callback != null) && (handler != null)) && (mState != android.telecom.Call.STATE_DISCONNECTED)) {
            mCallbackRecords.add(new android.telecom.CallbackRecord<android.telecom.Call.Callback>(callback, handler));
        }
    }
    ...
    public void unregisterCallback(android.telecom.Call.Callback callback) {
        ...
        if ((callback != null) && (mState != android.telecom.Call.STATE_DISCONNECTED)) {
            for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return new java.lang.StringBuilder().append("Call [id: ").append(mTelecomCallId).append(", state: ").append(android.telecom.Call.stateToString(mState)).append(", details: ").append(mDetails).append("]").toString();
    }
    ...
    private static java.lang.String stateToString(int state) {
        switch (state) {
            ...
            default :
                android.telecom.Log.w(android.telecom.Call.class, "Unknown state %d", state);
                return "UNKNOWN";
        }
    }
     ...
     * {@hide }
     */
    Call(android.telecom.Phone phone, java.lang.String telecomCallId, android.telecom.InCallAdapter inCallAdapter) {
        mPhone = phone;
        mTelecomCallId = telecomCallId;
        mInCallAdapter = inCallAdapter;
        mState = android.telecom.Call.STATE_NEW;
    }

    /**
     * {@hide }
     */
    Call(android.telecom.Phone phone, java.lang.String telecomCallId, android.telecom.InCallAdapter inCallAdapter, int state) {
        mPhone = phone;
        mTelecomCallId = telecomCallId;
        mInCallAdapter = inCallAdapter;
        mState = state;
     ...
     * {@hide }
     */
    final void internalUpdate(android.telecom.ParcelableCall parcelableCall, java.util.Map<java.lang.String, android.telecom.Call> callIdMap) {
        // First, we update the internal state as far as possible before firing any updates.
        android.telecom.Call.Details details = android.telecom.Call.Details.createFromParcelableCall(parcelableCall);
        boolean detailsChanged = !java.util.Objects.equals(mDetails, details);
        if (detailsChanged) {
            mDetails = details;
        }
        ...
        if (((mCannedTextResponses == null) && (parcelableCall.getCannedSmsResponses() != null)) && (!parcelableCall.getCannedSmsResponses().isEmpty())) {
            mCannedTextResponses = java.util.Collections.unmodifiableList(parcelableCall.getCannedSmsResponses());
            cannedTextResponsesChanged = true;
        }
        android.telecom.VideoCallImpl newVideoCallImpl = parcelableCall.getVideoCallImpl();
        boolean videoCallChanged = parcelableCall.isVideoCallProviderChanged() && (!java.util.Objects.equals(mVideoCallImpl, newVideoCallImpl));
        if (videoCallChanged) {
        ...
        java.lang.String parentId = parcelableCall.getParentCallId();
        boolean parentChanged = !java.util.Objects.equals(mParentId, parentId);
        if (parentChanged) {
            mParentId = parentId;
        }
        java.util.List<java.lang.String> childCallIds = parcelableCall.getChildCallIds();
        boolean childrenChanged = !java.util.Objects.equals(childCallIds, mChildrenIds);
        if (childrenChanged) {
            mChildrenIds.clear();
        ...
        java.util.List<android.telecom.Call> conferenceableCalls = new java.util.ArrayList<android.telecom.Call>(conferenceableCallIds.size());
        for (java.lang.String otherId : conferenceableCallIds) {
            if (callIdMap.containsKey(otherId)) {
                conferenceableCalls.add(callIdMap.get(otherId));
            }
        }
        if (!java.util.Objects.equals(mConferenceableCalls, conferenceableCalls)) {
        ...
        if (mState == android.telecom.Call.STATE_DISCONNECTED) {
            fireCallDestroyed();
        }
    }
     ...
     * {@hide }
     */
    final void internalSetPostDialWait(java.lang.String remaining) {
     ...
     * {@hide }
     */
    final void internalOnConnectionEvent(java.lang.String event, android.os.Bundle extras) {
        fireOnConnectionEvent(event, extras);
    }

    private void fireStateChanged(final int newState) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
    ...
    private void fireParentChanged(final android.telecom.Call newParent) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
    ...
    private void fireChildrenChanged(final java.util.List<android.telecom.Call> children) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
    ...
    private void fireCannedTextResponsesLoaded(final java.util.List<java.lang.String> cannedTextResponses) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
    ...
    private void firePostDialWait(final java.lang.String remainingPostDialSequence) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
    ...
    private void fireCallDestroyed() {
        ...
        for (final android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
                @java.lang.Override
                public void run() {
     ...
     * 		
     */
    private void fireOnConnectionEvent(final java.lang.String event, final android.os.Bundle extras) {
        for (android.telecom.CallbackRecord<android.telecom.Call.Callback> record : mCallbackRecords) {
            final android.telecom.Call call = this;
            final android.telecom.Call.Callback callback = record.getCallback();
            record.getHandler().post(new java.lang.Runnable() {
     ...
     * @unknown {@code true} if the bundles are equal, {@code false} otherwise.
     */
    private static boolean areBundlesEqual(android.os.Bundle bundle, android.os.Bundle newBundle) {
        ...
        for (java.lang.String key : bundle.keySet()) {
            if (key != null) {
                final java.lang.Object value = bundle.get(key);
                final java.lang.Object newValue = newBundle.get(key);
