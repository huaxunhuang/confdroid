...
public abstract class Connection extends android.telecom.Conferenceable {
     ...
     */
    public static final int CAPABILITY_HOLD = 0x1;

    /**
     * Connection supports the hold feature.
     */
    public static final int CAPABILITY_SUPPORT_HOLD = 0x2;
     ...
     */
    public static final int CAPABILITY_MERGE_CONFERENCE = 0x4;
     ...
     * This is only intended for use by a {@link Conference}.
     */
    public static final int CAPABILITY_SWAP_CONFERENCE = 0x8;
     ...
     * @unknown 
     */
    public static final int CAPABILITY_UNUSED = 0x10;

    /**
     * Connection supports responding via text option.
     */
    public static final int CAPABILITY_RESPOND_VIA_TEXT = 0x20;

    /**
     * Connection can be muted.
     */
    public static final int CAPABILITY_MUTE = 0x40;
     ...
     */
    public static final int CAPABILITY_MANAGE_CONFERENCE = 0x80;

    /**
     * Local device supports receiving video.
     */
    public static final int CAPABILITY_SUPPORTS_VT_LOCAL_RX = 0x100;

    /**
     * Local device supports transmitting video.
     */
    public static final int CAPABILITY_SUPPORTS_VT_LOCAL_TX = 0x200;

    /**
     * Local device supports bidirectional video calling.
     */
    public static final int CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL = android.telecom.Connection.CAPABILITY_SUPPORTS_VT_LOCAL_RX | android.telecom.Connection.CAPABILITY_SUPPORTS_VT_LOCAL_TX;

    /**
     * Remote device supports receiving video.
     */
    public static final int CAPABILITY_SUPPORTS_VT_REMOTE_RX = 0x400;

    /**
     * Remote device supports transmitting video.
     */
    public static final int CAPABILITY_SUPPORTS_VT_REMOTE_TX = 0x800;

    /**
     * Remote device supports bidirectional video calling.
     */
    public static final int CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL = android.telecom.Connection.CAPABILITY_SUPPORTS_VT_REMOTE_RX | android.telecom.Connection.CAPABILITY_SUPPORTS_VT_REMOTE_TX;

    /**
     * Connection is able to be separated from its parent {@code Conference}, if any.
     */
    public static final int CAPABILITY_SEPARATE_FROM_CONFERENCE = 0x1000;

    /**
     * Connection is able to be individually disconnected when in a {@code Conference}.
     */
    public static final int CAPABILITY_DISCONNECT_FROM_CONFERENCE = 0x2000;
     ...
     * @unknown 
     */
    public static final int CAPABILITY_UNUSED_2 = 0x4000;
     ...
     * @unknown 
     */
    public static final int CAPABILITY_UNUSED_3 = 0x8000;
    ...
    public boolean can(int capability) {
        return android.telecom.Connection.can(mConnectionCapabilities, capability);
    }
    ...
    public static java.lang.String capabilitiesToString(int capabilities) {
        return /* isLong */
        android.telecom.Connection.capabilitiesToStringInternal(capabilities, true);
    }
     ...
     * @unknown 
     */
    public static java.lang.String capabilitiesToStringShort(int capabilities) {
        return /* isLong */
        android.telecom.Connection.capabilitiesToStringInternal(capabilities, false);
    }

    private static java.lang.String capabilitiesToStringInternal(int capabilities, boolean isLong) {
        java.lang.StringBuilder builder = new java.lang.StringBuilder();
        builder.append("[");
        if (isLong) {
            builder.append("Capabilities:");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_HOLD)) {
            builder.append(isLong ? " CAPABILITY_HOLD" : " hld");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORT_HOLD)) {
            builder.append(isLong ? " CAPABILITY_SUPPORT_HOLD" : " sup_hld");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_MERGE_CONFERENCE)) {
            builder.append(isLong ? " CAPABILITY_MERGE_CONFERENCE" : " mrg_cnf");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SWAP_CONFERENCE)) {
            builder.append(isLong ? " CAPABILITY_SWAP_CONFERENCE" : " swp_cnf");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_RESPOND_VIA_TEXT)) {
            builder.append(isLong ? " CAPABILITY_RESPOND_VIA_TEXT" : " txt");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_MUTE)) {
            builder.append(isLong ? " CAPABILITY_MUTE" : " mut");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_MANAGE_CONFERENCE)) {
            builder.append(isLong ? " CAPABILITY_MANAGE_CONFERENCE" : " mng_cnf");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_LOCAL_RX)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_LOCAL_RX" : " VTlrx");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_LOCAL_TX)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_LOCAL_TX" : " VTltx");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_LOCAL_BIDIRECTIONAL" : " VTlbi");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_REMOTE_RX)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_REMOTE_RX" : " VTrrx");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_REMOTE_TX)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_REMOTE_TX" : " VTrtx");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL)) {
            builder.append(isLong ? " CAPABILITY_SUPPORTS_VT_REMOTE_BIDIRECTIONAL" : " VTrbi");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CANNOT_DOWNGRADE_VIDEO_TO_AUDIO)) {
            builder.append(isLong ? " CAPABILITY_CANNOT_DOWNGRADE_VIDEO_TO_AUDIO" : " !v2a");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_SPEED_UP_MT_AUDIO)) {
            builder.append(isLong ? " CAPABILITY_SPEED_UP_MT_AUDIO" : " spd_aud");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CAN_UPGRADE_TO_VIDEO)) {
            builder.append(isLong ? " CAPABILITY_CAN_UPGRADE_TO_VIDEO" : " a2v");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CAN_PAUSE_VIDEO)) {
            builder.append(isLong ? " CAPABILITY_CAN_PAUSE_VIDEO" : " paus_VT");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CONFERENCE_HAS_NO_CHILDREN)) {
            builder.append(isLong ? " CAPABILITY_SINGLE_PARTY_CONFERENCE" : " 1p_cnf");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CAN_SEND_RESPONSE_VIA_CONNECTION)) {
            builder.append(isLong ? " CAPABILITY_CAN_SEND_RESPONSE_VIA_CONNECTION" : " rsp_by_con");
        }
        if (android.telecom.Connection.can(capabilities, android.telecom.Connection.CAPABILITY_CAN_PULL_CALL)) {
     ...
     * @return A human readable string representation.
     */
    public static java.lang.String propertiesToString(int properties) {
        return /* isLong */
        android.telecom.Connection.propertiesToStringInternal(properties, true);
    }
     ...
     * @unknown 
     */
    public static java.lang.String propertiesToStringShort(int properties) {
        return /* isLong */
        android.telecom.Connection.propertiesToStringInternal(properties, false);
    }

    private static java.lang.String propertiesToStringInternal(int properties, boolean isLong) {
        java.lang.StringBuilder builder = new java.lang.StringBuilder();
        builder.append("[");
        if (isLong) {
            builder.append("Properties:");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_EMERGENCY_CALLBACK_MODE)) {
            builder.append(isLong ? " PROPERTY_EMERGENCY_CALLBACK_MODE" : " ecbm");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_HIGH_DEF_AUDIO)) {
            builder.append(isLong ? " PROPERTY_HIGH_DEF_AUDIO" : " HD");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_WIFI)) {
            builder.append(isLong ? " PROPERTY_WIFI" : " wifi");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_GENERIC_CONFERENCE)) {
            builder.append(isLong ? " PROPERTY_GENERIC_CONFERENCE" : " gen_conf");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_IS_EXTERNAL_CALL)) {
            builder.append(isLong ? " PROPERTY_IS_EXTERNAL_CALL" : " xtrnl");
        }
        if (android.telecom.Connection.can(properties, android.telecom.Connection.PROPERTY_HAS_CDMA_VOICE_PRIVACY)) {
    ...
    public static abstract class Listener {
        ...
        public void onAddressChanged(android.telecom.Connection c, android.net.Uri newAddress, int presentation) {
        }
        ...
        public void onConferenceablesChanged(android.telecom.Connection c, java.util.List<android.telecom.Conferenceable> conferenceables) {
        }

        public void onConferenceChanged(android.telecom.Connection c, android.telecom.Conference conference) {
        }
         ...
         * @unknown 
         */
        public void onConferenceParticipantsChanged(android.telecom.Connection c, java.util.List<android.telecom.ConferenceParticipant> participants) {
        }
        ...
        public void onConnectionEvent(android.telecom.Connection c, java.lang.String event, android.os.Bundle extras) {
        }
         ...
         * @unknown 
         */
        public void onConferenceSupportedChanged(android.telecom.Connection c, boolean isConferenceSupported) {
        }
    }
    ...
    public static abstract class VideoProvider {
         ...
         */
        private java.util.concurrent.ConcurrentHashMap<android.os.IBinder, com.android.internal.telecom.IVideoCallback> mVideoCallbacks = new java.util.concurrent.ConcurrentHashMap<android.os.IBinder, com.android.internal.telecom.IVideoCallback>(8, 0.9F, 1);
        ...
        private final class VideoProviderHandler extends android.os.Handler {
            ...
            public void handleMessage(android.os.Message msg) {
                switch (msg.what) {
                    case android.telecom.Connection.VideoProvider.MSG_ADD_VIDEO_CALLBACK :
                        {
                            android.os.IBinder binder = ((android.os.IBinder) (msg.obj));
                            com.android.internal.telecom.IVideoCallback callback = IVideoCallback.Stub.asInterface(((android.os.IBinder) (msg.obj)));
                            if (callback == null) {
                                android.telecom.Log.w(this, "addVideoProvider - skipped; callback is null.");
                                break;
                            }
                            if (mVideoCallbacks.containsKey(binder)) {
                                android.telecom.Log.i(this, "addVideoProvider - skipped; already present.");
                                break;
                            }
                            mVideoCallbacks.put(binder, callback);
                            break;
                        }
                    case android.telecom.Connection.VideoProvider.MSG_REMOVE_VIDEO_CALLBACK :
                        {
                            android.os.IBinder binder = ((android.os.IBinder) (msg.obj));
                            com.android.internal.telecom.IVideoCallback callback = IVideoCallback.Stub.asInterface(((android.os.IBinder) (msg.obj)));
                            if (!mVideoCallbacks.containsKey(binder)) {
                                android.telecom.Log.i(this, "removeVideoProvider - skipped; not present.");
                                break;
                            }
                            mVideoCallbacks.remove(binder);
                            break;
                        }
                    case android.telecom.Connection.VideoProvider.MSG_SET_CAMERA :
                        onSetCamera(((java.lang.String) (msg.obj)));
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SET_PREVIEW_SURFACE :
                        onSetPreviewSurface(((android.view.Surface) (msg.obj)));
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SET_DISPLAY_SURFACE :
                        onSetDisplaySurface(((android.view.Surface) (msg.obj)));
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SET_DEVICE_ORIENTATION :
                        onSetDeviceOrientation(msg.arg1);
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SET_ZOOM :
                        onSetZoom(((java.lang.Float) (msg.obj)));
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SEND_SESSION_MODIFY_REQUEST :
                        {
                            com.android.internal.os.SomeArgs args = ((com.android.internal.os.SomeArgs) (msg.obj));
                            try {
                                onSendSessionModifyRequest(((android.telecom.VideoProfile) (args.arg1)), ((android.telecom.VideoProfile) (args.arg2)));
                            } finally {
                                args.recycle();
                            }
                            break;
                        }
                    case android.telecom.Connection.VideoProvider.MSG_SEND_SESSION_MODIFY_RESPONSE :
                        onSendSessionModifyResponse(((android.telecom.VideoProfile) (msg.obj)));
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_REQUEST_CAMERA_CAPABILITIES :
                        onRequestCameraCapabilities();
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_REQUEST_CONNECTION_DATA_USAGE :
                        onRequestConnectionDataUsage();
                        break;
                    case android.telecom.Connection.VideoProvider.MSG_SET_PAUSE_IMAGE :
                        onSetPauseImage(((android.net.Uri) (msg.obj)));
                        break;
                    default :
                        break;
                }
        ...
        private final class VideoProviderBinder extends com.android.internal.telecom.IVideoProvider.Stub {
            public void addVideoCallback(android.os.IBinder videoCallbackBinder) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_ADD_VIDEO_CALLBACK, videoCallbackBinder).sendToTarget();
            }

            public void removeVideoCallback(android.os.IBinder videoCallbackBinder) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_REMOVE_VIDEO_CALLBACK, videoCallbackBinder).sendToTarget();
            }

            public void setCamera(java.lang.String cameraId) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_CAMERA, cameraId).sendToTarget();
            }

            public void setPreviewSurface(android.view.Surface surface) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_PREVIEW_SURFACE, surface).sendToTarget();
            }

            public void setDisplaySurface(android.view.Surface surface) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_DISPLAY_SURFACE, surface).sendToTarget();
            }

            public void setDeviceOrientation(int rotation) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_DEVICE_ORIENTATION, rotation, 0).sendToTarget();
            }

            public void setZoom(float value) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_ZOOM, value).sendToTarget();
            }
            ...
            public void sendSessionModifyRequest(android.telecom.VideoProfile fromProfile, android.telecom.VideoProfile toProfile) {
                ...
                args.arg2 = toProfile;
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SEND_SESSION_MODIFY_REQUEST, args).sendToTarget();
            }

            public void sendSessionModifyResponse(android.telecom.VideoProfile responseProfile) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SEND_SESSION_MODIFY_RESPONSE, responseProfile).sendToTarget();
            }

            public void requestCameraCapabilities() {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_REQUEST_CAMERA_CAPABILITIES).sendToTarget();
            }

            public void requestCallDataUsage() {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_REQUEST_CONNECTION_DATA_USAGE).sendToTarget();
            }

            public void setPauseImage(android.net.Uri uri) {
                mMessageHandler.obtainMessage(android.telecom.Connection.VideoProvider.MSG_SET_PAUSE_IMAGE, uri).sendToTarget();
            }
        }

        public VideoProvider() {
            mBinder = new android.telecom.Connection.VideoProvider.VideoProviderBinder();
            mMessageHandler = new android.telecom.Connection.VideoProvider.VideoProviderHandler(android.os.Looper.getMainLooper());
        }
        ...
        public VideoProvider(android.os.Looper looper) {
            mBinder = new android.telecom.Connection.VideoProvider.VideoProviderBinder();
            mMessageHandler = new android.telecom.Connection.VideoProvider.VideoProviderHandler(looper);
        }
        ...
        public void receiveSessionModifyRequest(android.telecom.VideoProfile videoProfile) {
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        callback.receiveSessionModifyRequest(videoProfile);
                    } catch (android.os.RemoteException ignored) {
                        android.telecom.Log.w(this, "receiveSessionModifyRequest callback failed", ignored);
                    }
                }
            }
        }
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "receiveSessionModifyResponse callback failed", ignored);
                    }
                }
            }
        }
         ...
         *
         * @param event
         * 		The event.  Valid values are: {@link VideoProvider#SESSION_EVENT_RX_PAUSE},
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "handleCallSessionEvent callback failed", ignored);
                    }
                }
            }
        }
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "changePeerDimensions callback failed", ignored);
                    }
                }
            }
        }
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "setCallDataUsage callback failed", ignored);
                    }
                }
            }
        }
         ...
         * @param dataUsage
         * 		The updated data usage (in byes).
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "changeCameraCapabilities callback failed", ignored);
                    }
                }
            }
        }
            ...
            if (mVideoCallbacks != null) {
                for (com.android.internal.telecom.IVideoCallback callback : mVideoCallbacks.values()) {
                    try {
                        ...
                        android.telecom.Log.w(this, "changeVideoQuality callback failed", ignored);
                    }
                }
            }
        }
         ...
         *
         * @param event
         * 		A call session event passed to {@link #handleCallSessionEvent(int)}.
         * @return String representation of the call session event.
         * @unknown 
         */
        public static java.lang.String sessionEventToString(int event) {
            switch (event) {
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_CAMERA_FAILURE :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_CAMERA_FAILURE_STR;
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_CAMERA_READY :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_CAMERA_READY_STR;
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_RX_PAUSE :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_RX_PAUSE_STR;
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_RX_RESUME :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_RX_RESUME_STR;
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_TX_START :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_TX_START_STR;
                case android.telecom.Connection.VideoProvider.SESSION_EVENT_TX_STOP :
                    return android.telecom.Connection.VideoProvider.SESSION_EVENT_TX_STOP_STR;
                default :
                    return (android.telecom.Connection.VideoProvider.SESSION_EVENT_UNKNOWN_STR + " ") + event;
            }
        }
    }
    ...
    private final android.telecom.Conference.Listener mConferenceDeathListener = new android.telecom.Conference.Listener() {
        @java.lang.Override
        public void onDestroyed(android.telecom.Conference c) {
            if (mConferenceables.remove(c)) {
                fireOnConferenceableConnectionsChanged();
            }
        }
     ...
     * access the map so make only a single shard
     */
    private final java.util.Set<android.telecom.Connection.Listener> mListeners = java.util.Collections.newSetFromMap(new java.util.concurrent.ConcurrentHashMap<android.telecom.Connection.Listener, java.lang.Boolean>(8, 0.9F, 1));

    private final java.util.List<android.telecom.Conferenceable> mConferenceables = new java.util.ArrayList<>();

    private final java.util.List<android.telecom.Conferenceable> mUnmodifiableConferenceables = java.util.Collections.unmodifiableList(mConferenceables);
    ...
    public final android.os.Bundle getExtras() {
        ...
        synchronized(mExtrasLock) {
            if (mExtras != null) {
                extras = new android.os.Bundle(mExtras);
            }
        }
        return extras;
    }
     ...
     * @unknown 
     */
    public final android.telecom.Connection addConnectionListener(android.telecom.Connection.Listener l) {
        mListeners.add(l);
        return this;
    }
     ...
     * @unknown 
     */
    public final android.telecom.Connection removeConnectionListener(android.telecom.Connection.Listener l) {
        if (l != null) {
            mListeners.remove(l);
        }
        return this;
     ...
     * @unknown 
     */
    public void setTelecomCallId(java.lang.String callId) {
    ...
    final void setCallAudioState(android.telecom.CallAudioState state) {
        checkImmutable();
        android.telecom.Log.d(this, "setAudioState %s", state);
     ...
     *
     * @param state
     * 		An integer value of a {@code STATE_*} constant.
     * @return A string representation of the value.
     */
    public static java.lang.String stateToString(int state) {
        switch (state) {
            case android.telecom.Connection.STATE_INITIALIZING :
                return "INITIALIZING";
            ...
            case android.telecom.Connection.STATE_DISCONNECTED :
                return "DISCONNECTED";
            default :
                android.telecom.Log.wtf(android.telecom.Connection.class, "Unknown state %d", state);
                return "UNKNOWN";
        }
    }
     ...
     * 		See {@link TelecomManager} for valid values.
     */
    public final void setAddress(android.net.Uri address, int presentation) {
        checkImmutable();
        android.telecom.Log.d(this, "setAddress %s", address);
        mAddress = address;
        mAddressPresentation = presentation;
        for (android.telecom.Connection.Listener l : mListeners) {
     ...
     * 		See {@link TelecomManager} for valid values.
     */
    public final void setCallerDisplayName(java.lang.String callerDisplayName, int presentation) {
        checkImmutable();
        android.telecom.Log.d(this, "setCallerDisplayName %s", callerDisplayName);
    ...
    public final void setVideoState(int videoState) {
        checkImmutable();
        android.telecom.Log.d(this, "setVideoState %d", videoState);
    ...
    public final void setRinging() {
        checkImmutable();
        setState(android.telecom.Connection.STATE_RINGING);
    }
    ...
    public final void setInitializing() {
        checkImmutable();
        setState(android.telecom.Connection.STATE_INITIALIZING);
    }
    ...
    public final void setInitialized() {
        checkImmutable();
        setState(android.telecom.Connection.STATE_NEW);
    }
    ...
    public final void setPulling() {
        checkImmutable();
        setState(android.telecom.Connection.STATE_PULLING_CALL);
    }
     ...
     */
    public final void setPostDialWait(java.lang.String remaining) {
        checkImmutable();
        for (android.telecom.Connection.Listener l : mListeners) {
     ...
     *
     * @param nextChar
     * 		The DTMF character that was just processed by the {@code Connection}.
     */
     ...
     * 		The conferenceables.
     */
    public final void setConferenceables(java.util.List<android.telecom.Conferenceable> conferenceables) {
        clearConferenceableList();
    ...
    public final void setConnectionService(android.telecom.ConnectionService connectionService) {
        ...
        if (mConnectionService != null) {
            android.telecom.Log.e(this, new java.lang.Exception(), "Trying to set ConnectionService on a connection " + "which is already associated with another ConnectionService.");
        } else {
    ...
    public final void unsetConnectionService(android.telecom.ConnectionService connectionService) {
        if (mConnectionService != connectionService) {
            android.telecom.Log.e(this, new java.lang.Exception(), "Trying to remove ConnectionService from a Connection " + "that does not belong to the ConnectionService.");
        } else {
    ...
    public final void resetConference() {
        if (mConference != null) {
            android.telecom.Log.d(this, "Conference reset");
            mConference = null;
            fireConferenceChanged();
        }
    }
     ...
     *
     * @param extras
     * 		The extras associated with this {@code Connection}.
     */
    ...
    android.os.Bundle extras) {
        ...
        synchronized(mExtrasLock) {
            ...
            listenerExtras = new android.os.Bundle(mExtras);
        }
        for (android.telecom.Connection.Listener l : mListeners) {
            // Create a new clone of the extras for each listener so that they don't clobber
            // each other
            l.onExtrasChanged(this, new android.os.Bundle(listenerExtras));
        }
    }
     ...
     *
     * @param state
     * 		The new state, one of the {@code STATE_*} constants.
     */
     ...
     *
     * @param endpoint
     * 		the {@link Uri} of the participant to disconnect.
     * @unknown 
     */
    public void onDisconnectConferenceParticipant(android.net.Uri endpoint) {
    }
     ...
     */
    public void onCallEvent(java.lang.String event, android.os.Bundle extras) {
    }
    ...
    static java.lang.String toLogSafePhoneNumber(java.lang.String number) {
        ...
        if (android.telecom.Connection.PII_DEBUG) {
    ...
    private void setState(int state) {
        checkImmutable();
        if ((mState == android.telecom.Connection.STATE_DISCONNECTED) && (mState != state)) {
            android.telecom.Log.d(this, "Connection already DISCONNECTED; cannot transition out of this state.");
            return;
        }
        if (mState != state) {
            android.telecom.Log.d(this, "setState: %s", android.telecom.Connection.stateToString(state));
            mState = state;
     ...
     *
     * @param disconnectCause
     * 		The disconnect cause, ({@see android.telecomm.DisconnectCause}).
    ...
    public static android.telecom.Connection createCanceledConnection() {
        return new android.telecom.Connection.FailureSignalingConnection(new android.telecom.DisconnectCause(android.telecom.DisconnectCause.CANCELED));
    }
    ...
    private final void clearConferenceableList() {
        for (android.telecom.Conferenceable c : mConferenceables) {
            if (c instanceof android.telecom.Connection) {
                android.telecom.Connection connection = ((android.telecom.Connection) (c));
     ...
     *
     * @param conferenceParticipants
     * 		The participants.
     * @unknown 
     */
    protected final void updateConferenceParticipants(java.util.List<android.telecom.ConferenceParticipant> conferenceParticipants) {
        for (android.telecom.Connection.Listener l : mListeners) {
     ...
     *
     * @param isConferenceSupported
     * 		{@code true} if the connection supports being part of a
     ...
     */
    public void sendConnectionEvent(java.lang.String event, android.os.Bundle extras) {
        for (android.telecom.Connection.Listener l : mListeners) {
