...
public class DrmErrorEvent extends android.drm.DrmEvent {
     ...
     */
    public DrmErrorEvent(int uniqueId, int type, java.lang.String message) {
     ...
     */
    public DrmErrorEvent(int uniqueId, int type, java.lang.String message, java.util.HashMap<java.lang.String, java.lang.Object> attributes) {
        super(uniqueId, type, message, attributes);
        checkTypeValidity(type);
    }

    private void checkTypeValidity(int type) {
        if ((type < android.drm.DrmErrorEvent.TYPE_RIGHTS_NOT_INSTALLED) || (type > android.drm.DrmErrorEvent.TYPE_ACQUIRE_DRM_INFO_FAILED)) {
