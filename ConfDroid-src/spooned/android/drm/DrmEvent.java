...
public class DrmEvent {
    ...
    private java.util.HashMap<java.lang.String, java.lang.Object> mAttributes = new java.util.HashMap<java.lang.String, java.lang.Object>();
     ...
     */
    protected DrmEvent(int uniqueId, int type, java.lang.String message, java.util.HashMap<java.lang.String, java.lang.Object> attributes) {
        mUniqueId = uniqueId;
        mType = type;
        if (null != message) {
            mMessage = message;
     ...
     * 		Message description.
     */
    protected DrmEvent(int uniqueId, int type, java.lang.String message) {
        mUniqueId = uniqueId;
        mType = type;
        if (null != message) {
            mMessage = message;
