...
public class DrmSupportInfo {
    private final java.util.ArrayList<java.lang.String> mFileSuffixList = new java.util.ArrayList<java.lang.String>();

    private final java.util.ArrayList<java.lang.String> mMimeTypeList = new java.util.ArrayList<java.lang.String>();
     ...
     */
    public void addFileSuffix(java.lang.String fileSuffix) {
        if (fileSuffix == "") {
    ...
    public boolean equals(java.lang.Object object) {
        if (object instanceof android.drm.DrmSupportInfo) {
            android.drm.DrmSupportInfo info = ((android.drm.DrmSupportInfo) (object));
            return (mFileSuffixList.equals(info.mFileSuffixList) && mMimeTypeList.equals(info.mMimeTypeList)) && mDescription.equals(info.mDescription);
        }
        return false;
    }
    ...
    boolean isSupportedMimeType(java.lang.String mimeType) {
        if ((null != mimeType) && (!mimeType.equals(""))) {
            for (int i = 0; i < mMimeTypeList.size(); i++) {
                java.lang.String completeMimeType = mMimeTypeList.get(i);
     ...
     */
    /* package */
    boolean isSupportedFileSuffix(java.lang.String fileSuffix) {
