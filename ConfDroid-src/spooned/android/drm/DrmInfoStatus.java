...
public class DrmInfoStatus {
     ...
     * 		The MIME type.
     */
    public DrmInfoStatus(int statusCode, int infoType, android.drm.ProcessedData data, java.lang.String mimeType) {
        if (!android.drm.DrmInfoRequest.isValidType(infoType)) {
            throw new java.lang.IllegalArgumentException("infoType: " + infoType);
        }
        if (!isValidStatusCode(statusCode)) {
            throw new java.lang.IllegalArgumentException("Unsupported status code: " + statusCode);
        }
    ...
    private boolean isValidStatusCode(int statusCode) {
        return (statusCode == android.drm.DrmInfoStatus.STATUS_OK) || (statusCode == android.drm.DrmInfoStatus.STATUS_ERROR);
    }
}
