...
public class DrmConvertedStatus {
    ...
    private boolean isValidStatusCode(int statusCode) {
        return ((statusCode == android.drm.DrmConvertedStatus.STATUS_OK) || (statusCode == android.drm.DrmConvertedStatus.STATUS_INPUTDATA_ERROR)) || (statusCode == android.drm.DrmConvertedStatus.STATUS_ERROR);
    }
}
