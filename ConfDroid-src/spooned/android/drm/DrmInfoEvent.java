...
public class DrmInfoEvent extends android.drm.DrmEvent {
     ...
     */
    public DrmInfoEvent(int uniqueId, int type, java.lang.String message) {
     ...
     */
    public DrmInfoEvent(int uniqueId, int type, java.lang.String message, java.util.HashMap<java.lang.String, java.lang.Object> attributes) {
    ...
    private void checkTypeValidity(int type) {
        if ((type < android.drm.DrmInfoEvent.TYPE_ALREADY_REGISTERED_BY_ANOTHER_ACCOUNT) || (type > android.drm.DrmInfoEvent.TYPE_RIGHTS_REMOVED)) {
            if ((type != android.drm.DrmEvent.TYPE_ALL_RIGHTS_REMOVED) && (type != android.drm.DrmEvent.TYPE_DRM_INFO_PROCESSED)) {
                final java.lang.String msg = "Unsupported type: " + type;
