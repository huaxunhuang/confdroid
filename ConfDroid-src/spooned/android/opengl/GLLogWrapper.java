...
class GLLogWrapper extends android.opengl.GLWrapperBase {
    ...
    public GLLogWrapper(javax.microedition.khronos.opengles.GL gl, java.io.Writer log, boolean logArgumentNames) {
        super(gl);
        mLog = log;
    ...
    private void checkError() {
        ...
        if ((glError = mgl.glGetError()) != 0) {
            java.lang.String errorMessage = "glError: " + java.lang.Integer.toString(glError);
    ...
    private void arg(java.lang.String name, boolean value) {
        arg(name, java.lang.Boolean.toString(value));
    }
    ...
    private void arg(java.lang.String name, float value) {
        arg(name, java.lang.Float.toString(value));
    }
    ...
    private void arg(java.lang.String name, int n, int[] arr, int offset) {
        arg(name, toString(n, android.opengl.GLLogWrapper.FORMAT_INT, arr, offset));
    }
    ...
    private void formattedAppend(java.lang.StringBuilder buf, int value, int format) {
        switch (format) {
            case android.opengl.GLLogWrapper.FORMAT_INT :
                buf.append(value);
                break;
            case android.opengl.GLLogWrapper.FORMAT_FLOAT :
                buf.append(java.lang.Float.intBitsToFloat(value));
                break;
            case android.opengl.GLLogWrapper.FORMAT_FIXED :
    ...
    private void arg(java.lang.String name, int n, java.nio.IntBuffer buf) {
        arg(name, toString(n, android.opengl.GLLogWrapper.FORMAT_INT, buf));
    }
    ...
    private java.lang.String getTextureEnvParamName(float param) {
        ...
        return java.lang.Float.toString(param);
    }
        ...
        switch (pname) {
            ...
            case GL_COMPRESSED_TEXTURE_FORMATS :
                // Have to ask the implementation for the size
                {
                    ...
                    mgl.glGetIntegerv(android.opengl.GL_NUM_COMPRESSED_TEXTURE_FORMATS, buffer, 0);
                    return buffer[0];
                }
            case GL_DEPTH_BITS :
                return 1;
    ...
    private int getIntegerStateFormat(int pname) {
        switch (pname) {
            ...
            case GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES :
            case GL_TEXTURE_MATRIX_FLOAT_AS_INT_BITS_OES :
                return android.opengl.GLLogWrapper.FORMAT_FLOAT;
            default :
                return android.opengl.GLLogWrapper.FORMAT_INT;
        }
    }
    ...
    private java.lang.String getLightName(int light) {
        if ((light >= GL_LIGHT0) && (light <= GL_LIGHT7)) {
            return "GL_LIGHT" + java.lang.Integer.toString(light);
        }
    ...
    private java.nio.ByteBuffer toByteBuffer(int byteCount, java.nio.Buffer input) {
        java.nio.ByteBuffer result = null;
        boolean convertWholeBuffer = byteCount < 0;
        if (input instanceof java.nio.ByteBuffer) {
            java.nio.ByteBuffer input2 = ((java.nio.ByteBuffer) (input));
            ...
            if (input instanceof java.nio.CharBuffer) {
                java.nio.CharBuffer input2 = ((java.nio.CharBuffer) (input));
                int position = input2.position();
                if (convertWholeBuffer) {
                    byteCount = (input2.limit() - position) * 2;
                }
                result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                java.nio.CharBuffer result2 = result.asCharBuffer();
                for (int i = 0; i < (byteCount / 2); i++) {
                    result2.put(input2.get());
                }
                input2.position(position);
            } else
                if (input instanceof java.nio.ShortBuffer) {
                    java.nio.ShortBuffer input2 = ((java.nio.ShortBuffer) (input));
                    int position = input2.position();
                    if (convertWholeBuffer) {
                        byteCount = (input2.limit() - position) * 2;
                    }
                    result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                    java.nio.ShortBuffer result2 = result.asShortBuffer();
                    for (int i = 0; i < (byteCount / 2); i++) {
                        result2.put(input2.get());
                    }
                    input2.position(position);
                } else
                    if (input instanceof java.nio.IntBuffer) {
                        java.nio.IntBuffer input2 = ((java.nio.IntBuffer) (input));
                        int position = input2.position();
                        if (convertWholeBuffer) {
                            byteCount = (input2.limit() - position) * 4;
                        }
                        result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                        java.nio.IntBuffer result2 = result.asIntBuffer();
                        for (int i = 0; i < (byteCount / 4); i++) {
                            result2.put(input2.get());
                        }
                        input2.position(position);
                    } else
                        if (input instanceof java.nio.FloatBuffer) {
                            java.nio.FloatBuffer input2 = ((java.nio.FloatBuffer) (input));
                            int position = input2.position();
                            if (convertWholeBuffer) {
                                byteCount = (input2.limit() - position) * 4;
                            }
                            result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                            java.nio.FloatBuffer result2 = result.asFloatBuffer();
                            for (int i = 0; i < (byteCount / 4); i++) {
                                result2.put(input2.get());
                            }
                            input2.position(position);
                        } else
                            if (input instanceof java.nio.DoubleBuffer) {
                                java.nio.DoubleBuffer input2 = ((java.nio.DoubleBuffer) (input));
                                int position = input2.position();
                                if (convertWholeBuffer) {
                                    byteCount = (input2.limit() - position) * 8;
                                }
                                result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                                java.nio.DoubleBuffer result2 = result.asDoubleBuffer();
                                for (int i = 0; i < (byteCount / 8); i++) {
                                    result2.put(input2.get());
                                }
                                input2.position(position);
                            } else
                                if (input instanceof java.nio.LongBuffer) {
                                    java.nio.LongBuffer input2 = ((java.nio.LongBuffer) (input));
                                    int position = input2.position();
                                    if (convertWholeBuffer) {
                                        byteCount = (input2.limit() - position) * 8;
                                    }
                                    result = java.nio.ByteBuffer.allocate(byteCount).order(input2.order());
                                    java.nio.LongBuffer result2 = result.asLongBuffer();
                                    for (int i = 0; i < (byteCount / 8); i++) {
                                        result2.put(input2.get());
                                    }
                                    input2.position(position);
    ...
    private char[] toCharIndices(int count, int type, java.nio.Buffer indices) {
        ...
        switch (type) {
            case GL_UNSIGNED_BYTE :
                {
                    java.nio.ByteBuffer byteBuffer = toByteBuffer(count, indices);
            ...
            case GL_UNSIGNED_SHORT :
                {
                    ...
                    if (indices instanceof java.nio.CharBuffer) {
                        charBuffer = ((java.nio.CharBuffer) (indices));
                    } else {
                        java.nio.ByteBuffer byteBuffer = toByteBuffer(count * 2, indices);
    ...
    private void doArrayElement(java.lang.StringBuilder builder, boolean enabled, java.lang.String name, android.opengl.GLLogWrapper.PointerInfo pointer, int index) {
        ...
        java.nio.ByteBuffer byteBuffer = pointer.mTempByteBuffer;
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (type) {
                case GL_BYTE :
                    {
                        ...
                        builder.append(java.lang.Integer.toString(d));
                    }
                    break;
                case GL_UNSIGNED_BYTE :
                    {
                        byte d = byteBuffer.get(byteOffset);
                        builder.append(java.lang.Integer.toString(0xff & d));
                    }
                    break;
                case GL_SHORT :
                    {
                ...
                case GL_FLOAT :
                    {
                        java.nio.FloatBuffer intBuffer = byteBuffer.asFloatBuffer();
                        float d = intBuffer.get(byteOffset / 4);
                        builder.append(java.lang.Float.toString(d));
                    }
                    break;
                default :
                    builder.append("?");
    ...
    private void startLogIndices() {
        mStringBuilder = new java.lang.StringBuilder();
    ...
    public void glColorPointer(int size, int type, int stride, java.nio.Buffer pointer) {
        ...
        mColorPointer = new android.opengl.GLLogWrapper.PointerInfo(size, type, stride, pointer);
    ...
    public void glGenTextures(int n, int[] textures, int offset) {
        begin("glGenTextures");
        arg("n", n);
        arg("textures", java.util.Arrays.toString(textures));
        arg("offset", offset);
        mgl.glGenTextures(n, textures, offset);
        returns(toString(n, android.opengl.GLLogWrapper.FORMAT_INT, textures, offset));
        checkError();
    }
    ...
    public void glGenTextures(int n, java.nio.IntBuffer textures) {
        ...
        returns(toString(n, android.opengl.GLLogWrapper.FORMAT_INT, textures));
        checkError();
    }
    ...
    public void glGetIntegerv(int pname, int[] params, int offset) {
        ...
        arg("params", java.util.Arrays.toString(params));
        arg("offset", offset);
    ...
    public java.lang.String glGetString(int name) {
        begin("glGetString");
        arg("name", name);
        java.lang.String result = mgl.glGetString(name);
        returns(result);
        checkError();
        return result;
    }
    ...
    public void glNormalPointer(int type, int stride, java.nio.Buffer pointer) {
        ...
        mNormalPointer = new android.opengl.GLLogWrapper.PointerInfo(3, type, stride, pointer);
    ...
    public void glTexCoordPointer(int size, int type, int stride, java.nio.Buffer pointer) {
        ...
        mTexCoordPointer = new android.opengl.GLLogWrapper.PointerInfo(size, type, stride, pointer);
    ...
    public void glVertexPointer(int size, int type, int stride, java.nio.Buffer pointer) {
        ...
        mVertexPointer = new android.opengl.GLLogWrapper.PointerInfo(size, type, stride, pointer);
    ...
    public int glQueryMatrixxOES(int[] mantissa, int mantissaOffset, int[] exponent, int exponentOffset) {
        ...
        arg("mantissa", java.util.Arrays.toString(mantissa));
        arg("exponent", java.util.Arrays.toString(exponent));
        end();
        int valid = mgl10Ext.glQueryMatrixxOES(mantissa, mantissaOffset, exponent, exponentOffset);
        returns(toString(16, android.opengl.GLLogWrapper.FORMAT_FIXED, mantissa, mantissaOffset));
        returns(toString(16, android.opengl.GLLogWrapper.FORMAT_INT, exponent, exponentOffset));
        checkError();
        return valid;
    }
    ...
    public int glQueryMatrixxOES(java.nio.IntBuffer mantissa, java.nio.IntBuffer exponent) {
        ...
        returns(toString(16, android.opengl.GLLogWrapper.FORMAT_FIXED, mantissa));
        returns(toString(16, android.opengl.GLLogWrapper.FORMAT_INT, exponent));
        checkError();
        return valid;
    }
    ...
    private class PointerInfo {
        ...
        public java.nio.ByteBuffer mTempByteBuffer;// Only valid during glDrawXXX calls


        public PointerInfo() {
        }

        public PointerInfo(int size, int type, int stride, java.nio.Buffer pointer) {
            mSize = size;
            mType = type;
            mStride = stride;
            mPointer = pointer;
    ...
    private android.opengl.GLLogWrapper.PointerInfo mColorPointer = new android.opengl.GLLogWrapper.PointerInfo();

    private android.opengl.GLLogWrapper.PointerInfo mNormalPointer = new android.opengl.GLLogWrapper.PointerInfo();

    private android.opengl.GLLogWrapper.PointerInfo mTexCoordPointer = new android.opengl.GLLogWrapper.PointerInfo();

    private android.opengl.GLLogWrapper.PointerInfo mVertexPointer = new android.opengl.GLLogWrapper.PointerInfo();
