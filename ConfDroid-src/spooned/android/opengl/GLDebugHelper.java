...
public class GLDebugHelper {
     ...
     *
     * @param gl
     * 		the existing GL interface. Must implement GL and GL10. May
    ...
    public static javax.microedition.khronos.opengles.GL wrap(javax.microedition.khronos.opengles.GL gl, int configFlags, java.io.Writer log) {
        if (configFlags != 0) {
            gl = new android.opengl.GLErrorWrapper(gl, configFlags);
        }
        if (log != null) {
            boolean logArgumentNames = (android.opengl.GLDebugHelper.CONFIG_LOG_ARGUMENT_NAMES & configFlags) != 0;
     ...
     */
    public static javax.microedition.khronos.egl.EGL wrap(javax.microedition.khronos.egl.EGL egl, int configFlags, java.io.Writer log) {
        if (log != null) {
