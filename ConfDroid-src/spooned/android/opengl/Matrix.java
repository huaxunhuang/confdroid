...
public class Matrix {
     ...
     * 		if result, lhs, or rhs are null, or if
    ...
    public static void perspectiveM(float[] m, int offset, float fovy, float aspect, float zNear, float zFar) {
        float f = 1.0F / ((float) (java.lang.Math.tan(fovy * (java.lang.Math.PI / 360.0))));
    ...
    public static void rotateM(float[] rm, int rmOffset, float[] m, int mOffset, float a, float x, float y, float z) {
        synchronized(android.opengl.Matrix.sTemp) {
            android.opengl.Matrix.setRotateM(android.opengl.Matrix.sTemp, 0, a, x, y, z);
            android.opengl.Matrix.multiplyMM(rm, rmOffset, m, mOffset, android.opengl.Matrix.sTemp, 0);
        }
    }
    ...
    public static void rotateM(float[] m, int mOffset, float a, float x, float y, float z) {
        synchronized(android.opengl.Matrix.sTemp) {
            android.opengl.Matrix.setRotateM(android.opengl.Matrix.sTemp, 0, a, x, y, z);
            android.opengl.Matrix.multiplyMM(android.opengl.Matrix.sTemp, 16, m, mOffset, android.opengl.Matrix.sTemp, 0);
            java.lang.System.arraycopy(android.opengl.Matrix.sTemp, 16, m, mOffset, 16);
        }
    }
    ...
    public static void setRotateM(float[] rm, int rmOffset, float a, float x, float y, float z) {
        ...
        rm[rmOffset + 14] = 0;
        rm[rmOffset + 15] = 1;
        a *= ((float) (java.lang.Math.PI / 180.0F));
        float s = ((float) (java.lang.Math.sin(a)));
        float c = ((float) (java.lang.Math.cos(a)));
        if (((1.0F == x) && (0.0F == y)) && (0.0F == z)) {
            ...
            if (((0.0F == x) && (1.0F == y)) && (0.0F == z)) {
                ...
                if (((0.0F == x) && (0.0F == y)) && (1.0F == z)) {
                    ...
                    float len = android.opengl.Matrix.length(x, y, z);
                    if (1.0F != len) {
    ...
    public static void setRotateEulerM(float[] rm, int rmOffset, float x, float y, float z) {
        x *= ((float) (java.lang.Math.PI / 180.0F));
        y *= ((float) (java.lang.Math.PI / 180.0F));
        z *= ((float) (java.lang.Math.PI / 180.0F));
        float cx = ((float) (java.lang.Math.cos(x)));
        float sx = ((float) (java.lang.Math.sin(x)));
        float cy = ((float) (java.lang.Math.cos(y)));
        float sy = ((float) (java.lang.Math.sin(y)));
        float cz = ((float) (java.lang.Math.cos(z)));
        float sz = ((float) (java.lang.Math.sin(z)));
        float cxsy = cx * sy;
        float sxsy = sx * sy;
        rm[rmOffset + 0] = cy * cz;
        rm[rmOffset + 1] = (-cy) * sz;
    ...
    public static void setLookAtM(float[] rm, int rmOffset, float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ) {
        ...
        // Normalize f
        float rlf = 1.0F / android.opengl.Matrix.length(fx, fy, fz);
        fx *= rlf;
        fy *= rlf;
        fz *= rlf;
