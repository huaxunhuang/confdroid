...
public class GLU {
    ...
    public static java.lang.String gluErrorString(int error) {
        switch (error) {
            case javax.microedition.khronos.opengles.GL10.GL_NO_ERROR :
                return "no error";
            case javax.microedition.khronos.opengles.GL10.GL_INVALID_ENUM :
                return "invalid enum";
            case javax.microedition.khronos.opengles.GL10.GL_INVALID_VALUE :
                return "invalid value";
            case javax.microedition.khronos.opengles.GL10.GL_INVALID_OPERATION :
                return "invalid operation";
            case javax.microedition.khronos.opengles.GL10.GL_STACK_OVERFLOW :
                return "stack overflow";
            case javax.microedition.khronos.opengles.GL10.GL_STACK_UNDERFLOW :
                return "stack underflow";
            case javax.microedition.khronos.opengles.GL10.GL_OUT_OF_MEMORY :
    ...
    public static void gluLookAt(javax.microedition.khronos.opengles.GL10 gl, float eyeX, float eyeY, float eyeZ, float centerX, float centerY, float centerZ, float upX, float upY, float upZ) {
        float[] scratch = android.opengl.GLU.sScratch;
    ...
    public static void gluPerspective(javax.microedition.khronos.opengles.GL10 gl, float fovy, float aspect, float zNear, float zFar) {
        float top = zNear * ((float) (java.lang.Math.tan(fovy * (java.lang.Math.PI / 360.0))));
        float bottom = -top;
    ...
    public static int gluProject(float objX, float objY, float objZ, float[] model, int modelOffset, float[] project, int projectOffset, int[] view, int viewOffset, float[] win, int winOffset) {
        ...
        synchronized(scratch) {
            ...
            android.opengl.Matrix.multiplyMM(scratch, M_OFFSET, project, projectOffset, model, modelOffset);
            scratch[V_OFFSET + 0] = objX;
            scratch[V_OFFSET + 1] = objY;
            scratch[V_OFFSET + 2] = objZ;
            scratch[V_OFFSET + 3] = 1.0F;
            android.opengl.Matrix.multiplyMV(scratch, V2_OFFSET, scratch, M_OFFSET, scratch, V_OFFSET);
            float w = scratch[V2_OFFSET + 3];
            if (w == 0.0F) {
                return javax.microedition.khronos.opengles.GL10.GL_FALSE;
            }
            float rw = 1.0F / w;
        ...
        return javax.microedition.khronos.opengles.GL10.GL_TRUE;
    }
    ...
    public static int gluUnProject(float winX, float winY, float winZ, float[] model, int modelOffset, float[] project, int projectOffset, int[] view, int viewOffset, float[] obj, int objOffset) {
        ...
        synchronized(scratch) {
            ...
            android.opengl.Matrix.multiplyMM(scratch, PM_OFFSET, project, projectOffset, model, modelOffset);
            if (!android.opengl.Matrix.invertM(scratch, INVPM_OFFSET, scratch, PM_OFFSET)) {
                return javax.microedition.khronos.opengles.GL10.GL_FALSE;
            }
            ...
            scratch[V_OFFSET + 3] = 1.0F;
            android.opengl.Matrix.multiplyMV(obj, objOffset, scratch, INVPM_OFFSET, scratch, V_OFFSET);
        }
        return javax.microedition.khronos.opengles.GL10.GL_TRUE;
    }
