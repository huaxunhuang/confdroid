...
public final class SQLiteDebug {
     ...
     */
    public static final boolean DEBUG_SQL_LOG = android.util.Log.isLoggable("SQLiteLog", android.util.Log.VERBOSE);
     ...
     */
    public static final boolean DEBUG_SQL_STATEMENTS = android.util.Log.isLoggable("SQLiteStatements", android.util.Log.VERBOSE);
     ...
     */
    public static final boolean DEBUG_SQL_TIME = android.util.Log.isLoggable("SQLiteTime", android.util.Log.VERBOSE);
     ...
     * @unknown 
     */
    public static final boolean DEBUG_LOG_SLOW_QUERIES = android.os.Build.IS_DEBUGGABLE;
    ...
    public static final boolean shouldLogSlowQuery(long elapsedTimeMillis) {
        int slowQueryMillis = android.os.SystemProperties.getInt("db.log.slow_query_threshold", -1);
    ...
    public static class DbStats {
        ...
        public DbStats(java.lang.String dbName, long pageCount, long pageSize, int lookaside, int hits, int misses, int cachesize) {
            this.dbName = dbName;
    ...
    public static android.database.sqlite.SQLiteDebug.PagerStats getDatabaseInfo() {
        android.database.sqlite.SQLiteDebug.PagerStats stats = new android.database.sqlite.SQLiteDebug.PagerStats();
        android.database.sqlite.SQLiteDebug.nativeGetPagerStats(stats);
        stats.dbStats = android.database.sqlite.SQLiteDatabase.getDbStats();
        return stats;
    }
     ...
     *
     * @param printer
     * 		The printer for dumping database state.
     * @param args
     * 		Command-line arguments supplied to dumpsys dbinfo
     */
    public static void dump(android.util.Printer printer, java.lang.String[] args) {
        ...
        android.database.sqlite.SQLiteDatabase.dumpAll(printer, verbose);
    }
}
