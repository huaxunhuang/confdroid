...
public final class SQLiteGlobal {
    ...
    public static int releaseMemory() {
        return android.database.sqlite.SQLiteGlobal.nativeReleaseMemory();
    }
    ...
    public static int getDefaultPageSize() {
        synchronized(android.database.sqlite.SQLiteGlobal.sLock) {
            if (android.database.sqlite.SQLiteGlobal.sDefaultPageSize == 0) {
                android.database.sqlite.SQLiteGlobal.sDefaultPageSize = new android.os.StatFs("/data").getBlockSize();
            }
            return android.os.SystemProperties.getInt("debug.sqlite.pagesize", android.database.sqlite.SQLiteGlobal.sDefaultPageSize);
        }
    }
    ...
    public static int getWALAutoCheckpoint() {
        int value = android.os.SystemProperties.getInt("debug.sqlite.wal.autocheckpoint", android.content.res.Resources.getSystem().getInteger(com.android.internal.R.integer.db_wal_autocheckpoint));
        return java.lang.Math.max(1, value);
    }
    ...
    public static int getWALConnectionPoolSize() {
        int value = android.os.SystemProperties.getInt("debug.sqlite.wal.poolsize", android.content.res.Resources.getSystem().getInteger(com.android.internal.R.integer.db_connection_pool_size));
        return java.lang.Math.max(2, value);
    }
}
