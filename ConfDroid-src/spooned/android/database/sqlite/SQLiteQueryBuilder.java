...
public class SQLiteQueryBuilder {
    ...
    private java.lang.StringBuilder mWhereClause = null;// lazily created
    ...
    public void appendWhere(java.lang.CharSequence inWhere) {
        if (mWhereClause == null) {
            mWhereClause = new java.lang.StringBuilder(inWhere.length() + 16);
        }
    ...
    public void appendWhereEscapeString(java.lang.String inWhere) {
        ...
        android.database.DatabaseUtils.appendEscapedSQLString(mWhereClause, inWhere);
    }
     ...
     */
    public static java.lang.String buildQueryString(boolean distinct, java.lang.String tables, java.lang.String[] columns, java.lang.String where, java.lang.String groupBy, java.lang.String having, java.lang.String orderBy, java.lang.String limit) {
        ...
        if ((!android.text.TextUtils.isEmpty(limit)) && (!android.database.sqlite.SQLiteQueryBuilder.sLimitPattern.matcher(limit).matches())) {
            throw new java.lang.IllegalArgumentException("invalid LIMIT clauses:" + limit);
        }
        java.lang.StringBuilder query = new java.lang.StringBuilder(120);
        query.append("SELECT ");
        if (distinct) {
     ...
     * them with commas.
     */
    public static void appendColumns(java.lang.StringBuilder s, java.lang.String[] columns) {
        int n = columns.length;
        for (int i = 0; i < n; i++) {
            java.lang.String column = columns[i];
            if (column != null) {
                if (i > 0) {
                    s.append(", ");
                }
    ...
    public android.database.Cursor query(android.database.sqlite.SQLiteDatabase db, java.lang.String[] projectionIn, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having, java.lang.String sortOrder) {
        return /* limit */
        /* cancellationSignal */
        query(db, projectionIn, selection, selectionArgs, groupBy, having, sortOrder, null, null);
    }
    ...
    String, String[], String)
     */
    public android.database.Cursor query(android.database.sqlite.SQLiteDatabase db, java.lang.String[] projectionIn, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having, java.lang.String sortOrder, java.lang.String limit) {
    ...
    public android.database.Cursor query(android.database.sqlite.SQLiteDatabase db, java.lang.String[] projectionIn, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having, java.lang.String sortOrder, java.lang.String limit, android.os.CancellationSignal cancellationSignal) {
        ...
        if ((mStrict && (selection != null)) && (selection.length() > 0)) {
            ...
            java.lang.String sqlForValidation = buildQuery(projectionIn, ("(" + selection) + ")", groupBy, having, sortOrder, limit);
            db.validateSql(sqlForValidation, cancellationSignal);// will throw if query is invalid

        }
        java.lang.String sql = buildQuery(projectionIn, selection, groupBy, having, sortOrder, limit);
        if (android.util.Log.isLoggable(android.database.sqlite.SQLiteQueryBuilder.TAG, android.util.Log.DEBUG)) {
            android.util.Log.d(android.database.sqlite.SQLiteQueryBuilder.TAG, "Performing query: " + sql);
        }
        return db.rawQueryWithFactory(mFactory, sql, selectionArgs, android.database.sqlite.SQLiteDatabase.findEditTable(mTables), cancellationSignal);// will throw if query is invalid
     ...
     */
    public java.lang.String buildQuery(java.lang.String[] projectionIn, java.lang.String selection, java.lang.String groupBy, java.lang.String having, java.lang.String sortOrder, java.lang.String limit) {
        java.lang.String[] projection = computeProjection(projectionIn);
        ...
        return android.database.sqlite.SQLiteQueryBuilder.buildQueryString(mDistinct, mTables, projection, where.toString(), groupBy, having, sortOrder, limit);
    }
     ...
     * @return the resulting SQL SELECT statement
     */
    public java.lang.String buildUnionSubQuery(java.lang.String typeDiscriminatorColumn, java.lang.String[] unionColumns, java.util.Set<java.lang.String> columnsPresentInTable, int computedColumnsOffset, java.lang.String typeDiscriminatorValue, java.lang.String selection, java.lang.String groupBy, java.lang.String having) {
        int unionColumnsCount = unionColumns.length;
        java.lang.String[] projectionIn = new java.lang.String[unionColumnsCount];
        for (int i = 0; i < unionColumnsCount; i++) {
            java.lang.String unionColumn = unionColumns[i];
        ...
        return /* sortOrder */
        /* limit */
        buildQuery(projectionIn, selection, groupBy, having, null, null);
    }
     ...
     */
    @java.lang.Deprecated
    public java.lang.String buildUnionSubQuery(java.lang.String typeDiscriminatorColumn, java.lang.String[] unionColumns, java.util.Set<java.lang.String> columnsPresentInTable, int computedColumnsOffset, java.lang.String typeDiscriminatorValue, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having) {
     ...
     * @return the resulting SQL SELECT statement
     */
    public java.lang.String buildUnionQuery(java.lang.String[] subQueries, java.lang.String sortOrder, java.lang.String limit) {
        java.lang.StringBuilder query = new java.lang.StringBuilder(128);
        int subQueryCount = subQueries.length;
        java.lang.String unionOperator = (mDistinct) ? " UNION " : " UNION ALL ";
    ...
    private java.lang.String[] computeProjection(java.lang.String[] projectionIn) {
        if ((projectionIn != null) && (projectionIn.length > 0)) {
            if (mProjectionMap != null) {
                java.lang.String[] projection = new java.lang.String[projectionIn.length];
                int length = projectionIn.length;
                for (int i = 0; i < length; i++) {
                    java.lang.String userColumn = projectionIn[i];
                    java.lang.String column = mProjectionMap.get(userColumn);
                    if (column != null) {
                        projection[i] = column;
                        continue;
                    }
                    ...
                    throw new java.lang.IllegalArgumentException("Invalid column " + projectionIn[i]);
                }
                return projection;
            } else {
                return projectionIn;
            ...
            if (mProjectionMap != null) {
                ...
                java.util.Set<java.util.Map.Entry<java.lang.String, java.lang.String>> entrySet = mProjectionMap.entrySet();
                java.lang.String[] projection = new java.lang.String[entrySet.size()];
                java.util.Iterator<java.util.Map.Entry<java.lang.String, java.lang.String>> entryIter = entrySet.iterator();
                int i = 0;
                while (entryIter.hasNext()) {
                    java.util.Map.Entry<java.lang.String, java.lang.String> entry = entryIter.next();
