...
public final class SQLiteDatabase extends android.database.sqlite.SQLiteClosable {
    ...
    private static java.util.WeakHashMap<android.database.sqlite.SQLiteDatabase, java.lang.Object> sActiveDatabases = new java.util.WeakHashMap<android.database.sqlite.SQLiteDatabase, java.lang.Object>();

    // Thread-local for database sessions that belong to this database.
    // Each thread has its own database session.
    // INVARIANT: Immutable.
    private final java.lang.ThreadLocal<android.database.sqlite.SQLiteSession> mThreadSession = new java.lang.ThreadLocal<android.database.sqlite.SQLiteSession>() {
        @java.lang.Override
    ...
    private static final java.lang.String[] CONFLICT_VALUES = new java.lang.String[]{ "", " OR ROLLBACK ", " OR ABORT ", " OR FAIL ", " OR IGNORE ", " OR REPLACE " };
     ...
     */
    public static final int OPEN_READWRITE = 0x0;// update native code if changing
     ...
     */
    public static final int OPEN_READONLY = 0x1;// update native code if changing


    private static final int OPEN_READ_MASK = 0x1;// update native code if changing
     ...
     */
    public static final int NO_LOCALIZED_COLLATORS = 0x10;// update native code if changing
    ...
    private SQLiteDatabase(java.lang.String path, int openFlags, android.database.sqlite.SQLiteDatabase.CursorFactory cursorFactory, android.database.DatabaseErrorHandler errorHandler) {
        mCursorFactory = cursorFactory;
        mErrorHandler = (errorHandler != null) ? errorHandler : new android.database.DefaultDatabaseErrorHandler();
        mConfigurationLocked = new android.database.sqlite.SQLiteDatabaseConfiguration(path, openFlags);
    }
    ...
    private void dispose(boolean finalized) {
        final android.database.sqlite.SQLiteConnectionPool pool;
        synchronized(mLock) {
        ...
        if (!finalized) {
            synchronized(android.database.sqlite.SQLiteDatabase.sActiveDatabases) {
                android.database.sqlite.SQLiteDatabase.sActiveDatabases.remove(this);
            }
            if (pool != null) {
                pool.close();
            }
     ...
     */
    void onCorruption() {
        android.util.EventLog.writeEvent(android.database.sqlite.SQLiteDatabase.EVENT_DB_CORRUPT, getLabel());
     ...
     * 		if the thread does not yet have a session and
    ...
    android.database.sqlite.SQLiteSession createSession() {
        ...
        return new android.database.sqlite.SQLiteSession(pool);
    }
    ...
    int getThreadDefaultConnectionFlags(boolean readOnly) {
        int flags = (readOnly) ? android.database.sqlite.SQLiteConnectionPool.CONNECTION_FLAG_READ_ONLY : android.database.sqlite.SQLiteConnectionPool.CONNECTION_FLAG_PRIMARY_CONNECTION_AFFINITY;
        if (android.database.sqlite.SQLiteDatabase.isMainThread()) {
            flags |= android.database.sqlite.SQLiteConnectionPool.CONNECTION_FLAG_INTERACTIVE;
        }
        return flags;
    }
    ...
    private static boolean isMainThread() {
        ...
        return (looper != null) && (looper == android.os.Looper.getMainLooper());
    }
    ...
    private void beginTransaction(android.database.sqlite.SQLiteTransactionListener transactionListener, boolean exclusive) {
        acquireReference();
        try {
            getThreadSession().beginTransaction(exclusive ? android.database.sqlite.SQLiteSession.TRANSACTION_MODE_EXCLUSIVE : android.database.sqlite.SQLiteSession.TRANSACTION_MODE_IMMEDIATE, transactionListener, /* readOnly */
    ...
    public boolean yieldIfContended() {
        return /* do not check yielding */
        /* sleepAfterYieldDelay */
        yieldIfContendedHelper(false, -1);
    }
    ...
    public boolean yieldIfContendedSafely() {
        return /* check yielding */
        /* sleepAfterYieldDelay */
        yieldIfContendedHelper(true, -1);
    }
    ...
    public boolean yieldIfContendedSafely(long sleepAfterYieldDelay) {
        return /* check yielding */
        yieldIfContendedHelper(true, sleepAfterYieldDelay);
    }
    ...
    public java.util.Map<java.lang.String, java.lang.String> getSyncedTables() {
        return new java.util.HashMap<java.lang.String, java.lang.String>(0);
    }
    ...
    public static android.database.sqlite.SQLiteDatabase openDatabase(java.lang.String path, android.database.sqlite.SQLiteDatabase.CursorFactory factory, int flags) {
        return android.database.sqlite.SQLiteDatabase.openDatabase(path, factory, flags, null);
    }
     ...
     * 		to control database access mode
     * @param errorHandler
     * 		the {@link DatabaseErrorHandler} obj to be used to handle corruption
    ...
    public static android.database.sqlite.SQLiteDatabase openDatabase(java.lang.String path, android.database.sqlite.SQLiteDatabase.CursorFactory factory, int flags, android.database.DatabaseErrorHandler errorHandler) {
        android.database.sqlite.SQLiteDatabase db = new android.database.sqlite.SQLiteDatabase(path, flags, factory, errorHandler);
        db.open();
        return db;
    }
    ...
    public static android.database.sqlite.SQLiteDatabase openOrCreateDatabase(java.lang.String path, android.database.sqlite.SQLiteDatabase.CursorFactory factory) {
        return android.database.sqlite.SQLiteDatabase.openDatabase(path, factory, android.database.sqlite.SQLiteDatabase.CREATE_IF_NECESSARY, null);
    }
    ...
    public static android.database.sqlite.SQLiteDatabase openOrCreateDatabase(java.lang.String path, android.database.sqlite.SQLiteDatabase.CursorFactory factory, android.database.DatabaseErrorHandler errorHandler) {
        return android.database.sqlite.SQLiteDatabase.openDatabase(path, factory, android.database.sqlite.SQLiteDatabase.CREATE_IF_NECESSARY, errorHandler);
    }
    ...
    public static boolean deleteDatabase(java.io.File file) {
        ...
        if (dir != null) {
            final java.lang.String prefix = file.getName() + "-mj";
            ...
            if (files != null) {
                for (java.io.File masterJournal : files) {
    ...
    public void reopenReadWrite() {
        synchronized(mLock) {
            ...
            mConfigurationLocked.openFlags = (mConfigurationLocked.openFlags & (~android.database.sqlite.SQLiteDatabase.OPEN_READ_MASK)) | android.database.sqlite.SQLiteDatabase.OPEN_READWRITE;
            try {
    ...
    private void open() {
        try {
            ...
            android.util.Log.e(android.database.sqlite.SQLiteDatabase.TAG, ("Failed to open database '" + getLabel()) + "'.", ex);
            close();
            throw ex;
        }
    }
    ...
    private void openInner() {
        synchronized(mLock) {
            ...
            mConnectionPoolLocked = android.database.sqlite.SQLiteConnectionPool.open(mConfigurationLocked);
            mCloseGuardLocked.open("close");
        }
        synchronized(android.database.sqlite.SQLiteDatabase.sActiveDatabases) {
            android.database.sqlite.SQLiteDatabase.sActiveDatabases.put(this, null);
        }
    }
    ...
    public static android.database.sqlite.SQLiteDatabase create(android.database.sqlite.SQLiteDatabase.CursorFactory factory) {
        ...
        return android.database.sqlite.SQLiteDatabase.openDatabase(android.database.sqlite.SQLiteDatabaseConfiguration.MEMORY_DB_PATH, factory, android.database.sqlite.SQLiteDatabase.CREATE_IF_NECESSARY);
    }
     ...
     * @unknown 
     */
    public void addCustomFunction(java.lang.String name, int numArgs, android.database.sqlite.SQLiteDatabase.CustomFunction function) {
        // Create wrapper (also validates arguments).
        android.database.sqlite.SQLiteCustomFunction wrapper = new android.database.sqlite.SQLiteCustomFunction(name, numArgs, function);
        synchronized(mLock) {
            throwIfNotOpenLocked();
    ...
    public int getVersion() {
        return ((java.lang.Long) (android.database.DatabaseUtils.longForQuery(this, "PRAGMA user_version;", null))).intValue();
    }
    ...
    public long getMaximumSize() {
        long pageCount = android.database.DatabaseUtils.longForQuery(this, "PRAGMA max_page_count;", null);
    ...
    public long setMaximumSize(long numBytes) {
        ...
        long newPageCount = android.database.DatabaseUtils.longForQuery(this, "PRAGMA max_page_count = " + numPages, null);
    ...
    public static java.lang.String findEditTable(java.lang.String tables) {
        if (!android.text.TextUtils.isEmpty(tables)) {
    ...
    public android.database.sqlite.SQLiteStatement compileStatement(java.lang.String sql) throws android.database.SQLException {
        acquireReference();
        try {
            return new android.database.sqlite.SQLiteStatement(this, sql, null);
        } finally {
            releaseReference();
        }
    }
    ...
    public android.database.Cursor queryWithFactory(android.database.sqlite.SQLiteDatabase.CursorFactory cursorFactory, boolean distinct, java.lang.String table, java.lang.String[] columns, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having, java.lang.String orderBy, java.lang.String limit, android.os.CancellationSignal cancellationSignal) {
        acquireReference();
        try {
            java.lang.String sql = android.database.sqlite.SQLiteQueryBuilder.buildQueryString(distinct, table, columns, selection, groupBy, having, orderBy, limit);
            return rawQueryWithFactory(cursorFactory, sql, selectionArgs, android.database.sqlite.SQLiteDatabase.findEditTable(table), cancellationSignal);
        } finally {
            releaseReference();
        }
    }
    ...
    public android.database.Cursor query(java.lang.String table, java.lang.String[] columns, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String groupBy, java.lang.String having, java.lang.String orderBy) {
        return /* limit */
        query(false, table, columns, selection, selectionArgs, groupBy, having, orderBy, null);
    }
    ...
    public android.database.Cursor rawQueryWithFactory(android.database.sqlite.SQLiteDatabase.CursorFactory cursorFactory, java.lang.String sql, java.lang.String[] selectionArgs, java.lang.String editTable, android.os.CancellationSignal cancellationSignal) {
        acquireReference();
        try {
            android.database.sqlite.SQLiteCursorDriver driver = new android.database.sqlite.SQLiteDirectCursorDriver(this, sql, editTable, cancellationSignal);
    ...
    public long insert(java.lang.String table, java.lang.String nullColumnHack, android.content.ContentValues values) {
        try {
            return insertWithOnConflict(table, nullColumnHack, values, android.database.sqlite.SQLiteDatabase.CONFLICT_NONE);
        } catch (android.database.SQLException e) {
            android.util.Log.e(android.database.sqlite.SQLiteDatabase.TAG, "Error inserting " + values, e);
            return -1;
        }
    }
    ...
    public long replace(java.lang.String table, java.lang.String nullColumnHack, android.content.ContentValues initialValues) {
        try {
            return insertWithOnConflict(table, nullColumnHack, initialValues, android.database.sqlite.SQLiteDatabase.CONFLICT_REPLACE);
        } catch (android.database.SQLException e) {
            android.util.Log.e(android.database.sqlite.SQLiteDatabase.TAG, "Error inserting " + initialValues, e);
            return -1;
        }
    }
    ...
    public long insertWithOnConflict(java.lang.String table, java.lang.String nullColumnHack, android.content.ContentValues initialValues, int conflictAlgorithm) {
        ...
        try {
            ...
            sql.append(table);
            sql.append('(');
            java.lang.Object[] bindArgs = null;
            int size = ((initialValues != null) && (initialValues.size() > 0)) ? initialValues.size() : 0;
            if (size > 0) {
                bindArgs = new java.lang.Object[size];
                int i = 0;
                for (java.lang.String colName : initialValues.keySet()) {
                    sql.append(i > 0 ? "," : "");
                    sql.append(colName);
            ...
            sql.append(')');
            android.database.sqlite.SQLiteStatement statement = new android.database.sqlite.SQLiteStatement(this, sql.toString(), bindArgs);
            try {
    ...
    public int delete(java.lang.String table, java.lang.String whereClause, java.lang.String[] whereArgs) {
        acquireReference();
        try {
            android.database.sqlite.SQLiteStatement statement = new android.database.sqlite.SQLiteStatement(this, ("DELETE FROM " + table) + (!android.text.TextUtils.isEmpty(whereClause) ? " WHERE " + whereClause : ""), whereArgs);
            try {
    ...
    public int update(java.lang.String table, android.content.ContentValues values, java.lang.String whereClause, java.lang.String[] whereArgs) {
        return updateWithOnConflict(table, values, whereClause, whereArgs, android.database.sqlite.SQLiteDatabase.CONFLICT_NONE);
    }
    ...
    public int updateWithOnConflict(java.lang.String table, android.content.ContentValues values, java.lang.String whereClause, java.lang.String[] whereArgs, int conflictAlgorithm) {
        ...
        acquireReference();
        try {
            java.lang.StringBuilder sql = new java.lang.StringBuilder(120);
            sql.append("UPDATE ");
            sql.append(android.database.sqlite.SQLiteDatabase.CONFLICT_VALUES[conflictAlgorithm]);
            sql.append(table);
            sql.append(" SET ");
            ...
            java.lang.Object[] bindArgs = new java.lang.Object[bindArgsSize];
            int i = 0;
            for (java.lang.String colName : values.keySet()) {
                sql.append(i > 0 ? "," : "");
                sql.append(colName);
    ...
    private int executeSql(java.lang.String sql, java.lang.Object[] bindArgs) throws android.database.SQLException {
        acquireReference();
        try {
            if (android.database.DatabaseUtils.getSqlStatementType(sql) == android.database.DatabaseUtils.STATEMENT_ATTACH) {
            ...
            android.database.sqlite.SQLiteStatement statement = new android.database.sqlite.SQLiteStatement(this, sql, bindArgs);
            try {
                return statement.executeUpdateDelete();
            } finally {
                statement.close();
     ...
     * 		when the query is executed.
     * @throws SQLiteException
     * 		if {@code sql} is invalid
     */
    public void validateSql(@android.annotation.NonNull
    java.lang.String sql, @android.annotation.Nullable
    android.os.CancellationSignal cancellationSignal) {
        getThreadSession().prepare(sql, /* readOnly = */
    ...
    private boolean isReadOnlyLocked() {
        return (mConfigurationLocked.openFlags & android.database.sqlite.SQLiteDatabase.OPEN_READ_MASK) == android.database.sqlite.SQLiteDatabase.OPEN_READONLY;
    }
    ...
    public void setLocale(java.util.Locale locale) {
        ...
        synchronized(mLock) {
            throwIfNotOpenLocked();
            final java.util.Locale oldLocale = mConfigurationLocked.locale;
     ...
     *
     * @param cacheSize
     * 		the size of the cache. can be (0 to {@link #MAX_SQL_CACHE_SIZE})
     * @throws IllegalStateException
     * 		if input cacheSize > {@link #MAX_SQL_CACHE_SIZE}.
     */
    public void setMaxSqlCacheSize(int cacheSize) {
        if ((cacheSize > android.database.sqlite.SQLiteDatabase.MAX_SQL_CACHE_SIZE) || (cacheSize < 0)) {
            throw new java.lang.IllegalStateException("expected value between 0 and " + android.database.sqlite.SQLiteDatabase.MAX_SQL_CACHE_SIZE);
        }
        synchronized(mLock) {
            throwIfNotOpenLocked();
    ...
    public boolean enableWriteAheadLogging() {
        synchronized(mLock) {
            throwIfNotOpenLocked();
            if ((mConfigurationLocked.openFlags & android.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0) {
                return true;
            }
            if (isReadOnlyLocked()) {
            ...
            if (mConfigurationLocked.isInMemoryDb()) {
                android.util.Log.i(android.database.sqlite.SQLiteDatabase.TAG, "can't enable WAL for memory databases.");
                return false;
            }
            // make sure this database has NO attached databases because sqlite's write-ahead-logging
            // doesn't work for databases with attached databases
            if (mHasAttachedDbsLocked) {
                if (android.util.Log.isLoggable(android.database.sqlite.SQLiteDatabase.TAG, android.util.Log.DEBUG)) {
                    android.util.Log.d(android.database.sqlite.SQLiteDatabase.TAG, ("this database: " + mConfigurationLocked.label) + " has attached databases. can't  enable WAL.");
                }
                return false;
            }
            mConfigurationLocked.openFlags |= android.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING;
            try {
                mConnectionPoolLocked.reconfigure(mConfigurationLocked);
            } catch (java.lang.RuntimeException ex) {
                mConfigurationLocked.openFlags &= ~android.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING;
    ...
    public boolean isWriteAheadLoggingEnabled() {
        synchronized(mLock) {
            throwIfNotOpenLocked();
            return (mConfigurationLocked.openFlags & android.database.sqlite.SQLiteDatabase.ENABLE_WRITE_AHEAD_LOGGING) != 0;
        }
    }
    ...
    static java.util.ArrayList<android.database.sqlite.SQLiteDebug.DbStats> getDbStats() {
        java.util.ArrayList<android.database.sqlite.SQLiteDebug.DbStats> dbStatsList = new java.util.ArrayList<android.database.sqlite.SQLiteDebug.DbStats>();
        for (android.database.sqlite.SQLiteDatabase db : android.database.sqlite.SQLiteDatabase.getActiveDatabases()) {
            db.collectDbStats(dbStatsList);
        }
        return dbStatsList;
    }

    private void collectDbStats(java.util.ArrayList<android.database.sqlite.SQLiteDebug.DbStats> dbStatsList) {
        synchronized(mLock) {
    ...
    private static java.util.ArrayList<android.database.sqlite.SQLiteDatabase> getActiveDatabases() {
        java.util.ArrayList<android.database.sqlite.SQLiteDatabase> databases = new java.util.ArrayList<android.database.sqlite.SQLiteDatabase>();
        synchronized(android.database.sqlite.SQLiteDatabase.sActiveDatabases) {
            databases.addAll(android.database.sqlite.SQLiteDatabase.sActiveDatabases.keySet());
        }
        return databases;
    }
     ...
     * Used by bug report.
     */
    static void dumpAll(android.util.Printer printer, boolean verbose) {
        for (android.database.sqlite.SQLiteDatabase db : android.database.sqlite.SQLiteDatabase.getActiveDatabases()) {
    ...
    public java.util.List<android.util.Pair<java.lang.String, java.lang.String>> getAttachedDbs() {
        java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>> attachedDbs = new java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>>();
        synchronized(mLock) {
            if (mConnectionPoolLocked == null) {
            ...
            if (!mHasAttachedDbsLocked) {
                ...
                attachedDbs.add(new android.util.Pair<java.lang.String, java.lang.String>("main", mConfigurationLocked.path));
                return attachedDbs;
            }
            acquireReference();
        }
        try {
            ...
            try {
                ...
                while (c.moveToNext()) {
                    ...
                    attachedDbs.add(new android.util.Pair<java.lang.String, java.lang.String>(c.getString(1), c.getString(2)));
                } 
            } finally {
                if (c != null) {
                    c.close();
    ...
    public boolean isDatabaseIntegrityOk() {
        ...
        try {
            ...
            try {
                ...
                attachedDbs = new java.util.ArrayList<android.util.Pair<java.lang.String, java.lang.String>>();
                attachedDbs.add(new android.util.Pair<java.lang.String, java.lang.String>("main", getPath()));
            }
            for (int i = 0; i < attachedDbs.size(); i++) {
                android.util.Pair<java.lang.String, java.lang.String> p = attachedDbs.get(i);
                android.database.sqlite.SQLiteStatement prog = null;
                try {
                    prog = compileStatement(("PRAGMA " + p.first) + ".integrity_check(1);");
                    java.lang.String rslt = prog.simpleQueryForString();
                    if (!rslt.equalsIgnoreCase("ok")) {
                        // integrity_checker failed on main or attached databases
                        android.util.Log.e(android.database.sqlite.SQLiteDatabase.TAG, (("PRAGMA integrity_check on " + p.second) + " returned: ") + rslt);
                        return false;
                    }
                } finally {
                    if (prog != null)
    ...
    private void throwIfNotOpenLocked() {
        if (mConnectionPoolLocked == null) {
            throw new java.lang.IllegalStateException(("The database '" + mConfigurationLocked.label) + "' is not open.");
        }
    }
    ...
    public interface CustomFunction {
        public void callback(java.lang.String[] args);
    }
}
