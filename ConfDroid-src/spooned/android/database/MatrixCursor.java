...
public class MatrixCursor extends android.database.AbstractCursor {
    ...
    public MatrixCursor(java.lang.String[] columnNames, int initialCapacity) {
        ...
        this.data = new java.lang.Object[columnCount * initialCapacity];
    }
     ...
     */
    private java.lang.Object get(int column) {
        if ((column < 0) || (column >= columnCount)) {
            throw new android.database.CursorIndexOutOfBoundsException((("Requested column: " + column) + ", # of columns: ") + columnCount);
        }
        if (mPos < 0) {
    ...
    public android.database.MatrixCursor.RowBuilder newRow() {
        ...
        return new android.database.MatrixCursor.RowBuilder(row);
    }
    ...
    public void addRow(java.lang.Object[] columnValues) {
        if (columnValues.length != columnCount) {
            throw new java.lang.IllegalArgumentException((("columnNames.length = " + columnCount) + ", columnValues.length = ") + columnValues.length);
        }
        int start = (rowCount++) * columnCount;
        ensureCapacity(start + columnCount);
        java.lang.System.arraycopy(columnValues, 0, data, start, columnCount);
    }
    ...
    public void addRow(java.lang.Iterable<?> columnValues) {
        ...
        ensureCapacity(end);
        if (columnValues instanceof java.util.ArrayList<?>) {
            addRow(((java.util.ArrayList<?>) (columnValues)), start);
            return;
        }
        int current = start;
        java.lang.Object[] localData = data;
        for (java.lang.Object columnValue : columnValues) {
            if (current == end) {
                // TODO: null out row?
     ...
     */
    private void addRow(java.util.ArrayList<?> columnValues, int start) {
        int size = columnValues.size();
        if (size != columnCount) {
            throw new java.lang.IllegalArgumentException((("columnNames.length = " + columnCount) + ", columnValues.size() = ") + size);
        }
        rowCount++;
        java.lang.Object[] localData = data;
    ...
    private void ensureCapacity(int size) {
        if (size > data.length) {
            java.lang.Object[] oldData = this.data;
            int newSize = data.length * 2;
            if (newSize < size) {
                newSize = size;
            }
            this.data = new java.lang.Object[newSize];
            java.lang.System.arraycopy(oldData, 0, this.data, 0, oldData.length);
        }
    }
    ...
    public class RowBuilder {
         ...
         * @return this builder to support chaining
         */
        public android.database.MatrixCursor.RowBuilder add(java.lang.String columnName, java.lang.Object value) {
    ...
    public java.lang.String getString(int column) {
        java.lang.Object value = get(column);
        if (value == null)
            return null;
    ...
    public int getType(int column) {
        return android.database.DatabaseUtils.getTypeOfObject(get(column));
    }
