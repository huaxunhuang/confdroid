...
public abstract class ContentObserver {
    ...
    private android.database.ContentObserver.Transport mTransport;// guarded by mLock
    ...
    public android.database.IContentObserver getContentObserver() {
        synchronized(mLock) {
            if (mTransport == null) {
                mTransport = new android.database.ContentObserver.Transport(this);
            }
            return mTransport;
        }
    }
    ...
    public android.database.IContentObserver releaseContentObserver() {
        synchronized(mLock) {
            final android.database.ContentObserver.Transport oldTransport = mTransport;
     ...
     * 		The Uri of the changed content, or null if unknown.
     * @param userId
     * 		The user whose content changed. Can be either a specific
    ...
    public final void dispatchChange(boolean selfChange, android.net.Uri uri) {
        dispatchChange(selfChange, uri, android.os.UserHandle.getCallingUserId());
    }
     ...
     * 		The Uri of the changed content, or null if unknown.
     * @param userId
     * 		The user whose content changed.
     */
    ...
    private final class NotificationRunnable implements java.lang.Runnable {
        ...
        public NotificationRunnable(boolean selfChange, android.net.Uri uri, int userId) {
