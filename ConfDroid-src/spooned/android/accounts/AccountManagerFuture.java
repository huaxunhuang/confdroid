...
public interface AccountManagerFuture<V> {
     ...
     */
    V getResult() throws android.accounts.AuthenticatorException, android.accounts.OperationCanceledException, java.io.IOException;
     ...
     * 		that it encountered an IOException while communicating with the authentication server
     */
    V getResult(long timeout, java.util.concurrent.TimeUnit unit) throws android.accounts.AuthenticatorException, android.accounts.OperationCanceledException, java.io.IOException;
}
