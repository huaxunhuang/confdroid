...
public abstract class AccountManagerInternal {
    ...
    public interface OnAppPermissionChangeListener {
         ...
         * 		The account
         * @param uid
         * 		The UID for which the grant changed
         */
        public void onAppPermissionChanged(android.accounts.Account account, int uid);
    }
     ...
     * @param packageName
     * 		The package name for which to request.
     * @param userId
     * 		Concrete user id for which to request.
     * @param callback
     * 		A callback for receiving the result.
     */
    public abstract void requestAccountAccess(@android.annotation.NonNull
    android.accounts.Account account, @android.annotation.NonNull
    java.lang.String packageName, @android.annotation.IntRange(from = 0)
     ...
     */
    public abstract boolean hasAccountAccess(@android.annotation.NonNull
    android.accounts.Account account, @android.annotation.IntRange(from = 0)
    int uid);
     ...
     * 		The listener
     */
    public abstract void addOnAppPermissionChangeListener(@android.annotation.NonNull
