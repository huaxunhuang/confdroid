...
public class SeekBarDialogPreference extends android.preference.DialogPreference {
    ...
    protected void onBindDialogView(android.view.View view) {
        ...
        final android.widget.ImageView iconView = ((android.widget.ImageView) (view.findViewById(R.id.icon)));
        if (mMyIcon != null) {
    ...
    protected static android.widget.SeekBar getSeekBar(android.view.View dialogView) {
        return ((android.widget.SeekBar) (dialogView.findViewById(R.id.seekbar)));
    }
}
