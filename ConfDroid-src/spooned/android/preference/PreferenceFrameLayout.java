...
public class PreferenceFrameLayout extends android.widget.FrameLayout {
    ...
    public PreferenceFrameLayout(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.PreferenceFrameLayout, defStyleAttr, defStyleRes);
        float density = context.getResources().getDisplayMetrics().density;
        int defaultBorderTop = ((int) ((density * android.preference.PreferenceFrameLayout.DEFAULT_BORDER_TOP) + 0.5F));
        int defaultBottomPadding = ((int) ((density * android.preference.PreferenceFrameLayout.DEFAULT_BORDER_BOTTOM) + 0.5F));
        int defaultLeftPadding = ((int) ((density * android.preference.PreferenceFrameLayout.DEFAULT_BORDER_LEFT) + 0.5F));
        int defaultRightPadding = ((int) ((density * android.preference.PreferenceFrameLayout.DEFAULT_BORDER_RIGHT) + 0.5F));
     ...
     */
    @java.lang.Override
    public android.preference.PreferenceFrameLayout.LayoutParams generateLayoutParams(android.util.AttributeSet attrs) {
        return new android.preference.PreferenceFrameLayout.LayoutParams(getContext(), attrs);
    }
    ...
    public void addView(android.view.View child) {
        ...
        android.preference.PreferenceFrameLayout.LayoutParams layoutParams = (params instanceof android.preference.PreferenceFrameLayout.LayoutParams) ? ((android.preference.PreferenceFrameLayout.LayoutParams) (child.getLayoutParams())) : null;
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(android.content.Context c, android.util.AttributeSet attrs) {
            super(c, attrs);
            android.content.res.TypedArray a = c.obtainStyledAttributes(attrs, com.android.internal.R.styleable.PreferenceFrameLayout_Layout);
            removeBorders = a.getBoolean(com.android.internal.R.styleable.PreferenceFrameLayout_Layout_layout_removeBorders, false);
            a.recycle();
        }
