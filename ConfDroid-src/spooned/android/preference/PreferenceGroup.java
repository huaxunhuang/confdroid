 ...
 * </div>
 *
 * @unknown ref android.R.styleable#PreferenceGroup_orderingFromXml
...
public abstract class PreferenceGroup extends android.preference.Preference implements android.preference.GenericInflater.Parent<android.preference.Preference> {
    ...
    public PreferenceGroup(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.PreferenceGroup, defStyleAttr, defStyleRes);
        mOrderingAsAdded = a.getBoolean(com.android.internal.R.styleable.PreferenceGroup_orderingFromXml, mOrderingAsAdded);
        a.recycle();
    }
    ...
    public boolean addPreference(android.preference.Preference preference) {
        ...
        if (preference.getOrder() == android.preference.Preference.DEFAULT_ORDER) {
            if (mOrderingAsAdded) {
            ...
            if (preference instanceof android.preference.PreferenceGroup) {
                ...
                ((android.preference.PreferenceGroup) (preference)).setOrderingAsAdded(mOrderingAsAdded);
            }
        }
    ...
    public void removeAll() {
        synchronized(this) {
            java.util.List<android.preference.Preference> preferenceList = mPreferenceList;
    ...
    public android.preference.Preference findPreference(java.lang.CharSequence key) {
        ...
        for (int i = 0; i < preferenceCount; i++) {
            final android.preference.Preference preference = getPreference(i);
            final java.lang.String curKey = preference.getKey();
            if ((curKey != null) && curKey.equals(key)) {
                return preference;
            }
            if (preference instanceof android.preference.PreferenceGroup) {
                final android.preference.Preference returnedPreference = ((android.preference.PreferenceGroup) (preference)).findPreference(key);
