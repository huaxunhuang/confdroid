...
public class ListPreferenceTest extends android.test.AndroidTestCase {
    public void testListPreferenceSummaryFromEntries() {
        java.lang.String[] entries = new java.lang.String[]{ "one", "two", "three" };
        java.lang.String[] entryValues = new java.lang.String[]{ "1", "2", "3" };
        android.preference.ListPreference lp = new android.preference.ListPreference(getContext());
