...
public class RemoteCallbackList<E extends android.os.IInterface> {
    /* package */
    android.util.ArrayMap<android.os.IBinder, android.os.RemoteCallbackList<E>.Callback> mCallbacks = new android.util.ArrayMap<android.os.IBinder, android.os.RemoteCallbackList<E>.Callback>();
    ...
    private final class Callback implements android.os.IBinder.DeathRecipient {
        ...
        Callback(E callback, java.lang.Object cookie) {
            mCallback = callback;
            mCookie = cookie;
        }
     ...
     * @see #onCallbackDied
     */
    public boolean register(E callback, java.lang.Object cookie) {
        synchronized(mCallbacks) {
            if (mKilled) {
                return false;
            }
            ...
            try {
                android.os.RemoteCallbackList<E>.Callback cb = new Callback(callback, cookie);
    ...
    public boolean unregister(E callback) {
        synchronized(mCallbacks) {
            android.os.RemoteCallbackList<E>.Callback cb = mCallbacks.remove(callback.asBinder());
            if (cb != null) {
    ...
    public void kill() {
        synchronized(mCallbacks) {
            for (int cbi = mCallbacks.size() - 1; cbi >= 0; cbi--) {
                android.os.RemoteCallbackList<E>.Callback cb = mCallbacks.valueAt(cbi);
                cb.mCallback.asBinder().unlinkToDeath(cb, 0);
            }
            mCallbacks.clear();
            mKilled = true;
     ...
     * @see #register
     */
    public void onCallbackDied(E callback, java.lang.Object cookie) {
    ...
    public int beginBroadcast() {
        synchronized(mCallbacks) {
            ...
            java.lang.Object[] active = mActiveBroadcast;
            if ((active == null) || (active.length < N)) {
                mActiveBroadcast = active = new java.lang.Object[N];
            }
            for (int i = 0; i < N; i++) {
    ...
    public E getBroadcastItem(int index) {
        return ((android.os.RemoteCallbackList<E>.Callback) (mActiveBroadcast[index])).mCallback;
    }
    ...
    public java.lang.Object getBroadcastCookie(int index) {
        return ((android.os.RemoteCallbackList<E>.Callback) (mActiveBroadcast[index])).mCookie;
    }
