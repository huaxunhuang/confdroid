...
public abstract class UserManagerInternal {
    public interface UserRestrictionsListener {
         ...
         * @param prevRestrictions
         * 		user restrictions that were previously set
         */
        void onUserRestrictionsChanged(int userId, android.os.Bundle newRestrictions, android.os.Bundle prevRestrictions);
    }
     ...
     *
     * @param userId
     * 		target user id for the local restrictions.
     * @param localRestrictions
     ...
     * 		Caller must not change it once passed to this method.
     */
    public abstract void setDevicePolicyUserRestrictions(int userId, @android.annotation.NonNull
    android.os.Bundle localRestrictions, @android.annotation.Nullable
     ...
     * from MNC.
     */
    public abstract android.os.Bundle getBaseUserRestrictions(int userId);

    /**
     * Called by {@link com.android.server.devicepolicy.DevicePolicyManagerService} for upgrading
     * from MNC.
     */
    public abstract void setBaseUserRestrictionsByDpmsForMigration(int userId, android.os.Bundle baseRestrictions);

    /**
     * Return a user restriction.
     */
    public abstract boolean getUserRestriction(int userId, java.lang.String key);

    /**
     * Adds a listener to user restriction changes.
     */
    public abstract void addUserRestrictionsListener(android.os.UserManagerInternal.UserRestrictionsListener listener);

    /**
     * Remove a {@link UserRestrictionsListener}.
     */
    public abstract void removeUserRestrictionsListener(android.os.UserManagerInternal.UserRestrictionsListener listener);
     ...
     */
    public abstract void setUserIcon(int userId, android.graphics.Bitmap bitmap);
     ...
     */
    public abstract android.content.pm.UserInfo createUserEvenWhenDisallowed(java.lang.String name, int flags);
