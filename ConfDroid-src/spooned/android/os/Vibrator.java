...
public abstract class Vibrator {
     ...
     */
    public Vibrator() {
        mPackageName = android.app.ActivityThread.currentPackageName();
    }
     ...
     * 		The number of milliseconds to vibrate.
     * @param attributes
     * 		{@link AudioAttributes} corresponding to the vibration. For example,
     * 		specify {@link AudioAttributes#USAGE_ALARM} for alarm vibrations or
     * 		{@link AudioAttributes#USAGE_NOTIFICATION_RINGTONE} for
     * 		vibrations associated with incoming calls.
     */
    public void vibrate(long milliseconds, android.media.AudioAttributes attributes) {
        vibrate(android.os.Process.myUid(), mPackageName, milliseconds, attributes);
    }
    ...
    public void vibrate(long[] pattern, int repeat, android.media.AudioAttributes attributes) {
        vibrate(android.os.Process.myUid(), mPackageName, pattern, repeat, attributes);
    }

    /**
     *
     *
     * @unknown Like {@link #vibrate(long, AudioAttributes)}, but allowing the caller to specify that
     ...
     *
     *
     * @unknown Like {@link #vibrate(long[], int, AudioAttributes)}, but allowing the caller to specify that
    the vibration is owned by someone else.
     */
