...
public final class Message implements android.os.Parcelable {
     ...
     */
    /* package */
    static final int FLAGS_TO_CLEAR_ON_COPY_FROM = android.os.Message.FLAG_IN_USE;
    ...
    public static android.os.Message obtain() {
        synchronized(android.os.Message.sPoolSync) {
            if (android.os.Message.sPool != null) {
                android.os.Message m = android.os.Message.sPool;
                android.os.Message.sPool = m.next;
                m.next = null;
    ...
    public static void updateCheckRecycle(int targetSdkVersion) {
        if (targetSdkVersion < android.os.Build.VERSION_CODES.LOLLIPOP) {
            android.os.Message.gCheckRecycle = false;
        }
    }
    ...
    public void recycle() {
        if (isInUse()) {
            if (android.os.Message.gCheckRecycle) {
    ...
    void recycleUnchecked() {
        ...
        flags = android.os.Message.FLAG_IN_USE;
        what = 0;
        arg1 = 0;
        arg2 = 0;
        obj = null;
        ...
        data = null;
        synchronized(android.os.Message.sPoolSync) {
            if (android.os.Message.sPoolSize < android.os.Message.MAX_POOL_SIZE) {
                next = android.os.Message.sPool;
                android.os.Message.sPool = this;
                android.os.Message.sPoolSize++;
            }
        }
    }
    ...
    public void copyFrom(android.os.Message o) {
        this.flags = o.flags & (~android.os.Message.FLAGS_TO_CLEAR_ON_COPY_FROM);
        this.what = o.what;
        this.arg1 = o.arg1;
        this.arg2 = o.arg2;
        this.obj = o.obj;
    ...
    public boolean isAsynchronous() {
        return (flags & android.os.Message.FLAG_ASYNCHRONOUS) != 0;
    }
    ...
    public void setAsynchronous(boolean async) {
        if (async) {
            flags |= android.os.Message.FLAG_ASYNCHRONOUS;
        } else {
            flags &= ~android.os.Message.FLAG_ASYNCHRONOUS;
        }
    }
    ...
    /* package */
    boolean isInUse() {
        return (flags & android.os.Message.FLAG_IN_USE) == android.os.Message.FLAG_IN_USE;
    }
    ...
    java.lang.String toString(long now) {
    ...
    public static final android.os.Parcelable.Creator<android.os.Message> CREATOR = new android.os.Parcelable.Creator<android.os.Message>() {
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        if (obj != null) {
            try {
                android.os.Parcelable p = ((android.os.Parcelable) (obj));
                dest.writeInt(1);
        ...
        android.os.Messenger.writeMessengerOrNullToParcel(replyTo, dest);
    ...
    private void readFromParcel(android.os.Parcel source) {
        ...
        replyTo = android.os.Messenger.readMessengerOrNullFromParcel(source);
