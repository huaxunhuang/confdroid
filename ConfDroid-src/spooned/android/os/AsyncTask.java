...
public abstract class AsyncTask<Params, Progress, Result> {
    ...
    private static final int CORE_POOL_SIZE = java.lang.Math.max(2, java.lang.Math.min(android.os.AsyncTask.CPU_COUNT - 1, 4));

    private static final int MAXIMUM_POOL_SIZE = (android.os.AsyncTask.CPU_COUNT * 2) + 1;
    ...
    private static final java.util.concurrent.ThreadFactory sThreadFactory = new java.util.concurrent.ThreadFactory() {
        ...
        public java.lang.Thread newThread(java.lang.Runnable r) {
            return new java.lang.Thread(r, "AsyncTask #" + mCount.getAndIncrement());
        }
    };
    ...
    static {
        java.util.concurrent.ThreadPoolExecutor threadPoolExecutor = new java.util.concurrent.ThreadPoolExecutor(android.os.AsyncTask.CORE_POOL_SIZE, android.os.AsyncTask.MAXIMUM_POOL_SIZE, android.os.AsyncTask.KEEP_ALIVE_SECONDS, java.util.concurrent.TimeUnit.SECONDS, android.os.AsyncTask.sPoolWorkQueue, android.os.AsyncTask.sThreadFactory);
     ...
     */
    public static final java.util.concurrent.Executor SERIAL_EXECUTOR = new android.os.AsyncTask.SerialExecutor();

    private static final int MESSAGE_POST_RESULT = 0x1;

    private static final int MESSAGE_POST_PROGRESS = 0x2;

    private static volatile java.util.concurrent.Executor sDefaultExecutor = android.os.AsyncTask.SERIAL_EXECUTOR;
    ...
    private static class SerialExecutor implements java.util.concurrent.Executor {
        final java.util.ArrayDeque<java.lang.Runnable> mTasks = new java.util.ArrayDeque<java.lang.Runnable>();
        ...
        protected synchronized void scheduleNext() {
            if ((mActive = mTasks.poll()) != null) {
                android.os.AsyncTask.THREAD_POOL_EXECUTOR.execute(mActive);
            }
        }
    }
    ...
    private static android.os.Handler getHandler() {
        synchronized(android.os.AsyncTask.class) {
            if (android.os.AsyncTask.sHandler == null) {
                android.os.AsyncTask.sHandler = new android.os.AsyncTask.InternalHandler();
            }
            return android.os.AsyncTask.sHandler;
        }
    }
    ...
    public static void setDefaultExecutor(java.util.concurrent.Executor exec) {
        android.os.AsyncTask.sDefaultExecutor = exec;
    }
     ...
     */
    public AsyncTask() {
        mWorker = new android.os.AsyncTask.WorkerRunnable<Params, Result>() {
        ...
        mFuture = new java.util.concurrent.FutureTask<Result>(mWorker) {
            @java.lang.Override
            protected void done() {
                try {
    ...
    private Result postResult(Result result) {
        ...
        android.os.Message message = android.os.AsyncTask.getHandler().obtainMessage(android.os.AsyncTask.MESSAGE_POST_RESULT, new android.os.AsyncTask.AsyncTaskResult<Result>(this, result));
    ...
    public final android.os.AsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(android.os.AsyncTask.sDefaultExecutor, params);
    }
    ...
    public static void execute(java.lang.Runnable runnable) {
        android.os.AsyncTask.sDefaultExecutor.execute(runnable);
    }
    ...
    protected final void publishProgress(Progress... values) {
        if (!isCancelled()) {
            android.os.AsyncTask.getHandler().obtainMessage(android.os.AsyncTask.MESSAGE_POST_PROGRESS, new android.os.AsyncTask.AsyncTaskResult<Progress>(this, values)).sendToTarget();
        }
    }
    ...
    private static class InternalHandler extends android.os.Handler {
        ...
        @java.lang.SuppressWarnings({ "unchecked", "RawUseOfParameterizedType" })
        @java.lang.Override
        public void handleMessage(android.os.Message msg) {
            android.os.AsyncTask.AsyncTaskResult<?> result = ((android.os.AsyncTask.AsyncTaskResult<?>) (msg.obj));
            switch (msg.what) {
                case android.os.AsyncTask.MESSAGE_POST_RESULT :
                    // There is only one result
                    result.mTask.finish(result.mData[0]);
                    break;
                case android.os.AsyncTask.MESSAGE_POST_PROGRESS :
