...
public class Build {
     ...
     */
    public static final java.lang.String ID = android.os.Build.getString("ro.build.id");

    /**
     * A build ID string meant for displaying to the user
     */
    public static final java.lang.String DISPLAY = android.os.Build.getString("ro.build.display.id");

    /**
     * The name of the overall product.
     */
    public static final java.lang.String PRODUCT = android.os.Build.getString("ro.product.name");

    /**
     * The name of the industrial design.
     */
    public static final java.lang.String DEVICE = android.os.Build.getString("ro.product.device");

    /**
     * The name of the underlying board, like "goldfish".
     */
    public static final java.lang.String BOARD = android.os.Build.getString("ro.product.board");
     ...
     */
    public static final java.lang.String MANUFACTURER = android.os.Build.getString("ro.product.manufacturer");

    /**
     * The consumer-visible brand with which the product/hardware will be associated, if any.
     */
    public static final java.lang.String BRAND = android.os.Build.getString("ro.product.brand");

    /**
     * The end-user-visible name for the end product.
     */
    public static final java.lang.String MODEL = android.os.Build.getString("ro.product.model");

    /**
     * The system bootloader version number.
     */
    public static final java.lang.String BOOTLOADER = android.os.Build.getString("ro.bootloader");
     ...
     */
    @java.lang.Deprecated
    public static final java.lang.String RADIO = android.os.Build.getString(TelephonyProperties.PROPERTY_BASEBAND_VERSION);

    /**
     * The name of the hardware (from the kernel command line or /proc).
     */
    public static final java.lang.String HARDWARE = android.os.Build.getString("ro.hardware");
     ...
     * @unknown 
     */
    public static final boolean IS_EMULATOR = android.os.Build.getString("ro.kernel.qemu").equals("1");

    /**
     * A hardware serial number, if available.  Alphanumeric only, case-insensitive.
     */
    public static final java.lang.String SERIAL = android.os.Build.getString("ro.serialno");
     ...
     */
    public static final java.lang.String[] SUPPORTED_ABIS = android.os.Build.getStringList("ro.product.cpu.abilist", ",");
     ...
     */
    public static final java.lang.String[] SUPPORTED_32_BIT_ABIS = android.os.Build.getStringList("ro.product.cpu.abilist32", ",");
     ...
     */
    public static final java.lang.String[] SUPPORTED_64_BIT_ABIS = android.os.Build.getStringList("ro.product.cpu.abilist64", ",");
    ...
    static {
        ...
        compatibility.
         */
        final java.lang.String[] abiList;
        if (dalvik.system.VMRuntime.getRuntime().is64Bit()) {
            abiList = android.os.Build.SUPPORTED_64_BIT_ABIS;
        } else {
            abiList = android.os.Build.SUPPORTED_32_BIT_ABIS;
        }
        CPU_ABI = abiList[0];
        if (abiList.length > 1) {
            CPU_ABI2 = abiList[1];
    ...
    public static class VERSION {
         ...
         * @unknown 
         */
        public static final java.lang.String[] ACTIVE_CODENAMES = ("REL".equals(android.os.Build.VERSION.ALL_CODENAMES[0])) ? new java.lang.String[0] : android.os.Build.VERSION.ALL_CODENAMES;
         ...
         * @unknown 
         */
        public static final int RESOURCES_SDK_INT = android.os.Build.VERSION.SDK_INT + android.os.Build.VERSION.ACTIVE_CODENAMES.length;
    }
     ...
     */
    public static final java.lang.String TYPE = android.os.Build.getString("ro.build.type");

    /**
     * Comma-separated tags describing the build, like "unsigned,debug".
     */
    public static final java.lang.String TAGS = android.os.Build.getString("ro.build.tags");

    /**
     * A string that uniquely identifies this build.  Do not attempt to parse this value.
     */
    public static final java.lang.String FINGERPRINT = android.os.Build.deriveFingerprint();
    ...
    private static java.lang.String deriveFingerprint() {
        java.lang.String finger = android.os.SystemProperties.get("ro.build.fingerprint");
        if (android.text.TextUtils.isEmpty(finger)) {
            finger = (((((((((((((android.os.Build.getString("ro.product.brand") + '/') + android.os.Build.getString("ro.product.name")) + '/') + android.os.Build.getString("ro.product.device")) + ':') + android.os.Build.getString("ro.build.version.release")) + '/') + android.os.Build.getString("ro.build.id")) + '/') + android.os.Build.getString("ro.build.version.incremental")) + ':') + android.os.Build.getString("ro.build.type")) + '/') + android.os.Build.getString("ro.build.tags");
        }
        return finger;
    }
    ...
    public static void ensureFingerprintProperty() {
        if (android.text.TextUtils.isEmpty(android.os.SystemProperties.get("ro.build.fingerprint"))) {
            try {
                android.os.SystemProperties.set("ro.build.fingerprint", android.os.Build.FINGERPRINT);
            } catch (java.lang.IllegalArgumentException e) {
                android.util.Slog.e(android.os.Build.TAG, "Failed to set fingerprint property", e);
            }
        }
    }
    ...
    public static boolean isBuildConsistent() {
        ...
        final java.lang.String system = android.os.SystemProperties.get("ro.build.fingerprint");
        final java.lang.String vendor = android.os.SystemProperties.get("ro.vendor.build.fingerprint");
        final java.lang.String bootimage = android.os.SystemProperties.get("ro.bootimage.build.fingerprint");
        final java.lang.String requiredBootloader = android.os.SystemProperties.get("ro.build.expect.bootloader");
        final java.lang.String currentBootloader = android.os.SystemProperties.get("ro.bootloader");
        final java.lang.String requiredRadio = android.os.SystemProperties.get("ro.build.expect.baseband");
        final java.lang.String currentRadio = android.os.SystemProperties.get("gsm.version.baseband");
        if (android.text.TextUtils.isEmpty(system)) {
            android.util.Slog.e(android.os.Build.TAG, "Required ro.build.fingerprint is empty!");
            return false;
        }
        if (!android.text.TextUtils.isEmpty(vendor)) {
            if (!java.util.Objects.equals(system, vendor)) {
                android.util.Slog.e(android.os.Build.TAG, (("Mismatched fingerprints; system reported " + system) + " but vendor reported ") + vendor);
                return false;
            }
        }
    ...
    public static final long TIME = android.os.Build.getLong("ro.build.date.utc") * 1000;

    public static final java.lang.String USER = android.os.Build.getString("ro.build.user");

    public static final java.lang.String HOST = android.os.Build.getString("ro.build.host");
     ...
     * @unknown 
     */
    public static final boolean IS_DEBUGGABLE = android.os.SystemProperties.getInt("ro.debuggable", 0) == 1;
    ...
    public static final boolean PERMISSIONS_REVIEW_REQUIRED = android.os.SystemProperties.getInt("ro.permission_review_required", 0) == 1;
    ...
    public static java.lang.String getRadioVersion() {
        return android.os.SystemProperties.get(TelephonyProperties.PROPERTY_BASEBAND_VERSION, null);
    }

    private static java.lang.String getString(java.lang.String property) {
        return android.os.SystemProperties.get(property, android.os.Build.UNKNOWN);
    }

    private static java.lang.String[] getStringList(java.lang.String property, java.lang.String separator) {
        java.lang.String value = android.os.SystemProperties.get(property);
        if (value.isEmpty()) {
    ...
    private static long getLong(java.lang.String property) {
        try {
            return java.lang.Long.parseLong(android.os.SystemProperties.get(property));
