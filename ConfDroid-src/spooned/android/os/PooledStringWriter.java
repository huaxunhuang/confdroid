...
public class PooledStringWriter {
     ...
     */
    private final java.util.HashMap<java.lang.String, java.lang.Integer> mPool;
    ...
    public PooledStringWriter(android.os.Parcel out) {
        mOut = out;
        mPool = new java.util.HashMap<>();
    ...
    public void writeString(java.lang.String str) {
        final java.lang.Integer cur = mPool.get(str);
        if (cur != null) {
            mOut.writeInt(cur);
        } else {
            mPool.put(str, mNext);
