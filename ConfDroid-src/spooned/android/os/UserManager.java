...
public class UserManager {
    private static java.lang.String TAG = "UserManager";
     ...
     *
     *
     * @unknown User restriction set by system/user.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown User restriction set by a device owner.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown User restriction set by a profile owner.
     */
    @android.annotation.SystemApi
    ...
    @android.annotation.IntDef(flag = true, value = { android.os.UserManager.RESTRICTION_NOT_SET, android.os.UserManager.RESTRICTION_SOURCE_SYSTEM, android.os.UserManager.RESTRICTION_SOURCE_DEVICE_OWNER, android.os.UserManager.RESTRICTION_SOURCE_PROFILE_OWNER })
    @android.annotation.SystemApi
     ...
     * @unknown 
     */
    public static final java.lang.String DISALLLOW_UNMUTE_DEVICE = "disallow_unmute_device";
     ...
     */
    public static final int USER_CREATION_FAILED_NOT_PERMITTED = android.app.Activity.RESULT_FIRST_USER;
     ...
     * {@link #createUserCreationIntent(String, String, String, PersistableBundle)}.
     */
    public static final int USER_CREATION_FAILED_NO_MORE_USERS = android.app.Activity.RESULT_FIRST_USER + 1;
    ...
    public static android.os.UserManager get(android.content.Context context) {
        return ((android.os.UserManager) (context.getSystemService(android.content.Context.USER_SERVICE)));
    }
     ...
     * @unknown 
     */
    public UserManager(android.content.Context context, android.os.IUserManager service) {
        mService = service;
        mContext = context;
    }
    ...
    public static boolean supportsMultipleUsers() {
        return (android.os.UserManager.getMaxSupportedUsers() > 1) && android.os.SystemProperties.getBoolean("fw.show_multiuserui", android.content.res.Resources.getSystem().getBoolean(R.bool.config_enableMultiUserUI));
    }
    ...
    public static boolean isSplitSystemUser() {
        return android.os.SystemProperties.getBoolean("ro.fw.system_user_split", false);
    }
    ...
    public boolean canSwitchUsers() {
        boolean allowUserSwitchingWhenSystemUserLocked = android.provider.Settings.Global.getInt(mContext.getContentResolver(), android.provider.Settings.Global.ALLOW_USER_SWITCHING_WHEN_SYSTEM_USER_LOCKED, 0) != 0;
        boolean isSystemUserUnlocked = isUserUnlocked(android.os.UserHandle.SYSTEM);
        boolean inCall = android.telephony.TelephonyManager.getDefault().getCallState() != android.telephony.TelephonyManager.CALL_STATE_IDLE;
    ...
    public boolean isPrimaryUser() {
        android.content.pm.UserInfo user = getUserInfo(android.os.UserHandle.myUserId());
    ...
    public boolean isSystemUser() {
        return android.os.UserHandle.myUserId() == android.os.UserHandle.USER_SYSTEM;
    }

    /**
     *
     *
     * @unknown Returns whether the caller is running as an admin user. There can be more than one admin
    user.
     */
    public boolean isAdminUser() {
        return isUserAdmin(android.os.UserHandle.myUserId());
    }

    /**
     *
     *
     * @unknown Returns whether the provided user is an admin user. There can be more than one admin
    user.
     */
    public boolean isUserAdmin(@android.annotation.UserIdInt
    int userId) {
        android.content.pm.UserInfo user = getUserInfo(userId);
     ...
     * @unknown 
     */
    public boolean canHaveRestrictedProfile(@android.annotation.UserIdInt
    int userId) {
        try {
    ...
    public boolean isDemoUser() {
        try {
            return mService.isDemoUser(android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isManagedProfile() {
        try {
            return mService.isManagedProfile(android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     */
    @android.annotation.SystemApi
    public boolean isManagedProfile(@android.annotation.UserIdInt
    int userId) {
        try {
    ...
    public boolean isEphemeralUser() {
        return isUserEphemeral(android.os.UserHandle.myUserId());
    }
     ...
     * @unknown 
     */
    public boolean isUserEphemeral(@android.annotation.UserIdInt
    int userId) {
        final android.content.pm.UserInfo user = getUserInfo(userId);
    ...
    public boolean isUserRunningOrStopping(android.os.UserHandle user) {
        try {
            ...
            return android.app.ActivityManagerNative.getDefault().isUserRunning(user.getIdentifier(), android.app.ActivityManager.FLAG_OR_STOPPED);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isUserRunningAndLocked() {
        return isUserRunningAndLocked(android.os.Process.myUserHandle());
    }
     ...
     */
    @java.lang.Deprecated
    public boolean isUserRunningAndLocked(android.os.UserHandle user) {
        try {
            return android.app.ActivityManagerNative.getDefault().isUserRunning(user.getIdentifier(), android.app.ActivityManager.FLAG_AND_LOCKED);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isUserRunningAndUnlocked() {
        return isUserRunningAndUnlocked(android.os.Process.myUserHandle());
    }
     ...
     */
    @java.lang.Deprecated
    public boolean isUserRunningAndUnlocked(android.os.UserHandle user) {
        try {
            return android.app.ActivityManagerNative.getDefault().isUserRunning(user.getIdentifier(), android.app.ActivityManager.FLAG_AND_UNLOCKED);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isUserUnlocked() {
        return isUserUnlocked(android.os.Process.myUserHandle());
    }
     ...
     * @see Context#createDeviceProtectedStorageContext()
     */
    public boolean isUserUnlocked(android.os.UserHandle user) {
     ...
     * {@hide }
     */
    public boolean isUserUnlocked(@android.annotation.UserIdInt
    int userId) {
        try {
            return android.app.ActivityManagerNative.getDefault().isUserRunning(userId, android.app.ActivityManager.FLAG_AND_UNLOCKED);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     * {@hide }
     */
    public boolean isUserUnlockingOrUnlocked(@android.annotation.UserIdInt
    int userId) {
        // TODO Switch to using UMS internal isUserUnlockingOrUnlocked
        try {
            return android.app.ActivityManagerNative.getDefault().isUserRunning(userId, android.app.ActivityManager.FLAG_AND_UNLOCKING_OR_UNLOCKED);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param userHandle
     * 		the user handle of the user whose information is being requested.
     * @return the UserInfo object for a specific user.
     * @unknown 
     */
    public android.content.pm.UserInfo getUserInfo(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     *
     *
     * @unknown Returns who set a user restriction on a user.
    Requires {@link android.Manifest.permission#MANAGE_USERS} permission.
    ...
    public int getUserRestrictionSource(java.lang.String restrictionKey, android.os.UserHandle userHandle) {
        try {
    ...
    public android.os.Bundle getUserRestrictions() {
        return getUserRestrictions(android.os.Process.myUserHandle());
    }
     ...
     *
     *
     * @unknown Returns whether the given user has been disallowed from performing certain actions
     ...
     * 		the UserHandle of the user for whom to retrieve the restrictions.
     */
    public boolean hasBaseUserRestriction(java.lang.String restrictionKey, android.os.UserHandle userHandle) {
        try {
    ...
    // System apps should use UserManager.setUserRestriction() instead.
    @java.lang.Deprecated
    public void setUserRestrictions(android.os.Bundle restrictions, android.os.UserHandle userHandle) {
        throw new java.lang.UnsupportedOperationException("This method is no longer supported");
    }
     ...
     */
    @java.lang.Deprecated
    public void setUserRestriction(java.lang.String key, boolean value) {
        setUserRestriction(key, value, android.os.Process.myUserHandle());
    }

    /**
     *
     *
     * @unknown Sets the value of a specific restriction on a specific user.
    Requires the MANAGE_USERS permission.
     * @param key
     * 		the key of the restriction
     * @param value
     * 		the value for the restriction
     * @param userHandle
     * 		the user whose restriction is to be changed.
     * @deprecated use {@link android.app.admin.DevicePolicyManager#addUserRestriction(
    android.content.ComponentName, String)} or
    {@link android.app.admin.DevicePolicyManager#clearUserRestriction(
    android.content.ComponentName, String)} instead.
     */
    @java.lang.Deprecated
    public void setUserRestriction(java.lang.String key, boolean value, android.os.UserHandle userHandle) {
        try {
    ...
    public boolean hasUserRestriction(java.lang.String restrictionKey) {
        return hasUserRestriction(restrictionKey, android.os.Process.myUserHandle());
    }
     ...
     * 		the UserHandle of the user for whom to retrieve the restrictions.
     */
    public boolean hasUserRestriction(java.lang.String restrictionKey, android.os.UserHandle userHandle) {
        try {
     ...
     *
     * @param user
     * 		The user whose serial number is to be retrieved.
    ...
    public android.os.UserHandle getUserForSerialNumber(long serialNumber) {
        ...
        return ident >= 0 ? new android.os.UserHandle(ident) : null;
    }
    ...
    public android.content.pm.UserInfo createUser(java.lang.String name, int flags) {
        android.content.pm.UserInfo user = null;
        try {
            user = mService.createUser(name, flags);
            // TODO: Keep this in sync with
            // UserManagerService.LocalService.createUserEvenWhenDisallowed
            if ((user != null) && (!user.isAdmin())) {
                mService.setUserRestriction(android.os.UserManager.DISALLOW_SMS, true, user.id);
                mService.setUserRestriction(android.os.UserManager.DISALLOW_OUTGOING_CALLS, true, user.id);
            }
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
     ...
     * @param name
     * 		the name to set for the user
     * @unknown 
     */
    public android.content.pm.UserInfo createGuest(android.content.Context context, java.lang.String name) {
        android.content.pm.UserInfo guest = null;
        try {
            guest = mService.createUser(name, android.content.pm.UserInfo.FLAG_GUEST);
            if (guest != null) {
                android.provider.Settings.Secure.putStringForUser(context.getContentResolver(), android.provider.Settings.Secure.SKIP_FIRST_USE_HINTS, "1", guest.id);
            }
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
     ...
     * @unknown 
     */
    public android.content.pm.UserInfo createProfileForUser(java.lang.String name, int flags, @android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     * @unknown 
     */
    public android.content.pm.UserInfo createRestrictedProfile(java.lang.String name) {
        try {
            android.os.UserHandle parentUserHandle = android.os.Process.myUserHandle();
            android.content.pm.UserInfo user = mService.createRestrictedProfile(name, parentUserHandle.getIdentifier());
            if (user != null) {
                android.accounts.AccountManager.get(mContext).addSharedAccountsFromParentUser(parentUserHandle, android.os.UserHandle.of(user.id));
            }
            return user;
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
     ...
     */
    public static android.content.Intent createUserCreationIntent(@android.annotation.Nullable
    java.lang.String userName, @android.annotation.Nullable
    java.lang.String accountName, @android.annotation.Nullable
    java.lang.String accountType, @android.annotation.Nullable
    android.os.PersistableBundle accountOptions) {
        android.content.Intent intent = new android.content.Intent(android.os.UserManager.ACTION_CREATE_USER);
        if (userName != null) {
            intent.putExtra(android.os.UserManager.EXTRA_USER_NAME, userName);
        }
        if ((accountName != null) && (accountType == null)) {
            throw new java.lang.IllegalArgumentException("accountType must be specified if accountName is " + "specified");
        }
        if (accountName != null) {
            intent.putExtra(android.os.UserManager.EXTRA_USER_ACCOUNT_NAME, accountName);
        }
        if (accountType != null) {
            intent.putExtra(android.os.UserManager.EXTRA_USER_ACCOUNT_TYPE, accountType);
        }
        if (accountOptions != null) {
            intent.putExtra(android.os.UserManager.EXTRA_USER_ACCOUNT_OPTIONS, accountOptions);
        }
        return intent;
    }
     ...
     *
     *
     * @unknown Returns the preferred account name for user creation. Requires MANAGE_USERS permission.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Returns the preferred account type for user creation. Requires MANAGE_USERS permission.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Returns the preferred account's options bundle for user creation. Requires MANAGE_USERS
    permission.
     ...
     *
     *
     * @unknown Called by a system activity to set the seed account information of a user created
     ...
     */
    public void setSeedAccountData(int userId, java.lang.String accountName, java.lang.String accountType, android.os.PersistableBundle accountOptions) {
        try {
            /* persist= */
            mService.setSeedAccountData(userId, accountName, accountType, accountOptions, true);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     *
     *
     * @unknown Clears the seed information used to create this user. Requires MANAGE_USERS permission.
     */
    @android.annotation.SystemApi
     ...
     *
     *
     * @unknown Marks the guest user for deletion to allow a new guest to be created before deleting
    the current user who is a guest.
     * @param userHandle
     * 		
     * @return 
     */
    public boolean markGuestForDeletion(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     *
     * @param userHandle
     * 		the id of the profile to enable
     * @unknown 
     */
    public void setUserEnabled(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     *
     * @param excludeDying
     * 		specify if the list should exclude users being removed.
    ...
    public long[] getSerialNumbersOfUsers(boolean excludeDying) {
        try {
            java.util.List<android.content.pm.UserInfo> users = mService.getUsers(excludeDying);
     ...
     * @unknown 
     */
    @android.annotation.RequiresPermission(allOf = { Manifest.permission.INTERACT_ACROSS_USERS_FULL, Manifest.permission.MANAGE_USERS })
    @android.annotation.Nullable
    public java.lang.String getUserAccount(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     */
    @android.annotation.RequiresPermission(allOf = { Manifest.permission.INTERACT_ACROSS_USERS_FULL, Manifest.permission.MANAGE_USERS })
    public void setUserAccount(@android.annotation.UserIdInt
    int userHandle, @android.annotation.Nullable
    ...
    public boolean canAddMoreUsers() {
        final java.util.List<android.content.pm.UserInfo> users = getUsers(true);
        ...
        return aliveUserCount < android.os.UserManager.getMaxSupportedUsers();
    }
     ...
     * @unknown 
     */
    public boolean canAddMoreManagedProfiles(@android.annotation.UserIdInt
    int userId, boolean allowedToRemoveOne) {
        try {
     ...
     * @unknown 
     */
    public java.util.List<android.content.pm.UserInfo> getProfiles(@android.annotation.UserIdInt
    int userHandle) {
        try {
            return /* enabledOnly */
            mService.getProfiles(userHandle, false);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     *
     * @param userId
     * 		one of the two user ids to check.
     * @param otherUserId
     * 		one of the two user ids to check.
     * @return true if the two user ids are in the same profile group.
     * @unknown 
     */
    public boolean isSameProfileGroup(@android.annotation.UserIdInt
     ...
     * @unknown 
     */
    public java.util.List<android.content.pm.UserInfo> getEnabledProfiles(@android.annotation.UserIdInt
    int userHandle) {
        try {
            return /* enabledOnly */
            mService.getProfiles(userHandle, true);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public java.util.List<android.os.UserHandle> getUserProfiles() {
        int[] userIds = /* enabledOnly */
        getProfileIds(android.os.UserHandle.myUserId(), true);
     ...
     *
     * @param userId
     * 		id of the user to return profiles for
     * @param enabledOnly
     * 		whether return only {@link UserInfo#isEnabled() enabled} profiles
     * @return A non-empty list of ids of profiles associated with the specified user.
     * @unknown 
     */
    public int[] getProfileIds(@android.annotation.UserIdInt
    int userId, boolean enabledOnly) {
        try {
     ...
     * @unknown 
     */
    public int[] getProfileIdsWithDisabled(@android.annotation.UserIdInt
    int userId) {
        return /* enabledOnly */
        getProfileIds(userId, false);
    }
     ...
     * @unknown 
     */
    public int[] getEnabledProfileIds(@android.annotation.UserIdInt
    int userId) {
        return /* enabledOnly */
        getProfileIds(userId, true);
    }
     ...
     * @unknown 
     */
    public int getCredentialOwnerProfile(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     * @unknown 
     */
    public android.content.pm.UserInfo getProfileParent(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     *
     * @param userHandle
     * 		The user handle of the profile.
     * @param enableQuietMode
     * 		Whether quiet mode should be enabled or disabled.
     * @unknown 
     */
    public void setQuietModeEnabled(@android.annotation.UserIdInt
    int userHandle, boolean enableQuietMode) {
        try {
     ...
     * @unknown 
     */
    public boolean trySetQuietModeDisabled(@android.annotation.UserIdInt
    int userHandle, android.content.IntentSender target) {
        try {
     ...
     * @unknown 
     */
    public android.graphics.drawable.Drawable getBadgedIconForUser(android.graphics.drawable.Drawable icon, android.os.UserHandle user) {
     ...
     * @unknown 
     */
    public android.graphics.drawable.Drawable getBadgedDrawableForUser(android.graphics.drawable.Drawable badgedDrawable, android.os.UserHandle user, android.graphics.Rect badgeLocation, int badgeDensity) {
        return mContext.getPackageManager().getUserBadgedDrawableForDensity(badgedDrawable, user, badgeLocation, badgeDensity);
    }
     ...
     * @unknown 
     */
    public java.lang.CharSequence getBadgedLabelForUser(java.lang.CharSequence label, android.os.UserHandle user) {
     ...
     * @unknown 
     */
    public boolean removeUser(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     *
     * @param userHandle
     * 		the user's integer handle
     * @param name
     * 		the new name for the user
     * @unknown 
     */
    public void setUserName(@android.annotation.UserIdInt
    int userHandle, java.lang.String name) {
        try {
     ...
     *
     * @param userHandle
     * 		the user for whom to change the photo.
     * @param icon
     * 		the bitmap to set as the photo.
     * @unknown 
     */
    public void setUserIcon(@android.annotation.UserIdInt
    int userHandle, android.graphics.Bitmap icon) {
        try {
     ...
     *
     * @param userHandle
     * 		the user whose photo we want to read.
     * @return a {@link Bitmap} of the user's photo, or null if there's no photo.
     * @see com.android.internal.util.UserIcons#getDefaultUserIcon for a default.
     * @unknown 
     */
    public android.graphics.Bitmap getUserIcon(@android.annotation.UserIdInt
    int userHandle) {
        try {
            android.os.ParcelFileDescriptor fd = mService.getUserIcon(userHandle);
            if (fd != null) {
                try {
                    return android.graphics.BitmapFactory.decodeFileDescriptor(fd.getFileDescriptor());
                } finally {
                    try {
                        fd.close();
    ...
    public static int getMaxSupportedUsers() {
        ...
        return android.os.SystemProperties.getInt("fw.max_users", android.content.res.Resources.getSystem().getInteger(R.integer.config_multiuserMaximumUsers));
    }
    ...
    public boolean isUserSwitcherEnabled() {
        if (!android.os.UserManager.supportsMultipleUsers()) {
            return false;
        }
        // If Demo Mode is on, don't show user switcher
        if (android.os.UserManager.isDeviceInDemoMode(mContext)) {
            return false;
        }
        ...
        final boolean guestEnabled = !mContext.getSystemService(android.app.admin.DevicePolicyManager.class).getGuestUserDisabled(null);
     ...
     * @unknown 
     */
    public int getUserSerialNumber(@android.annotation.UserIdInt
    int userHandle) {
        try {
     ...
     * @unknown 
     */
    public android.os.Bundle getApplicationRestrictions(java.lang.String packageName, android.os.UserHandle user) {
        try {
     ...
     * @unknown 
     */
    public void setApplicationRestrictions(java.lang.String packageName, android.os.Bundle restrictions, android.os.UserHandle user) {
        try {
     ...
     *
     *
     * @unknown Set restrictions that should apply to any future guest user that's created.
     */
     ...
     *
     *
     * @unknown Gets the default guest restrictions.
     */
     ...
     *
     *
     * @unknown Checks if any uninitialized user has the specific seed account name and type.
     * @param mAccountName
     * 		The account name to check for
     * @param mAccountType
     * 		The account type of the account to check for
