...
public final class ParcelUuid implements android.os.Parcelable {
    ...
    public static android.os.ParcelUuid fromString(java.lang.String uuid) {
        return new android.os.ParcelUuid(java.util.UUID.fromString(uuid));
    }
    ...
    public boolean equals(java.lang.Object object) {
        ...
        if (!(object instanceof android.os.ParcelUuid)) {
            return false;
        }
        android.os.ParcelUuid that = ((android.os.ParcelUuid) (object));
        return this.mUuid.equals(that.mUuid);
    }

    public static final android.os.Parcelable.Creator<android.os.ParcelUuid> CREATOR = new android.os.Parcelable.Creator<android.os.ParcelUuid>() {
        public android.os.ParcelUuid createFromParcel(android.os.Parcel source) {
            ...
            return new android.os.ParcelUuid(uuid);
        }

        public android.os.ParcelUuid[] newArray(int size) {
            return new android.os.ParcelUuid[size];
        }
    };
