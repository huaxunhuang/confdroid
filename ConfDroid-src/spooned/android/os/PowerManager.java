...
public final class PowerManager {
     ...
     * </p>
     */
    public static final int PARTIAL_WAKE_LOCK = 0x1;
    ...
    public static final int SCREEN_DIM_WAKE_LOCK = 0x6;
     ...
     */
    @java.lang.Deprecated
    public static final int SCREEN_BRIGHT_WAKE_LOCK = 0xa;
     ...
     * </p>
     */
    public static final int PROXIMITY_SCREEN_OFF_WAKE_LOCK = 0x20;
     ...
     * {@hide }
     */
    public static final int DOZE_WAKE_LOCK = 0x40;
     ...
     * {@hide }
     */
    public static final int DRAW_WAKE_LOCK = 0x80;
     ...
     * @unknown 
     */
    public static final int WAKE_LOCK_LEVEL_MASK = 0xffff;
     ...
     * {@hide }
     */
    public PowerManager(android.content.Context context, android.os.IPowerManager service, android.os.Handler handler) {
        mContext = context;
        mService = service;
        mHandler = handler;
    }
    ...
    public int getMinimumScreenBrightnessSetting() {
        return mContext.getResources().getInteger(com.android.internal.R.integer.config_screenBrightnessSettingMinimum);
    }
    ...
    public int getMaximumScreenBrightnessSetting() {
        return mContext.getResources().getInteger(com.android.internal.R.integer.config_screenBrightnessSettingMaximum);
    }
    ...
    public int getDefaultScreenBrightnessSetting() {
        return mContext.getResources().getInteger(com.android.internal.R.integer.config_screenBrightnessSettingDefault);
    }
    ...
    public static boolean useTwilightAdjustmentFeature() {
        return android.os.SystemProperties.getBoolean("persist.power.usetwilightadj", false);
    }
     ...
     */
    public android.os.PowerManager.WakeLock newWakeLock(int levelAndFlags, java.lang.String tag) {
        android.os.PowerManager.validateWakeLockParameters(levelAndFlags, tag);
        return new android.os.PowerManager.WakeLock(levelAndFlags, tag, mContext.getOpPackageName());
    }
    ...
    public static void validateWakeLockParameters(int levelAndFlags, java.lang.String tag) {
        switch (levelAndFlags & android.os.PowerManager.WAKE_LOCK_LEVEL_MASK) {
            case android.os.PowerManager.PARTIAL_WAKE_LOCK :
            case android.os.PowerManager.SCREEN_DIM_WAKE_LOCK :
            case android.os.PowerManager.SCREEN_BRIGHT_WAKE_LOCK :
            case android.os.PowerManager.FULL_WAKE_LOCK :
            case android.os.PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK :
            case android.os.PowerManager.DOZE_WAKE_LOCK :
            case android.os.PowerManager.DRAW_WAKE_LOCK :
                break;
            default :
     ...
     *
     * @param when
     * 		The time of the user activity, in the {@link SystemClock#uptimeMillis()}
     * 		time base.  This timestamp is used to correctly order the user activity request with
     * 		other power management functions.  It should be set
     * 		to the timestamp of the input event that caused the user activity.
     * @param noChangeLights
     ...
     * @see #wakeUp
     * @see #goToSleep
     * @unknown Requires signature or system permission.
     * @deprecated Use {@link #userActivity(long, int, int)}.
     */
    @java.lang.Deprecated
    public void userActivity(long when, boolean noChangeLights) {
        userActivity(when, android.os.PowerManager.USER_ACTIVITY_EVENT_OTHER, noChangeLights ? android.os.PowerManager.USER_ACTIVITY_FLAG_NO_CHANGE_LIGHTS : 0);
    }
     ...
     *
     * @param time
     * 		The time when the request to go to sleep was issued, in the
     * 		{@link SystemClock#uptimeMillis()} time base.  This timestamp is used to correctly
     * 		order the go to sleep request with other power management functions.  It should be set
     * 		to the timestamp of the input event that caused the request to go to sleep.
     * @see #userActivity
     * @see #wakeUp
     * @unknown Requires signature permission.
     */
    public void goToSleep(long time) {
        goToSleep(time, android.os.PowerManager.GO_TO_SLEEP_REASON_APPLICATION, 0);
    }
     ...
     * 		to the timestamp of the input event that caused the request to go to sleep.
     * @param reason
     * 		The reason the device is going to sleep.
     * @param flags
     ...
     *
     * @param time
     * 		The time when the request to wake up was issued, in the
     * 		{@link SystemClock#uptimeMillis()} time base.  This timestamp is used to correctly
     ...
     * @unknown 
     */
    public void wakeUp(long time, java.lang.String reason) {
        try {
     ...
     *
     * @param time
     * 		The time when the request to nap was issued, in the
     * 		{@link SystemClock#uptimeMillis()} time base.  This timestamp is used to correctly
     ...
     *
     * @param time
     * 		The time when the request to boost was issued, in the
     * 		{@link SystemClock#uptimeMillis()} time base.  This timestamp is used to correctly
     ...
     */
    public boolean isIgnoringBatteryOptimizations(java.lang.String packageName) {
        synchronized(this) {
            if (mIDeviceIdleController == null) {
                mIDeviceIdleController = IDeviceIdleController.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.DEVICE_IDLE_CONTROLLER));
            }
        }
        try {
    ...
    public boolean isSustainedPerformanceModeSupported() {
        return mContext.getResources().getBoolean(com.android.internal.R.bool.config_sustainedPerformanceModeSupported);
    }
     ...
     *
     *
     * @unknown Intent that is broadcast when the set of power save whitelist apps has changed.
    This broadcast is only sent to registered receivers.
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
     ...
     *
     *
     * @unknown Intent that is broadcast when the set of temporarily whitelisted apps has changed.
    This broadcast is only sent to registered receivers.
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
    ...
    public final class WakeLock {
        ...
        private final java.lang.Runnable mReleaser = new java.lang.Runnable() {
            public void run() {
                release();
            }
        };

        WakeLock(int flags, java.lang.String tag, java.lang.String packageName) {
            mFlags = flags;
            mTag = tag;
        ...
        protected void finalize() throws java.lang.Throwable {
            synchronized(mToken) {
                if (mHeld) {
                    android.util.Log.wtf(android.os.PowerManager.TAG, "WakeLock finalized while still held: " + mTag);
                    android.os.Trace.asyncTraceEnd(android.os.Trace.TRACE_TAG_POWER, mTraceName, 0);
                    try {
        ...
        private void acquireLocked() {
            if ((!mRefCounted) || ((mCount++) == 0)) {
                ...
                android.os.Trace.asyncTraceBegin(android.os.Trace.TRACE_TAG_POWER, mTraceName, 0);
                try {
        ...
        public void release(int flags) {
            synchronized(mToken) {
                ...
                if (mCount < 0) {
                    throw new java.lang.RuntimeException("WakeLock under-locked " + mTag);
                }
            }
        }
         ...
         * @unknown 
         */
        public void setHistoryTag(java.lang.String tag) {
            mHistoryTag = tag;
        }
        ...
        public void setUnimportantForLogging(boolean state) {
            if (state)
                mFlags |= android.os.PowerManager.UNIMPORTANT_FOR_LOGGING;
            else
                mFlags &= ~android.os.PowerManager.UNIMPORTANT_FOR_LOGGING;
        ...
        public java.lang.String toString() {
            synchronized(mToken) {
                return ((((("WakeLock{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " held=") + mHeld) + ", refCount=") + mCount) + "}";
            }
        }
