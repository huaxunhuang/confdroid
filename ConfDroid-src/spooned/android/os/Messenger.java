...
public final class Messenger implements android.os.Parcelable {
    ...
    public boolean equals(java.lang.Object otherObj) {
        ...
        try {
            return equals(((android.os.Messenger) (otherObj)).mTarget.asBinder());
    ...
    public static final android.os.Parcelable.Creator<android.os.Messenger> CREATOR = new android.os.Parcelable.Creator<android.os.Messenger>() {
        public android.os.Messenger createFromParcel(android.os.Parcel in) {
            android.os.IBinder target = in.readStrongBinder();
            return target != null ? new android.os.Messenger(target) : null;
        }

        public android.os.Messenger[] newArray(int size) {
            return new android.os.Messenger[size];
        }
    };
    ...
    public static android.os.Messenger readMessengerOrNullFromParcel(android.os.Parcel in) {
        ...
        return b != null ? new android.os.Messenger(b) : null;
    }
