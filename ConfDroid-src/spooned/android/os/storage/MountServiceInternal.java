...
public abstract class MountServiceInternal {
    ...
    public interface ExternalStorageMountPolicy {
         ...
         *
         * @param uid
         * 		The UID for which to determine mount mode.
         * @param packageName
         ...
         */
        public int getMountMode(int uid, java.lang.String packageName);

        /**
         * Gets whether external storage should be reported to the given UID.
         *
         * @param uid
         * 		The UID for which to determine whether it has external storage.
         * @param packageName
         * 		The package in the UID for making the call.
     ...
     * 		The policy to add.
     */
    public abstract void addExternalStoragePolicy(android.os.storage.MountServiceInternal.ExternalStorageMountPolicy policy);

    /**
     * Notify the mount service that the mount policy for a UID changed.
     *
     * @param uid
     * 		The UID for which policy changed.
     * @param packageName
     * 		The package in the UID for making the call.
     */
    public abstract void onExternalStoragePolicyChanged(int uid, java.lang.String packageName);
     ...
     *
     * @param uid
     * 		The UID for which to get mount mode.
     * @param packageName
     * 		The package in the UID for making the call.
     * @return The mount mode.
     */
    public abstract int getExternalStorageMountMode(int uid, java.lang.String packageName);
}
