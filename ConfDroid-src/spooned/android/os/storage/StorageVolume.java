...
public final class StorageVolume implements android.os.Parcelable {
     ...
     * {@hide }
     */
    public static final int STORAGE_ID_INVALID = 0x0;
     ...
     * {@hide }
     */
    public StorageVolume(java.lang.String id, int storageId, java.io.File path, java.lang.String description, boolean primary, boolean removable, boolean emulated, long mtpReserveSize, boolean allowMassStorage, long maxFileSize, android.os.UserHandle owner, java.lang.String fsUuid, java.lang.String state) {
        mId = com.android.internal.util.Preconditions.checkNotNull(id);
        mStorageId = storageId;
        mPath = com.android.internal.util.Preconditions.checkNotNull(path);
        mDescription = com.android.internal.util.Preconditions.checkNotNull(description);
        mPrimary = primary;
        ...
        mOwner = com.android.internal.util.Preconditions.checkNotNull(owner);
        mFsUuid = fsUuid;
        mState = com.android.internal.util.Preconditions.checkNotNull(state);
    }

    private StorageVolume(android.os.Parcel in) {
        mId = in.readString();
        mStorageId = in.readInt();
        mPath = new java.io.File(in.readString());
    ...
    public int getMtpReserveSpace() {
        return ((int) (mMtpReserveSize / android.net.TrafficStats.MB_IN_BYTES));
    }
    ...
    public int getFatVolumeId() {
        ...
        try {
            return ((int) (java.lang.Long.parseLong(mFsUuid.replace("-", ""), 16)));
     ...
     *
     * @param directoryName
     * 		must be one of {@link Environment#DIRECTORY_MUSIC},
     ...
     */
    @android.annotation.Nullable
    public android.content.Intent createAccessIntent(java.lang.String directoryName) {
        if ((isPrimary() && (directoryName == null)) || ((directoryName != null) && (!android.os.Environment.isStandardDirectory(directoryName)))) {
            return null;
        }
        final android.content.Intent intent = new android.content.Intent(android.os.storage.StorageVolume.ACTION_OPEN_EXTERNAL_DIRECTORY);
        intent.putExtra(android.os.storage.StorageVolume.EXTRA_STORAGE_VOLUME, this);
        intent.putExtra(android.os.storage.StorageVolume.EXTRA_DIRECTORY_NAME, directoryName);
        return intent;
    }

    @java.lang.Override
    public boolean equals(java.lang.Object obj) {
        if ((obj instanceof android.os.storage.StorageVolume) && (mPath != null)) {
            android.os.storage.StorageVolume volume = ((android.os.storage.StorageVolume) (obj));
    ...
    public java.lang.String toString() {
        final java.lang.StringBuilder buffer = new java.lang.StringBuilder("StorageVolume: ").append(mDescription);
        if (mFsUuid != null) {
    ...
    public static final android.os.Parcelable.Creator<android.os.storage.StorageVolume> CREATOR = new android.os.Parcelable.Creator<android.os.storage.StorageVolume>() {
        @java.lang.Override
        public android.os.storage.StorageVolume createFromParcel(android.os.Parcel in) {
            return new android.os.storage.StorageVolume(in);
        }

        @java.lang.Override
        public android.os.storage.StorageVolume[] newArray(int size) {
            return new android.os.storage.StorageVolume[size];
        }
    };
