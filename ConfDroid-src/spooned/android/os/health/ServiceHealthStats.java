...
public final class ServiceHealthStats {
    ...
    public static final int MEASUREMENT_START_SERVICE_COUNT = android.os.health.HealthKeys.BASE_SERVICE + 1;
     ...
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_LAUNCH_COUNT = android.os.health.HealthKeys.BASE_SERVICE + 2;
     ...
     * @unknown 
     */
    public static final android.os.health.HealthKeys.Constants CONSTANTS = new android.os.health.HealthKeys.Constants(android.os.health.ServiceHealthStats.class);
}
