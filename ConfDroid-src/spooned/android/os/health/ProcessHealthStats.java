...
public final class ProcessHealthStats {
    ...
    public static final int MEASUREMENT_USER_TIME_MS = android.os.health.HealthKeys.BASE_PROCESS + 1;
     ...
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_SYSTEM_TIME_MS = android.os.health.HealthKeys.BASE_PROCESS + 2;

    /**
     * Key for a measurement of the number of times this process was started for any reason.
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_STARTS_COUNT = android.os.health.HealthKeys.BASE_PROCESS + 3;

    /**
     * Key for a measurement of the number of crashes that happened in this process.
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_CRASHES_COUNT = android.os.health.HealthKeys.BASE_PROCESS + 4;

    /**
     * Key for a measurement of the number of ANRs that happened in this process.
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_ANR_COUNT = android.os.health.HealthKeys.BASE_PROCESS + 5;
     ...
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_FOREGROUND_MS = android.os.health.HealthKeys.BASE_PROCESS + 6;
