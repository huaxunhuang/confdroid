 ...
 *
 * @unknown When possible, the other APIs in this package avoid requiring a TimerStat
...
public final class TimerStat implements android.os.Parcelable {
     ...
     */
    public static final android.os.Parcelable.Creator<android.os.health.TimerStat> CREATOR = new android.os.Parcelable.Creator<android.os.health.TimerStat>() {
        public android.os.health.TimerStat createFromParcel(android.os.Parcel in) {
            return new android.os.health.TimerStat(in);
        }

        public android.os.health.TimerStat[] newArray(int size) {
            return new android.os.health.TimerStat[size];
        }
    };
