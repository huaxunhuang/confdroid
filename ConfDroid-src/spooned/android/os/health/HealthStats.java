...
public class HealthStats {
     ...
     * @unknown 
     */
    public HealthStats(android.os.Parcel in) {
        int count;
        // Header fields
        ...
        mStatsValues = new android.util.ArrayMap[count];
        for (int i = 0; i < count; i++) {
            mStatsKeys[i] = in.readInt();
            mStatsValues[i] = android.os.health.HealthStats.createHealthStatsMap(in);
        }
        // Timers fields
        count = in.readInt();
        mTimersKeys = new int[count];
        mTimersValues = new android.util.ArrayMap[count];
        for (int i = 0; i < count; i++) {
            mTimersKeys[i] = in.readInt();
            mTimersValues[i] = android.os.health.HealthStats.createParcelableMap(in, android.os.health.TimerStat.CREATOR);
        }
        // Measurements fields
        count = in.readInt();
        mMeasurementsKeys = new int[count];
        mMeasurementsValues = new android.util.ArrayMap[count];
        for (int i = 0; i < count; i++) {
            mMeasurementsKeys[i] = in.readInt();
            mMeasurementsValues[i] = android.os.health.HealthStats.createLongsMap(in);
        }
    }
    ...
    public boolean hasTimer(int key) {
        return android.os.health.HealthStats.getIndex(mTimerKeys, key) >= 0;
    }
     ...
     */
    public android.os.health.TimerStat getTimer(int key) {
        final int index = android.os.health.HealthStats.getIndex(mTimerKeys, key);
        if (index < 0) {
            throw new java.lang.IndexOutOfBoundsException((("Bad timer key dataType=" + mDataType) + " key=") + key);
        }
        return new android.os.health.TimerStat(mTimerCounts[index], mTimerTimes[index]);
    }
    ...
    public boolean hasMeasurement(int key) {
        return android.os.health.HealthStats.getIndex(mMeasurementKeys, key) >= 0;
    }
    ...
    public long getMeasurement(int key) {
        final int index = android.os.health.HealthStats.getIndex(mMeasurementKeys, key);
        if (index < 0) {
            throw new java.lang.IndexOutOfBoundsException((("Bad measurement key dataType=" + mDataType) + " key=") + key);
        }
    ...
    public boolean hasStats(int key) {
        return android.os.health.HealthStats.getIndex(mStatsKeys, key) >= 0;
    }
     ...
     */
    public java.util.Map<java.lang.String, android.os.health.HealthStats> getStats(int key) {
        final int index = android.os.health.HealthStats.getIndex(mStatsKeys, key);
        if (index < 0) {
            throw new java.lang.IndexOutOfBoundsException((("Bad stats key dataType=" + mDataType) + " key=") + key);
        }
    ...
    public boolean hasTimers(int key) {
        return android.os.health.HealthStats.getIndex(mTimersKeys, key) >= 0;
    }
     ...
     */
    public java.util.Map<java.lang.String, android.os.health.TimerStat> getTimers(int key) {
        final int index = android.os.health.HealthStats.getIndex(mTimersKeys, key);
        if (index < 0) {
            throw new java.lang.IndexOutOfBoundsException((("Bad timers key dataType=" + mDataType) + " key=") + key);
        }
    ...
    public boolean hasMeasurements(int key) {
        return android.os.health.HealthStats.getIndex(mMeasurementsKeys, key) >= 0;
    }
     ...
     */
    public java.util.Map<java.lang.String, java.lang.Long> getMeasurements(int key) {
        final int index = android.os.health.HealthStats.getIndex(mMeasurementsKeys, key);
        if (index < 0) {
            throw new java.lang.IndexOutOfBoundsException((("Bad measurements key dataType=" + mDataType) + " key=") + key);
        }
    ...
    private static int getIndex(int[] keys, int key) {
        return java.util.Arrays.binarySearch(keys, key);
    }

    /**
     * Create an ArrayMap<String,HealthStats> from the given Parcel.
     */
    private static android.util.ArrayMap<java.lang.String, android.os.health.HealthStats> createHealthStatsMap(android.os.Parcel in) {
        final int count = in.readInt();
        final android.util.ArrayMap<java.lang.String, android.os.health.HealthStats> result = new android.util.ArrayMap<java.lang.String, android.os.health.HealthStats>(count);
        for (int i = 0; i < count; i++) {
            result.put(in.readString(), new android.os.health.HealthStats(in));
        }
        return result;
    }
     ...
     */
    private static <T extends android.os.Parcelable> android.util.ArrayMap<java.lang.String, T> createParcelableMap(android.os.Parcel in, android.os.Parcelable.Creator<T> creator) {
        final int count = in.readInt();
        final android.util.ArrayMap<java.lang.String, T> result = new android.util.ArrayMap<java.lang.String, T>(count);
        for (int i = 0; i < count; i++) {
     ...
     */
    private static android.util.ArrayMap<java.lang.String, java.lang.Long> createLongsMap(android.os.Parcel in) {
        final int count = in.readInt();
        final android.util.ArrayMap<java.lang.String, java.lang.Long> result = new android.util.ArrayMap<java.lang.String, java.lang.Long>(count);
        for (int i = 0; i < count; i++) {
