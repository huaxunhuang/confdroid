...
public final class PidHealthStats {
    ...
    public static final int MEASUREMENT_WAKE_NESTING_COUNT = android.os.health.HealthKeys.BASE_PID + 1;
     ...
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_WAKE_SUM_MS = android.os.health.HealthKeys.BASE_PID + 2;
     ...
     */
    @android.os.health.HealthKeys.Constant(type = android.os.health.HealthKeys.TYPE_MEASUREMENT)
    public static final int MEASUREMENT_WAKE_START_MS = android.os.health.HealthKeys.BASE_PID + 3;
