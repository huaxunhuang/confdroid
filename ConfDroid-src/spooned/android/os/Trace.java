...
public final class Trace {
    ...
    private static volatile long sEnabledTags = android.os.Trace.TRACE_TAG_NOT_READY;
    ...
    static {
        ...
        android.os.SystemProperties.addChangeCallback(new java.lang.Runnable() {
            @java.lang.Override
            public void run() {
                android.os.Trace.cacheEnabledTags();
            }
        });
    }
    ...
    private static long cacheEnabledTags() {
        long tags = android.os.Trace.nativeGetEnabledTags();
        android.os.Trace.sEnabledTags = tags;
        return tags;
    }
     ...
     *
     * @param traceTag
     * 		The trace tag to check.
     * @return True if the trace tag is valid.
     * @unknown 
     */
    public static boolean isTagEnabled(long traceTag) {
        long tags = android.os.Trace.sEnabledTags;
        if (tags == android.os.Trace.TRACE_TAG_NOT_READY) {
            tags = android.os.Trace.cacheEnabledTags();
        }
     ...
     * @unknown 
     */
    public static void traceCounter(long traceTag, java.lang.String counterName, int counterValue) {
        if (android.os.Trace.isTagEnabled(traceTag)) {
            android.os.Trace.nativeTraceCounter(traceTag, counterName, counterValue);
        }
    }
    ...
    public static void setAppTracingAllowed(boolean allowed) {
        android.os.Trace.nativeSetAppTracingAllowed(allowed);
    ...
    public static void setTracingEnabled(boolean enabled) {
        android.os.Trace.nativeSetTracingEnabled(enabled);
     ...
     * @unknown 
     */
    public static void traceBegin(long traceTag, java.lang.String methodName) {
        if (android.os.Trace.isTagEnabled(traceTag)) {
            android.os.Trace.nativeTraceBegin(traceTag, methodName);
        }
    }
    ...
    public static void traceEnd(long traceTag) {
        if (android.os.Trace.isTagEnabled(traceTag)) {
            android.os.Trace.nativeTraceEnd(traceTag);
        }
    }
     ...
     * @unknown 
     */
    public static void asyncTraceBegin(long traceTag, java.lang.String methodName, int cookie) {
        if (android.os.Trace.isTagEnabled(traceTag)) {
            android.os.Trace.nativeAsyncTraceBegin(traceTag, methodName, cookie);
        }
    }
     ...
     * @unknown 
     */
    public static void asyncTraceEnd(long traceTag, java.lang.String methodName, int cookie) {
        if (android.os.Trace.isTagEnabled(traceTag)) {
            android.os.Trace.nativeAsyncTraceEnd(traceTag, methodName, cookie);
        }
    }
    ...
    public static void beginSection(java.lang.String sectionName) {
        if (android.os.Trace.isTagEnabled(android.os.Trace.TRACE_TAG_APP)) {
            if (sectionName.length() > android.os.Trace.MAX_SECTION_NAME_LEN) {
                throw new java.lang.IllegalArgumentException("sectionName is too long");
            }
            android.os.Trace.nativeTraceBegin(android.os.Trace.TRACE_TAG_APP, sectionName);
        }
    }
    ...
    public static void endSection() {
        if (android.os.Trace.isTagEnabled(android.os.Trace.TRACE_TAG_APP)) {
            android.os.Trace.nativeTraceEnd(android.os.Trace.TRACE_TAG_APP);
        }
    }
}
