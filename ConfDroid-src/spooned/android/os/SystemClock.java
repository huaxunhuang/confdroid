...
public final class SystemClock {
    ...
    public static void sleep(long ms) {
        ...
        do {
            ...
            duration = (start + ms) - android.os.SystemClock.uptimeMillis();
        } while (duration > 0 );
        if (interrupted) {
    ...
    public static boolean setCurrentTimeMillis(long millis) {
        ...
        android.app.IAlarmManager mgr = IAlarmManager.Stub.asInterface(b);
        if (mgr == null) {
            return false;
        }
        try {
            ...
            android.util.Slog.e(android.os.SystemClock.TAG, "Unable to set RTC", e);
