...
public abstract class UEventObserver {
    ...
    private static android.os.UEventObserver.UEventThread getThread() {
        synchronized(android.os.UEventObserver.class) {
            if (android.os.UEventObserver.sThread == null) {
                android.os.UEventObserver.sThread = new android.os.UEventObserver.UEventThread();
                android.os.UEventObserver.sThread.start();
            }
            return android.os.UEventObserver.sThread;
        }
    }
    ...
    public final void startObserving(java.lang.String match) {
        ...
        final android.os.UEventObserver.UEventThread t = android.os.UEventObserver.getThread();
    ...
    public static final class UEvent {
        ...
        private final java.util.HashMap<java.lang.String, java.lang.String> mMap = new java.util.HashMap<java.lang.String, java.lang.String>();

        public UEvent(java.lang.String message) {
            int offset = 0;
        ...
        public java.lang.String get(java.lang.String key, java.lang.String defaultValue) {
            java.lang.String result = mMap.get(key);
    ...
    private static final class UEventThread extends java.lang.Thread {
         ...
         */
        private final java.util.ArrayList<java.lang.Object> mKeysAndObservers = new java.util.ArrayList<java.lang.Object>();

        private final java.util.ArrayList<android.os.UEventObserver> mTempObserversToSignal = new java.util.ArrayList<android.os.UEventObserver>();
        ...
        public void run() {
            ...
            while (true) {
                java.lang.String message = android.os.UEventObserver.nativeWaitForNextEvent();
                if (message != null) {
                    if (android.os.UEventObserver.DEBUG) {
                        android.util.Log.d(android.os.UEventObserver.TAG, message);
                    }
                    sendEvent(message);
                }
            } 
        ...
        private void sendEvent(java.lang.String message) {
            synchronized(mKeysAndObservers) {
                final int N = mKeysAndObservers.size();
                for (int i = 0; i < N; i += 2) {
                    final java.lang.String key = ((java.lang.String) (mKeysAndObservers.get(i)));
                    if (message.contains(key)) {
                        final android.os.UEventObserver observer = ((android.os.UEventObserver) (mKeysAndObservers.get(i + 1)));
                        mTempObserversToSignal.add(observer);
                    }
                }
            }
            if (!mTempObserversToSignal.isEmpty()) {
                final android.os.UEventObserver.UEvent event = new android.os.UEventObserver.UEvent(message);
                final int N = mTempObserversToSignal.size();
                for (int i = 0; i < N; i++) {
                    final android.os.UEventObserver observer = mTempObserversToSignal.get(i);
        ...
        public void addObserver(java.lang.String match, android.os.UEventObserver observer) {
            synchronized(mKeysAndObservers) {
                mKeysAndObservers.add(match);
                mKeysAndObservers.add(observer);
                android.os.UEventObserver.nativeAddMatch(match);
            }
        }
         ...
         */
        public void removeObserver(android.os.UEventObserver observer) {
            synchronized(mKeysAndObservers) {
                for (int i = 0; i < mKeysAndObservers.size();) {
                    if (mKeysAndObservers.get(i + 1) == observer) {
                        mKeysAndObservers.remove(i + 1);
                        final java.lang.String match = ((java.lang.String) (mKeysAndObservers.remove(i)));
                        android.os.UEventObserver.nativeRemoveMatch(match);
                    } else {
                        i += 2;
                    }
                }
