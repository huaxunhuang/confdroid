...
public interface IBinder {
     ...
     */
    int FIRST_CALL_TRANSACTION = 0x1;

    /**
     * The last transaction code available for user commands.
     */
    int LAST_CALL_TRANSACTION = 0xffffff;
     ...
     * @see #unlinkToDeath
     */
    public void linkToDeath(android.os.IBinder.DeathRecipient recipient, int flags) throws android.os.RemoteException;
