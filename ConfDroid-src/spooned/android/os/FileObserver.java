...
public abstract class FileObserver {
     ...
     */
    public static final int ACCESS = 0x1;

    /**
     * Event type: Data was written to a file
     */
    public static final int MODIFY = 0x2;

    /**
     * Event type: Metadata (permissions, owner, timestamp) was changed explicitly
     */
    public static final int ATTRIB = 0x4;

    /**
     * Event type: Someone had a file or directory open for writing, and closed it
     */
    public static final int CLOSE_WRITE = 0x8;

    /**
     * Event type: Someone had a file or directory open read-only, and closed it
     */
    public static final int CLOSE_NOWRITE = 0x10;

    /**
     * Event type: A file or directory was opened
     */
    public static final int OPEN = 0x20;

    /**
     * Event type: A file or subdirectory was moved from the monitored directory
     */
    public static final int MOVED_FROM = 0x40;

    /**
     * Event type: A file or subdirectory was moved to the monitored directory
     */
    public static final int MOVED_TO = 0x80;
    ...
    private static class ObserverThread extends java.lang.Thread {
        ...
        public int startWatching(java.lang.String path, int mask, android.os.FileObserver observer) {
            int wfd = startWatching(m_fd, path, mask);
            java.lang.Integer i = new java.lang.Integer(wfd);
            if (wfd >= 0) {
                synchronized(m_observers) {
                    m_observers.put(i, new java.lang.ref.WeakReference(observer));
                }
            }
            return i;
        }
        ...
        public void onEvent(int wfd, int mask, java.lang.String path) {
            // look up our observer, fixing up the map if necessary...
            android.os.FileObserver observer = null;
            synchronized(m_observers) {
                java.lang.ref.WeakReference weak = m_observers.get(wfd);
                if (weak != null) {
                    // can happen with lots of events from a dead wfd
                    observer = ((android.os.FileObserver) (weak.get()));
                    if (observer == null) {
            ...
            if (observer != null) {
                try {
                    ...
                    android.util.Log.wtf(android.os.FileObserver.LOG_TAG, "Unhandled exception in FileObserver " + observer, throwable);
                }
            }
        }
        ...
        private native int startWatching(int fd, java.lang.String path, int mask);
    ...
    static {
        android.os.FileObserver.s_observerThread = new android.os.FileObserver.ObserverThread();
        android.os.FileObserver.s_observerThread.start();
    }
    ...
    public FileObserver(java.lang.String path) {
        this(path, android.os.FileObserver.ALL_EVENTS);
    }
     ...
     */
    public FileObserver(java.lang.String path, int mask) {
        m_path = path;
        m_mask = mask;
        m_descriptor = -1;
    }
    ...
    public void startWatching() {
        if (m_descriptor < 0) {
            m_descriptor = android.os.FileObserver.s_observerThread.startWatching(m_path, m_mask, this);
        }
    }
    ...
    public void stopWatching() {
        if (m_descriptor >= 0) {
            android.os.FileObserver.s_observerThread.stopWatching(m_descriptor);
            m_descriptor = -1;
        }
    }
     ...
     */
    public abstract void onEvent(int event, @android.annotation.Nullable
