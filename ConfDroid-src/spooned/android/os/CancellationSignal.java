...
public final class CancellationSignal {
     ...
     */
    public void cancel() {
        final android.os.CancellationSignal.OnCancelListener listener;
        final android.os.ICancellationSignal remote;
        synchronized(this) {
            if (mIsCanceled) {
                return;
            }
     ...
     *
     * @param remote
     * 		The remote transport, or null to remove.
     * @unknown 
     */
     ...
     * @unknown 
     */
    public static android.os.CancellationSignal fromTransport(android.os.ICancellationSignal transport) {
        if (transport instanceof android.os.CancellationSignal.Transport) {
            return ((android.os.CancellationSignal.Transport) (transport)).mCancellationSignal;
        }
        return null;
    }
    ...
    private static final class Transport extends android.os.ICancellationSignal.Stub {
        final android.os.CancellationSignal mCancellationSignal = new android.os.CancellationSignal();
