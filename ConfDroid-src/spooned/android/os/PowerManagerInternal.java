...
public abstract class PowerManagerInternal {
    ...
    public static java.lang.String wakefulnessToString(int wakefulness) {
        switch (wakefulness) {
            case android.os.PowerManagerInternal.WAKEFULNESS_ASLEEP :
                return "Asleep";
            case android.os.PowerManagerInternal.WAKEFULNESS_AWAKE :
                return "Awake";
            case android.os.PowerManagerInternal.WAKEFULNESS_DREAMING :
                return "Dreaming";
            case android.os.PowerManagerInternal.WAKEFULNESS_DOZING :
                return "Dozing";
            default :
                return java.lang.Integer.toString(wakefulness);
        }
    }
    ...
    public static boolean isInteractive(int wakefulness) {
        return (wakefulness == android.os.PowerManagerInternal.WAKEFULNESS_AWAKE) || (wakefulness == android.os.PowerManagerInternal.WAKEFULNESS_DREAMING);
    }
     ...
     *
     * @param brightness
     * 		The overridden brightness, or -1 to disable the override.
     */
     ...
     *
     * @param timeoutMillis
     * 		The overridden timeout, or -1 to disable the override.
     */
     ...
     *
     * @param screenState
     * 		The overridden screen state, or {@link Display#STATE_UNKNOWN}
