...
public class UpdateEngine {
    ...
    @android.annotation.SystemApi
    public UpdateEngine() {
        mUpdateEngine = IUpdateEngine.Stub.asInterface(android.os.ServiceManager.getService(android.os.UpdateEngine.UPDATE_ENGINE_SERVICE));
    }

    @android.annotation.SystemApi
    public boolean bind(final android.os.UpdateEngineCallback callback, final android.os.Handler handler) {
        android.os.IUpdateEngineCallback updateEngineCallback = new android.os.IUpdateEngineCallback.Stub() {
            @java.lang.Override
    ...
    @android.annotation.SystemApi
    public boolean bind(final android.os.UpdateEngineCallback callback) {
        return bind(callback, null);
    }

    @android.annotation.SystemApi
    public void applyPayload(java.lang.String url, long offset, long size, java.lang.String[] headerKeyValuePairs) {
        try {
