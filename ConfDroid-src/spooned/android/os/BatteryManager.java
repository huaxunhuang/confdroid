...
public class BatteryManager {
     ...
     * @unknown 
     */
    public static final int BATTERY_PLUGGED_ANY = (android.os.BatteryManager.BATTERY_PLUGGED_AC | android.os.BatteryManager.BATTERY_PLUGGED_USB) | android.os.BatteryManager.BATTERY_PLUGGED_WIRELESS;
    ...
    public BatteryManager() {
        ...
        mBatteryPropertiesRegistrar = IBatteryPropertiesRegistrar.Stub.asInterface(android.os.ServiceManager.getService("batteryproperties"));
    }
    ...
    private long queryProperty(int id) {
        ...
        try {
            android.os.BatteryProperty prop = new android.os.BatteryProperty();
            if (mBatteryPropertiesRegistrar.getProperty(id, prop) == 0)
                ret = prop.getLong();
            else
                ret = java.lang.Long.MIN_VALUE;
