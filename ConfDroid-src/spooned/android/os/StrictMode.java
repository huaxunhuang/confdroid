...
public final class StrictMode {
    ...
    private static final boolean LOG_V = android.util.Log.isLoggable(android.os.StrictMode.TAG, android.util.Log.VERBOSE);
     ...
     * @unknown 
     */
    public static final int DETECT_DISK_WRITE = 0x1;// for ThreadPolicy
     ...
     * @unknown 
     */
    public static final int DETECT_DISK_READ = 0x2;// for ThreadPolicy
     ...
     * @unknown 
     */
    public static final int DETECT_NETWORK = 0x4;// for ThreadPolicy
     ...
     * @unknown 
     */
    public static final int DETECT_CUSTOM = 0x8;// for ThreadPolicy
    ...
    private static final int ALL_THREAD_DETECT_BITS = (((android.os.StrictMode.DETECT_DISK_WRITE | android.os.StrictMode.DETECT_DISK_READ) | android.os.StrictMode.DETECT_NETWORK) | android.os.StrictMode.DETECT_CUSTOM) | android.os.StrictMode.DETECT_RESOURCE_MISMATCH;
     ...
     * @unknown 
     */
    public static final int DETECT_VM_CURSOR_LEAKS = 0x1 << 8;// for VmPolicy
     ...
     * @unknown 
     */
    public static final int DETECT_VM_CLOSABLE_LEAKS = 0x2 << 8;// for VmPolicy
     ...
     * @unknown 
     */
    public static final int DETECT_VM_ACTIVITY_LEAKS = 0x4 << 8;// for VmPolicy
     ...
     * @unknown 
     */
    private static final int DETECT_VM_INSTANCE_LEAKS = 0x8 << 8;// for VmPolicy
    ...
    private static final int ALL_VM_DETECT_BITS = (((((android.os.StrictMode.DETECT_VM_CURSOR_LEAKS | android.os.StrictMode.DETECT_VM_CLOSABLE_LEAKS) | android.os.StrictMode.DETECT_VM_ACTIVITY_LEAKS) | android.os.StrictMode.DETECT_VM_INSTANCE_LEAKS) | android.os.StrictMode.DETECT_VM_REGISTRATION_LEAKS) | android.os.StrictMode.DETECT_VM_FILE_URI_EXPOSURE) | android.os.StrictMode.DETECT_VM_CLEARTEXT_NETWORK;

    // Byte 3: Penalty
    /**
     * {@hide }
     */
    public static final int PENALTY_LOG = 0x1 << 16;// normal android.util.Log


    /**
     * {@hide }
     */
    public static final int PENALTY_DIALOG = 0x2 << 16;

    /**
     * {@hide }
     */
    public static final int PENALTY_DEATH = 0x4 << 16;
     ...
     * @unknown 
     */
    public static final int PENALTY_DEATH_ON_NETWORK = 0x1 << 24;
     ...
     * @unknown 
     */
    public static final int PENALTY_DEATH_ON_CLEARTEXT_NETWORK = 0x2 << 24;
     ...
     * @unknown 
     */
    public static final int PENALTY_DEATH_ON_FILE_URI_EXPOSURE = 0x4 << 24;

    /**
     * Mask of all the penalty bits valid for thread policies.
     */
    private static final int THREAD_PENALTY_MASK = (((((android.os.StrictMode.PENALTY_LOG | android.os.StrictMode.PENALTY_DIALOG) | android.os.StrictMode.PENALTY_DEATH) | android.os.StrictMode.PENALTY_DROPBOX) | android.os.StrictMode.PENALTY_GATHER) | android.os.StrictMode.PENALTY_DEATH_ON_NETWORK) | android.os.StrictMode.PENALTY_FLASH;

    /**
     * Mask of all the penalty bits valid for VM policies.
     */
    private static final int VM_PENALTY_MASK = (((android.os.StrictMode.PENALTY_LOG | android.os.StrictMode.PENALTY_DEATH) | android.os.StrictMode.PENALTY_DROPBOX) | android.os.StrictMode.PENALTY_DEATH_ON_CLEARTEXT_NETWORK) | android.os.StrictMode.PENALTY_DEATH_ON_FILE_URI_EXPOSURE;
    ...
    private static final java.util.HashMap<java.lang.Class, java.lang.Integer> EMPTY_CLASS_LIMIT_MAP = new java.util.HashMap<java.lang.Class, java.lang.Integer>();
    ...
    public static final class ThreadPolicy {
         ...
         */
        public static final android.os.StrictMode.ThreadPolicy LAX = new android.os.StrictMode.ThreadPolicy(0);
        ...
        public static final class Builder {
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectAll() {
                return enable(android.os.StrictMode.ALL_THREAD_DETECT_BITS);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitAll() {
                return disable(android.os.StrictMode.ALL_THREAD_DETECT_BITS);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectNetwork() {
                return enable(android.os.StrictMode.DETECT_NETWORK);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitNetwork() {
                return disable(android.os.StrictMode.DETECT_NETWORK);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectDiskReads() {
                return enable(android.os.StrictMode.DETECT_DISK_READ);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitDiskReads() {
                return disable(android.os.StrictMode.DETECT_DISK_READ);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectCustomSlowCalls() {
                return enable(android.os.StrictMode.DETECT_CUSTOM);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitCustomSlowCalls() {
                return disable(android.os.StrictMode.DETECT_CUSTOM);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitResourceMismatches() {
                return disable(android.os.StrictMode.DETECT_RESOURCE_MISMATCH);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectResourceMismatches() {
                return enable(android.os.StrictMode.DETECT_RESOURCE_MISMATCH);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder detectDiskWrites() {
                return enable(android.os.StrictMode.DETECT_DISK_WRITE);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder permitDiskWrites() {
                return disable(android.os.StrictMode.DETECT_DISK_WRITE);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyDialog() {
                return enable(android.os.StrictMode.PENALTY_DIALOG);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyDeath() {
                return enable(android.os.StrictMode.PENALTY_DEATH);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyDeathOnNetwork() {
                return enable(android.os.StrictMode.PENALTY_DEATH_ON_NETWORK);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyFlashScreen() {
                return enable(android.os.StrictMode.PENALTY_FLASH);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyLog() {
                return enable(android.os.StrictMode.PENALTY_LOG);
            }
            ...
            public android.os.StrictMode.ThreadPolicy.Builder penaltyDropBox() {
                return enable(android.os.StrictMode.PENALTY_DROPBOX);
            }
            ...
            public android.os.StrictMode.ThreadPolicy build() {
                ...
                if ((mMask != 0) && ((mMask & (((android.os.StrictMode.PENALTY_DEATH | android.os.StrictMode.PENALTY_LOG) | android.os.StrictMode.PENALTY_DROPBOX) | android.os.StrictMode.PENALTY_DIALOG)) == 0)) {
                    penaltyLog();
                }
                return new android.os.StrictMode.ThreadPolicy(mMask);
            }
        }
    }
    ...
    public static final class VmPolicy {
         ...
         * The default, lax policy which doesn't catch anything.
         */
        public static final android.os.StrictMode.VmPolicy LAX = new android.os.StrictMode.VmPolicy(0, android.os.StrictMode.EMPTY_CLASS_LIMIT_MAP);
        ...
        private VmPolicy(int mask, java.util.HashMap<java.lang.Class, java.lang.Integer> classInstanceLimit) {
        ...
        public static final class Builder {
            ...
            private java.util.HashMap<java.lang.Class, java.lang.Integer> mClassInstanceLimit;// null until needed
             ...
             */
            public android.os.StrictMode.VmPolicy.Builder setClassInstanceLimit(java.lang.Class klass, int instanceLimit) {
                if (klass == null) {
                ...
                if (mClassInstanceLimitNeedCow) {
                    ...
                    mClassInstanceLimit = ((java.util.HashMap<java.lang.Class, java.lang.Integer>) (mClassInstanceLimit.clone()));
                } else
                    if (mClassInstanceLimit == null) {
                        mClassInstanceLimit = new java.util.HashMap<java.lang.Class, java.lang.Integer>();
                    }

                mMask |= android.os.StrictMode.DETECT_VM_INSTANCE_LEAKS;
            ...
            public android.os.StrictMode.VmPolicy.Builder detectActivityLeaks() {
                return enable(android.os.StrictMode.DETECT_VM_ACTIVITY_LEAKS);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectAll() {
                int flags = (((android.os.StrictMode.DETECT_VM_ACTIVITY_LEAKS | android.os.StrictMode.DETECT_VM_CURSOR_LEAKS) | android.os.StrictMode.DETECT_VM_CLOSABLE_LEAKS) | android.os.StrictMode.DETECT_VM_REGISTRATION_LEAKS) | android.os.StrictMode.DETECT_VM_FILE_URI_EXPOSURE;
                // TODO: always add DETECT_VM_CLEARTEXT_NETWORK once we have facility
                // for apps to mark sockets that should be ignored
                if (android.os.SystemProperties.getBoolean(android.os.StrictMode.CLEARTEXT_PROPERTY, false)) {
                    flags |= android.os.StrictMode.DETECT_VM_CLEARTEXT_NETWORK;
                }
                return enable(flags);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectLeakedSqlLiteObjects() {
                return enable(android.os.StrictMode.DETECT_VM_CURSOR_LEAKS);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectLeakedClosableObjects() {
                return enable(android.os.StrictMode.DETECT_VM_CLOSABLE_LEAKS);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectLeakedRegistrationObjects() {
                return enable(android.os.StrictMode.DETECT_VM_REGISTRATION_LEAKS);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectFileUriExposure() {
                return enable(android.os.StrictMode.DETECT_VM_FILE_URI_EXPOSURE);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder detectCleartextNetwork() {
                return enable(android.os.StrictMode.DETECT_VM_CLEARTEXT_NETWORK);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder penaltyDeathOnCleartextNetwork() {
                return enable(android.os.StrictMode.PENALTY_DEATH_ON_CLEARTEXT_NETWORK);
            }
            ...
            public android.os.StrictMode.VmPolicy.Builder penaltyDeathOnFileUriExposure() {
                return enable(android.os.StrictMode.PENALTY_DEATH_ON_FILE_URI_EXPOSURE);
            }
            ...
            public android.os.StrictMode.VmPolicy build() {
                ...
                return new android.os.StrictMode.VmPolicy(mMask, mClassInstanceLimit != null ? mClassInstanceLimit : android.os.StrictMode.EMPTY_CLASS_LIMIT_MAP);
            }
        }
    }
     ...
     * choose how to react.
     */
    private static final java.lang.ThreadLocal<java.util.ArrayList<android.os.StrictMode.ViolationInfo>> gatheredViolations = new java.lang.ThreadLocal<java.util.ArrayList<android.os.StrictMode.ViolationInfo>>() {
        @java.lang.Override
        protected java.util.ArrayList<android.os.StrictMode.ViolationInfo> initialValue() {
     ...
     */
    public static void setThreadPolicy(final android.os.StrictMode.ThreadPolicy policy) {
        android.os.StrictMode.setThreadPolicyMask(policy.mask);
    }
    ...
    private static void setThreadPolicyMask(final int policyMask) {
        ...
        android.os.StrictMode.setBlockGuardPolicy(policyMask);
        // And set the Android native version...
        android.os.Binder.setThreadStrictModePolicy(policyMask);
    }

    // Sets the policy in Dalvik/libcore (BlockGuard)
    private static void setBlockGuardPolicy(final int policyMask) {
        if (policyMask == 0) {
            dalvik.system.BlockGuard.setThreadPolicy(BlockGuard.LAX_POLICY);
            return;
        }
        final dalvik.system.BlockGuard.Policy policy = dalvik.system.BlockGuard.getThreadPolicy();
        final android.os.StrictMode.AndroidBlockGuardPolicy androidPolicy;
        if (policy instanceof android.os.StrictMode.AndroidBlockGuardPolicy) {
            androidPolicy = ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy));
        } else {
            androidPolicy = android.os.StrictMode.threadAndroidPolicy.get();
            dalvik.system.BlockGuard.setThreadPolicy(androidPolicy);
        }
    ...
    private static void setCloseGuardEnabled(boolean enabled) {
        ...
        dalvik.system.CloseGuard.setEnabled(enabled);
    }
    ...
    public static class StrictModeViolation extends dalvik.system.BlockGuard.BlockGuardPolicyException {
        public StrictModeViolation(int policyState, int policyViolated, java.lang.String message) {
     ...
     * @unknown 
     */
    public static class StrictModeNetworkViolation extends android.os.StrictMode.StrictModeViolation {
        public StrictModeNetworkViolation(int policyMask) {
            super(policyMask, android.os.StrictMode.DETECT_NETWORK, null);
        }
    }
     ...
     * @unknown 
     */
    private static class StrictModeDiskReadViolation extends android.os.StrictMode.StrictModeViolation {
        public StrictModeDiskReadViolation(int policyMask) {
            super(policyMask, android.os.StrictMode.DETECT_DISK_READ, null);
        }
    }
     ...
     * @unknown 
     */
    private static class StrictModeDiskWriteViolation extends android.os.StrictMode.StrictModeViolation {
        public StrictModeDiskWriteViolation(int policyMask) {
            super(policyMask, android.os.StrictMode.DETECT_DISK_WRITE, null);
        }
    }
     ...
     * @unknown 
     */
    private static class StrictModeCustomViolation extends android.os.StrictMode.StrictModeViolation {
        public StrictModeCustomViolation(int policyMask, java.lang.String name) {
            super(policyMask, android.os.StrictMode.DETECT_CUSTOM, name);
        }
    }
     ...
     * @unknown 
     */
    private static class StrictModeResourceMismatchViolation extends android.os.StrictMode.StrictModeViolation {
        public StrictModeResourceMismatchViolation(int policyMask, java.lang.Object tag) {
            super(policyMask, android.os.StrictMode.DETECT_RESOURCE_MISMATCH, tag != null ? tag.toString() : null);
        }
    }
    ...
    public static int getThreadPolicyMask() {
        return dalvik.system.BlockGuard.getThreadPolicy().getPolicyMask();
    }
    ...
    public static android.os.StrictMode.ThreadPolicy getThreadPolicy() {
        ...
        return new android.os.StrictMode.ThreadPolicy(android.os.StrictMode.getThreadPolicyMask());
    }
    ...
    public static android.os.StrictMode.ThreadPolicy allowThreadDiskWrites() {
        int oldPolicyMask = android.os.StrictMode.getThreadPolicyMask();
        int newPolicyMask = oldPolicyMask & (~(android.os.StrictMode.DETECT_DISK_WRITE | android.os.StrictMode.DETECT_DISK_READ));
        if (newPolicyMask != oldPolicyMask) {
            android.os.StrictMode.setThreadPolicyMask(newPolicyMask);
        }
        return new android.os.StrictMode.ThreadPolicy(oldPolicyMask);
    }
    ...
    public static android.os.StrictMode.ThreadPolicy allowThreadDiskReads() {
        int oldPolicyMask = android.os.StrictMode.getThreadPolicyMask();
        int newPolicyMask = oldPolicyMask & (~android.os.StrictMode.DETECT_DISK_READ);
        if (newPolicyMask != oldPolicyMask) {
            android.os.StrictMode.setThreadPolicyMask(newPolicyMask);
        }
        return new android.os.StrictMode.ThreadPolicy(oldPolicyMask);
    ...
    private static boolean amTheSystemServerProcess() {
        ...
        java.lang.Throwable stack = new java.lang.Throwable();
        stack.fillInStackTrace();
        for (java.lang.StackTraceElement ste : stack.getStackTrace()) {
            java.lang.String clsName = ste.getClassName();
    ...
    public static boolean conditionallyEnableDebugLogging() {
        boolean doFlashes = android.os.SystemProperties.getBoolean(android.os.StrictMode.VISUAL_PROPERTY, false) && (!android.os.StrictMode.amTheSystemServerProcess());
        final boolean suppress = android.os.SystemProperties.getBoolean(android.os.StrictMode.DISABLE_PROPERTY, false);
        // For debug builds, log event loop stalls to dropbox for analysis.
        // Similar logic also appears in ActivityThread.java for system apps.
        if ((!doFlashes) && (android.os.StrictMode.IS_USER_BUILD || suppress)) {
            android.os.StrictMode.setCloseGuardEnabled(false);
            return false;
        }
        ...
        // check above.
        if (android.os.StrictMode.IS_ENG_BUILD) {
            doFlashes = true;
        }
        // Thread policy controls BlockGuard.
        int threadPolicyMask = (android.os.StrictMode.DETECT_DISK_WRITE | android.os.StrictMode.DETECT_DISK_READ) | android.os.StrictMode.DETECT_NETWORK;
        if (!android.os.StrictMode.IS_USER_BUILD) {
            threadPolicyMask |= android.os.StrictMode.PENALTY_DROPBOX;
        }
        if (doFlashes) {
            threadPolicyMask |= android.os.StrictMode.PENALTY_FLASH;
        }
        android.os.StrictMode.setThreadPolicyMask(threadPolicyMask);
        // VM Policy controls CloseGuard, detection of Activity leaks,
        // and instance counting.
        if (android.os.StrictMode.IS_USER_BUILD) {
            android.os.StrictMode.setCloseGuardEnabled(false);
        } else {
            android.os.StrictMode.VmPolicy.Builder policyBuilder = new android.os.StrictMode.VmPolicy.Builder().detectAll().penaltyDropBox();
            if (android.os.StrictMode.IS_ENG_BUILD) {
                policyBuilder.penaltyLog();
            }
            android.os.StrictMode.setVmPolicy(policyBuilder.build());
            android.os.StrictMode.setCloseGuardEnabled(android.os.StrictMode.vmClosableObjectLeaksEnabled());
        }
        return true;
    }
    ...
    public static void enableDeathOnNetwork() {
        int oldPolicy = android.os.StrictMode.getThreadPolicyMask();
        int newPolicy = (oldPolicy | android.os.StrictMode.DETECT_NETWORK) | android.os.StrictMode.PENALTY_DEATH_ON_NETWORK;
        android.os.StrictMode.setThreadPolicyMask(newPolicy);
    }
    ...
    public static void enableDeathOnFileUriExposure() {
        android.os.StrictMode.sVmPolicyMask |= android.os.StrictMode.DETECT_VM_FILE_URI_EXPOSURE | android.os.StrictMode.PENALTY_DEATH_ON_FILE_URI_EXPOSURE;
    }
     ...
     */
    private static int parsePolicyFromMessage(java.lang.String message) {
        ...
        java.lang.String policyString = message.substring(7, spaceIndex);
        try {
            return java.lang.Integer.parseInt(policyString);
     ...
     */
    private static int parseViolationFromMessage(java.lang.String message) {
        if (message == null) {
            return 0;
        }
        ...
        java.lang.String violationString = message.substring(numberStartIndex, numberEndIndex);
        try {
            return java.lang.Integer.parseInt(violationString);
        } catch (java.lang.NumberFormatException e) {
            return 0;
        }
    }

    private static final java.lang.ThreadLocal<java.util.ArrayList<android.os.StrictMode.ViolationInfo>> violationsBeingTimed = new java.lang.ThreadLocal<java.util.ArrayList<android.os.StrictMode.ViolationInfo>>() {
        @java.lang.Override
        protected java.util.ArrayList<android.os.StrictMode.ViolationInfo> initialValue() {
            return new java.util.ArrayList<android.os.StrictMode.ViolationInfo>();
        }
    };

    // Note: only access this once verifying the thread has a Looper.
    private static final java.lang.ThreadLocal<android.os.Handler> threadHandler = new java.lang.ThreadLocal<android.os.Handler>() {
        @java.lang.Override
    ...
    private static final java.lang.ThreadLocal<android.os.StrictMode.AndroidBlockGuardPolicy> threadAndroidPolicy = new java.lang.ThreadLocal<android.os.StrictMode.AndroidBlockGuardPolicy>() {
        @java.lang.Override
    ...
    private static boolean tooManyViolationsThisLoop() {
        return android.os.StrictMode.violationsBeingTimed.get().size() >= android.os.StrictMode.MAX_OFFENSES_PER_LOOP;
    }

    private static class AndroidBlockGuardPolicy implements dalvik.system.BlockGuard.Policy {
        ...
        public void onWriteToDisk() {
            if ((mPolicyMask & android.os.StrictMode.DETECT_DISK_WRITE) == 0) {
                return;
            }
            if (android.os.StrictMode.tooManyViolationsThisLoop()) {
                return;
            }
            dalvik.system.BlockGuard.BlockGuardPolicyException e = new android.os.StrictMode.StrictModeDiskWriteViolation(mPolicyMask);
            e.fillInStackTrace();
        ...
        void onCustomSlowCall(java.lang.String name) {
            if ((mPolicyMask & android.os.StrictMode.DETECT_CUSTOM) == 0) {
                return;
            }
            if (android.os.StrictMode.tooManyViolationsThisLoop()) {
                return;
            }
            dalvik.system.BlockGuard.BlockGuardPolicyException e = new android.os.StrictMode.StrictModeCustomViolation(mPolicyMask, name);
            e.fillInStackTrace();
            startHandlingViolationException(e);
        }

        // Not part of BlockGuard.Policy; just part of StrictMode:
        void onResourceMismatch(java.lang.Object tag) {
            if ((mPolicyMask & android.os.StrictMode.DETECT_RESOURCE_MISMATCH) == 0) {
                return;
            }
            if (android.os.StrictMode.tooManyViolationsThisLoop()) {
                return;
            }
            dalvik.system.BlockGuard.BlockGuardPolicyException e = new android.os.StrictMode.StrictModeResourceMismatchViolation(mPolicyMask, tag);
            e.fillInStackTrace();
            startHandlingViolationException(e);
        }
        ...
        public void onReadFromDisk() {
            if ((mPolicyMask & android.os.StrictMode.DETECT_DISK_READ) == 0) {
                return;
            }
            if (android.os.StrictMode.tooManyViolationsThisLoop()) {
                return;
            }
            dalvik.system.BlockGuard.BlockGuardPolicyException e = new android.os.StrictMode.StrictModeDiskReadViolation(mPolicyMask);
            e.fillInStackTrace();
            startHandlingViolationException(e);
        }
        ...
        public void onNetwork() {
            if ((mPolicyMask & android.os.StrictMode.DETECT_NETWORK) == 0) {
                return;
            }
            if ((mPolicyMask & android.os.StrictMode.PENALTY_DEATH_ON_NETWORK) != 0) {
                throw new android.os.NetworkOnMainThreadException();
            }
            if (android.os.StrictMode.tooManyViolationsThisLoop()) {
                return;
            }
            dalvik.system.BlockGuard.BlockGuardPolicyException e = new android.os.StrictMode.StrictModeNetworkViolation(mPolicyMask);
            e.fillInStackTrace();
            startHandlingViolationException(e);
        }
        ...
        // violation took.
        void startHandlingViolationException(dalvik.system.BlockGuard.BlockGuardPolicyException e) {
            final android.os.StrictMode.ViolationInfo info = new android.os.StrictMode.ViolationInfo(e, e.getPolicy());
            info.violationUptimeMillis = android.os.SystemClock.uptimeMillis();
        ...
        // the next epoll_wait)
        void handleViolationWithTimingAttempt(final android.os.StrictMode.ViolationInfo info) {
            ...
            if ((looper == null) || ((info.policy & android.os.StrictMode.THREAD_PENALTY_MASK) == android.os.StrictMode.PENALTY_DEATH)) {
                info.durationMillis = -1;// unknown (redundant, already set)

                handleViolation(info);
                return;
            }
            final java.util.ArrayList<android.os.StrictMode.ViolationInfo> records = android.os.StrictMode.violationsBeingTimed.get();
            if (records.size() >= android.os.StrictMode.MAX_OFFENSES_PER_LOOP) {
            ...
            final android.view.IWindowManager windowManager = ((info.policy & android.os.StrictMode.PENALTY_FLASH) != 0) ? android.os.StrictMode.sWindowManager.get() : null;
            ...
            // milliseconds.
            android.os.StrictMode.threadHandler.get().postAtFrontOfQueue(new java.lang.Runnable() {
                public void run() {
                    long loopFinishTime = android.os.SystemClock.uptimeMillis();
                    ...
                    for (int n = 0; n < records.size(); ++n) {
                        android.os.StrictMode.ViolationInfo v = records.get(n);
        ...
        void handleViolation(final android.os.StrictMode.ViolationInfo info) {
            if (((info == null) || (info.crashInfo == null)) || (info.crashInfo.stackTrace == null)) {
                android.util.Log.wtf(android.os.StrictMode.TAG, "unexpected null stacktrace");
                return;
            }
            if (android.os.StrictMode.LOG_V)
                android.util.Log.d(android.os.StrictMode.TAG, "handleViolation; policy=" + info.policy);

            if ((info.policy & android.os.StrictMode.PENALTY_GATHER) != 0) {
                java.util.ArrayList<android.os.StrictMode.ViolationInfo> violations = android.os.StrictMode.gatheredViolations.get();
                if (violations == null) {
                    violations = new java.util.ArrayList<android.os.StrictMode.ViolationInfo>(1);
                    android.os.StrictMode.gatheredViolations.set(violations);
                } else
                ...
                for (android.os.StrictMode.ViolationInfo previous : violations) {
            ...
            java.lang.Integer crashFingerprint = info.hashCode();
            long lastViolationTime = 0;
            if (mLastViolationTime != null) {
                java.lang.Long vtime = mLastViolationTime.get(crashFingerprint);
                if (vtime != null) {
                    lastViolationTime = vtime;
                }
            } else {
                mLastViolationTime = new android.util.ArrayMap<java.lang.Integer, java.lang.Long>(1);
            }
            long now = android.os.SystemClock.uptimeMillis();
            mLastViolationTime.put(crashFingerprint, now);
            long timeSinceLastViolationMillis = (lastViolationTime == 0) ? java.lang.Long.MAX_VALUE : now - lastViolationTime;
            if (((info.policy & android.os.StrictMode.PENALTY_LOG) != 0) && (timeSinceLastViolationMillis > android.os.StrictMode.MIN_LOG_INTERVAL_MS)) {
                if (info.durationMillis != (-1)) {
                    android.util.Log.d(android.os.StrictMode.TAG, (("StrictMode policy violation; ~duration=" + info.durationMillis) + " ms: ") + info.crashInfo.stackTrace);
                } else {
                    android.util.Log.d(android.os.StrictMode.TAG, "StrictMode policy violation: " + info.crashInfo.stackTrace);
                }
            }
            ...
            if (((info.policy & android.os.StrictMode.PENALTY_DIALOG) != 0) && (timeSinceLastViolationMillis > android.os.StrictMode.MIN_DIALOG_INTERVAL_MS)) {
                violationMaskSubset |= android.os.StrictMode.PENALTY_DIALOG;
            }
            if (((info.policy & android.os.StrictMode.PENALTY_DROPBOX) != 0) && (lastViolationTime == 0)) {
                violationMaskSubset |= android.os.StrictMode.PENALTY_DROPBOX;
            }
            if (violationMaskSubset != 0) {
                int violationBit = android.os.StrictMode.parseViolationFromMessage(info.crashInfo.exceptionMessage);
                violationMaskSubset |= violationBit;
                final int savedPolicyMask = android.os.StrictMode.getThreadPolicyMask();
                final boolean justDropBox = (info.policy & android.os.StrictMode.THREAD_PENALTY_MASK) == android.os.StrictMode.PENALTY_DROPBOX;
                if (justDropBox) {
                    ...
                    android.os.StrictMode.dropboxViolationAsync(violationMaskSubset, info);
                    return;
                }
                ...
                try {
                    ...
                    android.os.StrictMode.setThreadPolicyMask(0);
                    android.app.ActivityManagerNative.getDefault().handleApplicationStrictModeViolation(com.android.internal.os.RuntimeInit.getApplicationObject(), violationMaskSubset, info);
                } catch (android.os.RemoteException e) {
                    if (e instanceof android.os.DeadObjectException) {
                        // System process is dead; ignore
                    } else {
                        android.util.Log.e(android.os.StrictMode.TAG, "RemoteException trying to handle StrictMode violation", e);
                    }
                } finally {
                    // Restore the policy.
                    android.os.StrictMode.setThreadPolicyMask(savedPolicyMask);
                }
            }
            if ((info.policy & android.os.StrictMode.PENALTY_DEATH) != 0) {
                android.os.StrictMode.executeDeathPenalty(info);
            }
        }
    }
    ...
    private static void executeDeathPenalty(android.os.StrictMode.ViolationInfo info) {
        int violationBit = android.os.StrictMode.parseViolationFromMessage(info.crashInfo.exceptionMessage);
        throw new android.os.StrictMode.StrictModeViolation(info.policy, violationBit, null);
    }
     ...
     * applicable.
     */
    private static void dropboxViolationAsync(final int violationMaskSubset, final android.os.StrictMode.ViolationInfo info) {
        int outstanding = android.os.StrictMode.sDropboxCallsInFlight.incrementAndGet();
        if (outstanding > 20) {
            // What's going on?  Let's not make make the situation
            // worse and just not log.
            android.os.StrictMode.sDropboxCallsInFlight.decrementAndGet();
            return;
        }
        if (android.os.StrictMode.LOG_V)
            android.util.Log.d(android.os.StrictMode.TAG, "Dropboxing async; in-flight=" + outstanding);

        new java.lang.Thread("callActivityManagerForStrictModeDropbox") {
            public void run() {
                android.os.Process.setThreadPriority(android.os.Process.THREAD_PRIORITY_BACKGROUND);
                try {
                    android.app.IActivityManager am = android.app.ActivityManagerNative.getDefault();
                    if (am == null) {
                        android.util.Log.d(android.os.StrictMode.TAG, "No activity manager; failed to Dropbox violation.");
                    } else {
                        am.handleApplicationStrictModeViolation(com.android.internal.os.RuntimeInit.getApplicationObject(), violationMaskSubset, info);
                    }
                } catch (android.os.RemoteException e) {
                    if (e instanceof android.os.DeadObjectException) {
                        // System process is dead; ignore
                    } else {
                        android.util.Log.e(android.os.StrictMode.TAG, "RemoteException handling StrictMode violation", e);
                    }
                }
                int outstanding = android.os.StrictMode.sDropboxCallsInFlight.decrementAndGet();
                if (android.os.StrictMode.LOG_V)
                    android.util.Log.d(android.os.StrictMode.TAG, "Dropbox complete; in-flight=" + outstanding);
    ...
    private static class AndroidCloseGuardReporter implements dalvik.system.CloseGuard.Reporter {
        public void report(java.lang.String message, java.lang.Throwable allocationSite) {
            android.os.StrictMode.onVmPolicyViolation(message, allocationSite);
        }
    }
    ...
    static boolean hasGatheredViolations() {
        return android.os.StrictMode.gatheredViolations.get() != null;
    }
    ...
    static void clearGatheredViolations() {
        android.os.StrictMode.gatheredViolations.set(null);
    }
    ...
    public static void conditionallyCheckInstanceCounts() {
        android.os.StrictMode.VmPolicy policy = android.os.StrictMode.getVmPolicy();
        ...
        java.lang.Class[] classes = policy.classInstanceLimit.keySet().toArray(new java.lang.Class[policySize]);
        long[] instanceCounts = dalvik.system.VMDebug.countInstancesOfClasses(classes, false);
        for (int i = 0; i < classes.length; ++i) {
            java.lang.Class klass = classes[i];
            int limit = policy.classInstanceLimit.get(klass);
            long instances = instanceCounts[i];
            if (instances > limit) {
                java.lang.Throwable tr = new android.os.StrictMode.InstanceCountViolation(klass, instances, limit);
                android.os.StrictMode.onVmPolicyViolation(tr.getMessage(), tr);
            }
        }
    }
    ...
    private static final android.os.MessageQueue.IdleHandler sProcessIdleHandler = new android.os.MessageQueue.IdleHandler() {
        public boolean queueIdle() {
            long now = android.os.SystemClock.uptimeMillis();
            if ((now - android.os.StrictMode.sLastInstanceCountCheckMillis) > (30 * 1000)) {
                android.os.StrictMode.sLastInstanceCountCheckMillis = now;
     ...
     * 		the policy to put into place
     */
    public static void setVmPolicy(final android.os.StrictMode.VmPolicy policy) {
        synchronized(android.os.StrictMode.class) {
            android.os.StrictMode.sVmPolicy = policy;
            android.os.StrictMode.sVmPolicyMask = policy.mask;
            android.os.StrictMode.setCloseGuardEnabled(android.os.StrictMode.vmClosableObjectLeaksEnabled());
            android.os.Looper looper = android.os.Looper.getMainLooper();
            if (looper != null) {
                android.os.MessageQueue mq = looper.mQueue;
                if ((policy.classInstanceLimit.size() == 0) || ((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.VM_PENALTY_MASK) == 0)) {
                    mq.removeIdleHandler(android.os.StrictMode.sProcessIdleHandler);
                    android.os.StrictMode.sIsIdlerRegistered = false;
                } else
                    if (!android.os.StrictMode.sIsIdlerRegistered) {
                        mq.addIdleHandler(android.os.StrictMode.sProcessIdleHandler);
                        android.os.StrictMode.sIsIdlerRegistered = true;
                    }

            }
            int networkPolicy = android.os.StrictMode.NETWORK_POLICY_ACCEPT;
            if ((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_CLEARTEXT_NETWORK) != 0) {
                if (((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DEATH) != 0) || ((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DEATH_ON_CLEARTEXT_NETWORK) != 0)) {
                    networkPolicy = android.os.StrictMode.NETWORK_POLICY_REJECT;
                } else {
                    networkPolicy = android.os.StrictMode.NETWORK_POLICY_LOG;
                }
            }
            final android.os.INetworkManagementService netd = INetworkManagementService.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.NETWORKMANAGEMENT_SERVICE));
            if (netd != null) {
                try {
                ...
                if (networkPolicy != android.os.StrictMode.NETWORK_POLICY_ACCEPT) {
                    android.util.Log.w(android.os.StrictMode.TAG, "Dropping requested network policy due to missing service!");
                }
    ...
    public static android.os.StrictMode.VmPolicy getVmPolicy() {
        synchronized(android.os.StrictMode.class) {
            return android.os.StrictMode.sVmPolicy;
        }
    }
    ...
    public static boolean vmSqliteObjectLeaksEnabled() {
        return (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_CURSOR_LEAKS) != 0;
    }
    ...
    public static boolean vmClosableObjectLeaksEnabled() {
        return (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_CLOSABLE_LEAKS) != 0;
    }
    ...
    public static boolean vmRegistrationLeaksEnabled() {
        return (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_REGISTRATION_LEAKS) != 0;
    }
    ...
    public static boolean vmFileUriExposureEnabled() {
        return (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_FILE_URI_EXPOSURE) != 0;
    }
    ...
    public static boolean vmCleartextNetworkEnabled() {
        return (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.DETECT_VM_CLEARTEXT_NETWORK) != 0;
    }
    ...
    public static void onSqliteObjectLeaked(java.lang.String message, java.lang.Throwable originStack) {
        android.os.StrictMode.onVmPolicyViolation(message, originStack);
    }
    ...
    public static void onWebViewMethodCalledOnWrongThread(java.lang.Throwable originStack) {
        android.os.StrictMode.onVmPolicyViolation(null, originStack);
    }
     ...
     * @unknown 
     */
    public static void onFileUriExposed(android.net.Uri uri, java.lang.String location) {
        final java.lang.String message = (uri + " exposed beyond app through ") + location;
        if ((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DEATH_ON_FILE_URI_EXPOSURE) != 0) {
            throw new android.os.FileUriExposedException(message);
        } else {
            android.os.StrictMode.onVmPolicyViolation(null, new java.lang.Throwable(message));
        }
    }
    ...
    public static void onCleartextNetworkDetected(byte[] firstPacket) {
        ...
        if (firstPacket != null) {
            if ((firstPacket.length >= 20) && ((firstPacket[0] & 0xf0) == 0x40)) {
                // IPv4
                rawAddr = new byte[4];
                java.lang.System.arraycopy(firstPacket, 16, rawAddr, 0, 4);
            } else
                if ((firstPacket.length >= 40) && ((firstPacket[0] & 0xf0) == 0x60)) {
                    // IPv6
                    rawAddr = new byte[16];
                    java.lang.System.arraycopy(firstPacket, 24, rawAddr, 0, 16);
                }

        }
        final int uid = android.os.Process.myUid();
        java.lang.String msg = "Detected cleartext network traffic from UID " + uid;
        if (rawAddr != null) {
            try {
                msg = (("Detected cleartext network traffic from UID " + uid) + " to ") + java.net.InetAddress.getByAddress(rawAddr);
            } catch (java.net.UnknownHostException ignored) {
            }
        }
        final boolean forceDeath = (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DEATH_ON_CLEARTEXT_NETWORK) != 0;
        android.os.StrictMode.onVmPolicyViolation(com.android.internal.util.HexDump.dumpHexString(firstPacket).trim(), new java.lang.Throwable(msg), forceDeath);
    }

    // Map from VM violation fingerprint to uptime millis.
    private static final java.util.HashMap<java.lang.Integer, java.lang.Long> sLastVmViolationTime = new java.util.HashMap<java.lang.Integer, java.lang.Long>();
    ...
    public static void onVmPolicyViolation(java.lang.String message, java.lang.Throwable originStack) {
        android.os.StrictMode.onVmPolicyViolation(message, originStack, false);
    }
     ...
     * @unknown 
     */
    public static void onVmPolicyViolation(java.lang.String message, java.lang.Throwable originStack, boolean forceDeath) {
        final boolean penaltyDropbox = (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DROPBOX) != 0;
        final boolean penaltyDeath = ((android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_DEATH) != 0) || forceDeath;
        final boolean penaltyLog = (android.os.StrictMode.sVmPolicyMask & android.os.StrictMode.PENALTY_LOG) != 0;
        final android.os.StrictMode.ViolationInfo info = new android.os.StrictMode.ViolationInfo(message, originStack, android.os.StrictMode.sVmPolicyMask);
        // Erase stuff not relevant for process-wide violations
        info.numAnimationsRunning = 0;
        info.tags = null;
        info.broadcastIntentAction = null;
        final java.lang.Integer fingerprint = info.hashCode();
        final long now = android.os.SystemClock.uptimeMillis();
        long lastViolationTime = 0;
        long timeSinceLastViolationMillis = java.lang.Long.MAX_VALUE;
        synchronized(android.os.StrictMode.sLastVmViolationTime) {
            if (android.os.StrictMode.sLastVmViolationTime.containsKey(fingerprint)) {
                lastViolationTime = android.os.StrictMode.sLastVmViolationTime.get(fingerprint);
                timeSinceLastViolationMillis = now - lastViolationTime;
            }
            if (timeSinceLastViolationMillis > android.os.StrictMode.MIN_LOG_INTERVAL_MS) {
                android.os.StrictMode.sLastVmViolationTime.put(fingerprint, now);
            }
        }
        if (penaltyLog && (timeSinceLastViolationMillis > android.os.StrictMode.MIN_LOG_INTERVAL_MS)) {
            android.util.Log.e(android.os.StrictMode.TAG, message, originStack);
        }
        int violationMaskSubset = android.os.StrictMode.PENALTY_DROPBOX | (android.os.StrictMode.ALL_VM_DETECT_BITS & android.os.StrictMode.sVmPolicyMask);
     ...
     */
    /* package */
    static void writeGatheredViolationsToParcel(android.os.Parcel p) {
        java.util.ArrayList<android.os.StrictMode.ViolationInfo> violations = android.os.StrictMode.gatheredViolations.get();
        if (violations == null) {
            p.writeInt(0);
        } else {
            ...
            for (int i = 0; i < violations.size(); ++i) {
                ...
                if (size > (10 * 1024)) {
                    android.util.Slog.d(android.os.StrictMode.TAG, ((((("Wrote violation #" + i) + " of ") + violations.size()) + ": ") + (p.dataPosition() - start)) + " bytes");
                }
            }
            if (android.os.StrictMode.LOG_V)
                android.util.Log.d(android.os.StrictMode.TAG, "wrote violations to response parcel; num=" + violations.size());
    ...
    private static class LogStackTrace extends java.lang.Exception {}
     ...
     */
    /* package */
    static void readAndHandleBinderCallViolations(android.os.Parcel p) {
        // Our own stack trace to append
        java.io.StringWriter sw = new java.io.StringWriter();
        java.io.PrintWriter pw = new com.android.internal.util.FastPrintWriter(sw, false, 256);
        new android.os.StrictMode.LogStackTrace().printStackTrace(pw);
        pw.flush();
        java.lang.String ourStack = sw.toString();
        int policyMask = android.os.StrictMode.getThreadPolicyMask();
        boolean currentlyGathering = (policyMask & android.os.StrictMode.PENALTY_GATHER) != 0;
        int numViolations = p.readInt();
        for (int i = 0; i < numViolations; ++i) {
            if (android.os.StrictMode.LOG_V)
                android.util.Log.d(android.os.StrictMode.TAG, "strict mode violation stacks read from binder call.  i=" + i);

            android.os.StrictMode.ViolationInfo info = new android.os.StrictMode.ViolationInfo(p, !currentlyGathering);
            if ((info.crashInfo.stackTrace != null) && (info.crashInfo.stackTrace.length() > 30000)) {
                java.lang.String front = info.crashInfo.stackTrace.substring(0, 256);
                ...
                for (; i < numViolations; i++) {
                    info = new android.os.StrictMode.ViolationInfo(p, !currentlyGathering);
                }
                // Next clear out all gathered violations.
                android.os.StrictMode.clearGatheredViolations();
                // Now report the problem.
                android.util.Slog.wtfStack(android.os.StrictMode.TAG, (((("Stack is too large: numViolations=" + numViolations) + " policy=#") + java.lang.Integer.toHexString(policyMask)) + " front=") + front);
                return;
            }
            info.crashInfo.stackTrace += "# via Binder call with stack:\n" + ourStack;
            dalvik.system.BlockGuard.Policy policy = dalvik.system.BlockGuard.getThreadPolicy();
            if (policy instanceof android.os.StrictMode.AndroidBlockGuardPolicy) {
                ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy)).handleViolationWithTimingAttempt(info);
            }
        }
    }
    ...
    private static void onBinderStrictModePolicyChange(int newPolicy) {
        android.os.StrictMode.setBlockGuardPolicy(newPolicy);
    }
    ...
    public static class Span {
        ...
        private android.os.StrictMode.Span mPrev;// not used when in freeList, only active


        private final android.os.StrictMode.ThreadSpanState mContainerState;

        Span(android.os.StrictMode.ThreadSpanState threadState) {
        ...
        public void finish() {
            ...
            synchronized(state) {
                ...
                state.mActiveSize--;
                if (android.os.StrictMode.LOG_V)
                    android.util.Log.d(android.os.StrictMode.TAG, (("Span finished=" + mName) + "; size=") + state.mActiveSize);
    ...
    private static final android.os.StrictMode.Span NO_OP_SPAN = new android.os.StrictMode.Span() {
        public void finish() {
            // Do nothing.
        }
    };
    ...
    private static class ThreadSpanState {
        public android.os.StrictMode.Span mActiveHead;// doubly-linked list.


        public int mActiveSize;

        public android.os.StrictMode.Span mFreeListHead;// singly-linked list.  only changes at head.


        public int mFreeListSize;
    }

    private static final java.lang.ThreadLocal<android.os.StrictMode.ThreadSpanState> sThisThreadSpanState = new java.lang.ThreadLocal<android.os.StrictMode.ThreadSpanState>() {
        @java.lang.Override
    ...
    private static android.util.Singleton<android.view.IWindowManager> sWindowManager = new android.util.Singleton<android.view.IWindowManager>() {
        protected android.view.IWindowManager create() {
            return IWindowManager.Stub.asInterface(android.os.ServiceManager.getService("window"));
        }
    };
    ...
    public static android.os.StrictMode.Span enterCriticalSpan(java.lang.String name) {
        if (android.os.StrictMode.IS_USER_BUILD) {
            return android.os.StrictMode.NO_OP_SPAN;
        }
        if ((name == null) || name.isEmpty()) {
            throw new java.lang.IllegalArgumentException("name must be non-null and non-empty");
        }
        android.os.StrictMode.ThreadSpanState state = android.os.StrictMode.sThisThreadSpanState.get();
        android.os.StrictMode.Span span = null;
        synchronized(state) {
            if (state.mFreeListHead != null) {
                ...
                span = new android.os.StrictMode.Span(state);
            }
            span.mName = name;
            ...
            if (android.os.StrictMode.LOG_V)
                android.util.Log.d(android.os.StrictMode.TAG, (("Span enter=" + name) + "; size=") + state.mActiveSize);
    ...
    public static void noteSlowCall(java.lang.String name) {
        ...
        ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy)).onCustomSlowCall(name);
    }
     ...
     * @unknown 
     */
    public static void noteResourceMismatch(java.lang.Object tag) {
        dalvik.system.BlockGuard.Policy policy = dalvik.system.BlockGuard.getThreadPolicy();
        if (!(policy instanceof android.os.StrictMode.AndroidBlockGuardPolicy)) {
            // StrictMode not enabled.
            return;
        }
        ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy)).onResourceMismatch(tag);
    }
    ...
    public static void noteDiskRead() {
        ...
        ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy)).onReadFromDisk();
    }
    ...
    public static void noteDiskWrite() {
        ...
        ((android.os.StrictMode.AndroidBlockGuardPolicy) (policy)).onWriteToDisk();
    }

    // Guarded by StrictMode.class
    private static final java.util.HashMap<java.lang.Class, java.lang.Integer> sExpectedActivityInstanceCount = new java.util.HashMap<java.lang.Class, java.lang.Integer>();
    ...
    public static java.lang.Object trackActivity(java.lang.Object instance) {
        return new android.os.StrictMode.InstanceTracker(instance);
    }
    ...
    public static void incrementExpectedActivityCount(java.lang.Class klass) {
        ...
        synchronized(android.os.StrictMode.class) {
            if ((android.os.StrictMode.sVmPolicy.mask & android.os.StrictMode.DETECT_VM_ACTIVITY_LEAKS) == 0) {
                return;
            }
            java.lang.Integer expected = android.os.StrictMode.sExpectedActivityInstanceCount.get(klass);
            java.lang.Integer newExpected = (expected == null) ? 1 : expected + 1;
            android.os.StrictMode.sExpectedActivityInstanceCount.put(klass, newExpected);
        }
    }
    ...
    public static void decrementExpectedActivityCount(java.lang.Class klass) {
        ...
        synchronized(android.os.StrictMode.class) {
            ...
            if (newExpected == 0) {
                android.os.StrictMode.sExpectedActivityInstanceCount.remove(klass);
            } else {
                android.os.StrictMode.sExpectedActivityInstanceCount.put(klass, newExpected);
            }
        ...
        // Quick check.
        int actual = android.os.StrictMode.InstanceTracker.getInstanceCount(klass);
        if (actual <= limit) {
            return;
        }
        ...
        java.lang.System.runFinalization();
        java.lang.System.gc();
        long instances = dalvik.system.VMDebug.countInstancesOfClass(klass, false);
        if (instances > limit) {
            java.lang.Throwable tr = new android.os.StrictMode.InstanceCountViolation(klass, instances, limit);
            android.os.StrictMode.onVmPolicyViolation(tr.getMessage(), tr);
        }
    ...
    public static class ViolationInfo {
        ...
        public ViolationInfo(java.lang.Throwable tr, int policy) {
            this(null, tr, policy);
        }
         ...
         */
        public ViolationInfo(java.lang.String message, java.lang.Throwable tr, int policy) {
            this.message = message;
            crashInfo = new android.app.ApplicationErrorReport.CrashInfo(tr);
            violationUptimeMillis = android.os.SystemClock.uptimeMillis();
            this.policy = policy;
            this.numAnimationsRunning = android.animation.ValueAnimator.getCurrentAnimationsCount();
            android.content.Intent broadcastIntent = android.app.ActivityThread.getIntentBeingBroadcast();
            if (broadcastIntent != null) {
                broadcastIntentAction = broadcastIntent.getAction();
            }
            android.os.StrictMode.ThreadSpanState state = android.os.StrictMode.sThisThreadSpanState.get();
            if (tr instanceof android.os.StrictMode.InstanceCountViolation) {
                this.numInstances = ((android.os.StrictMode.InstanceCountViolation) (tr)).mInstances;
            }
            synchronized(state) {
                int spanActiveCount = state.mActiveSize;
                if (spanActiveCount > android.os.StrictMode.MAX_SPAN_TAGS) {
                    spanActiveCount = android.os.StrictMode.MAX_SPAN_TAGS;
                }
                if (spanActiveCount != 0) {
                    this.tags = new java.lang.String[spanActiveCount];
                    android.os.StrictMode.Span iter = state.mActiveHead;
                    int index = 0;
         ...
         */
        public ViolationInfo(android.os.Parcel in) {
            this(in, false);
        }
         ...
         */
        public ViolationInfo(android.os.Parcel in, boolean unsetGatheringBit) {
            message = in.readString();
            crashInfo = new android.app.ApplicationErrorReport.CrashInfo(in);
            int rawPolicy = in.readInt();
            if (unsetGatheringBit) {
                policy = rawPolicy & (~android.os.StrictMode.PENALTY_GATHER);
            } else {
                policy = rawPolicy;
            }
        ...
        public void writeToParcel(android.os.Parcel dest, int flags) {
            ...
            if (total > (10 * 1024)) {
                android.util.Slog.d(android.os.StrictMode.TAG, (((((((((("VIO: policy=" + policy) + " dur=") + durationMillis) + " numLoop=") + violationNumThisLoop) + " anim=") + numAnimationsRunning) + " uptime=") + violationUptimeMillis) + " numInst=") + numInstances);
                android.util.Slog.d(android.os.StrictMode.TAG, "VIO: action=" + broadcastIntentAction);
                android.util.Slog.d(android.os.StrictMode.TAG, "VIO: tags=" + java.util.Arrays.toString(tags));
                android.util.Slog.d(android.os.StrictMode.TAG, "VIO: TOTAL BYTES WRITTEN: " + (dest.dataPosition() - start));
            }
        }
    ...
    // misleading.
    private static class InstanceCountViolation extends java.lang.Throwable {
        final java.lang.Class mClass;

        final long mInstances;

        final int mLimit;

        private static final java.lang.StackTraceElement[] FAKE_STACK = new java.lang.StackTraceElement[]{ new java.lang.StackTraceElement("android.os.StrictMode", "setClassInstanceLimit", "StrictMode.java", 1) };

        public InstanceCountViolation(java.lang.Class klass, long instances, int limit) {
            super((((klass.toString() + "; instances=") + instances) + "; limit=") + limit);
            setStackTrace(android.os.StrictMode.InstanceCountViolation.FAKE_STACK);
            mClass = klass;
    ...
    private static final class InstanceTracker {
        private static final java.util.HashMap<java.lang.Class<?>, java.lang.Integer> sInstanceCounts = new java.util.HashMap<java.lang.Class<?>, java.lang.Integer>();

        private final java.lang.Class<?> mKlass;

        public InstanceTracker(java.lang.Object instance) {
            mKlass = instance.getClass();
            synchronized(android.os.StrictMode.InstanceTracker.sInstanceCounts) {
                final java.lang.Integer value = android.os.StrictMode.InstanceTracker.sInstanceCounts.get(mKlass);
                final int newValue = (value != null) ? value + 1 : 1;
                android.os.StrictMode.InstanceTracker.sInstanceCounts.put(mKlass, newValue);
            }
        }
                ...
                synchronized(android.os.StrictMode.InstanceTracker.sInstanceCounts) {
                    ...
                    if (value != null) {
                        ...
                        if (newValue > 0) {
                            ...
                            android.os.StrictMode.InstanceTracker.sInstanceCounts.remove(mKlass);
                        }
                    }
                }
            } finally {
        ...
        public static int getInstanceCount(java.lang.Class<?> klass) {
            synchronized(android.os.StrictMode.InstanceTracker.sInstanceCounts) {
                final java.lang.Integer value = android.os.StrictMode.InstanceTracker.sInstanceCounts.get(klass);
