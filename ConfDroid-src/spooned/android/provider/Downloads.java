...
public final class Downloads {
    ...
    public static final class Impl implements android.provider.BaseColumns {
         ...
         */
        public static final android.net.Uri PUBLICLY_ACCESSIBLE_DOWNLOADS_URI = android.net.Uri.parse("content://downloads/" + android.provider.Downloads.Impl.PUBLICLY_ACCESSIBLE_DOWNLOADS_URI_SEGMENT);
        ...
        public static boolean isNotificationToBeDisplayed(int visibility) {
            return (visibility == android.app.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_COMPLETED) || (visibility == android.app.DownloadManager.Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION);
        }
        ...
        public static java.lang.String statusToString(int status) {
            switch (status) {
                ...
                case android.provider.Downloads.Impl.STATUS_SUCCESS :
                    return "SUCCESS";
                case android.provider.Downloads.Impl.STATUS_BAD_REQUEST :
                    return "BAD_REQUEST";
                case android.provider.Downloads.Impl.STATUS_NOT_ACCEPTABLE :
                    return "NOT_ACCEPTABLE";
                case android.provider.Downloads.Impl.STATUS_LENGTH_REQUIRED :
                    return "LENGTH_REQUIRED";
                case android.provider.Downloads.Impl.STATUS_PRECONDITION_FAILED :
                ...
                case android.provider.Downloads.Impl.STATUS_CANCELED :
                    return "CANCELED";
                case android.provider.Downloads.Impl.STATUS_UNKNOWN_ERROR :
                ...
                case android.provider.Downloads.Impl.STATUS_HTTP_EXCEPTION :
                    return "HTTP_EXCEPTION";
                case android.provider.Downloads.Impl.STATUS_TOO_MANY_REDIRECTS :
                    return "TOO_MANY_REDIRECTS";
                case android.provider.Downloads.Impl.STATUS_BLOCKED :
                    return "BLOCKED";
                default :
     ...
     */
    private static final java.lang.String QUERY_WHERE_CLAUSE = ((android.provider.Downloads.Impl.COLUMN_NOTIFICATION_PACKAGE + "=? AND ") + android.provider.Downloads.Impl.COLUMN_NOTIFICATION_CLASS) + "=?";

    /**
     * Delete all the downloads for a package/class pair.
     */
    public static final void removeAllDownloadsByPackage(android.content.Context context, java.lang.String notification_package, java.lang.String notification_class) {
        context.getContentResolver().delete(android.provider.Downloads.Impl.CONTENT_URI, android.provider.Downloads.QUERY_WHERE_CLAUSE, new java.lang.String[]{ notification_package, notification_class });
    }
}
