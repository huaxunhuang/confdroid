...
public final class ContactsContract {
     ...
     */
    public static final android.net.Uri AUTHORITY_URI = android.net.Uri.parse("content://" + android.provider.ContactsContract.AUTHORITY);
    ...
    public static final class Directory implements android.provider.BaseColumns {
         ...
         */
        public static final long ENTERPRISE_DEFAULT = android.provider.ContactsContract.Directory.ENTERPRISE_DIRECTORY_ID_BASE + android.provider.ContactsContract.Directory.DEFAULT;

        /**
         * _ID of the work profile directory that represents locally stored invisible contacts.
         */
        public static final long ENTERPRISE_LOCAL_INVISIBLE = android.provider.ContactsContract.Directory.ENTERPRISE_DIRECTORY_ID_BASE + android.provider.ContactsContract.Directory.LOCAL_INVISIBLE;
        ...
        public static boolean isRemoteDirectoryId(long directoryId) {
            return (((directoryId != android.provider.ContactsContract.Directory.DEFAULT) && (directoryId != android.provider.ContactsContract.Directory.LOCAL_INVISIBLE)) && (directoryId != android.provider.ContactsContract.Directory.ENTERPRISE_DEFAULT)) && (directoryId != android.provider.ContactsContract.Directory.ENTERPRISE_LOCAL_INVISIBLE);
        }
        ...
        public static boolean isRemoteDirectory(long directoryId) {
            return android.provider.ContactsContract.Directory.isRemoteDirectoryId(directoryId);
        }
        ...
        public static boolean isEnterpriseDirectoryId(long directoryId) {
            return directoryId >= android.provider.ContactsContract.Directory.ENTERPRISE_DIRECTORY_ID_BASE;
        }
        ...
        public static void notifyDirectoryChange(android.content.ContentResolver resolver) {
            ...
            resolver.update(android.provider.ContactsContract.Directory.CONTENT_URI, contentValues, null, null);
        }
    }
     ...
     *
     *
     * @unknown should be removed when users are updated to refer to SyncState
    ...
    public static final class SyncState implements android.provider.SyncStateContract.Columns {
         ...
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.AUTHORITY_URI, android.provider.ContactsContract.SyncState.CONTENT_DIRECTORY);
        ...
        public static byte[] get(android.content.ContentProviderClient provider, android.accounts.Account account) throws android.os.RemoteException {
            return android.provider.SyncStateContract.Helpers.get(provider, android.provider.ContactsContract.SyncState.CONTENT_URI, account);
        }
        ...
        public static android.util.Pair<android.net.Uri, byte[]> getWithUri(android.content.ContentProviderClient provider, android.accounts.Account account) throws android.os.RemoteException {
            return android.provider.SyncStateContract.Helpers.getWithUri(provider, android.provider.ContactsContract.SyncState.CONTENT_URI, account);
        }
        ...
        public static void set(android.content.ContentProviderClient provider, android.accounts.Account account, byte[] data) throws android.os.RemoteException {
            android.provider.SyncStateContract.Helpers.set(provider, android.provider.ContactsContract.SyncState.CONTENT_URI, account, data);
        }
        ...
        public static android.content.ContentProviderOperation newSetOperation(android.accounts.Account account, byte[] data) {
            return android.provider.SyncStateContract.Helpers.newSetOperation(android.provider.ContactsContract.SyncState.CONTENT_URI, account, data);
        }
    }
    ...
    public static final class ProfileSyncState implements android.provider.SyncStateContract.Columns {
         ...
         * The content:// style URI for this table
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Profile.CONTENT_URI, android.provider.ContactsContract.ProfileSyncState.CONTENT_DIRECTORY);
         ...
         */
        public static byte[] get(android.content.ContentProviderClient provider, android.accounts.Account account) throws android.os.RemoteException {
            return android.provider.SyncStateContract.Helpers.get(provider, android.provider.ContactsContract.ProfileSyncState.CONTENT_URI, account);
        }
         ...
         */
        public static android.util.Pair<android.net.Uri, byte[]> getWithUri(android.content.ContentProviderClient provider, android.accounts.Account account) throws android.os.RemoteException {
            return android.provider.SyncStateContract.Helpers.getWithUri(provider, android.provider.ContactsContract.ProfileSyncState.CONTENT_URI, account);
        }
         ...
         */
        public static void set(android.content.ContentProviderClient provider, android.accounts.Account account, byte[] data) throws android.os.RemoteException {
            android.provider.SyncStateContract.Helpers.set(provider, android.provider.ContactsContract.ProfileSyncState.CONTENT_URI, account, data);
        }
         ...
         */
        public static android.content.ContentProviderOperation newSetOperation(android.accounts.Account account, byte[] data) {
            return android.provider.SyncStateContract.Helpers.newSetOperation(android.provider.ContactsContract.ProfileSyncState.CONTENT_URI, account, data);
        }
    }
    ...
    protected interface ContactsColumns {
         ...
         * <P>Type: TEXT</P>
         */
        public static final java.lang.String DISPLAY_NAME = android.provider.ContactsContract.ContactNameColumns.DISPLAY_NAME_PRIMARY;
    ...
    public static class Contacts implements android.provider.BaseColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.ContactNameColumns , android.provider.ContactsContract.ContactOptionsColumns , android.provider.ContactsContract.ContactStatusColumns , android.provider.ContactsContract.ContactsColumns {
         ...
         * The content:// style URI for this table
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.AUTHORITY_URI, "contacts");
         ...
         */
        public static final android.net.Uri CONTENT_LOOKUP_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "lookup");
         ...
         */
        public static final android.net.Uri CONTENT_VCARD_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "as_vcard");
         ...
         * </p>
         */
        public static final android.net.Uri CONTENT_MULTI_VCARD_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "as_multi_vcard");
         ...
         *
         * @param contactUri
         * 		A {@link #CONTENT_URI} row, or an existing
        ...
        public static android.net.Uri getLookupUri(android.content.ContentResolver resolver, android.net.Uri contactUri) {
            final android.database.Cursor c = resolver.query(contactUri, new java.lang.String[]{ android.provider.ContactsContract.Contacts.LOOKUP_KEY, android.provider.ContactsContract.Contacts._ID }, null, null, null);
            if (c == null) {
                return null;
            }
            try {
                if (c.moveToFirst()) {
                    final java.lang.String lookupKey = c.getString(0);
        ...
        public static android.net.Uri getLookupUri(long contactId, java.lang.String lookupKey) {
            if (android.text.TextUtils.isEmpty(lookupKey)) {
                return null;
            }
            return android.content.ContentUris.withAppendedId(android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_LOOKUP_URI, lookupKey), contactId);
        }
        ...
        public static android.net.Uri lookupContact(android.content.ContentResolver resolver, android.net.Uri lookupUri) {
            ...
            android.database.Cursor c = resolver.query(lookupUri, new java.lang.String[]{ android.provider.ContactsContract.Contacts._ID }, null, null, null);
            if (c == null) {
                return null;
            }
            try {
                if (c.moveToFirst()) {
                    ...
                    return android.content.ContentUris.withAppendedId(android.provider.ContactsContract.Contacts.CONTENT_URI, contactId);
                }
            } finally {
                c.close();
            }
        ...
        public static void markAsContacted(android.content.ContentResolver resolver, long contactId) {
            android.net.Uri uri = android.content.ContentUris.withAppendedId(android.provider.ContactsContract.Contacts.CONTENT_URI, contactId);
            android.content.ContentValues values = new android.content.ContentValues();
            // TIMES_CONTACTED will be incremented when LAST_TIME_CONTACTED is modified.
            values.put(android.provider.ContactsContract.ContactOptionsColumns.LAST_TIME_CONTACTED, java.lang.System.currentTimeMillis());
         ...
         */
        public static final android.net.Uri CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "filter");
         ...
         */
        public static final android.net.Uri ENTERPRISE_CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "filter_enterprise");
         ...
         */
        public static final android.net.Uri CONTENT_STREQUENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "strequent");

        /**
         * The content:// style URI for showing a list of frequently contacted people.
         */
        public static final android.net.Uri CONTENT_FREQUENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "frequent");
         ...
         * as an additional path segment after this URI.
         */
        public static final android.net.Uri CONTENT_STREQUENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_STREQUENT_URI, "filter");

        public static final android.net.Uri CONTENT_GROUP_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, "group");
        ...
        public static boolean isEnterpriseContactId(long contactId) {
            return (contactId >= android.provider.ContactsContract.Contacts.ENTERPRISE_CONTACT_ID_BASE) && (contactId < android.provider.ContactsContract.Profile.MIN_ID);
        }
         ...
         * </p>
         */
        public static final class AggregationSuggestions implements android.provider.BaseColumns , android.provider.ContactsContract.ContactOptionsColumns , android.provider.ContactsContract.ContactStatusColumns , android.provider.ContactsContract.ContactsColumns {
            /**
             * No public constructor since this is a utility class
             */
            ...
            public static final class Builder {
                ...
                private final java.util.ArrayList<java.lang.String> mValues = new java.util.ArrayList<java.lang.String>();
                 ...
                 * @return This Builder object to allow for chaining of calls to builder methods
                 */
                public android.provider.ContactsContract.Contacts.AggregationSuggestions.Builder addNameParameter(java.lang.String name) {
                    mValues.add(name);
                    return this;
                }
                ...
                public android.net.Uri build() {
                    ...
                    builder.appendEncodedPath(java.lang.String.valueOf(mContactId));
                    builder.appendPath(android.provider.ContactsContract.Contacts.AggregationSuggestions.CONTENT_DIRECTORY);
                    if (mLimit != 0) {
                        builder.appendQueryParameter("limit", java.lang.String.valueOf(mLimit));
                    }
                    int count = mValues.size();
                    for (int i = 0; i < count; i++) {
                        builder.appendQueryParameter("query", (android.provider.ContactsContract.Contacts.AggregationSuggestions.PARAMETER_MATCH_NAME + ":") + mValues.get(i));
                    }
        ...
        public static final class Photo implements android.provider.BaseColumns , android.provider.ContactsContract.DataColumnsWithJoins {
             ...
             * Type: NUMBER
             */
            public static final java.lang.String PHOTO_FILE_ID = android.provider.ContactsContract.DataColumns.DATA14;
             ...
             * Type: BLOB
             */
            public static final java.lang.String PHOTO = android.provider.ContactsContract.DataColumns.DATA15;
        }
        ...
        public static java.io.InputStream openContactPhotoInputStream(android.content.ContentResolver cr, android.net.Uri contactUri, boolean preferHighres) {
            if (preferHighres) {
                final android.net.Uri displayPhotoUri = android.net.Uri.withAppendedPath(contactUri, android.provider.ContactsContract.Contacts.Photo.DISPLAY_PHOTO);
                try {
                    android.content.res.AssetFileDescriptor fd = cr.openAssetFileDescriptor(displayPhotoUri, "r");
                    if (fd != null) {
                        return fd.createInputStream();
                    }
            ...
            android.net.Uri photoUri = android.net.Uri.withAppendedPath(contactUri, android.provider.ContactsContract.Contacts.Photo.CONTENT_DIRECTORY);
            if (photoUri == null) {
                return null;
            }
            android.database.Cursor cursor = cr.query(photoUri, new java.lang.String[]{ android.provider.ContactsContract.CommonDataKinds.Photo.PHOTO }, null, null, null);
            try {
        ...
        public static java.io.InputStream openContactPhotoInputStream(android.content.ContentResolver cr, android.net.Uri contactUri) {
            return android.provider.ContactsContract.Contacts.openContactPhotoInputStream(cr, contactUri, false);
        }
    }
     ...
     * </dl>
     */
    public static final class Profile implements android.provider.BaseColumns , android.provider.ContactsContract.ContactNameColumns , android.provider.ContactsContract.ContactOptionsColumns , android.provider.ContactsContract.ContactStatusColumns , android.provider.ContactsContract.ContactsColumns {
        /**
         * This utility class cannot be instantiated
         */
        private Profile() {
         ...
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.AUTHORITY_URI, "profile");
         ...
         * {@link ContentResolver#openAssetFileDescriptor(Uri, String)}.
         */
        public static final android.net.Uri CONTENT_VCARD_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Profile.CONTENT_URI, "as_vcard");
         ...
         * path as well.
         */
        public static final android.net.Uri CONTENT_RAW_CONTACTS_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Profile.CONTENT_URI, "raw_contacts");
         ...
         */
        public static final long MIN_ID = java.lang.Long.MAX_VALUE - ((long) (java.lang.Integer.MAX_VALUE));
    }
    ...
    public static boolean isProfileId(long id) {
        return id >= android.provider.ContactsContract.Profile.MIN_ID;
    }
    ...
    public static final class DeletedContacts implements android.provider.ContactsContract.DeletedContactsColumns {
         ...
         * deleted.
         */
        public static final long DAYS_KEPT_MILLISECONDS = (((1000L * 60L) * 60L) * 24L) * ((long) (android.provider.ContactsContract.DeletedContacts.DAYS_KEPT));
    }
     ...
     * </table>
     */
    public static final class RawContacts implements android.provider.BaseColumns , android.provider.ContactsContract.ContactNameColumns , android.provider.ContactsContract.ContactOptionsColumns , android.provider.ContactsContract.RawContactsColumns , android.provider.ContactsContract.SyncColumns {
        /**
         * This utility class cannot be instantiated
         */
        private RawContacts() {
        ...
        public static android.net.Uri getContactLookupUri(android.content.ContentResolver resolver, android.net.Uri rawContactUri) {
            ...
            final android.net.Uri dataUri = android.net.Uri.withAppendedPath(rawContactUri, android.provider.ContactsContract.RawContacts.Data.CONTENT_DIRECTORY);
            final android.database.Cursor cursor = resolver.query(dataUri, new java.lang.String[]{ android.provider.ContactsContract.RawContacts.CONTACT_ID, android.provider.ContactsContract.Contacts.LOOKUP_KEY }, null, null, null);
            android.net.Uri lookupUri = null;
            try {
                if ((cursor != null) && cursor.moveToFirst()) {
                    final long contactId = cursor.getLong(0);
                    final java.lang.String lookupKey = cursor.getString(1);
                    return android.provider.ContactsContract.Contacts.getLookupUri(contactId, lookupKey);
                }
            } finally {
                if (cursor != null)
        ...
        private static class EntityIteratorImpl extends android.content.CursorEntityIterator {
            private static final java.lang.String[] DATA_KEYS = new java.lang.String[]{ android.provider.ContactsContract.RawContacts.Data.DATA1, android.provider.ContactsContract.RawContacts.Data.DATA2, android.provider.ContactsContract.RawContacts.Data.DATA3, android.provider.ContactsContract.RawContacts.Data.DATA4, android.provider.ContactsContract.RawContacts.Data.DATA5, android.provider.ContactsContract.RawContacts.Data.DATA6, android.provider.ContactsContract.RawContacts.Data.DATA7, android.provider.ContactsContract.RawContacts.Data.DATA8, android.provider.ContactsContract.RawContacts.Data.DATA9, android.provider.ContactsContract.RawContacts.Data.DATA10, android.provider.ContactsContract.RawContacts.Data.DATA11, android.provider.ContactsContract.RawContacts.Data.DATA12, android.provider.ContactsContract.RawContacts.Data.DATA13, android.provider.ContactsContract.RawContacts.Data.DATA14, android.provider.ContactsContract.RawContacts.Data.DATA15, android.provider.ContactsContract.RawContacts.Data.SYNC1, android.provider.ContactsContract.RawContacts.Data.SYNC2, android.provider.ContactsContract.RawContacts.Data.SYNC3, android.provider.ContactsContract.RawContacts.Data.SYNC4 };
            ...
            public android.content.Entity getEntityAndIncrementCursor(android.database.Cursor cursor) throws android.os.RemoteException {
                final int columnRawContactId = cursor.getColumnIndexOrThrow(android.provider.ContactsContract.RawContacts._ID);
                final long rawContactId = cursor.getLong(columnRawContactId);
                // we expect the cursor is already at the row we need to read from
                android.content.ContentValues cv = new android.content.ContentValues();
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.SyncColumns.ACCOUNT_NAME);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.SyncColumns.ACCOUNT_TYPE);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContactsColumns.DATA_SET);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.BaseColumns._ID);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.SyncColumns.DIRTY);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.SyncColumns.VERSION);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.SyncColumns.SOURCE_ID);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.BaseSyncColumns.SYNC1);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.BaseSyncColumns.SYNC2);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.BaseSyncColumns.SYNC3);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.BaseSyncColumns.SYNC4);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContactsColumns.DELETED);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContactsColumns.CONTACT_ID);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.ContactOptionsColumns.STARRED);
                ...
                do {
                    ...
                    cv.put(android.provider.ContactsContract.RawContacts.Data._ID, cursor.getLong(cursor.getColumnIndexOrThrow(android.provider.ContactsContract.RawContacts.Entity.DATA_ID)));
                    android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.RES_PACKAGE);
                    android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.MIMETYPE);
                    android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.IS_PRIMARY);
                    android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.IS_SUPER_PRIMARY);
                    android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.DATA_VERSION);
                    android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.CommonDataKinds.GroupMembership.GROUP_SOURCE_ID);
                    android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, android.provider.ContactsContract.RawContacts.Data.DATA_VERSION);
                    for (java.lang.String key : android.provider.ContactsContract.RawContacts.EntityIteratorImpl.DATA_KEYS) {
    ...
    protected interface StatusColumns {
         ...
         */
        @java.lang.Deprecated
        public static final java.lang.String PRESENCE_STATUS = android.provider.ContactsContract.StatusColumns.PRESENCE;
         ...
         */
        @java.lang.Deprecated
        public static final java.lang.String PRESENCE_CUSTOM_STATUS = android.provider.ContactsContract.StatusColumns.STATUS;
    ...
    public static final class StreamItems implements android.provider.BaseColumns , android.provider.ContactsContract.StreamItemsColumns {
         ...
         */
        @java.lang.Deprecated
        public static final android.net.Uri CONTENT_PHOTO_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.StreamItems.CONTENT_URI, "photo");
    ...
    protected interface DataColumns {
         ...
         */
        public static final int CARRIER_PRESENCE_VT_CAPABLE = 0x1;
    }
     ...
     * </table>
     */
    public static final class Data implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
        /**
         * This utility class cannot be instantiated
         */
        private Data() {
    ...
    public static final class RawContactsEntity implements android.provider.BaseColumns , android.provider.ContactsContract.DataColumns , android.provider.ContactsContract.RawContactsColumns {
         ...
         * <P>Type: INTEGER</p>
         *
         * @unknown Maybe available only in Eclair and not really ready for public use.
     ...
     * </table>
     */
    public static final class PhoneLookup implements android.provider.BaseColumns , android.provider.ContactsContract.ContactOptionsColumns , android.provider.ContactsContract.ContactsColumns , android.provider.ContactsContract.PhoneLookupColumns {
        /**
         * This utility class cannot be instantiated
         */
        private PhoneLookup() {
     ...
     * </table>
     */
    public static class StatusUpdates implements android.provider.ContactsContract.PresenceColumns , android.provider.ContactsContract.StatusColumns {
        /**
         * This utility class cannot be instantiated
         */
        ...
        public static final int getPresenceIconResourceId(int status) {
            switch (status) {
                case android.provider.ContactsContract.StatusColumns.AVAILABLE :
                    return android.R.drawable.presence_online;
                case android.provider.ContactsContract.StatusColumns.IDLE :
                case android.provider.ContactsContract.StatusColumns.AWAY :
                    return android.R.drawable.presence_away;
                case android.provider.ContactsContract.StatusColumns.DO_NOT_DISTURB :
                    return android.R.drawable.presence_busy;
                case android.provider.ContactsContract.StatusColumns.INVISIBLE :
                    return android.R.drawable.presence_invisible;
                case android.provider.ContactsContract.StatusColumns.OFFLINE :
                default :
    ...
    public static final class CommonDataKinds {
        ...
        protected interface CommonColumns extends android.provider.ContactsContract.CommonDataKinds.BaseTypes {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String DATA = android.provider.ContactsContract.DataColumns.DATA1;

            /**
             * The type of data, for example Home or Work.
             * <P>Type: INTEGER</P>
             */
            public static final java.lang.String TYPE = android.provider.ContactsContract.DataColumns.DATA2;

            /**
             * The user defined label for the the contact method.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String LABEL = android.provider.ContactsContract.DataColumns.DATA3;
        }
         ...
         * </table>
         */
        public static final class StructuredName implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
             ...
             * Type: TEXT
             */
            public static final java.lang.String DISPLAY_NAME = android.provider.ContactsContract.DataColumns.DATA1;

            /**
             * The given name for the contact.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String GIVEN_NAME = android.provider.ContactsContract.DataColumns.DATA2;

            /**
             * The family name for the contact.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String FAMILY_NAME = android.provider.ContactsContract.DataColumns.DATA3;

            /**
             * The contact's honorific prefix, e.g. "Sir"
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String PREFIX = android.provider.ContactsContract.DataColumns.DATA4;

            /**
             * The contact's middle name
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String MIDDLE_NAME = android.provider.ContactsContract.DataColumns.DATA5;

            /**
             * The contact's honorific suffix, e.g. "Jr"
             */
            public static final java.lang.String SUFFIX = android.provider.ContactsContract.DataColumns.DATA6;

            /**
             * The phonetic version of the given name for the contact.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String PHONETIC_GIVEN_NAME = android.provider.ContactsContract.DataColumns.DATA7;

            /**
             * The phonetic version of the additional name for the contact.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String PHONETIC_MIDDLE_NAME = android.provider.ContactsContract.DataColumns.DATA8;

            /**
             * The phonetic version of the family name for the contact.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String PHONETIC_FAMILY_NAME = android.provider.ContactsContract.DataColumns.DATA9;

            /**
             * The style used for combining given/middle/family name into a full name.
             * See {@link ContactsContract.FullNameStyle}.
             */
            public static final java.lang.String FULL_NAME_STYLE = android.provider.ContactsContract.DataColumns.DATA10;

            /**
             * The alphabet used for capturing the phonetic name.
             * See ContactsContract.PhoneticNameStyle.
             */
            public static final java.lang.String PHONETIC_NAME_STYLE = android.provider.ContactsContract.DataColumns.DATA11;
        }
         ...
         * </table>
         */
        public static final class Nickname implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Nickname() {
             ...
             * The name itself
             */
            public static final java.lang.String NAME = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;
        }
         ...
         * </table>
         */
        public static final class Phone implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Phone() {
             ...
             */
            public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Data.CONTENT_URI, "phones");
             ...
             * @unknown 
             */
            public static final android.net.Uri ENTERPRISE_CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Data.ENTERPRISE_CONTENT_URI, "phones");
             ...
             * as an additional path segment after this URI.
             */
            public static final android.net.Uri CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Phone.CONTENT_URI, "filter");
             ...
             */
            public static final android.net.Uri ENTERPRISE_CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Phone.CONTENT_URI, "filter_enterprise");
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String NUMBER = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String NORMALIZED_NUMBER = android.provider.ContactsContract.DataColumns.DATA4;
            ...
            public static final java.lang.CharSequence getDisplayLabel(android.content.Context context, int type, java.lang.CharSequence label, java.lang.CharSequence[] labelArray) {
                return android.provider.ContactsContract.CommonDataKinds.Phone.getTypeLabel(context.getResources(), type, label);
            }
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if (((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) || (type == android.provider.ContactsContract.CommonDataKinds.Phone.TYPE_ASSISTANT)) && (!android.text.TextUtils.isEmpty(label))) {
                    return label;
                } else {
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Phone.getTypeLabelResource(type);
         ...
         * </table>
         */
        public static final class Email implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Email() {
             ...
             * </p>
             */
            public static final android.net.Uri CONTENT_LOOKUP_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Email.CONTENT_URI, "lookup");
             ...
             * </pre>
             */
            public static final android.net.Uri ENTERPRISE_CONTENT_LOOKUP_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Email.CONTENT_URI, "lookup_enterprise");
             ...
             * </p>
             */
            public static final android.net.Uri CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Email.CONTENT_URI, "filter");
             ...
             * parameters, otherwise it will throw IllegalArgumentException.
             */
            public static final android.net.Uri ENTERPRISE_CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Email.CONTENT_URI, "filter_enterprise");

            /**
             * The email address.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String ADDRESS = android.provider.ContactsContract.DataColumns.DATA1;
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String DISPLAY_NAME = android.provider.ContactsContract.DataColumns.DATA4;
             ...
             */
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    return label;
                } else {
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Email.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class StructuredPostal implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
             ...
             * Type: TEXT
             */
            public static final java.lang.String FORMATTED_ADDRESS = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;
             ...
             * Type: TEXT
             */
            public static final java.lang.String STREET = android.provider.ContactsContract.DataColumns.DATA4;
             ...
             * Type: TEXT
             */
            public static final java.lang.String POBOX = android.provider.ContactsContract.DataColumns.DATA5;
             ...
             * Type: TEXT
             */
            public static final java.lang.String NEIGHBORHOOD = android.provider.ContactsContract.DataColumns.DATA6;
             ...
             * Type: TEXT
             */
            public static final java.lang.String CITY = android.provider.ContactsContract.DataColumns.DATA7;
             ...
             * Type: TEXT
             */
            public static final java.lang.String REGION = android.provider.ContactsContract.DataColumns.DATA8;
             ...
             * Type: TEXT
             */
            public static final java.lang.String POSTCODE = android.provider.ContactsContract.DataColumns.DATA9;
             ...
             * Type: TEXT
             */
            public static final java.lang.String COUNTRY = android.provider.ContactsContract.DataColumns.DATA10;
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.StructuredPostal.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class Im implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Im() {
             ...
             */
            public static final java.lang.String PROTOCOL = android.provider.ContactsContract.DataColumns.DATA5;

            public static final java.lang.String CUSTOM_PROTOCOL = android.provider.ContactsContract.DataColumns.DATA6;
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case android.provider.ContactsContract.CommonDataKinds.Im.TYPE_HOME :
                        return com.android.internal.R.string.imTypeHome;
                    case android.provider.ContactsContract.CommonDataKinds.Im.TYPE_WORK :
                        return com.android.internal.R.string.imTypeWork;
                    case android.provider.ContactsContract.CommonDataKinds.Im.TYPE_OTHER :
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Im.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
            ...
            public static final int getProtocolLabelResource(int type) {
                switch (type) {
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_AIM :
                        return com.android.internal.R.string.imProtocolAim;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_MSN :
                        return com.android.internal.R.string.imProtocolMsn;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_YAHOO :
                        return com.android.internal.R.string.imProtocolYahoo;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_SKYPE :
                        return com.android.internal.R.string.imProtocolSkype;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_QQ :
                        return com.android.internal.R.string.imProtocolQq;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_GOOGLE_TALK :
                        return com.android.internal.R.string.imProtocolGoogleTalk;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_ICQ :
                        return com.android.internal.R.string.imProtocolIcq;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_JABBER :
                        return com.android.internal.R.string.imProtocolJabber;
                    case android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_NETMEETING :
            ...
            public static final java.lang.CharSequence getProtocolLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.Im.PROTOCOL_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    return label;
                } else {
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Im.getProtocolLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class Organization implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String COMPANY = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;

            /**
             * The position title at this company as the user entered it.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String TITLE = android.provider.ContactsContract.DataColumns.DATA4;

            /**
             * The department at this company as the user entered it.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String DEPARTMENT = android.provider.ContactsContract.DataColumns.DATA5;

            /**
             * The job description at this company as the user entered it.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String JOB_DESCRIPTION = android.provider.ContactsContract.DataColumns.DATA6;

            /**
             * The symbol of this company as the user entered it.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String SYMBOL = android.provider.ContactsContract.DataColumns.DATA7;

            /**
             * The phonetic name of this company as the user entered it.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String PHONETIC_NAME = android.provider.ContactsContract.DataColumns.DATA8;

            /**
             * The office location of this organization.
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String OFFICE_LOCATION = android.provider.ContactsContract.DataColumns.DATA9;

            /**
             * The alphabet used for capturing the phonetic name.
             * See {@link ContactsContract.PhoneticNameStyle}.
             */
            public static final java.lang.String PHONETIC_NAME_STYLE = android.provider.ContactsContract.DataColumns.DATA10;
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Organization.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class Relation implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Relation() {
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_ASSISTANT :
                        return com.android.internal.R.string.relationTypeAssistant;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_BROTHER :
                        return com.android.internal.R.string.relationTypeBrother;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_CHILD :
                        return com.android.internal.R.string.relationTypeChild;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_DOMESTIC_PARTNER :
                        return com.android.internal.R.string.relationTypeDomesticPartner;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_FATHER :
                        return com.android.internal.R.string.relationTypeFather;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_FRIEND :
                        return com.android.internal.R.string.relationTypeFriend;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_MANAGER :
                        return com.android.internal.R.string.relationTypeManager;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_MOTHER :
                        return com.android.internal.R.string.relationTypeMother;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_PARENT :
                        return com.android.internal.R.string.relationTypeParent;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_PARTNER :
                        return com.android.internal.R.string.relationTypePartner;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_REFERRED_BY :
                        return com.android.internal.R.string.relationTypeReferredBy;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_RELATIVE :
                        return com.android.internal.R.string.relationTypeRelative;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_SISTER :
                        return com.android.internal.R.string.relationTypeSister;
                    case android.provider.ContactsContract.CommonDataKinds.Relation.TYPE_SPOUSE :
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Relation.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class Event implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Event() {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String START_DATE = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;
            ...
            public static int getTypeResource(java.lang.Integer type) {
                ...
                switch (type) {
                    case android.provider.ContactsContract.CommonDataKinds.Event.TYPE_ANNIVERSARY :
                        return com.android.internal.R.string.eventTypeAnniversary;
                    case android.provider.ContactsContract.CommonDataKinds.Event.TYPE_BIRTHDAY :
                        return com.android.internal.R.string.eventTypeBirthday;
                    case android.provider.ContactsContract.CommonDataKinds.Event.TYPE_OTHER :
                        return com.android.internal.R.string.eventTypeOther;
                    default :
                        return com.android.internal.R.string.eventTypeCustom;
                }
            }
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.Event.getTypeResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </table>
         */
        public static final class Photo implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Photo() {
         ...
         * </table>
         */
        public static final class Note implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Note() {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String NOTE = android.provider.ContactsContract.DataColumns.DATA1;
        }
         ...
         * </table>
         */
        public static final class GroupMembership implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
             ...
             * <P>Type: INTEGER</P>
             */
            public static final java.lang.String GROUP_ROW_ID = android.provider.ContactsContract.DataColumns.DATA1;
         ...
         * </table>
         */
        public static final class Website implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Website() {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String URL = android.provider.ContactsContract.CommonDataKinds.CommonColumns.DATA;
        }
         ...
         * </table>
         */
        public static final class SipAddress implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private SipAddress() {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String SIP_ADDRESS = android.provider.ContactsContract.DataColumns.DATA1;
            ...
            public static final int getTypeLabelResource(int type) {
                switch (type) {
                    case android.provider.ContactsContract.CommonDataKinds.SipAddress.TYPE_HOME :
                        return com.android.internal.R.string.sipAddressTypeHome;
                    case android.provider.ContactsContract.CommonDataKinds.SipAddress.TYPE_WORK :
                        return com.android.internal.R.string.sipAddressTypeWork;
                    case android.provider.ContactsContract.CommonDataKinds.SipAddress.TYPE_OTHER :
            ...
            public static final java.lang.CharSequence getTypeLabel(android.content.res.Resources res, int type, java.lang.CharSequence label) {
                if ((type == android.provider.ContactsContract.CommonDataKinds.BaseTypes.TYPE_CUSTOM) && (!android.text.TextUtils.isEmpty(label))) {
                    ...
                    final int labelRes = android.provider.ContactsContract.CommonDataKinds.SipAddress.getTypeLabelResource(type);
                    return res.getText(labelRes);
                }
            }
        }
         ...
         * </p>
         */
        public static final class Identity implements android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             * This utility class cannot be instantiated
             */
            private Identity() {
             ...
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String IDENTITY = android.provider.ContactsContract.DataColumns.DATA1;

            /**
             * The namespace of the identity string, e.g. "com.google"
             * <P>Type: TEXT</P>
             */
            public static final java.lang.String NAMESPACE = android.provider.ContactsContract.DataColumns.DATA2;
        }
         ...
         * </p>
         */
        public static final class Callable implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             ...
             * data.
             */
            public static final android.net.Uri CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Callable.CONTENT_URI, "filter");
             ...
             * parameters, otherwise it will throw IllegalArgumentException.
             */
            public static final android.net.Uri ENTERPRISE_CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Callable.CONTENT_URI, "filter_enterprise");
        }
         ...
         */
        public static final class Contactables implements android.provider.ContactsContract.CommonDataKinds.CommonColumns , android.provider.ContactsContract.ContactCounts , android.provider.ContactsContract.DataColumnsWithJoins {
            /**
             ...
             */
            public static final android.net.Uri CONTENT_FILTER_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.CommonDataKinds.Contactables.CONTENT_URI, "filter");
    ...
    public static final class Groups implements android.provider.BaseColumns , android.provider.ContactsContract.GroupsColumns , android.provider.ContactsContract.SyncColumns {
        ...
        private static class EntityIteratorImpl extends android.content.CursorEntityIterator {
            ...
            public android.content.Entity getEntityAndIncrementCursor(android.database.Cursor cursor) throws android.os.RemoteException {
                ...
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, values, android.provider.BaseColumns._ID);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.SyncColumns.ACCOUNT_NAME);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.SyncColumns.ACCOUNT_TYPE);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.SyncColumns.DIRTY);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.SyncColumns.VERSION);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.SyncColumns.SOURCE_ID);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.RES_PACKAGE);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.TITLE);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.TITLE_RES);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.GROUP_VISIBLE);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.BaseSyncColumns.SYNC1);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.BaseSyncColumns.SYNC2);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.BaseSyncColumns.SYNC3);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.BaseSyncColumns.SYNC4);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.SYSTEM_ID);
                android.database.DatabaseUtils.cursorLongToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.DELETED);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.NOTES);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.SHOULD_SYNC);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.FAVORITES);
                android.database.DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, values, android.provider.ContactsContract.GroupsColumns.AUTO_ADD);
                cursor.moveToNext();
                return new android.content.Entity(values);
            }
        }
    }
    ...
    public static final class PinnedPositions {
        ...
        public static void undemote(android.content.ContentResolver contentResolver, long contactId) {
            contentResolver.call(android.provider.ContactsContract.AUTHORITY_URI, android.provider.ContactsContract.PinnedPositions.UNDEMOTE_METHOD, java.lang.String.valueOf(contactId), null);
        }
        ...
        public static void pin(android.content.ContentResolver contentResolver, long contactId, int pinnedPosition) {
            final android.net.Uri uri = android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_URI, java.lang.String.valueOf(contactId));
            final android.content.ContentValues values = new android.content.ContentValues();
            values.put(android.provider.ContactsContract.Contacts.PINNED, pinnedPosition);
    ...
    public static final class QuickContact {
         ...
         * @unknown 
         */
        public static final int MODE_DEFAULT = android.provider.ContactsContract.QuickContact.MODE_LARGE;
         ...
         * @unknown 
         */
        public static android.content.Intent composeQuickContactsIntent(android.content.Context context, android.view.View target, android.net.Uri lookupUri, int mode, java.lang.String[] excludeMimes) {
            ...
            return android.provider.ContactsContract.QuickContact.composeQuickContactsIntent(context, rect, lookupUri, mode, excludeMimes);
        }
         ...
         * @unknown 
         */
        public static android.content.Intent composeQuickContactsIntent(android.content.Context context, android.graphics.Rect target, android.net.Uri lookupUri, int mode, java.lang.String[] excludeMimes) {
            ...
            android.content.Context actualContext = context;
            while ((actualContext instanceof android.content.ContextWrapper) && (!(actualContext instanceof android.app.Activity))) {
                actualContext = ((android.content.ContextWrapper) (actualContext)).getBaseContext();
            } 
            final int intentFlags = (actualContext instanceof android.app.Activity ? 0 : android.content.Intent.FLAG_ACTIVITY_NEW_TASK | android.content.Intent.FLAG_ACTIVITY_CLEAR_TASK) | // Workaround for b/16898764. Declaring singleTop in manifest doesn't work.
            android.content.Intent.FLAG_ACTIVITY_SINGLE_TOP;
            // Launch pivot dialog through intent for now
            final android.content.Intent intent = new android.content.Intent(android.provider.ContactsContract.QuickContact.ACTION_QUICK_CONTACT).addFlags(intentFlags);
            // NOTE: This logic and rebuildManagedQuickContactsIntent() must be in sync.
            intent.setData(lookupUri);
            intent.setSourceBounds(target);
            intent.putExtra(android.provider.ContactsContract.QuickContact.EXTRA_MODE, mode);
            intent.putExtra(android.provider.ContactsContract.QuickContact.EXTRA_EXCLUDE_MIMES, excludeMimes);
            return intent;
        }
         ...
         * @unknown 
         */
        public static android.content.Intent rebuildManagedQuickContactsIntent(java.lang.String lookupKey, long contactId, boolean isContactIdIgnored, long directoryId, android.content.Intent originalIntent) {
            final android.content.Intent intent = new android.content.Intent(android.provider.ContactsContract.QuickContact.ACTION_QUICK_CONTACT);
            // Rebuild the URI from a lookup key and a contact ID.
            android.net.Uri uri = null;
            if (!android.text.TextUtils.isEmpty(lookupKey)) {
                uri = (isContactIdIgnored) ? android.net.Uri.withAppendedPath(android.provider.ContactsContract.Contacts.CONTENT_LOOKUP_URI, lookupKey) : android.provider.ContactsContract.Contacts.getLookupUri(contactId, lookupKey);
            }
            if ((uri != null) && (directoryId != android.provider.ContactsContract.Directory.DEFAULT)) {
                uri = uri.buildUpon().appendQueryParameter(android.provider.ContactsContract.DIRECTORY_PARAM_KEY, java.lang.String.valueOf(directoryId)).build();
            }
            intent.setData(uri);
            // Copy flags and always set NEW_TASK because it won't have a parent activity.
            intent.setFlags(originalIntent.getFlags() | android.content.Intent.FLAG_ACTIVITY_NEW_TASK);
            // Copy extras.
            intent.setSourceBounds(originalIntent.getSourceBounds());
            intent.putExtra(android.provider.ContactsContract.QuickContact.EXTRA_MODE, originalIntent.getIntExtra(android.provider.ContactsContract.QuickContact.EXTRA_MODE, android.provider.ContactsContract.QuickContact.MODE_DEFAULT));
            intent.putExtra(android.provider.ContactsContract.QuickContact.EXTRA_EXCLUDE_MIMES, originalIntent.getStringArrayExtra(android.provider.ContactsContract.QuickContact.EXTRA_EXCLUDE_MIMES));
            return intent;
        }
         ...
         *
         * @param context
         * 		The parent {@link Context} that may be used as the
         * 		parent for this dialog.
         * @param target
         * 		Specific {@link View} from your layout that this dialog
         ...
         * @param lookupUri
         * 		A {@link ContactsContract.Contacts#CONTENT_LOOKUP_URI} style
         ...
         * 		{@link PhoneLookup#ENTERPRISE_CONTENT_FILTER_URI}.
         * @param mode
         * 		Any of {@link #MODE_SMALL}, {@link #MODE_MEDIUM}, or
         * 		{@link #MODE_LARGE}, indicating the desired dialog size,
         * 		when supported.
         * @param excludeMimes
         * 		Optional list of {@link Data#MIMETYPE} MIME-types
        ...
        public static void showQuickContact(android.content.Context context, android.view.View target, android.net.Uri lookupUri, int mode, java.lang.String[] excludeMimes) {
            ...
            android.content.Intent intent = android.provider.ContactsContract.QuickContact.composeQuickContactsIntent(context, target, lookupUri, mode, excludeMimes);
            android.provider.ContactsInternal.startQuickContactWithErrorToast(context, intent);
        }
         ...
         * 		parent for this dialog.
         * @param target
         * 		Specific {@link Rect} that this dialog should be
         ...
         */
        public static void showQuickContact(android.content.Context context, android.view.View target, android.net.Uri lookupUri, java.lang.String[] excludeMimes, java.lang.String prioritizedMimeType) {
            ...
            // of QuickContacts.
            android.content.Intent intent = android.provider.ContactsContract.QuickContact.composeQuickContactsIntent(context, target, lookupUri, android.provider.ContactsContract.QuickContact.MODE_DEFAULT, excludeMimes);
            intent.putExtra(android.provider.ContactsContract.QuickContact.EXTRA_PRIORITIZED_MIMETYPE, prioritizedMimeType);
            android.provider.ContactsInternal.startQuickContactWithErrorToast(context, intent);
        }
         ...
         * 		displayed more prominently in QuickContacts.
         */
        public static void showQuickContact(android.content.Context context, android.graphics.Rect target, android.net.Uri lookupUri, java.lang.String[] excludeMimes, java.lang.String prioritizedMimeType) {
            // Use MODE_LARGE instead of accepting mode as a parameter. The different mode
            // values defined in ContactsContract only affect very old implementations
            // of QuickContacts.
            android.content.Intent intent = android.provider.ContactsContract.QuickContact.composeQuickContactsIntent(context, target, lookupUri, android.provider.ContactsContract.QuickContact.MODE_DEFAULT, excludeMimes);
    ...
    public static final class Intents {
         ...
         * voice. Note: this activity must also support the {@link android.content.Intent#CATEGORY_DEFAULT} so it can be found by {@link android.service.voice.VoiceInteractionSession#startVoiceActivity}.
         * <p>
         ...
         * labels in the Data table. The Voice Assistant needs to know this MIME type and {@link RawContacts#ACCOUNT_TYPE} that you are using in order to provide the smooth contact
         * disambiguation user experience. The following convention should be met when performing
         * such integration:
         * <ul>
         * <li>This activity should have a string meta-data field associated with it, {@link #METADATA_ACCOUNT_TYPE}, which defines {@link RawContacts#ACCOUNT_TYPE} for your Contacts
         ...
         * <li>This activity should have a string meta-data field associated with it, {@link #METADATA_MIMETYPE}, which defines {@link DataColumns#MIMETYPE} for your Contacts
         ...
         * <li>Optionally, when filling Data table row for METADATA_MIMETYPE, column {@link DataColumns#DATA3} could store a human readable label for the ID. For example it could be
         ...
         * CharSequence. Otherwise, the message content will be supplied through {@link android.content.Intent#setClipData(ClipData)} as a content provider URI(s). In the latter
         ...
         * n-th elements of {@link #EXTRA_RECIPIENT_CONTACT_URI}, {@link #EXTRA_RECIPIENT_CONTACT_CHAT_ID} and {@link #EXTRA_RECIPIENT_CONTACT_NAME} (as a
         ...
         * located in the Contacts Provider), used with {@link #ACTION_VOICE_SEND_MESSAGE_TO_CONTACTS} to supply the recipient(s). The value of this
        ...
        /**
         * This extra specifies a messaging app’s unique ID(s) for the contact(s), used with {@link #ACTION_VOICE_SEND_MESSAGE_TO_CONTACTS} to supply the recipient(s). The value of this
         * extra is a {@code String[]}. The number of elements in the array should be equal to
         * number of recipients (and consistent with {@link #EXTRA_RECIPIENT_CONTACT_URI} and {@link #EXTRA_RECIPIENT_CONTACT_NAME}). When the value of the element for the particular
         * recipient is absent, it will be set to null.
         * <p>
         ...
         * extra is a {@code String[]}. The number of elements in the array should be equal to
         * number of recipients (and consistent with {@link #EXTRA_RECIPIENT_CONTACT_URI} and {@link #EXTRA_RECIPIENT_CONTACT_CHAT_ID}). When the value of the element for the particular
         * recipient is absent, it will be set to null.
         * <p>
        ...
        public static final class Insert {
             ...
             */
            public static final java.lang.String ACTION = android.content.Intent.ACTION_INSERT;
    ...
    public static final class MetadataSync implements android.provider.BaseColumns , android.provider.ContactsContract.MetadataSyncColumns {
         ...
         */
        public static final android.net.Uri METADATA_AUTHORITY_URI = android.net.Uri.parse("content://" + android.provider.ContactsContract.MetadataSync.METADATA_AUTHORITY);
         ...
         * The content:// style URI for this table.
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.ContactsContract.MetadataSync.METADATA_AUTHORITY_URI, "metadata_sync");
