...
public class BlockedNumberContract {
     ...
     */
    public static final android.net.Uri AUTHORITY_URI = android.net.Uri.parse("content://" + android.provider.BlockedNumberContract.AUTHORITY);
    ...
    public static class BlockedNumbers {
         ...
         * </ul>
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.BlockedNumberContract.AUTHORITY_URI, "blocked");
    ...
    public static boolean isBlocked(android.content.Context context, java.lang.String phoneNumber) {
        final android.os.Bundle res = context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.METHOD_IS_BLOCKED, phoneNumber, null);
        return (res != null) && res.getBoolean(android.provider.BlockedNumberContract.RES_NUMBER_IS_BLOCKED, false);
    }
     ...
     */
    @android.annotation.WorkerThread
    public static int unblock(android.content.Context context, java.lang.String phoneNumber) {
        final android.os.Bundle res = context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.METHOD_UNBLOCK, phoneNumber, null);
        return res.getInt(android.provider.BlockedNumberContract.RES_NUM_ROWS_DELETED, 0);
    }
    ...
    public static boolean canCurrentUserBlockNumbers(android.content.Context context) {
        final android.os.Bundle res = context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.METHOD_CAN_CURRENT_USER_BLOCK_NUMBERS, null, null);
        return (res != null) && res.getBoolean(android.provider.BlockedNumberContract.RES_CAN_BLOCK_NUMBERS, false);
    }
    ...
    public static class SystemContract {
        ...
        public static void notifyEmergencyContact(android.content.Context context) {
            context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.SystemContract.METHOD_NOTIFY_EMERGENCY_CONTACT, null, null);
        }
        ...
        public static void endBlockSuppression(android.content.Context context) {
            context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.SystemContract.METHOD_END_BLOCK_SUPPRESSION, null, null);
        }
         ...
         * {@link #isBlocked(Context, String)}.
         */
        public static boolean shouldSystemBlockNumber(android.content.Context context, java.lang.String phoneNumber) {
            final android.os.Bundle res = context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.SystemContract.METHOD_SHOULD_SYSTEM_BLOCK_NUMBER, phoneNumber, null);
            return (res != null) && res.getBoolean(android.provider.BlockedNumberContract.RES_NUMBER_IS_BLOCKED, false);
        }
        ...
        public static android.provider.BlockedNumberContract.SystemContract.BlockSuppressionStatus getBlockSuppressionStatus(android.content.Context context) {
            final android.os.Bundle res = context.getContentResolver().call(android.provider.BlockedNumberContract.AUTHORITY_URI, android.provider.BlockedNumberContract.SystemContract.METHOD_GET_BLOCK_SUPPRESSION_STATUS, null, null);
            return new android.provider.BlockedNumberContract.SystemContract.BlockSuppressionStatus(res.getBoolean(android.provider.BlockedNumberContract.SystemContract.RES_IS_BLOCKING_SUPPRESSED, false), res.getLong(android.provider.BlockedNumberContract.SystemContract.RES_BLOCKING_SUPPRESSED_UNTIL_TIMESTAMP, 0));
        }
