...
public class SearchIndexableResource extends android.provider.SearchIndexableData {
     ...
     * @param xmlResId
     * 		the resource ID of a {@link android.preference.PreferenceScreen} XML file.
     * @param className
     ...
     */
    public SearchIndexableResource(int rank, int xmlResId, java.lang.String className, int iconResId) {
        super();
        this.rank = rank;
