...
public final class MediaStore {
    ...
    private static final java.lang.String CONTENT_AUTHORITY_SLASH = ("content://" + android.provider.MediaStore.AUTHORITY) + "/";
     ...
     * applications or internet. The activity should use {@link android.view.WindowManager.LayoutParams#FLAG_SHOW_WHEN_LOCKED} to display
     ...
     * is not granted, then attempting to use this action will result in a {@link java.lang.SecurityException}.
     *
     * @see #EXTRA_OUTPUT
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.ACTIVITY_INTENT_ACTION)
     ...
     * or video with other applications or internet. The activity should use {@link android.view.WindowManager.LayoutParams#FLAG_SHOW_WHEN_LOCKED} to display on top of the
     ...
     * <p>Note: if you app targets {@link android.os.Build.VERSION_CODES#M M} and above
     * and declares as using the {@link android.Manifest.permission#CAMERA} permission which
     * is not granted, then atempting to use this action will result in a {@link java.lang.SecurityException}.
     *
     * @see #EXTRA_OUTPUT
    ...
    public static final class Files {
        ...
        public static android.net.Uri getContentUri(java.lang.String volumeName) {
            return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/file");
        }
         ...
         * @return the URI to the files table on the given volume
         */
        public static final android.net.Uri getContentUri(java.lang.String volumeName, long rowId) {
            return android.net.Uri.parse(((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/file/") + rowId);
        }
        ...
        public static android.net.Uri getMtpObjectsUri(java.lang.String volumeName) {
            return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/object");
        }
         ...
         * @unknown 
         */
        public static final android.net.Uri getMtpObjectsUri(java.lang.String volumeName, long fileId) {
            return android.net.Uri.parse(((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/object/") + fileId);
        }
         ...
         * @unknown 
         */
        public static final android.net.Uri getMtpReferencesUri(java.lang.String volumeName, long fileId) {
            return android.net.Uri.parse((((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/object/") + fileId) + "/references");
        }
    ...
    private static class InternalThumbnails implements android.provider.BaseColumns {
        ...
        private static final java.lang.String[] PROJECTION = new java.lang.String[]{ android.provider.BaseColumns._ID, android.provider.MediaStore.MediaColumns.DATA };

        static final int DEFAULT_GROUP_ID = 0;

        private static final java.lang.Object sThumbBufLock = new java.lang.Object();

        private static byte[] sThumbBuf;

        private static android.graphics.Bitmap getMiniThumbFromFile(android.database.Cursor c, android.net.Uri baseUri, android.content.ContentResolver cr, android.graphics.BitmapFactory.Options options) {
            android.graphics.Bitmap bitmap = null;
            android.net.Uri thumbUri = null;
            try {
                long thumbId = c.getLong(0);
                java.lang.String filePath = c.getString(1);
                thumbUri = android.content.ContentUris.withAppendedId(baseUri, thumbId);
                android.os.ParcelFileDescriptor pfdInput = cr.openFileDescriptor(thumbUri, "r");
                bitmap = android.graphics.BitmapFactory.decodeFileDescriptor(pfdInput.getFileDescriptor(), null, options);
                pfdInput.close();
            } catch (java.io.FileNotFoundException ex) {
                android.util.Log.e(android.provider.MediaStore.TAG, (("couldn't open thumbnail " + thumbUri) + "; ") + ex);
            } catch (java.io.IOException ex) {
                android.util.Log.e(android.provider.MediaStore.TAG, (("couldn't open thumbnail " + thumbUri) + "; ") + ex);
            } catch (java.lang.OutOfMemoryError ex) {
                android.util.Log.e(android.provider.MediaStore.TAG, (("failed to allocate memory for thumbnail " + thumbUri) + "; ") + ex);
            }
            return bitmap;
        }
         ...
         * 		ContentResolver
         * @param origId
         * 		original image or video id. use -1 to cancel all requests.
         * @param groupId
         * 		the same groupId used in getThumbnail
         * @param baseUri
         * 		the base URI of requested thumbnails
         */
        static void cancelThumbnailRequest(android.content.ContentResolver cr, long origId, android.net.Uri baseUri, long groupId) {
            android.net.Uri cancelUri = baseUri.buildUpon().appendQueryParameter("cancel", "1").appendQueryParameter("orig_id", java.lang.String.valueOf(origId)).appendQueryParameter("group_id", java.lang.String.valueOf(groupId)).build();
            android.database.Cursor c = null;
            try {
                c = cr.query(cancelUri, android.provider.MediaStore.InternalThumbnails.PROJECTION, null, null, null);
            } finally {
                if (c != null)
                    c.close();
         ...
         */
        static android.graphics.Bitmap getThumbnail(android.content.ContentResolver cr, long origId, long groupId, int kind, android.graphics.BitmapFactory.Options options, android.net.Uri baseUri, boolean isVideo) {
            android.graphics.Bitmap bitmap = null;
            // Log.v(TAG, "getThumbnail: origId="+origId+", kind="+kind+", isVideo="+isVideo);
            // If the magic is non-zero, we simply return thumbnail if it does exist.
            // querying MediaProvider and simply return thumbnail.
            android.media.MiniThumbFile thumbFile = new android.media.MiniThumbFile(isVideo ? android.provider.MediaStore.Video.Media.EXTERNAL_CONTENT_URI : android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
            android.database.Cursor c = null;
            try {
                long magic = thumbFile.getMagic(origId);
                if (magic != 0) {
                    if (kind == android.provider.MediaStore.InternalThumbnails.MICRO_KIND) {
                        synchronized(android.provider.MediaStore.InternalThumbnails.sThumbBufLock) {
                            if (android.provider.MediaStore.InternalThumbnails.sThumbBuf == null) {
                                android.provider.MediaStore.InternalThumbnails.sThumbBuf = new byte[android.media.MiniThumbFile.BYTES_PER_MINTHUMB];
                            }
                            if (thumbFile.getMiniThumbFromFile(origId, android.provider.MediaStore.InternalThumbnails.sThumbBuf) != null) {
                                bitmap = android.graphics.BitmapFactory.decodeByteArray(android.provider.MediaStore.InternalThumbnails.sThumbBuf, 0, android.provider.MediaStore.InternalThumbnails.sThumbBuf.length);
                                if (bitmap == null) {
                                    android.util.Log.w(android.provider.MediaStore.TAG, "couldn't decode byte array.");
                                }
                            }
                        }
                        return bitmap;
                    } else
                        if (kind == android.provider.MediaStore.InternalThumbnails.MINI_KIND) {
                            java.lang.String column = (isVideo) ? "video_id=" : "image_id=";
                            c = cr.query(baseUri, android.provider.MediaStore.InternalThumbnails.PROJECTION, column + origId, null, null);
                            if ((c != null) && c.moveToFirst()) {
                                bitmap = android.provider.MediaStore.InternalThumbnails.getMiniThumbFromFile(c, baseUri, cr, options);
                                if (bitmap != null) {
                                    return bitmap;
                                }
                            }
                ...
                android.net.Uri blockingUri = baseUri.buildUpon().appendQueryParameter("blocking", "1").appendQueryParameter("orig_id", java.lang.String.valueOf(origId)).appendQueryParameter("group_id", java.lang.String.valueOf(groupId)).build();
                if (c != null)
                    c.close();

                c = cr.query(blockingUri, android.provider.MediaStore.InternalThumbnails.PROJECTION, null, null, null);
                ...
                if (kind == android.provider.MediaStore.InternalThumbnails.MICRO_KIND) {
                    synchronized(android.provider.MediaStore.InternalThumbnails.sThumbBufLock) {
                        ...
                        java.util.Arrays.fill(android.provider.MediaStore.InternalThumbnails.sThumbBuf, ((byte) (0)));
                        if (thumbFile.getMiniThumbFromFile(origId, android.provider.MediaStore.InternalThumbnails.sThumbBuf) != null) {
                            bitmap = android.graphics.BitmapFactory.decodeByteArray(android.provider.MediaStore.InternalThumbnails.sThumbBuf, 0, android.provider.MediaStore.InternalThumbnails.sThumbBuf.length);
                            if (bitmap == null) {
                                android.util.Log.w(android.provider.MediaStore.TAG, "couldn't decode byte array.");
                    ...
                    if (kind == android.provider.MediaStore.InternalThumbnails.MINI_KIND) {
                        ...
                        throw new java.lang.IllegalArgumentException("Unsupported kind: " + kind);
                    }

                // We probably run out of space, so create the thumbnail in memory.
                if (bitmap == null) {
                    android.util.Log.v(android.provider.MediaStore.TAG, (((("Create the thumbnail in memory: origId=" + origId) + ", kind=") + kind) + ", isVideo=") + isVideo);
                    android.net.Uri uri = android.net.Uri.parse(baseUri.buildUpon().appendPath(java.lang.String.valueOf(origId)).toString().replaceFirst("thumbnails", "media"));
                    if (c != null)
                        c.close();

                    c = cr.query(uri, android.provider.MediaStore.InternalThumbnails.PROJECTION, null, null, null);
                    if ((c == null) || (!c.moveToFirst())) {
                        return null;
                    }
                    java.lang.String filePath = c.getString(1);
                    if (filePath != null) {
                        if (isVideo) {
                            bitmap = android.media.ThumbnailUtils.createVideoThumbnail(filePath, kind);
                        } else {
                            bitmap = android.media.ThumbnailUtils.createImageThumbnail(filePath, kind);
                        }
                    }
                }
            } catch (android.database.sqlite.SQLiteException ex) {
                android.util.Log.w(android.provider.MediaStore.TAG, ex);
            } finally {
                if (c != null)
                    c.close();
    ...
    public static final class Images {
        ...
        public static final class Media implements android.provider.MediaStore.Images.ImageColumns {
            public static final android.database.Cursor query(android.content.ContentResolver cr, android.net.Uri uri, java.lang.String[] projection) {
                return cr.query(uri, projection, null, null, android.provider.MediaStore.Images.Media.DEFAULT_SORT_ORDER);
            }

            public static final android.database.Cursor query(android.content.ContentResolver cr, android.net.Uri uri, java.lang.String[] projection, java.lang.String where, java.lang.String orderBy) {
                return cr.query(uri, projection, where, null, orderBy == null ? android.provider.MediaStore.Images.Media.DEFAULT_SORT_ORDER : orderBy);
            }

            public static final android.database.Cursor query(android.content.ContentResolver cr, android.net.Uri uri, java.lang.String[] projection, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String orderBy) {
                return cr.query(uri, projection, selection, selectionArgs, orderBy == null ? android.provider.MediaStore.Images.Media.DEFAULT_SORT_ORDER : orderBy);
            }
             ...
             * 		
             */
            public static final android.graphics.Bitmap getBitmap(android.content.ContentResolver cr, android.net.Uri url) throws java.io.FileNotFoundException, java.io.IOException {
                java.io.InputStream input = cr.openInputStream(url);
             ...
             * 		
             */
            public static final java.lang.String insertImage(android.content.ContentResolver cr, java.lang.String imagePath, java.lang.String name, java.lang.String description) throws java.io.FileNotFoundException {
                ...
                try {
                    ...
                    java.lang.String ret = android.provider.MediaStore.Images.Media.insertImage(cr, bm, name, description);
                    bm.recycle();
                    return ret;
                } finally {
                    try {
            ...
            private static final android.graphics.Bitmap StoreThumbnail(android.content.ContentResolver cr, android.graphics.Bitmap source, long id, float width, float height, int kind) {
                // create the matrix to scale it
                android.graphics.Matrix matrix = new android.graphics.Matrix();
                float scaleX = width / source.getWidth();
                float scaleY = height / source.getHeight();
                matrix.setScale(scaleX, scaleY);
                android.graphics.Bitmap thumb = android.graphics.Bitmap.createBitmap(source, 0, 0, source.getWidth(), source.getHeight(), matrix, true);
                android.content.ContentValues values = new android.content.ContentValues(4);
                values.put(android.provider.MediaStore.Images.Thumbnails.KIND, kind);
                values.put(android.provider.MediaStore.Images.Thumbnails.IMAGE_ID, ((int) (id)));
                values.put(android.provider.MediaStore.Images.Thumbnails.HEIGHT, thumb.getHeight());
                values.put(android.provider.MediaStore.Images.Thumbnails.WIDTH, thumb.getWidth());
                android.net.Uri url = cr.insert(android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, values);
                try {
                    java.io.OutputStream thumbOut = cr.openOutputStream(url);
            ...
            for any reason.
             */
            public static final java.lang.String insertImage(android.content.ContentResolver cr, android.graphics.Bitmap source, java.lang.String title, java.lang.String description) {
                android.content.ContentValues values = new android.content.ContentValues();
                values.put(android.provider.MediaStore.Images.Media.TITLE, title);
                values.put(android.provider.MediaStore.Images.Media.DESCRIPTION, description);
                values.put(android.provider.MediaStore.Images.Media.MIME_TYPE, "image/jpeg");
                android.net.Uri url = null;
                java.lang.String stringUrl = null;/* value to be returned */

                try {
                    url = cr.insert(android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
                    if (source != null) {
                        java.io.OutputStream imageOut = cr.openOutputStream(url);
                        try {
                            source.compress(android.graphics.Bitmap.CompressFormat.JPEG, 50, imageOut);
                        } finally {
                            imageOut.close();
                        }
                        long id = android.content.ContentUris.parseId(url);
                        // Wait until MINI_KIND thumbnail is generated.
                        android.graphics.Bitmap miniThumb = android.provider.MediaStore.Images.Thumbnails.getThumbnail(cr, id, android.provider.MediaStore.Images.Thumbnails.MINI_KIND, null);
                        // This is for backward compatibility.
                        android.graphics.Bitmap microThumb = android.provider.MediaStore.Images.Media.StoreThumbnail(cr, miniThumb, id, 50.0F, 50.0F, android.provider.MediaStore.Images.Thumbnails.MICRO_KIND);
                    } else {
                        android.util.Log.e(android.provider.MediaStore.TAG, "Failed to create thumbnail, removing original");
                        cr.delete(url, null, null);
                        url = null;
                    }
                } catch (java.lang.Exception e) {
                    android.util.Log.e(android.provider.MediaStore.TAG, "Failed to insert image", e);
                    if (url != null) {
                        cr.delete(url, null, null);
                        url = null;
                    }
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/images/media");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Images.Media.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Images.Media.getContentUri("external");
             ...
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Images.ImageColumns.BUCKET_DISPLAY_NAME;
        }
        ...
        public static class Thumbnails implements android.provider.BaseColumns {
            public static final android.database.Cursor query(android.content.ContentResolver cr, android.net.Uri uri, java.lang.String[] projection) {
                return cr.query(uri, projection, null, null, android.provider.MediaStore.Images.Thumbnails.DEFAULT_SORT_ORDER);
            }

            public static final android.database.Cursor queryMiniThumbnails(android.content.ContentResolver cr, android.net.Uri uri, int kind, java.lang.String[] projection) {
                return cr.query(uri, projection, "kind = " + kind, null, android.provider.MediaStore.Images.Thumbnails.DEFAULT_SORT_ORDER);
            }

            public static final android.database.Cursor queryMiniThumbnail(android.content.ContentResolver cr, long origId, int kind, java.lang.String[] projection) {
                return cr.query(android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, projection, (((((android.provider.MediaStore.Images.Thumbnails.IMAGE_ID + " = ") + origId) + " AND ") + android.provider.MediaStore.Images.Thumbnails.KIND) + " = ") + kind, null, null);
            }
            ...
            public static void cancelThumbnailRequest(android.content.ContentResolver cr, long origId) {
                android.provider.MediaStore.InternalThumbnails.cancelThumbnailRequest(cr, origId, android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, android.provider.MediaStore.InternalThumbnails.DEFAULT_GROUP_ID);
            }
            ...
            public static android.graphics.Bitmap getThumbnail(android.content.ContentResolver cr, long origId, int kind, android.graphics.BitmapFactory.Options options) {
                return android.provider.MediaStore.InternalThumbnails.getThumbnail(cr, origId, android.provider.MediaStore.InternalThumbnails.DEFAULT_GROUP_ID, kind, options, android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, false);
            }
            ...
            public static void cancelThumbnailRequest(android.content.ContentResolver cr, long origId, long groupId) {
                android.provider.MediaStore.InternalThumbnails.cancelThumbnailRequest(cr, origId, android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, groupId);
            }
            ...
            public static android.graphics.Bitmap getThumbnail(android.content.ContentResolver cr, long origId, long groupId, int kind, android.graphics.BitmapFactory.Options options) {
                return android.provider.MediaStore.InternalThumbnails.getThumbnail(cr, origId, groupId, kind, options, android.provider.MediaStore.Images.Thumbnails.EXTERNAL_CONTENT_URI, false);
            }
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/images/thumbnails");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Images.Thumbnails.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Images.Thumbnails.getContentUri("external");
    ...
    public static final class Audio {
        ...
        public static java.lang.String keyFor(java.lang.String name) {
            if (name != null) {
                ...
                if (name.equals(android.provider.MediaStore.UNKNOWN_STRING)) {
                    return "\u0001";
                }
                ...
                if (name.length() > 0) {
                    ...
                    name = b.toString();
                    java.lang.String key = android.database.DatabaseUtils.getCollationKey(name);
                    if (sortfirst) {
                        key = "\u0001" + key;
                    }
                    return key;
        ...
        public static final class Media implements android.provider.MediaStore.Audio.AudioColumns {
            private static final java.lang.String[] EXTERNAL_PATHS;

            static {
                java.lang.String secondary_storage = java.lang.System.getenv("SECONDARY_STORAGE");
                if (secondary_storage != null) {
                    EXTERNAL_PATHS = secondary_storage.split(":");
                } else {
                    EXTERNAL_PATHS = new java.lang.String[0];
                }
            }
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/media");
            }

            public static android.net.Uri getContentUriForPath(java.lang.String path) {
                for (java.lang.String ep : android.provider.MediaStore.Audio.Media.EXTERNAL_PATHS) {
                    if (path.startsWith(ep)) {
                        return android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI;
                    }
                }
                return path.startsWith(android.os.Environment.getExternalStorageDirectory().getPath()) ? android.provider.MediaStore.Audio.Media.EXTERNAL_CONTENT_URI : android.provider.MediaStore.Audio.Media.INTERNAL_CONTENT_URI;
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Media.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Media.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.AudioColumns.TITLE_KEY;
        ...
        public static final class Genres implements android.provider.BaseColumns , android.provider.MediaStore.Audio.GenresColumns {
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/genres");
            }
             ...
             */
            public static android.net.Uri getContentUriForAudioId(java.lang.String volumeName, int audioId) {
                return android.net.Uri.parse((((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/media/") + audioId) + "/genres");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Genres.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Genres.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.GenresColumns.NAME;

            /**
             * Sub-directory of each genre containing all members.
             */
            public static final class Members implements android.provider.MediaStore.Audio.AudioColumns {
                public static final android.net.Uri getContentUri(java.lang.String volumeName, long genreId) {
                    return android.net.Uri.parse((((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/genres/") + genreId) + "/members");
                }
        ...
        public static final class Playlists implements android.provider.BaseColumns , android.provider.MediaStore.Audio.PlaylistsColumns {
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/playlists");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Playlists.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Playlists.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.PlaylistsColumns.NAME;

            /**
             * Sub-directory of each playlist containing all members.
             */
            public static final class Members implements android.provider.MediaStore.Audio.AudioColumns {
                public static final android.net.Uri getContentUri(java.lang.String volumeName, long playlistId) {
                    return android.net.Uri.parse((((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/playlists/") + playlistId) + "/members");
                }
                ...
                public static final boolean moveItem(android.content.ContentResolver res, long playlistId, int from, int to) {
                    android.net.Uri uri = android.provider.MediaStore.Audio.Playlists.Members.getContentUri("external", playlistId).buildUpon().appendEncodedPath(java.lang.String.valueOf(from)).appendQueryParameter("move", "true").build();
                    android.content.ContentValues values = new android.content.ContentValues();
                    values.put(android.provider.MediaStore.Audio.Playlists.Members.PLAY_ORDER, to);
                 ...
                 * The default sort order for this table
                 */
                public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.Playlists.Members.PLAY_ORDER;
            }
        }
        ...
        public static final class Artists implements android.provider.BaseColumns , android.provider.MediaStore.Audio.ArtistColumns {
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/artists");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Artists.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Artists.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.ArtistColumns.ARTIST_KEY;
            ...
            public static final class Albums implements android.provider.MediaStore.Audio.AlbumColumns {
                public static final android.net.Uri getContentUri(java.lang.String volumeName, long artistId) {
                    return android.net.Uri.parse((((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/artists/") + artistId) + "/albums");
                }
            }
        }
        ...
        public static final class Albums implements android.provider.BaseColumns , android.provider.MediaStore.Audio.AlbumColumns {
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/audio/albums");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Albums.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Audio.Albums.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.Audio.AlbumColumns.ALBUM_KEY;
        }
    ...
    public static final class Video {
         ...
         * The default sort order for this table.
         */
        public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.MediaColumns.DISPLAY_NAME;

        public static final android.database.Cursor query(android.content.ContentResolver cr, android.net.Uri uri, java.lang.String[] projection) {
            return cr.query(uri, projection, null, null, android.provider.MediaStore.Video.DEFAULT_SORT_ORDER);
        }
        ...
        public static final class Media implements android.provider.MediaStore.Video.VideoColumns {
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/video/media");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Video.Media.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Video.Media.getContentUri("external");
             ...
             * The default sort order for this table
             */
            public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.MediaStore.MediaColumns.TITLE;
        }
        ...
        public static class Thumbnails implements android.provider.BaseColumns {
             ...
             */
            public static void cancelThumbnailRequest(android.content.ContentResolver cr, long origId) {
                android.provider.MediaStore.InternalThumbnails.cancelThumbnailRequest(cr, origId, android.provider.MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, android.provider.MediaStore.InternalThumbnails.DEFAULT_GROUP_ID);
            }
             ...
             */
            public static android.graphics.Bitmap getThumbnail(android.content.ContentResolver cr, long origId, int kind, android.graphics.BitmapFactory.Options options) {
                return android.provider.MediaStore.InternalThumbnails.getThumbnail(cr, origId, android.provider.MediaStore.InternalThumbnails.DEFAULT_GROUP_ID, kind, options, android.provider.MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, true);
            }
             ...
             */
            public static android.graphics.Bitmap getThumbnail(android.content.ContentResolver cr, long origId, long groupId, int kind, android.graphics.BitmapFactory.Options options) {
                return android.provider.MediaStore.InternalThumbnails.getThumbnail(cr, origId, groupId, kind, options, android.provider.MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, true);
            }
             ...
             */
            public static void cancelThumbnailRequest(android.content.ContentResolver cr, long origId, long groupId) {
                android.provider.MediaStore.InternalThumbnails.cancelThumbnailRequest(cr, origId, android.provider.MediaStore.Video.Thumbnails.EXTERNAL_CONTENT_URI, groupId);
            }
             ...
             */
            public static android.net.Uri getContentUri(java.lang.String volumeName) {
                return android.net.Uri.parse((android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + volumeName) + "/video/thumbnails");
            }

            /**
             * The content:// style URI for the internal storage.
             */
            public static final android.net.Uri INTERNAL_CONTENT_URI = android.provider.MediaStore.Video.Thumbnails.getContentUri("internal");

            /**
             * The content:// style URI for the "primary" external storage
             * volume.
             */
            public static final android.net.Uri EXTERNAL_CONTENT_URI = android.provider.MediaStore.Video.Thumbnails.getContentUri("external");
    ...
    public static android.net.Uri getMediaScannerUri() {
        return android.net.Uri.parse(android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + "none/media_scanner");
    }
    ...
    public static java.lang.String getVersion(android.content.Context context) {
        android.database.Cursor c = context.getContentResolver().query(android.net.Uri.parse(android.provider.MediaStore.CONTENT_AUTHORITY_SLASH + "none/version"), null, null, null, null);
        if (c != null) {
            try {
                if (c.moveToFirst()) {
