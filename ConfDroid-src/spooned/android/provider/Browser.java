...
public class Browser {
     ...
     *
     *
     * @unknown if you change column order you must also change indices below
     */
    public static final java.lang.String[] HISTORY_PROJECTION = new java.lang.String[]{ android.provider.Browser.BookmarkColumns._ID// 0
    , android.provider.Browser.BookmarkColumns.URL// 1
    , android.provider.Browser.BookmarkColumns.VISITS// 2
    , android.provider.Browser.BookmarkColumns.DATE// 3
    , android.provider.Browser.BookmarkColumns.BOOKMARK// 4
    , android.provider.Browser.BookmarkColumns.TITLE// 5
    , android.provider.Browser.BookmarkColumns.FAVICON// 6
    , android.provider.Browser.BookmarkColumns.THUMBNAIL// 7
    , android.provider.Browser.BookmarkColumns.TOUCH_ICON// 8
    , android.provider.Browser.BookmarkColumns.USER_ENTERED// 9
     };

    /**
     *
     *
     * @unknown these indices dependent on HISTORY_PROJECTION
     */
     ...
     *
     *
     * @unknown columns needed to determine whether to truncate history @removed
     */
    public static final java.lang.String[] TRUNCATE_HISTORY_PROJECTION = new java.lang.String[]{ android.provider.Browser.BookmarkColumns._ID, android.provider.Browser.BookmarkColumns.DATE };
     ...
     *
     *
     * @unknown truncate this many history items at a time
     */
     ...
     * @unknown 
     */
    public static final java.lang.String[] SEARCHES_PROJECTION = new java.lang.String[]{ // if you change column order you must also change indices below
    android.provider.Browser.SearchColumns._ID// 0
    , android.provider.Browser.SearchColumns.SEARCH// 1
    , android.provider.Browser.SearchColumns.DATE// 2
     };

    /**
     *
     *
     * @unknown these indices dependent on SEARCHES_PROJECTION
     */
    ...
    public static final void sendString(android.content.Context context, java.lang.String string) {
        android.provider.Browser.sendString(context, string, context.getString(com.android.internal.R.string.sendText));
    }
     ...
     */
    public static final void sendString(android.content.Context c, java.lang.String stringToSend, java.lang.String chooserDialogTitle) {
        android.content.Intent send = new android.content.Intent(android.content.Intent.ACTION_SEND);
        send.setType("text/plain");
        send.putExtra(android.content.Intent.EXTRA_TEXT, stringToSend);
        try {
            android.content.Intent i = android.content.Intent.createChooser(send, chooserDialogTitle);
    ...
    public static final android.database.Cursor getAllBookmarks(android.content.ContentResolver cr) throws java.lang.IllegalStateException {
        return new android.database.MatrixCursor(new java.lang.String[]{ android.provider.BrowserContract.Bookmarks.URL }, 0);
    }
    ...
    public static final android.database.Cursor getAllVisitedUrls(android.content.ContentResolver cr) throws java.lang.IllegalStateException {
        return new android.database.MatrixCursor(new java.lang.String[]{ android.provider.BrowserContract.Combined.URL }, 0);
    }

    private static final void addOrUrlEquals(java.lang.StringBuilder sb) {
        sb.append((" OR " + android.provider.Browser.BookmarkColumns.URL) + " = ");
    }

    private static final android.database.Cursor getVisitedLike(android.content.ContentResolver cr, java.lang.String url) {
        boolean secure = false;
        java.lang.String compareString = url;
        ...
        java.lang.StringBuilder whereClause = null;
        if (secure) {
            whereClause = new java.lang.StringBuilder(android.provider.BrowserContract.Bookmarks.URL + " = ");
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, "https://" + compareString);
            android.provider.Browser.addOrUrlEquals(whereClause);
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, "https://www." + compareString);
        } else {
            whereClause = new java.lang.StringBuilder(android.provider.BrowserContract.Bookmarks.URL + " = ");
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, compareString);
            android.provider.Browser.addOrUrlEquals(whereClause);
            java.lang.String wwwString = "www." + compareString;
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, wwwString);
            android.provider.Browser.addOrUrlEquals(whereClause);
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, "http://" + compareString);
            android.provider.Browser.addOrUrlEquals(whereClause);
            android.database.DatabaseUtils.appendEscapedSQLString(whereClause, "http://" + wwwString);
        }
        return cr.query(android.provider.BrowserContract.History.CONTENT_URI, new java.lang.String[]{ android.provider.BrowserContract.History._ID, android.provider.BrowserContract.History.VISITS }, whereClause.toString(), null, null);
    }
