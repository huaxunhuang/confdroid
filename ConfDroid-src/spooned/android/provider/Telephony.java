 ...
 * <li>In a broadcast receiver, include an intent filter for {@link Sms.Intents#WAP_PUSH_DELIVER_ACTION}} ({@code "android.provider.Telephony.WAP_PUSH_DELIVER"})
 ...
 * Provider, but may also be notified when a new SMS arrives by listening for the {@link Sms.Intents#SMS_RECEIVED_ACTION}
...
public final class Telephony {
    ...
    public static final class Sms implements android.provider.BaseColumns , android.provider.Telephony.TextBasedSmsColumns {
        ...
        public static java.lang.String getDefaultSmsPackage(android.content.Context context) {
            android.content.ComponentName component = com.android.internal.telephony.SmsApplication.getDefaultSmsApplication(context, false);
            if (component != null) {
         ...
         * @unknown 
         */
        public static android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection) {
            return cr.query(android.provider.Telephony.Sms.CONTENT_URI, projection, null, null, android.provider.Telephony.Sms.DEFAULT_SORT_ORDER);
        }
         ...
         * @unknown 
         */
        public static android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection, java.lang.String where, java.lang.String orderBy) {
            return cr.query(android.provider.Telephony.Sms.CONTENT_URI, projection, where, null, orderBy == null ? android.provider.Telephony.Sms.DEFAULT_SORT_ORDER : orderBy);
        }
         ...
         * 		the body of the message
         * @param subject
         * 		the pseudo-subject of the message
         * @param date
         ...
         * @unknown 
         */
        public static android.net.Uri addMessageToUri(android.content.ContentResolver resolver, android.net.Uri uri, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read, boolean deliveryReport) {
            return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, uri, address, body, subject, date, read, deliveryReport, -1L);
        }
         ...
         * @unknown 
         */
        public static android.net.Uri addMessageToUri(int subId, android.content.ContentResolver resolver, android.net.Uri uri, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read, boolean deliveryReport) {
            return android.provider.Telephony.Sms.addMessageToUri(subId, resolver, uri, address, body, subject, date, read, deliveryReport, -1L);
        }
         ...
         * @unknown 
         */
        public static android.net.Uri addMessageToUri(android.content.ContentResolver resolver, android.net.Uri uri, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read, boolean deliveryReport, long threadId) {
            return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, uri, address, body, subject, date, read, deliveryReport, threadId);
        }
         ...
         * @unknown 
         */
        public static android.net.Uri addMessageToUri(int subId, android.content.ContentResolver resolver, android.net.Uri uri, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read, boolean deliveryReport, long threadId) {
            android.content.ContentValues values = new android.content.ContentValues(8);
            android.telephony.Rlog.v(android.provider.Telephony.TAG, "Telephony addMessageToUri sub id: " + subId);
            values.put(android.provider.Telephony.TextBasedSmsColumns.SUBSCRIPTION_ID, subId);
            values.put(android.provider.Telephony.TextBasedSmsColumns.ADDRESS, address);
            if (date != null) {
                values.put(android.provider.Telephony.TextBasedSmsColumns.DATE, date);
            }
            values.put(android.provider.Telephony.TextBasedSmsColumns.READ, read ? java.lang.Integer.valueOf(1) : java.lang.Integer.valueOf(0));
            values.put(android.provider.Telephony.TextBasedSmsColumns.SUBJECT, subject);
            values.put(android.provider.Telephony.TextBasedSmsColumns.BODY, body);
            if (deliveryReport) {
                values.put(android.provider.Telephony.TextBasedSmsColumns.STATUS, android.provider.Telephony.TextBasedSmsColumns.STATUS_PENDING);
            }
            if (threadId != (-1L)) {
                values.put(android.provider.Telephony.TextBasedSmsColumns.THREAD_ID, threadId);
            }
         ...
         * @unknown 
         */
        public static boolean moveMessageToFolder(android.content.Context context, android.net.Uri uri, int folder, int error) {
            if (uri == null) {
                return false;
            }
            ...
            switch (folder) {
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_INBOX :
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_DRAFT :
                    break;
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_OUTBOX :
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_SENT :
                    markAsRead = true;
                    break;
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_FAILED :
                case android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_QUEUED :
                    markAsUnread = true;
                    break;
                default :
                    return false;
            ...
            values.put(android.provider.Telephony.TextBasedSmsColumns.TYPE, folder);
            if (markAsUnread) {
                values.put(android.provider.Telephony.TextBasedSmsColumns.READ, 0);
            } else
                if (markAsRead) {
                    values.put(android.provider.Telephony.TextBasedSmsColumns.READ, 1);
                }

            values.put(android.provider.Telephony.TextBasedSmsColumns.ERROR_CODE, error);
            return 1 == android.database.sqlite.SqliteWrapper.update(context, context.getContentResolver(), uri, values, null, null);
        }
        ...
        public static boolean isOutgoingFolder(int messageType) {
            return (((messageType == android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_FAILED) || (messageType == android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_OUTBOX)) || (messageType == android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_SENT)) || (messageType == android.provider.Telephony.TextBasedSmsColumns.MESSAGE_TYPE_QUEUED);
        }
        ...
        public static final class Inbox implements android.provider.BaseColumns , android.provider.Telephony.TextBasedSmsColumns {
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read) {
                return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, android.provider.Telephony.Sms.Inbox.CONTENT_URI, address, body, subject, date, read, false);
            }
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(int subId, android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean read) {
                return android.provider.Telephony.Sms.addMessageToUri(subId, resolver, android.provider.Telephony.Sms.Inbox.CONTENT_URI, address, body, subject, date, read, false);
            }
        }
        ...
        public static final class Sent implements android.provider.BaseColumns , android.provider.Telephony.TextBasedSmsColumns {
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date) {
                return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, android.provider.Telephony.Sms.Sent.CONTENT_URI, address, body, subject, date, true, false);
            }
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(int subId, android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date) {
                return android.provider.Telephony.Sms.addMessageToUri(subId, resolver, android.provider.Telephony.Sms.Sent.CONTENT_URI, address, body, subject, date, true, false);
            }
        }
        ...
        public static final class Draft implements android.provider.BaseColumns , android.provider.Telephony.TextBasedSmsColumns {
             ...
             */
            public static android.net.Uri addMessage(android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date) {
                return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, android.provider.Telephony.Sms.Draft.CONTENT_URI, address, body, subject, date, true, false);
            }
             ...
             */
            public static android.net.Uri addMessage(int subId, android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date) {
                return android.provider.Telephony.Sms.addMessageToUri(subId, resolver, android.provider.Telephony.Sms.Draft.CONTENT_URI, address, body, subject, date, true, false);
            }
        ...
        public static final class Outbox implements android.provider.BaseColumns , android.provider.Telephony.TextBasedSmsColumns {
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean deliveryReport, long threadId) {
                return android.provider.Telephony.Sms.addMessageToUri(android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId(), resolver, android.provider.Telephony.Sms.Outbox.CONTENT_URI, address, body, subject, date, true, deliveryReport, threadId);
            }
             ...
             * @unknown 
             */
            public static android.net.Uri addMessage(int subId, android.content.ContentResolver resolver, java.lang.String address, java.lang.String body, java.lang.String subject, java.lang.Long date, boolean deliveryReport, long threadId) {
                return android.provider.Telephony.Sms.addMessageToUri(subId, resolver, android.provider.Telephony.Sms.Outbox.CONTENT_URI, address, body, subject, date, true, deliveryReport, threadId);
            }
        }
        ...
        public static final class Intents {
             ...
             * the <a href="{@docRoot }guide/topics/manifest/receiver-element.html">{@code <receiver>}</a> tag.
             *
            ...
            public static android.telephony.SmsMessage[] getMessagesFromIntent(android.content.Intent intent) {
                ...
                try {
                    messages = ((java.lang.Object[]) (intent.getSerializableExtra("pdus")));
                ...
                java.lang.String format = intent.getStringExtra("format");
                int subId = intent.getIntExtra(PhoneConstants.SUBSCRIPTION_KEY, android.telephony.SubscriptionManager.getDefaultSmsSubscriptionId());
                android.telephony.Rlog.v(android.provider.Telephony.TAG, " getMessagesFromIntent sub_id : " + subId);
                int pduCount = messages.length;
                android.telephony.SmsMessage[] msgs = new android.telephony.SmsMessage[pduCount];
                for (int i = 0; i < pduCount; i++) {
                    byte[] pdu = ((byte[]) (messages[i]));
                    msgs[i] = android.telephony.SmsMessage.createFromPdu(pdu, format);
                    if (msgs[i] != null)
    ...
    public static final class Threads implements android.provider.Telephony.ThreadsColumns {
        private static final java.lang.String[] ID_PROJECTION = new java.lang.String[]{ android.provider.BaseColumns._ID };
         ...
         */
        public static final android.net.Uri OBSOLETE_THREADS_URI = android.net.Uri.withAppendedPath(android.provider.Telephony.Threads.CONTENT_URI, "obsolete");
         ...
         */
        public static long getOrCreateThreadId(android.content.Context context, java.lang.String recipient) {
            java.util.Set<java.lang.String> recipients = new java.util.HashSet<java.lang.String>();
            recipients.add(recipient);
            return android.provider.Telephony.Threads.getOrCreateThreadId(context, recipients);
        }
         ...
         */
        public static long getOrCreateThreadId(android.content.Context context, java.util.Set<java.lang.String> recipients) {
            android.net.Uri.Builder uriBuilder = android.provider.Telephony.Threads.THREAD_ID_CONTENT_URI.buildUpon();
            for (java.lang.String recipient : recipients) {
                if (android.provider.Telephony.Mms.isEmailAddress(recipient)) {
            ...
            android.database.Cursor cursor = android.database.sqlite.SqliteWrapper.query(context, context.getContentResolver(), uri, android.provider.Telephony.Threads.ID_PROJECTION, null, null, null);
            if (cursor != null) {
                try {
            ...
            android.telephony.Rlog.e(android.provider.Telephony.TAG, ("getOrCreateThreadId failed with " + recipients.size()) + " recipients");
    ...
    public static final class Mms implements android.provider.Telephony.BaseMmsColumns {
         ...
         */
        public static final android.net.Uri REPORT_REQUEST_URI = android.net.Uri.withAppendedPath(android.provider.Telephony.Mms.CONTENT_URI, "report-request");

        /**
         * Content URI for getting MMS report status.
         */
        public static final android.net.Uri REPORT_STATUS_URI = android.net.Uri.withAppendedPath(android.provider.Telephony.Mms.CONTENT_URI, "report-status");
         ...
         */
        public static android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection) {
            return cr.query(android.provider.Telephony.Mms.CONTENT_URI, projection, null, null, android.provider.Telephony.Mms.DEFAULT_SORT_ORDER);
        }
         ...
         */
        public static android.database.Cursor query(android.content.ContentResolver cr, java.lang.String[] projection, java.lang.String where, java.lang.String orderBy) {
            return cr.query(android.provider.Telephony.Mms.CONTENT_URI, projection, where, null, orderBy == null ? android.provider.Telephony.Mms.DEFAULT_SORT_ORDER : orderBy);
        }
         ...
         * @unknown 
         */
        public static java.lang.String extractAddrSpec(java.lang.String address) {
            java.util.regex.Matcher match = android.provider.Telephony.Mms.NAME_ADDR_EMAIL_PATTERN.matcher(address);
            if (match.matches()) {
         ...
         *
         * @param address
         * 		the input address to test
         * @return true if address is an email address; false otherwise.
         * @unknown 
         */
        public static boolean isEmailAddress(java.lang.String address) {
            if (android.text.TextUtils.isEmpty(address)) {
                return false;
            }
            java.lang.String s = android.provider.Telephony.Mms.extractAddrSpec(address);
            java.util.regex.Matcher match = android.util.Patterns.EMAIL_ADDRESS.matcher(s);
         ...
         * @unknown 
         */
        public static boolean isPhoneNumber(java.lang.String number) {
            if (android.text.TextUtils.isEmpty(number)) {
                return false;
            }
            java.util.regex.Matcher match = android.util.Patterns.PHONE.matcher(number);
            return match.matches();
        }
        ...
        public static final class Rate {
             ...
             * The {@code content://} style URL for this table.
             */
            public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.Telephony.Mms.CONTENT_URI, "rate");
    ...
    public static final class MmsSms implements android.provider.BaseColumns {
        ...
        public static final class PendingMessages implements android.provider.BaseColumns {
            ...
            public static final android.net.Uri CONTENT_URI = android.net.Uri.withAppendedPath(android.provider.Telephony.MmsSms.CONTENT_URI, "pending");
    ...
    public static final class Carriers implements android.provider.BaseColumns {
         ...
         * @unknown 
         */
        public static final java.lang.String MODEM_COGNITIVE = "modem_cognitive";
         ...
         * @unknown 
         */
        public static final java.lang.String MAX_CONNS = "max_conns";
         ...
         * @unknown 
         */
        public static final java.lang.String WAIT_TIME = "wait_time";
         ...
         * @unknown 
         */
        public static final java.lang.String MAX_CONNS_TIME = "max_conns_time";
         ...
         * @unknown 
         */
        public static final java.lang.String EDITED = "edited";
    ...
    public static final class CellBroadcasts implements android.provider.BaseColumns {
         ...
         * The default sort order for this table.
         */
        public static final java.lang.String DEFAULT_SORT_ORDER = android.provider.Telephony.CellBroadcasts.DELIVERY_TIME + " DESC";

        /**
         * Query columns for instantiating {@link android.telephony.CellBroadcastMessage} objects.
         */
        public static final java.lang.String[] QUERY_COLUMNS = new java.lang.String[]{ android.provider.BaseColumns._ID, android.provider.Telephony.CellBroadcasts.GEOGRAPHICAL_SCOPE, android.provider.Telephony.CellBroadcasts.PLMN, android.provider.Telephony.CellBroadcasts.LAC, android.provider.Telephony.CellBroadcasts.CID, android.provider.Telephony.CellBroadcasts.SERIAL_NUMBER, android.provider.Telephony.CellBroadcasts.SERVICE_CATEGORY, android.provider.Telephony.CellBroadcasts.LANGUAGE_CODE, android.provider.Telephony.CellBroadcasts.MESSAGE_BODY, android.provider.Telephony.CellBroadcasts.DELIVERY_TIME, android.provider.Telephony.CellBroadcasts.MESSAGE_READ, android.provider.Telephony.CellBroadcasts.MESSAGE_FORMAT, android.provider.Telephony.CellBroadcasts.MESSAGE_PRIORITY, android.provider.Telephony.CellBroadcasts.ETWS_WARNING_TYPE, android.provider.Telephony.CellBroadcasts.CMAS_MESSAGE_CLASS, android.provider.Telephony.CellBroadcasts.CMAS_CATEGORY, android.provider.Telephony.CellBroadcasts.CMAS_RESPONSE_TYPE, android.provider.Telephony.CellBroadcasts.CMAS_SEVERITY, android.provider.Telephony.CellBroadcasts.CMAS_URGENCY, android.provider.Telephony.CellBroadcasts.CMAS_CERTAINTY };
    }
}
