...
public final class DocumentsContract {
     ...
     * {@hide }
     */
    public static final java.lang.String EXTRA_SHOW_ADVANCED = "android.content.extra.SHOW_ADVANCED";

    /**
     * {@hide }
     */
    public static final java.lang.String EXTRA_SHOW_FILESIZE = "android.content.extra.SHOW_FILESIZE";

    /**
     * {@hide }
     */
    public static final java.lang.String EXTRA_FANCY_FEATURES = "android.content.extra.FANCY";
     ...
     * {@hide }
     */
    public static final java.lang.String ACTION_BROWSE = "android.provider.action.BROWSE";
     ...
     */
    private static final int THUMBNAIL_BUFFER_SIZE = ((int) (128 * android.net.TrafficStats.KB_IN_BYTES));
    ...
    public static final class Document {
         ...
         * Type: STRING
         */
        public static final java.lang.String COLUMN_DISPLAY_NAME = android.provider.OpenableColumns.DISPLAY_NAME;
         ...
         * Type: INTEGER (long)
         */
        public static final java.lang.String COLUMN_SIZE = android.provider.OpenableColumns.SIZE;
    ...
    public static android.net.Uri buildRootsUri(java.lang.String authority) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_ROOT).build();
    }
     ...
     * @see #getRootId(Uri)
     */
    public static android.net.Uri buildRootUri(java.lang.String authority, java.lang.String rootId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_ROOT).appendPath(rootId).build();
    }
    ...
    public static android.net.Uri buildHomeUri() {
        ...
        return android.provider.DocumentsContract.buildRootUri("com.android.externalstorage.documents", "home");
    }
     ...
     * @see #getRootId(Uri)
     */
    public static android.net.Uri buildRecentDocumentsUri(java.lang.String authority, java.lang.String rootId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_ROOT).appendPath(rootId).appendPath(android.provider.DocumentsContract.PATH_RECENT).build();
    }
     ...
     */
    public static android.net.Uri buildTreeDocumentUri(java.lang.String authority, java.lang.String documentId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_TREE).appendPath(documentId).build();
    }
     ...
     */
    public static android.net.Uri buildDocumentUri(java.lang.String authority, java.lang.String documentId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_DOCUMENT).appendPath(documentId).build();
    }
     ...
     */
    public static android.net.Uri buildDocumentUriUsingTree(android.net.Uri treeUri, java.lang.String documentId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(treeUri.getAuthority()).appendPath(android.provider.DocumentsContract.PATH_TREE).appendPath(android.provider.DocumentsContract.getTreeDocumentId(treeUri)).appendPath(android.provider.DocumentsContract.PATH_DOCUMENT).appendPath(documentId).build();
    }

    /**
     * {@hide }
     */
    public static android.net.Uri buildDocumentUriMaybeUsingTree(android.net.Uri baseUri, java.lang.String documentId) {
        if (android.provider.DocumentsContract.isTreeUri(baseUri)) {
            return android.provider.DocumentsContract.buildDocumentUriUsingTree(baseUri, documentId);
        } else {
            return android.provider.DocumentsContract.buildDocumentUri(baseUri.getAuthority(), documentId);
        }
    }
     ...
     * @see #getDocumentId(Uri)
     */
    public static android.net.Uri buildChildDocumentsUri(java.lang.String authority, java.lang.String parentDocumentId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_DOCUMENT).appendPath(parentDocumentId).appendPath(android.provider.DocumentsContract.PATH_CHILDREN).build();
    }
     ...
     */
    public static android.net.Uri buildChildDocumentsUriUsingTree(android.net.Uri treeUri, java.lang.String parentDocumentId) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(treeUri.getAuthority()).appendPath(android.provider.DocumentsContract.PATH_TREE).appendPath(android.provider.DocumentsContract.getTreeDocumentId(treeUri)).appendPath(android.provider.DocumentsContract.PATH_DOCUMENT).appendPath(parentDocumentId).appendPath(android.provider.DocumentsContract.PATH_CHILDREN).build();
    }
     ...
     */
    public static android.net.Uri buildSearchDocumentsUri(java.lang.String authority, java.lang.String rootId, java.lang.String query) {
        return new android.net.Uri.Builder().scheme(android.content.ContentResolver.SCHEME_CONTENT).authority(authority).appendPath(android.provider.DocumentsContract.PATH_ROOT).appendPath(rootId).appendPath(android.provider.DocumentsContract.PATH_SEARCH).appendQueryParameter(android.provider.DocumentsContract.PARAM_QUERY, query).build();
    }
     ...
     */
    public static boolean isDocumentUri(android.content.Context context, @android.annotation.Nullable
    android.net.Uri uri) {
        if (android.provider.DocumentsContract.isContentUri(uri) && android.provider.DocumentsContract.isDocumentsProvider(context, uri.getAuthority())) {
            final java.util.List<java.lang.String> paths = uri.getPathSegments();
            if (paths.size() == 2) {
                return android.provider.DocumentsContract.PATH_DOCUMENT.equals(paths.get(0));
            } else
                if (paths.size() == 4) {
                    return android.provider.DocumentsContract.PATH_TREE.equals(paths.get(0)) && android.provider.DocumentsContract.PATH_DOCUMENT.equals(paths.get(2));
                }
     ...
     * {@hide }
     */
    public static boolean isRootUri(android.content.Context context, @android.annotation.Nullable
    android.net.Uri uri) {
        if (android.provider.DocumentsContract.isContentUri(uri) && android.provider.DocumentsContract.isDocumentsProvider(context, uri.getAuthority())) {
            final java.util.List<java.lang.String> paths = uri.getPathSegments();
            return (paths.size() == 2) && android.provider.DocumentsContract.PATH_ROOT.equals(paths.get(0));
        }
        return false;
    }
     ...
     * {@hide }
     */
    public static boolean isContentUri(@android.annotation.Nullable
    android.net.Uri uri) {
        return (uri != null) && android.content.ContentResolver.SCHEME_CONTENT.equals(uri.getScheme());
    }
    ...
    public static boolean isTreeUri(android.net.Uri uri) {
        final java.util.List<java.lang.String> paths = uri.getPathSegments();
        return (paths.size() >= 2) && android.provider.DocumentsContract.PATH_TREE.equals(paths.get(0));
    }

    private static boolean isDocumentsProvider(android.content.Context context, java.lang.String authority) {
        final android.content.Intent intent = new android.content.Intent(android.provider.DocumentsContract.PROVIDER_INTERFACE);
        final java.util.List<android.content.pm.ResolveInfo> infos = context.getPackageManager().queryIntentContentProviders(intent, 0);
    ...
    public static java.lang.String getRootId(android.net.Uri rootUri) {
        final java.util.List<java.lang.String> paths = rootUri.getPathSegments();
        if ((paths.size() >= 2) && android.provider.DocumentsContract.PATH_ROOT.equals(paths.get(0))) {
            return paths.get(1);
        }
        throw new java.lang.IllegalArgumentException("Invalid URI: " + rootUri);
    }
    ...
    public static java.lang.String getDocumentId(android.net.Uri documentUri) {
        final java.util.List<java.lang.String> paths = documentUri.getPathSegments();
        if ((paths.size() >= 2) && android.provider.DocumentsContract.PATH_DOCUMENT.equals(paths.get(0))) {
            return paths.get(1);
        }
        if (((paths.size() >= 4) && android.provider.DocumentsContract.PATH_TREE.equals(paths.get(0))) && android.provider.DocumentsContract.PATH_DOCUMENT.equals(paths.get(2))) {
            return paths.get(3);
        }
        throw new java.lang.IllegalArgumentException("Invalid URI: " + documentUri);
    }

    /**
     * Extract the via {@link Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
    public static java.lang.String getTreeDocumentId(android.net.Uri documentUri) {
        final java.util.List<java.lang.String> paths = documentUri.getPathSegments();
        if ((paths.size() >= 2) && android.provider.DocumentsContract.PATH_TREE.equals(paths.get(0))) {
            return paths.get(1);
        }
        throw new java.lang.IllegalArgumentException("Invalid URI: " + documentUri);
    }
    ...
    public static java.lang.String getSearchDocumentsQuery(android.net.Uri searchDocumentsUri) {
        return searchDocumentsUri.getQueryParameter(android.provider.DocumentsContract.PARAM_QUERY);
    }
    ...
    public static android.net.Uri setManageMode(android.net.Uri uri) {
        return uri.buildUpon().appendQueryParameter(android.provider.DocumentsContract.PARAM_MANAGE, "true").build();
    }
    ...
    public static boolean isManageMode(android.net.Uri uri) {
        return uri.getBooleanQueryParameter(android.provider.DocumentsContract.PARAM_MANAGE, false);
    }
    ...
    public static android.graphics.Bitmap getDocumentThumbnail(android.content.ContentResolver resolver, android.net.Uri documentUri, android.graphics.Point size, android.os.CancellationSignal signal) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(documentUri.getAuthority());
        try {
            return android.provider.DocumentsContract.getDocumentThumbnail(client, documentUri, size, signal);
        } catch (java.lang.Exception e) {
            if (!(e instanceof android.os.OperationCanceledException)) {
                android.util.Log.w(android.provider.DocumentsContract.TAG, (("Failed to load thumbnail for " + documentUri) + ": ") + e);
            }
            return null;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
    }
     ...
     * {@hide }
     */
    public static android.graphics.Bitmap getDocumentThumbnail(android.content.ContentProviderClient client, android.net.Uri documentUri, android.graphics.Point size, android.os.CancellationSignal signal) throws android.os.RemoteException, java.io.IOException {
        final android.os.Bundle openOpts = new android.os.Bundle();
        openOpts.putParcelable(android.content.ContentResolver.EXTRA_SIZE, size);
        android.content.res.AssetFileDescriptor afd = null;
        android.graphics.Bitmap bitmap = null;
        try {
            afd = client.openTypedAssetFileDescriptor(documentUri, "image/*", openOpts, signal);
            final java.io.FileDescriptor fd = afd.getFileDescriptor();
            ...
            try {
                ...
                is = new java.io.BufferedInputStream(new java.io.FileInputStream(fd), android.provider.DocumentsContract.THUMBNAIL_BUFFER_SIZE);
                is.mark(android.provider.DocumentsContract.THUMBNAIL_BUFFER_SIZE);
            }
            ...
            if (is != null) {
                ...
                android.graphics.BitmapFactory.decodeFileDescriptor(fd, null, opts);
            }
            final int widthSample = opts.outWidth / size.x;
            final int heightSample = opts.outHeight / size.y;
            opts.inJustDecodeBounds = false;
            opts.inSampleSize = java.lang.Math.min(widthSample, heightSample);
            if (is != null) {
                is.reset();
                ...
                bitmap = android.graphics.BitmapFactory.decodeFileDescriptor(fd, null, opts);
            }
            // Transform the bitmap if requested. We use a side-channel to
            // communicate the orientation, since EXIF thumbnails don't contain
            // the rotation flags of the original image.
            final android.os.Bundle extras = afd.getExtras();
            final int orientation = (extras != null) ? extras.getInt(android.provider.DocumentsContract.EXTRA_ORIENTATION, 0) : 0;
            if (orientation != 0) {
            ...
            libcore.io.IoUtils.closeQuietly(afd);
        }
        return bitmap;
    }
     ...
     */
    public static android.net.Uri createDocument(android.content.ContentResolver resolver, android.net.Uri parentDocumentUri, java.lang.String mimeType, java.lang.String displayName) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(parentDocumentUri.getAuthority());
        try {
            return android.provider.DocumentsContract.createDocument(client, parentDocumentUri, mimeType, displayName);
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to create document", e);
            return null;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static android.net.Uri createDocument(android.content.ContentProviderClient client, android.net.Uri parentDocumentUri, java.lang.String mimeType, java.lang.String displayName) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, parentDocumentUri);
        in.putString(android.provider.DocumentsContract.Document.COLUMN_MIME_TYPE, mimeType);
        in.putString(android.provider.DocumentsContract.Document.COLUMN_DISPLAY_NAME, displayName);
        final android.os.Bundle out = client.call(android.provider.DocumentsContract.METHOD_CREATE_DOCUMENT, null, in);
        return out.getParcelable(android.provider.DocumentsContract.EXTRA_URI);
    }

    /**
     * {@hide }
     */
    public static boolean isChildDocument(android.content.ContentProviderClient client, android.net.Uri parentDocumentUri, android.net.Uri childDocumentUri) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, parentDocumentUri);
        in.putParcelable(android.provider.DocumentsContract.EXTRA_TARGET_URI, childDocumentUri);
        final android.os.Bundle out = client.call(android.provider.DocumentsContract.METHOD_IS_CHILD_DOCUMENT, null, in);
        if (out == null) {
            throw new android.os.RemoteException("Failed to get a reponse from isChildDocument query.");
        }
        if (!out.containsKey(android.provider.DocumentsContract.EXTRA_RESULT)) {
            throw new android.os.RemoteException("Response did not include result field..");
        }
        return out.getBoolean(android.provider.DocumentsContract.EXTRA_RESULT);
    }
     ...
     *
     * @param documentUri
     * 		document with {@link Document#FLAG_SUPPORTS_RENAME}
     * @param displayName
     * 		updated name for document
     * @return the existing or new document after the rename, or {@code null} if
    failed.
     */
    public static android.net.Uri renameDocument(android.content.ContentResolver resolver, android.net.Uri documentUri, java.lang.String displayName) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(documentUri.getAuthority());
        try {
            return android.provider.DocumentsContract.renameDocument(client, documentUri, displayName);
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to rename document", e);
            return null;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static android.net.Uri renameDocument(android.content.ContentProviderClient client, android.net.Uri documentUri, java.lang.String displayName) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, documentUri);
        in.putString(android.provider.DocumentsContract.Document.COLUMN_DISPLAY_NAME, displayName);
        final android.os.Bundle out = client.call(android.provider.DocumentsContract.METHOD_RENAME_DOCUMENT, null, in);
        final android.net.Uri outUri = out.getParcelable(android.provider.DocumentsContract.EXTRA_URI);
     ...
     *
     * @param documentUri
     * 		document with {@link Document#FLAG_SUPPORTS_DELETE}
     * @return if the document was deleted successfully.
     */
    public static boolean deleteDocument(android.content.ContentResolver resolver, android.net.Uri documentUri) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(documentUri.getAuthority());
        try {
            android.provider.DocumentsContract.deleteDocument(client, documentUri);
            return true;
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to delete document", e);
            return false;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static void deleteDocument(android.content.ContentProviderClient client, android.net.Uri documentUri) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, documentUri);
        client.call(android.provider.DocumentsContract.METHOD_DELETE_DOCUMENT, null, in);
    }
     ...
     * 		document with {@link Document#FLAG_SUPPORTS_COPY}
     * @param targetParentDocumentUri
    ...
    public static android.net.Uri copyDocument(android.content.ContentResolver resolver, android.net.Uri sourceDocumentUri, android.net.Uri targetParentDocumentUri) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(sourceDocumentUri.getAuthority());
        try {
            return android.provider.DocumentsContract.copyDocument(client, sourceDocumentUri, targetParentDocumentUri);
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to copy document", e);
            return null;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static android.net.Uri copyDocument(android.content.ContentProviderClient client, android.net.Uri sourceDocumentUri, android.net.Uri targetParentDocumentUri) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, sourceDocumentUri);
        in.putParcelable(android.provider.DocumentsContract.EXTRA_TARGET_URI, targetParentDocumentUri);
        final android.os.Bundle out = client.call(android.provider.DocumentsContract.METHOD_COPY_DOCUMENT, null, in);
        return out.getParcelable(android.provider.DocumentsContract.EXTRA_URI);
    }
     ...
     *
     * @param sourceDocumentUri
     * 		document with {@link Document#FLAG_SUPPORTS_MOVE}
     * @param sourceParentDocumentUri
    ...
    public static android.net.Uri moveDocument(android.content.ContentResolver resolver, android.net.Uri sourceDocumentUri, android.net.Uri sourceParentDocumentUri, android.net.Uri targetParentDocumentUri) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(sourceDocumentUri.getAuthority());
        try {
            return android.provider.DocumentsContract.moveDocument(client, sourceDocumentUri, sourceParentDocumentUri, targetParentDocumentUri);
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to move document", e);
            return null;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static android.net.Uri moveDocument(android.content.ContentProviderClient client, android.net.Uri sourceDocumentUri, android.net.Uri sourceParentDocumentUri, android.net.Uri targetParentDocumentUri) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, sourceDocumentUri);
        in.putParcelable(android.provider.DocumentsContract.EXTRA_PARENT_URI, sourceParentDocumentUri);
        in.putParcelable(android.provider.DocumentsContract.EXTRA_TARGET_URI, targetParentDocumentUri);
        final android.os.Bundle out = client.call(android.provider.DocumentsContract.METHOD_MOVE_DOCUMENT, null, in);
        return out.getParcelable(android.provider.DocumentsContract.EXTRA_URI);
    }
     ...
     *
     * @param documentUri
     * 		document with {@link Document#FLAG_SUPPORTS_REMOVE}
     * @param parentDocumentUri
     * 		parent document of the document to remove.
     * @return true if the document was removed successfully.
     */
    public static boolean removeDocument(android.content.ContentResolver resolver, android.net.Uri documentUri, android.net.Uri parentDocumentUri) {
        final android.content.ContentProviderClient client = resolver.acquireUnstableContentProviderClient(documentUri.getAuthority());
        try {
            android.provider.DocumentsContract.removeDocument(client, documentUri, parentDocumentUri);
            return true;
        } catch (java.lang.Exception e) {
            android.util.Log.w(android.provider.DocumentsContract.TAG, "Failed to remove document", e);
            return false;
        } finally {
            android.content.ContentProviderClient.releaseQuietly(client);
        }
     ...
     * {@hide }
     */
    public static void removeDocument(android.content.ContentProviderClient client, android.net.Uri documentUri, android.net.Uri parentDocumentUri) throws android.os.RemoteException {
        final android.os.Bundle in = new android.os.Bundle();
        in.putParcelable(android.provider.DocumentsContract.EXTRA_URI, documentUri);
        in.putParcelable(android.provider.DocumentsContract.EXTRA_PARENT_URI, parentDocumentUri);
        client.call(android.provider.DocumentsContract.METHOD_REMOVE_DOCUMENT, null, in);
    }
    ...
    public static android.content.res.AssetFileDescriptor openImageThumbnail(java.io.File file) throws java.io.FileNotFoundException {
        final android.os.ParcelFileDescriptor pfd = android.os.ParcelFileDescriptor.open(file, android.os.ParcelFileDescriptor.MODE_READ_ONLY);
        android.os.Bundle extras = null;
        try {
            final android.media.ExifInterface exif = new android.media.ExifInterface(file.getAbsolutePath());
            ...
            if (thumb != null) {
                return new android.content.res.AssetFileDescriptor(pfd, thumb[0], thumb[1], extras);
            }
        } catch (java.io.IOException e) {
        }
        return new android.content.res.AssetFileDescriptor(pfd, 0, android.content.res.AssetFileDescriptor.UNKNOWN_LENGTH, extras);
    }
}
