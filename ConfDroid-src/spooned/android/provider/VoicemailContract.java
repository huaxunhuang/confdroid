...
public class VoicemailContract {
     ...
     */
    @android.annotation.SdkConstant(android.annotation.SdkConstant.SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final java.lang.String ACTION_VOICEMAIL_SMS_RECEIVED = "android.intent.action.VOICEMAIL_SMS_RECEIVED";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_VOICEMAIL_SMS_PREFIX = "com.android.voicemail.extra.VOICEMAIL_SMS_PREFIX";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_VOICEMAIL_SMS_FIELDS = "com.android.voicemail.extra.VOICEMAIL_SMS_FIELDS";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_VOICEMAIL_SMS_MESSAGE_BODY = "com.android.voicemail.extra.VOICEMAIL_SMS_MESSAGE_BODY";
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_VOICEMAIL_SMS_SUBID = "com.android.voicemail.extra.VOICEMAIL_SMS_SUBID";
    ...
    /**
     * Extra included in {@link #ACTION_SYNC_VOICEMAIL} broadcast intents to indicate which {@link PhoneAccountHandle} to sync.
     */
    ...
    public static final class Voicemails implements android.provider.BaseColumns , android.provider.OpenableColumns {
         ...
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse(("content://" + android.provider.VoicemailContract.AUTHORITY) + "/voicemail");
         ...
         * <P>Type: TEXT</P>
         */
        public static final java.lang.String SOURCE_PACKAGE = android.provider.VoicemailContract.SOURCE_PACKAGE_FIELD;
        ...
        public static android.net.Uri buildSourceUri(java.lang.String packageName) {
            return android.provider.VoicemailContract.Voicemails.CONTENT_URI.buildUpon().appendQueryParameter(android.provider.VoicemailContract.PARAM_KEY_SOURCE_PACKAGE, packageName).build();
        }
         ...
         *
         * @param context
         * 		The context of the app doing the inserting
         * @param voicemail
         * 		Data to be inserted
        ...
        public static android.net.Uri insert(android.content.Context context, android.telecom.Voicemail voicemail) {
            ...
            android.content.ContentValues contentValues = android.provider.VoicemailContract.Voicemails.getContentValues(voicemail);
            return contentResolver.insert(android.provider.VoicemailContract.Voicemails.buildSourceUri(context.getPackageName()), contentValues);
        }
         ...
         * @unknown 
         */
        public static int insert(android.content.Context context, java.util.List<android.telecom.Voicemail> voicemails) {
            android.content.ContentResolver contentResolver = context.getContentResolver();
            int count = voicemails.size();
            for (int i = 0; i < count; i++) {
                android.content.ContentValues contentValues = android.provider.VoicemailContract.Voicemails.getContentValues(voicemails.get(i));
                contentResolver.insert(android.provider.VoicemailContract.Voicemails.buildSourceUri(context.getPackageName()), contentValues);
            }
            return count;
        }
        ...
        public static int deleteAll(android.content.Context context) {
            return context.getContentResolver().delete(android.provider.VoicemailContract.Voicemails.buildSourceUri(context.getPackageName()), "", new java.lang.String[0]);
        }
        ...
        private static android.content.ContentValues getContentValues(android.telecom.Voicemail voicemail) {
            ...
            contentValues.put(android.provider.VoicemailContract.Voicemails.DATE, java.lang.String.valueOf(voicemail.getTimestampMillis()));
            contentValues.put(android.provider.VoicemailContract.Voicemails.NUMBER, voicemail.getNumber());
            contentValues.put(android.provider.VoicemailContract.Voicemails.DURATION, java.lang.String.valueOf(voicemail.getDuration()));
            contentValues.put(android.provider.VoicemailContract.Voicemails.SOURCE_PACKAGE, voicemail.getSourcePackage());
            contentValues.put(android.provider.VoicemailContract.Voicemails.SOURCE_DATA, voicemail.getSourceData());
            contentValues.put(android.provider.VoicemailContract.Voicemails.IS_READ, voicemail.isRead() ? 1 : 0);
            android.telecom.PhoneAccountHandle phoneAccount = voicemail.getPhoneAccount();
            if (phoneAccount != null) {
                contentValues.put(android.provider.VoicemailContract.Voicemails.PHONE_ACCOUNT_COMPONENT_NAME, phoneAccount.getComponentName().flattenToString());
                contentValues.put(android.provider.VoicemailContract.Voicemails.PHONE_ACCOUNT_ID, phoneAccount.getId());
            }
            if (voicemail.getTranscription() != null) {
                contentValues.put(android.provider.VoicemailContract.Voicemails.TRANSCRIPTION, voicemail.getTranscription());
            }
    ...
    public static final class Status implements android.provider.BaseColumns {
         ...
         */
        public static final android.net.Uri CONTENT_URI = android.net.Uri.parse(("content://" + android.provider.VoicemailContract.AUTHORITY) + "/status");
         ...
         */
        public static android.net.Uri buildSourceUri(java.lang.String packageName) {
            return android.provider.VoicemailContract.Status.CONTENT_URI.buildUpon().appendQueryParameter(android.provider.VoicemailContract.PARAM_KEY_SOURCE_PACKAGE, packageName).build();
        }
    }
}
