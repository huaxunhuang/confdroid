...
public final class GnssMeasurement implements android.os.Parcelable {
    ...
    @android.annotation.IntDef({ android.location.GnssMeasurement.MULTIPATH_INDICATOR_UNKNOWN, android.location.GnssMeasurement.MULTIPATH_INDICATOR_DETECTED, android.location.GnssMeasurement.MULTIPATH_INDICATOR_NOT_USED })
     ...
     */
    private static final int ADR_ALL = (android.location.GnssMeasurement.ADR_STATE_VALID | android.location.GnssMeasurement.ADR_STATE_RESET) | android.location.GnssMeasurement.ADR_STATE_CYCLE_SLIP;
     ...
     */
    @android.annotation.TestApi
    public void set(android.location.GnssMeasurement measurement) {
     ...
     */
    @android.annotation.TestApi
    public void setConstellationType(@android.location.GnssStatus.ConstellationType
    int value) {
    ...
    private java.lang.String getStateString() {
        if (mState == android.location.GnssMeasurement.STATE_UNKNOWN) {
            return "Unknown";
        }
        java.lang.StringBuilder builder = new java.lang.StringBuilder();
        if ((mState & android.location.GnssMeasurement.STATE_CODE_LOCK) != 0) {
            builder.append("CodeLock|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_BIT_SYNC) != 0) {
            builder.append("BitSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_SUBFRAME_SYNC) != 0) {
            builder.append("SubframeSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_TOW_DECODED) != 0) {
            builder.append("TowDecoded|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_MSEC_AMBIGUOUS) != 0) {
            builder.append("MsecAmbiguous|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_SYMBOL_SYNC) != 0) {
            builder.append("SymbolSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_GLO_STRING_SYNC) != 0) {
            builder.append("GloStringSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_GLO_TOD_DECODED) != 0) {
            builder.append("GloTodDecoded|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_BDS_D2_BIT_SYNC) != 0) {
            builder.append("BdsD2BitSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_BDS_D2_SUBFRAME_SYNC) != 0) {
            builder.append("BdsD2SubframeSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_GAL_E1BC_CODE_LOCK) != 0) {
            builder.append("GalE1bcCodeLock|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_GAL_E1C_2ND_CODE_LOCK) != 0) {
            builder.append("E1c2ndCodeLock|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_GAL_E1B_PAGE_SYNC) != 0) {
            builder.append("GalE1bPageSync|");
        }
        if ((mState & android.location.GnssMeasurement.STATE_SBAS_SYNC) != 0) {
            builder.append("SbasSync|");
        }
        int remainingStates = mState & (~android.location.GnssMeasurement.STATE_ALL);
    ...
    private java.lang.String getAccumulatedDeltaRangeStateString() {
        if (mAccumulatedDeltaRangeState == android.location.GnssMeasurement.ADR_STATE_UNKNOWN) {
            return "Unknown";
        }
        java.lang.StringBuilder builder = new java.lang.StringBuilder();
        if ((mAccumulatedDeltaRangeState & android.location.GnssMeasurement.ADR_STATE_VALID) == android.location.GnssMeasurement.ADR_STATE_VALID) {
            builder.append("Valid|");
        }
        if ((mAccumulatedDeltaRangeState & android.location.GnssMeasurement.ADR_STATE_RESET) == android.location.GnssMeasurement.ADR_STATE_RESET) {
            builder.append("Reset|");
        }
        if ((mAccumulatedDeltaRangeState & android.location.GnssMeasurement.ADR_STATE_CYCLE_SLIP) == android.location.GnssMeasurement.ADR_STATE_CYCLE_SLIP) {
            builder.append("CycleSlip|");
        }
        int remainingStates = mAccumulatedDeltaRangeState & (~android.location.GnssMeasurement.ADR_ALL);
        if (remainingStates > 0) {
            builder.append("Other(");
            builder.append(java.lang.Integer.toBinaryString(remainingStates));
            builder.append(")|");
    ...
    public boolean hasCarrierFrequencyHz() {
        return isFlagSet(android.location.GnssMeasurement.HAS_CARRIER_FREQUENCY);
    }
    ...
    public void setCarrierFrequencyHz(float carrierFrequencyHz) {
        setFlag(android.location.GnssMeasurement.HAS_CARRIER_FREQUENCY);
    ...
    public void resetCarrierFrequencyHz() {
        resetFlag(android.location.GnssMeasurement.HAS_CARRIER_FREQUENCY);
        mCarrierFrequencyHz = java.lang.Float.NaN;
    }
    ...
    public boolean hasCarrierCycles() {
        return isFlagSet(android.location.GnssMeasurement.HAS_CARRIER_CYCLES);
    }
    ...
    public void setCarrierCycles(long value) {
        setFlag(android.location.GnssMeasurement.HAS_CARRIER_CYCLES);
    ...
    public void resetCarrierCycles() {
        resetFlag(android.location.GnssMeasurement.HAS_CARRIER_CYCLES);
    ...
    public boolean hasCarrierPhase() {
        return isFlagSet(android.location.GnssMeasurement.HAS_CARRIER_PHASE);
    }
    ...
    public void setCarrierPhase(double value) {
        setFlag(android.location.GnssMeasurement.HAS_CARRIER_PHASE);
        mCarrierPhase = value;
    }
    ...
    public void resetCarrierPhase() {
        resetFlag(android.location.GnssMeasurement.HAS_CARRIER_PHASE);
    ...
    public boolean hasCarrierPhaseUncertainty() {
        return isFlagSet(android.location.GnssMeasurement.HAS_CARRIER_PHASE_UNCERTAINTY);
    }
    ...
    public void setCarrierPhaseUncertainty(double value) {
        setFlag(android.location.GnssMeasurement.HAS_CARRIER_PHASE_UNCERTAINTY);
    ...
    public void resetCarrierPhaseUncertainty() {
        resetFlag(android.location.GnssMeasurement.HAS_CARRIER_PHASE_UNCERTAINTY);
     ...
     */
    @android.annotation.TestApi
    public void setMultipathIndicator(@android.location.GnssMeasurement.MultipathIndicator
    int value) {
    ...
    private java.lang.String getMultipathIndicatorString() {
        switch (mMultipathIndicator) {
            case android.location.GnssMeasurement.MULTIPATH_INDICATOR_UNKNOWN :
                return "Unknown";
            case android.location.GnssMeasurement.MULTIPATH_INDICATOR_DETECTED :
                return "Detected";
            case android.location.GnssMeasurement.MULTIPATH_INDICATOR_NOT_USED :
                return "NotUsed";
            default :
    ...
    public boolean hasSnrInDb() {
        return isFlagSet(android.location.GnssMeasurement.HAS_SNR);
    }
    ...
    public void setSnrInDb(double snrInDb) {
        setFlag(android.location.GnssMeasurement.HAS_SNR);
        mSnrInDb = snrInDb;
    }
    ...
    public void resetSnrInDb() {
        resetFlag(android.location.GnssMeasurement.HAS_SNR);
        mSnrInDb = java.lang.Double.NaN;
    }

    public static final android.os.Parcelable.Creator<android.location.GnssMeasurement> CREATOR = new android.os.Parcelable.Creator<android.location.GnssMeasurement>() {
        @java.lang.Override
        public android.location.GnssMeasurement createFromParcel(android.os.Parcel parcel) {
            android.location.GnssMeasurement gnssMeasurement = new android.location.GnssMeasurement();
        ...
        @java.lang.Override
        public android.location.GnssMeasurement[] newArray(int i) {
            return new android.location.GnssMeasurement[i];
        }
    };
    ...
    public java.lang.String toString() {
        ...
        java.lang.StringBuilder builder = new java.lang.StringBuilder("GnssMeasurement:\n");
        builder.append(java.lang.String.format(format, "Svid", mSvid));
        builder.append(java.lang.String.format(format, "ConstellationType", mConstellationType));
        builder.append(java.lang.String.format(format, "TimeOffsetNanos", mTimeOffsetNanos));
        builder.append(java.lang.String.format(format, "State", getStateString()));
        builder.append(java.lang.String.format(formatWithUncertainty, "ReceivedSvTimeNanos", mReceivedSvTimeNanos, "ReceivedSvTimeUncertaintyNanos", mReceivedSvTimeUncertaintyNanos));
        builder.append(java.lang.String.format(format, "Cn0DbHz", mCn0DbHz));
        builder.append(java.lang.String.format(formatWithUncertainty, "PseudorangeRateMetersPerSecond", mPseudorangeRateMetersPerSecond, "PseudorangeRateUncertaintyMetersPerSecond", mPseudorangeRateUncertaintyMetersPerSecond));
        builder.append(java.lang.String.format(format, "AccumulatedDeltaRangeState", getAccumulatedDeltaRangeStateString()));
        builder.append(java.lang.String.format(formatWithUncertainty, "AccumulatedDeltaRangeMeters", mAccumulatedDeltaRangeMeters, "AccumulatedDeltaRangeUncertaintyMeters", mAccumulatedDeltaRangeUncertaintyMeters));
        builder.append(java.lang.String.format(format, "CarrierFrequencyHz", hasCarrierFrequencyHz() ? mCarrierFrequencyHz : null));
    ...
    private void initialize() {
        mFlags = android.location.GnssMeasurement.HAS_NO_FLAGS;
        setSvid(0);
        setTimeOffsetNanos(java.lang.Long.MIN_VALUE);
        setState(android.location.GnssMeasurement.STATE_UNKNOWN);
        setReceivedSvTimeNanos(java.lang.Long.MIN_VALUE);
        setReceivedSvTimeUncertaintyNanos(java.lang.Long.MAX_VALUE);
        setCn0DbHz(java.lang.Double.MIN_VALUE);
        setPseudorangeRateMetersPerSecond(java.lang.Double.MIN_VALUE);
        setPseudorangeRateUncertaintyMetersPerSecond(java.lang.Double.MIN_VALUE);
        setAccumulatedDeltaRangeState(android.location.GnssMeasurement.ADR_STATE_UNKNOWN);
        setAccumulatedDeltaRangeMeters(java.lang.Double.MIN_VALUE);
        setAccumulatedDeltaRangeUncertaintyMeters(java.lang.Double.MIN_VALUE);
        resetCarrierFrequencyHz();
        resetCarrierCycles();
        resetCarrierPhase();
        resetCarrierPhaseUncertainty();
        setMultipathIndicator(android.location.GnssMeasurement.MULTIPATH_INDICATOR_UNKNOWN);
        resetSnrInDb();
    }
