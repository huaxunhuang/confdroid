...
public final class GnssClock implements android.os.Parcelable {
     ...
     */
    @android.annotation.TestApi
    public void set(android.location.GnssClock clock) {
        mFlags = clock.mFlags;
    ...
    public boolean hasLeapSecond() {
        return isFlagSet(android.location.GnssClock.HAS_LEAP_SECOND);
    }
    ...
    public void setLeapSecond(int leapSecond) {
        setFlag(android.location.GnssClock.HAS_LEAP_SECOND);
    ...
    public void resetLeapSecond() {
        resetFlag(android.location.GnssClock.HAS_LEAP_SECOND);
        mLeapSecond = java.lang.Integer.MIN_VALUE;
    }
    ...
    public boolean hasTimeUncertaintyNanos() {
        return isFlagSet(android.location.GnssClock.HAS_TIME_UNCERTAINTY);
    }
    ...
    public void setTimeUncertaintyNanos(double timeUncertaintyNanos) {
        setFlag(android.location.GnssClock.HAS_TIME_UNCERTAINTY);
    ...
    public void resetTimeUncertaintyNanos() {
        resetFlag(android.location.GnssClock.HAS_TIME_UNCERTAINTY);
        mTimeUncertaintyNanos = java.lang.Double.NaN;
    }
    ...
    public boolean hasFullBiasNanos() {
        return isFlagSet(android.location.GnssClock.HAS_FULL_BIAS);
    }
    ...
    public void setFullBiasNanos(long value) {
        setFlag(android.location.GnssClock.HAS_FULL_BIAS);
    ...
    public void resetFullBiasNanos() {
        resetFlag(android.location.GnssClock.HAS_FULL_BIAS);
        mFullBiasNanos = java.lang.Long.MIN_VALUE;
    }
    ...
    public boolean hasBiasNanos() {
        return isFlagSet(android.location.GnssClock.HAS_BIAS);
    }
    ...
    public void setBiasNanos(double biasNanos) {
        setFlag(android.location.GnssClock.HAS_BIAS);
    ...
    public void resetBiasNanos() {
        resetFlag(android.location.GnssClock.HAS_BIAS);
        mBiasNanos = java.lang.Double.NaN;
    }
    ...
    public boolean hasBiasUncertaintyNanos() {
        return isFlagSet(android.location.GnssClock.HAS_BIAS_UNCERTAINTY);
    }
    ...
    public void setBiasUncertaintyNanos(double biasUncertaintyNanos) {
        setFlag(android.location.GnssClock.HAS_BIAS_UNCERTAINTY);
    ...
    public void resetBiasUncertaintyNanos() {
        resetFlag(android.location.GnssClock.HAS_BIAS_UNCERTAINTY);
        mBiasUncertaintyNanos = java.lang.Double.NaN;
    }
    ...
    public boolean hasDriftNanosPerSecond() {
        return isFlagSet(android.location.GnssClock.HAS_DRIFT);
    }
    ...
    public void setDriftNanosPerSecond(double driftNanosPerSecond) {
        setFlag(android.location.GnssClock.HAS_DRIFT);
    ...
    public void resetDriftNanosPerSecond() {
        resetFlag(android.location.GnssClock.HAS_DRIFT);
        mDriftNanosPerSecond = java.lang.Double.NaN;
    }
    ...
    public boolean hasDriftUncertaintyNanosPerSecond() {
        return isFlagSet(android.location.GnssClock.HAS_DRIFT_UNCERTAINTY);
    }
    ...
    public void setDriftUncertaintyNanosPerSecond(double driftUncertaintyNanosPerSecond) {
        setFlag(android.location.GnssClock.HAS_DRIFT_UNCERTAINTY);
    ...
    public void resetDriftUncertaintyNanosPerSecond() {
        resetFlag(android.location.GnssClock.HAS_DRIFT_UNCERTAINTY);
        mDriftUncertaintyNanosPerSecond = java.lang.Double.NaN;
    }
    ...
    public static final android.os.Parcelable.Creator<android.location.GnssClock> CREATOR = new android.os.Parcelable.Creator<android.location.GnssClock>() {
        @java.lang.Override
        public android.location.GnssClock createFromParcel(android.os.Parcel parcel) {
            android.location.GnssClock gpsClock = new android.location.GnssClock();
        ...
        @java.lang.Override
        public android.location.GnssClock[] newArray(int size) {
            return new android.location.GnssClock[size];
        }
    };
    ...
    public java.lang.String toString() {
        ...
        final java.lang.String formatWithUncertainty = "   %-15s = %-25s   %-26s = %s\n";
        java.lang.StringBuilder builder = new java.lang.StringBuilder("GnssClock:\n");
        builder.append(java.lang.String.format(format, "LeapSecond", hasLeapSecond() ? mLeapSecond : null));
        builder.append(java.lang.String.format(formatWithUncertainty, "TimeNanos", mTimeNanos, "TimeUncertaintyNanos", hasTimeUncertaintyNanos() ? mTimeUncertaintyNanos : null));
        builder.append(java.lang.String.format(format, "FullBiasNanos", hasFullBiasNanos() ? mFullBiasNanos : null));
        builder.append(java.lang.String.format(formatWithUncertainty, "BiasNanos", hasBiasNanos() ? mBiasNanos : null, "BiasUncertaintyNanos", hasBiasUncertaintyNanos() ? mBiasUncertaintyNanos : null));
        builder.append(java.lang.String.format(formatWithUncertainty, "DriftNanosPerSecond", hasDriftNanosPerSecond() ? mDriftNanosPerSecond : null, "DriftUncertaintyNanosPerSecond", hasDriftUncertaintyNanosPerSecond() ? mDriftUncertaintyNanosPerSecond : null));
        builder.append(java.lang.String.format(format, "HardwareClockDiscontinuityCount", mHardwareClockDiscontinuityCount));
        return builder.toString();
    }

    private void initialize() {
        mFlags = android.location.GnssClock.HAS_NO_FLAGS;
        resetLeapSecond();
        setTimeNanos(java.lang.Long.MIN_VALUE);
        ...
        setHardwareClockDiscontinuityCount(java.lang.Integer.MIN_VALUE);
    }
