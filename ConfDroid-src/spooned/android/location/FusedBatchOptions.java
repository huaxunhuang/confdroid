...
public class FusedBatchOptions implements android.os.Parcelable {
    ...
    public static final class BatchFlags {
        ...
        public static int WAKEUP_ON_FIFO_FULL = 0x1;

        public static int CALLBACK_ON_LOCATION_FIX = 0x2;
    }

    /* Method definitions to support Parcelable operations. */
    public static final android.os.Parcelable.Creator<android.location.FusedBatchOptions> CREATOR = new android.os.Parcelable.Creator<android.location.FusedBatchOptions>() {
        @java.lang.Override
        public android.location.FusedBatchOptions createFromParcel(android.os.Parcel parcel) {
            android.location.FusedBatchOptions options = new android.location.FusedBatchOptions();
        ...
        @java.lang.Override
        public android.location.FusedBatchOptions[] newArray(int size) {
            return new android.location.FusedBatchOptions[size];
        }
    };
