 ...
 * characteristics or monetary costs to the user.  The {@link Criteria} class allows providers to be selected based on
...
public class LocationProvider {
     ...
     * @unknown 
     */
    public static final java.lang.String BAD_CHARS_REGEX = "[^a-zA-Z0-9]";
     ...
     * @unknown 
     */
    public LocationProvider(java.lang.String name, com.android.internal.location.ProviderProperties properties) {
    ...
    public boolean meetsCriteria(android.location.Criteria criteria) {
        return android.location.LocationProvider.propertiesMeetCriteria(mName, mProperties, criteria);
    }
     ...
     * @unknown 
     */
    public static boolean propertiesMeetCriteria(java.lang.String name, com.android.internal.location.ProviderProperties properties, android.location.Criteria criteria) {
        if (android.location.LocationManager.PASSIVE_PROVIDER.equals(name)) {
        ...
        if ((criteria.getAccuracy() != android.location.Criteria.NO_REQUIREMENT) && (criteria.getAccuracy() < properties.mAccuracy)) {
            return false;
        }
        if ((criteria.getPowerRequirement() != android.location.Criteria.NO_REQUIREMENT) && (criteria.getPowerRequirement() < properties.mPowerRequirement)) {
            return false;
        }
