...
public class GpsClock implements android.os.Parcelable {
     ...
     */
    public void set(android.location.GpsClock clock) {
        mFlags = clock.mFlags;
    ...
    private java.lang.String getTypeString() {
        switch (mType) {
            case android.location.GpsClock.TYPE_UNKNOWN :
                return "Unknown";
            case android.location.GpsClock.TYPE_GPS_TIME :
                return "GpsTime";
            case android.location.GpsClock.TYPE_LOCAL_HW_TIME :
                return "LocalHwClock";
            default :
    ...
    public boolean hasLeapSecond() {
        return isFlagSet(android.location.GpsClock.HAS_LEAP_SECOND);
    }
    ...
    public void setLeapSecond(short leapSecond) {
        setFlag(android.location.GpsClock.HAS_LEAP_SECOND);
    ...
    public void resetLeapSecond() {
        resetFlag(android.location.GpsClock.HAS_LEAP_SECOND);
        mLeapSecond = java.lang.Short.MIN_VALUE;
    }
    ...
    public boolean hasTimeUncertaintyInNs() {
        return isFlagSet(android.location.GpsClock.HAS_TIME_UNCERTAINTY);
    }
    ...
    public void setTimeUncertaintyInNs(double timeUncertaintyInNs) {
        setFlag(android.location.GpsClock.HAS_TIME_UNCERTAINTY);
    ...
    public void resetTimeUncertaintyInNs() {
        resetFlag(android.location.GpsClock.HAS_TIME_UNCERTAINTY);
        mTimeUncertaintyInNs = java.lang.Double.NaN;
    }
    ...
    public boolean hasFullBiasInNs() {
        return isFlagSet(android.location.GpsClock.HAS_FULL_BIAS);
    }
    ...
    public void setFullBiasInNs(long value) {
        setFlag(android.location.GpsClock.HAS_FULL_BIAS);
        mFullBiasInNs = value;
    }
    ...
    public void resetFullBiasInNs() {
        resetFlag(android.location.GpsClock.HAS_FULL_BIAS);
        mFullBiasInNs = java.lang.Long.MIN_VALUE;
    }
    ...
    public boolean hasBiasInNs() {
        return isFlagSet(android.location.GpsClock.HAS_BIAS);
    }
    ...
    public void setBiasInNs(double biasInNs) {
        setFlag(android.location.GpsClock.HAS_BIAS);
        mBiasInNs = biasInNs;
    }
    ...
    public void resetBiasInNs() {
        resetFlag(android.location.GpsClock.HAS_BIAS);
        mBiasInNs = java.lang.Double.NaN;
    }
    ...
    public boolean hasBiasUncertaintyInNs() {
        return isFlagSet(android.location.GpsClock.HAS_BIAS_UNCERTAINTY);
    }
    ...
    public void setBiasUncertaintyInNs(double biasUncertaintyInNs) {
        setFlag(android.location.GpsClock.HAS_BIAS_UNCERTAINTY);
    ...
    public void resetBiasUncertaintyInNs() {
        resetFlag(android.location.GpsClock.HAS_BIAS_UNCERTAINTY);
        mBiasUncertaintyInNs = java.lang.Double.NaN;
    }
    ...
    public boolean hasDriftInNsPerSec() {
        return isFlagSet(android.location.GpsClock.HAS_DRIFT);
    }
    ...
    public void setDriftInNsPerSec(double driftInNsPerSec) {
        setFlag(android.location.GpsClock.HAS_DRIFT);
    ...
    public void resetDriftInNsPerSec() {
        resetFlag(android.location.GpsClock.HAS_DRIFT);
        mDriftInNsPerSec = java.lang.Double.NaN;
    }
    ...
    public boolean hasDriftUncertaintyInNsPerSec() {
        return isFlagSet(android.location.GpsClock.HAS_DRIFT_UNCERTAINTY);
    }
    ...
    public void setDriftUncertaintyInNsPerSec(double driftUncertaintyInNsPerSec) {
        setFlag(android.location.GpsClock.HAS_DRIFT_UNCERTAINTY);
    ...
    public void resetDriftUncertaintyInNsPerSec() {
        resetFlag(android.location.GpsClock.HAS_DRIFT_UNCERTAINTY);
        mDriftUncertaintyInNsPerSec = java.lang.Double.NaN;
    }

    public static final android.os.Parcelable.Creator<android.location.GpsClock> CREATOR = new android.os.Parcelable.Creator<android.location.GpsClock>() {
        @java.lang.Override
        public android.location.GpsClock createFromParcel(android.os.Parcel parcel) {
            android.location.GpsClock gpsClock = new android.location.GpsClock();
        ...
        @java.lang.Override
        public android.location.GpsClock[] newArray(int size) {
            return new android.location.GpsClock[size];
        }
    };
    ...
    public java.lang.String toString() {
        ...
        java.lang.StringBuilder builder = new java.lang.StringBuilder("GpsClock:\n");
        ...
        builder.append(java.lang.String.format(formatWithUncertainty, "TimeInNs", mTimeInNs, "TimeUncertaintyInNs", hasTimeUncertaintyInNs() ? mTimeUncertaintyInNs : null));
        builder.append(java.lang.String.format(format, "FullBiasInNs", hasFullBiasInNs() ? mFullBiasInNs : null));
        builder.append(java.lang.String.format(formatWithUncertainty, "BiasInNs", hasBiasInNs() ? mBiasInNs : null, "BiasUncertaintyInNs", hasBiasUncertaintyInNs() ? mBiasUncertaintyInNs : null));
        builder.append(java.lang.String.format(formatWithUncertainty, "DriftInNsPerSec", hasDriftInNsPerSec() ? mDriftInNsPerSec : null, "DriftUncertaintyInNsPerSec", hasDriftUncertaintyInNsPerSec() ? mDriftUncertaintyInNsPerSec : null));
        return builder.toString();
    }

    private void initialize() {
        mFlags = android.location.GpsClock.HAS_NO_FLAGS;
        resetLeapSecond();
        setType(android.location.GpsClock.TYPE_UNKNOWN);
        setTimeInNs(java.lang.Long.MIN_VALUE);
