...
public class Location implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public static final java.lang.String EXTRA_COARSE_LOCATION = "coarseLocation";
    ...
    private static java.lang.ThreadLocal<android.location.Location.BearingDistanceCache> sBearingDistanceCache = new java.lang.ThreadLocal<android.location.Location.BearingDistanceCache>() {
        @java.lang.Override
    ...
    public void set(android.location.Location l) {
        ...
        mExtras = (l.mExtras == null) ? null : new android.os.Bundle(l.mExtras);
    }
    ...
    public static java.lang.String convert(double coordinate, int outputType) {
        if (((coordinate < (-180.0)) || (coordinate > 180.0)) || java.lang.Double.isNaN(coordinate)) {
            throw new java.lang.IllegalArgumentException("coordinate=" + coordinate);
        }
        if (((outputType != android.location.Location.FORMAT_DEGREES) && (outputType != android.location.Location.FORMAT_MINUTES)) && (outputType != android.location.Location.FORMAT_SECONDS)) {
            throw new java.lang.IllegalArgumentException("outputType=" + outputType);
        }
        ...
        if ((outputType == android.location.Location.FORMAT_MINUTES) || (outputType == android.location.Location.FORMAT_SECONDS)) {
            int degrees = ((int) (java.lang.Math.floor(coordinate)));
            sb.append(degrees);
            sb.append(':');
            coordinate -= degrees;
            coordinate *= 60.0;
            if (outputType == android.location.Location.FORMAT_SECONDS) {
                int minutes = ((int) (java.lang.Math.floor(coordinate)));
                sb.append(minutes);
                sb.append(':');
                coordinate -= minutes;
                coordinate *= 60.0;
    ...
    public static double convert(java.lang.String coordinate) {
        ...
        if (coordinate == null) {
            throw new java.lang.NullPointerException("coordinate");
        }
        ...
        java.util.StringTokenizer st = new java.util.StringTokenizer(coordinate, ":");
        int tokens = st.countTokens();
        if (tokens < 1) {
            throw new java.lang.IllegalArgumentException("coordinate=" + coordinate);
        }
        try {
            java.lang.String degrees = st.nextToken();
            double val;
            if (tokens == 1) {
                val = java.lang.Double.parseDouble(degrees);
                return negative ? -val : val;
            }
            java.lang.String minutes = st.nextToken();
            int deg = java.lang.Integer.parseInt(degrees);
            double min;
            double sec = 0.0;
            boolean secPresent = false;
            if (st.hasMoreTokens()) {
                min = java.lang.Integer.parseInt(minutes);
                java.lang.String seconds = st.nextToken();
                sec = java.lang.Double.parseDouble(seconds);
                secPresent = true;
            } else {
                min = java.lang.Double.parseDouble(minutes);
            }
    ...
    private static void computeDistanceAndBearing(double lat1, double lon1, double lat2, double lon2, android.location.Location.BearingDistanceCache results) {
        // Based on http://www.ngs.noaa.gov/PUBS_LIB/inverse.pdf
        // using the "Inverse Formula" (section 4)
        int MAXITERS = 20;
        // Convert lat/long to radians
        lat1 *= java.lang.Math.PI / 180.0;
        lat2 *= java.lang.Math.PI / 180.0;
        lon1 *= java.lang.Math.PI / 180.0;
        lon2 *= java.lang.Math.PI / 180.0;
        ...
        double L = lon2 - lon1;
        double A = 0.0;
        double U1 = java.lang.Math.atan((1.0 - f) * java.lang.Math.tan(lat1));
        double U2 = java.lang.Math.atan((1.0 - f) * java.lang.Math.tan(lat2));
        double cosU1 = java.lang.Math.cos(U1);
        double cosU2 = java.lang.Math.cos(U2);
        double sinU1 = java.lang.Math.sin(U1);
        double sinU2 = java.lang.Math.sin(U2);
        ...
        for (int iter = 0; iter < MAXITERS; iter++) {
            ...
            cosLambda = java.lang.Math.cos(lambda);
            sinLambda = java.lang.Math.sin(lambda);
            double t1 = cosU2 * sinLambda;
            double t2 = (cosU1 * sinU2) - ((sinU1 * cosU2) * cosLambda);
            double sinSqSigma = (t1 * t1) + (t2 * t2);// (14)

            sinSigma = java.lang.Math.sqrt(sinSqSigma);
            cosSigma = sinU1sinU2 + (cosU1cosU2 * cosLambda);// (15)

            sigma = java.lang.Math.atan2(sinSigma, cosSigma);// (16)
            ...
            if (java.lang.Math.abs(delta) < 1.0E-12) {
                break;
            }
        }
        float distance = ((float) ((b * A) * (sigma - deltaSigma)));
        results.mDistance = distance;
        float initialBearing = ((float) (java.lang.Math.atan2(cosU2 * sinLambda, (cosU1 * sinU2) - ((sinU1 * cosU2) * cosLambda))));
        initialBearing *= 180.0 / java.lang.Math.PI;
        results.mInitialBearing = initialBearing;
        float finalBearing = ((float) (java.lang.Math.atan2(cosU1 * sinLambda, ((-sinU1) * cosU2) + ((cosU1 * sinU2) * cosLambda))));
        finalBearing *= 180.0 / java.lang.Math.PI;
    ...
    public static void distanceBetween(double startLatitude, double startLongitude, double endLatitude, double endLongitude, float[] results) {
        ...
        android.location.Location.BearingDistanceCache cache = android.location.Location.sBearingDistanceCache.get();
        android.location.Location.computeDistanceAndBearing(startLatitude, startLongitude, endLatitude, endLongitude, cache);
    ...
    public float distanceTo(android.location.Location dest) {
        ...
        if ((((mLatitude != cache.mLat1) || (mLongitude != cache.mLon1)) || (dest.mLatitude != cache.mLat2)) || (dest.mLongitude != cache.mLon2)) {
            android.location.Location.computeDistanceAndBearing(mLatitude, mLongitude, dest.mLatitude, dest.mLongitude, cache);
        }
    ...
    public boolean hasAltitude() {
        return (mFieldsMask & android.location.Location.HAS_ALTITUDE_MASK) != 0;
    }
    ...
    public void setAltitude(double altitude) {
        mAltitude = altitude;
        mFieldsMask |= android.location.Location.HAS_ALTITUDE_MASK;
    }
    ...
    public boolean hasSpeed() {
        return (mFieldsMask & android.location.Location.HAS_SPEED_MASK) != 0;
    }
    ...
    public void setSpeed(float speed) {
        mSpeed = speed;
        mFieldsMask |= android.location.Location.HAS_SPEED_MASK;
    }
    ...
    public boolean hasBearing() {
        return (mFieldsMask & android.location.Location.HAS_BEARING_MASK) != 0;
    }
    ...
    public void setBearing(float bearing) {
        ...
        mBearing = bearing;
        mFieldsMask |= android.location.Location.HAS_BEARING_MASK;
    }
    ...
    public boolean hasAccuracy() {
        return (mFieldsMask & android.location.Location.HAS_ACCURACY_MASK) != 0;
    }
    ...
    public void setAccuracy(float accuracy) {
        mAccuracy = accuracy;
        mFieldsMask |= android.location.Location.HAS_ACCURACY_MASK;
    }
    ...
    public void makeComplete() {
        ...
        if (mElapsedRealtimeNanos == 0)
            mElapsedRealtimeNanos = android.os.SystemClock.elapsedRealtimeNanos();
    ...
    public java.lang.String toString() {
        ...
        s.append("Location[");
        s.append(mProvider);
        s.append(java.lang.String.format(" %.6f,%.6f", mLatitude, mLongitude));
        if (hasAccuracy())
            s.append(java.lang.String.format(" acc=%.0f", mAccuracy));
        else
            s.append(" acc=???");
        ...
        if (mElapsedRealtimeNanos == 0) {
            ...
            s.append(" et=");
            android.util.TimeUtils.formatDuration(mElapsedRealtimeNanos / 1000000L, s);
        }
        if (hasAltitude())
    ...
    public static final android.os.Parcelable.Creator<android.location.Location> CREATOR = new android.os.Parcelable.Creator<android.location.Location>() {
        @java.lang.Override
        public android.location.Location createFromParcel(android.os.Parcel in) {
            java.lang.String provider = in.readString();
            android.location.Location l = new android.location.Location(provider);
            l.mTime = in.readLong();
            ...
            l.mExtras = android.os.Bundle.setDefusable(in.readBundle(), true);
            return l;
        }

        @java.lang.Override
        public android.location.Location[] newArray(int size) {
            return new android.location.Location[size];
        }
    };
    ...
    public android.location.Location getExtraLocation(java.lang.String key) {
        if (mExtras != null) {
            android.os.Parcelable value = mExtras.getParcelable(key);
            if (value instanceof android.location.Location) {
                return ((android.location.Location) (value));
            }
        }
        return null;
    }
    ...
    public boolean isFromMockProvider() {
        return (mFieldsMask & android.location.Location.HAS_MOCK_PROVIDER_MASK) != 0;
    }
    ...
    public void setIsFromMockProvider(boolean isFromMockProvider) {
        if (isFromMockProvider) {
            mFieldsMask |= android.location.Location.HAS_MOCK_PROVIDER_MASK;
        } else {
            mFieldsMask &= ~android.location.Location.HAS_MOCK_PROVIDER_MASK;
        }
    }
