...
public final class GnssStatus {
    ...
    @android.annotation.IntDef({ android.location.GnssStatus.CONSTELLATION_UNKNOWN, android.location.GnssStatus.CONSTELLATION_GPS, android.location.GnssStatus.CONSTELLATION_SBAS, android.location.GnssStatus.CONSTELLATION_GLONASS, android.location.GnssStatus.CONSTELLATION_QZSS, android.location.GnssStatus.CONSTELLATION_BEIDOU, android.location.GnssStatus.CONSTELLATION_GALILEO })
    ...
    public int getConstellationType(int satIndex) {
        return (mSvidWithFlags[satIndex] >> android.location.GnssStatus.CONSTELLATION_TYPE_SHIFT_WIDTH) & android.location.GnssStatus.CONSTELLATION_TYPE_MASK;
    }
    ...
    public int getSvid(int satIndex) {
        return mSvidWithFlags[satIndex] >> android.location.GnssStatus.SVID_SHIFT_WIDTH;
    }
    ...
    public boolean hasEphemerisData(int satIndex) {
        return (mSvidWithFlags[satIndex] & android.location.GnssStatus.GNSS_SV_FLAGS_HAS_EPHEMERIS_DATA) != 0;
    }
    ...
    public boolean hasAlmanacData(int satIndex) {
        return (mSvidWithFlags[satIndex] & android.location.GnssStatus.GNSS_SV_FLAGS_HAS_ALMANAC_DATA) != 0;
    }
    ...
    public boolean usedInFix(int satIndex) {
        return (mSvidWithFlags[satIndex] & android.location.GnssStatus.GNSS_SV_FLAGS_USED_IN_FIX) != 0;
    }
}
