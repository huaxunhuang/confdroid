...
public class LongSparseArray<E> implements java.lang.Cloneable {
    ...
    public LongSparseArray(int initialCapacity) {
        if (initialCapacity == 0) {
            mKeys = libcore.util.EmptyArray.LONG;
            mValues = libcore.util.EmptyArray.OBJECT;
        } else {
            mKeys = com.android.internal.util.ArrayUtils.newUnpaddedLongArray(initialCapacity);
    ...
    public android.util.LongSparseArray<E> clone() {
        android.util.LongSparseArray<E> clone = null;
        try {
            clone = ((android.util.LongSparseArray<E>) (super.clone()));
    ...
    public E get(long key, E valueIfKeyNotFound) {
        ...
        if ((i < 0) || (mValues[i] == android.util.LongSparseArray.DELETED)) {
    ...
    public void delete(long key) {
        int i = android.util.ContainerHelpers.binarySearch(mKeys, mSize, key);
        if (i >= 0) {
            if (mValues[i] != android.util.LongSparseArray.DELETED) {
                mValues[i] = android.util.LongSparseArray.DELETED;
                mGarbage = true;
            }
        }
    }
    ...
    public void removeAt(int index) {
        if (mValues[index] != android.util.LongSparseArray.DELETED) {
            mValues[index] = android.util.LongSparseArray.DELETED;
            mGarbage = true;
        }
    }
    ...
    private void gc() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (val != android.util.LongSparseArray.DELETED) {
                if (i != o) {
                    keys[o] = keys[i];
                    values[o] = val;
                    values[i] = null;
    ...
    public void put(long key, E value) {
        ...
        if (i >= 0) {
            ...
            i = ~i;
            if ((i < mSize) && (mValues[i] == android.util.LongSparseArray.DELETED)) {
                mKeys[i] = key;
                mValues[i] = value;
                return;
            }
