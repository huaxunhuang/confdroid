...
public class LogPrinter implements android.util.Printer {
     ...
     */
    public LogPrinter(int priority, java.lang.String tag) {
        mPriority = priority;
        mTag = tag;
     ...
     *
     *
     * @unknown Same as above, but buffer is one of the LOG_ID_ constants from android.util.Log.
     */
    public LogPrinter(int priority, java.lang.String tag, int buffer) {
        mPriority = priority;
        mTag = tag;
        mBuffer = buffer;
    }
    ...
    public void println(java.lang.String x) {
        android.util.Log.println_native(mBuffer, mPriority, mTag, x);
    }
}
