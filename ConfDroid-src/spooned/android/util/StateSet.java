...
public class StateSet {
    ...
    static final int[] VIEW_STATE_IDS = new int[]{ R.attr.state_window_focused, android.util.StateSet.VIEW_STATE_WINDOW_FOCUSED, R.attr.state_selected, android.util.StateSet.VIEW_STATE_SELECTED, R.attr.state_focused, android.util.StateSet.VIEW_STATE_FOCUSED, R.attr.state_enabled, android.util.StateSet.VIEW_STATE_ENABLED, R.attr.state_pressed, android.util.StateSet.VIEW_STATE_PRESSED, R.attr.state_activated, android.util.StateSet.VIEW_STATE_ACTIVATED, R.attr.state_accelerated, android.util.StateSet.VIEW_STATE_ACCELERATED, R.attr.state_hovered, android.util.StateSet.VIEW_STATE_HOVERED, R.attr.state_drag_can_accept, android.util.StateSet.VIEW_STATE_DRAG_CAN_ACCEPT, R.attr.state_drag_hovered, android.util.StateSet.VIEW_STATE_DRAG_HOVERED };

    static {
        if ((android.util.StateSet.VIEW_STATE_IDS.length / 2) != R.styleable.ViewDrawableStates.length) {
            throw new java.lang.IllegalStateException("VIEW_STATE_IDs array length does not match ViewDrawableStates style array");
        }
        final int[] orderedIds = new int[android.util.StateSet.VIEW_STATE_IDS.length];
        for (int i = 0; i < R.styleable.ViewDrawableStates.length; i++) {
            final int viewState = R.styleable.ViewDrawableStates[i];
            for (int j = 0; j < android.util.StateSet.VIEW_STATE_IDS.length; j += 2) {
                if (android.util.StateSet.VIEW_STATE_IDS[j] == viewState) {
                    orderedIds[i * 2] = viewState;
                    orderedIds[(i * 2) + 1] = android.util.StateSet.VIEW_STATE_IDS[j + 1];
                }
            }
        }
        final int NUM_BITS = android.util.StateSet.VIEW_STATE_IDS.length / 2;
        VIEW_STATE_SETS = new int[1 << NUM_BITS][];
        for (int i = 0; i < android.util.StateSet.VIEW_STATE_SETS.length; i++) {
            final int numBits = java.lang.Integer.bitCount(i);
            ...
            android.util.StateSet.VIEW_STATE_SETS[i] = set;
        }
    }
    ...
    public static int[] get(int mask) {
        if (mask >= android.util.StateSet.VIEW_STATE_SETS.length) {
            throw new java.lang.IllegalArgumentException("Invalid state set mask");
        }
        return android.util.StateSet.VIEW_STATE_SETS[mask];
    }
     ...
     * 		prohibited (if negative) {@link android.view.View} states.
     * @param state
     * 		a {@link android.view.View} state
     */
    ...
    public static int[] trimStateSet(int[] states, int newSize) {
        ...
        java.lang.System.arraycopy(states, 0, trimmedStates, 0, newSize);
