...
public class MonthDisplayHelper {
    ...
    public MonthDisplayHelper(int year, int month, int weekStartDay) {
        if ((weekStartDay < java.util.Calendar.SUNDAY) || (weekStartDay > java.util.Calendar.SATURDAY)) {
            throw new java.lang.IllegalArgumentException();
        }
        mWeekStartDay = weekStartDay;
        mCalendar = java.util.Calendar.getInstance();
        mCalendar.set(java.util.Calendar.YEAR, year);
        mCalendar.set(java.util.Calendar.MONTH, month);
        mCalendar.set(java.util.Calendar.DAY_OF_MONTH, 1);
        mCalendar.set(java.util.Calendar.HOUR_OF_DAY, 0);
    ...
    public MonthDisplayHelper(int year, int month) {
        this(year, month, java.util.Calendar.SUNDAY);
    }
    ...
    public int getMonth() {
        return mCalendar.get(java.util.Calendar.MONTH);
    }
    ...
    public int getFirstDayOfMonth() {
        return mCalendar.get(java.util.Calendar.DAY_OF_WEEK);
    }
    ...
    public int[] getDigitsForRow(int row) {
        if ((row < 0) || (row > 5)) {
            throw new java.lang.IllegalArgumentException(("row " + row) + " out of range (0-5)");
        }
    ...
    private void recalculate() {
        mNumDaysInMonth = mCalendar.getActualMaximum(java.util.Calendar.DAY_OF_MONTH);
        mCalendar.add(java.util.Calendar.MONTH, -1);
        mNumDaysInPrevMonth = mCalendar.getActualMaximum(java.util.Calendar.DAY_OF_MONTH);
        mCalendar.add(java.util.Calendar.MONTH, 1);
