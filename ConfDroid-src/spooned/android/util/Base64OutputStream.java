...
public class Base64OutputStream extends java.io.FilterOutputStream {
     ...
     */
    public Base64OutputStream(java.io.OutputStream out, int flags) {
        this(out, flags, true);
    }
     ...
     * @unknown 
     */
    public Base64OutputStream(java.io.OutputStream out, int flags, boolean encode) {
        super(out);
        this.flags = flags;
        if (encode) {
    ...
    public void close() throws java.io.IOException {
        ...
        try {
            flushBuffer();
            internalWrite(android.util.Base64OutputStream.EMPTY, 0, 0, true);
     ...
     */
    private void internalWrite(byte[] b, int off, int len, boolean finish) throws java.io.IOException {
