...
public final class MathUtils {
    ...
    private static final float DEG_TO_RAD = 3.1415925F / 180.0F;

    private static final float RAD_TO_DEG = 180.0F / 3.1415925F;
    ...
    public static float mag(float a, float b) {
        return ((float) (java.lang.Math.hypot(a, b)));
    }
    ...
    public static float radians(float degrees) {
        return degrees * android.util.MathUtils.DEG_TO_RAD;
    }

    public static float degrees(float radians) {
        return radians * android.util.MathUtils.RAD_TO_DEG;
    }
    ...
    public static int random(int howbig) {
        return ((int) (android.util.MathUtils.sRandom.nextFloat() * howbig));
    }
    ...
    public static int random(int howsmall, int howbig) {
        ...
        return ((int) ((android.util.MathUtils.sRandom.nextFloat() * (howbig - howsmall)) + howsmall));
    }
     ...
     */
    public static int addOrThrow(int a, int b) throws java.lang.IllegalArgumentException {
        if (b == 0) {
            return a;
        }
        if ((b > 0) && (a <= (java.lang.Integer.MAX_VALUE - b))) {
            return a + b;
        }
        if ((b < 0) && (a >= (java.lang.Integer.MIN_VALUE - b))) {
            return a + b;
        }
        throw new java.lang.IllegalArgumentException((("Addition overflow: " + a) + " + ") + b);
    }
}
