...
public abstract class Spline {
     ...
     */
    public static android.util.Spline createSpline(float[] x, float[] y) {
        if (!android.util.Spline.isStrictlyIncreasing(x)) {
            throw new java.lang.IllegalArgumentException("The control points must all have strictly " + "increasing X values.");
        }
        if (android.util.Spline.isMonotonic(y)) {
            return android.util.Spline.createMonotoneCubicSpline(x, y);
        } else {
            return android.util.Spline.createLinearSpline(x, y);
        }
    }
     ...
     */
    public static android.util.Spline createMonotoneCubicSpline(float[] x, float[] y) {
        return new android.util.Spline.MonotoneCubicSpline(x, y);
    }
     ...
     * 		increasing.
     */
    public static android.util.Spline createLinearSpline(float[] x, float[] y) {
        return new android.util.Spline.LinearSpline(x, y);
    }
