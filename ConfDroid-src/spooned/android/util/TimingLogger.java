...
public class TimingLogger {
     ...
     */
    public TimingLogger(java.lang.String tag, java.lang.String label) {
        reset(tag, label);
    }
     ...
     * 		a string to be displayed with each log
     */
    public void reset(java.lang.String tag, java.lang.String label) {
        mTag = tag;
        mLabel = label;
        reset();
    }
     ...
     */
    public void reset() {
        mDisabled = !android.util.Log.isLoggable(mTag, android.util.Log.VERBOSE);
        if (mDisabled)
            return;

        if (mSplits == null) {
            mSplits = new java.util.ArrayList<java.lang.Long>();
            mSplitLabels = new java.util.ArrayList<java.lang.String>();
        } else {
            mSplits.clear();
            mSplitLabels.clear();
        }
    ...
    public void dumpToLog() {
        ...
        for (int i = 1; i < mSplits.size(); i++) {
            now = mSplits.get(i);
            final java.lang.String splitLabel = mSplitLabels.get(i);
