...
public class SparseBooleanArray implements java.lang.Cloneable {
    ...
    public SparseBooleanArray(int initialCapacity) {
        if (initialCapacity == 0) {
            ...
            mValues = libcore.util.EmptyArray.BOOLEAN;
        } else {
            mKeys = com.android.internal.util.ArrayUtils.newUnpaddedIntArray(initialCapacity);
    ...
    public android.util.SparseBooleanArray clone() {
        android.util.SparseBooleanArray clone = null;
        try {
            clone = ((android.util.SparseBooleanArray) (super.clone()));
    ...
    public void delete(int key) {
        int i = android.util.ContainerHelpers.binarySearch(mKeys, mSize, key);
        if (i >= 0) {
            java.lang.System.arraycopy(mKeys, i + 1, mKeys, i, mSize - (i + 1));
            java.lang.System.arraycopy(mValues, i + 1, mValues, i, mSize - (i + 1));
            mSize--;
        }
    }
    ...
    public void removeAt(int index) {
        java.lang.System.arraycopy(mKeys, index + 1, mKeys, index, mSize - (index + 1));
    ...
    public boolean equals(java.lang.Object that) {
        ...
        if (!(that instanceof android.util.SparseBooleanArray)) {
            return false;
        }
        android.util.SparseBooleanArray other = ((android.util.SparseBooleanArray) (that));
