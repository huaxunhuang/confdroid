...
public final class Rational extends java.lang.Number implements java.lang.Comparable<android.util.Rational> {
            ...
            if ((denominator == 0) && (numerator < 0)) {
                ...
                if ((denominator == 0) && (numerator == 0)) {
                    ...
                    if (numerator == 0) {
                        ...
                        int gcd = android.util.Rational.gcd(numerator, denominator);
     ...
     *
     * <pre>{@code (new Rational(1, 2)).equals(new Rational(1, 2)) == true   // trivially true
     * (new Rational(2, 3)).equals(new Rational(1, 2)) == false  // trivially false
     * (new Rational(1, 2)).equals(new Rational(2, 4)) == true   // true after reduction
     * (new Rational(0, 0)).equals(new Rational(0, 0)) == true   // NaN.equals(NaN)
     * (new Rational(1, 0)).equals(new Rational(5, 0)) == true   // both are +infinity
     * (new Rational(1, 0)).equals(new Rational(-1, 0)) == false // +infinity != -infinity}</pre>
     *
     * @param obj
    ...
    public int compareTo(android.util.Rational another) {
        ...
        if (equals(another)) {
            ...
            if (isNaN()) {
                // NaN is greater than the other non-NaN value
                return 1;
            } else
                if (another.isNaN()) {
                    // the other NaN is greater than this non-NaN value
                    return -1;
                } else
    ...
    private void readObject(java.io.ObjectInputStream in) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        if (mNumerator == 0) {
            ...
            if (mDenominator == 0) {
                ...
                // finite value
                if (android.util.Rational.gcd(mNumerator, mDenominator) > 1) {
    ...
    private static java.lang.NumberFormatException invalidRational(java.lang.String s) {
        throw new java.lang.NumberFormatException(("Invalid Rational: \"" + s) + "\"");
    }
     ...
     *
     * <pre>{@code Rational.parseRational("3:+6").equals(new Rational(1, 2)) == true
     * Rational.parseRational("-3/-6").equals(new Rational(1, 2)) == true
     * Rational.parseRational("4.56") => throws NumberFormatException}</pre>
     *
     * @param string
     ...
     */
    public static android.util.Rational parseRational(java.lang.String string) throws java.lang.NumberFormatException {
        ...
        if (sep_ix < 0) {
            throw android.util.Rational.invalidRational(string);
        }
        try {
            return new android.util.Rational(java.lang.Integer.parseInt(string.substring(0, sep_ix)), java.lang.Integer.parseInt(string.substring(sep_ix + 1)));
