...
public final class SizeF {
    ...
    public SizeF(final float width, final float height) {
        mWidth = com.android.internal.util.Preconditions.checkArgumentFinite(width, "width");
        mHeight = com.android.internal.util.Preconditions.checkArgumentFinite(height, "height");
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof android.util.SizeF) {
            final android.util.SizeF other = ((android.util.SizeF) (obj));
    ...
    private static java.lang.NumberFormatException invalidSizeF(java.lang.String s) {
        throw new java.lang.NumberFormatException(("Invalid SizeF: \"" + s) + "\"");
    }
     ...
     *
     * <pre>{@code SizeF.parseSizeF("3.2*+6").equals(new SizeF(3.2f, 6.0f)) == true
     * SizeF.parseSizeF("-3x-6").equals(new SizeF(-3.0f, -6.0f)) == true
     * SizeF.parseSizeF("4 by 3") => throws NumberFormatException}</pre>
     *
     * @param string
     ...
     * 		if {@code string} was {@code null}
     */
    public static android.util.SizeF parseSizeF(java.lang.String string) throws java.lang.NumberFormatException {
        com.android.internal.util.Preconditions.checkNotNull(string, "string must not be null");
        int sep_ix = string.indexOf('*');
        if (sep_ix < 0) {
            sep_ix = string.indexOf('x');
        }
        if (sep_ix < 0) {
            throw android.util.SizeF.invalidSizeF(string);
        }
        try {
            return new android.util.SizeF(java.lang.Float.parseFloat(string.substring(0, sep_ix)), java.lang.Float.parseFloat(string.substring(sep_ix + 1)));
    ...
    @java.lang.Override
    public int hashCode() {
        return java.lang.Float.floatToIntBits(mWidth) ^ java.lang.Float.floatToIntBits(mHeight);
    }
