...
public class DisplayMetrics {
     ...
     */
    public static final int DENSITY_DEFAULT = android.util.DisplayMetrics.DENSITY_MEDIUM;
     ...
     * @unknown 
     */
    public static final float DENSITY_DEFAULT_SCALE = 1.0F / android.util.DisplayMetrics.DENSITY_DEFAULT;
     ...
     *
     * @unknown This value should not be used.
    ...
    public static int DENSITY_DEVICE = android.util.DisplayMetrics.getDeviceDensity();
     ...
     * use {@link #densityDpi}.
     */
    public static final int DENSITY_DEVICE_STABLE = android.util.DisplayMetrics.getDeviceDensity();
    ...
    public void setToDefaults() {
        widthPixels = 0;
        heightPixels = 0;
        density = android.util.DisplayMetrics.DENSITY_DEVICE / ((float) (android.util.DisplayMetrics.DENSITY_DEFAULT));
        densityDpi = android.util.DisplayMetrics.DENSITY_DEVICE;
        scaledDensity = density;
        xdpi = android.util.DisplayMetrics.DENSITY_DEVICE;
        ydpi = android.util.DisplayMetrics.DENSITY_DEVICE;
    ...
    public boolean equals(java.lang.Object o) {
        return (o instanceof android.util.DisplayMetrics) && equals(((android.util.DisplayMetrics) (o)));
    }
    ...
    private static int getDeviceDensity() {
        ...
        return android.os.SystemProperties.getInt("qemu.sf.lcd_density", android.os.SystemProperties.getInt("ro.sf.lcd_density", android.util.DisplayMetrics.DENSITY_DEFAULT));
    }
}
