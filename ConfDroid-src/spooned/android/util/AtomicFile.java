...
public class AtomicFile {
    ...
    public AtomicFile(java.io.File baseName) {
        mBaseName = baseName;
        mBackupName = new java.io.File(baseName.getPath() + ".bak");
    }
    ...
    public java.io.FileOutputStream startWrite() throws java.io.IOException {
        ...
        if (mBaseName.exists()) {
            if (!mBackupName.exists()) {
                if (!mBaseName.renameTo(mBackupName)) {
                    android.util.Log.w("AtomicFile", (("Couldn't rename file " + mBaseName) + " to backup file ") + mBackupName);
                }
            } else {
                mBaseName.delete();
            }
        ...
        try {
            str = new java.io.FileOutputStream(mBaseName);
        } catch (java.io.FileNotFoundException e) {
            java.io.File parent = mBaseName.getParentFile();
            if (!parent.mkdirs()) {
                throw new java.io.IOException("Couldn't create directory " + mBaseName);
            }
            ...
            try {
                ...
                throw new java.io.IOException("Couldn't create " + mBaseName);
            }
        }
        return str;
    }
    ...
    public void truncate() throws java.io.IOException {
        try {
            java.io.FileOutputStream fos = new java.io.FileOutputStream(mBaseName);
            android.os.FileUtils.sync(fos);
            fos.close();
        } catch (java.io.FileNotFoundException e) {
            throw new java.io.IOException("Couldn't append " + mBaseName);
        } catch (java.io.IOException e) {
        }
    }
    ...
    public java.io.FileOutputStream openAppend() throws java.io.IOException {
        try {
            return new java.io.FileOutputStream(mBaseName, true);
        } catch (java.io.FileNotFoundException e) {
            throw new java.io.IOException("Couldn't append " + mBaseName);
        }
    }
