...
public final class Range<T extends java.lang.Comparable<? super T>> {
     ...
     * 		if {@code lower} or {@code upper} is {@code null}
     */
    public Range(final T lower, final T upper) {
        mLower = android.util.Range.checkNotNull(lower, "lower must not be null");
        mUpper = android.util.Range.checkNotNull(upper, "upper must not be null");
     ...
     * 		if {@code lower} or {@code upper} is {@code null}
     */
    public static <T extends java.lang.Comparable<? super T>> android.util.Range<T> create(final T lower, final T upper) {
        return new android.util.Range<T>(lower, upper);
    }
    ...
    public boolean contains(T value) {
        android.util.Range.checkNotNull(value, "value must not be null");
     ...
     * @throws NullPointerException
     * 		if {@code range} was {@code null}
     */
    public boolean contains(android.util.Range<T> range) {
        android.util.Range.checkNotNull(range, "value must not be null");
        ...
        if (obj == null) {
            ...
            if (this == obj) {
                ...
                if (obj instanceof android.util.Range) {
                    ...
                    android.util.Range other = ((android.util.Range) (obj));
     ...
     *
     * @param range
     * 		a non-{@code null} {@code Range<T>} reference
    ...
    public android.util.Range<T> intersect(android.util.Range<T> range) {
        android.util.Range.checkNotNull(range, "range must not be null");
        ...
        if ((cmpLower <= 0) && (cmpUpper >= 0)) {
            ...
            if ((cmpLower >= 0) && (cmpUpper <= 0)) {
                ...
                return android.util.Range.create(cmpLower <= 0 ? mLower : range.mLower, cmpUpper >= 0 ? mUpper : range.mUpper);
            }
     ...
     * @return the intersection of this range and the other range
     * @throws NullPointerException
     * 		if {@code lower} or {@code upper} was {@code null}
     * @throws IllegalArgumentException
     * 		if the ranges are disjoint.
     */
    public android.util.Range<T> intersect(T lower, T upper) {
        android.util.Range.checkNotNull(lower, "lower must not be null");
        android.util.Range.checkNotNull(upper, "upper must not be null");
        ...
        if ((cmpLower <= 0) && (cmpUpper >= 0)) {
            ...
            return android.util.Range.create(cmpLower <= 0 ? mLower : lower, cmpUpper >= 0 ? mUpper : upper);
        }
    }
     ...
     * 		if {@code lower} or {@code upper} was {@code null}
     */
    public android.util.Range<T> extend(T lower, T upper) {
        android.util.Range.checkNotNull(lower, "lower must not be null");
        android.util.Range.checkNotNull(upper, "upper must not be null");
        int cmpLower = lower.compareTo(mLower);
        int cmpUpper = upper.compareTo(mUpper);
     ...
     * 		if {@code value} was {@code null}
     */
    public android.util.Range<T> extend(T value) {
        android.util.Range.checkNotNull(value, "value must not be null");
    ...
    public java.lang.String toString() {
        return java.lang.String.format("[%s, %s]", mLower, mUpper);
    }
    ...
    @java.lang.Override
    public int hashCode() {
        return android.hardware.camera2.utils.HashCodeHelpers.hashCodeGeneric(mLower, mUpper);
    }
