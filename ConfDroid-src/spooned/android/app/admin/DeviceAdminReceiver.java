...
public class DeviceAdminReceiver extends android.content.BroadcastReceiver {
    private static java.lang.String TAG = "DevicePolicy";
    ...
    @android.annotation.IntDef({ android.app.admin.DeviceAdminReceiver.BUGREPORT_FAILURE_FAILED_COMPLETING, android.app.admin.DeviceAdminReceiver.BUGREPORT_FAILURE_FILE_NO_LONGER_AVAILABLE })
    ...
    public android.app.admin.DevicePolicyManager getManager(android.content.Context context) {
        ...
        mManager = ((android.app.admin.DevicePolicyManager) (context.getSystemService(android.content.Context.DEVICE_POLICY_SERVICE)));
        return mManager;
    }
    ...
    public android.content.ComponentName getWho(android.content.Context context) {
        ...
        mWho = new android.content.ComponentName(context, getClass());
        return mWho;
    }
     ...
     *
     * @param context
     * 		The running context as per {@link #onReceive}.
     * @param intent
     * 		The received intent as per {@link #onReceive}.
     */
     ...
     */
    public void onLockTaskModeEntering(android.content.Context context, android.content.Intent intent, java.lang.String pkg) {
    }
     ...
     */
    public java.lang.String onChoosePrivateKeyAlias(android.content.Context context, android.content.Intent intent, int uid, android.net.Uri uri, java.lang.String alias) {
        return null;
    }
     ...
     * 		The received intent as per {@link #onReceive}.
     * @param receivedTime
     * 		The time as given by {@link System#currentTimeMillis()} indicating when
     * 		the current pending update was first available. -1 if no pending update is available.
     */
    public void onSystemUpdatePending(android.content.Context context, android.content.Intent intent, long receivedTime) {
    }
     ...
     * 		The running context as per {@link #onReceive}.
     * @param intent
     * 		The received intent as per {@link #onReceive}. Contains the URI of
     ...
     * @see DevicePolicyManager#requestBugreport
     */
    public void onBugreportShared(android.content.Context context, android.content.Intent intent, java.lang.String bugreportHash) {
    }
     ...
     * @see DevicePolicyManager#requestBugreport
     */
    public void onBugreportFailed(android.content.Context context, android.content.Intent intent, @android.app.admin.DeviceAdminReceiver.BugreportFailureCode
    int failureCode) {
    }
    ...
    public void onReceive(android.content.Context context, android.content.Intent intent) {
        ...
        if (android.app.admin.DeviceAdminReceiver.ACTION_PASSWORD_CHANGED.equals(action)) {
            onPasswordChanged(context, intent);
        } else
            if (android.app.admin.DeviceAdminReceiver.ACTION_PASSWORD_FAILED.equals(action)) {
                onPasswordFailed(context, intent);
            } else
                if (android.app.admin.DeviceAdminReceiver.ACTION_PASSWORD_SUCCEEDED.equals(action)) {
                    onPasswordSucceeded(context, intent);
                } else
                    if (android.app.admin.DeviceAdminReceiver.ACTION_DEVICE_ADMIN_ENABLED.equals(action)) {
                        onEnabled(context, intent);
                    } else
                        if (android.app.admin.DeviceAdminReceiver.ACTION_DEVICE_ADMIN_DISABLE_REQUESTED.equals(action)) {
                            java.lang.CharSequence res = onDisableRequested(context, intent);
                            if (res != null) {
                                android.os.Bundle extras = getResultExtras(true);
                                extras.putCharSequence(android.app.admin.DeviceAdminReceiver.EXTRA_DISABLE_WARNING, res);
                            }
                        } else
                            if (android.app.admin.DeviceAdminReceiver.ACTION_DEVICE_ADMIN_DISABLED.equals(action)) {
                                onDisabled(context, intent);
                            } else
                                if (android.app.admin.DeviceAdminReceiver.ACTION_PASSWORD_EXPIRING.equals(action)) {
                                    onPasswordExpiring(context, intent);
                                } else
                                    if (android.app.admin.DeviceAdminReceiver.ACTION_PROFILE_PROVISIONING_COMPLETE.equals(action)) {
                                        onProfileProvisioningComplete(context, intent);
                                    } else
                                        if (android.app.admin.DeviceAdminReceiver.ACTION_CHOOSE_PRIVATE_KEY_ALIAS.equals(action)) {
                                            int uid = intent.getIntExtra(android.app.admin.DeviceAdminReceiver.EXTRA_CHOOSE_PRIVATE_KEY_SENDER_UID, -1);
                                            android.net.Uri uri = intent.getParcelableExtra(android.app.admin.DeviceAdminReceiver.EXTRA_CHOOSE_PRIVATE_KEY_URI);
                                            java.lang.String alias = intent.getStringExtra(android.app.admin.DeviceAdminReceiver.EXTRA_CHOOSE_PRIVATE_KEY_ALIAS);
                                            java.lang.String chosenAlias = onChoosePrivateKeyAlias(context, intent, uid, uri, alias);
                                            setResultData(chosenAlias);
                                        } else
                                            if (android.app.admin.DeviceAdminReceiver.ACTION_LOCK_TASK_ENTERING.equals(action)) {
                                                java.lang.String pkg = intent.getStringExtra(android.app.admin.DeviceAdminReceiver.EXTRA_LOCK_TASK_PACKAGE);
                                                onLockTaskModeEntering(context, intent, pkg);
                                            } else
                                                if (android.app.admin.DeviceAdminReceiver.ACTION_LOCK_TASK_EXITING.equals(action)) {
                                                    onLockTaskModeExiting(context, intent);
                                                } else
                                                    if (android.app.admin.DeviceAdminReceiver.ACTION_NOTIFY_PENDING_SYSTEM_UPDATE.equals(action)) {
                                                        long receivedTime = intent.getLongExtra(android.app.admin.DeviceAdminReceiver.EXTRA_SYSTEM_UPDATE_RECEIVED_TIME, -1);
                                                        onSystemUpdatePending(context, intent, receivedTime);
                                                    } else
                                                        if (android.app.admin.DeviceAdminReceiver.ACTION_BUGREPORT_SHARING_DECLINED.equals(action)) {
                                                            onBugreportSharingDeclined(context, intent);
                                                        } else
                                                            if (android.app.admin.DeviceAdminReceiver.ACTION_BUGREPORT_SHARE.equals(action)) {
                                                                java.lang.String bugreportFileHash = intent.getStringExtra(android.app.admin.DeviceAdminReceiver.EXTRA_BUGREPORT_HASH);
                                                                onBugreportShared(context, intent, bugreportFileHash);
                                                            } else
                                                                if (android.app.admin.DeviceAdminReceiver.ACTION_BUGREPORT_FAILED.equals(action)) {
                                                                    int failureCode = intent.getIntExtra(android.app.admin.DeviceAdminReceiver.EXTRA_BUGREPORT_FAILURE_REASON, android.app.admin.DeviceAdminReceiver.BUGREPORT_FAILURE_FAILED_COMPLETING);
                                                                    onBugreportFailed(context, intent, failureCode);
                                                                } else
                                                                    if (android.app.admin.DeviceAdminReceiver.ACTION_SECURITY_LOGS_AVAILABLE.equals(action)) {
