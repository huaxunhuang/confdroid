...
public abstract class DevicePolicyManagerInternal {
    ...
    public interface OnCrossProfileWidgetProvidersChangeListener {
         ...
         *
         * @param profileId
         * 		The profile for which the white-listed packages changed.
         * @param packages
         * 		The white-listed packages.
         */
        public void onCrossProfileWidgetProvidersChanged(int profileId, java.util.List<java.lang.String> packages);
    }
    ...
    profile.
     */
    public abstract java.util.List<java.lang.String> getCrossProfileWidgetProviders(int profileId);
     ...
     * 		The listener to add.
     */
    public abstract void addOnCrossProfileWidgetProvidersChangeListener(android.app.admin.DevicePolicyManagerInternal.OnCrossProfileWidgetProvidersChangeListener listener);
     ...
     * 		App uid.
     * @param reqPolicy
     * 		Required policy, for policies see {@link DevicePolicyManager}.
     ...
     *
     * @param packageName
     * 		The package that is suspended
     * @param userId
     * 		The user having the suspended package.
     * @return The intent to trigger the admin support dialog.
     */
    public abstract android.content.Intent createPackageSuspendedDialogIntent(java.lang.String packageName, int userId);
}
