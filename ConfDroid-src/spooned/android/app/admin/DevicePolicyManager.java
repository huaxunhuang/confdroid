...
public class DevicePolicyManager {
    ...
    private DevicePolicyManager(android.content.Context context, boolean parentInstance) {
        this(context, IDevicePolicyManager.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.DEVICE_POLICY_SERVICE)), parentInstance);
    }
    ...
    protected DevicePolicyManager(android.content.Context context, android.app.admin.IDevicePolicyManager service, boolean parentInstance) {
        mContext = context;
        mService = service;
     ...
     * @unknown 
     */
    public static android.app.admin.DevicePolicyManager create(android.content.Context context) {
        android.app.admin.DevicePolicyManager me = new android.app.admin.DevicePolicyManager(context, false);
     ...
     * @unknown 
     */
    public static final java.lang.String ACTION_BUGREPORT_SHARING_ACCEPTED = "com.android.server.action.BUGREPORT_SHARING_ACCEPTED";
     ...
     * @unknown 
     */
    public static final java.lang.String ACTION_BUGREPORT_SHARING_DECLINED = "com.android.server.action.BUGREPORT_SHARING_DECLINED";
     ...
     * android package archive at the download location specified in {@link #EXTRA_PROVISIONING_DEVICE_ADMIN_PACKAGE_DOWNLOAD_LOCATION}.
     *
     ...
     *
     *
     * @unknown Activity action: ask the user to add a new device administrator as the profile owner
     ...
     *
     *
     * @unknown Name of the profile owner admin that controls the user.
     */
    @android.annotation.SystemApi
     ...
     */
    public static final int FLAG_PARENT_CAN_ACCESS_MANAGED = 0x1;
     ...
     */
    public static final int FLAG_MANAGED_CAN_ACCESS_PARENT = 0x2;
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.app.admin.DevicePolicyManager.STATE_USER_UNMANAGED, android.app.admin.DevicePolicyManager.STATE_USER_SETUP_INCOMPLETE, android.app.admin.DevicePolicyManager.STATE_USER_SETUP_COMPLETE, android.app.admin.DevicePolicyManager.STATE_USER_SETUP_FINALIZED, android.app.admin.DevicePolicyManager.STATE_USER_PROFILE_COMPLETE })
    ...
    otherwise
     */
    public boolean isAdminActive(@android.annotation.NonNull
     ...
     * @unknown 
     */
    public boolean isAdminActiveAsUser(@android.annotation.NonNull
    android.content.ComponentName admin, int userId) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public boolean isRemovingAdmin(@android.annotation.NonNull
    android.content.ComponentName admin, int userId) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public java.util.List<android.content.ComponentName> getActiveAdminsAsUser(int userId) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public boolean packageHasActiveAdmins(java.lang.String packageName, int userId) {
        if (mService != null) {
            try {
     ...
     * 		if the caller is not in the owner application of {@code admin}.
     */
    public void removeActiveAdmin(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     *
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associated with. Must be an
     * 		active administrator, or an exception will be thrown.
     * @param usesPolicy
     * 		Which uses-policy to check, as defined in {@link DeviceAdminInfo}.
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator.
     */
    public boolean hasGrantedPolicy(@android.annotation.NonNull
    android.content.ComponentName admin, int usesPolicy) {
     ...
     *
     *
     * @unknown adb shell dpm set-{device,profile}-owner will normally not allow installing an owner to
     ...
     *
     *
     * @unknown See {@link #ACCOUNT_FEATURE_DEVICE_OR_PROFILE_OWNER_ALLOWED}
     */
     ...
     *
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param quality
     * 		The new desired quality. One of {@link #PASSWORD_QUALITY_UNSPECIFIED},
     ...
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator or if {@code admin}
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordQuality(@android.annotation.NonNull
    android.content.ComponentName admin, int quality) {
        if (mService != null) {
            try {
     ...
     *
     * @param admin
     * 		The name of the admin component to check, or {@code null} to aggregate
     * 		all admins.
     */
    public int getPasswordQuality(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     *
     *
     * @unknown per-user version
     */
    public int getPasswordQuality(@android.annotation.Nullable
    android.content.ComponentName admin, int userHandle) {
        if (mService != null) {
            try {
        ...
        return android.app.admin.DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED;
    }
     ...
     * 		restriction.
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator or {@code admin}
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumLength(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     * 		all admins.
     */
    public int getPasswordMinimumLength(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumUpperCase(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     *
     * @param admin
     * 		The name of the admin component to check, or {@code null} to
     * 		aggregate all admins.
     * @return The minimum number of upper case letters required in the
    password.
     */
    public int getPasswordMinimumUpperCase(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumLowerCase(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
    ...
    password.
     */
    public int getPasswordMinimumLowerCase(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumLetters(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     */
    public int getPasswordMinimumLetters(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumNumeric(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     */
    public int getPasswordMinimumNumeric(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumSymbols(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     */
    public int getPasswordMinimumSymbols(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordMinimumNonLetter(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     * @return The minimum number of letters required in the password.
     */
    public int getPasswordMinimumNonLetter(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		does not use {@link DeviceAdminInfo#USES_POLICY_LIMIT_PASSWORD}
     */
    public void setPasswordHistoryLength(@android.annotation.NonNull
    android.content.ComponentName admin, int length) {
        if (mService != null) {
            try {
     ...
     */
    public void setPasswordExpirationTimeout(@android.annotation.NonNull
    android.content.ComponentName admin, long timeout) {
        if (mService != null) {
            try {
     ...
     *
     * @param admin
     * 		The name of the admin component to check, or {@code null} to aggregate all admins.
     * @return The timeout for the given admin or the minimum of all timeouts
     */
    public long getPasswordExpirationTimeout(@android.annotation.Nullable
    android.content.ComponentName admin) {
        if (mService != null) {
            try {
     ...
     */
    public long getPasswordExpiration(@android.annotation.Nullable
    android.content.ComponentName admin) {
        if (mService != null) {
            try {
     ...
     */
    public int getPasswordHistoryLength(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     *
     * @param userHandle
     * 		the userId of the profile to check the password for.
     * @return Returns true if the password would meet the current requirements, else false.
     * @throws SecurityException
     * 		if {@code userHandle} is not a managed profile.
     * @unknown 
     */
     ...
     * 		be wiped.
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator or does not use
     * 		both {@link DeviceAdminInfo#USES_POLICY_WATCH_LOGIN} and
     * 		{@link DeviceAdminInfo#USES_POLICY_WIPE_DATA}.
     */
    public void setMaximumFailedPasswordsForWipe(@android.annotation.NonNull
    android.content.ComponentName admin, int num) {
        if (mService != null) {
            try {
     ...
     * 		all admins.
     */
    public int getMaximumFailedPasswordsForWipe(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * user passed in.
     *
     * @unknown Used only by Keyguard
     */
    public int getProfileWithMinimumFailedPasswordsForWipe(int userHandle) {
        if (mService != null) {
            try {
                return mService.getProfileWithMinimumFailedPasswordsForWipe(userHandle, mParentInstance);
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
     ...
     */
    public static final int RESET_PASSWORD_REQUIRE_ENTRY = 0x1;
     ...
     */
    public static final int RESET_PASSWORD_DO_NOT_ASK_CREDENTIALS_ON_BOOT = 0x2;
     ...
     * @param flags
     * 		May be 0 or combination of {@link #RESET_PASSWORD_REQUIRE_ENTRY} and
     ...
     * 		if the password does not meet system requirements.
     */
    public boolean resetPassword(java.lang.String password, int flags) {
     ...
     * 		is no restriction.
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator or it does not use
     * 		{@link DeviceAdminInfo#USES_POLICY_FORCE_LOCK}
     */
    public void setMaximumTimeToLock(@android.annotation.NonNull
    android.content.ComponentName admin, long timeMs) {
        if (mService != null) {
            try {
     ...
     */
    public long getMaximumTimeToLock(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     * @unknown 
     */
    public void setRequiredStrongAuthTimeout(@android.annotation.NonNull
    android.content.ComponentName admin, long timeoutMs) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public long getRequiredStrongAuthTimeout(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     */
    public long getRequiredStrongAuthTimeout(@android.annotation.Nullable
    android.content.ComponentName admin, @android.annotation.UserIdInt
    int userId) {
        if (mService != null) {
            try {
        ...
        return android.app.admin.DevicePolicyManager.DEFAULT_STRONG_AUTH_TIMEOUT_MS;
    }
     ...
     */
    public static final int WIPE_EXTERNAL_STORAGE = 0x1;
     ...
     */
    public static final int WIPE_RESET_PROTECTION_DATA = 0x2;
     ...
     * @param exclusionList
     * 		a list of domains to be excluded from the global proxy.
     ...
     * @unknown 
     */
    public android.content.ComponentName setGlobalProxy(@android.annotation.NonNull
    android.content.ComponentName admin, java.net.Proxy proxySpec, java.util.List<java.lang.String> exclusionList) {
        ...
        if (mService != null) {
            try {
                java.lang.String hostSpec;
                java.lang.String exclSpec;
                if (proxySpec.equals(java.net.Proxy.NO_PROXY)) {
                    hostSpec = null;
                    exclSpec = null;
                } else {
                    if (!proxySpec.type().equals(java.net.Proxy.Type.HTTP)) {
                        throw new java.lang.IllegalArgumentException();
                    }
                    java.net.InetSocketAddress sa = ((java.net.InetSocketAddress) (proxySpec.address()));
                    java.lang.String hostName = sa.getHostName();
                    int port = sa.getPort();
                    java.lang.StringBuilder hostBuilder = new java.lang.StringBuilder();
                    hostSpec = hostBuilder.append(hostName).append(":").append(java.lang.Integer.toString(port)).toString();
                    if (exclusionList == null) {
                        exclSpec = "";
                    } else {
                        java.lang.StringBuilder listBuilder = new java.lang.StringBuilder();
                        boolean firstDomain = true;
                        for (java.lang.String exclDomain : exclusionList) {
                            if (!firstDomain) {
                    ...
                    if (android.net.Proxy.validate(hostName, java.lang.Integer.toString(port), exclSpec) != android.net.Proxy.PROXY_VALID)
                        throw new java.lang.IllegalArgumentException();
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param proxyInfo
     * 		The a {@link ProxyInfo} object defining the new global HTTP proxy. A
     * 		{@code null} value will clear the global HTTP proxy.
     * @throws SecurityException
     * 		if {@code admin} is not the device owner.
     */
    public void setRecommendedGlobalProxy(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
     ...
     */
    public int setStorageEncryption(@android.annotation.NonNull
    android.content.ComponentName admin, boolean encrypt) {
     ...
     *
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associated with.  If null,
     * 		this will return the requested encryption setting as an aggregate of all active
     * 		administrators.
     * @return true if the admin(s) are requesting encryption, false if not.
     */
    public boolean getStorageEncryption(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * @unknown 
     */
    public boolean approveCaCert(java.lang.String alias, int userHandle, boolean approval) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public boolean isCaCertApproved(java.lang.String alias, int userHandle) {
        if (mService != null) {
            try {
     ...
     *
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associated with, or
     ...
     * @throws SecurityException
     * 		if {@code admin} is not {@code null} and not a device or profile
     * 		owner.
     */
    public boolean installCaCert(@android.annotation.Nullable
    android.content.ComponentName admin, byte[] certBuffer) {
     ...
     * 		owner.
     */
    public void uninstallCaCert(@android.annotation.Nullable
    android.content.ComponentName admin, byte[] certBuffer) {
        throwIfParentInstance("uninstallCaCert");
        if (mService != null) {
            try {
                final java.lang.String alias = android.app.admin.DevicePolicyManager.getCaCertAlias(certBuffer);
                mService.uninstallCaCerts(admin, new java.lang.String[]{ alias });
            } catch (java.security.cert.CertificateException e) {
                android.util.Log.w(android.app.admin.DevicePolicyManager.TAG, "Unable to parse certificate", e);
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
     ...
     * 		owner.
     */
    public java.util.List<byte[]> getInstalledCaCerts(@android.annotation.Nullable
    android.content.ComponentName admin) {
        java.util.List<byte[]> certs = new java.util.ArrayList<byte[]>();
        throwIfParentInstance("getInstalledCaCerts");
        if (mService != null) {
            try {
                mService.enforceCanManageCaCerts(admin);
                final com.android.org.conscrypt.TrustedCertificateStore certStore = new com.android.org.conscrypt.TrustedCertificateStore();
                for (java.lang.String alias : certStore.userAliases()) {
                    try {
                        certs.add(certStore.getCertificate(alias).getEncoded());
                    } catch (java.security.cert.CertificateException ce) {
                        android.util.Log.w(android.app.admin.DevicePolicyManager.TAG, "Could not encode certificate: " + alias, ce);
                    }
                }
     ...
     * 		owner.
     */
    public void uninstallAllUserCaCerts(@android.annotation.Nullable
    android.content.ComponentName admin) {
        throwIfParentInstance("uninstallAllUserCaCerts");
        if (mService != null) {
            try {
                mService.uninstallCaCerts(admin, new com.android.org.conscrypt.TrustedCertificateStore().userAliases().toArray(new java.lang.String[0]));
            } catch (android.os.RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
     ...
     * 		owner.
     */
    public boolean hasCaCertInstalled(@android.annotation.Nullable
    android.content.ComponentName admin, byte[] certBuffer) {
        throwIfParentInstance("hasCaCertInstalled");
        if (mService != null) {
            try {
                mService.enforceCanManageCaCerts(admin);
                return android.app.admin.DevicePolicyManager.getCaCertAlias(certBuffer) != null;
            } catch (android.os.RemoteException re) {
                throw re.rethrowFromSystemServer();
            } catch (java.security.cert.CertificateException ce) {
                android.util.Log.w(android.app.admin.DevicePolicyManager.TAG, "Could not parse certificate", ce);
            }
        }
        return false;
    }
     ...
     * 		owner.
     */
    public boolean installKeyPair(@android.annotation.Nullable
    android.content.ComponentName admin, @android.annotation.NonNull
    java.security.PrivateKey privKey, @android.annotation.NonNull
    java.security.cert.Certificate cert, @android.annotation.NonNull
    java.lang.String alias) {
        return installKeyPair(admin, privKey, new java.security.cert.Certificate[]{ cert }, alias, false);
    }
     ...
     * 		with that alias already exists, it will be overwritten.
     * @param requestAccess
     * 		{@code true} to request that the calling app be granted access to the
    ...
    android.content.ComponentName admin, @android.annotation.NonNull
    java.security.PrivateKey privKey, @android.annotation.NonNull
    java.security.cert.Certificate[] certs, @android.annotation.NonNull
    java.lang.String alias, boolean requestAccess) {
        throwIfParentInstance("installKeyPair");
        try {
            final byte[] pemCert = android.security.Credentials.convertToPem(certs[0]);
            byte[] pemChain = null;
            if (certs.length > 1) {
                pemChain = android.security.Credentials.convertToPem(java.util.Arrays.copyOfRange(certs, 1, certs.length));
            }
            final byte[] pkcs8Key = java.security.KeyFactory.getInstance(privKey.getAlgorithm()).getKeySpec(privKey, java.security.spec.PKCS8EncodedKeySpec.class).getEncoded();
            ...
            android.util.Log.w(android.app.admin.DevicePolicyManager.TAG, "Failed to obtain private key material", e);
        } catch (java.security.cert.CertificateException | java.io.IOException e) {
            android.util.Log.w(android.app.admin.DevicePolicyManager.TAG, "Could not pem-encode certificate", e);
        }
        return false;
    }
     ...
     * 		owner.
     */
    public boolean removeKeyPair(@android.annotation.Nullable
    android.content.ComponentName admin, @android.annotation.NonNull
    java.lang.String alias) {
    ...
    doesn't exist.
     */
    private static java.lang.String getCaCertAlias(byte[] certBuffer) throws java.security.cert.CertificateException {
        final java.security.cert.CertificateFactory certFactory = java.security.cert.CertificateFactory.getInstance("X.509");
        final java.security.cert.X509Certificate cert = ((java.security.cert.X509Certificate) (certFactory.generateCertificate(new java.io.ByteArrayInputStream(certBuffer))));
        return new com.android.org.conscrypt.TrustedCertificateStore().getCertificateAlias(cert);
    }
     ...
     * @throws SecurityException
     * 		if {@code admin} is not a device or a profile owner.
     */
    public void setCertInstallerPackage(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
    java.lang.String installerPackage) throws java.lang.SecurityException {
     ...
     * 		if {@code admin} is not a device or a profile owner.
     */
    public java.lang.String getCertInstallerPackage(@android.annotation.NonNull
    android.content.ComponentName admin) throws java.lang.SecurityException {
     ...
     * @unknown 
     */
    public void setAlwaysOnVpnPackage(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
    java.lang.String vpnPackage) throws android.content.pm.PackageManager.NameNotFoundException, java.lang.UnsupportedOperationException {
        /* lockdownEnabled */
     ...
     *
     * @param vpnPackage
     * 		The package name for an installed VPN app on the device, or {@code null} to
     ...
     * 		if {@code vpnPackage} is not installed.
     * @throws UnsupportedOperationException
     * 		if {@code vpnPackage} exists but does not support being
        ...
        if (mService != null) {
            try {
                if (!mService.setAlwaysOnVpnPackage(admin, vpnPackage, lockdownEnabled)) {
                    throw new android.content.pm.PackageManager.NameNotFoundException(vpnPackage);
                }
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
     ...
     * 		if {@code admin} is not a device or a profile owner.
     */
    public java.lang.String getAlwaysOnVpnPackage(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     */
    public void setCameraDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     *
     * @param admin
     * 		The name of the admin component to check, or {@code null} to check whether any admins
     * 		have disabled the camera
     */
    public boolean getCameraDisabled(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * @throws SecurityException
     * 		if {@code admin} is not a device owner, or if there are users other
     * 		than the one managed by the device owner.
     */
    public boolean requestBugreport(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @unknown 
     */
    public boolean getGuestUserDisabled(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setScreenCaptureDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     */
    public boolean getScreenCaptureDisabled(@android.annotation.Nullable
    android.content.ComponentName admin) {
     ...
     * @throws SecurityException
     * 		if {@code admin} is not a device owner.
     */
    public void setAutoTimeRequired(@android.annotation.NonNull
    android.content.ComponentName admin, boolean required) {
     ...
     * @unknown 
     */
    public void setForceEphemeralUsers(@android.annotation.NonNull
    android.content.ComponentName admin, boolean forceEphemeralUsers) {
     ...
     * @unknown 
     */
    public boolean getForceEphemeralUsers(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @throws SecurityException
     * 		if {@code admin} is not an active administrator or does not user
     * 		{@link DeviceAdminInfo#USES_POLICY_DISABLE_KEYGUARD_FEATURES}
     */
    public void setKeyguardDisabledFeatures(@android.annotation.NonNull
    android.content.ComponentName admin, int which) {
        if (mService != null) {
            try {
     ...
     *
     * @param admin
     * 		The name of the admin component to check, or {@code null} to check whether any
     * 		admins have disabled features in keyguard.
     * @return bitfield of flags. See {@link #setKeyguardDisabledFeatures(ComponentName, int)}
    for a list.
     */
    public int getKeyguardDisabledFeatures(@android.annotation.Nullable
    android.content.ComponentName admin) {
    ...
    android.content.ComponentName admin, int userHandle) {
        ...
        return android.app.admin.DevicePolicyManager.KEYGUARD_DISABLE_FEATURES_NONE;
    }
     ...
     * @unknown 
     */
    public void setActiveAdmin(@android.annotation.NonNull
    android.content.ComponentName policyReceiver, boolean refreshing, int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    public void setActiveAdmin(@android.annotation.NonNull
    android.content.ComponentName policyReceiver, boolean refreshing) {
     ...
     * @unknown 
     */
    public void getRemoveWarning(@android.annotation.Nullable
    android.content.ComponentName admin, android.os.RemoteCallback result) {
        if (mService != null) {
            try {
     ...
     *
     *
     * @unknown Sets the given package as the device owner.
    Same as {@link #setDeviceOwner(ComponentName, String)} but without setting a device owner name.
     * @param who
     * 		the component name to be registered as device owner.
     * @return whether the package was successfully registered as the device owner.
     * @throws IllegalArgumentException
     * 		if the package name is null or invalid
     * @throws IllegalStateException
     * 		If the preconditions mentioned are not met.
     */
    public boolean setDeviceOwner(android.content.ComponentName who) {
     ...
     * @unknown 
     */
    public boolean setDeviceOwner(android.content.ComponentName who, int userId) {
     ...
     * @unknown 
     */
    public boolean setDeviceOwner(android.content.ComponentName who, java.lang.String ownerName) {
        return setDeviceOwner(who, ownerName, android.os.UserHandle.USER_SYSTEM);
    }

    /**
     *
     *
     * @unknown Sets the given package as the device owner. The package must already be installed. There
     ...
     * 		the component name to be registered as device owner.
     * @param ownerName
     * 		the human readable name of the institution that owns this device.
     * @param userId
     * 		ID of the user on which the device owner runs.
     * @return whether the package was successfully registered as the device owner.
     * @throws IllegalArgumentException
     * 		if the package name is null or invalid
     * @throws IllegalStateException
     * 		If the preconditions mentioned are not met.
     */
    public boolean setDeviceOwner(android.content.ComponentName who, java.lang.String ownerName, int userId) throws java.lang.IllegalArgumentException, java.lang.IllegalStateException {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public boolean isDeviceOwnerAppOnCallingUser(java.lang.String packageName) {
        return /* callingUserOnly = */
        isDeviceOwnerAppOnAnyUserInner(packageName, true);
    }
     ...
     * @unknown 
     */
    public boolean isDeviceOwnerAppOnAnyUser(java.lang.String packageName) {
        return /* callingUserOnly = */
        isDeviceOwnerAppOnAnyUserInner(packageName, false);
    }
    ...
    public android.content.ComponentName getDeviceOwnerComponentOnCallingUser() {
        return /* callingUserOnly = */
        getDeviceOwnerComponentInner(true);
    }
    ...
    public android.content.ComponentName getDeviceOwnerComponentOnAnyUser() {
        return /* callingUserOnly = */
        getDeviceOwnerComponentInner(false);
    }

    private boolean isDeviceOwnerAppOnAnyUserInner(java.lang.String packageName, boolean callingUserOnly) {
        if (packageName == null) {
            return false;
        }
        final android.content.ComponentName deviceOwner = getDeviceOwnerComponentInner(callingUserOnly);
        if (deviceOwner == null) {
            return false;
        }
    ...
    private android.content.ComponentName getDeviceOwnerComponentInner(boolean callingUserOnly) {
        if (mService != null) {
            try {
     ...
     * @throws SecurityException
     * 		if the caller is not in {@code packageName} or {@code packageName}
     * 		does not own the current device owner component.
     */
    public void clearDeviceOwnerApp(java.lang.String packageName) {
    ...
    public java.lang.String getDeviceOwner() {
        ...
        final android.content.ComponentName name = getDeviceOwnerComponentOnCallingUser();
     ...
     * @param admin
     * 		The component to register as an active admin and profile owner.
     * @param ownerName
     * 		The user-visible name of the entity that is managing this user.
     ...
     */
    @android.annotation.SystemApi
    public boolean setActiveProfileOwner(@android.annotation.NonNull
    android.content.ComponentName admin, @java.lang.Deprecated
    java.lang.String ownerName) throws java.lang.IllegalArgumentException {
     ...
     * @throws SecurityException
     * 		if {@code admin} is not an active profile owner.
     */
    public void clearProfileOwner(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     *
     *
     * @unknown Checks whether the user was already setup.
     */
     ...
     *
     *
     * @unknown Sets the given component as the profile owner of the given user profile. The package must
     ...
     * @param admin
     * 		the component name to be registered as profile owner.
     * @param ownerName
     * 		the human readable name of the organisation associated with this DPM.
     * @param userHandle
     * 		the userId to set the profile owner for.
     ...
     */
    public boolean setProfileOwner(@android.annotation.NonNull
    android.content.ComponentName admin, @java.lang.Deprecated
    java.lang.String ownerName, int userHandle) throws java.lang.IllegalArgumentException {
        if (mService != null) {
            try {
                if (ownerName == null) {
                    ownerName = "";
     ...
     * 		if {@code admin} is not a device owner.
     */
    public void setDeviceOwnerLockScreenInfo(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.CharSequence info) {
     ...
     * @param suspended
     * 		If set to {@code true} than the packages will be suspended, if set to
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public java.lang.String[] setPackagesSuspended(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String[] packageNames, boolean suspended) {
    ...
    android.content.ComponentName admin, java.lang.String packageName) throws android.content.pm.PackageManager.NameNotFoundException {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @throws SecurityException
     * 		if {@code admin} is not a profile owner.
     */
    public void setProfileEnabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associate with.
     * @param profileName
     * 		The name of the profile.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setProfileName(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String profileName) {
     ...
     */
    public boolean isProfileOwnerApp(java.lang.String packageName) {
        throwIfParentInstance("isProfileOwnerApp");
        if (mService != null) {
            try {
                android.content.ComponentName profileOwner = mService.getProfileOwner(myUserId());
    ...
    public android.content.ComponentName getProfileOwner() throws java.lang.IllegalArgumentException {
        ...
        return getProfileOwnerAsUser(android.os.Process.myUserHandle().getIdentifier());
    }
     ...
     * @unknown 
     */
    public android.content.ComponentName getProfileOwnerAsUser(final int userId) throws java.lang.IllegalArgumentException {
        if (mService != null) {
            try {
    ...
    public java.lang.String getProfileOwnerName() throws java.lang.IllegalArgumentException {
        if (mService != null) {
            try {
                return mService.getProfileOwnerName(android.os.Process.myUserHandle().getIdentifier());
            } catch (android.os.RemoteException re) {
                throw re.rethrowFromSystemServer();
            }
        }
     ...
     * @unknown 
     * @param userId
     * 		The user for whom to fetch the profile owner name, if any.
     ...
     */
    @android.annotation.SystemApi
    public java.lang.String getProfileOwnerNameAsUser(int userId) throws java.lang.IllegalArgumentException {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void addPersistentPreferredActivity(@android.annotation.NonNull
    android.content.ComponentName admin, android.content.IntentFilter filter, @android.annotation.NonNull
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void clearPackagePersistentPreferredActivities(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     * @throws NameNotFoundException
     * 		if {@code packageName} is not found
     */
    public void setApplicationRestrictionsManagingPackage(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public java.lang.String getApplicationRestrictionsManagingPackage(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @param settings
     * 		A {@link Bundle} to be parsed by the receiving application, conveying a new
     ...
     */
    public void setApplicationRestrictions(@android.annotation.Nullable
    android.content.ComponentName admin, java.lang.String packageName, android.os.Bundle settings) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param target
     * 		Component name of the agent to be enabled.
     * @param configuration
     ...
     * 		{@link DeviceAdminInfo#USES_POLICY_DISABLE_KEYGUARD_FEATURES}
     */
    public void setTrustAgentConfiguration(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.NonNull
    android.content.ComponentName target, android.os.PersistableBundle configuration) {
        if (mService != null) {
            try {
     ...
     */
    public java.util.List<android.os.PersistableBundle> getTrustAgentConfiguration(@android.annotation.Nullable
    android.content.ComponentName admin, @android.annotation.NonNull
    ...
    public java.util.List<android.os.PersistableBundle> getTrustAgentConfiguration(@android.annotation.Nullable
    android.content.ComponentName admin, @android.annotation.NonNull
    android.content.ComponentName agent, int userHandle) {
        if (mService != null) {
            try {
        ...
        return new java.util.ArrayList<android.os.PersistableBundle>();// empty list
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setCrossProfileCallerIdDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean getCrossProfileCallerIdDisabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setCrossProfileContactsSearchDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean getCrossProfileContactsSearchDisabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     *
     * @param userHandle
     * 		The user for whom to check the contacts search permission
     * @unknown 
     */
    public boolean getCrossProfileContactsSearchDisabled(@android.annotation.NonNull
     ...
     * @unknown 
     */
    public void startManagedQuickContact(java.lang.String actualLookupKey, long actualContactId, boolean isContactIdIgnored, long directoryId, android.content.Intent originalIntent) {
        if (mService != null) {
            try {
                mService.startManagedQuickContact(actualLookupKey, actualContactId, isContactIdIgnored, directoryId, originalIntent);
            } catch (android.os.RemoteException e) {
                throw e.rethrowFromSystemServer();
            }
        }
     ...
     * @unknown 
     */
    public void startManagedQuickContact(java.lang.String actualLookupKey, long actualContactId, android.content.Intent originalIntent) {
        startManagedQuickContact(actualLookupKey, actualContactId, false, android.provider.ContactsContract.Directory.DEFAULT, originalIntent);
    }
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setBluetoothContactSharingDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean getBluetoothContactSharingDisabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param filter
     * 		The {@link IntentFilter} the intent has to match to be also resolved in the
     * 		other profile
     * @param flags
     * 		{@link DevicePolicyManager#FLAG_MANAGED_CAN_ACCESS_PARENT} and
     * 		{@link DevicePolicyManager#FLAG_PARENT_CAN_ACCESS_MANAGED} are supported.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public void addCrossProfileIntentFilter(@android.annotation.NonNull
    android.content.ComponentName admin, android.content.IntentFilter filter, int flags) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void clearCrossProfileIntentFilters(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean setPermittedAccessibilityServices(@android.annotation.NonNull
    android.content.ComponentName admin, java.util.List<java.lang.String> packageNames) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public java.util.List<java.lang.String> getPermittedAccessibilityServices(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param packageName
     * 		Accessibility service package name that needs to be checked.
     * @param userHandle
     * 		user id the admin is running as.
     * @return true if the accessibility service is permitted, otherwise false.
     * @unknown 
     */
    public boolean isAccessibilityServicePermittedByAdmin(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.NonNull
    java.lang.String packageName, int userHandle) {
        if (mService != null) {
            try {
     ...
     */
    @android.annotation.SystemApi
    public java.util.List<java.lang.String> getPermittedAccessibilityServices(int userId) {
        throwIfParentInstance("getPermittedAccessibilityServices");
        if (mService != null) {
            try {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean setPermittedInputMethods(@android.annotation.NonNull
    android.content.ComponentName admin, java.util.List<java.lang.String> packageNames) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public java.util.List<java.lang.String> getPermittedInputMethods(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param packageName
     * 		Input method package name that needs to be checked.
     * @param userHandle
     * 		user id the admin is running as.
     * @return true if the input method is permitted, otherwise false.
     * @unknown 
     */
    public boolean isInputMethodPermittedByAdmin(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.NonNull
    java.lang.String packageName, int userHandle) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public java.util.List<java.lang.String> getKeepUninstalledPackages(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @unknown 
     */
    public void setKeepUninstalledPackages(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.NonNull
     ...
     * @unknown From {@link android.os.Build.VERSION_CODES#N}
     */
    @java.lang.Deprecated
    public android.os.UserHandle createUser(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String name) {
        return null;
    }
     ...
     * @param ownerName
     * 		the human readable name of the organisation associated with this DPM.
     * @param profileOwnerComponent
     * 		The {@link DeviceAdminReceiver} that will be an active admin on
     * 		the user.
     * @param adminExtras
     ...
     */
    @java.lang.Deprecated
    public android.os.UserHandle createAndInitializeUser(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String name, java.lang.String ownerName, @android.annotation.NonNull
    android.content.ComponentName profileOwnerComponent, android.os.Bundle adminExtras) {
        return null;
    }
     ...
     */
    public static final int SKIP_SETUP_WIZARD = 0x1;
     ...
     * @unknown 
     */
    public static final int MAKE_USER_EPHEMERAL = 0x2;
     ...
     * 		The user's name.
     * @param profileOwner
     * 		Which {@link DeviceAdminReceiver} will be profile owner. Has to be in the
     ...
     * 		user.
     * @param flags
     * 		{@link #SKIP_SETUP_WIZARD} is supported.
     * @see UserHandle
     * @return the {@link android.os.UserHandle} object for the created user, or {@code null} if the
    user could not be created.
     * @throws SecurityException
     * 		if {@code admin} is not a device owner.
     */
    public android.os.UserHandle createAndManageUser(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.NonNull
    java.lang.String name, @android.annotation.NonNull
    android.content.ComponentName profileOwner, @android.annotation.Nullable
    android.os.PersistableBundle adminExtras, int flags) {
     ...
     * 		if {@code admin} is not a device owner.
     */
    public boolean removeUser(@android.annotation.NonNull
    android.content.ComponentName admin, android.os.UserHandle userHandle) {
     ...
     */
    public boolean switchUser(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
    android.os.UserHandle userHandle) {
     ...
     */
    public android.os.Bundle getApplicationRestrictions(@android.annotation.Nullable
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param key
     * 		The key of the restriction. See the constants in {@link android.os.UserManager}
     * 		for the list of keys.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public void addUserRestriction(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String key) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void clearUserRestriction(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String key) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public android.os.Bundle getUserRestrictions(@android.annotation.NonNull
    android.content.ComponentName admin) {
        throwIfParentInstance("getUserRestrictions");
        android.os.Bundle ret = null;
        if (mService != null) {
            try {
        ...
        return ret == null ? new android.os.Bundle() : ret;
    }
     ...
     * @param hidden
     * 		{@code true} if the package should be hidden, {@code false} if it should be
     * 		unhidden.
     * @return boolean Whether the hidden setting of the package was successfully updated.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean setApplicationHidden(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName, boolean hidden) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean isApplicationHidden(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void enableSystemApp(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public int enableSystemApp(@android.annotation.NonNull
    android.content.ComponentName admin, android.content.Intent intent) {
        throwIfParentInstance("enableSystemApp");
        if (mService != null) {
            try {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setAccountManagementDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String accountType, boolean disabled) {
     ...
     */
    public void setLockTaskPackages(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String[] packages) throws java.lang.SecurityException {
     ...
     * @unknown 
     */
    public java.lang.String[] getLockTaskPackages(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     */
    public boolean isLockTaskPermitted(java.lang.String pkg) {
     ...
     * 		if {@code admin} is not a device owner.
     */
    public void setGlobalSetting(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String setting, java.lang.String value) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setSecureSetting(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String setting, java.lang.String value) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setRestrictionsProvider(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param on
     * 		{@code true} to mute master volume, {@code false} to turn mute off.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setMasterVolumeMuted(@android.annotation.NonNull
    android.content.ComponentName admin, boolean on) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean isMasterVolumeMuted(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setUninstallBlocked(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName, boolean uninstallBlocked) {
     ...
     * 		if {@code admin} is not a device or profile owner.
     */
    public boolean isUninstallBlocked(@android.annotation.Nullable
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param packageName
     * 		The package from which widget providers are white-listed.
     ...
     */
    public boolean addCrossProfileWidgetProvider(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param packageName
     * 		The package from which widget providers are no longer white-listed.
     ...
     * @see #getCrossProfileWidgetProviders(android.content.ComponentName)
     */
    public boolean removeCrossProfileWidgetProvider(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName) {
     ...
     * 		if {@code admin} is not a profile owner.
     */
    public java.util.List<java.lang.String> getCrossProfileWidgetProviders(@android.annotation.NonNull
    android.content.ComponentName admin) {
        throwIfParentInstance("getCrossProfileWidgetProviders");
        if (mService != null) {
            try {
                java.util.List<java.lang.String> providers = mService.getCrossProfileWidgetProviders(admin);
                if (providers != null) {
                    return providers;
                }
            } catch (android.os.RemoteException re) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param icon
     * 		the bitmap to set as the photo.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     */
    public void setUserIcon(@android.annotation.NonNull
    android.content.ComponentName admin, android.graphics.Bitmap icon) {
     ...
     *
     * @param admin
     * 		Which {@link DeviceAdminReceiver} this request is associated with. All
     * 		components in the device owner package can set system update policies and the most
     * 		recent policy takes effect.
     * @param policy
     * 		the new policy, or {@code null} to clear the current policy.
     * @throws SecurityException
     * 		if {@code admin} is not a device owner.
     * @see SystemUpdatePolicy
     */
    public void setSystemUpdatePolicy(@android.annotation.NonNull
    android.content.ComponentName admin, android.app.admin.SystemUpdatePolicy policy) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param disabled
     * 		{@code true} disables the keyguard, {@code false} reenables it.
     * @return {@code false} if attempting to disable the keyguard while a lock password was in
    place. {@code true} otherwise.
     * @throws SecurityException
     * 		if {@code admin} is not a device owner.
     */
    public boolean setKeyguardDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param disabled
     * 		{@code true} disables the status bar, {@code false} reenables it.
     * @return {@code false} if attempting to disable the status bar failed. {@code true} otherwise.
     * @throws SecurityException
     * 		if {@code admin} is not a device owner.
     */
    public boolean setStatusBarDisabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean disabled) {
     ...
     * permission.
     *
     * @param updateReceivedTime
     * 		The time as given by {@link System#currentTimeMillis()} indicating
     ...
     * @param policy
     * 		One of the policy constants {@link #PERMISSION_POLICY_PROMPT},
     * 		{@link #PERMISSION_POLICY_AUTO_GRANT} and {@link #PERMISSION_POLICY_AUTO_DENY}.
     * @throws SecurityException
     * 		if {@code admin} is not a device or profile owner.
     * @see #setPermissionGrantState
     */
    public void setPermissionPolicy(@android.annotation.NonNull
    android.content.ComponentName admin, int policy) {
     ...
     */
    public int getPermissionPolicy(android.content.ComponentName admin) {
     ...
     */
    public boolean setPermissionGrantState(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName, java.lang.String permission, int grantState) {
     ...
     */
    public int getPermissionGrantState(@android.annotation.NonNull
    android.content.ComponentName admin, java.lang.String packageName, java.lang.String permission) {
     ...
     */
    public boolean isManagedProfile(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     *
     *
     * @unknown Return if this user is a system-only user. An admin can manage a device from a system only
     ...
     */
    public boolean isSystemOnlyUser(@android.annotation.NonNull
    android.content.ComponentName admin) {
        try {
     ...
     * 		if {@code admin} is not a device owner.
     */
    public java.lang.String getWifiMacAddress(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     */
    public void reboot(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not an active administrator.
     */
    public void setShortSupportMessage(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
     ...
     * 		if {@code admin} is not an active administrator.
     */
    public java.lang.CharSequence getShortSupportMessage(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not an active administrator.
     */
    public void setLongSupportMessage(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
    java.lang.CharSequence message) {
     ...
     * 		if {@code admin} is not an active administrator.
     */
    public java.lang.CharSequence getLongSupportMessage(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @unknown 
     */
    public java.lang.CharSequence getShortSupportMessageForUser(@android.annotation.NonNull
    android.content.ComponentName admin, int userHandle) {
        if (mService != null) {
            try {
     ...
     * @unknown 
     */
    public java.lang.CharSequence getLongSupportMessageForUser(@android.annotation.NonNull
    android.content.ComponentName admin, int userHandle) {
        if (mService != null) {
            try {
     ...
     * 		if {@code admin} is not a profile owner.
     */
    public android.app.admin.DevicePolicyManager getParentProfileInstance(@android.annotation.NonNull
    android.content.ComponentName admin) {
        ...
        try {
            ...
            return new android.app.admin.DevicePolicyManager(mContext, true);
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     */
    public void setSecurityLoggingEnabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean enabled) {
     ...
     * 		if {@code admin} is not a device owner.
     */
    public boolean isSecurityLoggingEnabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * 		if {@code admin} is not a device owner.
     */
    public java.util.List<android.app.admin.SecurityLog.SecurityEvent> retrieveSecurityLogs(@android.annotation.NonNull
    android.content.ComponentName admin) {
        throwIfParentInstance("retrieveSecurityLogs");
        try {
            android.content.pm.ParceledListSlice<android.app.admin.SecurityLog.SecurityEvent> list = mService.retrieveSecurityLogs(admin);
            if (list != null) {
                return list.getList();
            } else {
                // Rate limit exceeded.
     ...
     * @unknown 
     */
    public android.app.admin.DevicePolicyManager getParentProfileInstance(android.content.pm.UserInfo uInfo) {
        mContext.checkSelfPermission(android.Manifest.permission.MANAGE_PROFILE_AND_DEVICE_OWNERS);
        if (!uInfo.isManagedProfile()) {
            throw new java.lang.SecurityException(("The user " + uInfo.id) + " does not have a parent profile.");
        }
        return new android.app.admin.DevicePolicyManager(mContext, true);
    }
     ...
     * 		if {@code admin} is not a device owner.
     */
    public java.util.List<android.app.admin.SecurityLog.SecurityEvent> retrievePreRebootSecurityLogs(@android.annotation.NonNull
    android.content.ComponentName admin) {
        throwIfParentInstance("retrievePreRebootSecurityLogs");
        try {
            android.content.pm.ParceledListSlice<android.app.admin.SecurityLog.SecurityEvent> list = mService.retrievePreRebootSecurityLogs(admin);
            if (list != null) {
                return list.getList();
            } else {
                return null;
     ...
     * 		if {@code admin} is not a profile owner.
     */
    public void setOrganizationColor(@android.annotation.NonNull
    android.content.ComponentName admin, int color) {
     ...
     *
     *
     * @unknown Sets the color used for customization.
     * @param color
     * 		The 24bit (0xRRGGBB) representation of the color to be used.
     * @param userId
     * 		which user to set the color to.
     * @unknown = {
    Manifest.permission.MANAGE_USERS,
    Manifest.permission.INTERACT_ACROSS_USERS_FULL})
     */
    public void setOrganizationColorForUser(@android.annotation.ColorInt
    int color, @android.annotation.UserIdInt
    int userId) {
        try {
            // always enforce alpha channel to have 100% opacity
            color |= 0xff000000;
    ...
    public int getOrganizationColor(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     *
     *
     * @unknown Retrieve the customization color for a given user.
     * @param userHandle
     * 		The user id of the user we're interested in.
     * @return The 24bit (0xRRGGBB) representation of the color to be used.
     */
    @android.annotation.ColorInt
     ...
     * 		Which {@link DeviceAdminReceiver} this request is associated with.
     * @param title
     * 		The organization name or {@code null} to clear a previously set name.
     * @throws SecurityException
     * 		if {@code admin} is not a profile owner.
     */
    public void setOrganizationName(@android.annotation.NonNull
    android.content.ComponentName admin, @android.annotation.Nullable
     ...
     * 		if {@code admin} is not a profile owner.
     */
    public java.lang.CharSequence getOrganizationName(@android.annotation.NonNull
    android.content.ComponentName admin) {
     ...
     * @unknown 
     */
    public java.lang.CharSequence getOrganizationNameForUser(int userHandle) {
        try {
    ...
    public int getUserProvisioningState() {
        ...
        return android.app.admin.DevicePolicyManager.STATE_USER_UNMANAGED;
    }
     ...
     * @unknown 
     */
    public void setUserProvisioningState(@android.app.admin.DevicePolicyManager.UserProvisioningState
    int state, int userHandle) {
        if (mService != null) {
            try {
     ...
     *
     *
     * @unknown Indicates the entity that controls the device or profile owner. A user/profile is considered
     ...
     * 		Which profile or device owner this request is associated with.
     * @param ids
     * 		A set of opaque affiliation ids.
     */
    public void setAffiliationIds(@android.annotation.NonNull
    android.content.ComponentName admin, java.util.Set<java.lang.String> ids) {
        throwIfParentInstance("setAffiliationIds");
        try {
            mService.setAffiliationIds(admin, new java.util.ArrayList<java.lang.String>(ids));
        } catch (android.os.RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
     ...
     *
     *
     * @unknown Returns whether this user/profile is affiliated with the device. See
     ...
     *
     *
     * @unknown Returns whether the uninstall for {@code packageName} for the current user is in queue
    to be started
     * @param packageName
     * 		the package to check for
     * @return whether the uninstall intent for {@code packageName} is pending
     */
    public boolean isUninstallInQueue(java.lang.String packageName) {
        try {
     ...
     * @unknown 
     * @param packageName
     * 		the package containing active DAs to be uninstalled
     */
    public void uninstallPackageWithActiveAdmins(java.lang.String packageName) {
        try {
     ...
     *
     *
     * @unknown Remove a test admin synchronously without sending it a broadcast about being removed.
    If the admin is a profile owner or device owner it will still be removed.
     * @param userHandle
     * 		user id to remove the admin for.
     * @param admin
     * 		The administration compononent to remove.
     * @throws SecurityException
     ...
     */
    public void forceRemoveActiveAdmin(android.content.ComponentName adminReceiver, int userHandle) {
        try {
     ...
     *
     *
     * @unknown Writes that the provisioning configuration has been applied.
     */
    ...
    private void throwIfParentInstance(java.lang.String functionName) {
        if (mParentInstance) {
            throw new java.lang.SecurityException(functionName + " cannot be called on the parent instance");
        }
    }
     ...
     */
    public void setBackupServiceEnabled(@android.annotation.NonNull
    android.content.ComponentName admin, boolean enabled) {
        try {
     ...
     */
    public boolean isBackupServiceEnabled(@android.annotation.NonNull
    android.content.ComponentName admin) {
        try {
