...
public class AssistContent implements android.os.Parcelable {
     ...
     *
     *
     * @unknown Called by {@link android.app.ActivityThread} to set the default Intent based on
     ...
     */
    public void setStructuredData(java.lang.String structuredData) {
    ...
    AssistContent(android.os.Parcel in) {
        if (in.readInt() != 0) {
            mIntent = android.content.Intent.CREATOR.createFromParcel(in);
        }
        if (in.readInt() != 0) {
            mClipData = android.content.ClipData.CREATOR.createFromParcel(in);
        }
        if (in.readInt() != 0) {
    ...
    void writeToParcelInternal(android.os.Parcel dest, int flags) {
        if (mIntent != null) {
            dest.writeInt(1);
    ...
    public static final android.os.Parcelable.Creator<android.app.assist.AssistContent> CREATOR = new android.os.Parcelable.Creator<android.app.assist.AssistContent>() {
        public android.app.assist.AssistContent createFromParcel(android.os.Parcel in) {
            return new android.app.assist.AssistContent(in);
        }

        public android.app.assist.AssistContent[] newArray(int size) {
            return new android.app.assist.AssistContent[size];
        }
    };
}
