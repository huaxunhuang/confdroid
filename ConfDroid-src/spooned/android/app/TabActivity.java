...
public class TabActivity extends android.app.ActivityGroup {
    ...
    protected void onRestoreInstanceState(android.os.Bundle state) {
        ...
        ensureTabHost();
        java.lang.String cur = state.getString("currentTab");
        if (cur != null) {
    ...
    public void onContentChanged() {
        ...
        mTabHost = ((android.widget.TabHost) (findViewById(com.android.internal.R.id.tabhost)));
        if (mTabHost == null) {
    ...
    protected void onChildTitleChanged(android.app.Activity childActivity, java.lang.CharSequence title) {
        ...
        if (getLocalActivityManager().getCurrentActivity() == childActivity) {
            android.view.View tabView = mTabHost.getCurrentTabView();
            if ((tabView != null) && (tabView instanceof android.widget.TextView)) {
                ((android.widget.TextView) (tabView)).setText(title);
            }
        }
    }
