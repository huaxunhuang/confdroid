...
public class JobInfo implements android.os.Parcelable {
    ...
    public static final long getMinPeriodMillis() {
        return android.app.job.JobInfo.MIN_PERIOD_MILLIS;
    }
    ...
    public static final long getMinFlexMillis() {
        return android.app.job.JobInfo.MIN_FLEX_MILLIS;
    }
     ...
     * @unknown 
     */
    public static final int DEFAULT_BACKOFF_POLICY = android.app.job.JobInfo.BACKOFF_POLICY_EXPONENTIAL;
    ...
    public long getIntervalMillis() {
        return intervalMillis >= android.app.job.JobInfo.getMinPeriodMillis() ? intervalMillis : android.app.job.JobInfo.getMinPeriodMillis();
    }
    ...
    public long getFlexMillis() {
        ...
        long clampedFlex = java.lang.Math.max(flexMillis, java.lang.Math.max(percentClamp, android.app.job.JobInfo.getMinFlexMillis()));
    ...
    private JobInfo(android.os.Parcel in) {
        ...
        triggerContentUris = in.createTypedArray(android.app.job.JobInfo.TriggerContentUri.CREATOR);
    ...
    private JobInfo(android.app.job.JobInfo.Builder b) {
        jobId = b.mJobId;
        extras = b.mExtras;
        service = b.mJobService;
        requireCharging = b.mRequiresCharging;
        requireDeviceIdle = b.mRequiresDeviceIdle;
        triggerContentUris = (b.mTriggerContentUris != null) ? b.mTriggerContentUris.toArray(new android.app.job.JobInfo.TriggerContentUri[b.mTriggerContentUris.size()]) : null;
    ...
    public static final android.os.Parcelable.Creator<android.app.job.JobInfo> CREATOR = new android.os.Parcelable.Creator<android.app.job.JobInfo>() {
        @java.lang.Override
        public android.app.job.JobInfo createFromParcel(android.os.Parcel in) {
            return new android.app.job.JobInfo(in);
        }

        @java.lang.Override
        public android.app.job.JobInfo[] newArray(int size) {
            return new android.app.job.JobInfo[size];
        }
    };
    ...
    public static final class TriggerContentUri implements android.os.Parcelable {
         ...
         * @param flags
         * 		Optional flags for the observer, either 0 or
         * 		{@link #FLAG_NOTIFY_FOR_DESCENDANTS}.
         */
        public TriggerContentUri(@android.annotation.NonNull
        android.net.Uri uri, int flags) {
            mUri = uri;
            mFlags = flags;
        }
        ...
        public boolean equals(java.lang.Object o) {
            if (!(o instanceof android.app.job.JobInfo.TriggerContentUri)) {
                return false;
            }
            android.app.job.JobInfo.TriggerContentUri t = ((android.app.job.JobInfo.TriggerContentUri) (o));
            return java.util.Objects.equals(t.mUri, mUri) && (t.mFlags == mFlags);
        }
        ...
        private TriggerContentUri(android.os.Parcel in) {
        ...
        public static final android.os.Parcelable.Creator<android.app.job.JobInfo.TriggerContentUri> CREATOR = new android.os.Parcelable.Creator<android.app.job.JobInfo.TriggerContentUri>() {
            @java.lang.Override
            public android.app.job.JobInfo.TriggerContentUri createFromParcel(android.os.Parcel in) {
                return new android.app.job.JobInfo.TriggerContentUri(in);
            }

            @java.lang.Override
            public android.app.job.JobInfo.TriggerContentUri[] newArray(int size) {
                return new android.app.job.JobInfo.TriggerContentUri[size];
            }
        };
    }
    ...
    public static final class Builder {
        ...
        private int mPriority = android.app.job.JobInfo.PRIORITY_DEFAULT;
        ...
        // Back-off parameters.
        private long mInitialBackoffMillis = android.app.job.JobInfo.DEFAULT_INITIAL_BACKOFF_MILLIS;

        private int mBackoffPolicy = android.app.job.JobInfo.DEFAULT_BACKOFF_POLICY;
         ...
         * @unknown 
         */
        public android.app.job.JobInfo.Builder setPriority(int priority) {
            mPriority = priority;
            return this;
        }
         ...
         * @unknown 
         */
        public android.app.job.JobInfo.Builder setFlags(int flags) {
            mFlags = flags;
            return this;
        }
         ...
         */
        public android.app.job.JobInfo.Builder setExtras(android.os.PersistableBundle extras) {
            mExtras = extras;
            return this;
        }
         ...
         */
        public android.app.job.JobInfo.Builder setRequiredNetworkType(int networkType) {
         ...
         */
        public android.app.job.JobInfo.Builder setRequiresCharging(boolean requiresCharging) {
         ...
         * 		window.
         */
        public android.app.job.JobInfo.Builder setRequiresDeviceIdle(boolean requiresDeviceIdle) {
         ...
         *
         * @param uri
         * 		The content: URI to monitor.
         */
        public android.app.job.JobInfo.Builder addTriggerContentUri(@android.annotation.NonNull
        android.app.job.JobInfo.TriggerContentUri uri) {
            if (mTriggerContentUris == null) {
                mTriggerContentUris = new java.util.ArrayList<>();
            }
         ...
         *
         * @param durationMs
         * 		Delay after most recent content change, in milliseconds.
         */
        public android.app.job.JobInfo.Builder setTriggerContentUpdateDelay(long durationMs) {
         ...
         *
         * @param durationMs
         * 		Delay after initial content change, in milliseconds.
         */
        public android.app.job.JobInfo.Builder setTriggerContentMaxDelay(long durationMs) {
         ...
         * 		Millisecond interval for which this job will repeat.
         */
        public android.app.job.JobInfo.Builder setPeriodic(long intervalMillis) {
         ...
         * 		higher.
         */
        public android.app.job.JobInfo.Builder setPeriodic(long intervalMillis, long flexMillis) {
            mIsPeriodic = true;
         ...
         *
         * @param minLatencyMillis
         * 		Milliseconds before which this job will not be considered for
         * 		execution.
         */
        public android.app.job.JobInfo.Builder setMinimumLatency(long minLatencyMillis) {
         ...
         * {@link android.app.job.JobInfo.Builder#build()} is called.
         */
        public android.app.job.JobInfo.Builder setOverrideDeadline(long maxExecutionDelayMillis) {
         ...
         * 		failed.
         * @param backoffPolicy
         * 		is one of {@link #BACKOFF_POLICY_LINEAR} or
         * 		{@link #BACKOFF_POLICY_EXPONENTIAL}
         */
        public android.app.job.JobInfo.Builder setBackoffCriteria(long initialBackoffMillis, int backoffPolicy) {
         ...
         * 		boot.
         */
        public android.app.job.JobInfo.Builder setPersisted(boolean isPersisted) {
        ...
        public android.app.job.JobInfo build() {
            ...
            if ((((((!mHasEarlyConstraint) && (!mHasLateConstraint)) && (!mRequiresCharging)) && (!mRequiresDeviceIdle)) && (mNetworkType == android.app.job.JobInfo.NETWORK_TYPE_NONE)) && (mTriggerContentUris == null)) {
                throw new java.lang.IllegalArgumentException("You're trying to build a job with no " + "constraints, this is not allowed.");
            }
            mExtras = new android.os.PersistableBundle(mExtras);// Make our own copy.
            ...
            android.app.job.JobInfo job = new android.app.job.JobInfo(this);
            if (job.isPeriodic()) {
                if (job.intervalMillis != job.getIntervalMillis()) {
                    java.lang.StringBuilder builder = new java.lang.StringBuilder();
                    builder.append("Specified interval for ").append(java.lang.String.valueOf(mJobId)).append(" is ");
                    android.util.TimeUtils.formatDuration(mIntervalMillis, builder);
                    builder.append(". Clamped to ");
                    android.util.TimeUtils.formatDuration(job.getIntervalMillis(), builder);
                    android.util.Log.w(android.app.job.JobInfo.TAG, builder.toString());
                }
                if (job.flexMillis != job.getFlexMillis()) {
                    java.lang.StringBuilder builder = new java.lang.StringBuilder();
                    builder.append("Specified flex for ").append(java.lang.String.valueOf(mJobId)).append(" is ");
                    android.util.TimeUtils.formatDuration(mFlexMillis, builder);
                    builder.append(". Clamped to ");
                    android.util.TimeUtils.formatDuration(job.getFlexMillis(), builder);
                    android.util.Log.w(android.app.job.JobInfo.TAG, builder.toString());
                }
            }
            return job;
