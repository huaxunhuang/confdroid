...
public class SearchManager implements android.content.DialogInterface.OnCancelListener , android.content.DialogInterface.OnDismissListener {
     ...
     * See Menu.Item.setAlphabeticShortcut() for more information.
     */
    public static final int MENU_KEYCODE = android.view.KeyEvent.KEYCODE_S;
    ...
    SearchManager(android.content.Context context, android.os.Handler handler) {
        mContext = context;
        mHandler = handler;
        android.app.SearchManager.mService = ISearchManager.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.SEARCH_SERVICE));
    }
     ...
     * @see #stopSearch
     */
    public void startSearch(java.lang.String initialQuery, boolean selectInitialQuery, android.content.ComponentName launchActivity, android.os.Bundle appSearchData, boolean globalSearch) {
     ...
     * @unknown 
     */
    public void startSearch(java.lang.String initialQuery, boolean selectInitialQuery, android.content.ComponentName launchActivity, android.os.Bundle appSearchData, boolean globalSearch, android.graphics.Rect sourceBounds) {
        if (globalSearch) {
            startGlobalSearch(initialQuery, selectInitialQuery, appSearchData, sourceBounds);
            return;
        }
        android.app.UiModeManager uiModeManager = new android.app.UiModeManager();
    ...
    private void ensureSearchDialog() {
        if (mSearchDialog == null) {
            mSearchDialog = new android.app.SearchDialog(mContext, this);
     ...
     */
    /* package */
    void startGlobalSearch(java.lang.String initialQuery, boolean selectInitialQuery, android.os.Bundle appSearchData, android.graphics.Rect sourceBounds) {
        android.content.ComponentName globalSearchActivity = getGlobalSearchActivity();
        if (globalSearchActivity == null) {
            android.util.Log.w(android.app.SearchManager.TAG, "No global search activity found.");
            return;
        }
        android.content.Intent intent = new android.content.Intent(android.app.SearchManager.INTENT_ACTION_GLOBAL_SEARCH);
        intent.addFlags(android.content.Intent.FLAG_ACTIVITY_NEW_TASK);
        intent.setComponent(globalSearchActivity);
        // Make sure that we have a Bundle to put source in
        if (appSearchData == null) {
            appSearchData = new android.os.Bundle();
        } else {
            appSearchData = new android.os.Bundle(appSearchData);
        }
        ...
        if (!android.text.TextUtils.isEmpty(initialQuery)) {
            intent.putExtra(android.app.SearchManager.QUERY, initialQuery);
        }
        if (selectInitialQuery) {
            intent.putExtra(android.app.SearchManager.EXTRA_SELECT_QUERY, selectInitialQuery);
        }
        intent.setSourceBounds(sourceBounds);
        try {
            if (android.app.SearchManager.DBG)
                android.util.Log.d(android.app.SearchManager.TAG, "Starting global search: " + intent.toUri(0));

            mContext.startActivity(intent);
        } catch (android.content.ActivityNotFoundException ex) {
            android.util.Log.e(android.app.SearchManager.TAG, "Global search activity not found: " + globalSearchActivity);
        }
    }
    ...
    public java.util.List<android.content.pm.ResolveInfo> getGlobalSearchActivities() {
        try {
            return android.app.SearchManager.mService.getGlobalSearchActivities();
    ...
    public android.content.ComponentName getGlobalSearchActivity() {
        try {
            return android.app.SearchManager.mService.getGlobalSearchActivity();
        } catch (android.os.RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }
    ...
    public android.content.ComponentName getWebSearchActivity() {
        try {
            return android.app.SearchManager.mService.getWebSearchActivity();
        } catch (android.os.RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }
     ...
     * @see #startSearch
     */
    public void triggerSearch(java.lang.String query, android.content.ComponentName launchActivity, android.os.Bundle appSearchData) {
        if ((query == null) || (android.text.TextUtils.getTrimmedLength(query) == 0)) {
            android.util.Log.w(android.app.SearchManager.TAG, "triggerSearch called with empty query, ignoring.");
            return;
        }
     ...
     *
     * @param listener
     * 		The {@link OnDismissListener} to use, or null.
     */
    public void setOnDismissListener(final android.app.SearchManager.OnDismissListener listener) {
     ...
     *
     * @param listener
     * 		The {@link OnCancelListener} to use, or null.
     */
    ...
    public android.app.SearchableInfo getSearchableInfo(android.content.ComponentName componentName) {
        try {
            return android.app.SearchManager.mService.getSearchableInfo(componentName);
        } catch (android.os.RemoteException ex) {
            throw ex.rethrowFromSystemServer();
        }
    }
     ...
     * @param query
     * 		The search text entered (so far).
     * @return a cursor with suggestions, or <code>null</null> the suggestion query failed.
     * @unknown because SearchableInfo is not part of the API.
     */
    public android.database.Cursor getSuggestions(android.app.SearchableInfo searchable, java.lang.String query) {
     ...
     * @unknown because SearchableInfo is not part of the API.
     */
    public android.database.Cursor getSuggestions(android.app.SearchableInfo searchable, java.lang.String query, int limit) {
        if (searchable == null) {
            return null;
        }
        ...
        if (limit > 0) {
            uriBuilder.appendQueryParameter(android.app.SearchManager.SUGGEST_PARAMETER_LIMIT, java.lang.String.valueOf(limit));
        }
    ...
    public java.util.List<android.app.SearchableInfo> getSearchablesInGlobalSearch() {
        try {
            return android.app.SearchManager.mService.getSearchablesInGlobalSearch();
     ...
     * @unknown 
     */
    public android.content.Intent getAssistIntent(boolean inclContext) {
        try {
            ...
            if (inclContext) {
                ...
                android.os.Bundle extras = am.getAssistContextExtras(android.app.ActivityManager.ASSIST_CONTEXT_BASIC);
                if (extras != null) {
     ...
     *
     * @param args
     * 		the args to pass to the assistant
     * @unknown 
     */
    public void launchAssist(android.os.Bundle args) {
        try {
            if (android.app.SearchManager.mService == null) {
                return;
            }
            android.app.SearchManager.mService.launchAssist(args);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
     ...
     * @unknown 
     */
    public boolean launchLegacyAssist(java.lang.String hint, int userHandle, android.os.Bundle args) {
        try {
            if (android.app.SearchManager.mService == null) {
                return false;
            }
            return android.app.SearchManager.mService.launchLegacyAssist(hint, userHandle, args);
        } catch (android.os.RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
