...
public final class UiAutomation {
     ...
     */
    public static final int ROTATION_FREEZE_0 = android.view.Surface.ROTATION_0;

    /**
     * Rotation constant: Freeze rotation to 90 degrees .
     */
    public static final int ROTATION_FREEZE_90 = android.view.Surface.ROTATION_90;

    /**
     * Rotation constant: Freeze rotation to 180 degrees .
     */
    public static final int ROTATION_FREEZE_180 = android.view.Surface.ROTATION_180;

    /**
     * Rotation constant: Freeze rotation to 270 degrees .
     */
    public static final int ROTATION_FREEZE_270 = android.view.Surface.ROTATION_270;
     ...
     */
    public static final int FLAG_DONT_SUPPRESS_ACCESSIBILITY_SERVICES = 0x1;

    private final java.lang.Object mLock = new java.lang.Object();

    private final java.util.ArrayList<android.view.accessibility.AccessibilityEvent> mEventQueue = new java.util.ArrayList<android.view.accessibility.AccessibilityEvent>();
    ...
    private int mConnectionId = android.app.UiAutomation.CONNECTION_ID_UNDEFINED;
     ...
     *
     * @param looper
     * 		The looper on which to execute accessibility callbacks.
     * @param connection
     * 		The connection for performing privileged operations.
     * @unknown 
     */
    public UiAutomation(android.os.Looper looper, android.app.IUiAutomationConnection connection) {
        if (looper == null) {
            throw new java.lang.IllegalArgumentException("Looper cannot be null!");
        }
        if (connection == null) {
            throw new java.lang.IllegalArgumentException("Connection cannot be null!");
        }
        mUiAutomationConnection = connection;
        mClient = new android.app.UiAutomation.IAccessibilityServiceClientImpl(looper);
    }
     ...
     *
     * @param flags
     * 		Any flags to apply to the automation as it gets connected
     * @unknown 
     */
    public void connect(int flags) {
        ...
        try {
            ...
            throw new java.lang.RuntimeException("Error while connecting UiAutomation", re);
        }
        synchronized(mLock) {
            ...
            try {
                while (true) {
                    ...
                    final long remainingTimeMillis = android.app.UiAutomation.CONNECT_TIMEOUT_MILLIS - elapsedTimeMillis;
    ...
    public void disconnect() {
        synchronized(mLock) {
            if (mIsConnecting) {
                throw new java.lang.IllegalStateException("Cannot call disconnect() while connecting!");
            }
            throwIfNotConnectedLocked();
            mConnectionId = android.app.UiAutomation.CONNECTION_ID_UNDEFINED;
        }
        try {
            // Calling out without a lock held.
            mUiAutomationConnection.disconnect();
        } catch (android.os.RemoteException re) {
            throw new java.lang.RuntimeException("Error while disconnecting UiAutomation", re);
        }
    }
    ...
    public final boolean performGlobalAction(int action) {
        final android.accessibilityservice.IAccessibilityServiceConnection connection;
        synchronized(mLock) {
            throwIfNotConnectedLocked();
            connection = android.view.accessibility.AccessibilityInteractionClient.getInstance().getConnection(mConnectionId);
        }
        // Calling out without a lock held.
        if (connection != null) {
            try {
                ...
                android.util.Log.w(android.app.UiAutomation.LOG_TAG, "Error while calling performGlobalAction", re);
            }
        }
        return false;
    }
    ...
    public final android.accessibilityservice.AccessibilityServiceInfo getServiceInfo() {
        ...
        if (connection != null) {
            try {
                ...
                android.util.Log.w(android.app.UiAutomation.LOG_TAG, "Error while getting AccessibilityServiceInfo", re);
            }
        }
        return null;
    }
    ...
    public final void setServiceInfo(android.accessibilityservice.AccessibilityServiceInfo info) {
        ...
        if (connection != null) {
            try {
                ...
                android.util.Log.w(android.app.UiAutomation.LOG_TAG, "Error while setting AccessibilityServiceInfo", re);
            }
        }
    }
    ...
    public java.util.List<android.view.accessibility.AccessibilityWindowInfo> getWindows() {
        ...
        // Calling out without a lock held.
        return android.view.accessibility.AccessibilityInteractionClient.getInstance().getWindows(connectionId);
    }
    ...
    public android.view.accessibility.AccessibilityNodeInfo getRootInActiveWindow() {
        ...
        // Calling out without a lock held.
        return android.view.accessibility.AccessibilityInteractionClient.getInstance().getRootInActiveWindow(connectionId);
    }
    ...
    public boolean injectInputEvent(android.view.InputEvent event, boolean sync) {
        ...
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, (("Injecting: " + event) + " sync: ") + sync);
            }
            // Calling out without a lock held.
            return mUiAutomationConnection.injectInputEvent(event, sync);
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error while injecting input event!", re);
        }
        return false;
    }
    ...
    public boolean setRotation(int rotation) {
        ...
        switch (rotation) {
            case android.app.UiAutomation.ROTATION_FREEZE_0 :
            case android.app.UiAutomation.ROTATION_FREEZE_90 :
            case android.app.UiAutomation.ROTATION_FREEZE_180 :
            case android.app.UiAutomation.ROTATION_FREEZE_270 :
            case android.app.UiAutomation.ROTATION_UNFREEZE :
            case android.app.UiAutomation.ROTATION_FREEZE_CURRENT :
                {
                    try {
                        // Calling out without a lock held.
                        ...
                        android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error while setting rotation!", re);
                    }
                }
                return false;
            default :
     ...
     */
    public android.view.accessibility.AccessibilityEvent executeAndWaitForEvent(java.lang.Runnable command, android.app.UiAutomation.AccessibilityEventFilter filter, long timeoutMillis) throws java.util.concurrent.TimeoutException {
        ...
        final long executionStartTimeMillis = android.os.SystemClock.uptimeMillis();
            ...
            try {
                ...
                while (true) {
                    ...
                    while (!mEventQueue.isEmpty()) {
                        android.view.accessibility.AccessibilityEvent event = mEventQueue.remove(0);
                    ...
                    if (remainingTimeMillis <= 0) {
                        throw new java.util.concurrent.TimeoutException(("Expected event not received within: " + timeoutMillis) + " ms.");
                    }
                    try {
                        mLock.wait(remainingTimeMillis);
                    } catch (java.lang.InterruptedException ie) {
     ...
     */
    public void waitForIdle(long idleTimeoutMillis, long globalTimeoutMillis) throws java.util.concurrent.TimeoutException {
        synchronized(mLock) {
            throwIfNotConnectedLocked();
            final long startTimeMillis = android.os.SystemClock.uptimeMillis();
            ...
            while (true) {
                final long currentTimeMillis = android.os.SystemClock.uptimeMillis();
                ...
                if (remainingGlobalTimeMillis <= 0) {
                    throw new java.util.concurrent.TimeoutException((("No idle state with idle timeout: " + idleTimeoutMillis) + " within global timeout: ") + globalTimeoutMillis);
                }
    ...
    public android.graphics.Bitmap takeScreenshot() {
        ...
        android.view.Display display = android.hardware.display.DisplayManagerGlobal.getInstance().getRealDisplay(android.view.Display.DEFAULT_DISPLAY);
        ...
        try {
            ...
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error while taking screnshot!", re);
            return null;
        }
        // Rotate the screenshot to the current orientation
        if (rotation != android.app.UiAutomation.ROTATION_FREEZE_0) {
            android.graphics.Bitmap unrotatedScreenShot = android.graphics.Bitmap.createBitmap(displayWidth, displayHeight, android.graphics.Bitmap.Config.ARGB_8888);
            android.graphics.Canvas canvas = new android.graphics.Canvas(unrotatedScreenShot);
            canvas.translate(unrotatedScreenShot.getWidth() / 2, unrotatedScreenShot.getHeight() / 2);
            canvas.rotate(android.app.UiAutomation.getDegreesForRotation(rotation));
    ...
    public void setRunAsMonkey(boolean enable) {
        ...
        try {
            android.app.ActivityManagerNative.getDefault().setUserIsMonkey(enable);
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error while setting run as monkey!", re);
        }
    }
    ...
    public boolean clearWindowContentFrameStats(int windowId) {
        ...
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Clearing content frame stats for window: " + windowId);
            }
            // Calling out without a lock held.
            return mUiAutomationConnection.clearWindowContentFrameStats(windowId);
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error clearing window content frame stats!", re);
        }
        return false;
    }
    ...
    public android.view.WindowContentFrameStats getWindowContentFrameStats(int windowId) {
        ...
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Getting content frame stats for window: " + windowId);
            }
            // Calling out without a lock held.
            return mUiAutomationConnection.getWindowContentFrameStats(windowId);
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error getting window content frame stats!", re);
        }
        return null;
    }
    ...
    public void clearWindowAnimationFrameStats() {
        ...
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Clearing window animation frame stats");
            }
            // Calling out without a lock held.
            mUiAutomationConnection.clearWindowAnimationFrameStats();
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error clearing window animation frame stats!", re);
        }
    }
    ...
    public android.view.WindowAnimationFrameStats getWindowAnimationFrameStats() {
        ...
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Getting window animation frame stats");
            }
            // Calling out without a lock held.
            return mUiAutomationConnection.getWindowAnimationFrameStats();
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error getting window animation frame stats!", re);
        }
        return null;
    }
     ...
     */
    @android.annotation.TestApi
    public boolean grantRuntimePermission(java.lang.String packageName, java.lang.String permission, android.os.UserHandle userHandle) {
        synchronized(mLock) {
            throwIfNotConnectedLocked();
        }
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Granting runtime permission");
            }
            // Calling out without a lock held.
            ...
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error granting runtime permission", re);
        }
        return false;
    }
     ...
     *
     * @param packageName
     * 		The package from which to revoke.
     * @param permission
     ...
     */
    @android.annotation.TestApi
    public boolean revokeRuntimePermission(java.lang.String packageName, java.lang.String permission, android.os.UserHandle userHandle) {
        synchronized(mLock) {
            throwIfNotConnectedLocked();
        }
        try {
            if (android.app.UiAutomation.DEBUG) {
                android.util.Log.i(android.app.UiAutomation.LOG_TAG, "Revoking runtime permission");
            }
            // Calling out without a lock held.
            ...
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error revoking runtime permission", re);
        }
        return false;
    }
    ...
    public android.os.ParcelFileDescriptor executeShellCommand(java.lang.String command) {
        ...
        try {
            ...
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error executing shell command!", ioe);
        } catch (android.os.RemoteException re) {
            android.util.Log.e(android.app.UiAutomation.LOG_TAG, "Error executing shell command!", re);
        } finally {
    ...
    private boolean isConnectedLocked() {
        return mConnectionId != android.app.UiAutomation.CONNECTION_ID_UNDEFINED;
    }

    private void throwIfConnectedLocked() {
        if (mConnectionId != android.app.UiAutomation.CONNECTION_ID_UNDEFINED) {
            throw new java.lang.IllegalStateException("UiAutomation not connected!");
        }
    }
    ...
    private class IAccessibilityServiceClientImpl extends android.accessibilityservice.AccessibilityService.IAccessibilityServiceClientWrapper {
        public IAccessibilityServiceClientImpl(android.os.Looper looper) {
            super(null, looper, new android.accessibilityservice.AccessibilityService.Callbacks() {
                @java.lang.Override
                public void init(int connectionId, android.os.IBinder windowToken) {
                    synchronized(mLock) {
                        android.app.UiAutomation.this.mConnectionId = connectionId;
                        mLock.notifyAll();
                    }
                }
                ...
                public void onAccessibilityEvent(android.view.accessibility.AccessibilityEvent event) {
                    synchronized(mLock) {
                        ...
                        if (mWaitingForEventDelivery) {
                            mEventQueue.add(android.view.accessibility.AccessibilityEvent.obtain(event));
                        }
                        mLock.notifyAll();
                    }
                    // Calling out only without a lock held.
                    final android.app.UiAutomation.OnAccessibilityEventListener listener = mOnAccessibilityEventListener;
                    if (listener != null) {
                        listener.onAccessibilityEvent(android.view.accessibility.AccessibilityEvent.obtain(event));
                    }
                }
