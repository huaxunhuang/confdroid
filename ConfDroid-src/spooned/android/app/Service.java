...
public abstract class Service extends android.content.ContextWrapper implements android.content.ComponentCallbacks2 {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, value = { android.app.Service.STOP_FOREGROUND_REMOVE, android.app.Service.STOP_FOREGROUND_DETACH })
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = false, value = { android.app.Service.START_STICKY_COMPATIBILITY, android.app.Service.START_STICKY, android.app.Service.START_NOT_STICKY, android.app.Service.START_REDELIVER_INTENT })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     */
    public static final int START_FLAG_REDELIVERY = 0x1;
     ...
     */
    public static final int START_FLAG_RETRY = 0x2;
     ...
     * @unknown 
     */
    @android.annotation.IntDef(flag = true, value = { android.app.Service.START_FLAG_REDELIVERY, android.app.Service.START_FLAG_RETRY })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
     ...
     *
     * @param intent
     * 		The Intent supplied to {@link android.content.Context#startService},
    ...
    public int onStartCommand(android.content.Intent intent, @android.app.Service.StartArgFlags
    int flags, int startId) {
        onStart(intent, startId);
        return mStartCompatibility ? android.app.Service.START_STICKY_COMPATIBILITY : android.app.Service.START_STICKY;
    }
    ...
    public final void stopSelf(int startId) {
        ...
        try {
            mActivityManager.stopServiceToken(new android.content.ComponentName(this, mClassName), mToken, startId);
    ...
    public final boolean stopSelfResult(int startId) {
        ...
        try {
            return mActivityManager.stopServiceToken(new android.content.ComponentName(this, mClassName), mToken, startId);
        } catch (android.os.RemoteException ex) {
        }
        return false;
    }
    ...
    public final void setForeground(boolean isForeground) {
        android.util.Log.w(android.app.Service.TAG, "setForeground: ignoring old API call on " + getClass().getName());
    }
    ...
    public final void startForeground(int id, android.app.Notification notification) {
        try {
            mActivityManager.setServiceForeground(new android.content.ComponentName(this, mClassName), mToken, id, notification, 0);
        } catch (android.os.RemoteException ex) {
        }
    }
     ...
     * 		If true, the {@link #STOP_FOREGROUND_REMOVE} flag
     * 		will be supplied.
     * @see #stopForeground(int)
     * @see #startForeground(int, Notification)
     */
    public final void stopForeground(boolean removeNotification) {
        stopForeground(removeNotification ? android.app.Service.STOP_FOREGROUND_REMOVE : 0);
    }
     ...
     *
     * @param flags
     * 		Additional behavior options: {@link #STOP_FOREGROUND_REMOVE},
     * 		{@link #STOP_FOREGROUND_DETACH}.
     * @see #startForeground(int, Notification)
     */
    public final void stopForeground(@android.app.Service.StopForegroundFlags
    int flags) {
        try {
            mActivityManager.setServiceForeground(new android.content.ComponentName(this, mClassName), mToken, 0, null, flags);
        } catch (android.os.RemoteException ex) {
        }
    }
     ...
     * @unknown 
     */
    public final void attach(android.content.Context context, android.app.ActivityThread thread, java.lang.String className, android.os.IBinder token, android.app.Application application, java.lang.Object activityManager) {
        ...
        mActivityManager = ((android.app.IActivityManager) (activityManager));
        mStartCompatibility = getApplicationInfo().targetSdkVersion < android.os.Build.VERSION_CODES.ECLAIR;
    }
    ...
    private java.lang.String mClassName = null;
