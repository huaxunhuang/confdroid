...
public class ListActivity extends android.app.Activity {
    ...
    private java.lang.Runnable mRequestFocus = new java.lang.Runnable() {
        public void run() {
    ...
    public void onContentChanged() {
        ...
        android.view.View emptyView = findViewById(com.android.internal.R.id.empty);
        mList = ((android.widget.ListView) (findViewById(com.android.internal.R.id.list)));
        if (mList == null) {
    ...
    private android.widget.AdapterView.OnItemClickListener mOnClickListener = new android.widget.AdapterView.OnItemClickListener() {
