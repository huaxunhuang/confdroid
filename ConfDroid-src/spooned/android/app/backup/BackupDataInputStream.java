 ...
 * entity's data during a restore operation. Used by {@link BackupHelper} classes within the {@link BackupAgentHelper} mechanism.
 * <p>
...
public class BackupDataInputStream extends java.io.InputStream {
     ...
     *
     * @param b
     * 		Byte array into which the data will be read
     * @param offset
     * 		The data will be stored in {@code b} beginning at this index
     * 		within the array.
     * @param size
     ...
     */
    public int read(byte[] b, int offset, int size) throws java.io.IOException {
