...
public abstract class BackupObserver {
     ...
     *
     * @param currentBackupPackage
     * 		The name of the package that now being backuped.
     * @param backupProgress
     * 		Current progress of backup for the package.
     */
    public void onUpdate(java.lang.String currentBackupPackage, android.app.backup.BackupProgress backupProgress) {
    }
     ...
     *
     * @param currentBackupPackage
     * 		The name of the package that was backuped.
     * @param status
     * 		Zero on success; a nonzero error code if the backup operation failed.
     */
    public void onResult(java.lang.String currentBackupPackage, int status) {
    }
