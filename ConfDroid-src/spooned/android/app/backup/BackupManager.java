 ...
 *
 * @unknown ref android.R.styleable#AndroidManifestApplication_allowBackup
 * @unknown ref android.R.styleable#AndroidManifestApplication_backupAgent
 * @unknown ref android.R.styleable#AndroidManifestApplication_killAfterRestore
 * @unknown ref android.R.styleable#AndroidManifestApplication_restoreAnyVersion
 */
public class BackupManager {
     ...
     */
    @android.annotation.SystemApi
    public static final int ERROR_TRANSPORT_ABORTED = android.app.backup.BackupTransport.TRANSPORT_ERROR;
     ...
     */
    @android.annotation.SystemApi
    public static final int ERROR_TRANSPORT_PACKAGE_REJECTED = android.app.backup.BackupTransport.TRANSPORT_PACKAGE_REJECTED;
     ...
     */
    @android.annotation.SystemApi
    public static final int ERROR_TRANSPORT_QUOTA_EXCEEDED = android.app.backup.BackupTransport.TRANSPORT_QUOTA_EXCEEDED;
     ...
     */
    @android.annotation.SystemApi
    public static final int ERROR_AGENT_FAILURE = android.app.backup.BackupTransport.AGENT_ERROR;
    ...
    private static void checkServiceBinder() {
        if (android.app.backup.BackupManager.sService == null) {
            android.app.backup.BackupManager.sService = IBackupManager.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.BACKUP_SERVICE));
        }
    }
     ...
     *
     * @param context
     * 		The {@link android.content.Context} that was provided when
    ...
    public void dataChanged() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.sService.dataChanged(mContext.getPackageName());
            } catch (android.os.RemoteException e) {
                android.util.Log.d(android.app.backup.BackupManager.TAG, "dataChanged() couldn't connect");
            }
        }
    }
    ...
    public static void dataChanged(java.lang.String packageName) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.sService.dataChanged(packageName);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "dataChanged(pkg) couldn't connect");
            }
        }
    }
     ...
     *
     * @param observer
     * 		The {@link RestoreObserver} to receive callbacks during the restore
    ...
    public int requestRestore(android.app.backup.RestoreObserver observer) {
        ...
        android.app.backup.BackupManager.checkServiceBinder();
        if (android.app.backup.BackupManager.sService != null) {
            android.app.backup.RestoreSession session = null;
            try {
                android.app.backup.IRestoreSession binder = android.app.backup.BackupManager.sService.beginRestoreSession(mContext.getPackageName(), null);
                if (binder != null) {
                    session = new android.app.backup.RestoreSession(mContext, binder);
                    result = session.restorePackage(mContext.getPackageName(), observer);
                }
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "restoreSelf() unable to contact service");
            } finally {
                if (session != null) {
    ...
    public android.app.backup.RestoreSession beginRestoreSession() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                ...
                android.app.backup.IRestoreSession binder = android.app.backup.BackupManager.sService.beginRestoreSession(null, null);
                if (binder != null) {
                    session = new android.app.backup.RestoreSession(mContext, binder);
                }
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "beginRestoreSession() couldn't connect");
            }
        }
        return session;
    }
    ...
    public void setBackupEnabled(boolean isEnabled) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.sService.setBackupEnabled(isEnabled);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "setBackupEnabled() couldn't connect");
            }
        }
    }
    ...
    public boolean isBackupEnabled() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.isBackupEnabled();
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "isBackupEnabled() couldn't connect");
            }
        }
        return false;
    }
    ...
    public void setAutoRestore(boolean isEnabled) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.sService.setAutoRestore(isEnabled);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "setAutoRestore() couldn't connect");
            }
        }
    }
    ...
    public java.lang.String getCurrentTransport() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.getCurrentTransport();
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "getCurrentTransport() couldn't connect");
            }
        }
        return null;
    }
    ...
    public java.lang.String[] listAllTransports() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.listAllTransports();
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "listAllTransports() couldn't connect");
            }
        }
        return null;
    }
    ...
    public java.lang.String selectBackupTransport(java.lang.String transport) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.selectBackupTransport(transport);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "selectBackupTransport() couldn't connect");
            }
        }
        return null;
    }
    ...
    public void backupNow() {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.sService.backupNow();
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "backupNow() couldn't connect");
            }
        }
    }
    ...
    public long getAvailableRestoreToken(java.lang.String packageName) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.getAvailableRestoreToken(packageName);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "getAvailableRestoreToken() couldn't connect");
            }
        }
        return 0;
    }
    ...
    public boolean isAppEligibleForBackup(java.lang.String packageName) {
        ...
        if (android.app.backup.BackupManager.sService != null) {
            try {
                return android.app.backup.BackupManager.sService.isAppEligibleForBackup(packageName);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "isAppEligibleForBackup(pkg) couldn't connect");
            }
        }
        return false;
    }
     ...
     *
     * @param packages
     * 		List of package names to backup.
     * @param observer
     * 		The {@link BackupObserver} to receive callbacks during the backup
     * 		operation. Could be {@code null}.
     * @return {@link BackupManager#SUCCESS} on success; nonzero on error.
     * @exception IllegalArgumentException
     * 		on null or empty {@code packages} param.
     * @unknown 
     */
    @android.annotation.SystemApi
    public int requestBackup(java.lang.String[] packages, android.app.backup.BackupObserver observer) {
        android.app.backup.BackupManager.checkServiceBinder();
        if (android.app.backup.BackupManager.sService != null) {
            try {
                android.app.backup.BackupManager.BackupObserverWrapper observerWrapper = (observer == null) ? null : new android.app.backup.BackupManager.BackupObserverWrapper(mContext, observer);
                return android.app.backup.BackupManager.sService.requestBackup(packages, observerWrapper);
            } catch (android.os.RemoteException e) {
                android.util.Log.e(android.app.backup.BackupManager.TAG, "requestBackup() couldn't connect");
            }
        }
        return -1;
    }
    ...
    private class BackupObserverWrapper extends android.app.backup.IBackupObserver.Stub {
        ...
        BackupObserverWrapper(android.content.Context context, android.app.backup.BackupObserver observer) {
            mHandler = new android.os.Handler(context.getMainLooper()) {
                @java.lang.Override
                public void handleMessage(android.os.Message msg) {
                    switch (msg.what) {
                        case android.app.backup.BackupManager.BackupObserverWrapper.MSG_UPDATE :
                            android.util.Pair<java.lang.String, android.app.backup.BackupProgress> obj = ((android.util.Pair<java.lang.String, android.app.backup.BackupProgress>) (msg.obj));
                            mObserver.onUpdate(obj.first, obj.second);
                            break;
                        case android.app.backup.BackupManager.BackupObserverWrapper.MSG_RESULT :
                            mObserver.onResult(((java.lang.String) (msg.obj)), msg.arg1);
                            break;
                        case android.app.backup.BackupManager.BackupObserverWrapper.MSG_FINISHED :
                            mObserver.backupFinished(msg.arg1);
                            break;
                        default :
                            android.util.Log.w(android.app.backup.BackupManager.TAG, "Unknown message: " + msg);
                            break;
                    }
                }
            };
        ...
        @java.lang.Override
        public void onUpdate(java.lang.String currentPackage, android.app.backup.BackupProgress backupProgress) {
            mHandler.sendMessage(mHandler.obtainMessage(android.app.backup.BackupManager.BackupObserverWrapper.MSG_UPDATE, android.util.Pair.create(currentPackage, backupProgress)));
        }

        @java.lang.Override
        public void onResult(java.lang.String currentPackage, int status) {
            mHandler.sendMessage(mHandler.obtainMessage(android.app.backup.BackupManager.BackupObserverWrapper.MSG_RESULT, status, 0, currentPackage));
        }

        @java.lang.Override
        public void backupFinished(int status) {
            mHandler.sendMessage(mHandler.obtainMessage(android.app.backup.BackupManager.BackupObserverWrapper.MSG_FINISHED, status, 0));
        }
    }
}
