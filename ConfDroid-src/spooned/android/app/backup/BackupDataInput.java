...
public class BackupDataInput {
    ...
    public BackupDataInput(java.io.FileDescriptor fd) {
        ...
        mBackupReader = android.app.backup.BackupDataInput.ctor(fd);
        if (mBackupReader == 0) {
    ...
    protected void finalize() throws java.lang.Throwable {
        try {
            android.app.backup.BackupDataInput.dtor(mBackupReader);
        } finally {
            super.finalize();
        }
    }
    ...
    public boolean readNextHeader() throws java.io.IOException {
        ...
        if (result == 0) {
            ...
            if (result > 0) {
                ...
                // error
                mHeaderReady = false;
                throw new java.io.IOException("failed: 0x" + java.lang.Integer.toHexString(result));
            }
     ...
     */
    public int readEntityData(byte[] data, int offset, int size) throws java.io.IOException {
        if (mHeaderReady) {
