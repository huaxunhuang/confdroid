...
public class RestoreSet implements android.os.Parcelable {
    ...
    public RestoreSet(java.lang.String _name, java.lang.String _dev, long _token) {
        name = _name;
        device = _dev;
        token = _token;
    }
    ...
    public static final android.os.Parcelable.Creator<android.app.backup.RestoreSet> CREATOR = new android.os.Parcelable.Creator<android.app.backup.RestoreSet>() {
        public android.app.backup.RestoreSet createFromParcel(android.os.Parcel in) {
            return new android.app.backup.RestoreSet(in);
        }

        public android.app.backup.RestoreSet[] newArray(int size) {
            return new android.app.backup.RestoreSet[size];
        }
    };
