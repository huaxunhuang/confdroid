...
public class BackupTransport {
    ...
    public int initializeDevice() {
        return android.app.backup.BackupTransport.TRANSPORT_ERROR;
    }
     ...
     * @param flags
     * 		{@link BackupTransport#FLAG_USER_INITIATED} or 0.
     ...
     */
    public int performBackup(android.content.pm.PackageInfo packageInfo, android.os.ParcelFileDescriptor inFd, int flags) {
     ...
     */
    public int performBackup(android.content.pm.PackageInfo packageInfo, android.os.ParcelFileDescriptor inFd) {
        return android.app.backup.BackupTransport.TRANSPORT_ERROR;
    }
     ...
     *
     * @param token
     * 		A backup token as returned by {@link #getAvailableRestoreSets}
     ...
     *
     * @param data
     * 		An open, writable file into which the key/value backup data should be stored.
     * @return the same error codes as {@link #startRestore}.
     */
    public int getRestoreData(android.os.ParcelFileDescriptor outFd) {
        return android.app.backup.BackupTransport.TRANSPORT_ERROR;
    }
     ...
     */
    public int performFullBackup(android.content.pm.PackageInfo targetPackage, android.os.ParcelFileDescriptor socket, int flags) {
    ...
    public int performFullBackup(android.content.pm.PackageInfo targetPackage, android.os.ParcelFileDescriptor socket) {
        return android.app.backup.BackupTransport.TRANSPORT_PACKAGE_REJECTED;
    }
    ...
    public int checkFullBackupSize(long size) {
        return android.app.backup.BackupTransport.TRANSPORT_OK;
    }
     ...
     */
    public boolean isAppEligibleForBackup(android.content.pm.PackageInfo targetPackage, boolean isFullBackup) {
        return true;
    }
     ...
     *
     * @param packageName
     * 		ID of package to provide the quota.
     * @param isFullBackup
     ...
     */
    public long getBackupQuota(java.lang.String packageName, boolean isFullBackup) {
     ...
     */
    public int getNextFullRestoreDataChunk(android.os.ParcelFileDescriptor socket) {
        return 0;
    }
    ...
    class TransportImpl extends com.android.internal.backup.IBackupTransport.Stub {
        ...
        public java.lang.String name() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.name();
        }

        @java.lang.Override
        public android.content.Intent configurationIntent() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.configurationIntent();
        }

        @java.lang.Override
        public java.lang.String currentDestinationString() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.currentDestinationString();
        }

        @java.lang.Override
        public android.content.Intent dataManagementIntent() {
            return android.app.backup.BackupTransport.this.dataManagementIntent();
        }

        @java.lang.Override
        public java.lang.String dataManagementLabel() {
            return android.app.backup.BackupTransport.this.dataManagementLabel();
        }

        @java.lang.Override
        public java.lang.String transportDirName() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.transportDirName();
        }

        @java.lang.Override
        public long requestBackupTime() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.requestBackupTime();
        }

        @java.lang.Override
        public int initializeDevice() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.initializeDevice();
        }
        ...
        public long requestFullBackupTime() throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.requestFullBackupTime();
        }
        ...
        public int performFullBackup(android.content.pm.PackageInfo targetPackage, android.os.ParcelFileDescriptor socket, int flags) throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.performFullBackup(targetPackage, socket, flags);
        }

        @java.lang.Override
        public int checkFullBackupSize(long size) {
            return android.app.backup.BackupTransport.this.checkFullBackupSize(size);
        }

        @java.lang.Override
        public int sendBackupData(int numBytes) throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.sendBackupData(numBytes);
        }
        ...
        public boolean isAppEligibleForBackup(android.content.pm.PackageInfo targetPackage, boolean isFullBackup) throws android.os.RemoteException {
            return android.app.backup.BackupTransport.this.isAppEligibleForBackup(targetPackage, isFullBackup);
        }

        @java.lang.Override
        public long getBackupQuota(java.lang.String packageName, boolean isFullBackup) {
            return android.app.backup.BackupTransport.this.getBackupQuota(packageName, isFullBackup);
        }

        @java.lang.Override
        public int getNextFullRestoreDataChunk(android.os.ParcelFileDescriptor socket) {
            return android.app.backup.BackupTransport.this.getNextFullRestoreDataChunk(socket);
        }

        @java.lang.Override
        public int abortFullRestore() {
            return android.app.backup.BackupTransport.this.abortFullRestore();
        }
    }
}
