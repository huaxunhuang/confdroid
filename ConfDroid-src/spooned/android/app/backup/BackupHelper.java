...
public interface BackupHelper {
     ...
     *
     * @param oldState
     * 		An open, read-only {@link android.os.ParcelFileDescriptor} pointing to the
     * 		last backup state provided by the application. May be
     * 		<code>null</code>, in which case no prior state is being
     * 		provided and the application should perform a full backup.
     * @param data
     * 		An open, read/write {@link BackupDataOutput}
     * 		pointing to the backup data destination.
     * 		Typically the application will use backup helper classes to
     * 		write to this file.
     * @param newState
     * 		An open, read/write {@link android.os.ParcelFileDescriptor} pointing to an
     ...
     *
     * @param data
     * 		An open {@link BackupDataInputStream} from which the backup data can be read.
     */
     ...
     *
     * @param newState
     * 		A {@link android.os.ParcelFileDescriptor} to which the new state will be
     * 		written.
     */
