...
public class FragmentController {
     ...
     */
    public static final android.app.FragmentController createController(android.app.FragmentHostCallback<?> callbacks) {
        return new android.app.FragmentController(callbacks);
    }

    private FragmentController(android.app.FragmentHostCallback<?> callbacks) {
        mHost = callbacks;
    }
     ...
     */
    public void restoreAllState(android.os.Parcelable state, java.util.List<android.app.Fragment> nonConfigList) {
        mHost.mFragmentManager.restoreAllState(state, new android.app.FragmentManagerNonConfig(nonConfigList, null));
    }
     ...
     */
    public void restoreAllState(android.os.Parcelable state, android.app.FragmentManagerNonConfig nonConfig) {
     ...
     *
     * @param retain
     * 		When {@code true}, the loaders aren't stopped, but, their instances
     ...
     */
    public void restoreLoaderNonConfig(android.util.ArrayMap<java.lang.String, android.app.LoaderManager> loaderManagers) {
