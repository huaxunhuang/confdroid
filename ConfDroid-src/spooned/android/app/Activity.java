...
public class Activity extends android.view.ContextThemeWrapper implements android.content.ComponentCallbacks2 , android.view.KeyEvent.Callback , android.view.LayoutInflater.Factory2 , android.view.View.OnCreateContextMenuListener , android.view.Window.Callback , android.view.Window.OnWindowDismissedCallback , android.view.Window.WindowControllerCallback {
     ...
     *
     *
     * @unknown Task isn't finished when activity is finished
     */
     ...
     *
     *
     * @unknown Task is finished if the finishing activity is the root of the task. To preserve the
     ...
     *
     *
     * @unknown Task is finished along with the finishing activity, but it is not removed from
    recents.
     */
    ...
    private static final java.lang.String KEYBOARD_SHORTCUTS_RECEIVER_CLASS_NAME = "com.android.systemui.statusbar.KeyboardShortcutsReceiver";
    ...
    private final java.util.ArrayList<android.app.Activity.ManagedCursor> mManagedCursors = new java.util.ArrayList<android.app.Activity.ManagedCursor>();

    // protected by synchronized (this)
    int mResultCode = android.app.Activity.RESULT_CANCELED;
    ...
    private int mDefaultKeyMode = android.app.Activity.DEFAULT_KEYS_DISABLE;

    private android.text.SpannableStringBuilder mDefaultKeySsb = null;

    private android.app.ActivityManager.TaskDescription mTaskDescription = new android.app.ActivityManager.TaskDescription();

    protected static final int[] FOCUSED_STATE_SET = new int[]{ com.android.internal.R.attr.state_focused };
    ...
    android.os.Bundle savedInstanceState) {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("onCreate " + this) + ": ") + savedInstanceState);
    ...
    android.os.Bundle savedInstanceState, @android.annotation.Nullable
     ...
     */
    final void performRestoreInstanceState(android.os.Bundle savedInstanceState) {
     ...
     * 		contains the saved state
     * @param persistentState
     * 		contains the persistable saved state
     */
    final void performRestoreInstanceState(android.os.Bundle savedInstanceState, android.os.PersistableBundle persistentState) {
    ...
    protected void onRestoreInstanceState(android.os.Bundle savedInstanceState) {
        if (mWindow != null) {
            android.os.Bundle windowState = savedInstanceState.getBundle(android.app.Activity.WINDOW_HIERARCHY_TAG);
            if (windowState != null) {
     ...
     * @see #onSaveInstanceState
     */
    public void onRestoreInstanceState(android.os.Bundle savedInstanceState, android.os.PersistableBundle persistentState) {
        if (savedInstanceState != null) {
            onRestoreInstanceState(savedInstanceState);
        }
    }
    ...
    private void restoreManagedDialogs(android.os.Bundle savedInstanceState) {
        final android.os.Bundle b = savedInstanceState.getBundle(android.app.Activity.SAVED_DIALOGS_TAG);
        if (b == null) {
            return;
        }
        final int[] ids = b.getIntArray(android.app.Activity.SAVED_DIALOG_IDS_KEY);
        final int numDialogs = ids.length;
        mManagedDialogs = new android.util.SparseArray<android.app.Activity.ManagedDialog>(numDialogs);
        for (int i = 0; i < numDialogs; i++) {
            final java.lang.Integer dialogId = ids[i];
            android.os.Bundle dialogState = b.getBundle(android.app.Activity.savedDialogKeyFor(dialogId));
            if (dialogState != null) {
                // Calling onRestoreInstanceState() below will invoke dispatchOnCreate
                // so tell createDialog() not to do it, otherwise we get an exception
                final android.app.Activity.ManagedDialog md = new android.app.Activity.ManagedDialog();
                md.mArgs = b.getBundle(android.app.Activity.savedDialogArgsKeyFor(dialogId));
    ...
    private android.app.Dialog createDialog(java.lang.Integer dialogId, android.os.Bundle state, android.os.Bundle args) {
        final android.app.Dialog dialog = onCreateDialog(dialogId, args);
        if (dialog == null) {
            return null;
        }
    ...
    private static java.lang.String savedDialogKeyFor(int key) {
        return android.app.Activity.SAVED_DIALOG_KEY_PREFIX + key;
    }

    private static java.lang.String savedDialogArgsKeyFor(int key) {
        return android.app.Activity.SAVED_DIALOG_ARGS_KEY_PREFIX + key;
    }
     ...
     */
    @android.annotation.CallSuper
    protected void onPostCreate(@android.annotation.Nullable
    android.os.Bundle savedInstanceState) {
        if (!isChild()) {
            mTitleReady = true;
     ...
     * @see #onCreate
     */
    public void onPostCreate(@android.annotation.Nullable
    android.os.Bundle savedInstanceState, @android.annotation.Nullable
    android.os.PersistableBundle persistentState) {
    ...
    protected void onStart() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onStart " + this);
    ...
    protected void onResume() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onResume " + this);
    ...
    void setVoiceInteractor(com.android.internal.app.IVoiceInteractor voiceInteractor) {
        if (mVoiceInteractor != null) {
            for (android.app.VoiceInteractor.Request activeRequest : mVoiceInteractor.getActiveRequests()) {
        ...
        if (voiceInteractor == null) {
            ...
            mVoiceInteractor = new android.app.VoiceInteractor(voiceInteractor, this, this, android.os.Looper.myLooper());
        }
    }
    ...
    public boolean isVoiceInteractionRoot() {
        try {
            return (mVoiceInteractor != null) && android.app.ActivityManagerNative.getDefault().isRootVoiceInteraction(mToken);
    ...
    public boolean isLocalVoiceInteractionSupported() {
        try {
            return android.app.ActivityManagerNative.getDefault().supportsLocalVoiceInteraction();
     ...
     *
     * @param privateOptions
     * 		a Bundle of private arguments to the current voice interaction service
     */
    public void startLocalVoiceInteraction(android.os.Bundle privateOptions) {
        try {
            android.app.ActivityManagerNative.getDefault().startLocalVoiceInteraction(mToken, privateOptions);
        } catch (android.os.RemoteException re) {
        }
    }
    ...
    public void stopLocalVoiceInteraction() {
        try {
            android.app.ActivityManagerNative.getDefault().stopLocalVoiceInteraction(mToken);
        } catch (android.os.RemoteException re) {
        }
    }
     ...
     */
    final void performSaveInstanceState(android.os.Bundle outState) {
        onSaveInstanceState(outState);
        saveManagedDialogs(outState);
        mActivityTransitionState.saveState(outState);
        storeHasCurrentPermissionRequest(outState);
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("onSaveInstanceState " + this) + ": ") + outState);
     ...
     * 		The bundle to save persistent state to.
     */
    final void performSaveInstanceState(android.os.Bundle outState, android.os.PersistableBundle outPersistentState) {
        onSaveInstanceState(outState, outPersistentState);
        saveManagedDialogs(outState);
        storeHasCurrentPermissionRequest(outState);
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (((("onSaveInstanceState " + this) + ": ") + outState) + ", ") + outPersistentState);
    ...
    protected void onSaveInstanceState(android.os.Bundle outState) {
        outState.putBundle(android.app.Activity.WINDOW_HIERARCHY_TAG, mWindow.saveHierarchyState());
    ...
    private void saveManagedDialogs(android.os.Bundle outState) {
        ...
        for (int i = 0; i < numDialogs; i++) {
            ...
            ids[i] = key;
            final android.app.Activity.ManagedDialog md = mManagedDialogs.valueAt(i);
            dialogState.putBundle(android.app.Activity.savedDialogKeyFor(key), md.mDialog.onSaveInstanceState());
            if (md.mArgs != null) {
                dialogState.putBundle(android.app.Activity.savedDialogArgsKeyFor(key), md.mArgs);
            }
        }
        dialogState.putIntArray(android.app.Activity.SAVED_DIALOG_IDS_KEY, ids);
        outState.putBundle(android.app.Activity.SAVED_DIALOGS_TAG, dialogState);
    }
    ...
    protected void onPause() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onPause " + this);
     ...
     */
    public void onProvideAssistContent(android.app.assist.AssistContent outContent) {
    }
    ...
    public final void requestShowKeyboardShortcuts() {
        ...
        intent.setComponent(new android.content.ComponentName(android.app.Activity.KEYBOARD_SHORTCUTS_RECEIVER_PKG_NAME, android.app.Activity.KEYBOARD_SHORTCUTS_RECEIVER_CLASS_NAME));
    ...
    public void onProvideKeyboardShortcuts(java.util.List<android.view.KeyboardShortcutGroup> data, android.view.Menu menu, int deviceId) {
        ...
        android.view.KeyboardShortcutGroup group = null;
        int menuSize = menu.size();
        for (int i = 0; i < menuSize; ++i) {
            final android.view.MenuItem item = menu.getItem(i);
            final java.lang.CharSequence title = item.getTitle();
            final char alphaShortcut = item.getAlphabeticShortcut();
            if ((title != null) && (alphaShortcut != java.lang.Character.MIN_VALUE)) {
                if (group == null) {
                    final int resource = mApplication.getApplicationInfo().labelRes;
                    group = new android.view.KeyboardShortcutGroup(resource != 0 ? getString(resource) : null);
                }
                group.addItem(new android.view.KeyboardShortcutInfo(title, alphaShortcut, android.view.KeyEvent.META_CTRL_ON));
            }
        }
        if (group != null) {
            data.add(group);
     ...
     */
    public boolean showAssist(android.os.Bundle args) {
        try {
            return android.app.ActivityManagerNative.getDefault().showAssistFromActivity(mToken, args);
        } catch (android.os.RemoteException e) {
        }
        return false;
    }
    ...
    protected void onStop() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onStop " + this);
    ...
    protected void onDestroy() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onDestroy " + this);
    ...
    public void reportFullyDrawn() {
        if (mDoReportFullyDrawn) {
            ...
            try {
                android.app.ActivityManagerNative.getDefault().reportActivityFullyDrawn(mToken);
            } catch (android.os.RemoteException e) {
            }
        }
    }
    ...
    public boolean isInMultiWindowMode() {
        try {
            return android.app.ActivityManagerNative.getDefault().isInMultiWindowMode(mToken);
        } catch (android.os.RemoteException e) {
        }
        return false;
    }
    ...
    public boolean isInPictureInPictureMode() {
        try {
            return android.app.ActivityManagerNative.getDefault().isInPictureInPictureMode(mToken);
        } catch (android.os.RemoteException e) {
        }
        return false;
    }
    ...
    public void enterPictureInPictureMode() {
        try {
            android.app.ActivityManagerNative.getDefault().enterPictureInPictureMode(mToken);
        } catch (android.os.RemoteException e) {
        }
    }
    ...
    public void onConfigurationChanged(android.content.res.Configuration newConfig) {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("onConfigurationChanged " + this) + ": ") + newConfig);
    ...
    android.app.Activity.NonConfigurationInstances retainNonConfigurationInstances() {
        java.lang.Object activity = onRetainNonConfigurationInstance();
        java.util.HashMap<java.lang.String, java.lang.Object> children = onRetainNonConfigurationChildInstances();
        android.app.FragmentManagerNonConfig fragments = mFragments.retainNestedNonConfig();
        ...
        android.util.ArrayMap<java.lang.String, android.app.LoaderManager> loaders = mFragments.retainLoaderNonConfig();
    ...
    public void onLowMemory() {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, "onLowMemory " + this);
    ...
    public void onTrimMemory(int level) {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("onTrimMemory " + this) + ": ") + level);
    ...
    public final android.database.Cursor managedQuery(android.net.Uri uri, java.lang.String[] projection, java.lang.String selection, java.lang.String sortOrder) {
        android.database.Cursor c = getContentResolver().query(uri, projection, selection, null, sortOrder);
        if (c != null) {
    ...
    public final android.database.Cursor managedQuery(android.net.Uri uri, java.lang.String[] projection, java.lang.String selection, java.lang.String[] selectionArgs, java.lang.String sortOrder) {
        android.database.Cursor c = getContentResolver().query(uri, projection, selection, selectionArgs, sortOrder);
        if (c != null) {
            startManagingCursor(c);
        }
        return c;
     ...
     */
    public void setActionBar(@android.annotation.Nullable
    android.widget.Toolbar toolbar) {
        ...
        if (toolbar != null) {
            final com.android.internal.app.ToolbarActionBar tbab = new com.android.internal.app.ToolbarActionBar(toolbar, getTitle(), this);
            mActionBar = tbab;
    ...
    private void initWindowDecorActionBar() {
        ...
        window.getDecorView();
        if ((isChild() || (!window.hasFeature(android.view.Window.FEATURE_ACTION_BAR))) || (mActionBar != null)) {
            return;
        }
     ...
     *
     * @param tm
     * 		The TransitionManager to use for scene changes.
     */
    public void setContentTransitionManager(android.transition.TransitionManager tm) {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.app.Activity.DEFAULT_KEYS_DISABLE, android.app.Activity.DEFAULT_KEYS_DIALER, android.app.Activity.DEFAULT_KEYS_SHORTCUT, android.app.Activity.DEFAULT_KEYS_SEARCH_LOCAL, android.app.Activity.DEFAULT_KEYS_SEARCH_GLOBAL })
     ...
     * @see #onKeyDown
     */
    public final void setDefaultKeyMode(@android.app.Activity.DefaultKeyMode
    int mode) {
        mDefaultKeyMode = mode;
        // Some modes use a SpannableStringBuilder to track & dispatch input events
        // This list must remain in sync with the switch in onKeyDown()
        switch (mode) {
            case android.app.Activity.DEFAULT_KEYS_DISABLE :
            case android.app.Activity.DEFAULT_KEYS_SHORTCUT :
                mDefaultKeySsb = null;// not used in these modes

                break;
            case android.app.Activity.DEFAULT_KEYS_DIALER :
            case android.app.Activity.DEFAULT_KEYS_SEARCH_LOCAL :
            case android.app.Activity.DEFAULT_KEYS_SEARCH_GLOBAL :
    ...
    public boolean onKeyDown(int keyCode, android.view.KeyEvent event) {
        ...
        if (mDefaultKeyMode == android.app.Activity.DEFAULT_KEYS_DISABLE) {
            return false;
        } else
            if (mDefaultKeyMode == android.app.Activity.DEFAULT_KEYS_SHORTCUT) {
                android.view.Window w = getWindow();
                if (w.hasFeature(android.view.Window.FEATURE_OPTIONS_PANEL) && w.performPanelShortcut(android.view.Window.FEATURE_OPTIONS_PANEL, keyCode, event, android.view.Menu.FLAG_ALWAYS_PERFORM_CLOSE)) {
                    return true;
                }
                return false;
            } else {
                ...
                if ((event.getRepeatCount() != 0) || event.isSystem()) {
                    ...
                    handled = android.text.method.TextKeyListener.getInstance().onKeyDown(null, mDefaultKeySsb, keyCode, event);
                    if (handled && (mDefaultKeySsb.length() > 0)) {
                        // something useable has been typed - dispatch it now.
                        final java.lang.String str = mDefaultKeySsb.toString();
                        clearSpannable = true;
                        switch (mDefaultKeyMode) {
                            case android.app.Activity.DEFAULT_KEYS_DIALER :
                                android.content.Intent intent = new android.content.Intent(android.content.Intent.ACTION_DIAL, android.net.Uri.parse("tel:" + str));
    ...
    public void onWindowDismissed(boolean finishTask) {
        finish(finishTask ? android.app.Activity.FINISH_TASK_WITH_ACTIVITY : android.app.Activity.DONT_FINISH_TASK_WITH_ACTIVITY);
    }
    ...
    public void exitFreeformMode() throws android.os.RemoteException {
        android.app.ActivityManagerNative.getDefault().exitFreeformMode(mToken);
    }
    ...
    public int getWindowStackId() throws android.os.RemoteException {
        return android.app.ActivityManagerNative.getDefault().getActivityStackId(mToken);
    }
    ...
    public void enterPictureInPictureModeIfPossible() {
        if (mActivityInfo.resizeMode == android.content.pm.ActivityInfo.RESIZE_MODE_RESIZEABLE_AND_PIPABLE) {
    ...
    public boolean dispatchKeyEvent(android.view.KeyEvent event) {
        ...
        if (((keyCode == android.view.KeyEvent.KEYCODE_MENU) && (mActionBar != null)) && mActionBar.onMenuKeyEvent(event)) {
            return true;
        } else
            if (event.isCtrlPressed() && (event.getUnicodeChar(event.getMetaState() & (~android.view.KeyEvent.META_CTRL_MASK)) == '<')) {
    ...
    public boolean onMenuOpened(int featureId, android.view.Menu menu) {
        if (featureId == android.view.Window.FEATURE_ACTION_BAR) {
            ...
            if (mActionBar != null) {
                ...
                android.util.Log.e(android.app.Activity.TAG, "Tried to open action bar menu with no action bar");
            }
        }
        return true;
    }
    ...
    public boolean onMenuItemSelected(int featureId, android.view.MenuItem item) {
        java.lang.CharSequence titleCondensed = item.getTitleCondensed();
        switch (featureId) {
            case android.view.Window.FEATURE_OPTIONS_PANEL :
                ...
                if (((item.getItemId() == android.R.id.home) && (mActionBar != null)) && ((mActionBar.getDisplayOptions() & android.app.ActionBar.DISPLAY_HOME_AS_UP) != 0)) {
                    if (mParent == null) {
                        return onNavigateUp();
                    } else {
    ...
    public void invalidateOptionsMenu() {
        if (mWindow.hasFeature(android.view.Window.FEATURE_OPTIONS_PANEL) && ((mActionBar == null) || (!mActionBar.invalidateOptionsMenu()))) {
    ...
    public boolean onNavigateUp() {
        ...
        android.content.Intent upIntent = getParentActivityIntent();
        if (upIntent != null) {
            if (mActivityInfo.taskAffinity == null) {
                ...
                if (shouldUpRecreateTask(upIntent)) {
                    android.app.TaskStackBuilder b = android.app.TaskStackBuilder.create(this);
                    onCreateNavigateUpTaskStack(b);
                    onPrepareNavigateUpTaskStack(b);
                    b.startActivities();
                    // We can't finishAffinity if we have a result.
                    // Fall back and simply finish the current activity instead.
                    if ((mResultCode != android.app.Activity.RESULT_CANCELED) || (mResultData != null)) {
                        // Tell the developer what's going on to avoid hair-pulling.
                        android.util.Log.i(android.app.Activity.TAG, "onNavigateUp only finishing topmost activity to return a result");
                        finish();
                    } else {
                        finishAffinity();
                    }
    ...
    public void openOptionsMenu() {
        if (mWindow.hasFeature(android.view.Window.FEATURE_OPTIONS_PANEL) && ((mActionBar == null) || (!mActionBar.openOptionsMenu()))) {
    ...
    public void closeContextMenu() {
        if (mWindow.hasFeature(android.view.Window.FEATURE_CONTEXT_MENU)) {
     ...
     * @param args
     * 		The dialog arguments provided to {@link #showDialog(int, Bundle)}.
    ...
    public final void dismissDialog(int id) {
        ...
        final android.app.Activity.ManagedDialog md = mManagedDialogs.get(id);
        if (md == null) {
            throw missingDialog(id);
        }
        md.mDialog.dismiss();
     ...
     * unexpected.
     */
    private java.lang.IllegalArgumentException missingDialog(int id) {
        return new java.lang.IllegalArgumentException((("no dialog with id " + id) + " was ever ") + "shown via Activity#showDialog");
    }
     ...
     *
     * @param searchEvent
     * 		The {@link SearchEvent} that signaled this search.
     ...
     */
    public boolean onSearchRequested(@android.annotation.Nullable
    ...
    public boolean onSearchRequested() {
        if ((getResources().getConfiguration().uiMode & android.content.res.Configuration.UI_MODE_TYPE_MASK) != android.content.res.Configuration.UI_MODE_TYPE_TELEVISION) {
     ...
     * 		If true, the initial query will be preselected, which means that
     ...
     */
    public void startSearch(@android.annotation.Nullable
    java.lang.String initialQuery, boolean selectInitialQuery, @android.annotation.Nullable
    android.os.Bundle appSearchData, boolean globalSearch) {
        ensureSearchManager();
     ...
     * 		no extra data is required.
     */
    public void triggerSearch(java.lang.String query, @android.annotation.Nullable
    ...
    public android.view.MenuInflater getMenuInflater() {
        ...
        if (mMenuInflater == null) {
            initWindowDecorActionBar();
            if (mActionBar != null) {
                mMenuInflater = new android.view.MenuInflater(mActionBar.getThemedContext(), this);
            } else {
    ...
    @java.lang.Override
    protected void onApplyThemeResource(android.content.res.Resources.Theme theme, @android.annotation.StyleRes
    int resid, boolean first) {
        if (mParent == null) {
        ...
        android.content.res.TypedArray a = theme.obtainStyledAttributes(com.android.internal.R.styleable.ActivityTaskDescription);
        if (mTaskDescription.getPrimaryColor() == 0) {
            int colorPrimary = a.getColor(com.android.internal.R.styleable.ActivityTaskDescription_colorPrimary, 0);
            if ((colorPrimary != 0) && (android.graphics.Color.alpha(colorPrimary) == 0xff)) {
        ...
        if (mTaskDescription.getBackgroundColor() == 0) {
            ...
            if ((colorBackground != 0) && (android.graphics.Color.alpha(colorBackground) == 0xff)) {
    ...
    java.lang.String[] permissions, int requestCode) {
        if (mHasCurrentPermissionsRequest) {
            android.util.Log.w(android.app.Activity.TAG, "Can reqeust only one set of permissions at a time");
            // Dispatch the callback with empty arrays which means a cancellation.
            onRequestPermissionsResult(requestCode, new java.lang.String[0], new int[0]);
            return;
        }
        android.content.Intent intent = getPackageManager().buildRequestPermissionsIntent(permissions);
        startActivityForResult(android.app.Activity.REQUEST_PERMISSIONS_WHO_PREFIX, intent, requestCode, null);
     ...
     * @see #startActivity
     */
    public void startActivityForResult(@android.annotation.RequiresPermission
     ...
     */
    public void startActivityForResult(@android.annotation.RequiresPermission
    android.content.Intent intent, int requestCode, @android.annotation.Nullable
    android.os.Bundle options) {
        if (mParent == null) {
            options = transferSpringboardActivityOptions(options);
            android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread.getApplicationThread(), mToken, this, intent, requestCode, options);
            if (ar != null) {
     ...
     *
     * @param options
     * 		The ActivityOptions bundle used to start an Activity.
     */
    private void cancelInputsAndStartExitTransition(android.os.Bundle options) {
        final android.view.View decor = (mWindow != null) ? mWindow.peekDecorView() : null;
        if (decor != null) {
    ...
    private android.os.Bundle transferSpringboardActivityOptions(android.os.Bundle options) {
        if ((options == null) && ((mWindow != null) && (!mWindow.isActive()))) {
            final android.app.ActivityOptions activityOptions = getActivityOptions();
            if ((activityOptions != null) && (activityOptions.getAnimationType() == android.app.ActivityOptions.ANIM_SCENE_TRANSITION)) {
     ...
     *
     *
     * @unknown Implement to provide correct calling token.
     */
    public void startActivityForResultAsUser(android.content.Intent intent, int requestCode, android.os.UserHandle user) {
     ...
     * @unknown Implement to provide correct calling token.
     */
    public void startActivityForResultAsUser(android.content.Intent intent, int requestCode, @android.annotation.Nullable
    android.os.Bundle options, android.os.UserHandle user) {
        if (mParent != null) {
            throw new java.lang.RuntimeException("Can't be called from a child");
        }
        options = transferSpringboardActivityOptions(options);
        android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread.getApplicationThread(), mToken, this, intent, requestCode, options, user);
        if (ar != null) {
            mMainThread.sendActivityResult(mToken, mEmbeddedID, requestCode, ar.getResultCode(), ar.getResultData());
        }
        if (requestCode >= 0) {
    ...
    public void startActivityAsUser(android.content.Intent intent, android.os.Bundle options, android.os.UserHandle user) {
        ...
        options = transferSpringboardActivityOptions(options);
        android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread.getApplicationThread(), mToken, this, intent, -1, options, user);
        if (ar != null) {
     ...
     * @param userId
     * 		The user the new activity should run as.
     * @unknown 
     */
    public void startActivityAsCaller(android.content.Intent intent, @android.annotation.Nullable
    android.os.Bundle options, boolean ignoreTargetSecurity, int userId) {
        if (mParent != null) {
            throw new java.lang.RuntimeException("Can't be called from a child");
        }
        options = transferSpringboardActivityOptions(options);
        android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivityAsCaller(this, mMainThread.getApplicationThread(), mToken, this, intent, -1, options, ignoreTargetSecurity, userId);
        if (ar != null) {
            mMainThread.sendActivityResult(mToken, mEmbeddedID, -1, ar.getResultCode(), ar.getResultData());
        }
        cancelInputsAndStartExitTransition(options);
    ...
    private void startIntentSenderForResultInner(android.content.IntentSender intent, java.lang.String who, int requestCode, android.content.Intent fillInIntent, int flagsMask, int flagsValues, android.os.Bundle options) throws android.content.IntentSender.SendIntentException {
        try {
            ...
            int result = android.app.ActivityManagerNative.getDefault().startActivityIntentSender(mMainThread.getApplicationThread(), intent, fillInIntent, resolvedType, mToken, who, requestCode, flagsMask, flagsValues, options);
     ...
     */
    @java.lang.Override
    public void startActivity(android.content.Intent intent, @android.annotation.Nullable
    android.os.Bundle options) {
        if (options != null) {
     ...
     */
    @java.lang.Override
    public void startActivities(android.content.Intent[] intents, @android.annotation.Nullable
    android.os.Bundle options) {
     ...
     * 		Always set to 0.
     */
    public void startIntentSender(android.content.IntentSender intent, @android.annotation.Nullable
    android.content.Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags) throws android.content.IntentSender.SendIntentException {
     ...
     * @see #startActivityForResult
     */
    public boolean startActivityIfNeeded(@android.annotation.RequiresPermission
    @android.annotation.NonNull
    android.content.Intent intent, int requestCode) {
    ...
    android.os.Bundle options) {
        if (mParent == null) {
            int result = android.app.ActivityManager.START_RETURN_INTENT_TO_CALLER;
            try {
                android.net.Uri referrer = onProvideReferrer();
                if (referrer != null) {
                    intent.putExtra(android.content.Intent.EXTRA_REFERRER, referrer);
                }
                intent.migrateExtraStreamToClipData();
                intent.prepareToLeaveProcess(this);
                result = android.app.ActivityManagerNative.getDefault().startActivity(mMainThread.getApplicationThread(), getBasePackageName(), intent, intent.resolveTypeIfNeeded(getContentResolver()), mToken, mEmbeddedID, requestCode, android.app.ActivityManager.START_FLAG_ONLY_IF_NEEDED, null, options);
            } catch (android.os.RemoteException e) {
                // Empty
            }
            ...
            return result != android.app.ActivityManager.START_RETURN_INTENT_TO_CALLER;
        }
    ...
    finish() on yourself.
     */
    public boolean startNextMatchingActivity(@android.annotation.RequiresPermission
    @android.annotation.NonNull
    ...
    android.os.Bundle options) {
        if (mParent == null) {
            try {
                intent.migrateExtraStreamToClipData();
                intent.prepareToLeaveProcess(this);
                return android.app.ActivityManagerNative.getDefault().startNextMatchingActivity(mToken, intent, options);
            } catch (android.os.RemoteException e) {
                // Empty
            }
            return false;
     ...
     * @see #startActivityForResult
     */
    public void startActivityFromChild(@android.annotation.NonNull
    android.app.Activity child, @android.annotation.RequiresPermission
    android.content.Intent intent, int requestCode) {
    ...
    android.os.Bundle options) {
        options = transferSpringboardActivityOptions(options);
        android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread.getApplicationThread(), mToken, child, intent, requestCode, options);
        if (ar != null) {
     ...
     */
    public void startActivityFromFragment(@android.annotation.NonNull
    android.app.Fragment fragment, @android.annotation.RequiresPermission
    android.content.Intent intent, int requestCode) {
     ...
     */
    @java.lang.Override
    public void startActivityForResult(java.lang.String who, android.content.Intent intent, int requestCode, @android.annotation.Nullable
    android.os.Bundle options) {
        android.net.Uri referrer = onProvideReferrer();
        if (referrer != null) {
            intent.putExtra(android.content.Intent.EXTRA_REFERRER, referrer);
        ...
        options = transferSpringboardActivityOptions(options);
        android.app.Instrumentation.ActivityResult ar = mInstrumentation.execStartActivity(this, mMainThread.getApplicationThread(), mToken, who, intent, requestCode, options);
        if (ar != null) {
     ...
     * for more information.
     */
    public void startIntentSenderFromChild(android.app.Activity child, android.content.IntentSender intent, int requestCode, android.content.Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, @android.annotation.Nullable
     ...
     * @unknown 
     */
    public void startIntentSenderFromChildFragment(android.app.Fragment child, android.content.IntentSender intent, int requestCode, android.content.Intent fillInIntent, int flagsMask, int flagsValues, int extraFlags, @android.annotation.Nullable
    android.os.Bundle options) throws android.content.IntentSender.SendIntentException {
    ...
    public void overridePendingTransition(int enterAnim, int exitAnim) {
        try {
            android.app.ActivityManagerNative.getDefault().overridePendingTransition(mToken, getPackageName(), enterAnim, exitAnim);
        } catch (android.os.RemoteException e) {
        }
    }
    ...
    public android.net.Uri getReferrer() {
        ...
        try {
            android.net.Uri referrer = intent.getParcelableExtra(android.content.Intent.EXTRA_REFERRER);
            if (referrer != null) {
                return referrer;
            }
            java.lang.String referrerName = intent.getStringExtra(android.content.Intent.EXTRA_REFERRER_NAME);
            if (referrerName != null) {
                return android.net.Uri.parse(referrerName);
            }
        } catch (android.os.BadParcelableException e) {
            android.util.Log.w(android.app.Activity.TAG, "Cannot read referrer from intent;" + " intent extras contain unknown custom Parcelable objects");
        }
        if (mReferrer != null) {
    ...
    private void finish(int finishTask) {
        if (mParent == null) {
            ...
            if (false)
                android.util.Log.v(android.app.Activity.TAG, "Finishing self: token=" + mToken);

            try {
                if (resultData != null) {
                    resultData.prepareToLeaveProcess(this);
                }
                if (android.app.ActivityManagerNative.getDefault().finishActivity(mToken, resultCode, resultData, finishTask)) {
                    mFinished = true;
                }
            } catch (android.os.RemoteException e) {
                // Empty
     ...
     */
    public void finish() {
        finish(android.app.Activity.DONT_FINISH_TASK_WITH_ACTIVITY);
    }
    ...
    public void finishAffinity() {
        ...
        try {
            if (android.app.ActivityManagerNative.getDefault().finishActivityAffinity(mToken)) {
                mFinished = true;
            }
        } catch (android.os.RemoteException e) {
            // Empty
    ...
    public void finishActivity(int requestCode) {
        if (mParent == null) {
            try {
                android.app.ActivityManagerNative.getDefault().finishSubActivity(mToken, mEmbeddedID, requestCode);
            } catch (android.os.RemoteException e) {
                // Empty
            }
        } else {
     ...
     * 		activity.
     */
    public void finishActivityFromChild(@android.annotation.NonNull
    android.app.Activity child, int requestCode) {
        try {
            android.app.ActivityManagerNative.getDefault().finishSubActivity(mToken, child.mEmbeddedID, requestCode);
        } catch (android.os.RemoteException e) {
            // Empty
        }
    }
    ...
    public void finishAndRemoveTask() {
        finish(android.app.Activity.FINISH_TASK_WITH_ROOT_ACTIVITY);
    }
    ...
    public boolean releaseInstance() {
        try {
            return android.app.ActivityManagerNative.getDefault().releaseActivityInstance(mToken);
        } catch (android.os.RemoteException e) {
            // Empty
        }
        return false;
     ...
     * 		by the sender.
     * @param flags
     * 		May be {@link PendingIntent#FLAG_ONE_SHOT PendingIntent.FLAG_ONE_SHOT},
     ...
     * @see PendingIntent
     */
    public android.app.PendingIntent createPendingResult(int requestCode, @android.annotation.NonNull
    android.content.Intent data, @android.app.PendingIntent.Flags
    int flags) {
        java.lang.String packageName = getPackageName();
        try {
            data.prepareToLeaveProcess(this);
            android.content.IIntentSender target = android.app.ActivityManagerNative.getDefault().getIntentSender(android.app.ActivityManager.INTENT_SENDER_ACTIVITY_RESULT, packageName, mParent == null ? mToken : mParent.mToken, mEmbeddedID, requestCode, new android.content.Intent[]{ data }, null, flags, null, android.os.UserHandle.myUserId());
     ...
     */
    public void setRequestedOrientation(@android.content.pm.ActivityInfo.ScreenOrientation
    ...
    public int getTaskId() {
        try {
            return android.app.ActivityManagerNative.getDefault().getTaskForActivity(mToken, false);
        } catch (android.os.RemoteException e) {
            return -1;
        }
    }
    ...
    public boolean isTaskRoot() {
        try {
            return android.app.ActivityManagerNative.getDefault().getTaskForActivity(mToken, true) >= 0;
        } catch (android.os.RemoteException e) {
            return false;
        }
    }
    ...
    public boolean moveTaskToBack(boolean nonRoot) {
        try {
            return android.app.ActivityManagerNative.getDefault().moveActivityTaskToBack(mToken, nonRoot);
        } catch (android.os.RemoteException e) {
            // Empty
        }
        return false;
    ...
    public java.lang.String getLocalClassName() {
        final java.lang.String pkg = getPackageName();
        final java.lang.String cls = mComponent.getClassName();
    ...
    @java.lang.Override
    public java.lang.Object getSystemService(@android.content.Context.ServiceName
    @android.annotation.NonNull
    java.lang.String name) {
        ...
        if (android.content.Context.WINDOW_SERVICE.equals(name)) {
            ...
            if (android.content.Context.SEARCH_SERVICE.equals(name)) {
                ensureSearchManager();
    ...
    public void setTaskDescription(android.app.ActivityManager.TaskDescription taskDescription) {
        if (mTaskDescription != taskDescription) {
            ...
            if ((taskDescription.getIconFilename() == null) && (taskDescription.getIcon() != null)) {
                final int size = android.app.ActivityManager.getLauncherLargeIconSizeInner(this);
                final android.graphics.Bitmap icon = android.graphics.Bitmap.createScaledBitmap(taskDescription.getIcon(), size, size, true);
                mTaskDescription.setIcon(icon);
            }
        }
        try {
            android.app.ActivityManagerNative.getDefault().setTaskDescription(mToken, mTaskDescription);
        } catch (android.os.RemoteException e) {
        }
    }
    ...
    public final void setProgressBarVisibility(boolean visible) {
        getWindow().setFeatureInt(android.view.Window.FEATURE_PROGRESS, visible ? android.view.Window.PROGRESS_VISIBILITY_ON : android.view.Window.PROGRESS_VISIBILITY_OFF);
    }
    ...
    public final void setProgressBarIndeterminateVisibility(boolean visible) {
        getWindow().setFeatureInt(android.view.Window.FEATURE_INDETERMINATE_PROGRESS, visible ? android.view.Window.PROGRESS_VISIBILITY_ON : android.view.Window.PROGRESS_VISIBILITY_OFF);
    }
    ...
    public final void setProgressBarIndeterminate(boolean indeterminate) {
        getWindow().setFeatureInt(android.view.Window.FEATURE_PROGRESS, indeterminate ? android.view.Window.PROGRESS_INDETERMINATE_ON : android.view.Window.PROGRESS_INDETERMINATE_OFF);
    }
    ...
    public final void setProgress(int progress) {
        getWindow().setFeatureInt(android.view.Window.FEATURE_PROGRESS, progress + android.view.Window.PROGRESS_START);
    }
    ...
    public final void setSecondaryProgress(int secondaryProgress) {
        getWindow().setFeatureInt(android.view.Window.FEATURE_PROGRESS, secondaryProgress + android.view.Window.PROGRESS_SECONDARY_START);
    }
     ...
     */
    public final void setMediaController(android.media.session.MediaController controller) {
    ...
    void dumpInner(java.lang.String prefix, java.io.FileDescriptor fd, java.io.PrintWriter writer, java.lang.String[] args) {
        writer.print(prefix);
        ...
        mHandler.getLooper().dump(new android.util.PrintWriterPrinter(writer), prefix);
    }
    ...
    private boolean isTopOfTask() {
        ...
        try {
            return android.app.ActivityManagerNative.getDefault().isTopOfTask(getActivityToken());
        } catch (android.os.RemoteException e) {
            return false;
        }
    }
    ...
    public void convertFromTranslucent() {
        try {
            mTranslucentCallback = null;
            if (android.app.ActivityManagerNative.getDefault().convertFromTranslucent(mToken)) {
                android.view.WindowManagerGlobal.getInstance().changeCanvasOpacity(mToken, true);
            }
        } catch (android.os.RemoteException e) {
            // pass
        }
     ...
     *
     * @param callback
     * 		the method to call when all visible Activities behind this one have been
     ...
     */
    @android.annotation.SystemApi
    public boolean convertToTranslucent(android.app.Activity.TranslucentConversionListener callback, android.app.ActivityOptions options) {
        boolean drawComplete;
        try {
            mTranslucentCallback = callback;
            mChangeCanvasToTranslucent = android.app.ActivityManagerNative.getDefault().convertToTranslucent(mToken, options);
            android.view.WindowManagerGlobal.getInstance().changeCanvasOpacity(mToken, false);
            drawComplete = true;
        } catch (android.os.RemoteException e) {
     ...
     * @unknown 
     */
    public void onNewActivityOptions(android.app.ActivityOptions options) {
     ...
     * from an activity launched by this activity in its call to {@link #convertToTranslucent(TranslucentConversionListener, ActivityOptions)}
     *
    ...
    android.app.ActivityOptions getActivityOptions() {
        try {
            return android.app.ActivityManagerNative.getDefault().getActivityOptions(mToken);
        } catch (android.os.RemoteException e) {
        }
        return null;
    }
     ...
     *
     * @param visible
     * 		true to notify the system that the activity wishes to be visible behind other
    ...
    public boolean requestVisibleBehind(boolean visible) {
        ...
        try {
            mVisibleBehind = android.app.ActivityManagerNative.getDefault().requestVisibleBehind(mToken, visible) && visible;
        } catch (android.os.RemoteException e) {
    ...
    public boolean isBackgroundVisibleBehind() {
        try {
            return android.app.ActivityManagerNative.getDefault().isBackgroundVisibleBehind(mToken);
        } catch (android.os.RemoteException e) {
        }
        return false;
    }
     ...
     * in the application's manifest entry for this activity, the {@link android.content.pm.ActivityInfo#flags ActivityInfo.flags} member will
     ...
     *
     * @param enabled
     * 		{@code true} to enable this mode.
     * @param requestedComponent
     * 		the name of the component to use as a
     ...
     */
    public void setVrModeEnabled(boolean enabled, @android.annotation.NonNull
    android.content.ComponentName requestedComponent) throws android.content.pm.PackageManager.NameNotFoundException {
        try {
            if (android.app.ActivityManagerNative.getDefault().setVrMode(mToken, enabled, requestedComponent) != 0) {
                throw new android.content.pm.PackageManager.NameNotFoundException(requestedComponent.flattenToString());
            }
        } catch (android.os.RemoteException e) {
            // pass
        }
     ...
     * 		Callback that will manage lifecycle events for this action mode
     * @param type
     * 		One of {@link ActionMode#TYPE_PRIMARY} or {@link ActionMode#TYPE_FLOATING}.
     * @return The ActionMode that was started, or null if it was canceled
     * @see ActionMode
     */
    @android.annotation.Nullable
    ...
    public android.view.ActionMode onWindowStartingActionMode(android.view.ActionMode.Callback callback) {
        ...
        if (mActionModeTypeStarting == android.view.ActionMode.TYPE_PRIMARY) {
            initWindowDecorActionBar();
            if (mActionBar != null) {
    ...
    public boolean shouldUpRecreateTask(android.content.Intent targetIntent) {
        try {
            ...
            android.content.ComponentName cn = targetIntent.getComponent();
            if (cn == null) {
            ...
            return android.app.ActivityManagerNative.getDefault().shouldUpRecreateTask(mToken, info.taskAffinity);
        } catch (android.os.RemoteException e) {
            return false;
    ...
    public boolean navigateUpTo(android.content.Intent upIntent) {
        if (mParent == null) {
            android.content.ComponentName destInfo = upIntent.getComponent();
            if (destInfo == null) {
                destInfo = upIntent.resolveActivity(getPackageManager());
                if (destInfo == null) {
                    return false;
                }
                upIntent = new android.content.Intent(upIntent);
            ...
            try {
                ...
                return android.app.ActivityManagerNative.getDefault().navigateUpTo(mToken, upIntent, resultCode, resultData);
            } catch (android.os.RemoteException e) {
                return false;
            }
        } else {
    ...
    public android.content.Intent getParentActivityIntent() {
        final java.lang.String parentName = mActivityInfo.parentActivityName;
        if (android.text.TextUtils.isEmpty(parentName)) {
            return null;
        }
        // If the parent itself has no parent, generate a main activity intent.
        final android.content.ComponentName target = new android.content.ComponentName(this, parentName);
        try {
            final android.content.pm.ActivityInfo parentInfo = getPackageManager().getActivityInfo(target, 0);
            final java.lang.String parentActivity = parentInfo.parentActivityName;
            final android.content.Intent parentIntent = (parentActivity == null) ? android.content.Intent.makeMainActivity(target) : new android.content.Intent().setComponent(target);
            return parentIntent;
        } catch (android.content.pm.PackageManager.NameNotFoundException e) {
            android.util.Log.e(android.app.Activity.TAG, ("getParentActivityIntent: bad parentActivityName '" + parentName) + "' in manifest");
            return null;
        }
    }
     ...
     */
    public android.view.DragAndDropPermissions requestDragAndDropPermissions(android.view.DragEvent event) {
        android.view.DragAndDropPermissions dragAndDropPermissions = android.view.DragAndDropPermissions.obtain(event);
    ...
    final void attach(android.content.Context context, android.app.ActivityThread aThread, android.app.Instrumentation instr, android.os.IBinder token, int ident, android.app.Application application, android.content.Intent intent, android.content.pm.ActivityInfo info, java.lang.CharSequence title, android.app.Activity parent, java.lang.String id, android.app.Activity.NonConfigurationInstances lastNonConfigurationInstances, android.content.res.Configuration config, java.lang.String referrer, com.android.internal.app.IVoiceInteractor voiceInteractor, android.view.Window window) {
        attachBaseContext(context);
        /* parent */
        mFragments.attachHost(null);
        mWindow = new com.android.internal.policy.PhoneWindow(this, window);
        mWindow.setWindowControllerCallback(this);
        mWindow.setCallback(this);
        mWindow.setOnWindowDismissedCallback(this);
        mWindow.getLayoutInflater().setPrivateFactory(this);
        if (info.softInputMode != android.view.WindowManager.LayoutParams.SOFT_INPUT_STATE_UNSPECIFIED) {
        ...
        mWindow.setWindowManager(((android.view.WindowManager) (context.getSystemService(android.content.Context.WINDOW_SERVICE))), mToken, mComponent.flattenToString(), (info.flags & android.content.pm.ActivityInfo.FLAG_HARDWARE_ACCELERATED) != 0);
        if (mParent != null) {
    ...
    final void performCreate(android.os.Bundle icicle) {
    ...
    final void performCreate(android.os.Bundle icicle, android.os.PersistableBundle persistentState) {
        restoreHasCurrentPermissionRequest(icicle);
    ...
    final void performStart() {
        ...
        if (!mCalled) {
            throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onStart()");
        }
        mFragments.dispatchStart();
        mFragments.reportLoaderStart();
        // This property is set for all builds except final release
        boolean isDlwarningEnabled = android.os.SystemProperties.getInt("ro.bionic.ld.warning", 0) == 1;
        boolean isAppDebuggable = (mApplication.getApplicationInfo().flags & android.content.pm.ApplicationInfo.FLAG_DEBUGGABLE) != 0;
        if (isAppDebuggable || isDlwarningEnabled) {
            java.lang.String dlwarning = android.app.Activity.getDlWarning();
            if (dlwarning != null) {
                java.lang.String appName = getApplicationInfo().loadLabel(getPackageManager()).toString();
                java.lang.String warning = ("Detected problems with app native libraries\n" + "(please consult log for detail):\n") + dlwarning;
                if (isAppDebuggable) {
                    new android.app.AlertDialog.Builder(this).setTitle(appName).setMessage(warning).setPositiveButton(android.R.string.ok, null).setCancelable(false).show();
                } else {
                    android.widget.Toast.makeText(this, (appName + "\n") + warning, android.widget.Toast.LENGTH_LONG).show();
                }
            }
        }
        mActivityTransitionState.enterReady(this);
    ...
    final void performRestart() {
        ...
        if ((mToken != null) && (mParent == null)) {
            ...
            /* stopped */
            android.view.WindowManagerGlobal.getInstance().setStoppedState(mToken, false);
        }
        if (mStopped) {
            mStopped = false;
            synchronized(mManagedCursors) {
                    ...
                    if (mc.mReleased || mc.mUpdated) {
                        if (!mc.mCursor.requery()) {
                            if (getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                                throw new java.lang.IllegalStateException("trying to requery an already closed cursor  " + mc.mCursor);
                            }
                        }
                        mc.mReleased = false;
                        mc.mUpdated = false;
            ...
            if (!mCalled) {
                throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onRestart()");
            }
            performStart();
        }
    }
    ...
    final void performResume() {
        ...
        if (!mCalled) {
            throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onResume()");
        }
        // invisible activities must be finished before onResume() completes
        if ((!mVisibleFromClient) && (!mFinished)) {
            android.util.Log.w(android.app.Activity.TAG, "An activity without a UI must call finish() before onResume() completes");
            if (getApplicationInfo().targetSdkVersion > android.os.Build.VERSION_CODES.LOLLIPOP_MR1) {
                throw new java.lang.IllegalStateException(("Activity " + mComponent.toShortString()) + " did not call finish() prior to onResume() completing");
            }
        }
        ...
        onPostResume();
        if (!mCalled) {
            throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onPostResume()");
        }
    }
    ...
    final void performPause() {
        ...
        if ((!mCalled) && (getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.GINGERBREAD)) {
            throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onPause()");
        }
        mResumed = false;
    }
    ...
    final void performStop(boolean preserveWindow) {
        ...
        if (!mStopped) {
            ...
            if (((!preserveWindow) && (mToken != null)) && (mParent == null)) {
                android.view.WindowManagerGlobal.getInstance().setStoppedState(mToken, true);
            }
            mFragments.dispatchStop();
            mCalled = false;
            mInstrumentation.callActivityOnStop(this);
            if (!mCalled) {
                throw new android.util.SuperNotCalledException(("Activity " + mComponent.toShortString()) + " did not call through to super.onStop()");
            }
            synchronized(mManagedCursors) {
                final int N = mManagedCursors.size();
                for (int i = 0; i < N; i++) {
    ...
    final void dispatchMultiWindowModeChanged(boolean isInMultiWindowMode) {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("dispatchMultiWindowModeChanged " + this) + ": ") + isInMultiWindowMode);
    ...
    final void dispatchPictureInPictureModeChanged(boolean isInPictureInPictureMode) {
        if (android.app.Activity.DEBUG_LIFECYCLE)
            android.util.Slog.v(android.app.Activity.TAG, (("dispatchPictureInPictureModeChanged " + this) + ": ") + isInPictureInPictureMode);
    ...
    private void storeHasCurrentPermissionRequest(android.os.Bundle bundle) {
        if ((bundle != null) && mHasCurrentPermissionsRequest) {
            bundle.putBoolean(android.app.Activity.HAS_CURENT_PERMISSIONS_REQUEST_KEY, true);
        }
    }

    private void restoreHasCurrentPermissionRequest(android.os.Bundle bundle) {
        if (bundle != null) {
            mHasCurrentPermissionsRequest = bundle.getBoolean(android.app.Activity.HAS_CURENT_PERMISSIONS_REQUEST_KEY, false);
        }
    }

    void dispatchActivityResult(java.lang.String who, int requestCode, int resultCode, android.content.Intent data) {
        if (false)
            android.util.Log.v(android.app.Activity.TAG, (((((("Dispatching result: who=" + who) + ", reqCode=") + requestCode) + ", resCode=") + resultCode) + ", data=") + data);

        mFragments.noteStateNotSaved();
        if (who == null) {
            onActivityResult(requestCode, resultCode, data);
        } else
            if (who.startsWith(android.app.Activity.REQUEST_PERMISSIONS_WHO_PREFIX)) {
                who = who.substring(android.app.Activity.REQUEST_PERMISSIONS_WHO_PREFIX.length());
                if (android.text.TextUtils.isEmpty(who)) {
                ...
                if (who.startsWith("@android:view:")) {
                    java.util.ArrayList<android.view.ViewRootImpl> views = android.view.WindowManagerGlobal.getInstance().getRootViews(getActivityToken());
                    for (android.view.ViewRootImpl viewRoot : views) {
    ...
    public void startLockTask() {
        try {
            android.app.ActivityManagerNative.getDefault().startLockTaskMode(mToken);
        } catch (android.os.RemoteException e) {
        }
    }
    ...
    public void showLockTaskEscapeMessage() {
        try {
            android.app.ActivityManagerNative.getDefault().showLockTaskEscapeMessage(mToken);
        } catch (android.os.RemoteException e) {
        }
    }
     ...
     * translucent again following a call to {@link Activity#convertToTranslucent(android.app.Activity.TranslucentConversionListener,
     * ActivityOptions)}
     *
     * @unknown 
     */
    ...
    private void dispatchRequestPermissionsResult(int requestCode, android.content.Intent data) {
        mHasCurrentPermissionsRequest = false;
        // If the package installer crashed we may have not data - best effort.
        java.lang.String[] permissions = (data != null) ? data.getStringArrayExtra(android.content.pm.PackageManager.EXTRA_REQUEST_PERMISSIONS_NAMES) : new java.lang.String[0];
        final int[] grantResults = (data != null) ? data.getIntArrayExtra(android.content.pm.PackageManager.EXTRA_REQUEST_PERMISSIONS_RESULTS) : new int[0];
        onRequestPermissionsResult(requestCode, permissions, grantResults);
    }

    private void dispatchRequestPermissionsResultToFragment(int requestCode, android.content.Intent data, android.app.Fragment fragment) {
        // If the package installer crashed we may have not data - best effort.
        java.lang.String[] permissions = (data != null) ? data.getStringArrayExtra(android.content.pm.PackageManager.EXTRA_REQUEST_PERMISSIONS_NAMES) : new java.lang.String[0];
        final int[] grantResults = (data != null) ? data.getIntArrayExtra(android.content.pm.PackageManager.EXTRA_REQUEST_PERMISSIONS_RESULTS) : new int[0];
    ...
    class HostCallbacks extends android.app.FragmentHostCallback<android.app.Activity> {
        ...
        public android.view.LayoutInflater onGetLayoutInflater() {
            final android.view.LayoutInflater result = android.app.Activity.this.getLayoutInflater();
        ...
        public boolean onUseFragmentManagerInflaterFactory() {
            ...
            return getApplicationInfo().targetSdkVersion >= android.os.Build.VERSION_CODES.LOLLIPOP;
        }
        ...
        @java.lang.Override
        public void onRequestPermissionsFromFragment(android.app.Fragment fragment, java.lang.String[] permissions, int requestCode) {
            java.lang.String who = android.app.Activity.REQUEST_PERMISSIONS_WHO_PREFIX + fragment.mWho;
            android.content.Intent intent = getPackageManager().buildRequestPermissionsIntent(permissions);
