...
public class AlarmManager {
    ...
    final class ListenerWrapper extends android.app.IAlarmListener.Stub implements java.lang.Runnable {
        ...
        public ListenerWrapper(android.app.AlarmManager.OnAlarmListener listener) {
            mListener = listener;
        }
        ...
        public void cancel() {
            ...
            synchronized(android.app.AlarmManager.class) {
                if (android.app.AlarmManager.sWrappers != null) {
                    android.app.AlarmManager.sWrappers.remove(mListener);
                }
            }
        }

        @java.lang.Override
        public void doAlarm(android.app.IAlarmCompleteListener alarmManager) {
     ...
     */
    AlarmManager(android.app.IAlarmManager service, android.content.Context ctx) {
        mService = service;
        mPackageName = ctx.getPackageName();
        mTargetSdkVersion = ctx.getApplicationInfo().targetSdkVersion;
        mAlwaysExact = mTargetSdkVersion < android.os.Build.VERSION_CODES.KITKAT;
        mMainThreadHandler = new android.os.Handler(ctx.getMainLooper());
    }

    private long legacyExactLength() {
        return mAlwaysExact ? android.app.AlarmManager.WINDOW_EXACT : android.app.AlarmManager.WINDOW_HEURISTIC;
    }
     ...
     *
     * @param type
     * 		One of {@link #ELAPSED_REALTIME}, {@link #ELAPSED_REALTIME_WAKEUP},
     ...
     * 		attribution
     * @param listener
     * 		{@link OnAlarmListener} instance whose
     ...
     * @param targetHandler
     * 		{@link Handler} on which to execute the listener's onAlarm()
     * 		callback, or {@code null} to run that callback on the main looper.
     */
    public void set(int type, long triggerAtMillis, java.lang.String tag, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler) {
     ...
     * @see #RTC_WAKEUP
     */
    public void setWindow(int type, long windowStartMillis, long windowLengthMillis, android.app.PendingIntent operation) {
     ...
     * if {@code null} is passed as the {@code targetHandler} parameter.
     */
    public void setWindow(int type, long windowStartMillis, long windowLengthMillis, java.lang.String tag, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler) {
     ...
     * @see #RTC_WAKEUP
     */
    public void setExact(int type, long triggerAtMillis, android.app.PendingIntent operation) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_EXACT, 0, 0, operation, null, null, null, null, null);
    }
     ...
     * if {@code null} is passed as the {@code targetHandler} parameter.
     */
    public void setExact(int type, long triggerAtMillis, java.lang.String tag, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_EXACT, 0, 0, null, listener, tag, targetHandler, null, null);
    }
     ...
     * @unknown 
     */
    public void setIdleUntil(int type, long triggerAtMillis, java.lang.String tag, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_EXACT, 0, android.app.AlarmManager.FLAG_IDLE_UNTIL, null, listener, tag, targetHandler, null, null);
    }
     ...
     * @see android.content.Intent#filterEquals
     */
    public void setAlarmClock(android.app.AlarmManager.AlarmClockInfo info, android.app.PendingIntent operation) {
        setImpl(android.app.AlarmManager.RTC_WAKEUP, info.getTriggerTime(), android.app.AlarmManager.WINDOW_EXACT, 0, 0, operation, null, null, null, null, info);
    }
    ...
    public void set(int type, long triggerAtMillis, long windowMillis, long intervalMillis, android.app.PendingIntent operation, android.os.WorkSource workSource) {
     ...
     * @unknown 
     */
    public void set(int type, long triggerAtMillis, long windowMillis, long intervalMillis, java.lang.String tag, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler, android.os.WorkSource workSource) {
     ...
     */
    @android.annotation.SystemApi
    public void set(int type, long triggerAtMillis, long windowMillis, long intervalMillis, android.app.AlarmManager.OnAlarmListener listener, android.os.Handler targetHandler, android.os.WorkSource workSource) {
        setImpl(type, triggerAtMillis, windowMillis, intervalMillis, 0, null, listener, null, targetHandler, workSource, null);
    }

    private void setImpl(int type, long triggerAtMillis, long windowMillis, long intervalMillis, int flags, android.app.PendingIntent operation, final android.app.AlarmManager.OnAlarmListener listener, java.lang.String listenerTag, android.os.Handler targetHandler, android.os.WorkSource workSource, android.app.AlarmManager.AlarmClockInfo alarmClock) {
        ...
        android.app.AlarmManager.ListenerWrapper recipientWrapper = null;
        if (listener != null) {
            synchronized(android.app.AlarmManager.class) {
                if (android.app.AlarmManager.sWrappers == null) {
                    android.app.AlarmManager.sWrappers = new android.util.ArrayMap<android.app.AlarmManager.OnAlarmListener, android.app.AlarmManager.ListenerWrapper>();
                }
                recipientWrapper = android.app.AlarmManager.sWrappers.get(listener);
                // no existing wrapper => build a new one
                if (recipientWrapper == null) {
                    recipientWrapper = new android.app.AlarmManager.ListenerWrapper(listener);
                    android.app.AlarmManager.sWrappers.put(listener, recipientWrapper);
                }
            }
            final android.os.Handler handler = (targetHandler != null) ? targetHandler : mMainThreadHandler;
     ...
     * when running on Android prior to API 19.
     */
    public static final long INTERVAL_HALF_HOUR = 2 * android.app.AlarmManager.INTERVAL_FIFTEEN_MINUTES;
     ...
     * when running on Android prior to API 19.
     */
    public static final long INTERVAL_HOUR = 2 * android.app.AlarmManager.INTERVAL_HALF_HOUR;
     ...
     * when running on Android prior to API 19.
     */
    public static final long INTERVAL_HALF_DAY = 12 * android.app.AlarmManager.INTERVAL_HOUR;
     ...
     * when running on Android prior to API 19.
     */
    public static final long INTERVAL_DAY = 2 * android.app.AlarmManager.INTERVAL_HALF_DAY;
     ...
     * one-shot alarms with an appropriate window instead; see {@link #setWindow(int, long, long, PendingIntent)} and
     * {@link #setExact(int, long, PendingIntent)}.
     *
     * <p class="note">
    ...
    public void setInexactRepeating(int type, long triggerAtMillis, long intervalMillis, android.app.PendingIntent operation) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_HEURISTIC, intervalMillis, 0, operation, null, null, null, null, null);
    }
     ...
     * @see #RTC_WAKEUP
     */
    public void setAndAllowWhileIdle(int type, long triggerAtMillis, android.app.PendingIntent operation) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_HEURISTIC, 0, android.app.AlarmManager.FLAG_ALLOW_WHILE_IDLE, operation, null, null, null, null, null);
    }
     ...
     * @see #RTC_WAKEUP
     */
    public void setExactAndAllowWhileIdle(int type, long triggerAtMillis, android.app.PendingIntent operation) {
        setImpl(type, triggerAtMillis, android.app.AlarmManager.WINDOW_EXACT, 0, android.app.AlarmManager.FLAG_ALLOW_WHILE_IDLE, operation, null, null, null, null, null);
    }
    ...
    public void cancel(android.app.PendingIntent operation) {
        if (operation == null) {
            final java.lang.String msg = "cancel() called with a null PendingIntent";
            if (mTargetSdkVersion >= android.os.Build.VERSION_CODES.N) {
                throw new java.lang.NullPointerException(msg);
            } else {
                android.util.Log.e(android.app.AlarmManager.TAG, msg);
                return;
            }
        }
        try {
    ...
    public void cancel(android.app.AlarmManager.OnAlarmListener listener) {
        ...
        android.app.AlarmManager.ListenerWrapper wrapper = null;
        synchronized(android.app.AlarmManager.class) {
            if (android.app.AlarmManager.sWrappers != null) {
                wrapper = android.app.AlarmManager.sWrappers.get(listener);
            }
        }
        if (wrapper == null) {
            android.util.Log.w(android.app.AlarmManager.TAG, "Unrecognized alarm listener " + listener);
            return;
        }
        wrapper.cancel();
    }
    ...
    public void setTimeZone(java.lang.String timeZone) {
        ...
        if (mTargetSdkVersion >= android.os.Build.VERSION_CODES.M) {
            boolean hasTimeZone = false;
            try {
                hasTimeZone = libcore.util.ZoneInfoDB.getInstance().hasTimeZone(timeZone);
            } catch (java.io.IOException ignored) {
            }
            if (!hasTimeZone) {
                throw new java.lang.IllegalArgumentException(("Timezone: " + timeZone) + " is not an Olson ID");
            }
        }
        try {
    ...
    public android.app.AlarmManager.AlarmClockInfo getNextAlarmClock() {
        return getNextAlarmClock(android.os.UserHandle.myUserId());
    }
    ...
    public static final class AlarmClockInfo implements android.os.Parcelable {
         ...
         * @unknown 
         */
        AlarmClockInfo(android.os.Parcel in) {
            mTriggerTime = in.readLong();
            mShowIntent = in.readParcelable(android.app.PendingIntent.class.getClassLoader());
        }
        ...
        public static final android.os.Parcelable.Creator<android.app.AlarmManager.AlarmClockInfo> CREATOR = new android.os.Parcelable.Creator<android.app.AlarmManager.AlarmClockInfo>() {
            @java.lang.Override
            public android.app.AlarmManager.AlarmClockInfo createFromParcel(android.os.Parcel in) {
                return new android.app.AlarmManager.AlarmClockInfo(in);
            }

            @java.lang.Override
            public android.app.AlarmManager.AlarmClockInfo[] newArray(int size) {
                return new android.app.AlarmManager.AlarmClockInfo[size];
            }
        };
    }
}
