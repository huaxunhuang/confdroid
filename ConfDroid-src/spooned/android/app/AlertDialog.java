...
public class AlertDialog extends android.app.Dialog implements android.content.DialogInterface {
     ...
     * @see android.R.styleable#Theme_alertDialogTheme
     */
    protected AlertDialog(android.content.Context context, @android.annotation.StyleRes
    int themeResId) {
        this(context, themeResId, true);
    }

    AlertDialog(android.content.Context context, @android.annotation.StyleRes
    int themeResId, boolean createContextThemeWrapper) {
        super(context, createContextThemeWrapper ? android.app.AlertDialog.resolveDialogTheme(context, themeResId) : 0, createContextThemeWrapper);
        mWindow.alwaysReadCloseOnTouchAttr();
        mAlert = com.android.internal.app.AlertController.create(getContext(), this, getWindow());
    }

    static int resolveDialogTheme(android.content.Context context, int themeResId) {
        if (themeResId == android.app.AlertDialog.THEME_TRADITIONAL) {
            return R.style.Theme_Dialog_Alert;
        } else
            if (themeResId == android.app.AlertDialog.THEME_HOLO_DARK) {
                return R.style.Theme_Holo_Dialog_Alert;
            } else
                if (themeResId == android.app.AlertDialog.THEME_HOLO_LIGHT) {
                    return R.style.Theme_Holo_Light_Dialog_Alert;
                } else
                    if (themeResId == android.app.AlertDialog.THEME_DEVICE_DEFAULT_DARK) {
                        return R.style.Theme_DeviceDefault_Dialog_Alert;
                    } else
                        if (themeResId == android.app.AlertDialog.THEME_DEVICE_DEFAULT_LIGHT) {
    ...
    public void setButton(java.lang.CharSequence text, android.os.Message msg) {
        setButton(android.content.DialogInterface.BUTTON_POSITIVE, text, msg);
    }
    ...
    public void setButton2(java.lang.CharSequence text, android.os.Message msg) {
        setButton(android.content.DialogInterface.BUTTON_NEGATIVE, text, msg);
    }
    ...
    public void setButton3(java.lang.CharSequence text, android.os.Message msg) {
        setButton(android.content.DialogInterface.BUTTON_NEUTRAL, text, msg);
    }
     ...
     */
    @java.lang.Deprecated
    public void setButton(java.lang.CharSequence text, final android.content.DialogInterface.OnClickListener listener) {
        setButton(android.content.DialogInterface.BUTTON_POSITIVE, text, listener);
    }
     ...
     */
    @java.lang.Deprecated
    public void setButton2(java.lang.CharSequence text, final android.content.DialogInterface.OnClickListener listener) {
        setButton(android.content.DialogInterface.BUTTON_NEGATIVE, text, listener);
    }
     ...
     */
    @java.lang.Deprecated
    public void setButton3(java.lang.CharSequence text, final android.content.DialogInterface.OnClickListener listener) {
        setButton(android.content.DialogInterface.BUTTON_NEUTRAL, text, listener);
    }
     ...
     */
    public void setIconAttribute(@android.annotation.AttrRes
    int attrId) {
    ...
    public static class Builder {
        ...
        public Builder(android.content.Context context, int themeResId) {
            P = new com.android.internal.app.AlertController.AlertParams(new android.view.ContextThemeWrapper(context, android.app.AlertDialog.resolveDialogTheme(context, themeResId)));
        }
         ...
         */
        public android.app.AlertDialog.Builder setTitle(@android.annotation.StringRes
        int titleId) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setMessage(@android.annotation.StringRes
        int messageId) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setIcon(@android.annotation.DrawableRes
        int iconId) {
            P.mIconId = iconId;
            return this;
        }
         ...
         * 		ID of a theme attribute that points to a drawable resource.
         */
        public android.app.AlertDialog.Builder setIconAttribute(@android.annotation.AttrRes
        int attrId) {
            android.util.TypedValue out = new android.util.TypedValue();
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setPositiveButton(@android.annotation.StringRes
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setNegativeButton(@android.annotation.StringRes
        int textId, final android.content.DialogInterface.OnClickListener listener) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setNeutralButton(@android.annotation.StringRes
        int textId, final android.content.DialogInterface.OnClickListener listener) {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setItems(@android.annotation.ArrayRes
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setAdapter(final android.widget.ListAdapter adapter, final android.content.DialogInterface.OnClickListener listener) {
            P.mAdapter = adapter;
            P.mOnClickListener = listener;
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setCursor(final android.database.Cursor cursor, final android.content.DialogInterface.OnClickListener listener, java.lang.String labelColumn) {
            P.mCursor = cursor;
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setMultiChoiceItems(@android.annotation.ArrayRes
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public android.app.AlertDialog.Builder setSingleChoiceItems(@android.annotation.ArrayRes
         ...
         * @return this Builder object to allow for chaining of calls to set
        methods
         * @unknown Remove once the framework usages have been replaced.
         * @deprecated Set the padding on the view itself.
         */
        @java.lang.Deprecated
        public android.app.AlertDialog.Builder setView(android.view.View view, int viewSpacingLeft, int viewSpacingTop, int viewSpacingRight, int viewSpacingBottom) {
            P.mView = view;
            P.mViewLayoutResId = 0;
        ...
        public android.app.AlertDialog create() {
            ...
            final android.app.AlertDialog dialog = new android.app.AlertDialog(P.mContext, 0, false);
        ...
        public android.app.AlertDialog show() {
            final android.app.AlertDialog dialog = create();
            dialog.show();
            return dialog;
        }
    }
