...
public class ApplicationErrorReport implements android.os.Parcelable {
    ...
    public static android.content.ComponentName getErrorReportReceiver(android.content.Context context, java.lang.String packageName, int appFlags) {
        ...
        java.lang.String candidate = null;
        android.content.ComponentName result = null;
        try {
        ...
        if (candidate != null) {
            result = android.app.ApplicationErrorReport.getErrorReportReceiver(pm, packageName, candidate);
            if (result != null) {
                return result;
            }
        }
        ...
        if ((appFlags & android.content.pm.ApplicationInfo.FLAG_SYSTEM) != 0) {
            candidate = android.os.SystemProperties.get(android.app.ApplicationErrorReport.SYSTEM_APPS_ERROR_RECEIVER_PROPERTY);
            result = android.app.ApplicationErrorReport.getErrorReportReceiver(pm, packageName, candidate);
            if (result != null) {
                return result;
            }
        ...
        candidate = android.os.SystemProperties.get(android.app.ApplicationErrorReport.DEFAULT_ERROR_RECEIVER_PROPERTY);
        return android.app.ApplicationErrorReport.getErrorReportReceiver(pm, packageName, candidate);
    }
     ...
     */
    static android.content.ComponentName getErrorReportReceiver(android.content.pm.PackageManager pm, java.lang.String errorPackage, java.lang.String receiverPackage) {
        ...
        android.content.pm.ResolveInfo info = pm.resolveActivity(intent, 0);
        if ((info == null) || (info.activityInfo == null)) {
            return null;
        }
        return new android.content.ComponentName(receiverPackage, info.activityInfo.name);
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        switch (type) {
            case android.app.ApplicationErrorReport.TYPE_CRASH :
                if (crashInfo != null) {
                    crashInfo.writeToParcel(dest, flags);
                }
                break;
            case android.app.ApplicationErrorReport.TYPE_ANR :
                anrInfo.writeToParcel(dest, flags);
                break;
            case android.app.ApplicationErrorReport.TYPE_BATTERY :
                batteryInfo.writeToParcel(dest, flags);
                break;
            case android.app.ApplicationErrorReport.TYPE_RUNNING_SERVICE :
    ...
    public void readFromParcel(android.os.Parcel in) {
        ...
        switch (type) {
            case android.app.ApplicationErrorReport.TYPE_CRASH :
                crashInfo = (hasCrashInfo) ? new android.app.ApplicationErrorReport.CrashInfo(in) : null;
                anrInfo = null;
                batteryInfo = null;
                runningServiceInfo = null;
                break;
            case android.app.ApplicationErrorReport.TYPE_ANR :
                anrInfo = new android.app.ApplicationErrorReport.AnrInfo(in);
                crashInfo = null;
                batteryInfo = null;
                runningServiceInfo = null;
                break;
            case android.app.ApplicationErrorReport.TYPE_BATTERY :
                batteryInfo = new android.app.ApplicationErrorReport.BatteryInfo(in);
                anrInfo = null;
                crashInfo = null;
                runningServiceInfo = null;
                break;
            case android.app.ApplicationErrorReport.TYPE_RUNNING_SERVICE :
                ...
                anrInfo = null;
                crashInfo = null;
                runningServiceInfo = new android.app.ApplicationErrorReport.RunningServiceInfo(in);
                break;
        }
    }
    ...
    public static class CrashInfo {
        ...
        public CrashInfo(java.lang.Throwable tr) {
            ...
            java.lang.Throwable rootTr = tr;
            while (tr.getCause() != null) {
                tr = tr.getCause();
                if ((tr.getStackTrace() != null) && (tr.getStackTrace().length > 0)) {
                    rootTr = tr;
                }
                java.lang.String msg = tr.getMessage();
            ...
            if (rootTr.getStackTrace().length > 0) {
                java.lang.StackTraceElement trace = rootTr.getStackTrace()[0];
         ...
         */
        private java.lang.String sanitizeString(java.lang.String s) {
            ...
            if ((s != null) && (s.length() > acceptableLength)) {
                ...
                java.lang.StringBuilder sb = new java.lang.StringBuilder(acceptableLength + replacement.length());
        ...
        public void writeToParcel(android.os.Parcel dest, int flags) {
            ...
            if (total > (20 * 1024)) {
                android.util.Slog.d("Error", "ERR: exClass=" + exceptionClassName);
                android.util.Slog.d("Error", "ERR: exMsg=" + exceptionMessage);
                android.util.Slog.d("Error", "ERR: file=" + throwFileName);
                android.util.Slog.d("Error", "ERR: class=" + throwClassName);
                android.util.Slog.d("Error", (("ERR: method=" + throwMethodName) + " line=") + throwLineNumber);
                android.util.Slog.d("Error", "ERR: stack=" + stackTrace);
                android.util.Slog.d("Error", "ERR: TOTAL BYTES WRITTEN: " + (dest.dataPosition() - start));
            }
        }
    ...
    public static final android.os.Parcelable.Creator<android.app.ApplicationErrorReport> CREATOR = new android.os.Parcelable.Creator<android.app.ApplicationErrorReport>() {
        public android.app.ApplicationErrorReport createFromParcel(android.os.Parcel source) {
            return new android.app.ApplicationErrorReport(source);
        }

        public android.app.ApplicationErrorReport[] newArray(int size) {
            return new android.app.ApplicationErrorReport[size];
        }
    };
