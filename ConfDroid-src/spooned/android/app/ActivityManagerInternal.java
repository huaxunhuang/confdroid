...
public abstract class ActivityManagerInternal {
     ...
     */
    public abstract java.lang.String checkContentProviderAccess(java.lang.String authority, int userId);

    // Called by the power manager.
    public abstract void onWakefulnessChanged(int wakefulness);

    public abstract int startIsolatedProcess(java.lang.String entryPoint, java.lang.String[] mainArgs, java.lang.String processName, java.lang.String abiOverride, int uid, java.lang.Runnable crashHandler);

    /**
     * Acquires a sleep token with the specified tag.
     *
     * @param tag
     * 		A string identifying the purpose of the token (eg. "Dream").
     */
    public abstract android.app.ActivityManagerInternal.SleepToken acquireSleepToken(@android.annotation.NonNull
     ...
     *
     * @param userId
     * 		ID of the user or {@link android.os.UserHandle#USER_ALL}
     */
    public abstract android.content.ComponentName getHomeActivityForUser(int userId);
     ...
     *
     * @param userId
     * 		The user being cleaned up.
     */
    public abstract void onUserRemoved(int userId);

    public abstract void onLocalVoiceInteractionStarted(android.os.IBinder callingActivity, android.service.voice.IVoiceInteractionSession mSession, com.android.internal.app.IVoiceInteractor mInteractor);
     ...
     */
    public abstract void setPendingIntentWhitelistDuration(android.content.IIntentSender target, long duration);
     ...
     * @param userId
     * 		the user to update the configuration for
     */
    public abstract void updatePersistentConfigurationForUser(@android.annotation.NonNull
    android.content.res.Configuration values, int userId);
     ...
     */
    public abstract int startActivitiesAsPackage(java.lang.String packageName, int userId, android.content.Intent[] intents, android.os.Bundle bOptions);
