...
public class UiModeManager {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.app.UiModeManager.MODE_NIGHT_AUTO, android.app.UiModeManager.MODE_NIGHT_NO, android.app.UiModeManager.MODE_NIGHT_YES })
     ...
     */
    public static final int MODE_NIGHT_AUTO = android.content.res.Configuration.UI_MODE_NIGHT_UNDEFINED >> 4;

    /**
     * Constant for {@link #setNightMode(int)} and {@link #getNightMode()}:
     * never run in night mode.
     */
    public static final int MODE_NIGHT_NO = android.content.res.Configuration.UI_MODE_NIGHT_NO >> 4;

    /**
     * Constant for {@link #setNightMode(int)} and {@link #getNightMode()}:
     * always run in night mode.
     */
    public static final int MODE_NIGHT_YES = android.content.res.Configuration.UI_MODE_NIGHT_YES >> 4;

    private android.app.IUiModeManager mService;

    /* package */
    UiModeManager() {
        mService = IUiModeManager.Stub.asInterface(android.os.ServiceManager.getService(android.content.Context.UI_MODE_SERVICE));
    }
     ...
     */
    public static final int ENABLE_CAR_MODE_GO_CAR_HOME = 0x1;
     ...
     * screen kept on.
     */
    public static final int ENABLE_CAR_MODE_ALLOW_SLEEP = 0x2;
     ...
     * being in car mode).
     */
    public static final int DISABLE_CAR_MODE_GO_HOME = 0x1;

    /**
     * Turn off special mode if currently in car mode.
     *
     * @param flags
     * 		May be 0 or {@link #DISABLE_CAR_MODE_GO_HOME}.
     */
    ...
    public int getCurrentModeType() {
        ...
        return android.content.res.Configuration.UI_MODE_TYPE_NORMAL;
    }
     ...
     * @see #getNightMode()
     */
    public void setNightMode(@android.app.UiModeManager.NightMode
    int mode) {
        if (mService != null) {
            try {
