...
public final class UsageStatsManager {
     ...
     * {@hide }
     */
    public UsageStatsManager(android.content.Context context, android.app.usage.IUsageStatsManager service) {
        mContext = context;
        mService = service;
    }
     ...
     * @see #INTERVAL_BEST
     */
    public java.util.List<android.app.usage.UsageStats> queryUsageStats(int intervalType, long beginTime, long endTime) {
        try {
            @java.lang.SuppressWarnings("unchecked")
            android.content.pm.ParceledListSlice<android.app.usage.UsageStats> slice = mService.queryUsageStats(intervalType, beginTime, endTime, mContext.getOpPackageName());
            if (slice != null) {
     ...
     */
    public java.util.List<android.app.usage.ConfigurationStats> queryConfigurations(int intervalType, long beginTime, long endTime) {
        try {
            @java.lang.SuppressWarnings("unchecked")
            android.content.pm.ParceledListSlice<android.app.usage.ConfigurationStats> slice = mService.queryConfigurationStats(intervalType, beginTime, endTime, mContext.getOpPackageName());
            if (slice != null) {
                return slice.getList();
            }
        } catch (android.os.RemoteException e) {
    ...
    public android.app.usage.UsageEvents queryEvents(long beginTime, long endTime) {
        try {
            android.app.usage.UsageEvents iter = mService.queryEvents(beginTime, endTime, mContext.getOpPackageName());
            if (iter != null) {
                return iter;
            }
        } catch (android.os.RemoteException e) {
        ...
        return android.app.usage.UsageStatsManager.sEmptyResults;
    }
    ...
    available.
     */
    public java.util.Map<java.lang.String, android.app.usage.UsageStats> queryAndAggregateUsageStats(long beginTime, long endTime) {
        java.util.List<android.app.usage.UsageStats> stats = queryUsageStats(android.app.usage.UsageStatsManager.INTERVAL_BEST, beginTime, endTime);
        if (stats.isEmpty()) {
            return java.util.Collections.emptyMap();
        }
        android.util.ArrayMap<java.lang.String, android.app.usage.UsageStats> aggregatedStats = new android.util.ArrayMap<>();
        final int statCount = stats.size();
        for (int i = 0; i < statCount; i++) {
            android.app.usage.UsageStats newStat = stats.get(i);
            android.app.usage.UsageStats existingStat = aggregatedStats.get(newStat.getPackageName());
     ...
     */
    public boolean isAppInactive(java.lang.String packageName) {
        try {
            return mService.isAppInactive(packageName, android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException e) {
     ...
     * @unknown 
     */
    public void setAppInactive(java.lang.String packageName, boolean inactive) {
        try {
            mService.setAppInactive(packageName, inactive, android.os.UserHandle.myUserId());
        } catch (android.os.RemoteException e) {
            // fall through
        }
    }
    ...
    public void whitelistAppTemporarily(java.lang.String packageName, long duration, android.os.UserHandle user) {
        try {
