...
public class GridTouchStackFromBottomManyTest extends android.test.ActivityInstrumentationTestCase<android.widget.gridview.GridStackFromBottomMany> {
    private android.widget.gridview.GridStackFromBottomMany mActivity;

    private android.widget.GridView mGridView;

    public GridTouchStackFromBottomManyTest() {
        super("com.android.frameworks.coretests", android.widget.gridview.GridStackFromBottomMany.class);
    }
    ...
    public void testScrollToBottom() {
        ...
        assertEquals("Last item is not touching the bottom edge", mGridView.getHeight() - mGridView.getListPaddingBottom(), lastChild.getBottom());
    }
}
