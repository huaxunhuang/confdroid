 ...
 */
public class GridThrasher extends android.app.Activity implements android.widget.AdapterView.OnItemSelectedListener {
    android.os.Handler mHandler = new android.os.Handler();

    android.widget.gridview.GridThrasher.ThrashListAdapter mAdapter;
    ...
    public void onCreate(android.os.Bundle icicle) {
        ...
        mAdapter = new android.widget.gridview.GridThrasher.ThrashListAdapter(this);
        android.widget.GridView g = ((android.widget.GridView) (findViewById(R.id.grid)));
