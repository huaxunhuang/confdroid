...
public class ArrayAdapter<T> extends android.widget.BaseAdapter implements android.widget.Filterable , android.widget.ThemedSpinnerAdapter {
     ...
     * 		instantiating views.
     */
    public ArrayAdapter(@android.annotation.NonNull
    android.content.Context context, @android.annotation.LayoutRes
    int resource) {
        this(context, resource, 0, new java.util.ArrayList<>());
    }
    ...
    public ArrayAdapter(@android.annotation.NonNull
    android.content.Context context, @android.annotation.LayoutRes
    int resource, @android.annotation.IdRes
    int textViewResourceId) {
        this(context, resource, textViewResourceId, new java.util.ArrayList<>());
    }
    ...
    public ArrayAdapter(@android.annotation.NonNull
    android.content.Context context, @android.annotation.LayoutRes
    int resource, @android.annotation.NonNull
    T[] objects) {
        this(context, resource, 0, java.util.Arrays.asList(objects));
    }
    ...
    android.content.Context context, @android.annotation.LayoutRes
    int resource, @android.annotation.IdRes
    int textViewResourceId, @android.annotation.NonNull
    T[] objects) {
        this(context, resource, textViewResourceId, java.util.Arrays.asList(objects));
    }
    ...
    private ArrayAdapter(@android.annotation.NonNull
    android.content.Context context, @android.annotation.LayoutRes
    int resource, @android.annotation.IdRes
    int textViewResourceId, @android.annotation.NonNull
    java.util.List<T> objects, boolean objsFromResources) {
        mContext = context;
     ...
     */
    public void add(@android.annotation.Nullable
    T object) {
        synchronized(mLock) {
     ...
     */
    public void addAll(@android.annotation.NonNull
     ...
     * 		if the underlying data collection is immutable
     */
    public void insert(@android.annotation.Nullable
    T object, int index) {
        synchronized(mLock) {
            if (mOriginalValues != null) {
     ...
     * 		if the underlying data collection is immutable
     */
    public void remove(@android.annotation.Nullable
    T object) {
        synchronized(mLock) {
            if (mOriginalValues != null) {
     ...
     * 		in this adapter.
     */
    public void sort(@android.annotation.NonNull
     ...
     */
    public int getPosition(@android.annotation.Nullable
    T item) {
    ...
    @java.lang.Override
    @android.annotation.NonNull
    public android.view.View getView(int position, @android.annotation.Nullable
    android.view.View convertView, @android.annotation.NonNull
    android.view.ViewGroup parent) {
        return createViewFromResource(mInflater, position, convertView, parent, mResource);
    }

    @android.annotation.NonNull
    private android.view.View createViewFromResource(@android.annotation.NonNull
    android.view.LayoutInflater inflater, int position, @android.annotation.Nullable
    android.view.View convertView, @android.annotation.NonNull
    android.view.ViewGroup parent, int resource) {
        ...
        try {
            if (mFieldId == 0) {
                ...
                if (text == null) {
                    throw new java.lang.RuntimeException(("Failed to find view with ID " + mContext.getResources().getResourceName(mFieldId)) + " in item layout");
                }
            }
     ...
     */
    public void setDropDownViewResource(@android.annotation.LayoutRes
    int resource) {
     ...
     */
    @java.lang.Override
    public void setDropDownViewTheme(@android.annotation.Nullable
    ...
    @java.lang.Override
    public android.view.View getDropDownView(int position, @android.annotation.Nullable
    android.view.View convertView, @android.annotation.NonNull
    android.view.ViewGroup parent) {
     ...
     */
    @android.annotation.NonNull
    public static android.widget.ArrayAdapter<java.lang.CharSequence> createFromResource(@android.annotation.NonNull
    android.content.Context context, @android.annotation.ArrayRes
    int textArrayResId, @android.annotation.LayoutRes
    int textViewResId) {
        final java.lang.CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new android.widget.ArrayAdapter<>(context, textViewResId, 0, java.util.Arrays.asList(strings), true);
    }
    ...
    public java.lang.CharSequence[] getAutofillOptions() {
        ...
        final java.lang.CharSequence[] explicitOptions = super.getAutofillOptions();
        ...
        final java.lang.CharSequence[] options = new java.lang.CharSequence[size];
        ...
        protected android.widget.Filter.FilterResults performFiltering(java.lang.CharSequence prefix) {
            ...
            if (mOriginalValues == null) {
                synchronized(android.widget.ArrayAdapter.this.mLock) {
                    mOriginalValues = new java.util.ArrayList<>(mObjects);
                }
            }
            if ((prefix == null) || (prefix.length() == 0)) {
                final java.util.ArrayList<T> list;
                synchronized(android.widget.ArrayAdapter.this.mLock) {
                    list = new java.util.ArrayList<>(mOriginalValues);
                }
                results.values = list;
                results.count = list.size();
            } else {
                final java.lang.String prefixString = prefix.toString().toLowerCase();
                final java.util.ArrayList<T> values;
                synchronized(android.widget.ArrayAdapter.this.mLock) {
                    values = new java.util.ArrayList<>(mOriginalValues);
                }
                final int count = values.size();
                final java.util.ArrayList<T> newValues = new java.util.ArrayList<>();
