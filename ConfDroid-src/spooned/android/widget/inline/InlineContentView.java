...
public class InlineContentView extends android.view.ViewGroup {
    ...
    public interface SurfaceControlCallback {
         ...
         *
         * @param surfaceControl
         * 		The surface control to manipulate the surface.
         */
        void onCreated(@android.annotation.NonNull
         ...
         * 		The surface control to manipulate the surface.
         */
        void onDestroyed(@android.annotation.NonNull
        android.view.SurfaceControl surfaceControl);
    }
    ...
    public interface SurfacePackageUpdater {
         ...
         *
         * @param consumer
         * 		consumes the updated surface package.
         */
        void getSurfacePackage(@android.annotation.NonNull
        java.util.function.Consumer<android.view.SurfaceControlViewHost.SurfacePackage> consumer);
    }

    @android.annotation.NonNull
    private final android.view.SurfaceHolder.Callback mSurfaceCallback = new android.view.SurfaceHolder.Callback() {
        @java.lang.Override
        public void surfaceCreated(@android.annotation.NonNull
        android.view.SurfaceHolder holder) {
            final android.view.SurfaceControl surfaceControl = getSurfaceControl();
            surfaceControl.addOnReparentListener(mOnReparentListener);
            mSurfaceControlCallback.onCreated(surfaceControl);
        }

        @java.lang.Override
        public void surfaceChanged(@android.annotation.NonNull
        android.view.SurfaceHolder holder, int format, int width, int height) {
            /* do nothing */
        }

        @java.lang.Override
        public void surfaceDestroyed(@android.annotation.NonNull
        android.view.SurfaceHolder holder) {
            final android.view.SurfaceControl surfaceControl = getSurfaceControl();
    ...
    @android.annotation.NonNull
    private final android.view.SurfaceControl.OnReparentListener mOnReparentListener = new android.view.SurfaceControl.OnReparentListener() {
        @java.lang.Override
        public void onReparent(android.view.SurfaceControl.Transaction transaction, android.view.SurfaceControl parent) {
            final android.view.View parentSurfaceOwnerView = (parent != null) ? parent.getLocalOwnerView() : null;
            if (parentSurfaceOwnerView instanceof android.view.SurfaceView) {
                mParentSurfaceOwnerView = new java.lang.ref.WeakReference<>(((android.view.SurfaceView) (parentSurfaceOwnerView)));
            } else {
    ...
    @android.annotation.NonNull
    private final android.view.ViewTreeObserver.OnDrawListener mOnDrawListener = new android.view.ViewTreeObserver.OnDrawListener() {
        @java.lang.Override
        public void onDraw() {
            computeParentPositionAndScale();
            final int visibility = (android.widget.inline.InlineContentView.this.isShown()) ? android.view.View.VISIBLE : android.view.View.GONE;
     ...
     * @unknown 
     */
    public InlineContentView(@android.annotation.NonNull
    ...
    android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mSurfaceView = new android.view.SurfaceView(context, attrs, defStyleAttr, defStyleRes) {
            @java.lang.Override
            protected void onSetSurfacePositionAndScaleRT(@android.annotation.NonNull
            android.view.SurfaceControl.Transaction transaction, @android.annotation.NonNull
            android.view.SurfaceControl surface, int positionLeft, int positionTop, float postScaleX, float postScaleY) {
                ...
                postScaleX = android.widget.inline.InlineContentView.this.getScaleX();
                postScaleY = android.widget.inline.InlineContentView.this.getScaleY();
                onSetSurfacePositionAndScaleRT(transaction, surface, positionLeft, positionTop, postScaleX, postScaleY);
            }
        };
        mSurfaceView.setZOrderOnTop(true);
        mSurfaceView.getHolder().setFormat(android.graphics.PixelFormat.TRANSPARENT);
        addView(mSurfaceView);
        setImportantForAccessibility(android.view.View.IMPORTANT_FOR_ACCESSIBILITY_NO);
    }
     ...
     */
    @android.annotation.TestApi
    public void setChildSurfacePackageUpdater(@android.annotation.Nullable
    android.widget.inline.InlineContentView.SurfacePackageUpdater surfacePackageUpdater) {
        mSurfacePackageUpdater = surfacePackageUpdater;
    }

    @java.lang.Override
    protected void onAttachedToWindow() {
        if (android.widget.inline.InlineContentView.DEBUG)
            android.util.Log.v(android.widget.inline.InlineContentView.TAG, "onAttachedToWindow");

        super.onAttachedToWindow();
        if (mSurfacePackageUpdater != null) {
            mSurfacePackageUpdater.getSurfacePackage(( sp) -> {
                if (android.widget.inline.InlineContentView.DEBUG)
                    android.util.Log.v(android.widget.inline.InlineContentView.TAG, "Received new SurfacePackage");
    ...
    protected void onDetachedFromWindow() {
        if (android.widget.inline.InlineContentView.DEBUG)
            android.util.Log.v(android.widget.inline.InlineContentView.TAG, "onDetachedFromWindow");
     ...
     *
     * @param callback
     * 		The callback to set or {@code null} to clear.
     */
    public void setSurfaceControlCallback(@android.annotation.Nullable
    android.widget.inline.InlineContentView.SurfaceControlCallback callback) {
    ...
    public boolean setZOrderedOnTop(boolean onTop) {
        return /* allowDynamicChange */
        setZOrderedOnTop(onTop, true);
    }
    ...
    private void computeParentPositionAndScale() {
        ...
        final android.view.SurfaceView parentSurfaceOwnerView = (mParentSurfaceOwnerView != null) ? mParentSurfaceOwnerView.get() : null;
        if (parentSurfaceOwnerView != null) {
            ...
            if ((oldParentPositionX != mParentPosition[0]) || (oldParentPositionY != mParentPosition[1])) {
                contentPositionOrScaleChanged = true;
            }
            if (mParentScale == null) {
                mParentScale = new android.graphics.PointF();
            }
            final float lastParentSurfaceWidth = parentSurfaceOwnerView.getSurfaceRenderPosition().width();
            final float oldParentScaleX = mParentScale.x;
            if (lastParentSurfaceWidth > 0) {
                mParentScale.x = lastParentSurfaceWidth / ((float) (parentSurfaceOwnerView.getWidth()));
            } else {
                mParentScale.x = 1.0F;
            }
            if ((!contentPositionOrScaleChanged) && (java.lang.Float.compare(oldParentScaleX, mParentScale.x) != 0)) {
                contentPositionOrScaleChanged = true;
            }
            final float lastParentSurfaceHeight = parentSurfaceOwnerView.getSurfaceRenderPosition().height();
            final float oldParentScaleY = mParentScale.y;
            if (lastParentSurfaceHeight > 0) {
                mParentScale.y = lastParentSurfaceHeight / ((float) (parentSurfaceOwnerView.getHeight()));
            } else {
                mParentScale.y = 1.0F;
            }
            if ((!contentPositionOrScaleChanged) && (java.lang.Float.compare(oldParentScaleY, mParentScale.y) != 0)) {
                contentPositionOrScaleChanged = true;
            }
        } else
            if ((mParentPosition != null) || (mParentScale != null)) {
                contentPositionOrScaleChanged = true;
