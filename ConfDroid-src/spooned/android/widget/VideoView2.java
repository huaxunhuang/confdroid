 ...
 *
 *
 * @unknown Displays a video file.  VideoView2 class is a View class which is wrapping {@link MediaPlayer2}
 ...
 */
public class VideoView2 extends android.media.update.ViewGroupHelper<android.media.update.VideoView2Provider> {
    /**
     *
     *
     * @unknown 
     */
    @android.annotation.IntDef({ android.widget.VideoView2.VIEW_TYPE_TEXTUREVIEW, android.widget.VideoView2.VIEW_TYPE_SURFACEVIEW })
    ...
    public VideoView2(@android.annotation.NonNull
    ...
    android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(( instance, superProvider, privateProvider) -> android.media.update.ApiLoader.getProvider().createVideoView2(((android.widget.VideoView2) (instance)), superProvider, privateProvider, attrs, defStyleAttr, defStyleRes), context, attrs, defStyleAttr, defStyleRes);
     ...
     * instance if any.
     *
     * @param mediaControlView
     * 		a media control view2 instance.
     * @param intervalMs
     * 		a time interval in milliseconds until VideoView2 hides MediaControlView2.
     */
    public void setMediaControlView2(android.widget.MediaControlView2 mediaControlView, long intervalMs) {
     ...
     *
     * @param metadata
     * 		a MediaMetadata2 instance.
     * @unknown 
     */
    public void setMediaMetadata(android.media.MediaMetadata2 metadata) {
     ...
     * 		if interal MediaSession is not created yet.
     * @unknown TODO: remove
     */
     ...
     *
     * @param enable
     * 		shows closed caption or subtitles if this value is true, or hides.
     */
     ...
     *
     * @param speed
     * 		the playback speed. It should be positive.
     */
     ...
     *
     * @param mediaItem
     * 		the MediaItem2 to play
     * @see #setDataSource
     */
    public void setMediaItem(@android.annotation.NonNull
    android.media.MediaItem2 mediaItem) {
     ...
     *
     * @param dataSource
     * 		the {@link DataSourceDesc} object to play.
     * @see #setMediaItem
     */
    public void setDataSource(@android.annotation.NonNull
    android.media.DataSourceDesc dataSource) {
     ...
     *
     * @param viewType
     * 		the view type to render video
     * 		<ul>
     * 		<li>{@link #VIEW_TYPE_SURFACEVIEW}
     * 		<li>{@link #VIEW_TYPE_TEXTUREVIEW}
     * 		</ul>
     */
    public void setViewType(@android.widget.VideoView2.ViewType
    int viewType) {
     ...
     */
    @android.widget.VideoView2.ViewType
     ...
     *
     * @param actionList
     * 		A list of {@link PlaybackState.CustomAction}. The return value of
     * 		{@link PlaybackState.CustomAction#getIcon()} will be used to draw buttons
     * 		in {@link MediaControlView2}.
     * @param executor
     * 		executor to run callbacks on.
     * @param listener
     * 		A listener to be called when a custom button is clicked.
     * @unknown TODO remove
     */
    public void setCustomActions(java.util.List<android.media.session.PlaybackState.CustomAction> actionList, java.util.concurrent.Executor executor, android.widget.VideoView2.OnCustomActionListener listener) {
    ...
    public void setOnViewTypeChangedListener(android.widget.VideoView2.OnViewTypeChangedListener l) {
     ...
     * @unknown TODO remove
     */
    public void setFullScreenRequestListener(android.widget.VideoView2.OnFullScreenRequestListener l) {
    ...
    public interface OnViewTypeChangedListener {
         ...
         * @see #setViewType(int)
         * @param view
         * 		the View whose view type is changed
         * @param viewType
         * 		<ul>
         * 		<li>{@link #VIEW_TYPE_SURFACEVIEW}
         * 		<li>{@link #VIEW_TYPE_TEXTUREVIEW}
         * 		</ul>
         */
        void onViewTypeChanged(android.view.View view, @android.widget.VideoView2.ViewType
        int viewType);
    }
    ...
    public interface OnFullScreenRequestListener {
         ...
         */
        void onFullScreenRequest(android.view.View view, boolean fullScreen);
    }
    ...
    public interface OnCustomActionListener {
         ...
         * 		Optional extras.
         */
        void onCustomAction(java.lang.String action, android.os.Bundle extras);
    }
