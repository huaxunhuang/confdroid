 ...
 * guide.</p>
 *
 * @unknown ref android.R.styleable#AutoCompleteTextView_completionHint
 * @unknown ref android.R.styleable#AutoCompleteTextView_completionThreshold
 * @unknown ref android.R.styleable#AutoCompleteTextView_completionHintView
 * @unknown ref android.R.styleable#AutoCompleteTextView_dropDownSelector
 * @unknown ref android.R.styleable#AutoCompleteTextView_dropDownAnchor
 * @unknown ref android.R.styleable#AutoCompleteTextView_dropDownWidth
 * @unknown ref android.R.styleable#AutoCompleteTextView_dropDownHeight
...
public class AutoCompleteTextView extends android.widget.EditText implements android.widget.Filter.FilterListener {
     ...
     */
    public AutoCompleteTextView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes, android.content.res.Resources.Theme popupTheme) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AutoCompleteTextView, defStyleAttr, defStyleRes);
        ...
        final android.content.res.TypedArray pa;
        ...
        final android.graphics.drawable.Drawable popupListSelector = pa.getDrawable(R.styleable.AutoCompleteTextView_dropDownSelector);
        final int popupWidth = pa.getLayoutDimension(R.styleable.AutoCompleteTextView_dropDownWidth, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        final int popupHeight = pa.getLayoutDimension(R.styleable.AutoCompleteTextView_dropDownHeight, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        final java.lang.CharSequence popupHintText = pa.getText(R.styleable.AutoCompleteTextView_completionHint);
        if (pa != a) {
            pa.recycle();
        }
        mPopup = new android.widget.ListPopupWindow(mPopupContext, attrs, defStyleAttr, defStyleRes);
        ...
        mDropDownAnchorId = a.getResourceId(R.styleable.AutoCompleteTextView_dropDownAnchor, android.view.View.NO_ID);
        mThreshold = a.getInt(R.styleable.AutoCompleteTextView_completionThreshold, 2);
        a.recycle();
        // Always turn on the auto complete input type flag, since it
        // makes no sense to use this widget without it.
        int inputType = getInputType();
        if ((inputType & TYPE_MASK_CLASS) == TYPE_CLASS_TEXT) {
            inputType |= TYPE_TEXT_FLAG_AUTO_COMPLETE;
            setRawInputType(inputType);
        }
        setFocusable(true);
        mAutoCompleteTextWatcher = new android.widget.AutoCompleteTextView.MyWatcher();
    ...
    public void setCompletionHint(java.lang.CharSequence hint) {
        ...
        if (hint != null) {
            if (mHintView == null) {
                final android.widget.TextView hintView = ((android.widget.TextView) (android.view.LayoutInflater.from(mPopupContext).inflate(mHintResource, null).findViewById(R.id.text1)));
     ...
     */
    @android.view.inspector.InspectableProperty(name = "popupBackground")
     ...
     * @unknown ref android.R.styleable#PopupWindow_popupBackground
     */
    public void setDropDownBackgroundResource(@android.annotation.DrawableRes
    int id) {
     ...
     * @unknown ref android.R.styleable#AutoCompleteTextView_completionThreshold
     */
    @android.view.inspector.InspectableProperty(name = "completionThreshold")
    ...
    public boolean onKeyPreIme(int keyCode, android.view.KeyEvent event) {
        if (((keyCode == android.view.KeyEvent.KEYCODE_BACK) && isPopupShowing()) && (!mPopup.isDropDownAlwaysVisible())) {
    ...
    public boolean enoughToFilter() {
        if (android.widget.AutoCompleteTextView.DEBUG)
            android.util.Log.v(android.widget.AutoCompleteTextView.TAG, (("Enough to filter: len=" + getText().length()) + " threshold=") + mThreshold);
    ...
    private class MyWatcher implements android.text.TextWatcher {
        ...
        public void beforeTextChanged(java.lang.CharSequence s, int start, int count, int after) {
            ...
            if (android.widget.AutoCompleteTextView.DEBUG)
                android.util.Log.v(android.widget.AutoCompleteTextView.TAG, "before text changed: open=" + mOpenBefore);
        ...
        public void afterTextChanged(android.text.Editable s) {
            ...
            if (android.widget.AutoCompleteTextView.DEBUG) {
                android.util.Log.v(android.widget.AutoCompleteTextView.TAG, (("after text changed: openBefore=" + mOpenBefore) + " open=") + isPopupShowing());
            }
    ...
    private void performCompletion(android.view.View selectedView, int position, long id) {
        if (isPopupShowing()) {
            ...
            if (selectedItem == null) {
                android.util.Log.w(android.widget.AutoCompleteTextView.TAG, "performCompletion: no selected item");
                return;
            }
            ...
            if (mItemClickListener != null) {
                final android.widget.ListPopupWindow list = mPopup;
     ...
     */
    public void setText(java.lang.CharSequence text, boolean filter) {
        if (filter) {
            setText(text);
        } else {
            mBlockCompletion = true;
    ...
    protected void replaceText(java.lang.CharSequence text) {
        ...
        android.text.Editable spannable = getText();
     ...
     *
     * @unknown internal used only by SearchDialog
     */
    @android.annotation.UnsupportedAppUsage
     ...
     * @unknown internal used only here and SearchDialog
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768913)
    public void ensureImeVisible(boolean visible) {
        mPopup.setInputMethodMode(visible ? android.widget.ListPopupWindow.INPUT_METHOD_NEEDED : android.widget.ListPopupWindow.INPUT_METHOD_NOT_NEEDED);
     ...
     *
     * @unknown This API is not being used and can be removed.
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P)
     ...
     * {@hide }
     */
    @android.annotation.IntDef({ android.widget.ListPopupWindow.INPUT_METHOD_FROM_FOCUSABLE, android.widget.ListPopupWindow.INPUT_METHOD_NEEDED, android.widget.ListPopupWindow.INPUT_METHOD_NOT_NEEDED })
     ...
     *
     * @param mode
     * 		speficies the input method mode. use one of the following values:
     * 		
     ...
     */
    public void setInputMethodMode(@android.widget.AutoCompleteTextView.InputMethodMode
    int mode) {
    ...
    public void showDropDown() {
        ...
        if (!isPopupShowing()) {
            ...
            mPopup.setListItemExpandMax(android.widget.AutoCompleteTextView.EXPAND_MAX);
        }
        mPopup.show();
     ...
     *
     * @unknown used only by SearchDialog
     */
    @android.annotation.UnsupportedAppUsage
    ...
    private void buildImeCompletions() {
        ...
        if (adapter != null) {
            android.view.inputmethod.InputMethodManager imm = getContext().getSystemService(android.view.inputmethod.InputMethodManager.class);
            if (imm != null) {
                final int count = java.lang.Math.min(adapter.getCount(), 20);
                android.view.inputmethod.CompletionInfo[] completions = new android.view.inputmethod.CompletionInfo[count];
                int realCount = 0;
                for (int i = 0; i < count; i++) {
                    if (adapter.isEnabled(i)) {
                        java.lang.Object item = adapter.getItem(i);
                        long id = adapter.getItemId(i);
                        completions[realCount] = new android.view.inputmethod.CompletionInfo(id, realCount, convertSelectionToString(item));
                        realCount++;
                    }
                }
                if (realCount != count) {
                    android.view.inputmethod.CompletionInfo[] tmp = new android.view.inputmethod.CompletionInfo[realCount];
                    java.lang.System.arraycopy(completions, 0, tmp, 0, realCount);
                    completions = tmp;
                }
    ...
    private static class PopupDataSetObserver extends android.database.DataSetObserver {
        ...
        private PopupDataSetObserver(android.widget.AutoCompleteTextView view) {
            mViewReference = new java.lang.ref.WeakReference<android.widget.AutoCompleteTextView>(view);
        }
        ...
        private final java.lang.Runnable updateRunnable = new java.lang.Runnable() {
            @java.lang.Override
            public void run() {
                final android.widget.AutoCompleteTextView textView = mViewReference.get();
                if (textView == null) {
                ...
                final android.widget.ListAdapter adapter = textView.mAdapter;
                if (adapter == null) {
                    return;
                }
