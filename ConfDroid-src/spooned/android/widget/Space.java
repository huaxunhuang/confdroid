...
public final class Space extends android.view.View {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(android.widget.Space.getDefaultSize2(getSuggestedMinimumWidth(), widthMeasureSpec), android.widget.Space.getDefaultSize2(getSuggestedMinimumHeight(), heightMeasureSpec));
    }
}
