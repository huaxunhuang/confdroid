 ...
 * columns.
 */
public abstract class CursorAdapter extends android.widget.BaseAdapter implements android.widget.CursorFilter.CursorFilterClient , android.widget.Filterable , android.widget.ThemedSpinnerAdapter {
    /**
    ...
    public CursorAdapter(android.content.Context context, android.database.Cursor c) {
        init(context, c, android.widget.CursorAdapter.FLAG_AUTO_REQUERY);
    }
    ...
    public CursorAdapter(android.content.Context context, android.database.Cursor c, boolean autoRequery) {
        init(context, c, autoRequery ? android.widget.CursorAdapter.FLAG_AUTO_REQUERY : android.widget.CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER);
    }
    ...
    void init(android.content.Context context, android.database.Cursor c, int flags) {
        if ((flags & android.widget.CursorAdapter.FLAG_AUTO_REQUERY) == android.widget.CursorAdapter.FLAG_AUTO_REQUERY) {
            flags |= android.widget.CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER;
            mAutoRequery = true;
        } else {
            mAutoRequery = false;
        }
        ...
        if ((flags & android.widget.CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER) == android.widget.CursorAdapter.FLAG_REGISTER_CONTENT_OBSERVER) {
            mChangeObserver = new android.widget.CursorAdapter.ChangeObserver();
            mDataSetObserver = new android.widget.CursorAdapter.MyDataSetObserver();
        } else {
    ...
    public void setDropDownViewTheme(android.content.res.Resources.Theme theme) {
        if (theme == null) {
            ...
            if (theme == mContext.getTheme()) {
                ...
                mDropDownContext = new android.view.ContextThemeWrapper(mContext, theme);
            }
