 ...
 *
 * @unknown ref android.R.styleable#TwoLineListItem_mode
...
public class TwoLineListItem extends android.widget.RelativeLayout {
    ...
    public TwoLineListItem(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, com.android.internal.R.styleable.TwoLineListItem, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, com.android.internal.R.styleable.TwoLineListItem, attrs, a, defStyleAttr, defStyleRes);
        a.recycle();
    }
