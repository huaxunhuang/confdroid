...
public class ActionMenuView extends android.widget.LinearLayout implements com.android.internal.view.menu.MenuBuilder.ItemInvoker , com.android.internal.view.menu.MenuView {
    ...
    public ActionMenuView(android.content.Context context, android.util.AttributeSet attrs) {
        ...
        mMinCellSize = ((int) (android.widget.ActionMenuView.MIN_CELL_SIZE * density));
        mGeneratedItemPadding = ((int) (android.widget.ActionMenuView.GENERATED_ITEM_PADDING * density));
     ...
     * @unknown 
     */
    public void setPresenter(android.widget.ActionMenuPresenter presenter) {
    ...
    public void setOnMenuItemClickListener(android.widget.ActionMenuView.OnMenuItemClickListener listener) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mFormatItems && (childCount > 0)) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final android.widget.ActionMenuView.LayoutParams lp = ((android.widget.ActionMenuView.LayoutParams) (child.getLayoutParams()));
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final boolean isGeneratedItem = child instanceof com.android.internal.view.menu.ActionMenuItemView;
            visibleItemCount++;
            if (isGeneratedItem) {
            ...
            lp.leftMargin = 0;
            lp.rightMargin = 0;
            lp.preventEdgeOffset = isGeneratedItem && ((com.android.internal.view.menu.ActionMenuItemView) (child)).hasText();
            // Overflow always gets 1 cell. No more, no less.
            final int cellsAvailable = (lp.isOverflowButton) ? 1 : cellsRemaining;
            final int cellsUsed = android.widget.ActionMenuView.measureChildForCells(child, cellSize, cellsAvailable, itemHeightSpec, heightPadding);
        ...
        if (((cellsRemaining > 0) && (smallestItemsAt != 0)) && (((cellsRemaining < (visibleItemCount - 1)) || singleItem) || (maxCellsUsed > 1))) {
            ...
            if (!singleItem) {
                ...
                if ((smallestItemsAt & 1) != 0) {
                    android.widget.ActionMenuView.LayoutParams lp = ((android.widget.ActionMenuView.LayoutParams) (getChildAt(0).getLayoutParams()));
                    if (!lp.preventEdgeOffset)
                        expandCount -= 0.5F;

                }
                if ((smallestItemsAt & (1 << (childCount - 1))) != 0) {
                    android.widget.ActionMenuView.LayoutParams lp = ((android.widget.ActionMenuView.LayoutParams) (getChildAt(childCount - 1).getLayoutParams()));
                    if (!lp.preventEdgeOffset)
                        expandCount -= 0.5F;
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                final android.view.View child = getChildAt(i);
                final android.widget.ActionMenuView.LayoutParams lp = ((android.widget.ActionMenuView.LayoutParams) (child.getLayoutParams()));
                if (child instanceof com.android.internal.view.menu.ActionMenuItemView) {
    ...
    static int measureChildForCells(android.view.View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        final com.android.internal.view.menu.ActionMenuItemView itemView = (child instanceof com.android.internal.view.menu.ActionMenuItemView) ? ((com.android.internal.view.menu.ActionMenuItemView) (child)) : null;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            android.widget.ActionMenuView.LayoutParams p = ((android.widget.ActionMenuView.LayoutParams) (v.getLayoutParams()));
        ...
        if (isLayoutRtl) {
            ...
            for (int i = 0; i < childCount; i++) {
                final android.view.View v = getChildAt(i);
                final android.widget.ActionMenuView.LayoutParams lp = ((android.widget.ActionMenuView.LayoutParams) (v.getLayoutParams()));
    ...
    protected android.widget.ActionMenuView.LayoutParams generateDefaultLayoutParams() {
        android.widget.ActionMenuView.LayoutParams params = new android.widget.ActionMenuView.LayoutParams(android.widget.ActionMenuView.LayoutParams.WRAP_CONTENT, android.widget.ActionMenuView.LayoutParams.WRAP_CONTENT);
        params.gravity = android.view.Gravity.CENTER_VERTICAL;
        return params;
    }

    @java.lang.Override
    public android.widget.ActionMenuView.LayoutParams generateLayoutParams(android.util.AttributeSet attrs) {
        return new android.widget.ActionMenuView.LayoutParams(getContext(), attrs);
    }

    @java.lang.Override
    protected android.widget.ActionMenuView.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (p != null) {
            final android.widget.ActionMenuView.LayoutParams result = (p instanceof android.widget.ActionMenuView.LayoutParams) ? new android.widget.ActionMenuView.LayoutParams(((android.widget.ActionMenuView.LayoutParams) (p))) : new android.widget.ActionMenuView.LayoutParams(p);
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return (p != null) && (p instanceof android.widget.ActionMenuView.LayoutParams);
    }
    ...
    public android.widget.ActionMenuView.LayoutParams generateOverflowButtonLayoutParams() {
        android.widget.ActionMenuView.LayoutParams result = generateDefaultLayoutParams();
     ...
     * @unknown 
     */
    public boolean invokeItem(com.android.internal.view.menu.MenuItemImpl item) {
     ...
     * @unknown 
     */
    public void initialize(@android.annotation.Nullable
    ...
    public android.view.Menu getMenu() {
        if (mMenu == null) {
            ...
            mMenu.setCallback(new android.widget.ActionMenuView.MenuBuilderCallback());
            mPresenter = new android.widget.ActionMenuPresenter(context);
            mPresenter.setReserveOverflow(true);
            mPresenter.setCallback(mActionMenuPresenterCallback != null ? mActionMenuPresenterCallback : new android.widget.ActionMenuView.ActionMenuPresenterCallback());
    ...
    protected boolean hasDividerBeforeChildAt(int childIndex) {
        ...
        if ((childIndex < getChildCount()) && (childBefore instanceof android.widget.ActionMenuView.ActionMenuChildView)) {
            result |= ((android.widget.ActionMenuView.ActionMenuChildView) (childBefore)).needsDividerAfter();
        }
        if ((childIndex > 0) && (child instanceof android.widget.ActionMenuView.ActionMenuChildView)) {
            result |= ((android.widget.ActionMenuView.ActionMenuChildView) (child)).needsDividerBefore();
        }
        return result;
    }
    ...
    private class ActionMenuPresenterCallback implements android.widget.ActionMenuPresenter.Callback {
        @java.lang.Override
