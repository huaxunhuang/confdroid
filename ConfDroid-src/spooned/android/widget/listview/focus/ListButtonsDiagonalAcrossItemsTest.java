 ...
 */
public class ListButtonsDiagonalAcrossItemsTest extends android.test.ActivityInstrumentationTestCase<android.widget.listview.ListButtonsDiagonalAcrossItems> {
    private android.widget.Button mLeftButton;

    private android.widget.Button mCenterButton;

    private android.widget.Button mRightButton;

    private android.widget.ListView mListView;

    public ListButtonsDiagonalAcrossItemsTest() {
        super("com.android.frameworks.coretests", android.widget.listview.ListButtonsDiagonalAcrossItems.class);
    }
    ...
    public void testPreconditions() {
        final android.widget.ListView lv = mListView;
        ...
        assertEquals("focus search right from left button should be center button", mCenterButton, android.view.FocusFinder.getInstance().findNextFocus(mListView, mLeftButton, android.view.View.FOCUS_RIGHT));
        assertEquals("focus search right from center button should be right button", mRightButton, android.view.FocusFinder.getInstance().findNextFocus(mListView, mCenterButton, android.view.View.FOCUS_RIGHT));
        assertEquals("focus search left from centr button should be left button", mLeftButton, android.view.FocusFinder.getInstance().findNextFocus(mListView, mCenterButton, android.view.View.FOCUS_LEFT));
    }

    @android.test.suitebuilder.annotation.MediumTest
    public void testGoingRightDoesNotChangeSelection() {
        sendKeys(android.view.KeyEvent.KEYCODE_DPAD_RIGHT);
        assertEquals("selected position shouldn't have changed", 0, mListView.getSelectedItemPosition());
