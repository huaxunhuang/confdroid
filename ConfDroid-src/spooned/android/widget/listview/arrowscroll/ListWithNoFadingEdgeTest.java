...
public class ListWithNoFadingEdgeTest extends android.test.ActivityInstrumentationTestCase<android.widget.listview.ListWithNoFadingEdge> {
    private android.widget.ListView mListView;

    public ListWithNoFadingEdgeTest() {
        super("com.android.frameworks.coretests", android.widget.listview.ListWithNoFadingEdge.class);
    }
