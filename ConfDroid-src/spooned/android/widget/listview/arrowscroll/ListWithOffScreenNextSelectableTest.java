...
public class ListWithOffScreenNextSelectableTest extends android.test.ActivityInstrumentationTestCase<android.widget.listview.ListWithOffScreenNextSelectable> {
    private android.widget.ListView mListView;

    public ListWithOffScreenNextSelectableTest() {
        super("com.android.frameworks.coretests", android.widget.listview.ListWithOffScreenNextSelectable.class);
    }
    ...
    public void testPreconditions() {
        ...
        assertEquals("only 4 children should be on screen (so that next selectable is off " + "screen) for this test to be meaningful.", 4, mListView.getChildCount());
    ...
    public void testGoDownToOffScreenSelectable() {
        ...
        final android.view.View lastVisibleView = mListView.getChildAt(mListView.getChildCount() - 1);
        ...
        assertEquals("wrong view created when scrolling", getActivity().getValueAtPosition(4), ((android.widget.TextView) (mListView.getSelectedView())).getText());
    ...
    public void testGoUpToOffScreenSelectable() {
        ...
        final android.view.View firstVisibleView = mListView.getChildAt(0);
        ...
        assertEquals(getActivity().getValueAtPosition(0), ((android.widget.TextView) (mListView.getSelectedView())).getText());
