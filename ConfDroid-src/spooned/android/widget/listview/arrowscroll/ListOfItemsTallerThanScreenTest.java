...
public class ListOfItemsTallerThanScreenTest extends android.test.ActivityInstrumentationTestCase2<android.widget.listview.ListOfItemsTallerThanScreen> {
    private android.widget.ListView mListView;

    private android.widget.listview.ListOfItemsTallerThanScreen mActivity;
    ...
    public ListOfItemsTallerThanScreenTest() {
        super(android.widget.listview.ListOfItemsTallerThanScreen.class);
    }
    ...
    public void testPreconditions() {
        ...
        assertTrue("must be more than max scroll off screen for this test to work", amountOffScreen > mListView.getMaxScrollAmount());
    }
    ...
    public void testScrollDownAcrossItem() {
        ...
        final android.view.View peekingView = mListView.getChildAt(1);
    ...
    private int getNumDownPressesToScrollDownAcrossSelected() {
        android.view.View selected = mListView.getSelectedView();
        int realBottom = mListView.getBottom() - mListView.getListPaddingBottom();
        assertTrue("view should be overlapping bottom", selected.getBottom() > realBottom);
        assertTrue("view should be overlapping bottom", selected.getTop() < realBottom);
