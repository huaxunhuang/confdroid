...
public class ListOfThinItemsTest extends android.test.ActivityInstrumentationTestCase<android.widget.listview.ListOfThinItems> {
    ...
    public void testPreconditions() {
        ...
        assertTrue("need item height less than fading edge length", mListView.getSelectedView().getHeight() < mListView.getVerticalFadingEdgeLength());
        assertTrue("need items off screen", mListView.getChildCount() < mListView.getAdapter().getCount());
    }
    ...
    public void testScrollToBottom() {
        ...
        for (int i = 0; i < numItems; i++) {
            ...
            java.lang.String prefix = ("after " + i) + " down presses, ";
    ...
    public void testScrollToTop() {
        ...
        for (int i = 0; i < numItems; i++) {
            ...
            java.lang.String prefix = ("after " + i) + " up presses, ";
