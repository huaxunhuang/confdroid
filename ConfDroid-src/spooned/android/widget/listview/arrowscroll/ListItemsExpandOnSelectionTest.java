...
public class ListItemsExpandOnSelectionTest extends android.test.ActivityInstrumentationTestCase<android.widget.listview.ListItemsExpandOnSelection> {
    ...
    public ListItemsExpandOnSelectionTest() {
        super("com.android.frameworks.coretests", android.widget.listview.ListItemsExpandOnSelection.class);
    }
    ...
    public void testPreconditions() {
        ...
        assertEquals("selected item should be 1.5 times taller than the others", mExpandedHeight, ((int) (mNormalHeight * 1.5)));
    }
    ...
    public void testMoveSelectionDownNotRequiringScroll() {
        ...
        assertEquals("first item's top should not have shifted", mListTop, mListView.getChildAt(0).getTop());
    }
    ...
    public void testMoveSelectionUpNotRequiringScroll() {
        ...
        assertEquals("bottom of 2nd itme should have stayed the same when " + "moving back up", oldBottom, mListView.getChildAt(1).getBottom());
    }
