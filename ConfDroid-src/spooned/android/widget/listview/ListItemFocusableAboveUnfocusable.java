 ...
 */
public class ListItemFocusableAboveUnfocusable extends android.util.ListScenario {
    protected void init(android.widget.listview.Params params) {
        params.setNumItems(2).setItemsFocusable(true).setItemScreenSizeFactor(0.2).setMustFillScreen(false);
    }
