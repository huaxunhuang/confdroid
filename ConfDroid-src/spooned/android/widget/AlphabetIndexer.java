...
public class AlphabetIndexer extends android.database.DataSetObserver implements android.widget.SectionIndexer {
     ...
     */
    public AlphabetIndexer(android.database.Cursor cursor, int sortedColumnIndex, java.lang.CharSequence alphabet) {
        mDataCursor = cursor;
        mColumnIndex = sortedColumnIndex;
        mAlphabet = alphabet;
        mAlphabetLength = alphabet.length();
        mAlphabetArray = new java.lang.String[mAlphabetLength];
        for (int i = 0; i < mAlphabetLength; i++) {
            mAlphabetArray[i] = java.lang.Character.toString(mAlphabet.charAt(i));
        }
        mAlphaMap = new android.util.SparseIntArray(mAlphabetLength);
        if (cursor != null) {
    ...
    protected int compare(java.lang.String word, java.lang.String letter) {
        final java.lang.String firstLetter;
        if (word.length() == 0) {
            firstLetter = " ";
        } else {
    ...
    public int getPositionForSection(int sectionIndex) {
        final android.util.SparseIntArray alphaMap = mAlphaMap;
        final android.database.Cursor cursor = mDataCursor;
        ...
        java.lang.String targetLetter = java.lang.Character.toString(letter);
        int key = letter;
        // Check map
        if (java.lang.Integer.MIN_VALUE != (pos = alphaMap.get(key, java.lang.Integer.MIN_VALUE))) {
        ...
        if (sectionIndex > 0) {
            ...
            int prevLetterPos = alphaMap.get(prevLetter, java.lang.Integer.MIN_VALUE);
            if (prevLetterPos != java.lang.Integer.MIN_VALUE) {
                start = java.lang.Math.abs(prevLetterPos);
            }
        }
        ...
        while (pos < end) {
            ...
            java.lang.String curName = cursor.getString(mColumnIndex);
            if (curName == null) {
                if (pos == 0) {
                    break;
                } else {
    ...
    public int getSectionForPosition(int position) {
        ...
        java.lang.String curName = mDataCursor.getString(mColumnIndex);
