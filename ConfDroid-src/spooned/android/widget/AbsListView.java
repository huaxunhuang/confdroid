 ...
 *
 * @unknown ref android.R.styleable#AbsListView_listSelector
 * @unknown ref android.R.styleable#AbsListView_drawSelectorOnTop
 * @unknown ref android.R.styleable#AbsListView_stackFromBottom
 * @unknown ref android.R.styleable#AbsListView_scrollingCache
 * @unknown ref android.R.styleable#AbsListView_textFilterEnabled
 * @unknown ref android.R.styleable#AbsListView_transcriptMode
 * @unknown ref android.R.styleable#AbsListView_cacheColorHint
 * @unknown ref android.R.styleable#AbsListView_fastScrollEnabled
 * @unknown ref android.R.styleable#AbsListView_smoothScrollbar
 * @unknown ref android.R.styleable#AbsListView_choiceMode
 */
public abstract class AbsListView extends android.widget.AdapterView<android.widget.ListAdapter> implements android.text.TextWatcher , android.view.ViewTreeObserver.OnGlobalLayoutListener , android.view.ViewTreeObserver.OnTouchModeChangeListener , android.widget.Filter.FilterListener , android.widget.RemoteViewsAdapter.RemoteAdapterConnectionCallback {
     ...
     */
    int mChoiceMode = android.widget.AbsListView.CHOICE_MODE_NONE;
     ...
     */
    @android.annotation.UnsupportedAppUsage
    int mLayoutMode = android.widget.AbsListView.LAYOUT_NORMAL;
    ...
    int mSelectorPosition = android.widget.AdapterView.INVALID_POSITION;

    /**
     * Defines the selector's location and dimension at drawing time
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P)
    android.graphics.Rect mSelectorRect = new android.graphics.Rect();

    /**
     * The data set used to store unused views that should be reused during the next layout
     * to avoid creating new ones
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769398)
    final android.widget.AbsListView.RecycleBin mRecycler = new android.widget.AbsListView.RecycleBin();
     ...
     * This view's padding
     */
    android.graphics.Rect mListPadding = new android.graphics.Rect();
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769413)
    int mTouchMode = android.widget.AbsListView.TOUCH_MODE_REST;
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769353)
     ...
     */
    int mResurrectToPosition = android.widget.AdapterView.INVALID_POSITION;

    @android.annotation.UnsupportedAppUsage
    private android.view.ContextMenu.ContextMenuInfo mContextMenuInfo = null;
    ...
    private int mLastTouchMode = android.widget.AbsListView.TOUCH_MODE_UNKNOWN;
     ...
     */
    private int mLastScrollState = android.widget.AbsListView.OnScrollListener.SCROLL_STATE_IDLE;

    /**
     * Helper object that renders and controls the fast scroll thumb.
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768941)
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 124051740)
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
    private int mActivePointerId = android.widget.AbsListView.INVALID_POINTER;
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769379)
    ...
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769408)
    private android.widget.EdgeEffect mEdgeGlowTop = new android.widget.EdgeEffect(mContext);
     ...
     */
    @android.annotation.NonNull
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768444)
    private android.widget.EdgeEffect mEdgeGlowBottom = new android.widget.EdgeEffect(mContext);
    ...
    public AbsListView(android.content.Context context) {
        super(context);
        initAbsListView();
        mOwnerThread = java.lang.Thread.currentThread();
        setVerticalScrollBarEnabled(true);
        android.content.res.TypedArray a = context.obtainStyledAttributes(R.styleable.View);
    ...
    public AbsListView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public AbsListView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        initAbsListView();
        mOwnerThread = java.lang.Thread.currentThread();
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AbsListView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.AbsListView, attrs, a, defStyleAttr, defStyleRes);
        final android.graphics.drawable.Drawable selector = a.getDrawable(R.styleable.AbsListView_listSelector);
        if (selector != null) {
        ...
        setTranscriptMode(a.getInt(R.styleable.AbsListView_transcriptMode, android.widget.AbsListView.TRANSCRIPT_MODE_DISABLED));
        ...
        setChoiceMode(a.getInt(R.styleable.AbsListView_choiceMode, android.widget.AbsListView.CHOICE_MODE_NONE));
    ...
    public void setAdapter(android.widget.ListAdapter adapter) {
        if (adapter != null) {
            ...
            if (((mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) && mAdapterHasStableIds) && (mCheckedIdStates == null)) {
                mCheckedIdStates = new android.util.LongSparseArray<java.lang.Integer>();
            }
        }
        clearChoices();
    }
    ...
    public int getCheckedItemPosition() {
        if (((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_SINGLE) && (mCheckStates != null)) && (mCheckStates.size() == 1)) {
    ...
    public android.util.SparseBooleanArray getCheckedItemPositions() {
        if (mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) {
            return mCheckStates;
        }
        return null;
    }
    ...
    public long[] getCheckedItemIds() {
        if (((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_NONE) || (mCheckedIdStates == null)) || (mAdapter == null)) {
            return new long[0];
        }
        final android.util.LongSparseArray<java.lang.Integer> idStates = mCheckedIdStates;
    ...
    public void setItemChecked(int position, boolean value) {
        ...
        if ((value && (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL)) && (mChoiceActionMode == null)) {
        ...
        if ((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE) || (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL)) {
    ...
    public boolean performItemClick(android.view.View view, int position, long id) {
        ...
        if (mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) {
            ...
            if ((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE) || ((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL) && (mChoiceActionMode != null))) {
                ...
                if (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_SINGLE) {
                    boolean checked = !mCheckStates.get(position, false);
                    if (checked) {
                        mCheckStates.clear();
                        mCheckStates.put(position, true);
    ...
    private void updateOnScreenCheckedViews() {
        ...
        final boolean useActivated = getContext().getApplicationInfo().targetSdkVersion >= android.widget.android.os.Build.VERSION_CODES;
        for (int i = 0; i < count; i++) {
     ...
     */
    @android.view.inspector.InspectableProperty(enumMapping = { @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.CHOICE_MODE_NONE, name = "none"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.CHOICE_MODE_SINGLE, name = "singleChoice"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.CHOICE_MODE_MULTIPLE, name = "multipleChoice"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL, name = "multipleChoiceModal") })
     ...
     *
     * @param choiceMode
     * 		One of {@link #CHOICE_MODE_NONE}, {@link #CHOICE_MODE_SINGLE}, or
     * 		{@link #CHOICE_MODE_MULTIPLE}
     */
    public void setChoiceMode(int choiceMode) {
        ...
        if (mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) {
            if (mCheckStates == null) {
                mCheckStates = new android.util.SparseBooleanArray(0);
            }
            if (((mCheckedIdStates == null) && (mAdapter != null)) && mAdapter.hasStableIds()) {
                mCheckedIdStates = new android.util.LongSparseArray<java.lang.Integer>(0);
            }
            // Modal multi-choice mode only has choices when the mode is active. Clear them.
            if (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL) {
                clearChoices();
    ...
    private void setFastScrollerEnabledUiThread(boolean enabled) {
        if (mFastScroll != null) {
            ...
            if (enabled) {
                mFastScroll = new android.widget.FastScroller(this, mFastScrollStyle);
    ...
    private boolean isOwnerThread() {
        return mOwnerThread == java.lang.Thread.currentThread();
    }
    ...
    public int getVerticalScrollbarWidth() {
        if ((mFastScroll != null) && mFastScroll.isEnabled()) {
            return java.lang.Math.max(super.getVerticalScrollbarWidth(), mFastScroll.getWidth());
        }
     ...
     */
    @android.view.ViewDebug.ExportedProperty
    @android.view.inspector.InspectableProperty(name = "smoothScrollbar")
    ...
    int getSelectionModeForAccessibility() {
        ...
        switch (choiceMode) {
            case android.widget.AbsListView.CHOICE_MODE_NONE :
                return android.view.accessibility.AccessibilityNodeInfo.CollectionInfo.SELECTION_MODE_NONE;
            case android.widget.AbsListView.CHOICE_MODE_SINGLE :
                return android.view.accessibility.AccessibilityNodeInfo.CollectionInfo.SELECTION_MODE_SINGLE;
            case android.widget.AbsListView.CHOICE_MODE_MULTIPLE :
            case android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL :
                return android.view.accessibility.AccessibilityNodeInfo.CollectionInfo.SELECTION_MODE_MULTIPLE;
            default :
                return android.view.accessibility.AccessibilityNodeInfo.CollectionInfo.SELECTION_MODE_NONE;
        }
    }
            ...
            case R.id.accessibilityActionScrollDown :
                {
                    if (isEnabled() && canScrollDown()) {
                        ...
                        smoothScrollBy(viewportHeight, android.widget.AbsListView.PositionScroller.SCROLL_DURATION);
                        return true;
                    }
                }
                return false;
     ...
     */
    @android.view.ViewDebug.ExportedProperty
    @android.view.inspector.InspectableProperty(name = "scrollingCache")
    ...
    static class SavedState extends android.view.View.BaseSavedState {
        ...
        private SavedState(android.os.Parcel in) {
            ...
            if (N > 0) {
                checkIdState = new android.util.LongSparseArray<java.lang.Integer>();
                for (int i = 0; i < N; i++) {
        ...
        public java.lang.String toString() {
            return ((((((((((((((("AbsListView.SavedState{" + java.lang.Integer.toHexString(java.lang.System.identityHashCode(this))) + " selectedId=") + selectedId) + " firstId=") + firstId) + " viewTop=") + viewTop) + " position=") + position) + " height=") + height) + " filter=") + filter) + " checkState=") + checkState) + "}";
        }

        @android.annotation.NonNull
        public static final android.os.Parcelable.Creator<android.widget.AbsListView.SavedState> CREATOR = new android.os.Parcelable.Creator<android.widget.AbsListView.SavedState>() {
            @java.lang.Override
    ...
    public android.os.Parcelable onSaveInstanceState() {
        ...
        android.widget.AbsListView.SavedState ss = new android.widget.AbsListView.SavedState(superState);
        ...
        ss.filter = null;
        if (mFiltered) {
            final android.widget.EditText textFilter = mTextFilter;
            if (textFilter != null) {
                android.text.Editable filterText = textFilter.getText();
                if (filterText != null) {
                    ss.filter = filterText.toString();
                }
            }
        }
        ss.inActionMode = (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL) && (mChoiceActionMode != null);
        if (mCheckStates != null) {
            ss.checkState = mCheckStates.clone();
        }
        if (mCheckedIdStates != null) {
            final android.util.LongSparseArray<java.lang.Integer> idState = new android.util.LongSparseArray<java.lang.Integer>();
    ...
    public void onRestoreInstanceState(android.os.Parcelable state) {
        android.widget.AbsListView.SavedState ss = ((android.widget.AbsListView.SavedState) (state));
        ...
        if ((ss.inActionMode && (mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL)) && (mMultiChoiceModeCallback != null)) {
            mChoiceActionMode = startActionMode(mMultiChoiceModeCallback);
        }
        requestLayout();
    }
    ...
    private boolean acceptFilter() {
        return (mTextFilterEnabled && (getAdapter() instanceof android.widget.Filterable)) && (((android.widget.Filterable) (getAdapter())).getFilter() != null);
    }
    ...
    public void setFilterText(java.lang.String filterText) {
        ...
        if (mTextFilterEnabled && (!android.text.TextUtils.isEmpty(filterText))) {
            createTextFilter(false);
            // This is going to call our listener onTextChanged, but we might not
            // be ready to bring up a window yet
            mTextFilter.setText(filterText);
            mTextFilter.setSelection(filterText.length());
            if (mAdapter instanceof android.widget.Filterable) {
    ...
    protected int computeVerticalScrollOffset() {
        ...
        if ((firstPosition >= 0) && (childCount > 0)) {
            if (mSmoothScrollbarEnabled) {
                ...
                int height = view.getHeight();
                if (height > 0) {
                    return java.lang.Math.max(((firstPosition * 100) - ((top * 100) / height)) + ((int) (((((float) (mScrollY)) / getHeight()) * mItemCount) * 100)), 0);
                }
            } else {
                int index;
    ...
    protected int computeVerticalScrollRange() {
        int result;
        if (mSmoothScrollbarEnabled) {
            result = java.lang.Math.max(mItemCount * 100, 0);
            if (mScrollY != 0) {
                // Compensate for overscroll
                result += java.lang.Math.abs(((int) (((((float) (mScrollY)) / getHeight()) * mItemCount) * 100)));
            }
        } else {
            result = mItemCount;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final android.graphics.Rect listPadding = mListPadding;
        listPadding.left = mSelectionLeftPadding + mPaddingLeft;
        listPadding.top = mSelectionTopPadding + mPaddingTop;
        listPadding.right = mSelectionRightPadding + mPaddingRight;
        listPadding.bottom = mSelectionBottomPadding + mPaddingBottom;
        // Check if our previous measured size was at a point where we should scroll later.
        if (mTranscriptMode == android.widget.AbsListView.TRANSCRIPT_MODE_NORMAL) {
            final int childCount = getChildCount();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        layoutChildren();
        mOverscrollMax = (b - t) / android.widget.AbsListView.OVERSCROLL_LIMIT_DIVISOR;
    ...
    protected boolean setFrame(int left, int top, int right, int bottom) {
        ...
        if (changed) {
            ...
            final boolean visible = getWindowVisibility() == android.view.View.VISIBLE;
     ...
     */
    android.view.View getAccessibilityFocusedChild(android.view.View focusedView) {
        android.view.ViewParent viewParent = focusedView.getParent();
        while ((viewParent instanceof android.view.View) && (viewParent != this)) {
            focusedView = ((android.view.View) (viewParent));
    ...
    void updateScrollIndicators() {
        if (mScrollUp != null) {
            mScrollUp.setVisibility(canScrollUp() ? android.view.View.VISIBLE : android.view.View.INVISIBLE);
        }
        if (mScrollDown != null) {
            mScrollDown.setVisibility(canScrollDown() ? android.view.View.VISIBLE : android.view.View.INVISIBLE);
        }
    }
     ...
     * @param outMetadata
     * 		an array of at least 1 boolean where the first entry
     ...
     */
    android.view.View obtainView(int position, boolean[] outMetadata) {
        android.os.Trace.traceBegin(Trace.TRACE_TAG_VIEW, "obtainView");
        outMetadata[0] = false;
        // Check whether we have a transient state view. Attempt to re-bind the
        // data and discard the view if we fail.
        final android.view.View transientView = mRecycler.getTransientStateView(position);
        if (transientView != null) {
            final android.widget.AbsListView.LayoutParams params = ((android.widget.AbsListView.LayoutParams) (transientView.getLayoutParams()));
            // If the view type hasn't changed, attempt to re-bind the data.
            if (params.viewType == mAdapter.getItemViewType(position)) {
                final android.view.View updatedView = mAdapter.getView(position, transientView, this);
        ...
        final android.view.View scrapView = mRecycler.getScrapView(position);
        final android.view.View child = mAdapter.getView(position, scrapView, this);
        if (scrapView != null) {
            if (child != scrapView) {
        ...
        if (child.getImportantForAccessibility() == android.view.View.IMPORTANT_FOR_ACCESSIBILITY_AUTO) {
        ...
        if (android.view.accessibility.AccessibilityManager.getInstance(mContext).isEnabled()) {
            if (mAccessibilityDelegate == null) {
                mAccessibilityDelegate = new android.widget.AbsListView.ListItemAccessibilityDelegate();
            }
    ...
    private void setItemViewLayoutParams(android.view.View child, int position) {
        final android.view.ViewGroup.LayoutParams vlp = child.getLayoutParams();
        android.widget.AbsListView.LayoutParams lp;
        if (vlp == null) {
            lp = ((android.widget.AbsListView.LayoutParams) (generateDefaultLayoutParams()));
        } else
            if (!checkLayoutParams(vlp)) {
                lp = ((android.widget.AbsListView.LayoutParams) (generateLayoutParams(vlp)));
            } else {
                lp = ((android.widget.AbsListView.LayoutParams) (vlp));
            }
    ...
    class ListItemAccessibilityDelegate extends android.view.View.AccessibilityDelegate {
        ...
        public boolean performAccessibilityAction(android.view.View host, int action, android.os.Bundle arguments) {
            ...
            final int position = getPositionForView(host);
            if ((position == android.widget.AdapterView.INVALID_POSITION) || (mAdapter == null)) {
            ...
            final android.view.ViewGroup.LayoutParams lp = host.getLayoutParams();
            if (lp instanceof android.widget.AbsListView.LayoutParams) {
                isItemEnabled = ((android.widget.AbsListView.LayoutParams) (lp)).isEnabled;
            } else {
                isItemEnabled = false;
            }
                ...
                case android.view.accessibility.AccessibilityNodeInfo.ACTION_CLEAR_SELECTION :
                    {
                        if (getSelectedItemPosition() == position) {
                            setSelection(android.widget.AdapterView.INVALID_POSITION);
                            return true;
                        }
                    }
                    return false;
    ...
    public void onInitializeAccessibilityNodeInfoForItem(android.view.View view, int position, android.view.accessibility.AccessibilityNodeInfo info) {
        ...
        if (lp instanceof android.widget.AbsListView.LayoutParams) {
            isItemEnabled = ((android.widget.AbsListView.LayoutParams) (lp)).isEnabled && isEnabled();
        } else {
            isItemEnabled = false;
        }
        ...
        if (position == getSelectedItemPosition()) {
            ...
            addAccessibilityActionIfEnabled(info, isItemEnabled, android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction.ACTION_CLEAR_SELECTION);
        } else {
            addAccessibilityActionIfEnabled(info, isItemEnabled, android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction.ACTION_SELECT);
        }
        if (isItemClickable(view)) {
            addAccessibilityActionIfEnabled(info, isItemEnabled, android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction.ACTION_CLICK);
            info.setClickable(true);
        }
        if (isLongClickable()) {
            addAccessibilityActionIfEnabled(info, isItemEnabled, android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction.ACTION_LONG_CLICK);
            info.setLongClickable(true);
        }
    }

    private void addAccessibilityActionIfEnabled(android.view.accessibility.AccessibilityNodeInfo info, boolean enabled, android.view.accessibility.AccessibilityNodeInfo.AccessibilityAction action) {
        if (enabled) {
            info.addAction(action);
        }
    }

    private boolean isItemClickable(android.view.View view) {
     ...
     */
    void positionSelectorLikeTouch(int position, android.view.View sel, float x, float y) {
     ...
     */
    void positionSelectorLikeFocus(int position, android.view.View sel) {
        if (((mSelector != null) && (mSelectorPosition != position)) && (position != android.widget.AdapterView.INVALID_POSITION)) {
            final android.graphics.Rect bounds = mSelectorRect;
    ...
    void positionSelector(int position, android.view.View sel) {
        positionSelector(position, sel, false, -1, -1);
    }

    @android.annotation.UnsupportedAppUsage
    private void positionSelector(int position, android.view.View sel, boolean manageHotspot, float x, float y) {
        final boolean positionChanged = position != mSelectorPosition;
        if (position != android.widget.AdapterView.INVALID_POSITION) {
            mSelectorPosition = position;
        }
        final android.graphics.Rect selectorRect = mSelectorRect;
        selectorRect.set(sel.getLeft(), sel.getTop(), sel.getRight(), sel.getBottom());
        if (sel instanceof android.widget.AbsListView.SelectionBoundsAdjuster) {
            ((android.widget.AbsListView.SelectionBoundsAdjuster) (sel)).adjustListItemSelectionBounds(selectorRect);
        }
        ...
        final android.graphics.drawable.Drawable selector = mSelector;
        if (selector != null) {
            if (positionChanged) {
    ...
    protected void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        if (clipToPadding) {
            ...
            mGroupFlags &= ~android.view.ViewGroup.CLIP_TO_PADDING_MASK;
        }
    ...
    protected boolean isPaddingOffsetRequired() {
        return (mGroupFlags & android.view.ViewGroup.CLIP_TO_PADDING_MASK) != android.view.ViewGroup.CLIP_TO_PADDING_MASK;
    }

    @java.lang.Override
    protected int getLeftPaddingOffset() {
        return (mGroupFlags & android.view.ViewGroup.CLIP_TO_PADDING_MASK) == android.view.ViewGroup.CLIP_TO_PADDING_MASK ? 0 : -mPaddingLeft;
    }

    @java.lang.Override
    protected int getTopPaddingOffset() {
        return (mGroupFlags & android.view.ViewGroup.CLIP_TO_PADDING_MASK) == android.view.ViewGroup.CLIP_TO_PADDING_MASK ? 0 : -mPaddingTop;
    }

    @java.lang.Override
    protected int getRightPaddingOffset() {
        return (mGroupFlags & android.view.ViewGroup.CLIP_TO_PADDING_MASK) == android.view.ViewGroup.CLIP_TO_PADDING_MASK ? 0 : mPaddingRight;
    }

    @java.lang.Override
    protected int getBottomPaddingOffset() {
        return (mGroupFlags & android.view.ViewGroup.CLIP_TO_PADDING_MASK) == android.view.ViewGroup.CLIP_TO_PADDING_MASK ? 0 : mPaddingBottom;
    }
    ...
    boolean touchModeDrawsInPressedState() {
        ...
        switch (mTouchMode) {
            case android.widget.AbsListView.TOUCH_MODE_TAP :
            case android.widget.AbsListView.TOUCH_MODE_DONE_WAITING :
                return true;
            default :
                return false;
        }
     ...
     * @unknown ref android.R.styleable#AbsListView_listSelector
     */
    public void setSelector(@android.annotation.DrawableRes
    int resID) {
     ...
     */
    @android.view.inspector.InspectableProperty(name = "listSelector")
    ...
    void keyPressed() {
        ...
        if (((selector != null) && (isFocused() || touchModeDrawsInPressedState())) && (!selectorRect.isEmpty())) {
            final android.view.View v = getChildAt(mSelectedPosition - mFirstPosition);
            if (v != null) {
            ...
            if ((d != null) && (d instanceof android.graphics.drawable.TransitionDrawable)) {
                if (longClickable) {
                    ((android.graphics.drawable.TransitionDrawable) (d)).startTransition(android.view.ViewConfiguration.getLongPressTimeout());
                } else {
    ...
    private int[] getDrawableStateForSelector() {
        ...
        // states.
        final int enabledState = android.view.View.ENABLED_STATE_SET[0];
        ...
        if (enabledPos >= 0) {
            java.lang.System.arraycopy(state, enabledPos + 1, state, enabledPos, (state.length - enabledPos) - 1);
        }
        return state;
    }

    @java.lang.Override
    public boolean verifyDrawable(@android.annotation.NonNull
    ...
    protected void onAttachedToWindow() {
        ...
        final android.view.ViewTreeObserver treeObserver = getViewTreeObserver();
    ...
    public void onWindowFocusChanged(boolean hasWindowFocus) {
        ...
        final int touchMode = (isInTouchMode()) ? android.widget.AbsListView.TOUCH_MODE_ON : android.widget.AbsListView.TOUCH_MODE_OFF;
        if (!hasWindowFocus) {
            ...
            dismissPopup();
            if (touchMode == android.widget.AbsListView.TOUCH_MODE_OFF) {
            ...
            if ((touchMode != mLastTouchMode) && (mLastTouchMode != android.widget.AbsListView.TOUCH_MODE_UNKNOWN)) {
     ...
     */
    android.view.ContextMenu.ContextMenuInfo createContextMenuInfo(android.view.View view, int position, long id) {
    ...
    private class PerformClick extends android.widget.AbsListView.WindowRunnnable implements java.lang.Runnable {
        ...
        public void run() {
            ...
            if ((((((adapter != null) && (mItemCount > 0)) && (motionPosition != android.widget.AdapterView.INVALID_POSITION)) && (motionPosition < adapter.getCount())) && sameWindow()) && adapter.isEnabled(motionPosition)) {
                final android.view.View view = getChildAt(motionPosition - mFirstPosition);
    ...
    private class CheckForLongPress extends android.widget.AbsListView.WindowRunnnable implements java.lang.Runnable {
        ...
        private float mX = android.widget.AbsListView.CheckForLongPress.INVALID_COORD;

        private float mY = android.widget.AbsListView.CheckForLongPress.INVALID_COORD;
        ...
        public void run() {
            ...
            final android.view.View child = getChildAt(motionPosition - mFirstPosition);
            if (child != null) {
                final int longPressPosition = mMotionPosition;
                final long longPressId = mAdapter.getItemId(mMotionPosition);
                boolean handled = false;
                if (sameWindow() && (!mDataChanged)) {
                    if ((mX != android.widget.AbsListView.CheckForLongPress.INVALID_COORD) && (mY != android.widget.AbsListView.CheckForLongPress.INVALID_COORD)) {
                ...
                if (handled) {
                    ...
                    mTouchMode = android.widget.AbsListView.TOUCH_MODE_REST;
                    setPressed(false);
                    child.setPressed(false);
                } else {
                    mTouchMode = android.widget.AbsListView.TOUCH_MODE_DONE_WAITING;
                }
            }
        }
    }
    ...
    private boolean performStylusButtonPressAction(android.view.MotionEvent ev) {
        if ((mChoiceMode == android.widget.AbsListView.CHOICE_MODE_MULTIPLE_MODAL) && (mChoiceActionMode == null)) {
    ...
    @android.annotation.UnsupportedAppUsage
    boolean performLongPress(final android.view.View child, final int longPressPosition, final long longPressId) {
        return performLongPress(child, longPressPosition, longPressId, android.widget.AbsListView.CheckForLongPress.INVALID_COORD, android.widget.AbsListView.CheckForLongPress.INVALID_COORD);
    }

    @android.annotation.UnsupportedAppUsage
    boolean performLongPress(final android.view.View child, final int longPressPosition, final long longPressId, float x, float y) {
        ...
        if (!handled) {
            ...
            if ((x != android.widget.AbsListView.CheckForLongPress.INVALID_COORD) && (y != android.widget.AbsListView.CheckForLongPress.INVALID_COORD)) {
    ...
    private boolean showContextMenuForChildInternal(android.view.View originalView, float x, float y, boolean useOffsets) {
        ...
        if (!handled) {
            final android.view.View child = getChildAt(longPressPosition - mFirstPosition);
            mContextMenuInfo = createContextMenuInfo(child, longPressPosition, longPressId);
            if (useOffsets) {
    ...
    public boolean onKeyUp(int keyCode, android.view.KeyEvent event) {
        if (android.view.KeyEvent.isConfirmKey(keyCode)) {
            ...
            if ((((isClickable() && isPressed()) && (mSelectedPosition >= 0)) && (mAdapter != null)) && (mSelectedPosition < mAdapter.getCount())) {
                final android.view.View view = getChildAt(mSelectedPosition - mFirstPosition);
                if (view != null) {
    ...
    private final class CheckForTap implements java.lang.Runnable {
        ...
        @java.lang.Override
        public void run() {
            if (mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN) {
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_TAP;
                final android.view.View child = getChildAt(mMotionPosition - mFirstPosition);
                if ((child != null) && (!child.hasExplicitFocusable())) {
                    ...
                    if (!mDataChanged) {
                        ...
                        final boolean longClickable = isLongClickable();
                        if (mSelector != null) {
                            final android.graphics.drawable.Drawable d = mSelector.getCurrent();
                            if ((d != null) && (d instanceof android.graphics.drawable.TransitionDrawable)) {
                                if (longClickable) {
                        ...
                        if (longClickable) {
                            if (mPendingCheckForLongPress == null) {
                                mPendingCheckForLongPress = new android.widget.AbsListView.CheckForLongPress();
                            }
    ...
    private boolean startScrollIfNeeded(int x, int y, android.view.MotionEvent vtev) {
        // Check if we have moved far enough that it looks more like a
        // scroll than a tap
        final int deltaY = y - mMotionY;
        final int distance = java.lang.Math.abs(deltaY);
        final boolean overscroll = mScrollY != 0;
        if ((overscroll || (distance > mTouchSlop)) && ((getNestedScrollAxes() & android.view.View.SCROLL_AXIS_VERTICAL) == 0)) {
            createScrollingCache();
            if (overscroll) {
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_OVERSCROLL;
                mMotionCorrection = 0;
            } else {
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_SCROLL;
            ...
            reportScrollStateChange(android.widget.AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
    ...
    private void scrollIfNeeded(int x, int y, android.view.MotionEvent vtev) {
        int rawDeltaY = y - mMotionY;
        int scrollOffsetCorrection = 0;
        int scrollConsumedCorrection = 0;
        if (mLastY == java.lang.Integer.MIN_VALUE) {
            rawDeltaY -= mMotionCorrection;
        }
        if (dispatchNestedPreScroll(0, mLastY != java.lang.Integer.MIN_VALUE ? mLastY - y : -rawDeltaY, mScrollConsumed, mScrollOffset)) {
        ...
        int incrementalDeltaY = (mLastY != java.lang.Integer.MIN_VALUE) ? (y - mLastY) + scrollConsumedCorrection : deltaY;
        int lastYCorrection = 0;
        if (mTouchMode == android.widget.AbsListView.TOUCH_MODE_SCROLL) {
            if (android.widget.AbsListView.PROFILE_SCROLLING) {
                if (!mScrollProfilingStarted) {
                    android.os.Debug.startMethodTracing("AbsListViewScroll");
            ...
            if (y != mLastY) {
                ...
                if (((mGroupFlags & android.view.ViewGroup.FLAG_DISALLOW_INTERCEPT) == 0) && (java.lang.Math.abs(rawDeltaY) > mTouchSlop)) {
                    final android.view.ViewParent parent = getParent();
                    if (parent != null) {
                        parent.requestDisallowInterceptTouchEvent(true);
                    }
                ...
                if (motionView != null) {
                    ...
                    if (atEdge) {
                        ...
                        if (dispatchNestedScroll(0, overscroll - incrementalDeltaY, 0, overscroll, mScrollOffset)) {
                            ...
                            if ((overscrollMode == android.view.View.OVER_SCROLL_ALWAYS) || ((overscrollMode == android.view.View.OVER_SCROLL_IF_CONTENT_SCROLLS) && (!contentFits()))) {
                                if (!atOverscrollEdge) {
                                ...
                                if (incrementalDeltaY > 0) {
                                    ...
                                    if (incrementalDeltaY < 0) {
                                        mEdgeGlowBottom.onPull(((float) (overscroll)) / getHeight(), 1.0F - (((float) (x)) / getWidth()));
            ...
            if (mTouchMode == android.widget.AbsListView.TOUCH_MODE_OVERSCROLL) {
                if (y != mLastY) {
                    ...
                    if (overScrollDistance != 0) {
                        ...
                        if ((overscrollMode == android.view.View.OVER_SCROLL_ALWAYS) || ((overscrollMode == android.view.View.OVER_SCROLL_IF_CONTENT_SCROLLS) && (!contentFits()))) {
                            if (rawDeltaY > 0) {
                                ...
                                if (rawDeltaY < 0) {
                                    mEdgeGlowBottom.onPull(((float) (overScrollDistance)) / getHeight(), 1.0F - (((float) (x)) / getWidth()));
                                    if (!mEdgeGlowTop.isFinished()) {
                                        mEdgeGlowTop.onRelease();
                                    }
                                    invalidateBottomGlow();
    ...
    public void onTouchModeChanged(boolean isInTouchMode) {
        if (isInTouchMode) {
            ...
            if ((touchMode == android.widget.AbsListView.TOUCH_MODE_OVERSCROLL) || (touchMode == android.widget.AbsListView.TOUCH_MODE_OVERFLING)) {
                if (mFlingRunnable != null) {
                    mFlingRunnable.endFling();
                }
                if (mPositionScroller != null) {
     ...
     */
    @java.lang.Override
    protected boolean handleScrollBarDragging(android.view.MotionEvent event) {
    ...
    public boolean onTouchEvent(android.view.MotionEvent ev) {
        ...
        final android.view.MotionEvent vtev = android.view.MotionEvent.obtain(ev);
    ...
    private void onTouchDown(android.view.MotionEvent ev) {
        mHasPerformedLongPress = false;
        mActivePointerId = ev.getPointerId(0);
        hideSelector();
        if (mTouchMode == android.widget.AbsListView.TOUCH_MODE_OVERFLING) {
            ...
            if (!mDataChanged) {
                if (mTouchMode == android.widget.AbsListView.TOUCH_MODE_FLING) {
                    ...
                    if ((motionPosition >= 0) && getAdapter().isEnabled(motionPosition)) {
                        ...
                        mTouchMode = android.widget.AbsListView.TOUCH_MODE_DOWN;
                        // FIXME Debounce
                        if (mPendingCheckForTap == null) {
                            mPendingCheckForTap = new android.widget.AbsListView.CheckForTap();
                        }
            ...
            if (motionPosition >= 0) {
                // Remember where the motion event started
                final android.view.View v = getChildAt(motionPosition - mFirstPosition);
                mMotionViewOriginalTop = v.getTop();
            }
            mMotionX = x;
            mMotionY = y;
            mMotionPosition = motionPosition;
            mLastY = java.lang.Integer.MIN_VALUE;
        }
        if (((mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN) && (mMotionPosition != android.widget.AdapterView.INVALID_POSITION)) && performButtonActionOnTouchDown(ev)) {
            removeCallbacks(mPendingCheckForTap);
        }
    }

    private void onTouchMove(android.view.MotionEvent ev, android.view.MotionEvent vtev) {
        ...
        switch (mTouchMode) {
            case android.widget.AbsListView.TOUCH_MODE_DOWN :
            case android.widget.AbsListView.TOUCH_MODE_TAP :
            case android.widget.AbsListView.TOUCH_MODE_DONE_WAITING :
                // Check if we have moved far enough that it looks more like a
                ...
                if (!pointInView(x, y, mTouchSlop)) {
                    ...
                    removeCallbacks(mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN ? mPendingCheckForTap : mPendingCheckForLongPress);
                    mTouchMode = android.widget.AbsListView.TOUCH_MODE_DONE_WAITING;
                    updateSelectorState();
                } else
                    if (motionView != null) {
            ...
            case android.widget.AbsListView.TOUCH_MODE_OVERSCROLL :
                scrollIfNeeded(((int) (ev.getX(pointerIndex))), y, vtev);
                break;
        }
    }

    private void onTouchUp(android.view.MotionEvent ev) {
        switch (mTouchMode) {
            case android.widget.AbsListView.TOUCH_MODE_DOWN :
            case android.widget.AbsListView.TOUCH_MODE_TAP :
            case android.widget.AbsListView.TOUCH_MODE_DONE_WAITING :
                ...
                if (child != null) {
                    ...
                    if (inList && (!child.hasExplicitFocusable())) {
                        if (mPerformClick == null) {
                            mPerformClick = new android.widget.AbsListView.PerformClick();
                        }
                        final android.widget.AbsListView.PerformClick performClick = mPerformClick;
                        performClick.mClickMotionPosition = motionPosition;
                        performClick.rememberWindowAttachCount();
                        mResurrectToPosition = motionPosition;
                        if ((mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN) || (mTouchMode == android.widget.AbsListView.TOUCH_MODE_TAP)) {
                            removeCallbacks(mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN ? mPendingCheckForTap : mPendingCheckForLongPress);
                            mLayoutMode = android.widget.AbsListView.LAYOUT_NORMAL;
                            if ((!mDataChanged) && mAdapter.isEnabled(motionPosition)) {
                                ...
                                mTouchModeReset = new java.lang.Runnable() {
                                    @java.lang.Override
                                    public void run() {
            ...
            case android.widget.AbsListView.TOUCH_MODE_SCROLL :
                ...
                if (childCount > 0) {
                    ...
                    if ((((mFirstPosition == 0) && (firstChildTop >= contentTop)) && ((mFirstPosition + childCount) < mItemCount)) && (lastChildBottom <= (getHeight() - contentBottom))) {
                        mTouchMode = android.widget.AbsListView.TOUCH_MODE_REST;
                        reportScrollStateChange(android.widget.AbsListView.OnScrollListener.SCROLL_STATE_IDLE);
                    } else {
                        ...
                        // fling further.
                        boolean flingVelocity = java.lang.Math.abs(initialVelocity) > mMinimumVelocity;
                        if (flingVelocity && (!(((mFirstPosition == 0) && (firstChildTop == (contentTop - mOverscrollDistance))) || (((mFirstPosition + childCount) == mItemCount) && (lastChildBottom == (contentBottom + mOverscrollDistance)))))) {
                            if (!dispatchNestedPreFling(0, -initialVelocity)) {
                                if (mFlingRunnable == null) {
                                    mFlingRunnable = new android.widget.AbsListView.FlingRunnable();
                                }
                                reportScrollStateChange(android.widget.AbsListView.OnScrollListener.SCROLL_STATE_FLING);
        ...
        mActivePointerId = android.widget.AbsListView.INVALID_POINTER;
        if (android.widget.AbsListView.PROFILE_SCROLLING) {
            if (mScrollProfilingStarted) {
    ...
    private void onTouchCancel() {
        switch (mTouchMode) {
            ...
            default :
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_REST;
                setPressed(false);
                final android.view.View motionView = this.getChildAt(mMotionPosition - mFirstPosition);
                if (motionView != null) {
                    motionView.setPressed(false);
                }
                clearScrollingCache();
        ...
        switch (event.getAction()) {
            ...
            case android.view.MotionEvent.ACTION_BUTTON_PRESS :
                if (event.isFromSource(android.view.InputDevice.SOURCE_CLASS_POINTER)) {
                    ...
                    if (((actionButton == android.view.MotionEvent.BUTTON_STYLUS_PRIMARY) || (actionButton == android.view.MotionEvent.BUTTON_SECONDARY)) && ((mTouchMode == android.widget.AbsListView.TOUCH_MODE_DOWN) || (mTouchMode == android.widget.AbsListView.TOUCH_MODE_TAP))) {
    ...
    public void onNestedScroll(android.view.View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        ...
        final android.view.View motionView = getChildAt(motionIndex);
    ...
    public boolean onNestedFling(android.view.View target, float velocityX, float velocityY, boolean consumed) {
        final int childCount = getChildCount();
        if ((((!consumed) && (childCount > 0)) && canScrollList(((int) (velocityY)))) && (java.lang.Math.abs(velocityY) > mMinimumVelocity)) {
            reportScrollStateChange(android.widget.AbsListView.OnScrollListener.SCROLL_STATE_FLING);
            if (mFlingRunnable == null) {
                mFlingRunnable = new android.widget.AbsListView.FlingRunnable();
            }
    ...
    public void draw(android.graphics.Canvas canvas) {
        ...
        if (shouldDisplayEdgeEffects()) {
            ...
            if (!mEdgeGlowTop.isFinished()) {
                ...
                final int edgeY = java.lang.Math.min(0, scrollY + mFirstPositionDistanceGuess) + translateY;
            ...
            if (!mEdgeGlowBottom.isFinished()) {
                ...
                final int edgeY = java.lang.Math.max(getHeight(), scrollY + mLastPositionDistanceGuess) - (clipToPadding ? mPaddingBottom : 0);
    ...
    public android.view.PointerIcon onResolvePointerIcon(android.view.MotionEvent event, int pointerIndex) {
        if (mFastScroll != null) {
            android.view.PointerIcon pointerIcon = mFastScroll.onResolvePointerIcon(event, pointerIndex);
            if (pointerIcon != null) {
                return pointerIcon;
            }
        }
    ...
    public boolean onInterceptTouchEvent(android.view.MotionEvent ev) {
        ...
        switch (actionMasked) {
            case android.view.MotionEvent.ACTION_DOWN :
                {
                    int touchMode = mTouchMode;
                    if ((touchMode == android.widget.AbsListView.TOUCH_MODE_OVERFLING) || (touchMode == android.widget.AbsListView.TOUCH_MODE_OVERSCROLL)) {
                        mMotionCorrection = 0;
                        return true;
                    }
                    final int x = ((int) (ev.getX()));
                    ...
                    if ((touchMode != android.widget.AbsListView.TOUCH_MODE_FLING) && (motionPosition >= 0)) {
                    ...
                    mNestedYOffset = 0;
                    startNestedScroll(android.view.View.SCROLL_AXIS_VERTICAL);
                    if (touchMode == android.widget.AbsListView.TOUCH_MODE_FLING) {
                        return true;
                    }
                    break;
                }
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123769710)
    ...
    private class FlingRunnable implements java.lang.Runnable {
        ...
        private final java.lang.Runnable mCheckFlywheel = new java.lang.Runnable() {
            @java.lang.Override
            public void run() {
                final int activeId = mActivePointerId;
                final android.view.VelocityTracker vt = mVelocityTracker;
                ...
                if ((java.lang.Math.abs(yvel) >= mMinimumVelocity) && scroller.isScrollingInDirection(0, yvel)) {
                    // Keep the fling alive a little longer
                    postDelayed(this, android.widget.AbsListView.FlingRunnable.FLYWHEEL_TIMEOUT);
                } else {
                    endFling();
                    mTouchMode = android.widget.AbsListView.TOUCH_MODE_SCROLL;
                    reportScrollStateChange(android.widget.AbsListView.OnScrollListener.SCROLL_STATE_TOUCH_SCROLL);
        ...
        void start(int initialVelocity) {
            int initialY = (initialVelocity < 0) ? java.lang.Integer.MAX_VALUE : 0;
            mLastFlingY = initialY;
            mScroller.setInterpolator(null);
            mScroller.fling(0, initialY, 0, initialVelocity, 0, java.lang.Integer.MAX_VALUE, 0, java.lang.Integer.MAX_VALUE);
            mTouchMode = android.widget.AbsListView.TOUCH_MODE_FLING;
            mSuppressIdleStateChangeCall = false;
            postOnAnimation(this);
            if (android.widget.AbsListView.PROFILE_FLINGING) {
                if (!mFlingProfilingStarted) {
                    android.os.Debug.startMethodTracing("AbsListViewFling");
                    mFlingProfilingStarted = true;
                }
            }
            if (mFlingStrictSpan == null) {
                mFlingStrictSpan = android.os.StrictMode.enterCriticalSpan("AbsListView-fling");
            }
        }
        ...
        void startSpringback() {
            ...
            if (mScroller.springBack(0, mScrollY, 0, 0, 0, 0)) {
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_OVERFLING;
                invalidate();
                postOnAnimation(this);
            } else {
                mTouchMode = android.widget.AbsListView.TOUCH_MODE_REST;
        ...
        void startOverfling(int initialVelocity) {
            mScroller.setInterpolator(null);
            mScroller.fling(0, mScrollY, 0, initialVelocity, 0, 0, java.lang.Integer.MIN_VALUE, java.lang.Integer.MAX_VALUE, 0, getHeight());
            mTouchMode = android.widget.AbsListView.TOUCH_MODE_OVERFLING;
            mSuppressIdleStateChangeCall = false;
            invalidate();
            postOnAnimation(this);
        ...
        void startScroll(int distance, int duration, boolean linear, boolean suppressEndFlingStateChangeCall) {
            int initialY = (distance < 0) ? java.lang.Integer.MAX_VALUE : 0;
            mLastFlingY = initialY;
            mScroller.setInterpolator(linear ? android.widget.AbsListView.sLinearInterpolator : null);
        ...
        void flywheelTouch() {
            postDelayed(mCheckFlywheel, android.widget.AbsListView.FlingRunnable.FLYWHEEL_TIMEOUT);
        }
                ...
                case android.widget.AbsListView.TOUCH_MODE_FLING :
                    {
                        ...
                        if (delta > 0) {
                            ...
                            final android.view.View firstView = getChildAt(0);
                            mMotionViewOriginalTop = firstView.getTop();
                            // Don't fling more than 1 screen
                            delta = java.lang.Math.min(((getHeight() - mPaddingBottom) - mPaddingTop) - 1, delta);
                        } else {
                            // List is moving towards the bottom. Use last view as mMotionPosition
                            int offsetToLast = getChildCount() - 1;
                            mMotionPosition = mFirstPosition + offsetToLast;
                            final android.view.View lastView = getChildAt(offsetToLast);
                            mMotionViewOriginalTop = lastView.getTop();
                            // Don't fling more than 1 screen
                            delta = java.lang.Math.max(-(((getHeight() - mPaddingBottom) - mPaddingTop) - 1), delta);
                        }
                        // Check to see if we have bumped into the scroll limit
    ...
    void smoothScrollByOffset(int position) {
        ...
        if (index > (-1)) {
            ...
            if (child != null) {
                ...
                smoothScrollToPosition(java.lang.Math.max(0, java.lang.Math.min(getCount(), index + position)));
            }
        }
    }
    ...
    private void clearScrollingCache() {
        if (!isHardwareAccelerated()) {
            if (mClearScrollingCache == null) {
                mClearScrollingCache = new java.lang.Runnable() {
                    @java.lang.Override
                    public void run() {
                        if (mCachingStarted) {
                            mCachingStarted = mCachingActive = false;
                            setChildrenDrawnWithCacheEnabled(false);
                            if ((mPersistentDrawingCache & android.view.ViewGroup.PERSISTENT_SCROLLING_CACHE) == 0) {
                                setChildrenDrawingCacheEnabled(false);
                            }
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 124051739)
    boolean trackMotionScroll(int deltaY, int incrementalDeltaY) {
        ...
        if (deltaY < 0) {
            deltaY = java.lang.Math.max(-(height - 1), deltaY);
        } else {
            deltaY = java.lang.Math.min(height - 1, deltaY);
        }
        if (incrementalDeltaY < 0) {
            incrementalDeltaY = java.lang.Math.max(-(height - 1), incrementalDeltaY);
        } else {
            incrementalDeltaY = java.lang.Math.min(height - 1, incrementalDeltaY);
        }
        final int firstPosition = mFirstPosition;
        ...
        final int absIncrementalDeltaY = java.lang.Math.abs(incrementalDeltaY);
    ...
    void hideSelector() {
        if (mSelectedPosition != android.widget.AdapterView.INVALID_POSITION) {
            if (mLayoutMode != android.widget.AbsListView.LAYOUT_SPECIFIC) {
                mResurrectToPosition = mSelectedPosition;
            }
    ...
    int reconcileSelectedPosition() {
        ...
        position = java.lang.Math.max(0, position);
        position = java.lang.Math.min(position, mItemCount - 1);
        return position;
    }
    ...
    int findClosestMotionRow(int y) {
        ...
        return motionRow != android.widget.AdapterView.INVALID_POSITION ? motionRow : (mFirstPosition + childCount) - 1;
    }
    ...
    boolean resurrectSelection() {
        ...
        if ((toPosition >= firstPosition) && (toPosition < (firstPosition + childCount))) {
            ...
            final android.view.View selected = getChildAt(selectedPos - mFirstPosition);
        ...
        if ((selectedPos >= firstPosition) && (selectedPos <= getLastVisiblePosition())) {
            mLayoutMode = android.widget.AbsListView.LAYOUT_SPECIFIC;
            updateSelectorState();
    ...
    void confirmCheckedPositionsById() {
        ...
        for (int checkedIndex = 0; checkedIndex < mCheckedIdStates.size(); checkedIndex++) {
            ...
            if (id != lastPosId) {
                ...
                final int start = java.lang.Math.max(0, lastPos - android.widget.AbsListView.CHECK_POSITION_SEARCH_DISTANCE);
                final int end = java.lang.Math.min(lastPos + android.widget.AbsListView.CHECK_POSITION_SEARCH_DISTANCE, mItemCount);
                boolean found = false;
    ...
    protected void handleDataChanged() {
        ...
        if (((mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) && (mAdapter != null)) && mAdapter.hasStableIds()) {
        ...
        if (count > 0) {
            ...
            if (mNeedSync) {
                ...
                mNeedSync = false;
                mPendingSync = null;
                if (mTranscriptMode == android.widget.AbsListView.TRANSCRIPT_MODE_ALWAYS_SCROLL) {
                    mLayoutMode = android.widget.AbsListView.LAYOUT_FORCE_BOTTOM;
                    return;
                } else
                    if (mTranscriptMode == android.widget.AbsListView.TRANSCRIPT_MODE_NORMAL) {
                ...
                switch (mSyncMode) {
                    case android.widget.AdapterView.SYNC_SELECTED_POSITION :
                        if (isInTouchMode()) {
                            ...
                            mLayoutMode = android.widget.AbsListView.LAYOUT_SYNC;
                            mSyncPosition = java.lang.Math.min(java.lang.Math.max(0, mSyncPosition), count - 1);
                            return;
                        } else {
        ...
        mLayoutMode = (mStackFromBottom) ? android.widget.AbsListView.LAYOUT_FORCE_BOTTOM : android.widget.AbsListView.LAYOUT_FORCE_TOP;
    ...
    protected void onDisplayHint(int hint) {
        ...
        mPopupHidden = hint == android.view.View.INVISIBLE;
    }
    ...
    private void positionPopup() {
        ...
        if (!mPopup.isShowing()) {
            mPopup.showAtLocation(this, android.view.Gravity.BOTTOM | android.view.Gravity.CENTER_HORIZONTAL, xy[0], bottomGap);
        } else {
     ...
     */
    static int getDistance(android.graphics.Rect source, android.graphics.Rect dest, int direction) {
        int sX;// source x, y
     ...
     */
    boolean sendToTextFilter(int keyCode, int count, android.view.KeyEvent event) {
        if (!acceptFilter()) {
            return false;
        }
        boolean handled = false;
        ...
        if (okToSend) {
            ...
            if (forwardEvent.getRepeatCount() > 0) {
                forwardEvent = android.view.KeyEvent.changeTimeRepeat(event, event.getEventTime(), 0);
            }
    ...
    public android.view.inputmethod.InputConnection onCreateInputConnection(android.view.inputmethod.EditorInfo outAttrs) {
        if (isTextFilterEnabled()) {
            if (mPublicInputConnection == null) {
                ...
                mPublicInputConnection = new android.widget.AbsListView.InputConnectionWrapper(outAttrs);
            }
            outAttrs.inputType = TYPE_CLASS_TEXT | TYPE_TEXT_VARIATION_FILTER;
    ...
    private class InputConnectionWrapper implements android.view.inputmethod.InputConnection {
        ...
        public InputConnectionWrapper(android.view.inputmethod.EditorInfo outAttrs) {
            mOutAttrs = outAttrs;
        }
        ...
        public int getCursorCapsMode(int reqModes) {
            if (mTarget == null)
                return android.text.InputType.TYPE_TEXT_FLAG_CAP_SENTENCES;
    ...
    private void createTextFilter(boolean animateEntrance) {
        if (mPopup == null) {
            android.widget.PopupWindow p = new android.widget.PopupWindow(getContext());
            p.setFocusable(false);
            p.setTouchable(false);
            p.setInputMethodMode(android.widget.PopupWindow.INPUT_METHOD_NOT_NEEDED);
            p.setContentView(getTextFilterInput());
            p.setWidth(android.widget.AbsListView.LayoutParams.WRAP_CONTENT);
            p.setHeight(android.widget.AbsListView.LayoutParams.WRAP_CONTENT);
    ...
    private android.widget.EditText getTextFilterInput() {
        if (mTextFilter == null) {
            final android.view.LayoutInflater layoutInflater = android.view.LayoutInflater.from(getContext());
            mTextFilter = ((android.widget.EditText) (layoutInflater.inflate(com.android.internal.R.layout.typing_filter, null)));
            // For some reason setting this as the "real" input type changes
            // the text view in some way that it doesn't work, and I don't
            // want to figure out why this is.
            mTextFilter.setRawInputType(TYPE_CLASS_TEXT | TYPE_TEXT_VARIATION_FILTER);
    ...
    protected android.view.ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new android.widget.AbsListView.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT, 0);
    }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return p instanceof android.widget.AbsListView.LayoutParams;
    }
     ...
     */
    @android.view.inspector.InspectableProperty(enumMapping = { @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.TRANSCRIPT_MODE_DISABLED, name = "disabled"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.TRANSCRIPT_MODE_NORMAL, name = "normal"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.AbsListView.TRANSCRIPT_MODE_ALWAYS_SCROLL, name = "alwaysScroll") })
     ...
     */
    public void setCacheColorHint(@android.annotation.ColorInt
    int color) {
    ...
    public void reclaimViews(java.util.List<android.view.View> views) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            android.widget.AbsListView.LayoutParams lp = ((android.widget.AbsListView.LayoutParams) (child.getLayoutParams()));
    ...
    public void setRemoteViewsAdapter(android.content.Intent intent, boolean isAsync) {
        ...
        if (mRemoteAdapter != null) {
            ...
            android.content.Intent.FilterComparison fcOld = new android.content.Intent.FilterComparison(mRemoteAdapter.getRemoteViewsServiceIntent());
        ...
        mRemoteAdapter = new android.widget.RemoteViewsAdapter(getContext(), intent, this, isAsync);
    ...
    class MultiChoiceModeWrapper implements android.widget.AbsListView.MultiChoiceModeListener {
        ...
        public void setWrapped(android.widget.AbsListView.MultiChoiceModeListener wrapped) {
            mWrapped = wrapped;
        }
    ...
    public static class LayoutParams extends android.view.ViewGroup.LayoutParams {
         ...
         */
        @android.view.ViewDebug.ExportedProperty(category = "list", mapping = { @android.view.ViewDebug.IntToString(from = android.widget.AdapterView.ITEM_VIEW_TYPE_IGNORE, to = "ITEM_VIEW_TYPE_IGNORE"), @android.view.ViewDebug.IntToString(from = android.widget.AdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER, to = "ITEM_VIEW_TYPE_HEADER_OR_FOOTER") })
        @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 115609023)
        int viewType;
    ...
    class RecycleBin {
        ...
        public void setViewTypeCount(int viewTypeCount) {
            ...
            java.util.ArrayList<android.view.View>[] scrapViews = new java.util.ArrayList[viewTypeCount];
        ...
        public void markChildrenDirty() {
            if (mViewTypeCount == 1) {
                final java.util.ArrayList<android.view.View> scrap = mCurrentScrap;
                ...
                for (int i = 0; i < typeCount; i++) {
                    final java.util.ArrayList<android.view.View> scrap = mScrapViews[i];
                    final int scrapCount = scrap.size();
        ...
        void fillActiveViews(int childCount, int firstActivePosition) {
            if (mActiveViews.length < childCount) {
                mActiveViews = new android.view.View[childCount];
            }
            mFirstActivePosition = firstActivePosition;
            // noinspection MismatchedReadAndWriteOfArray
            final android.view.View[] activeViews = mActiveViews;
            for (int i = 0; i < childCount; i++) {
                android.view.View child = getChildAt(i);
                android.widget.AbsListView.LayoutParams lp = ((android.widget.AbsListView.LayoutParams) (child.getLayoutParams()));
         ...
         */
        android.view.View getActiveView(int position) {
            int index = position - mFirstActivePosition;
            final android.view.View[] activeViews = mActiveViews;
            if ((index >= 0) && (index < activeViews.length)) {
                final android.view.View match = activeViews[index];
        ...
        android.view.View getTransientStateView(int position) {
            if (((mAdapter != null) && mAdapterHasStableIds) && (mTransientStateViewsById != null)) {
                long id = mAdapter.getItemId(position);
                android.view.View result = mTransientStateViewsById.get(id);
            ...
            if (mTransientStateViews != null) {
                ...
                if (index >= 0) {
                    android.view.View result = mTransientStateViews.valueAt(index);
        ...
        void clearTransientStateViews() {
            final android.util.SparseArray<android.view.View> viewsByPos = mTransientStateViews;
            if (viewsByPos != null) {
            ...
            final android.util.LongSparseArray<android.view.View> viewsById = mTransientStateViewsById;
            if (viewsById != null) {
         ...
         */
        android.view.View getScrapView(int position) {
            ...
            if (mViewTypeCount == 1) {
                ...
                if (whichScrap < mScrapViews.length) {
         ...
         */
        void addScrapView(android.view.View scrap, int position) {
            final android.widget.AbsListView.LayoutParams lp = ((android.widget.AbsListView.LayoutParams) (scrap.getLayoutParams()));
            if (lp == null) {
            ...
            if (scrapHasTransientState) {
                if ((mAdapter != null) && mAdapterHasStableIds) {
                    ...
                    // the same data.
                    if (mTransientStateViewsById == null) {
                        mTransientStateViewsById = new android.util.LongSparseArray();
                    }
                    ...
                    if (!mDataChanged) {
                        ...
                        // their old positions.
                        if (mTransientStateViews == null) {
                            mTransientStateViews = new android.util.SparseArray();
                        }
        ...
        private java.util.ArrayList<android.view.View> getSkippedScrap() {
            if (mSkippedScrap == null) {
                mSkippedScrap = new java.util.ArrayList<>();
            }
        ...
        void scrapActiveViews() {
            ...
            java.util.ArrayList<android.view.View> scrapViews = mCurrentScrap;
            final int count = activeViews.length;
            for (int i = count - 1; i >= 0; i--) {
                final android.view.View victim = activeViews[i];
                if (victim != null) {
                    final android.widget.AbsListView.LayoutParams lp = ((android.widget.AbsListView.LayoutParams) (victim.getLayoutParams()));
                    ...
                    if (victim.hasTransientState()) {
                        ...
                        if ((mAdapter != null) && mAdapterHasStableIds) {
                            if (mTransientStateViewsById == null) {
                                mTransientStateViewsById = new android.util.LongSparseArray<android.view.View>();
                            }
                            ...
                            if (!mDataChanged) {
                                if (mTransientStateViews == null) {
                                    mTransientStateViews = new android.util.SparseArray<android.view.View>();
                                }
        ...
        void fullyDetachScrapViews() {
            ...
            final java.util.ArrayList<android.view.View>[] scrapViews = mScrapViews;
            for (int i = 0; i < viewTypeCount; ++i) {
                final java.util.ArrayList<android.view.View> scrapPile = scrapViews[i];
                for (int j = scrapPile.size() - 1; j >= 0; j--) {
                    final android.view.View view = scrapPile.get(j);
        ...
        private void pruneScrapViews() {
            ...
            final android.util.SparseArray<android.view.View> transViewsByPos = mTransientStateViews;
            if (transViewsByPos != null) {
                for (int i = 0; i < transViewsByPos.size(); i++) {
                    final android.view.View v = transViewsByPos.valueAt(i);
            ...
            final android.util.LongSparseArray<android.view.View> transViewsById = mTransientStateViewsById;
            if (transViewsById != null) {
                for (int i = 0; i < transViewsById.size(); i++) {
                    final android.view.View v = transViewsById.valueAt(i);
                    if (!v.hasTransientState()) {
                        removeDetachedView(v, false);
         ...
         */
        void reclaimScrapViews(java.util.List<android.view.View> views) {
            if (mViewTypeCount == 1) {
        ...
        private android.view.View retrieveFromScrap(java.util.ArrayList<android.view.View> scrapViews, int position) {
            final int size = scrapViews.size();
            if (size > 0) {
                // See if we still have a view for this position or ID.
                // Traverse backwards to find the most recently used scrap view
                for (int i = size - 1; i >= 0; i--) {
                    final android.view.View view = scrapViews.get(i);
                    final android.widget.AbsListView.LayoutParams params = ((android.widget.AbsListView.LayoutParams) (view.getLayoutParams()));
                    if (mAdapterHasStableIds) {
                        final long id = mAdapter.getItemId(position);
                        if (id == params.itemId) {
                        ...
                        if (params.scrappedFromPosition == position) {
                            final android.view.View scrap = scrapViews.remove(i);
                            clearScrapForRebind(scrap);
                            return scrap;
                        }

                }
                final android.view.View scrap = scrapViews.remove(size - 1);
                clearScrapForRebind(scrap);
                return scrap;
            } else {
                return null;
        ...
        private void clearScrap(final java.util.ArrayList<android.view.View> scrap) {
            final int scrapCount = scrap.size();
            for (int j = 0; j < scrapCount; j++) {
        ...
        private void removeDetachedView(android.view.View child, boolean animate) {
            child.setAccessibilityDelegate(null);
            android.widget.AbsListView.this.removeDetachedView(child, animate);
        }
    }
    ...
    int getHeightForPosition(int position) {
        ...
        if ((index >= 0) && (index < childCount)) {
            ...
            final android.view.View view = obtainView(position, mIsScrap);
            view.measure(mWidthMeasureSpec, android.view.View.MeasureSpec.UNSPECIFIED);
    ...
    class PositionScroller extends android.widget.AbsListView.AbsPositionScroller implements java.lang.Runnable {
        ...
        PositionScroller() {
            mExtraScroll = android.view.ViewConfiguration.get(mContext).getScaledFadingEdgeLength();
        }
        ...
        public void start(final int position) {
            ...
            if (mDataChanged) {
                ...
                mPositionScrollAfterLayout = new java.lang.Runnable() {
                    @java.lang.Override
                    public void run() {
                        start(position);
                    }
            ...
            int viewTravelCount;
            int clampedPosition = java.lang.Math.max(0, java.lang.Math.min(getCount() - 1, position));
            if (clampedPosition < firstPos) {
                viewTravelCount = (firstPos - clampedPosition) + 1;
                mMode = android.widget.AbsListView.PositionScroller.MOVE_UP_POS;
            } else
                if (clampedPosition > lastPos) {
                    viewTravelCount = (clampedPosition - lastPos) + 1;
                    mMode = android.widget.AbsListView.PositionScroller.MOVE_DOWN_POS;
                } else {
                    scrollToVisible(clampedPosition, android.widget.AdapterView.INVALID_POSITION, android.widget.AbsListView.PositionScroller.SCROLL_DURATION);
                    return;
                }

            if (viewTravelCount > 0) {
                mScrollDuration = android.widget.AbsListView.PositionScroller.SCROLL_DURATION / viewTravelCount;
            } else {
                mScrollDuration = android.widget.AbsListView.PositionScroller.SCROLL_DURATION;
            }
            mTargetPos = clampedPosition;
            mBoundPos = android.widget.AdapterView.INVALID_POSITION;
            mLastSeenPos = android.widget.AdapterView.INVALID_POSITION;
            postOnAnimation(this);
        }
        ...
        public void start(final int position, final int boundPosition) {
            ...
            if (clampedPosition < firstPos) {
                ...
                if (boundTravel < posTravel) {
                    ...
                    mMode = android.widget.AbsListView.PositionScroller.MOVE_UP_BOUND;
                } else {
                ...
                if (clampedPosition > lastPos) {
                    ...
                    if (boundTravel < posTravel) {
                        viewTravelCount = boundTravel;
                        mMode = android.widget.AbsListView.PositionScroller.MOVE_DOWN_BOUND;
                    } else {
                        viewTravelCount = posTravel;
                        mMode = android.widget.AbsListView.PositionScroller.MOVE_DOWN_POS;
                    }
                } else {
                    scrollToVisible(clampedPosition, boundPosition, android.widget.AbsListView.PositionScroller.SCROLL_DURATION);
                    return;
                }
        ...
        public void startWithOffset(int position, int offset) {
            startWithOffset(position, offset, android.widget.AbsListView.PositionScroller.SCROLL_DURATION);
        }
        ...
        public void startWithOffset(final int position, int offset, final int duration) {
            ...
            mTargetPos = java.lang.Math.max(0, java.lang.Math.min(getCount() - 1, position));
            mOffsetFromTop = offset;
            mBoundPos = android.widget.AdapterView.INVALID_POSITION;
            mLastSeenPos = android.widget.AdapterView.INVALID_POSITION;
            mMode = android.widget.AbsListView.PositionScroller.MOVE_OFFSET;
            final int firstPos = mFirstPosition;
            final int lastPos = (firstPos + childCount) - 1;
            int viewTravelCount;
        ...
        private void scrollToVisible(int targetPos, int boundPos, int duration) {
            ...
            if ((targetPos < firstPos) || (targetPos > lastPos)) {
                android.util.Log.w(android.widget.AbsListView.TAG, ((((("scrollToVisible called with targetPos " + targetPos) + " not visible [") + firstPos) + ", ") + lastPos) + "]");
            }
            if ((boundPos < firstPos) || (boundPos > lastPos)) {
                // boundPos doesn't matter, it's already offscreen.
                boundPos = android.widget.AdapterView.INVALID_POSITION;
            }
            final android.view.View targetChild = getChildAt(targetPos - firstPos);
            ...
            if (boundPos >= 0) {
                final android.view.View boundChild = getChildAt(boundPos - firstPos);
                final int boundTop = boundChild.getTop();
                final int boundBottom = boundChild.getBottom();
                final int absScroll = java.lang.Math.abs(scrollBy);
                if ((scrollBy < 0) && ((boundBottom + absScroll) > paddedBottom)) {
                    // Don't scroll the bound view off the bottom of the screen.
                    scrollBy = java.lang.Math.max(0, boundBottom - paddedBottom);
                } else
                    if ((scrollBy > 0) && ((boundTop - absScroll) < paddedTop)) {
                        // Don't scroll the bound view off the top of the screen.
                        scrollBy = java.lang.Math.min(0, boundTop - paddedTop);
                    }
        ...
        public void run() {
            ...
            final int firstPos = mFirstPosition;
            switch (mMode) {
                case android.widget.AbsListView.PositionScroller.MOVE_DOWN_POS :
                    {
                        ...
                        final android.view.View lastView = getChildAt(lastViewIndex);
                        final int lastViewHeight = lastView.getHeight();
                        final int lastViewTop = lastView.getTop();
                        final int lastViewPixelsShowing = listHeight - lastViewTop;
                        final int extraScroll = (lastPos < (mItemCount - 1)) ? java.lang.Math.max(mListPadding.bottom, mExtraScroll) : mListPadding.bottom;
                ...
                case android.widget.AbsListView.PositionScroller.MOVE_DOWN_BOUND :
                    {
                        ...
                        final android.view.View nextView = getChildAt(nextViewIndex);
                        final int nextViewHeight = nextView.getHeight();
                        final int nextViewTop = nextView.getTop();
                        final int extraScroll = java.lang.Math.max(mListPadding.bottom, mExtraScroll);
                        if (nextPos < mBoundPos) {
                            smoothScrollBy(java.lang.Math.max(0, (nextViewHeight + nextViewTop) - extraScroll), mScrollDuration, true, true);
                ...
                case android.widget.AbsListView.PositionScroller.MOVE_UP_POS :
                    {
                        ...
                        final int extraScroll = (firstPos > 0) ? java.lang.Math.max(mExtraScroll, mListPadding.top) : mListPadding.top;
                ...
                case android.widget.AbsListView.PositionScroller.MOVE_UP_BOUND :
                    {
                        ...
                        final int lastViewTop = lastView.getTop();
                        final int lastViewPixelsShowing = listHeight - lastViewTop;
                        final int extraScroll = java.lang.Math.max(mListPadding.top, mExtraScroll);
                        mLastSeenPos = lastPos;
                ...
                case android.widget.AbsListView.PositionScroller.MOVE_OFFSET :
                    {
                        ...
                        final float modifier = java.lang.Math.min(java.lang.Math.abs(screenTravelCount), 1.0F);
                        if (position < firstPos) {
                            ...
                            if (position > lastPos) {
                                ...
                                final int duration = ((int) (mScrollDuration * (((float) (java.lang.Math.abs(distance))) / getHeight())));
