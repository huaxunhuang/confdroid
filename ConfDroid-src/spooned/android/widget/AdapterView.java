...
public abstract class AdapterView<T extends android.widget.Adapter> extends android.view.ViewGroup {
     ...
     */
    long mSyncRowId = android.widget.AdapterView.INVALID_ROW_ID;
     ...
     */
    @android.annotation.UnsupportedAppUsage(maxTargetSdk = Build.VERSION_CODES.P, trackingBug = 123768524)
    ...
    @android.annotation.UnsupportedAppUsage
    int mNextSelectedPosition = android.widget.AdapterView.INVALID_POSITION;

    /**
     * The item id of the item to select during the next layout.
     */
    @android.annotation.UnsupportedAppUsage
    long mNextSelectedRowId = android.widget.AdapterView.INVALID_ROW_ID;
    ...
    @android.view.ViewDebug.ExportedProperty(category = "list")
    @android.annotation.UnsupportedAppUsage
    int mSelectedPosition = android.widget.AdapterView.INVALID_POSITION;

    /**
     * The item id of the currently selected item.
     */
    long mSelectedRowId = android.widget.AdapterView.INVALID_ROW_ID;
     ...
     */
    public static final long INVALID_ROW_ID = java.lang.Long.MIN_VALUE;

    /**
     * The last selected position we used when notifying
     */
    @android.annotation.UnsupportedAppUsage
    int mOldSelectedPosition = android.widget.AdapterView.INVALID_POSITION;

    /**
     * The id of the last selected position we used when notifying
     */
    long mOldSelectedRowId = android.widget.AdapterView.INVALID_ROW_ID;
     ...
     * @see #checkFocus()
     */
    private int mDesiredFocusableState = android.view.View.FOCUSABLE_AUTO;
    ...
    public AdapterView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (mDesiredFocusableState == android.view.View.FOCUSABLE_AUTO) {
            // Starts off without an adapter, so NOT_FOCUSABLE by default.
            super.setFocusable(android.view.View.NOT_FOCUSABLE);
        }
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(android.widget.AdapterView<?> parent, android.view.View view, int position, long id);
    }
     ...
     *
     * @param view
     * 		an adapter item, or a descendant of an adapter item. This
    ...
    public int getPositionForView(android.view.View view) {
        ...
        try {
            android.view.View v;
            while (((v = ((android.view.View) (listItem.getParent()))) != null) && (!v.equals(this))) {
                listItem = v;
            } 
    ...
    public void setEmptyView(android.view.View emptyView) {
        ...
        // If not explicitly specified this view is important for accessibility.
        if ((emptyView != null) && (emptyView.getImportantForAccessibility() == android.view.View.IMPORTANT_FOR_ACCESSIBILITY_AUTO)) {
            emptyView.setImportantForAccessibility(android.view.View.IMPORTANT_FOR_ACCESSIBILITY_YES);
        }
    ...
    @java.lang.Override
    public void setFocusable(@android.view.View.Focusable
    int focusable) {
        final T adapter = getAdapter();
        final boolean empty = (adapter == null) || (adapter.getCount() == 0);
        mDesiredFocusableState = focusable;
        if ((focusable & (android.view.View.FOCUSABLE_AUTO | android.view.View.FOCUSABLE)) == 0) {
            mDesiredFocusableInTouchModeState = false;
        }
        super.setFocusable((!empty) || isInFilterMode() ? focusable : android.view.View.NOT_FOCUSABLE);
    }
    ...
    public void setFocusableInTouchMode(boolean focusable) {
        ...
        if (focusable) {
            mDesiredFocusableState = android.view.View.FOCUSABLE;
        }
    ...
    void checkFocus() {
        ...
        super.setFocusable(focusable ? mDesiredFocusableState : android.view.View.NOT_FOCUSABLE);
        if (mEmptyView != null) {
    ...
    public long getItemIdAtPosition(int position) {
        T adapter = getAdapter();
        return (adapter == null) || (position < 0) ? android.widget.AdapterView.INVALID_ROW_ID : adapter.getItemId(position);
    }
    ...
    class AdapterDataSetObserver extends android.database.DataSetObserver {
        ...
        public void onChanged() {
            ...
            if (((android.widget.AdapterView.this.getAdapter().hasStableIds() && (mInstanceState != null)) && (mOldItemCount == 0)) && (mItemCount > 0)) {
    ...
    void selectionChanged() {
        ...
        // a pending notifier.
        mPendingSelectionNotifier = null;
        if ((mOnItemSelectedListener != null) || android.view.accessibility.AccessibilityManager.getInstance(mContext).isEnabled()) {
    ...
    public boolean dispatchPopulateAccessibilityEventInternal(android.view.accessibility.AccessibilityEvent event) {
        ...
        if (((selectedView != null) && (selectedView.getVisibility() == android.view.View.VISIBLE)) && selectedView.dispatchPopulateAccessibilityEvent(event)) {
            return true;
        }
        return false;
    }
    ...
    public boolean onRequestSendAccessibilityEventInternal(android.view.View child, android.view.accessibility.AccessibilityEvent event) {
        if (super.onRequestSendAccessibilityEventInternal(child, event)) {
            ...
            android.view.accessibility.AccessibilityEvent record = android.view.accessibility.AccessibilityEvent.obtain();
    ...
    int findSyncPosition() {
        ...
        seed = java.lang.Math.max(0, seed);
        seed = java.lang.Math.min(count - 1, seed);
    ...
    void setNextSelectedPositionInt(int position) {
        ...
        if ((mNeedSync && (mSyncMode == android.widget.AdapterView.SYNC_SELECTED_POSITION)) && (position >= 0)) {
        ...
        if (getChildCount() > 0) {
            ...
            if (mSelectedPosition >= 0) {
                ...
                if ((mFirstPosition >= 0) && (mFirstPosition < adapter.getCount())) {
                    ...
                    mSyncRowId = android.view.View.NO_ID;
                }
     ...
     */
    @java.lang.Override
    public void onProvideAutofillStructure(android.view.ViewStructure structure, int flags) {
    ...
    int viewFor, int flags) {
        ...
        if (viewFor == android.view.View.VIEW_STRUCTURE_FOR_AUTOFILL) {
            final android.widget.Adapter adapter = getAdapter();
            if (adapter == null)
                return;

            final java.lang.CharSequence[] options = adapter.getAutofillOptions();
            if (options != null) {
