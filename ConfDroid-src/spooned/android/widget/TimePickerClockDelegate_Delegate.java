...
public class TimePickerClockDelegate_Delegate {
    ...
    static int getAmOrPmKeyCode(android.widget.TimePickerClockDelegate tpcd, int amOrPm) {
        // We don't care about locales here.
        if (amOrPm == android.widget.TimePickerClockDelegate_Delegate.AM) {
            return android.view.KeyEvent.KEYCODE_A;
        } else
            if (amOrPm == android.widget.TimePickerClockDelegate_Delegate.PM) {
