...
public class ExceptionTextView extends android.widget.EditText {
    ...
    @java.lang.Override
    protected void makeNewLayout(int w, int hintWidth, android.text.BoringLayout.Metrics boring, android.text.BoringLayout.Metrics hintMetrics, int ellipsizedWidth, boolean bringIntoView) {
        if (w < 0) {
            mFailed = true;
            w = 100;
        }
        super.makeNewLayout(w, hintWidth, boring, hintMetrics, ellipsizedWidth, bringIntoView);
    }
}
