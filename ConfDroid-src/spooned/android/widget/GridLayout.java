 ...
 *
 * @unknown ref android.R.styleable#GridLayout_orientation
 * @unknown ref android.R.styleable#GridLayout_rowCount
 * @unknown ref android.R.styleable#GridLayout_columnCount
 * @unknown ref android.R.styleable#GridLayout_useDefaultMargins
 * @unknown ref android.R.styleable#GridLayout_rowOrderPreserved
 * @unknown ref android.R.styleable#GridLayout_columnOrderPreserved
 */
...
public class GridLayout extends android.view.ViewGroup {
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "HORIZONTAL", "VERTICAL" }, value = { android.widget.GridLayout.HORIZONTAL, android.widget.GridLayout.VERTICAL })
     ...
     * @unknown 
     */
    @android.annotation.IntDef(prefix = { "ALIGN_" }, value = { android.widget.GridLayout.ALIGN_BOUNDS, android.widget.GridLayout.ALIGN_MARGINS })
    @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
    ...
    static final android.util.Printer LOG_PRINTER = new android.util.LogPrinter(android.util.Log.DEBUG, android.widget.GridLayout.class.getName());
    ...
    // Defaults
    private static final int DEFAULT_ORIENTATION = android.widget.GridLayout.HORIZONTAL;

    private static final int DEFAULT_COUNT = android.widget.GridLayout.UNDEFINED;

    private static final boolean DEFAULT_USE_DEFAULT_MARGINS = false;

    private static final boolean DEFAULT_ORDER_PRESERVED = true;

    private static final int DEFAULT_ALIGNMENT_MODE = android.widget.GridLayout.ALIGN_MARGINS;
    ...
    // Instance variables
    final android.widget.GridLayout.Axis mHorizontalAxis = new android.widget.GridLayout.Axis(true);

    final android.widget.GridLayout.Axis mVerticalAxis = new android.widget.GridLayout.Axis(false);

    int mOrientation = android.widget.GridLayout.DEFAULT_ORIENTATION;

    boolean mUseDefaultMargins = android.widget.GridLayout.DEFAULT_USE_DEFAULT_MARGINS;

    int mAlignmentMode = android.widget.GridLayout.DEFAULT_ALIGNMENT_MODE;

    int mDefaultGap;

    int mLastLayoutParamsHashCode = android.widget.GridLayout.UNINITIALIZED_HASH;

    android.util.Printer mPrinter = android.widget.GridLayout.LOG_PRINTER;
    ...
    public GridLayout(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.GridLayout, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.GridLayout, attrs, a, defStyleAttr, defStyleRes);
        try {
            setRowCount(a.getInt(android.widget.GridLayout.ROW_COUNT, android.widget.GridLayout.DEFAULT_COUNT));
            setColumnCount(a.getInt(android.widget.GridLayout.COLUMN_COUNT, android.widget.GridLayout.DEFAULT_COUNT));
            setOrientation(a.getInt(android.widget.GridLayout.ORIENTATION, android.widget.GridLayout.DEFAULT_ORIENTATION));
            setUseDefaultMargins(a.getBoolean(android.widget.GridLayout.USE_DEFAULT_MARGINS, android.widget.GridLayout.DEFAULT_USE_DEFAULT_MARGINS));
            setAlignmentMode(a.getInt(android.widget.GridLayout.ALIGNMENT_MODE, android.widget.GridLayout.DEFAULT_ALIGNMENT_MODE));
            setRowOrderPreserved(a.getBoolean(android.widget.GridLayout.ROW_ORDER_PRESERVED, android.widget.GridLayout.DEFAULT_ORDER_PRESERVED));
            setColumnOrderPreserved(a.getBoolean(android.widget.GridLayout.COLUMN_ORDER_PRESERVED, android.widget.GridLayout.DEFAULT_ORDER_PRESERVED));
        } finally {
            a.recycle();
        }
    }
    ...
    @android.view.inspector.InspectableProperty(enumMapping = { @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.GridLayout.HORIZONTAL, name = "horizontal"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.GridLayout.VERTICAL, name = "vertical") })
     ...
     * @unknown ref android.R.styleable#GridLayout_orientation
     */
    public void setOrientation(@android.widget.GridLayout.Orientation
    int orientation) {
     ...
     * @see #ALIGN_MARGINS
     * @see #setAlignmentMode(int)
     * @unknown ref android.R.styleable#GridLayout_alignmentMode
     */
    @android.widget.GridLayout.AlignmentMode
    @android.view.inspector.InspectableProperty(enumMapping = { @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.GridLayout.ALIGN_BOUNDS, name = "alignBounds"), @android.view.inspector.InspectableProperty.EnumEntry(value = android.widget.GridLayout.ALIGN_MARGINS, name = "alignMargins") })
     ...
     * @unknown ref android.R.styleable#GridLayout_alignmentMode
     */
    public void setAlignmentMode(@android.widget.GridLayout.AlignmentMode
    int alignmentMode) {
    ...
    public void setPrinter(android.util.Printer printer) {
        this.mPrinter = (printer == null) ? android.widget.GridLayout.NO_PRINTER : printer;
    }
    ...
    static android.widget.GridLayout.Alignment getAlignment(int gravity, boolean horizontal) {
        ...
        switch (flags) {
            case android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_BEFORE :
                return horizontal ? android.widget.GridLayout.LEFT : android.widget.GridLayout.TOP;
            case android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_AFTER :
                return horizontal ? android.widget.GridLayout.RIGHT : android.widget.GridLayout.BOTTOM;
            ...
            case android.view.Gravity.AXIS_SPECIFIED :
                return android.widget.GridLayout.CENTER;
            case (android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_BEFORE) | android.view.Gravity.RELATIVE_LAYOUT_DIRECTION :
                return android.widget.GridLayout.START;
            case (android.view.Gravity.AXIS_SPECIFIED | android.view.Gravity.AXIS_PULL_AFTER) | android.view.Gravity.RELATIVE_LAYOUT_DIRECTION :
                return android.widget.GridLayout.END;
            default :
                return android.widget.GridLayout.UNDEFINED_ALIGNMENT;
        }
    }
    ...
    private int getDefaultMargin(android.view.View c, android.widget.GridLayout.LayoutParams p, boolean horizontal, boolean leading) {
        if (!mUseDefaultMargins) {
            return 0;
        }
        android.widget.GridLayout.Spec spec = (horizontal) ? p.columnSpec : p.rowSpec;
        android.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
    ...
    int getMargin1(android.view.View view, boolean horizontal, boolean leading) {
        ...
        return margin == android.widget.GridLayout.UNDEFINED ? getDefaultMargin(view, lp, horizontal, leading) : margin;
    }

    private int getMargin(android.view.View view, boolean horizontal, boolean leading) {
        if (mAlignmentMode == android.widget.GridLayout.ALIGN_MARGINS) {
            return getMargin1(view, horizontal, leading);
        } else {
            android.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
            int[] margins = (leading) ? axis.getLeadingMargins() : axis.getTrailingMargins();
            android.widget.GridLayout.LayoutParams lp = getLayoutParams(view);
            android.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
    ...
    private static void setCellGroup(android.widget.GridLayout.LayoutParams lp, int row, int rowSpan, int col, int colSpan) {
    ...
    private static int clip(android.widget.GridLayout.Interval minorRange, boolean minorWasDefined, int count) {
    ...
    private void validateLayoutParams() {
        final boolean horizontal = mOrientation == android.widget.GridLayout.HORIZONTAL;
        final android.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
        final int count = (axis.definedCount != android.widget.GridLayout.UNDEFINED) ? axis.definedCount : 0;
        int major = 0;
        int minor = 0;
        int[] maxSizes = new int[count];
        for (int i = 0, N = getChildCount(); i < N; i++) {
            android.widget.GridLayout.LayoutParams lp = ((android.widget.GridLayout.LayoutParams) (getChildAt(i).getLayoutParams()));
            final android.widget.GridLayout.Spec majorSpec = (horizontal) ? lp.rowSpec : lp.columnSpec;
            final android.widget.GridLayout.Interval majorRange = majorSpec.span;
            final boolean majorWasDefined = majorSpec.startDefined;
            final int majorSpan = majorRange.size();
            if (majorWasDefined) {
                major = majorRange.min;
            }
            final android.widget.GridLayout.Spec minorSpec = (horizontal) ? lp.columnSpec : lp.rowSpec;
            final android.widget.GridLayout.Interval minorRange = minorSpec.span;
            final boolean minorWasDefined = minorSpec.startDefined;
            final int minorSpan = android.widget.GridLayout.clip(minorRange, minorWasDefined, count);
            if (minorWasDefined) {
            ...
            if (count != 0) {
                ...
                if ((!majorWasDefined) || (!minorWasDefined)) {
                    while (!android.widget.GridLayout.fits(maxSizes, major, minor, minor + minorSpan)) {
                        if (minorWasDefined) {
                            major++;
                        } else {
                ...
                android.widget.GridLayout.procrusteanFill(maxSizes, minor, minor + minorSpan, major + majorSpan);
            }
            if (horizontal) {
                android.widget.GridLayout.setCellGroup(lp, major, majorSpan, minor, minorSpan);
            } else {
                android.widget.GridLayout.setCellGroup(lp, minor, minorSpan, major, majorSpan);
            }
    ...
    private void invalidateStructure() {
        mLastLayoutParamsHashCode = android.widget.GridLayout.UNINITIALIZED_HASH;
    ...
    protected void onSetLayoutParams(android.view.View child, android.view.ViewGroup.LayoutParams layoutParams) {
        ...
        if (!checkLayoutParams(layoutParams)) {
            android.widget.GridLayout.handleInvalidParams("supplied LayoutParams are of the wrong type");
        }
        invalidateStructure();
    }

    final android.widget.GridLayout.LayoutParams getLayoutParams(android.view.View c) {
    ...
    private void checkLayoutParams(android.widget.GridLayout.LayoutParams lp, boolean horizontal) {
        java.lang.String groupName = (horizontal) ? "column" : "row";
        android.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
        android.widget.GridLayout.Interval span = spec.span;
        if ((span.min != android.widget.GridLayout.UNDEFINED) && (span.min < 0)) {
            android.widget.GridLayout.handleInvalidParams(groupName + " indices must be positive");
        }
        android.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
        int count = axis.definedCount;
        if (count != android.widget.GridLayout.UNDEFINED) {
            if (span.max > count) {
                android.widget.GridLayout.handleInvalidParams(((groupName + " indices (start + span) mustn't exceed the ") + groupName) + " count");
            }
            if (span.size() > count) {
                android.widget.GridLayout.handleInvalidParams(((groupName + " span mustn't exceed the ") + groupName) + " count");
            }
        }
    }
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        if (!(p instanceof android.widget.GridLayout.LayoutParams)) {
            return false;
        }
        android.widget.GridLayout.LayoutParams lp = ((android.widget.GridLayout.LayoutParams) (p));
    ...
    @java.lang.Override
    protected android.widget.GridLayout.LayoutParams generateLayoutParams(android.view.ViewGroup.LayoutParams lp) {
        if (android.view.View.sPreserveMarginParamsInLayoutParamConversion) {
            if (lp instanceof android.widget.GridLayout.LayoutParams) {
                return new android.widget.GridLayout.LayoutParams(((android.widget.GridLayout.LayoutParams) (lp)));
            } else
                if (lp instanceof android.view.ViewGroup.MarginLayoutParams) {
                    return new android.widget.GridLayout.LayoutParams(((android.view.ViewGroup.MarginLayoutParams) (lp)));
                }

        }
        return new android.widget.GridLayout.LayoutParams(lp);
    }
    ...
    protected void onDebugDraw(android.graphics.Canvas canvas) {
        ...
        android.graphics.Insets insets = getOpticalInsets();
    ...
    protected void onChildVisibilityChanged(android.view.View child, int oldVisibility, int newVisibility) {
        ...
        if ((oldVisibility == android.view.View.GONE) || (newVisibility == android.view.View.GONE)) {
            invalidateStructure();
        }
    }
    ...
    private int computeLayoutParamsHashCode() {
        ...
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            android.widget.GridLayout.LayoutParams lp = ((android.widget.GridLayout.LayoutParams) (c.getLayoutParams()));
    ...
    private void consistencyCheck() {
        if (mLastLayoutParamsHashCode == android.widget.GridLayout.UNINITIALIZED_HASH) {
    ...
    private void measureChildrenWithMargins(int widthSpec, int heightSpec, boolean firstPass) {
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            if (firstPass) {
                ...
                boolean horizontal = mOrientation == android.widget.GridLayout.HORIZONTAL;
                android.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                if (spec.getAbsoluteAlignment(horizontal) == android.widget.GridLayout.FILL) {
                    android.widget.GridLayout.Interval span = spec.span;
                    android.widget.GridLayout.Axis axis = (horizontal) ? mHorizontalAxis : mVerticalAxis;
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        int widthSpecSansPadding = android.widget.GridLayout.adjust(widthSpec, -hPadding);
        int heightSpecSansPadding = android.widget.GridLayout.adjust(heightSpec, -vPadding);
        ...
        if (mOrientation == android.widget.GridLayout.HORIZONTAL) {
        ...
        setMeasuredDimension(android.view.View.resolveSizeAndState(measuredWidth, widthSpec, 0), android.view.View.resolveSizeAndState(measuredHeight, heightSpec, 0));
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0, N = getChildCount(); i < N; i++) {
            ...
            android.widget.GridLayout.Alignment hAlign = columnSpec.getAbsoluteAlignment(true);
            android.widget.GridLayout.Alignment vAlign = rowSpec.getAbsoluteAlignment(false);
            android.widget.GridLayout.Bounds boundsX = mHorizontalAxis.getGroupBounds().getValue(i);
            android.widget.GridLayout.Bounds boundsY = mVerticalAxis.getGroupBounds().getValue(i);
    ...
    final class Axis {
        ...
        public int definedCount = android.widget.GridLayout.UNDEFINED;

        private int maxIndex = android.widget.GridLayout.UNDEFINED;
        ...
        boolean orderPreserved = android.widget.GridLayout.DEFAULT_ORDER_PRESERVED;

        private android.widget.GridLayout.MutableInt parentMin = new android.widget.GridLayout.MutableInt(0);

        private android.widget.GridLayout.MutableInt parentMax = new android.widget.GridLayout.MutableInt(-android.widget.GridLayout.MAX_SIZE);
        ...
        private int calculateMaxIndex() {
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                android.view.View c = getChildAt(i);
                android.widget.GridLayout.LayoutParams params = getLayoutParams(c);
                android.widget.GridLayout.Spec spec = (horizontal) ? params.columnSpec : params.rowSpec;
                android.widget.GridLayout.Interval span = spec.span;
        ...
        private int getMaxIndex() {
            if (maxIndex == android.widget.GridLayout.UNDEFINED) {
        ...
        public void setCount(int count) {
            if ((count != android.widget.GridLayout.UNDEFINED) && (count < getMaxIndex())) {
                android.widget.GridLayout.handleInvalidParams(((horizontal ? "column" : "row") + "Count must be greater than or equal to the maximum of all grid indices ") + "(and spans) defined in the LayoutParams of each child");
            }
        ...
        private android.widget.GridLayout.PackedMap<android.widget.GridLayout.Spec, android.widget.GridLayout.Bounds> createGroupBounds() {
            android.widget.GridLayout.Assoc<android.widget.GridLayout.Spec, android.widget.GridLayout.Bounds> assoc = android.widget.GridLayout.Assoc.of(android.widget.GridLayout.Spec.class, android.widget.GridLayout.Bounds.class);
            for (int i = 0, N = getChildCount(); i < N; i++) {
                android.view.View c = getChildAt(i);
                // we must include views that are GONE here, see introductory javadoc
                android.widget.GridLayout.LayoutParams lp = getLayoutParams(c);
                android.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                android.widget.GridLayout.Bounds bounds = spec.getAbsoluteAlignment(horizontal).getBounds();
        ...
        private void computeGroupBounds() {
            android.widget.GridLayout.Bounds[] values = groupBounds.values;
            ...
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                groupBounds.getValue(i).include(android.widget.GridLayout.this, c, spec, this, size);
            }
        }
        ...
        private android.widget.GridLayout.PackedMap<android.widget.GridLayout.Interval, android.widget.GridLayout.MutableInt> createLinks(boolean min) {
            android.widget.GridLayout.Assoc<android.widget.GridLayout.Interval, android.widget.GridLayout.MutableInt> result = android.widget.GridLayout.Assoc.of(android.widget.GridLayout.Interval.class, android.widget.GridLayout.MutableInt.class);
            android.widget.GridLayout.Spec[] keys = getGroupBounds().keys;
        ...
        private void computeLinks(android.widget.GridLayout.PackedMap<android.widget.GridLayout.Interval, android.widget.GridLayout.MutableInt> links, boolean min) {
            android.widget.GridLayout.MutableInt[] spans = links.values;
            for (int i = 0; i < spans.length; i++) {
                spans[i].reset();
            }
            // Use getter to trigger a re-evaluation
            android.widget.GridLayout.Bounds[] bounds = getGroupBounds().values;
            for (int i = 0; i < bounds.length; i++) {
                int size = bounds[i].size(min);
                android.widget.GridLayout.MutableInt valueHolder = links.getValue(i);
        ...
        private void include(java.util.List<android.widget.GridLayout.Arc> arcs, android.widget.GridLayout.Interval key, android.widget.GridLayout.MutableInt size, boolean ignoreIfAlreadyPresent) {
            ...
            if (ignoreIfAlreadyPresent) {
                for (android.widget.GridLayout.Arc arc : arcs) {
            ...
            arcs.add(new android.widget.GridLayout.Arc(key, size));
        }

        private void include(java.util.List<android.widget.GridLayout.Arc> arcs, android.widget.GridLayout.Interval key, android.widget.GridLayout.MutableInt size) {
        ...
        android.widget.GridLayout.Arc[][] groupArcsByFirstVertex(android.widget.GridLayout.Arc[] arcs) {
        ...
        private android.widget.GridLayout.Arc[] topologicalSort(final android.widget.GridLayout.Arc[] arcs) {
            return new java.lang.Object() {
                android.widget.GridLayout.Arc[] result = new android.widget.GridLayout.Arc[arcs.length];

                int cursor = result.length - 1;

                android.widget.GridLayout.Arc[][] arcsByVertex = groupArcsByFirstVertex(arcs);
                ...
                void walk(int loc) {
                    switch (visited[loc]) {
                        case android.widget.GridLayout.Axis.NEW :
                            {
                                visited[loc] = android.widget.GridLayout.Axis.PENDING;
                                for (android.widget.GridLayout.Arc arc : arcsByVertex[loc]) {
                                    walk(arc.span.max);
                                    result[cursor--] = arc;
                                }
                                visited[loc] = android.widget.GridLayout.Axis.COMPLETE;
                                break;
                            }
        ...
        private android.widget.GridLayout.Arc[] topologicalSort(java.util.List<android.widget.GridLayout.Arc> arcs) {
            return topologicalSort(arcs.toArray(new android.widget.GridLayout.Arc[arcs.size()]));
        }

        private void addComponentSizes(java.util.List<android.widget.GridLayout.Arc> result, android.widget.GridLayout.PackedMap<android.widget.GridLayout.Interval, android.widget.GridLayout.MutableInt> links) {
        ...
        private android.widget.GridLayout.Arc[] createArcs() {
            java.util.List<android.widget.GridLayout.Arc> mins = new java.util.ArrayList<android.widget.GridLayout.Arc>();
            java.util.List<android.widget.GridLayout.Arc> maxs = new java.util.ArrayList<android.widget.GridLayout.Arc>();
            ...
            if (orderPreserved) {
                ...
                for (int i = 0; i < getCount(); i++) {
                    include(mins, new android.widget.GridLayout.Interval(i, i + 1), new android.widget.GridLayout.MutableInt(0));
                }
            }
            ...
            int N = getCount();
            include(mins, new android.widget.GridLayout.Interval(0, N), parentMin, false);
            include(maxs, new android.widget.GridLayout.Interval(N, 0), parentMax, false);
            // Sort
            android.widget.GridLayout.Arc[] sMins = topologicalSort(mins);
            android.widget.GridLayout.Arc[] sMaxs = topologicalSort(maxs);
        ...
        private boolean relax(int[] locations, android.widget.GridLayout.Arc entry) {
            if (!entry.valid) {
                return false;
            }
        ...
        private java.lang.String arcsToString(java.util.List<android.widget.GridLayout.Arc> arcs) {
        ...
        private void logError(java.lang.String axisName, android.widget.GridLayout.Arc[] arcs, boolean[] culprits0) {
            java.util.List<android.widget.GridLayout.Arc> culprits = new java.util.ArrayList<android.widget.GridLayout.Arc>();
            java.util.List<android.widget.GridLayout.Arc> removed = new java.util.ArrayList<android.widget.GridLayout.Arc>();
         ...
         */
        private boolean solve(android.widget.GridLayout.Arc[] arcs, int[] locations) {
            return solve(arcs, locations, true);
        }

        private boolean solve(android.widget.GridLayout.Arc[] arcs, int[] locations, boolean modifyOnError) {
            ...
            for (int p = 0; p < arcs.length; p++) {
                ...
                for (int i = 0; i < arcs.length; i++) {
                    if (culprits[i]) {
                        android.widget.GridLayout.Arc arc = arcs[i];
        ...
        private boolean computeHasWeights() {
            for (int i = 0, N = getChildCount(); i < N; i++) {
                ...
                android.widget.GridLayout.LayoutParams lp = getLayoutParams(child);
                android.widget.GridLayout.Spec spec = (horizontal) ? lp.columnSpec : lp.rowSpec;
                if (spec.weight != 0) {
                    return true;
                }
        ...
        public int getMeasure(int measureSpec) {
            ...
            switch (mode) {
                case android.view.View.MeasureSpec.UNSPECIFIED :
                    {
                        return getMeasure(0, android.widget.GridLayout.MAX_SIZE);
                    }
     ...
     *
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_row
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_rowSpan
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_rowWeight
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_column
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_columnSpan
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_columnWeight
     * @unknown ref android.R.styleable#GridLayout_Layout_layout_gravity
     */
    public static class LayoutParams extends android.view.ViewGroup.MarginLayoutParams {
        ...
        private static final int DEFAULT_MARGIN = android.widget.GridLayout.UNDEFINED;

        private static final int DEFAULT_ROW = android.widget.GridLayout.UNDEFINED;

        private static final int DEFAULT_COLUMN = android.widget.GridLayout.UNDEFINED;

        private static final android.widget.GridLayout.Interval DEFAULT_SPAN = new android.widget.GridLayout.Interval(android.widget.GridLayout.UNDEFINED, android.widget.GridLayout.UNDEFINED + 1);

        private static final int DEFAULT_SPAN_SIZE = android.widget.GridLayout.LayoutParams.DEFAULT_SPAN.size();
         ...
         * calls to remove the warnings as soon as it is practical.
         */
        public android.widget.GridLayout.Spec columnSpec = android.widget.GridLayout.Spec.UNDEFINED;

        // Constructors
        private LayoutParams(int width, int height, int left, int top, int right, int bottom, android.widget.GridLayout.Spec rowSpec, android.widget.GridLayout.Spec columnSpec) {
            super(width, height);
        ...
        public LayoutParams(android.widget.GridLayout.Spec rowSpec, android.widget.GridLayout.Spec columnSpec) {
            this(android.widget.GridLayout.LayoutParams.DEFAULT_WIDTH, android.widget.GridLayout.LayoutParams.DEFAULT_HEIGHT, android.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, android.widget.GridLayout.LayoutParams.DEFAULT_MARGIN, rowSpec, columnSpec);
        }
        ...
        private void reInitSuper(android.content.Context context, android.util.AttributeSet attrs) {
            android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ViewGroup_MarginLayout);
            try {
                int margin = a.getDimensionPixelSize(android.widget.GridLayout.LayoutParams.MARGIN, android.widget.GridLayout.LayoutParams.DEFAULT_MARGIN);
                this.leftMargin = a.getDimensionPixelSize(android.widget.GridLayout.LayoutParams.LEFT_MARGIN, margin);
                this.topMargin = a.getDimensionPixelSize(android.widget.GridLayout.LayoutParams.TOP_MARGIN, margin);
                this.rightMargin = a.getDimensionPixelSize(android.widget.GridLayout.LayoutParams.RIGHT_MARGIN, margin);
                this.bottomMargin = a.getDimensionPixelSize(android.widget.GridLayout.LayoutParams.BOTTOM_MARGIN, margin);
            } finally {
                a.recycle();
            }
        }
        ...
        private void init(android.content.Context context, android.util.AttributeSet attrs) {
            ...
            try {
                int gravity = a.getInt(android.widget.GridLayout.LayoutParams.GRAVITY, android.view.Gravity.NO_GRAVITY);
                int column = a.getInt(android.widget.GridLayout.LayoutParams.COLUMN, android.widget.GridLayout.LayoutParams.DEFAULT_COLUMN);
                int colSpan = a.getInt(android.widget.GridLayout.LayoutParams.COLUMN_SPAN, android.widget.GridLayout.LayoutParams.DEFAULT_SPAN_SIZE);
                float colWeight = a.getFloat(android.widget.GridLayout.LayoutParams.COLUMN_WEIGHT, android.widget.GridLayout.Spec.DEFAULT_WEIGHT);
                this.columnSpec = android.widget.GridLayout.spec(column, colSpan, android.widget.GridLayout.getAlignment(gravity, true), colWeight);
                int row = a.getInt(android.widget.GridLayout.LayoutParams.ROW, android.widget.GridLayout.LayoutParams.DEFAULT_ROW);
                int rowSpan = a.getInt(android.widget.GridLayout.LayoutParams.ROW_SPAN, android.widget.GridLayout.LayoutParams.DEFAULT_SPAN_SIZE);
                float rowWeight = a.getFloat(android.widget.GridLayout.LayoutParams.ROW_WEIGHT, android.widget.GridLayout.Spec.DEFAULT_WEIGHT);
                this.rowSpec = android.widget.GridLayout.spec(row, rowSpan, android.widget.GridLayout.getAlignment(gravity, false), rowWeight);
            } finally {
                a.recycle();
            }
        }
        ...
        public void setGravity(int gravity) {
            rowSpec = rowSpec.copyWriteAlignment(android.widget.GridLayout.getAlignment(gravity, false));
            columnSpec = columnSpec.copyWriteAlignment(android.widget.GridLayout.getAlignment(gravity, true));
        }

        @java.lang.Override
        protected void setBaseAttributes(android.content.res.TypedArray attributes, int widthAttr, int heightAttr) {
            this.width = attributes.getLayoutDimension(widthAttr, android.widget.GridLayout.LayoutParams.DEFAULT_WIDTH);
            this.height = attributes.getLayoutDimension(heightAttr, android.widget.GridLayout.LayoutParams.DEFAULT_HEIGHT);
        }

        final void setRowSpecSpan(android.widget.GridLayout.Interval span) {
            rowSpec = rowSpec.copyWriteSpan(span);
        }

        final void setColumnSpecSpan(android.widget.GridLayout.Interval span) {
        ...
        public boolean equals(java.lang.Object o) {
            ...
            android.widget.GridLayout.LayoutParams that = ((android.widget.GridLayout.LayoutParams) (o));
    ...
    static final class Arc {
        ...
        public Arc(android.widget.GridLayout.Interval span, android.widget.GridLayout.MutableInt value) {
            this.span = span;
            this.value = value;
        }
    ...
    static final class Assoc<K, V> extends java.util.ArrayList<android.util.Pair<K, V>> {
        ...
        public static <K, V> android.widget.GridLayout.Assoc<K, V> of(java.lang.Class<K> keyType, java.lang.Class<V> valueType) {
    ...
    static final class PackedMap<K, V> {
        ...
        private PackedMap(K[] keys, V[] values) {
            this.index = android.widget.GridLayout.PackedMap.createIndex(keys);
            this.keys = android.widget.GridLayout.PackedMap.compact(keys, index);
            this.values = android.widget.GridLayout.PackedMap.compact(values, index);
        }
        ...
        private static <K> K[] compact(K[] a, int[] index) {
            ...
            K[] result = ((K[]) (java.lang.reflect.Array.newInstance(componentType, android.widget.GridLayout.max2(index, -1) + 1)));
    ...
    static class Bounds {
        ...
        protected void reset() {
            ...
            flexibility = android.widget.GridLayout.CAN_STRETCH;// from the above, we're flexible when empty
        ...
        protected int size(boolean min) {
            if (!min) {
                if (android.widget.GridLayout.canStretch(flexibility)) {
                    return android.widget.GridLayout.MAX_SIZE;
                }
            }
            return before + after;
        }

        protected int getOffset(android.widget.GridLayout gl, android.view.View c, android.widget.GridLayout.Alignment a, int size, boolean horizontal) {
            return before - a.getAlignmentValue(c, size, gl.getLayoutMode());
        }

        protected final void include(android.widget.GridLayout gl, android.view.View c, android.widget.GridLayout.Spec spec, android.widget.GridLayout.Axis axis, int size) {
            this.flexibility &= spec.getFlexibility();
            boolean horizontal = axis.horizontal;
            android.widget.GridLayout.Alignment alignment = spec.getAbsoluteAlignment(axis.horizontal);
    ...
    static final class Interval {
        ...
        public boolean equals(java.lang.Object that) {
            ...
            android.widget.GridLayout.Interval interval = ((android.widget.GridLayout.Interval) (that));
            if (max != interval.max) {
                return false;
            }
    ...
    public static class Spec {
        static final android.widget.GridLayout.Spec UNDEFINED = android.widget.GridLayout.spec(android.widget.GridLayout.UNDEFINED);
        ...
        private Spec(boolean startDefined, android.widget.GridLayout.Interval span, android.widget.GridLayout.Alignment alignment, float weight) {
        ...
        private Spec(boolean startDefined, int start, int size, android.widget.GridLayout.Alignment alignment, float weight) {
            this(startDefined, new android.widget.GridLayout.Interval(start, start + size), alignment, weight);
        }

        private android.widget.GridLayout.Alignment getAbsoluteAlignment(boolean horizontal) {
            if (alignment != android.widget.GridLayout.UNDEFINED_ALIGNMENT) {
                return alignment;
            }
            if (weight == 0.0F) {
                return horizontal ? android.widget.GridLayout.START : android.widget.GridLayout.BASELINE;
            }
            return android.widget.GridLayout.FILL;
        }

        final android.widget.GridLayout.Spec copyWriteSpan(android.widget.GridLayout.Interval span) {
            return new android.widget.GridLayout.Spec(startDefined, span, alignment, weight);
        }
        ...
        final int getFlexibility() {
            return (alignment == android.widget.GridLayout.UNDEFINED_ALIGNMENT) && (weight == 0) ? android.widget.GridLayout.INFLEXIBLE : android.widget.GridLayout.CAN_STRETCH;
        }
     ...
     * 		the weight
     */
    public static android.widget.GridLayout.Spec spec(int start, int size, android.widget.GridLayout.Alignment alignment, float weight) {
        return new android.widget.GridLayout.Spec(start != android.widget.GridLayout.UNDEFINED, start, size, alignment, weight);
    }
     ...
     * 		the weight
     */
    public static android.widget.GridLayout.Spec spec(int start, android.widget.GridLayout.Alignment alignment, float weight) {
        return android.widget.GridLayout.spec(start, 1, alignment, weight);
    }
     ...
     * 		the weight
     */
    public static android.widget.GridLayout.Spec spec(int start, int size, float weight) {
        return android.widget.GridLayout.spec(start, size, android.widget.GridLayout.UNDEFINED_ALIGNMENT, weight);
    }
     ...
     * 		the weight
     */
    public static android.widget.GridLayout.Spec spec(int start, float weight) {
        return android.widget.GridLayout.spec(start, 1, weight);
    }
     ...
     * 		the alignment
     */
    public static android.widget.GridLayout.Spec spec(int start, int size, android.widget.GridLayout.Alignment alignment) {
        return android.widget.GridLayout.spec(start, size, alignment, android.widget.GridLayout.Spec.DEFAULT_WEIGHT);
    }
     ...
     */
    public static android.widget.GridLayout.Spec spec(int start, android.widget.GridLayout.Alignment alignment) {
        return android.widget.GridLayout.spec(start, 1, alignment);
    }
    ...
    public static android.widget.GridLayout.Spec spec(int start, int size) {
        return android.widget.GridLayout.spec(start, size, android.widget.GridLayout.UNDEFINED_ALIGNMENT);
    }
    ...
    public static android.widget.GridLayout.Spec spec(int start) {
        return android.widget.GridLayout.spec(start, 1);
    }
    ...
    static final android.widget.GridLayout.Alignment UNDEFINED_ALIGNMENT = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
     ...
     */
    private static final android.widget.GridLayout.Alignment LEADING = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return 0;
        }
     ...
     * edges of the other views in its cell group.
     */
    private static final android.widget.GridLayout.Alignment TRAILING = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return cellDelta;
        }
     ...
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment TOP = android.widget.GridLayout.LEADING;

    /**
     * Indicates that a view should be aligned with the <em>bottom</em>
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment BOTTOM = android.widget.GridLayout.TRAILING;

    /**
     * Indicates that a view should be aligned with the <em>start</em>
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment START = android.widget.GridLayout.LEADING;

    /**
     * Indicates that a view should be aligned with the <em>end</em>
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment END = android.widget.GridLayout.TRAILING;

    private static android.widget.GridLayout.Alignment createSwitchingAlignment(final android.widget.GridLayout.Alignment ltr, final android.widget.GridLayout.Alignment rtl) {
        return new android.widget.GridLayout.Alignment() {
            @java.lang.Override
            int getGravityOffset(android.view.View view, int cellDelta) {
     ...
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment LEFT = android.widget.GridLayout.createSwitchingAlignment(android.widget.GridLayout.START, android.widget.GridLayout.END);

    /**
     * Indicates that a view should be aligned with the <em>right</em>
     * edges of the other views in its cell group.
     */
    public static final android.widget.GridLayout.Alignment RIGHT = android.widget.GridLayout.createSwitchingAlignment(android.widget.GridLayout.END, android.widget.GridLayout.START);
     ...
     */
    public static final android.widget.GridLayout.Alignment CENTER = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return cellDelta >> 1;
        }
     ...
     */
    public static final android.widget.GridLayout.Alignment BASELINE = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
        ...
        public android.widget.GridLayout.Bounds getBounds() {
            return new android.widget.GridLayout.Bounds() {
                ...
                @java.lang.Override
                protected int getOffset(android.widget.GridLayout gl, android.view.View c, android.widget.GridLayout.Alignment a, int size, boolean hrz) {
     ...
     */
    public static final android.widget.GridLayout.Alignment FILL = new android.widget.GridLayout.Alignment() {
        @java.lang.Override
        int getGravityOffset(android.view.View view, int cellDelta) {
            return 0;
        }
    ...
    static boolean canStretch(int flexibility) {
        return (flexibility & android.widget.GridLayout.CAN_STRETCH) != 0;
    }
