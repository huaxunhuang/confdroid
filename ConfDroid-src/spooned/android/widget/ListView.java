 ...
 *
 * @unknown ref android.R.styleable#ListView_entries
 * @unknown ref android.R.styleable#ListView_divider
 * @unknown ref android.R.styleable#ListView_dividerHeight
 * @unknown ref android.R.styleable#ListView_headerDividersEnabled
 * @unknown ref android.R.styleable#ListView_footerDividersEnabled
 */
...
public class ListView extends android.widget.AbsListView {
    ...
    java.util.ArrayList<android.widget.ListView.FixedViewInfo> mHeaderViewInfos = com.google.android.collect.Lists.newArrayList();

    @android.annotation.UnsupportedAppUsage
    java.util.ArrayList<android.widget.ListView.FixedViewInfo> mFooterViewInfos = com.google.android.collect.Lists.newArrayList();
    ...
    private final android.widget.ListView.ArrowScrollFocusResult mArrowScrollFocusResult = new android.widget.ListView.ArrowScrollFocusResult();
    ...
    public ListView(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ListView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, R.styleable.ListView, attrs, a, defStyleAttr, defStyleRes);
        final java.lang.CharSequence[] entries = a.getTextArray(R.styleable.ListView_entries);
        if (entries != null) {
            setAdapter(new android.widget.ArrayAdapter(context, R.layout.simple_list_item_1, entries));
        }
        final android.graphics.drawable.Drawable d = a.getDrawable(R.styleable.ListView_divider);
        if (d != null) {
            // Use an implicit divider height which may be explicitly
            // overridden by android:dividerHeight further down.
            setDivider(d);
        }
        final android.graphics.drawable.Drawable osHeader = a.getDrawable(R.styleable.ListView_overScrollHeader);
        if (osHeader != null) {
            setOverscrollHeader(osHeader);
        }
        final android.graphics.drawable.Drawable osFooter = a.getDrawable(R.styleable.ListView_overScrollFooter);
        if (osFooter != null) {
    ...
    public int getMaxScrollAmount() {
        return ((int) (android.widget.ListView.MAX_SCROLL_FACTOR * (mBottom - mTop)));
    }
     ...
     */
    public void addHeaderView(android.view.View v, java.lang.Object data, boolean isSelectable) {
        if ((v.getParent() != null) && (v.getParent() != this)) {
            if (android.util.Log.isLoggable(android.widget.ListView.TAG, Log.WARN)) {
                android.util.Log.w(android.widget.ListView.TAG, "The specified child already has a parent. " + "You must call removeView() on the child's parent first.");
            }
        }
        final android.widget.ListView.FixedViewInfo info = new android.widget.ListView.FixedViewInfo();
        info.view = v;
        info.data = data;
        ...
        if (mAdapter != null) {
            if (!(mAdapter instanceof android.widget.HeaderViewListAdapter)) {
    ...
    public boolean removeHeaderView(android.view.View v) {
        if (mHeaderViewInfos.size() > 0) {
            ...
            if ((mAdapter != null) && ((android.widget.HeaderViewListAdapter) (mAdapter)).removeHeader(v)) {
                if (mDataSetObserver != null) {
                    mDataSetObserver.onChanged();
                }
                result = true;
    ...
    private void removeFixedViewInfo(android.view.View v, java.util.ArrayList<android.widget.ListView.FixedViewInfo> where) {
        int len = where.size();
        for (int i = 0; i < len; ++i) {
     ...
     */
    public void addFooterView(android.view.View v, java.lang.Object data, boolean isSelectable) {
        if ((v.getParent() != null) && (v.getParent() != this)) {
            if (android.util.Log.isLoggable(android.widget.ListView.TAG, Log.WARN)) {
                android.util.Log.w(android.widget.ListView.TAG, "The specified child already has a parent. " + "You must call removeView() on the child's parent first.");
            }
    ...
    public boolean removeFooterView(android.view.View v) {
        if (mFooterViewInfos.size() > 0) {
            boolean result = false;
            if ((mAdapter != null) && ((android.widget.HeaderViewListAdapter) (mAdapter)).removeFooter(v)) {
                if (mDataSetObserver != null) {
                    mDataSetObserver.onChanged();
                }
                result = true;
    ...
    private void clearRecycledState(java.util.ArrayList<android.widget.ListView.FixedViewInfo> infos) {
        if (infos != null) {
            final int count = infos.size();
            for (int i = 0; i < count; i++) {
                final android.view.View child = infos.get(i).view;
                final android.view.ViewGroup.LayoutParams params = child.getLayoutParams();
                if (checkLayoutParams(params)) {
                    ((android.widget.AbsListView.LayoutParams) (params)).recycledHeaderFooter = false;
                }
            }
        }
    }
    ...
    public boolean requestChildRectangleOnScreen(android.view.View child, android.graphics.Rect rect, boolean immediate) {
        ...
        if ((rect.bottom > listUnfadedBottom) && (rect.top > listUnfadedTop)) {
            ...
            if ((rect.top < listUnfadedTop) && (rect.bottom < listUnfadedBottom)) {
                ...
                scrollYDelta = java.lang.Math.max(scrollYDelta, deltaToTop);
            }
    ...
    private android.view.View fillUp(int pos, int nextBottom) {
        ...
        while ((nextBottom > end) && (pos >= 0)) {
            // is this the selected item?
            boolean selected = pos == mSelectedPosition;
            android.view.View child = makeAndAddView(pos, nextBottom, false, mListPadding.left, selected);
    ...
    private android.view.View fillFromMiddle(int childrenTop, int childrenBottom) {
        ...
        android.view.View sel = makeAndAddView(position, childrenTop, true, mListPadding.left, true);
    ...
    private android.view.View fillFromSelection(int selectedTop, int childrenTop, int childrenBottom) {
        ...
        if (sel.getBottom() > bottomSelectionPixel) {
            ...
            final int offset = java.lang.Math.min(spaceAbove, spaceBelow);
     ...
     * @return The view that currently has selection
     */
    private android.view.View moveSelection(android.view.View oldSel, android.view.View newSel, int delta, int childrenTop, int childrenBottom) {
        int fadingEdgeLength = getVerticalFadingEdgeLength();
        final int selectedPosition = mSelectedPosition;
        android.view.View sel;
        final int topSelectionPixel = getTopSelectionPixel(childrenTop, fadingEdgeLength, selectedPosition);
        ...
        if (delta > 0) {
            ...
            if (sel.getBottom() > bottomSelectionPixel) {
                ...
                offset = java.lang.Math.min(offset, halfVerticalSpace);
    ...
    private class FocusSelector implements java.lang.Runnable {
        ...
        android.widget.ListView.FocusSelector setupForSetSelection(int position, int top) {
            mPosition = position;
            mPositionTop = top;
            mAction = android.widget.ListView.FocusSelector.STATE_SET_SELECTION;
            return this;
        }

        public void run() {
            if (mAction == android.widget.ListView.FocusSelector.STATE_SET_SELECTION) {
                setSelectionFromTop(mPosition, mPositionTop);
                mAction = android.widget.ListView.FocusSelector.STATE_WAIT_FOR_LAYOUT;
            } else
                if (mAction == android.widget.ListView.FocusSelector.STATE_REQUEST_FOCUS) {
        ...
        java.lang.Runnable setupFocusIfValid(int position) {
            if ((mAction != android.widget.ListView.FocusSelector.STATE_WAIT_FOR_LAYOUT) || (position != mPosition)) {
                return null;
            }
            mAction = android.widget.ListView.FocusSelector.STATE_REQUEST_FOCUS;
            return this;
        }

        void onLayoutComplete() {
            if (mAction == android.widget.ListView.FocusSelector.STATE_WAIT_FOR_LAYOUT) {
                mAction = -1;
            }
        }
    }
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        if (getChildCount() > 0) {
            ...
            if (focusedChild != null) {
                ...
                final int offset = java.lang.Math.max(0, childBottom - (h - mPaddingTop));
                final int top = focusedChild.getTop() - offset;
                if (mFocusSelector == null) {
                    mFocusSelector = new android.widget.ListView.FocusSelector();
                }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if ((mItemCount > 0) && ((widthMode == android.view.View.MeasureSpec.UNSPECIFIED) || (heightMode == android.view.View.MeasureSpec.UNSPECIFIED))) {
            ...
            if (recycleOnMeasure() && mRecycler.shouldRecycleViewType(((android.widget.AbsListView.LayoutParams) (child.getLayoutParams())).viewType)) {
        ...
        if (widthMode == android.view.View.MeasureSpec.UNSPECIFIED) {
            ...
            widthSize |= childState & android.view.View.MEASURED_STATE_MASK;
        }
        ...
        if (heightMode == android.view.View.MeasureSpec.AT_MOST) {
            ...
            heightSize = measureHeightOfChildren(widthMeasureSpec, 0, android.widget.ListView.NO_POSITION, heightSize, -1);
        }
        setMeasuredDimension(widthSize, heightSize);
        mWidthMeasureSpec = widthMeasureSpec;
    }

    private void measureScrapChild(android.view.View child, int position, int widthMeasureSpec, int heightHint) {
        ...
        p.forceAdd = true;
        final int childWidthSpec = android.view.ViewGroup.getChildMeasureSpec(widthMeasureSpec, mListPadding.left + mListPadding.right, p.width);
        final int lpHeight = p.height;
        final int childHeightSpec;
        if (lpHeight > 0) {
            childHeightSpec = android.view.View.MeasureSpec.makeMeasureSpec(lpHeight, android.view.View.MeasureSpec.EXACTLY);
        } else {
            childHeightSpec = android.view.View.MeasureSpec.makeSafeMeasureSpec(heightHint, android.view.View.MeasureSpec.UNSPECIFIED);
        }
    ...
    final int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition, int maxHeight, int disallowPartialChildPosition) {
        ...
        endPosition = (endPosition == android.widget.ListView.NO_POSITION) ? adapter.getCount() - 1 : endPosition;
        ...
        for (i = startPosition; i <= endPosition; ++i) {
            ...
            if (recyle && recycleBin.shouldRecycleViewType(((android.widget.AbsListView.LayoutParams) (child.getLayoutParams())).viewType)) {
    ...
    protected void layoutChildren() {
        ...
        try {
            ...
            switch (mLayoutMode) {
                ...
                case android.widget.AbsListView.LAYOUT_SPECIFIC :
                    ...
                    if ((sel == null) && (mFocusSelector != null)) {
                        final java.lang.Runnable focusRunnable = mFocusSelector.setupFocusIfValid(selectedPosition);
            ...
            if (sel != null) {
                ...
                final boolean inTouchMode = (mTouchMode == android.widget.AbsListView.TOUCH_MODE_TAP) || (mTouchMode == android.widget.AbsListView.TOUCH_MODE_DONE_WAITING);
                if (inTouchMode) {
     ...
     *
     * @param infoList
     * 		The info list to be traversed
     */
    private void removeUnusedFixedViews(@android.annotation.Nullable
    java.util.List<android.widget.ListView.FixedViewInfo> infoList) {
        if (infoList == null) {
            return;
        }
        for (int i = infoList.size() - 1; i >= 0; i--) {
            final android.widget.ListView.FixedViewInfo fixedViewInfo = infoList.get(i);
            final android.view.View view = fixedViewInfo.view;
    ...
    private boolean isDirectChildHeaderOrFooter(android.view.View child) {
        final java.util.ArrayList<android.widget.ListView.FixedViewInfo> headers = mHeaderViewInfos;
        ...
        final java.util.ArrayList<android.widget.ListView.FixedViewInfo> footers = mFooterViewInfos;
     ...
     */
    @android.annotation.UnsupportedAppUsage
    private android.view.View makeAndAddView(int position, int y, boolean flow, int childrenLeft, boolean selected) {
        if (!mDataChanged) {
     ...
     */
    private void setupChild(android.view.View child, int position, int y, boolean flowDown, int childrenLeft, boolean selected, boolean isAttachedToWindow) {
        android.os.Trace.traceBegin(Trace.TRACE_TAG_VIEW, "setupListItem");
        ...
        if ((isAttachedToWindow && (!p.forceAdd)) || (p.recycledHeaderFooter && (p.viewType == android.widget.AdapterView.ITEM_VIEW_TYPE_HEADER_OR_FOOTER))) {
        ...
        if (needToMeasure) {
            final int childWidthSpec = android.view.ViewGroup.getChildMeasureSpec(mWidthMeasureSpec, mListPadding.left + mListPadding.right, p.width);
            final int lpHeight = p.height;
            final int childHeightSpec;
            if (lpHeight > 0) {
                childHeightSpec = android.view.View.MeasureSpec.makeMeasureSpec(lpHeight, android.view.View.MeasureSpec.EXACTLY);
            } else {
                childHeightSpec = android.view.View.MeasureSpec.makeSafeMeasureSpec(getMeasuredHeight(), android.view.View.MeasureSpec.UNSPECIFIED);
            }
            child.measure(childWidthSpec, childHeightSpec);
        } else {
    ...
    int lookForSelectablePosition(int position, boolean lookDown) {
        ...
        if (!mAreAllItemsSelectable) {
            if (lookDown) {
                ...
                position = java.lang.Math.min(position, count - 1);
    ...
    int lookForSelectablePositionAfter(int current, int position, boolean lookDown) {
        ...
        if (after != android.widget.AdapterView.INVALID_POSITION) {
            return after;
        }
        // Then check between the starting position and the current position.
        final int count = adapter.getCount();
        current = android.util.MathUtils.constrain(current, -1, count - 1);
        if (lookDown) {
            position = java.lang.Math.min(position - 1, count - 1);
            ...
            position = java.lang.Math.max(0, position + 1);
            while ((position < current) && (!adapter.isEnabled(position))) {
                position++;
            } 
            if (position >= current) {
            ...
            switch (keyCode) {
                case android.view.KeyEvent.KEYCODE_DPAD_UP :
                    if (event.hasNoModifiers()) {
                        ...
                        if (!handled) {
                            while ((count--) > 0) {
                                if (arrowScroll(android.view.View.FOCUS_UP)) {
                                    handled = true;
                                } else {
                                    break;
                                }
                ...
                case android.view.KeyEvent.KEYCODE_DPAD_DOWN :
                    if (event.hasNoModifiers()) {
                        ...
                        if (!handled) {
                            while ((count--) > 0) {
                                if (arrowScroll(android.view.View.FOCUS_DOWN)) {
                                    handled = true;
                                } else {
                                    break;
                                }
    ...
    boolean pageScroll(int direction) {
        ...
        if (direction == android.view.View.FOCUS_UP) {
            nextPage = java.lang.Math.max(0, (mSelectedPosition - getChildCount()) - 1);
            down = false;
        } else
            if (direction == android.view.View.FOCUS_DOWN) {
                nextPage = java.lang.Math.min(mItemCount - 1, (mSelectedPosition + getChildCount()) - 1);
                down = true;
            } else {
                return false;
            }
        ...
        if (nextPage >= 0) {
            ...
            if (position >= 0) {
                ...
                if ((!down) && (position < getChildCount())) {
                    mLayoutMode = android.widget.AbsListView.LAYOUT_FORCE_TOP;
                }
    ...
    private boolean handleHorizontalFocusWithinListItem(int direction) {
        ...
        if ((mItemsCanFocus && (numChildren > 0)) && (mSelectedPosition != android.widget.AdapterView.INVALID_POSITION)) {
            final android.view.View selectedView = getSelectedView();
            if (((selectedView != null) && selectedView.hasFocus()) && (selectedView instanceof android.view.ViewGroup)) {
                final android.view.View currentFocus = selectedView.findFocus();
                final android.view.View nextFocus = android.view.FocusFinder.getInstance().findNextFocus(((android.view.ViewGroup) (selectedView)), currentFocus, direction);
                if (nextFocus != null) {
                    // do the math to get interesting rect in next focus' coordinates
                    android.graphics.Rect focusedRect = mTempRect;
                ...
                final android.view.View globalNextFocus = android.view.FocusFinder.getInstance().findNextFocus(((android.view.ViewGroup) (getRootView())), currentFocus, direction);
     ...
     *
     * @param selectedView
     * 		Current selected view to move from
     * @param selectedPos
     * 		Current selected position to move from
     * @param direction
     * 		Direction to move in
     * @return Desired selected position after moving in the given direction
     */
    private final int nextSelectedPositionForDirection(android.view.View selectedView, int selectedPos, int direction) {
        int nextSelected;
        if (direction == android.view.View.FOCUS_DOWN) {
            final int listBottom = getHeight() - mListPadding.bottom;
            if ((selectedView != null) && (selectedView.getBottom() <= listBottom)) {
                nextSelected = ((selectedPos != android.widget.AdapterView.INVALID_POSITION) && (selectedPos >= mFirstPosition)) ? selectedPos + 1 : mFirstPosition;
            } else {
                return android.widget.AdapterView.INVALID_POSITION;
            }
        } else {
            ...
            if ((selectedView != null) && (selectedView.getTop() >= listTop)) {
                ...
                nextSelected = ((selectedPos != android.widget.AdapterView.INVALID_POSITION) && (selectedPos <= lastPos)) ? selectedPos - 1 : lastPos;
            } else {
                return android.widget.AdapterView.INVALID_POSITION;
            }
        }
        ...
        return lookForSelectablePosition(nextSelected, direction == android.view.View.FOCUS_DOWN);
    }
    ...
    private boolean arrowScrollImpl(int direction) {
        ...
        final android.widget.ListView.ArrowScrollFocusResult focusResult = (mItemsCanFocus) ? arrowScrollFocused(direction) : null;
        if (focusResult != null) {
        ...
        if (amountToScroll > 0) {
            scrollListItemsBy(direction == android.view.View.FOCUS_UP ? amountToScroll : -amountToScroll);
            needToRedraw = true;
        }
        ...
        if (((mItemsCanFocus && (focusResult == null)) && (selectedView != null)) && selectedView.hasFocus()) {
            final android.view.View focused = selectedView.findFocus();
            if (focused != null) {
        ...
        if (((nextSelectedPosition == android.widget.AdapterView.INVALID_POSITION) && (selectedView != null)) && (!isViewAncestorOf(selectedView, this))) {
            selectedView = null;
            hideSelector();
     ...
     */
    private void handleNewSelectionChange(android.view.View selectedView, int direction, int newSelectedPosition, boolean newFocusAssigned) {
    ...
    private void measureItem(android.view.View child) {
        ...
        if (p == null) {
            p = new android.view.ViewGroup.LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT);
        }
        int childWidthSpec = android.view.ViewGroup.getChildMeasureSpec(mWidthMeasureSpec, mListPadding.left + mListPadding.right, p.width);
    ...
    private int getArrowScrollPreviewLength() {
        return java.lang.Math.max(android.widget.ListView.MIN_SCROLL_PREVIEW_PIXELS, getVerticalFadingEdgeLength());
    }
    ...
    private int amountToScroll(int direction, int nextSelectedPosition) {
        ...
        if (direction == android.view.View.FOCUS_DOWN) {
            ...
            final android.view.View viewToMakeVisible = getChildAt(indexToMakeVisible);
            ...
            if ((nextSelectedPosition != android.widget.AdapterView.INVALID_POSITION) && ((goalBottom - viewToMakeVisible.getTop()) >= getMaxScrollAmount())) {
            ...
            if ((mFirstPosition + numChildren) == mItemCount) {
                ...
                amountToScroll = java.lang.Math.min(amountToScroll, max);
            }
            return java.lang.Math.min(amountToScroll, getMaxScrollAmount());
        } else {
            ...
            if ((nextSelectedPosition != android.widget.AdapterView.INVALID_POSITION) && ((viewToMakeVisible.getBottom() - goalTop) >= getMaxScrollAmount())) {
                // item already has enough of it visible, changing selection is good enough
                return 0;
            }
    ...
    private int lookForSelectablePositionOnScreen(int direction) {
        final int firstPosition = mFirstPosition;
        if (direction == android.view.View.FOCUS_DOWN) {
            int startPos = (mSelectedPosition != android.widget.AdapterView.INVALID_POSITION) ? mSelectedPosition + 1 : firstPosition;
            ...
            for (int pos = startPos; pos <= lastVisiblePos; pos++) {
                if (adapter.isEnabled(pos) && (getChildAt(pos - firstPosition).getVisibility() == android.view.View.VISIBLE)) {
                    return pos;
                }
            }
        } else {
            int last = (firstPosition + getChildCount()) - 1;
            int startPos = (mSelectedPosition != android.widget.AdapterView.INVALID_POSITION) ? mSelectedPosition - 1 : (firstPosition + getChildCount()) - 1;
     ...
     */
    private android.widget.ListView.ArrowScrollFocusResult arrowScrollFocused(final int direction) {
        final android.view.View selectedView = getSelectedView();
        ...
        if ((selectedView != null) && selectedView.hasFocus()) {
            ...
            newFocus = android.view.FocusFinder.getInstance().findNextFocusFromRect(this, mTempRect, direction);
        }
        if (newFocus != null) {
            final int positionOfNewFocus = positionOfNewFocus(newFocus);
            // if the focus change is in a different new position, make sure
            // we aren't jumping over another selectable position
            if ((mSelectedPosition != android.widget.AdapterView.INVALID_POSITION) && (positionOfNewFocus != mSelectedPosition)) {
                final int selectablePosition = lookForSelectablePositionOnScreen(direction);
                if ((selectablePosition != android.widget.AdapterView.INVALID_POSITION) && (((direction == android.view.View.FOCUS_DOWN) && (selectablePosition < positionOfNewFocus)) || ((direction == android.view.View.FOCUS_UP) && (selectablePosition > positionOfNewFocus)))) {
                    return null;
                }
            }
     ...
     */
    private boolean isViewAncestorOf(android.view.View child, android.view.View parent) {
        if (child == parent) {
            return true;
        }
        final android.view.ViewParent theParent = child.getParent();
        return (theParent instanceof android.view.ViewGroup) && isViewAncestorOf(((android.view.View) (theParent)), parent);
    }
    ...
    needs to be taken into account when actually scrolling.
     */
    private int amountToScrollToNewFocus(int direction, android.view.View newFocus, int positionOfNewFocus) {
    ...
    private void scrollListItemsBy(int amount) {
        ...
        if (amount < 0) {
            ...
            while (first.getBottom() < listTop) {
                android.widget.AbsListView.LayoutParams layoutParams = ((android.widget.AbsListView.LayoutParams) (first.getLayoutParams()));
            ...
            while (last.getTop() > listBottom) {
                android.widget.AbsListView.LayoutParams layoutParams = ((android.widget.AbsListView.LayoutParams) (last.getLayoutParams()));
                if (recycleBin.shouldRecycleViewType(layoutParams.viewType)) {
    ...
    protected void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        // Draw the dividers
        final int dividerHeight = mDividerHeight;
        final android.graphics.drawable.Drawable overscrollHeader = mOverScrollHeader;
        final android.graphics.drawable.Drawable overscrollFooter = mOverScrollFooter;
        final boolean drawOverscrollHeader = overscrollHeader != null;
        final boolean drawOverscrollFooter = overscrollFooter != null;
        final boolean drawDividers = (dividerHeight > 0) && (mDivider != null);
        if ((drawDividers || drawOverscrollHeader) || drawOverscrollFooter) {
            // Only modify the top and bottom in the loop, we set the left and right here
            final android.graphics.Rect bounds = mTempRect;
            ...
            final android.graphics.Paint paint = mDividerPaint;
    ...
    void drawDivider(android.graphics.Canvas canvas, android.graphics.Rect bounds, int childIndex) {
        ...
        final android.graphics.drawable.Drawable divider = mDivider;
     ...
     * @unknown ref R.styleable#ListView_divider
     */
     ...
     * @unknown ref R.styleable#ListView_divider
     */
    public void setDivider(@android.annotation.Nullable
    android.graphics.drawable.Drawable divider) {
        ...
        mDivider = divider;
        mDividerIsOpaque = (divider == null) || (divider.getOpacity() == android.graphics.PixelFormat.OPAQUE);
        requestLayout();
        invalidate();
    }
     ...
     */
    @android.view.inspector.InspectableProperty(name = "headerDividersEnabled")
     ...
     * @see #setFooterDividersEnabled(boolean)
     */
    @android.view.inspector.InspectableProperty(name = "footerDividersEnabled")
     ...
     * @unknown For internal use only. This should have been hidden.
     */
    @java.lang.Override
    ...
    int id) {
        ...
        // may be scrolled off.
        android.view.View v = super.findViewTraversal(id);
        if (v == null) {
    ...
    android.view.View findViewInHeadersOrFooters(java.util.ArrayList<android.widget.ListView.FixedViewInfo> where, int id) {
    ...
    protected <T extends android.view.View> T findViewWithTagTraversal(java.lang.Object tag) {
        // First look in our children, then in any header and footer views that
        // may be scrolled off.
        android.view.View v = super.findViewWithTagTraversal(tag);
        if (v == null) {
    ...
    android.view.View findViewWithTagInHeadersOrFooters(java.util.ArrayList<android.widget.ListView.FixedViewInfo> where, java.lang.Object tag) {
    ...
    protected <T extends android.view.View> T findViewByPredicateTraversal(java.util.function.Predicate<android.view.View> predicate, android.view.View childToSkip) {
        android.view.View v = super.findViewByPredicateTraversal(predicate, childToSkip);
        if (v == null) {
     ...
     */
    android.view.View findViewByPredicateInHeadersOrFooters(java.util.ArrayList<android.widget.ListView.FixedViewInfo> where, java.util.function.Predicate<android.view.View> predicate, android.view.View childToSkip) {
        if (where != null) {
            int len = where.size();
            android.view.View v;
            for (int i = 0; i < len; i++) {
    ...
    public long[] getCheckItemIds() {
        ...
        if (((mChoiceMode != android.widget.AbsListView.CHOICE_MODE_NONE) && (mCheckStates != null)) && (mAdapter != null)) {
            final android.util.SparseBooleanArray states = mCheckStates;
            ...
            if (checkedCount == count) {
                ...
                java.lang.System.arraycopy(ids, 0, result, 0, checkedCount);
                return result;
            }
        }
        return new long[0];
    ...
    public void onInitializeAccessibilityNodeInfoInternal(android.view.accessibility.AccessibilityNodeInfo info) {
        ...
        final android.view.accessibility.AccessibilityNodeInfo.CollectionInfo collectionInfo = android.view.accessibility.AccessibilityNodeInfo.CollectionInfo.obtain(rowsCount, 1, false, selectionMode);
            ...
            case R.id.accessibilityActionScrollToPosition :
                {
                    ...
                    final int position = java.lang.Math.min(row, getCount() - 1);
                    if (row >= 0) {
    ...
    public void onInitializeAccessibilityNodeInfoForItem(android.view.View view, int position, android.view.accessibility.AccessibilityNodeInfo info) {
        ...
        final android.view.accessibility.AccessibilityNodeInfo.CollectionItemInfo itemInfo = android.view.accessibility.AccessibilityNodeInfo.CollectionItemInfo.obtain(position, 1, 0, 1, isHeading, isSelected);
     ...
     * @unknown 
     */
    protected android.widget.HeaderViewListAdapter wrapHeaderListAdapterInternal(java.util.ArrayList<android.widget.ListView.FixedViewInfo> headerViewInfos, java.util.ArrayList<android.widget.ListView.FixedViewInfo> footerViewInfos, android.widget.ListAdapter adapter) {
        return new android.widget.HeaderViewListAdapter(headerViewInfos, footerViewInfos, adapter);
    }
