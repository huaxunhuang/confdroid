...
public class HeaderViewListAdapter implements android.widget.Filterable , android.widget.WrapperListAdapter {
    ...
    static final java.util.ArrayList<android.widget.ListView.FixedViewInfo> EMPTY_INFO_LIST = new java.util.ArrayList<android.widget.ListView.FixedViewInfo>();

    boolean mAreAllFixedViewsSelectable;

    private final boolean mIsFilterable;

    public HeaderViewListAdapter(java.util.ArrayList<android.widget.ListView.FixedViewInfo> headerViewInfos, java.util.ArrayList<android.widget.ListView.FixedViewInfo> footerViewInfos, android.widget.ListAdapter adapter) {
        mAdapter = adapter;
        mIsFilterable = adapter instanceof android.widget.Filterable;
        if (headerViewInfos == null) {
            mHeaderViewInfos = android.widget.HeaderViewListAdapter.EMPTY_INFO_LIST;
        } else {
            mHeaderViewInfos = headerViewInfos;
        }
        if (footerViewInfos == null) {
            mFooterViewInfos = android.widget.HeaderViewListAdapter.EMPTY_INFO_LIST;
        } else {
    ...
    private boolean areAllListInfosSelectable(java.util.ArrayList<android.widget.ListView.FixedViewInfo> infos) {
        if (infos != null) {
            for (android.widget.ListView.FixedViewInfo info : infos) {
