 ...
 */
public class FocusChangeWithInterestingRectHintTest extends android.test.ActivityInstrumentationTestCase<android.widget.focus.AdjacentVerticalRectLists> {
    ...
    public FocusChangeWithInterestingRectHintTest() {
        super("com.android.frameworks.coretests", android.widget.focus.AdjacentVerticalRectLists.class);
    }
