...
public class AutoCompleteTextViewCallbacks extends android.test.ActivityInstrumentationTestCase2<android.widget.AutoCompleteTextViewSimple> {
    ...
    public void testPopupNoSelection() throws java.lang.Exception {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        ...
        java.lang.Thread.sleep(android.widget.AutoCompleteTextViewCallbacks.WAIT_TIME);
     ...
     */
    @android.test.FlakyTest(tolerance = 3)
    public void testPopupEnterSelection() throws java.lang.Exception {
        final android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        final android.app.Instrumentation instrumentation = getInstrumentation();
        // focus and type
        textView.requestFocus();
        instrumentation.waitForIdleSync();
        sendKeys("A");
        textView.post(new java.lang.Runnable() {
            public void run() {
