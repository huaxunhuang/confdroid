 ...
 */
public class AutoCompleteTextViewPopup extends android.test.ActivityInstrumentationTestCase2<android.widget.AutoCompleteTextViewSimple> {
    ...
    public AutoCompleteTextViewPopup() {
        super("com.android.frameworks.coretests", android.widget.AutoCompleteTextViewSimple.class);
    }
    ...
    public void testPopupSetListSelection() throws java.lang.Throwable {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        final android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        ...
        waitAssertListSelection(textView, android.widget.ListView.INVALID_POSITION);
        // set and check
     ...
     */
    @android.test.FlakyTest(tolerance = 3)
    public void testPopupGetListSelection() throws java.lang.Throwable {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        final android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        final android.app.Instrumentation instrumentation = getInstrumentation();
        // focus and type
     ...
     */
    @android.test.FlakyTest(tolerance = 3)
    public void testPopupClearListSelection() throws java.lang.Throwable {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        final android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        final android.app.Instrumentation instrumentation = getInstrumentation();
        // focus and type
        ...
        instrumentation.waitForIdleSync();
        waitAssertListSelection("setListSelection(ListView.INVALID_POSITION)", textView, android.widget.ListView.INVALID_POSITION);
        // TODO: FlakyTest repeat runs will not currently call setUp, clear state
        clearText(textView);
    }
     ...
     */
    @android.test.FlakyTest(tolerance = 3)
    public void testPopupNavigateNoAdapter() throws java.lang.Throwable {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        final android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        final android.app.Instrumentation instrumentation = getInstrumentation();
        // focus and type
        ...
        runTestOnUiThread(new java.lang.Runnable() {
            public void run() {
                textView.setAdapter(((android.widget.ArrayAdapter<?>) (null)));
            }
        });
        instrumentation.waitForIdleSync();
     ...
     */
    @android.test.FlakyTest(tolerance = 3)
    public void testPopupShow() throws java.lang.Throwable {
        android.widget.AutoCompleteTextViewSimple theActivity = getActivity();
        final android.widget.AutoCompleteTextView textView = theActivity.getTextView();
        final android.app.Instrumentation instrumentation = getInstrumentation();
    ...
    private void waitAssertPopupShowState(java.lang.String message, android.widget.AutoCompleteTextView textView, boolean expected) throws java.lang.InterruptedException {
        for (int i = 0; i < android.widget.AutoCompleteTextViewPopup.LOOP_AMOUNT; i++) {
            if (textView.isPopupShowing() == expected) {
                return;
            }
            java.lang.Thread.sleep(android.widget.AutoCompleteTextViewPopup.SLEEP_TIME);
        }
        assertEquals(message, expected, textView.isPopupShowing());
    }

    private void waitAssertListSelection(android.widget.AutoCompleteTextView textView, int expected) throws java.lang.Exception {
        waitAssertListSelection("getListSelection()", textView, expected);
    }

    private void waitAssertListSelection(java.lang.String message, android.widget.AutoCompleteTextView textView, int expected) throws java.lang.Exception {
        int currentSelection = android.widget.ListView.INVALID_POSITION;
        for (int i = 0; i < android.widget.AutoCompleteTextViewPopup.LOOP_AMOUNT; i++) {
    ...
    private void clearText(final android.widget.AutoCompleteTextView textView) throws java.lang.Throwable {
        runTestOnUiThread(new java.lang.Runnable() {
            public void run() {
                textView.setText("");
            }
