 ...
 * object.
 *
 * @unknown ref android.R.styleable#TabWidget_divider
 * @unknown ref android.R.styleable#TabWidget_tabStripEnabled
 * @unknown ref android.R.styleable#TabWidget_tabStripLeft
 * @unknown ref android.R.styleable#TabWidget_tabStripRight
 */
public class TabWidget extends android.widget.LinearLayout implements android.view.View.OnFocusChangeListener {
    ...
    public TabWidget(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final android.content.res.TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TabWidget, defStyleAttr, defStyleRes);
    ...
    void measureChildBeforeLayout(android.view.View child, int childIndex, int widthMeasureSpec, int totalWidth, int heightMeasureSpec, int totalHeight) {
        if ((!isMeasureWithLargestChildEnabled()) && (mImposedTabsHeight >= 0)) {
            widthMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(totalWidth + mImposedTabWidths[childIndex], android.view.View.MeasureSpec.EXACTLY);
            heightMeasureSpec = android.view.View.MeasureSpec.makeMeasureSpec(mImposedTabsHeight, android.view.View.MeasureSpec.EXACTLY);
        }
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final int unspecifiedWidth = android.view.View.MeasureSpec.makeSafeMeasureSpec(width, android.view.View.MeasureSpec.UNSPECIFIED);
        ...
        if (extraWidth > 0) {
            ...
            if (childCount > 0) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    final int newWidth = java.lang.Math.max(0, childWidth - delta);
                    ...
                    childCount--;
                    mImposedTabsHeight = java.lang.Math.max(mImposedTabsHeight, child.getMeasuredHeight());
                }
            }
        }
     ...
     */
    @java.lang.Override
    public void setDividerDrawable(@android.annotation.Nullable
     ...
     * @unknown ref android.R.styleable#TabWidget_divider
     */
    public void setDividerDrawable(@android.annotation.DrawableRes
    int resId) {
     ...
     * @unknown ref android.R.styleable#TabWidget_tabStripLeft
     */
    public void setLeftStripDrawable(@android.annotation.Nullable
    android.graphics.drawable.Drawable drawable) {
        mLeftStrip = drawable;
        requestLayout();
        invalidate();
     ...
     * @unknown ref android.R.styleable#TabWidget_tabStripLeft
     */
    public void setLeftStripDrawable(@android.annotation.DrawableRes
    int resId) {
     ...
     * @unknown ref android.R.styleable#TabWidget_tabStripRight
     */
    public void setRightStripDrawable(@android.annotation.Nullable
    android.graphics.drawable.Drawable drawable) {
     ...
     * @unknown ref android.R.styleable#TabWidget_tabStripRight
     */
    public void setRightStripDrawable(@android.annotation.DrawableRes
    int resId) {
    ...
    public void dispatchDraw(android.graphics.Canvas canvas) {
        ...
        final android.view.View selectedChild = getChildTabViewAt(mSelectedTab);
        final android.graphics.drawable.Drawable leftStrip = mLeftStrip;
        final android.graphics.drawable.Drawable rightStrip = mRightStrip;
        if (leftStrip != null) {
        ...
        if (mStripMoved) {
            final android.graphics.Rect bounds = mBounds;
            bounds.left = selectedChild.getLeft();
            bounds.right = selectedChild.getRight();
            final int myHeight = getHeight();
            if (leftStrip != null) {
                leftStrip.setBounds(java.lang.Math.min(0, bounds.left - leftStrip.getIntrinsicWidth()), myHeight - leftStrip.getIntrinsicHeight(), bounds.left, myHeight);
            }
            if (rightStrip != null) {
                rightStrip.setBounds(bounds.right, myHeight - rightStrip.getIntrinsicHeight(), java.lang.Math.max(getWidth(), bounds.right + rightStrip.getIntrinsicWidth()), myHeight);
            }
            mStripMoved = false;
        }
        if (leftStrip != null) {
     ...
     *
     * @param index
     * 		the index of the tab that you want to indicate as the
    ...
    public void setEnabled(boolean enabled) {
        ...
        for (int i = 0; i < count; i++) {
            final android.view.View child = getChildTabViewAt(i);
    ...
    public void addView(android.view.View child) {
        if (child.getLayoutParams() == null) {
            final android.widget.LinearLayout.LayoutParams lp = new android.widget.LinearLayout.LayoutParams(0, android.view.ViewGroup.LayoutParams.MATCH_PARENT, 1.0F);
        ...
        if (child.getPointerIcon() == null) {
            child.setPointerIcon(android.view.PointerIcon.getSystemIcon(getContext(), android.view.PointerIcon.TYPE_HAND));
        }
        super.addView(child);
        // TODO: detect this via geometry with a tabwidget listener rather
        // than potentially interfere with the view's listener
        child.setOnClickListener(new android.widget.TabWidget.TabClickListener(getTabCount() - 1));
    }
     ...
     */
    @android.annotation.UnsupportedAppUsage
    void setTabSelectionListener(android.widget.TabWidget.OnTabSelectionChanged listener) {
