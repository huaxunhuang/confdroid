...
public class ButtonAboveTallInternalSelectionViewTest extends android.test.ActivityInstrumentationTestCase<android.widget.scroll.ButtonAboveTallInternalSelectionView> {
    public ButtonAboveTallInternalSelectionViewTest() {
        super("com.android.frameworks.coretests", android.widget.scroll.ButtonAboveTallInternalSelectionView.class);
    }
    ...
    public void testMovingFocusDownToItemTallerThanScreenStillOnScreen() {
        ...
        final android.util.InternalSelectionView isv = getActivity().getIsv();
