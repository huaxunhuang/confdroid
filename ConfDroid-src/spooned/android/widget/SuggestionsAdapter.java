...
class SuggestionsAdapter extends android.widget.ResourceCursorAdapter implements android.view.View.OnClickListener {
    ...
    private int mQueryRefinement = android.widget.SuggestionsAdapter.REFINE_BY_ENTRY;
    ...
    private int mText1Col = android.widget.SuggestionsAdapter.INVALID_INDEX;

    private int mText2Col = android.widget.SuggestionsAdapter.INVALID_INDEX;

    private int mText2UrlCol = android.widget.SuggestionsAdapter.INVALID_INDEX;

    private int mIconName1Col = android.widget.SuggestionsAdapter.INVALID_INDEX;

    private int mIconName2Col = android.widget.SuggestionsAdapter.INVALID_INDEX;

    private int mFlagsCol = android.widget.SuggestionsAdapter.INVALID_INDEX;
    ...
    public SuggestionsAdapter(android.content.Context context, android.widget.SearchView searchView, android.app.SearchableInfo searchable, java.util.WeakHashMap<java.lang.String, android.graphics.drawable.Drawable.ConstantState> outsideDrawablesCache) {
        /* no initial cursor */
        /* auto-requery */
        ...
        final android.content.Context activityContext = mSearchable.getActivityContext(mContext);
        ...
        getFilter().setDelayer(new android.widget.Filter.Delayer() {
            ...
            public long getPostingDelay(java.lang.CharSequence constraint) {
                ...
                long delay = (constraint.length() < mPreviousLength) ? android.widget.SuggestionsAdapter.DELETE_KEY_POST_DELAY : 0;
    ...
    public android.database.Cursor runQueryOnBackgroundThread(java.lang.CharSequence constraint) {
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, ("runQueryOnBackgroundThread(" + constraint) + ")");
        ...
        try {
            cursor = mSearchManager.getSuggestions(mSearchable, query, android.widget.SuggestionsAdapter.QUERY_LIMIT);
            ...
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, "Search suggestions query threw an exception.", e);
        }
    ...
    public void close() {
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, "close()");
    ...
    public void notifyDataSetChanged() {
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, "notifyDataSetChanged");
    ...
    public void notifyDataSetInvalidated() {
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, "notifyDataSetInvalidated");
    ...
    private void updateSpinnerState(android.database.Cursor cursor) {
        ...
        if (android.widget.SuggestionsAdapter.DBG) {
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, "updateSpinnerState - extra = " + (extras != null ? extras.getBoolean(SearchManager.CURSOR_EXTRA_KEY_IN_PROGRESS) : null));
        }
    ...
    public void changeCursor(android.database.Cursor c) {
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, ("changeCursor(" + c) + ")");

        if (mClosed) {
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, "Tried to change cursor after adapter was closed.");
            if (c != null)
                c.close();
        ...
        try {
            ...
            android.util.Log.e(android.widget.SuggestionsAdapter.LOG_TAG, "error changing cursor and caching columns", e);
        }
    }
    ...
    public android.view.View newView(android.content.Context context, android.database.Cursor cursor, android.view.ViewGroup parent) {
        ...
        // Set up icon.
        final android.widget.ImageView iconRefine = v.findViewById(R.id.edit_query);
    ...
    public void bindView(android.view.View view, android.content.Context context, android.database.Cursor cursor) {
        android.widget.SuggestionsAdapter.ChildViewCache views = ((android.widget.SuggestionsAdapter.ChildViewCache) (view.getTag()));
        int flags = 0;
        if (mFlagsCol != android.widget.SuggestionsAdapter.INVALID_INDEX) {
            flags = cursor.getInt(mFlagsCol);
        }
        if (views.mText1 != null) {
            java.lang.String text1 = android.widget.SuggestionsAdapter.getStringOrNull(cursor, mText1Col);
            setViewText(views.mText1, text1);
        }
        if (views.mText2 != null) {
            // First check TEXT_2_URL
            java.lang.CharSequence text2 = android.widget.SuggestionsAdapter.getStringOrNull(cursor, mText2UrlCol);
            if (text2 != null) {
                text2 = formatUrl(context, text2);
            } else {
                text2 = android.widget.SuggestionsAdapter.getStringOrNull(cursor, mText2Col);
            }
        ...
        if ((mQueryRefinement == android.widget.SuggestionsAdapter.REFINE_ALL) || ((mQueryRefinement == android.widget.SuggestionsAdapter.REFINE_BY_ENTRY) && ((flags & android.app.SearchManager.FLAG_QUERY_REFINEMENT) != 0))) {
    ...
    private java.lang.CharSequence formatUrl(android.content.Context context, java.lang.CharSequence url) {
        if (mUrlColor == null) {
        ...
        text.setSpan(new android.text.style.TextAppearanceSpan(null, 0, 0, mUrlColor, null), 0, url.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        return text;
    }
    ...
    private android.graphics.drawable.Drawable getIcon1(android.database.Cursor cursor) {
        if (mIconName1Col == android.widget.SuggestionsAdapter.INVALID_INDEX) {
            return null;
        }
    ...
    private android.graphics.drawable.Drawable getIcon2(android.database.Cursor cursor) {
        if (mIconName2Col == android.widget.SuggestionsAdapter.INVALID_INDEX) {
            return null;
        }
    ...
    public java.lang.CharSequence convertToString(android.database.Cursor cursor) {
        ...
        java.lang.String query = android.widget.SuggestionsAdapter.getColumnString(cursor, SearchManager.SUGGEST_COLUMN_QUERY);
        if (query != null) {
            return query;
        }
        if (mSearchable.shouldRewriteQueryFromData()) {
            java.lang.String data = android.widget.SuggestionsAdapter.getColumnString(cursor, SearchManager.SUGGEST_COLUMN_INTENT_DATA);
            if (data != null) {
                return data;
            }
        }
        if (mSearchable.shouldRewriteQueryFromText()) {
            java.lang.String text1 = android.widget.SuggestionsAdapter.getColumnString(cursor, SearchManager.SUGGEST_COLUMN_TEXT_1);
            if (text1 != null) {
                return text1;
            }
        }
    ...
    public android.view.View getView(int position, android.view.View convertView, android.view.ViewGroup parent) {
        try {
            ...
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, "Search suggestions cursor threw exception.", e);
            // Put exception string in item title
            android.view.View v = newView(mContext, mCursor, parent);
            if (v != null) {
                android.widget.SuggestionsAdapter.ChildViewCache views = ((android.widget.SuggestionsAdapter.ChildViewCache) (v.getTag()));
    ...
    public android.view.View getDropDownView(int position, android.view.View convertView, android.view.ViewGroup parent) {
        try {
            ...
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, "Search suggestions cursor threw exception.", e);
            // Put exception string in item title
            final android.content.Context context = (mDropDownContext == null) ? mContext : mDropDownContext;
            final android.view.View v = newDropDownView(context, mCursor, parent);
            if (v != null) {
                final android.widget.SuggestionsAdapter.ChildViewCache views = ((android.widget.SuggestionsAdapter.ChildViewCache) (v.getTag()));
                final android.widget.TextView tv = views.mText1;
                tv.setText(e.toString());
            }
            return v;
        }
    ...
    private android.graphics.drawable.Drawable getDrawableFromResourceValue(java.lang.String drawableId) {
        ...
        try {
            ...
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, "Icon resource not found: " + drawableId);
            return null;
        }
    }
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri uri) {
        try {
            ...
            if (android.content.ContentResolver.SCHEME_ANDROID_RESOURCE.equals(scheme)) {
                ...
                android.content.ContentResolver.OpenResourceIdResult r = mProviderContext.getContentResolver().getResourceId(uri);
                try {
                ...
                try {
                    ...
                    try {
                        ...
                        android.util.Log.e(android.widget.SuggestionsAdapter.LOG_TAG, "Error closing icon stream for " + uri, ex);
                    }
                }
            }
        } catch (java.io.FileNotFoundException fnfe) {
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, (("Icon not found: " + uri) + ", ") + fnfe.getMessage());
            return null;
        }
    }
    ...
    private android.graphics.drawable.Drawable checkIconCache(java.lang.String resourceUri) {
        ...
        if (android.widget.SuggestionsAdapter.DBG)
            android.util.Log.d(android.widget.SuggestionsAdapter.LOG_TAG, "Found icon in cache: " + resourceUri);
    ...
    private android.graphics.drawable.Drawable getActivityIcon(android.content.ComponentName component) {
        ...
        try {
            ...
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, ex.toString());
            return null;
        }
        ...
        if (drawable == null) {
            android.util.Log.w(android.widget.SuggestionsAdapter.LOG_TAG, (("Invalid icon resource " + iconId) + " for ") + component.flattenToShortString());
            return null;
        }
        return drawable;
    }
    ...
    public static java.lang.String getColumnString(android.database.Cursor cursor, java.lang.String columnName) {
        ...
        return android.widget.SuggestionsAdapter.getStringOrNull(cursor, col);
    }

    private static java.lang.String getStringOrNull(android.database.Cursor cursor, int col) {
        if (col == android.widget.SuggestionsAdapter.INVALID_INDEX) {
            return null;
        }
        try {
            return cursor.getString(col);
        } catch (java.lang.Exception e) {
            android.util.Log.e(android.widget.SuggestionsAdapter.LOG_TAG, "unexpected error retrieving valid column from cursor, " + "did the remote process die?", e);
            return null;
        }
    }
}
