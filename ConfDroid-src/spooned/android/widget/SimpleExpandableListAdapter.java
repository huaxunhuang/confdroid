...
public class SimpleExpandableListAdapter extends android.widget.BaseExpandableListAdapter {
    ...
    private void bindView(android.view.View view, java.util.Map<java.lang.String, ?> data, java.lang.String[] from, int[] to) {
        int len = to.length;
        for (int i = 0; i < len; i++) {
            android.widget.TextView v = ((android.widget.TextView) (view.findViewById(to[i])));
            if (v != null) {
                v.setText(((java.lang.String) (data.get(from[i]))));
            }
        }
    }
