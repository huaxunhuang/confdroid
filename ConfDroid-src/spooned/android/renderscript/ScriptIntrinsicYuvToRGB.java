...
public final class ScriptIntrinsicYuvToRGB extends android.renderscript.ScriptIntrinsic {
    ...
    ScriptIntrinsicYuvToRGB(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public static android.renderscript.ScriptIntrinsicYuvToRGB create(android.renderscript.RenderScript rs, android.renderscript.Element e) {
        // 6 comes from RS_SCRIPT_INTRINSIC_YUV_TO_RGB in rsDefines.h
        long id = rs.nScriptIntrinsicCreate(6, e.getID(rs));
        android.renderscript.ScriptIntrinsicYuvToRGB si = new android.renderscript.ScriptIntrinsicYuvToRGB(id, rs);
        return si;
    }
