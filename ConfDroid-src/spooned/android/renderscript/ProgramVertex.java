 ...
 *
 *
 * @unknown <p>The RenderScript vertex program, also known as a vertex shader, describes a stage in
...
public class ProgramVertex extends android.renderscript.Program {
    ProgramVertex(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public android.renderscript.Element getInput(int slot) {
    ...
    public static class Builder extends android.renderscript.Program.BaseProgramBuilder {
         ...
         * @return self
         */
        public android.renderscript.ProgramVertex.Builder addInput(android.renderscript.Element e) throws java.lang.IllegalStateException {
        ...
        public android.renderscript.ProgramVertex create() {
            ...
            android.renderscript.ProgramVertex pv = new android.renderscript.ProgramVertex(id, mRS);
            initProgram(pv);
            return pv;
        }
    }
