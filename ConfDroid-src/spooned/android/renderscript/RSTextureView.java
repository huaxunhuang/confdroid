...
public class RSTextureView extends android.view.TextureView implements android.view.TextureView.SurfaceTextureListener {
     ...
     * @param sc
     * 		The RS surface config to create.
     * @return RenderScriptGL The new object created.
     */
    public android.renderscript.RenderScriptGL createRenderScriptGL(android.renderscript.RenderScriptGL.SurfaceConfig sc) {
        android.renderscript.RenderScriptGL rs = new android.renderscript.RenderScriptGL(this.getContext(), sc);
     ...
     * 		The new RS object.
     */
    public void setRenderScriptGL(android.renderscript.RenderScriptGL rs) {
        mRS = rs;
        if (mSurfaceTexture != null) {
            mRS.setSurfaceTexture(mSurfaceTexture, getWidth(), getHeight());
        }
