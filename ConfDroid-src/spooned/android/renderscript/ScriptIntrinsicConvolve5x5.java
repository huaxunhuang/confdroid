...
public final class ScriptIntrinsicConvolve5x5 extends android.renderscript.ScriptIntrinsic {
    ...
    private ScriptIntrinsicConvolve5x5(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public static android.renderscript.ScriptIntrinsicConvolve5x5 create(android.renderscript.RenderScript rs, android.renderscript.Element e) {
        ...
        return new android.renderscript.ScriptIntrinsicConvolve5x5(id, rs);
    }
    ...
    public void setCoefficients(float[] v) {
        android.renderscript.FieldPacker fp = new android.renderscript.FieldPacker(25 * 4);
