...
public class Matrix3f {
     ...
     */
    public void loadMultiply(android.renderscript.Matrix3f lhs, android.renderscript.Matrix3f rhs) {
        for (int i = 0; i < 3; i++) {
            float ri0 = 0;
            float ri1 = 0;
            float ri2 = 0;
     ...
     */
    public void multiply(android.renderscript.Matrix3f rhs) {
        android.renderscript.Matrix3f tmp = new android.renderscript.Matrix3f();
