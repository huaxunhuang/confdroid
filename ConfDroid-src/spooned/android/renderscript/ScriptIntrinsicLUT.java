...
public final class ScriptIntrinsicLUT extends android.renderscript.ScriptIntrinsic {
    ...
    private ScriptIntrinsicLUT(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
        mTables = android.renderscript.Allocation.createSized(rs, android.renderscript.Element.U8(rs), 1024);
     ...
     */
    public static android.renderscript.ScriptIntrinsicLUT create(android.renderscript.RenderScript rs, android.renderscript.Element e) {
        long id = rs.nScriptIntrinsicCreate(3, e.getID(rs));
        return new android.renderscript.ScriptIntrinsicLUT(id, rs);
    }
