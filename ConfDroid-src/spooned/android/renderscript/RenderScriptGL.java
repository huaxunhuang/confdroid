...
public class RenderScriptGL extends android.renderscript.RenderScript {
    ...
    public static class SurfaceConfig {
         ...
         * @deprecated in API 16
         */
        public SurfaceConfig(android.renderscript.RenderScriptGL.SurfaceConfig sc) {
     ...
     * 		The context.
     * @param sc
     * 		The desired format of the primary rendering surface.
     */
    public RenderScriptGL(android.content.Context ctx, android.renderscript.RenderScriptGL.SurfaceConfig sc) {
        super(ctx);
        mSurfaceConfig = new android.renderscript.RenderScriptGL.SurfaceConfig(sc);
        ...
        mMessageThread = new android.renderscript.RenderScript.MessageThread(this);
    ...
    public void setSurfaceTexture(android.graphics.SurfaceTexture sur, int w, int h) {
        ...
        android.view.Surface s = null;
        if (sur != null) {
            s = new android.view.Surface(sur);
        }
        mWidth = w;
        mHeight = h;
        nContextSetSurface(w, h, s);
     ...
     */
    public void bindRootScript(android.renderscript.Script s) {
        validate();
     ...
     * 		
     */
    public void bindProgramStore(android.renderscript.ProgramStore p) {
        validate();
     ...
     * 		
     */
    public void bindProgramFragment(android.renderscript.ProgramFragment p) {
        validate();
     ...
     * 		
     */
    public void bindProgramRaster(android.renderscript.ProgramRaster p) {
        validate();
     ...
     * 		
     */
    public void bindProgramVertex(android.renderscript.ProgramVertex p) {
        validate();
