...
public final class ScriptIntrinsicHistogram extends android.renderscript.ScriptIntrinsic {
    ...
    private ScriptIntrinsicHistogram(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public static android.renderscript.ScriptIntrinsicHistogram create(android.renderscript.RenderScript rs, android.renderscript.Element e) {
        if ((((!e.isCompatible(android.renderscript.Element.U8_4(rs))) && (!e.isCompatible(android.renderscript.Element.U8_3(rs)))) && (!e.isCompatible(android.renderscript.Element.U8_2(rs)))) && (!e.isCompatible(android.renderscript.Element.U8(rs)))) {
        ...
        android.renderscript.ScriptIntrinsicHistogram sib = new android.renderscript.ScriptIntrinsicHistogram(id, rs);
        return sib;
    }
     ...
     * 		The input image
     */
    public void forEach(android.renderscript.Allocation ain) {
        forEach(ain, null);
    }
     ...
     */
    public void forEach(android.renderscript.Allocation ain, android.renderscript.Script.LaunchOptions opt) {
        ...
        if ((((!ain.getType().getElement().isCompatible(android.renderscript.Element.U8(mRS))) && (!ain.getType().getElement().isCompatible(android.renderscript.Element.U8_2(mRS)))) && (!ain.getType().getElement().isCompatible(android.renderscript.Element.U8_3(mRS)))) && (!ain.getType().getElement().isCompatible(android.renderscript.Element.U8_4(mRS)))) {
     ...
     */
    public void setOutput(android.renderscript.Allocation aout) {
        mOut = aout;
        if ((((((((mOut.getType().getElement() != android.renderscript.Element.U32(mRS)) && (mOut.getType().getElement() != android.renderscript.Element.U32_2(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.U32_3(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.U32_4(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.I32(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.I32_2(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.I32_3(mRS))) && (mOut.getType().getElement() != android.renderscript.Element.I32_4(mRS))) {
     ...
     * 		The input image
     */
    public void forEach_Dot(android.renderscript.Allocation ain) {
     ...
     * 		LaunchOptions for clipping
     */
    public void forEach_Dot(android.renderscript.Allocation ain, android.renderscript.Script.LaunchOptions opt) {
