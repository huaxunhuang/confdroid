...
public class Matrix4f {
     ...
     * @unknown 
     */
    public void load(android.renderscript.Matrix3f src) {
        mMat[0] = src.mMat[0];
        mMat[1] = src.mMat[1];
        mMat[2] = src.mMat[2];
        mMat[3] = 0;
     ...
     */
    public void loadMultiply(android.renderscript.Matrix4f lhs, android.renderscript.Matrix4f rhs) {
        for (int i = 0; i < 4; i++) {
            float ri0 = 0;
            float ri1 = 0;
            float ri2 = 0;
    ...
    public void loadProjectionNormalized(int w, int h) {
        ...
        android.renderscript.Matrix4f m1 = new android.renderscript.Matrix4f();
        android.renderscript.Matrix4f m2 = new android.renderscript.Matrix4f();
        if (w > h) {
    ...
    public void multiply(android.renderscript.Matrix4f rhs) {
        android.renderscript.Matrix4f tmp = new android.renderscript.Matrix4f();
    ...
    public boolean inverse() {
        android.renderscript.Matrix4f result = new android.renderscript.Matrix4f();
        for (int i = 0; i < 4; ++i) {
            for (int j = 0; j < 4; ++j) {
