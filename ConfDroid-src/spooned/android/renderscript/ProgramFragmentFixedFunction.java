...
public class ProgramFragmentFixedFunction extends android.renderscript.ProgramFragment {
    ProgramFragmentFixedFunction(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
    ...
    static class InternalBuilder extends android.renderscript.Program.BaseProgramBuilder {
        ...
        public android.renderscript.ProgramFragmentFixedFunction create() {
            ...
            android.renderscript.ProgramFragmentFixedFunction pf = new android.renderscript.ProgramFragmentFixedFunction(id, mRS);
            initProgram(pf);
            return pf;
        }
    }
    ...
    public static class Builder {
        ...
        private class Slot {
            ...
            Slot(android.renderscript.ProgramFragmentFixedFunction.Builder.EnvMode _env, android.renderscript.ProgramFragmentFixedFunction.Builder.Format _fmt) {
                env = _env;
                format = _fmt;
            }
        }
         ...
         *
         *
         * @deprecated Creates a builder for fixed function fragment program
         * @param rs
         * 		Context to which the program will belong.
         */
        public Builder(android.renderscript.RenderScript rs) {
            mRS = rs;
            mSlots = new android.renderscript.ProgramFragmentFixedFunction.Builder.Slot[android.renderscript.ProgramFragmentFixedFunction.Builder.MAX_TEXTURE];
         ...
         * 		current color
         * @param slot
         * 		index of the texture to apply the operations on
         * @return this
         */
        public android.renderscript.ProgramFragmentFixedFunction.Builder setTexture(android.renderscript.ProgramFragmentFixedFunction.Builder.EnvMode env, android.renderscript.ProgramFragmentFixedFunction.Builder.Format fmt, int slot) throws java.lang.IllegalArgumentException {
            if ((slot < 0) || (slot >= android.renderscript.ProgramFragmentFixedFunction.Builder.MAX_TEXTURE)) {
                throw new java.lang.IllegalArgumentException("MAX_TEXTURE exceeded.");
            }
            mSlots[slot] = new android.renderscript.ProgramFragmentFixedFunction.Builder.Slot(env, fmt);
            return this;
        }
         ...
         */
        public android.renderscript.ProgramFragmentFixedFunction.Builder setPointSpriteTexCoordinateReplacement(boolean enable) {
        ...
        fragment shader
         */
        public android.renderscript.ProgramFragmentFixedFunction.Builder setVaryingColor(boolean enable) {
         ...
         */
        public android.renderscript.ProgramFragmentFixedFunction create() {
            android.renderscript.ProgramFragmentFixedFunction.InternalBuilder sb = new android.renderscript.ProgramFragmentFixedFunction.InternalBuilder(mRS);
            mNumTextures = 0;
            for (int i = 0; i < android.renderscript.ProgramFragmentFixedFunction.Builder.MAX_TEXTURE; i++) {
                if (mSlots[i] != null) {
                    mNumTextures++;
                }
            }
            ...
            android.renderscript.Type constType = null;
            if (!mVaryingColorEnable) {
                ...
                android.renderscript.Type.Builder typeBuilder = new android.renderscript.Type.Builder(mRS, b.create());
                typeBuilder.setX(1);
                constType = typeBuilder.create();
                sb.addConstant(constType);
            }
            for (int i = 0; i < mNumTextures; i++) {
                sb.addTexture(android.renderscript.Program.TextureType.TEXTURE_2D);
            }
            android.renderscript.ProgramFragmentFixedFunction pf = sb.create();
            pf.mTextureCount = android.renderscript.ProgramFragmentFixedFunction.Builder.MAX_TEXTURE;
            if (!mVaryingColorEnable) {
                android.renderscript.Allocation constantData = android.renderscript.Allocation.createTyped(mRS, constType);
                android.renderscript.FieldPacker fp = new android.renderscript.FieldPacker(16);
                android.renderscript.Float4 f4 = new android.renderscript.Float4(1.0F, 1.0F, 1.0F, 1.0F);
                fp.addF32(f4);
