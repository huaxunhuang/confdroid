...
public class RenderScript {
    static final long TRACE_TAG = android.os.Trace.TRACE_TAG_RS;
    ...
    private static java.util.ArrayList<android.renderscript.RenderScript> mProcessContextList = new java.util.ArrayList<android.renderscript.RenderScript>();
     ...
     */
    public static final int CREATE_FLAG_LOW_LATENCY = 0x2;
    ...
    on some implementations.
     */
    public static final int CREATE_FLAG_LOW_POWER = 0x4;

    /**
     *
     *
     * @unknown Context creation flag which instructs the implementation to wait for
    a debugger to be attached before continuing execution.
     */
    public static final int CREATE_FLAG_WAIT_FOR_ATTACH = 0x8;
    ...
    static {
        android.renderscript.RenderScript.sInitialized = false;
        if (!android.os.SystemProperties.getBoolean("config.disable_renderscript", false)) {
            try {
                ...
                android.renderscript.RenderScript.sRuntime = get_runtime.invoke(null);
                android.renderscript.RenderScript.registerNativeAllocation = vm_runtime.getDeclaredMethod("registerNativeAllocation", java.lang.Integer.TYPE);
                android.renderscript.RenderScript.registerNativeFree = vm_runtime.getDeclaredMethod("registerNativeFree", java.lang.Integer.TYPE);
            } catch (java.lang.Exception e) {
                android.util.Log.e(android.renderscript.RenderScript.LOG_TAG, "Error loading GC methods: " + e);
                throw new android.renderscript.RSRuntimeException("Error loading GC methods: " + e);
            }
            try {
                java.lang.System.loadLibrary("rs_jni");
                android.renderscript.RenderScript._nInit();
                android.renderscript.RenderScript.sInitialized = true;
                android.renderscript.RenderScript.sPointerSize = android.renderscript.RenderScript.rsnSystemGetPointerSize();
            } catch (java.lang.UnsatisfiedLinkError e) {
                android.util.Log.e(android.renderscript.RenderScript.LOG_TAG, "Error loading RS jni library: " + e);
     ...
     *
     *
     * @unknown Only exist to be compatible with old version RenderScript Support lib.
    ...
    public static long getMinorVersion() {
        return android.renderscript.RenderScript.sMinorVersion;
    }
    ...
    native void rsnContextSetCacheDir(long con, java.lang.String cacheDir);

    synchronized void nContextSetCacheDir(java.lang.String cacheDir) {
        validate();
    ...
    native java.nio.ByteBuffer rsnAllocationGetByteBuffer(long con, long alloc, long[] stride, int xBytesSize, int dimY, int dimZ);

    synchronized java.nio.ByteBuffer nAllocationGetByteBuffer(long alloc, long[] stride, int xBytesSize, int dimY, int dimZ) {
        validate();
    ...
    synchronized void nAllocationData1D(long id, int off, int mip, int count, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    synchronized void nAllocationData2D(long id, int xoff, int yoff, int mip, int face, int w, int h, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    synchronized void nAllocationData3D(long id, int xoff, int yoff, int zoff, int mip, int w, int h, int depth, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    synchronized void nAllocationRead(long id, java.lang.Object d, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    synchronized void nAllocationRead1D(long id, int off, int mip, int count, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    synchronized void nAllocationRead2D(long id, int xoff, int yoff, int mip, int face, int w, int h, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
        rsnAllocationRead2D(mContext, id, xoff, yoff, mip, face, w, h, d, sizeBytes, dt.mID, mSize, usePadding);
    }

    native void rsnAllocationRead3D(long con, long id, int xoff, int yoff, int zoff, int mip, int w, int h, int depth, java.lang.Object d, int sizeBytes, int dt, int mSize, boolean usePadding);

    synchronized void nAllocationRead3D(long id, int xoff, int yoff, int zoff, int mip, int w, int h, int depth, java.lang.Object d, int sizeBytes, android.renderscript.Element.DataType dt, int mSize, boolean usePadding) {
        validate();
    ...
    native void rsnAllocationAdapterOffset(long con, long id, int x, int y, int z, int mip, int face, int a1, int a2, int a3, int a4);
    ...
    native void rsnScriptIntrinsicBLAS_Single(long con, long id, int func, int TransA, int TransB, int Side, int Uplo, int Diag, int M, int N, int K, float alpha, long A, long B, float beta, long C, int incX, int incY, int KL, int KU);
    ...
    native void rsnScriptIntrinsicBLAS_Double(long con, long id, int func, int TransA, int TransB, int Side, int Uplo, int Diag, int M, int N, int K, double alpha, long A, long B, double beta, long C, int incX, int incY, int KL, int KU);
    ...
    native void rsnScriptIntrinsicBLAS_Complex(long con, long id, int func, int TransA, int TransB, int Side, int Uplo, int Diag, int M, int N, int K, float alphaX, float alphaY, long A, long B, float betaX, float betaY, long C, int incX, int incY, int KL, int KU);
    ...
    native void rsnScriptIntrinsicBLAS_Z(long con, long id, int func, int TransA, int TransB, int Side, int Uplo, int Diag, int M, int N, int K, double alphaX, double alphaY, long A, long B, double betaX, double betaY, long C, int incX, int incY, int KL, int KU);
    ...
    native void rsnScriptIntrinsicBLAS_BNNM(long con, long id, int M, int N, int K, long A, int a_offset, long B, int b_offset, long C, int c_offset, int c_mult_int);
     ...
     * not guaranteed to have completed when {@link android.renderscript.RenderScript#finish} returns.
     */
    ...
    void validateObject(android.renderscript.BaseObj o) {
        if (o != null) {
            if (o.mRS != this) {
     ...
     */
    public void setPriority(android.renderscript.RenderScript.Priority p) {
        validate();
    ...
    static class MessageThread extends java.lang.Thread {
        ...
        MessageThread(android.renderscript.RenderScript rs) {
        ...
        public void run() {
            ...
            while (mRun) {
                ...
                if (msg == android.renderscript.RenderScript.MessageThread.RS_MESSAGE_TO_CLIENT_USER) {
                    if ((size >> 2) >= rbuf.length) {
                        rbuf = new int[(size + 3) >> 2];
                    }
                    if (mRS.nContextGetUserMessage(mRS.mContext, rbuf) != android.renderscript.RenderScript.MessageThread.RS_MESSAGE_TO_CLIENT_USER) {
                ...
                if (msg == android.renderscript.RenderScript.MessageThread.RS_MESSAGE_TO_CLIENT_ERROR) {
                    ...
                    // error callback.
                    if ((subID >= android.renderscript.RenderScript.MessageThread.RS_ERROR_FATAL_UNKNOWN) || ((subID >= android.renderscript.RenderScript.MessageThread.RS_ERROR_FATAL_DEBUG) && ((mRS.mContextType != android.renderscript.RenderScript.ContextType.DEBUG) || (mRS.mErrorCallback == null)))) {
                        throw new android.renderscript.RSRuntimeException((("Fatal error " + subID) + ", details: ") + e);
                    }
                    if (mRS.mErrorCallback != null) {
                        ...
                        android.util.Log.e(android.renderscript.RenderScript.LOG_TAG, "non fatal RS error, " + e);
                        // Do not throw here. In these cases, we do not have
                        // a fatal error.
                    }
                    continue;
                }
                if (msg == android.renderscript.RenderScript.MessageThread.RS_MESSAGE_TO_CLIENT_NEW_BUFFER) {
                    if (mRS.nContextGetUserMessage(mRS.mContext, rbuf) != android.renderscript.RenderScript.MessageThread.RS_MESSAGE_TO_CLIENT_NEW_BUFFER) {
                        throw new android.renderscript.RSDriverException("Error processing message from RenderScript.");
                    }
                    long bufferID = (((long) (rbuf[1])) << 32L) + (((long) (rbuf[0])) & 0xffffffffL);
                    android.renderscript.Allocation.sendBufferNotification(bufferID);
                    continue;
                }
                // 2: teardown.
    ...
    RenderScript(android.content.Context ctx) {
        mContextType = android.renderscript.RenderScript.ContextType.NORMAL;
        if (ctx != null) {
            mApplicationContext = ctx.getApplicationContext();
        }
        mRWLock = new java.util.concurrent.locks.ReentrantReadWriteLock();
        try {
            android.renderscript.RenderScript.registerNativeAllocation.invoke(android.renderscript.RenderScript.sRuntime, (4 * 1024) * 1024);// 4MB for GC sake
    ...
    static synchronized java.lang.String getCachePath() {
        if (android.renderscript.RenderScript.mCachePath == null) {
            final java.lang.String CACHE_PATH = "com.android.renderscript.cache";
            ...
            java.io.File f = new java.io.File(android.renderscript.RenderScriptCacheDir.mCacheDir, CACHE_PATH);
            android.renderscript.RenderScript.mCachePath = f.getAbsolutePath();
            f.mkdirs();
        }
        return android.renderscript.RenderScript.mCachePath;
    }
     ...
     * @return RenderScript
     */
    private static android.renderscript.RenderScript internalCreate(android.content.Context ctx, int sdkVersion, android.renderscript.RenderScript.ContextType ct, int flags) {
        if (!android.renderscript.RenderScript.sInitialized) {
            android.util.Log.e(android.renderscript.RenderScript.LOG_TAG, "RenderScript.create() called when disabled; someone is likely to crash");
            return null;
        }
        if ((flags & (~((android.renderscript.RenderScript.CREATE_FLAG_LOW_LATENCY | android.renderscript.RenderScript.CREATE_FLAG_LOW_POWER) | android.renderscript.RenderScript.CREATE_FLAG_WAIT_FOR_ATTACH))) != 0) {
            throw new android.renderscript.RSIllegalArgumentException("Invalid flags passed.");
        }
        android.renderscript.RenderScript rs = new android.renderscript.RenderScript(ctx);
        ...
        rs.nContextSetCacheDir(android.renderscript.RenderScript.getCachePath());
        rs.mMessageThread = new android.renderscript.RenderScript.MessageThread(rs);
     ...
     * @return RenderScript
     */
    public static android.renderscript.RenderScript create(android.content.Context ctx) {
        return android.renderscript.RenderScript.create(ctx, android.renderscript.RenderScript.ContextType.NORMAL);
    }
     ...
     * @return RenderScript
     */
    public static android.renderscript.RenderScript create(android.content.Context ctx, android.renderscript.RenderScript.ContextType ct) {
        return android.renderscript.RenderScript.create(ctx, ct, android.renderscript.RenderScript.CREATE_FLAG_NONE);
    }
     ...
     * @return RenderScript
     */
    public static android.renderscript.RenderScript create(android.content.Context ctx, android.renderscript.RenderScript.ContextType ct, int flags) {
        int v = ctx.getApplicationInfo().targetSdkVersion;
        return android.renderscript.RenderScript.create(ctx, v, ct, flags);
    }
    ...
    public static android.renderscript.RenderScript create(android.content.Context ctx, int sdkVersion) {
        return android.renderscript.RenderScript.create(ctx, sdkVersion, android.renderscript.RenderScript.ContextType.NORMAL, android.renderscript.RenderScript.CREATE_FLAG_NONE);
    }
     ...
     * @return RenderScript
     */
    private static android.renderscript.RenderScript create(android.content.Context ctx, int sdkVersion, android.renderscript.RenderScript.ContextType ct, int flags) {
        if (sdkVersion < 23) {
            return android.renderscript.RenderScript.internalCreate(ctx, sdkVersion, ct, flags);
        }
        synchronized(android.renderscript.RenderScript.mProcessContextList) {
            for (android.renderscript.RenderScript prs : android.renderscript.RenderScript.mProcessContextList) {
                if (((prs.mContextType == ct) && (prs.mContextFlags == flags)) && (prs.mContextSdkVersion == sdkVersion)) {
                    return prs;
                }
            }
            android.renderscript.RenderScript prs = android.renderscript.RenderScript.internalCreate(ctx, sdkVersion, ct, flags);
            prs.mIsProcessContext = true;
            android.renderscript.RenderScript.mProcessContextList.add(prs);
            return prs;
        }
    }
    ...
    public static void releaseAllContexts() {
        java.util.ArrayList<android.renderscript.RenderScript> oldList;
        synchronized(android.renderscript.RenderScript.mProcessContextList) {
            oldList = android.renderscript.RenderScript.mProcessContextList;
            android.renderscript.RenderScript.mProcessContextList = new java.util.ArrayList<android.renderscript.RenderScript>();
        }
        for (android.renderscript.RenderScript prs : oldList) {
     ...
     * @return RenderScript
     */
    public static android.renderscript.RenderScript createMultiContext(android.content.Context ctx, android.renderscript.RenderScript.ContextType ct, int flags, int API_number) {
        return android.renderscript.RenderScript.internalCreate(ctx, API_number, ct, flags);
    }
    ...
    private void helpDestroy() {
        ...
        if (shouldDestroy) {
            ...
            if (interrupted) {
                android.util.Log.v(android.renderscript.RenderScript.LOG_TAG, "Interrupted during wait for MessageThread to join");
    ...
    long safeID(android.renderscript.BaseObj o) {
        if (o != null) {
            return o.getID(this);
        }
        return 0;
