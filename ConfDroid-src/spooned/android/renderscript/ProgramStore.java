 ...
 *
 *
 * @unknown <p>ProgramStore contains a set of parameters that control how
...
public class ProgramStore extends android.renderscript.BaseObj {
    ...
    ProgramStore(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
    }
     ...
     */
    public static android.renderscript.ProgramStore BLEND_NONE_DEPTH_TEST(android.renderscript.RenderScript rs) {
        if (rs.mProgramStore_BLEND_NONE_DEPTH_TEST == null) {
            android.renderscript.ProgramStore.Builder builder = new android.renderscript.ProgramStore.Builder(rs);
     ...
     * 		Context to which the program will belong.
     */
    public static android.renderscript.ProgramStore BLEND_NONE_DEPTH_NONE(android.renderscript.RenderScript rs) {
     ...
     * 		Context to which the program will belong.
     */
    public static android.renderscript.ProgramStore BLEND_ALPHA_DEPTH_TEST(android.renderscript.RenderScript rs) {
     ...
     * 		Context to which the program will belong.
     */
    public static android.renderscript.ProgramStore BLEND_ALPHA_DEPTH_NONE(android.renderscript.RenderScript rs) {
    ...
    public static class Builder {
        ...
        public Builder(android.renderscript.RenderScript rs) {
            mRS = rs;
            mDepthFunc = android.renderscript.ProgramStore.DepthFunc.ALWAYS;
            mDepthMask = false;
            mColorMaskR = true;
            mColorMaskG = true;
            mColorMaskB = true;
            mColorMaskA = true;
            mBlendSrc = android.renderscript.ProgramStore.BlendSrcFunc.ONE;
            mBlendDst = android.renderscript.ProgramStore.BlendDstFunc.ZERO;
        }
         ...
         * @return this
         */
        public android.renderscript.ProgramStore.Builder setDepthFunc(android.renderscript.ProgramStore.DepthFunc func) {
            mDepthFunc = func;
            return this;
        }
         ...
         * @return this
         */
        public android.renderscript.ProgramStore.Builder setDepthMaskEnabled(boolean enable) {
            mDepthMask = enable;
            return this;
        }
         ...
         *
         * @param r
         * 		specifies whether red channel is written
         * @param g
         * 		specifies whether green channel is written
         * @param b
         * 		specifies whether blue channel is written
         * @param a
         * 		specifies whether alpha channel is written
         * @return this
         */
        public android.renderscript.ProgramStore.Builder setColorMaskEnabled(boolean r, boolean g, boolean b, boolean a) {
            mColorMaskR = r;
            mColorMaskG = g;
            mColorMaskB = b;
            mColorMaskA = a;
         ...
         * @return this
         */
        public android.renderscript.ProgramStore.Builder setBlendFunc(android.renderscript.ProgramStore.BlendSrcFunc src, android.renderscript.ProgramStore.BlendDstFunc dst) {
            mBlendSrc = src;
            mBlendDst = dst;
            return this;
        }
         ...
         * @return this
         */
        public android.renderscript.ProgramStore.Builder setDitherEnabled(boolean enable) {
            mDither = enable;
            return this;
        }
        ...
        public android.renderscript.ProgramStore create() {
            ...
            android.renderscript.ProgramStore programStore = new android.renderscript.ProgramStore(id, mRS);
