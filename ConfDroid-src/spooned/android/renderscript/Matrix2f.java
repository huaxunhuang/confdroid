...
public class Matrix2f {
     ...
     */
    public void load(android.renderscript.Matrix2f src) {
     ...
     */
    public void loadMultiply(android.renderscript.Matrix2f lhs, android.renderscript.Matrix2f rhs) {
        for (int i = 0; i < 2; i++) {
            float ri0 = 0;
            float ri1 = 0;
            for (int j = 0; j < 2; j++) {
     ...
     */
    public void multiply(android.renderscript.Matrix2f rhs) {
        android.renderscript.Matrix2f tmp = new android.renderscript.Matrix2f();
