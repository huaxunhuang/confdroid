...
/**
 * <p>A Type describes the {@link android.renderscript.Element} and dimensions used for an {@link android.renderscript.Allocation} or a parallel operation. Types are created through {@link android.renderscript.Type.Builder}.</p>
 *
...
public class Type extends android.renderscript.BaseObj {
     ...
     *
     *
     * @unknown Return the dimension of the specified array.
     * @param arrayNum
     * 		The array dimension to query
     * @return int
     */
    public int getArray(int arrayNum) {
        if ((arrayNum < 0) || (arrayNum >= android.renderscript.Type.mMaxArrays)) {
     ...
     *
     *
     * @unknown Return the number of array dimensions.
     * @return int
     */
    ...
    Type(long id, android.renderscript.RenderScript rs) {
        super(id, rs);
        guard.open("destroy");
    }
    ...
    void updateFromNative() {
        ...
        if (elementID != 0) {
            mElement = new android.renderscript.Element(elementID, mRS);
     ...
     * @return Type
     */
    public static android.renderscript.Type createX(android.renderscript.RenderScript rs, android.renderscript.Element e, int dimX) {
        if (dimX < 1) {
        ...
        android.renderscript.Type t = new android.renderscript.Type(id, rs);
        t.mElement = e;
        t.mDimX = dimX;
        t.calcElementCount();
        return t;
     ...
     * @return Type
     */
    public static android.renderscript.Type createXY(android.renderscript.RenderScript rs, android.renderscript.Element e, int dimX, int dimY) {
        if ((dimX < 1) || (dimY < 1)) {
            throw new android.renderscript.RSInvalidStateException("Dimension must be >= 1.");
        }
     ...
     * @return Type
     */
    public static android.renderscript.Type createXYZ(android.renderscript.RenderScript rs, android.renderscript.Element e, int dimX, int dimY, int dimZ) {
    ...
    public static class Builder {
        ...
        int[] mArray = new int[android.renderscript.Type.mMaxArrays];
         ...
         */
        public Builder(android.renderscript.RenderScript rs, android.renderscript.Element e) {
            e.checkValid();
            mRS = rs;
            mElement = e;
        }
         ...
         * 		
         */
        public android.renderscript.Type.Builder setX(int value) {
            if (value < 1) {
        ...
        public android.renderscript.Type.Builder setY(int value) {
            if (value < 1) {
        ...
        public android.renderscript.Type.Builder setZ(int value) {
            if (value < 1) {
         ...
         *
         *
         * @unknown Adds an array dimension to the builder
         * @param dim
         * 		
         * @param value
         * 		
         * @return Builder
         */
        public android.renderscript.Type.Builder setArray(int dim, int value) {
            if ((dim < 0) || (dim >= android.renderscript.Type.mMaxArrays)) {
                throw new android.renderscript.RSIllegalArgumentException("Array dimension out of range.");
            }
            mArray[dim] = value;
            return this;
        ...
        public android.renderscript.Type.Builder setMipmaps(boolean value) {
            mDimMipmaps = value;
            return this;
        }

        public android.renderscript.Type.Builder setFaces(boolean value) {
            mDimFaces = value;
            return this;
        }
         ...
         *
         * @param yuvFormat
         * 		{@link android.graphics.ImageFormat#YV12}, {@link android.graphics.ImageFormat#NV21}, or
         * 		{@link android.graphics.ImageFormat#YUV_420_888}.
         */
        public android.renderscript.Type.Builder setYuvFormat(int yuvFormat) {
            switch (yuvFormat) {
        ...
        public android.renderscript.Type create() {
            ...
            int[] arrays = null;
            for (int ct = android.renderscript.Type.mMaxArrays - 1; ct >= 0; ct--) {
            ...
            android.renderscript.Type t = new android.renderscript.Type(id, mRS);
            t.mElement = mElement;
            t.mDimX = mDimX;
            t.mDimY = mDimY;
            t.mDimZ = mDimZ;
