...
public class AllocationAdapter extends android.renderscript.Allocation {
    ...
    AllocationAdapter(long id, android.renderscript.RenderScript rs, android.renderscript.Allocation alloc, android.renderscript.Type t) {
    ...
    void initLOD(int lod) {
        if (lod < 0) {
            throw new android.renderscript.RSIllegalArgumentException(("Attempting to set negative lod (" + lod) + ").");
        }
        ...
        for (int ct = 0; ct < lod; ct++) {
            if (((tx == 1) && (ty == 1)) && (tz == 1)) {
                throw new android.renderscript.RSIllegalArgumentException(("Attempting to set lod (" + lod) + ") out of range.");
            }
            if (tx > 1)
                tx >>= 1;
    ...
    private void updateOffsets() {
        ...
        mRS.nAllocationAdapterOffset(getID(mRS), mSelectedX, mSelectedY, mSelectedZ, mSelectedLOD, mSelectedFace.mID, a1, a2, a3, a4);
    }
     ...
     *
     * @param cf
     * 		The face to make active.
     */
    public void setFace(android.renderscript.Type.CubemapFace cf) {
    ...
    public static android.renderscript.AllocationAdapter create1D(android.renderscript.RenderScript rs, android.renderscript.Allocation a) {
        rs.validate();
        android.renderscript.Type t = android.renderscript.Type.createX(rs, a.getElement(), a.getType().getX());
        return android.renderscript.AllocationAdapter.createTyped(rs, a, t);
    }

    public static android.renderscript.AllocationAdapter create2D(android.renderscript.RenderScript rs, android.renderscript.Allocation a) {
        rs.validate();
        android.renderscript.Type t = android.renderscript.Type.createXY(rs, a.getElement(), a.getType().getX(), a.getType().getY());
        return android.renderscript.AllocationAdapter.createTyped(rs, a, t);
    }
     ...
     */
    public static android.renderscript.AllocationAdapter createTyped(android.renderscript.RenderScript rs, android.renderscript.Allocation a, android.renderscript.Type t) {
        rs.validate();
        ...
        android.renderscript.Type at = a.getType();
        ...
        return new android.renderscript.AllocationAdapter(id, rs, a, t);
    }
