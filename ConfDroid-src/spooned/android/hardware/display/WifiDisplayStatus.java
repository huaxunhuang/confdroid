...
public final class WifiDisplayStatus implements android.os.Parcelable {
    ...
    public static final android.os.Parcelable.Creator<android.hardware.display.WifiDisplayStatus> CREATOR = new android.os.Parcelable.Creator<android.hardware.display.WifiDisplayStatus>() {
        public android.hardware.display.WifiDisplayStatus createFromParcel(android.os.Parcel in) {
            int featureState = in.readInt();
            int scanState = in.readInt();
            int activeDisplayState = in.readInt();
            android.hardware.display.WifiDisplay activeDisplay = null;
            if (in.readInt() != 0) {
                activeDisplay = android.hardware.display.WifiDisplay.CREATOR.createFromParcel(in);
            }
            android.hardware.display.WifiDisplay[] displays = android.hardware.display.WifiDisplay.CREATOR.newArray(in.readInt());
            for (int i = 0; i < displays.length; i++) {
                displays[i] = android.hardware.display.WifiDisplay.CREATOR.createFromParcel(in);
            }
            android.hardware.display.WifiDisplaySessionInfo sessionInfo = android.hardware.display.WifiDisplaySessionInfo.CREATOR.createFromParcel(in);
            return new android.hardware.display.WifiDisplayStatus(featureState, scanState, activeDisplayState, activeDisplay, displays, sessionInfo);
        }

        public android.hardware.display.WifiDisplayStatus[] newArray(int size) {
            return new android.hardware.display.WifiDisplayStatus[size];
        }
    };

    public WifiDisplayStatus() {
        this(android.hardware.display.WifiDisplayStatus.FEATURE_STATE_UNAVAILABLE, android.hardware.display.WifiDisplayStatus.SCAN_STATE_NOT_SCANNING, android.hardware.display.WifiDisplayStatus.DISPLAY_STATE_NOT_CONNECTED, null, android.hardware.display.WifiDisplay.EMPTY_ARRAY, null);
    }

    public WifiDisplayStatus(int featureState, int scanState, int activeDisplayState, android.hardware.display.WifiDisplay activeDisplay, android.hardware.display.WifiDisplay[] displays, android.hardware.display.WifiDisplaySessionInfo sessionInfo) {
        if (displays == null) {
        ...
        mDisplays = displays;
        mSessionInfo = (sessionInfo != null) ? sessionInfo : new android.hardware.display.WifiDisplaySessionInfo();
    }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        for (android.hardware.display.WifiDisplay display : mDisplays) {
    ...
    public java.lang.String toString() {
        return ((((((((((("WifiDisplayStatus{featureState=" + mFeatureState) + ", scanState=") + mScanState) + ", activeDisplayState=") + mActiveDisplayState) + ", activeDisplay=") + mActiveDisplay) + ", displays=") + java.util.Arrays.toString(mDisplays)) + ", sessionInfo=") + mSessionInfo) + "}";
    }
}
