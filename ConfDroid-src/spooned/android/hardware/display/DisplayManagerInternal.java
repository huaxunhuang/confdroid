...
public abstract class DisplayManagerInternal {
     ...
     */
    public abstract void initPowerManagement(android.hardware.display.DisplayManagerInternal.DisplayPowerCallbacks callbacks, android.os.Handler handler, android.hardware.SensorManager sensorManager);
     ...
     * @param waitForNegativeProximity
     ...
     */
    public abstract boolean requestPowerState(android.hardware.display.DisplayManagerInternal.DisplayPowerRequest request, boolean waitForNegativeProximity);
     ...
     */
    public abstract android.view.DisplayInfo getDisplayInfo(int displayId);
     ...
     */
    public abstract void registerDisplayTransactionListener(android.hardware.display.DisplayManagerInternal.DisplayTransactionListener listener);
     ...
     */
    public abstract void unregisterDisplayTransactionListener(android.hardware.display.DisplayManagerInternal.DisplayTransactionListener listener);
     ...
     */
    public abstract void setDisplayInfoOverrideFromWindowManager(int displayId, android.view.DisplayInfo info);
     ...
     *
     * @param displayId
     * 		The logical display id to update.
     * @param hasContent
     ...
     * 		The logical display id to update.
     * @param x
     * 		The X offset by which to shift the contents of the display.
     * @param y
    ...
    public static final class DisplayPowerRequest {
        ...
        public DisplayPowerRequest() {
            policy = android.hardware.display.DisplayManagerInternal.DisplayPowerRequest.POLICY_BRIGHT;
            useProximitySensor = false;
            screenBrightness = android.os.PowerManager.BRIGHTNESS_ON;
            screenAutoBrightnessAdjustment = 0.0F;
            useAutoBrightness = false;
            blockScreenOn = false;
            dozeScreenBrightness = android.os.PowerManager.BRIGHTNESS_DEFAULT;
            dozeScreenState = android.view.Display.STATE_UNKNOWN;
        }

        public DisplayPowerRequest(android.hardware.display.DisplayManagerInternal.DisplayPowerRequest other) {
            copyFrom(other);
        }

        public boolean isBrightOrDim() {
            return (policy == android.hardware.display.DisplayManagerInternal.DisplayPowerRequest.POLICY_BRIGHT) || (policy == android.hardware.display.DisplayManagerInternal.DisplayPowerRequest.POLICY_DIM);
        }

        public void copyFrom(android.hardware.display.DisplayManagerInternal.DisplayPowerRequest other) {
            policy = other.policy;
        ...
        public boolean equals(java.lang.Object o) {
            return (o instanceof android.hardware.display.DisplayManagerInternal.DisplayPowerRequest) && equals(((android.hardware.display.DisplayManagerInternal.DisplayPowerRequest) (o)));
        }

        public boolean equals(android.hardware.display.DisplayManagerInternal.DisplayPowerRequest other) {
        ...
        public java.lang.String toString() {
            return (((((((((((((((((((((("policy=" + android.hardware.display.DisplayManagerInternal.DisplayPowerRequest.policyToString(policy)) + ", useProximitySensor=") + useProximitySensor) + ", screenBrightness=") + screenBrightness) + ", screenAutoBrightnessAdjustment=") + screenAutoBrightnessAdjustment) + ", brightnessSetByUser=") + brightnessSetByUser) + ", useAutoBrightness=") + useAutoBrightness) + ", blockScreenOn=") + blockScreenOn) + ", lowPowerMode=") + lowPowerMode) + ", boostScreenBrightness=") + boostScreenBrightness) + ", dozeScreenBrightness=") + dozeScreenBrightness) + ", dozeScreenState=") + android.view.Display.stateToString(dozeScreenState)) + ", useTwilight=") + useTwilight;
        }

        public static java.lang.String policyToString(int policy) {
            switch (policy) {
                ...
                case android.hardware.display.DisplayManagerInternal.DisplayPowerRequest.POLICY_BRIGHT :
                    return "BRIGHT";
                default :
                    return java.lang.Integer.toString(policy);
            }
        }
    }
