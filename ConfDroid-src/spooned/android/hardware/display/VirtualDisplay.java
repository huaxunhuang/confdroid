...
public final class VirtualDisplay {
    ...
    VirtualDisplay(android.hardware.display.DisplayManagerGlobal global, android.view.Display display, android.hardware.display.IVirtualDisplayCallback token, android.view.Surface surface) {
        mGlobal = global;
        mDisplay = display;
        mToken = token;
        mSurface = surface;
     ...
     *
     * @param surface
     * 		The surface to set, or null to detach the surface from the virtual display.
     */
