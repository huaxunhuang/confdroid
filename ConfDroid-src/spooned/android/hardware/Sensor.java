...
public final class Sensor {
     ...
     *
     * @see #isWakeUpSensor()
     * @unknown This sensor is expected to only be used by the system ui
     */
     ...
     *
     * @unknown Expected to be used internally for always on display.
     */
     ...
     *
     * @unknown This sensor is expected to be used internally for always on display.
     ...
     * See {@link android.hardware.SensorEvent#values SensorEvent.values} for more details.
     *
     * @unknown Expected to be used internally for auto-rotate and speaker rotation.
     */
     ...
     * the system. This sensor type should always use special trigger report mode ({@code SensorManager.REPORTING_MODE_SPECIAL_TRIGGER}).
     *
     * @unknown This sensor is expected to be used only by system services.
     */
    @android.annotation.SystemApi
     ...
     * @unknown This sensor is expected to only be used by the system service
     */
    @android.annotation.SystemApi
    ...
    private static final int[] sSensorReportingModes = new int[]{ 0// padding because sensor types start at 1
    ...
    public int getReportingMode() {
        return (mFlags & android.hardware.Sensor.REPORTING_MODE_MASK) >> android.hardware.Sensor.REPORTING_MODE_SHIFT;
    }

    static int getMaxLengthValuesArray(android.hardware.Sensor sensor, int sdkLevel) {
        // RotationVector length has changed to 3 to 5 for API level 18
        // Set it to 3 for backward compatibility.
        if ((sensor.mType == android.hardware.Sensor.TYPE_ROTATION_VECTOR) && (sdkLevel <= android.os.Build.VERSION_CODES.JELLY_BEAN_MR1)) {
            return 3;
        }
        int offset = sensor.mType;
        if (offset >= android.hardware.Sensor.sSensorReportingModes.length) {
        ...
        return android.hardware.Sensor.sSensorReportingModes[offset];
    }
     ...
     * maximum reporting latency is elapsed or the hardware FIFO gets full. See {@link SensorManager#registerListener(SensorEventListener, Sensor, int, int)} for more details.
     * </p>
     *
     * @return <code>true</code> if this is a wake-up sensor, <code>false</code> otherwise.
     */
    public boolean isWakeUpSensor() {
        return (mFlags & android.hardware.Sensor.SENSOR_FLAG_WAKE_UP_SENSOR) != 0;
    }
    ...
    public boolean isDynamicSensor() {
        return (mFlags & android.hardware.Sensor.DYNAMIC_SENSOR_MASK) != 0;
    }
    ...
    public boolean isAdditionalInfoSupported() {
        return (mFlags & android.hardware.Sensor.ADDITIONAL_INFO_MASK) != 0;
    }
    ...
    public boolean isDataInjectionSupported() {
        return ((mFlags & android.hardware.Sensor.DATA_INJECTION_MASK) >> android.hardware.Sensor.DATA_INJECTION_SHIFT) != 0;
    }
