...
public class SensorAdditionalInfo {
     ...
     * @unknown 
     */
    @android.annotation.IntDef({ android.hardware.SensorAdditionalInfo.TYPE_FRAME_BEGIN, android.hardware.SensorAdditionalInfo.TYPE_FRAME_END, android.hardware.SensorAdditionalInfo.TYPE_UNTRACKED_DELAY, android.hardware.SensorAdditionalInfo.TYPE_INTERNAL_TEMPERATURE, android.hardware.SensorAdditionalInfo.TYPE_VEC3_CALIBRATION, android.hardware.SensorAdditionalInfo.TYPE_SENSOR_PLACEMENT, android.hardware.SensorAdditionalInfo.TYPE_SAMPLING })
    ...
    SensorAdditionalInfo(android.hardware.Sensor aSensor, int aType, int aSerial, int[] aIntValues, float[] aFloatValues) {
        sensor = aSensor;
        type = aType;
        serial = aSerial;
