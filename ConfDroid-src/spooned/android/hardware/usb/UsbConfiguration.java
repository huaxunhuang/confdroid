...
public class UsbConfiguration implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public UsbConfiguration(int id, java.lang.String name, int attributes, int maxPower) {
        mId = id;
        mName = name;
    ...
    public boolean isSelfPowered() {
        return (mAttributes & android.hardware.usb.UsbConfiguration.ATTR_SELF_POWERED) != 0;
    }
    ...
    public boolean isRemoteWakeup() {
        return (mAttributes & android.hardware.usb.UsbConfiguration.ATTR_REMOTE_WAKEUP) != 0;
    }
    ...
    public android.hardware.usb.UsbInterface getInterface(int index) {
        return ((android.hardware.usb.UsbInterface) (mInterfaces[index]));
    }
     ...
     * @unknown 
     */
    public void setInterfaces(android.os.Parcelable[] interfaces) {
        mInterfaces = interfaces;
    }

    @java.lang.Override
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(((((((("UsbConfiguration[mId=" + mId) + ",mName=") + mName) + ",mAttributes=") + mAttributes) + ",mMaxPower=") + mMaxPower) + ",mInterfaces=[");
    ...
    public static final android.os.Parcelable.Creator<android.hardware.usb.UsbConfiguration> CREATOR = new android.os.Parcelable.Creator<android.hardware.usb.UsbConfiguration>() {
        public android.hardware.usb.UsbConfiguration createFromParcel(android.os.Parcel in) {
            int id = in.readInt();
            java.lang.String name = in.readString();
            int attributes = in.readInt();
            int maxPower = in.readInt();
            android.os.Parcelable[] interfaces = in.readParcelableArray(android.hardware.usb.UsbInterface.class.getClassLoader());
            android.hardware.usb.UsbConfiguration configuration = new android.hardware.usb.UsbConfiguration(id, name, attributes, maxPower);
            configuration.setInterfaces(interfaces);
            return configuration;
        }

        public android.hardware.usb.UsbConfiguration[] newArray(int size) {
            return new android.hardware.usb.UsbConfiguration[size];
        }
    };
