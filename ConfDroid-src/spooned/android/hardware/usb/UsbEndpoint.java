...
public class UsbEndpoint implements android.os.Parcelable {
    ...
    public int getEndpointNumber() {
        return mAddress & android.hardware.usb.UsbConstants.USB_ENDPOINT_NUMBER_MASK;
    }
    ...
    public int getDirection() {
        return mAddress & android.hardware.usb.UsbConstants.USB_ENDPOINT_DIR_MASK;
    }
     ...
     */
    public int getType() {
        return mAttributes & android.hardware.usb.UsbConstants.USB_ENDPOINT_XFERTYPE_MASK;
    }
    ...
    public java.lang.String toString() {
        return ((((((("UsbEndpoint[mAddress=" + mAddress) + ",mAttributes=") + mAttributes) + ",mMaxPacketSize=") + mMaxPacketSize) + ",mInterval=") + mInterval) + "]";
    }

    public static final android.os.Parcelable.Creator<android.hardware.usb.UsbEndpoint> CREATOR = new android.os.Parcelable.Creator<android.hardware.usb.UsbEndpoint>() {
        public android.hardware.usb.UsbEndpoint createFromParcel(android.os.Parcel in) {
            int address = in.readInt();
            int attributes = in.readInt();
            int maxPacketSize = in.readInt();
            int interval = in.readInt();
            return new android.hardware.usb.UsbEndpoint(address, attributes, maxPacketSize, interval);
        }

        public android.hardware.usb.UsbEndpoint[] newArray(int size) {
            return new android.hardware.usb.UsbEndpoint[size];
        }
    };
