...
public class UsbDeviceConnection {
    ...
    /* package */
    boolean open(java.lang.String name, android.os.ParcelFileDescriptor pfd, @android.annotation.NonNull
     ...
     */
    public boolean claimInterface(android.hardware.usb.UsbInterface intf, boolean force) {
     ...
     */
    public boolean setInterface(android.hardware.usb.UsbInterface intf) {
     ...
     */
    public boolean setConfiguration(android.hardware.usb.UsbConfiguration configuration) {
    ...
    public int controlTransfer(int requestType, int request, int value, int index, byte[] buffer, int offset, int length, int timeout) {
        android.hardware.usb.UsbDeviceConnection.checkBounds(buffer, offset, length);
    ...
    or negative value for failure
     */
    public int bulkTransfer(android.hardware.usb.UsbEndpoint endpoint, byte[] buffer, int length, int timeout) {
    ...
    or negative value for failure
     */
    public int bulkTransfer(android.hardware.usb.UsbEndpoint endpoint, byte[] buffer, int offset, int length, int timeout) {
        android.hardware.usb.UsbDeviceConnection.checkBounds(buffer, offset, length);
    ...
    public android.hardware.usb.UsbRequest requestWait() {
        android.hardware.usb.UsbRequest request = native_request_wait();
        if (request != null) {
            request.dequeue();
        }
        return request;
