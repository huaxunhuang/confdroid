...
public final class UsbConstants {
     ...
     */
    public static final int USB_ENDPOINT_NUMBER_MASK = 0xf;
     ...
     */
    public static final int USB_ENDPOINT_XFERTYPE_MASK = 0x3;
     ...
     */
    public static final int USB_CLASS_CDC_DATA = 0xa;

    /**
     * USB class for content smart card devices.
     */
    public static final int USB_CLASS_CSCID = 0xb;

    /**
     * USB class for content security devices.
     */
    public static final int USB_CLASS_CONTENT_SEC = 0xd;

    /**
     * USB class for video devices.
     */
    public static final int USB_CLASS_VIDEO = 0xe;
