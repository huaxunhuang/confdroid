...
public class UsbInterface implements android.os.Parcelable {
     ...
     * @unknown 
     */
    public UsbInterface(int id, int alternateSetting, java.lang.String name, int Class, int subClass, int protocol) {
        mId = id;
    ...
    public android.hardware.usb.UsbEndpoint getEndpoint(int index) {
        return ((android.hardware.usb.UsbEndpoint) (mEndpoints[index]));
    }
     ...
     * @unknown 
     */
    public void setEndpoints(android.os.Parcelable[] endpoints) {
        mEndpoints = endpoints;
    }

    @java.lang.Override
    public java.lang.String toString() {
        java.lang.StringBuilder builder = new java.lang.StringBuilder(((((((((((("UsbInterface[mId=" + mId) + ",mAlternateSetting=") + mAlternateSetting) + ",mName=") + mName) + ",mClass=") + mClass) + ",mSubclass=") + mSubclass) + ",mProtocol=") + mProtocol) + ",mEndpoints=[");
    ...
    public static final android.os.Parcelable.Creator<android.hardware.usb.UsbInterface> CREATOR = new android.os.Parcelable.Creator<android.hardware.usb.UsbInterface>() {
        public android.hardware.usb.UsbInterface createFromParcel(android.os.Parcel in) {
            int id = in.readInt();
            ...
            android.os.Parcelable[] endpoints = in.readParcelableArray(android.hardware.usb.UsbEndpoint.class.getClassLoader());
            android.hardware.usb.UsbInterface intf = new android.hardware.usb.UsbInterface(id, alternateSetting, name, Class, subClass, protocol);
            intf.setEndpoints(endpoints);
            return intf;
        }

        public android.hardware.usb.UsbInterface[] newArray(int size) {
            return new android.hardware.usb.UsbInterface[size];
        }
    };
