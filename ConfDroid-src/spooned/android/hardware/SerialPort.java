...
public class SerialPort {
     ...
     * @unknown 
     */
    public void open(android.os.ParcelFileDescriptor pfd, int speed) throws java.io.IOException {
    ...
    private native void native_open(java.io.FileDescriptor pfd, int speed) throws java.io.IOException;

    private native void native_close();

    private native int native_read_array(byte[] buffer, int length) throws java.io.IOException;

    private native int native_read_direct(java.nio.ByteBuffer buffer, int length) throws java.io.IOException;

    private native void native_write_array(byte[] buffer, int length) throws java.io.IOException;

    private native void native_write_direct(java.nio.ByteBuffer buffer, int length) throws java.io.IOException;
