...
public abstract class RadioTuner {
     ...
     *
     * @param config
     * 		The desired band configuration (FmBandConfig or AmBandConfig).
     * @return <ul>
     ...
     *
     * @param direction
     * 		{@link #DIRECTION_UP} or {@link #DIRECTION_DOWN}.
     * @param skipSubChannel
     ...
     *
     * @param info
     * 		a ProgramInfo array of lengh 1 where the information is returned.
     * @return <ul>
    <li>{@link RadioManager#STATUS_OK} in case of success, </li>
    <li>{@link RadioManager#STATUS_ERROR} in case of unspecified error, </li>
    <li>{@link RadioManager#STATUS_NO_INIT} if the native service cannot be reached, </li>
    ...
    public static abstract class Callback {
         ...
         */
        public void onConfigurationChanged(android.hardware.radio.RadioManager.BandConfig config) {
        }
         ...
         * be called.
         */
        public void onProgramInfoChanged(android.hardware.radio.RadioManager.ProgramInfo info) {
        }
         ...
         */
        public void onMetadataChanged(android.hardware.radio.RadioMetadata metadata) {
        }
