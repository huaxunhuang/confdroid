...
public class RequestHolder {
    ...
    private final java.util.Collection<java.lang.Long> mJpegSurfaceIds;
    ...
    public static final class Builder {
         ...
         *
         * @param requestId
         * 		the ID to set in {@link RequestHolder} objects.
         * @param subsequenceId
         * 		the sequence ID to set in {@link RequestHolder} objects.
         * @param request
         * 		the original {@link CaptureRequest} to set in {@link RequestHolder}
         * 		objects.
         * @param repeating
         * 		{@code true} if the request is repeating.
         */
        public Builder(int requestId, int subsequenceId, android.hardware.camera2.CaptureRequest request, boolean repeating, java.util.Collection<java.lang.Long> jpegSurfaceIds) {
         ...
         *
         * @param s
         * 		a {@link android.view.Surface} to check.
         * @return true if the surface requires a jpeg buffer.
         */
        private boolean jpegType(android.view.Surface s) throws android.hardware.camera2.legacy.LegacyExceptionUtils.BufferQueueAbandonedException {
            return android.hardware.camera2.legacy.LegacyCameraDevice.containsSurfaceId(s, mJpegSurfaceIds);
        }
         ...
         */
        private boolean previewType(android.view.Surface s) throws android.hardware.camera2.legacy.LegacyExceptionUtils.BufferQueueAbandonedException {
            return !jpegType(s);
        }
         ...
         */
        private int numJpegTargets(android.hardware.camera2.CaptureRequest request) {
            int count = 0;
            for (android.view.Surface s : request.getTargets()) {
                try {
                    if (jpegType(s)) {
                        ++count;
                    }
                } catch (android.hardware.camera2.legacy.LegacyExceptionUtils.BufferQueueAbandonedException e) {
                    android.util.Log.d(android.hardware.camera2.legacy.RequestHolder.TAG, "Surface abandoned, skipping...", e);
                }
            }
            return count;
        }
         ...
         */
        private int numPreviewTargets(android.hardware.camera2.CaptureRequest request) {
            int count = 0;
            for (android.view.Surface s : request.getTargets()) {
                try {
                    if (previewType(s)) {
         ...
         *
         * @param frameNumber
         * 		the {@code framenumber} to generate in the {@link RequestHolder}.
         * @return a {@link RequestHolder} constructed with the {@link Builder}'s parameters.
         */
        public android.hardware.camera2.legacy.RequestHolder build(long frameNumber) {
            return new android.hardware.camera2.legacy.RequestHolder(mRequestId, mSubsequenceId, mRequest, mRepeating, frameNumber, mNumJpegTargets, mNumPreviewTargets, mJpegSurfaceIds);
        }
    }

    private RequestHolder(int requestId, int subsequenceId, android.hardware.camera2.CaptureRequest request, boolean repeating, long frameNumber, int numJpegTargets, int numPreviewTargets, java.util.Collection<java.lang.Long> jpegSurfaceIds) {
        mRepeating = repeating;
        mRequest = request;
        mRequestId = requestId;
     ...
     * @return true if the surface requires a jpeg buffer.
     */
    public boolean jpegType(android.view.Surface s) throws android.hardware.camera2.legacy.LegacyExceptionUtils.BufferQueueAbandonedException {
        return android.hardware.camera2.legacy.LegacyCameraDevice.containsSurfaceId(s, mJpegSurfaceIds);
    }
    ...
    public void failRequest() {
        android.util.Log.w(android.hardware.camera2.legacy.RequestHolder.TAG, "Capture failed for request: " + getRequestId());
        mFailed = true;
    }
