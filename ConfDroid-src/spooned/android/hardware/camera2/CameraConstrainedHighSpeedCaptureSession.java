...
public abstract class CameraConstrainedHighSpeedCaptureSession extends android.hardware.camera2.CameraCaptureSession {
     ...
     *
     * @param request
     * 		The high speed capture request that will be used to generate the high speed
     * 		request list.
     * @return A unmodifiable CaptureRequest list that is suitable for constrained high speed
    capture.
     * @throws IllegalArgumentException
     * 		if the set of output Surfaces in the request do not meet the
    ...
    public abstract java.util.List<android.hardware.camera2.CaptureRequest> createHighSpeedRequestList(@android.annotation.NonNull
    android.hardware.camera2.CaptureRequest request) throws android.hardware.camera2.CameraAccessException;
}
