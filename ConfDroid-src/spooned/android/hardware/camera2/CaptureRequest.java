...
public final class CaptureRequest extends android.hardware.camera2.CameraMetadata<android.hardware.camera2.CaptureRequest.Key<?>> implements android.os.Parcelable {
    ...
    public static final class Key<T> {
        ...
        public final boolean equals(java.lang.Object o) {
            return (o instanceof android.hardware.camera2.CaptureRequest.Key) && ((android.hardware.camera2.CaptureRequest.Key<T>) (o)).mKey.equals(mKey);
        }
        ...
        public java.lang.String toString() {
            return java.lang.String.format("CaptureRequest.Key(%s)", mKey.getName());
        }
    ...
    private final java.util.HashSet<android.view.Surface> mSurfaceSet;
    ...
    private CaptureRequest() {
        mSettings = new android.hardware.camera2.impl.CameraMetadataNative();
        mSurfaceSet = new java.util.HashSet<android.view.Surface>();
        mIsReprocess = false;
        mReprocessableSessionId = android.hardware.camera2.CameraCaptureSession.SESSION_ID_NONE;
    }
     ...
     */
    @java.lang.SuppressWarnings("unchecked")
    private CaptureRequest(android.hardware.camera2.CaptureRequest source) {
        mSettings = new android.hardware.camera2.impl.CameraMetadataNative(source.mSettings);
        mSurfaceSet = ((java.util.HashSet<android.view.Surface>) (source.mSurfaceSet.clone()));
     ...
     * @param isReprocess
     * 		Indicates whether to create a reprocess capture request. {@code true}
     * 		to create a reprocess capture request. {@code false} to create a regular
     * 		capture request.
     * @param reprocessableSessionId
     * 		The ID of the camera capture session this capture is created
     ...
     * @see CameraDevice#createReprocessCaptureRequest
     */
    private CaptureRequest(android.hardware.camera2.impl.CameraMetadataNative settings, boolean isReprocess, int reprocessableSessionId) {
        mSettings = android.hardware.camera2.impl.CameraMetadataNative.move(settings);
        mSurfaceSet = new java.util.HashSet<android.view.Surface>();
        mIsReprocess = isReprocess;
        if (isReprocess) {
            if (reprocessableSessionId == android.hardware.camera2.CameraCaptureSession.SESSION_ID_NONE) {
                throw new java.lang.IllegalArgumentException(("Create a reprocess capture request with an " + "invalid session ID: ") + reprocessableSessionId);
            }
    ...
    @java.lang.SuppressWarnings("unchecked")
    @java.lang.Override
    protected <T> T getProtected(android.hardware.camera2.CaptureRequest.Key<?> key) {
    ...
    protected java.lang.Class<android.hardware.camera2.CaptureRequest.Key<?>> getKeyClass() {
        java.lang.Object thisClass = android.hardware.camera2.CaptureRequest.Key.class;
        return ((java.lang.Class<android.hardware.camera2.CaptureRequest.Key<?>>) (thisClass));
    }
    ...
    public android.hardware.camera2.impl.CameraMetadataNative getNativeCopy() {
        return new android.hardware.camera2.impl.CameraMetadataNative(mSettings);
    }
     ...
     * 		if this capture request is not a reprocess capture request.
     * @unknown 
     */
    public int getReprocessableSessionId() {
        if ((mIsReprocess == false) || (mReprocessableSessionId == android.hardware.camera2.CameraCaptureSession.SESSION_ID_NONE)) {
     ...
     *
     * @param other
     * 		Another instance of CaptureRequest.
     * @return True if the requests are the same, false otherwise.
     */
    @java.lang.Override
    public boolean equals(java.lang.Object other) {
        return (other instanceof android.hardware.camera2.CaptureRequest) && equals(((android.hardware.camera2.CaptureRequest) (other)));
    }

    private boolean equals(android.hardware.camera2.CaptureRequest other) {
        return (((((other != null) && java.util.Objects.equals(mUserTag, other.mUserTag)) && mSurfaceSet.equals(other.mSurfaceSet)) && mSettings.equals(other.mSettings)) && (mIsReprocess == other.mIsReprocess)) && (mReprocessableSessionId == other.mReprocessableSessionId);
    }

    @java.lang.Override
    public int hashCode() {
        return android.hardware.camera2.utils.HashCodeHelpers.hashCodeGeneric(mSettings, mSurfaceSet, mUserTag);
    }

    public static final android.os.Parcelable.Creator<android.hardware.camera2.CaptureRequest> CREATOR = new android.os.Parcelable.Creator<android.hardware.camera2.CaptureRequest>() {
        @java.lang.Override
        public android.hardware.camera2.CaptureRequest createFromParcel(android.os.Parcel in) {
            android.hardware.camera2.CaptureRequest request = new android.hardware.camera2.CaptureRequest();
            request.readFromParcel(in);
            return request;
        }

        @java.lang.Override
        public android.hardware.camera2.CaptureRequest[] newArray(int size) {
            return new android.hardware.camera2.CaptureRequest[size];
        }
    };
     ...
     *
     * @param in
     * 		The parcel from which the object should be read
     * @unknown 
     */
    private void readFromParcel(android.os.Parcel in) {
        mSettings.readFromParcel(in);
        mSurfaceSet.clear();
        android.os.Parcelable[] parcelableArray = in.readParcelableArray(android.view.Surface.class.getClassLoader());
        if (parcelableArray == null) {
            return;
        }
        for (android.os.Parcelable p : parcelableArray) {
            android.view.Surface s = ((android.view.Surface) (p));
            mSurfaceSet.add(s);
        }
    ...
    public void writeToParcel(android.os.Parcel dest, int flags) {
        ...
        dest.writeParcelableArray(mSurfaceSet.toArray(new android.view.Surface[mSurfaceSet.size()]), flags);
    ...
    public java.util.Collection<android.view.Surface> getTargets() {
        return java.util.Collections.unmodifiableCollection(mSurfaceSet);
    }
    ...
    public static final class Builder {
         ...
         *
         * @param template
         * 		Template settings for this capture request.
         * @param reprocess
         * 		Indicates whether to create a reprocess capture request. {@code true}
         * 		to create a reprocess capture request. {@code false} to create a regular
         * 		capture request.
         ...
         * @unknown 
         */
        public Builder(android.hardware.camera2.impl.CameraMetadataNative template, boolean reprocess, int reprocessableSessionId) {
            mRequest = new android.hardware.camera2.CaptureRequest(template, reprocess, reprocessableSessionId);
        }
         ...
         */
        public void addTarget(@android.annotation.NonNull
         ...
         * 		Surface to use as an output target for this request
         */
        public void removeTarget(@android.annotation.NonNull
        android.view.Surface outputTarget) {
         ...
         * 		type to the key.
         */
        public <T> void set(@android.annotation.NonNull
        android.hardware.camera2.CaptureRequest.Key<T> key, T value) {
         ...
         */
        public void setTag(@android.annotation.Nullable
        ...
        public android.hardware.camera2.CaptureRequest build() {
            return new android.hardware.camera2.CaptureRequest(mRequest);
        }
    ...
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> COLOR_CORRECTION_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.colorCorrection.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.ColorSpaceTransform> COLOR_CORRECTION_TRANSFORM = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.colorCorrection.transform", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.RggbChannelVector> COLOR_CORRECTION_GAINS = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.RggbChannelVector>("android.colorCorrection.gains", android.hardware.camera2.params.RggbChannelVector.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> COLOR_CORRECTION_ABERRATION_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.colorCorrection.aberrationMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AE_ANTIBANDING_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.aeAntibandingMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AE_EXPOSURE_COMPENSATION = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.aeExposureCompensation", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean> CONTROL_AE_LOCK = new android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean>("android.control.aeLock", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AE_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.aeMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]> CONTROL_AE_REGIONS = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]>("android.control.aeRegions", android.hardware.camera2.params.MeteringRectangle[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.util.Range<java.lang.Integer>> CONTROL_AE_TARGET_FPS_RANGE = new android.hardware.camera2.CaptureRequest.Key<android.util.Range<java.lang.Integer>>("android.control.aeTargetFpsRange", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Integer>>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AE_PRECAPTURE_TRIGGER = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.aePrecaptureTrigger", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AF_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.afMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]> CONTROL_AF_REGIONS = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]>("android.control.afRegions", android.hardware.camera2.params.MeteringRectangle[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AF_TRIGGER = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.afTrigger", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean> CONTROL_AWB_LOCK = new android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean>("android.control.awbLock", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_AWB_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.awbMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]> CONTROL_AWB_REGIONS = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.MeteringRectangle[]>("android.control.awbRegions", android.hardware.camera2.params.MeteringRectangle[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_CAPTURE_INTENT = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.captureIntent", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_EFFECT_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.effectMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_SCENE_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.sceneMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_VIDEO_STABILIZATION_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.videoStabilizationMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> CONTROL_POST_RAW_SENSITIVITY_BOOST = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.control.postRawSensitivityBoost", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> EDGE_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.edge.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> FLASH_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.flash.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> HOT_PIXEL_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.hotPixel.mode", int.class);
    ...
    public static final android.hardware.camera2.CaptureRequest.Key<android.location.Location> JPEG_GPS_LOCATION = new android.hardware.camera2.CaptureRequest.Key<android.location.Location>("android.jpeg.gpsLocation", android.location.Location.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<double[]> JPEG_GPS_COORDINATES = new android.hardware.camera2.CaptureRequest.Key<double[]>("android.jpeg.gpsCoordinates", double[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.String> JPEG_GPS_PROCESSING_METHOD = new android.hardware.camera2.CaptureRequest.Key<java.lang.String>("android.jpeg.gpsProcessingMethod", java.lang.String.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Long> JPEG_GPS_TIMESTAMP = new android.hardware.camera2.CaptureRequest.Key<java.lang.Long>("android.jpeg.gpsTimestamp", long.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> JPEG_ORIENTATION = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.jpeg.orientation", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Byte> JPEG_QUALITY = new android.hardware.camera2.CaptureRequest.Key<java.lang.Byte>("android.jpeg.quality", byte.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Byte> JPEG_THUMBNAIL_QUALITY = new android.hardware.camera2.CaptureRequest.Key<java.lang.Byte>("android.jpeg.thumbnailQuality", byte.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.util.Size> JPEG_THUMBNAIL_SIZE = new android.hardware.camera2.CaptureRequest.Key<android.util.Size>("android.jpeg.thumbnailSize", android.util.Size.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> LENS_APERTURE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.lens.aperture", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> LENS_FILTER_DENSITY = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.lens.filterDensity", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> LENS_FOCAL_LENGTH = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.lens.focalLength", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> LENS_FOCUS_DISTANCE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.lens.focusDistance", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> LENS_OPTICAL_STABILIZATION_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.lens.opticalStabilizationMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> NOISE_REDUCTION_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.noiseReduction.mode", int.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> REQUEST_ID = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.request.id", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.graphics.Rect> SCALER_CROP_REGION = new android.hardware.camera2.CaptureRequest.Key<android.graphics.Rect>("android.scaler.cropRegion", android.graphics.Rect.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Long> SENSOR_EXPOSURE_TIME = new android.hardware.camera2.CaptureRequest.Key<java.lang.Long>("android.sensor.exposureTime", long.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Long> SENSOR_FRAME_DURATION = new android.hardware.camera2.CaptureRequest.Key<java.lang.Long>("android.sensor.frameDuration", long.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> SENSOR_SENSITIVITY = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.sensor.sensitivity", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<int[]> SENSOR_TEST_PATTERN_DATA = new android.hardware.camera2.CaptureRequest.Key<int[]>("android.sensor.testPatternData", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> SENSOR_TEST_PATTERN_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.sensor.testPatternMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> SHADING_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.shading.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> STATISTICS_FACE_DETECT_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.statistics.faceDetectMode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean> STATISTICS_HOT_PIXEL_MAP_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean>("android.statistics.hotPixelMapMode", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> STATISTICS_LENS_SHADING_MAP_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.statistics.lensShadingMapMode", int.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<float[]> TONEMAP_CURVE_BLUE = new android.hardware.camera2.CaptureRequest.Key<float[]>("android.tonemap.curveBlue", float[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<float[]> TONEMAP_CURVE_GREEN = new android.hardware.camera2.CaptureRequest.Key<float[]>("android.tonemap.curveGreen", float[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<float[]> TONEMAP_CURVE_RED = new android.hardware.camera2.CaptureRequest.Key<float[]>("android.tonemap.curveRed", float[].class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.TonemapCurve> TONEMAP_CURVE = new android.hardware.camera2.CaptureRequest.Key<android.hardware.camera2.params.TonemapCurve>("android.tonemap.curve", android.hardware.camera2.params.TonemapCurve.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> TONEMAP_MODE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.tonemap.mode", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> TONEMAP_GAMMA = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.tonemap.gamma", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Integer> TONEMAP_PRESET_CURVE = new android.hardware.camera2.CaptureRequest.Key<java.lang.Integer>("android.tonemap.presetCurve", int.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean> LED_TRANSMIT = new android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean>("android.led.transmit", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean> BLACK_LEVEL_LOCK = new android.hardware.camera2.CaptureRequest.Key<java.lang.Boolean>("android.blackLevel.lock", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CaptureRequest.Key<java.lang.Float> REPROCESS_EFFECTIVE_EXPOSURE_FACTOR = new android.hardware.camera2.CaptureRequest.Key<java.lang.Float>("android.reprocess.effectiveExposureFactor", float.class);
}
