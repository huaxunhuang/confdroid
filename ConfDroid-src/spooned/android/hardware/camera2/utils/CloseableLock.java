...
public class CloseableLock implements java.lang.AutoCloseable {
    ...
    private final java.lang.String TAG = "CloseableLock";
     ...
     */
    private final java.util.concurrent.locks.Condition mCondition = mLock.newCondition();

    /**
     * How many times the current thread is holding the lock
     */
    private final java.lang.ThreadLocal<java.lang.Integer> mLockCount = new java.lang.ThreadLocal<java.lang.Integer>() {
        @java.lang.Override
     ...
     *
     * @param name
     * 		set an optional name for logging functionality
     */
    public CloseableLock(java.lang.String name) {
        mName = name;
    }
    ...
    public void close() {
        if (mClosed) {
            if (android.hardware.camera2.utils.CloseableLock.VERBOSE) {
                log("close - already closed; ignoring");
            }
            return;
        }
        android.hardware.camera2.utils.CloseableLock.ScopedLock scoper = acquireExclusiveLock();
    ...
    was already closed.
     * @throws IllegalStateException
     * 		if this thread is already holding an exclusive lock
     */
    ...
    public void releaseLock() {
        ...
        try {
            ...
            if (!mExclusive) {
                ...
                if (mSharedLocks != 0) {
                    throw new java.lang.AssertionError("Too many shared locks " + mSharedLocks);
                }
            }
            ownedLocks = mLockCount.get() - 1;
            mLockCount.set(ownedLocks);
            if ((ownedLocks == 0) && mExclusive) {
                ...
                if ((ownedLocks == 0) && (mSharedLocks == 0)) {
    ...
    private void log(java.lang.String what) {
        android.util.Log.v(((TAG + "[") + mName) + "]", what);
    }
}
