...
public class TaskDrainer<T> {
     ...
     */
    private final java.util.Set<T> mTaskSet = new java.util.HashSet<T>();
     ...
     */
    private final java.util.Set<T> mEarlyFinishedTaskSet = new java.util.HashSet<T>();
     ...
     */
    public TaskDrainer(android.os.Handler handler, android.hardware.camera2.utils.TaskDrainer.DrainListener listener) {
        mHandler = android.hardware.camera2.utils.TaskDrainer.checkNotNull(handler, "handler must not be null");
        mListener = android.hardware.camera2.utils.TaskDrainer.checkNotNull(listener, "listener must not be null");
        mName = null;
    }
     ...
     */
    public TaskDrainer(android.os.Handler handler, android.hardware.camera2.utils.TaskDrainer.DrainListener listener, java.lang.String name) {
    ...
    public void taskStarted(T task) {
        synchronized(mLock) {
            if (DEBUG) {
                android.util.Log.v(((android.hardware.camera2.utils.TaskDrainer.TAG + "[") + mName) + "]", "taskStarted " + task);
            }
            if (mDraining) {
            ...
            if (!mEarlyFinishedTaskSet.remove(task)) {
                ...
                if (!mTaskSet.add(task)) {
                    throw new java.lang.IllegalStateException(("Task " + task) + " was already started");
                }
            }
        }
    }
    ...
    public void taskFinished(T task) {
        synchronized(mLock) {
            if (DEBUG) {
                android.util.Log.v(((android.hardware.camera2.utils.TaskDrainer.TAG + "[") + mName) + "]", "taskFinished " + task);
            }
            ...
            if (!mTaskSet.remove(task)) {
                ...
                if (!mEarlyFinishedTaskSet.add(task)) {
                    throw new java.lang.IllegalStateException(("Task " + task) + " was already finished");
                }
            }
    ...
    public void beginDrain() {
        synchronized(mLock) {
            if (!mDraining) {
                if (DEBUG) {
                    android.util.Log.v(((android.hardware.camera2.utils.TaskDrainer.TAG + "[") + mName) + "]", "beginDrain started");
                }
                mDraining = true;
                ...
                if (DEBUG) {
                    android.util.Log.v(((android.hardware.camera2.utils.TaskDrainer.TAG + "[") + mName) + "]", "beginDrain ignored");
                }
            }
        }
    }
    ...
    private void postDrained() {
        mHandler.post(new java.lang.Runnable() {
            ...
            public void run() {
                if (DEBUG) {
                    android.util.Log.v(((android.hardware.camera2.utils.TaskDrainer.TAG + "[") + mName) + "]", "onDrained");
                }
                mListener.onDrained();
            }
        });
