...
public class ArrayUtils {
    ...
    public static <T> int getArrayIndex(T[] array, T needle) {
        ...
        int index = 0;
        for (T elem : array) {
            if (java.util.Objects.equals(elem, needle)) {
                return index;
            }
            index++;
        }
     ...
     */
    public static int[] convertStringListToIntArray(java.util.List<java.lang.String> list, java.lang.String[] convertFrom, int[] convertTo) {
        if (list == null) {
            return null;
        }
        java.util.List<java.lang.Integer> convertedList = android.hardware.camera2.utils.ArrayUtils.convertStringListToIntList(list, convertFrom, convertTo);
    ...
    or {@code null} if {@code list} was {@code null}
     */
    public static java.util.List<java.lang.Integer> convertStringListToIntList(java.util.List<java.lang.String> list, java.lang.String[] convertFrom, int[] convertTo) {
        if (list == null) {
            return null;
        }
        java.util.List<java.lang.Integer> convertedList = new java.util.ArrayList<>(list.size());
        for (java.lang.String str : list) {
            int strIndex = android.hardware.camera2.utils.ArrayUtils.getArrayIndex(convertFrom, str);
            // Guard against unexpected values
            if (strIndex < 0) {
                if (android.hardware.camera2.utils.ArrayUtils.DEBUG)
                    android.util.Log.v(android.hardware.camera2.utils.ArrayUtils.TAG, "Ignoring invalid value " + str);
     ...
     *
     * @param list
     * 		a list of non-{@code null} integers
     * @return a new int array containing all the elements from {@code list}
     * @throws NullPointerException
     * 		if any of the elements in {@code list} were {@code null}
     */
     ...
     *
     * @param array
     * 		{@code array} to check for {@code elem}
     * @param elem
     * 		{@code elem} to test for
     * @return {@code true} if the given element is contained
     */
    public static boolean contains(int[] array, int elem) {
        return android.hardware.camera2.utils.ArrayUtils.getArrayIndex(array, elem) != (-1);
    }
