...
public class SubmitInfo implements android.os.Parcelable {
    ...
    public SubmitInfo() {
        mRequestId = -1;
        mLastFrameNumber = android.hardware.camera2.ICameraDeviceUser.NO_IN_FLIGHT_REPEATING_FRAMES;
    }
    ...
    public static final android.os.Parcelable.Creator<android.hardware.camera2.utils.SubmitInfo> CREATOR = new android.os.Parcelable.Creator<android.hardware.camera2.utils.SubmitInfo>() {
        @java.lang.Override
        public android.hardware.camera2.utils.SubmitInfo createFromParcel(android.os.Parcel in) {
            return new android.hardware.camera2.utils.SubmitInfo(in);
        }

        @java.lang.Override
        public android.hardware.camera2.utils.SubmitInfo[] newArray(int size) {
            return new android.hardware.camera2.utils.SubmitInfo[size];
        }
    };

    private SubmitInfo(android.os.Parcel in) {
        readFromParcel(in);
    }
