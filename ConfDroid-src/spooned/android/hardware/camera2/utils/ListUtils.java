...
public class ListUtils {
     ...
     */
    public static <T> boolean listContains(java.util.List<T> list, T needle) {
        if (list == null) {
            return false;
        } else {
     ...
     * {@code single}.
     */
    public static <T> boolean listElementsEqualTo(java.util.List<T> list, T single) {
        if (list == null) {
            return false;
        }
     ...
     * @param choices
     * 		an array of objects which should be used to select an item from
     * @return the first item from {@code choices} contained in {@code list}, otherwise {@code null}
     */
    public static <T> T listSelectFirstFrom(java.util.List<T> list, T[] choices) {
        if (list == null) {
            return null;
        }
