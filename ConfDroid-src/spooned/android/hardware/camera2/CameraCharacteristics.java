...
public final class CameraCharacteristics extends android.hardware.camera2.CameraMetadata<android.hardware.camera2.CameraCharacteristics.Key<?>> {
    ...
    public static final class Key<T> {
        ...
        public Key(java.lang.String name, java.lang.Class<T> type) {
            mKey = new android.hardware.camera2.impl.CameraMetadataNative.Key<T>(name, type);
        }
        ...
        public Key(java.lang.String name, android.hardware.camera2.utils.TypeReference<T> typeReference) {
            mKey = new android.hardware.camera2.impl.CameraMetadataNative.Key<T>(name, typeReference);
        }
        ...
        public final boolean equals(java.lang.Object o) {
            return (o instanceof android.hardware.camera2.CameraCharacteristics.Key) && ((android.hardware.camera2.CameraCharacteristics.Key<T>) (o)).mKey.equals(mKey);
        }
        ...
        public java.lang.String toString() {
            return java.lang.String.format("CameraCharacteristics.Key(%s)", mKey.getName());
        }
        ...
        private Key(android.hardware.camera2.impl.CameraMetadataNative.Key<?> nativeKey) {
            mKey = ((android.hardware.camera2.impl.CameraMetadataNative.Key<T>) (nativeKey));
        }
    }
    ...
    public CameraCharacteristics(android.hardware.camera2.impl.CameraMetadataNative properties) {
        mProperties = android.hardware.camera2.impl.CameraMetadataNative.move(properties);
    }
    ...
    public android.hardware.camera2.impl.CameraMetadataNative getNativeCopy() {
        return new android.hardware.camera2.impl.CameraMetadataNative(mProperties);
    }
    ...
    @java.lang.SuppressWarnings("unchecked")
    @java.lang.Override
    protected <T> T getProtected(android.hardware.camera2.CameraCharacteristics.Key<?> key) {
    ...
    protected java.lang.Class<android.hardware.camera2.CameraCharacteristics.Key<?>> getKeyClass() {
        java.lang.Object thisClass = android.hardware.camera2.CameraCharacteristics.Key.class;
        return ((java.lang.Class<android.hardware.camera2.CameraCharacteristics.Key<?>>) (thisClass));
    }
    ...
    public java.util.List<android.hardware.camera2.CameraCharacteristics.Key<?>> getKeys() {
        ...
        int[] filterTags = get(android.hardware.camera2.CameraCharacteristics.REQUEST_AVAILABLE_CHARACTERISTICS_KEYS);
        if (filterTags == null) {
            throw new java.lang.AssertionError("android.request.availableCharacteristicsKeys must be non-null" + " in the characteristics");
        }
        mKeys = java.util.Collections.unmodifiableList(android.hardware.camera2.CameraMetadata.getKeysStatic(getClass(), getKeyClass(), this, filterTags));
        return mKeys;
    }
    ...
    public java.util.List<android.hardware.camera2.CaptureRequest.Key<?>> getAvailableCaptureRequestKeys() {
        if (mAvailableRequestKeys == null) {
            java.lang.Object crKey = android.hardware.camera2.CaptureRequest.Key.class;
            java.lang.Class<android.hardware.camera2.CaptureRequest.Key<?>> crKeyTyped = ((java.lang.Class<android.hardware.camera2.CaptureRequest.Key<?>>) (crKey));
            int[] filterTags = get(android.hardware.camera2.CameraCharacteristics.REQUEST_AVAILABLE_REQUEST_KEYS);
            if (filterTags == null) {
                throw new java.lang.AssertionError("android.request.availableRequestKeys must be non-null " + "in the characteristics");
            }
            mAvailableRequestKeys = getAvailableKeyList(android.hardware.camera2.CaptureRequest.class, crKeyTyped, filterTags);
        }
    ...
    public java.util.List<android.hardware.camera2.CaptureResult.Key<?>> getAvailableCaptureResultKeys() {
        if (mAvailableResultKeys == null) {
            java.lang.Object crKey = android.hardware.camera2.CaptureResult.Key.class;
            java.lang.Class<android.hardware.camera2.CaptureResult.Key<?>> crKeyTyped = ((java.lang.Class<android.hardware.camera2.CaptureResult.Key<?>>) (crKey));
            int[] filterTags = get(android.hardware.camera2.CameraCharacteristics.REQUEST_AVAILABLE_RESULT_KEYS);
            if (filterTags == null) {
                throw new java.lang.AssertionError("android.request.availableResultKeys must be non-null " + "in the characteristics");
            }
            mAvailableResultKeys = getAvailableKeyList(android.hardware.camera2.CaptureResult.class, crKeyTyped, filterTags);
        }
     ...
     *
     * @param metadataClass
     * 		The subclass of CameraMetadata that you want to get the keys for.
     * @param keyClass
     ...
     * @throws IllegalArgumentException
     * 		if metadataClass is not a subclass of CameraMetadata
     */
    private <TKey> java.util.List<TKey> getAvailableKeyList(java.lang.Class<?> metadataClass, java.lang.Class<TKey> keyClass, int[] filterTags) {
        if (metadataClass.equals(android.hardware.camera2.CameraMetadata.class)) {
            throw new java.lang.AssertionError("metadataClass must be a strict subclass of CameraMetadata");
        } else
            if (!android.hardware.camera2.CameraMetadata.class.isAssignableFrom(metadataClass)) {
                throw new java.lang.AssertionError("metadataClass must be a subclass of CameraMetadata");
            }

        java.util.List<TKey> staticKeyList = /* instance */
        android.hardware.camera2.CameraCharacteristics.<TKey>getKeysStatic(metadataClass, keyClass, null, filterTags);
        return java.util.Collections.unmodifiableList(staticKeyList);
    }
    ...
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> COLOR_CORRECTION_AVAILABLE_ABERRATION_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.colorCorrection.availableAberrationModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AE_AVAILABLE_ANTIBANDING_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.aeAvailableAntibandingModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AE_AVAILABLE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.aeAvailableModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>[]> CONTROL_AE_AVAILABLE_TARGET_FPS_RANGES = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>[]>("android.control.aeAvailableTargetFpsRanges", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Integer>[]>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>> CONTROL_AE_COMPENSATION_RANGE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>>("android.control.aeCompensationRange", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Integer>>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Rational> CONTROL_AE_COMPENSATION_STEP = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Rational>("android.control.aeCompensationStep", android.util.Rational.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AF_AVAILABLE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.afAvailableModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AVAILABLE_EFFECTS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.availableEffects", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AVAILABLE_SCENE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.availableSceneModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AVAILABLE_VIDEO_STABILIZATION_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.availableVideoStabilizationModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AWB_AVAILABLE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.awbAvailableModes", int[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_MAX_REGIONS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.maxRegions", int[].class);
    ...
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> CONTROL_MAX_REGIONS_AE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.control.maxRegionsAe", int.class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> CONTROL_MAX_REGIONS_AWB = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.control.maxRegionsAwb", int.class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> CONTROL_MAX_REGIONS_AF = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.control.maxRegionsAf", int.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.HighSpeedVideoConfiguration[]> CONTROL_AVAILABLE_HIGH_SPEED_VIDEO_CONFIGURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.HighSpeedVideoConfiguration[]>("android.control.availableHighSpeedVideoConfigurations", android.hardware.camera2.params.HighSpeedVideoConfiguration[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean> CONTROL_AE_LOCK_AVAILABLE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean>("android.control.aeLockAvailable", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean> CONTROL_AWB_LOCK_AVAILABLE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean>("android.control.awbLockAvailable", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> CONTROL_AVAILABLE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.control.availableModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>> CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>>("android.control.postRawSensitivityBoostRange", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Integer>>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> EDGE_AVAILABLE_EDGE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.edge.availableEdgeModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean> FLASH_INFO_AVAILABLE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean>("android.flash.info.available", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> HOT_PIXEL_AVAILABLE_HOT_PIXEL_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.hotPixel.availableHotPixelModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]> JPEG_AVAILABLE_THUMBNAIL_SIZES = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]>("android.jpeg.availableThumbnailSizes", android.util.Size[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_INFO_AVAILABLE_APERTURES = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.info.availableApertures", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_INFO_AVAILABLE_FILTER_DENSITIES = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.info.availableFilterDensities", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_INFO_AVAILABLE_FOCAL_LENGTHS = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.info.availableFocalLengths", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> LENS_INFO_AVAILABLE_OPTICAL_STABILIZATION = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.lens.info.availableOpticalStabilization", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float> LENS_INFO_HYPERFOCAL_DISTANCE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float>("android.lens.info.hyperfocalDistance", float.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float> LENS_INFO_MINIMUM_FOCUS_DISTANCE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float>("android.lens.info.minimumFocusDistance", float.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Size> LENS_INFO_SHADING_MAP_SIZE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Size>("android.lens.info.shadingMapSize", android.util.Size.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> LENS_INFO_FOCUS_DISTANCE_CALIBRATION = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.lens.info.focusDistanceCalibration", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> LENS_FACING = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.lens.facing", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_POSE_ROTATION = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.poseRotation", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_POSE_TRANSLATION = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.poseTranslation", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_INTRINSIC_CALIBRATION = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.intrinsicCalibration", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<float[]> LENS_RADIAL_DISTORTION = new android.hardware.camera2.CameraCharacteristics.Key<float[]>("android.lens.radialDistortion", float[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> NOISE_REDUCTION_AVAILABLE_NOISE_REDUCTION_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.noiseReduction.availableNoiseReductionModes", int[].class);
    ...
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte> QUIRKS_USE_PARTIAL_RESULT = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte>("android.quirks.usePartialResult", byte.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> REQUEST_MAX_NUM_OUTPUT_STREAMS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.request.maxNumOutputStreams", int[].class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REQUEST_MAX_NUM_OUTPUT_RAW = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.request.maxNumOutputRaw", int.class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REQUEST_MAX_NUM_OUTPUT_PROC = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.request.maxNumOutputProc", int.class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REQUEST_MAX_NUM_OUTPUT_PROC_STALLING = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.request.maxNumOutputProcStalling", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REQUEST_MAX_NUM_INPUT_STREAMS = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.request.maxNumInputStreams", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte> REQUEST_PIPELINE_MAX_DEPTH = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte>("android.request.pipelineMaxDepth", byte.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REQUEST_PARTIAL_RESULT_COUNT = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.request.partialResultCount", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> REQUEST_AVAILABLE_CAPABILITIES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.request.availableCapabilities", int[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> REQUEST_AVAILABLE_REQUEST_KEYS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.request.availableRequestKeys", int[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> REQUEST_AVAILABLE_RESULT_KEYS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.request.availableResultKeys", int[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> REQUEST_AVAILABLE_CHARACTERISTICS_KEYS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.request.availableCharacteristicsKeys", int[].class);
     ...
     */
    @java.lang.Deprecated
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> SCALER_AVAILABLE_FORMATS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.scaler.availableFormats", int[].class);
     ...
     */
    @java.lang.Deprecated
    public static final android.hardware.camera2.CameraCharacteristics.Key<long[]> SCALER_AVAILABLE_JPEG_MIN_DURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<long[]>("android.scaler.availableJpegMinDurations", long[].class);
     ...
     */
    @java.lang.Deprecated
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]> SCALER_AVAILABLE_JPEG_SIZES = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]>("android.scaler.availableJpegSizes", android.util.Size[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float> SCALER_AVAILABLE_MAX_DIGITAL_ZOOM = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Float>("android.scaler.availableMaxDigitalZoom", float.class);
     ...
     */
    @java.lang.Deprecated
    public static final android.hardware.camera2.CameraCharacteristics.Key<long[]> SCALER_AVAILABLE_PROCESSED_MIN_DURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<long[]>("android.scaler.availableProcessedMinDurations", long[].class);
     ...
     */
    @java.lang.Deprecated
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]> SCALER_AVAILABLE_PROCESSED_SIZES = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Size[]>("android.scaler.availableProcessedSizes", android.util.Size[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ReprocessFormatsMap> SCALER_AVAILABLE_INPUT_OUTPUT_FORMATS_MAP = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ReprocessFormatsMap>("android.scaler.availableInputOutputFormatsMap", android.hardware.camera2.params.ReprocessFormatsMap.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfiguration[]> SCALER_AVAILABLE_STREAM_CONFIGURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfiguration[]>("android.scaler.availableStreamConfigurations", android.hardware.camera2.params.StreamConfiguration[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]> SCALER_AVAILABLE_MIN_FRAME_DURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]>("android.scaler.availableMinFrameDurations", android.hardware.camera2.params.StreamConfigurationDuration[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]> SCALER_AVAILABLE_STALL_DURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]>("android.scaler.availableStallDurations", android.hardware.camera2.params.StreamConfigurationDuration[].class);
    ...
    @android.hardware.camera2.impl.PublicKey
    @android.hardware.camera2.impl.SyntheticKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationMap> SCALER_STREAM_CONFIGURATION_MAP = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationMap>("android.scaler.streamConfigurationMap", android.hardware.camera2.params.StreamConfigurationMap.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SCALER_CROPPING_TYPE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.scaler.croppingType", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect> SENSOR_INFO_ACTIVE_ARRAY_SIZE = new android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect>("android.sensor.info.activeArraySize", android.graphics.Rect.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>> SENSOR_INFO_SENSITIVITY_RANGE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Integer>>("android.sensor.info.sensitivityRange", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Integer>>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_INFO_COLOR_FILTER_ARRANGEMENT = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.info.colorFilterArrangement", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Long>> SENSOR_INFO_EXPOSURE_TIME_RANGE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Range<java.lang.Long>>("android.sensor.info.exposureTimeRange", new android.hardware.camera2.utils.TypeReference<android.util.Range<java.lang.Long>>() {
        {
        }
    });
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Long> SENSOR_INFO_MAX_FRAME_DURATION = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Long>("android.sensor.info.maxFrameDuration", long.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.SizeF> SENSOR_INFO_PHYSICAL_SIZE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.SizeF>("android.sensor.info.physicalSize", android.util.SizeF.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.util.Size> SENSOR_INFO_PIXEL_ARRAY_SIZE = new android.hardware.camera2.CameraCharacteristics.Key<android.util.Size>("android.sensor.info.pixelArraySize", android.util.Size.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_INFO_WHITE_LEVEL = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.info.whiteLevel", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_INFO_TIMESTAMP_SOURCE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.info.timestampSource", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean> SENSOR_INFO_LENS_SHADING_APPLIED = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean>("android.sensor.info.lensShadingApplied", boolean.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect> SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE = new android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect>("android.sensor.info.preCorrectionActiveArraySize", android.graphics.Rect.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_REFERENCE_ILLUMINANT1 = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.referenceIlluminant1", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte> SENSOR_REFERENCE_ILLUMINANT2 = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Byte>("android.sensor.referenceIlluminant2", byte.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_CALIBRATION_TRANSFORM1 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.calibrationTransform1", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_CALIBRATION_TRANSFORM2 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.calibrationTransform2", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_COLOR_TRANSFORM1 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.colorTransform1", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_COLOR_TRANSFORM2 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.colorTransform2", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_FORWARD_MATRIX1 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.forwardMatrix1", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform> SENSOR_FORWARD_MATRIX2 = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.ColorSpaceTransform>("android.sensor.forwardMatrix2", android.hardware.camera2.params.ColorSpaceTransform.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.BlackLevelPattern> SENSOR_BLACK_LEVEL_PATTERN = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.BlackLevelPattern>("android.sensor.blackLevelPattern", android.hardware.camera2.params.BlackLevelPattern.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_MAX_ANALOG_SENSITIVITY = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.maxAnalogSensitivity", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SENSOR_ORIENTATION = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sensor.orientation", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> SENSOR_AVAILABLE_TEST_PATTERN_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.sensor.availableTestPatternModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect[]> SENSOR_OPTICAL_BLACK_REGIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.graphics.Rect[]>("android.sensor.opticalBlackRegions", android.graphics.Rect[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> SHADING_AVAILABLE_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.shading.availableModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> STATISTICS_INFO_AVAILABLE_FACE_DETECT_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.statistics.info.availableFaceDetectModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> STATISTICS_INFO_MAX_FACE_COUNT = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.statistics.info.maxFaceCount", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<boolean[]> STATISTICS_INFO_AVAILABLE_HOT_PIXEL_MAP_MODES = new android.hardware.camera2.CameraCharacteristics.Key<boolean[]>("android.statistics.info.availableHotPixelMapModes", boolean[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.statistics.info.availableLensShadingMapModes", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> TONEMAP_MAX_CURVE_POINTS = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.tonemap.maxCurvePoints", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> TONEMAP_AVAILABLE_TONE_MAP_MODES = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.tonemap.availableToneMapModes", int[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<int[]> LED_AVAILABLE_LEDS = new android.hardware.camera2.CameraCharacteristics.Key<int[]>("android.led.availableLeds", int[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> INFO_SUPPORTED_HARDWARE_LEVEL = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.info.supportedHardwareLevel", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> SYNC_MAX_LATENCY = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.sync.maxLatency", int.class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer> REPROCESS_MAX_CAPTURE_STALL = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Integer>("android.reprocess.maxCaptureStall", int.class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfiguration[]> DEPTH_AVAILABLE_DEPTH_STREAM_CONFIGURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfiguration[]>("android.depth.availableDepthStreamConfigurations", android.hardware.camera2.params.StreamConfiguration[].class);
     ...
     * @unknown 
     */
    public static final android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]> DEPTH_AVAILABLE_DEPTH_STALL_DURATIONS = new android.hardware.camera2.CameraCharacteristics.Key<android.hardware.camera2.params.StreamConfigurationDuration[]>("android.depth.availableDepthStallDurations", android.hardware.camera2.params.StreamConfigurationDuration[].class);
     ...
     */
    @android.hardware.camera2.impl.PublicKey
    public static final android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean> DEPTH_DEPTH_IS_EXCLUSIVE = new android.hardware.camera2.CameraCharacteristics.Key<java.lang.Boolean>("android.depth.depthIsExclusive", boolean.class);
}
