...
public final class BlackLevelPattern {
    ...
    public BlackLevelPattern(int[] offsets) {
        ...
        if (offsets.length < android.hardware.camera2.params.BlackLevelPattern.COUNT) {
            throw new java.lang.IllegalArgumentException("Invalid offsets array length");
        }
        mCfaOffsets = java.util.Arrays.copyOf(offsets, android.hardware.camera2.params.BlackLevelPattern.COUNT);
    }
    ...
    public void copyTo(int[] destination, int offset) {
        com.android.internal.util.Preconditions.checkNotNull(destination, "destination must not be null");
        if (offset < 0) {
            throw new java.lang.IllegalArgumentException("Null offset passed to copyTo");
        }
        if ((destination.length - offset) < android.hardware.camera2.params.BlackLevelPattern.COUNT) {
        ...
        if (obj == null) {
            ...
            if (this == obj) {
                ...
                if (obj instanceof android.hardware.camera2.params.BlackLevelPattern) {
                    final android.hardware.camera2.params.BlackLevelPattern other = ((android.hardware.camera2.params.BlackLevelPattern) (obj));
                    return java.util.Arrays.equals(other.mCfaOffsets, mCfaOffsets);
                }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("BlackLevelPattern([%d, %d], [%d, %d])", mCfaOffsets[0], mCfaOffsets[1], mCfaOffsets[2], mCfaOffsets[3]);
    }
