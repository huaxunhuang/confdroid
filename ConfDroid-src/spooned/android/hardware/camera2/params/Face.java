...
public final class Face {
     ...
     * 		Bounds of the face.
     * @param score
     * 		Confidence level between {@value #SCORE_MIN}-{@value #SCORE_MAX}.
     * @param id
     * 		A unique ID per face visible to the tracker.
    ...
    public Face(android.graphics.Rect bounds, int score, int id, android.graphics.Point leftEyePosition, android.graphics.Point rightEyePosition, android.graphics.Point mouthPosition) {
        android.hardware.camera2.params.Face.checkNotNull("bounds", bounds);
        if ((score < android.hardware.camera2.params.Face.SCORE_MIN) || (score > android.hardware.camera2.params.Face.SCORE_MAX)) {
            throw new java.lang.IllegalArgumentException("Confidence out of range");
        } else
            if ((id < 0) && (id != android.hardware.camera2.params.Face.ID_UNSUPPORTED)) {
                throw new java.lang.IllegalArgumentException("Id out of range");
            }

        if (id == android.hardware.camera2.params.Face.ID_UNSUPPORTED) {
            android.hardware.camera2.params.Face.checkNull("leftEyePosition", leftEyePosition);
            android.hardware.camera2.params.Face.checkNull("rightEyePosition", rightEyePosition);
            android.hardware.camera2.params.Face.checkNull("mouthPosition", mouthPosition);
        }
        mBounds = bounds;
        mScore = score;
        mId = id;
    ...
    public Face(android.graphics.Rect bounds, int score) {
        ...
        /* rightEyePosition */
        /* mouthPosition */
        this(bounds, score, android.hardware.camera2.params.Face.ID_UNSUPPORTED, null, null, null);
    }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("{ bounds: %s, score: %s, id: %d, " + "leftEyePosition: %s, rightEyePosition: %s, mouthPosition: %s }", mBounds, mScore, mId, mLeftEye, mRightEye, mMouth);
    }

    private static void checkNotNull(java.lang.String name, java.lang.Object obj) {
        if (obj == null) {
            throw new java.lang.IllegalArgumentException(name + " was required, but it was null");
        }
    }

    private static void checkNull(java.lang.String name, java.lang.Object obj) {
        if (obj != null) {
            throw new java.lang.IllegalArgumentException(name + " was required to be null, but it wasn't");
        }
    }
}
