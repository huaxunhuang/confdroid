...
public final class TonemapCurve {
     ...
     *
     * @param red
     * 		An array of elements whose length is divisible by {@value #POINT_SIZE}
     * @param green
     * 		An array of elements whose length is divisible by {@value #POINT_SIZE}
     * @param blue
     * 		An array of elements whose length is divisible by {@value #POINT_SIZE}
    ...
    public TonemapCurve(float[] red, float[] green, float[] blue) {
        ...
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthDivisibleBy(red, android.hardware.camera2.params.TonemapCurve.POINT_SIZE, "red");
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthDivisibleBy(green, android.hardware.camera2.params.TonemapCurve.POINT_SIZE, "green");
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthDivisibleBy(blue, android.hardware.camera2.params.TonemapCurve.POINT_SIZE, "blue");
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthNoLessThan(red, android.hardware.camera2.params.TonemapCurve.MIN_CURVE_LENGTH, "red");
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthNoLessThan(green, android.hardware.camera2.params.TonemapCurve.MIN_CURVE_LENGTH, "green");
        android.hardware.camera2.params.TonemapCurve.checkArgumentArrayLengthNoLessThan(blue, android.hardware.camera2.params.TonemapCurve.MIN_CURVE_LENGTH, "blue");
        checkArrayElementsInRange(red, android.hardware.camera2.params.TonemapCurve.LEVEL_BLACK, android.hardware.camera2.params.TonemapCurve.LEVEL_WHITE, "red");
        checkArrayElementsInRange(green, android.hardware.camera2.params.TonemapCurve.LEVEL_BLACK, android.hardware.camera2.params.TonemapCurve.LEVEL_WHITE, "green");
        checkArrayElementsInRange(blue, android.hardware.camera2.params.TonemapCurve.LEVEL_BLACK, android.hardware.camera2.params.TonemapCurve.LEVEL_WHITE, "blue");
        mRed = java.util.Arrays.copyOf(red, red.length);
        mGreen = java.util.Arrays.copyOf(green, green.length);
        mBlue = java.util.Arrays.copyOf(blue, blue.length);
    }
    ...
    private static void checkArgumentArrayLengthDivisibleBy(float[] array, int divisible, java.lang.String arrayName) {
        if ((array.length % divisible) != 0) {
            throw new java.lang.IllegalArgumentException((arrayName + " size must be divisible by ") + divisible);
        }
    }

    private static int checkArgumentColorChannel(int colorChannel) {
        switch (colorChannel) {
            case android.hardware.camera2.params.TonemapCurve.CHANNEL_RED :
            case android.hardware.camera2.params.TonemapCurve.CHANNEL_GREEN :
            case android.hardware.camera2.params.TonemapCurve.CHANNEL_BLUE :
                break;
            default :
    ...
    private static void checkArgumentArrayLengthNoLessThan(float[] array, int minLength, java.lang.String arrayName) {
        if (array.length < minLength) {
            throw new java.lang.IllegalArgumentException((arrayName + " size must be at least ") + minLength);
        }
    }
     ...
     *
     * @param colorChannel
     * 		one of {@link #CHANNEL_RED}, {@link #CHANNEL_GREEN}, {@link #CHANNEL_BLUE}
     * @return number of points stored in this tonemap for that color's curve (>= 0)
     * @throws IllegalArgumentException
     * 		if {@code colorChannel} was out of range
     */
    public int getPointCount(int colorChannel) {
        android.hardware.camera2.params.TonemapCurve.checkArgumentColorChannel(colorChannel);
        return getCurve(colorChannel).length / android.hardware.camera2.params.TonemapCurve.POINT_SIZE;
    }
     ...
     *
     * @param colorChannel
     * 		{@link #CHANNEL_RED}, {@link #CHANNEL_GREEN}, or {@link #CHANNEL_BLUE}
     * @param index
     * 		at least 0 but no greater than {@code getPointCount(colorChannel)}
     * @return the {@code (Pin, Pout)} pair mapping the tone for that index
     * @throws IllegalArgumentException
     * 		if {@code colorChannel} or {@code index} was out of range
     * @see #LEVEL_BLACK
     * @see #LEVEL_WHITE
     */
    public android.graphics.PointF getPoint(int colorChannel, int index) {
        ...
        final float pIn = curve[(index * android.hardware.camera2.params.TonemapCurve.POINT_SIZE) + android.hardware.camera2.params.TonemapCurve.OFFSET_POINT_IN];
        final float pOut = curve[(index * android.hardware.camera2.params.TonemapCurve.POINT_SIZE) + android.hardware.camera2.params.TonemapCurve.OFFSET_POINT_OUT];
        return new android.graphics.PointF(pIn, pOut);
    }
    ...
    public void copyColorCurve(int colorChannel, float[] destination, int offset) {
        ...
        if ((destination.length + offset) < (getPointCount(colorChannel) * android.hardware.camera2.params.TonemapCurve.POINT_SIZE)) {
        ...
        /* srcPos */
        java.lang.System.arraycopy(curve, 0, destination, offset, curve.length);
    }
    ...
    public boolean equals(java.lang.Object obj) {
        ...
        if (obj instanceof android.hardware.camera2.params.TonemapCurve) {
            final android.hardware.camera2.params.TonemapCurve other = ((android.hardware.camera2.params.TonemapCurve) (obj));
            return (java.util.Arrays.equals(mRed, other.mRed) && java.util.Arrays.equals(mGreen, other.mGreen)) && java.util.Arrays.equals(mBlue, other.mBlue);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        mHashCode = android.hardware.camera2.utils.HashCodeHelpers.hashCodeGeneric(mRed, mGreen, mBlue);
    ...
    public java.lang.String toString() {
        java.lang.StringBuilder sb = new java.lang.StringBuilder("TonemapCurve{");
        sb.append("R:");
        sb.append(curveToString(android.hardware.camera2.params.TonemapCurve.CHANNEL_RED));
        sb.append(", G:");
        sb.append(curveToString(android.hardware.camera2.params.TonemapCurve.CHANNEL_GREEN));
        sb.append(", B:");
        sb.append(curveToString(android.hardware.camera2.params.TonemapCurve.CHANNEL_BLUE));
        sb.append("}");
        return sb.toString();
    }
    ...
    private java.lang.String curveToString(int colorChannel) {
        ...
        float[] curve = getCurve(colorChannel);
        int pointCount = curve.length / android.hardware.camera2.params.TonemapCurve.POINT_SIZE;
    ...
    private static final int MIN_CURVE_LENGTH = android.hardware.camera2.params.TonemapCurve.TONEMAP_MIN_CURVE_POINTS * android.hardware.camera2.params.TonemapCurve.POINT_SIZE;
