...
public final class HighSpeedVideoConfiguration {
     ...
     * @param fpsMax
     * 		maximum frames per second for the configuration (larger or equal to 60)
    ...
    public HighSpeedVideoConfiguration(final int width, final int height, final int fpsMin, final int fpsMax, final int batchSizeMax) {
        if (fpsMax < android.hardware.camera2.params.HighSpeedVideoConfiguration.HIGH_SPEED_MAX_MINIMAL_FPS) {
            throw new java.lang.IllegalArgumentException("fpsMax must be at least " + android.hardware.camera2.params.HighSpeedVideoConfiguration.HIGH_SPEED_MAX_MINIMAL_FPS);
        }
        mFpsMax = fpsMax;
        ...
        mSize = new android.util.Size(mWidth, mHeight);
        mBatchSizeMax = checkArgumentPositive(batchSizeMax, "batchSizeMax must be positive");
        mFpsRange = new android.util.Range<java.lang.Integer>(mFpsMin, mFpsMax);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof android.hardware.camera2.params.HighSpeedVideoConfiguration) {
            final android.hardware.camera2.params.HighSpeedVideoConfiguration other = ((android.hardware.camera2.params.HighSpeedVideoConfiguration) (obj));
    ...
    @java.lang.Override
    public int hashCode() {
        return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mWidth, mHeight, mFpsMin, mFpsMax);
    }
