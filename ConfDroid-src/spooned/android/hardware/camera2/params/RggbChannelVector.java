...
public final class RggbChannelVector {
     ...
     *
     * @param colorChannel
     * 		greater or equal to {@code 0} and less than {@link #COUNT}
     * @return a floating point value (guaranteed to be finite)
     * @throws IllegalArgumentException
    ...
    public float getComponent(final int colorChannel) {
        ...
        switch (colorChannel) {
            case android.hardware.camera2.params.RggbChannelVector.RED :
                return mRed;
            case android.hardware.camera2.params.RggbChannelVector.GREEN_EVEN :
                return mGreenEven;
            case android.hardware.camera2.params.RggbChannelVector.GREEN_ODD :
                return mGreenOdd;
            case android.hardware.camera2.params.RggbChannelVector.BLUE :
                return mBlue;
            default :
                throw new java.lang.AssertionError("Unhandled case " + colorChannel);
        }
    }
    ...
    public void copyTo(final float[] destination, final int offset) {
        ...
        if ((destination.length - offset) < android.hardware.camera2.params.RggbChannelVector.COUNT) {
            throw new java.lang.ArrayIndexOutOfBoundsException("destination too small to fit elements");
        }
        destination[offset + android.hardware.camera2.params.RggbChannelVector.RED] = mRed;
        destination[offset + android.hardware.camera2.params.RggbChannelVector.GREEN_EVEN] = mGreenEven;
        destination[offset + android.hardware.camera2.params.RggbChannelVector.GREEN_ODD] = mGreenOdd;
        destination[offset + android.hardware.camera2.params.RggbChannelVector.BLUE] = mBlue;
    }
        ...
        if (obj == null) {
            ...
            if (this == obj) {
                ...
                if (obj instanceof android.hardware.camera2.params.RggbChannelVector) {
                    final android.hardware.camera2.params.RggbChannelVector other = ((android.hardware.camera2.params.RggbChannelVector) (obj));
                    return (((mRed == other.mRed) && (mGreenEven == other.mGreenEven)) && (mGreenOdd == other.mGreenOdd)) && (mBlue == other.mBlue);
                }
    ...
    @java.lang.Override
    public int hashCode() {
        return ((java.lang.Float.floatToIntBits(mRed) ^ java.lang.Float.floatToIntBits(mGreenEven)) ^ java.lang.Float.floatToIntBits(mGreenOdd)) ^ java.lang.Float.floatToIntBits(mBlue);
    }
    ...
    private java.lang.String toShortString() {
        return java.lang.String.format("{R:%f, G_even:%f, G_odd:%f, B:%f}", mRed, mGreenEven, mGreenOdd, mBlue);
    }
