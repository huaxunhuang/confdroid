...
public final class MeteringRectangle {
     ...
     * @param height
     * 		height >= 0
     * @param meteringWeight
     * 		weight between {@value #METERING_WEIGHT_MIN} and
    ...
    public MeteringRectangle(int x, int y, int width, int height, int meteringWeight) {
        ...
        mWeight = checkArgumentInRange(meteringWeight, android.hardware.camera2.params.MeteringRectangle.METERING_WEIGHT_MIN, android.hardware.camera2.params.MeteringRectangle.METERING_WEIGHT_MAX, "meteringWeight");
    }
     ...
     *
     * @param xy
     * 		a non-{@code null} {@link Point} with both x,y >= 0
     * @param dimensions
     * 		a non-{@code null} {@link android.util.Size Size} with width, height >= 0
     * @param meteringWeight
     * 		weight >= 0
     * @throws IllegalArgumentException
     * 		if any of the parameters were negative
     ...
     *
     * @param rect
     * 		a non-{@code null} rectangle with all x,y,w,h dimensions >= 0
     * @param meteringWeight
     * 		weight >= 0
     * @throws IllegalArgumentException
     * 		if any of the parameters were negative
    ...
    public android.graphics.Point getUpperLeftPoint() {
        return new android.graphics.Point(mX, mY);
    }
    ...
    public android.graphics.Rect getRect() {
        return new android.graphics.Rect(mX, mY, mX + mWidth, mY + mHeight);
    }
    ...
    public boolean equals(final java.lang.Object other) {
        return (other instanceof android.hardware.camera2.params.MeteringRectangle) && equals(((android.hardware.camera2.params.MeteringRectangle) (other)));
    }
     ...
     */
    public boolean equals(final android.hardware.camera2.params.MeteringRectangle other) {
        if (other == null) {
            return false;
        }
        return ((((mX == other.mX) && (mY == other.mY)) && (mWidth == other.mWidth)) && (mHeight == other.mHeight)) && (mWeight == other.mWeight);
    }
    ...
    @java.lang.Override
    public int hashCode() {
        return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mX, mY, mWidth, mHeight, mWeight);
    }
    ...
    public java.lang.String toString() {
        return java.lang.String.format("(x:%d, y:%d, w:%d, h:%d, wt:%d)", mX, mY, mWidth, mHeight, mWeight);
    }
}
