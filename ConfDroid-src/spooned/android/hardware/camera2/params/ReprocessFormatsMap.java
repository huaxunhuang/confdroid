...
public final class ReprocessFormatsMap {
     ...
     *
     * @param entry
     * 		Array of ints, not yet deserialized (not-null)
    ...
    public ReprocessFormatsMap(final int[] entry) {
        ...
        for (int i = 0; i < entry.length;) {
            int inputFormat = android.hardware.camera2.params.StreamConfigurationMap.checkArgumentFormatInternal(entry[i]);
            left--;
            i++;
            if (left < 1) {
                throw new java.lang.IllegalArgumentException(java.lang.String.format("Input %x had no output format length listed", inputFormat));
            }
            ...
            for (int j = 0; j < length; ++j) {
                ...
                android.hardware.camera2.params.StreamConfigurationMap.checkArgumentFormatInternal(outputFormat);
            }
            if (length > 0) {
                if (left < length) {
                    throw new java.lang.IllegalArgumentException(java.lang.String.format("Input %x had too few output formats listed (actual: %d, " + "expected: %d)", inputFormat, left, length));
                }
                i += length;
                left -= length;
            }
    ...
    public int[] getInputs() {
        ...
        for (int i = 0, j = 0; i < mEntry.length; j++) {
            ...
            i++;
            if (left < 1) {
                throw new java.lang.AssertionError(java.lang.String.format("Input %x had no output format length listed", format));
            }
            ...
            if (length > 0) {
                if (left < length) {
                    throw new java.lang.AssertionError(java.lang.String.format("Input %x had too few output formats listed (actual: %d, " + "expected: %d)", format, left, length));
                }
                i += length;
                left -= length;
            }
        ...
        return android.hardware.camera2.params.StreamConfigurationMap.imageFormatToPublic(inputs);
    }
    ...
    public int[] getOutputs(final int format) {
        ...
        for (int i = 0; i < mEntry.length;) {
            ...
            if (inputFormat == format) {
                ...
                return android.hardware.camera2.params.StreamConfigurationMap.imageFormatToPublic(outputs);
            }
            i += length;
            left -= length;
        }
        throw new java.lang.IllegalArgumentException(java.lang.String.format("Input format %x was not one in #getInputs", format));
    }
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof android.hardware.camera2.params.ReprocessFormatsMap) {
            final android.hardware.camera2.params.ReprocessFormatsMap other = ((android.hardware.camera2.params.ReprocessFormatsMap) (obj));
            // Do not compare anything besides mEntry, since the rest of the values are derived
            return java.util.Arrays.equals(mEntry, other.mEntry);
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mEntry);
    }
