...
public final class StreamConfiguration {
     ...
     * @param input
     * 		true if this is an input configuration, false for output configurations
     ...
     * @unknown 
     */
    public StreamConfiguration(final int format, final int width, final int height, final boolean input) {
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof android.hardware.camera2.params.StreamConfiguration) {
            final android.hardware.camera2.params.StreamConfiguration other = ((android.hardware.camera2.params.StreamConfiguration) (obj));
    ...
    @java.lang.Override
    public int hashCode() {
        return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mFormat, mWidth, mHeight, mInput ? 1 : 0);
    }
