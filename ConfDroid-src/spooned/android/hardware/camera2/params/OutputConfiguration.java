...
public final class OutputConfiguration implements android.os.Parcelable {
     ...
     */
    public OutputConfiguration(@android.annotation.NonNull
    android.view.Surface surface) {
        this(android.hardware.camera2.params.OutputConfiguration.SURFACE_GROUP_ID_NONE, surface, android.hardware.camera2.params.OutputConfiguration.ROTATION_0);
    }
     ...
     * 		A Surface for camera to output to.
     */
    public OutputConfiguration(int surfaceGroupId, @android.annotation.NonNull
    android.view.Surface surface) {
        this(surfaceGroupId, surface, android.hardware.camera2.params.OutputConfiguration.ROTATION_0);
    }
    ...
    @android.annotation.SystemApi
    public OutputConfiguration(@android.annotation.NonNull
    android.view.Surface surface, int rotation) {
        this(android.hardware.camera2.params.OutputConfiguration.SURFACE_GROUP_ID_NONE, surface, rotation);
    }
    ...
    android.view.Surface surface, int rotation) {
        ...
        checkArgumentInRange(rotation, android.hardware.camera2.params.OutputConfiguration.ROTATION_0, android.hardware.camera2.params.OutputConfiguration.ROTATION_270, "Rotation constant");
        mSurfaceGroupId = surfaceGroupId;
        mSurfaceType = SURFACE_TYPE_UNKNOWN;
        mSurface = surface;
        mRotation = rotation;
        mConfiguredSize = android.hardware.camera2.utils.SurfaceUtils.getSurfaceSize(surface);
        mConfiguredFormat = android.hardware.camera2.utils.SurfaceUtils.getSurfaceFormat(surface);
        mConfiguredDataspace = android.hardware.camera2.utils.SurfaceUtils.getSurfaceDataspace(surface);
     ...
     * @param klass
     * 		a non-{@code null} {@link Class} object reference that indicates the source of
     ...
     * @unknown 
     */
    public <T> OutputConfiguration(@android.annotation.NonNull
    android.util.Size surfaceSize, @android.annotation.NonNull
    java.lang.Class<T> klass) {
        ...
        if (klass == android.view.SurfaceHolder.class) {
            ...
            if (klass == android.graphics.SurfaceTexture.class) {
                ...
                mSurfaceType = SURFACE_TYPE_UNKNOWN;
                throw new java.lang.IllegalArgumentException("Unknow surface source class type");
            }

        mSurfaceGroupId = android.hardware.camera2.params.OutputConfiguration.SURFACE_GROUP_ID_NONE;
        mSurface = null;
        mRotation = android.hardware.camera2.params.OutputConfiguration.ROTATION_0;
        mConfiguredSize = surfaceSize;
        mConfiguredFormat = android.hardware.camera2.params.StreamConfigurationMap.imageFormatToInternal(android.graphics.ImageFormat.PRIVATE);
        mConfiguredDataspace = android.hardware.camera2.params.StreamConfigurationMap.imageFormatToDataspace(android.graphics.ImageFormat.PRIVATE);
     ...
     *
     * @param surface
     * 		The deferred surface to be set.
     ...
     * @unknown 
     */
    public void setDeferredSurface(@android.annotation.NonNull
    android.view.Surface surface) {
        checkNotNull(surface, "Surface must not be null");
        if (mSurface != null) {
            throw new java.lang.IllegalStateException("Deferred surface is already set!");
        }
        ...
        if (!surfaceSize.equals(mConfiguredSize)) {
            android.util.Log.w(android.hardware.camera2.params.OutputConfiguration.TAG, ((("Deferred surface size " + surfaceSize) + " is different with pre-configured size ") + mConfiguredSize) + ", the pre-configured size will be used.");
        }
        mSurface = surface;
    }
     ...
     *
     * @param other
     * 		Another {@link OutputConfiguration} instance to be copied.
     * @unknown 
     */
    public OutputConfiguration(@android.annotation.NonNull
     ...
     */
    private OutputConfiguration(@android.annotation.NonNull
    android.os.Parcel source) {
        ...
        android.view.Surface surface = android.view.Surface.CREATOR.createFromParcel(source);
        checkArgumentInRange(rotation, android.hardware.camera2.params.OutputConfiguration.ROTATION_0, android.hardware.camera2.params.OutputConfiguration.ROTATION_270, "Rotation constant");
        ...
        if (surface != null) {
            mSurfaceType = SURFACE_TYPE_UNKNOWN;
            mConfiguredSize = android.hardware.camera2.utils.SurfaceUtils.getSurfaceSize(mSurface);
            mConfiguredFormat = android.hardware.camera2.utils.SurfaceUtils.getSurfaceFormat(mSurface);
            mConfiguredDataspace = android.hardware.camera2.utils.SurfaceUtils.getSurfaceDataspace(mSurface);
            mConfiguredGenerationId = mSurface.getGenerationId();
            mIsDeferredConfig = true;
        } else {
            mSurfaceType = surfaceType;
            mConfiguredSize = new android.util.Size(width, height);
            mConfiguredFormat = android.hardware.camera2.params.StreamConfigurationMap.imageFormatToInternal(android.graphics.ImageFormat.PRIVATE);
            mConfiguredGenerationId = 0;
            mConfiguredDataspace = android.hardware.camera2.params.StreamConfigurationMap.imageFormatToDataspace(android.graphics.ImageFormat.PRIVATE);
            mIsDeferredConfig = false;
    ...
    public static final android.os.Parcelable.Creator<android.hardware.camera2.params.OutputConfiguration> CREATOR = new android.os.Parcelable.Creator<android.hardware.camera2.params.OutputConfiguration>() {
        @java.lang.Override
        public android.hardware.camera2.params.OutputConfiguration createFromParcel(android.os.Parcel source) {
            try {
                android.hardware.camera2.params.OutputConfiguration outputConfiguration = new android.hardware.camera2.params.OutputConfiguration(source);
                return outputConfiguration;
            } catch (java.lang.Exception e) {
                android.util.Log.e(android.hardware.camera2.params.OutputConfiguration.TAG, "Exception creating OutputConfiguration from parcel", e);
                return null;
            }
        }

        @java.lang.Override
        public android.hardware.camera2.params.OutputConfiguration[] newArray(int size) {
            return new android.hardware.camera2.params.OutputConfiguration[size];
        }
    };
        ...
        if (obj == null) {
            ...
            if (this == obj) {
                ...
                if (obj instanceof android.hardware.camera2.params.OutputConfiguration) {
                    final android.hardware.camera2.params.OutputConfiguration other = ((android.hardware.camera2.params.OutputConfiguration) (obj));
                    boolean iSSurfaceEqual = (mSurface == other.mSurface) && (mConfiguredGenerationId == other.mConfiguredGenerationId);
                    if (mIsDeferredConfig) {
                        android.util.Log.i(android.hardware.camera2.params.OutputConfiguration.TAG, "deferred config has the same surface");
                        iSSurfaceEqual = true;
                    }
    ...
    public int hashCode() {
        ...
        // surface is set.
        if (mIsDeferredConfig) {
            return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mRotation, mConfiguredSize.hashCode(), mConfiguredFormat, mConfiguredDataspace, mSurfaceGroupId, mSurfaceType);
        }
        return android.hardware.camera2.utils.HashCodeHelpers.hashCode(mRotation, mSurface.hashCode(), mConfiguredGenerationId, mConfiguredSize.hashCode(), mConfiguredFormat, mConfiguredDataspace, mSurfaceGroupId);
    }
