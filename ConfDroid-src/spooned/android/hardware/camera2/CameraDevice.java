...
public abstract class CameraDevice implements java.lang.AutoCloseable {
    ...
    @android.annotation.IntDef({ android.hardware.camera2.CameraDevice.TEMPLATE_PREVIEW, android.hardware.camera2.CameraDevice.TEMPLATE_STILL_CAPTURE, android.hardware.camera2.CameraDevice.TEMPLATE_RECORD, android.hardware.camera2.CameraDevice.TEMPLATE_VIDEO_SNAPSHOT, android.hardware.camera2.CameraDevice.TEMPLATE_ZERO_SHUTTER_LAG, android.hardware.camera2.CameraDevice.TEMPLATE_MANUAL })
     ...
     *
     * <p>This ID can be used to query the camera device's {@link CameraCharacteristics fixed properties} with {@link CameraManager#getCameraCharacteristics}.</p>
     *
     ...
     *   getOutputSizes(SurfaceHolder.class)} and then obtain the Surface by calling {@link android.view.SurfaceHolder#getSurface}. If the size is not set by the application, it will
     ...
     *   SurfaceTexture}: Set the size of the SurfaceTexture with {@link android.graphics.SurfaceTexture#setDefaultBufferSize} to be one of the sizes returned by
     ...
     */
    public abstract void createCaptureSession(@android.annotation.NonNull
    java.util.List<android.view.Surface> outputs, @android.annotation.NonNull
    android.hardware.camera2.CameraCaptureSession.StateCallback callback, @android.annotation.Nullable
     ...
     * 		the current thread's {@link android.os.Looper looper}.
     * @throws IllegalArgumentException
     * 		if the input configuration is null or not supported, the set
     ...
     */
    public abstract void createReprocessableCaptureSession(@android.annotation.NonNull
    android.hardware.camera2.params.InputConfiguration inputConfig, @android.annotation.NonNull
    java.util.List<android.view.Surface> outputs, @android.annotation.NonNull
    android.hardware.camera2.CameraCaptureSession.StateCallback callback, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
     ...
     * @see OutputConfiguration
     */
    public abstract void createReprocessableCaptureSessionByConfigurations(@android.annotation.NonNull
    android.hardware.camera2.params.InputConfiguration inputConfig, @android.annotation.NonNull
    java.util.List<android.hardware.camera2.params.OutputConfiguration> outputs, @android.annotation.NonNull
    android.hardware.camera2.CameraCaptureSession.StateCallback callback, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
     ...
     */
    public abstract void createConstrainedHighSpeedCaptureSession(@android.annotation.NonNull
    java.util.List<android.view.Surface> outputs, @android.annotation.NonNull
    android.hardware.camera2.CameraCaptureSession.StateCallback callback, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.hardware.camera2.CaptureRequest.Builder createCaptureRequest(@android.hardware.camera2.CameraDevice.RequestTemplate
    int templateType) throws android.hardware.camera2.CameraAccessException;
     ...
     */
    @android.annotation.NonNull
    public abstract android.hardware.camera2.CaptureRequest.Builder createReprocessCaptureRequest(@android.annotation.NonNull
    android.hardware.camera2.TotalCaptureResult inputResult) throws android.hardware.camera2.CameraAccessException;
    ...
    public static abstract class StateCallback {
         ...
         */
        @java.lang.annotation.Retention(java.lang.annotation.RetentionPolicy.SOURCE)
        @android.annotation.IntDef({ android.hardware.camera2.CameraDevice.StateCallback.ERROR_CAMERA_IN_USE, android.hardware.camera2.CameraDevice.StateCallback.ERROR_MAX_CAMERAS_IN_USE, android.hardware.camera2.CameraDevice.StateCallback.ERROR_CAMERA_DISABLED, android.hardware.camera2.CameraDevice.StateCallback.ERROR_CAMERA_DEVICE, android.hardware.camera2.CameraDevice.StateCallback.ERROR_CAMERA_SERVICE })
         ...
         */
        public abstract void onOpened(@android.annotation.NonNull
        android.hardware.camera2.CameraDevice camera);// Must implement
         ...
         */
        public abstract void onDisconnected(@android.annotation.NonNull
        android.hardware.camera2.CameraDevice camera);// Must implement
        ...
        android.hardware.camera2.CameraDevice camera, @android.hardware.camera2.CameraDevice.StateCallback.ErrorCode
        int error);// Must implement
     ...
     * @unknown 
     */
    public static abstract class StateListener extends android.hardware.camera2.CameraDevice.StateCallback {}
