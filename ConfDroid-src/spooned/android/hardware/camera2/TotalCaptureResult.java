...
public final class TotalCaptureResult extends android.hardware.camera2.CaptureResult {
     ...
     *
     * @param partials
     * 		a list of partial results; {@code null} will be substituted for an empty list
     * @unknown 
     */
    public TotalCaptureResult(android.hardware.camera2.impl.CameraMetadataNative results, android.hardware.camera2.CaptureRequest parent, android.hardware.camera2.impl.CaptureResultExtras extras, java.util.List<android.hardware.camera2.CaptureResult> partials, int sessionId) {
        super(results, parent, extras);
        if (partials == null) {
            mPartialResults = new java.util.ArrayList<>();
        } else {
    ...
    public TotalCaptureResult(android.hardware.camera2.impl.CameraMetadataNative results, int sequenceId) {
        ...
        mPartialResults = new java.util.ArrayList<>();
        mSessionId = android.hardware.camera2.CameraCaptureSession.SESSION_ID_NONE;
    }
    ...
    public java.util.List<android.hardware.camera2.CaptureResult> getPartialResults() {
        return java.util.Collections.unmodifiableList(mPartialResults);
    }
