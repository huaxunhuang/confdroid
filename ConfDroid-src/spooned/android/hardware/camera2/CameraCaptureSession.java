...
public abstract class CameraCaptureSession implements java.lang.AutoCloseable {
     ...
     */
    public abstract void prepare(@android.annotation.NonNull
    android.view.Surface surface) throws android.hardware.camera2.CameraAccessException;
     ...
     * @param surface
     * 		the output Surface for which buffers should be pre-allocated.
     * @throws CameraAccessException
     * 		if the camera device is no longer connected or has
     * 		encountered a fatal error.
     * @throws IllegalStateException
     ...
     * @unknown 
     */
    public abstract void prepare(int maxCount, @android.annotation.NonNull
    android.view.Surface surface) throws android.hardware.camera2.CameraAccessException;
     ...
     * @unknown 
     */
    public abstract void tearDown(@android.annotation.NonNull
    android.view.Surface surface) throws android.hardware.camera2.CameraAccessException;
     ...
     * </p>
     *
     * @param deferredOutputConfigs
     * 		a list of {@link OutputConfiguration OutputConfigurations} that
     ...
     * @unknown 
     */
    public abstract void finishDeferredConfiguration(java.util.List<android.hardware.camera2.params.OutputConfiguration> deferredOutputConfigs) throws android.hardware.camera2.CameraAccessException;
     ...
     */
    public abstract int capture(@android.annotation.NonNull
    android.hardware.camera2.CaptureRequest request, @android.annotation.Nullable
    android.hardware.camera2.CameraCaptureSession.CaptureCallback listener, @android.annotation.Nullable
     ...
     * @see #abortCaptures
     */
    public abstract int captureBurst(@android.annotation.NonNull
    java.util.List<android.hardware.camera2.CaptureRequest> requests, @android.annotation.Nullable
    android.hardware.camera2.CameraCaptureSession.CaptureCallback listener, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
     ...
     * @see #abortCaptures
     */
    public abstract int setRepeatingRequest(@android.annotation.NonNull
    android.hardware.camera2.CaptureRequest request, @android.annotation.Nullable
    android.hardware.camera2.CameraCaptureSession.CaptureCallback listener, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
     ...
     * @see #abortCaptures
     */
    public abstract int setRepeatingBurst(@android.annotation.NonNull
    java.util.List<android.hardware.camera2.CaptureRequest> requests, @android.annotation.Nullable
    android.hardware.camera2.CameraCaptureSession.CaptureCallback listener, @android.annotation.Nullable
    android.os.Handler handler) throws android.hardware.camera2.CameraAccessException;
    ...
    public static abstract class StateCallback {
         ...
         */
        public abstract void onConfigured(@android.annotation.NonNull
         ...
         * 		the session returned by {@link CameraDevice#createCaptureSession}
         */
        public abstract void onConfigureFailed(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session);
         ...
         * 		the session returned by {@link CameraDevice#createCaptureSession}
         */
        public void onReady(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session) {
         ...
         * 		the session returned by {@link CameraDevice#createCaptureSession}
         */
        public void onActive(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session) {
            // default empty implementation
        }
         ...
         * 		the session returned by {@link CameraDevice#createCaptureSession}
         */
        public void onClosed(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session) {
            // default empty implementation
        }
         ...
         */
        public void onSurfacePrepared(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
     ...
     * @unknown 
     */
    public static abstract class StateListener extends android.hardware.camera2.CameraCaptureSession.StateCallback {}
    ...
    public static abstract class CaptureCallback {
         ...
         */
        public void onCaptureStarted(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
        android.hardware.camera2.CaptureRequest request, long timestamp, long frameNumber) {
         ...
         * @unknown 
         */
        public void onCaptureStarted(android.hardware.camera2.CameraCaptureSession session, android.hardware.camera2.CaptureRequest request, long timestamp) {
            // default empty implementation
        }
         ...
         * @unknown 
         */
        public void onCapturePartial(android.hardware.camera2.CameraCaptureSession session, android.hardware.camera2.CaptureRequest request, android.hardware.camera2.CaptureResult result) {
            // default empty implementation
        }
         ...
         * @see #setRepeatingBurst
         */
        public void onCaptureProgressed(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
        android.hardware.camera2.CaptureRequest request, @android.annotation.NonNull
         ...
         * @see #setRepeatingBurst
         */
        public void onCaptureCompleted(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
        android.hardware.camera2.CaptureRequest request, @android.annotation.NonNull
         ...
         * @see #setRepeatingBurst
         */
        public void onCaptureFailed(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
        android.hardware.camera2.CaptureRequest request, @android.annotation.NonNull
         ...
         */
        public void onCaptureSequenceCompleted(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, int sequenceId, long frameNumber) {
            // default empty implementation
        }
         ...
         */
        public void onCaptureSequenceAborted(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, int sequenceId) {
            // default empty implementation
        }
         ...
         */
        public void onCaptureBufferLost(@android.annotation.NonNull
        android.hardware.camera2.CameraCaptureSession session, @android.annotation.NonNull
        android.hardware.camera2.CaptureRequest request, @android.annotation.NonNull
        android.view.Surface target, long frameNumber) {
            // default empty implementation
        }
    }
     ...
     * @unknown 
     */
    public static abstract class CaptureListener extends android.hardware.camera2.CameraCaptureSession.CaptureCallback {}
}
