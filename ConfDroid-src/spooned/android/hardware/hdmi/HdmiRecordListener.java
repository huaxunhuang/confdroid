...
public abstract class HdmiRecordListener {
     ...
     * 		request
     * @param data
     * 		timer status data. For more details, look at {@link TimerStatusData}.
     */
    public void onTimerRecordingResult(int recorderAddress, android.hardware.hdmi.HdmiRecordListener.TimerStatusData data) {
    }
    ...
    public static class TimerStatusData {
        ...
        static android.hardware.hdmi.HdmiRecordListener.TimerStatusData parseFrom(int result) {
            android.hardware.hdmi.HdmiRecordListener.TimerStatusData data = new android.hardware.hdmi.HdmiRecordListener.TimerStatusData();
            ...
            if (data.mProgrammed) {
                ...
                data.mDurationHour = android.hardware.hdmi.HdmiRecordListener.TimerStatusData.bcdByteToInt(((byte) ((result >> 16) & 0xff)));
                data.mDurationMinute = android.hardware.hdmi.HdmiRecordListener.TimerStatusData.bcdByteToInt(((byte) ((result >> 8) & 0xff)));
            } else {
         ...
         * 		if it's called when {@link #isProgrammed()}
         * 		returns false
         */
