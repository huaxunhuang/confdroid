...
public final class HdmiPortInfo implements android.os.Parcelable {
     ...
     *
     * @param id
     * 		identifier assigned to each port. 1 for HDMI port 1
     * @param type
     * 		HDMI port input/output type
     * @param address
     * 		physical address of the port
     * @param cec
     * 		{@code true} if HDMI-CEC is supported on the port
     * @param mhl
     * 		{@code true} if MHL is supported on the port
     * @param arc
     * 		{@code true} if audio return channel is supported on the port
     */
     ...
     */
    public static final android.os.Parcelable.Creator<android.hardware.hdmi.HdmiPortInfo> CREATOR = new android.os.Parcelable.Creator<android.hardware.hdmi.HdmiPortInfo>() {
        @java.lang.Override
        public android.hardware.hdmi.HdmiPortInfo createFromParcel(android.os.Parcel source) {
            ...
            return new android.hardware.hdmi.HdmiPortInfo(id, type, address, cec, mhl, arc);
        }

        @java.lang.Override
        public android.hardware.hdmi.HdmiPortInfo[] newArray(int size) {
            return new android.hardware.hdmi.HdmiPortInfo[size];
        }
    };
    ...
    public java.lang.String toString() {
        ...
        s.append("address: ").append(java.lang.String.format("0x%04x", mAddress)).append(", ");
    ...
    public boolean equals(java.lang.Object o) {
        if (!(o instanceof android.hardware.hdmi.HdmiPortInfo)) {
            return false;
        }
        final android.hardware.hdmi.HdmiPortInfo other = ((android.hardware.hdmi.HdmiPortInfo) (o));
        return (((((mId == other.mId) && (mType == other.mType)) && (mAddress == other.mAddress)) && (mCecSupported == other.mCecSupported)) && (mArcSupported == other.mArcSupported)) && (mMhlSupported == other.mMhlSupported);
    }
}
