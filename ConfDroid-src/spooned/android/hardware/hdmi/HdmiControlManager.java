...
public final class HdmiControlManager {
     ...
     */
    public static final int ONE_TOUCH_RECORD_RECORDING_CURRENTLY_SELECTED_SOURCE = 0x1;

    /**
     * Recording Digital Service. Indicates the status of a recording.
     */
    public static final int ONE_TOUCH_RECORD_RECORDING_DIGITAL_SERVICE = 0x2;

    /**
     * Recording Analogue Service. Indicates the status of a recording.
     */
    public static final int ONE_TOUCH_RECORD_RECORDING_ANALOGUE_SERVICE = 0x3;

    /**
     * Recording External input. Indicates the status of a recording.
     */
    public static final int ONE_TOUCH_RECORD_RECORDING_EXTERNAL_INPUT = 0x4;

    // --- One Touch Record failure result
    /**
     * No recording – unable to record Digital Service. No suitable tuner.
     */
    public static final int ONE_TOUCH_RECORD_UNABLE_DIGITAL_SERVICE = 0x5;

    /**
     * No recording – unable to record Analogue Service. No suitable tuner.
     */
    public static final int ONE_TOUCH_RECORD_UNABLE_ANALOGUE_SERVICE = 0x6;
     ...
     */
    public static final int ONE_TOUCH_RECORD_UNABLE_SELECTED_SERVICE = 0x7;

    /**
     * No recording – invalid External plug number
     */
    public static final int ONE_TOUCH_RECORD_INVALID_EXTERNAL_PLUG_NUMBER = 0x9;

    /**
     * No recording – invalid External Physical Address
     */
    public static final int ONE_TOUCH_RECORD_INVALID_EXTERNAL_PHYSICAL_ADDRESS = 0xa;

    /**
     * No recording – CA system not supported
     */
    public static final int ONE_TOUCH_RECORD_UNSUPPORTED_CA = 0xb;

    /**
     * No Recording – No or Insufficient CA Entitlements”
     */
    public static final int ONE_TOUCH_RECORD_NO_OR_INSUFFICIENT_CA_ENTITLEMENTS = 0xc;

    /**
     * No recording – Not allowed to copy source. Source is “copy never”.
     */
    public static final int ONE_TOUCH_RECORD_DISALLOW_TO_COPY = 0xd;

    /**
     * No recording – No further copies allowed
     */
    public static final int ONE_TOUCH_RECORD_DISALLOW_TO_FUTHER_COPIES = 0xe;
     ...
     * No extra error.
     */
    public static final int TIMER_RECORDING_RESULT_EXTRA_NO_ERROR = 0x0;

    /**
     * No timer recording - check recorder and connection.
     */
    public static final int TIMER_RECORDING_RESULT_EXTRA_CHECK_RECORDER_CONNECTION = 0x1;

    /**
     * No timer recording - cannot record selected source.
     */
    public static final int TIMER_RECORDING_RESULT_EXTRA_FAIL_TO_RECORD_SELECTED_SOURCE = 0x2;

    /**
     * CEC is disabled.
     */
    public static final int TIMER_RECORDING_RESULT_EXTRA_CEC_DISABLED = 0x3;

    // -- Timer cleared status data code used for result of onClearTimerRecordingResult.
    /**
     * Timer not cleared – recording.
     */
    public static final int CLEAR_TIMER_STATUS_TIMER_NOT_CLEARED_RECORDING = 0x0;

    /**
     * Timer not cleared – no matching.
     */
    public static final int CLEAR_TIMER_STATUS_TIMER_NOT_CLEARED_NO_MATCHING = 0x1;

    /**
     * Timer not cleared – no info available.
     */
    public static final int CLEAR_TIMER_STATUS_TIMER_NOT_CLEARED_NO_INFO_AVAILABLE = 0x2;
     ...
     */
    public HdmiControlManager(android.hardware.hdmi.IHdmiControlService service) {
        mService = service;
        int[] types = null;
        if (mService != null) {
            try {
        ...
        mHasTvDevice = android.hardware.hdmi.HdmiControlManager.hasDeviceType(types, android.hardware.hdmi.HdmiDeviceInfo.DEVICE_TV);
        mHasPlaybackDevice = android.hardware.hdmi.HdmiControlManager.hasDeviceType(types, android.hardware.hdmi.HdmiDeviceInfo.DEVICE_PLAYBACK);
    }
     ...
     */
    @android.annotation.Nullable
    public android.hardware.hdmi.HdmiClient getClient(int type) {
        if (mService == null) {
            return null;
        }
        switch (type) {
            case android.hardware.hdmi.HdmiDeviceInfo.DEVICE_TV :
                return mHasTvDevice ? new android.hardware.hdmi.HdmiTvClient(mService) : null;
            case android.hardware.hdmi.HdmiDeviceInfo.DEVICE_PLAYBACK :
                return mHasPlaybackDevice ? new android.hardware.hdmi.HdmiPlaybackClient(mService) : null;
            default :
                return null;
        }
    }
    ...
    public android.hardware.hdmi.HdmiPlaybackClient getPlaybackClient() {
        return ((android.hardware.hdmi.HdmiPlaybackClient) (getClient(android.hardware.hdmi.HdmiDeviceInfo.DEVICE_PLAYBACK)));
    }
    ...
    public android.hardware.hdmi.HdmiTvClient getTvClient() {
        return ((android.hardware.hdmi.HdmiTvClient) (getClient(android.hardware.hdmi.HdmiDeviceInfo.DEVICE_TV)));
    }
    ...
    public interface HotplugEventListener {
        void onReceived(android.hardware.hdmi.HdmiHotplugEvent event);
    }
    ...
    public interface VendorCommandListener {
         ...
         * @param hasVendorId
         * 		{@code true} if the command is &lt;Vendor Command
         ...
         *
         * @param enabled
         * 		{@code true} if HdmiControlService is enabled.
         * @param reason
         * 		the reason code why the state of HdmiControlService is changed.
     ...
     *
     * @param listener
     * 		{@link HotplugEventListener} instance
     * @see HdmiControlManager#removeHotplugEventListener(HotplugEventListener)
     */
    public void addHotplugEventListener(android.hardware.hdmi.HdmiControlManager.HotplugEventListener listener) {
        if (mService == null) {
            android.util.Log.e(android.hardware.hdmi.HdmiControlManager.TAG, "HdmiControlService is not available");
            return;
        }
        if (mHotplugEventListeners.containsKey(listener)) {
            android.util.Log.e(android.hardware.hdmi.HdmiControlManager.TAG, "listener is already registered");
            return;
        }
        android.hardware.hdmi.IHdmiHotplugEventListener wrappedListener = getHotplugEventListenerWrapper(listener);
     ...
     *
     * @param listener
     * 		{@link HotplugEventListener} instance to be removed
     */
    public void removeHotplugEventListener(android.hardware.hdmi.HdmiControlManager.HotplugEventListener listener) {
        if (mService == null) {
            android.util.Log.e(android.hardware.hdmi.HdmiControlManager.TAG, "HdmiControlService is not available");
            return;
        }
        android.hardware.hdmi.IHdmiHotplugEventListener wrappedListener = mHotplugEventListeners.remove(listener);
        if (wrappedListener == null) {
            android.util.Log.e(android.hardware.hdmi.HdmiControlManager.TAG, "tried to remove not-registered listener");
            return;
        }
        try {
    ...
    private android.hardware.hdmi.IHdmiHotplugEventListener getHotplugEventListenerWrapper(final android.hardware.hdmi.HdmiControlManager.HotplugEventListener listener) {
        return new android.hardware.hdmi.IHdmiHotplugEventListener.Stub() {
            @java.lang.Override
