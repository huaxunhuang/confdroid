...
public final class GeofenceHardwareRequest {
    ...
    private int mLastTransition = android.hardware.location.GeofenceHardware.GEOFENCE_UNCERTAIN;

    private int mUnknownTimer = 30000;// 30 secs


    private int mMonitorTransitions = (android.hardware.location.GeofenceHardware.GEOFENCE_UNCERTAIN | android.hardware.location.GeofenceHardware.GEOFENCE_ENTERED) | android.hardware.location.GeofenceHardware.GEOFENCE_EXITED;

    private int mNotificationResponsiveness = 5000;// 5 secs


    private int mSourceTechnologies = android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_GNSS;

    private void setCircularGeofence(double latitude, double longitude, double radius) {
        mLatitude = latitude;
        mLongitude = longitude;
        mRadius = radius;
        mType = android.hardware.location.GeofenceHardwareRequest.GEOFENCE_TYPE_CIRCLE;
    }
     ...
     */
    public static android.hardware.location.GeofenceHardwareRequest createCircularGeofence(double latitude, double longitude, double radius) {
        android.hardware.location.GeofenceHardwareRequest geofenceRequest = new android.hardware.location.GeofenceHardwareRequest();
     ...
     *
     * @param monitorTransitions
     * 		Bitwise OR of {@link GeofenceHardware#GEOFENCE_ENTERED},
     ...
     *
     * @param sourceTechnologies
     * 		The set of source technologies to use.
     */
    public void setSourceTechnologies(int sourceTechnologies) {
        int sourceTechnologiesAll = (((android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_GNSS | android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_WIFI) | android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_SENSORS) | android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_CELL) | android.hardware.location.GeofenceHardware.SOURCE_TECHNOLOGY_BLUETOOTH;
