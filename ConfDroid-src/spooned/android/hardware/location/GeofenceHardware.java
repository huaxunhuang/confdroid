...
public final class GeofenceHardware {
    ...
    private java.util.HashMap<android.hardware.location.GeofenceHardwareCallback, android.hardware.location.GeofenceHardware.GeofenceHardwareCallbackWrapper> mCallbacks = new java.util.HashMap<android.hardware.location.GeofenceHardwareCallback, android.hardware.location.GeofenceHardware.GeofenceHardwareCallbackWrapper>();

    private java.util.HashMap<android.hardware.location.GeofenceHardwareMonitorCallback, android.hardware.location.GeofenceHardware.GeofenceHardwareMonitorCallbackWrapper> mMonitorCallbacks = new java.util.HashMap<android.hardware.location.GeofenceHardwareMonitorCallback, android.hardware.location.GeofenceHardware.GeofenceHardwareMonitorCallbackWrapper>();
    ...
    public int getStatusOfMonitoringType(int monitoringType) {
        try {
            ...
            return android.hardware.location.GeofenceHardware.MONITOR_UNSUPPORTED;
        }
    }
     ...
     * 		The {@link GeofenceHardwareRequest} object associated with the
     * 		geofence.
     * @param callback
     * 		{@link GeofenceHardwareCallback} that will be use to notify the
     * 		transition.
     ...
     */
    public boolean addGeofence(int geofenceId, int monitoringType, android.hardware.location.GeofenceHardwareRequest geofenceRequest, android.hardware.location.GeofenceHardwareCallback callback) {
        try {
            if (geofenceRequest.getType() == android.hardware.location.GeofenceHardwareRequest.GEOFENCE_TYPE_CIRCLE) {
                return mService.addCircularFence(monitoringType, new android.hardware.location.GeofenceHardwareRequestParcelable(geofenceId, geofenceRequest), getCallbackWrapper(callback));
            } else {
     ...
     */
    public boolean registerForMonitorStateChangeCallback(int monitoringType, android.hardware.location.GeofenceHardwareMonitorCallback callback) {
        try {
            return mService.registerForMonitorStateChangeCallback(monitoringType, getMonitorCallbackWrapper(callback));
        } catch (android.os.RemoteException e) {
        }
        return false;
    }
     ...
     * @return true on success
     */
    public boolean unregisterForMonitorStateChangeCallback(int monitoringType, android.hardware.location.GeofenceHardwareMonitorCallback callback) {
    ...
    private void removeCallback(android.hardware.location.GeofenceHardwareCallback callback) {
        synchronized(mCallbacks) {
            mCallbacks.remove(callback);
        }
    }

    private android.hardware.location.GeofenceHardware.GeofenceHardwareCallbackWrapper getCallbackWrapper(android.hardware.location.GeofenceHardwareCallback callback) {
        synchronized(mCallbacks) {
            android.hardware.location.GeofenceHardware.GeofenceHardwareCallbackWrapper wrapper = mCallbacks.get(callback);
            if (wrapper == null) {
                wrapper = new android.hardware.location.GeofenceHardware.GeofenceHardwareCallbackWrapper(callback);
    ...
    private void removeMonitorCallback(android.hardware.location.GeofenceHardwareMonitorCallback callback) {
        synchronized(mMonitorCallbacks) {
            mMonitorCallbacks.remove(callback);
        }
    }

    private android.hardware.location.GeofenceHardware.GeofenceHardwareMonitorCallbackWrapper getMonitorCallbackWrapper(android.hardware.location.GeofenceHardwareMonitorCallback callback) {
        synchronized(mMonitorCallbacks) {
            android.hardware.location.GeofenceHardware.GeofenceHardwareMonitorCallbackWrapper wrapper = mMonitorCallbacks.get(callback);
            if (wrapper == null) {
                wrapper = new android.hardware.location.GeofenceHardware.GeofenceHardwareMonitorCallbackWrapper(callback);
    ...
    class GeofenceHardwareMonitorCallbackWrapper extends android.hardware.location.IGeofenceHardwareMonitorCallback.Stub {
        ...
        GeofenceHardwareMonitorCallbackWrapper(android.hardware.location.GeofenceHardwareMonitorCallback c) {
            mCallback = new java.lang.ref.WeakReference<android.hardware.location.GeofenceHardwareMonitorCallback>(c);
        }

        public void onMonitoringSystemChange(android.hardware.location.GeofenceHardwareMonitorEvent event) {
            android.hardware.location.GeofenceHardwareMonitorCallback c = mCallback.get();
            if (c == null)
                return;

            // report the legacy event first, so older clients are not broken
            c.onMonitoringSystemChange(event.getMonitoringType(), event.getMonitoringStatus() == android.hardware.location.GeofenceHardware.MONITOR_CURRENTLY_AVAILABLE, event.getLocation());
    ...
    class GeofenceHardwareCallbackWrapper extends android.hardware.location.IGeofenceHardwareCallback.Stub {
        ...
        GeofenceHardwareCallbackWrapper(android.hardware.location.GeofenceHardwareCallback c) {
            mCallback = new java.lang.ref.WeakReference<android.hardware.location.GeofenceHardwareCallback>(c);
        }

        public void onGeofenceTransition(int geofenceId, int transition, android.location.Location location, long timestamp, int monitoringType) {
            android.hardware.location.GeofenceHardwareCallback c = mCallback.get();
            if (c != null) {
