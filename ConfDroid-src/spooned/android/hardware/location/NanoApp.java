...
public class NanoApp {
    private final java.lang.String TAG = "NanoApp";
     ...
     *
     * @param publisher
     * 		name of the publisher of this nano app
     */
    ...
    private NanoApp(android.os.Parcel in) {
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
        if (mAppBinary == null) {
            throw new java.lang.IllegalStateException("Must set non-null AppBinary for nanoapp " + mName);
        }
        if (!mAppIdSet) {
            throw new java.lang.IllegalStateException("Must set AppId for nanoapp " + mName);
        }
    ...
    public static final android.os.Parcelable.Creator<android.hardware.location.NanoApp> CREATOR = new android.os.Parcelable.Creator<android.hardware.location.NanoApp>() {
        public android.hardware.location.NanoApp createFromParcel(android.os.Parcel in) {
            return new android.hardware.location.NanoApp(in);
        }

        public android.hardware.location.NanoApp[] newArray(int size) {
            return new android.hardware.location.NanoApp[size];
        }
    };

    @java.lang.Override
    public java.lang.String toString() {
        java.lang.String retVal = "Id : " + mAppId;
