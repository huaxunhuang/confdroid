...
public final class GeofenceHardwareRequestParcelable implements android.os.Parcelable {
     ...
     */
    public static final android.os.Parcelable.Creator<android.hardware.location.GeofenceHardwareRequestParcelable> CREATOR = new android.os.Parcelable.Creator<android.hardware.location.GeofenceHardwareRequestParcelable>() {
        @java.lang.Override
        public android.hardware.location.GeofenceHardwareRequestParcelable createFromParcel(android.os.Parcel parcel) {
            ...
            if (geofenceType != android.hardware.location.GeofenceHardwareRequest.GEOFENCE_TYPE_CIRCLE) {
                android.util.Log.e("GeofenceHardwareRequest", java.lang.String.format("Invalid Geofence type: %d", geofenceType));
                return null;
            }
            android.hardware.location.GeofenceHardwareRequest request = android.hardware.location.GeofenceHardwareRequest.createCircularGeofence(parcel.readDouble(), parcel.readDouble(), parcel.readDouble());
            ...
            return new android.hardware.location.GeofenceHardwareRequestParcelable(id, request);
        }

        @java.lang.Override
        public android.hardware.location.GeofenceHardwareRequestParcelable[] newArray(int size) {
            return new android.hardware.location.GeofenceHardwareRequestParcelable[size];
        }
    };
