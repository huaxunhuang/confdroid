...
public abstract class SensorManager {
    ...
    private final android.util.SparseArray<java.util.List<android.hardware.Sensor>> mSensorListByType = new android.util.SparseArray<java.util.List<android.hardware.Sensor>>();
     ...
     */
    @java.lang.Deprecated
    public static final int SENSOR_MIN = android.hardware.SensorManager.SENSOR_ORIENTATION;
     ...
     */
    @java.lang.Deprecated
    public static final int SENSOR_MAX = (android.hardware.SensorManager.SENSOR_ALL + 1) >> 1;
     ...
     * see {@link #remapCoordinateSystem}
     */
    public static final int AXIS_MINUS_X = android.hardware.SensorManager.AXIS_X | 0x80;

    /**
     * see {@link #remapCoordinateSystem}
     */
    public static final int AXIS_MINUS_Y = android.hardware.SensorManager.AXIS_Y | 0x80;

    /**
     * see {@link #remapCoordinateSystem}
     */
    public static final int AXIS_MINUS_Z = android.hardware.SensorManager.AXIS_Z | 0x80;
    ...
    public java.util.List<android.hardware.Sensor> getSensorList(int type) {
        ...
        final java.util.List<android.hardware.Sensor> fullList = getFullSensorList();
        synchronized(mSensorListByType) {
            list = mSensorListByType.get(type);
            if (list == null) {
                if (type == android.hardware.Sensor.TYPE_ALL) {
                    list = fullList;
                } else {
                    list = new java.util.ArrayList<android.hardware.Sensor>();
     ...
     * @see Sensor
     */
    public java.util.List<android.hardware.Sensor> getDynamicSensorList(int type) {
        // cache the returned lists the first time
        final java.util.List<android.hardware.Sensor> fullList = getFullDynamicSensorList();
        if (type == android.hardware.Sensor.TYPE_ALL) {
            return java.util.Collections.unmodifiableList(fullList);
        } else {
    ...
    public android.hardware.Sensor getDefaultSensor(int type) {
        ...
        java.util.List<android.hardware.Sensor> l = getSensorList(type);
        boolean wakeUpSensor = false;
        // For the following sensor types, return a wake-up sensor. These types are by default
        // defined as wake-up sensors. For the rest of the SDK defined sensor types return a
        // non_wake-up version.
        if (((((((type == android.hardware.Sensor.TYPE_PROXIMITY) || (type == android.hardware.Sensor.TYPE_SIGNIFICANT_MOTION)) || (type == android.hardware.Sensor.TYPE_TILT_DETECTOR)) || (type == android.hardware.Sensor.TYPE_WAKE_GESTURE)) || (type == android.hardware.Sensor.TYPE_GLANCE_GESTURE)) || (type == android.hardware.Sensor.TYPE_PICK_UP_GESTURE)) || (type == android.hardware.Sensor.TYPE_WRIST_TILT_GESTURE)) {
            wakeUpSensor = true;
        }
        for (android.hardware.Sensor sensor : l) {
     ...
     */
    public android.hardware.Sensor getDefaultSensor(int type, boolean wakeUp) {
        java.util.List<android.hardware.Sensor> l = getSensorList(type);
        for (android.hardware.Sensor sensor : l) {
    ...
    public boolean registerListener(android.hardware.SensorListener listener, int sensors) {
        return registerListener(listener, sensors, android.hardware.SensorManager.SENSOR_DELAY_NORMAL);
    }
    ...
    public void unregisterListener(android.hardware.SensorListener listener) {
        unregisterListener(listener, android.hardware.SensorManager.SENSOR_ALL | android.hardware.SensorManager.SENSOR_ORIENTATION_RAW);
    }
     ...
     * @unknown 
     */
    protected abstract void unregisterListenerImpl(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor);
     ...
     * deactivated by the application. Applications must unregister their {@code SensorEventListener}s in their activity's {@code onPause()} method to avoid consuming power
     ...
     *
     * @param listener
     * 		A {@link android.hardware.SensorEventListener SensorEventListener} object.
     * @param sensor
     ...
     * @see #unregisterListener(SensorEventListener, Sensor)
     */
    public boolean registerListener(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor, int samplingPeriodUs) {
     ...
     */
    public boolean registerListener(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor, int samplingPeriodUs, int maxReportLatencyUs) {
        int delay = android.hardware.SensorManager.getDelay(samplingPeriodUs);
     ...
     * @param handler
     * 		The {@link android.os.Handler Handler} the {@link android.hardware.SensorEvent
     ...
     * @see #unregisterListener(SensorEventListener, Sensor)
     */
    public boolean registerListener(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor, int samplingPeriodUs, android.os.Handler handler) {
        int delay = android.hardware.SensorManager.getDelay(samplingPeriodUs);
     ...
     */
    public boolean registerListener(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor, int samplingPeriodUs, int maxReportLatencyUs, android.os.Handler handler) {
        int delayUs = android.hardware.SensorManager.getDelay(samplingPeriodUs);
     ...
     * @unknown 
     */
    protected abstract boolean registerListenerImpl(android.hardware.SensorEventListener listener, android.hardware.Sensor sensor, int delayUs, android.os.Handler handler, int maxReportLatencyUs, int reservedFlags);
    ...
    public static abstract class DynamicSensorCallback {
         ...
         *
         * @param sensor
         * 		the newly connected sensor. See {@link android.hardware.Sensor Sensor}.
         */
         ...
         *
         * @param sensor
         * 		the disconnected sensor. See {@link android.hardware.Sensor Sensor}.
         */
     ...
     */
    public void registerDynamicSensorCallback(android.hardware.SensorManager.DynamicSensorCallback callback) {
     ...
     * @param handler
     * 		The {@link android.os.Handler Handler} the {@link android.hardware.SensorManager.DynamicSensorCallback
     * 		sensor connection events} will be delivered to.
     * @throws IllegalArgumentException
     * 		when callback is null.
     */
    public void registerDynamicSensorCallback(android.hardware.SensorManager.DynamicSensorCallback callback, android.os.Handler handler) {
     ...
     * 		interface for receiving callbacks.
     */
    public void unregisterDynamicSensorCallback(android.hardware.SensorManager.DynamicSensorCallback callback) {
    ...
    public boolean isDynamicSensorDiscoverySupported() {
        java.util.List<android.hardware.Sensor> sensors = getSensorList(android.hardware.Sensor.TYPE_DYNAMIC_SENSOR_META);
     ...
     * @unknown 
     */
    protected abstract void registerDynamicSensorCallbackImpl(android.hardware.SensorManager.DynamicSensorCallback callback, android.os.Handler handler);
     ...
     * @unknown 
     */
    protected abstract void unregisterDynamicSensorCallbackImpl(android.hardware.SensorManager.DynamicSensorCallback callback);
    ...
    public static boolean getRotationMatrix(float[] R, float[] I, float[] gravity, float[] geomagnetic) {
        ...
        final float normH = ((float) (java.lang.Math.sqrt(((Hx * Hx) + (Hy * Hy)) + (Hz * Hz))));
        if (normH < 0.1F) {
        ...
        Hy *= invH;
        Hz *= invH;
        final float invA = 1.0F / ((float) (java.lang.Math.sqrt(((Ax * Ax) + (Ay * Ay)) + (Az * Az))));
        Ax *= invA;
        Ay *= invA;
        Az *= invA;
        ...
        if (I != null) {
            ...
            final float invE = 1.0F / ((float) (java.lang.Math.sqrt(((Ex * Ex) + (Ey * Ey)) + (Ez * Ez))));
    ...
    public static float getInclination(float[] I) {
        if (I.length == 9) {
            return ((float) (java.lang.Math.atan2(I[5], I[4])));
        } else {
            return ((float) (java.lang.Math.atan2(I[6], I[5])));
        }
    }
    ...
    public static boolean remapCoordinateSystem(float[] inR, int X, int Y, float[] outR) {
        if (inR == outR) {
            final float[] temp = android.hardware.SensorManager.mTempMatrix;
            synchronized(temp) {
    ...
    public static float[] getOrientation(float[] R, float[] values) {
         ...
         */
        if (R.length == 9) {
            values[0] = ((float) (java.lang.Math.atan2(R[1], R[4])));
            values[1] = ((float) (java.lang.Math.asin(-R[7])));
            values[2] = ((float) (java.lang.Math.atan2(-R[6], R[8])));
        } else {
            values[0] = ((float) (java.lang.Math.atan2(R[1], R[5])));
            values[1] = ((float) (java.lang.Math.asin(-R[9])));
            values[2] = ((float) (java.lang.Math.atan2(-R[8], R[10])));
        }
        return values;
    }
    ...
    public static float getAltitude(float p0, float p) {
        ...
        return 44330.0F * (1.0F - ((float) (java.lang.Math.pow(p / p0, coef))));
    }
    ...
    public static void getAngleChange(float[] angleChange, float[] R, float[] prevR) {
        ...
        angleChange[0] = ((float) (java.lang.Math.atan2(rd1, rd4)));
        angleChange[1] = ((float) (java.lang.Math.asin(-rd7)));
        angleChange[2] = ((float) (java.lang.Math.atan2(-rd6, rd8)));
    }
    ...
    public static void getQuaternionFromVector(float[] Q, float[] rv) {
        if (rv.length >= 4) {
            ...
            Q[0] = (Q[0] > 0) ? ((float) (java.lang.Math.sqrt(Q[0]))) : 0;
        }
        Q[1] = rv[0];
        Q[2] = rv[1];
        Q[3] = rv[2];
     ...
     * @unknown 
     */
    protected abstract boolean requestTriggerSensorImpl(android.hardware.TriggerEventListener listener, android.hardware.Sensor sensor);
     ...
     */
    public boolean cancelTriggerSensor(android.hardware.TriggerEventListener listener, android.hardware.Sensor sensor) {
     ...
     * @unknown 
     */
    protected abstract boolean cancelTriggerSensorImpl(android.hardware.TriggerEventListener listener, android.hardware.Sensor sensor, boolean disable);
     ...
     * @param timestamp
     * 		Sensor timestamp associated with the event.
     ...
     */
    @android.annotation.SystemApi
    public boolean injectSensorData(android.hardware.Sensor sensor, float[] values, int accuracy, long timestamp) {
        if (sensor == null) {
        ...
        int expectedNumValues = android.hardware.Sensor.getMaxLengthValuesArray(sensor, android.os.Build.VERSION_CODES.M);
        if (values.length != expectedNumValues) {
            throw new java.lang.IllegalArgumentException((((("Wrong number of values for sensor " + sensor.getName()) + " actual=") + values.length) + " expected=") + expectedNumValues);
        }
        if ((accuracy < android.hardware.SensorManager.SENSOR_STATUS_NO_CONTACT) || (accuracy > android.hardware.SensorManager.SENSOR_STATUS_ACCURACY_HIGH)) {
     ...
     * @unknown 
     */
    protected abstract boolean injectSensorDataImpl(android.hardware.Sensor sensor, float[] values, int accuracy, long timestamp);

    private android.hardware.LegacySensorManager getLegacySensorManager() {
        synchronized(mSensorListByType) {
            if (mLegacySensorManager == null) {
                android.util.Log.i(android.hardware.SensorManager.TAG, "This application is using deprecated SensorManager API which will " + "be removed someday.  Please consider switching to the new API.");
                mLegacySensorManager = new android.hardware.LegacySensorManager(this);
            }
    ...
    private static int getDelay(int rate) {
        int delay = -1;
        switch (rate) {
            case android.hardware.SensorManager.SENSOR_DELAY_FASTEST :
                delay = 0;
                break;
