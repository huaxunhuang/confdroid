...
public final class KeyboardLayout implements android.os.Parcelable , java.lang.Comparable<android.hardware.input.KeyboardLayout> {
    ...
    public static final android.os.Parcelable.Creator<android.hardware.input.KeyboardLayout> CREATOR = new android.os.Parcelable.Creator<android.hardware.input.KeyboardLayout>() {
        public android.hardware.input.KeyboardLayout createFromParcel(android.os.Parcel source) {
            return new android.hardware.input.KeyboardLayout(source);
        }

        public android.hardware.input.KeyboardLayout[] newArray(int size) {
            return new android.hardware.input.KeyboardLayout[size];
        }
    };

    public KeyboardLayout(java.lang.String descriptor, java.lang.String label, java.lang.String collection, int priority, android.os.LocaleList locales, int vid, int pid) {
    ...
    public int compareTo(android.hardware.input.KeyboardLayout another) {
        ...
        int result = java.lang.Integer.compare(another.mPriority, mPriority);
        if (result == 0) {
