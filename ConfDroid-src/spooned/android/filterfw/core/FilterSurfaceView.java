...
public class FilterSurfaceView extends android.view.SurfaceView implements android.view.SurfaceHolder.Callback {
    ...
    private int mState = android.filterfw.core.FilterSurfaceView.STATE_ALLOCATED;
    ...
    public synchronized void bindToListener(android.view.SurfaceHolder.Callback listener, android.filterfw.core.GLEnvironment glEnv) {
        ...
        if (listener == null) {
            ...
            if ((mListener != null) && (mListener != listener)) {
                throw new java.lang.RuntimeException((((("Attempting to bind filter " + listener) + " to SurfaceView with another open ") + "filter ") + mListener) + " attached already!");
            }
        ...
        if (mState >= android.filterfw.core.FilterSurfaceView.STATE_CREATED) {
            ...
            if (mState == android.filterfw.core.FilterSurfaceView.STATE_INITIALIZED) {
    ...
    public synchronized void surfaceCreated(android.view.SurfaceHolder holder) {
        mState = android.filterfw.core.FilterSurfaceView.STATE_CREATED;
    ...
    public synchronized void surfaceChanged(android.view.SurfaceHolder holder, int format, int width, int height) {
        ...
        mWidth = width;
        mHeight = height;
        mState = android.filterfw.core.FilterSurfaceView.STATE_INITIALIZED;
        // Forward to renderer
        if (mListener != null) {
    ...
    public synchronized void surfaceDestroyed(android.view.SurfaceHolder holder) {
        mState = android.filterfw.core.FilterSurfaceView.STATE_ALLOCATED;
        // Forward to renderer
        if (mListener != null) {
