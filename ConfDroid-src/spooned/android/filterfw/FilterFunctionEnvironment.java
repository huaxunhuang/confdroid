...
public class FilterFunctionEnvironment extends android.filterfw.MffEnvironment {
     ...
     */
    public android.filterfw.core.FilterFunction createFunction(java.lang.Class filterClass, java.lang.Object... parameters) {
        java.lang.String filterName = ("FilterFunction(" + filterClass.getSimpleName()) + ")";
        android.filterfw.core.Filter filter = android.filterfw.core.FilterFactory.sharedFactory().createFilterByClass(filterClass, filterName);
        filter.initWithAssignmentList(parameters);
        return new android.filterfw.core.FilterFunction(getContext(), filter);
    }
}
