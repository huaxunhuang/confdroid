...
import androidsourcecode.branchedflow.Predicate;
...
public class ReadXmlFilesForFinalOutputs {
    static int num = 0;
...
//                System.out.println(tempFile.toString());
    ...
    public static void getNodes(Element element, String path) {
        if(path.contains("-v") || path.contains("/mtrl_")){
            return;
        }
        if(path.contains("styles.xml")){
            return;
        }
